...
- [uber/h3](https://github.com/uber/h3) topic:geospatial,h3,hexagon,spatial-indexing,uber pushed_at:2023-07 star:4.1k fork:0.4k Hexagonal hierarchical geospatial indexing system
...
- [uber/libphutil](https://github.com/uber/libphutil) topic: pushed_at:2023-07 star:0.0k fork:0.0k A collection of PHP utility classes
...
- [uber/mock](https://github.com/uber/mock) topic: pushed_at:2023-07 star:0.3k fork:0.0k GoMock is a mocking framework for the Go programming language.
...
- [uber/zanzibar](https://github.com/uber/zanzibar) topic: pushed_at:2023-07 star:0.4k fork:0.1k A build system & configuration system to generate versioned API gateways.
...
- [uber/NullAway](https://github.com/uber/NullAway) topic:android,java,nullability,nullability-analysis,static-analysis,static-code-analysis pushed_at:2023-07 star:3.3k fork:0.3k A tool to help eliminate NullPointerExceptions (NPEs) in your Java code with low build-time overhead
...
- [uber/rides-java-sdk](https://github.com/uber/rides-java-sdk) topic: pushed_at:2023-07 star:0.1k fork:0.1k Uber Rides Java SDK (beta)
...
- [uber/simple-store](https://github.com/uber/simple-store) topic:incubation pushed_at:2023-07 star:0.1k fork:0.0k Simple yet performant asynchronous file storage for Android
...
- [uber/cadence-web](https://github.com/uber/cadence-web) topic:cadence,mocha,stylus,uber,vuejs2,webpack,workflows pushed_at:2023-07 star:0.3k fork:0.1k Web UI for visualizing workflows on Cadence
...
- [uber/h3-js](https://github.com/uber/h3-js) topic:emscripten,geospatial,h3,hexagon,javascript,spatial-indexing,uber pushed_at:2023-07 star:0.7k fork:0.1k h3-js provides a JavaScript version of H3, a hexagon-based geospatial indexing system.
...
- [uber/RIBs](https://github.com/uber/RIBs) topic:android,architectural-patterns,architecture,ios,mobile,mobile-app,mobile-development,mvc,mvp,mvvm,viper pushed_at:2023-07 star:7.4k fork:0.9k Uber's cross-platform mobile architecture framework.
...
- [uber/vscode-go](https://github.com/uber/vscode-go) topic: pushed_at:2023-07 star:0.0k fork:0.0k Go extension for Visual Studio Code, with added Bazel Support
...
- [uber/arcanist](https://github.com/uber/arcanist) topic: pushed_at:2023-07 star:0.0k fork:0.0k Command line interface for Phabricator

## Python

- [uber/aristotle](https://github.com/uber/aristotle) topic: pushed_at:2023-07 star:0.0k fork:0.0k Uber Fork of Aristotle - for contribution purposes
...
- [uber/causalml](https://github.com/uber/causalml) topic:causal-inference,incubation,machine-learning,uplift-modeling pushed_at:2023-07 star:4.1k fork:0.7k Uplift modeling and causal inference with machine learning algorithms
...
- [uber/Python-Sample-Application](https://github.com/uber/Python-Sample-Application) topic: pushed_at:2023-07 star:0.4k fork:0.6k 
...
- [uber/baseweb](https://github.com/uber/baseweb) topic:component-library,design-systems,react,react-components pushed_at:2023-07 star:8.4k fork:0.8k A React Component library implementing the Base design language
...
- [uber/Cadence-Docs](https://github.com/uber/Cadence-Docs) topic: pushed_at:2023-07 star:0.0k fork:0.1k 
