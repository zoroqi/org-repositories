...
- [uber/h3](https://github.com/uber/h3) topic:geospatial,h3,hexagon,spatial-indexing,uber pushed_at:2026-04 star:6.2k fork:0.6k Hexagonal hierarchical geospatial indexing system
...
- [uber/kraken](https://github.com/uber/kraken) topic:bittorrent,container,containerd,docker,docker-image,docker-registry,p2p pushed_at:2026-04 star:6.7k fork:0.5k P2P Docker registry capable of distributing TBs of data in seconds
...
- [uber/scip-lsp](https://github.com/uber/scip-lsp) topic: pushed_at:2026-03 star:0.0k fork:0.0k 
...
- [uber/AutoDispose](https://github.com/uber/AutoDispose) topic:android,autodispose,kotlin,lifecycle,reactive-extensions,reactive-streams,rxandroid,rxjava,uber pushed_at:2026-04 star:3.4k fork:0.2k Automatic binding+disposal of RxJava streams.
...
- [uber/NullAway](https://github.com/uber/NullAway) topic:android,java,nullability,nullability-analysis,static-analysis,static-code-analysis pushed_at:2026-04 star:4.0k fork:0.3k A tool to help eliminate NullPointerExceptions (NPEs) in your Java code with low build-time overhead
...
- [uber/rides-android-sdk](https://github.com/uber/rides-android-sdk) topic: pushed_at:2026-01 star:0.3k fork:0.1k Uber Rides Android SDK (beta)
...
- [uber/ios-snapshot-test-case](https://github.com/uber/ios-snapshot-test-case) topic: pushed_at:2025-12 star:1.8k fork:0.2k Snapshot view unit tests for iOS
...
- [uber/kotlin](https://github.com/uber/kotlin) topic: pushed_at:2026-04 star:0.0k fork:0.0k Uber fork of Kotlin (only used for patching critical bug fixes) - no new development
...
- [uber/lightdash](https://github.com/uber/lightdash) topic: pushed_at:2026-04 star:0.0k fork:0.0k Uber Fork of Lightdash - for contribution purposes
...
- [uber/causalml](https://github.com/uber/causalml) topic:causal-inference,incubation,machine-learning,uplift-modeling pushed_at:2026-04 star:5.8k fork:0.9k Uplift modeling and causal inference with machine learning algorithms
...
- [uber/uber-ios-sdk](https://github.com/uber/uber-ios-sdk) topic: pushed_at:2026-04 star:0.4k fork:0.1k Uber iOS SDK (beta)
...
- [uber/cosmo](https://github.com/uber/cosmo) topic: pushed_at:2026-03 star:0.0k fork:0.0k Uber FORK of wundergraph/cosmo
