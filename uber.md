...
- [uber/h3](https://github.com/uber/h3) topic:geospatial,h3,hexagon,spatial-indexing,uber pushed_at:2023-08 star:4.2k fork:0.4k Hexagonal hierarchical geospatial indexing system
...
- [uber/go-vertex-ai](https://github.com/uber/go-vertex-ai) topic: pushed_at:2023-09 star:0.0k fork:0.0k A go implementation of the Google VertexAI API
...
- [uber/kraken](https://github.com/uber/kraken) topic:bittorrent,container,docker,docker-image,docker-registry,p2p pushed_at:2023-09 star:5.6k fork:0.4k P2P Docker registry capable of distributing TBs of data in seconds
...
- [uber/tchannel-go](https://github.com/uber/tchannel-go) topic: pushed_at:2023-08 star:0.5k fork:0.1k Go implementation of a multiplexing and framing protocol for RPC calls
...
- [uber/zanzibar](https://github.com/uber/zanzibar) topic: pushed_at:2023-09 star:0.4k fork:0.1k A build system & configuration system to generate versioned API gateways.
...
- [uber/AutoDispose](https://github.com/uber/AutoDispose) topic:android,autodispose,kotlin,lifecycle,reactive-extensions,reactive-streams,rxandroid,rxjava,uber pushed_at:2023-09 star:3.3k fork:0.2k Automatic binding+disposal of RxJava streams.
...
- [uber/NullAway](https://github.com/uber/NullAway) topic:android,java,nullability,nullability-analysis,static-analysis,static-code-analysis pushed_at:2023-09 star:3.4k fork:0.3k A tool to help eliminate NullPointerExceptions (NPEs) in your Java code with low build-time overhead
...
- [uber/piranha](https://github.com/uber/piranha) topic:ast,ast-matcher,clang-plugin,code-management,code-quality,deadcode,feature-flags,feature-toggles,java,javascript,objective-c,refactoring,refactoring-tools,stale-flags,swift,swift-syntax pushed_at:2023-09 star:2.1k fork:0.2k A tool for refactoring code related to feature flag APIs
...
- [uber/cadence-web](https://github.com/uber/cadence-web) topic:cadence,mocha,stylus,uber,vuejs2,webpack,workflows pushed_at:2023-09 star:0.4k fork:0.1k Web UI for visualizing workflows on Cadence
...
- [uber/react-digraph](https://github.com/uber/react-digraph) topic: pushed_at:2023-09 star:2.5k fork:0.3k A library for creating directed graph editors
- [uber/react-global-hooks](https://github.com/uber/react-global-hooks) topic: pushed_at:2020-09 star:0.0k fork:0.0k 
- [uber/react-vis](https://github.com/uber/react-vis) topic:chart,charting-library,data-visualization,react,uber,visualization pushed_at:2023-06 star:8.6k fork:0.9k Data Visualization Components
...
- [uber/RIBs](https://github.com/uber/RIBs) topic:android,architectural-patterns,architecture,ios,mobile,mobile-app,mobile-development,mvc,mvp,mvvm,viper pushed_at:2023-09 star:7.5k fork:0.9k Uber's cross-platform mobile architecture framework.
...
- [uber/go.uber.org](https://github.com/uber/go.uber.org) topic: pushed_at:2023-09 star:0.0k fork:0.0k Golang https://go.uber.org custom import path
...
- [uber/arcanist](https://github.com/uber/arcanist) topic: pushed_at:2023-09 star:0.0k fork:0.0k Command line interface for Phabricator

## Python

- [uber/aristotle](https://github.com/uber/aristotle) topic: pushed_at:2023-09 star:0.0k fork:0.0k Uber Fork of Aristotle - for contribution purposes
...
- [uber/causalml](https://github.com/uber/causalml) topic:causal-inference,incubation,machine-learning,uplift-modeling pushed_at:2023-09 star:4.2k fork:0.7k Uplift modeling and causal inference with machine learning algorithms
...
- [uber/hermetic_cc_toolchain](https://github.com/uber/hermetic_cc_toolchain) topic: pushed_at:2023-09 star:0.2k fork:0.0k Bazel C/C++ toolchain for cross-compiling C/C++ programs
...
- [uber/rides-ios-sdk](https://github.com/uber/rides-ios-sdk) topic: pushed_at:2023-09 star:0.4k fork:0.1k Uber Rides iOS SDK (beta)
...
- [uber/cadence-idl](https://github.com/uber/cadence-idl) topic: pushed_at:2023-09 star:0.0k fork:0.0k Cadence IDL repo, shared by server / clients
- [uber/dosa-idl](https://github.com/uber/dosa-idl) topic: pushed_at:2022-02 star:0.0k fork:0.0k 
- [uber/tchannel](https://github.com/uber/tchannel) topic: pushed_at:2022-05 star:1.1k fork:0.1k network multiplexing and framing protocol for RPC
...
- [uber/baseweb](https://github.com/uber/baseweb) topic:component-library,design-systems,react,react-components pushed_at:2023-09 star:8.4k fork:0.8k A React Component library implementing the Base design language
...
- [uber/Cadence-Docs](https://github.com/uber/Cadence-Docs) topic: pushed_at:2023-09 star:0.0k fork:0.1k 
