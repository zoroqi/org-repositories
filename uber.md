...
- [uber/kraken](https://github.com/uber/kraken) topic:bittorrent,container,docker,docker-image,docker-registry,p2p pushed_at:2023-08 star:5.6k fork:0.4k P2P Docker registry capable of distributing TBs of data in seconds
- [uber/kubernetes](https://github.com/uber/kubernetes) topic: pushed_at:2023-08 star:0.0k fork:0.0k Uber downstream fork of Kubernetes - for contribution use only
...
- [uber/zanzibar](https://github.com/uber/zanzibar) topic: pushed_at:2023-08 star:0.4k fork:0.1k A build system & configuration system to generate versioned API gateways.
...
- [uber/AutoDispose](https://github.com/uber/AutoDispose) topic:android,autodispose,kotlin,lifecycle,reactive-extensions,reactive-streams,rxandroid,rxjava,uber pushed_at:2023-08 star:3.3k fork:0.2k Automatic binding+disposal of RxJava streams.
- [uber/cadence-java-client](https://github.com/uber/cadence-java-client) topic:aws-swf,cadence,cadence-client,task-management,task-management-system,task-queue,task-scheduler,uber,workflow-engine,workflow-management-system,workflow-scheduler pushed_at:2023-08 star:0.1k fork:0.1k Java framework for Cadence Workflow Service
...
- [uber/NullAway](https://github.com/uber/NullAway) topic:android,java,nullability,nullability-analysis,static-analysis,static-code-analysis pushed_at:2023-08 star:3.4k fork:0.3k A tool to help eliminate NullPointerExceptions (NPEs) in your Java code with low build-time overhead
...
- [uber/piranha](https://github.com/uber/piranha) topic:ast,ast-matcher,clang-plugin,code-management,code-quality,deadcode,feature-flags,feature-toggles,java,javascript,objective-c,refactoring,refactoring-tools,stale-flags,swift,swift-syntax pushed_at:2023-08 star:2.1k fork:0.2k A tool for refactoring code related to feature flag APIs
...
- [uber/rides-android-sdk](https://github.com/uber/rides-android-sdk) topic: pushed_at:2023-08 star:0.3k fork:0.1k Uber Rides Android SDK (beta)
...
- [uber/cadence-web](https://github.com/uber/cadence-web) topic:cadence,mocha,stylus,uber,vuejs2,webpack,workflows pushed_at:2023-08 star:0.4k fork:0.1k Web UI for visualizing workflows on Cadence
...
- [uber/grafana-dash-gen](https://github.com/uber/grafana-dash-gen) topic: pushed_at:2023-08 star:0.5k fork:0.1k grafana dash dash dash gen
...
- [uber/RIBs](https://github.com/uber/RIBs) topic:android,architectural-patterns,architecture,ios,mobile,mobile-app,mobile-development,mvc,mvp,mvvm,viper pushed_at:2023-08 star:7.5k fork:0.9k Uber's cross-platform mobile architecture framework.
...
- [uber/aristotle](https://github.com/uber/aristotle) topic: pushed_at:2023-08 star:0.0k fork:0.0k Uber Fork of Aristotle - for contribution purposes
...
- [uber/causalml](https://github.com/uber/causalml) topic:causal-inference,incubation,machine-learning,uplift-modeling pushed_at:2023-08 star:4.2k fork:0.7k Uplift modeling and causal inference with machine learning algorithms
...
- [uber/h3-py](https://github.com/uber/h3-py) topic:geocoding,geospatial,gis,h3,hexagonal-architecture,python,uber pushed_at:2023-08 star:0.7k fork:0.1k Python bindings for H3, a hierarchical hexagonal geospatial indexing system
...
- [uber/Python-Sample-Application](https://github.com/uber/Python-Sample-Application) topic: pushed_at:2023-08 star:0.4k fork:0.6k 
...
- [uber/hermetic_cc_toolchain](https://github.com/uber/hermetic_cc_toolchain) topic: pushed_at:2023-08 star:0.2k fork:0.0k Bazel C/C++ toolchain for cross-compiling C/C++ programs
...
- [uber/needle](https://github.com/uber/needle) topic: pushed_at:2023-08 star:1.6k fork:0.1k Compile-time safe Swift dependency injection framework
...
- [uber/baseweb](https://github.com/uber/baseweb) topic:component-library,design-systems,react,react-components pushed_at:2023-08 star:8.4k fork:0.8k A React Component library implementing the Base design language
...
- [uber/vscode-go](https://github.com/uber/vscode-go) topic: pushed_at:2023-08 star:0.0k fork:0.0k Go extension for Visual Studio Code, with added Bazel Support

## Vue

- [uber/Cadence-Docs](https://github.com/uber/Cadence-Docs) topic: pushed_at:2023-08 star:0.0k fork:0.1k 
