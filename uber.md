...
- [uber/h3](https://github.com/uber/h3) pushed_at:2022-08 star:3.6k fork:0.4k Hexagonal hierarchical geospatial indexing system
- [uber/h3-go](https://github.com/uber/h3-go) pushed_at:2022-08 star:0.2k fork:0.0k Go bindings for H3, a hierarchical hexagonal geospatial indexing system

## C++

- [uber/libphutil](https://github.com/uber/libphutil) pushed_at:2022-06 star:0.0k fork:0.0k A collection of PHP utility classes
- [uber/nanoscope-art](https://github.com/uber/nanoscope-art) pushed_at:2019-09 star:0.0k fork:0.0k 
- [uber/neuropod](https://github.com/uber/neuropod) pushed_at:2022-07 star:0.9k fork:0.1k A uniform interface to run deep learning models from multiple frameworks
...
- [uber/athenadriver](https://github.com/uber/athenadriver) pushed_at:2022-07 star:0.1k fork:0.0k A fully-featured AWS Athena database driver (+ athenareader https://github.com/uber/athenadriver/tree/master/athenareader)
- [uber/cadence](https://github.com/uber/cadence) pushed_at:2022-08 star:6.2k fork:0.6k Cadence is a distributed, scalable, durable, and highly available orchestration engine to execute asynchronous long-running business logic in a scalable and resilient way.
...
- [uber/kraken](https://github.com/uber/kraken) pushed_at:2022-07 star:5.1k fork:0.4k P2P Docker registry capable of distributing TBs of data in seconds
- [uber/pam-ussh](https://github.com/uber/pam-ussh) pushed_at:2022-03 star:0.8k fork:0.1k uber's ssh certificate pam module
...
- [uber/ringpop-go](https://github.com/uber/ringpop-go) pushed_at:2022-07 star:0.7k fork:0.1k Scalable, fault-tolerant application-layer sharding for Go applications
...
- [uber/tchannel-go](https://github.com/uber/tchannel-go) pushed_at:2022-07 star:0.5k fork:0.1k Go implementation of a multiplexing and framing protocol for RPC calls
...
- [uber/zanzibar](https://github.com/uber/zanzibar) pushed_at:2022-08 star:0.4k fork:0.1k A build system & configuration system to generate versioned API gateways.
...
- [uber/queryparser](https://github.com/uber/queryparser) pushed_at:2022-02 star:1.0k fork:0.1k Parsing and analysis of Vertica, Hive, and Presto SQL.
...
- [uber/cadence-java-client](https://github.com/uber/cadence-java-client) pushed_at:2022-08 star:0.1k fork:0.1k Java framework for Cadence Workflow Service
...
- [uber/h3-java](https://github.com/uber/h3-java) pushed_at:2022-08 star:0.2k fork:0.0k Java bindings for H3, a hierarchical hexagonal geospatial indexing system
- [uber/marmaray](https://github.com/uber/marmaray) pushed_at:2022-07 star:0.5k fork:0.1k Generic Data Ingestion & Dispersal Library for Hadoop
- [uber/NullAway](https://github.com/uber/NullAway) pushed_at:2022-08 star:3.2k fork:0.2k A tool to help eliminate NullPointerExceptions (NPEs) in your Java code with low build-time overhead
- [uber/okbuck](https://github.com/uber/okbuck) pushed_at:2022-07 star:1.5k fork:0.2k OkBuck is a gradle plugin that lets developers utilize the Buck build system on a gradle project.
- [uber/phabricator-jenkins-plugin](https://github.com/uber/phabricator-jenkins-plugin) pushed_at:2022-04 star:0.4k fork:0.1k Jenkins plugin to integrate with Phabricator, Harbormaster, and Uberalls
- [uber/piranha](https://github.com/uber/piranha) pushed_at:2022-08 star:2.0k fork:0.1k A tool for refactoring code related to feature flag APIs
- [uber/RemoteShuffleService](https://github.com/uber/RemoteShuffleService) pushed_at:2022-08 star:0.2k fork:0.1k Remote shuffle service for Apache Spark to store shuffle data on remote servers. 
...
- [uber/RxCentralBle](https://github.com/uber/RxCentralBle) pushed_at:2022-02 star:0.2k fork:0.0k A reactive, interface-driven central role Bluetooth LE library for Android
...
- [uber/simple-store](https://github.com/uber/simple-store) pushed_at:2022-05 star:0.1k fork:0.0k Simple yet performant asynchronous file storage for Android
...
- [uber/uReplicator](https://github.com/uber/uReplicator) pushed_at:2022-07 star:0.8k fork:0.2k Improvement of Apache Kafka Mirrormaker
...
- [uber/cadence-web](https://github.com/uber/cadence-web) pushed_at:2022-07 star:0.3k fork:0.1k Web UI for visualizing workflows on Cadence
...
- [uber/h3-js](https://github.com/uber/h3-js) pushed_at:2022-08 star:0.6k fork:0.1k h3-js provides a JavaScript version of H3, a hexagon-based geospatial indexing system.
...
- [uber/manifold](https://github.com/uber/manifold) pushed_at:2022-07 star:1.6k fork:0.1k A model-agnostic visual debugging tool for machine learning
- [uber/react-digraph](https://github.com/uber/react-digraph) pushed_at:2022-08 star:2.3k fork:0.3k A library for creating directed graph editors
- [uber/react-global-hooks](https://github.com/uber/react-global-hooks) pushed_at:2020-09 star:0.0k fork:0.0k 
- [uber/react-vis](https://github.com/uber/react-vis) pushed_at:2022-06 star:8.3k fork:0.8k Data Visualization Components
...
- [uber/tchannel-node](https://github.com/uber/tchannel-node) pushed_at:2022-05 star:0.2k fork:0.0k 
...
- [uber/h3-py-notebooks](https://github.com/uber/h3-py-notebooks) pushed_at:2021-11 star:0.2k fork:0.1k Jupyter notebooks for h3-py, a hierarchical hexagonal geospatial indexing system

## Kotlin

- [uber/artist](https://github.com/uber/artist) pushed_at:2022-06 star:0.2k fork:0.0k An artist creates views. Artist is a Gradle plugin that codegens a base set of Android Views.
...
- [uber/motif](https://github.com/uber/motif) pushed_at:2022-07 star:0.5k fork:0.0k A simple DI API for Android / Java
- [uber/RIBs](https://github.com/uber/RIBs) pushed_at:2022-08 star:7.0k fork:0.8k Uber's cross-platform mobile architecture framework.
...
- [uber/NEAL](https://github.com/uber/NEAL) pushed_at:2022-04 star:0.4k fork:0.0k 🔎🐞 A language-agnostic linting platform 

## Objective-C

- [uber/ios-snapshot-test-case](https://github.com/uber/ios-snapshot-test-case) pushed_at:2022-06 star:1.6k fork:0.2k Snapshot view unit tests for iOS
...
- [uber/UberSignature](https://github.com/uber/UberSignature) pushed_at:2020-09 star:1.3k fork:0.2k Provides an iOS view controller allowing a user to draw their signature with their finger in a realistic style.

## Others

- [uber/.github](https://github.com/uber/.github) pushed_at:2020-03 star:0.0k fork:0.0k 
- [uber/gqlgen](https://github.com/uber/gqlgen) pushed_at:2022-07 star:0.0k fork:0.0k Uber fork:  go generate based graphql server library
- [uber/presto](https://github.com/uber/presto) pushed_at:2022-08 star:0.0k fork:0.0k Uber fork of the prestodb/presto project.  This fork is used for upstream contributions.  Please use the upstream copy for testing and production.
- [uber/RedELK](https://github.com/uber/RedELK) pushed_at:2022-07 star:0.0k fork:0.0k The Uber fork of Red Team's SIEM.  Used for upstream contributions, please use the upstream copy for testing and production.
...
- [uber/arcanist](https://github.com/uber/arcanist) pushed_at:2022-07 star:0.0k fork:0.0k Command line interface for Phabricator
...
- [uber/causalml](https://github.com/uber/causalml) pushed_at:2022-08 star:3.2k fork:0.5k Uplift modeling and causal inference with machine learning algorithms
...
- [uber/fiber](https://github.com/uber/fiber) pushed_at:2022-06 star:1.0k fork:0.1k Distributed Computing for AI Made Simple
- [uber/h3-py](https://github.com/uber/h3-py) pushed_at:2022-08 star:0.6k fork:0.1k Python bindings for H3, a hierarchical hexagonal geospatial indexing system
...
- [uber/Python-Sample-Application](https://github.com/uber/Python-Sample-Application) pushed_at:2021-09 star:0.4k fork:0.5k 
- [uber/rides-python-sdk](https://github.com/uber/rides-python-sdk) pushed_at:2021-06 star:0.2k fork:0.1k Uber Rides Python SDK (beta)
...
- [uber/tchannel-python](https://github.com/uber/tchannel-python) pushed_at:2022-05 star:0.1k fork:0.0k Python implementation of the TChannel protocol.
- [uber/uber-poet](https://github.com/uber/uber-poet) pushed_at:2022-01 star:0.1k fork:0.0k A mock swift project generator & build runner to help benchmark various module dependency graphs.

## Ruby

- [uber/client-platform-engineering](https://github.com/uber/client-platform-engineering) pushed_at:2022-06 star:0.1k fork:0.0k A collection of cookbooks, scripts and binaries used to manage our macOS, Ubuntu and Windows endpoints
- [uber/homebrew-nanoscope](https://github.com/uber/homebrew-nanoscope) pushed_at:2021-11 star:0.0k fork:0.0k 
...
- [uber/mockolo](https://github.com/uber/mockolo) pushed_at:2022-08 star:0.6k fork:0.1k Efficient Mock Generator for Swift
- [uber/needle](https://github.com/uber/needle) pushed_at:2022-07 star:1.3k fork:0.1k Compile-time safe Swift dependency injection framework
...
- [uber/SwiftCodeSan](https://github.com/uber/SwiftCodeSan) pushed_at:2022-06 star:0.2k fork:0.0k SwiftCodeSan is a tool that "sanitizes" code written in Swift.
...
- [uber/cadence-idl](https://github.com/uber/cadence-idl) pushed_at:2022-08 star:0.0k fork:0.0k Cadence IDL repo, shared by server / clients
- [uber/dosa-idl](https://github.com/uber/dosa-idl) pushed_at:2022-02 star:0.0k fork:0.0k 
- [uber/tchannel](https://github.com/uber/tchannel) pushed_at:2022-05 star:1.2k fork:0.1k network multiplexing and framing protocol for RPC
...
- [uber/Cadence-Docs](https://github.com/uber/Cadence-Docs) pushed_at:2022-08 star:0.0k fork:0.0k 
