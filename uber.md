...
- [uber/kraken](https://github.com/uber/kraken) topic:bittorrent,container,containerd,docker,docker-image,docker-registry,p2p pushed_at:2025-08 star:6.5k fork:0.5k P2P Docker registry capable of distributing TBs of data in seconds
...
- [uber/scip-lsp](https://github.com/uber/scip-lsp) topic: pushed_at:2025-08 star:0.0k fork:0.0k 
...
- [uber/RIBs](https://github.com/uber/RIBs) topic:android,architectural-patterns,architecture,mobile,mobile-app,mobile-development,mvc,mvp,mvvm,viper pushed_at:2025-08 star:7.9k fork:0.9k Uber's cross-platform mobile architecture framework - Android Repository
...
- [uber/petastorm](https://github.com/uber/petastorm) topic:deep-learning,machine-learning,parquet,parquet-files,pyarrow,pyspark,pytorch,sysml,tensorflow pushed_at:2025-08 star:1.9k fork:0.3k Petastorm library enables single machine or distributed training and evaluation of deep learning models from datasets in Apache Parquet format. It supports ML frameworks such as Tensorflow, Pytorch, and PySpark and can be used from pure Python code.
...
- [uber/needle](https://github.com/uber/needle) topic: pushed_at:2025-05 star:1.9k fork:0.2k Compile-time safe Swift dependency injection framework
- [uber/RIBs-iOS](https://github.com/uber/RIBs-iOS) topic: pushed_at:2025-08 star:0.1k fork:0.0k RIBs for iOS
...
- [uber/cosmo](https://github.com/uber/cosmo) topic: pushed_at:2025-08 star:0.0k fork:0.0k Uber FORK of wundergraph/cosmo
