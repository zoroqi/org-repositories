...
- [uber/h3](https://github.com/uber/h3) pushed_at:2021-05 star:2.7k fork:0.3k Hexagonal hierarchical geospatial indexing system
...
- [uber/cadence](https://github.com/uber/cadence) pushed_at:2021-05 star:4.9k fork:0.5k Cadence is a distributed, scalable, durable, and highly available orchestration engine to execute asynchronous long-running business logic in a scalable and resilient way.
...
- [uber/baseweb](https://github.com/uber/baseweb) pushed_at:2021-05 star:6.3k fork:0.6k A React Component library implementing the Base design language
...
- [uber/cadence-docs](https://github.com/uber/cadence-docs) pushed_at:2021-05 star:0.0k fork:0.0k 
- [uber/cadence-web](https://github.com/uber/cadence-web) pushed_at:2021-05 star:0.3k fork:0.1k Web UI for visualizing workflows on Cadence
...
- [uber/grafana-dash-gen](https://github.com/uber/grafana-dash-gen) pushed_at:2021-05 star:0.3k fork:0.1k grafana dash dash dash gen
...
- [uber/react-digraph](https://github.com/uber/react-digraph) pushed_at:2021-05 star:2.1k fork:0.2k A library for creating directed graph editors
...
- [uber/xviz](https://github.com/uber/xviz) pushed_at:2021-05 star:0.7k fork:0.2k A protocol for real-time transfer and visualization of autonomy data
...
- [uber/artist](https://github.com/uber/artist) pushed_at:2021-05 star:0.2k fork:0.0k An artist creates views. Artist is a Gradle plugin that codegens a base set of Android Views.
...
- [uber/motif](https://github.com/uber/motif) pushed_at:2021-05 star:0.5k fork:0.0k A simple DI API for Android / Java
...
- [uber/ios-snapshot-test-case](https://github.com/uber/ios-snapshot-test-case) pushed_at:2021-05 star:1.4k fork:0.2k Snapshot view unit tests for iOS
...
- [uber/arcanist](https://github.com/uber/arcanist) pushed_at:2021-05 star:0.0k fork:0.0k Command line interface for Phabricator
...
- [uber/causalml](https://github.com/uber/causalml) pushed_at:2021-05 star:1.9k fork:0.3k Uplift modeling and causal inference with machine learning algorithms
...
- [uber/fiber](https://github.com/uber/fiber) pushed_at:2021-04 star:0.9k fork:0.1k Distributed Computing for AI Made Simple
...
- [uber/orbit](https://github.com/uber/orbit) pushed_at:2021-05 star:0.4k fork:0.0k A Python package for Bayesian forecasting with object-oriented design and probabilistic models under the hood.
...
- [uber/SwiftCodeSan](https://github.com/uber/SwiftCodeSan) pushed_at:2021-05 star:0.0k fork:0.0k SwiftCodeSan is a tool that "sanitizes" code written in Swift.
...
- [uber/cadence-idl](https://github.com/uber/cadence-idl) pushed_at:2021-05 star:0.0k fork:0.0k Cadence IDL repo, shared by server / clients
...
- [uber/nebula.gl](https://github.com/uber/nebula.gl) pushed_at:2021-05 star:0.4k fork:0.1k A suite of 3D-enabled data editing overlays, suitable for deck.gl
- [uber/react-view](https://github.com/uber/react-view) pushed_at:2021-05 star:0.6k fork:0.0k React View is an interactive playground, documentation and code generator for your components.
