...
- [uber/aresdb](https://github.com/uber/aresdb) topic:analytics,cgo,cuda,data,database,golang,gpu-programming,query,real-time,storage pushed_at:2023-11 star:3.0k fork:0.2k A GPU-powered real-time analytics storage and query engine. 
...
- [uber/go-vertex-ai](https://github.com/uber/go-vertex-ai) topic: pushed_at:2023-11 star:0.0k fork:0.0k A go implementation of the Google VertexAI API
...
- [uber/h3-go](https://github.com/uber/h3-go) topic:geospatial,go,golang,h3,hexagon,spatial-indexing,uber pushed_at:2023-05 star:0.2k fork:0.1k Go bindings for H3, a hierarchical hexagonal geospatial indexing system
...
- [uber/tchannel-go](https://github.com/uber/tchannel-go) topic: pushed_at:2023-11 star:0.5k fork:0.1k Go implementation of a multiplexing and framing protocol for RPC calls
...
- [uber/zanzibar](https://github.com/uber/zanzibar) topic: pushed_at:2023-11 star:0.4k fork:0.1k A build system & configuration system to generate versioned API gateways.
...
- [uber/AutoDispose](https://github.com/uber/AutoDispose) topic:android,autodispose,kotlin,lifecycle,reactive-extensions,reactive-streams,rxandroid,rxjava,uber pushed_at:2023-11 star:3.3k fork:0.2k Automatic binding+disposal of RxJava streams.
...
- [uber/cadence-java-samples](https://github.com/uber/cadence-java-samples) topic: pushed_at:2023-11 star:0.1k fork:0.1k 
...
- [uber/NullAway](https://github.com/uber/NullAway) topic:android,java,nullability,nullability-analysis,static-analysis,static-code-analysis pushed_at:2023-11 star:3.4k fork:0.3k A tool to help eliminate NullPointerExceptions (NPEs) in your Java code with low build-time overhead
...
- [uber/piranha](https://github.com/uber/piranha) topic:ast,ast-matcher,clang-plugin,code-management,code-quality,deadcode,feature-flags,feature-toggles,java,javascript,objective-c,refactoring,refactoring-tools,stale-flags,swift,swift-syntax pushed_at:2023-11 star:2.2k fork:0.2k A tool for refactoring code related to feature flag APIs
...
- [uber/rides-android-sdk](https://github.com/uber/rides-android-sdk) topic: pushed_at:2023-11 star:0.3k fork:0.1k Uber Rides Android SDK (beta)
...
- [uber/cadence-web](https://github.com/uber/cadence-web) topic:cadence,mocha,stylus,uber,vuejs2,webpack,workflows pushed_at:2023-11 star:0.4k fork:0.1k Web UI for visualizing workflows on Cadence
...
- [uber/motif](https://github.com/uber/motif) topic: pushed_at:2023-11 star:0.5k fork:0.0k A simple DI API for Android / Java
- [uber/RIBs](https://github.com/uber/RIBs) topic:android,architectural-patterns,architecture,ios,mobile,mobile-app,mobile-development,mvc,mvp,mvvm,viper pushed_at:2023-11 star:7.6k fork:0.9k Uber's cross-platform mobile architecture framework.
...
- [uber/causalml](https://github.com/uber/causalml) topic:causal-inference,incubation,machine-learning,uplift-modeling pushed_at:2023-11 star:4.4k fork:0.7k Uplift modeling and causal inference with machine learning algorithms
...
- [uber/h3-py](https://github.com/uber/h3-py) topic:geocoding,geospatial,gis,h3,hexagonal-architecture,python,uber pushed_at:2023-11 star:0.7k fork:0.1k Python bindings for H3, a hierarchical hexagonal geospatial indexing system
...
- [uber/hermetic_cc_toolchain](https://github.com/uber/hermetic_cc_toolchain) topic: pushed_at:2023-11 star:0.2k fork:0.1k Bazel C/C++ toolchain for cross-compiling C/C++ programs
...
- [uber/cadence-idl](https://github.com/uber/cadence-idl) topic: pushed_at:2023-11 star:0.0k fork:0.0k Cadence IDL repo, shared by server / clients
...
- [uber/vscode-go](https://github.com/uber/vscode-go) topic: pushed_at:2023-11 star:0.0k fork:0.0k Go extension for Visual Studio Code, with added Bazel Support

## Vue

- [uber/Cadence-Docs](https://github.com/uber/Cadence-Docs) topic: pushed_at:2023-11 star:0.0k fork:0.1k 
