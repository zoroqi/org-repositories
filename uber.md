...
- [uber/neuropod](https://github.com/uber/neuropod) topic:deep-learning,deeplearning,incubation,inference,keras,machine-learning,machinelearning,pytorch,tensorflow pushed_at:2023-05 star:0.9k fork:0.1k A uniform interface to run deep learning models from multiple frameworks
...
- [uber/h3-go](https://github.com/uber/h3-go) topic:geospatial,go,golang,h3,hexagon,spatial-indexing,uber pushed_at:2023-05 star:0.2k fork:0.0k Go bindings for H3, a hierarchical hexagonal geospatial indexing system
...
- [uber/kubernetes](https://github.com/uber/kubernetes) topic: pushed_at:2023-05 star:0.0k fork:0.0k Uber downstream fork of Kubernetes - for contribution use only
...
- [uber/zanzibar](https://github.com/uber/zanzibar) topic: pushed_at:2023-05 star:0.4k fork:0.1k A build system & configuration system to generate versioned API gateways.
...
- [uber/NullAway](https://github.com/uber/NullAway) topic:android,java,nullability,nullability-analysis,static-analysis,static-code-analysis pushed_at:2023-05 star:3.3k fork:0.3k A tool to help eliminate NullPointerExceptions (NPEs) in your Java code with low build-time overhead
- [uber/okbuck](https://github.com/uber/okbuck) topic:android,buck,gradle,gradle-plugin,watchman pushed_at:2023-05 star:1.5k fork:0.2k OkBuck is a gradle plugin that lets developers utilize the Buck build system on a gradle project.
- [uber/piranha](https://github.com/uber/piranha) topic:ast,ast-matcher,clang-plugin,code-management,code-quality,deadcode,feature-flags,feature-toggles,java,javascript,objective-c,refactoring,refactoring-tools,stale-flags,swift,swift-syntax pushed_at:2023-05 star:2.0k fork:0.2k A tool for refactoring code related to feature flag APIs
- [uber/RemoteShuffleService](https://github.com/uber/RemoteShuffleService) topic: pushed_at:2023-05 star:0.3k fork:0.1k Remote shuffle service for Apache Spark to store shuffle data on remote servers. 
- [uber/rides-android-sdk](https://github.com/uber/rides-android-sdk) topic: pushed_at:2023-05 star:0.3k fork:0.1k Uber Rides Android SDK (beta)
- [uber/rides-java-sdk](https://github.com/uber/rides-java-sdk) topic: pushed_at:2023-05 star:0.1k fork:0.1k Uber Rides Java SDK (beta)
...
- [uber/simple-store](https://github.com/uber/simple-store) topic:incubation pushed_at:2023-05 star:0.1k fork:0.0k Simple yet performant asynchronous file storage for Android
...
- [uber/bufrw](https://github.com/uber/bufrw) topic: pushed_at:2023-05 star:0.0k fork:0.0k Buffer Reading and Writing
...
- [uber/cadence-web](https://github.com/uber/cadence-web) topic:cadence,mocha,stylus,uber,vuejs2,webpack,workflows pushed_at:2023-05 star:0.3k fork:0.1k Web UI for visualizing workflows on Cadence
...
- [uber/grafana-dash-gen](https://github.com/uber/grafana-dash-gen) topic: pushed_at:2023-05 star:0.4k fork:0.1k grafana dash dash dash gen
...
- [uber/h3-js](https://github.com/uber/h3-js) topic:emscripten,geospatial,h3,hexagon,javascript,spatial-indexing,uber pushed_at:2023-05 star:0.7k fork:0.1k h3-js provides a JavaScript version of H3, a hexagon-based geospatial indexing system.
...
- [uber/react-digraph](https://github.com/uber/react-digraph) topic: pushed_at:2023-05 star:2.5k fork:0.3k A library for creating directed graph editors
...
- [uber/RIBs](https://github.com/uber/RIBs) topic:android,architectural-patterns,architecture,ios,mobile,mobile-app,mobile-development,mvc,mvp,mvvm,viper pushed_at:2023-05 star:7.4k fork:0.9k Uber's cross-platform mobile architecture framework.
...
- [uber/kubernetes-test-infra](https://github.com/uber/kubernetes-test-infra) topic: pushed_at:2023-02 star:0.0k fork:0.0k Uber fork of kubernetes-test-infra - for contribution use only
...
- [uber/mock](https://github.com/uber/mock) topic: pushed_at:2023-04 star:0.0k fork:0.0k GoMock is a mocking framework for the Go programming language.
...
- [uber/causalml](https://github.com/uber/causalml) topic:causal-inference,incubation,machine-learning,uplift-modeling pushed_at:2023-05 star:4.0k fork:0.6k Uplift modeling and causal inference with machine learning algorithms
...
- [uber/h3-py](https://github.com/uber/h3-py) topic:geocoding,geospatial,gis,h3,hexagonal-architecture,python,uber pushed_at:2023-05 star:0.6k fork:0.1k Python bindings for H3, a hierarchical hexagonal geospatial indexing system
...
- [uber/hermetic_cc_toolchain](https://github.com/uber/hermetic_cc_toolchain) topic: pushed_at:2023-05 star:0.1k fork:0.0k Bazel C/C++ toolchain for cross-compiling C/C++ programs
...
- [uber/mockolo](https://github.com/uber/mockolo) topic:commandline,efficient,fast,generates-mocks,mock,mockgen,mockgenerator,mocking,mocking-framework,mocking-library,mocking-utility,mocks,performant,protocols,scale,scaleable,subclassing,swift,swiftsyntax,xcode pushed_at:2023-05 star:0.7k fork:0.1k Efficient Mock Generator for Swift
- [uber/needle](https://github.com/uber/needle) topic: pushed_at:2023-04 star:1.6k fork:0.1k Compile-time safe Swift dependency injection framework
- [uber/rides-ios-sdk](https://github.com/uber/rides-ios-sdk) topic: pushed_at:2023-05 star:0.4k fork:0.1k Uber Rides iOS SDK (beta)
...
- [uber/cadence-idl](https://github.com/uber/cadence-idl) topic: pushed_at:2023-05 star:0.0k fork:0.0k Cadence IDL repo, shared by server / clients
...
- [uber/base-design-docs](https://github.com/uber/base-design-docs) topic:design-system,documentation pushed_at:2023-05 star:0.0k fork:0.0k A documentation site for the Base design system.
