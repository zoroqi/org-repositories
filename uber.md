...
- [uber/libphutil](https://github.com/uber/libphutil) topic: pushed_at:2026-05 star:0.0k fork:0.0k A collection of PHP utility classes
...
- [uber/h3-go](https://github.com/uber/h3-go) topic:geospatial,go,golang,h3,hexagon,spatial-indexing,uber pushed_at:2026-05 star:0.4k fork:0.1k Go bindings for H3, a hierarchical hexagonal geospatial indexing system
...
- [uber/NullAway](https://github.com/uber/NullAway) topic:android,java,nullability,nullability-analysis,static-analysis,static-code-analysis pushed_at:2026-05 star:4.1k fork:0.3k A tool to help eliminate NullPointerExceptions (NPEs) in your Java code with low build-time overhead
...
- [uber/uGroup](https://github.com/uber/uGroup) topic: pushed_at:2026-05 star:0.0k fork:0.0k  uGroup is a Kafka consumer lag monitoring service that reads the consumer offset topic to calculate and expose real-time lag metrics via Prometheus and REST API.
...
- [uber/h3-js](https://github.com/uber/h3-js) topic:emscripten,geospatial,h3,hexagon,javascript,spatial-indexing,uber pushed_at:2026-05 star:1.1k fork:0.1k h3-js provides a JavaScript version of H3, a hexagon-based geospatial indexing system.
...
- [uber/motif](https://github.com/uber/motif) topic: pushed_at:2026-05 star:0.5k fork:0.0k A simple DI API for Android / Java
...
- [uber/ADR](https://github.com/uber/ADR) topic: pushed_at:2026-05 star:0.0k fork:0.0k 
...
- [uber/causalml](https://github.com/uber/causalml) topic:causal-inference,incubation,machine-learning,uplift-modeling pushed_at:2026-05 star:5.9k fork:0.9k Uplift modeling and causal inference with machine learning algorithms
...
- [uber/h3-py](https://github.com/uber/h3-py) topic:geocoding,geospatial,gis,h3,hexagonal-architecture,python,uber pushed_at:2026-05 star:1.0k fork:0.1k Python bindings for H3, a hierarchical hexagonal geospatial indexing system
...
- [uber/RIBs-iOS](https://github.com/uber/RIBs-iOS) topic: pushed_at:2026-05 star:0.2k fork:0.0k RIBs for iOS
...
- [uber/baseweb](https://github.com/uber/baseweb) topic:component-library,design-systems,react,react-components pushed_at:2026-05 star:9.0k fork:0.9k A React Component library implementing the Base design language
