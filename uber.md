...
- [uber/h3](https://github.com/uber/h3) topic:geospatial,h3,hexagon,spatial-indexing,uber pushed_at:2024-01 star:4.5k fork:0.4k Hexagonal hierarchical geospatial indexing system
...
- [uber/h3-go](https://github.com/uber/h3-go) topic:geospatial,go,golang,h3,hexagon,spatial-indexing,uber pushed_at:2024-01 star:0.3k fork:0.1k Go bindings for H3, a hierarchical hexagonal geospatial indexing system
- [uber/kraken](https://github.com/uber/kraken) topic:bittorrent,container,docker,docker-image,docker-registry,p2p pushed_at:2024-01 star:5.8k fork:0.4k P2P Docker registry capable of distributing TBs of data in seconds
...
- [uber/tchannel-go](https://github.com/uber/tchannel-go) topic: pushed_at:2024-01 star:0.5k fork:0.1k Go implementation of a multiplexing and framing protocol for RPC calls
...
- [uber/zanzibar](https://github.com/uber/zanzibar) topic: pushed_at:2024-01 star:0.4k fork:0.1k A build system & configuration system to generate versioned API gateways.
...
- [uber/AutoDispose](https://github.com/uber/AutoDispose) topic:android,autodispose,kotlin,lifecycle,reactive-extensions,reactive-streams,rxandroid,rxjava,uber pushed_at:2024-01 star:3.3k fork:0.2k Automatic binding+disposal of RxJava streams.
- [uber/cadence-java-client](https://github.com/uber/cadence-java-client) topic:aws-swf,cadence,cadence-client,task-management,task-management-system,task-queue,task-scheduler,uber,workflow-engine,workflow-management-system,workflow-scheduler pushed_at:2024-02 star:0.1k fork:0.1k Java framework for Cadence Workflow Service
- [uber/cadence-java-samples](https://github.com/uber/cadence-java-samples) topic: pushed_at:2024-01 star:0.1k fork:0.1k 
...
- [uber/NullAway](https://github.com/uber/NullAway) topic:android,java,nullability,nullability-analysis,static-analysis,static-code-analysis pushed_at:2024-02 star:3.5k fork:0.3k A tool to help eliminate NullPointerExceptions (NPEs) in your Java code with low build-time overhead
...
- [uber/piranha](https://github.com/uber/piranha) topic:ast,ast-matcher,clang-plugin,code-management,code-quality,deadcode,feature-flags,feature-toggles,java,javascript,objective-c,refactoring,refactoring-tools,stale-flags,swift,swift-syntax pushed_at:2024-01 star:2.2k fork:0.2k A tool for refactoring code related to feature flag APIs
...
- [uber/cadence-web](https://github.com/uber/cadence-web) topic:cadence,mocha,stylus,uber,vuejs2,webpack,workflows pushed_at:2024-01 star:0.4k fork:0.1k Web UI for visualizing workflows on Cadence
...
- [uber/RIBs](https://github.com/uber/RIBs) topic:android,architectural-patterns,architecture,ios,mobile,mobile-app,mobile-development,mvc,mvp,mvvm,viper pushed_at:2024-01 star:7.6k fork:0.9k Uber's cross-platform mobile architecture framework.
...
- [uber/ios-snapshot-test-case](https://github.com/uber/ios-snapshot-test-case) topic: pushed_at:2024-01 star:1.7k fork:0.2k Snapshot view unit tests for iOS
...
- [uber/causalml](https://github.com/uber/causalml) topic:causal-inference,incubation,machine-learning,uplift-modeling pushed_at:2024-01 star:4.6k fork:0.8k Uplift modeling and causal inference with machine learning algorithms
...
- [uber/h3-py](https://github.com/uber/h3-py) topic:geocoding,geospatial,gis,h3,hexagonal-architecture,python,uber pushed_at:2024-01 star:0.7k fork:0.1k Python bindings for H3, a hierarchical hexagonal geospatial indexing system
...
- [uber/gluten-fork](https://github.com/uber/gluten-fork) topic: pushed_at:2024-01 star:0.0k fork:0.0k Uber Fork of the Gluten Project (Plugin to Double SparkSQL's Performance)
...
- [uber/hermetic_cc_toolchain](https://github.com/uber/hermetic_cc_toolchain) topic: pushed_at:2024-01 star:0.2k fork:0.1k Bazel C/C++ toolchain for cross-compiling C/C++ programs
...
- [uber/cadence-idl](https://github.com/uber/cadence-idl) topic: pushed_at:2024-01 star:0.0k fork:0.0k Cadence IDL repo, shared by server / clients
...
- [uber/baseweb](https://github.com/uber/baseweb) topic:component-library,design-systems,react,react-components pushed_at:2024-01 star:8.6k fork:0.8k A React Component library implementing the Base design language
- [uber/nebula.gl](https://github.com/uber/nebula.gl) topic:deck-gl,uber,webgl pushed_at:2024-01 star:0.6k fork:0.2k A suite of 3D-enabled data editing overlays, suitable for deck.gl
- [uber/react-view](https://github.com/uber/react-view) topic:code-generator,documentation,playground,react pushed_at:2024-01 star:0.7k fork:0.0k React View is an interactive playground, documentation and code generator for your components.
...
- [uber/Cadence-Docs](https://github.com/uber/Cadence-Docs) topic: pushed_at:2024-01 star:0.0k fork:0.1k 
