...
- [uber/h3](https://github.com/uber/h3) topic:geospatial,h3,hexagon,spatial-indexing,uber pushed_at:2026-05 star:6.3k fork:0.6k Hexagonal hierarchical geospatial indexing system
...
- [uber/libphutil](https://github.com/uber/libphutil) topic: pushed_at:2025-09 star:0.0k fork:0.0k A collection of PHP utility classes
...
- [uber/go-vertex-ai](https://github.com/uber/go-vertex-ai) topic: pushed_at:2025-07 star:0.0k fork:0.0k A go implementation of the Google VertexAI API
...
- [uber/h3-go](https://github.com/uber/h3-go) topic:geospatial,go,golang,h3,hexagon,spatial-indexing,uber pushed_at:2026-04 star:0.4k fork:0.1k Go bindings for H3, a hierarchical hexagonal geospatial indexing system
- [uber/kraken](https://github.com/uber/kraken) topic:bittorrent,container,containerd,docker,docker-image,docker-registry,p2p pushed_at:2026-05 star:6.7k fork:0.5k P2P Docker registry capable of distributing TBs of data in seconds
...
- [uber/scip-lsp](https://github.com/uber/scip-lsp) topic: pushed_at:2026-05 star:0.0k fork:0.0k 
...
- [uber/uber-direct-sdk](https://github.com/uber/uber-direct-sdk) topic: pushed_at:2025-11 star:0.0k fork:0.0k An Uber supported SDK for the Uber Direct API.
...
- [uber/AutoDispose](https://github.com/uber/AutoDispose) topic:android,autodispose,kotlin,lifecycle,reactive-extensions,reactive-streams,rxandroid,rxjava,uber pushed_at:2026-05 star:3.4k fork:0.2k Automatic binding+disposal of RxJava streams.
...
- [uber/h3-java](https://github.com/uber/h3-java) topic:geospatial,h3,hexagon,java,spatial-indexing,uber pushed_at:2026-02 star:0.3k fork:0.1k Java bindings for H3, a hierarchical hexagonal geospatial indexing system
...
- [uber/NullAway](https://github.com/uber/NullAway) topic:android,java,nullability,nullability-analysis,static-analysis,static-code-analysis pushed_at:2026-05 star:4.0k fork:0.3k A tool to help eliminate NullPointerExceptions (NPEs) in your Java code with low build-time overhead
- [uber/okbuck](https://github.com/uber/okbuck) topic:android,buck,gradle,gradle-plugin,watchman pushed_at:2026-03 star:1.5k fork:0.2k OkBuck is a gradle plugin that lets developers utilize the Buck build system on a gradle project.
...
- [uber/rides-android-sdk](https://github.com/uber/rides-android-sdk) topic: pushed_at:2026-05 star:0.3k fork:0.1k Uber Rides Android SDK (beta)
...
- [uber/simple-store](https://github.com/uber/simple-store) topic:incubation pushed_at:2025-07 star:0.1k fork:0.0k Simple yet performant asynchronous file storage for Android
...
- [uber/geojson2h3](https://github.com/uber/geojson2h3) topic:geojson,geospatial,h3,hexagon,javascript pushed_at:2026-04 star:0.2k fork:0.0k Conversion utilities between H3 indexes and GeoJSON
...
- [uber/h3-js](https://github.com/uber/h3-js) topic:emscripten,geospatial,h3,hexagon,javascript,spatial-indexing,uber pushed_at:2026-04 star:1.1k fork:0.1k h3-js provides a JavaScript version of H3, a hexagon-based geospatial indexing system.
...
- [uber/manifold](https://github.com/uber/manifold) topic:incubation,machine-learning,visualization pushed_at:2025-02 star:1.7k fork:0.1k A model-agnostic visual debugging tool for machine learning
...
- [uber/react-vis](https://github.com/uber/react-vis) topic:chart,charting-library,data-visualization,react,uber,visualization pushed_at:2024-12 star:8.8k fork:0.8k Data Visualization Components
...
- [uber/uber-direct-sdk-samples](https://github.com/uber/uber-direct-sdk-samples) topic: pushed_at:2025-03 star:0.0k fork:0.0k Sample code using the Uber Direct SDK
...
- [uber/uber-pay-reference-app](https://github.com/uber/uber-pay-reference-app) topic:api,example,money,sandbox,uber pushed_at:2026-05 star:0.0k fork:0.0k Uber Pay reference integration
...
- [uber/motif](https://github.com/uber/motif) topic: pushed_at:2025-10 star:0.5k fork:0.0k A simple DI API for Android / Java
...
- [uber/go.uber.org](https://github.com/uber/go.uber.org) topic: pushed_at:2025-11 star:0.0k fork:0.0k Golang https://go.uber.org custom import path
...
- [uber/ios-snapshot-test-case](https://github.com/uber/ios-snapshot-test-case) topic: pushed_at:2025-12 star:1.9k fork:0.2k Snapshot view unit tests for iOS
- [uber/signals-ios](https://github.com/uber/signals-ios) topic: pushed_at:2019-01 star:0.5k fork:0.0k Typeful eventing
...
- [uber/.github](https://github.com/uber/.github) topic: pushed_at:2026-01 star:0.0k fork:0.0k 
- [uber/ADR](https://github.com/uber/ADR) topic: pushed_at:2026-04 star:0.0k fork:0.0k 
...
- [uber/kotlin](https://github.com/uber/kotlin) topic: pushed_at:2026-05 star:0.0k fork:0.0k Uber fork of Kotlin (only used for patching critical bug fixes) - no new development
...
- [uber/lightdash](https://github.com/uber/lightdash) topic: pushed_at:2026-05 star:0.0k fork:0.0k Uber Fork of Lightdash - for contribution purposes
...
- [uber/Moirai-SOSP25-logs](https://github.com/uber/Moirai-SOSP25-logs) topic: pushed_at:2025-10 star:0.0k fork:0.0k 
...
- [uber/arcanist](https://github.com/uber/arcanist) topic: pushed_at:2026-02 star:0.0k fork:0.0k Command line interface for Phabricator
...
- [uber/causalml](https://github.com/uber/causalml) topic:causal-inference,incubation,machine-learning,uplift-modeling pushed_at:2026-05 star:5.8k fork:0.9k Uplift modeling and causal inference with machine learning algorithms
...
- [uber/h3-py](https://github.com/uber/h3-py) topic:geocoding,geospatial,gis,h3,hexagonal-architecture,python,uber pushed_at:2026-04 star:1.0k fork:0.1k Python bindings for H3, a hierarchical hexagonal geospatial indexing system
...
- [uber/orbit](https://github.com/uber/orbit) topic:arima,bayesian,bayesian-methods,bayesian-statistics,changepoint,exponential-smoothing,forecast,forecasting,machine-learning,orbit,probabilistic,probabilistic-programming,pyro,pystan,python,pytorch,regression,regression-models,stan,time-series pushed_at:2026-05 star:2.1k fork:0.1k A Python package for Bayesian forecasting with object-oriented design and probabilistic models under the hood.
- [uber/petastorm](https://github.com/uber/petastorm) topic:deep-learning,machine-learning,parquet,parquet-files,pyarrow,pyspark,pytorch,sysml,tensorflow pushed_at:2026-01 star:1.9k fork:0.3k Petastorm library enables single machine or distributed training and evaluation of deep learning models from datasets in Apache Parquet format. It supports ML frameworks such as Tensorflow, Pytorch, and PySpark and can be used from pure Python code.
...
- [uber/RedELK](https://github.com/uber/RedELK) topic: pushed_at:2025-03 star:0.0k fork:0.0k The Uber fork of Red Team's SIEM.  Used for upstream contributions, please use the upstream copy for testing and production.
...
- [uber/client-platform-engineering](https://github.com/uber/client-platform-engineering) topic:chef,chef-cookbook pushed_at:2024-12 star:0.1k fork:0.0k A collection of cookbooks, scripts and binaries used to manage our macOS, Ubuntu and Windows endpoints
...
- [uber/RIBs-iOS](https://github.com/uber/RIBs-iOS) topic: pushed_at:2026-04 star:0.2k fork:0.0k RIBs for iOS
...
- [uber/uber-ios-sdk](https://github.com/uber/uber-ios-sdk) topic: pushed_at:2026-05 star:0.4k fork:0.1k Uber iOS SDK (beta)
...
- [uber/baseweb](https://github.com/uber/baseweb) topic:component-library,design-systems,react,react-components pushed_at:2026-04 star:9.0k fork:0.9k A React Component library implementing the Base design language
...
- [uber/vscode-bazel-bsp](https://github.com/uber/vscode-bazel-bsp) topic:bazel,build-server-protocol,testing-tools,vscode-extension pushed_at:2026-04 star:0.0k fork:0.0k VS Code extension to provide integration with Bazel BSP, leveraging Build Server Protocol.  Currently focused on VS Code test explorer integration.
