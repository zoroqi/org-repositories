...
- [twitter/ios-twitter-image-pipeline](https://github.com/twitter/ios-twitter-image-pipeline) topic:cache,image-pipeline,ios,objective-c,swift,twitter pushed_at:2024-01 star:1.8k fork:0.1k Twitter Image Pipeline is a robust and performant image loading and caching framework for iOS clients
...
- [twitter/twemcache](https://github.com/twitter/twemcache) topic: pushed_at:2021-11 star:0.9k fork:0.1k Twemcache is the Twitter Memcached
...
- [twitter/vireo](https://github.com/twitter/vireo) topic: pushed_at:2021-10 star:1.0k fork:0.1k Vireo is a lightweight and versatile video processing library written in C++11
...
- [twitter/twemoji](https://github.com/twitter/twemoji) topic:emoji,twemoji pushed_at:2026-07 star:17.7k fork:1.9k Emoji for everyone. https://twemoji.twitter.com/
...
- [twitter/typeahead.js](https://github.com/twitter/typeahead.js) topic: pushed_at:2023-04 star:16.5k fork:3.1k typeahead.js is a fast and fully-featured autocomplete library
...
- [twitter/communitynotes](https://github.com/twitter/communitynotes) topic:crowdsourcing,twitter pushed_at:2026-07 star:1.9k fork:0.3k Documentation and source code powering Twitter's Community Notes
...
- [twitter/twitter-cldr-rb](https://github.com/twitter/twitter-cldr-rb) topic: pushed_at:2025-12 star:0.7k fork:0.1k Ruby implementation of the ICU (International Components for Unicode) that uses the Common Locale Data Repository to format dates, plurals, and more.
...
- [twitter/opensource-website](https://github.com/twitter/opensource-website) topic:ospo pushed_at:2026-04 star:3.3k fork:0.8k Twitter's open source website, identifying projects we've released, organizations we support, and the work we do to support open source.

## Scala

- [twitter/algebird](https://github.com/twitter/algebird) topic: pushed_at:2025-11 star:2.3k fork:0.3k Abstract Algebra for Scala
- [twitter/bazel-multiversion](https://github.com/twitter/bazel-multiversion) topic:bazel,bazel-build,bazel-rules,coursier,dependency-manager,java,jvm,kotlin,scala pushed_at:2023-06 star:0.1k fork:0.0k Bazel rules to resolve, fetch and manage 3rdparty JVM dependencies with support for multiple parallel versions of the same dependency. Powered by Coursier. 
...
- [twitter/finagle](https://github.com/twitter/finagle) topic:distributed-systems,finagle,http,http2,java,memcached,mysql,redis,rpc,scala,thrift,zipkin pushed_at:2026-04 star:8.9k fork:1.4k A fault tolerant, protocol-agnostic RPC system
...
- [twitter/the-algorithm](https://github.com/twitter/the-algorithm) topic: pushed_at:2025-09 star:73.6k fork:13.3k Source code for the X Recommendation Algorithm
...
- [twitter/twitter-server](https://github.com/twitter/twitter-server) topic:finagle,finatra pushed_at:2026-02 star:1.6k fork:0.3k Twitter-Server defines a template from which services at Twitter are built
- [twitter/util](https://github.com/twitter/util) topic:finagle,scala,utility pushed_at:2025-12 star:2.7k fork:0.6k Wonderful reusable code from Twitter
...
- [twitter/x-ads-conversion-api-gtm-template](https://github.com/twitter/x-ads-conversion-api-gtm-template) topic: pushed_at:2026-06 star:0.0k fork:0.0k 
