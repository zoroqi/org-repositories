...
- [twitter/communitynotes](https://github.com/twitter/communitynotes) topic:crowdsourcing,twitter pushed_at:2025-07 star:1.7k fork:0.3k Documentation and source code powering Twitter's Community Notes
...
- [twitter/opensource-website](https://github.com/twitter/opensource-website) topic:ospo pushed_at:2025-07 star:3.1k fork:0.8k Twitter's open source website, identifying projects we've released, organizations we support, and the work we do to support open source.
...
- [twitter/finagle](https://github.com/twitter/finagle) topic:distributed-systems,finagle,http,http2,java,memcached,mysql,redis,rpc,scala,thrift,zipkin pushed_at:2025-06 star:8.8k fork:1.4k A fault tolerant, protocol-agnostic RPC system
- [twitter/finatra](https://github.com/twitter/finatra) topic:finagle,framework,guice,http,microservices,scala,slf4j,testing,thrift,twitter-server pushed_at:2025-04 star:2.3k fork:0.4k Fast, testable, Scala services built on TwitterServer and Finagle
...
- [twitter/the-algorithm](https://github.com/twitter/the-algorithm) topic: pushed_at:2024-07 star:63.4k fork:12.2k Source code for Twitter's Recommendation Algorithm
...
- [twitter/util](https://github.com/twitter/util) topic:finagle,scala,utility pushed_at:2025-07 star:2.7k fork:0.6k Wonderful reusable code from Twitter
