...
- [twitter/pelikan](https://github.com/twitter/pelikan) topic: pushed_at:2022-12 star:1.8k fork:0.2k Pelikan is Twitter's unified cache backend
...
- [twitter/twemproxy](https://github.com/twitter/twemproxy) topic: pushed_at:2022-12 star:11.7k fork:2.0k A fast, light-weight proxy for memcached and redis
...
- [twitter/birdwatch](https://github.com/twitter/birdwatch) topic: pushed_at:2022-12 star:0.1k fork:0.0k 
...
- [twitter/twemoji](https://github.com/twitter/twemoji) topic:emoji,twemoji pushed_at:2022-12 star:15.0k fork:1.7k Emoji for everyone. https://twemoji.twitter.com/
- [twitter/twitter-text](https://github.com/twitter/twitter-text) topic:emoji,java,nodejs,objective-c,ruby,tweet,twitter,twitter-text,unicode pushed_at:2022-12 star:2.9k fork:0.5k Twitter Text Libraries. This code is used at Twitter to tokenize and parse text to meet the expectations for what can be used on the platform.
- [twitter/twitter.github.io](https://github.com/twitter/twitter.github.io) topic: pushed_at:2021-10 star:0.1k fork:0.0k 

## Java

- [twitter/cloudhopper-commons](https://github.com/twitter/cloudhopper-commons) topic: pushed_at:2022-11 star:0.0k fork:0.1k Cloudhopper Commons
- [twitter/elephant-bird](https://github.com/twitter/elephant-bird) topic: pushed_at:2022-10 star:1.1k fork:0.4k Twitter's collection of LZO and Protocol Buffer-related Hadoop, Pig, Hive, and HBase code.
...
- [twitter/twitter-cldr-js](https://github.com/twitter/twitter-cldr-js) topic: pushed_at:2022-12 star:0.3k fork:0.1k JavaScript implementation of the ICU (International Components for Unicode) that uses the Common Locale Data Repository to format dates, plurals, and more.  Based on twitter-cldr-rb.
- [twitter/twitter-cldr-npm](https://github.com/twitter/twitter-cldr-npm) topic: pushed_at:2022-12 star:0.0k fork:0.0k TwitterCldr npm package
- [twitter/typeahead.js](https://github.com/twitter/typeahead.js) topic: pushed_at:2022-12 star:16.5k fork:3.3k typeahead.js is a fast and fully-featured autocomplete library

## Kotlin

- [twitter/compose-rules](https://github.com/twitter/compose-rules) topic:android,jetpack-compose,ktlint,static-code-analysis pushed_at:2022-11 star:1.1k fork:0.0k Static checks to aid with a healthy adoption of Compose
...
- [twitter/metrics](https://github.com/twitter/metrics) topic: pushed_at:2022-12 star:0.0k fork:0.0k 
...
- [twitter/communitynotes](https://github.com/twitter/communitynotes) topic: pushed_at:2022-12 star:0.4k fork:0.0k 
...
- [twitter/pants](https://github.com/twitter/pants) topic: pushed_at:2022-12 star:0.1k fork:0.0k Pants Build System
...
- [twitter/focus](https://github.com/twitter/focus) topic:bazel,git,source-control,sparse-checkout pushed_at:2022-11 star:0.1k fork:0.0k Focus aligns Git worktree content based on outlines of a repository's Bazel build graph. Focused repos are sparse, shallow, and thin and unlock markedly better performance in large repos.
- [twitter/rezolus](https://github.com/twitter/rezolus) topic: pushed_at:2022-11 star:1.2k fork:0.1k Systems performance telemetry
...
- [twitter/opensource-website](https://github.com/twitter/opensource-website) topic:ospo pushed_at:2022-12 star:2.0k fork:0.6k Twitter's open source website, identifying projects we've released, organizations we support, and the work we do to support open source.

## Scala

- [twitter/algebird](https://github.com/twitter/algebird) topic: pushed_at:2022-12 star:2.2k fork:0.3k Abstract Algebra for Scala
...
- [twitter/bijection](https://github.com/twitter/bijection) topic: pushed_at:2022-12 star:0.6k fork:0.1k Reversible conversions between types
...
- [twitter/chill](https://github.com/twitter/chill) topic: pushed_at:2022-12 star:0.6k fork:0.1k Scala extensions for the Kryo serialization library
- [twitter/finagle](https://github.com/twitter/finagle) topic:distributed-systems,finagle,http,http2,java,memcached,mysql,redis,rpc,scala,thrift,zipkin pushed_at:2022-12 star:8.5k fork:1.4k A fault tolerant, protocol-agnostic RPC system
- [twitter/finatra](https://github.com/twitter/finatra) topic:finagle,framework,guice,http,microservices,scala,slf4j,testing,thrift,twitter-server pushed_at:2022-12 star:2.2k fork:0.4k Fast, testable, Scala services built on TwitterServer and Finagle
...
- [twitter/scrooge](https://github.com/twitter/scrooge) topic:android,cocoa,code-generation,finagle,java,lua,scala,thrift pushed_at:2022-12 star:0.8k fork:0.2k A Thrift parser/generator
...
- [twitter/twemoji-parser](https://github.com/twitter/twemoji-parser) topic: pushed_at:2022-12 star:0.1k fork:0.0k A simple library for identifying emoji entities within a string in order to render them as Twemoji.
...
- [twitter/twitter-server](https://github.com/twitter/twitter-server) topic:finagle,finatra pushed_at:2022-12 star:1.4k fork:0.2k Twitter-Server defines a template from which services at Twitter are built
- [twitter/util](https://github.com/twitter/util) topic:finagle,scala,utility pushed_at:2022-12 star:2.6k fork:0.6k Wonderful reusable code from Twitter
...
- [twitter/TwitterTextEditor](https://github.com/twitter/TwitterTextEditor) topic:ios,swift,textkit,uikit pushed_at:2022-07 star:2.8k fork:0.1k A standalone, flexible API that provides a full-featured rich text editor for iOS applications.
...
- [twitter/sqrl](https://github.com/twitter/sqrl) topic: pushed_at:2022-11 star:0.1k fork:0.0k A Safe, Stateful Rules Language for Event Streams
