...
- [twitter/finagle](https://github.com/twitter/finagle) topic:distributed-systems,finagle,http,http2,java,memcached,mysql,redis,rpc,scala,thrift,zipkin pushed_at:2024-12 star:8.8k fork:1.4k A fault tolerant, protocol-agnostic RPC system
...
- [twitter/the-algorithm](https://github.com/twitter/the-algorithm) topic: pushed_at:2024-07 star:62.7k fork:12.2k Source code for Twitter's Recommendation Algorithm
