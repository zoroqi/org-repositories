...
- [twitter/twemproxy](https://github.com/twitter/twemproxy) topic: pushed_at:2023-01 star:11.8k fork:2.0k A fast, light-weight proxy for memcached and redis
...
- [twitter/go-bindata](https://github.com/twitter/go-bindata) topic: pushed_at:2023-03 star:0.1k fork:0.0k 
...
- [twitter/scala_school](https://github.com/twitter/scala_school) topic: pushed_at:2022-11 star:3.7k fork:1.2k Lessons in the Fundamentals of Scala
- [twitter/twemoji](https://github.com/twitter/twemoji) topic:emoji,twemoji pushed_at:2023-04 star:15.8k fork:1.9k Emoji for everyone. https://twemoji.twitter.com/
...
- [twitter/GraphJet](https://github.com/twitter/GraphJet) topic: pushed_at:2023-03 star:0.6k fork:0.1k GraphJet is a real-time graph processing library.
...
- [twitter/nodes](https://github.com/twitter/nodes) topic: pushed_at:2023-02 star:0.2k fork:0.0k  A library to implement asynchronous dependency graphs for services in Java
- [twitter/sbf](https://github.com/twitter/sbf) topic: pushed_at:2023-02 star:0.1k fork:0.0k 
- [twitter/Serial](https://github.com/twitter/Serial) topic: pushed_at:2023-04 star:0.9k fork:0.1k Light-weight, fast framework for object serialization in Java, with Android support.
...
- [twitter/labella.js](https://github.com/twitter/labella.js) topic: pushed_at:2022-03 star:3.8k fork:0.2k Placing labels on a timeline without overlap.
- [twitter/SentenTree](https://github.com/twitter/SentenTree) topic: pushed_at:2023-02 star:0.2k fork:0.1k A novel text visualization technique
...
- [twitter/compose-rules](https://github.com/twitter/compose-rules) topic:android,jetpack-compose,ktlint,static-code-analysis pushed_at:2023-01 star:1.2k fork:0.1k Static checks to aid with a healthy adoption of Compose
...
- [twitter/the-algorithm-ml](https://github.com/twitter/the-algorithm-ml) topic: pushed_at:2023-04 star:8.2k fork:2.0k Source code for Twitter's Recommendation Algorithm
- [twitter/zktraffic](https://github.com/twitter/zktraffic) topic: pushed_at:2020-07 star:0.2k fork:0.1k ZooKeeper protocol analyzer and stats gathering daemon
...
- [twitter/opensource-website](https://github.com/twitter/opensource-website) topic:ospo pushed_at:2023-04 star:2.4k fork:0.7k Twitter's open source website, identifying projects we've released, organizations we support, and the work we do to support open source.
...
- [twitter/chill](https://github.com/twitter/chill) topic: pushed_at:2023-03 star:0.6k fork:0.1k Scala extensions for the Kryo serialization library
...
- [twitter/iago2](https://github.com/twitter/iago2) topic: pushed_at:2023-02 star:0.0k fork:0.0k A load generator, built for engineers
...
- [twitter/scrooge](https://github.com/twitter/scrooge) topic:android,cocoa,code-generation,finagle,java,lua,scala,thrift pushed_at:2023-02 star:0.8k fork:0.3k A Thrift parser/generator
...
- [twitter/the-algorithm](https://github.com/twitter/the-algorithm) topic: pushed_at:2023-04 star:51.5k fork:10.6k Source code for Twitter's Recommendation Algorithm
...
- [twitter/twemoji-parser](https://github.com/twitter/twemoji-parser) topic: pushed_at:2023-02 star:0.1k fork:0.1k A simple library for identifying emoji entities within a string in order to render them as Twemoji.
...
- [twitter/twitter-server](https://github.com/twitter/twitter-server) topic:finagle,finatra pushed_at:2023-01 star:1.4k fork:0.3k Twitter-Server defines a template from which services at Twitter are built
...
- [twitter/dodo](https://github.com/twitter/dodo) topic:finagle,finatra,ostrich,sbt,scrooge,twitter-oss,twitter-server,util pushed_at:2022-12 star:0.0k fork:0.0k The Twitter OSS Project Builder
- [twitter/hadoop-lzo](https://github.com/twitter/hadoop-lzo) topic: pushed_at:2023-02 star:0.5k fork:0.3k Refactored version of code.google.com/hadoop-gpl-compression for hadoop 0.20
...
- [twitter/TwitterTextEditor](https://github.com/twitter/TwitterTextEditor) topic:ios,swift,textkit,uikit pushed_at:2023-03 star:2.9k fork:0.1k A standalone, flexible API that provides a full-featured rich text editor for iOS applications.

## TypeScript

- [twitter/dodo-build](https://github.com/twitter/dodo-build) topic: pushed_at:2023-02 star:0.0k fork:0.0k A Github Action for running Dodo: The Twitter OSS Project Builder
- [twitter/sqrl](https://github.com/twitter/sqrl) topic: pushed_at:2023-02 star:0.1k fork:0.0k A Safe, Stateful Rules Language for Event Streams

## Vue

- [twitter/check-my-repo](https://github.com/twitter/check-my-repo) topic: pushed_at:2023-02 star:0.0k fork:0.0k Automatically check repositories health and quality and build reports that help us understand the current state of Sauce Labs repositories
