...
- [twitter/ios-twitter-image-pipeline](https://github.com/twitter/ios-twitter-image-pipeline) topic:cache,image-pipeline,ios,objective-c,swift,twitter pushed_at:2023-04 star:1.8k fork:0.1k Twitter Image Pipeline is a robust and performant image loading and caching framework for iOS clients
...
- [twitter/twemproxy](https://github.com/twitter/twemproxy) topic: pushed_at:2023-01 star:11.8k fork:2.1k A fast, light-weight proxy for memcached and redis
...
- [twitter/scoot](https://github.com/twitter/scoot) topic: pushed_at:2023-04 star:0.3k fork:0.0k Scoot is a distributed task runner, supporting both a proprietary API and Bazel's Remote Execution.
...
- [twitter/twemoji](https://github.com/twitter/twemoji) topic:emoji,twemoji pushed_at:2023-04 star:15.9k fork:1.9k Emoji for everyone. https://twemoji.twitter.com/
- [twitter/twitter-text](https://github.com/twitter/twitter-text) topic:emoji,java,nodejs,objective-c,ruby,tweet,twitter,twitter-text,unicode pushed_at:2023-04 star:3.0k fork:0.5k Twitter Text Libraries. This code is used at Twitter to tokenize and parse text to meet the expectations for what can be used on the platform.
- [twitter/twitter.github.io](https://github.com/twitter/twitter.github.io) topic: pushed_at:2021-10 star:0.1k fork:0.0k 

## Java

- [twitter/cloudhopper-commons](https://github.com/twitter/cloudhopper-commons) topic: pushed_at:2023-04 star:0.0k fork:0.1k Cloudhopper Commons
...
- [twitter/nodes](https://github.com/twitter/nodes) topic: pushed_at:2023-04 star:0.2k fork:0.0k  A library to implement asynchronous dependency graphs for services in Java
- [twitter/sbf](https://github.com/twitter/sbf) topic: pushed_at:2023-04 star:0.1k fork:0.0k 
...
- [twitter/hogan.js](https://github.com/twitter/hogan.js) topic: pushed_at:2023-04 star:5.1k fork:0.5k A compiler for the Mustache templating language
- [twitter/labella.js](https://github.com/twitter/labella.js) topic: pushed_at:2023-04 star:3.8k fork:0.2k Placing labels on a timeline without overlap.
...
- [twitter/twitter-cldr-npm](https://github.com/twitter/twitter-cldr-npm) topic: pushed_at:2023-04 star:0.0k fork:0.0k TwitterCldr npm package
- [twitter/typeahead.js](https://github.com/twitter/typeahead.js) topic: pushed_at:2023-04 star:16.5k fork:3.3k typeahead.js is a fast and fully-featured autocomplete library

## Kotlin

- [twitter/compose-rules](https://github.com/twitter/compose-rules) topic:android,jetpack-compose,ktlint,static-code-analysis pushed_at:2023-04 star:1.2k fork:0.1k Static checks to aid with a healthy adoption of Compose
...
- [twitter/.github](https://github.com/twitter/.github) topic: pushed_at:2023-04 star:0.0k fork:0.1k Twitter GitHub Organization-wide files
...
- [twitter/metrics](https://github.com/twitter/metrics) topic: pushed_at:2023-04 star:0.1k fork:0.0k 
...
- [twitter/communitynotes](https://github.com/twitter/communitynotes) topic:crowdsourcing,twitter pushed_at:2023-04 star:0.6k fork:0.1k Documentation and source code powering Twitter's Community Notes
- [twitter/dict_minimize](https://github.com/twitter/dict_minimize) topic:scipy,scipy-stack pushed_at:2023-04 star:0.1k fork:0.0k Access scipy optimizers from your favorite deep learning framework.
...
- [twitter/the-algorithm-ml](https://github.com/twitter/the-algorithm-ml) topic: pushed_at:2023-04 star:8.8k fork:2.1k Source code for Twitter's Recommendation Algorithm
...
- [twitter/twurl](https://github.com/twitter/twurl) topic:cli,curl,ruby,twitter,twitter-api,twurl pushed_at:2023-04 star:1.7k fork:0.3k OAuth-enabled curl for the Twitter API
...
- [twitter/rezolus](https://github.com/twitter/rezolus) topic: pushed_at:2023-03 star:1.5k fork:0.1k Systems performance telemetry
...
- [twitter/opensource-website](https://github.com/twitter/opensource-website) topic:ospo pushed_at:2023-04 star:2.5k fork:0.7k Twitter's open source website, identifying projects we've released, organizations we support, and the work we do to support open source.

## Scala

- [twitter/algebird](https://github.com/twitter/algebird) topic: pushed_at:2023-04 star:2.2k fork:0.3k Abstract Algebra for Scala
- [twitter/bazel-multiversion](https://github.com/twitter/bazel-multiversion) topic:bazel,bazel-build,bazel-rules,coursier,dependency-manager,java,jvm,kotlin,scala pushed_at:2023-03 star:0.0k fork:0.0k Bazel rules to resolve, fetch and manage 3rdparty JVM dependencies with support for multiple parallel versions of the same dependency. Powered by Coursier. 
- [twitter/bijection](https://github.com/twitter/bijection) topic: pushed_at:2023-04 star:0.6k fork:0.1k Reversible conversions between types
...
- [twitter/chill](https://github.com/twitter/chill) topic: pushed_at:2023-04 star:0.6k fork:0.1k Scala extensions for the Kryo serialization library
- [twitter/finagle](https://github.com/twitter/finagle) topic:distributed-systems,finagle,http,http2,java,memcached,mysql,redis,rpc,scala,thrift,zipkin pushed_at:2023-04 star:8.6k fork:1.5k A fault tolerant, protocol-agnostic RPC system
- [twitter/finatra](https://github.com/twitter/finatra) topic:finagle,framework,guice,http,microservices,scala,slf4j,testing,thrift,twitter-server pushed_at:2023-04 star:2.2k fork:0.4k Fast, testable, Scala services built on TwitterServer and Finagle
...
- [twitter/scrooge](https://github.com/twitter/scrooge) topic:android,cocoa,code-generation,finagle,java,lua,scala,thrift pushed_at:2023-04 star:0.8k fork:0.3k A Thrift parser/generator
...
- [twitter/the-algorithm](https://github.com/twitter/the-algorithm) topic: pushed_at:2023-04 star:54.6k fork:11.3k Source code for Twitter's Recommendation Algorithm
...
- [twitter/twemoji-parser](https://github.com/twitter/twemoji-parser) topic: pushed_at:2023-04 star:0.1k fork:0.1k A simple library for identifying emoji entities within a string in order to render them as Twemoji.
...
- [twitter/twitter-server](https://github.com/twitter/twitter-server) topic:finagle,finatra pushed_at:2023-04 star:1.4k fork:0.3k Twitter-Server defines a template from which services at Twitter are built
- [twitter/util](https://github.com/twitter/util) topic:finagle,scala,utility pushed_at:2023-04 star:2.6k fork:0.6k Wonderful reusable code from Twitter
...
- [twitter/dodo](https://github.com/twitter/dodo) topic:finagle,finatra,ostrich,sbt,scrooge,twitter-oss,twitter-server,util pushed_at:2023-04 star:0.0k fork:0.0k The Twitter OSS Project Builder
- [twitter/hadoop-lzo](https://github.com/twitter/hadoop-lzo) topic: pushed_at:2023-04 star:0.5k fork:0.3k Refactored version of code.google.com/hadoop-gpl-compression for hadoop 0.20
...
- [twitter/TwitterTextEditor](https://github.com/twitter/TwitterTextEditor) topic:ios,swift,textkit,uikit pushed_at:2023-04 star:2.9k fork:0.1k A standalone, flexible API that provides a full-featured rich text editor for iOS applications.

## TypeScript

- [twitter/dodo-build](https://github.com/twitter/dodo-build) topic: pushed_at:2023-04 star:0.0k fork:0.0k A Github Action for running Dodo: The Twitter OSS Project Builder
