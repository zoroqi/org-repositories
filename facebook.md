...
- [facebook/fishhook](https://github.com/facebook/fishhook) pushed_at:2021-02 A library that enables dynamically rebinding symbols in Mach-O binaries running on iOS.
- [facebook/glusterfs](https://github.com/facebook/glusterfs) pushed_at:2019-06 Gluster Filesystem - (this is only a public mirror)
- [facebook/openbmc](https://github.com/facebook/openbmc) pushed_at:2021-02 OpenBMC is an open software framework to build a complete Linux image for a Board Management Controller (BMC).
- [facebook/openbmc-linux](https://github.com/facebook/openbmc-linux) pushed_at:2021-02 Linux kernel consumed by OpenBMC
- [facebook/openbmc-uboot](https://github.com/facebook/openbmc-uboot) pushed_at:2021-02 Tracking Denx Das u-boot with various trusted computing add-ons.
...
- [facebook/zstd](https://github.com/facebook/zstd) pushed_at:2021-02 Zstandard - Fast real-time compression algorithm

## C++

- [facebook/bistro](https://github.com/facebook/bistro) pushed_at:2021-02 Bistro is a flexible distributed scheduler, a high-performance framework supporting multiple paradigms while retaining ease of configuration, management, and monitoring.
...
- [facebook/fatal](https://github.com/facebook/fatal) pushed_at:2021-02 Fatal is a library for fast prototyping software in modern C++. It provides facilities to enhance the expressive power of C++. The library is heavily based on template meta-programming, while keeping the complexity under-the-hood.
- [facebook/fb303](https://github.com/facebook/fb303) pushed_at:2021-02 fb303 is a core set of thrift functions that provide a common mechanism for querying stats and other information from a service.
- [facebook/fboss](https://github.com/facebook/fboss) pushed_at:2021-02 Facebook Open Switching System  Software for controlling network switches.
- [facebook/fbthrift](https://github.com/facebook/fbthrift) pushed_at:2021-02 Facebook's branch of Apache Thrift, including a new C++ server.
- [facebook/folly](https://github.com/facebook/folly) pushed_at:2021-02 An open-source C++ library developed and used at Facebook.
- [facebook/hermes](https://github.com/facebook/hermes) pushed_at:2021-02 Hermes is a small and lightweight JavaScript engine optimized for running React Native on Android.
- [facebook/hhvm](https://github.com/facebook/hhvm) pushed_at:2021-02 A virtual machine for executing programs written in Hack.
- [facebook/mcrouter](https://github.com/facebook/mcrouter) pushed_at:2021-02 Mcrouter is a memcached protocol router for scaling memcached deployments.
- [facebook/mysql-5.6](https://github.com/facebook/mysql-5.6) pushed_at:2021-02 Facebook's branch of the Oracle MySQL v5.6 database. This includes MyRocks.
...
- [facebook/openr](https://github.com/facebook/openr) pushed_at:2021-02 Distributed platform for building autonomic network functions.
- [facebook/proxygen](https://github.com/facebook/proxygen) pushed_at:2021-02 A collection of C++ HTTP libraries including an easy to use HTTP server.
- [facebook/pyre2](https://github.com/facebook/pyre2) pushed_at:2020-03 Python wrapper for RE2
- [facebook/redex](https://github.com/facebook/redex) pushed_at:2021-02 A bytecode optimizer for Android apps
- [facebook/rocksdb](https://github.com/facebook/rocksdb) pushed_at:2021-02 A library that provides an embeddable, persistent key-value store for fast storage.
...
- [facebook/squangle](https://github.com/facebook/squangle) pushed_at:2021-02 SQuangLe is a C++ API for accessing MySQL servers
...
- [facebook/ThreatExchange](https://github.com/facebook/ThreatExchange) pushed_at:2021-02 Share threat information with vetted partners
- [facebook/treadmill](https://github.com/facebook/treadmill) pushed_at:2020-12 An intelligent loadtester
- [facebook/wangle](https://github.com/facebook/wangle) pushed_at:2021-02 Wangle is a framework providing a set of common client/server abstractions for building services in a consistent, modular, and composable way.
- [facebook/watchman](https://github.com/facebook/watchman) pushed_at:2021-02 Watches files and records, or triggers actions, when they change. 
...
- [facebook/yoga](https://github.com/facebook/yoga) pushed_at:2021-02 Yoga is a cross-platform layout engine which implements Flexbox. Follow https://twitter.com/yogalayout for updates.
...
- [facebook/duckling](https://github.com/facebook/duckling) pushed_at:2021-02 Language, engine, and tooling for expressing, testing, and evaluating composable language rules on input strings.
...
- [facebook/Haxl](https://github.com/facebook/Haxl) pushed_at:2021-02 A Haskell library that simplifies access to remote data, such as databases or web-based services. 
...
- [facebook/react-native-fbsdk](https://github.com/facebook/react-native-fbsdk) pushed_at:2021-02 A React Native wrapper around the Facebook SDKs for Android and iOS.  Provides access to Facebook login, sharing, graph requests, app events etc.
...
- [facebook/SoLoader](https://github.com/facebook/SoLoader) pushed_at:2021-02 Native code loader for Android
...
- [facebook/create-react-app](https://github.com/facebook/create-react-app) pushed_at:2021-02 Set up a modern web app by running one command.
- [facebook/draft-js](https://github.com/facebook/draft-js) pushed_at:2021-02 A React framework for building text editors.
- [facebook/facebook-nodejs-business-sdk](https://github.com/facebook/facebook-nodejs-business-sdk) pushed_at:2021-02 Facebook Ads API using Node.js
...
- [facebook/fbt](https://github.com/facebook/fbt) pushed_at:2021-02 A JavaScript Internationalization Framework
- [facebook/flux](https://github.com/facebook/flux) pushed_at:2021-01 Application Architecture for Building User Interfaces
- [facebook/instant-articles-builder](https://github.com/facebook/instant-articles-builder) pushed_at:2021-02 Instant Articles Rules Editor
- [facebook/jscodeshift](https://github.com/facebook/jscodeshift) pushed_at:2021-01 A JavaScript codemod toolkit.
- [facebook/metro](https://github.com/facebook/metro) pushed_at:2021-02 🚇 The JavaScript bundler for React Native.
...
- [facebook/prop-types](https://github.com/facebook/prop-types) pushed_at:2021-02 Runtime type checking for React props and similar objects
- [facebook/react](https://github.com/facebook/react) pushed_at:2021-02 A declarative, efficient, and flexible JavaScript library for building user interfaces.
- [facebook/react-native](https://github.com/facebook/react-native) pushed_at:2021-02 A framework for building native apps with React.
- [facebook/react-native-website](https://github.com/facebook/react-native-website) pushed_at:2021-02 The site and docs for React Native
...
- [facebook/relay](https://github.com/facebook/relay) pushed_at:2021-02 Relay is a JavaScript framework for building data-driven React applications.

## Jupyter Notebook

- [facebook/Ax](https://github.com/facebook/Ax) pushed_at:2021-02 Adaptive Experimentation Platform
...
- [facebook/flow](https://github.com/facebook/flow) pushed_at:2021-02 Adds static typing to JavaScript to improve developer productivity and code quality.
- [facebook/infer](https://github.com/facebook/infer) pushed_at:2021-02 A static analyzer for Java, C, C++, and Objective-C
- [facebook/pyre-check](https://github.com/facebook/pyre-check) pushed_at:2021-02 Performant type-checking for python.

## Objective-C

- [facebook/facebook-ios-sdk](https://github.com/facebook/facebook-ios-sdk) pushed_at:2021-02 Used to integrate the Facebook Platform with your iOS & tvOS apps.
...
- [facebook/idb](https://github.com/facebook/idb) pushed_at:2021-02 idb is a flexible command line interface for automating iOS simulators and devices
...
- [facebook/componentkit](https://github.com/facebook/componentkit) pushed_at:2021-02 A React-inspired view framework for iOS.
...
- [facebook/jsx](https://github.com/facebook/jsx) pushed_at:2021-01 The JSX specification is a XML-like syntax extension to ECMAScript.
...
- [facebook/fbzmq](https://github.com/facebook/fbzmq) pushed_at:2021-02 Facebook ZeroMQ wrappers.
...
- [facebook/prophet](https://github.com/facebook/prophet) pushed_at:2021-02 Tool for producing high quality forecasts for time series data that has multiple seasonality with linear or non-linear growth.
...
- [facebook/sapp](https://github.com/facebook/sapp) pushed_at:2021-02 Post Processor for Facebook Static Analysis Tools.
- [facebook/TestSlide](https://github.com/facebook/TestSlide) pushed_at:2021-02 A Python test framework
...
- [facebook/docusaurus](https://github.com/facebook/docusaurus) pushed_at:2021-02 Easy to maintain open source documentation websites.
- [facebook/flipper](https://github.com/facebook/flipper) pushed_at:2021-02 A desktop debugging platform for mobile developers.
- [facebook/jest](https://github.com/facebook/jest) pushed_at:2021-02 Delightful JavaScript Testing.
- [facebook/remodel](https://github.com/facebook/remodel) pushed_at:2021-02 Remodel is a tool that helps iOS and OS X developers avoid repetitive code by generating Objective-C models that support coding, value comparison, and immutability.
