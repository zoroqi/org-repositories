...
- [facebook/zstd](https://github.com/facebook/zstd) topic: pushed_at:2025-08 star:25.5k fork:2.3k Zstandard - Fast real-time compression algorithm
...
- [facebook/hermes](https://github.com/facebook/hermes) topic: pushed_at:2025-08 star:10.4k fork:0.7k A JavaScript engine optimized for running React Native.
- [facebook/hhvm](https://github.com/facebook/hhvm) topic:hack,hacklang,hhvm,php pushed_at:2025-08 star:18.5k fork:3.1k A virtual machine for executing programs written in Hack.
...
- [facebook/react-native](https://github.com/facebook/react-native) topic:android,app-framework,cross-platform,ios,mobile,mobile-development,react,react-native pushed_at:2025-08 star:123.4k fork:24.8k A framework for building native applications using React
...
- [facebook/rocksdb](https://github.com/facebook/rocksdb) topic:database,storage-engine pushed_at:2025-08 star:30.3k fork:6.6k A library that provides an embeddable, persistent key-value store for fast storage.
...
- [facebook/ThreatExchange](https://github.com/facebook/ThreatExchange) topic:hashing,image,image-hashing,image-similarity,ncmec,perceptual-hashing,stopncii,threatexchange,video,video-hashing,video-similarity pushed_at:2025-08 star:1.2k fork:0.3k Trust & Safety tools for working together to fight digital harms. 
...
- [facebook/watchman](https://github.com/facebook/watchman) topic: pushed_at:2025-08 star:13.2k fork:1.0k Watches files and records, or triggers actions, when they change. 
...
- [facebook/react](https://github.com/facebook/react) topic:declarative,frontend,javascript,library,react,ui pushed_at:2025-08 star:238.2k fork:49.1k The library for web and native user interfaces.
...
- [facebook/litho](https://github.com/facebook/litho) topic: pushed_at:2025-08 star:7.7k fork:0.8k A declarative framework for building efficient UIs on Android.
...
- [facebook/infer](https://github.com/facebook/infer) topic:c,code-quality,cpp,java,objective-c,static-analysis,static-code-analysis pushed_at:2025-08 star:15.3k fork:2.0k A static analyzer for Java, C, C++, and Objective-C
- [facebook/pyre-check](https://github.com/facebook/pyre-check) topic:abstract-interpretation,code-quality,control-flow-analysis,ocaml,program-analysis,python,security,static-analysis,taint-analysis,type-check,typechecker pushed_at:2025-08 star:7.1k fork:0.5k Performant type-checking for python.

## Objective-C

- [facebook/idb](https://github.com/facebook/idb) topic: pushed_at:2025-08 star:4.7k fork:0.5k idb is a flexible command line interface for automating iOS simulators and devices
...
- [facebook/akd](https://github.com/facebook/akd) topic: pushed_at:2025-08 star:0.3k fork:0.0k An implementation of an auditable key directory
- [facebook/buck2](https://github.com/facebook/buck2) topic: pushed_at:2025-08 star:4.0k fork:0.3k Build system, successor to Buck
- [facebook/bunnylol.rs](https://github.com/facebook/bunnylol.rs) topic:rocket-rs,rust pushed_at:2025-08 star:0.0k fork:0.0k a tool that lets you write smart bookmarks 
...
- [facebook/pyrefly](https://github.com/facebook/pyrefly) topic:code-quality,contributions-welcome,good-first-issue,ide,language-server,lsp,python,rust,type-check,type-checker,typecheck,typechecker,types,typing pushed_at:2025-08 star:3.5k fork:0.1k A fast type checker and IDE for Python
...
- [facebook/sapling](https://github.com/facebook/sapling) topic: pushed_at:2025-08 star:6.5k fork:0.3k A Scalable, User-Friendly Source Control System.
...
- [facebook/buck2-prelude](https://github.com/facebook/buck2-prelude) topic: pushed_at:2025-08 star:0.1k fork:0.1k Prelude for the Buck2 project
...
- [facebook/docusaurus](https://github.com/facebook/docusaurus) topic:documentation,hacktoberfest,javascript,open-source,react,website pushed_at:2025-08 star:61.3k fork:9.3k Easy to maintain open source documentation websites.
...
- [facebook/lexical](https://github.com/facebook/lexical) topic: pushed_at:2025-08 star:21.8k fork:2.0k Lexical is an extensible text editor framework that provides excellent reliability, accessibility and performance.
...
- [facebook/react-native-website](https://github.com/facebook/react-native-website) topic:docusaurus,react,react-native pushed_at:2025-08 star:2.0k fork:5.1k The React Native website and docs
