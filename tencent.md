...
- [Tencent/Hippy](https://github.com/Tencent/Hippy) topic:android,cross-platform,frontend,hippy,ios,mobile,react,vue,web pushed_at:2025-04 star:8.3k fork:1.0k Hippy is designed to easily build cross-platform dynamic apps. 👏
...
- [Tencent/libpag](https://github.com/Tencent/libpag) topic:after-effects,animation,keyframes,libpag,pag pushed_at:2025-04 star:5.3k fork:0.5k The official rendering library for PAG (Portable Animated Graphics) files that renders After Effects animations natively across multiple platforms.
...
- [Tencent/rapidjson](https://github.com/Tencent/rapidjson) topic: pushed_at:2025-02 star:14.7k fork:3.6k A fast JSON parser/generator for C++ with both SAX/DOM style API
...
- [Tencent/AI-Infra-Guard](https://github.com/Tencent/AI-Infra-Guard) topic: pushed_at:2025-04 star:1.1k fork:0.1k A comprehensive, intelligent, easy-to-use, and lightweight AI Infrastructure Vulnerability Assessment and MCP Server Security Analysis Tool.
...
- [Tencent/tdesign-miniprogram](https://github.com/Tencent/tdesign-miniprogram) topic:miniprogram,tdesign,wechat pushed_at:2025-04 star:1.4k fork:0.3k A Wechat MiniProgram UI components lib for TDesign.
...
- [Tencent/TencentKona-11](https://github.com/Tencent/TencentKona-11) topic: pushed_at:2025-04 star:0.3k fork:0.1k Tencent Kona JDK11 is a no-cost, production-ready distribution of the Open Java Development Kit (OpenJDK), Long-Term Support(LTS) with quarterly updates. Tencent Kona JDK11 is certified as compatible with the Java SE standard.
- [Tencent/TencentKona-17](https://github.com/Tencent/TencentKona-17) topic: pushed_at:2025-04 star:0.2k fork:0.0k Tencent Kona JDK17 is a no-cost, production-ready distribution of the Open Java Development Kit (OpenJDK), Long-Term Support(LTS) with quarterly updates. Tencent Kona JDK17 is certified as compatible with the Java SE standard.
- [Tencent/TencentKona-21](https://github.com/Tencent/TencentKona-21) topic: pushed_at:2025-04 star:0.0k fork:0.0k Tencent Kona JDK21 is a no-cost, production-ready distribution of the Open Java Development Kit (OpenJDK), Long-Term Support(LTS) with quarterly updates. Tencent Kona JDK21 is certified as compatible with the Java SE standard.
- [Tencent/TencentKona-8](https://github.com/Tencent/TencentKona-8) topic: pushed_at:2025-04 star:1.0k fork:0.1k Tencent Kona is a no-cost, production-ready distribution of the Open Java Development Kit (OpenJDK), Long-term support(LTS) with quarterly updates. Tencent Kona serves as the default JDK internally at Tencent Cloud for cloud computing and other Java applications.
...
- [Tencent/cherry-markdown](https://github.com/Tencent/cherry-markdown) topic:editor,javascript,markdown pushed_at:2025-04 star:4.2k fork:0.5k ✨ A Markdown Editor
...
- [Tencent/hel](https://github.com/Tencent/hel) topic:better-module-federation,hel,hel-micro,micro-frontend,module-federation,runtime-module-federation pushed_at:2025-04 star:1.1k fork:0.1k A module federation SDK which is unrelated to tool chain for module consumer. 工具链无关的运行时模块联邦sdk.
...
- [Tencent/weui-wxss](https://github.com/Tencent/weui-wxss) topic:weui,wxss pushed_at:2024-12 star:15.2k fork:5.2k A UI library by WeChat official design team, includes the most useful widgets/modules.
...
- [Tencent/DepthCrafter](https://github.com/Tencent/DepthCrafter) topic: pushed_at:2025-04 star:1.3k fork:0.1k [CVPR 2025 Highlight] DepthCrafter: Generating Consistent Long Depth Sequences for Open-world Videos
...
- [Tencent/Hunyuan3D-2](https://github.com/Tencent/Hunyuan3D-2) topic:3d,3d-aigc,3d-generation,diffusion-models,hunyuan3d,image-to-3d,shape,shape-generation,text-to-3d,texture-generation pushed_at:2025-04 star:9.2k fork:0.8k High-Resolution 3D Assets Generation with Large Scale Hunyuan3D Diffusion Models.
- [Tencent/HunyuanVideo](https://github.com/Tencent/HunyuanVideo) topic:diffusion-models,diffusion-transformer,video-generation pushed_at:2025-04 star:9.8k fork:0.8k HunyuanVideo: A Systematic Framework For Large Video Generation Model
- [Tencent/HunyuanVideo-I2V](https://github.com/Tencent/HunyuanVideo-I2V) topic:diffusion-models,image-to-video,image-to-video-generation,videogeneration pushed_at:2025-04 star:1.4k fork:0.1k HunyuanVideo-I2V: A Customizable Image-to-Video Model based on HunyuanVideo
- [Tencent/InstantCharacter](https://github.com/Tencent/InstantCharacter) topic: pushed_at:2025-04 star:0.8k fork:0.1k 
...
- [Tencent/VITA](https://github.com/Tencent/VITA) topic: pushed_at:2025-04 star:0.0k fork:0.0k The official implement of VITA, VITA15, LongVITA, and VITA-Audio.
...
- [Tencent/cos-mcp](https://github.com/Tencent/cos-mcp) topic: pushed_at:2025-04 star:0.0k fork:0.0k 基于 MCP 协议的腾讯云 COS MCP Server，无需编码即可让大模型快速接入腾讯云存储 (COS) 和数据万象 (CI) 能力。
...
- [Tencent/tdesign-icons](https://github.com/Tencent/tdesign-icons) topic:icons,tdesign pushed_at:2025-04 star:0.1k fork:0.0k A mono repo for TDesign Icons
...
- [Tencent/tdesign-react](https://github.com/Tencent/tdesign-react) topic:less,pc,react,tdesign,typescript pushed_at:2025-05 star:0.9k fork:0.3k A React UI components lib for TDesign.
...
- [Tencent/tdesign-vue-next](https://github.com/Tencent/tdesign-vue-next) topic:less,pc,tdesign,typescript,vue,vue3 pushed_at:2025-04 star:1.7k fork:0.5k A Vue3.x UI components lib for TDesign.
