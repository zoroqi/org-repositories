...
- [Tencent/puerts](https://github.com/Tencent/puerts) topic:dotnet,javascript,nodejs,quickjs,typescript,unity,unrealengine,v8 pushed_at:2025-08 star:5.6k fork:0.8k PUER(普洱) Typescript. Let's write your game in UE or Unity with TypeScript.
...
- [Tencent/wcdb](https://github.com/Tencent/wcdb) topic:android,database,ios,linux,macos,sqlcipher,sqlite,wechat,windows pushed_at:2025-08 star:11.2k fork:1.5k WCDB is a cross-platform database framework developed by WeChat.
...
- [Tencent/AI-Infra-Guard](https://github.com/Tencent/AI-Infra-Guard) topic: pushed_at:2025-08 star:1.6k fork:0.2k A comprehensive, intelligent, easy-to-use, and lightweight AI Infrastructure Vulnerability Assessment and MCP Server Security Analysis Tool.
...
- [Tencent/WeKnora](https://github.com/Tencent/WeKnora) topic: pushed_at:2025-08 star:1.6k fork:0.2k LLM-powered framework for deep document understanding, semantic retrieval, and context-aware answers using RAG paradigm.
...
- [Tencent/weui-wxss](https://github.com/Tencent/weui-wxss) topic:weui,wxss pushed_at:2025-08 star:15.2k fork:5.2k A UI library by WeChat official design team, includes the most useful widgets/modules.
...
- [Tencent/tdesign-vue-next](https://github.com/Tencent/tdesign-vue-next) topic:less,pc,tdesign,typescript,vue,vue3 pushed_at:2025-08 star:1.8k fork:0.6k A Vue3.x UI components lib for TDesign.
