...
- [Tencent/xLua](https://github.com/Tencent/xLua) topic:csharp,lua,unity,unity3d,xlua pushed_at:2025-11 star:9.9k fork:2.5k xLua is a lua programming solution for  C# ( Unity, .Net, Mono) , it supports android, ios, windows, linux, osx, etc.
...
- [Tencent/libpag](https://github.com/Tencent/libpag) topic:after-effects,animation,keyframes,libpag,pag pushed_at:2025-12 star:5.5k fork:0.5k The official rendering library for PAG (Portable Animated Graphics) files that renders After Effects animations natively across multiple platforms.
...
- [Tencent/game-log-sdk-go](https://github.com/Tencent/game-log-sdk-go) topic: pushed_at:2025-09 star:0.0k fork:0.0k 
...
- [Tencent/fast-causal-inference](https://github.com/Tencent/fast-causal-inference) topic: pushed_at:2025-08 star:0.2k fork:0.0k It is a high-performance causal inference (statistical model) computing library based on OLAP, which solves the performance bottleneck of the existing statistical model library (R/Python) under big data
...
- [Tencent/vectordatabase-sdk-java](https://github.com/Tencent/vectordatabase-sdk-java) topic: pushed_at:2025-11 star:0.0k fork:0.0k Tencent VectorDB Java SDK
...
- [Tencent/MLeaksFinder](https://github.com/Tencent/MLeaksFinder) topic: pushed_at:2023-09 star:5.5k fork:0.9k Find memory leaks in your iOS app at develop time.
...
- [Tencent/IssueShoot](https://github.com/Tencent/IssueShoot) topic: pushed_at:2025-09 star:0.0k fork:0.0k 
...
- [Tencent/AI-Infra-Guard](https://github.com/Tencent/AI-Infra-Guard) topic:agent,ai,ai-infra,benchmark,jailbreak,llm,llm-security,mcp,red-teaming,scanner,security,security-tools,vulnerability-scanners pushed_at:2025-12 star:2.6k fork:0.3k A.I.G (AI-Infra-Guard) is a comprehensive, intelligent, and easy-to-use AI Red Teaming platform developed by Tencent Zhuque Lab.
- [Tencent/AICGSecEval](https://github.com/Tencent/AICGSecEval) topic:agent,aigc,benchmark,codesecurity,llm pushed_at:2025-12 star:0.9k fork:0.1k A.S.E (AICGSecEval) is a repository-level AI-generated code security evaluation benchmark developed by Tencent Wukong Code Security Team.
...
- [Tencent/vectordatabase-sdk-python](https://github.com/Tencent/vectordatabase-sdk-python) topic: pushed_at:2025-11 star:0.0k fork:0.0k Tencent VectorDB Python SDK
...
- [Tencent/tquic](https://github.com/Tencent/tquic) topic:cross-platform,http3,network-programming,networking,protocol,quic,rust,udp pushed_at:2025-09 star:1.4k fork:0.1k A high-performance, lightweight, and cross-platform QUIC library
...
- [Tencent/omi](https://github.com/Tencent/omi) topic:components,css,custom-elements,html,javascript,js,jsx,omi,reactive-signal,shadow-dom,signal,signals,tailwind,tailwindcss,ts,tsx,typescript,web,web-components,webcomponents pushed_at:2025-09 star:13.2k fork:1.3k Web Components Framework - Web组件框架
