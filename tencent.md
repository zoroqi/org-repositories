...
- [Tencent/puerts](https://github.com/Tencent/puerts) topic:dotnet,javascript,nodejs,quickjs,typescript,unity,unrealengine,v8 pushed_at:2025-05 star:5.4k fork:0.7k PUER(普洱) Typescript. Let's write your game in UE or Unity with TypeScript.
...
- [Tencent/wcdb](https://github.com/Tencent/wcdb) topic:android,database,ios,linux,macos,sqlcipher,sqlite,wechat,windows pushed_at:2025-05 star:11.1k fork:1.4k WCDB is a cross-platform database framework developed by WeChat.
- [Tencent/xLua](https://github.com/Tencent/xLua) topic:csharp,lua,unity,unity3d,xlua pushed_at:2025-03 star:9.7k fork:2.5k xLua is a lua programming solution for  C# ( Unity, .Net, Mono) , it supports android, ios, windows, linux, osx, etc.
...
- [Tencent/BqLog](https://github.com/Tencent/BqLog) topic:cpp,cross-platform,csharp,gamedev,high-performance,ios,java,linux,logging,mac,ndk,posix,unity,unix,unreal,windows pushed_at:2025-05 star:0.3k fork:0.0k Maybe the world's fastest logging library, originating from the client of the top mobile game Honor of Kings, is lightweight, works on PC, mobile, and servers, supports C#, Java, and C++, and is well adapted to Unity and Unreal engines. 可能是全球最快的日志库，源自最成功的手游之一《王者荣耀》客户端，轻量级，适用于PC、移动设备和服务器，支持C#、Java、C++，并对Unity、Unreal引擎做了良好适配。
...
- [Tencent/Hippy](https://github.com/Tencent/Hippy) topic:android,cross-platform,frontend,hippy,ios,mobile,react,vue,web pushed_at:2025-05 star:8.3k fork:1.0k Hippy is designed to easily build cross-platform dynamic apps. 👏
...
- [Tencent/libpag](https://github.com/Tencent/libpag) topic:after-effects,animation,keyframes,libpag,pag pushed_at:2025-05 star:5.3k fork:0.5k The official rendering library for PAG (Portable Animated Graphics) files that renders After Effects animations natively across multiple platforms.
...
- [Tencent/Tendis](https://github.com/Tencent/Tendis) topic:cpp17,high-performance,kv,kvstore,nosql,redis,rocksdb,tendis pushed_at:2025-05 star:3.0k fork:0.3k Tendis is a high-performance distributed storage system fully compatible with the Redis protocol. 
- [Tencent/tgfx](https://github.com/Tencent/tgfx) topic:2d,filter,gpu,graphics,image,rendering,shape,text,tgfx pushed_at:2025-05 star:1.2k fork:0.1k A lightweight 2D graphics library for rendering texts, geometries, and images with high-performance APIs that work across various platforms.
- [Tencent/TNN](https://github.com/Tencent/TNN) topic:coreml,deep-learning,face-detection,hairsegmentaion,inference,mnn,ncnn,ocr,openvino,pytorch,tengine,tensorflow,tensorrt pushed_at:2025-05 star:4.5k fork:0.8k TNN: developed by Tencent Youtu Lab and Guangying Lab, a uniform deep learning inference framework for mobile、desktop and server. TNN is distinguished by several outstanding features, including its cross-platform capability, high performance, model compression and code pruning. Based on ncnn and Rapidnet, TNN further strengthens the support and performance optimization for mobile devices, and also draws on the advantages of good extensibility and high performance from existed open source efforts. TNN has been deployed in multiple Apps from Tencent, such as Mobile QQ, Weishi, Pitu, etc. Contributions are welcome to work in collaborative with us and make TNN a better framework. 
...
- [Tencent/tdesign-flutter](https://github.com/Tencent/tdesign-flutter) topic: pushed_at:2025-05 star:0.8k fork:0.1k A Flutter UI components lib for TDesign.

## Go

- [Tencent/AI-Infra-Guard](https://github.com/Tencent/AI-Infra-Guard) topic: pushed_at:2025-05 star:1.2k fork:0.1k A comprehensive, intelligent, easy-to-use, and lightweight AI Infrastructure Vulnerability Assessment and MCP Server Security Analysis Tool.
...
- [Tencent/tdesign-miniprogram](https://github.com/Tencent/tdesign-miniprogram) topic:miniprogram,tdesign,wechat pushed_at:2025-05 star:1.4k fork:0.3k A Wechat MiniProgram UI components lib for TDesign.
...
- [Tencent/APIJSON](https://github.com/Tencent/APIJSON) topic:baas,clickhouse,crud,databricks,elasticsearch,hadoop,hive,influxdb,low-code,lowcode,milvus,nocode,oracle,postgresql,postgresql-database,serverless,snowflake,sqlserver,tdengine,tidb pushed_at:2025-05 star:17.8k fork:2.2k 🏆 实时 零代码、全功能、强安全 ORM 库 🚀 后端接口和文档零代码，前端(客户端) 定制返回 JSON 的数据和结构 🏆 Real-Time coding-free, powerful and secure ORM 🚀  providing APIs and Docs without coding by Backend, and the returned JSON of API can be customized by Frontend(Client) users
- [Tencent/fast-causal-inference](https://github.com/Tencent/fast-causal-inference) topic: pushed_at:2024-12 star:0.2k fork:0.0k It is a high-performance causal inference (statistical model) computing library based on OLAP, which solves the performance bottleneck of the existing statistical model library (R/Python) under big data
...
- [Tencent/spring-cloud-tencent](https://github.com/Tencent/spring-cloud-tencent) topic:java,microservice,microservices,polarismesh,service-governance,spring,spring-cloud,springcloud pushed_at:2025-05 star:3.3k fork:0.5k Spring Cloud Tencent is a Spring Cloud based Service Governance Framework provided by Tencent.
- [Tencent/TencentKona-11](https://github.com/Tencent/TencentKona-11) topic: pushed_at:2025-05 star:0.3k fork:0.1k Tencent Kona JDK11 is a no-cost, production-ready distribution of the Open Java Development Kit (OpenJDK), Long-Term Support(LTS) with quarterly updates. Tencent Kona JDK11 is certified as compatible with the Java SE standard.
- [Tencent/TencentKona-17](https://github.com/Tencent/TencentKona-17) topic: pushed_at:2025-05 star:0.2k fork:0.0k Tencent Kona JDK17 is a no-cost, production-ready distribution of the Open Java Development Kit (OpenJDK), Long-Term Support(LTS) with quarterly updates. Tencent Kona JDK17 is certified as compatible with the Java SE standard.
- [Tencent/TencentKona-21](https://github.com/Tencent/TencentKona-21) topic: pushed_at:2025-05 star:0.0k fork:0.0k Tencent Kona JDK21 is a no-cost, production-ready distribution of the Open Java Development Kit (OpenJDK), Long-Term Support(LTS) with quarterly updates. Tencent Kona JDK21 is certified as compatible with the Java SE standard.
- [Tencent/TencentKona-8](https://github.com/Tencent/TencentKona-8) topic: pushed_at:2025-05 star:1.0k fork:0.1k Tencent Kona is a no-cost, production-ready distribution of the Open Java Development Kit (OpenJDK), Long-term support(LTS) with quarterly updates. Tencent Kona serves as the default JDK internally at Tencent Cloud for cloud computing and other Java applications.
...
- [Tencent/tinker](https://github.com/Tencent/tinker) topic:android,dynamic,hotfix,wechat pushed_at:2025-05 star:17.3k fork:3.4k Tinker is a hot-fix solution library for Android, it supports dex, library and resources update without reinstall apk.
...
- [Tencent/vectordatabase-sdk-java](https://github.com/Tencent/vectordatabase-sdk-java) topic: pushed_at:2025-05 star:0.0k fork:0.0k Tencent VectorDB Java SDK
...
- [Tencent/cherry-markdown](https://github.com/Tencent/cherry-markdown) topic:editor,javascript,markdown pushed_at:2025-05 star:4.2k fork:0.5k ✨ A Markdown Editor
...
- [Tencent/hel](https://github.com/Tencent/hel) topic:better-module-federation,hel,hel-micro,micro-frontend,module-federation,runtime-module-federation pushed_at:2025-05 star:1.1k fork:0.1k A module federation SDK which is unrelated to tool chain for module consumer. 工具链无关的运行时模块联邦sdk.
...
- [Tencent/tdesign-miniprogram-starter-retail](https://github.com/Tencent/tdesign-miniprogram-starter-retail) topic:miniprogram,retail,tdesign,template,tencent,wechat pushed_at:2025-05 star:0.7k fork:0.2k TDesign - 微信小程序 - 零售行业模板
...
- [Tencent/tdesign-common](https://github.com/Tencent/tdesign-common) topic:less,tdesign,utils pushed_at:2025-05 star:0.1k fork:0.3k TDesign style/utils shared by multiple frameworks repo.
...
- [Tencent/lemon-cleaner](https://github.com/Tencent/lemon-cleaner) topic: pushed_at:2025-05 star:5.7k fork:0.8k 腾讯柠檬清理是针对macOS系统专属制定的清理工具。主要功能包括重复文件和相似照片的识别、软件的定制化垃圾扫描、可视化的全盘空间分析、内存释放、浏览器隐私清理以及设备实时状态的监控等。重点聚焦清理功能，对上百款软件提供定制化的清理方案，提供专业的清理建议，帮助用户轻松完成一键式清理。
...
- [Tencent/CodeAnalysis](https://github.com/Tencent/CodeAnalysis) topic:code-analysis,code-quality,code-quality-analyzer,code-review,program-analysis,python37 pushed_at:2025-05 star:1.8k fork:0.3k Static Code Analysis - 静态代码分析
...
- [Tencent/digitalhuman](https://github.com/Tencent/digitalhuman) topic: pushed_at:2025-05 star:0.0k fork:0.0k 
...
- [Tencent/FlashVDM](https://github.com/Tencent/FlashVDM) topic: pushed_at:2025-05 star:0.2k fork:0.0k Unleashing Vecset Diffusion Model for Fast Shape Generation within 1 Second.  
...
- [Tencent/Hunyuan3D-2](https://github.com/Tencent/Hunyuan3D-2) topic:3d,3d-aigc,3d-generation,diffusion-models,hunyuan3d,image-to-3d,shape,shape-generation,text-to-3d,texture-generation pushed_at:2025-05 star:9.7k fork:0.8k High-Resolution 3D Assets Generation with Large Scale Hunyuan3D Diffusion Models.
- [Tencent/HunyuanCustom](https://github.com/Tencent/HunyuanCustom) topic:audio-driven,diffusion-models,image-to-video,image-to-video-generation,video-editing,video-generation pushed_at:2025-05 star:0.9k fork:0.1k HunyuanCustom: A Multimodal-Driven Architecture for Customized Video Generation
- [Tencent/HunyuanVideo](https://github.com/Tencent/HunyuanVideo) topic:diffusion-models,diffusion-transformer,video-generation pushed_at:2025-04 star:10.0k fork:0.9k HunyuanVideo: A Systematic Framework For Large Video Generation Model
...
- [Tencent/InstantCharacter](https://github.com/Tencent/InstantCharacter) topic: pushed_at:2025-05 star:0.9k fork:0.1k 
...
- [Tencent/MimicMotion](https://github.com/Tencent/MimicMotion) topic:diffusion-models,video-generation pushed_at:2024-09 star:2.4k fork:0.2k High-Quality Human Motion Video Generation with Confidence-aware Pose Guidance
...
- [Tencent/VITA](https://github.com/Tencent/VITA) topic: pushed_at:2025-05 star:0.0k fork:0.0k The official implement of VITA, VITA15, LongVITA, and VITA-Audio.
...
- [Tencent/omi](https://github.com/Tencent/omi) topic:admin,components,css,custom-elements,dashboard,html,javascript,jsx,omi,reactive-signal,shadow-dom,signal,tailwind,tailwindcss,tsx,typescript,web,web-components,webcomponents pushed_at:2025-05 star:13.2k fork:1.3k Web Components Framework - Web组件框架
...
- [Tencent/tdesign-icons](https://github.com/Tencent/tdesign-icons) topic:icons,tdesign pushed_at:2025-05 star:0.1k fork:0.0k A mono repo for TDesign Icons
- [Tencent/tdesign-mobile-react](https://github.com/Tencent/tdesign-mobile-react) topic:react,tdesign,typescript pushed_at:2025-05 star:0.1k fork:0.1k A React Mobile UI components lib for TDesign.
- [Tencent/tdesign-mobile-vue](https://github.com/Tencent/tdesign-mobile-vue) topic:tdesign,typescript,vue3 pushed_at:2025-05 star:0.3k fork:0.2k A Vue3.x Mobile UI components lib for TDesign.
...
- [Tencent/tdesign-vue](https://github.com/Tencent/tdesign-vue) topic:less,pc,tdesign,tyepscript,vue2 pushed_at:2025-05 star:1.0k fork:0.4k A Vue.js UI components lib for TDesign.
- [Tencent/tdesign-vue-next](https://github.com/Tencent/tdesign-vue-next) topic:less,pc,tdesign,typescript,vue,vue3 pushed_at:2025-05 star:1.7k fork:0.5k A Vue3.x UI components lib for TDesign.
...
- [Tencent/tmagic-editor](https://github.com/Tencent/tmagic-editor) topic: pushed_at:2025-05 star:4.7k fork:0.8k 
...
- [Tencent/tdesign](https://github.com/Tencent/tdesign) topic:miniapp,react,tdesign,vue pushed_at:2025-05 star:3.4k fork:0.3k Enterprise Design System
- [Tencent/tdesign-vue-next-starter](https://github.com/Tencent/tdesign-vue-next-starter) topic:pinia,tdesign,typescript,vue3 pushed_at:2025-05 star:0.8k fork:0.2k A starter-kit for TDesign Vue Next UI components
