...
- [Tencent/puerts](https://github.com/Tencent/puerts) topic:dotnet,javascript,nodejs,quickjs,typescript,unity,unrealengine,v8 pushed_at:2025-05 star:5.5k fork:0.7k PUER(普洱) Typescript. Let's write your game in UE or Unity with TypeScript.
...
- [Tencent/BqLog](https://github.com/Tencent/BqLog) topic:cpp,cross-platform,csharp,gamedev,high-performance,ios,java,linux,logging,mac,ndk,posix,unity,unix,unreal,windows pushed_at:2025-05 star:0.4k fork:0.0k Maybe the world's fastest logging library, originating from the client of the top mobile game Honor of Kings, is lightweight, works on PC, mobile, and servers, supports C#, Java, and C++, and is well adapted to Unity and Unreal engines. 可能是全球最快的日志库，源自最成功的手游之一《王者荣耀》客户端，轻量级，适用于PC、移动设备和服务器，支持C#、Java、C++，并对Unity、Unreal引擎做了良好适配。
...
- [Tencent/tgfx](https://github.com/Tencent/tgfx) topic:2d,filter,gpu,graphics,image,rendering,shape,text,tgfx pushed_at:2025-05 star:1.3k fork:0.1k A lightweight 2D graphics library for rendering texts, geometries, and images with high-performance APIs that work across various platforms.
...
- [Tencent/UnLua](https://github.com/Tencent/UnLua) topic: pushed_at:2024-09 star:2.4k fork:0.7k A feature-rich, easy-learning and highly optimized Lua scripting plugin for UE.
...
- [Tencent/tdesign-flutter](https://github.com/Tencent/tdesign-flutter) topic: pushed_at:2025-05 star:0.9k fork:0.1k A Flutter UI components lib for TDesign.

## Go

- [Tencent/AI-Infra-Guard](https://github.com/Tencent/AI-Infra-Guard) topic: pushed_at:2025-05 star:1.3k fork:0.1k A comprehensive, intelligent, easy-to-use, and lightweight AI Infrastructure Vulnerability Assessment and MCP Server Security Analysis Tool.
...
- [Tencent/vectordatabase-sdk-go](https://github.com/Tencent/vectordatabase-sdk-go) topic: pushed_at:2025-05 star:0.0k fork:0.0k Tencent VectorDB Golang SDK
...
- [Tencent/nf-tencentcloud](https://github.com/Tencent/nf-tencentcloud) topic: pushed_at:2025-05 star:0.0k fork:0.0k nf-tencentcloud is a nextflow plugin designed to add Tencent Cloud Object storage and Tencent Healthcare Omics Platform executor adaptation support to the nextflow workflow engine.
...
- [Tencent/tinker](https://github.com/Tencent/tinker) topic:android,dynamic,hotfix,wechat pushed_at:2025-05 star:17.4k fork:3.4k Tinker is a hot-fix solution library for Android, it supports dex, library and resources update without reinstall apk.
...
- [Tencent/HaploVLM](https://github.com/Tencent/HaploVLM) topic: pushed_at:2025-05 star:0.0k fork:0.0k 
...
- [Tencent/vectordatabase-sdk-python](https://github.com/Tencent/vectordatabase-sdk-python) topic: pushed_at:2025-05 star:0.0k fork:0.0k Tencent VectorDB Python SDK
