...
- [Tencent/loli_profiler](https://github.com/Tencent/loli_profiler) topic:android,cpp,memory,profiler,qt5,unity3d,unreal-engine-4 pushed_at:2025-12 star:0.7k fork:0.1k Memory instrumentation tool for android app&game developers.
...
- [Tencent/wcdb](https://github.com/Tencent/wcdb) topic:android,database,ios,linux,macos,sqlcipher,sqlite,wechat,windows pushed_at:2025-12 star:11.6k fork:1.5k WCDB is a cross-platform database framework developed by WeChat.
...
- [Tencent/BqLog](https://github.com/Tencent/BqLog) topic:cpp,cross-platform,csharp,gamedev,high-performance,ios,java,linux,logging,mac,ndk,posix,unity,unix,unreal,windows pushed_at:2025-12 star:0.5k fork:0.0k Maybe the world's fastest logging library, originating from the client of the top mobile game Honor of Kings, is lightweight, works on PC, mobile, and servers, supports C#, Java, and C++, and is well adapted to Unity and Unreal engines. 可能是全球最快的日志库，源自最成功的手游之一《王者荣耀》客户端，轻量级，适用于PC、移动设备和服务器，支持C#、Java、C++，并对Unity、Unreal引擎做了良好适配。
...
- [Tencent/Hippy](https://github.com/Tencent/Hippy) topic:android,cross-platform,frontend,hippy,ios,mobile,react,vue,web pushed_at:2025-12 star:8.5k fork:1.0k Hippy is designed to easily build cross-platform dynamic apps. 👏
...
- [Tencent/KsanaLLM](https://github.com/Tencent/KsanaLLM) topic: pushed_at:2025-11 star:0.5k fork:0.0k 
...
- [Tencent/libpag](https://github.com/Tencent/libpag) topic:after-effects,animation,keyframes,libpag,pag pushed_at:2025-12 star:5.6k fork:0.5k The official rendering library for PAG (Portable Animated Graphics) files that renders After Effects animations natively across multiple platforms.
...
- [Tencent/puerts](https://github.com/Tencent/puerts) topic:dotnet,javascript,nodejs,quickjs,typescript,unity,unrealengine,v8 pushed_at:2025-12 star:5.8k fork:0.8k PUER(普洱) Typescript. Let's write your game in UE or Unity with TypeScript.
- [Tencent/rapidjson](https://github.com/Tencent/rapidjson) topic: pushed_at:2025-02 star:14.9k fork:3.6k A fast JSON parser/generator for C++ with both SAX/DOM style API
...
- [Tencent/tgfx](https://github.com/Tencent/tgfx) topic:2d,blend,filter,gpu,graphics,image,layer,path,pdf,rendering,svg,text,tgfx,vector pushed_at:2025-12 star:1.4k fork:0.1k A lightweight 2D graphics library for modern GPUs, delivering high-performance text, image, and vector rendering across major platforms.
...
- [Tencent/UnLua](https://github.com/Tencent/UnLua) topic: pushed_at:2025-12 star:2.6k fork:0.7k A feature-rich, easy-learning and highly optimized Lua scripting plugin for UE.
...
- [Tencent/tdesign-flutter](https://github.com/Tencent/tdesign-flutter) topic: pushed_at:2025-12 star:1.0k fork:0.2k A Flutter UI components lib for TDesign.
...
- [Tencent/spring-cloud-tencent](https://github.com/Tencent/spring-cloud-tencent) topic:java,microservice,microservices,polarismesh,service-governance,spring,spring-cloud,springcloud pushed_at:2025-12 star:3.3k fork:0.5k Spring Cloud Tencent is a Spring Cloud based Service Governance Framework provided by Tencent.
...
- [Tencent/cherry-markdown](https://github.com/Tencent/cherry-markdown) topic:editor,javascript,markdown pushed_at:2025-12 star:4.5k fork:0.5k ✨ A Markdown Editor
...
- [Tencent/hel](https://github.com/Tencent/hel) topic:better-module-federation,hel,hel-micro,micro-frontend,module-federation,runtime-module-federation pushed_at:2025-12 star:1.1k fork:0.1k A module federation SDK for browser and node, it is unrelated to tool chain for module consumer. 工具链无关的跨端模块联邦sdk.
...
- [Tencent/srpo-project-page](https://github.com/Tencent/srpo-project-page) topic: pushed_at:2025-09 star:0.0k fork:0.0k 
- [Tencent/tdesign-icons](https://github.com/Tencent/tdesign-icons) topic:icons,tdesign pushed_at:2025-12 star:0.1k fork:0.0k A mono repo for TDesign Icons
- [Tencent/tdesign-miniprogram-starter-retail](https://github.com/Tencent/tdesign-miniprogram-starter-retail) topic:miniprogram,retail,tdesign,template,tencent,wechat pushed_at:2025-12 star:0.8k fork:0.2k TDesign - 微信小程序 - 零售行业模板
...
- [Tencent/tdesign-common](https://github.com/Tencent/tdesign-common) topic:less,tdesign,utils pushed_at:2025-12 star:0.2k fork:0.4k TDesign style/utils shared by multiple frameworks repo.
...
- [Tencent/AI-Infra-Guard](https://github.com/Tencent/AI-Infra-Guard) topic:agent,ai,ai-infra,benchmark,jailbreak,llm,llm-security,mcp,red-teaming,scanner,security,security-tools,vulnerability-scanners pushed_at:2025-12 star:2.7k fork:0.3k A.I.G (AI-Infra-Guard) is a comprehensive, intelligent, and easy-to-use AI Red Teaming platform developed by Tencent Zhuque Lab.
- [Tencent/AICGSecEval](https://github.com/Tencent/AICGSecEval) topic:agent,aigc,benchmark,codesecurity,llm pushed_at:2025-12 star:1.0k fork:0.1k A.S.E (AICGSecEval) is a repository-level AI-generated code security evaluation benchmark developed by Tencent Wukong Code Security Team.
- [Tencent/AngelSlim](https://github.com/Tencent/AngelSlim) topic:deepseek,diffusion,eagle,fp4,hunyuan,llm,llm-compression,quantization,qwen,speculative-decoding,vlm pushed_at:2025-12 star:0.2k fork:0.0k Model compression toolkit engineered for enhanced usability, comprehensiveness, and efficiency.
...
- [Tencent/VCB-Bench](https://github.com/Tencent/VCB-Bench) topic: pushed_at:2025-12 star:0.0k fork:0.0k 
...
- [Tencent/WeDLM](https://github.com/Tencent/WeDLM) topic: pushed_at:2025-12 star:0.3k fork:0.0k WeDLM: The fastest diffusion language model with standard causal attention and native KV cache compatibility, delivering real speedups over vLLM-optimized baselines.
...
- [Tencent/omi](https://github.com/Tencent/omi) topic:components,css,custom-elements,html,javascript,js,jsx,omi,reactive-signal,shadow-dom,signal,signals,tailwind,tailwindcss,ts,tsx,typescript,web,web-components,webcomponents pushed_at:2025-12 star:13.2k fork:1.3k Web Components Framework - Web组件框架
...
- [Tencent/tdesign-miniprogram](https://github.com/Tencent/tdesign-miniprogram) topic:miniprogram,tdesign,wechat pushed_at:2025-12 star:1.5k fork:0.3k A Wechat MiniProgram UI components lib for TDesign.
- [Tencent/tdesign-mobile-react](https://github.com/Tencent/tdesign-mobile-react) topic:react,tdesign,typescript pushed_at:2025-12 star:0.1k fork:0.1k A React Mobile UI components lib for TDesign.
- [Tencent/tdesign-mobile-vue](https://github.com/Tencent/tdesign-mobile-vue) topic:tdesign,typescript,vue3 pushed_at:2025-12 star:0.4k fork:0.2k A Vue3.x Mobile UI components lib for TDesign.
- [Tencent/tdesign-react](https://github.com/Tencent/tdesign-react) topic:less,pc,react,tdesign,typescript pushed_at:2025-12 star:0.9k fork:0.4k A React UI components lib for TDesign.
...
- [Tencent/tdesign-vue](https://github.com/Tencent/tdesign-vue) topic:less,pc,tdesign,tyepscript,vue2 pushed_at:2025-12 star:1.0k fork:0.4k A Vue.js UI components lib for TDesign.
- [Tencent/tdesign-vue-next](https://github.com/Tencent/tdesign-vue-next) topic:less,pc,tdesign,typescript,vue,vue3 pushed_at:2025-12 star:2.0k fork:0.6k A Vue3.x UI components lib for TDesign.
...
- [Tencent/tmagic-editor](https://github.com/Tencent/tmagic-editor) topic: pushed_at:2025-12 star:4.9k fork:0.8k 
...
- [Tencent/tdesign](https://github.com/Tencent/tdesign) topic:miniapp,react,tdesign,vue pushed_at:2025-12 star:3.7k fork:0.3k Enterprise Design System
