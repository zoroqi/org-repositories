...
- [Tencent/puerts](https://github.com/Tencent/puerts) topic:dotnet,javascript,nodejs,quickjs,typescript,unity,unrealengine,v8 pushed_at:2025-04 star:5.4k fork:0.7k PUER(普洱) Typescript. Let's write your game in UE or Unity with TypeScript.
...
- [Tencent/wcdb](https://github.com/Tencent/wcdb) topic:android,database,ios,linux,macos,sqlcipher,sqlite,wechat,windows pushed_at:2025-04 star:11.0k fork:1.4k WCDB is a cross-platform database framework developed by WeChat.
...
- [Tencent/BqLog](https://github.com/Tencent/BqLog) topic:cpp,cross-platform,csharp,gamedev,high-performance,ios,java,linux,logging,mac,ndk,posix,unity,unix,unreal,windows pushed_at:2025-04 star:0.3k fork:0.0k Maybe the world's fastest logging library, originating from the client of the top mobile game Honor of Kings, is lightweight, works on PC, mobile, and servers, supports C#, Java, and C++, and is well adapted to Unity and Unreal engines. 可能是全球最快的日志库，源自最成功的手游之一《王者荣耀》客户端，轻量级，适用于PC、移动设备和服务器，支持C#、Java、C++，并对Unity、Unreal引擎做了良好适配。
...
- [Tencent/Hippy](https://github.com/Tencent/Hippy) topic:android,cross-platform,frontend,hippy,ios,mobile,react,vue,web pushed_at:2025-04 star:8.2k fork:1.0k Hippy is designed to easily build cross-platform dynamic apps. 👏
...
- [Tencent/libpag](https://github.com/Tencent/libpag) topic:after-effects,animation,keyframes,libpag,pag pushed_at:2025-04 star:5.2k fork:0.5k The official rendering library for PAG (Portable Animated Graphics) files that renders After Effects animations natively across multiple platforms.
...
- [Tencent/mars](https://github.com/Tencent/mars) topic:cross-platform,log,network,wechat pushed_at:2024-12 star:17.5k fork:3.6k Mars is a cross-platform network component  developed by WeChat.
- [Tencent/MMKV](https://github.com/Tencent/MMKV) topic:android,flutter,golang,ios,key-value,kotlin,macos,ohos,python,swift,tvos,visionos,watchos,wechat,windows pushed_at:2025-04 star:17.8k fork:1.9k An efficient, small mobile key-value storage framework developed by WeChat. Works on Android, iOS, macOS, Windows, POSIX, and OHOS.
- [Tencent/ModernFlux](https://github.com/Tencent/ModernFlux) topic: pushed_at:2023-04 star:0.0k fork:0.0k 
- [Tencent/ncnn](https://github.com/Tencent/ncnn) topic:android,arm-neon,artificial-intelligence,caffe,darknet,deep-learning,high-preformance,inference,ios,keras,mlir,mxnet,ncnn,neural-network,onnx,pytorch,riscv,simd,tensorflow,vulkan pushed_at:2025-04 star:21.3k fork:4.2k ncnn is a high-performance neural network inference framework optimized for the mobile platform
...
- [Tencent/Tendis](https://github.com/Tencent/Tendis) topic:cpp17,high-performance,kv,kvstore,nosql,redis,rocksdb,tendis pushed_at:2025-04 star:3.0k fork:0.3k Tendis is a high-performance distributed storage system fully compatible with the Redis protocol. 
- [Tencent/tgfx](https://github.com/Tencent/tgfx) topic:2d,filter,gpu,graphics,image,rendering,shape,text,tgfx pushed_at:2025-04 star:1.2k fork:0.1k A lightweight 2D graphics library for rendering texts, geometries, and images with high-performance APIs that work across various platforms.
...
- [Tencent/TurboTransformers](https://github.com/Tencent/TurboTransformers) topic:albert,bert,decoder,gpt2,gpu,huggingface-transformers,inference,machine-translation,nlp,pytorch,roberta,transformer pushed_at:2025-04 star:1.5k fork:0.2k a fast and user-friendly runtime for transformer inference (Bert, Albert, GPT2, Decoders, etc) on CPU and GPU.
...
- [Tencent/tdesign-flutter](https://github.com/Tencent/tdesign-flutter) topic: pushed_at:2025-04 star:0.8k fork:0.1k A Flutter UI components lib for TDesign.

## Go

- [Tencent/AI-Infra-Guard](https://github.com/Tencent/AI-Infra-Guard) topic: pushed_at:2025-03 star:1.0k fork:0.1k AI infrastructure security assessment tool designed to discover and detect potential security risks in AI systems.
...
- [Tencent/edgeone-keyless-server](https://github.com/Tencent/edgeone-keyless-server) topic:edgeone,keyless pushed_at:2025-03 star:0.0k fork:0.0k It is used for the keyless feature in EdgeOne.
- [Tencent/game-log-sdk-go](https://github.com/Tencent/game-log-sdk-go) topic: pushed_at:2025-03 star:0.0k fork:0.0k 
- [Tencent/goom](https://github.com/Tencent/goom) topic:devops,go,golang,mock,tdd,test,test-automation,testing,unit-testing pushed_at:2025-04 star:0.0k fork:0.0k go语言mock库， 用于编写go语言单元测试时，mock函数、接口等场景
...
- [Tencent/tdesign-miniprogram](https://github.com/Tencent/tdesign-miniprogram) topic:miniprogram,tdesign,wechat pushed_at:2025-04 star:1.3k fork:0.3k A Wechat MiniProgram UI components lib for TDesign.
...
- [Tencent/spring-cloud-tencent](https://github.com/Tencent/spring-cloud-tencent) topic:java,microservice,microservices,polarismesh,service-governance,spring,spring-cloud,springcloud pushed_at:2025-04 star:3.2k fork:0.5k Spring Cloud Tencent is a Spring Cloud based Service Governance Framework provided by Tencent.
...
- [Tencent/vectordatabase-sdk-java](https://github.com/Tencent/vectordatabase-sdk-java) topic: pushed_at:2025-04 star:0.0k fork:0.0k Tencent VectorDB Java SDK
...
- [Tencent/hel](https://github.com/Tencent/hel) topic:better-module-federation,hel,hel-micro,micro-frontend,module-federation,runtime-module-federation pushed_at:2025-04 star:1.0k fork:0.1k A module federation SDK which is unrelated to tool chain for module consumer. 工具链无关的运行时模块联邦sdk.
...
- [Tencent/tdesign-miniprogram-starter-retail](https://github.com/Tencent/tdesign-miniprogram-starter-retail) topic:miniprogram,retail,tdesign,template,tencent,wechat pushed_at:2025-04 star:0.7k fork:0.2k TDesign - 微信小程序 - 零售行业模板
...
- [Tencent/HunyuanDiT](https://github.com/Tencent/HunyuanDiT) topic: pushed_at:2025-01 star:4.1k fork:0.3k Hunyuan-DiT : A Powerful Multi-Resolution Diffusion Transformer with Fine-Grained Chinese Understanding

## Less

- [Tencent/tdesign-common](https://github.com/Tencent/tdesign-common) topic:less,tdesign,utils pushed_at:2025-04 star:0.1k fork:0.3k TDesign style/utils shared by multiple frameworks repo.
...
- [Tencent/lemon-cleaner](https://github.com/Tencent/lemon-cleaner) topic: pushed_at:2025-04 star:5.7k fork:0.8k 腾讯柠檬清理是针对macOS系统专属制定的清理工具。主要功能包括重复文件和相似照片的识别、软件的定制化垃圾扫描、可视化的全盘空间分析、内存释放、浏览器隐私清理以及设备实时状态的监控等。重点聚焦清理功能，对上百款软件提供定制化的清理方案，提供专业的清理建议，帮助用户轻松完成一键式清理。
...
- [Tencent/CodeAnalysis](https://github.com/Tencent/CodeAnalysis) topic:code-analysis,code-quality,code-quality-analyzer,code-review,program-analysis,python37 pushed_at:2025-04 star:1.7k fork:0.3k Static Code Analysis - 静态代码分析
- [Tencent/CogKernel](https://github.com/Tencent/CogKernel) topic: pushed_at:2025-02 star:0.0k fork:0.0k 
- [Tencent/DepthCrafter](https://github.com/Tencent/DepthCrafter) topic: pushed_at:2025-02 star:1.3k fork:0.1k DepthCrafter: Generating Consistent Long Depth Sequences for Open-world Videos
...
- [Tencent/FlashVDM](https://github.com/Tencent/FlashVDM) topic: pushed_at:2025-04 star:0.2k fork:0.0k Unleashing Vecset Diffusion Model for Fast Shape Generation within 1 Second.  
...
- [Tencent/Hunyuan3D-2](https://github.com/Tencent/Hunyuan3D-2) topic:3d,3d-aigc,3d-generation,diffusion-models,hunyuan3d,image-to-3d,shape,shape-generation,text-to-3d,texture-generation pushed_at:2025-04 star:8.5k fork:0.7k High-Resolution 3D Assets Generation with Large Scale Hunyuan3D Diffusion Models.
- [Tencent/HunyuanVideo](https://github.com/Tencent/HunyuanVideo) topic:diffusion-models,diffusion-transformer,video-generation pushed_at:2025-03 star:9.7k fork:0.8k HunyuanVideo: A Systematic Framework For Large Video Generation Model
- [Tencent/HunyuanVideo-I2V](https://github.com/Tencent/HunyuanVideo-I2V) topic:diffusion-models,image-to-video,image-to-video-generation,videogeneration pushed_at:2025-03 star:1.3k fork:0.1k HunyuanVideo-I2V: A Customizable Image-to-Video Model based on HunyuanVideo
...
- [Tencent/LUCY](https://github.com/Tencent/LUCY) topic: pushed_at:2025-04 star:0.0k fork:0.0k The official implement of "LUCY: Linguistic Understanding and Control Yielding Early Stage of Her"
...
- [Tencent/TFace](https://github.com/Tencent/TFace) topic: pushed_at:2025-04 star:1.4k fork:0.2k A trusty face analysis research platform developed by Tencent Youtu Lab
...
- [Tencent/omi](https://github.com/Tencent/omi) topic:admin,components,css,custom-elements,dashboard,html,javascript,jsx,omi,reactive-signal,shadow-dom,signal,tailwind,tailwindcss,tsx,typescript,web,web-components,webcomponents pushed_at:2025-04 star:13.2k fork:1.3k Web Components Framework - Web组件框架
...
- [Tencent/tdesign-mobile-react](https://github.com/Tencent/tdesign-mobile-react) topic:react,tdesign,typescript pushed_at:2025-04 star:0.1k fork:0.1k A React Mobile UI components lib for TDesign.
- [Tencent/tdesign-mobile-vue](https://github.com/Tencent/tdesign-mobile-vue) topic:tdesign,typescript,vue3 pushed_at:2025-04 star:0.3k fork:0.2k A Vue3.x Mobile UI components lib for TDesign.
- [Tencent/tdesign-react](https://github.com/Tencent/tdesign-react) topic:less,pc,react,tdesign,typescript pushed_at:2025-04 star:0.9k fork:0.3k A React UI components lib for TDesign.
...
- [Tencent/tdesign-vue](https://github.com/Tencent/tdesign-vue) topic:less,pc,tdesign,tyepscript,vue2 pushed_at:2025-04 star:1.0k fork:0.4k A Vue.js UI components lib for TDesign.
- [Tencent/tdesign-vue-next](https://github.com/Tencent/tdesign-vue-next) topic:less,pc,tdesign,typescript,vue,vue3 pushed_at:2025-04 star:1.6k fork:0.5k A Vue3.x UI components lib for TDesign.
...
- [Tencent/tmagic-editor](https://github.com/Tencent/tmagic-editor) topic: pushed_at:2025-04 star:4.7k fork:0.8k 
...
- [Tencent/vConsole](https://github.com/Tencent/vConsole) topic:console,mobile,wechat pushed_at:2024-06 star:17.1k fork:3.0k A lightweight, extendable front-end developer tool for mobile web page.
- [Tencent/wujie](https://github.com/Tencent/wujie) topic: pushed_at:2025-04 star:4.5k fork:0.6k 极致的微前端框架

## Vue

- [Tencent/tdesign](https://github.com/Tencent/tdesign) topic:miniapp,react,tdesign,vue pushed_at:2025-04 star:3.4k fork:0.3k Enterprise Design System
- [Tencent/tdesign-vue-next-starter](https://github.com/Tencent/tdesign-vue-next-starter) topic:pinia,tdesign,typescript,vue3 pushed_at:2025-04 star:0.8k fork:0.2k A starter-kit for TDesign Vue Next UI components
- [Tencent/tdesign-vue-starter](https://github.com/Tencent/tdesign-vue-starter) topic:starter-kit,tdesign,vue2 pushed_at:2025-04 star:0.4k fork:0.1k A starter-kit for TDesign Vue UI components.
