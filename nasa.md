...
- [nasa/CF](https://github.com/nasa/CF) topic: pushed_at:2025-11 star:0.1k fork:0.1k The Core Flight System (cFS) CFDP application.
- [nasa/cFE](https://github.com/nasa/cFE) topic: pushed_at:2025-11 star:0.5k fork:0.2k The Core Flight System (cFS) Core Flight Executive (cFE)
...
- [nasa/CryptoLib](https://github.com/nasa/CryptoLib) topic:ccsds,cfs,communications,data-link,ground-station,sdls-ep,space-communications,space-data-link-security-protocol,space-network,spack-data-link pushed_at:2025-11 star:0.1k fork:0.0k Provide a software-only solution using the CCSDS Space Data Link Security Protocol - Extended Procedures (SDLS-EP) to secure communications between a spacecraft running the core Flight System (cFS) and a ground station.
...
- [nasa/PSP](https://github.com/nasa/PSP) topic: pushed_at:2025-11 star:0.1k fork:0.1k The Core Flight System (cFS) Platform Support Package (PSP)
...
- [nasa/dcapp](https://github.com/nasa/dcapp) topic: pushed_at:2025-12 star:0.0k fork:0.0k 
...
- [nasa/IDF](https://github.com/nasa/IDF) topic: pushed_at:2025-10 star:0.1k fork:0.0k 
...
- [nasa/cFS](https://github.com/nasa/cFS) topic: pushed_at:2025-11 star:1.1k fork:0.3k The Core Flight System (cFS)
...
- [nasa/opera-sds](https://github.com/nasa/opera-sds) topic: pushed_at:2025-12 star:0.0k fork:0.0k 
...
- [nasa/earthdata-search](https://github.com/nasa/earthdata-search) topic:data-discovery,earthdata-search,eosdis,hacktoberfest pushed_at:2025-12 star:0.8k fork:0.2k Earthdata Search is a web application developed by NASA EOSDIS to enable data discovery, search, comparison, visualization, and access across EOSDIS' Earth Science data holdings.
...
- [nasa/meza](https://github.com/nasa/meza) topic:elasticsearch,enterprise,mediawiki,visual-editor,wiki pushed_at:2025-09 star:0.0k fork:0.0k Setup an enterprise MediaWiki server with simple commands
...
- [nasa/Open-Source-Catalog](https://github.com/nasa/Open-Source-Catalog) topic:ai-tags,catalog,meta-record,nasa,open-source,website pushed_at:2025-10 star:0.3k fork:0.1k Contains the NASA open source software catalog for automatic deployment to code.nasa.gov
...
- [nasa/GeneLab_Data_Processing](https://github.com/nasa/GeneLab_Data_Processing) topic:genelab,genes,genetics,pipeline pushed_at:2025-11 star:0.1k fork:0.1k Standard bioinformatics pipelines for omics data from spaceflight and space-relevant experiments.
...
- [nasa/pyturbo-aero](https://github.com/nasa/pyturbo-aero) topic: pushed_at:2025-09 star:0.1k fork:0.0k Turbomachinery Blade and Flow path design tool
...
- [nasa/GeneLab_RNASeq_Workflow](https://github.com/nasa/GeneLab_RNASeq_Workflow) topic:differential-expression,genelab,genes,genomics,rna-seq,workflow pushed_at:2025-09 star:0.0k fork:0.0k Nextflow implementation of the GeneLab bulk RNASeq data processing pipelines.
...
- [nasa/cape](https://github.com/nasa/cape) topic: pushed_at:2025-09 star:0.0k fork:0.0k Computational Aerosciences Productivity & Execution
...
- [nasa/scrub](https://github.com/nasa/scrub) topic:code-quality,code-review,python,security,static-analysis pushed_at:2025-11 star:0.0k fork:0.0k SCRUB is a platform for orchestration and aggregation of static code analysis tools.
