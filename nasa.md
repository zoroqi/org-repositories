...
- [nasa/ci_lab](https://github.com/nasa/ci_lab) topic: pushed_at:2022-12 star:0.0k fork:0.0k The Core Flight System (cFS) Command Ingest Lab App (ci_lab)
...
- [nasa/CryptoLib](https://github.com/nasa/CryptoLib) topic:ccsds,cfs,communications,data-link,ground-station,sdls-ep,space-communications,space-data-link-security-protocol,space-network,spack-data-link pushed_at:2022-12 star:0.0k fork:0.0k Provide a software-only solution using the CCSDS Space Data Link Security Protocol - Extended Procedures (SDLS-EP) to secure communications between a spacecraft running the core Flight System (cFS) and a ground station.
- [nasa/CS](https://github.com/nasa/CS) topic: pushed_at:2022-12 star:0.0k fork:0.0k The Core Flight System (cFS) Checksum (CS) application.
- [nasa/DS](https://github.com/nasa/DS) topic: pushed_at:2022-12 star:0.0k fork:0.0k The Core Flight System (cFS) Data Storage (DS) application.
...
- [nasa/FM](https://github.com/nasa/FM) topic: pushed_at:2022-12 star:0.0k fork:0.0k The Core Flight System (cFS) File Manager (FM) application.
...
- [nasa/HK](https://github.com/nasa/HK) topic: pushed_at:2022-12 star:0.0k fork:0.0k The Core Flight System (cFS) Housekeeping (HK) application.
- [nasa/HS](https://github.com/nasa/HS) topic: pushed_at:2022-12 star:0.0k fork:0.0k The Core Flight System (cFS) Health and Safety (HS) application.
...
- [nasa/MD](https://github.com/nasa/MD) topic: pushed_at:2022-12 star:0.0k fork:0.0k  The Core Flight System (cFS) Memory Dwell (MD) application.
...
- [nasa/MM](https://github.com/nasa/MM) topic: pushed_at:2022-12 star:0.0k fork:0.0k The Core Flight System (cFS) Memory Manager (MM) application.
- [nasa/Multi-Process-Proxy](https://github.com/nasa/Multi-Process-Proxy) topic: pushed_at:2022-12 star:0.0k fork:0.0k 
- [nasa/Multi-Process-Proxy-Client](https://github.com/nasa/Multi-Process-Proxy-Client) topic: pushed_at:2022-12 star:0.0k fork:0.0k 
- [nasa/Multi-Process-Proxy-Events](https://github.com/nasa/Multi-Process-Proxy-Events) topic: pushed_at:2022-12 star:0.0k fork:0.0k 
...
- [nasa/osal](https://github.com/nasa/osal) topic: pushed_at:2022-12 star:0.4k fork:0.2k The Core Flight System (cFS) Operating System Abstraction Layer (OSAL)
...
- [nasa/SC](https://github.com/nasa/SC) topic: pushed_at:2022-12 star:0.0k fork:0.0k The Core Flight System (cFS) Stored Commands (SC) application.
...
- [nasa/sch_lab](https://github.com/nasa/sch_lab) topic: pushed_at:2022-12 star:0.0k fork:0.0k The Core Flight System (cFS) Scheduler Lab App (sch_lab)
...
- [nasa/to_lab](https://github.com/nasa/to_lab) topic: pushed_at:2022-12 star:0.0k fork:0.0k The Core Flight System (cFS) Telemetry Output Lab App (to_lab)
...
- [nasa/gunns](https://github.com/nasa/gunns) topic: pushed_at:2022-12 star:0.0k fork:0.0k The NASA General-Use Nodal Network Solver (GUNNS) software
- [nasa/HDTN](https://github.com/nasa/HDTN) topic: pushed_at:2022-12 star:0.0k fork:0.0k 
...
- [nasa/isaac](https://github.com/nasa/isaac) topic: pushed_at:2022-12 star:0.0k fork:0.0k Integrated System for Autonomous and Adaptive Caretaking
...
- [nasa/ow_autonomy](https://github.com/nasa/ow_autonomy) topic: pushed_at:2022-12 star:0.0k fork:0.0k 
...
- [nasa/puma](https://github.com/nasa/puma) topic: pushed_at:2022-12 star:0.0k fork:0.0k 
...
- [nasa/cmr-stac](https://github.com/nasa/cmr-stac) topic: pushed_at:2022-12 star:0.0k fork:0.0k 
...
- [nasa/daidalus](https://github.com/nasa/daidalus) topic: pushed_at:2022-12 star:0.0k fork:0.0k open source release: LAR-19282-1 Detect and Avoid Alerting Logic for Unmanned Systems (DAIDALUS) with Dynamic Well-Clear Separation Volumes).
...
- [nasa/astrobee_android](https://github.com/nasa/astrobee_android) topic: pushed_at:2022-12 star:0.1k fork:0.0k NASA Astrobee Robot Software, Android
...
- [nasa/ziggy](https://github.com/nasa/ziggy) topic:algorithm,analysis,arc,data,data-analysis,data-reduction,java,k2,kepler,linux,macos,nasa,open-source,pipeline,science,tess,ziggy pushed_at:2022-12 star:0.0k fork:0.0k Ziggy, a portable, scalable infrastructure for science data processing pipelines, is the child of the Transiting Exoplanet Survey Satellite (TESS) pipeline and the grandchild of the Kepler Pipeline.
...
- [nasa/cmr-graphql](https://github.com/nasa/cmr-graphql) topic:earth-science,eosdis,gis,gsfc,hacktoberfest,nasa,open-source pushed_at:2022-12 star:0.0k fork:0.0k GraphQL interface for NASA's Common Metadata Repository (CMR).
...
- [nasa/cumulus-api](https://github.com/nasa/cumulus-api) topic:cumulus,nasa-cumulus pushed_at:2022-12 star:0.0k fork:0.0k Cumulus API Documentation
- [nasa/cumulus-dashboard](https://github.com/nasa/cumulus-dashboard) topic:cumulus,nasa-cumulus pushed_at:2022-12 star:0.1k fork:0.0k Cumulus API Dashboard
...
- [nasa/cumulus-ecs-task](https://github.com/nasa/cumulus-ecs-task) topic:cumulus,nasa-cumulus pushed_at:2022-12 star:0.0k fork:0.0k 
...
- [nasa/earthdata-search](https://github.com/nasa/earthdata-search) topic:data-discovery,earthdata-search,eosdis,hacktoberfest pushed_at:2022-12 star:0.7k fork:0.2k Earthdata Search is a web application developed by NASA EOSDIS to enable data discovery, search, comparison, visualization, and access across EOSDIS' Earth Science data holdings.
...
- [nasa/edsc-echoforms](https://github.com/nasa/edsc-echoforms) topic:earthdata-search,echo-forms,eosdis,hacktoberfest pushed_at:2022-12 star:0.0k fork:0.0k A React component implementing the ECHO Forms specification.
...
- [nasa/edsc-timeline](https://github.com/nasa/edsc-timeline) topic:earthdata-search,eosdis,timeline pushed_at:2022-12 star:0.0k fork:0.0k 
...
- [nasa/openmct-hello](https://github.com/nasa/openmct-hello) topic: pushed_at:2022-12 star:0.0k fork:0.0k Hello, world plugin repository for Open MCT.
...
- [nasa/opera-sds-bach-ui](https://github.com/nasa/opera-sds-bach-ui) topic: pushed_at:2022-12 star:0.0k fork:0.0k 
...
- [nasa/fmdtools](https://github.com/nasa/fmdtools) topic:fault-model,hazard-assessment,reliability,resilience,safety,simulation pushed_at:2022-12 star:0.0k fork:0.0k System Resilience Modelling, Simulation, and Assessment in Python
...
- [nasa/harmony-regression-tests](https://github.com/nasa/harmony-regression-tests) topic: pushed_at:2022-12 star:0.0k fork:0.0k 
...
- [nasa/Kamodo](https://github.com/nasa/Kamodo) topic: pushed_at:2022-12 star:0.0k fork:0.0k 
...
- [nasa/Plot3D_utilities](https://github.com/nasa/Plot3D_utilities) topic:computational-domain,mesh,mesh-generation,plot3d pushed_at:2022-12 star:0.0k fork:0.0k A Python library for reading, writing, finding connectivity for plot3d files
...
- [nasa/889-Compliance-SAM-Tool-](https://github.com/nasa/889-Compliance-SAM-Tool-) topic: pushed_at:2022-12 star:0.0k fork:0.0k  Determine Vendor 889 Compliance for Procurements Topic tags: #SAM.GOV API #889 compliance #Procurement #Purchase card SRA number: LAR-20069-1 
...
- [nasa/gesdisc-meditor](https://github.com/nasa/gesdisc-meditor) topic: pushed_at:2022-12 star:0.0k fork:0.0k 
...
- [nasa/upsp-processing](https://github.com/nasa/upsp-processing) topic: pushed_at:2022-12 star:0.0k fork:0.0k 
...
- [nasa/cape](https://github.com/nasa/cape) topic: pushed_at:2022-12 star:0.0k fork:0.0k Computational Aerosciences Productivity & Execution
...
- [nasa/dss](https://github.com/nasa/dss) topic: pushed_at:2022-12 star:0.0k fork:0.0k This repository contains the core software products of the InterUSS Platform: an implementation of the ASTM DSS concept for RID and flight coordination, and monitoring tools for federated UTM, including automated testing.
...
- [nasa/GlennOPT](https://github.com/nasa/GlennOPT) topic: pushed_at:2022-12 star:0.0k fork:0.0k Single and multi-objective optimization for computational simulations
...
- [nasa/harmony-gdal-adapter](https://github.com/nasa/harmony-gdal-adapter) topic: pushed_at:2022-12 star:0.0k fork:0.0k Translates Harmony service requests into gdal transformations
- [nasa/harmony-netcdf-to-zarr](https://github.com/nasa/harmony-netcdf-to-zarr) topic: pushed_at:2022-12 star:0.0k fork:0.0k Service for transforming NetCDF4 files into Zarr files within Harmony.  https://github.com/nasa/harmony
...
- [nasa/HyperInSPACE](https://github.com/nasa/HyperInSPACE) topic: pushed_at:2022-12 star:0.0k fork:0.0k 
...
- [nasa/opera-sds-lambdas](https://github.com/nasa/opera-sds-lambdas) topic: pushed_at:2022-12 star:0.0k fork:0.0k 
...
- [nasa/opera-sds-pge](https://github.com/nasa/opera-sds-pge) topic: pushed_at:2022-12 star:0.0k fork:0.0k Observational Products for End-Users from Remote Sensing Analysis (OPERA)
...
- [nasa/pbs4py](https://github.com/nasa/pbs4py) topic:batch-jobs,hpc,pbs pushed_at:2022-12 star:0.0k fork:0.0k Python utilities for submitting jobs on high performance computing systems
- [nasa/pigans-material-ID](https://github.com/nasa/pigans-material-ID) topic: pushed_at:2022-12 star:0.0k fork:0.0k 
...
- [nasa/prog_models](https://github.com/nasa/prog_models) topic:modeling,prognostic-models,prognostics,prognostics-health-management,simulation pushed_at:2022-12 star:0.1k fork:0.0k The NASA Prognostic Model Package is a Python framework focused on defining and building models for prognostics (computation of remaining useful life) of engineering systems, and provides a set of prognostics models for select components developed within this framework, suitable for use in prognostics applications for these components.
...
- [nasa/PROTEUS](https://github.com/nasa/PROTEUS) topic: pushed_at:2022-12 star:0.0k fork:0.0k PROTEUS - Parallelized Radar Optical Toolbox for Estimating dynamic sUrface water extentS
...
- [nasa/radbelt](https://github.com/nasa/radbelt) topic:cubesat,electron,heliophysics,igrf,magnetosphere,nasa,proton,radiation,satellite pushed_at:2022-12 star:0.0k fork:0.0k radbelt: An Astropy-friendly wrapper for the AE-8/AP-8 Van Allen belt model
...
- [nasa/cmr-opensearch](https://github.com/nasa/cmr-opensearch) topic: pushed_at:2022-12 star:0.0k fork:0.0k CMR-OpenSearch is a web application developed by NASA EOSDIS to enable data discovery, search, and access across the CMR Earth Science data holdings via the OpenSearch standard.
...
- [nasa/daa-displays](https://github.com/nasa/daa-displays) topic: pushed_at:2022-12 star:0.0k fork:0.0k 
- [nasa/harmony](https://github.com/nasa/harmony) topic: pushed_at:2022-12 star:0.0k fork:0.0k Application for providing services for Earth observation data in the cloud using standards-based APIs
- [nasa/vscode-pvs](https://github.com/nasa/vscode-pvs) topic: pushed_at:2022-12 star:0.0k fork:0.0k LAR-19642-1: Visual Studio Code Extension for PVS
