...
- [nasa/PRECiSA](https://github.com/nasa/PRECiSA) topic: pushed_at:2024-04 star:0.0k fork:0.0k Program Round-off Error Certifier via Static Analysis
...
- [nasa/fprime-gds](https://github.com/nasa/fprime-gds) topic: pushed_at:2024-05 star:0.0k fork:0.0k F´ Python Ground Data System (GDS).
...
- [nasa/Open-Source-Catalog](https://github.com/nasa/Open-Source-Catalog) topic:ai-tags,catalog,meta-record,nasa,open-source,website pushed_at:2024-04 star:0.3k fork:0.1k Contains the NASA open source software catalog for automatic deployment to code.nasa.gov
- [nasa/openmct](https://github.com/nasa/openmct) topic: pushed_at:2024-04 star:11.8k fork:1.2k A web based mission control framework. 
...
- [nasa/dorado-sensitivity](https://github.com/nasa/dorado-sensitivity) topic:astronomy,astropy,ccd,nasa,satellite,ultraviolet pushed_at:2024-04 star:0.0k fork:0.0k Dorado sensitivity and exposure time calculator
...
- [nasa/gesdisc-tutorials](https://github.com/nasa/gesdisc-tutorials) topic: pushed_at:2024-04 star:0.0k fork:0.0k 
...
- [nasa/HLS-Data-Resources](https://github.com/nasa/HLS-Data-Resources) topic:hls,lpdaac pushed_at:2024-04 star:0.0k fork:0.0k This repository provides guides, short how-tos, and tutorials to help users access and work with Harmonized Landsat Sentinel-2 (HLS) data.
...
- [nasa/pyturbo-aero](https://github.com/nasa/pyturbo-aero) topic: pushed_at:2024-04 star:0.0k fork:0.0k Turbomachinery Blade and Flow path design tool
...
- [nasa/harmony-py](https://github.com/nasa/harmony-py) topic: pushed_at:2024-04 star:0.0k fork:0.0k Python client library for working with NASA’s Earth observing system data using Harmony.  https://harmony.earthdata.nasa.gov
...
- [nasa/harmony-regridding-service](https://github.com/nasa/harmony-regridding-service) topic: pushed_at:2024-04 star:0.0k fork:0.0k 
...
- [nasa/svrstormsig](https://github.com/nasa/svrstormsig) topic: pushed_at:2024-04 star:0.0k fork:0.0k 
...
- [nasa/spotthestation](https://github.com/nasa/spotthestation) topic: pushed_at:2024-04 star:0.0k fork:0.0k Spot The Station Application Code Rep
