...
- [nasa/cFS](https://github.com/nasa/cFS) topic: pushed_at:2026-06 star:1.4k fork:0.4k The Core Flight System (cFS)
...
- [nasa/ci_lab](https://github.com/nasa/ci_lab) topic: pushed_at:2026-05 star:0.0k fork:0.0k The Core Flight System (cFS) Command Ingest Lab App (ci_lab)
...
- [nasa/CryptoLib](https://github.com/nasa/CryptoLib) topic:ccsds,cfs,communications,data-link,ground-station,sdls-ep,space-communications,space-data-link-security-protocol,space-network,spack-data-link pushed_at:2026-05 star:0.2k fork:0.1k Provide a software-only solution using the CCSDS Space Data Link Security Protocol - Extended Procedures (SDLS-EP) to secure communications between a spacecraft running the core Flight System (cFS) and a ground station.
...
- [nasa/nos3](https://github.com/nasa/nos3) topic:42,cfs,cosmos,digital-twin,nasa,nos,nos3,simulator pushed_at:2026-06 star:0.6k fork:0.1k NASA Operational Simulator for Space Systems
...
- [nasa/SBN](https://github.com/nasa/SBN) topic: pushed_at:2026-05 star:0.0k fork:0.0k 
...
- [nasa/cml](https://github.com/nasa/cml) topic: pushed_at:2026-06 star:0.0k fork:0.0k The Common Model Library. CML provides a collection of generic, verified, validated, and reusable C++ models of spacecraft that are compatible with NASA's Trick Simulation Environment.
...
- [nasa/DdsJs](https://github.com/nasa/DdsJs) topic: pushed_at:2025-03 star:0.0k fork:0.0k 
...
- [nasa/fprime](https://github.com/nasa/fprime) topic:components,cpp,embedded,embedded-systems,flight,flight-software,fprime,framework,nasa,object-oriented-programming,raspberry-pi,real-time,spaceflight pushed_at:2026-06 star:11.0k fork:1.6k F´ - A flight software and embedded systems framework
...
- [nasa/IDF](https://github.com/nasa/IDF) topic: pushed_at:2026-05 star:0.1k fork:0.0k 
...
- [nasa/trick](https://github.com/nasa/trick) topic: pushed_at:2026-06 star:0.1k fork:0.1k Trick Simulation Environment.  Trick provides a common set of simulation capabilities and utilities to build simulations automatically.
...
- [nasa/TrickHLA](https://github.com/nasa/TrickHLA) topic: pushed_at:2026-06 star:0.1k fork:0.0k TrickHLA: An IEEE 1516 High Level Architecture (HLA) Simulation Interoperability Standard Implementation for Trick Base Simulations
...
- [nasa/Common-Metadata-Repository](https://github.com/nasa/Common-Metadata-Repository) topic:common-metadata-repository,eosdis pushed_at:2026-06 star:0.4k fork:0.1k 
...
- [nasa/PWOM](https://github.com/nasa/PWOM) topic: pushed_at:2025-09 star:0.0k fork:0.0k 
...
- [nasa/cumulus-api](https://github.com/nasa/cumulus-api) topic:cumulus,nasa-cumulus pushed_at:2026-04 star:0.0k fork:0.0k Cumulus API Documentation
...
- [nasa/GeneLab-Training](https://github.com/nasa/GeneLab-Training) topic:education,genes,genetics,nasa,outreach,pipeline,training,training-materials pushed_at:2026-03 star:0.0k fork:0.0k A repository for GeneLab Training documentation.
...
- [nasa/opera-sds](https://github.com/nasa/opera-sds) topic: pushed_at:2026-06 star:0.0k fork:0.0k 
- [nasa/opera-sds-ops](https://github.com/nasa/opera-sds-ops) topic: pushed_at:2026-06 star:0.0k fork:0.0k 
...
- [nasa/opera-sds-bach-ui](https://github.com/nasa/opera-sds-bach-ui) topic: pushed_at:2026-05 star:0.0k fork:0.0k 
...
- [nasa/AppEEARS-Data-Resources](https://github.com/nasa/AppEEARS-Data-Resources) topic:appeears,lpdaac pushed_at:2026-04 star:0.0k fork:0.0k  This repository provides resources and tutorials to help users work with AppEEARS programmatically.
...
- [nasa/GeneLab_Data_Processing](https://github.com/nasa/GeneLab_Data_Processing) topic:genelab,genes,genetics,omics,osdr,pipeline pushed_at:2026-04 star:0.1k fork:0.1k Standard bioinformatics pipelines for omics data from spaceflight and space-relevant experiments.
...
- [nasa/HLS-Data-Resources](https://github.com/nasa/HLS-Data-Resources) topic:hls,lpdaac pushed_at:2026-05 star:0.1k fork:0.0k This repository provides guides, short how-tos, and tutorials to help users access and work with Harmonized Landsat Sentinel-2 (HLS) data.
...
- [nasa/Kamodo](https://github.com/nasa/Kamodo) topic: pushed_at:2026-05 star:0.1k fork:0.0k 
...
- [nasa/oceandata-notebooks](https://github.com/nasa/oceandata-notebooks) topic:nasa-pace pushed_at:2026-05 star:0.0k fork:0.0k Tutorials for OB.DAAC data
...
- [nasa/VITALS](https://github.com/nasa/VITALS) topic:ecostress,emit,lpdaac pushed_at:2026-04 star:0.1k fork:0.1k This repository provides Python Jupyter notebook examples to help users work with VSWIR and TIR data from the EMIT and ECOSTRESS missions.
...
- [nasa/apod-api](https://github.com/nasa/apod-api) topic:apod-api,apod-image,apod-parser,astronomy,astronomy-photo,astronomy-picture,astronomy-picture-of-the-day,nasa,nasa-api,space pushed_at:2026-05 star:1.1k fork:0.2k Astronomy Picture of the Day API service
...
- [nasa/condor](https://github.com/nasa/condor) topic: pushed_at:2026-04 star:0.1k fork:0.0k NASA's Condor is a framework for mathematical modeling of engineering systems in Python, for engineers with deadlines.
...
- [nasa/harmony-casper](https://github.com/nasa/harmony-casper) topic: pushed_at:2026-06 star:0.0k fork:0.0k 
...
- [nasa/opera-sds-bach-api](https://github.com/nasa/opera-sds-bach-api) topic: pushed_at:2026-05 star:0.0k fork:0.0k 
...
- [nasa/pbs4py](https://github.com/nasa/pbs4py) topic:batch-jobs,hpc,pbs pushed_at:2026-02 star:0.0k fork:0.0k Python utilities for submitting jobs on high performance computing systems
...
- [nasa/hermes](https://github.com/nasa/hermes) topic:commanding,flight-software,ground-station,telemetry pushed_at:2026-05 star:0.0k fork:0.0k A lightweight extensible spacecraft commanding & telemetry processing framework
...
- [nasa/vscode-pvs](https://github.com/nasa/vscode-pvs) topic: pushed_at:2026-05 star:0.1k fork:0.0k LAR-19642-1: Visual Studio Code Extension for PVS
