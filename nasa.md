...
- [nasa/CF](https://github.com/nasa/CF) topic: pushed_at:2026-01 star:0.1k fork:0.1k The Core Flight System (cFS) CFDP application.
- [nasa/cFE](https://github.com/nasa/cFE) topic: pushed_at:2026-03 star:0.5k fork:0.2k The Core Flight System (cFS) Core Flight Executive (cFE)
- [nasa/cfs-commandline-tools](https://github.com/nasa/cfs-commandline-tools) topic: pushed_at:2026-01 star:0.0k fork:0.0k 
...
- [nasa/ci_lab](https://github.com/nasa/ci_lab) topic: pushed_at:2026-01 star:0.0k fork:0.0k The Core Flight System (cFS) Command Ingest Lab App (ci_lab)
...
- [nasa/CryptoLib](https://github.com/nasa/CryptoLib) topic:ccsds,cfs,communications,data-link,ground-station,sdls-ep,space-communications,space-data-link-security-protocol,space-network,spack-data-link pushed_at:2026-03 star:0.1k fork:0.1k Provide a software-only solution using the CCSDS Space Data Link Security Protocol - Extended Procedures (SDLS-EP) to secure communications between a spacecraft running the core Flight System (cFS) and a ground station.
- [nasa/CS](https://github.com/nasa/CS) topic: pushed_at:2026-01 star:0.0k fork:0.0k The Core Flight System (cFS) Checksum (CS) application.
- [nasa/DS](https://github.com/nasa/DS) topic: pushed_at:2026-01 star:0.0k fork:0.0k The Core Flight System (cFS) Data Storage (DS) application.
...
- [nasa/EdsLib](https://github.com/nasa/EdsLib) topic: pushed_at:2026-01 star:0.0k fork:0.0k CCSDS SOIS Electronic Data Sheet Tool and Library
- [nasa/eefs](https://github.com/nasa/eefs) topic: pushed_at:2024-08 star:0.3k fork:0.1k EEPROM File System
- [nasa/elf2cfetbl](https://github.com/nasa/elf2cfetbl) topic: pushed_at:2026-01 star:0.0k fork:0.0k The Core Flight System (cFS) ELF to CFE Table Tool (elf2cfetbl)
- [nasa/FM](https://github.com/nasa/FM) topic: pushed_at:2026-01 star:0.0k fork:0.0k The Core Flight System (cFS) File Manager (FM) application.
...
- [nasa/HK](https://github.com/nasa/HK) topic: pushed_at:2026-01 star:0.0k fork:0.0k The Core Flight System (cFS) Housekeeping (HK) application.
- [nasa/HS](https://github.com/nasa/HS) topic: pushed_at:2026-01 star:0.0k fork:0.0k The Core Flight System (cFS) Health and Safety (HS) application.
...
- [nasa/LC](https://github.com/nasa/LC) topic: pushed_at:2026-02 star:0.0k fork:0.0k The Core Flight System (cFS) Limit Checker (LC) application.
- [nasa/MD](https://github.com/nasa/MD) topic: pushed_at:2026-01 star:0.0k fork:0.0k  The Core Flight System (cFS) Memory Dwell (MD) application.
...
- [nasa/MM](https://github.com/nasa/MM) topic: pushed_at:2026-03 star:0.0k fork:0.0k The Core Flight System (cFS) Memory Manager (MM) application.
...
- [nasa/nos3](https://github.com/nasa/nos3) topic:42,cfs,cosmos,digital-twin,nasa,nos,nos3,simulator pushed_at:2026-03 star:0.6k fork:0.1k NASA Operational Simulator for Space Systems
- [nasa/osal](https://github.com/nasa/osal) topic: pushed_at:2026-01 star:0.6k fork:0.3k The Core Flight System (cFS) Operating System Abstraction Layer (OSAL)
- [nasa/PSP](https://github.com/nasa/PSP) topic: pushed_at:2026-01 star:0.1k fork:0.1k The Core Flight System (cFS) Platform Support Package (PSP)
...
- [nasa/sample_app](https://github.com/nasa/sample_app) topic: pushed_at:2026-01 star:0.1k fork:0.1k The Core Flight System (cFS) Sample App (sample_app)
- [nasa/sample_lib](https://github.com/nasa/sample_lib) topic: pushed_at:2026-01 star:0.0k fork:0.0k The Core Flight System (cFS) Sample Library (sample_lib)
- [nasa/SBN](https://github.com/nasa/SBN) topic: pushed_at:2026-01 star:0.0k fork:0.0k 
...
- [nasa/SC](https://github.com/nasa/SC) topic: pushed_at:2026-01 star:0.0k fork:0.0k The Core Flight System (cFS) Stored Commands (SC) application.
...
- [nasa/sch_lab](https://github.com/nasa/sch_lab) topic: pushed_at:2026-01 star:0.0k fork:0.0k The Core Flight System (cFS) Scheduler Lab App (sch_lab)
...
- [nasa/tblCRCTool](https://github.com/nasa/tblCRCTool) topic: pushed_at:2026-01 star:0.0k fork:0.0k The Core Flight System (cFS) Table CRC Tool (tblCRCTool)
- [nasa/to_lab](https://github.com/nasa/to_lab) topic: pushed_at:2026-01 star:0.0k fork:0.1k The Core Flight System (cFS) Telemetry Output Lab App (to_lab)
...
- [nasa/dcapp](https://github.com/nasa/dcapp) topic: pushed_at:2026-03 star:0.0k fork:0.0k A lightweight XML-based framework for building real-time display applications and cockpit interfaces.
...
- [nasa/fprime](https://github.com/nasa/fprime) topic:components,cpp,embedded,embedded-systems,flight,flight-software,fprime,framework,nasa,object-oriented-programming,raspberry-pi,real-time,spaceflight pushed_at:2026-04 star:10.8k fork:1.5k F´ - A flight software and embedded systems framework
- [nasa/fprime-examples](https://github.com/nasa/fprime-examples) topic: pushed_at:2026-02 star:0.0k fork:0.0k A repository for storing examples called out in the F Prime documentation
- [nasa/gigatraj](https://github.com/nasa/gigatraj) topic: pushed_at:2026-03 star:0.0k fork:0.0k 
...
- [nasa/gunns](https://github.com/nasa/gunns) topic: pushed_at:2026-03 star:0.1k fork:0.0k The NASA General-Use Nodal Network Solver (GUNNS) software
- [nasa/harmony-trajectory-subsetter](https://github.com/nasa/harmony-trajectory-subsetter) topic: pushed_at:2026-03 star:0.0k fork:0.0k 
...
- [nasa/IDF](https://github.com/nasa/IDF) topic: pushed_at:2026-03 star:0.1k fork:0.0k 
...
- [nasa/koviz](https://github.com/nasa/koviz) topic: pushed_at:2026-03 star:0.0k fork:0.0k Koviz is a Trick simulation data plotting, visualization and analysis tool
...
- [nasa/trick](https://github.com/nasa/trick) topic: pushed_at:2026-03 star:0.1k fork:0.1k Trick Simulation Environment.  Trick provides a common set of simulation capabilities and utilities to build simulations automatically.
...
- [nasa/cFS](https://github.com/nasa/cFS) topic: pushed_at:2026-01 star:1.2k fork:0.3k The Core Flight System (cFS)
...
- [nasa/Common-Metadata-Repository](https://github.com/nasa/Common-Metadata-Repository) topic:common-metadata-repository,eosdis pushed_at:2026-03 star:0.4k fork:0.1k 
...
- [nasa/rbf](https://github.com/nasa/rbf) topic: pushed_at:2026-03 star:0.0k fork:0.0k Mode shape interpolation via radial basis functions
...
- [nasa/cumulus-template-deploy](https://github.com/nasa/cumulus-template-deploy) topic:cumulus,nasa-cumulus pushed_at:2026-03 star:0.0k fork:0.0k Cumulus template deployment project
...
- [nasa/cumulus-api](https://github.com/nasa/cumulus-api) topic:cumulus,nasa-cumulus pushed_at:2026-03 star:0.0k fork:0.0k Cumulus API Documentation
...
- [nasa/fmdtools](https://github.com/nasa/fmdtools) topic:fault-model,hazard-assessment,reliability,resilience,safety,simulation pushed_at:2026-03 star:0.1k fork:0.0k System Resilience Modelling, Simulation, and Assessment in Python
...
- [nasa/opera-sds-ops](https://github.com/nasa/opera-sds-ops) topic: pushed_at:2026-03 star:0.0k fork:0.0k 
...
- [nasa/PLEXIL5](https://github.com/nasa/PLEXIL5) topic: pushed_at:2026-03 star:0.0k fork:0.0k PLEXIL5 is a Formal Verification Environment for PLEXIL
...
- [nasa/cmr-graphql](https://github.com/nasa/cmr-graphql) topic:earth-science,eosdis,gis,gsfc,hacktoberfest,nasa,open-source pushed_at:2026-03 star:0.0k fork:0.0k GraphQL interface for NASA's Common Metadata Repository (CMR).
...
- [nasa/cumulus](https://github.com/nasa/cumulus) topic:cumulus,nasa-cumulus pushed_at:2026-03 star:0.3k fork:0.1k Cumulus Framework + Cumulus API
- [nasa/cumulus-dashboard](https://github.com/nasa/cumulus-dashboard) topic:cumulus,nasa-cumulus pushed_at:2026-03 star:0.1k fork:0.0k Cumulus API Dashboard
...
- [nasa/cumulus-message-adapter-js](https://github.com/nasa/cumulus-message-adapter-js) topic:cumulus,nasa-cumulus pushed_at:2026-03 star:0.0k fork:0.0k A library for validating and parsing the Cumulus message protocol
- [nasa/earthdata-search](https://github.com/nasa/earthdata-search) topic:data-discovery,earthdata-search,eosdis,hacktoberfest pushed_at:2026-04 star:0.8k fork:0.2k Earthdata Search is a web application developed by NASA EOSDIS to enable data discovery, search, comparison, visualization, and access across EOSDIS' Earth Science data holdings.
...
- [nasa/fprime-gds](https://github.com/nasa/fprime-gds) topic: pushed_at:2026-03 star:0.0k fork:0.1k F´ Python Ground Data System (GDS).
...
- [nasa/openmct](https://github.com/nasa/openmct) topic: pushed_at:2026-03 star:12.9k fork:1.4k A web based mission control framework. 
...
- [nasa/AI4LS](https://github.com/nasa/AI4LS) topic: pushed_at:2026-03 star:0.0k fork:0.0k The Artificial Intelligence for Life in Space (AI4LS) team at NASA Ames uses artificial intelligence and machine learning to support and advance space exploration. This repository contains code for ongoing and completed projects.  SRA#ARC-18915-1
- [nasa/AppEEARS-Data-Resources](https://github.com/nasa/AppEEARS-Data-Resources) topic:appeears,lpdaac pushed_at:2025-11 star:0.0k fork:0.0k  This repository provides resources and tutorials to help users work with AppEEARS programmatically.
- [nasa/ASDC_Data_and_User_Services](https://github.com/nasa/ASDC_Data_and_User_Services) topic: pushed_at:2026-03 star:0.0k fork:0.0k Tutorials for missions conducted by the Atmospheric Science Data Center (ASDC)
- [nasa/ASTER-Data-Resources](https://github.com/nasa/ASTER-Data-Resources) topic:aster,cmr,gis,lpdaac,nasa,nasa-data,open-science,openscience,remote-sensing,umm pushed_at:2026-02 star:0.0k fork:0.0k This repository provides guides, short how-tos, and tutorials to help users access and work with ASTER data.
...
- [nasa/GeneLab_Data_Processing](https://github.com/nasa/GeneLab_Data_Processing) topic:genelab,genes,genetics,omics,osdr,pipeline pushed_at:2026-03 star:0.1k fork:0.1k Standard bioinformatics pipelines for omics data from spaceflight and space-relevant experiments.
- [nasa/gesdisc-cloud-tutorials](https://github.com/nasa/gesdisc-cloud-tutorials) topic: pushed_at:2024-06 star:0.0k fork:0.0k 
- [nasa/gesdisc-tutorials](https://github.com/nasa/gesdisc-tutorials) topic: pushed_at:2026-03 star:0.1k fork:0.0k 
...
- [nasa/GlennOPT](https://github.com/nasa/GlennOPT) topic: pushed_at:2025-04 star:0.0k fork:0.0k Single and multi-objective optimization for computational simulations
- [nasa/harmony-regression-tests](https://github.com/nasa/harmony-regression-tests) topic: pushed_at:2026-03 star:0.0k fork:0.0k 
...
- [nasa/kms](https://github.com/nasa/kms) topic: pushed_at:2026-03 star:0.0k fork:0.0k 
...
- [nasa/LPDAAC-Data-Resources](https://github.com/nasa/LPDAAC-Data-Resources) topic:lpdaac pushed_at:2026-03 star:0.1k fork:0.0k This repository is a place to find data user resources that demonstrate how to use LP DAAC tools, services, and data.
...
- [nasa/Plot3D_utilities](https://github.com/nasa/Plot3D_utilities) topic:computational-domain,mesh,mesh-generation,plot3d pushed_at:2026-03 star:0.1k fork:0.0k A Python library for reading, writing, finding connectivity for plot3d files
...
- [nasa/turbo-design](https://github.com/nasa/turbo-design) topic: pushed_at:2026-03 star:0.1k fork:0.0k Radial Equilibrium Code to design Turbomachinery
...
- [nasa/CARA_Analysis_Tools](https://github.com/nasa/CARA_Analysis_Tools) topic: pushed_at:2026-03 star:0.1k fork:0.0k 
...
- [nasa/GeneLab_Metagenomics_Workflow](https://github.com/nasa/GeneLab_Metagenomics_Workflow) topic:genelab,genomics,metagenomics,nextflow,workflow pushed_at:2026-03 star:0.0k fork:0.0k Nextflow implementation of the GeneLab Metagenomics data processing pipelines.
...
- [nasa/GMAT](https://github.com/nasa/GMAT) topic: pushed_at:2026-03 star:0.0k fork:0.0k 
...
- [nasa/NASA-3D-Resources](https://github.com/nasa/NASA-3D-Resources) topic: pushed_at:2025-06 star:3.5k fork:0.5k Here you'll find a growing collection of 3D models, textures, and images from inside NASA.
...
- [nasa/Open-Source-Catalog](https://github.com/nasa/Open-Source-Catalog) topic:ai-tags,catalog,meta-record,nasa,open-source,website pushed_at:2026-03 star:0.3k fork:0.1k Contains the NASA open source software catalog for automatic deployment to code.nasa.gov
...
- [nasa/apod-api](https://github.com/nasa/apod-api) topic:apod-api,apod-image,apod-parser,astronomy,astronomy-photo,astronomy-picture,astronomy-picture-of-the-day,nasa,nasa-api,space pushed_at:2026-03 star:1.0k fork:0.2k Astronomy Picture of the Day API service
...
- [nasa/batchee](https://github.com/nasa/batchee) topic:asdc,batching,filenames,grouping pushed_at:2026-03 star:0.0k fork:0.0k NASA Harmony service that groups together files into batches for concatenation
...
- [nasa/cfs-cosmos-plugin](https://github.com/nasa/cfs-cosmos-plugin) topic: pushed_at:2026-02 star:0.0k fork:0.0k 
- [nasa/cFS-EDS-GroundStation](https://github.com/nasa/cFS-EDS-GroundStation) topic: pushed_at:2021-11 star:0.0k fork:0.0k 
- [nasa/cFS-GroundSystem](https://github.com/nasa/cFS-GroundSystem) topic: pushed_at:2026-01 star:0.1k fork:0.1k The Core Flight System (cFS) Ground System Lab Tool (cFS-GroundSystem)
...
- [nasa/condor](https://github.com/nasa/condor) topic: pushed_at:2026-03 star:0.1k fork:0.0k NASA's Condor is a framework for mathematical modeling of engineering systems in Python, for engineers with deadlines.
...
- [nasa/cumulus-message-adapter](https://github.com/nasa/cumulus-message-adapter) topic:cumulus,nasa-cumulus pushed_at:2025-09 star:0.0k fork:0.0k A command-line interface for preparing and outputting Cumulus Messages for Cumulus Tasks
...
- [nasa/earthdata-hashdiff](https://github.com/nasa/earthdata-hashdiff) topic: pushed_at:2026-03 star:0.0k fork:0.0k 
- [nasa/earthdata-mcp](https://github.com/nasa/earthdata-mcp) topic: pushed_at:2026-03 star:0.0k fork:0.0k 
- [nasa/earthdata-varinfo](https://github.com/nasa/earthdata-varinfo) topic: pushed_at:2026-03 star:0.0k fork:0.0k 
...
- [nasa/fprime-tools](https://github.com/nasa/fprime-tools) topic: pushed_at:2026-03 star:0.0k fork:0.1k F´ Python tooling and helpers.
...
- [nasa/harmony-autotester](https://github.com/nasa/harmony-autotester) topic: pushed_at:2026-03 star:0.0k fork:0.0k 
- [nasa/harmony-browse-image-generator](https://github.com/nasa/harmony-browse-image-generator) topic: pushed_at:2026-03 star:0.0k fork:0.0k 
- [nasa/harmony-casper](https://github.com/nasa/harmony-casper) topic: pushed_at:2026-04 star:0.0k fork:0.0k 
- [nasa/harmony-filtering-service](https://github.com/nasa/harmony-filtering-service) topic: pushed_at:2026-03 star:0.0k fork:0.0k 
- [nasa/harmony-gdal-adapter](https://github.com/nasa/harmony-gdal-adapter) topic: pushed_at:2026-03 star:0.0k fork:0.0k Translates Harmony service requests into gdal transformations
- [nasa/harmony-maskfill](https://github.com/nasa/harmony-maskfill) topic: pushed_at:2026-03 star:0.0k fork:0.0k 
- [nasa/harmony-metadata-annotator](https://github.com/nasa/harmony-metadata-annotator) topic: pushed_at:2026-03 star:0.0k fork:0.0k 
...
- [nasa/harmony-opendap-subsetter](https://github.com/nasa/harmony-opendap-subsetter) topic: pushed_at:2026-03 star:0.0k fork:0.0k 
- [nasa/harmony-py](https://github.com/nasa/harmony-py) topic: pushed_at:2026-02 star:0.1k fork:0.0k Python client library for working with NASA’s Earth observing system data using Harmony.  https://harmony.earthdata.nasa.gov
...
- [nasa/harmony-regridding-service](https://github.com/nasa/harmony-regridding-service) topic: pushed_at:2026-03 star:0.0k fork:0.0k 
...
- [nasa/harmony-SMAP-L2-gridding-service](https://github.com/nasa/harmony-SMAP-L2-gridding-service) topic: pushed_at:2026-03 star:0.0k fork:0.0k 
- [nasa/harmony-swath-projector](https://github.com/nasa/harmony-swath-projector) topic: pushed_at:2026-03 star:0.0k fork:0.0k 
...
- [nasa/HyperCP](https://github.com/nasa/HyperCP) topic: pushed_at:2026-03 star:0.1k fork:0.0k 
...
- [nasa/nasmat-prepost](https://github.com/nasa/nasmat-prepost) topic: pushed_at:2026-03 star:0.0k fork:0.0k 
- [nasa/ncompare](https://github.com/nasa/ncompare) topic:data-comparison,hierarchical-data,netcdf pushed_at:2026-03 star:0.0k fork:0.0k Compare the structure of two netCDF (or HDF5) files
- [nasa/OnAIR](https://github.com/nasa/OnAIR) topic: pushed_at:2025-10 star:0.1k fork:0.0k The On-board Artificial Intelligence Research (OnAIR) Platform is a framework that enables AI algorithms written in Python to interact with NASA's cFS. It is intended to explore research concepts in autonomous operations in a simulated environment. 
...
- [nasa/opera-sds-pcm](https://github.com/nasa/opera-sds-pcm) topic: pushed_at:2026-03 star:0.0k fork:0.0k Observational Products for End-Users from Remote Sensing Analysis (OPERA)
- [nasa/opera-sds-pge](https://github.com/nasa/opera-sds-pge) topic: pushed_at:2026-03 star:0.0k fork:0.0k Observational Products for End-Users from Remote Sensing Analysis (OPERA)
...
- [nasa/OSDR_Tutorials](https://github.com/nasa/OSDR_Tutorials) topic: pushed_at:2025-10 star:0.0k fork:0.0k 
...
- [nasa/pyDownlinkParser](https://github.com/nasa/pyDownlinkParser) topic:ccsds,ccsdspy pushed_at:2025-09 star:0.0k fork:0.0k Parse downlinks binary file following CCSDS standard, primarily for Europa-Clipper Science Data System.
...
- [nasa/python_cmr](https://github.com/nasa/python_cmr) topic: pushed_at:2025-12 star:0.0k fork:0.0k Python library for querying the common metadata repository.
...
- [nasa/ROSES-Compliance-Checking-Tools](https://github.com/nasa/ROSES-Compliance-Checking-Tools) topic: pushed_at:2026-03 star:0.0k fork:0.0k 
...
- [nasa/stitchee](https://github.com/nasa/stitchee) topic:asdc,concatenation,data-combination,netcdf pushed_at:2026-03 star:0.0k fork:0.0k NASA Harmony service that concatenates netCDF4 data files along an existing dimension
...
- [nasa/cmr-opensearch](https://github.com/nasa/cmr-opensearch) topic: pushed_at:2026-03 star:0.0k fork:0.0k CMR-OpenSearch is a web application developed by NASA EOSDIS to enable data discovery, search, and access across the CMR Earth Science data holdings via the OpenSearch standard.
...
- [nasa/fpp](https://github.com/nasa/fpp) topic: pushed_at:2026-03 star:0.1k fork:0.1k F Prime Prime: A modeling language for F Prime
...
- [nasa/cmr-stac](https://github.com/nasa/cmr-stac) topic: pushed_at:2026-03 star:0.1k fork:0.0k 
- [nasa/coda](https://github.com/nasa/coda) topic: pushed_at:2026-03 star:0.0k fork:0.0k 
...
- [nasa/harmony](https://github.com/nasa/harmony) topic: pushed_at:2026-03 star:0.1k fork:0.1k Application for providing services for Earth observation data in the cloud using standards-based APIs
...
- [nasa/spotthestation](https://github.com/nasa/spotthestation) topic: pushed_at:2025-02 star:0.0k fork:0.0k Spot The Station Application Code Rep
- [nasa/terra-ui-components](https://github.com/nasa/terra-ui-components) topic: pushed_at:2026-03 star:0.0k fork:0.0k 
- [nasa/vscode-pvs](https://github.com/nasa/vscode-pvs) topic: pushed_at:2025-12 star:0.0k fork:0.0k LAR-19642-1: Visual Studio Code Extension for PVS
