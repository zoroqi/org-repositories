...
- [nasa/ci_lab](https://github.com/nasa/ci_lab) topic: pushed_at:2026-06 star:0.0k fork:0.0k The Core Flight System (cFS) Command Ingest Lab App (ci_lab)
...
- [nasa/CryptoLib](https://github.com/nasa/CryptoLib) topic:ccsds,cfs,communications,data-link,ground-station,sdls-ep,space-communications,space-data-link-security-protocol,space-network,spack-data-link pushed_at:2026-07 star:0.2k fork:0.1k Provide a software-only solution using the CCSDS Space Data Link Security Protocol - Extended Procedures (SDLS-EP) to secure communications between a spacecraft running the core Flight System (cFS) and a ground station.
...
- [nasa/EdsLib](https://github.com/nasa/EdsLib) topic: pushed_at:2026-07 star:0.0k fork:0.0k CCSDS SOIS Electronic Data Sheet Tool and Library
...
- [nasa/MD](https://github.com/nasa/MD) topic: pushed_at:2026-07 star:0.0k fork:0.0k  The Core Flight System (cFS) Memory Dwell (MD) application.
...
- [nasa/SBN](https://github.com/nasa/SBN) topic: pushed_at:2026-07 star:0.0k fork:0.0k 
...
- [nasa/gunns](https://github.com/nasa/gunns) topic: pushed_at:2026-07 star:0.1k fork:0.0k The NASA General-Use Nodal Network Solver (GUNNS) software
...
- [nasa/sgdass](https://github.com/nasa/sgdass) topic:astronomy,data-analysis,geodesy,geophysics,vlbi-analysis pushed_at:2026-05 star:0.0k fork:0.0k Space geodesy data analysis software suite
...
- [nasa/cmr-graphql](https://github.com/nasa/cmr-graphql) topic:earth-science,eosdis,gis,gsfc,hacktoberfest,nasa,open-source pushed_at:2026-07 star:0.0k fork:0.0k GraphQL interface for NASA's Common Metadata Repository (CMR).
...
- [nasa/cumulus-dashboard](https://github.com/nasa/cumulus-dashboard) topic:cumulus,nasa-cumulus pushed_at:2026-05 star:0.1k fork:0.0k Cumulus API Dashboard
...
- [nasa/mmt](https://github.com/nasa/mmt) topic: pushed_at:2026-07 star:0.1k fork:0.0k NASA's Metadata Management Tool.
...
- [nasa/ECOSTRESS-Data-Resources](https://github.com/nasa/ECOSTRESS-Data-Resources) topic:ecostress,lpdaac pushed_at:2025-09 star:0.0k fork:0.0k How to find, access, and work with ECOSTRESS (ECOsystem Spaceborne Thermal Radiometer Experiment on Space Station) Data.
...
- [nasa/Kamodo](https://github.com/nasa/Kamodo) topic: pushed_at:2026-08 star:0.1k fork:0.0k 
...
- [nasa/Plot3D_utilities](https://github.com/nasa/Plot3D_utilities) topic:computational-domain,mesh,mesh-generation,plot3d pushed_at:2026-07 star:0.1k fork:0.0k A Python library for reading, writing, finding connectivity for plot3d files
...
- [nasa/turbo-design](https://github.com/nasa/turbo-design) topic: pushed_at:2026-07 star:0.1k fork:0.0k Radial Equilibrium Code to design Turbomachinery
...
- [nasa/cape-doc](https://github.com/nasa/cape-doc) topic: pushed_at:2025-09 star:0.0k fork:0.0k 
...
- [nasa/NASA-3D-Resources](https://github.com/nasa/NASA-3D-Resources) topic: pushed_at:2025-06 star:3.7k fork:0.5k Here you'll find a growing collection of 3D models, textures, and images from inside NASA.
...
- [nasa/AMMPER](https://github.com/nasa/AMMPER) topic: pushed_at:2025-07 star:0.0k fork:0.0k 
...
- [nasa/cape](https://github.com/nasa/cape) topic: pushed_at:2026-07 star:0.0k fork:0.0k Computational Aerosciences Productivity & Execution
...
- [nasa/cfs-cosmos-plugin](https://github.com/nasa/cfs-cosmos-plugin) topic: pushed_at:2026-07 star:0.0k fork:0.0k 
...
- [nasa/harmony-casper](https://github.com/nasa/harmony-casper) topic: pushed_at:2026-08 star:0.0k fork:0.0k 
...
- [nasa/Kamodo-core](https://github.com/nasa/Kamodo-core) topic: pushed_at:2026-08 star:0.0k fork:0.0k 
...
- [nasa/opera-sds-pge](https://github.com/nasa/opera-sds-pge) topic: pushed_at:2026-07 star:0.0k fork:0.0k Observational Products for End-Users from Remote Sensing Analysis (OPERA)
...
- [nasa/OSDR_Tutorials](https://github.com/nasa/OSDR_Tutorials) topic: pushed_at:2026-04 star:0.0k fork:0.0k 
...
- [nasa/python_cmr](https://github.com/nasa/python_cmr) topic: pushed_at:2026-07 star:0.0k fork:0.0k Python library for querying the common metadata repository.
