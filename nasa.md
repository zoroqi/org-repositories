...
- [nasa/bp](https://github.com/nasa/bp) topic: pushed_at:2022-10 star:0.0k fork:0.0k The Bundle Protocol Core Flight System Application (BP) License: Apache-2.0
- [nasa/bplib](https://github.com/nasa/bplib) topic: pushed_at:2022-10 star:0.0k fork:0.0k 
- [nasa/CF](https://github.com/nasa/CF) topic: pushed_at:2022-10 star:0.0k fork:0.0k The Core Flight System (cFS) CFDP application.
- [nasa/cFE](https://github.com/nasa/cFE) topic: pushed_at:2022-10 star:0.3k fork:0.2k The Core Flight System (cFS) Core Flight Executive (cFE)
...
- [nasa/ci_lab](https://github.com/nasa/ci_lab) topic: pushed_at:2022-10 star:0.0k fork:0.0k The Core Flight System (cFS) Command Ingest Lab App (ci_lab)
...
- [nasa/CryptoLib](https://github.com/nasa/CryptoLib) topic:ccsds,cfs,communications,data-link,ground-station,sdls-ep,space-communications,space-data-link-security-protocol,space-network,spack-data-link pushed_at:2022-09 star:0.0k fork:0.0k Provide a software-only solution using the CCSDS Space Data Link Security Protocol - Extended Procedures (SDLS-EP) to secure communications between a spacecraft running the core Flight System (cFS) and a ground station.
- [nasa/CS](https://github.com/nasa/CS) topic: pushed_at:2022-10 star:0.0k fork:0.0k The Core Flight System (cFS) Checksum (CS) application.
- [nasa/DS](https://github.com/nasa/DS) topic: pushed_at:2022-10 star:0.0k fork:0.0k The Core Flight System (cFS) Data Storage (DS) application.
...
- [nasa/elf2cfetbl](https://github.com/nasa/elf2cfetbl) topic: pushed_at:2022-10 star:0.0k fork:0.0k The Core Flight System (cFS) ELF to CFE Table Tool (elf2cfetbl)
- [nasa/FM](https://github.com/nasa/FM) topic: pushed_at:2022-10 star:0.0k fork:0.0k The Core Flight System (cFS) File Manager (FM) application.
...
- [nasa/HK](https://github.com/nasa/HK) topic: pushed_at:2022-10 star:0.0k fork:0.0k The Core Flight System (cFS) Housekeeping (HK) application.
- [nasa/HS](https://github.com/nasa/HS) topic: pushed_at:2022-10 star:0.0k fork:0.0k The Core Flight System (cFS) Health and Safety (HS) application.
...
- [nasa/LC](https://github.com/nasa/LC) topic: pushed_at:2022-10 star:0.0k fork:0.0k The Core Flight System (cFS) Limit Checker (LC) application.
- [nasa/MD](https://github.com/nasa/MD) topic: pushed_at:2022-10 star:0.0k fork:0.0k  The Core Flight System (cFS) Memory Dwell (MD) application.
...
- [nasa/MM](https://github.com/nasa/MM) topic: pushed_at:2022-10 star:0.0k fork:0.0k The Core Flight System (cFS) Memory Manager (MM) application.
...
- [nasa/nos3](https://github.com/nasa/nos3) topic: pushed_at:2022-10 star:0.1k fork:0.0k 
- [nasa/osal](https://github.com/nasa/osal) topic: pushed_at:2022-10 star:0.4k fork:0.2k The Core Flight System (cFS) Operating System Abstraction Layer (OSAL)
- [nasa/PSP](https://github.com/nasa/PSP) topic: pushed_at:2022-10 star:0.1k fork:0.0k The Core Flight System (cFS) Platform Support Package (PSP)
...
- [nasa/refine](https://github.com/nasa/refine) topic: pushed_at:2022-10 star:0.0k fork:0.0k 
...
- [nasa/sample_lib](https://github.com/nasa/sample_lib) topic: pushed_at:2022-10 star:0.0k fork:0.0k The Core Flight System (cFS) Sample Library (sample_lib)
...
- [nasa/SC](https://github.com/nasa/SC) topic: pushed_at:2022-10 star:0.0k fork:0.0k The Core Flight System (cFS) Stored Commands (SC) application.
...
- [nasa/to_lab](https://github.com/nasa/to_lab) topic: pushed_at:2022-10 star:0.0k fork:0.0k The Core Flight System (cFS) Telemetry Output Lab App (to_lab)
...
- [nasa/XPlaneConnect](https://github.com/nasa/XPlaneConnect) topic: pushed_at:2022-10 star:0.5k fork:0.2k The X-Plane Communications Toolbox is a research tool used to interact with the X-Plane flight simulator
...
- [nasa/astrobee](https://github.com/nasa/astrobee) topic: pushed_at:2022-10 star:0.7k fork:0.3k NASA Astrobee Robot Software
- [nasa/bingocpp](https://github.com/nasa/bingocpp) topic: pushed_at:2022-10 star:0.0k fork:0.0k 
...
- [nasa/DTNME](https://github.com/nasa/DTNME) topic: pushed_at:2022-10 star:0.0k fork:0.0k 
...
- [nasa/fprime](https://github.com/nasa/fprime) topic:components,cpp,embedded,embedded-systems,flight,flight-software,fprime,framework,nasa,object-oriented-programming,raspberry-pi,real-time,spaceflight pushed_at:2022-10 star:9.1k fork:1.2k F' - A flight software and embedded systems framework
- [nasa/GMSEC_API](https://github.com/nasa/GMSEC_API) topic: pushed_at:2022-09 star:0.0k fork:0.0k 
- [nasa/GSAP](https://github.com/nasa/GSAP) topic: pushed_at:2022-09 star:0.0k fork:0.0k Generic Software Architecture for Prognostics (GSAP)
- [nasa/gunns](https://github.com/nasa/gunns) topic: pushed_at:2022-10 star:0.0k fork:0.0k The NASA General-Use Nodal Network Solver (GUNNS) software
- [nasa/HDTN](https://github.com/nasa/HDTN) topic: pushed_at:2022-10 star:0.0k fork:0.0k 
- [nasa/HDTN-BPCodec](https://github.com/nasa/HDTN-BPCodec) topic: pushed_at:2021-01 star:0.0k fork:0.0k 
- [nasa/IDF](https://github.com/nasa/IDF) topic: pushed_at:2022-10 star:0.1k fork:0.0k 
- [nasa/irg_open](https://github.com/nasa/irg_open) topic: pushed_at:2022-09 star:0.0k fork:0.0k 
- [nasa/isaac](https://github.com/nasa/isaac) topic: pushed_at:2022-10 star:0.0k fork:0.0k Integrated System for Autonomous and Adaptive Caretaking
...
- [nasa/ow_autonomy](https://github.com/nasa/ow_autonomy) topic: pushed_at:2022-10 star:0.0k fork:0.0k 
...
- [nasa/trick](https://github.com/nasa/trick) topic: pushed_at:2022-10 star:0.6k fork:0.2k Trick Simulation Environment.  Trick provides a common set of simulation capabilities and utilities to build simulations automatically.
...
- [nasa/cFS](https://github.com/nasa/cFS) topic: pushed_at:2022-10 star:0.5k fork:0.2k The Core Flight System (cFS)
...
- [nasa/code-nasa-gov](https://github.com/nasa/code-nasa-gov) topic:catalog,code,gov-tech,nasa,open-source pushed_at:2022-10 star:0.2k fork:0.1k code.nasa.gov site leveraging the Open Source Catalog on github.com, powered by Polymer
...
- [nasa/Common-Metadata-Repository](https://github.com/nasa/Common-Metadata-Repository) topic:common-metadata-repository,eosdis pushed_at:2022-10 star:0.3k fork:0.1k 

## Common Lisp

- [nasa/pvslib](https://github.com/nasa/pvslib) topic: pushed_at:2022-07 star:0.2k fork:0.1k NASA PVS Library of Formal Developments
...
- [nasa/cmr-stac](https://github.com/nasa/cmr-stac) topic: pushed_at:2022-10 star:0.0k fork:0.0k 
...
- [nasa/instructions](https://github.com/nasa/instructions) topic:gov,nasa,welcome-page pushed_at:2022-09 star:0.3k fork:0.1k https://github.com/nasa/nasa.github.io/blob/master/docs/INSTRUCTIONS.md
...
- [nasa/ogma](https://github.com/nasa/ogma) topic: pushed_at:2022-09 star:0.2k fork:0.0k 
...
- [nasa/astrobee_android](https://github.com/nasa/astrobee_android) topic: pushed_at:2022-06 star:0.1k fork:0.0k NASA Astrobee Robot Software, Android
...
- [nasa/CCDD](https://github.com/nasa/CCDD) topic: pushed_at:2022-10 star:0.1k fork:0.0k CFS Command and Data Dictionary Tool (CCDDT)
...
- [nasa/cmr-graphql](https://github.com/nasa/cmr-graphql) topic:earth-science,eosdis,gis,gsfc,hacktoberfest,nasa,open-source pushed_at:2022-10 star:0.0k fork:0.0k GraphQL interface for NASA's Common Metadata Repository (CMR).
- [nasa/common-mapping-client](https://github.com/nasa/common-mapping-client) topic: pushed_at:2022-10 star:0.1k fork:0.0k CMC is a starter-kit for creating web-based mapping applications
- [nasa/cumulus](https://github.com/nasa/cumulus) topic:cumulus,nasa-cumulus pushed_at:2022-10 star:0.2k fork:0.1k Cumulus Framework + Cumulus API
- [nasa/cumulus-api](https://github.com/nasa/cumulus-api) topic:cumulus,nasa-cumulus pushed_at:2022-10 star:0.0k fork:0.0k Cumulus API Documentation
- [nasa/cumulus-dashboard](https://github.com/nasa/cumulus-dashboard) topic:cumulus,nasa-cumulus pushed_at:2022-10 star:0.1k fork:0.0k Cumulus API Dashboard
...
- [nasa/earthdata-search](https://github.com/nasa/earthdata-search) topic:data-discovery,earthdata-search,eosdis,hacktoberfest pushed_at:2022-10 star:0.7k fork:0.2k Earthdata Search is a web application developed by NASA EOSDIS to enable data discovery, search, comparison, visualization, and access across EOSDIS' Earth Science data holdings.
...
- [nasa/edsc-echoforms](https://github.com/nasa/edsc-echoforms) topic:earthdata-search,echo-forms,eosdis,hacktoberfest pushed_at:2022-10 star:0.0k fork:0.0k A React component implementing the ECHO Forms specification.
- [nasa/edsc-geo](https://github.com/nasa/edsc-geo) topic: pushed_at:2022-06 star:0.0k fork:0.0k 
- [nasa/edsc-smart-handoffs](https://github.com/nasa/edsc-smart-handoffs) topic:earth-science,eosdis,gis,gsfc,hacktoberfest,hacktoberfest2022,nasa,open-source pushed_at:2022-10 star:0.0k fork:0.0k Smart handoffs allow users to link from one application to another while carrying with them certain parameters that set a specific context (e.g. open up the same dataset, temporal range, and spatial search in a new tool). This code simplifies the creation of smart handoff links.
- [nasa/edsc-timeline](https://github.com/nasa/edsc-timeline) topic:earthdata-search,eosdis,timeline pushed_at:2022-10 star:0.0k fork:0.0k 
...
- [nasa/NASA-Acronyms](https://github.com/nasa/NASA-Acronyms) topic: pushed_at:2022-10 star:0.1k fork:0.0k 
...
- [nasa/Open-Source-Catalog](https://github.com/nasa/Open-Source-Catalog) topic:ai-tags,catalog,meta-record,nasa,open-source,website pushed_at:2022-02 star:0.2k fork:0.1k Contains the NASA open source software catalog for automatic deployment to code.nasa.gov
- [nasa/openmct](https://github.com/nasa/openmct) topic: pushed_at:2022-10 star:10.6k fork:1.1k A web based mission control framework. 
- [nasa/openmct-heatmap](https://github.com/nasa/openmct-heatmap) topic: pushed_at:2018-01 star:0.0k fork:0.0k 
- [nasa/openmct-hello](https://github.com/nasa/openmct-hello) topic: pushed_at:2022-09 star:0.0k fork:0.0k Hello, world plugin repository for Open MCT.
- [nasa/openmct-legacy-plugin](https://github.com/nasa/openmct-legacy-plugin) topic: pushed_at:2022-02 star:0.0k fork:0.0k 
- [nasa/openmct-map](https://github.com/nasa/openmct-map) topic: pushed_at:2022-06 star:0.0k fork:0.0k 
...
- [nasa/opera-sds-bach-ui](https://github.com/nasa/opera-sds-bach-ui) topic: pushed_at:2022-10 star:0.0k fork:0.0k 
...
- [nasa/dorado-sensitivity](https://github.com/nasa/dorado-sensitivity) topic:astronomy,astropy,ccd,nasa,satellite,ultraviolet pushed_at:2022-03 star:0.0k fork:0.0k Dorado sensitivity and exposure time calculator
...
- [nasa/GeneLab_Data_Processing](https://github.com/nasa/GeneLab_Data_Processing) topic:genelab,genes,genetics,pipeline pushed_at:2022-10 star:0.0k fork:0.0k 
- [nasa/gesdisc-cloud-tutorials](https://github.com/nasa/gesdisc-cloud-tutorials) topic: pushed_at:2022-09 star:0.0k fork:0.0k 
- [nasa/gesdisc-tutorials](https://github.com/nasa/gesdisc-tutorials) topic: pushed_at:2022-10 star:0.0k fork:0.0k 
- [nasa/harmony-regression-tests](https://github.com/nasa/harmony-regression-tests) topic: pushed_at:2022-10 star:0.0k fork:0.0k 
...
- [nasa/Kamodo](https://github.com/nasa/Kamodo) topic: pushed_at:2022-09 star:0.0k fork:0.0k 
...
- [nasa/progpy](https://github.com/nasa/progpy) topic: pushed_at:2022-10 star:0.0k fork:0.0k 
...
- [nasa/pyturbo-aero](https://github.com/nasa/pyturbo-aero) topic: pushed_at:2022-10 star:0.0k fork:0.0k Turbomachinery Blade and Flow path design tool
...
- [nasa/EMTAT](https://github.com/nasa/EMTAT) topic: pushed_at:2022-07 star:0.0k fork:0.0k 
- [nasa/GTM_DesignSim](https://github.com/nasa/GTM_DesignSim) topic: pushed_at:2019-08 star:0.0k fork:0.0k 
...
- [nasa/LSDAO](https://github.com/nasa/LSDAO) topic: pushed_at:2022-08 star:0.0k fork:0.0k 
...
- [nasa/PVS-ANTLR](https://github.com/nasa/PVS-ANTLR) topic: pushed_at:2022-10 star:0.0k fork:0.0k 
...
- [nasa/Second-Generation-Beacon-Performance-Analysis-Test-Tools](https://github.com/nasa/Second-Generation-Beacon-Performance-Analysis-Test-Tools) topic: pushed_at:2022-10 star:0.0k fork:0.0k 
...
- [nasa/Transform-to-Open-Science](https://github.com/nasa/Transform-to-Open-Science) topic:cross-agency,open-code,open-data,open-science,open-source pushed_at:2022-10 star:0.4k fork:0.1k Transformation to Open Science
...
- [nasa/apod-api](https://github.com/nasa/apod-api) topic:apod-api,apod-image,apod-parser,astronomy,astronomy-photo,astronomy-picture,astronomy-picture-of-the-day,nasa,nasa-api,space pushed_at:2022-08 star:0.6k fork:0.1k Astronomy Picture of the Day API service
- [nasa/bingo](https://github.com/nasa/bingo) topic: pushed_at:2022-10 star:0.0k fork:0.0k 
- [nasa/BrightComets](https://github.com/nasa/BrightComets) topic: pushed_at:2019-12 star:0.0k fork:0.0k 
- [nasa/cape](https://github.com/nasa/cape) topic: pushed_at:2022-09 star:0.0k fork:0.0k Computational Aerosciences Productivity & Execution
...
- [nasa/cFS-GroundSystem](https://github.com/nasa/cFS-GroundSystem) topic: pushed_at:2022-10 star:0.1k fork:0.1k The Core Flight System (cFS) Ground System Lab Tool (cFS-GroundSystem)
...
- [nasa/cumulus-orca](https://github.com/nasa/cumulus-orca) topic: pushed_at:2022-10 star:0.0k fork:0.0k 
...
- [nasa/harmony-gdal-adapter](https://github.com/nasa/harmony-gdal-adapter) topic: pushed_at:2022-08 star:0.0k fork:0.0k Translates Harmony service requests into gdal transformations
- [nasa/harmony-netcdf-to-zarr](https://github.com/nasa/harmony-netcdf-to-zarr) topic: pushed_at:2022-10 star:0.0k fork:0.0k Service for transforming NetCDF4 files into Zarr files within Harmony.  https://github.com/nasa/harmony
- [nasa/harmony-py](https://github.com/nasa/harmony-py) topic: pushed_at:2022-10 star:0.0k fork:0.0k Python client library for working with NASA’s Earth observing system data using Harmony.  https://harmony.earthdata.nasa.gov
...
- [nasa/hybridq](https://github.com/nasa/hybridq) topic:high-performance-computing,hpc,quantum-computing,simulation pushed_at:2022-10 star:0.0k fork:0.0k HybridQ is a highly extensible platform designed to provide a common framework to integrate multiple state-of-the-art techniques to simulate large scale quantum circuits on a variety of hardware. HybridQ provides tools to manipulate, develop, and extend noiseless and noisy circuits for different hardware architectures. HybridQ also supports large-scale high-performance computing (HPC) simulations, automatically balancing workload among different processor nodes and enabling the use of multiple backends to maximize parallel efficiency. Everything is then glued together by a simple and expressive language that allows seamless switching from one technique to another as well as from one hardware to the next, without the need to write lengthy translations, thus greatly simplifying the development of new hybrid algorithms and techniques.
- [nasa/HyperInSPACE](https://github.com/nasa/HyperInSPACE) topic: pushed_at:2022-10 star:0.0k fork:0.0k 
...
- [nasa/LHASA](https://github.com/nasa/LHASA) topic: pushed_at:2022-10 star:0.0k fork:0.0k Landslide Hazard Analysis for Situational Awareness
...
- [nasa/opera-sds-bach-api](https://github.com/nasa/opera-sds-bach-api) topic: pushed_at:2022-10 star:0.0k fork:0.0k 
- [nasa/opera-sds-int](https://github.com/nasa/opera-sds-int) topic: pushed_at:2022-10 star:0.0k fork:0.0k 
- [nasa/opera-sds-lambdas](https://github.com/nasa/opera-sds-lambdas) topic: pushed_at:2022-10 star:0.0k fork:0.0k 
- [nasa/opera-sds-pcm](https://github.com/nasa/opera-sds-pcm) topic: pushed_at:2022-10 star:0.0k fork:0.0k Observational Products for End-Users from Remote Sensing Analysis (OPERA)
- [nasa/opera-sds-pge](https://github.com/nasa/opera-sds-pge) topic: pushed_at:2022-10 star:0.0k fork:0.0k Observational Products for End-Users from Remote Sensing Analysis (OPERA)
...
- [nasa/ow_simulator](https://github.com/nasa/ow_simulator) topic: pushed_at:2022-10 star:0.1k fork:0.0k 
...
- [nasa/pigans-material-ID](https://github.com/nasa/pigans-material-ID) topic: pushed_at:2022-09 star:0.0k fork:0.0k 
...
- [nasa/pretrained-microscopy-models](https://github.com/nasa/pretrained-microscopy-models) topic: pushed_at:2022-10 star:0.0k fork:0.0k 
- [nasa/prog_algs](https://github.com/nasa/prog_algs) topic:integrated-system-health-management,prognostics,prognostics-health-management pushed_at:2022-10 star:0.0k fork:0.0k The Prognostic Algorithm Package is a python framework for model-based prognostics (computation of remaining useful life) of engineering systems, and provides a set of algorithms for state estimation and prediction, including uncertainty propagation. The algorithms take as inputs prognostic models (from NASA's Prognostics Model Package), and perform estimation and prediction functions. The library allows the rapid development of prognostics solutions for given models of components and systems. Different algorithms can be easily swapped to do comparative studies and evaluations of different algorithms to select the best for the application at hand.
- [nasa/prog_models](https://github.com/nasa/prog_models) topic:modeling,prognostic-models,prognostics,prognostics-health-management,simulation pushed_at:2022-10 star:0.1k fork:0.0k The NASA Prognostic Model Package is a Python framework focused on defining and building models for prognostics (computation of remaining useful life) of engineering systems, and provides a set of prognostics models for select components developed within this framework, suitable for use in prognostics applications for these components.
...
- [nasa/PROTEUS](https://github.com/nasa/PROTEUS) topic: pushed_at:2022-10 star:0.0k fork:0.0k PROTEUS - Parallelized Radar Optical Toolbox for Estimating dynamic sUrface water extentS
...
- [nasa/pyrefine](https://github.com/nasa/pyrefine) topic:cfd,mesh-adaptation,refine pushed_at:2022-10 star:0.0k fork:0.0k Python scripting for computational fluid dynamics mesh adaptation with refine
- [nasa/python_cmr](https://github.com/nasa/python_cmr) topic: pushed_at:2022-03 star:0.0k fork:0.0k Python library for querying the common metadata repository.
- [nasa/radbelt](https://github.com/nasa/radbelt) topic:cubesat,electron,heliophysics,igrf,magnetosphere,nasa,proton,radiation,satellite pushed_at:2022-10 star:0.0k fork:0.0k radbelt: An Astropy-friendly wrapper for the AE-8/AP-8 Van Allen belt model
...
- [nasa/scrub](https://github.com/nasa/scrub) topic:code-quality,code-review,python,security,static-analysis pushed_at:2022-10 star:0.0k fork:0.0k SCRUB is a platform for orchestration and aggregation of static code analysis tools.
...
- [nasa/SMCPy](https://github.com/nasa/SMCPy) topic: pushed_at:2022-09 star:0.1k fork:0.0k Python module for uncertainty quantification using a parallel sequential Monte Carlo sampler
...
- [nasa/NASAaccess](https://github.com/nasa/NASAaccess) topic: pushed_at:2022-07 star:0.1k fork:0.0k NASAaccess is R package that can generate gridded ascii tables of climate (CIMP5) and weather data (GPM, TRMM, GLDAS) needed to drive various hydrological models (e.g., SWAT, VIC, RHESSys, ..etc)
...
- [nasa/cmr-metadata-review](https://github.com/nasa/cmr-metadata-review) topic:rails,ruby pushed_at:2022-10 star:0.0k fork:0.0k The CMR Metadata Review tool is used to curate NASA EOSDIS collection and granule level metadata in CMR for correctness, completeness and consistency.
- [nasa/cmr-opensearch](https://github.com/nasa/cmr-opensearch) topic: pushed_at:2022-10 star:0.0k fork:0.0k CMR-OpenSearch is a web application developed by NASA EOSDIS to enable data discovery, search, and access across the CMR Earth Science data holdings via the OpenSearch standard.
- [nasa/georef_deploy](https://github.com/nasa/georef_deploy) topic: pushed_at:2020-08 star:0.0k fork:0.0k 
- [nasa/mmt](https://github.com/nasa/mmt) topic: pushed_at:2022-10 star:0.1k fork:0.0k NASA's Metadata Management Tool.

## SCSS

- [nasa/api-docs](https://github.com/nasa/api-docs) topic:api,demo,example,gov,javascript,nasa,nasa-apis,python,uswds pushed_at:2022-10 star:0.3k fork:0.1k api.nasa.gov
- [nasa/data-nasa-gov-frontpage](https://github.com/nasa/data-nasa-gov-frontpage) topic:data-catalog,data-visualization,datasets,frontpage,gov,gov-tech,metadata,nasa,open-data,treemap pushed_at:2022-10 star:0.0k fork:0.0k a frontpage for data.nasa.gov
...
- [nasa/harmony](https://github.com/nasa/harmony) topic: pushed_at:2022-10 star:0.0k fork:0.0k Application for providing services for Earth observation data in the cloud using standards-based APIs
...
- [nasa/now-in-space](https://github.com/nasa/now-in-space) topic: pushed_at:2022-10 star:0.0k fork:0.0k 
