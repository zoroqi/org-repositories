...
- [nasa/bp](https://github.com/nasa/bp) topic: pushed_at:2023-05 star:0.0k fork:0.0k The Bundle Protocol Core Flight System Application (BP) License: Apache-2.0
...
- [nasa/tvsio](https://github.com/nasa/tvsio) topic:cfs,sbn,trick,tvsio pushed_at:2023-05 star:0.0k fork:0.0k Trick Variable Server Input Output is a Core Flight Software app that can transfer data to and from Trick simulations
...
- [nasa/HDTN](https://github.com/nasa/HDTN) topic:dtn pushed_at:2023-05 star:0.0k fork:0.0k High-rate Delay Tolerant Network (HDTN) Software
...
- [nasa/CCDD](https://github.com/nasa/CCDD) topic: pushed_at:2023-05 star:0.1k fork:0.0k CFS Command and Data Dictionary Tool (CCDDT)
...
- [nasa/openmct](https://github.com/nasa/openmct) topic: pushed_at:2023-05 star:10.9k fork:1.2k A web based mission control framework. 
...
- [nasa/progpy](https://github.com/nasa/progpy) topic: pushed_at:2023-05 star:0.0k fork:0.0k 
...
- [nasa/Transform-to-Open-Science-Book](https://github.com/nasa/Transform-to-Open-Science-Book) topic: pushed_at:2023-05 star:0.0k fork:0.0k 
...
- [nasa/cape](https://github.com/nasa/cape) topic: pushed_at:2023-05 star:0.0k fork:0.0k Computational Aerosciences Productivity & Execution
...
- [nasa/pretrained-microscopy-models](https://github.com/nasa/pretrained-microscopy-models) topic: pushed_at:2023-05 star:0.0k fork:0.0k 
- [nasa/prog_algs](https://github.com/nasa/prog_algs) topic:integrated-system-health-management,prognostics,prognostics-health-management pushed_at:2023-05 star:0.1k fork:0.0k The Prognostic Algorithm Package is a python framework for model-based prognostics (computation of remaining useful life) of engineering systems, and provides a set of algorithms for state estimation and prediction, including uncertainty propagation. The algorithms take as inputs prognostic models (from NASA's Prognostics Model Package), and perform estimation and prediction functions. The library allows the rapid development of prognostics solutions for given models of components and systems. Different algorithms can be easily swapped to do comparative studies and evaluations of different algorithms to select the best for the application at hand.
...
- [nasa/SROMPy](https://github.com/nasa/SROMPy) topic: pushed_at:2023-05 star:0.0k fork:0.0k Python module to generate stochastic reduced order models (SROMs)
