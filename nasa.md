...
- [nasa/refine](https://github.com/nasa/refine) topic: pushed_at:2022-09 star:0.0k fork:0.0k 
...
- [nasa/bingocpp](https://github.com/nasa/bingocpp) topic: pushed_at:2022-08 star:0.0k fork:0.0k 
...
- [nasa/europa](https://github.com/nasa/europa) topic: pushed_at:2021-05 star:0.2k fork:0.1k 
...
- [nasa/edsc-smart-handoffs](https://github.com/nasa/edsc-smart-handoffs) topic:earth-science,eosdis,gis,gsfc,nasa,open-source pushed_at:2022-06 star:0.0k fork:0.0k Smart handoffs allow users to link from one application to another while carrying with them certain parameters that set a specific context (e.g. open up the same dataset, temporal range, and spatial search in a new tool). This code simplifies the creation of smart handoff links.
...
- [nasa/Transform-to-Open-Science](https://github.com/nasa/Transform-to-Open-Science) topic:cross-agency,open-code,open-data,open-science,open-source pushed_at:2022-10 star:0.3k fork:0.1k Transformation to Open Science
...
- [nasa/harmony-service-example](https://github.com/nasa/harmony-service-example) topic: pushed_at:2022-08 star:0.0k fork:0.0k Example service implementation for subsetting and reprojecting L3 data using Harmony. https://github.com/nasa/harmony
