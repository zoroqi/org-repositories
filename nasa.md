...
- [nasa/cmr-graphql](https://github.com/nasa/cmr-graphql) topic:earth-science,eosdis,gis,gsfc,hacktoberfest,nasa,open-source pushed_at:2023-08 star:0.0k fork:0.0k GraphQL interface for NASA's Common Metadata Repository (CMR).
...
- [nasa/openmct](https://github.com/nasa/openmct) topic: pushed_at:2023-08 star:11.0k fork:1.2k A web based mission control framework. 
