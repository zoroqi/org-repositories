...
- [nasa/nos3](https://github.com/nasa/nos3) topic:42,cfs,cosmos,digital-twin,nasa,simulator pushed_at:2024-08 star:0.3k fork:0.1k NASA Operational Simulator for Small Satellites
...
- [nasa/tvsio](https://github.com/nasa/tvsio) topic:cfs,sbn,trick,tvsio pushed_at:2024-06 star:0.0k fork:0.0k Trick Variable Server Input Output is a Core Flight Software app that can transfer data to and from Trick simulations
- [nasa/tvsio-demo](https://github.com/nasa/tvsio-demo) topic:cfs,demo,sample,sbn,trick,tvsio pushed_at:2024-06 star:0.0k fork:0.0k A sample project for integrating TVS-IO into cFS
...
- [nasa/trick](https://github.com/nasa/trick) topic: pushed_at:2024-08 star:0.0k fork:0.0k Trick Simulation Environment.  Trick provides a common set of simulation capabilities and utilities to build simulations automatically.
- [nasa/TrickHLA](https://github.com/nasa/TrickHLA) topic: pushed_at:2024-08 star:0.0k fork:0.0k TrickHLA: An IEEE 1516 High Level Architecture (HLA) Simulation Interoperability Standard Implementation for Trick Base Simulations
...
- [nasa/cumulus-template-deploy](https://github.com/nasa/cumulus-template-deploy) topic:cumulus,nasa-cumulus pushed_at:2024-07 star:0.0k fork:0.0k Cumulus template deployment project
...
- [nasa/cumulus-api](https://github.com/nasa/cumulus-api) topic:cumulus,nasa-cumulus pushed_at:2024-07 star:0.0k fork:0.0k Cumulus API Documentation
...
- [nasa/fmdtools](https://github.com/nasa/fmdtools) topic:fault-model,hazard-assessment,reliability,resilience,safety,simulation pushed_at:2024-07 star:0.0k fork:0.0k System Resilience Modelling, Simulation, and Assessment in Python
...
- [nasa/VITALS](https://github.com/nasa/VITALS) topic:ecostress,emit,lpdaac pushed_at:2024-05 star:0.0k fork:0.1k This repository provides Python Jupyter notebook examples to help users work with VSWIR and TIR data from the EMIT and ECOSTRESS missions.
...
- [nasa/FilePlottingTools](https://github.com/nasa/FilePlottingTools) topic: pushed_at:2024-07 star:0.0k fork:0.0k 
...
- [nasa/cape](https://github.com/nasa/cape) topic: pushed_at:2024-07 star:0.0k fork:0.0k Computational Aerosciences Productivity & Execution
...
- [nasa/api-docs](https://github.com/nasa/api-docs) topic:api,demo,example,gov,javascript,nasa,nasa-apis,python,uswds pushed_at:2024-07 star:0.4k fork:0.1k api.nasa.gov
