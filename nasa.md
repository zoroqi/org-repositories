...
- [nasa/-AGTF30-mex-solver-](https://github.com/nasa/-AGTF30-mex-solver-) topic: pushed_at:2026-03 star:0.0k fork:0.0k 
...
- [nasa/bplib](https://github.com/nasa/bplib) topic: pushed_at:2026-03 star:0.0k fork:0.0k 
- [nasa/CF](https://github.com/nasa/CF) topic: pushed_at:2026-09 star:0.1k fork:0.1k The Core Flight System (cFS) CFDP application.
- [nasa/cFE](https://github.com/nasa/cFE) topic: pushed_at:2026-09 star:0.5k fork:0.3k The Core Flight System (cFS) Core Flight Executive (cFE)
- [nasa/cFS](https://github.com/nasa/cFS) topic: pushed_at:2026-09 star:1.5k fork:0.4k The Core Flight System (cFS)
- [nasa/cfs-commandline-tools](https://github.com/nasa/cfs-commandline-tools) topic: pushed_at:2026-09 star:0.0k fork:0.0k 
...
- [nasa/ci_lab](https://github.com/nasa/ci_lab) topic: pushed_at:2026-09 star:0.0k fork:0.0k The Core Flight System (cFS) Command Ingest Lab App (ci_lab)
...
- [nasa/CryptoLib](https://github.com/nasa/CryptoLib) topic:ccsds,cfs,communications,data-link,ground-station,sdls-ep,space-communications,space-data-link-security-protocol,space-network,spack-data-link pushed_at:2026-09 star:0.2k fork:0.1k Provide a software-only solution using the CCSDS Space Data Link Security Protocol - Extended Procedures (SDLS-EP) to secure communications between a spacecraft running the core Flight System (cFS) and a ground station.
- [nasa/CS](https://github.com/nasa/CS) topic: pushed_at:2026-09 star:0.0k fork:0.0k The Core Flight System (cFS) Checksum (CS) application.
- [nasa/DS](https://github.com/nasa/DS) topic: pushed_at:2026-09 star:0.0k fork:0.0k The Core Flight System (cFS) Data Storage (DS) application.
...
- [nasa/EdsLib](https://github.com/nasa/EdsLib) topic: pushed_at:2026-09 star:0.0k fork:0.0k CCSDS SOIS Electronic Data Sheet Tool and Library
- [nasa/eefs](https://github.com/nasa/eefs) topic: pushed_at:2024-08 star:0.3k fork:0.1k EEPROM File System
- [nasa/elf2cfetbl](https://github.com/nasa/elf2cfetbl) topic: pushed_at:2026-09 star:0.0k fork:0.0k The Core Flight System (cFS) ELF to CFE Table Tool (elf2cfetbl)
- [nasa/FM](https://github.com/nasa/FM) topic: pushed_at:2026-09 star:0.0k fork:0.0k The Core Flight System (cFS) File Manager (FM) application.
...
- [nasa/HK](https://github.com/nasa/HK) topic: pushed_at:2026-09 star:0.0k fork:0.0k The Core Flight System (cFS) Housekeeping (HK) application.
- [nasa/HS](https://github.com/nasa/HS) topic: pushed_at:2026-09 star:0.0k fork:0.0k The Core Flight System (cFS) Health and Safety (HS) application.
...
- [nasa/LC](https://github.com/nasa/LC) topic: pushed_at:2026-09 star:0.0k fork:0.0k The Core Flight System (cFS) Limit Checker (LC) application.
- [nasa/MD](https://github.com/nasa/MD) topic: pushed_at:2026-09 star:0.0k fork:0.0k  The Core Flight System (cFS) Memory Dwell (MD) application.
...
- [nasa/MM](https://github.com/nasa/MM) topic: pushed_at:2026-09 star:0.0k fork:0.0k The Core Flight System (cFS) Memory Manager (MM) application.
...
- [nasa/nos3](https://github.com/nasa/nos3) topic:42,cfs,cosmos,digital-twin,nasa,nos,nos3,simulator pushed_at:2026-09 star:0.6k fork:0.2k NASA Operational Simulator for Space Systems
- [nasa/osal](https://github.com/nasa/osal) topic: pushed_at:2026-09 star:0.7k fork:0.3k The Core Flight System (cFS) Operating System Abstraction Layer (OSAL)
- [nasa/PSP](https://github.com/nasa/PSP) topic: pushed_at:2026-09 star:0.1k fork:0.1k The Core Flight System (cFS) Platform Support Package (PSP)
...
- [nasa/sample_app](https://github.com/nasa/sample_app) topic: pushed_at:2026-09 star:0.1k fork:0.1k The Core Flight System (cFS) Sample App (sample_app)
- [nasa/sample_lib](https://github.com/nasa/sample_lib) topic: pushed_at:2026-09 star:0.0k fork:0.0k The Core Flight System (cFS) Sample Library (sample_lib)
- [nasa/SBN](https://github.com/nasa/SBN) topic: pushed_at:2026-09 star:0.0k fork:0.0k 
- [nasa/SBN-Client](https://github.com/nasa/SBN-Client) topic: pushed_at:2026-04 star:0.0k fork:0.0k The Software Bus Network Client (SBNC) enables two-way communication with NASA's core Flight System (cFS) Software Bus and an external application. SBNC implements the Software Bus Network (SBN) communication protocol in a standalone C library.
- [nasa/SC](https://github.com/nasa/SC) topic: pushed_at:2026-09 star:0.0k fork:0.0k The Core Flight System (cFS) Stored Commands (SC) application.
...
- [nasa/sch_lab](https://github.com/nasa/sch_lab) topic: pushed_at:2026-09 star:0.0k fork:0.0k The Core Flight System (cFS) Scheduler Lab App (sch_lab)
...
- [nasa/tblCRCTool](https://github.com/nasa/tblCRCTool) topic: pushed_at:2026-09 star:0.0k fork:0.0k The Core Flight System (cFS) Table CRC Tool (tblCRCTool)
- [nasa/to_lab](https://github.com/nasa/to_lab) topic: pushed_at:2026-09 star:0.0k fork:0.1k The Core Flight System (cFS) Telemetry Output Lab App (to_lab)
- [nasa/TrickFMI](https://github.com/nasa/TrickFMI) topic: pushed_at:2026-09 star:0.0k fork:0.0k A Functional Mockup Interface (FMI) Standard Implementation for Trick Base Models and Simulations
...
- [nasa/tvsio](https://github.com/nasa/tvsio) topic:cfs,sbn,trick,tvsio pushed_at:2025-12 star:0.0k fork:0.0k Trick Variable Server Input Output is a Core Flight Software app that can transfer data to and from Trick simulations
- [nasa/tvsio-demo](https://github.com/nasa/tvsio-demo) topic:cfs,demo,sample,sbn,trick,tvsio pushed_at:2026-08 star:0.0k fork:0.0k A sample project for integrating TVS-IO into cFS
...
- [nasa/astrobee](https://github.com/nasa/astrobee) topic: pushed_at:2025-12 star:1.4k fork:0.4k NASA Astrobee Robot Software
- [nasa/Baseball-Avoidance-Multirotor-BAM](https://github.com/nasa/Baseball-Avoidance-Multirotor-BAM) topic: pushed_at:2026-01 star:0.0k fork:0.0k 
...
- [nasa/cml](https://github.com/nasa/cml) topic:aerospace-engineering,cpp,modeling-and-simulation,nasa,orbital-mechanics,spacecraft pushed_at:2026-09 star:0.0k fork:0.0k The Common Model Library. CML provides a collection of generic, verified, validated, and reusable C++ models of spacecraft that are compatible with NASA's Trick Simulation Environment.
...
- [nasa/daidalus](https://github.com/nasa/daidalus) topic: pushed_at:2025-09 star:0.1k fork:0.0k open source release: LAR-19282-1 Detect and Avoid Alerting Logic for Unmanned Systems (DAIDALUS) with Dynamic Well-Clear Separation Volumes).
- [nasa/dcapp](https://github.com/nasa/dcapp) topic: pushed_at:2026-09 star:0.0k fork:0.0k A lightweight XML-based framework for building real-time display applications and cockpit interfaces.
...
- [nasa/fprime](https://github.com/nasa/fprime) topic:components,cpp,embedded,embedded-systems,flight,flight-software,fprime,framework,nasa,object-oriented-programming,raspberry-pi,real-time,spaceflight pushed_at:2026-09 star:11.7k fork:1.8k F´ - A flight software and embedded systems framework
- [nasa/fprime-examples](https://github.com/nasa/fprime-examples) topic: pushed_at:2026-08 star:0.0k fork:0.0k A repository for storing examples called out in the F Prime documentation
- [nasa/gigatraj](https://github.com/nasa/gigatraj) topic: pushed_at:2026-09 star:0.0k fork:0.0k 
- [nasa/GMAT](https://github.com/nasa/GMAT) topic:astrodynamics,data-visualization,flight-dynamics,mathematics,navigation,orbital-dynamics,physics,simulation,space pushed_at:2026-08 star:0.1k fork:0.0k The General Mission Analysis Tool (GMAT) is the world's leading enterprise, multi-mission, open source software system for space mission design, optimization, and navigation. The system supports missions in flight regimes ranging from low Earth orbit to lunar, libration point, and deep space missions. NOTE: Non-release tagged commits are AS IS.
- [nasa/GMSEC_API](https://github.com/nasa/GMSEC_API) topic: pushed_at:2025-09 star:0.0k fork:0.0k 
...
- [nasa/gunns](https://github.com/nasa/gunns) topic: pushed_at:2026-09 star:0.1k fork:0.0k The NASA General-Use Nodal Network Solver (GUNNS) software
- [nasa/harmony-trajectory-subsetter](https://github.com/nasa/harmony-trajectory-subsetter) topic: pushed_at:2026-09 star:0.0k fork:0.0k 
- [nasa/HDTN](https://github.com/nasa/HDTN) topic:dtn pushed_at:2026-07 star:0.1k fork:0.0k High-rate Delay Tolerant Network (HDTN) Software
- [nasa/HDTN-BPCodec](https://github.com/nasa/HDTN-BPCodec) topic: pushed_at:2021-01 star:0.0k fork:0.0k 
- [nasa/IDF](https://github.com/nasa/IDF) topic: pushed_at:2026-09 star:0.1k fork:0.0k 
- [nasa/irg_open](https://github.com/nasa/irg_open) topic: pushed_at:2024-06 star:0.0k fork:0.0k 
- [nasa/jeod](https://github.com/nasa/jeod) topic: pushed_at:2026-09 star:0.0k fork:0.0k 
...
- [nasa/koviz](https://github.com/nasa/koviz) topic: pushed_at:2026-09 star:0.0k fork:0.0k Koviz is a Trick simulation data plotting, visualization and analysis tool
...
- [nasa/meshNetwork](https://github.com/nasa/meshNetwork) topic: pushed_at:2019-08 star:0.2k fork:0.0k 
- [nasa/mimic](https://github.com/nasa/mimic) topic: pushed_at:2026-07 star:0.0k fork:0.0k 
...
- [nasa/PanNDE](https://github.com/nasa/PanNDE) topic: pushed_at:2025-05 star:0.0k fork:0.0k 
...
- [nasa/tfexec](https://github.com/nasa/tfexec) topic: pushed_at:2025-07 star:0.0k fork:0.0k This library gives an easy interface for loading and executing deep learning models written in Tensorflow.
- [nasa/Three-Dimensional-Nozzle-Design-Code](https://github.com/nasa/Three-Dimensional-Nozzle-Design-Code) topic: pushed_at:2020-08 star:0.1k fork:0.0k 
...
- [nasa/trick](https://github.com/nasa/trick) topic: pushed_at:2026-09 star:0.2k fork:0.1k Trick Simulation Environment.  Trick provides a common set of simulation capabilities and utilities to build simulations automatically.
- [nasa/TrickCFS](https://github.com/nasa/TrickCFS) topic: pushed_at:2026-06 star:0.0k fork:0.0k TrickCFS is a software package that provides the C structs, C++ classes and pertinent code required to synchronize a core Flight System (cFS) with the Trick simulation executive.
- [nasa/TrickHLA](https://github.com/nasa/TrickHLA) topic: pushed_at:2026-09 star:0.1k fork:0.0k TrickHLA: An IEEE 1516 High Level Architecture (HLA) Simulation Interoperability Standard Implementation for Trick Base Simulations
...
- [nasa/vira](https://github.com/nasa/vira) topic:astrodynamics,raytracing,rendering pushed_at:2025-11 star:0.0k fork:0.0k Vira is a rendering and ray tracing library for space exploration and mission design purposes.
...
- [nasa/Common-Metadata-Repository](https://github.com/nasa/Common-Metadata-Repository) topic:clojure,common-metadata-repository,eosdis pushed_at:2026-09 star:0.4k fork:0.1k The Common Metadata Repository (CMR) is a high-performance, high-quality, continuously evolving metadata system that catalogs Earth Science data and associated service metadata records. These metadata records are registered, modified, discovered, and accessed through programmatic interfaces leveraging standard protocols and APIs.

## Common Lisp

- [nasa/pvslib](https://github.com/nasa/pvslib) topic: pushed_at:2026-07 star:0.3k fork:0.1k NASA PVS Library of Formal Developments
...
- [nasa/NASTRAN-93](https://github.com/nasa/NASTRAN-93) topic: pushed_at:2015-12 star:0.2k fork:0.1k NASTRAN is the NASA Structural Analysis System, a finite element analysis program (FEA)
- [nasa/NASTRAN-95](https://github.com/nasa/NASTRAN-95) topic: pushed_at:2024-04 star:0.6k fork:0.3k 

## Fortran

- [nasa/AmesGCM](https://github.com/nasa/AmesGCM) topic: pushed_at:2026-06 star:0.0k fork:0.0k 
- [nasa/cea](https://github.com/nasa/cea) topic:cea,combustion,detonation,equilibrium,grc,nasa,rocket,shock,thermodynamics,transport pushed_at:2026-09 star:0.2k fork:0.0k CEA computes the equilibrium composition of mixtures via free-energy minimization, and uses the resulting product concentrations to determine thermodynamic and transport properties. It includes a large database of species with thermodynamic curve-fit data, and can be used for rocket performance, detonation parameters, and shock-wave analysis.
- [nasa/cfdtools](https://github.com/nasa/cfdtools) topic: pushed_at:2023-03 star:0.2k fork:0.0k 
- [nasa/CFL3D](https://github.com/nasa/CFL3D) topic: pushed_at:2022-08 star:0.3k fork:0.2k 
- [nasa/CompDam_DGD](https://github.com/nasa/CompDam_DGD) topic: pushed_at:2026-07 star:0.2k fork:0.1k 
...
- [nasa/PWOM](https://github.com/nasa/PWOM) topic: pushed_at:2026-06 star:0.0k fork:0.0k 
- [nasa/rbf](https://github.com/nasa/rbf) topic: pushed_at:2026-06 star:0.0k fork:0.0k Mode shape interpolation via radial basis functions
- [nasa/sgdass](https://github.com/nasa/sgdass) topic:astronomy,data-analysis,geodesy,geophysics,vlbi-analysis pushed_at:2026-09 star:0.0k fork:0.0k Space geodesy data analysis software suite
- [nasa/TLNS3D](https://github.com/nasa/TLNS3D) topic: pushed_at:2018-04 star:0.1k fork:0.0k 
...
- [nasa/dss](https://github.com/nasa/dss) topic: pushed_at:2025-12 star:0.0k fork:0.0k This repository contains the core software products of the InterUSS Platform: an implementation of the ASTM DSS concept for RID and flight coordination, and monitoring tools for federated UTM, including automated testing.

## HCL

- [nasa/cumulus-template-deploy](https://github.com/nasa/cumulus-template-deploy) topic:cumulus,nasa-cumulus pushed_at:2026-06 star:0.0k fork:0.0k Cumulus template deployment project
...
- [nasa/cumulus-api](https://github.com/nasa/cumulus-api) topic:cumulus,nasa-cumulus pushed_at:2026-07 star:0.0k fork:0.0k Cumulus API Documentation
...
- [nasa/EMIT-Data-Resources](https://github.com/nasa/EMIT-Data-Resources) topic:emit,lpdaac pushed_at:2025-09 star:0.2k fork:0.1k This repository provides guides, short how-tos, and tutorials to help users access and work with data from the Earth Surface Mineral Dust Source Investigation (EMIT) mission.
- [nasa/fmdtools](https://github.com/nasa/fmdtools) topic:fault-model,hazard-assessment,reliability,resilience,safety,simulation pushed_at:2026-09 star:0.1k fork:0.0k System Resilience Modelling, Simulation, and Assessment in Python
- [nasa/GeneLab-Training](https://github.com/nasa/GeneLab-Training) topic:education,genes,genetics,nasa,outreach,pipeline,training,training-materials pushed_at:2026-03 star:0.1k fork:0.0k A repository for GeneLab Training documentation.
- [nasa/GPU_SDR](https://github.com/nasa/GPU_SDR) topic: pushed_at:2019-07 star:0.0k fork:0.0k 
- [nasa/instructions](https://github.com/nasa/instructions) topic:gov,nasa,welcome-page pushed_at:2026-08 star:0.4k fork:0.1k https://github.com/nasa/nasa.github.io/blob/master/docs/INSTRUCTIONS.md
...
- [nasa/opera-sds](https://github.com/nasa/opera-sds) topic: pushed_at:2026-08 star:0.0k fork:0.0k 
- [nasa/opera-sds-ops](https://github.com/nasa/opera-sds-ops) topic: pushed_at:2026-09 star:0.0k fork:0.0k 
- [nasa/PolyCARP](https://github.com/nasa/PolyCARP) topic: pushed_at:2020-11 star:0.0k fork:0.0k 
- [nasa/sector33](https://github.com/nasa/sector33) topic: pushed_at:2026-08 star:0.0k fork:0.0k 
...
- [nasa/ogma](https://github.com/nasa/ogma) topic:assurance,autonomy,cfs,embedded-systems,flight-software,fprime,robot-operating-system,robotics,ros,ros2,runtime-monitoring,runtime-monitoring-system,runtime-verification,rv,space-ros,spacecraft pushed_at:2026-09 star:0.6k fork:0.1k Generator of runtime monitors for flight and robotics applications.
- [nasa/PRECiSA](https://github.com/nasa/PRECiSA) topic: pushed_at:2026-09 star:0.1k fork:0.0k Program Round-off Error Certifier via Static Analysis
...
- [nasa/CCDD](https://github.com/nasa/CCDD) topic: pushed_at:2026-06 star:0.1k fork:0.0k CFS Command and Data Dictionary Tool (CCDDT)
...
- [nasa/DERT](https://github.com/nasa/DERT) topic: pushed_at:2019-02 star:0.2k fork:0.1k DERT is an open source software tool for exploring NASA's digital terrain models in 3D
...
- [nasa/ziggy](https://github.com/nasa/ziggy) topic:algorithm,analysis,arc,data,data-analysis,data-reduction,java,k2,kepler,linux,macos,nasa,open-source,pipeline,science,tess,ziggy pushed_at:2026-07 star:0.0k fork:0.0k Ziggy, a portable, scalable infrastructure for science data processing pipelines, is the child of the Transiting Exoplanet Survey Satellite (TESS) pipeline and the grandchild of the Kepler Pipeline.
...
- [nasa/cmr-graphql](https://github.com/nasa/cmr-graphql) topic:earth-science,eosdis,gis,gsfc,hacktoberfest,nasa,open-source pushed_at:2026-09 star:0.0k fork:0.0k GraphQL interface for NASA's Common Metadata Repository (CMR).
...
- [nasa/cumulus](https://github.com/nasa/cumulus) topic:cumulus,nasa-cumulus pushed_at:2026-09 star:0.3k fork:0.1k Cumulus Framework + Cumulus API
- [nasa/cumulus-dashboard](https://github.com/nasa/cumulus-dashboard) topic:cumulus,nasa-cumulus pushed_at:2026-08 star:0.1k fork:0.0k Cumulus API Dashboard
...
- [nasa/cumulus-message-adapter-js](https://github.com/nasa/cumulus-message-adapter-js) topic:cumulus,nasa-cumulus pushed_at:2026-09 star:0.0k fork:0.0k A library for validating and parsing the Cumulus message protocol
- [nasa/earthdata-search](https://github.com/nasa/earthdata-search) topic:data-discovery,earthdata-search,eosdis,hacktoberfest pushed_at:2026-09 star:0.8k fork:0.3k Earthdata Search is a web application developed by NASA EOSDIS to enable data discovery, search, comparison, visualization, and access across EOSDIS' Earth Science data holdings.
...
- [nasa/edsc-echoforms](https://github.com/nasa/edsc-echoforms) topic:earthdata-search,echo-forms,eosdis,hacktoberfest pushed_at:2026-05 star:0.0k fork:0.0k A React component implementing the ECHO Forms specification.
- [nasa/edsc-geo](https://github.com/nasa/edsc-geo) topic: pushed_at:2026-05 star:0.0k fork:0.0k 
- [nasa/edsc-smart-handoffs](https://github.com/nasa/edsc-smart-handoffs) topic:earth-science,eosdis,gis,gsfc,hacktoberfest,hacktoberfest2022,nasa,open-source pushed_at:2026-05 star:0.0k fork:0.0k Smart handoffs allow users to link from one application to another while carrying with them certain parameters that set a specific context (e.g. open up the same dataset, temporal range, and spatial search in a new tool). This code simplifies the creation of smart handoff links.
- [nasa/edsc-timeline](https://github.com/nasa/edsc-timeline) topic:earthdata-search,eosdis,timeline pushed_at:2026-05 star:0.0k fork:0.0k 
...
- [nasa/hds-core](https://github.com/nasa/hds-core) topic:design-system,nasa,uswds pushed_at:2026-09 star:0.0k fork:0.0k Documentation for NASA's Horizon Design System (HDS), with a Sass/CSS theme layer for the U.S. Web Design System (USWDS).
...
- [nasa/kms](https://github.com/nasa/kms) topic: pushed_at:2026-09 star:0.0k fork:0.0k 
- [nasa/meza](https://github.com/nasa/meza) topic:elasticsearch,enterprise,mediawiki,visual-editor,wiki pushed_at:2025-12 star:0.0k fork:0.0k Setup an enterprise MediaWiki server with simple commands
...
- [nasa/mmt](https://github.com/nasa/mmt) topic: pushed_at:2026-09 star:0.1k fork:0.0k NASA's Metadata Management Tool.
- [nasa/NASA-Acronyms](https://github.com/nasa/NASA-Acronyms) topic: pushed_at:2026-02 star:0.1k fork:0.0k 
...
- [nasa/openmct](https://github.com/nasa/openmct) topic: pushed_at:2026-09 star:13.1k fork:1.5k A web based mission control framework. 
- [nasa/openmct-heatmap](https://github.com/nasa/openmct-heatmap) topic: pushed_at:2018-01 star:0.0k fork:0.0k 
- [nasa/openmct-hello](https://github.com/nasa/openmct-hello) topic: pushed_at:2026-02 star:0.0k fork:0.0k Hello, world plugin repository for Open MCT.
...
- [nasa/openmct-tutorial](https://github.com/nasa/openmct-tutorial) topic: pushed_at:2025-06 star:0.3k fork:0.1k A tutorial for OpenMCT that guides you through integrating historical and realtime telemetry.
- [nasa/opera-sds-bach-ui](https://github.com/nasa/opera-sds-bach-ui) topic: pushed_at:2026-09 star:0.0k fork:0.0k 
...
- [nasa/Mirage.jl](https://github.com/nasa/Mirage.jl) topic: pushed_at:2026-08 star:0.0k fork:0.0k Build desktop GUIs in Julia with real-time 2D and 3D graphics.
- [nasa/plot3d_julia](https://github.com/nasa/plot3d_julia) topic: pushed_at:2025-11 star:0.0k fork:0.0k 
...
- [nasa/AI4LS](https://github.com/nasa/AI4LS) topic: pushed_at:2026-09 star:0.0k fork:0.0k The Artificial Intelligence for Life in Space (AI4LS) team at NASA Ames uses artificial intelligence and machine learning to support and advance space exploration. This repository contains code for ongoing and completed projects.  SRA#ARC-18915-1
- [nasa/AppEEARS-Data-Resources](https://github.com/nasa/AppEEARS-Data-Resources) topic:appeears,lpdaac pushed_at:2026-07 star:0.0k fork:0.0k  This repository provides resources and tutorials to help users work with AppEEARS programmatically.
- [nasa/ASDC_Data_and_User_Services](https://github.com/nasa/ASDC_Data_and_User_Services) topic: pushed_at:2026-09 star:0.1k fork:0.0k Tutorials for missions conducted by the Atmospheric Science Data Center (ASDC)
- [nasa/ASTER-Data-Resources](https://github.com/nasa/ASTER-Data-Resources) topic:aster,cmr,gis,lpdaac,nasa,nasa-data,open-science,openscience,remote-sensing,umm pushed_at:2026-09 star:0.0k fork:0.0k This repository provides guides, short how-tos, and tutorials to help users access and work with ASTER data.
- [nasa/Autonomous-Modular-Sensor-Wildfire-Segmentation](https://github.com/nasa/Autonomous-Modular-Sensor-Wildfire-Segmentation) topic: pushed_at:2025-12 star:0.0k fork:0.0k 
...
- [nasa/ECOSTRESS-Data-Resources](https://github.com/nasa/ECOSTRESS-Data-Resources) topic:ecostress,lpdaac pushed_at:2026-08 star:0.0k fork:0.0k How to find, access, and work with ECOSTRESS (ECOsystem Spaceborne Thermal Radiometer Experiment on Space Station) Data.
- [nasa/exoscene](https://github.com/nasa/exoscene) topic: pushed_at:2022-04 star:0.0k fork:0.0k 
- [nasa/GEDI-Data-Resources](https://github.com/nasa/GEDI-Data-Resources) topic:gedi,lpdaac pushed_at:2025-06 star:0.1k fork:0.0k This repository provides guides, short how-tos, and tutorials to help users access and work with data from the Global Ecosystem Dynamics Investigation (GEDI) mission.
- [nasa/GeneLab_Data_Processing](https://github.com/nasa/GeneLab_Data_Processing) topic:genelab,genes,genetics,omics,osdr,pipeline pushed_at:2026-08 star:0.1k fork:0.1k Standard bioinformatics pipelines for omics data from spaceflight and space-relevant experiments.
- [nasa/gesdisc-cloud-tutorials](https://github.com/nasa/gesdisc-cloud-tutorials) topic: pushed_at:2024-06 star:0.0k fork:0.0k 
- [nasa/gesdisc-tutorials](https://github.com/nasa/gesdisc-tutorials) topic: pushed_at:2026-09 star:0.1k fork:0.0k 
- [nasa/GHRC-FieldCampaign-eXplorer-core](https://github.com/nasa/GHRC-FieldCampaign-eXplorer-core) topic:core,python pushed_at:2025-04 star:0.0k fork:0.0k 
- [nasa/GlennOPT](https://github.com/nasa/GlennOPT) topic: pushed_at:2026-09 star:0.0k fork:0.0k Single and multi-objective optimization for computational simulations
- [nasa/harmony-regression-tests](https://github.com/nasa/harmony-regression-tests) topic: pushed_at:2026-09 star:0.0k fork:0.0k 
- [nasa/HLS-Data-Resources](https://github.com/nasa/HLS-Data-Resources) topic:hls,lpdaac pushed_at:2026-06 star:0.1k fork:0.0k This repository provides guides, short how-tos, and tutorials to help users access and work with Harmonized Landsat Sentinel-2 (HLS) data.
...
- [nasa/Kamodo](https://github.com/nasa/Kamodo) topic: pushed_at:2026-09 star:0.1k fork:0.0k The CCMC Kamodo Analysis Suite is a NASA open-source Python package designed for functionalizing and analyzing heliophysics model outputs. It offers intuitive tools for data analysis, unit conversions, and creating publication-quality graphics. Kamodo supports a variety of models and online data.
- [nasa/legacy-mars-global-climate-model](https://github.com/nasa/legacy-mars-global-climate-model) topic:atmosphere,climate-model,climate-modeling,clouds,dust,gcm,global-climate-model,mars,microphysics pushed_at:2023-04 star:0.1k fork:0.0k We present the NASA Ames Legacy Mars Global Climate Model for public release. This model uses a modified version of the ARIES/GEOS dynamical core coupled with a set of Mars physics packages to simulate the martian climate. The physics packages include the treatment of surface properties, a ground temperature model, a planetary boundary layer scheme, water and carbon dioxide sublimation/condensation physics, a water ice cloud microphysical scheme, the use of a moment method for tracer transport, a semi-interactive dust tracking scheme, and a two-stream radiative transfer code based on correlated-k’s.
- [nasa/LPDAAC-Data-Resources](https://github.com/nasa/LPDAAC-Data-Resources) topic:lpdaac pushed_at:2026-08 star:0.1k fork:0.0k This repository is a place to find data user resources that demonstrate how to use LP DAAC tools, services, and data.
- [nasa/MMM-Py](https://github.com/nasa/MMM-Py) topic: pushed_at:2022-08 star:0.1k fork:0.0k Marshall MRMS Mosaic Python Toolkit
- [nasa/MODIS-VIIRS-Data-Resources](https://github.com/nasa/MODIS-VIIRS-Data-Resources) topic:lpdaac,modis,viirs pushed_at:2025-06 star:0.0k fork:0.0k This repository provides guides, short how-tos, and tutorials to help users access and work with MODIS and VIIRS data.
- [nasa/multihole-probe-calibration](https://github.com/nasa/multihole-probe-calibration) topic: pushed_at:2025-07 star:0.0k fork:0.0k 
- [nasa/oceandata-notebooks](https://github.com/nasa/oceandata-notebooks) topic:nasa-pace pushed_at:2026-09 star:0.0k fork:0.0k Tutorials for OB.DAAC data
- [nasa/open-science-tools](https://github.com/nasa/open-science-tools) topic: pushed_at:2026-09 star:0.0k fork:0.0k Python scripts for checking the contents of PubSpace for open science metrics.  Resources
- [nasa/Plot3D_utilities](https://github.com/nasa/Plot3D_utilities) topic:computational-domain,mesh,mesh-generation,plot3d pushed_at:2026-09 star:0.1k fork:0.0k A Python library for reading, writing, finding connectivity for plot3d files
- [nasa/pretrained-microscopy-models](https://github.com/nasa/pretrained-microscopy-models) topic: pushed_at:2025-06 star:0.1k fork:0.0k 
- [nasa/PyAMPR](https://github.com/nasa/PyAMPR) topic: pushed_at:2025-11 star:0.0k fork:0.0k Python Advanced Microwave Precipitation Radiometer Data Toolkit (PyAMPR)
...
- [nasa/PySA](https://github.com/nasa/PySA) topic: pushed_at:2025-05 star:0.0k fork:0.0k 
...
- [nasa/pyturbo-aero](https://github.com/nasa/pyturbo-aero) topic: pushed_at:2026-09 star:0.1k fork:0.0k Turbomachinery Blade and Flow path design tool
...
- [nasa/turbo-design](https://github.com/nasa/turbo-design) topic: pushed_at:2026-09 star:0.1k fork:0.0k Radial Equilibrium Code to design Turbomachinery
- [nasa/VITALS](https://github.com/nasa/VITALS) topic:ecostress,emit,lpdaac pushed_at:2026-07 star:0.1k fork:0.1k This repository provides Python Jupyter notebook examples to help users work with VSWIR and TIR data from the EMIT and ECOSTRESS missions.
...
- [nasa/zarr-eosdis-store](https://github.com/nasa/zarr-eosdis-store) topic: pushed_at:2025-04 star:0.0k fork:0.0k DEPRECATED: This repository is no longer maintained. Please use https://github.com/zarr-developers/VirtualiZarr instead.  Zarr data store for efficiently accessing NetCDF4 data from NASA’s Earth observing system in the cloud using the Zarr Python library.

## LabVIEW

- [nasa/NDAS](https://github.com/nasa/NDAS) topic:labview,ndas pushed_at:2026-03 star:0.1k fork:0.0k NASA Data Acquisition System (NDAS) is an integrated suite of applications that manage the complete data acquisition lifecycle—from acquisition, processing, and calibration to display, recording, and distribution. This is our code peer review tool. 
...
- [nasa/CARA_Analysis_Tools](https://github.com/nasa/CARA_Analysis_Tools) topic: pushed_at:2026-09 star:0.1k fork:0.0k 
- [nasa/EMTAT](https://github.com/nasa/EMTAT) topic: pushed_at:2025-09 star:0.0k fork:0.0k 
- [nasa/frost](https://github.com/nasa/frost) topic: pushed_at:2026-09 star:0.0k fork:0.0k 
...
- [nasa/GTM_DesignSim](https://github.com/nasa/GTM_DesignSim) topic: pushed_at:2019-08 star:0.1k fork:0.1k 
...
- [nasa/MATLAB_CODEV_toolkit](https://github.com/nasa/MATLAB_CODEV_toolkit) topic: pushed_at:2026-01 star:0.0k fork:0.0k 
- [nasa/muscat](https://github.com/nasa/muscat) topic: pushed_at:2025-11 star:0.0k fork:0.0k 
...
- [nasa/Second-Generation-Beacon-Performance-Analysis-Test-Tools](https://github.com/nasa/Second-Generation-Beacon-Performance-Analysis-Test-Tools) topic: pushed_at:2026-09 star:0.0k fork:0.0k 
...
- [nasa/LSDAO](https://github.com/nasa/LSDAO) topic: pushed_at:2025-12 star:0.0k fork:0.0k 
- [nasa/smd-open-science-guidelines](https://github.com/nasa/smd-open-science-guidelines) topic: pushed_at:2025-05 star:0.0k fork:0.0k 
...
- [nasa/automated_testing_interfaces](https://github.com/nasa/automated_testing_interfaces) topic: pushed_at:2026-08 star:0.0k fork:0.0k InterUSS-defined interfaces for automated testing
- [nasa/baboon](https://github.com/nasa/baboon) topic: pushed_at:2025-06 star:0.0k fork:0.0k 
- [nasa/BGA](https://github.com/nasa/BGA) topic: pushed_at:2023-03 star:0.1k fork:0.0k Beginner's Guide to Aeronautics
- [nasa/cape-doc](https://github.com/nasa/cape-doc) topic: pushed_at:2026-08 star:0.0k fork:0.0k 
...
- [nasa/cram](https://github.com/nasa/cram) topic: pushed_at:2025-06 star:0.0k fork:0.0k 
...
- [nasa/dishas](https://github.com/nasa/dishas) topic: pushed_at:2025-06 star:0.0k fork:0.0k 
...
- [nasa/earthdata-conductor](https://github.com/nasa/earthdata-conductor) topic: pushed_at:2026-08 star:0.0k fork:0.0k 
...
- [nasa/GeneLab-sampleProcessing](https://github.com/nasa/GeneLab-sampleProcessing) topic: pushed_at:2025-12 star:0.0k fork:0.0k 
- [nasa/GeneLab_Metagenomics_Workflow](https://github.com/nasa/GeneLab_Metagenomics_Workflow) topic:genelab,genomics,metagenomics,nextflow,workflow pushed_at:2026-06 star:0.0k fork:0.0k Nextflow implementation of the GeneLab Metagenomics data processing pipelines.
- [nasa/GeneLab_MethylSeq_Workflow](https://github.com/nasa/GeneLab_MethylSeq_Workflow) topic:genelab,genomics,methyl-seq,methylation-analysis,rna-methylation,workflow pushed_at:2025-12 star:0.0k fork:0.0k Nextflow implementation of the GeneLab MethylSeq data processing pipelines.
- [nasa/GeneLab_RNASeq_Workflow](https://github.com/nasa/GeneLab_RNASeq_Workflow) topic:differential-expression,genelab,genes,genomics,nextflow,rna-seq,workflow pushed_at:2026-09 star:0.0k fork:0.0k Nextflow implementation of the GeneLab bulk RNASeq data processing pipelines.
...
- [nasa/Heimdall-WxRadar-MetFall-Extractor](https://github.com/nasa/Heimdall-WxRadar-MetFall-Extractor) topic: pushed_at:2025-07 star:0.0k fork:0.0k 
...
- [nasa/Inverse-Design-of-Materials](https://github.com/nasa/Inverse-Design-of-Materials) topic: pushed_at:2025-06 star:0.0k fork:0.0k Algorithms to perform inverse design of materials. Machine learning models establish the relationship between processing and material properties with uncertainty quantification. Bayesian optimization, other optimization algorithms, or machine learning models determine optimal processing steps to achieve target material properties.
...
- [nasa/libbrace](https://github.com/nasa/libbrace) topic: pushed_at:2025-06 star:0.0k fork:0.0k 
...
- [nasa/MATLAB_OSLO_toolkit](https://github.com/nasa/MATLAB_OSLO_toolkit) topic: pushed_at:2026-01 star:0.0k fork:0.0k 
- [nasa/MDE-SDK](https://github.com/nasa/MDE-SDK) topic: pushed_at:2022-07 star:0.0k fork:0.0k Math Description Engine
- [nasa/mead](https://github.com/nasa/mead) topic: pushed_at:2025-06 star:0.0k fork:0.0k 
- [nasa/mercury7](https://github.com/nasa/mercury7) topic: pushed_at:2026-03 star:0.0k fork:0.0k CAD and software to build the same M7 prototype rovers that were built as part of CADRE to develop and test multi-rover autonomy software on rovers with the same compute and sensors are the flight models.
- [nasa/MPEC](https://github.com/nasa/MPEC) topic: pushed_at:2025-04 star:0.0k fork:0.0k electronic structure program
...
- [nasa/NASA-3D-Resources](https://github.com/nasa/NASA-3D-Resources) topic: pushed_at:2025-06 star:3.8k fork:0.5k Here you'll find a growing collection of 3D models, textures, and images from inside NASA.
...
- [nasa/okapi](https://github.com/nasa/okapi) topic: pushed_at:2025-06 star:0.0k fork:0.0k 
...
- [nasa/Open-Source-Catalog](https://github.com/nasa/Open-Source-Catalog) topic:ai-tags,catalog,meta-record,nasa,open-source,website pushed_at:2026-07 star:0.3k fork:0.1k Contains the NASA open source software catalog for automatic deployment to code.nasa.gov
...
- [nasa/opera-sds-ai](https://github.com/nasa/opera-sds-ai) topic: pushed_at:2026-06 star:0.0k fork:0.0k 
- [nasa/opera-sds-tools](https://github.com/nasa/opera-sds-tools) topic: pushed_at:2026-06 star:0.0k fork:0.0k 
- [nasa/OpticalConstantDatabase](https://github.com/nasa/OpticalConstantDatabase) topic: pushed_at:2022-02 star:0.0k fork:0.0k 
- [nasa/OSDR_Data_Curation](https://github.com/nasa/OSDR_Data_Curation) topic: pushed_at:2026-08 star:0.0k fork:0.0k 
- [nasa/otools](https://github.com/nasa/otools) topic: pushed_at:2025-06 star:0.0k fork:0.0k 
...
- [nasa/pinpoint](https://github.com/nasa/pinpoint) topic: pushed_at:2025-06 star:0.0k fork:0.0k 
...
- [nasa/sdtp](https://github.com/nasa/sdtp) topic: pushed_at:2025-06 star:0.0k fork:0.0k 
...
- [nasa/T2S](https://github.com/nasa/T2S) topic: pushed_at:2025-05 star:0.0k fork:0.0k 
...
- [nasa/uam-apis](https://github.com/nasa/uam-apis) topic: pushed_at:2025-09 star:0.0k fork:0.0k 
...
- [nasa/virgo](https://github.com/nasa/virgo) topic: pushed_at:2026-08 star:0.0k fork:0.0k 
- [nasa/waveracers](https://github.com/nasa/waveracers) topic: pushed_at:2026-07 star:0.0k fork:0.0k 
...
- [nasa/nasapress](https://github.com/nasa/nasapress) topic: pushed_at:2026-03 star:0.1k fork:0.0k Deprecated legacy WordPress theme for NASA Glenn Research Center sites. Retained for historical reference; no further active maintenance planned.
...
- [nasa/NPSS-Power-System-Library](https://github.com/nasa/NPSS-Power-System-Library) topic: pushed_at:2026-07 star:0.0k fork:0.0k 
...
- [nasa/abaverify](https://github.com/nasa/abaverify) topic: pushed_at:2026-07 star:0.0k fork:0.0k 
...
- [nasa/AMMPER](https://github.com/nasa/AMMPER) topic: pushed_at:2026-08 star:0.0k fork:0.0k 
- [nasa/apod-api](https://github.com/nasa/apod-api) topic:apod-api,apod-image,apod-parser,astronomy,astronomy-photo,astronomy-picture,astronomy-picture-of-the-day,nasa,nasa-api,space pushed_at:2026-09 star:1.1k fork:0.2k Astronomy Picture of the Day API service
- [nasa/AppEEARS-QGIS-Plugin](https://github.com/nasa/AppEEARS-QGIS-Plugin) topic:appeears,lpdaac pushed_at:2026-09 star:0.0k fork:0.0k Browse and load cloud-optimized geotiff output files from AppEEARS directly into QGIS
- [nasa/AQUAMI-TGO](https://github.com/nasa/AQUAMI-TGO) topic: pushed_at:2025-06 star:0.0k fork:0.0k Automatic Image Analysis of Environmental Barrier Coating Oxide Layers using Machine Learning and Computer Vision
- [nasa/atmospheric-neural-rendering](https://github.com/nasa/atmospheric-neural-rendering) topic: pushed_at:2025-10 star:0.0k fork:0.0k Library & scripts for cloud 3d volumetric reconstruction in multi-angle satellite data using neural rendering.
- [nasa/batchee](https://github.com/nasa/batchee) topic:asdc,batching,filenames,grouping pushed_at:2026-09 star:0.0k fork:0.0k NASA Harmony service that groups together files into batches for concatenation
- [nasa/bingo](https://github.com/nasa/bingo) topic: pushed_at:2026-08 star:0.1k fork:0.0k 
- [nasa/bp](https://github.com/nasa/bp) topic: pushed_at:2026-03 star:0.0k fork:0.0k The Bundle Protocol Core Flight System Application (BP) License: Apache-2.0
- [nasa/BrightComets](https://github.com/nasa/BrightComets) topic: pushed_at:2019-12 star:0.0k fork:0.0k 
- [nasa/camel](https://github.com/nasa/camel) topic: pushed_at:2026-08 star:0.0k fork:0.0k SRA number: GSC-19,143-1 
- [nasa/cape](https://github.com/nasa/cape) topic: pushed_at:2026-09 star:0.0k fork:0.0k Computational Aerosciences Productivity & Execution
...
- [nasa/cfs-cosmos-plugin](https://github.com/nasa/cfs-cosmos-plugin) topic: pushed_at:2026-09 star:0.0k fork:0.0k 
- [nasa/cFS-EDS-GroundStation](https://github.com/nasa/cFS-EDS-GroundStation) topic: pushed_at:2021-11 star:0.0k fork:0.0k 
- [nasa/cFS-GroundSystem](https://github.com/nasa/cFS-GroundSystem) topic: pushed_at:2026-09 star:0.1k fork:0.1k The Core Flight System (cFS) Ground System Lab Tool (cFS-GroundSystem)
- [nasa/cmr-tea-config-generator](https://github.com/nasa/cmr-tea-config-generator) topic: pushed_at:2026-05 star:0.0k fork:0.0k 
- [nasa/concept-tagging-api](https://github.com/nasa/concept-tagging-api) topic:api,concept-tag,flask-application,machine-learning,nasa,nasa-api,nlp,nlp-machine-learning,usg-artificial-intelligence pushed_at:2024-10 star:0.0k fork:0.0k Contains code for the API that takes in text and predicts concepts & keywords from a list of standardized NASA keywords.  API is for exposing models created with the repository `concept-tagging-training`.  
...
- [nasa/condor](https://github.com/nasa/condor) topic: pushed_at:2026-09 star:0.1k fork:0.0k NASA's Condor is a framework for mathematical modeling of engineering systems in Python, for engineers with deadlines.
- [nasa/COTS-Star-Tracker](https://github.com/nasa/COTS-Star-Tracker) topic: pushed_at:2025-08 star:0.1k fork:0.0k 
- [nasa/CrisisMappingToolkit](https://github.com/nasa/CrisisMappingToolkit) topic: pushed_at:2025-12 star:0.2k fork:0.1k NASA Ames Crisis Mapping Toolkit
- [nasa/CTF](https://github.com/nasa/CTF) topic: pushed_at:2026-07 star:0.0k fork:0.0k This is a new repository for a new tool to be added to the cFS ecosystem called cFS Test Framework (CTF).
- [nasa/Cumulus-API-Python](https://github.com/nasa/Cumulus-API-Python) topic: pushed_at:2026-04 star:0.0k fork:0.0k  Python client library that abstracts CUMULUS API calls to interact with the Cumulus Framework, such as monitoring status or creating, editing, and deleting records. This is the same API that powers the Cumulus dashboard. 
...
- [nasa/cumulus-gap-detection](https://github.com/nasa/cumulus-gap-detection) topic: pushed_at:2026-09 star:0.0k fork:0.0k 
- [nasa/cumulus-message-adapter](https://github.com/nasa/cumulus-message-adapter) topic:cumulus,nasa-cumulus pushed_at:2026-06 star:0.0k fork:0.0k A command-line interface for preparing and outputting Cumulus Messages for Cumulus Tasks
- [nasa/cumulus-message-adapter-python](https://github.com/nasa/cumulus-message-adapter-python) topic:cumulus,nasa-cumulus pushed_at:2025-09 star:0.0k fork:0.0k 
- [nasa/cumulus-orca](https://github.com/nasa/cumulus-orca) topic: pushed_at:2026-03 star:0.0k fork:0.0k 
- [nasa/cumulus-process-py](https://github.com/nasa/cumulus-process-py) topic:cumulus,nasa-cumulus pushed_at:2026-06 star:0.0k fork:0.0k Python utilities library for Cumulus
...
- [nasa/DCATUS-Validator](https://github.com/nasa/DCATUS-Validator) topic: pushed_at:2026-08 star:0.0k fork:0.0k 
...
- [nasa/doi-trace](https://github.com/nasa/doi-trace) topic: pushed_at:2025-05 star:0.0k fork:0.0k 
...
- [nasa/dtn-test-framework](https://github.com/nasa/dtn-test-framework) topic: pushed_at:2025-08 star:0.0k fork:0.0k 
- [nasa/dtn-tools](https://github.com/nasa/dtn-tools) topic: pushed_at:2026-03 star:0.0k fork:0.0k Collection of tools that can be used in python-based scripts to run tests against a Bundle Protocol version 7 Delay/Disruption Tolerant Networking (DTN) node.
- [nasa/earth-imagery-api](https://github.com/nasa/earth-imagery-api) topic:api,beginner,earth,earth-observation,flask,gee,imagery,landsat,nasa,python,satellite,satellite-data,satellite-imagery,user-friendly pushed_at:2025-07 star:0.0k fork:0.0k The code repository for earth-imagery-api on https://api.nasa.gov/
- [nasa/Earthdata-DUCS](https://github.com/nasa/Earthdata-DUCS) topic: pushed_at:2026-09 star:0.0k fork:0.0k Earthdata Data Use Code Snippets (DUCS) 
- [nasa/earthdata-hashdiff](https://github.com/nasa/earthdata-hashdiff) topic: pushed_at:2026-09 star:0.0k fork:0.0k 
- [nasa/earthdata-mcp](https://github.com/nasa/earthdata-mcp) topic: pushed_at:2026-09 star:0.0k fork:0.0k An MCP (Model Context Protocol) server providing LLM agents with direct access to NASA's Common Metadata Repository (CMR).
- [nasa/earthdata-varinfo](https://github.com/nasa/earthdata-varinfo) topic: pushed_at:2026-09 star:0.0k fork:0.0k 
- [nasa/edgraph](https://github.com/nasa/edgraph) topic: pushed_at:2025-08 star:0.0k fork:0.0k 
...
- [nasa/ExoMiner](https://github.com/nasa/ExoMiner) topic:astronomy,astrophysics,big-data,convolutional-neural-networks,data-science,deep-learning,exominer,exoplanets,kepler,machine-learning,nasa,neural-networks,photometry,tess,tess-spoc pushed_at:2026-09 star:0.1k fork:0.0k Automating the vetting and validation of planet candidates from photometry survey missions - Kepler and TESS - using deep learning methods
- [nasa/ExoVista](https://github.com/nasa/ExoVista) topic: pushed_at:2026-08 star:0.0k fork:0.0k 
- [nasa/feature_selection_tool](https://github.com/nasa/feature_selection_tool) topic: pushed_at:2022-03 star:0.0k fork:0.0k 
- [nasa/fprime-actions](https://github.com/nasa/fprime-actions) topic: pushed_at:2026-09 star:0.0k fork:0.0k 
- [nasa/fprime-gds](https://github.com/nasa/fprime-gds) topic: pushed_at:2026-09 star:0.0k fork:0.1k F´ Python Ground Data System (GDS).
- [nasa/fprime-tools](https://github.com/nasa/fprime-tools) topic: pushed_at:2026-09 star:0.0k fork:0.1k F´ Python tooling and helpers.
...
- [nasa/GHRC-PyLOT](https://github.com/nasa/GHRC-PyLOT) topic: pushed_at:2026-04 star:0.0k fork:0.0k Python Core
- [nasa/giant](https://github.com/nasa/giant) topic: pushed_at:2025-09 star:0.1k fork:0.0k Goddard Image Analysis and Navigation Tool
...
- [nasa/harmony-autotester](https://github.com/nasa/harmony-autotester) topic: pushed_at:2026-09 star:0.0k fork:0.0k 
- [nasa/harmony-browse-image-generator](https://github.com/nasa/harmony-browse-image-generator) topic: pushed_at:2026-09 star:0.0k fork:0.0k 
- [nasa/harmony-casper](https://github.com/nasa/harmony-casper) topic: pushed_at:2026-09 star:0.0k fork:0.0k 
- [nasa/harmony-filtering-service](https://github.com/nasa/harmony-filtering-service) topic: pushed_at:2026-08 star:0.0k fork:0.0k 
- [nasa/harmony-gdal-adapter](https://github.com/nasa/harmony-gdal-adapter) topic: pushed_at:2026-09 star:0.0k fork:0.0k Translates Harmony service requests into gdal transformations
- [nasa/harmony-maskfill](https://github.com/nasa/harmony-maskfill) topic: pushed_at:2026-09 star:0.0k fork:0.0k 
- [nasa/harmony-metadata-annotator](https://github.com/nasa/harmony-metadata-annotator) topic: pushed_at:2026-09 star:0.0k fork:0.0k 
- [nasa/harmony-netcdf-to-zarr](https://github.com/nasa/harmony-netcdf-to-zarr) topic: pushed_at:2025-04 star:0.0k fork:0.0k Service for transforming NetCDF4 files into Zarr files within Harmony.  https://github.com/nasa/harmony
- [nasa/harmony-opendap-subsetter](https://github.com/nasa/harmony-opendap-subsetter) topic: pushed_at:2026-09 star:0.0k fork:0.0k 
- [nasa/harmony-py](https://github.com/nasa/harmony-py) topic: pushed_at:2026-09 star:0.1k fork:0.0k Python client library for working with NASA’s Earth observing system data using Harmony.  https://harmony.earthdata.nasa.gov
...
- [nasa/harmony-regridding-service](https://github.com/nasa/harmony-regridding-service) topic: pushed_at:2026-09 star:0.0k fork:0.0k 
- [nasa/harmony-service-example](https://github.com/nasa/harmony-service-example) topic: pushed_at:2025-12 star:0.0k fork:0.0k Example service implementation for subsetting and reprojecting L3 data using Harmony. https://github.com/nasa/harmony
- [nasa/harmony-service-lib-py](https://github.com/nasa/harmony-service-lib-py) topic: pushed_at:2026-05 star:0.0k fork:0.0k Python library to simplify adapting transformation services for use in Harmony https://github.com/nasa/harmony
- [nasa/harmony-SMAP-L2-gridding-service](https://github.com/nasa/harmony-SMAP-L2-gridding-service) topic: pushed_at:2026-09 star:0.0k fork:0.0k 
- [nasa/harmony-swath-projector](https://github.com/nasa/harmony-swath-projector) topic: pushed_at:2026-09 star:0.0k fork:0.0k 
...
- [nasa/HyperCP](https://github.com/nasa/HyperCP) topic: pushed_at:2026-08 star:0.1k fork:0.0k 
...
- [nasa/Kamodo-core](https://github.com/nasa/Kamodo-core) topic: pushed_at:2026-08 star:0.0k fork:0.0k Kamodo is an open source CCMC tool for access, interpolation, and visualization of space weather models and data in python. Kamodo allows model developers to represent simulation results as mathematical functions which may be manipulated directly by end users.
...
- [nasa/lfc](https://github.com/nasa/lfc) topic: pushed_at:2025-07 star:0.0k fork:0.0k LFC is an extension to git for managing large files
- [nasa/LHASA](https://github.com/nasa/LHASA) topic: pushed_at:2026-03 star:0.1k fork:0.0k Landslide Hazard Analysis for Situational Awareness
...
- [nasa/materialite](https://github.com/nasa/materialite) topic:additive-manufacturing,crystal-plasticity,crystallography,materials-science,mechanics-of-materials,orientation,tensors pushed_at:2025-11 star:0.0k fork:0.0k Streamlined Microstructure Modeling for Materials Science and Mechanics
- [nasa/MEOW-ML](https://github.com/nasa/MEOW-ML) topic: pushed_at:2026-03 star:0.0k fork:0.0k 
- [nasa/metnumdens](https://github.com/nasa/metnumdens) topic: pushed_at:2025-11 star:0.0k fork:0.0k 
...
- [nasa/monitoring](https://github.com/nasa/monitoring) topic: pushed_at:2025-03 star:0.0k fork:0.0k InterUSS Platform USS monitoring tools for federated UTM, including automated testing.
...
- [nasa/MXMCPy](https://github.com/nasa/MXMCPy) topic: pushed_at:2024-07 star:0.0k fork:0.0k 
- [nasa/nasa-soteria-processing-code](https://github.com/nasa/nasa-soteria-processing-code) topic: pushed_at:2024-11 star:0.0k fork:0.0k 
- [nasa/nasmat-prepost](https://github.com/nasa/nasmat-prepost) topic: pushed_at:2026-06 star:0.0k fork:0.0k 
- [nasa/ncompare](https://github.com/nasa/ncompare) topic:data-comparison,hierarchical-data,netcdf pushed_at:2026-09 star:0.0k fork:0.0k Compare the structure of two netCDF (or HDF5) files
- [nasa/OnAIR](https://github.com/nasa/OnAIR) topic: pushed_at:2026-04 star:0.1k fork:0.0k The On-board Artificial Intelligence Research (OnAIR) Platform is a framework that enables AI algorithms written in Python to interact with NASA's cFS. It is intended to explore research concepts in autonomous operations in a simulated environment. 
...
- [nasa/opera-sds-bach-api](https://github.com/nasa/opera-sds-bach-api) topic: pushed_at:2026-09 star:0.0k fork:0.0k 
- [nasa/opera-sds-int](https://github.com/nasa/opera-sds-int) topic: pushed_at:2026-03 star:0.0k fork:0.0k 
- [nasa/opera-sds-lambdas](https://github.com/nasa/opera-sds-lambdas) topic: pushed_at:2026-09 star:0.0k fork:0.0k 
- [nasa/opera-sds-pcm](https://github.com/nasa/opera-sds-pcm) topic: pushed_at:2026-09 star:0.0k fork:0.0k Observational Products for End-Users from Remote Sensing Analysis (OPERA)
- [nasa/opera-sds-pge](https://github.com/nasa/opera-sds-pge) topic: pushed_at:2026-09 star:0.0k fork:0.0k Observational Products for End-Users from Remote Sensing Analysis (OPERA)
...
- [nasa/OSDR_Tutorials](https://github.com/nasa/OSDR_Tutorials) topic: pushed_at:2026-08 star:0.0k fork:0.0k 
- [nasa/Oversight](https://github.com/nasa/Oversight) topic: pushed_at:2021-10 star:0.0k fork:0.0k 
- [nasa/ow_simulator](https://github.com/nasa/ow_simulator) topic: pushed_at:2024-09 star:0.2k fork:0.0k 
- [nasa/pbs4py](https://github.com/nasa/pbs4py) topic:batch-jobs,hpc,pbs pushed_at:2026-07 star:0.0k fork:0.0k Python utilities for submitting jobs on high performance computing systems
...
- [nasa/PLEXIL-V](https://github.com/nasa/PLEXIL-V) topic: pushed_at:2026-09 star:0.0k fork:0.0k PLEXIL5 is a Formal Verification Environment for PLEXIL
- [nasa/podaac_tools_and_services](https://github.com/nasa/podaac_tools_and_services) topic:gravity,nasa,ocean-circulation,ocean-surface-topography,ocean-winds,oceanography,ost,physical-oceanography,podaac,sea,sea-ice,sea-surface-salinity,sea-surface-temperature,services,sss,sst,tools pushed_at:2025-05 star:0.1k fork:0.0k A meta-repository which essentially lists code related to all tools and services software for NASA JPL's PO.DAAC
...
- [nasa/prog_server](https://github.com/nasa/prog_server) topic:prognostics,prognostics-as-a-service,prognostics-health-management pushed_at:2025-06 star:0.0k fork:0.0k The NASA Prognostics As-A-Service (PaaS) Sandbox is a simplified implementation of a Software Oriented Architecture (SOA) for performing prognostics (estimation of time until events and future system states) of engineering systems. The PaaS Sandbox is a wrapper around the Prognostics Algorithms Package and Prognostics Models Package, allowing one or more users to access the features of these packages through a REST API. The package is intended to be used as a research tool to prototype and benchmark Prognostics As-A-Service (PaaS) architectures and work on the challenges facing such architectures, including Generality, Communication, Security, Environmental Complexity, Utility, and Trust.
- [nasa/progpy](https://github.com/nasa/progpy) topic:integrated-system-health-management,modeling,modeling-and-simulation,prognostic-models,prognostics,prognostics-health-management,simulation pushed_at:2026-08 star:0.1k fork:0.0k The NASA Prognostic Python Packages is a Python framework focused on defining and building models and algorit for prognostics (computation of remaining useful life) of engineering systems, and provides a set of models and algorithms for select components developed within this framework, suitable for use in prognostic applications.
- [nasa/PROTEUS](https://github.com/nasa/PROTEUS) topic: pushed_at:2025-10 star:0.0k fork:0.0k PROTEUS - The Dynamic Surface Water eXtent from Harmonized Landsat and Sentinel-2 (DSWx-HLS) Science Application Software (SAS)
- [nasa/pyCMR](https://github.com/nasa/pyCMR) topic: pushed_at:2018-11 star:0.0k fork:0.0k Client for CMR APIs
- [nasa/pyDownlinkParser](https://github.com/nasa/pyDownlinkParser) topic:ccsds,ccsdspy pushed_at:2026-06 star:0.0k fork:0.0k Parse downlinks binary file following CCSDS standard, primarily for Europa-Clipper Science Data System.
...
- [nasa/pyrefine](https://github.com/nasa/pyrefine) topic:cfd,mesh-adaptation,refine pushed_at:2025-05 star:0.0k fork:0.0k Python scripting for computational fluid dynamics mesh adaptation with refine
- [nasa/pysips](https://github.com/nasa/pysips) topic:bayesian-inference,genetic-programming,sequential-monte-carlo,symbolic-regression pushed_at:2026-07 star:0.0k fork:0.0k A symbolic regression tool designed to work with noisy data 
- [nasa/python_cmr](https://github.com/nasa/python_cmr) topic: pushed_at:2026-08 star:0.0k fork:0.0k Python library for querying the common metadata repository.
- [nasa/radbelt](https://github.com/nasa/radbelt) topic:cubesat,electron,heliophysics,igrf,magnetosphere,nasa,proton,radiation,satellite pushed_at:2025-05 star:0.0k fork:0.0k radbelt: An Astropy-friendly wrapper for the AE-8/AP-8 Van Allen belt model. Replaced by https://github.com/m4opt/aep8
- [nasa/random_field_c-lfm](https://github.com/nasa/random_field_c-lfm) topic: pushed_at:2026-06 star:0.0k fork:0.0k 
...
- [nasa/ROSES-Compliance-Checking-Tools](https://github.com/nasa/ROSES-Compliance-Checking-Tools) topic: pushed_at:2026-05 star:0.0k fork:0.0k 
...
- [nasa/scrub](https://github.com/nasa/scrub) topic:code-quality,code-review,python,security,static-analysis pushed_at:2026-09 star:0.1k fork:0.0k SCRUB is a platform for orchestration and aggregation of static code analysis tools.
...
- [nasa/simupy-flight](https://github.com/nasa/simupy-flight) topic: pushed_at:2024-12 star:0.1k fork:0.0k 
- [nasa/SMCPy](https://github.com/nasa/SMCPy) topic: pushed_at:2026-08 star:0.1k fork:0.0k Python module for uncertainty quantification using a parallel sequential Monte Carlo sampler
- [nasa/spotthestation-backend](https://github.com/nasa/spotthestation-backend) topic: pushed_at:2026-07 star:0.0k fork:0.0k 
- [nasa/spreadsheet-row-indexer](https://github.com/nasa/spreadsheet-row-indexer) topic: pushed_at:2026-07 star:0.0k fork:0.0k 
...
- [nasa/stitchee](https://github.com/nasa/stitchee) topic:asdc,concatenation,data-combination,netcdf pushed_at:2026-09 star:0.0k fork:0.0k NASA Harmony service that concatenates netCDF4 data files along an existing dimension
- [nasa/svrstormsig](https://github.com/nasa/svrstormsig) topic: pushed_at:2026-09 star:0.0k fork:0.0k 
...
- [nasa/GeneLab_AmpliconSeq_Workflow](https://github.com/nasa/GeneLab_AmpliconSeq_Workflow) topic:amplicon-sequencing,genelab,genomics,microbiome,workflow pushed_at:2026-07 star:0.0k fork:0.0k Nextflow implementation of the GeneLab Amplicon Sequencing data processing pipeline.
- [nasa/GeoNEXTools](https://github.com/nasa/GeoNEXTools) topic: pushed_at:2025-11 star:0.0k fork:0.0k 
...
- [nasa/puppies](https://github.com/nasa/puppies) topic: pushed_at:2025-01 star:0.0k fork:0.0k 
...
- [nasa/cmr-metadata-review](https://github.com/nasa/cmr-metadata-review) topic:rails,ruby pushed_at:2025-09 star:0.0k fork:0.0k The CMR Metadata Review tool is used to curate NASA EOSDIS collection and granule level metadata in CMR for correctness, completeness and consistency.
- [nasa/cmr-opensearch](https://github.com/nasa/cmr-opensearch) topic: pushed_at:2026-09 star:0.0k fork:0.0k CMR-OpenSearch is a web application developed by NASA EOSDIS to enable data discovery, search, and access across the CMR Earth Science data holdings via the OpenSearch standard.
- [nasa/georef_deploy](https://github.com/nasa/georef_deploy) topic: pushed_at:2020-08 star:0.0k fork:0.0k 

## Rust

- [nasa/spacewasm](https://github.com/nasa/spacewasm) topic:embedded-systems,flight-software,webassembly pushed_at:2026-09 star:1.6k fork:0.1k A flight-compliant WebAssembly interpreter.
- [nasa/wavepool](https://github.com/nasa/wavepool) topic: pushed_at:2026-07 star:0.0k fork:0.0k 

## SCSS

- [nasa/api-docs](https://github.com/nasa/api-docs) topic:api,demo,example,gov,javascript,nasa,nasa-apis,python,uswds pushed_at:2026-09 star:0.6k fork:0.1k api.nasa.gov
- [nasa/data-nasa-gov-frontpage](https://github.com/nasa/data-nasa-gov-frontpage) topic:data-catalog,data-visualization,datasets,frontpage,gov,gov-tech,metadata,nasa,open-data,treemap pushed_at:2024-10 star:0.0k fork:0.0k a frontpage for data.nasa.gov
- [nasa/esdis-services-governance-model](https://github.com/nasa/esdis-services-governance-model) topic: pushed_at:2026-09 star:0.0k fork:0.0k 

## Scala

- [nasa/fpp](https://github.com/nasa/fpp) topic: pushed_at:2026-09 star:0.1k fork:0.1k F Prime Prime: A modeling language for F Prime
...
- [nasa/nasa-latex-docs](https://github.com/nasa/nasa-latex-docs) topic:aiaa,documentation,ieee,latex,latex-template,latexmk pushed_at:2026-03 star:0.3k fork:0.1k An easy and convenient package to create technical LaTeX documents.

## TypeScript

- [nasa/aegis](https://github.com/nasa/aegis) topic: pushed_at:2026-09 star:0.0k fork:0.0k 
- [nasa/cmr-stac](https://github.com/nasa/cmr-stac) topic: pushed_at:2026-09 star:0.1k fork:0.0k 
- [nasa/coda](https://github.com/nasa/coda) topic: pushed_at:2026-09 star:0.0k fork:0.0k 
- [nasa/daa-displays](https://github.com/nasa/daa-displays) topic: pushed_at:2025-09 star:0.0k fork:0.0k 
- [nasa/DANTi](https://github.com/nasa/DANTi) topic: pushed_at:2024-12 star:0.0k fork:0.0k DANTi: Detect and Avoid application for Manned Aviation
- [nasa/earthdata-download](https://github.com/nasa/earthdata-download) topic:hacktoberfest pushed_at:2026-09 star:0.1k fork:0.0k Download your Earth science data with only one click
- [nasa/esdis-data-catalog](https://github.com/nasa/esdis-data-catalog) topic: pushed_at:2026-09 star:0.0k fork:0.0k A simplified search interface for NASA's CMR Data Catalog
- [nasa/gesdisc-meditor](https://github.com/nasa/gesdisc-meditor) topic: pushed_at:2026-09 star:0.0k fork:0.0k 
- [nasa/harmony](https://github.com/nasa/harmony) topic: pushed_at:2026-09 star:0.1k fork:0.1k Application for providing services for Earth observation data in the cloud using standards-based APIs
- [nasa/hermes](https://github.com/nasa/hermes) topic:commanding,flight-software,ground-station,telemetry pushed_at:2026-09 star:0.1k fork:0.0k A lightweight extensible spacecraft commanding & telemetry processing framework
- [nasa/openmct-build](https://github.com/nasa/openmct-build) topic: pushed_at:2026-08 star:0.0k fork:0.0k 
- [nasa/spotthestation](https://github.com/nasa/spotthestation) topic: pushed_at:2026-07 star:0.0k fork:0.0k Spot The Station Application Code Rep
- [nasa/terra-ui-components](https://github.com/nasa/terra-ui-components) topic: pushed_at:2026-09 star:0.0k fork:0.0k 
- [nasa/vscode-pvs](https://github.com/nasa/vscode-pvs) topic: pushed_at:2026-07 star:0.1k fork:0.0k LAR-19642-1: Visual Studio Code Extension for PVS
