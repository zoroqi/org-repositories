...
- [nasa/CF](https://github.com/nasa/CF) topic: pushed_at:2024-08 star:0.1k fork:0.0k The Core Flight System (cFS) CFDP application.
...
- [nasa/HK](https://github.com/nasa/HK) topic: pushed_at:2024-07 star:0.0k fork:0.0k The Core Flight System (cFS) Housekeeping (HK) application.
...
- [nasa/MD](https://github.com/nasa/MD) topic: pushed_at:2024-08 star:0.0k fork:0.0k  The Core Flight System (cFS) Memory Dwell (MD) application.
...
- [nasa/MM](https://github.com/nasa/MM) topic: pushed_at:2024-08 star:0.0k fork:0.0k The Core Flight System (cFS) Memory Manager (MM) application.
...
- [nasa/nos3](https://github.com/nasa/nos3) topic:42,cfs,cosmos,digital-twin,nasa,nos,nos3,simulator pushed_at:2024-09 star:0.3k fork:0.1k NASA Operational Simulator for Small Satellites
...
- [nasa/reflow](https://github.com/nasa/reflow) topic: pushed_at:2024-07 star:0.0k fork:0.0k 
...
- [nasa/tvsio](https://github.com/nasa/tvsio) topic:cfs,sbn,trick,tvsio pushed_at:2024-08 star:0.0k fork:0.0k Trick Variable Server Input Output is a Core Flight Software app that can transfer data to and from Trick simulations
...
- [nasa/astrobee](https://github.com/nasa/astrobee) topic: pushed_at:2024-08 star:1.0k fork:0.3k NASA Astrobee Robot Software
...
- [nasa/fpp](https://github.com/nasa/fpp) topic: pushed_at:2024-09 star:0.0k fork:0.0k F Prime Prime: A modeling language for F Prime
- [nasa/fprime](https://github.com/nasa/fprime) topic:components,cpp,embedded,embedded-systems,flight,flight-software,fprime,framework,nasa,object-oriented-programming,raspberry-pi,real-time,spaceflight pushed_at:2024-09 star:10.0k fork:1.3k F´ - A flight software and embedded systems framework
...
- [nasa/jeod](https://github.com/nasa/jeod) topic: pushed_at:2024-08 star:0.0k fork:0.0k 
...
- [nasa/TrickHLA](https://github.com/nasa/TrickHLA) topic: pushed_at:2024-09 star:0.0k fork:0.0k TrickHLA: An IEEE 1516 High Level Architecture (HLA) Simulation Interoperability Standard Implementation for Trick Base Simulations
...
- [nasa/code-nasa-gov](https://github.com/nasa/code-nasa-gov) topic:catalog,code,gov-tech,nasa,open-source pushed_at:2024-03 star:0.2k fork:0.1k code.nasa.gov site leveraging the Open Source Catalog on github.com, powered by Polymer
...
- [nasa/Common-Metadata-Repository](https://github.com/nasa/Common-Metadata-Repository) topic:common-metadata-repository,eosdis pushed_at:2024-09 star:0.3k fork:0.1k 
...
- [nasa/instructions](https://github.com/nasa/instructions) topic:gov,nasa,welcome-page pushed_at:2024-08 star:0.3k fork:0.1k https://github.com/nasa/nasa.github.io/blob/master/docs/INSTRUCTIONS.md
...
- [nasa/PRECiSA](https://github.com/nasa/PRECiSA) topic: pushed_at:2024-07 star:0.0k fork:0.0k Program Round-off Error Certifier via Static Analysis
...
- [nasa/edsc-smart-handoffs](https://github.com/nasa/edsc-smart-handoffs) topic:earth-science,eosdis,gis,gsfc,hacktoberfest,hacktoberfest2022,nasa,open-source pushed_at:2024-04 star:0.0k fork:0.0k Smart handoffs allow users to link from one application to another while carrying with them certain parameters that set a specific context (e.g. open up the same dataset, temporal range, and spatial search in a new tool). This code simplifies the creation of smart handoff links.
- [nasa/edsc-timeline](https://github.com/nasa/edsc-timeline) topic:earthdata-search,eosdis,timeline pushed_at:2024-04 star:0.0k fork:0.0k 
...
- [nasa/Open-Source-Catalog](https://github.com/nasa/Open-Source-Catalog) topic:ai-tags,catalog,meta-record,nasa,open-source,website pushed_at:2024-07 star:0.3k fork:0.1k Contains the NASA open source software catalog for automatic deployment to code.nasa.gov
- [nasa/openmct](https://github.com/nasa/openmct) topic: pushed_at:2024-09 star:12.0k fork:1.2k A web based mission control framework. 
- [nasa/openmct-heatmap](https://github.com/nasa/openmct-heatmap) topic: pushed_at:2018-01 star:0.0k fork:0.0k 
- [nasa/openmct-hello](https://github.com/nasa/openmct-hello) topic: pushed_at:2024-08 star:0.0k fork:0.0k Hello, world plugin repository for Open MCT.
...
- [nasa/pyturbo-aero](https://github.com/nasa/pyturbo-aero) topic: pushed_at:2024-08 star:0.0k fork:0.0k Turbomachinery Blade and Flow path design tool
...
- [nasa/turbo-design](https://github.com/nasa/turbo-design) topic: pushed_at:2024-09 star:0.0k fork:0.0k 
...
- [nasa/open-science-tools](https://github.com/nasa/open-science-tools) topic: pushed_at:2024-08 star:0.0k fork:0.0k Python scripts for checking the contents of PubSpace for open science metrics.  Resources
...
- [nasa/spaceapps](https://github.com/nasa/spaceapps) topic: pushed_at:2024-08 star:0.4k fork:0.0k 
...
- [nasa/yoga](https://github.com/nasa/yoga) topic: pushed_at:2024-08 star:0.0k fork:0.0k 
...
- [nasa/lfc](https://github.com/nasa/lfc) topic: pushed_at:2024-08 star:0.0k fork:0.0k 
...
- [nasa/OnAIR](https://github.com/nasa/OnAIR) topic: pushed_at:2024-08 star:0.1k fork:0.0k The On-board Artificial Intelligence Research (OnAIR) Platform is a framework that enables AI algorithms written in Python to interact with NASA's cFS. It is intended to explore research concepts in autonomous operations in a simulated environment. 
...
- [nasa/opera-sds](https://github.com/nasa/opera-sds) topic: pushed_at:2024-09 star:0.0k fork:0.0k 
...
- [nasa/opera-sds-pcm](https://github.com/nasa/opera-sds-pcm) topic: pushed_at:2024-09 star:0.0k fork:0.0k Observational Products for End-Users from Remote Sensing Analysis (OPERA)
...
- [nasa/progpy](https://github.com/nasa/progpy) topic:integrated-system-health-management,modeling,modeling-and-simulation,prognostic-models,prognostics,prognostics-health-management,simulation pushed_at:2024-08 star:0.1k fork:0.0k The NASA Prognostic Python Packages is a Python framework focused on defining and building models and algorit for prognostics (computation of remaining useful life) of engineering systems, and provides a set of models and algorithms for select components developed within this framework, suitable for use in prognostic applications.
...
- [nasa/cmr-metadata-review](https://github.com/nasa/cmr-metadata-review) topic:rails,ruby pushed_at:2024-08 star:0.0k fork:0.0k The CMR Metadata Review tool is used to curate NASA EOSDIS collection and granule level metadata in CMR for correctness, completeness and consistency.
...
- [nasa/api-docs](https://github.com/nasa/api-docs) topic:api,demo,example,gov,javascript,nasa,nasa-apis,python,uswds pushed_at:2024-08 star:0.4k fork:0.1k api.nasa.gov
- [nasa/data-nasa-gov-frontpage](https://github.com/nasa/data-nasa-gov-frontpage) topic:data-catalog,data-visualization,datasets,frontpage,gov,gov-tech,metadata,nasa,open-data,treemap pushed_at:2024-07 star:0.0k fork:0.0k a frontpage for data.nasa.gov
...
- [nasa/gesdisc-meditor](https://github.com/nasa/gesdisc-meditor) topic: pushed_at:2024-08 star:0.0k fork:0.0k 
