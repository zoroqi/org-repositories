...
- [nasa/bp](https://github.com/nasa/bp) topic: pushed_at:2025-12 star:0.0k fork:0.0k The Bundle Protocol Core Flight System Application (BP) License: Apache-2.0
- [nasa/bplib](https://github.com/nasa/bplib) topic: pushed_at:2025-12 star:0.0k fork:0.0k 
...
- [nasa/CryptoLib](https://github.com/nasa/CryptoLib) topic:ccsds,cfs,communications,data-link,ground-station,sdls-ep,space-communications,space-data-link-security-protocol,space-network,spack-data-link pushed_at:2026-01 star:0.1k fork:0.1k Provide a software-only solution using the CCSDS Space Data Link Security Protocol - Extended Procedures (SDLS-EP) to secure communications between a spacecraft running the core Flight System (cFS) and a ground station.
...
- [nasa/fprime](https://github.com/nasa/fprime) topic:components,cpp,embedded,embedded-systems,flight,flight-software,fprime,framework,nasa,object-oriented-programming,raspberry-pi,real-time,spaceflight pushed_at:2026-03 star:10.8k fork:1.5k F´ - A flight software and embedded systems framework
...
- [nasa/gunns](https://github.com/nasa/gunns) topic: pushed_at:2026-02 star:0.1k fork:0.0k The NASA General-Use Nodal Network Solver (GUNNS) software
...
- [nasa/IDF](https://github.com/nasa/IDF) topic: pushed_at:2025-12 star:0.1k fork:0.0k 
...
- [nasa/koviz](https://github.com/nasa/koviz) topic: pushed_at:2026-02 star:0.0k fork:0.0k Koviz is a Trick simulation data plotting, visualization and analysis tool
...
- [nasa/TrickHLA](https://github.com/nasa/TrickHLA) topic: pushed_at:2026-03 star:0.1k fork:0.0k TrickHLA: An IEEE 1516 High Level Architecture (HLA) Simulation Interoperability Standard Implementation for Trick Base Simulations
...
- [nasa/cumulus-template-deploy](https://github.com/nasa/cumulus-template-deploy) topic:cumulus,nasa-cumulus pushed_at:2025-12 star:0.0k fork:0.0k Cumulus template deployment project
...
- [nasa/GeneLab-Training](https://github.com/nasa/GeneLab-Training) topic:education,genes,genetics,nasa,outreach,pipeline,training,training-materials pushed_at:2025-12 star:0.0k fork:0.0k A repository for GeneLab Training documentation.
...
- [nasa/opera-sds](https://github.com/nasa/opera-sds) topic: pushed_at:2026-03 star:0.0k fork:0.0k 
...
- [nasa/cumulus-message-adapter-js](https://github.com/nasa/cumulus-message-adapter-js) topic:cumulus,nasa-cumulus pushed_at:2026-02 star:0.0k fork:0.0k A library for validating and parsing the Cumulus message protocol
- [nasa/earthdata-search](https://github.com/nasa/earthdata-search) topic:data-discovery,earthdata-search,eosdis,hacktoberfest pushed_at:2026-03 star:0.8k fork:0.2k Earthdata Search is a web application developed by NASA EOSDIS to enable data discovery, search, comparison, visualization, and access across EOSDIS' Earth Science data holdings.
...
- [nasa/mmt](https://github.com/nasa/mmt) topic: pushed_at:2026-03 star:0.1k fork:0.0k NASA's Metadata Management Tool.
...
- [nasa/openmct](https://github.com/nasa/openmct) topic: pushed_at:2026-03 star:12.8k fork:1.4k A web based mission control framework. 
...
- [nasa/Plot3D_utilities](https://github.com/nasa/Plot3D_utilities) topic:computational-domain,mesh,mesh-generation,plot3d pushed_at:2026-03 star:0.0k fork:0.0k A Python library for reading, writing, finding connectivity for plot3d files
...
- [nasa/NDAS](https://github.com/nasa/NDAS) topic:labview,ndas pushed_at:2026-01 star:0.1k fork:0.0k NASA Data Acquisition System (NDAS) is an integrated suite of applications that manage the complete data acquisition lifecycle—from acquisition, processing, and calibration to display, recording, and distribution. This is our code peer review tool. 
...
- [nasa/GeneLab_Metagenomics_Workflow](https://github.com/nasa/GeneLab_Metagenomics_Workflow) topic:genelab,genomics,metagenomics,nextflow,workflow pushed_at:2026-02 star:0.0k fork:0.0k Nextflow implementation of the GeneLab Metagenomics data processing pipelines.
...
- [nasa/mercury7](https://github.com/nasa/mercury7) topic: pushed_at:2026-03 star:0.0k fork:0.0k 
...
- [nasa/apod-api](https://github.com/nasa/apod-api) topic:apod-api,apod-image,apod-parser,astronomy,astronomy-photo,astronomy-picture,astronomy-picture-of-the-day,nasa,nasa-api,space pushed_at:2026-02 star:1.0k fork:0.2k Astronomy Picture of the Day API service
...
- [nasa/bingo](https://github.com/nasa/bingo) topic: pushed_at:2026-02 star:0.1k fork:0.0k 
...
- [nasa/DCATUS-Validator](https://github.com/nasa/DCATUS-Validator) topic: pushed_at:2025-08 star:0.0k fork:0.0k 
...
- [nasa/dtn-tools](https://github.com/nasa/dtn-tools) topic: pushed_at:2025-12 star:0.0k fork:0.0k Collection of tools that can be used in python-based scripts to run tests against a Bundle Protocol version 7 Delay/Disruption Tolerant Networking (DTN) node.
...
- [nasa/ExoVista](https://github.com/nasa/ExoVista) topic: pushed_at:2025-12 star:0.0k fork:0.0k 
...
- [nasa/harmony-casper](https://github.com/nasa/harmony-casper) topic: pushed_at:2026-03 star:0.0k fork:0.0k 
...
- [nasa/opera-sds-bach-api](https://github.com/nasa/opera-sds-bach-api) topic: pushed_at:2026-02 star:0.0k fork:0.0k 
- [nasa/opera-sds-int](https://github.com/nasa/opera-sds-int) topic: pushed_at:2026-02 star:0.0k fork:0.0k 
- [nasa/opera-sds-lambdas](https://github.com/nasa/opera-sds-lambdas) topic: pushed_at:2026-02 star:0.0k fork:0.0k 
...
- [nasa/ROSES-Compliance-Checking-Tools](https://github.com/nasa/ROSES-Compliance-Checking-Tools) topic: pushed_at:2025-12 star:0.0k fork:0.0k 
...
- [nasa/SMCPy](https://github.com/nasa/SMCPy) topic: pushed_at:2025-09 star:0.1k fork:0.0k Python module for uncertainty quantification using a parallel sequential Monte Carlo sampler
...
- [nasa/api-docs](https://github.com/nasa/api-docs) topic:api,demo,example,gov,javascript,nasa,nasa-apis,python,uswds pushed_at:2026-02 star:0.5k fork:0.1k api.nasa.gov
...
- [nasa/nasa-latex-docs](https://github.com/nasa/nasa-latex-docs) topic:aiaa,documentation,ieee,latex,latex-template,latexmk pushed_at:2023-12 star:0.3k fork:0.1k An easy and convenient package to create technical LaTeX documents.
...
- [nasa/gesdisc-meditor](https://github.com/nasa/gesdisc-meditor) topic: pushed_at:2026-02 star:0.0k fork:0.0k 
...
- [nasa/hermes](https://github.com/nasa/hermes) topic:commanding,flight-software,ground-station,telemetry pushed_at:2026-03 star:0.0k fork:0.0k A lightweight extensible spacecraft commanding & telemetry processing framework
