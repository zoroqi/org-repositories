...
- [nasa/ci_lab](https://github.com/nasa/ci_lab) topic: pushed_at:2023-10 star:0.0k fork:0.0k The Core Flight System (cFS) Command Ingest Lab App (ci_lab)
...
- [nasa/elf2cfetbl](https://github.com/nasa/elf2cfetbl) topic: pushed_at:2023-10 star:0.0k fork:0.0k The Core Flight System (cFS) ELF to CFE Table Tool (elf2cfetbl)
...
- [nasa/sample_app](https://github.com/nasa/sample_app) topic: pushed_at:2023-10 star:0.0k fork:0.0k The Core Flight System (cFS) Sample App (sample_app)
...
- [nasa/sch_lab](https://github.com/nasa/sch_lab) topic: pushed_at:2023-10 star:0.0k fork:0.0k The Core Flight System (cFS) Scheduler Lab App (sch_lab)
...
- [nasa/to_lab](https://github.com/nasa/to_lab) topic: pushed_at:2023-10 star:0.0k fork:0.0k The Core Flight System (cFS) Telemetry Output Lab App (to_lab)
...
- [nasa/isaac](https://github.com/nasa/isaac) topic: pushed_at:2023-10 star:0.0k fork:0.0k Integrated System for Autonomous and Adaptive Caretaking
...
- [nasa/trick](https://github.com/nasa/trick) topic: pushed_at:2023-11 star:0.7k fork:0.2k Trick Simulation Environment.  Trick provides a common set of simulation capabilities and utilities to build simulations automatically.
...
- [nasa/instructions](https://github.com/nasa/instructions) topic:gov,nasa,welcome-page pushed_at:2023-10 star:0.3k fork:0.1k https://github.com/nasa/nasa.github.io/blob/master/docs/INSTRUCTIONS.md
...
- [nasa/ogma](https://github.com/nasa/ogma) topic: pushed_at:2023-10 star:0.3k fork:0.0k 
...
- [nasa/CCDD](https://github.com/nasa/CCDD) topic: pushed_at:2023-10 star:0.1k fork:0.0k CFS Command and Data Dictionary Tool (CCDDT)
...
- [nasa/openmct](https://github.com/nasa/openmct) topic: pushed_at:2023-11 star:11.1k fork:1.2k A web based mission control framework. 
...
- [nasa/AppEEARS-Data-Resources](https://github.com/nasa/AppEEARS-Data-Resources) topic:appeears,lpdaac pushed_at:2023-10 star:0.0k fork:0.0k  This repository provides resources and tutorials to help users work with AppEEARS programmatically.
- [nasa/ASDC_Data_and_User_Services](https://github.com/nasa/ASDC_Data_and_User_Services) topic: pushed_at:2023-10 star:0.0k fork:0.0k 
...
- [nasa/Earthdata-cloud-playground](https://github.com/nasa/Earthdata-cloud-playground) topic: pushed_at:2023-10 star:0.0k fork:0.0k Content will be open and available for use by our user communities, and will be used to help foster open science practices with our external collaborators.
- [nasa/exoscene](https://github.com/nasa/exoscene) topic: pushed_at:2022-04 star:0.0k fork:0.0k 
- [nasa/GEDI-Data-Resources](https://github.com/nasa/GEDI-Data-Resources) topic:gedi,lpdaac pushed_at:2023-10 star:0.0k fork:0.0k This repository provides guides, short how-tos, and tutorials to help users access and work with data from the Global Ecosystem Dynamics Investigation (GEDI) mission.
...
- [nasa/gesdisc-tutorials](https://github.com/nasa/gesdisc-tutorials) topic: pushed_at:2023-10 star:0.0k fork:0.0k 
...
- [nasa/zarr-accumulation-generation](https://github.com/nasa/zarr-accumulation-generation) topic: pushed_at:2023-10 star:0.0k fork:0.0k 
...
- [nasa/harmony-service-lib-py](https://github.com/nasa/harmony-service-lib-py) topic: pushed_at:2023-10 star:0.0k fork:0.0k Python library to simplify adapting transformation services for use in Harmony https://github.com/nasa/harmony
...
- [nasa/LHASA](https://github.com/nasa/LHASA) topic: pushed_at:2023-10 star:0.0k fork:0.0k Landslide Hazard Analysis for Situational Awareness
...
- [nasa/opera-sds-bach-api](https://github.com/nasa/opera-sds-bach-api) topic: pushed_at:2023-10 star:0.0k fork:0.0k 
- [nasa/opera-sds-int](https://github.com/nasa/opera-sds-int) topic: pushed_at:2023-09 star:0.0k fork:0.0k 
- [nasa/opera-sds-lambdas](https://github.com/nasa/opera-sds-lambdas) topic: pushed_at:2023-10 star:0.0k fork:0.0k 
- [nasa/opera-sds-ops](https://github.com/nasa/opera-sds-ops) topic: pushed_at:2023-09 star:0.0k fork:0.0k 
- [nasa/opera-sds-pcm](https://github.com/nasa/opera-sds-pcm) topic: pushed_at:2023-11 star:0.0k fork:0.0k Observational Products for End-Users from Remote Sensing Analysis (OPERA)
...
- [nasa/pretrained-microscopy-models](https://github.com/nasa/pretrained-microscopy-models) topic: pushed_at:2023-10 star:0.1k fork:0.0k 
- [nasa/prog_server](https://github.com/nasa/prog_server) topic:prognostics,prognostics-as-a-service,prognostics-health-management pushed_at:2023-10 star:0.0k fork:0.0k The NASA Prognostics As-A-Service (PaaS) Sandbox is a simplified implementation of a Software Oriented Architecture (SOA) for performing prognostics (estimation of time until events and future system states) of engineering systems. The PaaS Sandbox is a wrapper around the Prognostics Algorithms Package and Prognostics Models Package, allowing one or more users to access the features of these packages through a REST API. The package is intended to be used as a research tool to prototype and benchmark Prognostics As-A-Service (PaaS) architectures and work on the challenges facing such architectures, including Generality, Communication, Security, Environmental Complexity, Utility, and Trust.
- [nasa/progpy](https://github.com/nasa/progpy) topic:integrated-system-health-management,modeling,modeling-and-simulation,prognostic-models,prognostics,prognostics-health-management,simulation pushed_at:2023-10 star:0.0k fork:0.0k The NASA Prognostic Python Packages is a Python framework focused on defining and building models and algorit for prognostics (computation of remaining useful life) of engineering systems, and provides a set of models and algorithms for select components developed within this framework, suitable for use in prognostic applications.
