...
- [nasa/cFE](https://github.com/nasa/cFE) topic: pushed_at:2023-02 star:0.3k fork:0.2k The Core Flight System (cFS) Core Flight Executive (cFE)
...
- [nasa/CryptoLib](https://github.com/nasa/CryptoLib) topic:ccsds,cfs,communications,data-link,ground-station,sdls-ep,space-communications,space-data-link-security-protocol,space-network,spack-data-link pushed_at:2023-01 star:0.0k fork:0.0k Provide a software-only solution using the CCSDS Space Data Link Security Protocol - Extended Procedures (SDLS-EP) to secure communications between a spacecraft running the core Flight System (cFS) and a ground station.
- [nasa/CS](https://github.com/nasa/CS) topic: pushed_at:2023-02 star:0.0k fork:0.0k The Core Flight System (cFS) Checksum (CS) application.
- [nasa/DS](https://github.com/nasa/DS) topic: pushed_at:2023-02 star:0.0k fork:0.0k The Core Flight System (cFS) Data Storage (DS) application.
...
- [nasa/EdsLib](https://github.com/nasa/EdsLib) topic: pushed_at:2023-02 star:0.0k fork:0.0k CCSDS SOIS Electronic Data Sheet Tool and Library
...
- [nasa/FM](https://github.com/nasa/FM) topic: pushed_at:2023-02 star:0.0k fork:0.0k The Core Flight System (cFS) File Manager (FM) application.
...
- [nasa/HS](https://github.com/nasa/HS) topic: pushed_at:2023-02 star:0.0k fork:0.0k The Core Flight System (cFS) Health and Safety (HS) application.
...
- [nasa/LC](https://github.com/nasa/LC) topic: pushed_at:2023-02 star:0.0k fork:0.0k The Core Flight System (cFS) Limit Checker (LC) application.
- [nasa/MD](https://github.com/nasa/MD) topic: pushed_at:2023-02 star:0.0k fork:0.0k  The Core Flight System (cFS) Memory Dwell (MD) application.
...
- [nasa/MM](https://github.com/nasa/MM) topic: pushed_at:2023-02 star:0.0k fork:0.0k The Core Flight System (cFS) Memory Manager (MM) application.
...
- [nasa/nos3](https://github.com/nasa/nos3) topic: pushed_at:2023-03 star:0.1k fork:0.0k NASA Operational Simulator for Small Satellites
...
- [nasa/sample_app](https://github.com/nasa/sample_app) topic: pushed_at:2023-02 star:0.0k fork:0.0k The Core Flight System (cFS) Sample App (sample_app)
...
- [nasa/SBN-Client](https://github.com/nasa/SBN-Client) topic: pushed_at:2023-02 star:0.0k fork:0.0k The Software Bus Network Client (SBNC) enables two-way communication with NASA's core Flight System (cFS) Software Bus and an external application. SBNC implements the Software Bus Network (SBN) communication protocol in a standalone C library.
- [nasa/SC](https://github.com/nasa/SC) topic: pushed_at:2023-02 star:0.0k fork:0.0k The Core Flight System (cFS) Stored Commands (SC) application.
...
- [nasa/to_lab](https://github.com/nasa/to_lab) topic: pushed_at:2023-01 star:0.0k fork:0.0k The Core Flight System (cFS) Telemetry Output Lab App (to_lab)
...
- [nasa/irg_open](https://github.com/nasa/irg_open) topic: pushed_at:2023-02 star:0.0k fork:0.0k 
- [nasa/isaac](https://github.com/nasa/isaac) topic: pushed_at:2023-02 star:0.0k fork:0.0k Integrated System for Autonomous and Adaptive Caretaking
...
- [nasa/ow_autonomy](https://github.com/nasa/ow_autonomy) topic: pushed_at:2023-02 star:0.0k fork:0.0k 
...
- [nasa/astrobee_media](https://github.com/nasa/astrobee_media) topic: pushed_at:2023-02 star:0.0k fork:0.0k 
...
- [nasa/ow_europa](https://github.com/nasa/ow_europa) topic: pushed_at:2023-02 star:0.0k fork:0.0k 
...
- [nasa/ogma](https://github.com/nasa/ogma) topic: pushed_at:2023-02 star:0.2k fork:0.0k 
...
- [nasa/ziggy](https://github.com/nasa/ziggy) topic:algorithm,analysis,arc,data,data-analysis,data-reduction,java,k2,kepler,linux,macos,nasa,open-source,pipeline,science,tess,ziggy pushed_at:2023-02 star:0.0k fork:0.0k Ziggy, a portable, scalable infrastructure for science data processing pipelines, is the child of the Transiting Exoplanet Survey Satellite (TESS) pipeline and the grandchild of the Kepler Pipeline.
...
- [nasa/common-mapping-client](https://github.com/nasa/common-mapping-client) topic: pushed_at:2023-02 star:0.1k fork:0.0k CMC is a starter-kit for creating web-based mapping applications
...
- [nasa/meza](https://github.com/nasa/meza) topic:elasticsearch,enterprise,mediawiki,visual-editor,wiki pushed_at:2023-02 star:0.0k fork:0.0k Setup an enterprise MediaWiki server with simple commands
...
- [nasa/NASA-Acronyms](https://github.com/nasa/NASA-Acronyms) topic: pushed_at:2023-02 star:0.1k fork:0.0k 
...
- [nasa/openmct](https://github.com/nasa/openmct) topic: pushed_at:2023-03 star:10.7k fork:1.2k A web based mission control framework. 
...
- [nasa/opera-sds-bach-ui](https://github.com/nasa/opera-sds-bach-ui) topic: pushed_at:2023-02 star:0.0k fork:0.0k 
...
- [nasa/AppEEARS-Data-Resources](https://github.com/nasa/AppEEARS-Data-Resources) topic: pushed_at:2023-02 star:0.0k fork:0.0k 
- [nasa/cmr-stac](https://github.com/nasa/cmr-stac) topic: pushed_at:2023-02 star:0.0k fork:0.0k 
...
- [nasa/EMIT-Data-Resources](https://github.com/nasa/EMIT-Data-Resources) topic: pushed_at:2023-02 star:0.0k fork:0.0k 
...
- [nasa/LPDAAC-Data-Resources](https://github.com/nasa/LPDAAC-Data-Resources) topic: pushed_at:2023-01 star:0.0k fork:0.0k 
...
- [nasa/NPSS-Power-System-Library](https://github.com/nasa/NPSS-Power-System-Library) topic: pushed_at:2023-02 star:0.0k fork:0.0k 
...
- [nasa/cFS-GroundSystem](https://github.com/nasa/cFS-GroundSystem) topic: pushed_at:2023-01 star:0.1k fork:0.1k The Core Flight System (cFS) Ground System Lab Tool (cFS-GroundSystem)
...
- [nasa/dss](https://github.com/nasa/dss) topic: pushed_at:2023-02 star:0.0k fork:0.0k This repository contains the core software products of the InterUSS Platform: an implementation of the ASTM DSS concept for RID and flight coordination, and monitoring tools for federated UTM, including automated testing.
...
- [nasa/harmony-py](https://github.com/nasa/harmony-py) topic: pushed_at:2023-02 star:0.0k fork:0.0k Python client library for working with NASA’s Earth observing system data using Harmony.  https://harmony.earthdata.nasa.gov
...
- [nasa/hybridq](https://github.com/nasa/hybridq) topic:high-performance-computing,hpc,quantum-computing,simulation pushed_at:2023-02 star:0.0k fork:0.0k HybridQ is a highly extensible platform designed to provide a common framework to integrate multiple state-of-the-art techniques to simulate large scale quantum circuits on a variety of hardware. HybridQ provides tools to manipulate, develop, and extend noiseless and noisy circuits for different hardware architectures. HybridQ also supports large-scale high-performance computing (HPC) simulations, automatically balancing workload among different processor nodes and enabling the use of multiple backends to maximize parallel efficiency. Everything is then glued together by a simple and expressive language that allows seamless switching from one technique to another as well as from one hardware to the next, without the need to write lengthy translations, thus greatly simplifying the development of new hybrid algorithms and techniques.
...
- [nasa/LHASA](https://github.com/nasa/LHASA) topic: pushed_at:2023-02 star:0.0k fork:0.0k Landslide Hazard Analysis for Situational Awareness
...
- [nasa/opera-sds-bach-api](https://github.com/nasa/opera-sds-bach-api) topic: pushed_at:2023-02 star:0.0k fork:0.0k 
- [nasa/opera-sds-int](https://github.com/nasa/opera-sds-int) topic: pushed_at:2023-01 star:0.0k fork:0.0k 
- [nasa/opera-sds-lambdas](https://github.com/nasa/opera-sds-lambdas) topic: pushed_at:2023-02 star:0.0k fork:0.0k 
...
- [nasa/pyrefine](https://github.com/nasa/pyrefine) topic:cfd,mesh-adaptation,refine pushed_at:2023-02 star:0.0k fork:0.0k Python scripting for computational fluid dynamics mesh adaptation with refine
...
- [nasa/radbelt](https://github.com/nasa/radbelt) topic:cubesat,electron,heliophysics,igrf,magnetosphere,nasa,proton,radiation,satellite pushed_at:2023-01 star:0.0k fork:0.0k radbelt: An Astropy-friendly wrapper for the AE-8/AP-8 Van Allen belt model
...
- [nasa/NASAaccess](https://github.com/nasa/NASAaccess) topic: pushed_at:2023-02 star:0.1k fork:0.0k NASAaccess is R package that can generate gridded ascii tables of climate (CIMP5) and weather data (GPM, TRMM, GLDAS) needed to drive various hydrological models (e.g., SWAT, VIC, RHESSys, ..etc)
...
- [nasa/cmr-opensearch](https://github.com/nasa/cmr-opensearch) topic: pushed_at:2023-02 star:0.0k fork:0.0k CMR-OpenSearch is a web application developed by NASA EOSDIS to enable data discovery, search, and access across the CMR Earth Science data holdings via the OpenSearch standard.
...
- [nasa/opera-sds-ops](https://github.com/nasa/opera-sds-ops) topic: pushed_at:2023-02 star:0.0k fork:0.0k 
...
- [nasa/now-in-space](https://github.com/nasa/now-in-space) topic: pushed_at:2023-02 star:0.0k fork:0.0k 
