...
- [nasa/cFE](https://github.com/nasa/cFE) topic: pushed_at:2025-03 star:0.4k fork:0.2k The Core Flight System (cFS) Core Flight Executive (cFE)
...
- [nasa/osal](https://github.com/nasa/osal) topic: pushed_at:2025-03 star:0.6k fork:0.2k The Core Flight System (cFS) Operating System Abstraction Layer (OSAL)
- [nasa/PSP](https://github.com/nasa/PSP) topic: pushed_at:2025-03 star:0.1k fork:0.1k The Core Flight System (cFS) Platform Support Package (PSP)
...
- [nasa/sample_app](https://github.com/nasa/sample_app) topic: pushed_at:2025-02 star:0.1k fork:0.1k The Core Flight System (cFS) Sample App (sample_app)
...
- [nasa/fprime](https://github.com/nasa/fprime) topic:components,cpp,embedded,embedded-systems,flight,flight-software,fprime,framework,nasa,object-oriented-programming,raspberry-pi,real-time,spaceflight pushed_at:2025-03 star:10.3k fork:1.4k F´ - A flight software and embedded systems framework
...
- [nasa/gunns](https://github.com/nasa/gunns) topic: pushed_at:2025-03 star:0.1k fork:0.0k The NASA General-Use Nodal Network Solver (GUNNS) software
...
- [nasa/cFS](https://github.com/nasa/cFS) topic: pushed_at:2025-03 star:0.9k fork:0.2k The Core Flight System (cFS)
...
- [nasa/cmr-graphql](https://github.com/nasa/cmr-graphql) topic:earth-science,eosdis,gis,gsfc,hacktoberfest,nasa,open-source pushed_at:2025-03 star:0.0k fork:0.0k GraphQL interface for NASA's Common Metadata Repository (CMR).
...
- [nasa/edsc-geo](https://github.com/nasa/edsc-geo) topic: pushed_at:2025-03 star:0.0k fork:0.0k 
...
- [nasa/openmct](https://github.com/nasa/openmct) topic: pushed_at:2025-03 star:12.3k fork:1.3k A web based mission control framework. 
...
- [nasa/ASDC_Data_and_User_Services](https://github.com/nasa/ASDC_Data_and_User_Services) topic: pushed_at:2025-03 star:0.0k fork:0.0k Tutorials for missions conducted by the Atmospheric Science Data Center (ASDC)
...
- [nasa/ECOSTRESS-Data-Resources](https://github.com/nasa/ECOSTRESS-Data-Resources) topic:ecostress,lpdaac pushed_at:2025-03 star:0.0k fork:0.0k How to find, access, and work with ECOSTRESS (ECOsystem Spaceborne Thermal Radiometer Experiment on Space Station) Data.
...
- [nasa/LPDAAC-Data-Resources](https://github.com/nasa/LPDAAC-Data-Resources) topic:lpdaac pushed_at:2025-03 star:0.0k fork:0.0k This repository is a place to find data user resources that demonstrate how to use LP DAAC tools, services, and data.
...
- [nasa/pyturbo-aero](https://github.com/nasa/pyturbo-aero) topic: pushed_at:2025-03 star:0.0k fork:0.0k Turbomachinery Blade and Flow path design tool
...
- [nasa/NASA-3D-Resources](https://github.com/nasa/NASA-3D-Resources) topic: pushed_at:2025-03 star:3.1k fork:0.5k Here you'll find a growing collection of 3D models, textures, and images from inside NASA.
...
- [nasa/harmony-metadata-annotator](https://github.com/nasa/harmony-metadata-annotator) topic: pushed_at:2025-03 star:0.0k fork:0.0k 
...
- [nasa/HyperCP](https://github.com/nasa/HyperCP) topic: pushed_at:2025-03 star:0.0k fork:0.0k 
...
- [nasa/ncompare](https://github.com/nasa/ncompare) topic:data-comparison,hierarchical-data,netcdf pushed_at:2025-03 star:0.0k fork:0.0k Compare the structure of two netCDF (or HDF5) files
...
- [nasa/opera-sds-bach-api](https://github.com/nasa/opera-sds-bach-api) topic: pushed_at:2025-03 star:0.0k fork:0.0k 
- [nasa/opera-sds-int](https://github.com/nasa/opera-sds-int) topic: pushed_at:2024-10 star:0.0k fork:0.0k 
- [nasa/opera-sds-lambdas](https://github.com/nasa/opera-sds-lambdas) topic: pushed_at:2025-03 star:0.0k fork:0.0k 
...
- [nasa/progpy](https://github.com/nasa/progpy) topic:integrated-system-health-management,modeling,modeling-and-simulation,prognostic-models,prognostics,prognostics-health-management,simulation pushed_at:2025-03 star:0.1k fork:0.0k The NASA Prognostic Python Packages is a Python framework focused on defining and building models and algorit for prognostics (computation of remaining useful life) of engineering systems, and provides a set of models and algorithms for select components developed within this framework, suitable for use in prognostic applications.
...
- [nasa/stitchee](https://github.com/nasa/stitchee) topic:asdc,concatenation,data-combination,netcdf pushed_at:2025-03 star:0.0k fork:0.0k Harmony service that concatenates netCDF4 data files along an existing dimension
...
- [nasa/cmr-opensearch](https://github.com/nasa/cmr-opensearch) topic: pushed_at:2025-03 star:0.0k fork:0.0k CMR-OpenSearch is a web application developed by NASA EOSDIS to enable data discovery, search, and access across the CMR Earth Science data holdings via the OpenSearch standard.
...
- [nasa/cmr-stac](https://github.com/nasa/cmr-stac) topic: pushed_at:2025-03 star:0.1k fork:0.0k 
...
- [nasa/earthdata-download](https://github.com/nasa/earthdata-download) topic:hacktoberfest pushed_at:2025-03 star:0.0k fork:0.0k Download your Earth science data with only one click
...
- [nasa/gesdisc-meditor](https://github.com/nasa/gesdisc-meditor) topic: pushed_at:2025-03 star:0.0k fork:0.0k 
