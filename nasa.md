...
- [nasa/fprime](https://github.com/nasa/fprime) topic:components,cpp,embedded,embedded-systems,flight,flight-software,fprime,framework,nasa,object-oriented-programming,raspberry-pi,real-time,spaceflight pushed_at:2025-08 star:10.4k fork:1.4k F´ - A flight software and embedded systems framework
...
- [nasa/EMIT-Data-Resources](https://github.com/nasa/EMIT-Data-Resources) topic:emit,lpdaac pushed_at:2025-05 star:0.2k fork:0.1k This repository provides guides, short how-tos, and tutorials to help users access and work with data from the Earth Surface Mineral Dust Source Investigation (EMIT) mission.
- [nasa/fmdtools](https://github.com/nasa/fmdtools) topic:fault-model,hazard-assessment,reliability,resilience,safety,simulation pushed_at:2025-06 star:0.0k fork:0.0k System Resilience Modelling, Simulation, and Assessment in Python
...
- [nasa/opera-sds](https://github.com/nasa/opera-sds) topic: pushed_at:2025-08 star:0.0k fork:0.0k 
...
- [nasa/earthdata-search](https://github.com/nasa/earthdata-search) topic:data-discovery,earthdata-search,eosdis,hacktoberfest pushed_at:2025-08 star:0.8k fork:0.2k Earthdata Search is a web application developed by NASA EOSDIS to enable data discovery, search, comparison, visualization, and access across EOSDIS' Earth Science data holdings.
...
- [nasa/fprime-gds](https://github.com/nasa/fprime-gds) topic: pushed_at:2025-08 star:0.0k fork:0.0k F´ Python Ground Data System (GDS).
...
- [nasa/Open-Source-Catalog](https://github.com/nasa/Open-Source-Catalog) topic:ai-tags,catalog,meta-record,nasa,open-source,website pushed_at:2025-07 star:0.3k fork:0.1k Contains the NASA open source software catalog for automatic deployment to code.nasa.gov
- [nasa/openmct](https://github.com/nasa/openmct) topic: pushed_at:2025-08 star:12.5k fork:1.3k A web based mission control framework. 
...
- [nasa/opera-sds-bach-ui](https://github.com/nasa/opera-sds-bach-ui) topic: pushed_at:2025-07 star:0.0k fork:0.0k 
...
- [nasa/Plot3D_utilities](https://github.com/nasa/Plot3D_utilities) topic:computational-domain,mesh,mesh-generation,plot3d pushed_at:2025-07 star:0.0k fork:0.0k A Python library for reading, writing, finding connectivity for plot3d files
...
- [nasa/OSDR_Data_Curation](https://github.com/nasa/OSDR_Data_Curation) topic: pushed_at:2025-07 star:0.0k fork:0.0k 
...
- [nasa/opera-sds-bach-api](https://github.com/nasa/opera-sds-bach-api) topic: pushed_at:2025-07 star:0.0k fork:0.0k 
...
- [nasa/pyDownlinkParser](https://github.com/nasa/pyDownlinkParser) topic:ccsds,ccsdspy pushed_at:2025-01 star:0.0k fork:0.0k Parse downlinks binary file following CCSDS standard, primarily for Europa-Clipper Science Data System.
...
- [nasa/pysips](https://github.com/nasa/pysips) topic: pushed_at:2025-07 star:0.0k fork:0.0k 
- [nasa/python_cmr](https://github.com/nasa/python_cmr) topic: pushed_at:2025-06 star:0.0k fork:0.0k Python library for querying the common metadata repository.
...
- [nasa/scrub](https://github.com/nasa/scrub) topic:code-quality,code-review,python,security,static-analysis pushed_at:2025-02 star:0.0k fork:0.0k SCRUB is a platform for orchestration and aggregation of static code analysis tools.
