...
- [nasa/fpp](https://github.com/nasa/fpp) topic: pushed_at:2025-02 star:0.1k fork:0.0k F Prime Prime: A modeling language for F Prime
- [nasa/fprime](https://github.com/nasa/fprime) topic:components,cpp,embedded,embedded-systems,flight,flight-software,fprime,framework,nasa,object-oriented-programming,raspberry-pi,real-time,spaceflight pushed_at:2025-01 star:10.2k fork:1.3k F´ - A flight software and embedded systems framework
...
- [nasa/gunns](https://github.com/nasa/gunns) topic: pushed_at:2025-01 star:0.0k fork:0.0k The NASA General-Use Nodal Network Solver (GUNNS) software
...
- [nasa/IDF](https://github.com/nasa/IDF) topic: pushed_at:2025-01 star:0.1k fork:0.0k 
...
- [nasa/cFS](https://github.com/nasa/cFS) topic: pushed_at:2025-01 star:0.8k fork:0.2k The Core Flight System (cFS)
...
- [nasa/EMIT-Data-Resources](https://github.com/nasa/EMIT-Data-Resources) topic:emit,lpdaac pushed_at:2025-01 star:0.1k fork:0.1k This repository provides guides, short how-tos, and tutorials to help users access and work with data from the Earth Surface Mineral Dust Source Investigation (EMIT) mission.
- [nasa/fmdtools](https://github.com/nasa/fmdtools) topic:fault-model,hazard-assessment,reliability,resilience,safety,simulation pushed_at:2025-01 star:0.0k fork:0.0k System Resilience Modelling, Simulation, and Assessment in Python
...
- [nasa/kms](https://github.com/nasa/kms) topic: pushed_at:2025-01 star:0.0k fork:0.0k 
...
- [nasa/openmct](https://github.com/nasa/openmct) topic: pushed_at:2025-01 star:12.2k fork:1.3k A web based mission control framework. 
...
- [nasa/opera-sds-bach-ui](https://github.com/nasa/opera-sds-bach-ui) topic: pushed_at:2025-01 star:0.0k fork:0.0k 
...
- [nasa/ECOSTRESS-Data-Resources](https://github.com/nasa/ECOSTRESS-Data-Resources) topic:ecostress,lpdaac pushed_at:2025-01 star:0.0k fork:0.0k How to find, access, and work with ECOSTRESS (ECOsystem Spaceborne Thermal Radiometer Experiment on Space Station) Data.
- [nasa/exoscene](https://github.com/nasa/exoscene) topic: pushed_at:2022-04 star:0.0k fork:0.0k 
- [nasa/GEDI-Data-Resources](https://github.com/nasa/GEDI-Data-Resources) topic:gedi,lpdaac pushed_at:2025-01 star:0.1k fork:0.0k This repository provides guides, short how-tos, and tutorials to help users access and work with data from the Global Ecosystem Dynamics Investigation (GEDI) mission.
...
- [nasa/GlennOPT](https://github.com/nasa/GlennOPT) topic: pushed_at:2025-01 star:0.0k fork:0.0k Single and multi-objective optimization for computational simulations
- [nasa/harmony-regression-tests](https://github.com/nasa/harmony-regression-tests) topic: pushed_at:2025-01 star:0.0k fork:0.0k 
- [nasa/HLS-Data-Resources](https://github.com/nasa/HLS-Data-Resources) topic:hls,lpdaac pushed_at:2025-01 star:0.1k fork:0.0k This repository provides guides, short how-tos, and tutorials to help users access and work with Harmonized Landsat Sentinel-2 (HLS) data.
...
- [nasa/Kamodo](https://github.com/nasa/Kamodo) topic: pushed_at:2025-01 star:0.1k fork:0.0k 
...
- [nasa/LPDAAC-Data-Resources](https://github.com/nasa/LPDAAC-Data-Resources) topic:lpdaac pushed_at:2025-01 star:0.0k fork:0.0k This repository is a place to find data user resources that demonstrate how to use LP DAAC tools, services, and data.
...
- [nasa/pyturbo-aero](https://github.com/nasa/pyturbo-aero) topic: pushed_at:2025-01 star:0.0k fork:0.0k Turbomachinery Blade and Flow path design tool
...
- [nasa/turbo-design](https://github.com/nasa/turbo-design) topic: pushed_at:2025-01 star:0.0k fork:0.0k Radial Equilibrium Code to design Turbomachinery
...
- [nasa/GHRC-PyLOT](https://github.com/nasa/GHRC-PyLOT) topic: pushed_at:2025-01 star:0.0k fork:0.0k Python Core
...
- [nasa/harmony-py](https://github.com/nasa/harmony-py) topic: pushed_at:2025-01 star:0.1k fork:0.0k Python client library for working with NASA’s Earth observing system data using Harmony.  https://harmony.earthdata.nasa.gov
...
- [nasa/harmony-service-example](https://github.com/nasa/harmony-service-example) topic: pushed_at:2025-01 star:0.0k fork:0.0k Example service implementation for subsetting and reprojecting L3 data using Harmony. https://github.com/nasa/harmony
- [nasa/harmony-service-lib-py](https://github.com/nasa/harmony-service-lib-py) topic: pushed_at:2025-01 star:0.0k fork:0.0k Python library to simplify adapting transformation services for use in Harmony https://github.com/nasa/harmony
...
- [nasa/LHASA](https://github.com/nasa/LHASA) topic: pushed_at:2025-01 star:0.0k fork:0.0k Landslide Hazard Analysis for Situational Awareness
...
- [nasa/opera-sds](https://github.com/nasa/opera-sds) topic: pushed_at:2025-02 star:0.0k fork:0.0k 
- [nasa/opera-sds-bach-api](https://github.com/nasa/opera-sds-bach-api) topic: pushed_at:2025-01 star:0.0k fork:0.0k 
- [nasa/opera-sds-int](https://github.com/nasa/opera-sds-int) topic: pushed_at:2024-10 star:0.0k fork:0.0k 
- [nasa/opera-sds-lambdas](https://github.com/nasa/opera-sds-lambdas) topic: pushed_at:2025-01 star:0.0k fork:0.0k 
...
- [nasa/scrub](https://github.com/nasa/scrub) topic:code-quality,code-review,python,security,static-analysis pushed_at:2025-01 star:0.0k fork:0.0k SCRUB is a platform for orchestration and aggregation of static code analysis tools.
...
- [nasa/cmr-metadata-review](https://github.com/nasa/cmr-metadata-review) topic:rails,ruby pushed_at:2025-01 star:0.0k fork:0.0k The CMR Metadata Review tool is used to curate NASA EOSDIS collection and granule level metadata in CMR for correctness, completeness and consistency.
- [nasa/cmr-opensearch](https://github.com/nasa/cmr-opensearch) topic: pushed_at:2025-01 star:0.0k fork:0.0k CMR-OpenSearch is a web application developed by NASA EOSDIS to enable data discovery, search, and access across the CMR Earth Science data holdings via the OpenSearch standard.
...
- [nasa/esdis-data-catalog](https://github.com/nasa/esdis-data-catalog) topic: pushed_at:2025-01 star:0.0k fork:0.0k A simplified search interface for NASA's CMR Data Catalog
