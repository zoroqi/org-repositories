...
- [nasa/bp](https://github.com/nasa/bp) topic: pushed_at:2023-09 star:0.0k fork:0.0k The Bundle Protocol Core Flight System Application (BP) License: Apache-2.0
- [nasa/bplib](https://github.com/nasa/bplib) topic: pushed_at:2023-09 star:0.0k fork:0.0k 
- [nasa/CF](https://github.com/nasa/CF) topic: pushed_at:2023-10 star:0.1k fork:0.0k The Core Flight System (cFS) CFDP application.
- [nasa/cFE](https://github.com/nasa/cFE) topic: pushed_at:2023-10 star:0.4k fork:0.2k The Core Flight System (cFS) Core Flight Executive (cFE)
...
- [nasa/ci_lab](https://github.com/nasa/ci_lab) topic: pushed_at:2023-09 star:0.0k fork:0.0k The Core Flight System (cFS) Command Ingest Lab App (ci_lab)
...
- [nasa/CryptoLib](https://github.com/nasa/CryptoLib) topic:ccsds,cfs,communications,data-link,ground-station,sdls-ep,space-communications,space-data-link-security-protocol,space-network,spack-data-link pushed_at:2023-10 star:0.1k fork:0.0k Provide a software-only solution using the CCSDS Space Data Link Security Protocol - Extended Procedures (SDLS-EP) to secure communications between a spacecraft running the core Flight System (cFS) and a ground station.
- [nasa/CS](https://github.com/nasa/CS) topic: pushed_at:2023-09 star:0.0k fork:0.0k The Core Flight System (cFS) Checksum (CS) application.
- [nasa/DS](https://github.com/nasa/DS) topic: pushed_at:2023-09 star:0.0k fork:0.0k The Core Flight System (cFS) Data Storage (DS) application.
...
- [nasa/EdsLib](https://github.com/nasa/EdsLib) topic: pushed_at:2023-10 star:0.0k fork:0.0k CCSDS SOIS Electronic Data Sheet Tool and Library
- [nasa/eefs](https://github.com/nasa/eefs) topic: pushed_at:2021-03 star:0.2k fork:0.1k EEPROM File System
- [nasa/elf2cfetbl](https://github.com/nasa/elf2cfetbl) topic: pushed_at:2023-09 star:0.0k fork:0.0k The Core Flight System (cFS) ELF to CFE Table Tool (elf2cfetbl)
...
- [nasa/HK](https://github.com/nasa/HK) topic: pushed_at:2023-10 star:0.0k fork:0.0k The Core Flight System (cFS) Housekeeping (HK) application.
- [nasa/HS](https://github.com/nasa/HS) topic: pushed_at:2023-09 star:0.0k fork:0.0k The Core Flight System (cFS) Health and Safety (HS) application.
...
- [nasa/LC](https://github.com/nasa/LC) topic: pushed_at:2023-09 star:0.0k fork:0.0k The Core Flight System (cFS) Limit Checker (LC) application.
...
- [nasa/MM](https://github.com/nasa/MM) topic: pushed_at:2023-09 star:0.0k fork:0.0k The Core Flight System (cFS) Memory Manager (MM) application.
...
- [nasa/nos3](https://github.com/nasa/nos3) topic: pushed_at:2023-10 star:0.3k fork:0.1k NASA Operational Simulator for Small Satellites
- [nasa/osal](https://github.com/nasa/osal) topic: pushed_at:2023-10 star:0.5k fork:0.2k The Core Flight System (cFS) Operating System Abstraction Layer (OSAL)
- [nasa/PSP](https://github.com/nasa/PSP) topic: pushed_at:2023-10 star:0.1k fork:0.0k The Core Flight System (cFS) Platform Support Package (PSP)
...
- [nasa/SC](https://github.com/nasa/SC) topic: pushed_at:2023-10 star:0.0k fork:0.0k The Core Flight System (cFS) Stored Commands (SC) application.
...
- [nasa/sch_lab](https://github.com/nasa/sch_lab) topic: pushed_at:2023-09 star:0.0k fork:0.0k The Core Flight System (cFS) Scheduler Lab App (sch_lab)
...
- [nasa/to_lab](https://github.com/nasa/to_lab) topic: pushed_at:2023-09 star:0.0k fork:0.0k The Core Flight System (cFS) Telemetry Output Lab App (to_lab)
...
- [nasa/XPlaneConnect](https://github.com/nasa/XPlaneConnect) topic: pushed_at:2023-10 star:0.5k fork:0.3k The X-Plane Communications Toolbox is a research tool used to interact with the X-Plane flight simulator
...
- [nasa/astrobee](https://github.com/nasa/astrobee) topic: pushed_at:2023-08 star:0.9k fork:0.3k NASA Astrobee Robot Software
...
- [nasa/daidalus](https://github.com/nasa/daidalus) topic: pushed_at:2023-09 star:0.0k fork:0.0k open source release: LAR-19282-1 Detect and Avoid Alerting Logic for Unmanned Systems (DAIDALUS) with Dynamic Well-Clear Separation Volumes).
...
- [nasa/fprime](https://github.com/nasa/fprime) topic:components,cpp,embedded,embedded-systems,flight,flight-software,fprime,framework,nasa,object-oriented-programming,raspberry-pi,real-time,spaceflight pushed_at:2023-10 star:9.6k fork:1.2k F' - A flight software and embedded systems framework
- [nasa/GMSEC_API](https://github.com/nasa/GMSEC_API) topic: pushed_at:2023-09 star:0.0k fork:0.0k 
...
- [nasa/gunns](https://github.com/nasa/gunns) topic: pushed_at:2023-10 star:0.0k fork:0.0k The NASA General-Use Nodal Network Solver (GUNNS) software
- [nasa/HDTN](https://github.com/nasa/HDTN) topic:dtn pushed_at:2023-10 star:0.0k fork:0.0k High-rate Delay Tolerant Network (HDTN) Software
...
- [nasa/irg_open](https://github.com/nasa/irg_open) topic: pushed_at:2023-10 star:0.0k fork:0.0k 
...
- [nasa/ow_autonomy](https://github.com/nasa/ow_autonomy) topic: pushed_at:2023-10 star:0.0k fork:0.0k 
...
- [nasa/trick](https://github.com/nasa/trick) topic: pushed_at:2023-10 star:0.7k fork:0.2k Trick Simulation Environment.  Trick provides a common set of simulation capabilities and utilities to build simulations automatically.
- [nasa/TrickHLA](https://github.com/nasa/TrickHLA) topic: pushed_at:2023-10 star:0.0k fork:0.0k TrickHLA: An IEEE 1516 High Level Architecture (HLA) Simulation Interoperability Standard Implementation for Trick Base Simulations
...
- [nasa/cFS](https://github.com/nasa/cFS) topic: pushed_at:2023-10 star:0.6k fork:0.2k The Core Flight System (cFS)
...
- [nasa/Common-Metadata-Repository](https://github.com/nasa/Common-Metadata-Repository) topic:common-metadata-repository,eosdis pushed_at:2023-10 star:0.3k fork:0.1k 

## Common Lisp

- [nasa/pvslib](https://github.com/nasa/pvslib) topic: pushed_at:2023-10 star:0.2k fork:0.1k NASA PVS Library of Formal Developments
...
- [nasa/AmesGCM](https://github.com/nasa/AmesGCM) topic: pushed_at:2023-09 star:0.0k fork:0.0k 
...
- [nasa/ow_europa](https://github.com/nasa/ow_europa) topic: pushed_at:2023-10 star:0.0k fork:0.0k 
...
- [nasa/cumulus-api](https://github.com/nasa/cumulus-api) topic:cumulus,nasa-cumulus pushed_at:2023-09 star:0.0k fork:0.0k Cumulus API Documentation
...
- [nasa/EMIT-Data-Resources](https://github.com/nasa/EMIT-Data-Resources) topic:emit,lpdaac pushed_at:2023-10 star:0.1k fork:0.0k This repository provides guides, short how-tos, and tutorials to help users access and work with data from the Earth Surface Mineral Dust Source Investigation (EMIT) mission.
...
- [nasa/ogma](https://github.com/nasa/ogma) topic: pushed_at:2023-09 star:0.3k fork:0.0k 
...
- [nasa/cumulus-message-adapter-java](https://github.com/nasa/cumulus-message-adapter-java) topic:cumulus,nasa-cumulus pushed_at:2023-10 star:0.0k fork:0.0k Java handler for the Cumulus Message Adapter
...
- [nasa/cmr-graphql](https://github.com/nasa/cmr-graphql) topic:earth-science,eosdis,gis,gsfc,hacktoberfest,nasa,open-source pushed_at:2023-10 star:0.0k fork:0.0k GraphQL interface for NASA's Common Metadata Repository (CMR).
...
- [nasa/cumulus](https://github.com/nasa/cumulus) topic:cumulus,nasa-cumulus pushed_at:2023-10 star:0.2k fork:0.1k Cumulus Framework + Cumulus API
- [nasa/cumulus-dashboard](https://github.com/nasa/cumulus-dashboard) topic:cumulus,nasa-cumulus pushed_at:2023-10 star:0.1k fork:0.0k Cumulus API Dashboard
...
- [nasa/earthdata-search](https://github.com/nasa/earthdata-search) topic:data-discovery,earthdata-search,eosdis,hacktoberfest pushed_at:2023-10 star:0.7k fork:0.2k Earthdata Search is a web application developed by NASA EOSDIS to enable data discovery, search, comparison, visualization, and access across EOSDIS' Earth Science data holdings.
...
- [nasa/meza](https://github.com/nasa/meza) topic:elasticsearch,enterprise,mediawiki,visual-editor,wiki pushed_at:2023-10 star:0.0k fork:0.0k Setup an enterprise MediaWiki server with simple commands
...
- [nasa/NASA-Acronyms](https://github.com/nasa/NASA-Acronyms) topic: pushed_at:2023-10 star:0.1k fork:0.0k 
...
- [nasa/Open-Source-Catalog](https://github.com/nasa/Open-Source-Catalog) topic:ai-tags,catalog,meta-record,nasa,open-source,website pushed_at:2023-10 star:0.3k fork:0.1k Contains the NASA open source software catalog for automatic deployment to code.nasa.gov
- [nasa/openmct](https://github.com/nasa/openmct) topic: pushed_at:2023-10 star:11.1k fork:1.2k A web based mission control framework. 
...
- [nasa/opera-sds-bach-ui](https://github.com/nasa/opera-sds-bach-ui) topic: pushed_at:2023-10 star:0.0k fork:0.0k 
...
- [nasa/opera-sds-pge](https://github.com/nasa/opera-sds-pge) topic: pushed_at:2023-10 star:0.0k fork:0.0k Observational Products for End-Users from Remote Sensing Analysis (OPERA)
...
- [nasa/AppEEARS-Data-Resources](https://github.com/nasa/AppEEARS-Data-Resources) topic:appeears,lpdaac pushed_at:2023-09 star:0.0k fork:0.0k  This repository provides resources and tutorials to help users work with AppEEARS programmatically.
- [nasa/ASDC_Data_and_User_Services](https://github.com/nasa/ASDC_Data_and_User_Services) topic: pushed_at:2023-09 star:0.0k fork:0.0k 
...
- [nasa/Earthdata-cloud-hub](https://github.com/nasa/Earthdata-cloud-hub) topic: pushed_at:2023-09 star:0.0k fork:0.0k Content will be open and available for use by our user communities, and will be used to help foster open science practices with our external collaborators.
...
- [nasa/GeneLab_Data_Processing](https://github.com/nasa/GeneLab_Data_Processing) topic:genelab,genes,genetics,pipeline pushed_at:2023-10 star:0.0k fork:0.0k 
- [nasa/gesdisc-cloud-tutorials](https://github.com/nasa/gesdisc-cloud-tutorials) topic: pushed_at:2023-02 star:0.0k fork:0.0k 
- [nasa/gesdisc-tutorials](https://github.com/nasa/gesdisc-tutorials) topic: pushed_at:2023-09 star:0.0k fork:0.0k 
- [nasa/harmony-regression-tests](https://github.com/nasa/harmony-regression-tests) topic: pushed_at:2023-10 star:0.0k fork:0.0k 
- [nasa/HLS-Data-Resources](https://github.com/nasa/HLS-Data-Resources) topic:hls,lpdaac pushed_at:2023-10 star:0.0k fork:0.0k This repository provides guides, short how-tos, and tutorials to help users access and work with Harmonized Landsat Sentinel-2 (HLS) data.
...
- [nasa/Kamodo](https://github.com/nasa/Kamodo) topic: pushed_at:2023-09 star:0.0k fork:0.0k 
...
- [nasa/LPDAAC-Data-Resources](https://github.com/nasa/LPDAAC-Data-Resources) topic:lpdaac pushed_at:2023-09 star:0.0k fork:0.0k This repository is a place to find data user resources that demonstrate how to use LP DAAC tools, services, and data.
...
- [nasa/progpy](https://github.com/nasa/progpy) topic: pushed_at:2023-10 star:0.0k fork:0.0k 
...
- [nasa/pyturbo-aero](https://github.com/nasa/pyturbo-aero) topic: pushed_at:2023-09 star:0.0k fork:0.0k Turbomachinery Blade and Flow path design tool
...
- [nasa/VITALS](https://github.com/nasa/VITALS) topic:ecostress,emit,lpdaac pushed_at:2023-10 star:0.0k fork:0.0k This repository provides Python Jupyter notebook examples to help users work with VSWIR and TIR data from the EMIT and ECOSTRESS missions.
...
- [nasa/CARA_Analysis_Tools](https://github.com/nasa/CARA_Analysis_Tools) topic: pushed_at:2023-10 star:0.0k fork:0.0k 
...
- [nasa/ECOSTRESS-Data-Resources](https://github.com/nasa/ECOSTRESS-Data-Resources) topic:ecostress,lpdaac pushed_at:2023-09 star:0.0k fork:0.0k 
...
- [nasa/opera-sds](https://github.com/nasa/opera-sds) topic: pushed_at:2023-09 star:0.0k fork:0.0k 
...
- [nasa/reflow](https://github.com/nasa/reflow) topic: pushed_at:2023-10 star:0.0k fork:0.0k 
...
- [nasa/smd-open-science-guidelines](https://github.com/nasa/smd-open-science-guidelines) topic: pushed_at:2023-10 star:0.0k fork:0.0k 
- [nasa/spaceapps](https://github.com/nasa/spaceapps) topic: pushed_at:2023-10 star:0.4k fork:0.0k 
- [nasa/spotthestation](https://github.com/nasa/spotthestation) topic: pushed_at:2023-08 star:0.0k fork:0.0k Spot The Station Application Code Rep
- [nasa/spotthestation-backend](https://github.com/nasa/spotthestation-backend) topic: pushed_at:2023-09 star:0.0k fork:0.0k 
...
- [nasa/Transform-to-Open-Science](https://github.com/nasa/Transform-to-Open-Science) topic:cross-agency,open-code,open-data,open-science,open-source pushed_at:2023-10 star:0.5k fork:0.1k Transformation to Open Science
- [nasa/Transform-to-Open-Science-Book](https://github.com/nasa/Transform-to-Open-Science-Book) topic: pushed_at:2023-10 star:0.0k fork:0.0k 
...
- [nasa/NPSS-Power-System-Library](https://github.com/nasa/NPSS-Power-System-Library) topic: pushed_at:2023-09 star:0.0k fork:0.0k 
...
- [nasa/bingo](https://github.com/nasa/bingo) topic: pushed_at:2023-10 star:0.0k fork:0.0k 
...
- [nasa/cape](https://github.com/nasa/cape) topic: pushed_at:2023-10 star:0.0k fork:0.0k Computational Aerosciences Productivity & Execution
...
- [nasa/COTS-Star-Tracker](https://github.com/nasa/COTS-Star-Tracker) topic: pushed_at:2023-09 star:0.0k fork:0.0k 
...
- [nasa/CTF](https://github.com/nasa/CTF) topic: pushed_at:2023-09 star:0.0k fork:0.0k This is a new repository for a new tool to be added to the cFS ecosystem called cFS Test Framework (CTF).
...
- [nasa/cumulus-message-adapter](https://github.com/nasa/cumulus-message-adapter) topic:cumulus,nasa-cumulus pushed_at:2023-10 star:0.0k fork:0.0k A command-line interface for preparing and outputting Cumulus Messages for Cumulus Tasks
...
- [nasa/cumulus-orca](https://github.com/nasa/cumulus-orca) topic: pushed_at:2023-10 star:0.0k fork:0.0k 
...
- [nasa/earthdata-varinfo](https://github.com/nasa/earthdata-varinfo) topic: pushed_at:2023-10 star:0.0k fork:0.0k 
...
- [nasa/fmdtools](https://github.com/nasa/fmdtools) topic:fault-model,hazard-assessment,reliability,resilience,safety,simulation pushed_at:2023-09 star:0.0k fork:0.0k System Resilience Modelling, Simulation, and Assessment in Python
...
- [nasa/harmony-opendap-subsetter](https://github.com/nasa/harmony-opendap-subsetter) topic: pushed_at:2023-10 star:0.0k fork:0.0k 
- [nasa/harmony-py](https://github.com/nasa/harmony-py) topic: pushed_at:2023-10 star:0.0k fork:0.0k Python client library for working with NASA’s Earth observing system data using Harmony.  https://harmony.earthdata.nasa.gov
...
- [nasa/harmony-service-lib-py](https://github.com/nasa/harmony-service-lib-py) topic: pushed_at:2023-09 star:0.0k fork:0.0k Python library to simplify adapting transformation services for use in Harmony https://github.com/nasa/harmony
- [nasa/hybridq](https://github.com/nasa/hybridq) topic:high-performance-computing,hpc,quantum-computing,simulation pushed_at:2023-10 star:0.0k fork:0.0k HybridQ is a highly extensible platform designed to provide a common framework to integrate multiple state-of-the-art techniques to simulate large scale quantum circuits on a variety of hardware. HybridQ provides tools to manipulate, develop, and extend noiseless and noisy circuits for different hardware architectures. HybridQ also supports large-scale high-performance computing (HPC) simulations, automatically balancing workload among different processor nodes and enabling the use of multiple backends to maximize parallel efficiency. Everything is then glued together by a simple and expressive language that allows seamless switching from one technique to another as well as from one hardware to the next, without the need to write lengthy translations, thus greatly simplifying the development of new hybrid algorithms and techniques.
- [nasa/HyperCP](https://github.com/nasa/HyperCP) topic: pushed_at:2023-10 star:0.0k fork:0.0k 
...
- [nasa/mika](https://github.com/nasa/mika) topic: pushed_at:2023-10 star:0.0k fork:0.0k 
...
- [nasa/ncompare](https://github.com/nasa/ncompare) topic:data-comparison,hierarchical-data,netcdf pushed_at:2023-10 star:0.0k fork:0.0k Compare the structure of two netCDF files at the command line
- [nasa/OnAIR](https://github.com/nasa/OnAIR) topic: pushed_at:2023-10 star:0.0k fork:0.0k The On-board Artificial Intelligence Research (OnAIR) Platform is a framework that enables AI algorithms written in Python to interact with NASA's cFS. It is intended to explore research concepts in autonomous operations in a simulated environment. 
...
- [nasa/opera-sds-bach-api](https://github.com/nasa/opera-sds-bach-api) topic: pushed_at:2023-09 star:0.0k fork:0.0k 
- [nasa/opera-sds-int](https://github.com/nasa/opera-sds-int) topic: pushed_at:2023-09 star:0.0k fork:0.0k 
- [nasa/opera-sds-lambdas](https://github.com/nasa/opera-sds-lambdas) topic: pushed_at:2023-09 star:0.0k fork:0.0k 
- [nasa/opera-sds-ops](https://github.com/nasa/opera-sds-ops) topic: pushed_at:2023-09 star:0.0k fork:0.0k 
- [nasa/opera-sds-pcm](https://github.com/nasa/opera-sds-pcm) topic: pushed_at:2023-10 star:0.0k fork:0.0k Observational Products for End-Users from Remote Sensing Analysis (OPERA)
...
- [nasa/ow_simulator](https://github.com/nasa/ow_simulator) topic: pushed_at:2023-10 star:0.1k fork:0.0k 
...
- [nasa/radbelt](https://github.com/nasa/radbelt) topic:cubesat,electron,heliophysics,igrf,magnetosphere,nasa,proton,radiation,satellite pushed_at:2023-10 star:0.0k fork:0.0k radbelt: An Astropy-friendly wrapper for the AE-8/AP-8 Van Allen belt model
...
- [nasa/scrub](https://github.com/nasa/scrub) topic:code-quality,code-review,python,security,static-analysis pushed_at:2023-10 star:0.0k fork:0.0k SCRUB is a platform for orchestration and aggregation of static code analysis tools.
...
- [nasa/SMCPy](https://github.com/nasa/SMCPy) topic: pushed_at:2023-10 star:0.1k fork:0.0k Python module for uncertainty quantification using a parallel sequential Monte Carlo sampler
...
- [nasa/cmr-metadata-review](https://github.com/nasa/cmr-metadata-review) topic:rails,ruby pushed_at:2023-10 star:0.0k fork:0.0k The CMR Metadata Review tool is used to curate NASA EOSDIS collection and granule level metadata in CMR for correctness, completeness and consistency.
- [nasa/cmr-opensearch](https://github.com/nasa/cmr-opensearch) topic: pushed_at:2023-10 star:0.0k fork:0.0k CMR-OpenSearch is a web application developed by NASA EOSDIS to enable data discovery, search, and access across the CMR Earth Science data holdings via the OpenSearch standard.
- [nasa/georef_deploy](https://github.com/nasa/georef_deploy) topic: pushed_at:2020-08 star:0.0k fork:0.0k 
- [nasa/mmt](https://github.com/nasa/mmt) topic: pushed_at:2023-10 star:0.1k fork:0.0k NASA's Metadata Management Tool.

## SCSS

- [nasa/api-docs](https://github.com/nasa/api-docs) topic:api,demo,example,gov,javascript,nasa,nasa-apis,python,uswds pushed_at:2023-09 star:0.4k fork:0.1k api.nasa.gov
...
- [nasa/nasa-latex-docs](https://github.com/nasa/nasa-latex-docs) topic:aiaa,documentation,ieee,latex,latex-template,latexmk pushed_at:2023-09 star:0.2k fork:0.1k An easy and convenient package to create technical LaTeX documents.

## TypeScript

- [nasa/cmr-stac](https://github.com/nasa/cmr-stac) topic: pushed_at:2023-10 star:0.0k fork:0.0k 
- [nasa/daa-displays](https://github.com/nasa/daa-displays) topic: pushed_at:2023-09 star:0.0k fork:0.0k 
- [nasa/earthdata-download](https://github.com/nasa/earthdata-download) topic:hacktoberfest pushed_at:2023-10 star:0.0k fork:0.0k 
- [nasa/gesdisc-meditor](https://github.com/nasa/gesdisc-meditor) topic: pushed_at:2023-10 star:0.0k fork:0.0k 
- [nasa/harmony](https://github.com/nasa/harmony) topic: pushed_at:2023-10 star:0.1k fork:0.0k Application for providing services for Earth observation data in the cloud using standards-based APIs
