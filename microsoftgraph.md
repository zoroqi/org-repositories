...
- [microsoftgraph/microsoft-graph-docs](https://github.com/microsoftgraph/microsoft-graph-docs) topic:devxdocs,microsoft-graph-documentation pushed_at:2023-05 star:1.1k fork:1.9k Documentation for the Microsoft Graph REST API
...
- [microsoftgraph/powershell-intune-samples](https://github.com/microsoftgraph/powershell-intune-samples) topic:devxsample pushed_at:2023-04 star:1.0k fork:0.6k This repository of PowerShell sample scripts show how to access Intune service resources. They demonstrate this by making HTTPS RESTful API requests to the Microsoft Graph API from PowerShell.
...
- [microsoftgraph/msgraph-training-react-native](https://github.com/microsoftgraph/msgraph-training-react-native) topic:devxtraining,microsoft-graph,react-native pushed_at:2023-05 star:0.0k fork:0.0k This sample demonstrates how to use the Microsoft Graph JavaScript SDK to access data in Office 365 from React Native mobile apps.
