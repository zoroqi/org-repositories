...
- [microsoftgraph/msgraph-beta-sdk-dotnet](https://github.com/microsoftgraph/msgraph-beta-sdk-dotnet) pushed_at:2021-12 star:0.1k fork:0.0k The Microsoft Graph Client Beta Library for .NET supports the Microsoft Graph /beta endpoint. (preview)
...
- [microsoftgraph/msgraph-samples-dashboard](https://github.com/microsoftgraph/msgraph-samples-dashboard) pushed_at:2021-12 star:0.0k fork:0.0k Dashboard for msgraph samples
...
- [microsoftgraph/msgraph-sdk-dotnet](https://github.com/microsoftgraph/msgraph-sdk-dotnet) pushed_at:2021-12 star:0.4k fork:0.2k Microsoft Graph Client Library for .NET!
...
- [microsoftgraph/java-spring-webhooks-sample](https://github.com/microsoftgraph/java-spring-webhooks-sample) pushed_at:2021-12 star:0.0k fork:0.0k Receive change notifications with data with the Microsoft Graph
- [microsoftgraph/msgraph-beta-sdk-java](https://github.com/microsoftgraph/msgraph-beta-sdk-java) pushed_at:2021-12 star:0.0k fork:0.0k Microsoft Graph Beta Java SDK
...
- [microsoftgraph/msgraph-sdk-java](https://github.com/microsoftgraph/msgraph-sdk-java) pushed_at:2021-12 star:0.2k fork:0.1k Microsoft Graph SDK for Java
...
- [microsoftgraph/security-api-solutions](https://github.com/microsoftgraph/security-api-solutions) pushed_at:2021-12 star:0.2k fork:0.1k Microsoft Graph Security API applications and services.
...
- [microsoftgraph/msgraph-sdk-objc-models](https://github.com/microsoftgraph/msgraph-sdk-objc-models) pushed_at:2021-12 star:0.0k fork:0.0k Generated Models for Objective C SDK
...
- [microsoftgraph/msgraph-access-files-data](https://github.com/microsoftgraph/msgraph-access-files-data) pushed_at:2021-12 star:0.0k fork:0.0k 
- [microsoftgraph/msgraph-access-group-data](https://github.com/microsoftgraph/msgraph-access-group-data) pushed_at:2021-12 star:0.0k fork:0.0k 
- [microsoftgraph/msgraph-access-user-data](https://github.com/microsoftgraph/msgraph-access-user-data) pushed_at:2021-12 star:0.0k fork:0.0k 
...
- [microsoftgraph/microsoft-graph-docs](https://github.com/microsoftgraph/microsoft-graph-docs) pushed_at:2021-12 star:0.9k fork:1.4k Documentation for the Microsoft Graph REST API
...
- [microsoftgraph/msgraph-sdk-powershell](https://github.com/microsoftgraph/msgraph-sdk-powershell) pushed_at:2021-12 star:0.4k fork:0.1k Powershell SDK for Microsoft Graph
- [microsoftgraph/msgraph-typescript-typings](https://github.com/microsoftgraph/msgraph-typescript-typings) pushed_at:2021-12 star:0.1k fork:0.0k Microsoft Graph TypeScript Type Definitions
...
- [microsoftgraph/powershell-intune-samples](https://github.com/microsoftgraph/powershell-intune-samples) pushed_at:2021-12 star:0.7k fork:0.4k This repository of PowerShell sample scripts show how to access Intune service resources. They demonstrate this by making HTTPS RESTful API requests to the Microsoft Graph API from PowerShell.
...
- [microsoftgraph/msgraph-sdk-design](https://github.com/microsoftgraph/msgraph-sdk-design) pushed_at:2021-12 star:0.0k fork:0.0k Requirements and design documents for Microsoft Graph SDKs
...
- [microsoftgraph/get-app-token](https://github.com/microsoftgraph/get-app-token) pushed_at:2021-12 star:0.0k fork:0.0k This GitHub Action retrieves a GitHub App installation token for use in workflows
...
- [microsoftgraph/msgraph-beta-typescript-typings](https://github.com/microsoftgraph/msgraph-beta-typescript-typings) pushed_at:2021-12 star:0.0k fork:0.0k Microsoft Graph Beta TypeScript Type Definitions
...
- [microsoftgraph/msgraph-sdk-javascript](https://github.com/microsoftgraph/msgraph-sdk-javascript) pushed_at:2021-12 star:0.5k fork:0.2k Microsoft Graph client library for JavaScript
