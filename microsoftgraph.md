...
- [microsoftgraph/github-issue-manager](https://github.com/microsoftgraph/github-issue-manager) topic: pushed_at:2025-04 star:0.0k fork:0.0k This sample combines a Microsoft Graph connector, declarative agent, and API plugin to create an issue management agent for Microsoft 365 Copilot
...
- [microsoftgraph/kibali](https://github.com/microsoftgraph/kibali) topic:devxeng pushed_at:2025-04 star:0.0k fork:0.0k Tooling for managing Microsoft Graph Permissions
...
- [microsoftgraph/microsoft-graph-devx-api](https://github.com/microsoftgraph/microsoft-graph-devx-api) topic:devxeng pushed_at:2025-04 star:0.1k fork:0.0k Services API for Graph Explorer
- [microsoftgraph/msgraph-beta-cli](https://github.com/microsoftgraph/msgraph-beta-cli) topic:devxeng pushed_at:2025-04 star:0.0k fork:0.0k 
- [microsoftgraph/msgraph-beta-sdk-dotnet](https://github.com/microsoftgraph/msgraph-beta-sdk-dotnet) topic:devxeng pushed_at:2025-04 star:0.1k fork:0.0k The Microsoft Graph Client Beta Library for .NET supports the Microsoft Graph /beta endpoint. (preview)
...
- [microsoftgraph/msgraph-cli](https://github.com/microsoftgraph/msgraph-cli) topic:devxeng pushed_at:2025-04 star:0.1k fork:0.0k CLI tool for Microsoft Graph based on .NET
- [microsoftgraph/msgraph-cli-core](https://github.com/microsoftgraph/msgraph-cli-core) topic:devxeng pushed_at:2025-02 star:0.0k fork:0.0k 
- [microsoftgraph/msgraph-cloud-support](https://github.com/microsoftgraph/msgraph-cloud-support) topic: pushed_at:2025-04 star:0.0k fork:0.0k 
...
- [microsoftgraph/msgraph-sample-aspnet-core](https://github.com/microsoftgraph/msgraph-sample-aspnet-core) topic:asp-net-core,devxsample,microsoft-graph pushed_at:2025-02 star:0.1k fork:0.0k This sample demonstrates how to use the Microsoft Graph .NET SDK to access data in Office 365 from ASP.NET Core apps.
- [microsoftgraph/msgraph-sample-azurefunction-csharp](https://github.com/microsoftgraph/msgraph-sample-azurefunction-csharp) topic:azure-functions,csharp,devxsample,microsoft-graph pushed_at:2025-04 star:0.0k fork:0.0k This sample demonstrates how to use the Microsoft Graph .NET SDK to access data in Office 365 from Azure Functions.
...
- [microsoftgraph/msgraph-sample-copilot-plugin](https://github.com/microsoftgraph/msgraph-sample-copilot-plugin) topic: pushed_at:2025-04 star:0.0k fork:0.0k Budget Tracker sample API used for API plugin
- [microsoftgraph/msgraph-sample-deltaquery](https://github.com/microsoftgraph/msgraph-sample-deltaquery) topic:devxsample pushed_at:2025-04 star:0.0k fork:0.0k This console application demonstrates how to make Delta Query calls to the Graph API, allowing applications to request only changed data from Microsoft Graph tenants.
...
- [microsoftgraph/msgraph-sdk-dotnet](https://github.com/microsoftgraph/msgraph-sdk-dotnet) topic:devxeng,microsoftgraph pushed_at:2025-04 star:0.7k fork:0.3k Microsoft Graph Client Library for .NET!
...
- [microsoftgraph/msgraph-sdk-dotnet-core](https://github.com/microsoftgraph/msgraph-sdk-dotnet-core) topic:devxeng,sdk pushed_at:2025-04 star:0.2k fork:0.1k The core Microsoft Graph client library for .Net. (Microsoft.Graph.Core)
- [microsoftgraph/msgraph-sdk-powershell](https://github.com/microsoftgraph/msgraph-sdk-powershell) topic:cmdlets,devxeng,graph,microsoft,powershell,powershell-modules,powershell-sdk pushed_at:2025-04 star:0.8k fork:0.2k Powershell SDK for Microsoft Graph
...
- [microsoftgraph/msgraph-snippets-dotnet](https://github.com/microsoftgraph/msgraph-snippets-dotnet) topic: pushed_at:2025-04 star:0.0k fork:0.0k Repository of snippets in Microsoft Graph .NET SDK documentation.
- [microsoftgraph/msgraph-toc-gen](https://github.com/microsoftgraph/msgraph-toc-gen) topic: pushed_at:2025-04 star:0.0k fork:0.0k 
- [microsoftgraph/msgraph-training-dotnet](https://github.com/microsoftgraph/msgraph-training-dotnet) topic:devxtraining pushed_at:2025-04 star:0.1k fork:0.1k Microsoft Graph Training Module - Build .NET apps with Microsoft Graph
...
- [microsoftgraph/msgraph-beta-sdk-go](https://github.com/microsoftgraph/msgraph-beta-sdk-go) topic:devxeng,go,microsoft-graph,microsoft-graph-sdk,sdk pushed_at:2025-04 star:0.0k fork:0.0k Microsoft Graph Beta Go SDK
- [microsoftgraph/msgraph-sdk-go](https://github.com/microsoftgraph/msgraph-sdk-go) topic:devxeng,go,microsoft-graph,microsoft-graph-sdk,sdk pushed_at:2025-04 star:0.3k fork:0.0k Microsoft Graph SDK for Go
- [microsoftgraph/msgraph-sdk-go-core](https://github.com/microsoftgraph/msgraph-sdk-go-core) topic:devxeng,go,microsoft-graph,sdk pushed_at:2025-04 star:0.0k fork:0.0k Microsoft Graph SDK for Go - Core Library
- [microsoftgraph/msgraph-snippets-go](https://github.com/microsoftgraph/msgraph-snippets-go) topic: pushed_at:2025-04 star:0.0k fork:0.0k Repository of snippets in Microsoft Graph Go SDK documentation.
- [microsoftgraph/msgraph-training-go](https://github.com/microsoftgraph/msgraph-training-go) topic:devxtraining pushed_at:2025-04 star:0.0k fork:0.0k Completed project for Build Go apps with Microsoft Graph
...
- [microsoftgraph/msgraph-sample-blazor-clientside](https://github.com/microsoftgraph/msgraph-sample-blazor-clientside) topic:blazor,devxsample,microsoft-graph pushed_at:2025-04 star:0.0k fork:0.0k This sample demonstrates how to use the Microsoft Graph .NET SDK to access data in Office 365 from Blazor WebAssembly apps.
...
- [microsoftgraph/java-spring-webhooks-sample](https://github.com/microsoftgraph/java-spring-webhooks-sample) topic:devxsample pushed_at:2025-04 star:0.0k fork:0.0k Receive change notifications with data with the Microsoft Graph
- [microsoftgraph/msgraph-beta-sdk-java](https://github.com/microsoftgraph/msgraph-beta-sdk-java) topic:devxeng,java,microsoft-graph,sdk pushed_at:2025-04 star:0.0k fork:0.0k Microsoft Graph Beta Java SDK
...
- [microsoftgraph/msgraph-sample-eventgrid-notifications-java](https://github.com/microsoftgraph/msgraph-sample-eventgrid-notifications-java) topic: pushed_at:2025-04 star:0.0k fork:0.0k This Java Spring sample listens for change notifications from Microsoft Graph delivered to Azure Event Grid.
...
- [microsoftgraph/msgraph-sdk-java](https://github.com/microsoftgraph/msgraph-sdk-java) topic:devxeng,java,microsoft-graph,microsoft-graph-sdk,sdk pushed_at:2025-04 star:0.4k fork:0.1k Microsoft Graph SDK for Java
...
- [microsoftgraph/msgraph-sdk-java-core](https://github.com/microsoftgraph/msgraph-sdk-java-core) topic:devxeng,hacktoberfest,java,microsoft-graph,sdk pushed_at:2025-04 star:0.1k fork:0.0k Microsoft Graph SDK for Java - Core Library
- [microsoftgraph/msgraph-snippets-java](https://github.com/microsoftgraph/msgraph-snippets-java) topic: pushed_at:2025-04 star:0.0k fork:0.0k About Repository of snippets in Microsoft Graph Java SDK documentation.
- [microsoftgraph/msgraph-training-java](https://github.com/microsoftgraph/msgraph-training-java) topic:devxtraining pushed_at:2025-04 star:0.1k fork:0.1k Microsoft Graph Training Module - Build Java apps with Microsoft Graph
...
- [microsoftgraph/msgraph-sample-office-addin](https://github.com/microsoftgraph/msgraph-sample-office-addin) topic:devxsample,microsoft-graph,office-addin pushed_at:2025-04 star:0.0k fork:0.0k This sample demonstrates how to use the Microsoft Graph JavaScript SDK to access data in Office 365 from Office Add-ins.
...
- [microsoftgraph/msgraph-training-javascript](https://github.com/microsoftgraph/msgraph-training-javascript) topic:devxtraining pushed_at:2025-04 star:0.0k fork:0.0k About Completed project for Build JavaScript apps with Microsoft Graph
...
- [microsoftgraph/nodejs-webhooks-sample](https://github.com/microsoftgraph/nodejs-webhooks-sample) topic:devxsample pushed_at:2025-04 star:0.1k fork:0.1k Create Microsoft Graph webhook subscriptions for a Node.js app, so that it can receive notifications of changes in a user’s Microsoft account data.
...
- [microsoftgraph/dataconnect-solutions](https://github.com/microsoftgraph/dataconnect-solutions) topic:devxsample,microsoft-graph,microsoft-graph-dataconnect,microsoft365 pushed_at:2025-03 star:0.1k fork:0.0k Microsoft Graph Data Connect enables scaled access to Microsoft 365 data with fine grained consent model, integrated with compliance and governance, to enable analytics and big data applications on the largest productivity platform.  
...
- [microsoftgraph/msgraph-beta-sdk-php](https://github.com/microsoftgraph/msgraph-beta-sdk-php) topic:devxeng pushed_at:2025-04 star:0.0k fork:0.0k Microsoft Graph beta model library for PHP (preview).
...
- [microsoftgraph/msgraph-sdk-php](https://github.com/microsoftgraph/msgraph-sdk-php) topic:devxeng,microsoftgraph,sdk pushed_at:2025-04 star:0.6k fork:0.1k Microsoft Graph Library for PHP.
...
- [microsoftgraph/msgraph-snippets-php](https://github.com/microsoftgraph/msgraph-snippets-php) topic: pushed_at:2025-04 star:0.0k fork:0.0k Repository of snippets in Microsoft Graph PHP SDK documentation.
- [microsoftgraph/msgraph-training-php](https://github.com/microsoftgraph/msgraph-training-php) topic:devxtraining pushed_at:2025-04 star:0.0k fork:0.0k Completed project for Build PHP apps with Microsoft Graph
...
- [microsoftgraph/entra-powershell](https://github.com/microsoftgraph/entra-powershell) topic:devxeng,graph,microsoft,powershell,powershell-module pushed_at:2025-04 star:0.1k fork:0.0k Microsoft Entra PowerShell
...
- [microsoftgraph/msgraph-typescript-typings](https://github.com/microsoftgraph/msgraph-typescript-typings) topic:devxeng,intellisense,microsoft-graph-models,microsoft-graph-typescript,typescript-definitions pushed_at:2025-04 star:0.1k fork:0.0k Microsoft Graph TypeScript Type Definitions
...
- [microsoftgraph/msgraph-beta-sdk-python](https://github.com/microsoftgraph/msgraph-beta-sdk-python) topic:devxeng pushed_at:2025-04 star:0.0k fork:0.0k 
...
- [microsoftgraph/msgraph-sdk-python](https://github.com/microsoftgraph/msgraph-sdk-python) topic:devxeng pushed_at:2025-04 star:0.5k fork:0.1k 
...
- [microsoftgraph/msgraph-snippets-python](https://github.com/microsoftgraph/msgraph-snippets-python) topic: pushed_at:2025-04 star:0.0k fork:0.0k Repository of snippets in Microsoft Graph Python SDK documentation.
- [microsoftgraph/msgraph-training-python](https://github.com/microsoftgraph/msgraph-training-python) topic:devxtraining pushed_at:2025-03 star:0.1k fork:0.0k Completed project for Build Python apps with Microsoft Graph
...
- [microsoftgraph/msgraph-sample-rubyrailsapp](https://github.com/microsoftgraph/msgraph-sample-rubyrailsapp) topic:devxsample,microsoft-graph,rails,ruby pushed_at:2025-04 star:0.1k fork:0.0k This sample demonstrates how to use the Microsoft Graph REST API to access data in Office 365 from Ruby on Rails apps.
- [microsoftgraph/msgraph-sdk-ruby](https://github.com/microsoftgraph/msgraph-sdk-ruby) topic:devxeng,microsoftgraph,ruby pushed_at:2025-04 star:0.1k fork:0.1k Microsoft Graph Ruby client library for v1 APIs
...
- [microsoftgraph/assign-to-author](https://github.com/microsoftgraph/assign-to-author) topic:devxdocs pushed_at:2025-04 star:0.0k fork:0.0k This GitHub action assigns issues in the microsoft-graph-docs repository to the author of the referenced page
...
- [microsoftgraph/eol-blocker](https://github.com/microsoftgraph/eol-blocker) topic:devxdocs pushed_at:2025-04 star:0.0k fork:0.0k This GitHub action blocks pull requests that contain improper line-endings
- [microsoftgraph/get-app-token](https://github.com/microsoftgraph/get-app-token) topic:devxdocs pushed_at:2025-04 star:0.0k fork:0.0k This GitHub Action retrieves a GitHub App installation token for use in workflows
...
- [microsoftgraph/microsoft-graph-explorer-v4](https://github.com/microsoftgraph/microsoft-graph-explorer-v4) topic:devxeng,microsoft-graph,microsoft-graph-api,office-365,office-ui-fabric,react-redux pushed_at:2025-04 star:0.2k fork:0.1k React/Redux version of Graph Explorer used to learn the Microsoft Graph Api
...
- [microsoftgraph/msgraph-beta-sdk-typescript](https://github.com/microsoftgraph/msgraph-beta-sdk-typescript) topic:devxeng pushed_at:2025-04 star:0.0k fork:0.0k 
- [microsoftgraph/msgraph-beta-typescript-typings](https://github.com/microsoftgraph/msgraph-beta-typescript-typings) topic:devxeng pushed_at:2025-04 star:0.0k fork:0.0k Microsoft Graph Beta TypeScript Type Definitions
- [microsoftgraph/msgraph-bicep-types](https://github.com/microsoftgraph/msgraph-bicep-types) topic: pushed_at:2025-03 star:0.1k fork:0.0k Repo contains Microsoft Graph resource types to integrate with bicep templates.
...
- [microsoftgraph/msgraph-sample-eventgrid-notifications-typescript](https://github.com/microsoftgraph/msgraph-sample-eventgrid-notifications-typescript) topic: pushed_at:2025-04 star:0.0k fork:0.0k This TypeScript/Node.js sample listens for change notifications from Microsoft Graph delivered to Azure Event Grid.
- [microsoftgraph/msgraph-sample-github-connector-typescript](https://github.com/microsoftgraph/msgraph-sample-github-connector-typescript) topic: pushed_at:2025-04 star:0.0k fork:0.0k This Node.js application shows how to create a Microsoft Graph connector for GitHub repos and issues.
...
- [microsoftgraph/msgraph-sdk-javascript](https://github.com/microsoftgraph/msgraph-sdk-javascript) topic:devxeng,js-sdk,microsoft-graph,microsoft-graph-sdk,typescript pushed_at:2025-04 star:0.8k fork:0.2k Microsoft Graph client library for JavaScript
- [microsoftgraph/msgraph-sdk-typescript](https://github.com/microsoftgraph/msgraph-sdk-typescript) topic:devxeng pushed_at:2025-04 star:0.0k fork:0.0k 
- [microsoftgraph/msgraph-sdk-typescript-core](https://github.com/microsoftgraph/msgraph-sdk-typescript-core) topic: pushed_at:2025-04 star:0.0k fork:0.0k Core functionalities for the Microsoft Graph JavaScript SDKs fluent APIs
- [microsoftgraph/msgraph-snippets-typescript](https://github.com/microsoftgraph/msgraph-snippets-typescript) topic: pushed_at:2025-04 star:0.0k fork:0.0k Repository of snippets in Microsoft Graph TypeScript SDK documentation.
...
- [microsoftgraph/msgraph-training-typescript](https://github.com/microsoftgraph/msgraph-training-typescript) topic:devxtraining pushed_at:2025-04 star:0.0k fork:0.0k Completed project for Build TypeScript apps with Microsoft Graph
...
- [microsoftgraph/msgraph-metadata](https://github.com/microsoftgraph/msgraph-metadata) topic:azure-active-directory,devxeng,exchange,kiota-index,microsoft-graph,office365,onedrive,onenote,outlook,planner,sharepoint,teams,todo pushed_at:2025-04 star:0.1k fork:0.0k Microsoft Graph metadata captured and used for generating client library code files.
