...
- [microsoftgraph/apidoctor](https://github.com/microsoftgraph/apidoctor) pushed_at:2021-10 star:0.0k fork:0.0k Application for validating API documentation and generating test cases
...
- [microsoftgraph/aspnet-snippets-sample](https://github.com/microsoftgraph/aspnet-snippets-sample) pushed_at:2021-10 star:0.1k fork:0.1k A repository of code snippets that use Microsoft Graph to perform common tasks such as sending email, managing groups, and other activities from an ASP.NET Core MVC app. This sample uses the Microsoft Graph .NET Client Library to work with data, and the Microsoft Identity Web Library for authentication on the Microsoft identity platform v2.0 endpoint.
...
- [microsoftgraph/aspnetcore-webhooks-sample](https://github.com/microsoftgraph/aspnetcore-webhooks-sample) pushed_at:2021-11 star:0.1k fork:0.0k This sample shows how to subscribe for Microsoft Graph webhooks using application (app-only) permissions and the Azure AD endpoint.
...
- [microsoftgraph/microsoft-graph-devx-api](https://github.com/microsoftgraph/microsoft-graph-devx-api) pushed_at:2021-11 star:0.0k fork:0.0k Services API for Graph Explorer
- [microsoftgraph/msgraph-beta-sdk-dotnet](https://github.com/microsoftgraph/msgraph-beta-sdk-dotnet) pushed_at:2021-11 star:0.1k fork:0.0k The Microsoft Graph Client Beta Library for .NET supports the Microsoft Graph /beta endpoint. (preview)
...
- [microsoftgraph/msgraph-samples-dashboard](https://github.com/microsoftgraph/msgraph-samples-dashboard) pushed_at:2021-11 star:0.0k fork:0.0k Dashboard for msgraph samples
- [microsoftgraph/MSGraph-SDK-Code-Generator](https://github.com/microsoftgraph/MSGraph-SDK-Code-Generator) pushed_at:2021-11 star:0.1k fork:0.1k MSGraph SDK Code Generator
- [microsoftgraph/msgraph-sdk-dotnet](https://github.com/microsoftgraph/msgraph-sdk-dotnet) pushed_at:2021-11 star:0.4k fork:0.2k Microsoft Graph Client Library for .NET!
...
- [microsoftgraph/msgraph-sdk-dotnet-core](https://github.com/microsoftgraph/msgraph-sdk-dotnet-core) pushed_at:2021-11 star:0.1k fork:0.0k The core Microsoft Graph client library for .Net. (Microsoft.Graph.Core)
- [microsoftgraph/msgraph-sdk-raptor](https://github.com/microsoftgraph/msgraph-sdk-raptor) pushed_at:2021-11 star:0.0k fork:0.0k End to end testing tool for verifying generated code snippets and testing against Graph APIs
...
- [microsoftgraph/msgraph-beta-sdk-go](https://github.com/microsoftgraph/msgraph-beta-sdk-go) pushed_at:2021-11 star:0.0k fork:0.0k Microsoft Graph Beta Go SDK
- [microsoftgraph/msgraph-sdk-go](https://github.com/microsoftgraph/msgraph-sdk-go) pushed_at:2021-11 star:0.0k fork:0.0k Microsoft Graph SDK for Go
- [microsoftgraph/msgraph-sdk-go-core](https://github.com/microsoftgraph/msgraph-sdk-go-core) pushed_at:2021-11 star:0.0k fork:0.0k Microsoft Graph SDK for Go - Core Library
...
- [microsoftgraph/msgraph-beta-sdk-java](https://github.com/microsoftgraph/msgraph-beta-sdk-java) pushed_at:2021-11 star:0.0k fork:0.0k Microsoft Graph Beta Java SDK
...
- [microsoftgraph/msgraph-sdk-java](https://github.com/microsoftgraph/msgraph-sdk-java) pushed_at:2021-11 star:0.2k fork:0.1k Microsoft Graph SDK for Java
...
- [microsoftgraph/msgraph-sdk-java-core](https://github.com/microsoftgraph/msgraph-sdk-java-core) pushed_at:2021-11 star:0.0k fork:0.0k Microsoft Graph SDK for Java - Core Library
...
- [microsoftgraph/microsoft-graph-devx-content](https://github.com/microsoftgraph/microsoft-graph-devx-content) pushed_at:2021-11 star:0.0k fork:0.0k Content used by the DevX API to enhance clients and tooling.
...
- [microsoftgraph/nodejs-webhooks-sample](https://github.com/microsoftgraph/nodejs-webhooks-sample) pushed_at:2021-11 star:0.1k fork:0.1k Create Microsoft Graph webhook subscriptions for a Node.js app, so that it can receive notifications of changes in a user’s Microsoft account data.
...
- [microsoftgraph/msgraph-sdk-objc-models](https://github.com/microsoftgraph/msgraph-sdk-objc-models) pushed_at:2021-11 star:0.0k fork:0.0k Generated Models for Objective C SDK
...
- [microsoftgraph/microsoft-graph-comms-samples](https://github.com/microsoftgraph/microsoft-graph-comms-samples) pushed_at:2021-11 star:0.1k fork:0.1k Microsoft Graph Communications Samples
...
- [microsoftgraph/msgraph-training-javascriptspa](https://github.com/microsoftgraph/msgraph-training-javascriptspa) pushed_at:2021-10 star:0.0k fork:0.0k Microsoft Graph Training Module - Build JavaScript single-page apps with Microsoft Graph
...
- [microsoftgraph/msgraph-training-nodeexpressapp](https://github.com/microsoftgraph/msgraph-training-nodeexpressapp) pushed_at:2021-11 star:0.1k fork:0.1k Microsoft Graph Training Module - Build Node.js web apps with Microsoft Graph
...
- [microsoftgraph/msgraph-beta-sdk-php](https://github.com/microsoftgraph/msgraph-beta-sdk-php) pushed_at:2021-11 star:0.0k fork:0.0k Microsoft Graph beta model library for PHP (preview).
- [microsoftgraph/msgraph-sdk-php](https://github.com/microsoftgraph/msgraph-sdk-php) pushed_at:2021-11 star:0.3k fork:0.1k Microsoft Graph Library for PHP.
...
- [microsoftgraph/microsoft-graph-docs](https://github.com/microsoftgraph/microsoft-graph-docs) pushed_at:2021-11 star:0.8k fork:1.4k Documentation for the Microsoft Graph REST API
- [microsoftgraph/microsoft-graph-docs.pt-BR](https://github.com/microsoftgraph/microsoft-graph-docs.pt-BR) pushed_at:2021-11 star:0.0k fork:0.0k Documentation for the Microsoft Graph REST API for Portuguese
- [microsoftgraph/microsoft-graph-docs.ru-RU](https://github.com/microsoftgraph/microsoft-graph-docs.ru-RU) pushed_at:2021-11 star:0.0k fork:0.0k Documentation for the Microsoft Graph REST API for Russian
- [microsoftgraph/microsoft-graph-docs.zh-CN](https://github.com/microsoftgraph/microsoft-graph-docs.zh-CN) pushed_at:2021-11 star:0.0k fork:0.0k Documentation for the Microsoft Graph REST API for Chinese(Simplified)
...
- [microsoftgraph/msgraph-sdk-powershell](https://github.com/microsoftgraph/msgraph-sdk-powershell) pushed_at:2021-11 star:0.3k fork:0.1k Powershell SDK for Microsoft Graph
- [microsoftgraph/msgraph-typescript-typings](https://github.com/microsoftgraph/msgraph-typescript-typings) pushed_at:2021-11 star:0.1k fork:0.0k Microsoft Graph TypeScript Type Definitions
...
- [microsoftgraph/msgraph-sdk-design](https://github.com/microsoftgraph/msgraph-sdk-design) pushed_at:2021-11 star:0.0k fork:0.0k Requirements and design documents for Microsoft Graph SDKs
...
- [microsoftgraph/assign-to-author](https://github.com/microsoftgraph/assign-to-author) pushed_at:2021-10 star:0.0k fork:0.0k This GitHub action assigns issues in the microsoft-graph-docs repository to the author of the referenced page
...
- [microsoftgraph/microsoft-graph-explorer-v4](https://github.com/microsoftgraph/microsoft-graph-explorer-v4) pushed_at:2021-11 star:0.1k fork:0.1k React/Redux version of Graph Explorer used to learn the Microsoft Graph Api
- [microsoftgraph/microsoft-graph-toolkit](https://github.com/microsoftgraph/microsoft-graph-toolkit) pushed_at:2021-11 star:0.6k fork:0.2k Authentication Providers and UI components for Microsoft Graph 🦒
- [microsoftgraph/msgraph-beta-typescript-typings](https://github.com/microsoftgraph/msgraph-beta-typescript-typings) pushed_at:2021-11 star:0.0k fork:0.0k Microsoft Graph Beta TypeScript Type Definitions
...
- [microsoftgraph/msgraph-metadata](https://github.com/microsoftgraph/msgraph-metadata) pushed_at:2021-11 star:0.0k fork:0.0k Metadata captured and used for generating client library code files.
