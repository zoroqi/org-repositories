...
- [cloudflare/stpyv8](https://github.com/cloudflare/stpyv8) topic: pushed_at:2024-11 star:0.4k fork:0.0k Python 3 and JavaScript interoperability. Successor To PyV8 (https://github.com/flier/pyv8)
...
- [cloudflare/cloudflared](https://github.com/cloudflare/cloudflared) topic:argo-tunnel,cloudflare,cloudflare-tunnel,reverse-proxy,zero-trust-network-access pushed_at:2024-11 star:9.4k fork:0.8k Cloudflare Tunnel client (formerly Argo Tunnel)
...
- [cloudflare/goflow](https://github.com/cloudflare/goflow) topic:cisco,flow,go,ipfix,juniper,kafka,netflow,sflow pushed_at:2024-11 star:0.9k fork:0.2k The high-scalability sFlow/NetFlow/IPFIX collector used internally at Cloudflare.
...
- [cloudflare/pat-go](https://github.com/cloudflare/pat-go) topic: pushed_at:2024-11 star:0.0k fork:0.0k Private Access Tokens reference implementation
...
- [cloudflare/roughtime](https://github.com/cloudflare/roughtime) topic:ntp,roughtime,time pushed_at:2024-11 star:0.1k fork:0.0k A secure clock-synchronization protocol for when rough is enough.
...
- [cloudflare/cloudflare-docs](https://github.com/cloudflare/cloudflare-docs) topic:cloudflare,docs,hacktoberfest,markdown,mdx pushed_at:2024-11 star:3.1k fork:4.9k Cloudflare’s documentation
...
- [cloudflare/boring](https://github.com/cloudflare/boring) topic: pushed_at:2024-11 star:0.4k fork:0.1k BoringSSL bindings for the Rust programming language.
...
- [cloudflare/cardinality-estimator](https://github.com/cloudflare/cardinality-estimator) topic:cardinality-estimation,distinct-elements,hyperloglog,probalistic-data-structures,sketches pushed_at:2024-11 star:0.0k fork:0.0k A crate for estimating the cardinality of distinct elements in a stream or dataset.
...
- [cloudflare/freighter](https://github.com/cloudflare/freighter) topic: pushed_at:2024-11 star:0.1k fork:0.0k A fast, modular, and operationally boring Rust private registry implementation.
...
- [cloudflare/mmap-sync](https://github.com/cloudflare/mmap-sync) topic:interprocess-communication,memory-mapping,synchronization,wait-free,zero-copy pushed_at:2024-11 star:0.5k fork:0.0k Rust library for concurrent data access, using memory-mapped files, zero-copy deserialization, and wait-free synchronization.
...
- [cloudflare/pingora](https://github.com/cloudflare/pingora) topic: pushed_at:2024-11 star:22.6k fork:1.3k A library for building fast, reliable and evolvable network services.
...
- [cloudflare/recapn](https://github.com/cloudflare/recapn) topic: pushed_at:2024-11 star:0.0k fork:0.0k A WIP Cap'n Proto implementation in Rust written from the ground up
...
- [cloudflare/mcp-server-cloudflare](https://github.com/cloudflare/mcp-server-cloudflare) topic: pushed_at:2024-11 star:0.1k fork:0.0k 
...
- [cloudflare/next-on-pages](https://github.com/cloudflare/next-on-pages) topic:cloudflare-pages,nextjs pushed_at:2024-11 star:1.3k fork:0.1k CLI to build and develop Next.js apps for Cloudflare Pages
...
- [cloudflare/privacypass-issuer](https://github.com/cloudflare/privacypass-issuer) topic:authentication,cryptography,privacy-pass,token,typescript pushed_at:2024-11 star:0.0k fork:0.0k A TypeScript Issuer for the Privacy Pass Authentication Protocol
...
- [cloudflare/templates](https://github.com/cloudflare/templates) topic: pushed_at:2024-11 star:1.0k fork:0.6k Templates for Cloudflare Workers
...
- [cloudflare/wrangler-action](https://github.com/cloudflare/wrangler-action) topic:cloudflare,cloudflare-workers,github-actions,wrangler pushed_at:2024-11 star:1.3k fork:0.2k 🧙‍♀️ easily deploy cloudflare workers applications using wrangler and github actions
