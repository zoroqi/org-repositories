...
- [cloudflare/bn256](https://github.com/cloudflare/bn256) topic: pushed_at:2025-04 star:0.1k fork:0.0k Package bn256 implements a particular bilinear group.
...
- [cloudflare/cf-terraforming](https://github.com/cloudflare/cf-terraforming) topic:cloudflare,terraform pushed_at:2025-04 star:1.1k fork:0.2k A command line utility to facilitate terraforming your existing Cloudflare resources.
...
- [cloudflare/cfssl](https://github.com/cloudflare/cfssl) topic: pushed_at:2025-02 star:9.0k fork:1.1k CFSSL: Cloudflare's PKI and TLS toolkit
- [cloudflare/cfssl_trust](https://github.com/cloudflare/cfssl_trust) topic: pushed_at:2025-04 star:0.3k fork:0.0k CFSSL's CA trust store repository
- [cloudflare/circl](https://github.com/cloudflare/circl) topic:circl,cryptography,csidh,dilithium,ed25519,ed448,elliptic-curves,go,golang,hpke,kyber,pki,post-quantum,sidh pushed_at:2025-04 star:1.4k fork:0.2k CIRCL: Cloudflare Interoperable Reusable Cryptographic Library
...
- [cloudflare/cloudflared](https://github.com/cloudflare/cloudflared) topic:argo-tunnel,cloudflare,cloudflare-tunnel,reverse-proxy,zero-trust-network-access pushed_at:2025-04 star:10.3k fork:0.9k Cloudflare Tunnel client (formerly Argo Tunnel)
...
- [cloudflare/ebpf_exporter](https://github.com/cloudflare/ebpf_exporter) topic:bpf,ebpf,libbpf,linux-kernel,performance,prometheus,prometheus-exporter,tracing pushed_at:2025-04 star:2.3k fork:0.2k Prometheus exporter for custom eBPF metrics
...
- [cloudflare/gokey](https://github.com/cloudflare/gokey) topic:deterministic,ecc,ed25519,key-generator,keychain,password-generator,password-manager,password-store,password-vault,rsa-key,seed,stateless pushed_at:2025-04 star:2.0k fork:0.1k A simple vaultless password manager in Go
- [cloudflare/gokeyless](https://github.com/cloudflare/gokeyless) topic:hsm,pkcs11,pki,tls pushed_at:2025-04 star:0.5k fork:0.1k Go implementation of the keyless protocol
...
- [cloudflare/ipvs](https://github.com/cloudflare/ipvs) topic: pushed_at:2025-04 star:0.1k fork:0.0k Package ipvs allows you to manage Linux IPVS services and destinations
...
- [cloudflare/origin-ca-issuer](https://github.com/cloudflare/origin-ca-issuer) topic:cert-manager pushed_at:2025-04 star:0.3k fork:0.1k cert-manager issuer for Origin CA
...
- [cloudflare/parquet-tsdb-poc](https://github.com/cloudflare/parquet-tsdb-poc) topic: pushed_at:2025-04 star:0.0k fork:0.0k A POC for a tsdb storage using parquet
- [cloudflare/pat-app](https://github.com/cloudflare/pat-app) topic: pushed_at:2025-04 star:0.0k fork:0.0k 
- [cloudflare/pat-go](https://github.com/cloudflare/pat-go) topic: pushed_at:2025-04 star:0.0k fork:0.0k Private Access Tokens reference implementation
- [cloudflare/pint](https://github.com/cloudflare/pint) topic:linter,metrics,observability,prometheus,validator pushed_at:2025-04 star:0.9k fork:0.1k Prometheus rule linter/validator
- [cloudflare/privacy-gateway-server-go](https://github.com/cloudflare/privacy-gateway-server-go) topic: pushed_at:2025-04 star:0.1k fork:0.0k An Oblivious HTTP gateway
...
- [cloudflare/blindrsa-ts](https://github.com/cloudflare/blindrsa-ts) topic:blind-rsa,cryptography,typescript pushed_at:2025-04 star:0.0k fork:0.0k A TypeScript Library for Blind RSA Signature protocol
...
- [cloudflare/cloudflare-docs](https://github.com/cloudflare/cloudflare-docs) topic:cloudflare,docs,hacktoberfest,markdown,mdx pushed_at:2025-04 star:3.5k fork:6.3k Cloudflare’s documentation
...
- [cloudflare/api-schemas](https://github.com/cloudflare/api-schemas) topic: pushed_at:2025-04 star:0.1k fork:0.0k 
...
- [cloudflare/langchain-cloudflare](https://github.com/cloudflare/langchain-cloudflare) topic: pushed_at:2025-04 star:0.0k fork:0.0k LangChain integrations for Cloudflare
...
- [cloudflare/python-workers-examples](https://github.com/cloudflare/python-workers-examples) topic: pushed_at:2025-04 star:0.1k fork:0.0k 
...
- [cloudflare/azul](https://github.com/cloudflare/azul) topic:certificate-transparency,certificate-transparency-logs,cryptography,merkle-tree,pki,web pushed_at:2025-04 star:0.0k fork:0.0k An implementation of a static-ct-api certificate transparency log for deployment on Cloudflare Workers
- [cloudflare/boring](https://github.com/cloudflare/boring) topic: pushed_at:2025-04 star:0.4k fork:0.1k BoringSSL bindings for the Rust programming language.
- [cloudflare/boringtun](https://github.com/cloudflare/boringtun) topic:cloudflare,rust,wireguard pushed_at:2025-04 star:6.3k fork:0.4k Userspace WireGuard® Implementation in Rust
...
- [cloudflare/freighter](https://github.com/cloudflare/freighter) topic: pushed_at:2025-04 star:0.1k fork:0.0k A fast, modular, and operationally boring Rust private registry implementation.
...
- [cloudflare/pingora](https://github.com/cloudflare/pingora) topic: pushed_at:2025-03 star:23.8k fork:1.4k A library for building fast, reliable and evolvable network services.
...
- [cloudflare/quiche](https://github.com/cloudflare/quiche) topic:http3,network-programming,protocol,quic,rust pushed_at:2025-04 star:10.1k fork:0.8k 🥧 Savoury implementation of the QUIC transport protocol and HTTP/3
...
- [cloudflare/wirefilter](https://github.com/cloudflare/wirefilter) topic:compiler,engine,filters,firewall,firewall-configuration,firewall-rules,rust,wireshark pushed_at:2025-04 star:1.0k fork:0.1k An execution engine for Wireshark-like filters
- [cloudflare/workerd-cxx](https://github.com/cloudflare/workerd-cxx) topic: pushed_at:2025-04 star:0.0k fork:0.0k workerd-cxx is a fork of cxx crate for workerd/edgeworker project
...
- [cloudflare/sciuro](https://github.com/cloudflare/sciuro) topic:alertmanager,kubernetes pushed_at:2025-04 star:0.2k fork:0.0k Alertmanager to Kubernetes Node conditions bridge
...
- [cloudflare/agents](https://github.com/cloudflare/agents) topic:agents,ai,cloudflare,durable-objects,workflows pushed_at:2025-04 star:1.5k fork:0.1k Build and deploy AI Agents on Cloudflare 
- [cloudflare/agents-starter](https://github.com/cloudflare/agents-starter) topic:agents,ai,cloudflare,durable-objects pushed_at:2025-04 star:0.7k fork:0.1k A starter kit for building ai agents on Cloudflare
- [cloudflare/ai](https://github.com/cloudflare/ai) topic: pushed_at:2025-04 star:0.1k fork:0.0k 
...
- [cloudflare/containers-demos](https://github.com/cloudflare/containers-demos) topic: pushed_at:2025-04 star:0.1k fork:0.0k 
- [cloudflare/d1-northwind](https://github.com/cloudflare/d1-northwind) topic:cloudflare-workers,d1 pushed_at:2025-04 star:0.1k fork:0.0k Northwind Traders D1 Demo
...
- [cloudflare/docs-examples](https://github.com/cloudflare/docs-examples) topic: pushed_at:2025-04 star:0.0k fork:0.0k Examples surfaced in the Cloudflare Docs
...
- [cloudflare/mcp-server-cloudflare](https://github.com/cloudflare/mcp-server-cloudflare) topic: pushed_at:2025-04 star:1.3k fork:0.1k 
...
- [cloudflare/next-on-pages](https://github.com/cloudflare/next-on-pages) topic:cloudflare-pages,nextjs pushed_at:2025-04 star:1.4k fork:0.1k CLI to build and develop Next.js apps for Cloudflare Pages
...
- [cloudflare/orange](https://github.com/cloudflare/orange) topic: pushed_at:2025-04 star:1.9k fork:0.3k 
...
- [cloudflare/playwright](https://github.com/cloudflare/playwright) topic: pushed_at:2025-04 star:0.0k fork:0.0k Playwright fork that works with Cloudflare Browser Rendering
...
- [cloudflare/privacypass-issuer](https://github.com/cloudflare/privacypass-issuer) topic:authentication,cryptography,privacy-pass,token,typescript pushed_at:2025-04 star:0.0k fork:0.0k A TypeScript Issuer for the Privacy Pass Authentication Protocol
...
- [cloudflare/privacypass-ts](https://github.com/cloudflare/privacypass-ts) topic:blindrsa,cryptography,privacy-pass,token,typescript,voprf pushed_at:2025-04 star:0.0k fork:0.0k A TypeScript Library for the Privacy Pass Issuance Protocol
...
- [cloudflare/puppeteer](https://github.com/cloudflare/puppeteer) topic:cloudflare,workers pushed_at:2025-04 star:0.3k fork:0.0k Puppeteer Core fork that works with Cloudflare Browser Workers
...
- [cloudflare/templates](https://github.com/cloudflare/templates) topic: pushed_at:2025-04 star:1.2k fork:0.7k Templates for Cloudflare Workers
...
- [cloudflare/workers-mcp](https://github.com/cloudflare/workers-mcp) topic: pushed_at:2025-04 star:0.5k fork:0.0k Talk to a Cloudflare Worker from Claude Desktop!
- [cloudflare/workers-oauth-provider](https://github.com/cloudflare/workers-oauth-provider) topic: pushed_at:2025-04 star:0.1k fork:0.0k OAuth provider library for Cloudflare Workers
- [cloudflare/workers-sdk](https://github.com/cloudflare/workers-sdk) topic:cli,cloudflare,cloudflare-workers,javascript,serverless,wasm pushed_at:2025-04 star:3.0k fork:0.8k ⛅️ Home to Wrangler, the CLI for Cloudflare Workers®
...
- [cloudflare/workflows-starter](https://github.com/cloudflare/workflows-starter) topic:cloudflare,durable-execution,workers,workflows pushed_at:2025-04 star:0.0k fork:0.0k A starter template for Cloudflare Workflows. 
