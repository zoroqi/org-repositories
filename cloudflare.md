...
- [cloudflare/workerd](https://github.com/cloudflare/workerd) topic: pushed_at:2025-07 star:6.8k fork:0.4k The JavaScript / Wasm runtime that powers Cloudflare Workers
...
- [cloudflare/circl](https://github.com/cloudflare/circl) topic:circl,cryptography,csidh,dilithium,ed25519,ed448,elliptic-curves,go,golang,hpke,kyber,pki,post-quantum,sidh pushed_at:2025-06 star:1.5k fork:0.2k CIRCL: Cloudflare Interoperable Reusable Cryptographic Library
...
- [cloudflare/cloudflared](https://github.com/cloudflare/cloudflared) topic:argo-tunnel,cloudflare,cloudflare-tunnel,reverse-proxy,zero-trust-network-access pushed_at:2025-06 star:10.9k fork:1.0k Cloudflare Tunnel client (formerly Argo Tunnel)
...
- [cloudflare/isbgpsafeyet.com](https://github.com/cloudflare/isbgpsafeyet.com) topic:bgp,cloudflare,hacktoberfest,rpki,wrangler pushed_at:2025-06 star:0.3k fork:0.3k Is BGP safe yet?
...
- [cloudflare/cloudflare-docs](https://github.com/cloudflare/cloudflare-docs) topic:cloudflare,docs,markdown,mdx pushed_at:2025-07 star:3.7k fork:7.0k Cloudflare’s documentation
...
- [cloudflare/boringtun](https://github.com/cloudflare/boringtun) topic:cloudflare,rust,wireguard pushed_at:2025-05 star:6.5k fork:0.5k Userspace WireGuard® Implementation in Rust
...
- [cloudflare/pingora](https://github.com/cloudflare/pingora) topic: pushed_at:2025-06 star:24.5k fork:1.4k A library for building fast, reliable and evolvable network services.
...
- [cloudflare/quiche](https://github.com/cloudflare/quiche) topic:http3,network-programming,protocol,quic,rust pushed_at:2025-06 star:10.3k fork:0.8k 🥧 Savoury implementation of the QUIC transport protocol and HTTP/3
...
- [cloudflare/actors](https://github.com/cloudflare/actors) topic:actors,cloudflare,durable-objects,sqlite pushed_at:2025-06 star:0.1k fork:0.0k An easier way to build with Cloudflare Durable Objects
- [cloudflare/agents](https://github.com/cloudflare/agents) topic:agents,ai,cloudflare,durable-objects,workflows pushed_at:2025-06 star:2.2k fork:0.2k Build and deploy AI Agents on Cloudflare 
...
- [cloudflare/ai](https://github.com/cloudflare/ai) topic: pushed_at:2025-06 star:0.6k fork:0.1k 
...
- [cloudflare/chanfana](https://github.com/cloudflare/chanfana) topic:api,cloudflare,cloudflare-workers,hono,honojs,openapi,openapi3,router,swagger,typescript,workers,workers-script pushed_at:2025-06 star:0.6k fork:0.0k OpenAPI 3 and 3.1 schema generator and validator for Hono, itty-router and more!
...
- [cloudflare/containers](https://github.com/cloudflare/containers) topic: pushed_at:2025-06 star:0.1k fork:0.0k 
- [cloudflare/containers-demos](https://github.com/cloudflare/containers-demos) topic: pushed_at:2025-06 star:0.2k fork:0.0k 
...
- [cloudflare/mcp-server-cloudflare](https://github.com/cloudflare/mcp-server-cloudflare) topic: pushed_at:2025-06 star:2.6k fork:0.2k 
...
- [cloudflare/orange](https://github.com/cloudflare/orange) topic: pushed_at:2025-06 star:2.1k fork:0.3k 
...
- [cloudflare/sandbox-sdk](https://github.com/cloudflare/sandbox-sdk) topic: pushed_at:2025-06 star:0.0k fork:0.0k 
...
- [cloudflare/workers-oauth-provider](https://github.com/cloudflare/workers-oauth-provider) topic: pushed_at:2025-06 star:1.4k fork:0.1k OAuth provider library for Cloudflare Workers
...
- [cloudflare/zkp-ecdsa](https://github.com/cloudflare/zkp-ecdsa) topic:crypto,cryptography,ecdsa,zero-knowledge,zkattest pushed_at:2025-06 star:0.2k fork:0.0k Proves knowledge of an ECDSA-P256 signature under one of many public keys that are stored in a list.
