...
- [cloudflare/bbmp2kafka](https://github.com/cloudflare/bbmp2kafka) topic:bgp,bgp-monitor,bgp-monitoring-protocol,bmp pushed_at:2025-11 star:0.0k fork:0.0k BMP to Kafka processor
...
- [cloudflare/cloudflare-go](https://github.com/cloudflare/cloudflare-go) topic:api,cloudflare,sdk,sdk-go,sdk-golang pushed_at:2026-03 star:1.9k fork:0.7k The official Go library for the Cloudflare API
...
- [cloudflare/cloudflared](https://github.com/cloudflare/cloudflared) topic:cloudflare,cloudflare-tunnel,reverse-proxy,zero-trust-network-access pushed_at:2026-03 star:13.5k fork:1.2k Cloudflare Tunnel client
...
- [cloudflare/origin-ca-issuer](https://github.com/cloudflare/origin-ca-issuer) topic:cert-manager pushed_at:2026-02 star:0.3k fork:0.1k cert-manager issuer for Origin CA
...
- [cloudflare/cloudflare-docs](https://github.com/cloudflare/cloudflare-docs) topic:cloudflare,docs,hacktoberfest,markdown,mdx pushed_at:2026-03 star:4.5k fork:12.8k Cloudflare’s documentation
...
- [cloudflare/agent-skills-discovery-rfc](https://github.com/cloudflare/agent-skills-discovery-rfc) topic: pushed_at:2026-02 star:0.2k fork:0.0k 
...
- [cloudflare/skills](https://github.com/cloudflare/skills) topic:agents,cloudflare,skills,workers pushed_at:2026-03 star:0.7k fork:0.1k Skills for teaching agents how to build on Cloudflare.
...
- [cloudflare/bbperf](https://github.com/cloudflare/bbperf) topic: pushed_at:2026-01 star:0.0k fork:0.0k bbperf
...
- [cloudflare/langchain-cloudflare](https://github.com/cloudflare/langchain-cloudflare) topic: pushed_at:2026-01 star:0.0k fork:0.0k LangChain integrations for Cloudflare
...
- [cloudflare/pyodide-build-scripts](https://github.com/cloudflare/pyodide-build-scripts) topic: pushed_at:2025-08 star:0.0k fork:0.0k Automated build processes for Cloudflare Workers Pyodide distribution
...
- [cloudflare/homebrew-cloudflare](https://github.com/cloudflare/homebrew-cloudflare) topic: pushed_at:2025-08 star:0.1k fork:0.0k 
...
- [cloudflare/boring](https://github.com/cloudflare/boring) topic: pushed_at:2026-02 star:0.5k fork:0.2k BoringSSL bindings for the Rust programming language.
- [cloudflare/boringtun](https://github.com/cloudflare/boringtun) topic:cloudflare,rust,wireguard pushed_at:2026-01 star:6.9k fork:0.5k Userspace WireGuard® Implementation in Rust
...
- [cloudflare/ecdysis](https://github.com/cloudflare/ecdysis) topic: pushed_at:2026-02 star:0.3k fork:0.0k A library for graceful restarts in Rust
...
- [cloudflare/freighter](https://github.com/cloudflare/freighter) topic: pushed_at:2026-02 star:0.1k fork:0.0k A fast, modular, and operationally boring Rust private registry implementation.
...
- [cloudflare/lol-html](https://github.com/cloudflare/lol-html) topic:css-selectors,html,parser,rewriting,rust,stream,streaming pushed_at:2026-03 star:1.9k fork:0.1k Low output latency streaming HTML parser/rewriter with CSS selector-based API
...
- [cloudflare/quiche](https://github.com/cloudflare/quiche) topic:http3,network-programming,protocol,quic,rust pushed_at:2026-03 star:11.3k fork:1.0k 🥧 Savoury implementation of the QUIC transport protocol and HTTP/3
...
- [cloudflare/recapn](https://github.com/cloudflare/recapn) topic: pushed_at:2026-02 star:0.1k fork:0.0k A WIP Cap'n Proto implementation in Rust written from the ground up
...
- [cloudflare/trie-hard](https://github.com/cloudflare/trie-hard) topic: pushed_at:2026-02 star:0.6k fork:0.0k Novel implementation of a Trie data structure optimized for small, sparse maps
...
- [cloudflare/workerd-cxx](https://github.com/cloudflare/workerd-cxx) topic: pushed_at:2026-02 star:0.0k fork:0.0k workerd-cxx is a fork of cxx crate for workerd/edgeworker project
...
- [cloudflare/realtimekit-ios-core](https://github.com/cloudflare/realtimekit-ios-core) topic: pushed_at:2026-02 star:0.0k fork:0.0k Swift package definitions for RealtimeKitCore
- [cloudflare/realtimekit-ios-ui](https://github.com/cloudflare/realtimekit-ios-ui) topic: pushed_at:2026-01 star:0.0k fork:0.0k Swift package definitions for RealtimeKitUI
...
- [cloudflare/agents](https://github.com/cloudflare/agents) topic:agents,ai,cloudflare,durable-objects,workflows pushed_at:2026-03 star:4.5k fork:0.5k Build and deploy AI Agents on Cloudflare 
- [cloudflare/agents-starter](https://github.com/cloudflare/agents-starter) topic:agents,ai,cloudflare,durable-objects pushed_at:2026-03 star:1.2k fork:0.2k A starter kit for building ai agents on Cloudflare
...
- [cloudflare/capnweb](https://github.com/cloudflare/capnweb) topic: pushed_at:2026-03 star:3.7k fork:0.1k JavaScript/TypeScript-native, low-boilerplate, object-capability RPC system
...
- [cloudflare/kumo](https://github.com/cloudflare/kumo) topic: pushed_at:2026-03 star:0.9k fork:0.1k Cloudflare's component library for building modern web applications.
...
- [cloudflare/mcp-server-cloudflare](https://github.com/cloudflare/mcp-server-cloudflare) topic: pushed_at:2026-03 star:3.5k fork:0.4k 
...
- [cloudflare/moltworker](https://github.com/cloudflare/moltworker) topic:ai-agents,cloudflare-workers pushed_at:2026-03 star:9.6k fork:1.7k Run OpenClaw, (formerly Moltbot, formerly Clawdbot) on Cloudflare Workers
...
- [cloudflare/opaque-ts](https://github.com/cloudflare/opaque-ts) topic:crypto,cryptography,opaque,pake,password pushed_at:2026-02 star:0.1k fork:0.0k A TypeScript library for OPAQUE Asymmetric Password-Authenticated Key Exchange Protocol
...
- [cloudflare/orange](https://github.com/cloudflare/orange) topic: pushed_at:2025-10 star:2.3k fork:0.3k 
...
- [cloudflare/partykit](https://github.com/cloudflare/partykit) topic:agents,ai,collaboration,durable-objects,real-time pushed_at:2026-03 star:1.0k fork:0.1k PartyKit, for Workers
...
- [cloudflare/vinext](https://github.com/cloudflare/vinext) topic: pushed_at:2026-03 star:6.8k fork:0.2k Vite plugin that reimplements the Next.js API surface — deploy anywhere
...
- [cloudflare/workers-sdk](https://github.com/cloudflare/workers-sdk) topic:cli,cloudflare,cloudflare-workers,javascript,serverless,wasm pushed_at:2026-03 star:3.9k fork:1.2k ⛅️ Home to Wrangler, the CLI for Cloudflare Workers®
...
- [cloudflare/zkp-ecdsa](https://github.com/cloudflare/zkp-ecdsa) topic:crypto,cryptography,ecdsa,zero-knowledge,zkattest pushed_at:2026-02 star:0.2k fork:0.0k Proves knowledge of an ECDSA-P256 signature under one of many public keys that are stored in a list.
