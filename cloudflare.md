...
- [cloudflare/workerd](https://github.com/cloudflare/workerd) topic: pushed_at:2025-12 star:7.3k fork:0.5k The JavaScript / Wasm runtime that powers Cloudflare Workers
...
- [cloudflare/cloudflared](https://github.com/cloudflare/cloudflared) topic:cloudflare,cloudflare-tunnel,reverse-proxy,zero-trust-network-access pushed_at:2025-11 star:12.3k fork:1.1k Cloudflare Tunnel client
...
- [cloudflare/cloudflare-gcp](https://github.com/cloudflare/cloudflare-gcp) topic: pushed_at:2025-12 star:0.1k fork:0.1k Google Cloud Function to push json files from GC Storage to Big Query
...
- [cloudflare/workers.cloudflare.com](https://github.com/cloudflare/workers.cloudflare.com) topic: pushed_at:2025-11 star:0.2k fork:0.0k The Cloudflare Workers website.
...
- [cloudflare/cloudflare-docs](https://github.com/cloudflare/cloudflare-docs) topic:cloudflare,docs,hacktoberfest,markdown,mdx pushed_at:2025-12 star:4.2k fork:10.9k Cloudflare’s documentation
...
- [cloudflare/boringtun](https://github.com/cloudflare/boringtun) topic:cloudflare,rust,wireguard pushed_at:2025-11 star:6.7k fork:0.5k Userspace WireGuard® Implementation in Rust
...
- [cloudflare/moq-rs](https://github.com/cloudflare/moq-rs) topic:livestreaming,lowlatency,mediaoverquic,moq,quic pushed_at:2025-11 star:0.1k fork:0.0k Rust implementation of the IETF MoQ Transport protocol
...
- [cloudflare/pingora](https://github.com/cloudflare/pingora) topic: pushed_at:2025-12 star:25.7k fork:1.5k A library for building fast, reliable and evolvable network services.
...
- [cloudflare/quiche](https://github.com/cloudflare/quiche) topic:http3,network-programming,protocol,quic,rust pushed_at:2025-12 star:11.0k fork:0.9k 🥧 Savoury implementation of the QUIC transport protocol and HTTP/3
...
- [cloudflare/wirefilter](https://github.com/cloudflare/wirefilter) topic:compiler,engine,filters,firewall,firewall-configuration,firewall-rules,rust,wireshark pushed_at:2025-11 star:1.1k fork:0.1k An execution engine for Wireshark-like filters
...
- [cloudflare/workers-rs](https://github.com/cloudflare/workers-rs) topic:cloudflare,ffi,rust,serverless,webassembly,workers,workers-rs pushed_at:2025-12 star:3.2k fork:0.4k Write Cloudflare Workers in 100% Rust via WebAssembly
...
- [cloudflare/agents](https://github.com/cloudflare/agents) topic:agents,ai,cloudflare,durable-objects,workflows pushed_at:2025-12 star:2.9k fork:0.3k Build and deploy AI Agents on Cloudflare 
- [cloudflare/agents-starter](https://github.com/cloudflare/agents-starter) topic:agents,ai,cloudflare,durable-objects pushed_at:2025-11 star:1.1k fork:0.2k A starter kit for building ai agents on Cloudflare
...
- [cloudflare/awesome-agents](https://github.com/cloudflare/awesome-agents) topic: pushed_at:2025-12 star:0.1k fork:0.0k Awesome Agents
...
- [cloudflare/capnweb](https://github.com/cloudflare/capnweb) topic: pushed_at:2025-12 star:3.5k fork:0.1k JavaScript/TypeScript-native, low-boilerplate, object-capability RPC system
...
- [cloudflare/partykit](https://github.com/cloudflare/partykit) topic:agents,ai,collaboration,durable-objects,real-time pushed_at:2025-10 star:0.9k fork:0.1k PartyKit, for Workers
...
- [cloudflare/vibesdk](https://github.com/cloudflare/vibesdk) topic:ai,cloudflare-workers,coding-agent,durable-objects,text-to-app,vibe-coding pushed_at:2025-12 star:4.4k fork:1.0k An open-source vibe coding platform that helps you build your own vibe-coding platform, built entirely on Cloudflare stack 
...
- [cloudflare/workers-sdk](https://github.com/cloudflare/workers-sdk) topic:cli,cloudflare,cloudflare-workers,javascript,serverless,wasm pushed_at:2025-12 star:3.6k fork:1.1k ⛅️ Home to Wrangler, the CLI for Cloudflare Workers®
