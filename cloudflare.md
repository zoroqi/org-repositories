...
- [cloudflare/workerd](https://github.com/cloudflare/workerd) topic: pushed_at:2024-11 star:6.3k fork:0.3k The JavaScript / Wasm runtime that powers Cloudflare Workers
...
- [cloudflare/cf-terraforming](https://github.com/cloudflare/cf-terraforming) topic:cloudflare,terraform pushed_at:2024-11 star:1.0k fork:0.1k A command line utility to facilitate terraforming your existing Cloudflare resources.
...
- [cloudflare/cfssl](https://github.com/cloudflare/cfssl) topic: pushed_at:2024-10 star:8.8k fork:1.1k CFSSL: Cloudflare's PKI and TLS toolkit
- [cloudflare/cfssl_trust](https://github.com/cloudflare/cfssl_trust) topic: pushed_at:2024-11 star:0.3k fork:0.0k CFSSL's CA trust store repository
- [cloudflare/circl](https://github.com/cloudflare/circl) topic:circl,cryptography,csidh,dilithium,ed25519,ed448,elliptic-curves,go,golang,hpke,kyber,pki,post-quantum,sidh pushed_at:2024-11 star:1.3k fork:0.1k CIRCL: Cloudflare Interoperable Reusable Cryptographic Library
...
- [cloudflare/cloudflare-go](https://github.com/cloudflare/cloudflare-go) topic:api,cloudflare,sdk,sdk-go,sdk-golang pushed_at:2024-11 star:1.5k fork:0.6k The official Go library for the Cloudflare API
...
- [cloudflare/cloudflared](https://github.com/cloudflare/cloudflared) topic:argo-tunnel,cloudflare,cloudflare-tunnel,reverse-proxy,zero-trust-network-access pushed_at:2024-11 star:9.3k fork:0.8k Cloudflare Tunnel client (formerly Argo Tunnel)
...
- [cloudflare/ebpf_exporter](https://github.com/cloudflare/ebpf_exporter) topic:bpf,ebpf,libbpf,linux-kernel,performance,prometheus,prometheus-exporter,tracing pushed_at:2024-11 star:2.2k fork:0.2k Prometheus exporter for custom eBPF metrics
...
- [cloudflare/go](https://github.com/cloudflare/go) topic:delegated-credentials,ech,go,kyber,post-quantum pushed_at:2024-09 star:0.3k fork:0.1k Go with Cloudflare experimental patches
...
- [cloudflare/gokeyless](https://github.com/cloudflare/gokeyless) topic:hsm,pkcs11,pki,tls pushed_at:2024-11 star:0.5k fork:0.1k Go implementation of the keyless protocol
...
- [cloudflare/octopus](https://github.com/cloudflare/octopus) topic:hacktoberfest pushed_at:2024-11 star:0.0k fork:0.0k The Octopus is part of our network automation pipeline. Its job is to aggregate data from different authoritative data sources into one Enriched Topology to provide a full picture to downstream systems.
...
- [cloudflare/origin-ca-issuer](https://github.com/cloudflare/origin-ca-issuer) topic:cert-manager pushed_at:2024-11 star:0.3k fork:0.1k cert-manager issuer for Origin CA
...
- [cloudflare/pint](https://github.com/cloudflare/pint) topic:linter,metrics,observability,prometheus,validator pushed_at:2024-11 star:0.9k fork:0.1k Prometheus rule linter/validator
...
- [cloudflare/api-schemas](https://github.com/cloudflare/api-schemas) topic: pushed_at:2024-11 star:0.1k fork:0.0k 
...
- [cloudflare/cloudflare-docs](https://github.com/cloudflare/cloudflare-docs) topic:cloudflare,docs,hacktoberfest,markdown,mdx pushed_at:2024-11 star:3.1k fork:4.7k Cloudflare’s documentation
...
- [cloudflare/research.cloudflare.com](https://github.com/cloudflare/research.cloudflare.com) topic: pushed_at:2024-11 star:0.0k fork:0.0k 
...
- [cloudflare/cloudflare-python](https://github.com/cloudflare/cloudflare-python) topic:api,cloudflare,sdk,sdk-python pushed_at:2024-11 star:0.1k fork:0.0k The official Python library for the Cloudflare API
...
- [cloudflare/homebrew-cloudflare](https://github.com/cloudflare/homebrew-cloudflare) topic: pushed_at:2024-11 star:0.1k fork:0.0k 
...
- [cloudflare/daphne](https://github.com/cloudflare/daphne) topic:privacy-preserving pushed_at:2024-11 star:0.1k fork:0.0k Implementation of DAP
...
- [cloudflare/foundations](https://github.com/cloudflare/foundations) topic: pushed_at:2024-11 star:1.3k fork:0.1k Cloudflare's Rust service foundations library.
...
- [cloudflare/lol-html](https://github.com/cloudflare/lol-html) topic:css-selectors,html,parser,rewriting,rust,stream,streaming pushed_at:2024-11 star:1.5k fork:0.1k Low output latency streaming HTML parser/rewriter with CSS selector-based API
...
- [cloudflare/networkquality-rs](https://github.com/cloudflare/networkquality-rs) topic: pushed_at:2024-11 star:0.0k fork:0.0k 
...
- [cloudflare/pingora](https://github.com/cloudflare/pingora) topic: pushed_at:2024-11 star:22.1k fork:1.2k A library for building fast, reliable and evolvable network services.
...
- [cloudflare/quiche](https://github.com/cloudflare/quiche) topic:http3,network-programming,protocol,quic,rust pushed_at:2024-11 star:9.5k fork:0.7k 🥧 Savoury implementation of the QUIC transport protocol and HTTP/3
...
- [cloudflare/shellflip](https://github.com/cloudflare/shellflip) topic:graceful-shutdown,process,restart,rust,server,systemd pushed_at:2024-10 star:0.3k fork:0.0k Graceful process restarts in Rust
...
- [cloudflare/trie-hard](https://github.com/cloudflare/trie-hard) topic: pushed_at:2024-11 star:0.5k fork:0.0k Novel implementation of a Trie data structure optimized for small, sparse maps
...
- [cloudflare/wildcard](https://github.com/cloudflare/wildcard) topic:text-processing,wildcard pushed_at:2024-11 star:0.2k fork:0.0k Wildcard matching
- [cloudflare/wirefilter](https://github.com/cloudflare/wirefilter) topic:compiler,engine,filters,firewall,firewall-configuration,firewall-rules,rust,wireshark pushed_at:2024-11 star:1.0k fork:0.1k An execution engine for Wireshark-like filters
- [cloudflare/workerd-cxx](https://github.com/cloudflare/workerd-cxx) topic: pushed_at:2024-11 star:0.0k fork:0.0k Safe interop between Rust and C++
- [cloudflare/workers-rs](https://github.com/cloudflare/workers-rs) topic:cloudflare,ffi,rust,serverless,webassembly,workers,workers-rs pushed_at:2024-11 star:2.6k fork:0.3k Write Cloudflare Workers in 100% Rust via WebAssembly
...
- [cloudflare/chanfana](https://github.com/cloudflare/chanfana) topic:api,cloudflare,cloudflare-workers,hono,honojs,openapi,openapi3,router,swagger,typescript,workers,workers-script pushed_at:2024-11 star:0.3k fork:0.0k OpenAPI 3 and 3.1 schema generator and validator for Hono, itty-router and more!
- [cloudflare/cloudflare-typescript](https://github.com/cloudflare/cloudflare-typescript) topic:api,cloudflare,sdk,sdk-typescript pushed_at:2024-11 star:0.3k fork:0.0k The official Typescript library for the Cloudflare API
...
- [cloudflare/orange](https://github.com/cloudflare/orange) topic: pushed_at:2024-11 star:1.6k fork:0.2k 
...
- [cloudflare/serverless-registry](https://github.com/cloudflare/serverless-registry) topic:artifacts,cloudflare,container,container-registry,containers,docker,docker-registry,javascript,r2,registry,typescript,workers pushed_at:2024-11 star:1.0k fork:0.0k A container registry backed by Workers and R2.
...
- [cloudflare/workers-for-platforms-example](https://github.com/cloudflare/workers-for-platforms-example) topic: pushed_at:2024-10 star:0.2k fork:0.0k A great place for platforms to get started on Cloudflare Workers!
- [cloudflare/workers-graphql-server](https://github.com/cloudflare/workers-graphql-server) topic:apollo,cloudflare-workers,graphql,serverless pushed_at:2024-11 star:0.7k fork:0.5k 🔥Lightning-fast, globally distributed Apollo GraphQL server, deployed at the edge using Cloudflare Workers
...
- [cloudflare/workers-sdk](https://github.com/cloudflare/workers-sdk) topic:cli,cloudflare,cloudflare-workers,javascript,serverless,wasm pushed_at:2024-11 star:2.7k fork:0.7k ⛅️ Home to Wrangler, the CLI for Cloudflare Workers®
...
- [cloudflare/workflows-starter](https://github.com/cloudflare/workflows-starter) topic:cloudflare,durable-execution,workers,workflows pushed_at:2024-11 star:0.0k fork:0.0k A starter template for Cloudflare Workflows. 
- [cloudflare/wrangler-action](https://github.com/cloudflare/wrangler-action) topic:cloudflare,cloudflare-workers,github-actions,wrangler pushed_at:2024-11 star:1.2k fork:0.2k 🧙‍♀️ easily deploy cloudflare workers applications using wrangler and github actions
