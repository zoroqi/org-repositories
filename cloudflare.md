...
- [cloudflare/cloudflare-blog](https://github.com/cloudflare/cloudflare-blog) topic: pushed_at:2025-01 star:1.2k fork:0.2k Cloudflare Blog code samples
...
- [cloudflare/zlib](https://github.com/cloudflare/zlib) topic: pushed_at:2025-01 star:0.7k fork:0.1k Cloudflare fork of zlib with massive performance improvements
...
- [cloudflare/stpyv8](https://github.com/cloudflare/stpyv8) topic: pushed_at:2025-01 star:0.4k fork:0.0k Python 3 and JavaScript interoperability. Successor To PyV8 (https://github.com/flier/pyv8)
- [cloudflare/workerd](https://github.com/cloudflare/workerd) topic: pushed_at:2025-01 star:6.4k fork:0.3k The JavaScript / Wasm runtime that powers Cloudflare Workers
- [cloudflare/workers-wasi](https://github.com/cloudflare/workers-wasi) topic: pushed_at:2024-09 star:0.1k fork:0.0k 

## CMake

- [cloudflare/workerd-tools](https://github.com/cloudflare/workerd-tools) topic: pushed_at:2025-01 star:0.0k fork:0.0k Prebuilt tools and utilities required for ongoing development in the workerd repo.
...
- [cloudflare/cf-terraforming](https://github.com/cloudflare/cf-terraforming) topic:cloudflare,terraform pushed_at:2025-01 star:1.0k fork:0.1k A command line utility to facilitate terraforming your existing Cloudflare resources.
...
- [cloudflare/cfssl](https://github.com/cloudflare/cfssl) topic: pushed_at:2024-10 star:8.9k fork:1.1k CFSSL: Cloudflare's PKI and TLS toolkit
- [cloudflare/cfssl_trust](https://github.com/cloudflare/cfssl_trust) topic: pushed_at:2025-01 star:0.3k fork:0.0k CFSSL's CA trust store repository
- [cloudflare/circl](https://github.com/cloudflare/circl) topic:circl,cryptography,csidh,dilithium,ed25519,ed448,elliptic-curves,go,golang,hpke,kyber,pki,post-quantum,sidh pushed_at:2025-01 star:1.4k fork:0.1k CIRCL: Cloudflare Interoperable Reusable Cryptographic Library
...
- [cloudflare/cloudflare-go](https://github.com/cloudflare/cloudflare-go) topic:api,cloudflare,sdk,sdk-go,sdk-golang pushed_at:2025-01 star:1.5k fork:0.6k The official Go library for the Cloudflare API
...
- [cloudflare/cloudflared](https://github.com/cloudflare/cloudflared) topic:argo-tunnel,cloudflare,cloudflare-tunnel,reverse-proxy,zero-trust-network-access pushed_at:2025-01 star:9.7k fork:0.9k Cloudflare Tunnel client (formerly Argo Tunnel)
...
- [cloudflare/gokeyless](https://github.com/cloudflare/gokeyless) topic:hsm,pkcs11,pki,tls pushed_at:2025-01 star:0.5k fork:0.1k Go implementation of the keyless protocol
...
- [cloudflare/octopus](https://github.com/cloudflare/octopus) topic:hacktoberfest pushed_at:2025-01 star:0.0k fork:0.0k The Octopus is part of our network automation pipeline. Its job is to aggregate data from different authoritative data sources into one Enriched Topology to provide a full picture to downstream systems.
...
- [cloudflare/origin-ca-issuer](https://github.com/cloudflare/origin-ca-issuer) topic:cert-manager pushed_at:2025-01 star:0.3k fork:0.1k cert-manager issuer for Origin CA
...
- [cloudflare/pint](https://github.com/cloudflare/pint) topic:linter,metrics,observability,prometheus,validator pushed_at:2025-01 star:0.9k fork:0.1k Prometheus rule linter/validator
...
- [cloudflare/terraform-provider-cloudflare](https://github.com/cloudflare/terraform-provider-cloudflare) topic:cloudflare,terraform,terraform-provider pushed_at:2025-01 star:0.9k fork:0.6k Cloudflare Terraform Provider
...
- [cloudflare/cf-product-infrastructure-templates](https://github.com/cloudflare/cf-product-infrastructure-templates) topic: pushed_at:2025-01 star:0.0k fork:0.0k 
...
- [cloudflare/calls-examples](https://github.com/cloudflare/calls-examples) topic: pushed_at:2024-12 star:0.1k fork:0.0k 
...
- [cloudflare/isbgpsafeyet.com](https://github.com/cloudflare/isbgpsafeyet.com) topic:bgp,cloudflare,hacktoberfest,rpki,wrangler pushed_at:2025-01 star:0.3k fork:0.3k Is BGP safe yet?
...
- [cloudflare/api-schemas](https://github.com/cloudflare/api-schemas) topic: pushed_at:2025-01 star:0.1k fork:0.0k 
...
- [cloudflare/cloudflare-gcp](https://github.com/cloudflare/cloudflare-gcp) topic: pushed_at:2024-09 star:0.1k fork:0.1k Google Cloud Function to push json files from GC Storage to Big Query
...
- [cloudflare/speedtest](https://github.com/cloudflare/speedtest) topic:bandwidth,cloudflare,latency,network-quality,packet-loss,speedtest pushed_at:2025-01 star:0.5k fork:0.0k Component to perform network speed tests against Cloudflare's edge network
...
- [cloudflare/workers.cloudflare.com](https://github.com/cloudflare/workers.cloudflare.com) topic: pushed_at:2025-01 star:0.1k fork:0.0k The Cloudflare Workers website.
...
- [cloudflare/cloudflare-docs](https://github.com/cloudflare/cloudflare-docs) topic:cloudflare,docs,hacktoberfest,markdown,mdx pushed_at:2025-01 star:3.2k fork:5.6k Cloudflare’s documentation
...
- [cloudflare/research.cloudflare.com](https://github.com/cloudflare/research.cloudflare.com) topic: pushed_at:2025-01 star:0.0k fork:0.0k 
...
- [cloudflare/cloudflare-python](https://github.com/cloudflare/cloudflare-python) topic:api,cloudflare,sdk,sdk-python pushed_at:2025-01 star:0.2k fork:0.0k The official Python library for the Cloudflare API
...
- [cloudflare/boring](https://github.com/cloudflare/boring) topic: pushed_at:2025-01 star:0.4k fork:0.1k BoringSSL bindings for the Rust programming language.
...
- [cloudflare/daphne](https://github.com/cloudflare/daphne) topic:privacy-preserving pushed_at:2025-01 star:0.1k fork:0.0k Implementation of DAP
...
- [cloudflare/foundations](https://github.com/cloudflare/foundations) topic: pushed_at:2025-01 star:1.3k fork:0.1k Cloudflare's Rust service foundations library.
- [cloudflare/freighter](https://github.com/cloudflare/freighter) topic: pushed_at:2025-01 star:0.1k fork:0.0k A fast, modular, and operationally boring Rust private registry implementation.
...
- [cloudflare/lol-html](https://github.com/cloudflare/lol-html) topic:css-selectors,html,parser,rewriting,rust,stream,streaming pushed_at:2025-01 star:1.6k fork:0.1k Low output latency streaming HTML parser/rewriter with CSS selector-based API
...
- [cloudflare/pingora](https://github.com/cloudflare/pingora) topic: pushed_at:2024-12 star:23.1k fork:1.3k A library for building fast, reliable and evolvable network services.
...
- [cloudflare/quiche](https://github.com/cloudflare/quiche) topic:http3,network-programming,protocol,quic,rust pushed_at:2025-01 star:9.8k fork:0.8k 🥧 Savoury implementation of the QUIC transport protocol and HTTP/3
- [cloudflare/quiche-mallard](https://github.com/cloudflare/quiche-mallard) topic: pushed_at:2025-01 star:0.0k fork:0.0k quiche fork with congestion & zero-copy patches
...
- [cloudflare/svg-hush](https://github.com/cloudflare/svg-hush) topic:sanitizer,security,svg,xss-filter pushed_at:2025-01 star:0.4k fork:0.0k Make it safe to serve untrusted SVG files
...
- [cloudflare/workers-rs](https://github.com/cloudflare/workers-rs) topic:cloudflare,ffi,rust,serverless,webassembly,workers,workers-rs pushed_at:2025-01 star:2.7k fork:0.3k Write Cloudflare Workers in 100% Rust via WebAssembly
...
- [cloudflare/sciuro](https://github.com/cloudflare/sciuro) topic:alertmanager,kubernetes pushed_at:2025-01 star:0.2k fork:0.0k Alertmanager to Kubernetes Node conditions bridge
...
- [cloudflare/chanfana](https://github.com/cloudflare/chanfana) topic:api,cloudflare,cloudflare-workers,hono,honojs,openapi,openapi3,router,swagger,typescript,workers,workers-script pushed_at:2025-01 star:0.4k fork:0.0k OpenAPI 3 and 3.1 schema generator and validator for Hono, itty-router and more!
- [cloudflare/cloudflare-typescript](https://github.com/cloudflare/cloudflare-typescript) topic:api,cloudflare,sdk,sdk-typescript pushed_at:2025-01 star:0.3k fork:0.0k The official Typescript library for the Cloudflare API
...
- [cloudflare/next-on-pages](https://github.com/cloudflare/next-on-pages) topic:cloudflare-pages,nextjs pushed_at:2025-01 star:1.3k fork:0.1k CLI to build and develop Next.js apps for Cloudflare Pages
...
- [cloudflare/orange](https://github.com/cloudflare/orange) topic: pushed_at:2025-01 star:1.8k fork:0.3k 
...
- [cloudflare/privacypass-issuer](https://github.com/cloudflare/privacypass-issuer) topic:authentication,cryptography,privacy-pass,token,typescript pushed_at:2025-01 star:0.0k fork:0.0k A TypeScript Issuer for the Privacy Pass Authentication Protocol
...
- [cloudflare/serverless-registry](https://github.com/cloudflare/serverless-registry) topic:artifacts,cloudflare,container,container-registry,containers,docker,docker-registry,javascript,r2,registry,typescript,workers pushed_at:2025-01 star:1.1k fork:0.0k A container registry backed by Workers and R2.
...
- [cloudflare/templates](https://github.com/cloudflare/templates) topic: pushed_at:2025-01 star:1.0k fork:0.6k Templates for Cloudflare Workers
...
- [cloudflare/workers-ai-provider](https://github.com/cloudflare/workers-ai-provider) topic: pushed_at:2024-12 star:0.1k fork:0.0k A Workers AI provider for the vercel AI SDK
...
- [cloudflare/workers-graphql-server](https://github.com/cloudflare/workers-graphql-server) topic:apollo,cloudflare-workers,graphql,serverless pushed_at:2024-12 star:0.7k fork:0.6k 🔥Lightning-fast, globally distributed Apollo GraphQL server, deployed at the edge using Cloudflare Workers
...
- [cloudflare/workers-sdk](https://github.com/cloudflare/workers-sdk) topic:cli,cloudflare,cloudflare-workers,javascript,serverless,wasm pushed_at:2025-01 star:2.8k fork:0.8k ⛅️ Home to Wrangler, the CLI for Cloudflare Workers®
...
- [cloudflare/workflows-starter](https://github.com/cloudflare/workflows-starter) topic:cloudflare,durable-execution,workers,workflows pushed_at:2025-01 star:0.0k fork:0.0k A starter template for Cloudflare Workflows. 
