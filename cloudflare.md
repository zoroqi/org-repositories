...
- [cloudflare/astro-blog-starter-template-brayden](https://github.com/cloudflare/astro-blog-starter-template-brayden) topic: pushed_at:2025-12 star:0.0k fork:0.0k 
- [cloudflare/astro-blog-starter-template-brayden1](https://github.com/cloudflare/astro-blog-starter-template-brayden1) topic: pushed_at:2025-12 star:0.0k fork:0.0k 
...
- [cloudflare/cloudflare-workers-wasm-demo](https://github.com/cloudflare/cloudflare-workers-wasm-demo) topic: pushed_at:2024-09 star:0.2k fork:0.0k 
- [cloudflare/doom-wasm](https://github.com/cloudflare/doom-wasm) topic:doom,wasm,webassembly,websockets pushed_at:2024-09 star:0.4k fork:0.1k Chocolate Doom WebAssembly port with WebSockets support
...
- [cloudflare/udpgrm](https://github.com/cloudflare/udpgrm) topic: pushed_at:2026-03 star:0.1k fork:0.0k UDP Graceful Restart Marshal
- [cloudflare/zlib](https://github.com/cloudflare/zlib) topic: pushed_at:2026-02 star:0.7k fork:0.1k Cloudflare fork of zlib with massive performance improvements
...
- [cloudflare/stpyv8](https://github.com/cloudflare/stpyv8) topic: pushed_at:2026-01 star:0.5k fork:0.1k Python 3 and JavaScript interoperability. Successor To PyV8 (https://github.com/flier/pyv8)
- [cloudflare/workerd](https://github.com/cloudflare/workerd) topic: pushed_at:2026-04 star:8.1k fork:0.6k The JavaScript / Wasm runtime that powers Cloudflare Workers
- [cloudflare/workers-wasi](https://github.com/cloudflare/workers-wasi) topic: pushed_at:2024-09 star:0.2k fork:0.0k 
...
- [cloudflare/ahocorasick](https://github.com/cloudflare/ahocorasick) topic: pushed_at:2024-09 star:0.7k fork:0.1k A Golang implementation of the Aho-Corasick string matching algorithm
...
- [cloudflare/bbmp2kafka](https://github.com/cloudflare/bbmp2kafka) topic:bgp,bgp-monitor,bgp-monitoring-protocol,bmp pushed_at:2026-03 star:0.0k fork:0.0k BMP to Kafka processor
...
- [cloudflare/bn256](https://github.com/cloudflare/bn256) topic:bn256,cryptography,pairing pushed_at:2025-11 star:0.1k fork:0.0k Package bn256 implements a particular bilinear group.
...
- [cloudflare/cbpfc](https://github.com/cloudflare/cbpfc) topic: pushed_at:2026-02 star:0.2k fork:0.0k cBPF to C or eBPF compiler
...
- [cloudflare/cf-terraforming](https://github.com/cloudflare/cf-terraforming) topic:cloudflare,terraform pushed_at:2026-03 star:1.3k fork:0.2k A command line utility to facilitate terraforming your existing Cloudflare resources.
...
- [cloudflare/cfssl](https://github.com/cloudflare/cfssl) topic: pushed_at:2025-02 star:9.4k fork:1.1k CFSSL: Cloudflare's PKI and TLS toolkit
- [cloudflare/cfssl_trust](https://github.com/cloudflare/cfssl_trust) topic: pushed_at:2026-03 star:0.3k fork:0.1k CFSSL's CA trust store repository
...
- [cloudflare/cloudflared](https://github.com/cloudflare/cloudflared) topic:cloudflare,cloudflare-tunnel,reverse-proxy,zero-trust-network-access pushed_at:2026-04 star:13.9k fork:1.3k Cloudflare Tunnel client
...
- [cloudflare/fgbgp](https://github.com/cloudflare/fgbgp) topic: pushed_at:2024-09 star:0.1k fork:0.0k 
- [cloudflare/flow-pipeline](https://github.com/cloudflare/flow-pipeline) topic:clickhouse,cloudflare,docker,goflow,kafka,netflow,protobuf,sflow pushed_at:2025-12 star:0.2k fork:0.0k A set of tools and examples to run a flow-pipeline (sFlow, NetFlow)
...
- [cloudflare/go](https://github.com/cloudflare/go) topic:delegated-credentials,ech,go,kyber,post-quantum pushed_at:2025-05 star:0.4k fork:0.1k Go with Cloudflare experimental patches
...
- [cloudflare/gokey](https://github.com/cloudflare/gokey) topic:deterministic,ecc,ed25519,key-generator,keychain,password-generator,password-manager,password-store,password-vault,rsa-key,seed,stateless pushed_at:2026-03 star:2.4k fork:0.1k A simple vaultless password manager in Go
...
- [cloudflare/golibs](https://github.com/cloudflare/golibs) topic: pushed_at:2024-09 star:0.4k fork:0.0k Various small golang libraries
...
- [cloudflare/ipvs](https://github.com/cloudflare/ipvs) topic: pushed_at:2026-02 star:0.2k fork:0.0k Package ipvs allows you to manage Linux IPVS services and destinations
...
- [cloudflare/octopus](https://github.com/cloudflare/octopus) topic:hacktoberfest pushed_at:2025-11 star:0.0k fork:0.0k The Octopus is part of our network automation pipeline. Its job is to aggregate data from different authoritative data sources into one Enriched Topology to provide a full picture to downstream systems.
...
- [cloudflare/origin-ca-issuer](https://github.com/cloudflare/origin-ca-issuer) topic:cert-manager pushed_at:2026-03 star:0.3k fork:0.1k cert-manager issuer for Origin CA
...
- [cloudflare/parquet-tsdb-poc](https://github.com/cloudflare/parquet-tsdb-poc) topic: pushed_at:2025-11 star:0.0k fork:0.0k A POC for a tsdb storage using parquet
- [cloudflare/pat-app](https://github.com/cloudflare/pat-app) topic: pushed_at:2026-02 star:0.0k fork:0.0k 
...
- [cloudflare/privacy-gateway-server-go](https://github.com/cloudflare/privacy-gateway-server-go) topic: pushed_at:2026-02 star:0.1k fork:0.0k An Oblivious HTTP gateway
...
- [cloudflare/proxy-everything](https://github.com/cloudflare/proxy-everything) topic: pushed_at:2026-03 star:0.0k fork:0.0k 
...
- [cloudflare/terraform-provider-cloudflare](https://github.com/cloudflare/terraform-provider-cloudflare) topic:cloudflare,terraform,terraform-provider pushed_at:2026-04 star:1.2k fork:0.8k Cloudflare Terraform Provider
- [cloudflare/tf-migrate](https://github.com/cloudflare/tf-migrate) topic: pushed_at:2026-04 star:0.0k fork:0.0k CLI tool for upgrading the terraform-provider-cloudflare to a new major version
...
- [cloudflare/tusd](https://github.com/cloudflare/tusd) topic: pushed_at:2026-01 star:0.0k fork:0.0k The official server implementation of the tus resumable upload protocol.
...
- [cloudflare/xdpcap](https://github.com/cloudflare/xdpcap) topic: pushed_at:2024-09 star:0.8k fork:0.1k tcpdump like XDP packet capture
...
- [cloudflare/cfweb3](https://github.com/cloudflare/cfweb3) topic: pushed_at:2024-09 star:0.3k fork:0.0k 
...
- [cloudflare/cloudflare-gcp](https://github.com/cloudflare/cloudflare-gcp) topic: pushed_at:2026-02 star:0.1k fork:0.1k Google Cloud Function to push json files from GC Storage to Big Query
...
- [cloudflare/fyz](https://github.com/cloudflare/fyz) topic: pushed_at:2025-12 star:0.0k fork:0.0k 
...
- [cloudflare/llm-chat-app-template](https://github.com/cloudflare/llm-chat-app-template) topic: pushed_at:2025-12 star:0.0k fork:0.0k 
- [cloudflare/llm-chat-app-template-brayden](https://github.com/cloudflare/llm-chat-app-template-brayden) topic: pushed_at:2025-12 star:0.0k fork:0.0k 
...
- [cloudflare/worker-sentry](https://github.com/cloudflare/worker-sentry) topic: pushed_at:2025-04 star:0.1k fork:0.0k Sentry over Access for Worker
...
- [cloudflare/workers-chat-demo](https://github.com/cloudflare/workers-chat-demo) topic: pushed_at:2025-07 star:1.1k fork:0.2k 
...
- [cloudflare/cloudflare-docs](https://github.com/cloudflare/cloudflare-docs) topic:cloudflare,docs,hacktoberfest,markdown,mdx pushed_at:2026-04 star:4.6k fork:13.5k Cloudflare’s documentation
...
- [cloudflare/agent-skills-discovery-rfc](https://github.com/cloudflare/agent-skills-discovery-rfc) topic:agent-skills,agents,rfc8615,skills pushed_at:2026-03 star:0.2k fork:0.0k A mechanism for discovering Agent Skills using the .well-known URI path prefix as specified in RFC 8615 for discovering Agent Skills.
- [cloudflare/api-schemas](https://github.com/cloudflare/api-schemas) topic: pushed_at:2026-04 star:0.2k fork:0.1k 
- [cloudflare/arcnact](https://github.com/cloudflare/arcnact) topic:anonymous-credentials,crypto,cryptography,privacy pushed_at:2026-02 star:0.0k fork:0.0k ARC & ACT Anonymous Credentials
...
- [cloudflare/linux](https://github.com/cloudflare/linux) topic: pushed_at:2025-09 star:0.1k fork:0.0k Cloudflare Linux Kernel Patches
...
- [cloudflare/skills](https://github.com/cloudflare/skills) topic:agents,cloudflare,skills,workers pushed_at:2026-04 star:0.9k fork:0.1k Skills for teaching agents how to build on Cloudflare.
...
- [cloudflare/cloudflare-php](https://github.com/cloudflare/cloudflare-php) topic: pushed_at:2024-12 star:0.7k fork:0.3k PHP library for the Cloudflare v4 API
...
- [cloudflare/Cloudflare-WordPress](https://github.com/cloudflare/Cloudflare-WordPress) topic: pushed_at:2026-03 star:0.2k fork:0.1k A Cloudflare plugin for WordPress
...
- [cloudflare/bbperf](https://github.com/cloudflare/bbperf) topic: pushed_at:2026-03 star:0.0k fork:0.0k bbperf
...
- [cloudflare/filterforge](https://github.com/cloudflare/filterforge) topic: pushed_at:2026-03 star:0.1k fork:0.0k Tool for solving BPF filters and crafting packets based on these.
- [cloudflare/flan](https://github.com/cloudflare/flan) topic: pushed_at:2024-09 star:4.2k fork:0.3k A pretty sweet vulnerability scanner
...
- [cloudflare/notebook-examples](https://github.com/cloudflare/notebook-examples) topic:cloudflare,cloudflare-api,notebooks,python pushed_at:2026-01 star:0.0k fork:0.0k These examples demonstrate how to use the Cloudflare API within interactive Python notebooks.
...
- [cloudflare/pyodide-build-scripts](https://github.com/cloudflare/pyodide-build-scripts) topic: pushed_at:2026-03 star:0.0k fork:0.0k Automated build processes for Cloudflare Workers Pyodide distribution
...
- [cloudflare/homebrew-cloudflare](https://github.com/cloudflare/homebrew-cloudflare) topic: pushed_at:2026-03 star:0.1k fork:0.0k 
...
- [cloudflare/boring](https://github.com/cloudflare/boring) topic: pushed_at:2026-04 star:0.5k fork:0.2k BoringSSL bindings for the Rust programming language.
- [cloudflare/boringtun](https://github.com/cloudflare/boringtun) topic:cloudflare,rust,wireguard pushed_at:2026-03 star:7.0k fork:0.5k Userspace WireGuard® Implementation in Rust
- [cloudflare/cardinality-estimator](https://github.com/cloudflare/cardinality-estimator) topic:cardinality-estimation,distinct-elements,hyperloglog,probalistic-data-structures,sketches pushed_at:2026-02 star:0.0k fork:0.0k A crate for estimating the cardinality of distinct elements in a stream or dataset.
...
- [cloudflare/chaussette](https://github.com/cloudflare/chaussette) topic: pushed_at:2026-01 star:0.0k fork:0.0k 
...
- [cloudflare/cloudflare-rs](https://github.com/cloudflare/cloudflare-rs) topic:api-client,cloudflare,rust pushed_at:2025-08 star:0.3k fork:0.1k Rust library for the Cloudflare v4 API
...
- [cloudflare/freighter](https://github.com/cloudflare/freighter) topic: pushed_at:2026-03 star:0.1k fork:0.0k A fast, modular, and operationally boring Rust private registry implementation.
...
- [cloudflare/networkquality-rs](https://github.com/cloudflare/networkquality-rs) topic: pushed_at:2026-03 star:0.1k fork:0.0k 
...
- [cloudflare/pingora](https://github.com/cloudflare/pingora) topic: pushed_at:2026-04 star:26.4k fork:1.6k A library for building fast, reliable and evolvable network services.
...
- [cloudflare/privacy-gateway-client-library](https://github.com/cloudflare/privacy-gateway-client-library) topic: pushed_at:2026-02 star:0.0k fork:0.0k 
...
- [cloudflare/recapn](https://github.com/cloudflare/recapn) topic: pushed_at:2026-03 star:0.1k fork:0.0k A WIP Cap'n Proto implementation in Rust written from the ground up
- [cloudflare/rust-binary-install](https://github.com/cloudflare/rust-binary-install) topic: pushed_at:2026-03 star:0.0k fork:0.0k 
...
- [cloudflare/saffron](https://github.com/cloudflare/saffron) topic:cloudflare-workers,cron,rust pushed_at:2025-12 star:0.2k fork:0.0k The cron parser powering Cron Triggers on Cloudflare Workers
- [cloudflare/shellflip](https://github.com/cloudflare/shellflip) topic:graceful-shutdown,process,restart,rust,server,systemd pushed_at:2025-03 star:0.5k fork:0.0k Graceful process restarts in Rust
- [cloudflare/sliceslice-rs](https://github.com/cloudflare/sliceslice-rs) topic:avx2,search-in-text,simd,simd-instructions,simd-programming,substring-search,text-processing pushed_at:2025-11 star:0.1k fork:0.0k A fast implementation of single-pattern substring search using SIMD acceleration.
...
- [cloudflare/svg-hush](https://github.com/cloudflare/svg-hush) topic:sanitizer,security,svg,xss-filter pushed_at:2026-02 star:0.4k fork:0.0k Make it safe to serve untrusted SVG files
...
- [cloudflare/trie-hard](https://github.com/cloudflare/trie-hard) topic: pushed_at:2026-03 star:0.6k fork:0.0k Novel implementation of a Trie data structure optimized for small, sparse maps
- [cloudflare/wasm-coredump](https://github.com/cloudflare/wasm-coredump) topic:cloudflare-workers,rust,wasm,webassembly pushed_at:2026-02 star:0.0k fork:0.0k Cloudflare Workers Wasm Coredump Service
- [cloudflare/web-bot-auth](https://github.com/cloudflare/web-bot-auth) topic:agents,cryptography pushed_at:2026-03 star:0.1k fork:0.0k Sign and verify orchestrated HTTP requests
...
- [cloudflare/workers-rs](https://github.com/cloudflare/workers-rs) topic:cloudflare,ffi,rust,serverless,webassembly,workers,workers-rs pushed_at:2026-04 star:3.4k fork:0.4k Write Cloudflare Workers in 100% Rust via WebAssembly
- [cloudflare/workers-wonnx](https://github.com/cloudflare/workers-wonnx) topic: pushed_at:2026-02 star:0.1k fork:0.0k 
...
- [cloudflare/agentic-inbox](https://github.com/cloudflare/agentic-inbox) topic: pushed_at:2026-04 star:0.3k fork:0.0k A self-hosted email client with an AI agent, running entirely on Cloudflare Workers
- [cloudflare/agents](https://github.com/cloudflare/agents) topic:agents,ai,cloudflare,durable-objects,workflows pushed_at:2026-04 star:4.8k fork:0.5k Build and deploy AI Agents on Cloudflare 
- [cloudflare/agents-starter](https://github.com/cloudflare/agents-starter) topic:agents,ai,cloudflare,durable-objects pushed_at:2026-04 star:1.2k fork:0.2k A starter kit for building ai agents on Cloudflare
...
- [cloudflare/awesome-agents](https://github.com/cloudflare/awesome-agents) topic: pushed_at:2025-12 star:0.2k fork:0.0k Awesome Agents
...
- [cloudflare/capnweb](https://github.com/cloudflare/capnweb) topic: pushed_at:2026-03 star:3.8k fork:0.1k JavaScript/TypeScript-native, low-boilerplate, object-capability RPC system
- [cloudflare/cf-sealion-api](https://github.com/cloudflare/cf-sealion-api) topic: pushed_at:2026-01 star:0.0k fork:0.0k 
- [cloudflare/cf-sealion-demo](https://github.com/cloudflare/cf-sealion-demo) topic: pushed_at:2026-01 star:0.0k fork:0.0k 
- [cloudflare/chanfana](https://github.com/cloudflare/chanfana) topic:api,cloudflare,cloudflare-workers,hono,honojs,openapi,openapi3,router,swagger,typescript,workers,workers-script pushed_at:2026-03 star:0.7k fork:0.1k OpenAPI 3 and 3.1 schema generator and validator for Hono, itty-router and more!
- [cloudflare/chanfana-openapi-template-11](https://github.com/cloudflare/chanfana-openapi-template-11) topic: pushed_at:2025-10 star:0.0k fork:0.0k 
- [cloudflare/cloudflare-prometheus-exporter](https://github.com/cloudflare/cloudflare-prometheus-exporter) topic: pushed_at:2026-04 star:0.1k fork:0.0k Export Cloudflare metrics to Prometheus. Built on Cloudflare Workers with Durable Objects for stateful metric accumulation.
...
- [cloudflare/containers-demos](https://github.com/cloudflare/containers-demos) topic: pushed_at:2026-03 star:0.2k fork:0.0k 
- [cloudflare/d1-northwind](https://github.com/cloudflare/d1-northwind) topic:cloudflare-workers,d1 pushed_at:2026-01 star:0.2k fork:0.0k Northwind Traders D1 Demo
- [cloudflare/d1-template-123](https://github.com/cloudflare/d1-template-123) topic: pushed_at:2025-10 star:0.0k fork:0.0k 
- [cloudflare/d1-template-12344](https://github.com/cloudflare/d1-template-12344) topic: pushed_at:2025-10 star:0.0k fork:0.0k 
- [cloudflare/d1-template-333](https://github.com/cloudflare/d1-template-333) topic: pushed_at:2025-09 star:0.0k fork:0.0k 
- [cloudflare/d1-template-666](https://github.com/cloudflare/d1-template-666) topic: pushed_at:2025-09 star:0.0k fork:0.0k 
- [cloudflare/d1-template-777](https://github.com/cloudflare/d1-template-777) topic: pushed_at:2025-09 star:0.0k fork:0.0k 
- [cloudflare/d1-template-888](https://github.com/cloudflare/d1-template-888) topic: pushed_at:2025-09 star:0.0k fork:0.0k 
...
- [cloudflare/dmarc-email-worker](https://github.com/cloudflare/dmarc-email-worker) topic:cloudflare,dmarc,workers pushed_at:2024-10 star:0.2k fork:0.0k DMARC reports processor using Cloudflare Workers and Email Workers
- [cloudflare/docs-examples](https://github.com/cloudflare/docs-examples) topic: pushed_at:2026-02 star:0.0k fork:0.0k Examples surfaced in the Cloudflare Docs
- [cloudflare/dog](https://github.com/cloudflare/dog) topic: pushed_at:2025-04 star:0.3k fork:0.0k Durable Object Groups
- [cloudflare/durable-chat-template](https://github.com/cloudflare/durable-chat-template) topic: pushed_at:2025-12 star:0.0k fork:0.0k 
...
- [cloudflare/har-sanitizer](https://github.com/cloudflare/har-sanitizer) topic: pushed_at:2026-01 star:0.2k fork:0.0k 
...
- [cloudflare/kubernetes-access-worker-example](https://github.com/cloudflare/kubernetes-access-worker-example) topic: pushed_at:2026-01 star:0.0k fork:0.0k Example implementation of an Access-protected private Kubernetes API
- [cloudflare/kumo](https://github.com/cloudflare/kumo) topic: pushed_at:2026-04 star:1.0k fork:0.1k Cloudflare's component library for building modern web applications.
...
- [cloudflare/managed-component-to-cloudflare-worker](https://github.com/cloudflare/managed-component-to-cloudflare-worker) topic:cloudflare,cloudflare-workers,managed-components,workers,zaraz pushed_at:2025-08 star:0.0k fork:0.0k Deploy Managed Components as Cloudflare Workers and use them in Cloudflare Zaraz
- [cloudflare/matched-data-worker](https://github.com/cloudflare/matched-data-worker) topic: pushed_at:2025-11 star:0.0k fork:0.0k 
- [cloudflare/mcp](https://github.com/cloudflare/mcp) topic:cloudflare,cloudflare-workers,mcp,mcp-server pushed_at:2026-04 star:0.3k fork:0.0k MCP server for the Cloudflare API
- [cloudflare/mcp-server-cloudflare](https://github.com/cloudflare/mcp-server-cloudflare) topic: pushed_at:2026-03 star:3.6k fork:0.4k 
- [cloudflare/meet](https://github.com/cloudflare/meet) topic: pushed_at:2026-03 star:2.3k fork:0.4k 
...
- [cloudflare/moltworker](https://github.com/cloudflare/moltworker) topic:ai-agents,cloudflare-workers pushed_at:2026-04 star:9.8k fork:1.8k Run OpenClaw, (formerly Moltbot, formerly Clawdbot) on Cloudflare Workers
...
- [cloudflare/opaque-ts](https://github.com/cloudflare/opaque-ts) topic:crypto,cryptography,opaque,pake,password pushed_at:2026-03 star:0.1k fork:0.0k A TypeScript library for OPAQUE Asymmetric Password-Authenticated Key Exchange Protocol
- [cloudflare/openai-workers-relay](https://github.com/cloudflare/openai-workers-relay) topic: pushed_at:2024-11 star:0.2k fork:0.0k A relay server for OpenAI's realtime API, for Cloudflare Workers
- [cloudflare/openauth-template-24](https://github.com/cloudflare/openauth-template-24) topic: pushed_at:2025-09 star:0.0k fork:0.0k 
...
- [cloudflare/partykit](https://github.com/cloudflare/partykit) topic:agents,ai,collaboration,durable-objects,real-time pushed_at:2026-03 star:1.1k fork:0.1k PartyKit, for Workers
...
- [cloudflare/playwright-mcp](https://github.com/cloudflare/playwright-mcp) topic:browser-rendering,mcp,playwright pushed_at:2026-02 star:0.2k fork:0.0k Playwright MCP fork that works with Cloudflare Browser Rendering
...
- [cloudflare/privacypass-config](https://github.com/cloudflare/privacypass-config) topic:authentication,cli,cryptography,privacy-pass,token,typescript pushed_at:2026-03 star:0.0k fork:0.0k Development and deployment CLI for Cloudflare Privacy Pass implementation
...
- [cloudflare/production-saas](https://github.com/cloudflare/production-saas) topic: pushed_at:2024-09 star:1.2k fork:0.1k (WIP) Example SaaS application built in public on the Cloudflare stack!
...
- [cloudflare/r2-explorer-template-9](https://github.com/cloudflare/r2-explorer-template-9) topic: pushed_at:2025-09 star:0.0k fork:0.0k 
- [cloudflare/r2-explorer-template123](https://github.com/cloudflare/r2-explorer-template123) topic: pushed_at:2025-09 star:0.0k fork:0.0k 
- [cloudflare/react-router-hono-fullstack-template](https://github.com/cloudflare/react-router-hono-fullstack-template) topic: pushed_at:2025-10 star:0.0k fork:0.0k 
- [cloudflare/realtime-examples](https://github.com/cloudflare/realtime-examples) topic: pushed_at:2025-11 star:0.1k fork:0.0k 
- [cloudflare/realtimekit-ui](https://github.com/cloudflare/realtimekit-ui) topic: pushed_at:2026-04 star:0.0k fork:0.0k RealtimeKit UI provides pre-built, ready-to-use UI components for integrating with Cloudflare RealtimeKit
- [cloudflare/realtimekit-ui-addons](https://github.com/cloudflare/realtimekit-ui-addons) topic: pushed_at:2026-03 star:0.0k fork:0.0k 
...
- [cloudflare/serverless-registry](https://github.com/cloudflare/serverless-registry) topic:artifacts,cloudflare,container,container-registry,containers,docker,docker-registry,javascript,r2,registry,typescript,workers pushed_at:2026-02 star:1.4k fork:0.1k A container registry backed by Workers and R2.
...
- [cloudflare/templates](https://github.com/cloudflare/templates) topic: pushed_at:2026-03 star:1.9k fork:1.0k Templates for Cloudflare Workers
- [cloudflare/to-do-list-kv-template-100](https://github.com/cloudflare/to-do-list-kv-template-100) topic: pushed_at:2025-10 star:0.0k fork:0.0k 
- [cloudflare/to-do-list-kv-template-123](https://github.com/cloudflare/to-do-list-kv-template-123) topic: pushed_at:2025-10 star:0.0k fork:0.0k 
- [cloudflare/to-do-list-kv-template99](https://github.com/cloudflare/to-do-list-kv-template99) topic: pushed_at:2025-10 star:0.0k fork:0.0k 
...
- [cloudflare/turnstile-firebase-app-check-provider](https://github.com/cloudflare/turnstile-firebase-app-check-provider) topic: pushed_at:2026-02 star:0.0k fork:0.0k 
- [cloudflare/vibesdk](https://github.com/cloudflare/vibesdk) topic:ai,cloudflare-workers,coding-agent,durable-objects,text-to-app,vibe-coding pushed_at:2026-04 star:4.9k fork:1.2k An open-source vibe coding platform that helps you build your own vibe-coding platform, built entirely on Cloudflare stack 
...
- [cloudflare/vinext](https://github.com/cloudflare/vinext) topic: pushed_at:2026-04 star:7.8k fork:0.3k Vite plugin that reimplements the Next.js API surface — deploy anywhere
...
- [cloudflare/vite-react-template-bray](https://github.com/cloudflare/vite-react-template-bray) topic: pushed_at:2025-12 star:0.0k fork:0.0k 
- [cloudflare/vite-react-template-brayden](https://github.com/cloudflare/vite-react-template-brayden) topic: pushed_at:2025-12 star:0.0k fork:0.0k 
...
- [cloudflare/webcm](https://github.com/cloudflare/webcm) topic:managed-components pushed_at:2025-12 star:0.1k fork:0.0k 🧩 Components Manager for the Web. Free, open-source, and fast!
...
- [cloudflare/workers-for-platforms-example](https://github.com/cloudflare/workers-for-platforms-example) topic: pushed_at:2025-09 star:0.4k fork:0.2k A great place for platforms to get started on Cloudflare Workers!
- [cloudflare/workers-graphql-server](https://github.com/cloudflare/workers-graphql-server) topic:apollo,cloudflare-workers,graphql,serverless pushed_at:2024-12 star:0.8k fork:0.6k 🔥Lightning-fast, globally distributed Apollo GraphQL server, deployed at the edge using Cloudflare Workers
...
- [cloudflare/workers-mcp](https://github.com/cloudflare/workers-mcp) topic: pushed_at:2025-04 star:0.6k fork:0.1k Talk to a Cloudflare Worker from Claude Desktop!
...
- [cloudflare/workers-sdk](https://github.com/cloudflare/workers-sdk) topic:cli,cloudflare,cloudflare-workers,javascript,serverless,wasm pushed_at:2026-04 star:4.0k fork:1.2k ⛅️ Home to Wrangler, the CLI for Cloudflare Workers®
...
- [cloudflare/workflows-starter](https://github.com/cloudflare/workflows-starter) topic:cloudflare,durable-execution,workers,workflows pushed_at:2025-09 star:0.0k fork:0.0k A starter template for Cloudflare Workflows. 
