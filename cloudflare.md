...
- [cloudflare/stpyv8](https://github.com/cloudflare/stpyv8) topic: pushed_at:2025-12 star:0.5k fork:0.1k Python 3 and JavaScript interoperability. Successor To PyV8 (https://github.com/flier/pyv8)
...
- [cloudflare/workerd-tools](https://github.com/cloudflare/workerd-tools) topic: pushed_at:2025-12 star:0.0k fork:0.0k Prebuilt tools and utilities required for ongoing development in the workerd repo.
...
- [cloudflare/cf-terraforming](https://github.com/cloudflare/cf-terraforming) topic:cloudflare,terraform pushed_at:2025-12 star:1.3k fork:0.2k A command line utility to facilitate terraforming your existing Cloudflare resources.
...
- [cloudflare/cfssl_trust](https://github.com/cloudflare/cfssl_trust) topic: pushed_at:2025-12 star:0.3k fork:0.1k CFSSL's CA trust store repository
- [cloudflare/circl](https://github.com/cloudflare/circl) topic:circl,cryptography,csidh,dilithium,ed25519,ed448,elliptic-curves,go,golang,hpke,kyber,pki,post-quantum,sidh pushed_at:2025-12 star:1.6k fork:0.2k CIRCL: Cloudflare Interoperable Reusable Cryptographic Library
...
- [cloudflare/cloudflare-go](https://github.com/cloudflare/cloudflare-go) topic:api,cloudflare,sdk,sdk-go,sdk-golang pushed_at:2025-12 star:1.9k fork:0.7k The official Go library for the Cloudflare API
...
- [cloudflare/cloudflared](https://github.com/cloudflare/cloudflared) topic:cloudflare,cloudflare-tunnel,reverse-proxy,zero-trust-network-access pushed_at:2025-11 star:12.5k fork:1.1k Cloudflare Tunnel client
...
- [cloudflare/ebpf_exporter](https://github.com/cloudflare/ebpf_exporter) topic:bpf,ebpf,libbpf,linux-kernel,performance,prometheus,prometheus-exporter,tracing pushed_at:2025-12 star:2.5k fork:0.3k Prometheus exporter for custom eBPF metrics
...
- [cloudflare/pint](https://github.com/cloudflare/pint) topic:linter,metrics,observability,prometheus,validator pushed_at:2025-12 star:1.0k fork:0.1k Prometheus rule linter/validator
...
- [cloudflare/terraform-provider-cloudflare](https://github.com/cloudflare/terraform-provider-cloudflare) topic:cloudflare,terraform,terraform-provider pushed_at:2025-12 star:1.2k fork:0.8k Cloudflare Terraform Provider
- [cloudflare/tf-migrate](https://github.com/cloudflare/tf-migrate) topic: pushed_at:2025-12 star:0.0k fork:0.0k CLI tool for upgrading the terraform-provider-cloudflare to a new major version
...
- [cloudflare/telescope](https://github.com/cloudflare/telescope) topic: pushed_at:2025-12 star:0.2k fork:0.0k Cross-browser web performance testing agent
...
- [cloudflare/workers-nodejs-compat-matrix](https://github.com/cloudflare/workers-nodejs-compat-matrix) topic: pushed_at:2025-09 star:0.0k fork:0.0k https://workers-nodejs-compat-matrix.pages.dev
...
- [cloudflare/workers.cloudflare.com](https://github.com/cloudflare/workers.cloudflare.com) topic: pushed_at:2025-12 star:0.2k fork:0.0k The Cloudflare Workers website.
...
- [cloudflare/research.cloudflare.com](https://github.com/cloudflare/research.cloudflare.com) topic: pushed_at:2025-11 star:0.0k fork:0.0k 
...
- [cloudflare/api-schemas](https://github.com/cloudflare/api-schemas) topic: pushed_at:2025-12 star:0.1k fork:0.1k 
...
- [cloudflare/skills](https://github.com/cloudflare/skills) topic: pushed_at:2025-12 star:0.0k fork:0.0k 
...
- [cloudflare/bbperf](https://github.com/cloudflare/bbperf) topic: pushed_at:2025-11 star:0.0k fork:0.0k bbperf
...
- [cloudflare/cloudflare-python](https://github.com/cloudflare/cloudflare-python) topic:api,cloudflare,sdk,sdk-python pushed_at:2025-12 star:0.4k fork:0.1k The official Python library for the Cloudflare API
...
- [cloudflare/langchain-cloudflare](https://github.com/cloudflare/langchain-cloudflare) topic: pushed_at:2025-12 star:0.0k fork:0.0k LangChain integrations for Cloudflare
...
- [cloudflare/python-workers-examples](https://github.com/cloudflare/python-workers-examples) topic: pushed_at:2025-12 star:0.2k fork:0.1k 
...
- [cloudflare/workers-py](https://github.com/cloudflare/workers-py) topic: pushed_at:2025-11 star:0.0k fork:0.0k Write Cloudflare Workers in 100% Python via Pyodide.
...
- [cloudflare/azul](https://github.com/cloudflare/azul) topic:certificate-transparency,certificate-transparency-logs,cryptography,merkle-tree,pki,web pushed_at:2025-12 star:0.0k fork:0.0k An implementation of a static-ct-api certificate transparency log for deployment on Cloudflare Workers
- [cloudflare/boring](https://github.com/cloudflare/boring) topic: pushed_at:2025-12 star:0.5k fork:0.1k BoringSSL bindings for the Rust programming language.
- [cloudflare/boringtun](https://github.com/cloudflare/boringtun) topic:cloudflare,rust,wireguard pushed_at:2025-11 star:6.8k fork:0.5k Userspace WireGuard® Implementation in Rust
...
- [cloudflare/chaussette](https://github.com/cloudflare/chaussette) topic: pushed_at:2025-08 star:0.0k fork:0.0k 
...
- [cloudflare/foundations](https://github.com/cloudflare/foundations) topic: pushed_at:2025-12 star:1.5k fork:0.1k Cloudflare's Rust service foundations library.
- [cloudflare/freighter](https://github.com/cloudflare/freighter) topic: pushed_at:2025-09 star:0.1k fork:0.0k A fast, modular, and operationally boring Rust private registry implementation.
...
- [cloudflare/lol-html](https://github.com/cloudflare/lol-html) topic:css-selectors,html,parser,rewriting,rust,stream,streaming pushed_at:2025-10 star:1.9k fork:0.1k Low output latency streaming HTML parser/rewriter with CSS selector-based API
...
- [cloudflare/pingora](https://github.com/cloudflare/pingora) topic: pushed_at:2025-12 star:25.8k fork:1.5k A library for building fast, reliable and evolvable network services.
...
- [cloudflare/quiche](https://github.com/cloudflare/quiche) topic:http3,network-programming,protocol,quic,rust pushed_at:2025-12 star:11.1k fork:0.9k 🥧 Savoury implementation of the QUIC transport protocol and HTTP/3
...
- [cloudflare/web-bot-auth](https://github.com/cloudflare/web-bot-auth) topic:agents,cryptography pushed_at:2025-12 star:0.1k fork:0.0k Sign and verify orchestrated HTTP requests
...
- [cloudflare/wirefilter](https://github.com/cloudflare/wirefilter) topic:compiler,engine,filters,firewall,firewall-configuration,firewall-rules,rust,wireshark pushed_at:2025-12 star:1.1k fork:0.1k An execution engine for Wireshark-like filters
- [cloudflare/workerd-cxx](https://github.com/cloudflare/workerd-cxx) topic: pushed_at:2025-12 star:0.0k fork:0.0k workerd-cxx is a fork of cxx crate for workerd/edgeworker project
- [cloudflare/workers-rs](https://github.com/cloudflare/workers-rs) topic:cloudflare,ffi,rust,serverless,webassembly,workers,workers-rs pushed_at:2025-12 star:3.3k fork:0.4k Write Cloudflare Workers in 100% Rust via WebAssembly
...
- [cloudflare/actors](https://github.com/cloudflare/actors) topic:actors,cloudflare,durable-objects,sqlite pushed_at:2025-12 star:0.3k fork:0.0k An easier way to build with Cloudflare Durable Objects
- [cloudflare/agents](https://github.com/cloudflare/agents) topic:agents,ai,cloudflare,durable-objects,workflows pushed_at:2025-12 star:3.0k fork:0.3k Build and deploy AI Agents on Cloudflare 
...
- [cloudflare/ai](https://github.com/cloudflare/ai) topic: pushed_at:2025-12 star:0.9k fork:0.2k 
...
- [cloudflare/capnweb](https://github.com/cloudflare/capnweb) topic: pushed_at:2025-12 star:3.6k fork:0.1k JavaScript/TypeScript-native, low-boilerplate, object-capability RPC system
- [cloudflare/chanfana](https://github.com/cloudflare/chanfana) topic:api,cloudflare,cloudflare-workers,hono,honojs,openapi,openapi3,router,swagger,typescript,workers,workers-script pushed_at:2025-11 star:0.7k fork:0.1k OpenAPI 3 and 3.1 schema generator and validator for Hono, itty-router and more!
...
- [cloudflare/cloudflare-prometheus-exporter](https://github.com/cloudflare/cloudflare-prometheus-exporter) topic: pushed_at:2025-12 star:0.1k fork:0.0k Export Cloudflare metrics to Prometheus. Built on Cloudflare Workers with Durable Objects for stateful metric accumulation.
- [cloudflare/cloudflare-typescript](https://github.com/cloudflare/cloudflare-typescript) topic:api,cloudflare,sdk,sdk-typescript pushed_at:2025-12 star:0.6k fork:0.1k The official Typescript library for the Cloudflare API
- [cloudflare/containers](https://github.com/cloudflare/containers) topic:cloudflare,containers,durable-objects pushed_at:2025-12 star:0.2k fork:0.0k Enhance your Workers with serverless containers
- [cloudflare/containers-demos](https://github.com/cloudflare/containers-demos) topic: pushed_at:2025-07 star:0.2k fork:0.0k 
- [cloudflare/d1-northwind](https://github.com/cloudflare/d1-northwind) topic:cloudflare-workers,d1 pushed_at:2025-11 star:0.1k fork:0.0k Northwind Traders D1 Demo
...
- [cloudflare/mcp-server-cloudflare](https://github.com/cloudflare/mcp-server-cloudflare) topic: pushed_at:2025-12 star:3.2k fork:0.3k 
...
- [cloudflare/partykit](https://github.com/cloudflare/partykit) topic:agents,ai,collaboration,durable-objects,real-time pushed_at:2025-12 star:0.9k fork:0.1k PartyKit, for Workers
...
- [cloudflare/playwright](https://github.com/cloudflare/playwright) topic: pushed_at:2025-12 star:0.1k fork:0.0k Playwright fork that works with Cloudflare Browser Rendering
- [cloudflare/playwright-mcp](https://github.com/cloudflare/playwright-mcp) topic:browser-rendering,mcp,playwright pushed_at:2025-12 star:0.2k fork:0.0k Playwright MCP fork that works with Cloudflare Browser Rendering
...
- [cloudflare/privacypass-issuer](https://github.com/cloudflare/privacypass-issuer) topic:authentication,cryptography,privacy-pass,token,typescript pushed_at:2025-12 star:0.0k fork:0.0k A TypeScript Issuer for the Privacy Pass Authentication Protocol
...
- [cloudflare/puppeteer](https://github.com/cloudflare/puppeteer) topic:cloudflare,workers pushed_at:2025-12 star:0.3k fork:0.0k Puppeteer Core fork that works with Cloudflare Browser Workers
...
- [cloudflare/realtimekit-ui](https://github.com/cloudflare/realtimekit-ui) topic: pushed_at:2025-12 star:0.0k fork:0.0k RealtimeKit UI provides pre-built, ready-to-use UI components for integrating with Cloudflare RealtimeKit
- [cloudflare/realtimekit-web-examples](https://github.com/cloudflare/realtimekit-web-examples) topic:cloudflare,realtime,webrtc pushed_at:2025-11 star:0.0k fork:0.0k Web examples for Cloudflare RealtimeKit :rocket:
- [cloudflare/sandbox-sdk](https://github.com/cloudflare/sandbox-sdk) topic:agent,agents,ai,code-interpreter,containers,devtools,sandbox pushed_at:2025-12 star:0.7k fork:0.0k Run sandboxed code environments on Cloudflare's edge network
...
- [cloudflare/templates](https://github.com/cloudflare/templates) topic: pushed_at:2025-12 star:1.7k fork:0.9k Templates for Cloudflare Workers
...
- [cloudflare/vibesdk](https://github.com/cloudflare/vibesdk) topic:ai,cloudflare-workers,coding-agent,durable-objects,text-to-app,vibe-coding pushed_at:2025-12 star:4.5k fork:1.0k An open-source vibe coding platform that helps you build your own vibe-coding platform, built entirely on Cloudflare stack 
...
- [cloudflare/workers-oauth-provider](https://github.com/cloudflare/workers-oauth-provider) topic: pushed_at:2025-12 star:1.7k fork:0.1k OAuth provider library for Cloudflare Workers
- [cloudflare/workers-sdk](https://github.com/cloudflare/workers-sdk) topic:cli,cloudflare,cloudflare-workers,javascript,serverless,wasm pushed_at:2025-12 star:3.7k fork:1.1k ⛅️ Home to Wrangler, the CLI for Cloudflare Workers®
...
- [cloudflare/zkp-ecdsa](https://github.com/cloudflare/zkp-ecdsa) topic:crypto,cryptography,ecdsa,zero-knowledge,zkattest pushed_at:2025-11 star:0.2k fork:0.0k Proves knowledge of an ECDSA-P256 signature under one of many public keys that are stored in a list.
