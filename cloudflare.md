...
- [cloudflare/cloudflare-blog](https://github.com/cloudflare/cloudflare-blog) topic: pushed_at:2026-01 star:1.2k fork:0.3k Cloudflare Blog code samples
...
- [cloudflare/workerd](https://github.com/cloudflare/workerd) topic: pushed_at:2026-02 star:7.5k fork:0.5k The JavaScript / Wasm runtime that powers Cloudflare Workers
- [cloudflare/workers-wasi](https://github.com/cloudflare/workers-wasi) topic: pushed_at:2024-09 star:0.1k fork:0.0k 

## CMake

- [cloudflare/workerd-tools](https://github.com/cloudflare/workerd-tools) topic: pushed_at:2026-02 star:0.0k fork:0.0k Prebuilt tools and utilities required for ongoing development in the workerd repo.
...
- [cloudflare/cloudflared](https://github.com/cloudflare/cloudflared) topic:cloudflare,cloudflare-tunnel,reverse-proxy,zero-trust-network-access pushed_at:2026-02 star:13.0k fork:1.2k Cloudflare Tunnel client
...
- [cloudflare/pat-app](https://github.com/cloudflare/pat-app) topic: pushed_at:2025-12 star:0.0k fork:0.0k 
- [cloudflare/pat-go](https://github.com/cloudflare/pat-go) topic: pushed_at:2025-11 star:0.0k fork:0.0k Private Access Tokens reference implementation
...
- [cloudflare/terraform-provider-cloudflare](https://github.com/cloudflare/terraform-provider-cloudflare) topic:cloudflare,terraform,terraform-provider pushed_at:2026-02 star:1.2k fork:0.8k Cloudflare Terraform Provider
...
- [cloudflare/blindrsa-ts](https://github.com/cloudflare/blindrsa-ts) topic:blind-rsa,cryptography,typescript pushed_at:2026-01 star:0.0k fork:0.0k A TypeScript Library for Blind RSA Signature protocol
...
- [cloudflare/cloudflare-docs](https://github.com/cloudflare/cloudflare-docs) topic:cloudflare,docs,hacktoberfest,markdown,mdx pushed_at:2026-02 star:4.4k fork:12.2k Cloudflare’s documentation
...
- [cloudflare/research.cloudflare.com](https://github.com/cloudflare/research.cloudflare.com) topic: pushed_at:2026-01 star:0.0k fork:0.0k 
...
- [cloudflare/agent-skills-discovery-rfc](https://github.com/cloudflare/agent-skills-discovery-rfc) topic: pushed_at:2026-02 star:0.1k fork:0.0k 
...
- [cloudflare/skills](https://github.com/cloudflare/skills) topic:agents,cloudflare,skills,workers pushed_at:2026-02 star:0.3k fork:0.0k Skills for teaching agents how to build on Cloudflare.
...
- [cloudflare/ecdysis](https://github.com/cloudflare/ecdysis) topic: pushed_at:2026-02 star:0.2k fork:0.0k A library for graceful restarts in Rust
...
- [cloudflare/lol-html](https://github.com/cloudflare/lol-html) topic:css-selectors,html,parser,rewriting,rust,stream,streaming pushed_at:2026-01 star:1.9k fork:0.1k Low output latency streaming HTML parser/rewriter with CSS selector-based API
...
- [cloudflare/pingora](https://github.com/cloudflare/pingora) topic: pushed_at:2026-02 star:26.1k fork:1.6k A library for building fast, reliable and evolvable network services.
...
- [cloudflare/quiche](https://github.com/cloudflare/quiche) topic:http3,network-programming,protocol,quic,rust pushed_at:2026-02 star:11.2k fork:0.9k 🥧 Savoury implementation of the QUIC transport protocol and HTTP/3
...
- [cloudflare/recapn](https://github.com/cloudflare/recapn) topic: pushed_at:2025-11 star:0.1k fork:0.0k A WIP Cap'n Proto implementation in Rust written from the ground up
...
- [cloudflare/workers-rs](https://github.com/cloudflare/workers-rs) topic:cloudflare,ffi,rust,serverless,webassembly,workers,workers-rs pushed_at:2026-02 star:3.3k fork:0.4k Write Cloudflare Workers in 100% Rust via WebAssembly
...
- [cloudflare/actors](https://github.com/cloudflare/actors) topic:actors,cloudflare,durable-objects,sqlite pushed_at:2026-01 star:0.3k fork:0.0k An easier way to build with Cloudflare Durable Objects
- [cloudflare/agents](https://github.com/cloudflare/agents) topic:agents,ai,cloudflare,durable-objects,workflows pushed_at:2026-02 star:3.2k fork:0.4k Build and deploy AI Agents on Cloudflare 
- [cloudflare/agents-starter](https://github.com/cloudflare/agents-starter) topic:agents,ai,cloudflare,durable-objects pushed_at:2026-01 star:1.2k fork:0.2k A starter kit for building ai agents on Cloudflare
...
- [cloudflare/kumo](https://github.com/cloudflare/kumo) topic: pushed_at:2026-02 star:0.7k fork:0.0k Cloudflare's component library for building modern web applications.
...
- [cloudflare/mcp-server-cloudflare](https://github.com/cloudflare/mcp-server-cloudflare) topic: pushed_at:2026-01 star:3.4k fork:0.3k 
...
- [cloudflare/moltworker](https://github.com/cloudflare/moltworker) topic:ai-agents,cloudflare-workers pushed_at:2026-02 star:8.8k fork:1.5k Run OpenClaw, (formerly Moltbot, formerly Clawdbot) on Cloudflare Workers
...
- [cloudflare/opaque-ts](https://github.com/cloudflare/opaque-ts) topic:crypto,cryptography,opaque,pake,password pushed_at:2025-11 star:0.1k fork:0.0k A TypeScript library for OPAQUE Asymmetric Password-Authenticated Key Exchange Protocol
...
- [cloudflare/pipelines-starter](https://github.com/cloudflare/pipelines-starter) topic: pushed_at:2026-01 star:0.0k fork:0.0k Starter template for Cloudflare Pipelines, which let you ingest real time data streams and load into R2.
...
- [cloudflare/pp-browser-extension](https://github.com/cloudflare/pp-browser-extension) topic:browser-extension,chrome-extension,cryptography,firefox-addon,privacy-pass,token,typescript pushed_at:2025-12 star:0.4k fork:0.0k Client for Privacy Pass protocol providing unlinkable cryptographic tokens 
...
- [cloudflare/puppeteer](https://github.com/cloudflare/puppeteer) topic:cloudflare,workers pushed_at:2026-02 star:0.4k fork:0.0k Puppeteer Core fork that works with Cloudflare Browser Workers
...
- [cloudflare/realtimekit-ui-addons](https://github.com/cloudflare/realtimekit-ui-addons) topic: pushed_at:2025-11 star:0.0k fork:0.0k 
...
- [cloudflare/serverless-registry](https://github.com/cloudflare/serverless-registry) topic:artifacts,cloudflare,container,container-registry,containers,docker,docker-registry,javascript,r2,registry,typescript,workers pushed_at:2026-01 star:1.3k fork:0.1k A container registry backed by Workers and R2.
...
- [cloudflare/telescope](https://github.com/cloudflare/telescope) topic: pushed_at:2026-02 star:0.2k fork:0.0k Cross-browser web performance testing agent
...
- [cloudflare/templates](https://github.com/cloudflare/templates) topic: pushed_at:2026-02 star:1.8k fork:0.9k Templates for Cloudflare Workers
...
- [cloudflare/turnstile-firebase-app-check-provider](https://github.com/cloudflare/turnstile-firebase-app-check-provider) topic: pushed_at:2026-01 star:0.0k fork:0.0k 
...
- [cloudflare/voprf-ts](https://github.com/cloudflare/voprf-ts) topic:crypto,cryptography,dleq,oprf,poprf,typescript,voprf pushed_at:2026-01 star:0.0k fork:0.0k A TypeScript library for Oblivious Pseudorandom Functions
...
- [cloudflare/workers-sdk](https://github.com/cloudflare/workers-sdk) topic:cli,cloudflare,cloudflare-workers,javascript,serverless,wasm pushed_at:2026-02 star:3.8k fork:1.1k ⛅️ Home to Wrangler, the CLI for Cloudflare Workers®
