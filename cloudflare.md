...
- [cloudflare/cloudflare-blog](https://github.com/cloudflare/cloudflare-blog) topic: pushed_at:2024-09 star:1.2k fork:0.2k Cloudflare Blog code samples
...
- [cloudflare/stpyv8](https://github.com/cloudflare/stpyv8) topic: pushed_at:2024-12 star:0.4k fork:0.0k Python 3 and JavaScript interoperability. Successor To PyV8 (https://github.com/flier/pyv8)
- [cloudflare/workerd](https://github.com/cloudflare/workerd) topic: pushed_at:2024-12 star:6.3k fork:0.3k The JavaScript / Wasm runtime that powers Cloudflare Workers
- [cloudflare/workers-wasi](https://github.com/cloudflare/workers-wasi) topic: pushed_at:2024-09 star:0.1k fork:0.0k 

## CMake

- [cloudflare/workerd-tools](https://github.com/cloudflare/workerd-tools) topic: pushed_at:2024-12 star:0.0k fork:0.0k Prebuilt tools and utilities required for ongoing development in the workerd repo.
...
- [cloudflare/bbmp2kafka](https://github.com/cloudflare/bbmp2kafka) topic:bgp,bgp-monitor,bgp-monitoring-protocol,bmp pushed_at:2024-11 star:0.0k fork:0.0k BMP to Kafka processor
...
- [cloudflare/bn256](https://github.com/cloudflare/bn256) topic: pushed_at:2024-12 star:0.1k fork:0.0k Package bn256 implements a particular bilinear group.
...
- [cloudflare/cf-terraforming](https://github.com/cloudflare/cf-terraforming) topic:cloudflare,terraform pushed_at:2024-12 star:1.0k fork:0.1k A command line utility to facilitate terraforming your existing Cloudflare resources.
...
- [cloudflare/cfssl_trust](https://github.com/cloudflare/cfssl_trust) topic: pushed_at:2024-12 star:0.3k fork:0.0k CFSSL's CA trust store repository
- [cloudflare/circl](https://github.com/cloudflare/circl) topic:circl,cryptography,csidh,dilithium,ed25519,ed448,elliptic-curves,go,golang,hpke,kyber,pki,post-quantum,sidh pushed_at:2024-12 star:1.3k fork:0.1k CIRCL: Cloudflare Interoperable Reusable Cryptographic Library
...
- [cloudflare/cloudflare-go](https://github.com/cloudflare/cloudflare-go) topic:api,cloudflare,sdk,sdk-go,sdk-golang pushed_at:2024-12 star:1.5k fork:0.6k The official Go library for the Cloudflare API
...
- [cloudflare/cloudflared](https://github.com/cloudflare/cloudflared) topic:argo-tunnel,cloudflare,cloudflare-tunnel,reverse-proxy,zero-trust-network-access pushed_at:2024-12 star:9.5k fork:0.8k Cloudflare Tunnel client (formerly Argo Tunnel)
...
- [cloudflare/ebpf_exporter](https://github.com/cloudflare/ebpf_exporter) topic:bpf,ebpf,libbpf,linux-kernel,performance,prometheus,prometheus-exporter,tracing pushed_at:2024-12 star:2.2k fork:0.2k Prometheus exporter for custom eBPF metrics
...
- [cloudflare/goflow](https://github.com/cloudflare/goflow) topic:cisco,flow,go,ipfix,juniper,kafka,netflow,sflow pushed_at:2024-12 star:0.9k fork:0.2k The high-scalability sFlow/NetFlow/IPFIX collector used internally at Cloudflare.
...
- [cloudflare/gokey](https://github.com/cloudflare/gokey) topic:deterministic,ecc,ed25519,key-generator,keychain,password-generator,password-manager,password-store,password-vault,rsa-key,seed,stateless pushed_at:2024-12 star:2.0k fork:0.1k A simple vaultless password manager in Go
- [cloudflare/gokeyless](https://github.com/cloudflare/gokeyless) topic:hsm,pkcs11,pki,tls pushed_at:2024-12 star:0.5k fork:0.1k Go implementation of the keyless protocol
...
- [cloudflare/hello-world-container-image](https://github.com/cloudflare/hello-world-container-image) topic: pushed_at:2024-11 star:0.0k fork:0.0k Example container image for running on Cloudflare's container runtime
...
- [cloudflare/octopus](https://github.com/cloudflare/octopus) topic:hacktoberfest pushed_at:2024-12 star:0.0k fork:0.0k The Octopus is part of our network automation pipeline. Its job is to aggregate data from different authoritative data sources into one Enriched Topology to provide a full picture to downstream systems.
...
- [cloudflare/pat-go](https://github.com/cloudflare/pat-go) topic: pushed_at:2024-12 star:0.0k fork:0.0k Private Access Tokens reference implementation
- [cloudflare/pint](https://github.com/cloudflare/pint) topic:linter,metrics,observability,prometheus,validator pushed_at:2024-12 star:0.9k fork:0.1k Prometheus rule linter/validator
- [cloudflare/privacy-gateway-server-go](https://github.com/cloudflare/privacy-gateway-server-go) topic: pushed_at:2024-12 star:0.1k fork:0.0k An Oblivious HTTP gateway
...
- [cloudflare/roughtime](https://github.com/cloudflare/roughtime) topic:ntp,roughtime,time pushed_at:2024-12 star:0.1k fork:0.0k A secure clock-synchronization protocol for when rough is enough.
...
- [cloudflare/terraform-provider-cloudflare](https://github.com/cloudflare/terraform-provider-cloudflare) topic:cloudflare,terraform,terraform-provider pushed_at:2024-12 star:0.8k fork:0.6k Cloudflare Terraform Provider
...
- [cloudflare/cf-product-infrastructure-templates](https://github.com/cloudflare/cf-product-infrastructure-templates) topic: pushed_at:2024-12 star:0.0k fork:0.0k 
...
- [cloudflare/api-schemas](https://github.com/cloudflare/api-schemas) topic: pushed_at:2024-12 star:0.1k fork:0.0k 
...
- [cloudflare/speedtest](https://github.com/cloudflare/speedtest) topic:bandwidth,cloudflare,latency,network-quality,packet-loss,speedtest pushed_at:2024-12 star:0.5k fork:0.0k Component to perform network speed tests against Cloudflare's edge network
...
- [cloudflare/cloudflare-docs](https://github.com/cloudflare/cloudflare-docs) topic:cloudflare,docs,hacktoberfest,markdown,mdx pushed_at:2024-12 star:3.1k fork:5.2k Cloudflare’s documentation
...
- [cloudflare/bbperf](https://github.com/cloudflare/bbperf) topic: pushed_at:2024-12 star:0.0k fork:0.0k bbperf
...
- [cloudflare/sshcert](https://github.com/cloudflare/sshcert) topic: pushed_at:2024-12 star:0.0k fork:0.0k A package for handling ssh certificates
...
- [cloudflare/cloudflare-python](https://github.com/cloudflare/cloudflare-python) topic:api,cloudflare,sdk,sdk-python pushed_at:2024-12 star:0.2k fork:0.0k The official Python library for the Cloudflare API
...
- [cloudflare/python-workers-examples](https://github.com/cloudflare/python-workers-examples) topic: pushed_at:2024-12 star:0.1k fork:0.0k 
...
- [cloudflare/homebrew-cloudflare](https://github.com/cloudflare/homebrew-cloudflare) topic: pushed_at:2024-12 star:0.1k fork:0.0k 
...
- [cloudflare/boring](https://github.com/cloudflare/boring) topic: pushed_at:2024-12 star:0.4k fork:0.1k BoringSSL bindings for the Rust programming language.
- [cloudflare/boringtun](https://github.com/cloudflare/boringtun) topic:cloudflare,rust,wireguard pushed_at:2024-10 star:6.2k fork:0.4k Userspace WireGuard® Implementation in Rust
- [cloudflare/cardinality-estimator](https://github.com/cloudflare/cardinality-estimator) topic:cardinality-estimation,distinct-elements,hyperloglog,probalistic-data-structures,sketches pushed_at:2024-12 star:0.0k fork:0.0k A crate for estimating the cardinality of distinct elements in a stream or dataset.
...
- [cloudflare/daphne](https://github.com/cloudflare/daphne) topic:privacy-preserving pushed_at:2024-12 star:0.1k fork:0.0k Implementation of DAP
...
- [cloudflare/foundations](https://github.com/cloudflare/foundations) topic: pushed_at:2024-12 star:1.3k fork:0.1k Cloudflare's Rust service foundations library.
- [cloudflare/freighter](https://github.com/cloudflare/freighter) topic: pushed_at:2024-12 star:0.1k fork:0.0k A fast, modular, and operationally boring Rust private registry implementation.
...
- [cloudflare/lol-html](https://github.com/cloudflare/lol-html) topic:css-selectors,html,parser,rewriting,rust,stream,streaming pushed_at:2024-12 star:1.5k fork:0.1k Low output latency streaming HTML parser/rewriter with CSS selector-based API
...
- [cloudflare/mmap-sync](https://github.com/cloudflare/mmap-sync) topic:interprocess-communication,memory-mapping,synchronization,wait-free,zero-copy pushed_at:2024-12 star:0.5k fork:0.0k Rust library for concurrent data access, using memory-mapped files, zero-copy deserialization, and wait-free synchronization.
...
- [cloudflare/pingora](https://github.com/cloudflare/pingora) topic: pushed_at:2024-12 star:22.8k fork:1.3k A library for building fast, reliable and evolvable network services.
- [cloudflare/plexi](https://github.com/cloudflare/plexi) topic:auditor,cryptography,e2ee,key-transparency,transparency pushed_at:2024-12 star:0.0k fork:0.0k Your Key Transparency auditor companion
...
- [cloudflare/quiche](https://github.com/cloudflare/quiche) topic:http3,network-programming,protocol,quic,rust pushed_at:2024-12 star:9.5k fork:0.7k 🥧 Savoury implementation of the QUIC transport protocol and HTTP/3
- [cloudflare/recapn](https://github.com/cloudflare/recapn) topic: pushed_at:2024-12 star:0.0k fork:0.0k A WIP Cap'n Proto implementation in Rust written from the ground up
...
- [cloudflare/shellflip](https://github.com/cloudflare/shellflip) topic:graceful-shutdown,process,restart,rust,server,systemd pushed_at:2024-11 star:0.3k fork:0.0k Graceful process restarts in Rust
...
- [cloudflare/wildcard](https://github.com/cloudflare/wildcard) topic:text-processing,wildcard pushed_at:2024-12 star:0.2k fork:0.0k Wildcard matching
- [cloudflare/wirefilter](https://github.com/cloudflare/wirefilter) topic:compiler,engine,filters,firewall,firewall-configuration,firewall-rules,rust,wireshark pushed_at:2024-12 star:1.0k fork:0.1k An execution engine for Wireshark-like filters
...
- [cloudflare/workers-rs](https://github.com/cloudflare/workers-rs) topic:cloudflare,ffi,rust,serverless,webassembly,workers,workers-rs pushed_at:2024-12 star:2.6k fork:0.3k Write Cloudflare Workers in 100% Rust via WebAssembly
...
- [cloudflare/chanfana](https://github.com/cloudflare/chanfana) topic:api,cloudflare,cloudflare-workers,hono,honojs,openapi,openapi3,router,swagger,typescript,workers,workers-script pushed_at:2024-12 star:0.4k fork:0.0k OpenAPI 3 and 3.1 schema generator and validator for Hono, itty-router and more!
- [cloudflare/cloudflare-typescript](https://github.com/cloudflare/cloudflare-typescript) topic:api,cloudflare,sdk,sdk-typescript pushed_at:2024-12 star:0.3k fork:0.0k The official Typescript library for the Cloudflare API
...
- [cloudflare/mcp-server-cloudflare](https://github.com/cloudflare/mcp-server-cloudflare) topic: pushed_at:2024-12 star:0.2k fork:0.0k 
...
- [cloudflare/next-on-pages](https://github.com/cloudflare/next-on-pages) topic:cloudflare-pages,nextjs pushed_at:2024-12 star:1.3k fork:0.1k CLI to build and develop Next.js apps for Cloudflare Pages
...
- [cloudflare/orange](https://github.com/cloudflare/orange) topic: pushed_at:2024-12 star:1.6k fork:0.2k 
...
- [cloudflare/privacypass-issuer](https://github.com/cloudflare/privacypass-issuer) topic:authentication,cryptography,privacy-pass,token,typescript pushed_at:2024-12 star:0.0k fork:0.0k A TypeScript Issuer for the Privacy Pass Authentication Protocol
...
- [cloudflare/serverless-registry](https://github.com/cloudflare/serverless-registry) topic:artifacts,cloudflare,container,container-registry,containers,docker,docker-registry,javascript,r2,registry,typescript,workers pushed_at:2024-12 star:1.0k fork:0.0k A container registry backed by Workers and R2.
...
- [cloudflare/templates](https://github.com/cloudflare/templates) topic: pushed_at:2024-12 star:1.0k fork:0.6k Templates for Cloudflare Workers
...
- [cloudflare/workers-graphql-server](https://github.com/cloudflare/workers-graphql-server) topic:apollo,cloudflare-workers,graphql,serverless pushed_at:2024-12 star:0.7k fork:0.5k 🔥Lightning-fast, globally distributed Apollo GraphQL server, deployed at the edge using Cloudflare Workers
...
- [cloudflare/workers-sdk](https://github.com/cloudflare/workers-sdk) topic:cli,cloudflare,cloudflare-workers,javascript,serverless,wasm pushed_at:2024-12 star:2.8k fork:0.7k ⛅️ Home to Wrangler, the CLI for Cloudflare Workers®
...
- [cloudflare/workflows-starter](https://github.com/cloudflare/workflows-starter) topic:cloudflare,durable-execution,workers,workflows pushed_at:2024-12 star:0.0k fork:0.0k A starter template for Cloudflare Workflows. 
- [cloudflare/wrangler-action](https://github.com/cloudflare/wrangler-action) topic:cloudflare,cloudflare-workers,github-actions,wrangler pushed_at:2024-12 star:1.3k fork:0.2k 🧙‍♀️ easily deploy cloudflare workers applications using wrangler and github actions
