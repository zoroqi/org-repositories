...
- [JetBrains/godot-support](https://github.com/JetBrains/godot-support) topic: pushed_at:2025-01 star:0.4k fork:0.0k 
...
- [JetBrains/UnrealLink](https://github.com/JetBrains/UnrealLink) topic: pushed_at:2025-01 star:0.1k fork:0.0k 
...
- [JetBrains/intellij-community](https://github.com/JetBrains/intellij-community) topic:code-editor,ide,intellij,intellij-community,intellij-platform pushed_at:2025-02 star:17.6k fork:5.3k IntelliJ IDEA Community Edition & IntelliJ Platform
...
- [JetBrains/jediterm](https://github.com/JetBrains/jediterm) topic: pushed_at:2025-01 star:0.7k fork:0.2k Pure Java Terminal Emulator. Works with SSH and PTY.
- [JetBrains/JetBrainsApiTest](https://github.com/JetBrains/JetBrainsApiTest) topic: pushed_at:2024-09 star:0.0k fork:0.0k 
- [JetBrains/JetBrainsRuntime](https://github.com/JetBrains/JetBrainsRuntime) topic:intellij-platform,jdk,openjdk pushed_at:2025-02 star:1.4k fork:0.2k Runtime environment based on OpenJDK for running IntelliJ Platform-based products on Windows, macOS, and Linux
...
- [JetBrains/teamcity-premerge](https://github.com/JetBrains/teamcity-premerge) topic: pushed_at:2025-01 star:0.0k fork:0.0k This plugin allows running builds on merge results before the merge was committed. It helps to detect integration problems.
...
- [JetBrains/compose-multiplatform](https://github.com/JetBrains/compose-multiplatform) topic:android,awt,compose,declarative-ui,desktop,gui,ios,javascript,kotlin,multiplatform,reactive,swing,ui,wasm,web,webassembly pushed_at:2025-01 star:16.7k fork:1.2k Compose Multiplatform, a modern UI framework for Kotlin that makes building performant and beautiful user interfaces easy and enjoyable.
...
- [JetBrains/hirschgarten](https://github.com/JetBrains/hirschgarten) topic:bazel,bazel-rules,build-server-protocol,intellij-idea,intellij-plugin pushed_at:2025-02 star:0.1k fork:0.0k A new approach to Bazel support for IntelliJ IDEA
...
- [JetBrains/ideavim](https://github.com/JetBrains/ideavim) topic:ideavim,intellij,intellij-platform,intellij-plugin,jb-official,jetbrains,kotlin,vim pushed_at:2025-01 star:9.5k fork:0.8k IdeaVim – A Vim engine for JetBrains IDEs
...
- [JetBrains/intellij-ui-test-robot](https://github.com/JetBrains/intellij-ui-test-robot) topic:ide,idea-plugin,intellij,intellij-plugin,java,kotlin,test-automation pushed_at:2025-01 star:0.1k fork:0.0k The library allows you to write and execute UI tests among IntelliJ IDEA. You can test your Plugin.
- [JetBrains/java-annotations](https://github.com/JetBrains/java-annotations) topic: pushed_at:2025-01 star:0.4k fork:0.0k Annotations for JVM-based languages.
...
- [JetBrains/kotlin](https://github.com/JetBrains/kotlin) topic:compiler,gradle-plugin,intellij-plugin,kotlin,kotlin-library,maven-plugin,programming-language,wasm,webassembly pushed_at:2025-02 star:49.9k fork:5.8k The Kotlin Programming Language. 
...
- [JetBrains/kotlin-wrappers](https://github.com/JetBrains/kotlin-wrappers) topic:css,kotlin,kotlin-js,react,react-router-dom,styled-components pushed_at:2025-02 star:1.4k fork:0.2k Kotlin wrappers for popular JavaScript libraries
- [JetBrains/kotlinconf-app](https://github.com/JetBrains/kotlinconf-app) topic: pushed_at:2025-01 star:3.1k fork:0.3k KotlinConf Schedule Application
...
- [JetBrains/plugin-repository-rest-client](https://github.com/JetBrains/plugin-repository-rest-client) topic: pushed_at:2025-01 star:0.0k fork:0.0k 
...
- [JetBrains/swot](https://github.com/JetBrains/swot) topic: pushed_at:2025-01 star:1.8k fork:23.2k Identify email addresses or domains names that belong to colleges or universities. Help automate the process of approving or rejecting academic discounts.
...
- [JetBrains/xodus-entity-browser](https://github.com/JetBrains/xodus-entity-browser) topic:ktor,xodus,xodus-database,xodus-entity-browser pushed_at:2025-01 star:0.1k fork:0.0k Web UI entity browser for xodus database 
...
- [JetBrains/helm-charts](https://github.com/JetBrains/helm-charts) topic:helm,jetbrains,kubernetes pushed_at:2025-01 star:0.0k fork:0.0k JetBrains Helm Charts
...
- [JetBrains/marketplace-docs](https://github.com/JetBrains/marketplace-docs) topic:docs,intellij-plugin,jetbrains,marketplace pushed_at:2025-01 star:0.0k fork:0.0k JetBrains Marketplace Documentation
...
- [JetBrains/sample_rails_app_8th_ed](https://github.com/JetBrains/sample_rails_app_8th_ed) topic: pushed_at:2025-01 star:0.0k fork:0.0k 
...
- [JetBrains/clion-bundle-buildenv](https://github.com/JetBrains/clion-bundle-buildenv) topic:build,cmake,cross-compilation,dockerfile,gdb,lldb,makepkg,mingw-w64,pkgbuild pushed_at:2025-01 star:0.0k fork:0.0k Dockerfile for building GDB/LLDB for MinGW-W64 and Linux
...
- [JetBrains/JetBrainsMono](https://github.com/JetBrains/JetBrainsMono) topic:coding-font,font,ligatures,monospaced-font,programming-font,programming-ligatures pushed_at:2025-01 star:11.2k fork:0.3k JetBrains Mono – the free and open-source typeface for developers
...
- [JetBrains/youtrack-mobile](https://github.com/JetBrains/youtrack-mobile) topic:android,ios,react,react-native,youtrack pushed_at:2025-01 star:0.3k fork:0.1k A iOS and Android client for YouTrack
