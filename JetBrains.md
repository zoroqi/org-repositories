...
- [JetBrains/rider-trx-plugin](https://github.com/JetBrains/rider-trx-plugin) topic:dotnet,jetbrains-rider,trx pushed_at:2025-03 star:0.0k fork:0.0k JetBrains Rider plugin to support TRX test report files.
...
- [JetBrains/intellij-sdk-code-samples](https://github.com/JetBrains/intellij-sdk-code-samples) topic:intellij,intellij-idea,intellij-platform,intellij-plugin,intellij-plugins,intellij-sdk,jetbrains,jetbrains-plugin,jetbrains-plugins pushed_at:2025-03 star:1.2k fork:0.4k Mirror of the IntelliJ SDK Docs Code Samples
...
- [JetBrains/mcp-jetbrains](https://github.com/JetBrains/mcp-jetbrains) topic:ide,intellij,jetbrains,mcp,mcp-server,pycharm pushed_at:2025-01 star:0.2k fork:0.0k A model context protocol server to work with JetBrains IDEs: IntelliJ, PyCharm, WebStorm, etc. Also, works with Android Studio
...
- [JetBrains/youtrack-apps](https://github.com/JetBrains/youtrack-apps) topic: pushed_at:2025-03 star:0.0k fork:0.0k 
...
- [JetBrains/MPS-extensions](https://github.com/JetBrains/MPS-extensions) topic:jetbrains-mps pushed_at:2025-03 star:0.1k fork:0.1k MPS-extensions aims to ease language development within MPS.
...
- [JetBrains/compose-hot-reload](https://github.com/JetBrains/compose-hot-reload) topic:compose,compose-desktop,compose-hot-reload,compose-multiplatform,firework,hot-reload,kotlin pushed_at:2025-03 star:0.8k fork:0.0k Compose Hot Reload: Make changes to your UI code in a Compose Multiplatform application, and see the results in real time. No restarts required. Compose Hot Reload runs your application on a special desktop JVM, and intelligently reloads your code whenever it is changed.
- [JetBrains/compose-multiplatform](https://github.com/JetBrains/compose-multiplatform) topic:android,awt,compose,declarative-ui,desktop,gui,ios,javascript,kotlin,multiplatform,reactive,swing,ui,wasm,web,webassembly pushed_at:2025-03 star:16.9k fork:1.2k Compose Multiplatform, a modern UI framework for Kotlin that makes building performant and beautiful user interfaces easy and enjoyable.
- [JetBrains/compose-multiplatform-core](https://github.com/JetBrains/compose-multiplatform-core) topic: pushed_at:2025-03 star:0.5k fork:0.1k Development environment for Android Jetpack extension libraries under the androidx namespace. Synchronized with Android Jetpack's primary development branch on AOSP.
...
- [JetBrains/Exposed](https://github.com/JetBrains/Exposed) topic:dao,kotlin,orm,sql pushed_at:2025-03 star:8.6k fork:0.7k Kotlin SQL Framework
...
- [JetBrains/ExternalAnnotations](https://github.com/JetBrains/ExternalAnnotations) topic:jetbrains,plugin,resharper,resharper-plugin pushed_at:2025-03 star:0.1k fork:0.0k JetBrains ReSharper External Annotations
...
- [JetBrains/ideavim](https://github.com/JetBrains/ideavim) topic:ideavim,intellij,intellij-platform,intellij-plugin,jb-official,jetbrains,kotlin,vim pushed_at:2025-03 star:9.5k fork:0.8k IdeaVim – A Vim engine for JetBrains IDEs
- [JetBrains/ideolog](https://github.com/JetBrains/ideolog) topic: pushed_at:2025-03 star:0.3k fork:0.1k Interactive viewer for '.log' files.
...
- [JetBrains/intellij-ide-starter](https://github.com/JetBrains/intellij-ide-starter) topic: pushed_at:2025-03 star:0.0k fork:0.0k 
...
- [JetBrains/intellij-platform-gradle-plugin](https://github.com/JetBrains/intellij-platform-gradle-plugin) topic:gradle,gradle-intellij-plugin,intellij,intellij-ides,intellij-platform,intellij-plugin,intellij-sdk,jetbrains-plugin,plugin-verifier pushed_at:2025-03 star:1.5k fork:0.3k Gradle plugin for building plugins for JetBrains IDEs
- [JetBrains/intellij-platform-plugin-template](https://github.com/JetBrains/intellij-platform-plugin-template) topic:intellij,intellij-idea,intellij-idea-plugin,intellij-platform,intellij-plugin,intellij-plugins,jetbrains-plugin pushed_at:2025-03 star:3.3k fork:0.7k Template repository for creating plugins for IntelliJ Platform
- [JetBrains/intellij-plugin-verifier](https://github.com/JetBrains/intellij-plugin-verifier) topic: pushed_at:2025-03 star:0.2k fork:0.0k Compatibility verification tool for IntelliJ Platform plugins
...
- [JetBrains/intellij-ui-test-robot](https://github.com/JetBrains/intellij-ui-test-robot) topic:ide,idea-plugin,intellij,intellij-plugin,java,kotlin,test-automation pushed_at:2025-03 star:0.1k fork:0.0k The library allows you to write and execute UI tests among IntelliJ IDEA. You can test your Plugin.
...
- [JetBrains/kotlin](https://github.com/JetBrains/kotlin) topic:compiler,gradle-plugin,intellij-plugin,kotlin,kotlin-library,maven-plugin,programming-language,wasm,webassembly pushed_at:2025-03 star:50.2k fork:5.9k The Kotlin Programming Language. 
- [JetBrains/kotlin-compiler-server](https://github.com/JetBrains/kotlin-compiler-server) topic:kotlin,kotlin-compiler,kotlin-playground,spring,spring-boot pushed_at:2025-03 star:0.3k fork:0.1k Server for executing kotlin code
...
- [JetBrains/kotlinconf-app](https://github.com/JetBrains/kotlinconf-app) topic: pushed_at:2025-03 star:3.1k fork:0.3k KotlinConf Schedule Application
...
- [JetBrains/lincheck](https://github.com/JetBrains/lincheck) topic: pushed_at:2025-03 star:0.6k fork:0.0k Framework for testing concurrent data structures
...
- [JetBrains/marketplace-zip-signer](https://github.com/JetBrains/marketplace-zip-signer) topic:intellij,intellij-idea,intellij-idea-plugin,intellij-platform,intellij-plugin,intellij-plugins,jetbrains-plugin pushed_at:2025-03 star:0.0k fork:0.0k Marketplace ZIP Signer tool handles signing and verification of the JetBrains plugins.
...
- [JetBrains/mcp-server-plugin](https://github.com/JetBrains/mcp-server-plugin) topic: pushed_at:2025-03 star:0.0k fork:0.0k JetBrains MCP Server Plugin
...
- [JetBrains/pest-intellij](https://github.com/JetBrains/pest-intellij) topic:intellij,intellij-plugin,kotlin,pest,php,phpstorm,phpstorm-plugin pushed_at:2025-03 star:0.2k fork:0.0k The official Pest Plugin for PhpStorm / IntelliJ IDEA
...
- [JetBrains/rider-efcore](https://github.com/JetBrains/rider-efcore) topic:dotnet,dotnet-core,dotnet-ef,ef-core,entity-framework,entity-framework-core,jetbrains-plugin,jetbrains-rider pushed_at:2025-03 star:0.2k fork:0.0k Entity Framework Core UI plugin for JetBrains Rider
- [JetBrains/Rplugin](https://github.com/JetBrains/Rplugin) topic:intellij-plugin,rlang,rlanguage pushed_at:2025-03 star:0.1k fork:0.0k R Language support for IntelliJ-based IDEs
...
- [JetBrains/swot](https://github.com/JetBrains/swot) topic: pushed_at:2025-03 star:1.9k fork:24.6k Identify email addresses or domains names that belong to colleges or universities. Help automate the process of approving or rejecting academic discounts.
...
- [JetBrains/teamcity-dotnet-plugin](https://github.com/JetBrains/teamcity-dotnet-plugin) topic:ci,dotnet,dotnet-core,dotnet-standard,msbuild,teamcity,teamcity-plugin,vstest pushed_at:2025-03 star:0.1k fork:0.0k TeamCity plugin for .NET projects
...
- [JetBrains/teamcity-hashicorp-vault-plugin](https://github.com/JetBrains/teamcity-hashicorp-vault-plugin) topic:hashicorp-vault,teamcity,vault pushed_at:2025-03 star:0.0k fork:0.0k TeamCity plugin to support HashiCorp Vault
- [JetBrains/teamcity-kotlin-script-runner](https://github.com/JetBrains/teamcity-kotlin-script-runner) topic: pushed_at:2025-03 star:0.0k fork:0.0k 
...
- [JetBrains/intellij-sdk-docs](https://github.com/JetBrains/intellij-sdk-docs) topic:docs,intellij,intellij-platform,intellij-plugin,intellijidea-plugin,jetbrains,sdk pushed_at:2025-03 star:1.2k fork:0.9k IntelliJ SDK Platform Documentation
...
- [JetBrains/junie-workflows](https://github.com/JetBrains/junie-workflows) topic: pushed_at:2025-03 star:0.0k fork:0.0k Set of workflows to run junie (matterhorn) helper
...
- [JetBrains/marketplace-docs](https://github.com/JetBrains/marketplace-docs) topic:docs,intellij-plugin,jetbrains,marketplace pushed_at:2025-03 star:0.0k fork:0.0k JetBrains Marketplace Documentation
...
- [JetBrains/Qodana](https://github.com/JetBrains/Qodana) topic:ci,code-quality,code-review,code-scanning,continuous-integration,java,javascript,jetbrains,kotlin,php,python,static-analysis,static-code-analysis,typescript pushed_at:2025-03 star:0.4k fork:0.1k 📝 Source repository of Qodana Help
...
- [JetBrains/Rkernel-proto](https://github.com/JetBrains/Rkernel-proto) topic: pushed_at:2025-03 star:0.0k fork:0.0k 
...
- [JetBrains/teamcity-documentation](https://github.com/JetBrains/teamcity-documentation) topic: pushed_at:2025-03 star:0.0k fork:0.1k Source repository of TeamCity Help
...
- [JetBrains/phpstorm-stubs](https://github.com/JetBrains/phpstorm-stubs) topic: pushed_at:2025-03 star:1.3k fork:0.8k PHP runtime & extensions header files for PhpStorm
...
- [JetBrains/Rkernel](https://github.com/JetBrains/Rkernel) topic: pushed_at:2025-03 star:0.0k fork:0.0k 
...
- [JetBrains/intellij-scala](https://github.com/JetBrains/intellij-scala) topic:intellij-idea,intellij-plugin,scala pushed_at:2025-03 star:1.2k fork:0.4k Scala plugin for IntelliJ IDEA
...
- [JetBrains/JetBrainsMono](https://github.com/JetBrains/JetBrainsMono) topic:coding-font,font,ligatures,monospaced-font,programming-font,programming-ligatures pushed_at:2025-01 star:11.4k fork:0.3k JetBrains Mono – the free and open-source typeface for developers
...
- [JetBrains/qodana-profiles](https://github.com/JetBrains/qodana-profiles) topic:code-inspection,intellij,qodana pushed_at:2025-03 star:0.0k fork:0.0k 🧰 Code inspection profiles used in Qodana linters
...
- [JetBrains/kotlin-multiplatform-dev-docs](https://github.com/JetBrains/kotlin-multiplatform-dev-docs) topic: pushed_at:2025-03 star:0.1k fork:0.1k Kotlin Multiplatfom development documentation

## TypeScript

- [JetBrains/guide](https://github.com/JetBrains/guide) topic:dotnet,golang,java,python,unity,unreal-engine,vitest pushed_at:2025-03 star:0.0k fork:0.0k The JetBrains Guide is a collection of resources for learning JetBrains IDEs.
...
- [JetBrains/ring-ui](https://github.com/JetBrains/ring-ui) topic:components,jetbrains-ui,react pushed_at:2025-03 star:3.7k fork:0.2k A collection of JetBrains Web UI components
...
- [JetBrains/youtrack-mobile](https://github.com/JetBrains/youtrack-mobile) topic:android,ios,react,react-native,youtrack pushed_at:2025-03 star:0.3k fork:0.1k A iOS and Android client for YouTrack

## Vue

- [JetBrains/ij-perf-report-aggregator](https://github.com/JetBrains/ij-perf-report-aggregator) topic: pushed_at:2025-03 star:0.0k fork:0.0k 
