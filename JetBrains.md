...
- [JetBrains/CMake](https://github.com/JetBrains/CMake) topic: pushed_at:2023-04 star:0.0k fork:0.0k CMake with debugging support. Based on initial Sysprogs fork. 
...
- [JetBrains/go-code-samples](https://github.com/JetBrains/go-code-samples) topic: pushed_at:2023-05 star:0.0k fork:0.0k 
...
- [JetBrains/tc-sbt-runner](https://github.com/JetBrains/tc-sbt-runner) topic: pushed_at:2023-05 star:0.0k fork:0.0k TeamCity plugin makes SBT runner
...
- [JetBrains/teamcity-aws-core-plugin](https://github.com/JetBrains/teamcity-aws-core-plugin) topic: pushed_at:2023-05 star:0.0k fork:0.0k Core utilities common for TeamCity Amazon-related plugins. Before TeamCity 2019.2 was a part of teamcity-aws-codedeploy-plugin.
...
- [JetBrains/teamcity-webhooks](https://github.com/JetBrains/teamcity-webhooks) topic: pushed_at:2023-05 star:0.0k fork:0.0k 
...
- [JetBrains/android](https://github.com/JetBrains/android) topic: pushed_at:2023-05 star:0.8k fork:0.2k Android Plugin for IntelliJ IDEA. This repository is a subset of https://git.jetbrains.org/?p=idea/android.git cut according to GitHub file size limitations.
...
- [JetBrains/compose-multiplatform](https://github.com/JetBrains/compose-multiplatform) topic:android,awt,compose,declarative-ui,desktop,gui,javascript,kotlin,multiplatform,reactive,swing,ui pushed_at:2023-05 star:11.7k fork:0.9k Compose Multiplatform, a modern UI framework for Kotlin that makes building performant and beautiful user interfaces easy and enjoyable.
...
- [JetBrains/compose-multiplatform-ios-android-template](https://github.com/JetBrains/compose-multiplatform-ios-android-template) topic: pushed_at:2023-05 star:0.8k fork:0.1k Compose Multiplatform iOS+Android Application project template
...
- [JetBrains/educational-plugin](https://github.com/JetBrains/educational-plugin) topic: pushed_at:2023-05 star:0.1k fork:0.0k Educational plugin to learn and teach programming languages such as Kotlin, Java, Python, JavaScript, and others right inside of JetBrains IntelliJ Platform based IDEs.
...
- [JetBrains/Exposed](https://github.com/JetBrains/Exposed) topic:dao,kotlin,orm,sql pushed_at:2023-05 star:7.1k fork:0.6k Kotlin SQL Framework
...
- [JetBrains/intellij-platform-plugin-template](https://github.com/JetBrains/intellij-platform-plugin-template) topic:intellij,intellij-idea,intellij-idea-plugin,intellij-platform,intellij-plugin,intellij-plugins,jetbrains-plugin pushed_at:2023-04 star:2.2k fork:0.4k Template repository for creating plugins for IntelliJ Platform
...
- [JetBrains/kotlin](https://github.com/JetBrains/kotlin) topic:compiler,gradle-plugin,intellij-plugin,kotlin,kotlin-library,maven-plugin,programming-language pushed_at:2023-05 star:44.7k fork:5.5k The Kotlin Programming Language. 
...
- [JetBrains/kotlin-compiler-server](https://github.com/JetBrains/kotlin-compiler-server) topic:kotlin,kotlin-compiler,kotlin-playground,spring,spring-boot pushed_at:2023-05 star:0.1k fork:0.1k Server for executing kotlin code
...
- [JetBrains/swot](https://github.com/JetBrains/swot) topic: pushed_at:2023-05 star:1.5k fork:14.8k Identify email addresses or domains names that belong to colleges or universities. Help automate the process of approving or rejecting academic discounts.
...
- [JetBrains/teamcity-demo-plugin-example](https://github.com/JetBrains/teamcity-demo-plugin-example) topic: pushed_at:2023-04 star:0.0k fork:0.0k 
- [JetBrains/teamcity-dotnet-plugin](https://github.com/JetBrains/teamcity-dotnet-plugin) topic:ci,dotnet,dotnet-core,dotnet-standard,msbuild,teamcity,teamcity-plugin,vstest pushed_at:2023-05 star:0.1k fork:0.0k TeamCity plugin for .NET projects
...
- [JetBrains/teamcity-kotlin-script-runner](https://github.com/JetBrains/teamcity-kotlin-script-runner) topic: pushed_at:2023-05 star:0.0k fork:0.0k 
...
- [JetBrains/intellij-community](https://github.com/JetBrains/intellij-community) topic:code-editor,ide,intellij,intellij-community,intellij-platform pushed_at:2023-05 star:15.3k fork:4.9k IntelliJ IDEA Community Edition & IntelliJ Platform
...
- [JetBrains/ReSharper-InspectCode](https://github.com/JetBrains/ReSharper-InspectCode) topic:csharp,dotnet,github-action,github-actions,jetbrains,resharper,static-analysis,static-analyzer pushed_at:2023-04 star:0.0k fork:0.0k C# static analysis on GitHub Actions using JetBrains ReSharper InspectCode.
...
- [JetBrains/writerside-templates-library](https://github.com/JetBrains/writerside-templates-library) topic: pushed_at:2023-05 star:0.0k fork:0.0k 
...
- [JetBrains/sbt-idea-example](https://github.com/JetBrains/sbt-idea-example) topic:idea-plugin,intellij-plugin,sbt pushed_at:2023-04 star:0.0k fork:0.0k SBT based IntellJ plugin template project
- [JetBrains/sbt-idea-plugin](https://github.com/JetBrains/sbt-idea-plugin) topic:intellij,intellij-ide,intellij-platform,intellij-plugin,plugin-sbt,sbt,sbt-plugin pushed_at:2023-04 star:0.1k fork:0.0k Develop IntelliJ plugins with Scala and SBT
...
- [JetBrains/JetBrainsMono](https://github.com/JetBrains/JetBrainsMono) topic:coding-font,font,ligatures,monospaced-font,programming-font,programming-ligatures pushed_at:2023-03 star:8.9k fork:0.3k JetBrains Mono – the free and open-source typeface for developers
...
- [JetBrains/pycharm-demos](https://github.com/JetBrains/pycharm-demos) topic: pushed_at:2023-05 star:0.0k fork:0.0k 

## TypeScript

- [JetBrains/guide](https://github.com/JetBrains/guide) topic: pushed_at:2023-05 star:0.0k fork:0.0k 
- [JetBrains/ring-ui](https://github.com/JetBrains/ring-ui) topic:components,jetbrains-ui,react pushed_at:2023-05 star:3.4k fork:0.2k A collection of JetBrains Web UI components
