...
- [JetBrains/ForTea](https://github.com/JetBrains/ForTea) topic:hacktoberfest pushed_at:2023-03 star:0.0k fork:0.0k 
...
- [JetBrains/roslyn](https://github.com/JetBrains/roslyn) topic: pushed_at:2023-03 star:0.0k fork:0.0k The .NET Compiler Platform ("Roslyn") provides open-source C# and Visual Basic compilers with rich code analysis APIs.
...
- [JetBrains/UnrealLink](https://github.com/JetBrains/UnrealLink) topic: pushed_at:2023-03 star:0.1k fork:0.0k 
...
- [JetBrains/azure-tools-for-intellij](https://github.com/JetBrains/azure-tools-for-intellij) topic: pushed_at:2023-03 star:0.0k fork:0.0k Azure Toolkit for JetBrains Rider.
...
- [JetBrains/pty4j](https://github.com/JetBrains/pty4j) topic: pushed_at:2023-03 star:0.3k fork:0.1k Pty for Java
...
- [JetBrains/lets-plot-docs](https://github.com/JetBrains/lets-plot-docs) topic: pushed_at:2023-03 star:0.0k fork:0.0k 
...
- [JetBrains/compose-multiplatform](https://github.com/JetBrains/compose-multiplatform) topic:android,awt,compose,declarative-ui,desktop,gui,javascript,kotlin,multiplatform,reactive,swing,ui pushed_at:2023-03 star:10.5k fork:0.8k Compose Multiplatform, a modern UI framework for Kotlin that makes building performant and beautiful user interfaces easy and enjoyable.
- [JetBrains/compose-multiplatform-core](https://github.com/JetBrains/compose-multiplatform-core) topic: pushed_at:2023-03 star:0.1k fork:0.0k Development environment for Android Jetpack extension libraries under the androidx namespace. Synchronized with Android Jetpack's primary development branch on AOSP.
...
- [JetBrains/compose-multiplatform-template](https://github.com/JetBrains/compose-multiplatform-template) topic: pushed_at:2023-03 star:0.0k fork:0.0k Compose Multiplatform Application project template
...
- [JetBrains/Exposed](https://github.com/JetBrains/Exposed) topic:dao,kotlin,orm,sql pushed_at:2023-03 star:6.9k fork:0.6k Kotlin SQL Framework
...
- [JetBrains/intellij-arend](https://github.com/JetBrains/intellij-arend) topic:arend,intellij,intellij-plugin pushed_at:2023-03 star:0.1k fork:0.0k Arend plugin for IntelliJ IDEA
...
- [JetBrains/intellij-platform-plugin-template](https://github.com/JetBrains/intellij-platform-plugin-template) topic:intellij,intellij-idea,intellij-idea-plugin,intellij-platform,intellij-plugin,intellij-plugins,jetbrains-plugin pushed_at:2023-03 star:2.1k fork:0.4k Template repository for creating plugins for IntelliJ Platform
...
- [JetBrains/kotlin](https://github.com/JetBrains/kotlin) topic:compiler,gradle-plugin,intellij-plugin,kotlin,kotlin-library,maven-plugin,programming-language pushed_at:2023-03 star:44.1k fork:5.5k The Kotlin Programming Language. 
...
- [JetBrains/marketplace-zip-signer](https://github.com/JetBrains/marketplace-zip-signer) topic:intellij,intellij-idea,intellij-idea-plugin,intellij-platform,intellij-plugin,intellij-plugins,jetbrains-plugin pushed_at:2023-03 star:0.0k fork:0.0k Marketplace ZIP Signer tool handles signing and verification of the JetBrains plugins.
...
- [JetBrains/phpstorm-stubs](https://github.com/JetBrains/phpstorm-stubs) topic: pushed_at:2023-03 star:1.2k fork:0.8k PHP runtime & extensions header files for PhpStorm
