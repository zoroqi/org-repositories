...
- [JetBrains/profiler-unity-api](https://github.com/JetBrains/profiler-unity-api) topic: pushed_at:2023-04 star:0.0k fork:0.0k 
...
- [JetBrains/resharper-unity](https://github.com/JetBrains/resharper-unity) topic:hacktoberfest,jetbrains,plugin,resharper,resharper-plugin,rider,unity,unity-editor pushed_at:2023-04 star:1.1k fork:0.1k Unity support for both ReSharper and Rider
...
- [JetBrains/UnrealLink](https://github.com/JetBrains/UnrealLink) topic: pushed_at:2023-04 star:0.1k fork:0.0k 
...
- [JetBrains/resharper-fsharp](https://github.com/JetBrains/resharper-fsharp) topic:fsharp,hacktoberfest,jetbrains,plugin,resharper,rider pushed_at:2023-04 star:0.3k fork:0.1k F# support in JetBrains Rider
...
- [JetBrains/go-code-samples](https://github.com/JetBrains/go-code-samples) topic: pushed_at:2023-04 star:0.0k fork:0.0k 
...
- [JetBrains/intellij-coverage](https://github.com/JetBrains/intellij-coverage) topic:coverage,coverage-agent,intellij,java pushed_at:2023-04 star:0.1k fork:0.0k IntelliJ IDEA code coverage agent
...
- [JetBrains/JetBrainsApiTest](https://github.com/JetBrains/JetBrainsApiTest) topic: pushed_at:2023-04 star:0.0k fork:0.0k 
- [JetBrains/JetBrainsRuntime](https://github.com/JetBrains/JetBrainsRuntime) topic:intellij-platform,jdk,openjdk pushed_at:2023-05 star:0.8k fork:0.2k Runtime environment based on OpenJDK for running IntelliJ Platform-based products on Windows, macOS, and Linux
...
- [JetBrains/teamcity-deployer-plugin](https://github.com/JetBrains/teamcity-deployer-plugin) topic:deploy,ftp,smb,ssh,teamcity,teamcity-plugin pushed_at:2023-04 star:0.0k fork:0.0k Deployer plugin for TeamCity CI server
...
- [JetBrains/xodus](https://github.com/JetBrains/xodus) topic:database,db,embedded-database,entity-store,java,key-value,kotlin,log-structured,nosql,schema-less,snapshot-isolation,transactional,xodus,youtrack pushed_at:2023-04 star:1.1k fork:0.1k Transactional schema-less embedded database used by JetBrains YouTrack and JetBrains Hub.
...
- [JetBrains/lets-plot-docs](https://github.com/JetBrains/lets-plot-docs) topic: pushed_at:2023-04 star:0.0k fork:0.0k 
...
- [JetBrains/compose-multiplatform](https://github.com/JetBrains/compose-multiplatform) topic:android,awt,compose,declarative-ui,desktop,gui,javascript,kotlin,multiplatform,reactive,swing,ui pushed_at:2023-04 star:11.5k fork:0.9k Compose Multiplatform, a modern UI framework for Kotlin that makes building performant and beautiful user interfaces easy and enjoyable.
...
- [JetBrains/compose-multiplatform-ios-android-template](https://github.com/JetBrains/compose-multiplatform-ios-android-template) topic: pushed_at:2023-04 star:0.8k fork:0.0k Compose Multiplatform iOS+Android Application project template
- [JetBrains/compose-multiplatform-template](https://github.com/JetBrains/compose-multiplatform-template) topic: pushed_at:2023-04 star:0.2k fork:0.0k Compose Multiplatform Application project template
...
- [JetBrains/download-pgp-verifier](https://github.com/JetBrains/download-pgp-verifier) topic:gpg,jetbrains,netstandard pushed_at:2023-04 star:0.0k fork:0.0k Checks PGP signatures for JetBrains distributions
...
- [JetBrains/EnhancedUnrealEngineDocumentation](https://github.com/JetBrains/EnhancedUnrealEngineDocumentation) topic: pushed_at:2023-04 star:0.0k fork:0.0k 
- [JetBrains/Exposed](https://github.com/JetBrains/Exposed) topic:dao,kotlin,orm,sql pushed_at:2023-04 star:7.1k fork:0.6k Kotlin SQL Framework
...
- [JetBrains/ideavim](https://github.com/JetBrains/ideavim) topic:ideavim,intellij,intellij-platform,intellij-plugin,jb-official,jetbrains,kotlin,vim pushed_at:2023-04 star:7.6k fork:0.7k IdeaVim – A Vim engine for JetBrains IDEs
...
- [JetBrains/intellij-bsp](https://github.com/JetBrains/intellij-bsp) topic:bazel,build-server-protocol,build-tool,build-tool-integration pushed_at:2023-04 star:0.0k fork:0.0k IntelliJ IDEA client for the Build Server Protocol (https://build-server-protocol.github.io/)
...
- [JetBrains/intellij-plugin-verifier](https://github.com/JetBrains/intellij-plugin-verifier) topic: pushed_at:2023-04 star:0.1k fork:0.0k Compatibility verification tool for IntelliJ Platform plugins
...
- [JetBrains/intellij-ui-test-robot](https://github.com/JetBrains/intellij-ui-test-robot) topic:ide,idea-plugin,intellij,intellij-plugin,java,kotlin,test-automation pushed_at:2023-04 star:0.1k fork:0.0k The library allows you to write and execute UI tests among IntelliJ IDEA. You can test your Plugin.
- [JetBrains/jewel](https://github.com/JetBrains/jewel) topic:compose,desktop,intellij,kotlin,laf,look-and-feel,multiplatform,swing,theme,ui pushed_at:2023-04 star:0.3k fork:0.0k An implementation of the IntelliJ look and feels in Compose for Desktop
...
- [JetBrains/kotlin](https://github.com/JetBrains/kotlin) topic:compiler,gradle-plugin,intellij-plugin,kotlin,kotlin-library,maven-plugin,programming-language pushed_at:2023-04 star:44.5k fork:5.5k The Kotlin Programming Language. 
...
- [JetBrains/kotlin-wrappers](https://github.com/JetBrains/kotlin-wrappers) topic:css,kotlin,kotlin-js,react,react-router-dom,redux,styled-components pushed_at:2023-04 star:1.2k fork:0.2k Kotlin wrappers for popular JavaScript libraries
- [JetBrains/kotlinconf-app](https://github.com/JetBrains/kotlinconf-app) topic: pushed_at:2023-04 star:2.7k fork:0.3k KotlinConf Schedule Application
...
- [JetBrains/swot](https://github.com/JetBrains/swot) topic: pushed_at:2023-04 star:1.5k fork:14.7k Identify email addresses or domains names that belong to colleges or universities. Help automate the process of approving or rejecting academic discounts.
...
- [JetBrains/Rkernel-proto](https://github.com/JetBrains/Rkernel-proto) topic: pushed_at:2023-04 star:0.0k fork:0.0k 
- [JetBrains/scoop-utils](https://github.com/JetBrains/scoop-utils) topic: pushed_at:2023-04 star:0.0k fork:0.0k 
...
- [JetBrains/teamcity-documentation](https://github.com/JetBrains/teamcity-documentation) topic: pushed_at:2023-04 star:0.0k fork:0.1k Source repository of TeamCity Help
...
- [JetBrains/phpstorm-stubs](https://github.com/JetBrains/phpstorm-stubs) topic: pushed_at:2023-04 star:1.2k fork:0.8k PHP runtime & extensions header files for PhpStorm
...
- [JetBrains/Rkernel](https://github.com/JetBrains/Rkernel) topic: pushed_at:2023-04 star:0.0k fork:0.0k 
...
- [JetBrains/homebrew-utils](https://github.com/JetBrains/homebrew-utils) topic: pushed_at:2023-04 star:0.0k fork:0.0k 
...
- [JetBrains/clion-bundle-buildenv](https://github.com/JetBrains/clion-bundle-buildenv) topic:build,cmake,cross-compilation,dockerfile,gdb,lldb,makepkg,mingw-w64,pkgbuild pushed_at:2023-04 star:0.0k fork:0.0k Dockerfile for building GDB/LLDB for MinGW-W64 and Linux
- [JetBrains/clion-wsl](https://github.com/JetBrains/clion-wsl) topic: pushed_at:2021-08 star:0.1k fork:0.1k 
- [JetBrains/datalore-configs](https://github.com/JetBrains/datalore-configs) topic: pushed_at:2023-04 star:0.0k fork:0.0k 
...
- [JetBrains/ij-perf-report-aggregator](https://github.com/JetBrains/ij-perf-report-aggregator) topic: pushed_at:2023-04 star:0.0k fork:0.0k 
