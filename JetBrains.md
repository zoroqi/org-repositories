...
- [JetBrains/CMake](https://github.com/JetBrains/CMake) topic: pushed_at:2025-04 star:0.0k fork:0.0k CMake with debugging support. Based on initial @sysprogs fork. 
...
- [JetBrains/roslyn](https://github.com/JetBrains/roslyn) topic: pushed_at:2025-04 star:0.0k fork:0.0k The .NET Compiler Platform ("Roslyn") provides open-source C# and Visual Basic compilers with rich code analysis APIs.
...
- [JetBrains/devcontainers-examples](https://github.com/JetBrains/devcontainers-examples) topic: pushed_at:2025-03 star:0.1k fork:0.0k 
...
- [JetBrains/fsharp](https://github.com/JetBrains/fsharp) topic: pushed_at:2025-04 star:0.0k fork:0.0k The Visual F# compiler and tools
...
- [JetBrains/commit-status-publisher](https://github.com/JetBrains/commit-status-publisher) topic: pushed_at:2025-04 star:0.1k fork:0.1k TeamCity commit status publisher
...
- [JetBrains/intellij-community](https://github.com/JetBrains/intellij-community) topic:code-editor,ide,intellij,intellij-community,intellij-platform pushed_at:2025-05 star:17.9k fork:5.4k IntelliJ IDEA Community Edition & IntelliJ Platform
...
- [JetBrains/JetBrainsRuntime](https://github.com/JetBrains/JetBrainsRuntime) topic:intellij-platform,jdk,openjdk pushed_at:2025-05 star:1.6k fork:0.2k Runtime environment based on OpenJDK for running IntelliJ Platform-based products on Windows, macOS, and Linux
...
- [JetBrains/pty4j](https://github.com/JetBrains/pty4j) topic: pushed_at:2025-04 star:0.4k fork:0.1k Pty for Java
...
- [JetBrains/TeamCity.SonarQubePlugin](https://github.com/JetBrains/TeamCity.SonarQubePlugin) topic: pushed_at:2025-04 star:0.1k fork:0.0k A plugin for TeamCity server allowing you to configure and run SonarQube analysis from the CI
...
- [JetBrains/kotlin-playground](https://github.com/JetBrains/kotlin-playground) topic:kotlin,kotlin-playground,playground pushed_at:2025-04 star:0.5k fork:0.1k Self-contained component to embed in websites for running Kotlin code
...
- [JetBrains/mcp-jetbrains](https://github.com/JetBrains/mcp-jetbrains) topic:ide,intellij,jetbrains,mcp,mcp-server,pycharm pushed_at:2025-05 star:0.6k fork:0.0k A model context protocol server to work with JetBrains IDEs: IntelliJ, PyCharm, WebStorm, etc. Also, works with Android Studio
...
- [JetBrains/xdebug-extension](https://github.com/JetBrains/xdebug-extension) topic: pushed_at:2025-04 star:0.1k fork:0.0k A modern, dependency-free, cross-browser extension for Xdebug.
...
- [JetBrains/MPS-extensions](https://github.com/JetBrains/MPS-extensions) topic:jetbrains-mps pushed_at:2025-05 star:0.1k fork:0.1k MPS-extensions aims to ease language development within MPS.
...
- [JetBrains/amper](https://github.com/JetBrains/amper) topic:build-tool,compose,fleet,intellij,jetbrains,jvm,kotlin,kotlin-multiplatform pushed_at:2025-05 star:1.3k fork:0.0k Amper - a project configuration and build tool with a focus on the user experience and the IDE support
...
- [JetBrains/compose-hot-reload](https://github.com/JetBrains/compose-hot-reload) topic:compose,compose-desktop,compose-hot-reload,compose-multiplatform,firework,hot-reload,kotlin pushed_at:2025-05 star:1.1k fork:0.0k Compose Hot Reload: Make changes to your UI code in a Compose Multiplatform application, and see the results in real time. No restarts required. Compose Hot Reload runs your application on the JetBrains Runtime and intelligently reloads your code whenever it is changed.
- [JetBrains/compose-multiplatform](https://github.com/JetBrains/compose-multiplatform) topic:android,awt,compose,declarative-ui,desktop,gui,ios,javascript,kotlin,multiplatform,reactive,swing,ui,wasm,web,webassembly pushed_at:2025-05 star:17.5k fork:1.3k Compose Multiplatform, a modern UI framework for Kotlin that makes building performant and beautiful user interfaces easy and enjoyable.
...
- [JetBrains/Exposed](https://github.com/JetBrains/Exposed) topic:dao,kotlin,orm,sql pushed_at:2025-05 star:8.7k fork:0.7k Kotlin SQL Framework
...
- [JetBrains/hirschgarten](https://github.com/JetBrains/hirschgarten) topic:bazel,bazel-rules,intellij-idea,intellij-plugin pushed_at:2025-05 star:0.1k fork:0.0k A new approach to Bazel support for IntelliJ IDEA
...
- [JetBrains/ideavim](https://github.com/JetBrains/ideavim) topic:ideavim,intellij,intellij-platform,intellij-plugin,jb-official,jetbrains,kotlin,vim pushed_at:2025-05 star:9.7k fork:0.8k IdeaVim – A Vim engine for JetBrains IDEs
...
- [JetBrains/kotlin](https://github.com/JetBrains/kotlin) topic:compiler,gradle-plugin,intellij-plugin,kotlin,kotlin-library,maven-plugin,programming-language,wasm,webassembly pushed_at:2025-05 star:50.5k fork:5.9k The Kotlin Programming Language. 
...
- [JetBrains/kotlin-wrappers](https://github.com/JetBrains/kotlin-wrappers) topic:css,kotlin,kotlin-js,react,react-router-dom,styled-components pushed_at:2025-05 star:1.5k fork:0.2k Kotlin wrappers for popular JavaScript libraries
...
- [JetBrains/rider-efcore](https://github.com/JetBrains/rider-efcore) topic:dotnet,dotnet-core,dotnet-ef,ef-core,entity-framework,entity-framework-core,jetbrains-plugin,jetbrains-rider pushed_at:2025-04 star:0.2k fork:0.0k Entity Framework Core UI plugin for JetBrains Rider
...
- [JetBrains/swot](https://github.com/JetBrains/swot) topic: pushed_at:2025-05 star:1.9k fork:26.2k Identify email addresses or domains names that belong to colleges or universities. Help automate the process of approving or rejecting academic discounts.
...
- [JetBrains/marketplace-docs](https://github.com/JetBrains/marketplace-docs) topic:docs,intellij-plugin,jetbrains,marketplace pushed_at:2025-04 star:0.0k fork:0.0k JetBrains Marketplace Documentation
...
- [JetBrains/sbt-idea-plugin](https://github.com/JetBrains/sbt-idea-plugin) topic:intellij,intellij-ide,intellij-platform,intellij-plugin,plugin-sbt,sbt,sbt-plugin pushed_at:2025-04 star:0.1k fork:0.0k Develop IntelliJ plugins with Scala and SBT
...
- [JetBrains/JetBrainsMono](https://github.com/JetBrains/JetBrainsMono) topic:coding-font,font,ligatures,monospaced-font,programming-font,programming-ligatures pushed_at:2025-01 star:11.6k fork:0.3k JetBrains Mono – the free and open-source typeface for developers
