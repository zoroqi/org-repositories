...
- [apple/swift-crypto](https://github.com/apple/swift-crypto) topic:boringssl,ciphers,cryptography,ecdh,ecdsa,eddsa,elliptic-curves,hash-functions,swift,swift-crypto pushed_at:2026-03 star:1.7k fork:0.2k Open-source implementation of a substantial portion of the API of Apple CryptoKit suitable for use on Linux platforms.
- [apple/swift-nio-ssl](https://github.com/apple/swift-nio-ssl) topic:swift5,swiftnio,tls,tls-support pushed_at:2026-03 star:0.4k fork:0.2k TLS Support for SwiftNIO, based on BoringSSL.
...
- [apple/StreamingSession](https://github.com/apple/StreamingSession) topic: pushed_at:2026-03 star:0.0k fork:0.0k Streaming immersive content from a CloudXR™ application to visionOS and iOS
...
- [apple/SwiftUsd](https://github.com/apple/SwiftUsd) topic: pushed_at:2026-03 star:0.1k fork:0.0k A Swift Package for using OpenUSD in Swift
...
- [apple/pkl-lang.org](https://github.com/apple/pkl-lang.org) topic: pushed_at:2026-03 star:0.1k fork:0.0k The pkl-lang.org website

## Go

- [apple/container-builder-shim](https://github.com/apple/container-builder-shim) topic: pushed_at:2026-03 star:0.1k fork:0.0k Shim for connecting Swift host code to BuildKit running in a container. 
...
- [apple/pkl-go](https://github.com/apple/pkl-go) topic: pushed_at:2026-03 star:0.3k fork:0.0k Pkl bindings for the Go programming language
- [apple/pkl-go-examples](https://github.com/apple/pkl-go-examples) topic: pushed_at:2026-03 star:0.2k fork:0.0k Examples for using Pkl within Go applications
...
- [apple/app-store-server-library-java](https://github.com/apple/app-store-server-library-java) topic: pushed_at:2026-03 star:0.3k fork:0.1k The Java server library for the App Store Server API and App Store Server Notifications.
...
- [apple/pkl](https://github.com/apple/pkl) topic:config,configuration,data,functional,java,json,kotlin,language,object-oriented,pkl,programming-language,properties,propertylist,validation,xml,yaml pushed_at:2026-03 star:11.1k fork:0.4k A configuration as code language with rich validation and tooling.
- [apple/pkl-spring](https://github.com/apple/pkl-spring) topic: pushed_at:2026-03 star:0.0k fork:0.0k Spring Boot extension for configuring Boot apps with Pkl
- [apple/pollianna](https://github.com/apple/pollianna) topic: pushed_at:2026-01 star:0.1k fork:0.0k 
- [apple/servicetalk](https://github.com/apple/servicetalk) topic:framework,grpc,http,http2,java,microservices,netty,reactive,reactive-streams,rpc pushed_at:2026-03 star:1.0k fork:0.2k A networking framework that evolves with your application

## JavaScript

- [apple/highlightjs-pkl](https://github.com/apple/highlightjs-pkl) topic: pushed_at:2026-03 star:0.0k fork:0.0k Highlight.js syntax highlighting for Pkl
...
- [apple/password-manager-resources](https://github.com/apple/password-manager-resources) topic: pushed_at:2026-03 star:4.7k fork:0.6k A place for creators and users of password managers to collaborate on resources to make password management better.
...
- [apple/pfl-research](https://github.com/apple/pfl-research) topic:differential-privacy,federated-learning,federated-learning-framework,machine-learning,privacy pushed_at:2026-03 star:0.4k fork:0.0k Simulation framework for accelerating research in Private Federated Learning
...
- [apple/pkl-package-docs](https://github.com/apple/pkl-package-docs) topic: pushed_at:2026-03 star:0.0k fork:0.0k Documentation for Pkl packages
...
- [apple/ml-lito](https://github.com/apple/ml-lito) topic: pushed_at:2026-03 star:0.0k fork:0.0k [ICLR 2026] LiTo: Surface Light Field Tokenizatio
...
- [apple/ml-over-searching](https://github.com/apple/ml-over-searching) topic: pushed_at:2026-03 star:0.0k fork:0.0k 
...
- [apple/pkl-evolution](https://github.com/apple/pkl-evolution) topic: pushed_at:2026-02 star:0.0k fork:0.0k Suggested Pkl Improvements, Changes, or Enhancements (SPICEs)
...
- [apple/pkl-pantry](https://github.com/apple/pkl-pantry) topic: pushed_at:2026-03 star:0.3k fork:0.0k Shared Pkl packages
- [apple/pkl-project-commons](https://github.com/apple/pkl-project-commons) topic:pkl pushed_at:2026-03 star:0.0k fork:0.0k Internal utility libraries for Pkl
...
- [apple/app-store-server-library-python](https://github.com/apple/app-store-server-library-python) topic: pushed_at:2026-03 star:0.3k fork:0.0k The Python server library for the App Store Server API and App Store Server Notifications.
...
- [apple/axlearn](https://github.com/apple/axlearn) topic:deep-learning,jax pushed_at:2026-02 star:2.3k fork:0.4k An Extensible Deep Learning Library
...
- [apple/coremltools](https://github.com/apple/coremltools) topic:coreml,coremltools,machine-learning,model-conversion,model-converter,pytorch,tensorflow pushed_at:2026-03 star:5.2k fork:0.8k Core ML tools contain supporting tools for Core ML model conversion, editing, and validation.
...
- [apple/ml-mobileclip](https://github.com/apple/ml-mobileclip) topic: pushed_at:2025-10 star:1.5k fork:0.1k This repository contains the official implementation of the research papers, "MobileCLIP" CVPR 2024 and "MobileCLIP2" TMLR August 2025
...
- [apple/ml-sharp](https://github.com/apple/ml-sharp) topic: pushed_at:2025-12 star:8.0k fork:0.6k Sharp Monocular View Synthesis in Less Than a Second
...
- [apple/ml-ssd](https://github.com/apple/ml-ssd) topic: pushed_at:2026-03 star:0.0k fork:0.0k 
...
- [apple/app-store-server-library-swift](https://github.com/apple/app-store-server-library-swift) topic: pushed_at:2026-03 star:0.3k fork:0.1k The Swift server library for the App Store Server API and App Store Server Notifications.
...
- [apple/container](https://github.com/apple/container) topic: pushed_at:2026-04 star:25.6k fork:0.7k A tool for creating and running Linux containers using lightweight virtual machines on a Mac. It is written in Swift, and optimized for Apple silicon. 
- [apple/containerization](https://github.com/apple/containerization) topic: pushed_at:2026-03 star:8.4k fork:0.3k Containerization is a Swift package for running Linux containers on macOS.
...
- [apple/pir-service-example](https://github.com/apple/pir-service-example) topic: pushed_at:2026-03 star:0.2k fork:0.0k Example PIR service & documentation for Live Caller ID Lookup & NEURLFilter
- [apple/pkl-swift](https://github.com/apple/pkl-swift) topic: pushed_at:2026-03 star:0.2k fork:0.0k Pkl bindings for the Swift programming language
...
- [apple/swift-argument-parser](https://github.com/apple/swift-argument-parser) topic:cli,command-line,flag,option pushed_at:2026-03 star:3.7k fork:0.4k Straightforward, type-safe argument parsing for Swift
- [apple/swift-asn1](https://github.com/apple/swift-asn1) topic:asn1,der,swift pushed_at:2026-03 star:0.2k fork:0.1k An implementation of ASN.1 for Swift
...
- [apple/swift-async-dns-resolver](https://github.com/apple/swift-async-dns-resolver) topic: pushed_at:2026-03 star:0.2k fork:0.0k A Swift library for asynchronous DNS requests, wrapping c-ares with Swift-friendly APIs and data structures.
...
- [apple/swift-cassandra-client](https://github.com/apple/swift-cassandra-client) topic: pushed_at:2026-03 star:0.1k fork:0.0k Cassandra client in Swift
- [apple/swift-certificates](https://github.com/apple/swift-certificates) topic:certificates,swift,x509 pushed_at:2026-03 star:0.3k fork:0.1k An implementation of X.509 for Swift
- [apple/swift-cluster-membership](https://github.com/apple/swift-cluster-membership) topic:distributed-systems,server-side-swift,swift,swift-on-server pushed_at:2026-03 star:0.2k fork:0.0k Distributed Membership Protocol implementations in Swift
- [apple/swift-collections](https://github.com/apple/swift-collections) topic:collection,container,deque,dequeue,hash,ordered-dictionary,ordered-set,queue,sequence pushed_at:2026-03 star:4.4k fork:0.4k Commonly used data structures for Swift
...
- [apple/swift-configuration](https://github.com/apple/swift-configuration) topic:configuration,server,swift pushed_at:2026-03 star:0.8k fork:0.0k API package for reading configuration.
- [apple/swift-container-plugin](https://github.com/apple/swift-container-plugin) topic:containers,plugin,server-side-swift,swift,swift-package-manager,swift-package-manager-plugin,swiftpm pushed_at:2026-02 star:0.4k fork:0.0k Build and publish container images using Swift Package Manager
- [apple/swift-distributed-actors](https://github.com/apple/swift-distributed-actors) topic:actor-model,actors,distributed-systems,swift pushed_at:2026-03 star:0.7k fork:0.1k Peer-to-peer cluster implementation for Swift Distributed Actors
- [apple/swift-distributed-tracing](https://github.com/apple/swift-distributed-tracing) topic:distributed-systems,distributed-tracing,swift,tracing pushed_at:2026-03 star:0.3k fork:0.1k Instrumentation library for Swift server applications
...
- [apple/swift-homomorphic-encryption](https://github.com/apple/swift-homomorphic-encryption) topic:cryptography,homomorphic-encryption,swift pushed_at:2026-03 star:0.6k fork:0.0k Homomorphic Encryption library and applications in Swift
- [apple/swift-http-api-proposal](https://github.com/apple/swift-http-api-proposal) topic: pushed_at:2026-03 star:0.0k fork:0.0k This repository contains a proposal for standardized HTTP client and server APIs for the Swift ecosystem
- [apple/swift-http-structured-headers](https://github.com/apple/swift-http-structured-headers) topic:headers,http,structured-fields,swift pushed_at:2026-03 star:0.2k fork:0.0k A Swift implementation of the HTTP Structured Header Field specification.
- [apple/swift-http-types](https://github.com/apple/swift-http-types) topic: pushed_at:2025-11 star:1.0k fork:0.1k Version-independent HTTP currency types for Swift
- [apple/swift-llbuild2](https://github.com/apple/swift-llbuild2) topic: pushed_at:2026-03 star:0.3k fork:0.0k A fresh take on a low-level build system API.
- [apple/swift-log](https://github.com/apple/swift-log) topic:logging,swift-server pushed_at:2026-03 star:4.0k fork:0.3k A Logging API for Swift
- [apple/swift-metrics](https://github.com/apple/swift-metrics) topic:metrics,swift-server pushed_at:2026-03 star:0.8k fork:0.1k Metrics API for Swift
...
- [apple/swift-nio](https://github.com/apple/swift-nio) topic:asynchronous-io,event-driven,high-performance,networking,non-blocking,non-blocking-io,swift,swift-server,swift5,swiftnio pushed_at:2026-03 star:8.4k fork:0.7k Event-driven network application framework for high performance protocol servers & clients, non-blocking.
...
- [apple/swift-nio-extras](https://github.com/apple/swift-nio-extras) topic:swift5,swiftnio pushed_at:2026-03 star:0.3k fork:0.1k Useful code around SwiftNIO.
- [apple/swift-nio-http2](https://github.com/apple/swift-nio-http2) topic:async,beta,http2,swift5,swiftnio pushed_at:2026-03 star:0.5k fork:0.1k HTTP/2 support for SwiftNIO
- [apple/swift-nio-imap](https://github.com/apple/swift-nio-imap) topic: pushed_at:2026-03 star:0.1k fork:0.0k A Swift project that provides an implementation of the IMAP4rev1 protocol, built upon SwiftNIO.
...
- [apple/swift-nio-oblivious-http](https://github.com/apple/swift-nio-oblivious-http) topic: pushed_at:2026-03 star:0.1k fork:0.0k Package providing Oblivious HTTP.  Also allows Oblivious encryption of alternative encodings.
- [apple/swift-nio-ssh](https://github.com/apple/swift-nio-ssh) topic: pushed_at:2026-03 star:0.5k fork:0.1k SwiftNIO SSH is a programmatic implementation of SSH using SwiftNIO
...
- [apple/swift-nio-transport-services](https://github.com/apple/swift-nio-transport-services) topic: pushed_at:2026-03 star:0.3k fork:0.1k Extensions for SwiftNIO to support Apple platforms as first-class citizens.
...
- [apple/swift-openapi-generator](https://github.com/apple/swift-openapi-generator) topic:ios-swift,openapi,plugin,server-side-swift,swift,swiftpm pushed_at:2026-03 star:1.9k fork:0.2k Generate Swift client and server code from an OpenAPI document.
- [apple/swift-openapi-runtime](https://github.com/apple/swift-openapi-runtime) topic:middleware,openapi,swift,transport pushed_at:2026-03 star:0.3k fork:0.1k API package for code generated by Swift OpenAPI Generator.
- [apple/swift-openapi-urlsession](https://github.com/apple/swift-openapi-urlsession) topic:openapi,swift,transport,urlsession pushed_at:2026-03 star:0.2k fork:0.0k URLSession transport for Swift OpenAPI Generator.
...
- [apple/swift-protobuf](https://github.com/apple/swift-protobuf) topic: pushed_at:2026-03 star:4.9k fork:0.5k Plugin and runtime library for using protobuf with Swift
...
- [apple/swift-service-context](https://github.com/apple/swift-service-context) topic:async-context,baggage,baggage-context,concurrency,context-propagation,distributed-systems,sswg,trace-context pushed_at:2026-03 star:0.2k fork:0.0k Minimal type-safe context propagation container
- [apple/swift-service-discovery](https://github.com/apple/swift-service-discovery) topic: pushed_at:2026-03 star:0.2k fork:0.0k A service discovery API for Swift.
...
- [apple/swift-statsd-client](https://github.com/apple/swift-statsd-client) topic: pushed_at:2026-03 star:0.1k fork:0.0k metrics backend for swift-metrics that uses the statsd protocol
...
- [apple/swift-system-metrics](https://github.com/apple/swift-system-metrics) topic:metrics,process,server,swift,swift-server,system pushed_at:2026-03 star:0.1k fork:0.0k Report process-level system metrics (memory, CPU, file descriptors) to Swift Metrics
- [apple/swift-temporal-sdk](https://github.com/apple/swift-temporal-sdk) topic: pushed_at:2026-03 star:0.2k fork:0.0k Swift SDK for Temporal
- [apple/swift-tools-support-async](https://github.com/apple/swift-tools-support-async) topic: pushed_at:2026-03 star:0.0k fork:0.0k Common infrastructural helpers on top of NIO for llbuild2 and swiftpm-on-llbuild2 projects. This is NOT a general purpose package and is unlikely to ever become stable.
- [apple/swift-xcode-playground-support](https://github.com/apple/swift-xcode-playground-support) topic: pushed_at:2026-03 star:0.3k fork:0.1k Logging and communication to allow Swift toolchains to communicate with Xcode.
...
- [apple/app-store-server-library-node](https://github.com/apple/app-store-server-library-node) topic: pushed_at:2026-03 star:0.3k fork:0.1k The Node.js server library for the App Store Server API and App Store Server Notifications.
- [apple/embedding-atlas](https://github.com/apple/embedding-atlas) topic:embedding,visualization pushed_at:2026-03 star:4.7k fork:0.3k Embedding Atlas is a tool that provides interactive visualizations for large embeddings. It allows you to visualize, cross-filter, and search embeddings and metadata.
