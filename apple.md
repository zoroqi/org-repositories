...
- [apple/unityplugins](https://github.com/apple/unityplugins) topic: pushed_at:2026-03 star:1.0k fork:0.2k 
...
- [apple/foundationdb](https://github.com/apple/foundationdb) topic:acid,distributed-database,foundationdb,key-value-store,transactional pushed_at:2026-04 star:16.2k fork:1.5k FoundationDB - the open source, distributed, transactional key-value store
...
- [apple/pkl-readers](https://github.com/apple/pkl-readers) topic: pushed_at:2026-03 star:0.0k fork:0.0k Shared Pkl external readers
- [apple/publicsuffix-list](https://github.com/apple/publicsuffix-list) topic: pushed_at:2026-01 star:0.0k fork:0.0k The Public Suffix List
...
- [apple/pkl-intellij](https://github.com/apple/pkl-intellij) topic: pushed_at:2026-03 star:0.1k fork:0.0k JetBrains editor plugins providing Pkl language support
- [apple/pkl-lsp](https://github.com/apple/pkl-lsp) topic:lsp,lsp-server,pkl pushed_at:2026-03 star:0.1k fork:0.0k Language server for Pkl, implementing the server-side of the Language Server Protocol.
...
- [apple/tree-sitter-pkl](https://github.com/apple/tree-sitter-pkl) topic:pkl,tree-sitter pushed_at:2026-03 star:0.0k fork:0.0k Tree-sitter parser for Pkl
...
- [apple/pkl-neovim](https://github.com/apple/pkl-neovim) topic: pushed_at:2026-03 star:0.2k fork:0.0k Pkl language support for Neovim
...
- [apple/apple-root-program](https://github.com/apple/apple-root-program) topic: pushed_at:2026-02 star:0.0k fork:0.0k This repository hosts the official policy documentation and public communications for the Apple Root Program. It serves as the authoritative publication point for the Apple Root Program Policy and related materials intended for Certification Authorities, auditors, researchers, and other ecosystem participants.
...
- [apple/pkl-jvm-examples](https://github.com/apple/pkl-jvm-examples) topic: pushed_at:2026-03 star:0.1k fork:0.0k Examples for using Pkl within JVM applications
- [apple/pkl-k8s](https://github.com/apple/pkl-k8s) topic: pushed_at:2026-03 star:0.1k fork:0.0k Templates for using Pkl with Kubernetes
- [apple/pkl-k8s-examples](https://github.com/apple/pkl-k8s-examples) topic: pushed_at:2026-03 star:0.2k fork:0.0k Examples for using Pkl with Kubernetes
...
- [apple/pkl.tmbundle](https://github.com/apple/pkl.tmbundle) topic: pushed_at:2026-03 star:0.0k fork:0.0k TextMate bundle for Pkl
...
- [apple/axlearn](https://github.com/apple/axlearn) topic:deep-learning,jax pushed_at:2026-04 star:2.3k fork:0.4k An Extensible Deep Learning Library
...
- [apple/ml-depth-pro](https://github.com/apple/ml-depth-pro) topic: pushed_at:2025-04 star:5.4k fork:0.4k Depth Pro: Sharp Monocular Metric Depth in Less Than a Second.
...
- [apple/ml-fastvlm](https://github.com/apple/ml-fastvlm) topic: pushed_at:2025-05 star:7.3k fork:0.5k This repository contains the official implementation of "FastVLM: Efficient Vision Encoding for Vision Language Models" - CVPR 2025
...
- [apple/ml-sharp](https://github.com/apple/ml-sharp) topic: pushed_at:2025-12 star:8.1k fork:0.6k Sharp Monocular View Synthesis in Less Than a Second
...
- [apple/ml-tic-lm](https://github.com/apple/ml-tic-lm) topic: pushed_at:2026-03 star:0.0k fork:0.0k Repository for the paper: "TiC-LM: A Web-Scale Benchmark for Time-Continual LLM Pretraining" ACL Oral 2025
...
- [apple/rules_pkl](https://github.com/apple/rules_pkl) topic: pushed_at:2026-03 star:0.0k fork:0.0k Bazel build rules for Pkl
...
- [apple/container](https://github.com/apple/container) topic: pushed_at:2026-04 star:25.9k fork:0.7k A tool for creating and running Linux containers using lightweight virtual machines on a Mac. It is written in Swift, and optimized for Apple silicon. 
- [apple/containerization](https://github.com/apple/containerization) topic: pushed_at:2026-04 star:8.5k fork:0.3k Containerization is a Swift package for running Linux containers on macOS.
...
- [apple/pkl-swift-examples](https://github.com/apple/pkl-swift-examples) topic: pushed_at:2026-03 star:0.1k fork:0.0k Examples for using Pkl within Swift applications
...
- [apple/swift-collections](https://github.com/apple/swift-collections) topic:collection,container,deque,dequeue,hash,ordered-dictionary,ordered-set,queue,sequence pushed_at:2026-04 star:4.4k fork:0.4k Commonly used data structures for Swift
...
- [apple/swift-nio-extras](https://github.com/apple/swift-nio-extras) topic:swift5,swiftnio pushed_at:2026-04 star:0.3k fork:0.1k Useful code around SwiftNIO.
...
- [apple/swift-temporal-sdk](https://github.com/apple/swift-temporal-sdk) topic: pushed_at:2026-04 star:0.2k fork:0.0k Swift SDK for Temporal
...
- [apple/app-store-server-library-node](https://github.com/apple/app-store-server-library-node) topic: pushed_at:2026-04 star:0.3k fork:0.1k The Node.js server library for the App Store Server API and App Store Server Notifications.
- [apple/embedding-atlas](https://github.com/apple/embedding-atlas) topic:embedding,visualization pushed_at:2026-04 star:4.7k fork:0.3k Embedding Atlas is a tool that provides interactive visualizations for large embeddings. It allows you to visualize, cross-filter, and search embeddings and metadata.
...
- [apple/pkl-vscode](https://github.com/apple/pkl-vscode) topic: pushed_at:2026-03 star:0.1k fork:0.0k Pkl language support for VS Code
