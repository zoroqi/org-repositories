...
- [apple/swift-crypto](https://github.com/apple/swift-crypto) topic:boringssl,ciphers,cryptography,ecdh,ecdsa,eddsa,elliptic-curves,hash-functions,swift,swift-crypto pushed_at:2025-11 star:1.7k fork:0.2k Open-source implementation of a substantial portion of the API of Apple CryptoKit suitable for use on Linux platforms.
- [apple/swift-nio-ssl](https://github.com/apple/swift-nio-ssl) topic:swift5,swiftnio,tls,tls-support pushed_at:2025-10 star:0.4k fork:0.2k TLS Support for SwiftNIO, based on BoringSSL.
...
- [apple/foundationdb](https://github.com/apple/foundationdb) topic:acid,distributed-database,foundationdb,key-value-store,transactional pushed_at:2026-02 star:16.1k fork:1.5k FoundationDB - the open source, distributed, transactional key-value store
...
- [apple/SwiftUsd](https://github.com/apple/SwiftUsd) topic: pushed_at:2026-01 star:0.1k fork:0.0k A Swift Package for using OpenUSD in Swift
- [apple/SwiftUsd-ast-answerer](https://github.com/apple/SwiftUsd-ast-answerer) topic: pushed_at:2025-11 star:0.0k fork:0.0k Code generation tool for SwiftUsd
...
- [apple/pkl-go-examples](https://github.com/apple/pkl-go-examples) topic: pushed_at:2026-01 star:0.2k fork:0.0k Examples for using Pkl within Go applications
...
- [apple/pkl](https://github.com/apple/pkl) topic:config,configuration,data,functional,java,json,kotlin,language,object-oriented,pkl,programming-language,properties,propertylist,validation,xml,yaml pushed_at:2026-02 star:11.0k fork:0.4k A configuration as code language with rich validation and tooling.
...
- [apple/highlightjs-pkl](https://github.com/apple/highlightjs-pkl) topic: pushed_at:2026-01 star:0.0k fork:0.0k Highlight.js syntax highlighting for Pkl
...
- [apple/pkl-neovim](https://github.com/apple/pkl-neovim) topic: pushed_at:2026-01 star:0.2k fork:0.0k Pkl language support for Neovim
...
- [apple/pkl-evolution](https://github.com/apple/pkl-evolution) topic: pushed_at:2026-01 star:0.0k fork:0.0k Suggested Pkl Improvements, Changes, or Enhancements (SPICEs)
...
- [apple/pkl-jvm-examples](https://github.com/apple/pkl-jvm-examples) topic: pushed_at:2026-01 star:0.1k fork:0.0k Examples for using Pkl within JVM applications
...
- [apple/pkl-k8s-examples](https://github.com/apple/pkl-k8s-examples) topic: pushed_at:2026-01 star:0.2k fork:0.0k Examples for using Pkl with Kubernetes
...
- [apple/pkl.tmbundle](https://github.com/apple/pkl.tmbundle) topic: pushed_at:2026-01 star:0.0k fork:0.0k TextMate bundle for Pkl
...
- [apple/coremltools](https://github.com/apple/coremltools) topic:coreml,coremltools,machine-learning,model-conversion,model-converter,pytorch,tensorflow pushed_at:2026-01 star:5.2k fork:0.8k Core ML tools contain supporting tools for Core ML model conversion, editing, and validation.
...
- [apple/ml-clara](https://github.com/apple/ml-clara) topic: pushed_at:2025-12 star:1.0k fork:0.1k 
...
- [apple/ml-egodex](https://github.com/apple/ml-egodex) topic: pushed_at:2025-08 star:0.1k fork:0.0k EgoDex: Learning Dexterous Manipulation from Large-Scale Egocentric Video
...
- [apple/ml-sharp](https://github.com/apple/ml-sharp) topic: pushed_at:2025-12 star:7.6k fork:0.5k Sharp Monocular View Synthesis in Less Than a Second
...
- [apple/ml-tic-lm](https://github.com/apple/ml-tic-lm) topic: pushed_at:2026-01 star:0.0k fork:0.0k Repository for the paper: "TiC-LM: A Web-Scale Benchmark for Time-Continual LLM Pretraining" ACL Oral 2025
...
- [apple/container](https://github.com/apple/container) topic: pushed_at:2026-02 star:24.5k fork:0.6k A tool for creating and running Linux containers using lightweight virtual machines on a Mac. It is written in Swift, and optimized for Apple silicon. 
- [apple/containerization](https://github.com/apple/containerization) topic: pushed_at:2026-02 star:8.3k fork:0.2k Containerization is a Swift package for running Linux containers on macOS.
...
- [apple/pkl-swift-examples](https://github.com/apple/pkl-swift-examples) topic: pushed_at:2026-01 star:0.1k fork:0.0k Examples for using Pkl within Swift applications
...
- [apple/security-pcc](https://github.com/apple/security-pcc) topic: pushed_at:2025-10 star:0.9k fork:0.1k Private Cloud Compute (PCC)
...
- [apple/swift-http-structured-headers](https://github.com/apple/swift-http-structured-headers) topic:headers,http,structured-fields,swift pushed_at:2025-11 star:0.2k fork:0.0k A Swift implementation of the HTTP Structured Header Field specification.
...
- [apple/swift-nio-extras](https://github.com/apple/swift-nio-extras) topic:swift5,swiftnio pushed_at:2026-01 star:0.2k fork:0.1k Useful code around SwiftNIO.
...
- [apple/swift-nio-oblivious-http](https://github.com/apple/swift-nio-oblivious-http) topic: pushed_at:2025-11 star:0.1k fork:0.0k Package providing Oblivious HTTP.  Also allows Oblivious encryption of alternative encodings.
- [apple/swift-nio-ssh](https://github.com/apple/swift-nio-ssh) topic: pushed_at:2025-11 star:0.5k fork:0.1k SwiftNIO SSH is a programmatic implementation of SSH using SwiftNIO
...
- [apple/swift-nio-transport-services](https://github.com/apple/swift-nio-transport-services) topic: pushed_at:2025-11 star:0.3k fork:0.1k Extensions for SwiftNIO to support Apple platforms as first-class citizens.
...
- [apple/swift-openapi-generator](https://github.com/apple/swift-openapi-generator) topic:ios-swift,openapi,plugin,server-side-swift,swift,swiftpm pushed_at:2026-01 star:1.8k fork:0.2k Generate Swift client and server code from an OpenAPI document.
- [apple/swift-openapi-runtime](https://github.com/apple/swift-openapi-runtime) topic:middleware,openapi,swift,transport pushed_at:2025-12 star:0.3k fork:0.1k API package for code generated by Swift OpenAPI Generator.
...
- [apple/SwiftUsd-Tests](https://github.com/apple/SwiftUsd-Tests) topic: pushed_at:2026-01 star:0.0k fork:0.0k Unit tests for SwiftUsd
...
- [apple/pkl-vscode](https://github.com/apple/pkl-vscode) topic: pushed_at:2026-01 star:0.1k fork:0.0k Pkl language support for VS Code
