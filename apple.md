...
- [apple/foundationdb](https://github.com/apple/foundationdb) topic:acid,distributed-database,foundationdb,key-value-store,transactional pushed_at:2026-07 star:16.5k fork:1.5k FoundationDB - the open source, distributed, transactional key-value store
...
- [apple/password-manager-resources](https://github.com/apple/password-manager-resources) topic: pushed_at:2026-07 star:4.8k fork:0.6k A place for creators and users of password managers to collaborate on resources to make password management better.
...
- [apple/ml-sharp](https://github.com/apple/ml-sharp) topic: pushed_at:2025-12 star:8.7k fork:0.6k Sharp Monocular View Synthesis in Less Than a Second
...
- [apple/container](https://github.com/apple/container) topic: pushed_at:2026-07 star:47.9k fork:1.5k A tool for creating and running Linux containers using lightweight virtual machines on a Mac. It is written in Swift, and optimized for Apple silicon. 
...
- [apple/coreai-models](https://github.com/apple/coreai-models) topic: pushed_at:2026-07 star:1.4k fork:0.1k Model export recipes, Python primitives, and Swift runtime utilities for on-device AI
...
- [apple/foundation-models-utilities](https://github.com/apple/foundation-models-utilities) topic: pushed_at:2026-07 star:0.4k fork:0.0k Emerging and experimental patterns for building with the Foundation Models framework
...
- [apple/swift-homomorphic-encryption](https://github.com/apple/swift-homomorphic-encryption) topic:cryptography,homomorphic-encryption,swift pushed_at:2026-07 star:0.6k fork:0.0k Homomorphic Encryption library and applications in Swift
...
- [apple/swift-nio-quic](https://github.com/apple/swift-nio-quic) topic:networking,quic,swift-nio,swift-server pushed_at:2026-07 star:0.0k fork:0.0k QUIC support for SwiftNIO
...
- [apple/swift-openapi-generator](https://github.com/apple/swift-openapi-generator) topic:ios-swift,openapi,plugin,server-side-swift,swift,swiftpm pushed_at:2026-07 star:1.9k fork:0.2k Generate Swift client and server code from an OpenAPI document.
