...
- [apple/foundationdb](https://github.com/apple/foundationdb) topic:acid,distributed-database,foundationdb,key-value-store,transactional pushed_at:2025-11 star:15.8k fork:1.4k FoundationDB - the open source, distributed, transactional key-value store
...
- [apple/pkl](https://github.com/apple/pkl) topic:config,configuration,data,functional,java,json,kotlin,language,object-oriented,pkl,programming-language,properties,propertylist,validation,xml,yaml pushed_at:2025-11 star:10.9k fork:0.3k A configuration as code language with rich validation and tooling.
- [apple/pkl-spring](https://github.com/apple/pkl-spring) topic: pushed_at:2025-10 star:0.0k fork:0.0k Spring Boot extension for configuring Boot apps with Pkl
...
- [apple/pkl-project-commons](https://github.com/apple/pkl-project-commons) topic:pkl pushed_at:2025-11 star:0.0k fork:0.0k Utility libraries for Pkl
...
- [apple/coremltools](https://github.com/apple/coremltools) topic:coreml,coremltools,machine-learning,model-conversion,model-converter,pytorch,tensorflow pushed_at:2025-11 star:5.0k fork:0.7k Core ML tools contain supporting tools for Core ML model conversion, editing, and validation.
...
- [apple/ml-cross-entropy](https://github.com/apple/ml-cross-entropy) topic: pushed_at:2025-09 star:0.5k fork:0.1k 
...
- [apple/ml-fastvlm](https://github.com/apple/ml-fastvlm) topic: pushed_at:2025-05 star:6.9k fork:0.5k This repository contains the official implementation of "FastVLM: Efficient Vision Encoding for Vision Language Models" - CVPR 2025
...
- [apple/pico-banana-400k](https://github.com/apple/pico-banana-400k) topic: pushed_at:2025-10 star:1.6k fork:0.1k 
...
- [apple/app-store-server-library-swift](https://github.com/apple/app-store-server-library-swift) topic: pushed_at:2025-11 star:0.3k fork:0.1k The Swift server library for the App Store Server API and App Store Server Notifications.
...
- [apple/container](https://github.com/apple/container) topic: pushed_at:2025-11 star:22.2k fork:0.5k A tool for creating and running Linux containers using lightweight virtual machines on a Mac. It is written in Swift, and optimized for Apple silicon. 
...
- [apple/swift-argument-parser](https://github.com/apple/swift-argument-parser) topic:cli,command-line,flag,option pushed_at:2025-10 star:3.6k fork:0.4k Straightforward, type-safe argument parsing for Swift
...
- [apple/swift-async-algorithms](https://github.com/apple/swift-async-algorithms) topic:swift pushed_at:2025-10 star:3.5k fork:0.2k Async Algorithms for Swift
...
- [apple/swift-atomics](https://github.com/apple/swift-atomics) topic:concurrency,synchronization pushed_at:2025-09 star:1.2k fork:0.1k Low-level atomic operations for Swift
...
- [apple/swift-certificates](https://github.com/apple/swift-certificates) topic:certificates,swift,x509 pushed_at:2025-10 star:0.3k fork:0.1k An implementation of X.509 for Swift
...
- [apple/swift-collections](https://github.com/apple/swift-collections) topic:collection,container,deque,dequeue,hash,ordered-dictionary,ordered-set,queue,sequence pushed_at:2025-11 star:4.2k fork:0.4k Commonly used data structures for Swift
...
- [apple/swift-distributed-actors](https://github.com/apple/swift-distributed-actors) topic:actor-model,actors,distributed-systems,swift pushed_at:2025-10 star:0.7k fork:0.1k Peer-to-peer cluster implementation for Swift Distributed Actors
- [apple/swift-distributed-tracing](https://github.com/apple/swift-distributed-tracing) topic:distributed-systems,distributed-tracing,swift,tracing pushed_at:2025-11 star:0.3k fork:0.1k Instrumentation library for Swift server applications
...
- [apple/swift-homomorphic-encryption](https://github.com/apple/swift-homomorphic-encryption) topic:cryptography,homomorphic-encryption,swift pushed_at:2025-10 star:0.6k fork:0.0k Homomorphic Encryption library and applications in Swift
...
- [apple/swift-http-types](https://github.com/apple/swift-http-types) topic: pushed_at:2025-10 star:1.0k fork:0.1k Version-independent HTTP currency types for Swift
- [apple/swift-llbuild2](https://github.com/apple/swift-llbuild2) topic: pushed_at:2025-10 star:0.3k fork:0.0k A fresh take on a low-level build system API.
...
- [apple/swift-nio-examples](https://github.com/apple/swift-nio-examples) topic: pushed_at:2025-10 star:0.2k fork:0.1k examples of how to use swift-nio
...
- [apple/swift-nio-transport-services](https://github.com/apple/swift-nio-transport-services) topic: pushed_at:2025-10 star:0.3k fork:0.1k Extensions for SwiftNIO to support Apple platforms as first-class citizens.
...
- [apple/embedding-atlas](https://github.com/apple/embedding-atlas) topic:embedding,visualization pushed_at:2025-11 star:4.1k fork:0.2k Embedding Atlas is a tool that provides interactive visualizations for large embeddings. It allows you to visualize, cross-filter, and search embeddings and metadata.
