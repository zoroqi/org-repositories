...
- [apple/unityplugins](https://github.com/apple/unityplugins) topic: pushed_at:2025-10 star:0.9k fork:0.2k 
...
- [apple/container-builder-shim](https://github.com/apple/container-builder-shim) topic: pushed_at:2025-10 star:0.1k fork:0.0k Shim for connecting Swift host code to BuildKit running in a container. 
...
- [apple/pkl-go](https://github.com/apple/pkl-go) topic: pushed_at:2025-10 star:0.3k fork:0.0k Pkl bindings for the Go programming language
...
- [apple/app-store-server-library-java](https://github.com/apple/app-store-server-library-java) topic: pushed_at:2025-10 star:0.2k fork:0.1k The Java server library for the App Store Server API and App Store Server Notifications.
...
- [apple/pkl](https://github.com/apple/pkl) topic:config,configuration,data,functional,java,json,kotlin,language,object-oriented,pkl,programming-language,properties,propertylist,validation,xml,yaml pushed_at:2025-10 star:10.9k fork:0.3k A configuration as code language with rich validation and tooling.
...
- [apple/servicetalk](https://github.com/apple/servicetalk) topic:framework,grpc,http,http2,java,microservices,netty,reactive,reactive-streams,rpc pushed_at:2025-10 star:1.0k fork:0.2k A networking framework that evolves with your application
...
- [apple/password-manager-resources](https://github.com/apple/password-manager-resources) topic: pushed_at:2025-10 star:4.5k fork:0.5k A place for creators and users of password managers to collaborate on resources to make password management better.
- [apple/pkl-lang.org](https://github.com/apple/pkl-lang.org) topic: pushed_at:2025-10 star:0.1k fork:0.0k The pkl-lang.org website
...
- [apple/ml-atoken](https://github.com/apple/ml-atoken) topic: pushed_at:2025-10 star:0.1k fork:0.0k 
...
- [apple/pkl-intellij](https://github.com/apple/pkl-intellij) topic: pushed_at:2025-10 star:0.1k fork:0.0k JetBrains editor plugins providing Pkl language support
- [apple/pkl-lsp](https://github.com/apple/pkl-lsp) topic:lsp,lsp-server,pkl pushed_at:2025-10 star:0.1k fork:0.0k Language server for Pkl, implementing the server-side of the Language Server Protocol.
- [apple/pkl-package-docs](https://github.com/apple/pkl-package-docs) topic: pushed_at:2025-10 star:0.0k fork:0.0k Documentation for Pkl packages
- [apple/tree-sitter-pkl](https://github.com/apple/tree-sitter-pkl) topic:pkl,tree-sitter pushed_at:2025-10 star:0.0k fork:0.0k Tree-sitter parser for Pkl
...
- [apple/pkl-pantry](https://github.com/apple/pkl-pantry) topic: pushed_at:2025-10 star:0.3k fork:0.0k Shared Pkl packages
- [apple/pkl-project-commons](https://github.com/apple/pkl-project-commons) topic:pkl pushed_at:2025-10 star:0.0k fork:0.0k Utility libraries for Pkl
...
- [apple/app-store-server-library-python](https://github.com/apple/app-store-server-library-python) topic: pushed_at:2025-10 star:0.2k fork:0.0k The Python server library for the App Store Server API and App Store Server Notifications.
...
- [apple/axlearn](https://github.com/apple/axlearn) topic:deep-learning,jax pushed_at:2025-10 star:2.3k fork:0.4k An Extensible Deep Learning Library
...
- [apple/coremltools](https://github.com/apple/coremltools) topic:coreml,coremltools,machine-learning,model-conversion,model-converter,pytorch,tensorflow pushed_at:2025-09 star:5.0k fork:0.7k Core ML tools contain supporting tools for Core ML model conversion, editing, and validation.
...
- [apple/ml-cubifyanything](https://github.com/apple/ml-cubifyanything) topic: pushed_at:2025-09 star:0.3k fork:0.0k 
...
- [apple/ml-depth-pro](https://github.com/apple/ml-depth-pro) topic: pushed_at:2025-04 star:4.9k fork:0.4k Depth Pro: Sharp Monocular Metric Depth in Less Than a Second.
...
- [apple/ml-fastvlm](https://github.com/apple/ml-fastvlm) topic: pushed_at:2025-05 star:6.8k fork:0.5k This repository contains the official implementation of "FastVLM: Efficient Vision Encoding for Vision Language Models" - CVPR 2025
...
- [apple/pico-banana-400k](https://github.com/apple/pico-banana-400k) topic: pushed_at:2025-10 star:1.4k fork:0.1k 
...
- [apple/rules_pkl](https://github.com/apple/rules_pkl) topic: pushed_at:2025-10 star:0.0k fork:0.0k Bazel build rules for Pkl
...
- [apple/app-store-server-library-swift](https://github.com/apple/app-store-server-library-swift) topic: pushed_at:2025-10 star:0.3k fork:0.0k The Swift server library for the App Store Server API and App Store Server Notifications.
...
- [apple/container](https://github.com/apple/container) topic: pushed_at:2025-10 star:21.9k fork:0.5k A tool for creating and running Linux containers using lightweight virtual machines on a Mac. It is written in Swift, and optimized for Apple silicon. 
- [apple/containerization](https://github.com/apple/containerization) topic: pushed_at:2025-10 star:8.0k fork:0.2k Containerization is a Swift package for running Linux containers on macOS.
...
- [apple/pkl-swift](https://github.com/apple/pkl-swift) topic: pushed_at:2025-10 star:0.2k fork:0.0k Pkl bindings for the Swift programming language
...
- [apple/swift-algorithms](https://github.com/apple/swift-algorithms) topic:algorithm,iterator,itertools pushed_at:2025-09 star:6.3k fork:0.5k Commonly used sequence and collection algorithms for Swift
- [apple/swift-argument-parser](https://github.com/apple/swift-argument-parser) topic:cli,command-line,flag,option pushed_at:2025-10 star:3.6k fork:0.3k Straightforward, type-safe argument parsing for Swift
...
- [apple/swift-async-dns-resolver](https://github.com/apple/swift-async-dns-resolver) topic: pushed_at:2025-10 star:0.1k fork:0.0k A Swift library for asynchronous DNS requests, wrapping c-ares with Swift-friendly APIs and data structures.
...
- [apple/swift-cassandra-client](https://github.com/apple/swift-cassandra-client) topic: pushed_at:2025-10 star:0.1k fork:0.0k Cassandra client in Swift
...
- [apple/swift-collections](https://github.com/apple/swift-collections) topic:collection,container,deque,dequeue,hash,ordered-dictionary,ordered-set,queue,sequence pushed_at:2025-10 star:4.2k fork:0.4k Commonly used data structures for Swift
...
- [apple/swift-configuration](https://github.com/apple/swift-configuration) topic:configuration,server,swift pushed_at:2025-10 star:0.5k fork:0.0k API package for reading configuration.
- [apple/swift-container-plugin](https://github.com/apple/swift-container-plugin) topic:containers,plugin,server-side-swift,swift,swift-package-manager,swift-package-manager-plugin,swiftpm pushed_at:2025-10 star:0.3k fork:0.0k Build and publish container images using Swift Package Manager
...
- [apple/swift-distributed-tracing](https://github.com/apple/swift-distributed-tracing) topic:distributed-systems,distributed-tracing,swift,tracing pushed_at:2025-10 star:0.3k fork:0.1k Instrumentation library for Swift server applications
...
- [apple/swift-http-structured-headers](https://github.com/apple/swift-http-structured-headers) topic:headers,http,structured-fields,swift pushed_at:2025-10 star:0.2k fork:0.0k A Swift implementation of the HTTP Structured Header Field specification.
...
- [apple/swift-log](https://github.com/apple/swift-log) topic:logging,swift-server pushed_at:2025-10 star:3.8k fork:0.3k A Logging API for Swift
...
- [apple/swift-metrics-extras](https://github.com/apple/swift-metrics-extras) topic: pushed_at:2025-10 star:0.1k fork:0.0k 
...
- [apple/swift-nio](https://github.com/apple/swift-nio) topic:asynchronous-io,event-driven,high-performance,networking,non-blocking,non-blocking-io,swift,swift-server,swift5,swiftnio pushed_at:2025-10 star:8.3k fork:0.7k Event-driven network application framework for high performance protocol servers & clients, non-blocking.
...
- [apple/swift-nio-extras](https://github.com/apple/swift-nio-extras) topic:swift5,swiftnio pushed_at:2025-10 star:0.2k fork:0.1k Useful code around SwiftNIO.
- [apple/swift-nio-http2](https://github.com/apple/swift-nio-http2) topic:async,beta,http2,swift5,swiftnio pushed_at:2025-10 star:0.5k fork:0.1k HTTP/2 support for SwiftNIO
- [apple/swift-nio-imap](https://github.com/apple/swift-nio-imap) topic: pushed_at:2025-10 star:0.1k fork:0.0k A Swift project that provides an implementation of the IMAP4rev1 protocol, built upon SwiftNIO.
...
- [apple/swift-nio-oblivious-http](https://github.com/apple/swift-nio-oblivious-http) topic: pushed_at:2025-10 star:0.1k fork:0.0k Package providing Oblivious HTTP.  Also allows Oblivious encryption of alternative encodings.
- [apple/swift-nio-ssh](https://github.com/apple/swift-nio-ssh) topic: pushed_at:2025-10 star:0.5k fork:0.1k SwiftNIO SSH is a programmatic implementation of SSH using SwiftNIO
...
- [apple/swift-numerics](https://github.com/apple/swift-numerics) topic:complex,math,mathematics,maths,real,trig pushed_at:2025-10 star:1.8k fork:0.2k Advanced mathematical types and functions for Swift
...
- [apple/swift-openapi-runtime](https://github.com/apple/swift-openapi-runtime) topic:middleware,openapi,swift,transport pushed_at:2025-10 star:0.2k fork:0.1k API package for code generated by Swift OpenAPI Generator.
...
- [apple/swift-play-experimental](https://github.com/apple/swift-play-experimental) topic: pushed_at:2025-10 star:0.1k fork:0.0k 
- [apple/swift-profile-recorder](https://github.com/apple/swift-profile-recorder) topic: pushed_at:2025-10 star:0.2k fork:0.0k 
- [apple/swift-protobuf](https://github.com/apple/swift-protobuf) topic: pushed_at:2025-10 star:4.8k fork:0.5k Plugin and runtime library for using protobuf with Swift
...
- [apple/swift-service-context](https://github.com/apple/swift-service-context) topic:async-context,baggage,baggage-context,concurrency,context-propagation,distributed-systems,sswg,trace-context pushed_at:2025-10 star:0.2k fork:0.0k Minimal type-safe context propagation container
...
- [apple/swift-system](https://github.com/apple/swift-system) topic:file-descriptor,file-path,posix pushed_at:2025-10 star:1.3k fork:0.1k Low-level system calls and types for Swift
- [apple/swift-temporal-sdk](https://github.com/apple/swift-temporal-sdk) topic: pushed_at:2025-10 star:0.1k fork:0.0k Swift SDK for Temporal
...
- [apple/swift-xcode-playground-support](https://github.com/apple/swift-xcode-playground-support) topic: pushed_at:2025-10 star:0.3k fork:0.1k Logging and communication to allow Swift toolchains to communicate with Xcode.
...
- [apple/app-store-server-library-node](https://github.com/apple/app-store-server-library-node) topic: pushed_at:2025-10 star:0.3k fork:0.1k The Node.js server library for the App Store Server API and App Store Server Notifications.
- [apple/embedding-atlas](https://github.com/apple/embedding-atlas) topic:embedding,visualization pushed_at:2025-10 star:4.0k fork:0.2k Embedding Atlas is a tool that provides interactive visualizations for large embeddings. It allows you to visualize, cross-filter, and search embeddings and metadata.
- [apple/ml-hierarchical-confusion-matrix](https://github.com/apple/ml-hierarchical-confusion-matrix) topic:confusion-matrix,data-visualization,machine-learning,visual-analytics pushed_at:2025-10 star:0.3k fork:0.0k Neo: Hierarchical Confusion Matrix Visualization (CHI 2022)
