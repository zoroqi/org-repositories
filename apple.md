...
- [apple/foundationdb](https://github.com/apple/foundationdb) topic:acid,distributed-database,foundationdb,key-value-store,transactional pushed_at:2025-07 star:15.6k fork:1.4k FoundationDB - the open source, distributed, transactional key-value store
...
- [apple/pkl-go-examples](https://github.com/apple/pkl-go-examples) topic: pushed_at:2025-07 star:0.2k fork:0.0k Examples for using Pkl within Go applications

## Groovy

- [apple/pkl-jvm-examples](https://github.com/apple/pkl-jvm-examples) topic: pushed_at:2025-07 star:0.1k fork:0.0k Examples for using Pkl within JVM applications
...
- [apple/app-store-server-library-java](https://github.com/apple/app-store-server-library-java) topic: pushed_at:2025-07 star:0.2k fork:0.1k The Java server library for the App Store Server API and App Store Server Notifications.
...
- [apple/pkl-intellij](https://github.com/apple/pkl-intellij) topic: pushed_at:2025-07 star:0.1k fork:0.0k JetBrains editor plugins providing Pkl language support
- [apple/pkl-lsp](https://github.com/apple/pkl-lsp) topic:lsp,lsp-server,pkl pushed_at:2025-07 star:0.1k fork:0.0k Language server for Pkl, implementing the server-side of the Language Server Protocol.
...
- [apple/pkl-evolution](https://github.com/apple/pkl-evolution) topic: pushed_at:2025-07 star:0.0k fork:0.0k Suggested Pkl Improvements, Changes, or Enhancements (SPICEs)
...
- [apple/app-store-server-library-python](https://github.com/apple/app-store-server-library-python) topic: pushed_at:2025-06 star:0.2k fork:0.0k The Python server library for the App Store Server API and App Store Server Notifications.
...
- [apple/ml-fastvlm](https://github.com/apple/ml-fastvlm) topic: pushed_at:2025-05 star:5.2k fork:0.3k This repository contains the official implementation of "FastVLM: Efficient Vision Encoding for Vision Language Models" - CVPR 2025
...
- [apple/ml-inrflow](https://github.com/apple/ml-inrflow) topic: pushed_at:2025-07 star:0.0k fork:0.0k 
...
- [apple/ml-tic-lm](https://github.com/apple/ml-tic-lm) topic: pushed_at:2025-07 star:0.0k fork:0.0k 
...
- [apple/rules_pkl](https://github.com/apple/rules_pkl) topic: pushed_at:2025-07 star:0.0k fork:0.0k Bazel build rules for Pkl
...
- [apple/app-store-server-library-swift](https://github.com/apple/app-store-server-library-swift) topic: pushed_at:2025-07 star:0.3k fork:0.0k The Swift server library for the App Store Server API and App Store Server Notifications.
...
- [apple/container](https://github.com/apple/container) topic: pushed_at:2025-07 star:17.9k fork:0.4k A tool for creating and running Linux containers using lightweight virtual machines on a Mac. It is written in Swift, and optimized for Apple silicon. 
- [apple/containerization](https://github.com/apple/containerization) topic: pushed_at:2025-07 star:7.6k fork:0.2k Containerization is a Swift package for running Linux containers on macOS.
...
- [apple/pkl-swift](https://github.com/apple/pkl-swift) topic: pushed_at:2025-07 star:0.2k fork:0.0k Pkl bindings for the Swift programming language
...
- [apple/swift-cassandra-client](https://github.com/apple/swift-cassandra-client) topic: pushed_at:2025-07 star:0.1k fork:0.0k Cassandra client in Swift
...
- [apple/swift-http-structured-headers](https://github.com/apple/swift-http-structured-headers) topic:headers,http,structured-fields,swift pushed_at:2025-07 star:0.2k fork:0.0k A Swift implementation of the HTTP Structured Header Field specification.
...
- [apple/swift-llbuild2](https://github.com/apple/swift-llbuild2) topic: pushed_at:2025-07 star:0.3k fork:0.0k A fresh take on a low-level build system API.
...
- [apple/swift-metrics](https://github.com/apple/swift-metrics) topic:metrics,swift-server pushed_at:2025-07 star:0.7k fork:0.1k Metrics API for Swift
...
- [apple/swift-nio-oblivious-http](https://github.com/apple/swift-nio-oblivious-http) topic: pushed_at:2025-07 star:0.1k fork:0.0k Package providing Oblivious HTTP.  Also allows Oblivious encryption of alternative encodings.
- [apple/swift-nio-ssh](https://github.com/apple/swift-nio-ssh) topic: pushed_at:2025-07 star:0.4k fork:0.1k SwiftNIO SSH is a programmatic implementation of SSH using SwiftNIO
...
- [apple/swift-nio-transport-services](https://github.com/apple/swift-nio-transport-services) topic: pushed_at:2025-07 star:0.3k fork:0.1k Extensions for SwiftNIO to support Apple platforms as first-class citizens.
...
- [apple/swift-openapi-runtime](https://github.com/apple/swift-openapi-runtime) topic:middleware,openapi,swift,transport pushed_at:2025-07 star:0.2k fork:0.1k API package for code generated by Swift OpenAPI Generator.
...
- [apple/app-store-server-library-node](https://github.com/apple/app-store-server-library-node) topic: pushed_at:2025-07 star:0.3k fork:0.1k The Node.js server library for the App Store Server API and App Store Server Notifications.
- [apple/embedding-atlas](https://github.com/apple/embedding-atlas) topic:embedding,visualization pushed_at:2025-07 star:0.3k fork:0.0k Embedding Atlas is a tool that provides interactive visualizations for large embeddings. It allows you to visualize, cross-filter, and search embeddings and metadata.
