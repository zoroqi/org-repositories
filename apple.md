...
- [apple/foundationdb](https://github.com/apple/foundationdb) topic:acid,distributed-database,foundationdb,key-value-store,transactional pushed_at:2025-07 star:15.5k fork:1.4k FoundationDB - the open source, distributed, transactional key-value store
...
- [apple/pkl-go](https://github.com/apple/pkl-go) topic: pushed_at:2025-07 star:0.3k fork:0.0k Pkl bindings for the Go programming language
...
- [apple/app-store-server-library-java](https://github.com/apple/app-store-server-library-java) topic: pushed_at:2025-07 star:0.2k fork:0.1k 
...
- [apple/pkl](https://github.com/apple/pkl) topic:config,configuration,data,functional,java,json,kotlin,language,object-oriented,pkl,programming-language,properties,propertylist,validation,xml,yaml pushed_at:2025-07 star:10.8k fork:0.3k A configuration as code language with rich validation and tooling.
...
- [apple/servicetalk](https://github.com/apple/servicetalk) topic:framework,grpc,http,http2,java,microservices,netty,reactive,reactive-streams,rpc pushed_at:2025-07 star:1.0k fork:0.2k A networking framework that evolves with your application
...
- [apple/password-manager-resources](https://github.com/apple/password-manager-resources) topic: pushed_at:2025-07 star:4.4k fork:0.5k A place for creators and users of password managers to collaborate on resources to make password management better.
- [apple/pkl-lang.org](https://github.com/apple/pkl-lang.org) topic: pushed_at:2025-07 star:0.1k fork:0.0k The pkl-lang.org website
...
- [apple/pkl-package-docs](https://github.com/apple/pkl-package-docs) topic: pushed_at:2025-07 star:0.0k fork:0.0k Documentation for Pkl packages
...
- [apple/pkl-pantry](https://github.com/apple/pkl-pantry) topic: pushed_at:2025-07 star:0.3k fork:0.0k Shared Pkl packages
...
- [apple/axlearn](https://github.com/apple/axlearn) topic:deep-learning,jax pushed_at:2025-07 star:2.2k fork:0.4k An Extensible Deep Learning Library
...
- [apple/coremltools](https://github.com/apple/coremltools) topic:coreml,coremltools,machine-learning,model-conversion,model-converter,pytorch,tensorflow pushed_at:2025-07 star:4.8k fork:0.7k Core ML tools contain supporting tools for Core ML model conversion, editing, and validation.
...
- [apple/ml-depth-pro](https://github.com/apple/ml-depth-pro) topic: pushed_at:2025-04 star:4.7k fork:0.3k Depth Pro: Sharp Monocular Metric Depth in Less Than a Second.
- [apple/ml-destseg](https://github.com/apple/ml-destseg) topic: pushed_at:2024-05 star:0.1k fork:0.0k 
- [apple/ml-diffucoder](https://github.com/apple/ml-diffucoder) topic: pushed_at:2025-07 star:0.6k fork:0.0k DiffuCoder: Understanding and Improving Masked Diffusion Models for Code Generation
...
- [apple/ml-hypersim](https://github.com/apple/ml-hypersim) topic: pushed_at:2024-10 star:1.9k fork:0.1k Hypersim: A Photorealistic Synthetic Dataset for Holistic Indoor Scene Understanding
...
- [apple/ml-stable-diffusion](https://github.com/apple/ml-stable-diffusion) topic: pushed_at:2025-07 star:17.5k fork:1.0k Stable Diffusion with Core ML on Apple Silicon
...
- [apple/app-store-server-library-swift](https://github.com/apple/app-store-server-library-swift) topic: pushed_at:2025-07 star:0.3k fork:0.0k 
...
- [apple/container](https://github.com/apple/container) topic: pushed_at:2025-07 star:17.2k fork:0.3k A tool for creating and running Linux containers using lightweight virtual machines on a Mac. It is written in Swift, and optimized for Apple silicon. 
- [apple/containerization](https://github.com/apple/containerization) topic: pushed_at:2025-07 star:7.5k fork:0.2k Containerization is a Swift package for running Linux containers on macOS.
...
- [apple/swift-async-algorithms](https://github.com/apple/swift-async-algorithms) topic:swift pushed_at:2025-07 star:3.3k fork:0.2k Async Algorithms for Swift
...
- [apple/swift-binary-parsing](https://github.com/apple/swift-binary-parsing) topic: pushed_at:2025-07 star:0.3k fork:0.0k 
...
- [apple/swift-certificates](https://github.com/apple/swift-certificates) topic:certificates,swift,x509 pushed_at:2025-07 star:0.3k fork:0.1k An implementation of X.509 for Swift
...
- [apple/swift-collections](https://github.com/apple/swift-collections) topic:collection,container,deque,dequeue,hash,ordered-dictionary,ordered-set,queue,sequence pushed_at:2025-07 star:4.1k fork:0.3k Commonly used data structures for Swift
...
- [apple/swift-distributed-tracing](https://github.com/apple/swift-distributed-tracing) topic:distributed-systems,distributed-tracing,swift,tracing pushed_at:2025-07 star:0.3k fork:0.0k Instrumentation library for Swift server applications
...
- [apple/swift-homomorphic-encryption](https://github.com/apple/swift-homomorphic-encryption) topic:cryptography,homomorphic-encryption,swift pushed_at:2025-07 star:0.6k fork:0.0k Homomorphic Encryption library and applications in Swift
...
- [apple/swift-log](https://github.com/apple/swift-log) topic:logging,swift-server pushed_at:2025-07 star:3.8k fork:0.3k A Logging API for Swift
...
- [apple/swift-nio](https://github.com/apple/swift-nio) topic:asynchronous-io,event-driven,high-performance,networking,non-blocking,non-blocking-io,swift,swift-server,swift5,swiftnio pushed_at:2025-07 star:8.2k fork:0.7k Event-driven network application framework for high performance protocol servers & clients, non-blocking.
...
- [apple/swift-nio-extras](https://github.com/apple/swift-nio-extras) topic:swift5,swiftnio pushed_at:2025-07 star:0.2k fork:0.1k Useful code around SwiftNIO.
...
- [apple/swift-openapi-generator](https://github.com/apple/swift-openapi-generator) topic:ios-swift,openapi,plugin,server-side-swift,swift,swiftpm pushed_at:2025-07 star:1.7k fork:0.1k Generate Swift client and server code from an OpenAPI document.
...
- [apple/swift-play-experimental](https://github.com/apple/swift-play-experimental) topic: pushed_at:2025-07 star:0.1k fork:0.0k 
- [apple/swift-protobuf](https://github.com/apple/swift-protobuf) topic: pushed_at:2025-07 star:4.7k fork:0.5k Plugin and runtime library for using protobuf with Swift
...
- [apple/swift-system](https://github.com/apple/swift-system) topic:file-descriptor,file-path,posix pushed_at:2025-07 star:1.3k fork:0.1k Low-level system calls and types for Swift
...
- [apple/swift-xcode-playground-support](https://github.com/apple/swift-xcode-playground-support) topic: pushed_at:2025-07 star:0.3k fork:0.1k Logging and communication to allow Swift toolchains to communicate with Xcode.
- [apple/swiftpm-on-llbuild2](https://github.com/apple/swiftpm-on-llbuild2) topic: pushed_at:2022-04 star:0.0k fork:0.0k 

## TypeScript

- [apple/app-store-server-library-node](https://github.com/apple/app-store-server-library-node) topic: pushed_at:2025-07 star:0.3k fork:0.1k 
- [apple/embedding-atlas](https://github.com/apple/embedding-atlas) topic:embedding,visualization pushed_at:2025-06 star:0.3k fork:0.0k Embedding Atlas is a tool that provides interactive visualizations for large embeddings. It allows you to visualize, cross-filter, and search embeddings and metadata.
- [apple/ml-hierarchical-confusion-matrix](https://github.com/apple/ml-hierarchical-confusion-matrix) topic:confusion-matrix,data-visualization,machine-learning,visual-analytics pushed_at:2025-07 star:0.3k fork:0.0k Neo: Hierarchical Confusion Matrix Visualization (CHI 2022)
