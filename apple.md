...
- [apple/foundationdb](https://github.com/apple/foundationdb) topic:acid,distributed-database,foundationdb,key-value-store,transactional pushed_at:2026-05 star:16.3k fork:1.5k FoundationDB - the open source, distributed, transactional key-value store
...
- [apple/container-builder-shim](https://github.com/apple/container-builder-shim) topic: pushed_at:2026-04 star:0.1k fork:0.0k Shim for connecting Swift host code to BuildKit running in a container. 
...
- [apple/pkl-go](https://github.com/apple/pkl-go) topic: pushed_at:2026-04 star:0.3k fork:0.0k Pkl bindings for the Go programming language
...
- [apple/pkl-k8s-examples](https://github.com/apple/pkl-k8s-examples) topic: pushed_at:2026-05 star:0.2k fork:0.0k Examples for using Pkl with Kubernetes
...
- [apple/ml-fastvlm](https://github.com/apple/ml-fastvlm) topic: pushed_at:2025-05 star:7.3k fork:0.6k This repository contains the official implementation of "FastVLM: Efficient Vision Encoding for Vision Language Models" - CVPR 2025
...
- [apple/ml-lgtm](https://github.com/apple/ml-lgtm) topic: pushed_at:2026-04 star:0.0k fork:0.0k Less Gaussians, Texture More: 4K Feed-Forward Textured Splatting
- [apple/ml-lineas](https://github.com/apple/ml-lineas) topic: pushed_at:2025-10 star:0.0k fork:0.0k 
- [apple/ml-lito](https://github.com/apple/ml-lito) topic: pushed_at:2026-05 star:0.2k fork:0.0k [ICLR 2026] LiTo: Surface Light Field Tokenization
...
- [apple/ToolSandbox](https://github.com/apple/ToolSandbox) topic: pushed_at:2025-11 star:0.2k fork:0.0k 
...
- [apple/container](https://github.com/apple/container) topic: pushed_at:2026-05 star:26.5k fork:0.8k A tool for creating and running Linux containers using lightweight virtual machines on a Mac. It is written in Swift, and optimized for Apple silicon. 
- [apple/containerization](https://github.com/apple/containerization) topic: pushed_at:2026-05 star:8.5k fork:0.3k Containerization is a Swift package for running Linux containers on macOS.
...
- [apple/swift-cluster-membership](https://github.com/apple/swift-cluster-membership) topic:distributed-systems,server-side-swift,swift,swift-on-server pushed_at:2026-04 star:0.2k fork:0.0k Distributed Membership Protocol implementations in Swift
...
- [apple/swift-container-plugin](https://github.com/apple/swift-container-plugin) topic:containers,plugin,server-side-swift,swift,swift-package-manager,swift-package-manager-plugin,swiftpm pushed_at:2026-04 star:0.4k fork:0.0k Build and publish container images using Swift Package Manager
- [apple/swift-distributed-actors](https://github.com/apple/swift-distributed-actors) topic:actor-model,actors,distributed-systems,swift pushed_at:2026-04 star:0.7k fork:0.1k Peer-to-peer cluster implementation for Swift Distributed Actors
...
- [apple/swift-mmio](https://github.com/apple/swift-mmio) topic:embedded,mmio,swift pushed_at:2026-03 star:0.3k fork:0.0k Define and operate on type safe MMIO
- [apple/swift-nio](https://github.com/apple/swift-nio) topic:asynchronous-io,event-driven,high-performance,networking,non-blocking,non-blocking-io,swift,swift-server,swift5,swiftnio pushed_at:2026-05 star:8.5k fork:0.7k Event-driven network application framework for high performance protocol servers & clients, non-blocking.
...
- [apple/swift-nio-http2](https://github.com/apple/swift-nio-http2) topic:async,beta,http2,swift5,swiftnio pushed_at:2026-04 star:0.5k fork:0.1k HTTP/2 support for SwiftNIO
- [apple/swift-nio-imap](https://github.com/apple/swift-nio-imap) topic: pushed_at:2026-04 star:0.1k fork:0.0k A Swift project that provides an implementation of the IMAP4rev1 protocol, built upon SwiftNIO.
...
- [apple/swift-ntp](https://github.com/apple/swift-ntp) topic: pushed_at:2026-01 star:0.1k fork:0.0k Swift NTP library using Swift NIO. Provides an NTPClient.
- [apple/swift-numerics](https://github.com/apple/swift-numerics) topic:complex,math,mathematics,maths,real,trig pushed_at:2026-01 star:1.8k fork:0.2k Advanced mathematical types and functions for Swift
...
- [apple/swift-profile-recorder](https://github.com/apple/swift-profile-recorder) topic: pushed_at:2026-03 star:0.2k fork:0.0k 
...
- [apple/swift-system](https://github.com/apple/swift-system) topic:file-descriptor,file-path,posix pushed_at:2026-03 star:1.4k fork:0.1k Low-level system calls and types for Swift
...
- [apple/embedding-atlas](https://github.com/apple/embedding-atlas) topic:embedding,visualization pushed_at:2026-05 star:4.8k fork:0.3k Embedding Atlas is a tool that provides interactive visualizations for large embeddings. It allows you to visualize, cross-filter, and search embeddings and metadata.
