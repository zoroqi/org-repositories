...
- [apple/unityplugins](https://github.com/apple/unityplugins) topic: pushed_at:2025-12 star:0.9k fork:0.2k 
...
- [apple/SwiftUsd](https://github.com/apple/SwiftUsd) topic: pushed_at:2025-12 star:0.1k fork:0.0k A Swift Package for using OpenUSD in Swift
...
- [apple/pkl-lang.org](https://github.com/apple/pkl-lang.org) topic: pushed_at:2025-12 star:0.1k fork:0.0k The pkl-lang.org website

## Go

- [apple/container-builder-shim](https://github.com/apple/container-builder-shim) topic: pushed_at:2025-12 star:0.1k fork:0.0k Shim for connecting Swift host code to BuildKit running in a container. 
...
- [apple/pkl-go](https://github.com/apple/pkl-go) topic: pushed_at:2025-12 star:0.3k fork:0.0k Pkl bindings for the Go programming language
- [apple/pkl-go-examples](https://github.com/apple/pkl-go-examples) topic: pushed_at:2025-12 star:0.2k fork:0.0k Examples for using Pkl within Go applications
- [apple/pkl-readers](https://github.com/apple/pkl-readers) topic: pushed_at:2025-12 star:0.0k fork:0.0k Shared Pkl external readers
...
- [apple/pkl](https://github.com/apple/pkl) topic:config,configuration,data,functional,java,json,kotlin,language,object-oriented,pkl,programming-language,properties,propertylist,validation,xml,yaml pushed_at:2025-12 star:11.0k fork:0.3k A configuration as code language with rich validation and tooling.
- [apple/pkl-spring](https://github.com/apple/pkl-spring) topic: pushed_at:2025-12 star:0.0k fork:0.0k Spring Boot extension for configuring Boot apps with Pkl
- [apple/pollianna](https://github.com/apple/pollianna) topic: pushed_at:2025-12 star:0.1k fork:0.0k 
- [apple/servicetalk](https://github.com/apple/servicetalk) topic:framework,grpc,http,http2,java,microservices,netty,reactive,reactive-streams,rpc pushed_at:2025-12 star:1.0k fork:0.2k A networking framework that evolves with your application

## JavaScript

- [apple/highlightjs-pkl](https://github.com/apple/highlightjs-pkl) topic: pushed_at:2025-12 star:0.0k fork:0.0k Highlight.js syntax highlighting for Pkl
...
- [apple/password-manager-resources](https://github.com/apple/password-manager-resources) topic: pushed_at:2025-12 star:4.6k fork:0.5k A place for creators and users of password managers to collaborate on resources to make password management better.
...
- [apple/pkl-intellij](https://github.com/apple/pkl-intellij) topic: pushed_at:2025-12 star:0.1k fork:0.0k JetBrains editor plugins providing Pkl language support
- [apple/pkl-lsp](https://github.com/apple/pkl-lsp) topic:lsp,lsp-server,pkl pushed_at:2025-12 star:0.1k fork:0.0k Language server for Pkl, implementing the server-side of the Language Server Protocol.
- [apple/pkl-package-docs](https://github.com/apple/pkl-package-docs) topic: pushed_at:2025-12 star:0.0k fork:0.0k Documentation for Pkl packages
- [apple/tree-sitter-pkl](https://github.com/apple/tree-sitter-pkl) topic:pkl,tree-sitter pushed_at:2025-12 star:0.0k fork:0.0k Tree-sitter parser for Pkl
...
- [apple/pkl-neovim](https://github.com/apple/pkl-neovim) topic: pushed_at:2025-12 star:0.2k fork:0.0k Pkl language support for Neovim
...
- [apple/publicsuffix-list](https://github.com/apple/publicsuffix-list) topic: pushed_at:2025-12 star:0.0k fork:0.0k The Public Suffix List
...
- [apple/pkl-jvm-examples](https://github.com/apple/pkl-jvm-examples) topic: pushed_at:2025-12 star:0.1k fork:0.0k Examples for using Pkl within JVM applications
- [apple/pkl-k8s](https://github.com/apple/pkl-k8s) topic: pushed_at:2025-12 star:0.1k fork:0.0k Templates for using Pkl with Kubernetes
- [apple/pkl-k8s-examples](https://github.com/apple/pkl-k8s-examples) topic: pushed_at:2025-12 star:0.2k fork:0.0k Examples for using Pkl with Kubernetes
- [apple/pkl-pantry](https://github.com/apple/pkl-pantry) topic: pushed_at:2025-12 star:0.3k fork:0.0k Shared Pkl packages
- [apple/pkl-project-commons](https://github.com/apple/pkl-project-commons) topic:pkl pushed_at:2025-12 star:0.0k fork:0.0k Internal utility libraries for Pkl
- [apple/pkl.tmbundle](https://github.com/apple/pkl.tmbundle) topic: pushed_at:2025-12 star:0.0k fork:0.0k TextMate bundle for Pkl
...
- [apple/coremltools](https://github.com/apple/coremltools) topic:coreml,coremltools,machine-learning,model-conversion,model-converter,pytorch,tensorflow pushed_at:2025-12 star:5.1k fork:0.7k Core ML tools contain supporting tools for Core ML model conversion, editing, and validation.
...
- [apple/ml-depth-pro](https://github.com/apple/ml-depth-pro) topic: pushed_at:2025-04 star:5.1k fork:0.4k Depth Pro: Sharp Monocular Metric Depth in Less Than a Second.
...
- [apple/pico-banana-400k](https://github.com/apple/pico-banana-400k) topic: pushed_at:2025-12 star:1.7k fork:0.1k 
...
- [apple/rules_pkl](https://github.com/apple/rules_pkl) topic: pushed_at:2025-12 star:0.0k fork:0.0k Bazel build rules for Pkl
...
- [apple/pkl-swift](https://github.com/apple/pkl-swift) topic: pushed_at:2025-12 star:0.2k fork:0.0k Pkl bindings for the Swift programming language
- [apple/pkl-swift-examples](https://github.com/apple/pkl-swift-examples) topic: pushed_at:2025-12 star:0.1k fork:0.0k Examples for using Pkl within Swift applications
...
- [apple/swift-cassandra-client](https://github.com/apple/swift-cassandra-client) topic: pushed_at:2025-12 star:0.1k fork:0.0k Cassandra client in Swift
- [apple/swift-certificates](https://github.com/apple/swift-certificates) topic:certificates,swift,x509 pushed_at:2025-12 star:0.3k fork:0.1k An implementation of X.509 for Swift
...
- [apple/swift-configuration](https://github.com/apple/swift-configuration) topic:configuration,server,swift pushed_at:2025-12 star:0.7k fork:0.0k API package for reading configuration.
...
- [apple/swift-distributed-tracing](https://github.com/apple/swift-distributed-tracing) topic:distributed-systems,distributed-tracing,swift,tracing pushed_at:2025-12 star:0.3k fork:0.1k Instrumentation library for Swift server applications
...
- [apple/swift-homomorphic-encryption](https://github.com/apple/swift-homomorphic-encryption) topic:cryptography,homomorphic-encryption,swift pushed_at:2025-12 star:0.6k fork:0.0k Homomorphic Encryption library and applications in Swift
...
- [apple/swift-llbuild2](https://github.com/apple/swift-llbuild2) topic: pushed_at:2025-12 star:0.3k fork:0.0k A fresh take on a low-level build system API.
- [apple/swift-log](https://github.com/apple/swift-log) topic:logging,swift-server pushed_at:2025-12 star:3.9k fork:0.3k A Logging API for Swift
...
- [apple/swift-openapi-generator](https://github.com/apple/swift-openapi-generator) topic:ios-swift,openapi,plugin,server-side-swift,swift,swiftpm pushed_at:2025-12 star:1.8k fork:0.1k Generate Swift client and server code from an OpenAPI document.
...
- [apple/swift-system](https://github.com/apple/swift-system) topic:file-descriptor,file-path,posix pushed_at:2025-12 star:1.3k fork:0.1k Low-level system calls and types for Swift
- [apple/swift-temporal-sdk](https://github.com/apple/swift-temporal-sdk) topic: pushed_at:2025-12 star:0.2k fork:0.0k Swift SDK for Temporal
...
- [apple/swift-xcode-playground-support](https://github.com/apple/swift-xcode-playground-support) topic: pushed_at:2025-12 star:0.3k fork:0.1k Logging and communication to allow Swift toolchains to communicate with Xcode.
- [apple/swiftpm-on-llbuild2](https://github.com/apple/swiftpm-on-llbuild2) topic: pushed_at:2022-04 star:0.0k fork:0.0k 
- [apple/SwiftUsd-Tests](https://github.com/apple/SwiftUsd-Tests) topic: pushed_at:2025-12 star:0.0k fork:0.0k Unit tests for SwiftUsd

## TypeScript

- [apple/app-store-server-library-node](https://github.com/apple/app-store-server-library-node) topic: pushed_at:2025-12 star:0.3k fork:0.1k The Node.js server library for the App Store Server API and App Store Server Notifications.
- [apple/embedding-atlas](https://github.com/apple/embedding-atlas) topic:embedding,visualization pushed_at:2025-12 star:4.5k fork:0.2k Embedding Atlas is a tool that provides interactive visualizations for large embeddings. It allows you to visualize, cross-filter, and search embeddings and metadata.
...
- [apple/ml-hierarchical-confusion-matrix](https://github.com/apple/ml-hierarchical-confusion-matrix) topic:confusion-matrix,data-visualization,machine-learning,visual-analytics pushed_at:2025-12 star:0.3k fork:0.0k Neo: Hierarchical Confusion Matrix Visualization (CHI 2022)
...
- [apple/pkl-vscode](https://github.com/apple/pkl-vscode) topic: pushed_at:2025-12 star:0.1k fork:0.0k Pkl language support for VS Code
