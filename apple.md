...
- [apple/swift-crypto](https://github.com/apple/swift-crypto) topic:boringssl,ciphers,cryptography,ecdh,ecdsa,eddsa,elliptic-curves,hash-functions,swift,swift-crypto pushed_at:2026-08 star:1.7k fork:0.2k Open-source implementation of a substantial portion of the API of Apple CryptoKit suitable for use on all Swift supported platforms.
- [apple/swift-nio-ssl](https://github.com/apple/swift-nio-ssl) topic:swift5,swiftnio,tls,tls-support pushed_at:2026-08 star:0.4k fork:0.2k TLS Support for SwiftNIO, based on BoringSSL.
...
- [apple/foundationdb](https://github.com/apple/foundationdb) topic:acid,distributed-database,foundationdb,key-value-store,transactional pushed_at:2026-08 star:16.6k fork:1.5k FoundationDB - the open source, distributed, transactional key-value store
...
- [apple/SwiftUsd](https://github.com/apple/SwiftUsd) topic: pushed_at:2026-08 star:0.1k fork:0.0k A Swift Package for using OpenUSD, Pixar's Universal Scene Description
- [apple/SwiftUsd-ast-answerer](https://github.com/apple/SwiftUsd-ast-answerer) topic: pushed_at:2026-08 star:0.0k fork:0.0k Code generation tool for SwiftUsd
...
- [apple/pkl-lang.org](https://github.com/apple/pkl-lang.org) topic: pushed_at:2026-08 star:0.1k fork:0.0k The pkl-lang.org website

## Go

- [apple/container-builder-shim](https://github.com/apple/container-builder-shim) topic: pushed_at:2026-08 star:0.1k fork:0.0k Shim for connecting Swift host code to BuildKit running in a container. 
...
- [apple/app-store-server-library-java](https://github.com/apple/app-store-server-library-java) topic: pushed_at:2026-08 star:0.3k fork:0.1k The Java server library for the App Store Server API and App Store Server Notifications.
...
- [apple/pkl](https://github.com/apple/pkl) topic:config,configuration,data,functional,java,json,kotlin,language,object-oriented,pkl,programming-language,properties,propertylist,validation,xml,yaml pushed_at:2026-08 star:11.5k fork:0.4k A configuration as code language with rich validation and tooling.
...
- [apple/servicetalk](https://github.com/apple/servicetalk) topic:framework,grpc,http,http2,java,microservices,netty,reactive,reactive-streams,rpc pushed_at:2026-08 star:1.0k fork:0.2k A networking framework that evolves with your application
...
- [apple/pfl-research](https://github.com/apple/pfl-research) topic:differential-privacy,federated-learning,federated-learning-framework,machine-learning,privacy pushed_at:2026-08 star:0.4k fork:0.0k Simulation framework for accelerating research in Private Federated Learning

## Kotlin

- [apple/pkl-intellij](https://github.com/apple/pkl-intellij) topic: pushed_at:2026-08 star:0.1k fork:0.0k JetBrains editor plugins providing Pkl language support
- [apple/pkl-lsp](https://github.com/apple/pkl-lsp) topic:lsp,lsp-server,pkl pushed_at:2026-08 star:0.1k fork:0.0k Language server for Pkl, implementing the server-side of the Language Server Protocol.
...
- [apple/device-management](https://github.com/apple/device-management) topic: pushed_at:2026-08 star:1.0k fork:0.1k Device management schema data for MDM.
...
- [apple/coreai-optimization](https://github.com/apple/coreai-optimization) topic: pushed_at:2026-08 star:0.1k fork:0.0k A library for PyTorch model compression and optimizations for deployment via Core AI on Apple silicon.
- [apple/coreai-torch](https://github.com/apple/coreai-torch) topic: pushed_at:2026-08 star:0.1k fork:0.0k Bridges PyTorch and Core AI. Convert existing models to Core AI IR, or author new ones from PyTorch via composite ops, custom op lowerings, and inline Metal GPU kernels.
- [apple/coremltools](https://github.com/apple/coremltools) topic:coreml,coremltools,machine-learning,model-conversion,model-converter,pytorch,tensorflow pushed_at:2026-08 star:5.4k fork:0.8k Core ML tools contain supporting tools for Core ML model conversion, editing, and validation.
...
- [apple/ml-depth-pro](https://github.com/apple/ml-depth-pro) topic: pushed_at:2025-04 star:5.7k fork:0.4k Depth Pro: Sharp Monocular Metric Depth in Less Than a Second.
...
- [apple/ml-egodex](https://github.com/apple/ml-egodex) topic: pushed_at:2025-08 star:0.4k fork:0.0k EgoDex: Learning Dexterous Manipulation from Large-Scale Egocentric Video
...
- [apple/ml-stable-diffusion](https://github.com/apple/ml-stable-diffusion) topic: pushed_at:2025-07 star:18.0k fork:1.1k Stable Diffusion with Core ML on Apple Silicon
...
- [apple/rules_servicetalk](https://github.com/apple/rules_servicetalk) topic: pushed_at:2026-08 star:0.0k fork:0.0k Bazel rules for Servicetalk
...
- [apple/container](https://github.com/apple/container) topic: pushed_at:2026-08 star:49.0k fork:1.7k A tool for creating and running Linux containers using lightweight virtual machines on a Mac. It is written in Swift, and optimized for Apple silicon. 
- [apple/containerization](https://github.com/apple/containerization) topic: pushed_at:2026-08 star:8.9k fork:0.3k Containerization is a Swift package for running Linux containers on macOS.
- [apple/coreai-models](https://github.com/apple/coreai-models) topic: pushed_at:2026-08 star:1.6k fork:0.1k Model export recipes, Python primitives, and Swift runtime utilities for on-device AI
...
- [apple/pir-service-example](https://github.com/apple/pir-service-example) topic: pushed_at:2026-08 star:0.2k fork:0.0k Example PIR service & documentation for Live Caller ID Lookup & NEURLFilter
...
- [apple/swift-argument-parser](https://github.com/apple/swift-argument-parser) topic:cli,command-line,flag,option pushed_at:2026-08 star:3.8k fork:0.4k Straightforward, type-safe argument parsing for Swift
- [apple/swift-asn1](https://github.com/apple/swift-asn1) topic:asn1,der,swift pushed_at:2026-08 star:0.2k fork:0.1k An implementation of ASN.1 for Swift
- [apple/swift-async-algorithms](https://github.com/apple/swift-async-algorithms) topic:swift pushed_at:2026-08 star:3.7k fork:0.2k Async Algorithms for Swift
...
- [apple/swift-cassandra-client](https://github.com/apple/swift-cassandra-client) topic: pushed_at:2026-08 star:0.1k fork:0.0k Cassandra client in Swift
...
- [apple/swift-collections](https://github.com/apple/swift-collections) topic:collection,container,deque,dequeue,hash,ordered-dictionary,ordered-set,queue,sequence pushed_at:2026-08 star:4.5k fork:0.4k Commonly used data structures for Swift
...
- [apple/swift-configuration](https://github.com/apple/swift-configuration) topic:configuration,server,swift pushed_at:2026-08 star:0.8k fork:0.1k API package for reading configuration.
...
- [apple/swift-http-types](https://github.com/apple/swift-http-types) topic: pushed_at:2026-08 star:1.0k fork:0.1k Version-independent HTTP currency types for Swift
- [apple/swift-llbuild2](https://github.com/apple/swift-llbuild2) topic: pushed_at:2026-08 star:0.3k fork:0.0k A fresh take on a low-level build system API.
- [apple/swift-log](https://github.com/apple/swift-log) topic:logging,swift-server pushed_at:2026-08 star:4.0k fork:0.3k A Logging API for Swift
- [apple/swift-metrics](https://github.com/apple/swift-metrics) topic:metrics,swift-server pushed_at:2026-08 star:0.8k fork:0.1k Metrics API for Swift
...
- [apple/swift-nio](https://github.com/apple/swift-nio) topic:asynchronous-io,event-driven,high-performance,networking,non-blocking,non-blocking-io,swift,swift-server,swift5,swiftnio pushed_at:2026-08 star:8.5k fork:0.8k Event-driven network application framework for high performance protocol servers & clients, non-blocking.
...
- [apple/swift-nio-extras](https://github.com/apple/swift-nio-extras) topic:swift5,swiftnio pushed_at:2026-08 star:0.3k fork:0.1k Useful code around SwiftNIO.
- [apple/swift-nio-http2](https://github.com/apple/swift-nio-http2) topic:async,beta,http2,swift5,swiftnio pushed_at:2026-08 star:0.5k fork:0.1k HTTP/2 support for SwiftNIO
- [apple/swift-nio-http3](https://github.com/apple/swift-nio-http3) topic:http3,networking,swift-nio,swift-server pushed_at:2026-08 star:0.0k fork:0.0k HTTP/3 support for SwiftNIO
- [apple/swift-nio-imap](https://github.com/apple/swift-nio-imap) topic: pushed_at:2026-08 star:0.1k fork:0.0k A Swift project that provides an implementation of the IMAP4rev1 protocol, built upon SwiftNIO.
...
- [apple/swift-nio-quic](https://github.com/apple/swift-nio-quic) topic:networking,quic,swift-nio,swift-server pushed_at:2026-08 star:0.1k fork:0.0k QUIC support for SwiftNIO
...
- [apple/swift-openapi-generator](https://github.com/apple/swift-openapi-generator) topic:ios-swift,openapi,plugin,server-side-swift,swift,swiftpm pushed_at:2026-08 star:2.0k fork:0.2k Generate Swift client and server code from an OpenAPI document.
...
- [apple/swift-protobuf](https://github.com/apple/swift-protobuf) topic: pushed_at:2026-08 star:5.0k fork:0.5k Plugin and runtime library for using protobuf with Swift
...
- [apple/swift-system](https://github.com/apple/swift-system) topic:file-descriptor,file-path,posix pushed_at:2026-08 star:1.4k fork:0.1k Low-level system calls and types for Swift
- [apple/swift-system-metrics](https://github.com/apple/swift-system-metrics) topic:metrics,process,server,swift,swift-server,system pushed_at:2026-08 star:0.2k fork:0.0k Report process-level system metrics (memory, CPU, file descriptors) to Swift Metrics
- [apple/swift-temporal-sdk](https://github.com/apple/swift-temporal-sdk) topic: pushed_at:2026-08 star:0.3k fork:0.0k Swift SDK for Temporal
...
- [apple/SwiftUsd-Tests](https://github.com/apple/SwiftUsd-Tests) topic: pushed_at:2026-08 star:0.0k fork:0.0k Unit tests for SwiftUsd
...
- [apple/embedding-atlas](https://github.com/apple/embedding-atlas) topic:embedding,visualization pushed_at:2026-08 star:4.9k fork:0.3k Embedding Atlas is a tool that provides interactive visualizations for large embeddings. It allows you to visualize, cross-filter, and search embeddings and metadata.
