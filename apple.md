...
- [apple/swift-crypto](https://github.com/apple/swift-crypto) topic:boringssl,ciphers,cryptography,ecdh,ecdsa,eddsa,elliptic-curves,hash-functions,swift,swift-crypto pushed_at:2026-07 star:1.7k fork:0.2k Open-source implementation of a substantial portion of the API of Apple CryptoKit suitable for use on all Swift supported platforms.
- [apple/swift-nio-ssl](https://github.com/apple/swift-nio-ssl) topic:swift5,swiftnio,tls,tls-support pushed_at:2026-07 star:0.4k fork:0.2k TLS Support for SwiftNIO, based on BoringSSL.
...
- [apple/unityplugins](https://github.com/apple/unityplugins) topic: pushed_at:2026-07 star:1.0k fork:0.2k 
...
- [apple/foundationdb](https://github.com/apple/foundationdb) topic:acid,distributed-database,foundationdb,key-value-store,transactional pushed_at:2026-07 star:16.6k fork:1.5k FoundationDB - the open source, distributed, transactional key-value store
...
- [apple/SwiftUsd](https://github.com/apple/SwiftUsd) topic: pushed_at:2026-07 star:0.1k fork:0.0k A Swift Package for using OpenUSD, Pixar's Universal Scene Description
- [apple/SwiftUsd-ast-answerer](https://github.com/apple/SwiftUsd-ast-answerer) topic: pushed_at:2026-07 star:0.0k fork:0.0k Code generation tool for SwiftUsd
...
- [apple/pkl-lang.org](https://github.com/apple/pkl-lang.org) topic: pushed_at:2026-07 star:0.1k fork:0.0k The pkl-lang.org website

## Go

- [apple/container-builder-shim](https://github.com/apple/container-builder-shim) topic: pushed_at:2026-07 star:0.1k fork:0.0k Shim for connecting Swift host code to BuildKit running in a container. 
...
- [apple/pkl-go](https://github.com/apple/pkl-go) topic: pushed_at:2026-07 star:0.3k fork:0.0k Pkl bindings for the Go programming language
...
- [apple/app-store-server-library-java](https://github.com/apple/app-store-server-library-java) topic: pushed_at:2026-07 star:0.3k fork:0.1k The Java server library for the App Store Server API and App Store Server Notifications.
...
- [apple/pkl](https://github.com/apple/pkl) topic:config,configuration,data,functional,java,json,kotlin,language,object-oriented,pkl,programming-language,properties,propertylist,validation,xml,yaml pushed_at:2026-07 star:11.5k fork:0.4k A configuration as code language with rich validation and tooling.
...
- [apple/servicetalk](https://github.com/apple/servicetalk) topic:framework,grpc,http,http2,java,microservices,netty,reactive,reactive-streams,rpc pushed_at:2026-07 star:1.0k fork:0.2k A networking framework that evolves with your application
...
- [apple/password-manager-resources](https://github.com/apple/password-manager-resources) topic: pushed_at:2026-08 star:4.8k fork:0.6k A place for creators and users of password managers to collaborate on resources to make password management better.
...
- [apple/ml-impact](https://github.com/apple/ml-impact) topic: pushed_at:2026-07 star:0.0k fork:0.0k 
...
- [apple/pfl-research](https://github.com/apple/pfl-research) topic:differential-privacy,federated-learning,federated-learning-framework,machine-learning,privacy pushed_at:2026-07 star:0.4k fork:0.0k Simulation framework for accelerating research in Private Federated Learning

## Kotlin

- [apple/pkl-intellij](https://github.com/apple/pkl-intellij) topic: pushed_at:2026-07 star:0.1k fork:0.0k JetBrains editor plugins providing Pkl language support
- [apple/pkl-lsp](https://github.com/apple/pkl-lsp) topic:lsp,lsp-server,pkl pushed_at:2026-07 star:0.1k fork:0.0k Language server for Pkl, implementing the server-side of the Language Server Protocol.
- [apple/pkl-package-docs](https://github.com/apple/pkl-package-docs) topic: pushed_at:2026-07 star:0.0k fork:0.0k Documentation for Pkl packages
- [apple/tree-sitter-pkl](https://github.com/apple/tree-sitter-pkl) topic:pkl,tree-sitter pushed_at:2026-07 star:0.1k fork:0.0k Tree-sitter parser for Pkl
...
- [apple/apple-root-program](https://github.com/apple/apple-root-program) topic: pushed_at:2026-07 star:0.0k fork:0.0k This repository hosts the official policy documentation and public communications for the Apple Root Program. It serves as the authoritative publication point for the Apple Root Program Policy and related materials intended for Certification Authorities, auditors, researchers, and other ecosystem participants.
- [apple/device-management](https://github.com/apple/device-management) topic: pushed_at:2026-06 star:1.0k fork:0.1k Device management schema data for MDM.
...
- [apple/ml-hat](https://github.com/apple/ml-hat) topic: pushed_at:2026-06 star:0.0k fork:0.0k HAT: Hallucination Annotation for Translation
...
- [apple/pkl-evolution](https://github.com/apple/pkl-evolution) topic: pushed_at:2026-07 star:0.0k fork:0.0k Suggested Pkl Improvements, Changes, or Enhancements (SPICEs)
- [apple/swift-homomorphic-encryption-protobuf](https://github.com/apple/swift-homomorphic-encryption-protobuf) topic: pushed_at:2026-07 star:0.0k fork:0.0k Protocol buffers definitions for Swift Homomorphic Encryption
...
- [apple/pkl-k8s](https://github.com/apple/pkl-k8s) topic: pushed_at:2026-07 star:0.1k fork:0.0k Templates for using Pkl with Kubernetes
...
- [apple/pkl-pantry](https://github.com/apple/pkl-pantry) topic: pushed_at:2026-07 star:0.3k fork:0.0k Shared Pkl packages
...
- [apple/app-store-server-library-python](https://github.com/apple/app-store-server-library-python) topic: pushed_at:2026-07 star:0.3k fork:0.1k The Python server library for the App Store Server API and App Store Server Notifications.
...
- [apple/coreai-torch](https://github.com/apple/coreai-torch) topic: pushed_at:2026-07 star:0.1k fork:0.0k Bridges PyTorch and Core AI. Convert existing models to Core AI IR, or author new ones from PyTorch via composite ops, custom op lowerings, and inline Metal GPU kernels.
- [apple/coremltools](https://github.com/apple/coremltools) topic:coreml,coremltools,machine-learning,model-conversion,model-converter,pytorch,tensorflow pushed_at:2026-07 star:5.4k fork:0.8k Core ML tools contain supporting tools for Core ML model conversion, editing, and validation.
...
- [apple/ml-amips](https://github.com/apple/ml-amips) topic: pushed_at:2026-07 star:0.0k fork:0.0k Amortizing Maximum Inner Product Search with Learned Support Functions (AMIPS)
...
- [apple/ml-aspanformer](https://github.com/apple/ml-aspanformer) topic: pushed_at:2023-01 star:0.3k fork:0.0k 
...
- [apple/ml-calibatt](https://github.com/apple/ml-calibatt) topic: pushed_at:2026-07 star:0.0k fork:0.0k [ECCV 2026] Accelerating Text-to-Video Generation with Calibrated Sparse Attention --  Official Code Repository
...
- [apple/ml-learning-to-evict](https://github.com/apple/ml-learning-to-evict) topic: pushed_at:2026-07 star:0.0k fork:0.0k 
- [apple/ml-lgtm](https://github.com/apple/ml-lgtm) topic: pushed_at:2026-04 star:0.2k fork:0.0k Less Gaussians, Texture More: 4K Feed-Forward Textured Splatting
...
- [apple/ml-mmtoolsandbox](https://github.com/apple/ml-mmtoolsandbox) topic: pushed_at:2026-07 star:0.0k fork:0.0k MM-ToolSandBox: A Unified Framework for Evaluating Visual Tool-Calling Agents
...
- [apple/ml-sharp](https://github.com/apple/ml-sharp) topic: pushed_at:2025-12 star:8.8k fork:0.6k Sharp Monocular View Synthesis in Less Than a Second
...
- [apple/ml-sid-dit](https://github.com/apple/ml-sid-dit) topic: pushed_at:2025-10 star:0.1k fork:0.0k 
...
- [apple/ml-vbenchcomp](https://github.com/apple/ml-vbenchcomp) topic: pushed_at:2026-06 star:0.0k fork:0.0k 
...
- [apple/rules_servicetalk](https://github.com/apple/rules_servicetalk) topic: pushed_at:2026-07 star:0.0k fork:0.0k Bazel rules for Servicetalk
...
- [apple/app-store-server-library-swift](https://github.com/apple/app-store-server-library-swift) topic: pushed_at:2026-07 star:0.3k fork:0.1k The Swift server library for the App Store Server API and App Store Server Notifications.
...
- [apple/container](https://github.com/apple/container) topic: pushed_at:2026-07 star:48.5k fork:1.6k A tool for creating and running Linux containers using lightweight virtual machines on a Mac. It is written in Swift, and optimized for Apple silicon. 
- [apple/containerization](https://github.com/apple/containerization) topic: pushed_at:2026-07 star:8.8k fork:0.3k Containerization is a Swift package for running Linux containers on macOS.
- [apple/coreai-models](https://github.com/apple/coreai-models) topic: pushed_at:2026-07 star:1.5k fork:0.1k Model export recipes, Python primitives, and Swift runtime utilities for on-device AI
...
- [apple/foundation-models-utilities](https://github.com/apple/foundation-models-utilities) topic: pushed_at:2026-07 star:0.5k fork:0.0k Emerging and experimental patterns for building with the Foundation Models framework
- [apple/ml-comlet](https://github.com/apple/ml-comlet) topic: pushed_at:2026-07 star:0.0k fork:0.0k CoMLET: Collaborative Machine Learning Exploration Tool
...
- [apple/pcc-vre-pir-service](https://github.com/apple/pcc-vre-pir-service) topic: pushed_at:2026-07 star:0.0k fork:0.0k A test server for exercising Private Information Retrieval (PIR) and Visual Lookup (VLU) inside the Private Cloud Compute (PCC) Virtual Research Environment (VRE)
- [apple/pir-service-example](https://github.com/apple/pir-service-example) topic: pushed_at:2026-07 star:0.2k fork:0.0k Example PIR service & documentation for Live Caller ID Lookup & NEURLFilter
- [apple/pkl-swift](https://github.com/apple/pkl-swift) topic: pushed_at:2026-07 star:0.2k fork:0.0k Pkl bindings for the Swift programming language
...
- [apple/realitykitscripting](https://github.com/apple/realitykitscripting) topic: pushed_at:2026-07 star:0.0k fork:0.0k JavaScript bindings for RealityKit with type-safe Swift interoperability
...
- [apple/swift-argument-parser](https://github.com/apple/swift-argument-parser) topic:cli,command-line,flag,option pushed_at:2026-07 star:3.7k fork:0.4k Straightforward, type-safe argument parsing for Swift
...
- [apple/swift-async-algorithms](https://github.com/apple/swift-async-algorithms) topic:swift pushed_at:2026-07 star:3.7k fork:0.2k Async Algorithms for Swift
- [apple/swift-async-dns-resolver](https://github.com/apple/swift-async-dns-resolver) topic: pushed_at:2026-07 star:0.2k fork:0.0k A Swift library for asynchronous DNS requests, wrapping c-ares with Swift-friendly APIs and data structures.
...
- [apple/swift-binary-parsing](https://github.com/apple/swift-binary-parsing) topic: pushed_at:2026-07 star:0.4k fork:0.0k 
- [apple/swift-cassandra-client](https://github.com/apple/swift-cassandra-client) topic: pushed_at:2026-07 star:0.1k fork:0.0k Cassandra client in Swift
- [apple/swift-certificates](https://github.com/apple/swift-certificates) topic:certificates,swift,x509 pushed_at:2026-07 star:0.3k fork:0.1k An implementation of X.509 for Swift
- [apple/swift-cluster-membership](https://github.com/apple/swift-cluster-membership) topic:distributed-systems,server-side-swift,swift,swift-on-server pushed_at:2026-07 star:0.2k fork:0.0k Distributed Membership Protocol implementations in Swift
- [apple/swift-collections](https://github.com/apple/swift-collections) topic:collection,container,deque,dequeue,hash,ordered-dictionary,ordered-set,queue,sequence pushed_at:2026-07 star:4.5k fork:0.4k Commonly used data structures for Swift
...
- [apple/swift-configuration](https://github.com/apple/swift-configuration) topic:configuration,server,swift pushed_at:2026-07 star:0.8k fork:0.1k API package for reading configuration.
...
- [apple/swift-distributed-tracing](https://github.com/apple/swift-distributed-tracing) topic:distributed-systems,distributed-tracing,swift,tracing pushed_at:2026-07 star:0.3k fork:0.1k Instrumentation library for Swift server applications
...
- [apple/swift-homomorphic-encryption](https://github.com/apple/swift-homomorphic-encryption) topic:cryptography,homomorphic-encryption,swift pushed_at:2026-07 star:0.7k fork:0.0k Homomorphic Encryption library and applications in Swift
- [apple/swift-http-api-proposal](https://github.com/apple/swift-http-api-proposal) topic: pushed_at:2026-07 star:0.1k fork:0.0k This repository contains a proposal for standardized HTTP client and server APIs for the Swift ecosystem
...
- [apple/swift-log](https://github.com/apple/swift-log) topic:logging,swift-server pushed_at:2026-07 star:4.0k fork:0.3k A Logging API for Swift
- [apple/swift-metrics](https://github.com/apple/swift-metrics) topic:metrics,swift-server pushed_at:2026-07 star:0.8k fork:0.1k Metrics API for Swift
...
- [apple/swift-network-evolution](https://github.com/apple/swift-network-evolution) topic: pushed_at:2026-08 star:0.1k fork:0.0k Network protocol stack in Swift for transports like QUIC.
- [apple/swift-nio](https://github.com/apple/swift-nio) topic:asynchronous-io,event-driven,high-performance,networking,non-blocking,non-blocking-io,swift,swift-server,swift5,swiftnio pushed_at:2026-07 star:8.5k fork:0.8k Event-driven network application framework for high performance protocol servers & clients, non-blocking.
...
- [apple/swift-nio-extras](https://github.com/apple/swift-nio-extras) topic:swift5,swiftnio pushed_at:2026-07 star:0.2k fork:0.1k Useful code around SwiftNIO.
- [apple/swift-nio-http2](https://github.com/apple/swift-nio-http2) topic:async,beta,http2,swift5,swiftnio pushed_at:2026-07 star:0.5k fork:0.1k HTTP/2 support for SwiftNIO
- [apple/swift-nio-http3](https://github.com/apple/swift-nio-http3) topic:http3,networking,swift-nio,swift-server pushed_at:2026-07 star:0.0k fork:0.0k HTTP/3 support for SwiftNIO
- [apple/swift-nio-imap](https://github.com/apple/swift-nio-imap) topic: pushed_at:2026-07 star:0.1k fork:0.0k A Swift project that provides an implementation of the IMAP4rev1 protocol, built upon SwiftNIO.
...
- [apple/swift-nio-oblivious-http](https://github.com/apple/swift-nio-oblivious-http) topic: pushed_at:2026-07 star:0.1k fork:0.0k Package providing Oblivious HTTP.  Also allows Oblivious encryption of alternative encodings.
- [apple/swift-nio-quic](https://github.com/apple/swift-nio-quic) topic:networking,quic,swift-nio,swift-server pushed_at:2026-07 star:0.1k fork:0.0k QUIC support for SwiftNIO
- [apple/swift-nio-quic-helpers](https://github.com/apple/swift-nio-quic-helpers) topic:networking,quic,swift-nio,swift-server pushed_at:2026-07 star:0.0k fork:0.0k QUIC supporting types for SwiftNIO
- [apple/swift-nio-ssh](https://github.com/apple/swift-nio-ssh) topic: pushed_at:2026-07 star:0.5k fork:0.1k SwiftNIO SSH is a programmatic implementation of SSH using SwiftNIO
...
- [apple/swift-openapi-generator](https://github.com/apple/swift-openapi-generator) topic:ios-swift,openapi,plugin,server-side-swift,swift,swiftpm pushed_at:2026-07 star:2.0k fork:0.2k Generate Swift client and server code from an OpenAPI document.
- [apple/swift-openapi-runtime](https://github.com/apple/swift-openapi-runtime) topic:middleware,openapi,swift,transport pushed_at:2026-07 star:0.3k fork:0.1k API package for code generated by Swift OpenAPI Generator.
...
- [apple/swift-protobuf](https://github.com/apple/swift-protobuf) topic: pushed_at:2026-07 star:5.0k fork:0.5k Plugin and runtime library for using protobuf with Swift
...
- [apple/swift-service-context](https://github.com/apple/swift-service-context) topic:async-context,baggage,baggage-context,concurrency,context-propagation,distributed-systems,sswg,trace-context pushed_at:2026-07 star:0.2k fork:0.0k Minimal type-safe context propagation container
- [apple/swift-service-discovery](https://github.com/apple/swift-service-discovery) topic: pushed_at:2026-07 star:0.2k fork:0.0k A service discovery API for Swift.
- [apple/swift-statsd-client](https://github.com/apple/swift-statsd-client) topic: pushed_at:2026-07 star:0.1k fork:0.0k metrics backend for swift-metrics that uses the statsd protocol
...
- [apple/swift-system](https://github.com/apple/swift-system) topic:file-descriptor,file-path,posix pushed_at:2026-07 star:1.4k fork:0.1k Low-level system calls and types for Swift
- [apple/swift-system-metrics](https://github.com/apple/swift-system-metrics) topic:metrics,process,server,swift,swift-server,system pushed_at:2026-07 star:0.2k fork:0.0k Report process-level system metrics (memory, CPU, file descriptors) to Swift Metrics
- [apple/swift-temporal-sdk](https://github.com/apple/swift-temporal-sdk) topic: pushed_at:2026-07 star:0.3k fork:0.0k Swift SDK for Temporal
- [apple/swift-tls](https://github.com/apple/swift-tls) topic: pushed_at:2026-07 star:0.1k fork:0.0k Swift implementation of TLS 1.3 for QUIC.
- [apple/swift-tools-support-async](https://github.com/apple/swift-tools-support-async) topic: pushed_at:2026-07 star:0.0k fork:0.0k Common infrastructural helpers on top of NIO for llbuild2 and swiftpm-on-llbuild2 projects. This is NOT a general purpose package and is unlikely to ever become stable.
- [apple/swiftpm-on-llbuild2](https://github.com/apple/swiftpm-on-llbuild2) topic: pushed_at:2022-04 star:0.0k fork:0.0k 
- [apple/SwiftUsd-Tests](https://github.com/apple/SwiftUsd-Tests) topic: pushed_at:2026-07 star:0.0k fork:0.0k Unit tests for SwiftUsd
...
- [apple/app-store-server-library-node](https://github.com/apple/app-store-server-library-node) topic: pushed_at:2026-07 star:0.4k fork:0.1k The Node.js server library for the App Store Server API and App Store Server Notifications.
- [apple/embedding-atlas](https://github.com/apple/embedding-atlas) topic:embedding,visualization pushed_at:2026-07 star:4.9k fork:0.3k Embedding Atlas is a tool that provides interactive visualizations for large embeddings. It allows you to visualize, cross-filter, and search embeddings and metadata.
...
- [apple/ml-agentuxlab](https://github.com/apple/ml-agentuxlab) topic: pushed_at:2026-07 star:0.0k fork:0.0k 
...
- [apple/pkl-vscode](https://github.com/apple/pkl-vscode) topic: pushed_at:2026-07 star:0.2k fork:0.0k Pkl language support for VS Code
