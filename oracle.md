...
- [oracle/odpi](https://github.com/oracle/odpi) topic: pushed_at:2026-05 star:0.3k fork:0.1k ODPI-C: Oracle Database Programming Interface for Drivers and Applications
...
- [oracle/nosql-dotnet-sdk](https://github.com/oracle/nosql-dotnet-sdk) topic:dotnet,nosql,nosql-database,oracle pushed_at:2026-06 star:0.0k fork:0.0k A .NET SDK for Oracle NoSQL Database
- [oracle/oci-dotnet-sdk](https://github.com/oracle/oci-dotnet-sdk) topic:cloud,csharp,dotnet,oracle,oracle-cloud,oracle-cloud-infrastructure,sdk pushed_at:2026-06 star:0.1k fork:0.0k Oracle Cloud Infrastructure SDK for .NET
- [oracle/oci-powershell-modules](https://github.com/oracle/oci-powershell-modules) topic:cloud,csharp,dotnet,oci,oracle,oracle-cloud,oracle-cloud-infrastructure,powershell,powershell-modules pushed_at:2026-06 star:0.0k fork:0.0k Oracle Cloud Infrastructure Modules for PowerShell
...
- [oracle/graaljs](https://github.com/oracle/graaljs) topic:graalvm,java,javascript,nodejs pushed_at:2026-06 star:2.0k fork:0.2k GraalJS – A high-performance, ECMAScript compliant, and embeddable JavaScript runtime for Java
...
- [oracle/fusabase-flutter-sdk](https://github.com/oracle/fusabase-flutter-sdk) topic: pushed_at:2026-06 star:0.0k fork:0.0k Fusabase Flutter SDK provides a unified, developer-friendly interface to interact with backend services provided by Oracle directly from hybrid application.
...
- [oracle/coherence-cli](https://github.com/oracle/coherence-cli) topic:cli,cli-tool,coherence,coherence-ce,management,monitoring,oracle pushed_at:2026-06 star:0.0k fork:0.0k The Coherence command line interface (CLI) is a lightweight tool, in the tradition of tools such as kubectl, which can be scripted or used interactively to manage and monitor Coherence clusters.
...
- [oracle/coherence-operator](https://github.com/oracle/coherence-operator) topic:coherence,kubernetes,kubernetes-operator,operator,oracle pushed_at:2026-06 star:0.1k fork:0.0k Oracle Coherence Operator
- [oracle/crossplane-provider-oci](https://github.com/oracle/crossplane-provider-oci) topic:crossplane,crossplane-provider pushed_at:2026-06 star:0.1k fork:0.0k Crossplane provider for Oracle Cloud Infrastructure(OCI)
...
- [oracle/karpenter-provider-oci](https://github.com/oracle/karpenter-provider-oci) topic: pushed_at:2026-06 star:0.0k fork:0.0k Karpenter Provider for Oracle Cloud Infrastructure
...
- [oracle/nosql-go-sdk](https://github.com/oracle/nosql-go-sdk) topic:cloud,nosql-database,oracle pushed_at:2026-06 star:0.0k fork:0.0k SDK for Go for Oracle NoSQL Database
- [oracle/oci-cloud-controller-manager](https://github.com/oracle/oci-cloud-controller-manager) topic:kubernetes,kubernetes-cluster,oracle-cloud,oracle-cloud-infrastructure pushed_at:2026-06 star:0.2k fork:0.1k Kubernetes Cloud Controller Manager implementation for Oracle Cloud Infrastructure
...
- [oracle/oci-go-sdk](https://github.com/oracle/oci-go-sdk) topic:cloud,go,oracle-cloud,oracle-cloud-infrastructure,sdk pushed_at:2026-06 star:0.2k fork:0.1k Go SDK for Oracle Cloud Infrastructure 
...
- [oracle/oci-grafana-metrics](https://github.com/oracle/oci-grafana-metrics) topic:grafana,oci,oracle-cloud-infrastructure,plugin pushed_at:2026-06 star:0.1k fork:0.0k Grafana datasource plugin for OCI metrics
...
- [oracle/oci-secrets-store-csi-driver-provider](https://github.com/oracle/oci-secrets-store-csi-driver-provider) topic: pushed_at:2025-06 star:0.0k fork:0.0k 
- [oracle/oci-service-operator](https://github.com/oracle/oci-service-operator) topic:cloud,kubernetes,kubernetes-operator,oci-service-operator,operator-sdk,oracle-cloud,oracle-cloud-infrastructure pushed_at:2026-05 star:0.0k fork:0.0k The OCI Service Operator for Kubernetes (OSOK) makes it easy to connect and manage OCI services from a cloud native application running in a Kubernetes environment.
...
- [oracle/oracle-database-operator](https://github.com/oracle/oracle-database-operator) topic:autonomous-database,kubernetes,kubernetes-operator,openshift,operator,oracle-cloud-infrastucture,oracle-database pushed_at:2026-06 star:0.2k fork:0.1k The Oracle Database Operator for Kubernetes (a.k.a. OraOperator) helps developers, DBAs, DevOps and GitOps teams reduce the time and complexity of deploying and managing Oracle Databases. It eliminates the dependency on a human operator or administrator for the majority of database operations.
- [oracle/oracle-db-appdev-monitoring](https://github.com/oracle/oracle-db-appdev-monitoring) topic:appdev,grafana-dashboard,microservices,opentelemetry,oracle-database,prometheus pushed_at:2026-06 star:0.3k fork:0.1k Oracle Database Metrics Exporter supporting de-facto standard Prometheus/OpenTelemetry metrics
...
- [oracle/terraform-provider-oci](https://github.com/oracle/terraform-provider-oci) topic:bare-metal,iaas,oci,oracle,oracle-cloud,oracle-cloud-infrastructure,orchestration,terraform,terraform-provider pushed_at:2026-06 star:0.9k fork:0.7k Terraform Oracle Cloud Infrastructure provider
...
- [oracle/hospitality-api-docs](https://github.com/oracle/hospitality-api-docs) topic:hospitality,oas2,postman-collection,rest-api pushed_at:2026-06 star:0.2k fork:0.1k This repository stores REST API specifications and accompanying Postman collections for Oracle Hospitality APIs.
...
- [oracle/database-navigator](https://github.com/oracle/database-navigator) topic: pushed_at:2026-06 star:0.0k fork:0.0k Database Navigator is a privately developed open-source database tool and it became an Oracle product early 2025. 
...
- [oracle/fusabase-android-sdk](https://github.com/oracle/fusabase-android-sdk) topic: pushed_at:2026-06 star:0.0k fork:0.0k Fusabase Android SDK provides a unified, developer-friendly interface to interact with backend services provided by Oracle directly from Mobile application.
...
- [oracle/graal-dev-kit](https://github.com/oracle/graal-dev-kit) topic: pushed_at:2026-06 star:0.0k fork:0.0k Graal Development Kit for Micronaut (GDK) is a curated set of open source Micronaut® framework modules designed from the ground up to be compiled ahead-of-time with GraalVM Native Image resulting in native executables ideal for microservices.
- [oracle/graalpy-extensions](https://github.com/oracle/graalpy-extensions) topic: pushed_at:2026-06 star:0.0k fork:0.0k 
...
- [oracle/nosql-java-sdk](https://github.com/oracle/nosql-java-sdk) topic:cloud,database,java,nosql,nosql-database,oracle,oracle-cloud pushed_at:2026-06 star:0.0k fork:0.0k SDK for Java for the Oracle NoSQL Database
...
- [oracle/oci-java-sdk](https://github.com/oracle/oci-java-sdk) topic:oracle-cloud,sdk pushed_at:2026-06 star:0.2k fork:0.2k Oracle Cloud Infrastructure SDK for Java
...
- [oracle/ojdbc-extensions](https://github.com/oracle/ojdbc-extensions) topic:jdbc,oauth2,ojdbc8,oracle,spi pushed_at:2026-06 star:0.0k fork:0.0k The Oracle JDBC Driver Extensions include providers for centralized configuration or token providers for authentication with the DB.
...
- [oracle/opengrok](https://github.com/oracle/opengrok) topic:code,engine,java,maven,opengrok,search,source pushed_at:2026-06 star:4.9k fork:0.8k OpenGrok is a fast and usable source code search and cross reference engine, written in Java
...
- [oracle/pushiomanager-react-native](https://github.com/oracle/pushiomanager-react-native) topic:android,ios,oracle,react-native,responsys pushed_at:2026-06 star:0.0k fork:0.0k React Native Module for Responsys SDK
...
- [oracle/spring-cloud-oracle](https://github.com/oracle/spring-cloud-oracle) topic: pushed_at:2026-06 star:0.1k fork:0.0k Spring Cloud Oracle, eases the integration with Oracle Database and OCI services, and offers a convenient way to interact with Oracle Database and OCI-provided services using well-known Spring idioms and APIs.
...
- [oracle/weblogic-image-tool](https://github.com/oracle/weblogic-image-tool) topic:docker,docker-image,image-builder,kubernetes,oracle-weblogic-image,weblogic,weblogic-server pushed_at:2026-06 star:0.1k fork:0.0k WebLogic Image Tool
- [oracle/weblogic-kubernetes-operator](https://github.com/oracle/weblogic-kubernetes-operator) topic:kubernetes,operator,weblogic,weblogic-server pushed_at:2026-06 star:0.3k fork:0.2k WebLogic Kubernetes Operator
...
- [oracle/fusabase-js-namespace-sdk](https://github.com/oracle/fusabase-js-namespace-sdk) topic: pushed_at:2026-06 star:0.0k fork:0.0k Fusabase JavaScript Namespace SDK provides a unified, developer-friendly interface to interact with backend services provided by Oracle directly from web application.
...
- [oracle/weblogic-toolkit-ui](https://github.com/oracle/weblogic-toolkit-ui) topic:devops,kubernetes,provisioning,weblogic pushed_at:2026-06 star:0.0k fork:0.0k WebLogic Kubernetes Toolkit UI
...
- [oracle/apex](https://github.com/oracle/apex) topic:app-development,low-code,oracle-database pushed_at:2026-06 star:0.6k fork:0.3k Official Oracle APEX repo for sample code, starter apps, plug-ins, and more! #orclapex
- [oracle/binutils-gdb](https://github.com/oracle/binutils-gdb) topic:binutils,gdb,oracle pushed_at:2025-08 star:0.0k fork:0.0k Unofficial mirror of http://sourceware.org/git/binutils-gdb.git
...
- [oracle/container-images](https://github.com/oracle/container-images) topic:aarch64,amd64,docker,docker-image,oracle,oracle-linux,oracle-support pushed_at:2026-06 star:0.2k fork:0.1k Oracle Linux container images
...
- [oracle/gcc](https://github.com/oracle/gcc) topic:gcc,oracle pushed_at:2025-08 star:0.0k fork:0.0k Unofficial mirror of https://gcc.gnu.org/git/gcc.git
- [oracle/glibc](https://github.com/oracle/glibc) topic:glibc,oracle pushed_at:2026-05 star:0.0k fork:0.0k Unofficial mirror of http://sourceware.org/git/glibc.git
...
- [oracle/linux-uek](https://github.com/oracle/linux-uek) topic:kernel,linux,linux-kernel,oracle,uek pushed_at:2026-06 star:0.4k fork:0.1k Oracle Linux UEK: Unbreakable Enterprise Kernel
...
- [oracle/template-repo](https://github.com/oracle/template-repo) topic: pushed_at:2026-01 star:0.0k fork:0.0k This is a template repository. It contains information about the guidelines for Oracle’s GitHub repositories.
...
- [oracle/accelerated-data-science](https://github.com/oracle/accelerated-data-science) topic:cloud,machine-learning,oci,oracle,python3 pushed_at:2026-06 star:0.1k fork:0.1k ADS is the Oracle Data Science Cloud Service's python SDK supporting, model ops (train/eval/deploy), along with running workloads on Jobs and Pipeline resources.
...
- [oracle/ai-optimizer](https://github.com/oracle/ai-optimizer) topic:embedding-models,generative-ai,large-language-models,nl2sql,oracle-database,retrieval-augmented-generation,vector-database pushed_at:2026-06 star:0.1k fork:0.0k GenAI/RAG Optimizer and Toolkit for experimentation using Oracle Database AI Vector Search and NL2SQL
...
- [oracle/dbt-oracle](https://github.com/oracle/dbt-oracle) topic:autonomous-database,data-build-tool,dbt,oracle pushed_at:2026-06 star:0.1k fork:0.0k dbt (data build tool) adapter for Oracle Autonomous AI Database
- [oracle/graalpython](https://github.com/oracle/graalpython) topic:embeddable,graalvm,java,python,python3 pushed_at:2026-06 star:1.6k fork:0.2k GraalPy – A high-performance embeddable Python 3 runtime for Java
...
- [oracle/kconfigs](https://github.com/oracle/kconfigs) topic:linux,linux-kernel pushed_at:2026-06 star:0.0k fork:0.0k Tool for extracting Linux kernel configurations from many distributions & displaying a web UI
- [oracle/langchain-oracle](https://github.com/oracle/langchain-oracle) topic: pushed_at:2026-06 star:0.1k fork:0.0k The Oracle LangChain integration provides official LangChain support for Oracle’s Generative AI and AI Platform services, enabling developers to build intelligent, secure, and scalable applications powered by Oracle’s cloud technologies.
- [oracle/macaron](https://github.com/oracle/macaron) topic:build-system,cicd,docker,gradle,integrity-protection,malware-analysis,malware-detection,maven,npm,python,sbom,slsa,supply-chain-security pushed_at:2026-06 star:0.2k fork:0.0k Macaron is an extensible supply-chain security analysis framework from Oracle Labs that supports a wide range of build systems and CI/CD services. It can be used to prevent supply chain attacks, detect malicious Python packages, or check conformance to frameworks, such as SLSA. Documentation:
- [oracle/mcp](https://github.com/oracle/mcp) topic: pushed_at:2026-06 star:0.4k fork:0.1k Repository containing MCP (Model Context Protocol) servers that provides a suite of tools for managing and interacting with Oracle products.
...
- [oracle/oci-cli](https://github.com/oracle/oci-cli) topic:bare-metal,cli,cloud,infrastructure pushed_at:2026-06 star:0.6k fork:0.2k Command Line Interface for Oracle Cloud Infrastructure
...
- [oracle/oci-python-sdk](https://github.com/oracle/oci-python-sdk) topic: pushed_at:2026-06 star:0.5k fork:0.3k Oracle Cloud Infrastructure SDK for Python
...
- [oracle/python-oracledb](https://github.com/oracle/python-oracledb) topic:api,database,development,driver,interface,module,oracle,oracle-database,oracle-database-driver,python,python-oracledb pushed_at:2026-06 star:0.4k fork:0.1k Python driver for Oracle Database conforming to the Python DB API 2.0 specification with many advanced features. Fast, small, portable. Enterprise ready.
- [oracle/python-select-ai](https://github.com/oracle/python-select-ai) topic: pushed_at:2026-06 star:0.0k fork:0.0k Select AI for Python
- [oracle/skills](https://github.com/oracle/skills) topic: pushed_at:2026-06 star:0.7k fork:0.2k Oracle Skills is a curated, open-source collection of practical, installable skills for working with Oracle technologies. It provides developers, administrators, and AI agents with high-quality, source-backed guidance across the entire Oracle ecosystem.
- [oracle/solaris-ips](https://github.com/oracle/solaris-ips) topic:solaris pushed_at:2026-06 star:0.1k fork:0.0k Solaris IPS: Image Packaging System
...
- [oracle/wayflow](https://github.com/oracle/wayflow) topic: pushed_at:2026-06 star:0.2k fork:0.0k WayFlow is a powerful, intuitive Python library for building sophisticated AI-powered assistants. It is a reference runtime for Agent Spec, with native support for all Agent Spec Agents and Flows.
- [oracle/weblogic-deploy-tooling](https://github.com/oracle/weblogic-deploy-tooling) topic:automation,continuous-testing,python,wdt,weblogic pushed_at:2026-06 star:0.2k fork:0.1k WebLogic Deploy Tooling
...
- [oracle/yo](https://github.com/oracle/yo) topic:linux,oci,oracle-cloud-infrastructure pushed_at:2026-06 star:0.1k fork:0.0k A fast and simple command line OCI client
...
- [oracle/oci-ruby-sdk](https://github.com/oracle/oci-ruby-sdk) topic:cloud,oracle-cloud,oracle-cloud-infrastructure,ruby,sdk pushed_at:2025-05 star:0.0k fork:0.0k Ruby SDK for Oracle Cloud Infrastructure
- [oracle/puppet-solaris_providers](https://github.com/oracle/puppet-solaris_providers) topic:puppet,solaris pushed_at:2026-06 star:0.0k fork:0.0k Oracle Solaris Puppet Module
...
- [oracle/nosql-rust-sdk](https://github.com/oracle/nosql-rust-sdk) topic:cloud,nosql,nosql-database,rust pushed_at:2026-06 star:0.0k fork:0.0k SDK for Rust for the Oracle NoSQL Database
...
- [oracle/fmw-kubernetes](https://github.com/oracle/fmw-kubernetes) topic:kubernetes,operator,oracle-webcenter pushed_at:2026-06 star:0.0k fork:0.0k Kubernetes Deployment Scripts for Oracle Fusion Middleware products
...
- [oracle/vagrant-projects](https://github.com/oracle/vagrant-projects) topic:oracle,vagrant,vagrant-boxes,vagrant-virtual-machine,vagrantfiles,virtualbox,virtualbox-vm pushed_at:2026-06 star:1.0k fork:0.5k Vagrant projects for Oracle products and other examples
- [oracle/weblogic-azure](https://github.com/oracle/weblogic-azure) topic:aks,azure,kubernetes,vms,weblogic pushed_at:2026-06 star:0.0k fork:0.0k This project offers support for running Oracle WebLogic Server in the Azure Virtual Machines and Azure Kubernetes Service (AKS)
...
- [oracle/fusabase-ios-sdk](https://github.com/oracle/fusabase-ios-sdk) topic: pushed_at:2026-06 star:0.0k fork:0.0k Fusabase IOS SDK provides a unified, developer-friendly interface to interact with backend services provided by Oracle directly from mobile application.
...
- [oracle/coherence-js-client](https://github.com/oracle/coherence-js-client) topic:caching,clustering,coherence,data-grid,distributed,grpc,grpc-client,grpc-node,in-memory,kv-store,microservices,polyglot,scalability pushed_at:2026-06 star:0.0k fork:0.0k The Coherence JavaScript Client
...
- [oracle/fusabase-js-sdk](https://github.com/oracle/fusabase-js-sdk) topic: pushed_at:2026-06 star:0.0k fork:0.0k Fusabase JavaScript SDK provides a unified, developer-friendly interface to interact with backend services provided by Oracle directly from web application.
- [oracle/gdk-vscode-extensions](https://github.com/oracle/gdk-vscode-extensions) topic:devops,gcn,graalvm,oci,vscode-extension pushed_at:2026-06 star:0.0k fork:0.0k Graal Development Kit for Micronaut VSCode developer support
- [oracle/javavscode](https://github.com/oracle/javavscode) topic:java,language-server-protocol,oracle,vscode-extension pushed_at:2026-06 star:0.3k fork:0.1k Java platform support for Visual Studio Code for full featured Java development (edit-compile-debug & test cycle)
...
- [oracle/oci-typescript-sdk](https://github.com/oracle/oci-typescript-sdk) topic:cloud,javascript,nodejs,oracle-cloud,sdk,typescript pushed_at:2026-06 star:0.1k fork:0.1k Oracle Cloud Infrastructure SDK for TypeScript and JavaScript
