...
- [oracle/bpftune](https://github.com/oracle/bpftune) topic:auto-tuning,bpf,ebpf,linux pushed_at:2024-11 star:1.4k fork:0.1k bpftune uses BPF to auto-tune Linux systems
...
- [oracle/oci-cloud-controller-manager](https://github.com/oracle/oci-cloud-controller-manager) topic:kubernetes,kubernetes-cluster,oracle-cloud,oracle-cloud-infrastructure pushed_at:2024-11 star:0.1k fork:0.1k Kubernetes Cloud Controller Manager implementation for Oracle Cloud Infrastructure
...
- [oracle/oci-grafana-logs](https://github.com/oracle/oci-grafana-logs) topic:grafana,logs,oci,oracle pushed_at:2024-11 star:0.0k fork:0.0k Grafana datasource plugin for OCI logs
...
- [oracle/oci-native-ingress-controller](https://github.com/oracle/oci-native-ingress-controller) topic: pushed_at:2024-11 star:0.0k fork:0.0k OCI Native Ingress Controller
...
- [oracle/hospitality-api-docs](https://github.com/oracle/hospitality-api-docs) topic:hospitality,oas2,postman-collection,rest-api pushed_at:2024-11 star:0.1k fork:0.1k This repository stores REST API specifications and accompanying Postman collections for Oracle Hospitality APIs.
...
- [oracle/gdk-intellij-tooling](https://github.com/oracle/gdk-intellij-tooling) topic:cloud,framework,tools,web pushed_at:2024-11 star:0.0k fork:0.0k The plugin provides Graal Development Kit for Micronaut (GDK) project wizard which generates GDK applications.
...
- [oracle/graalvm-reachability-metadata](https://github.com/oracle/graalvm-reachability-metadata) topic: pushed_at:2024-12 star:0.4k fork:0.1k Repository which contains community-driven collection of GraalVM reachability metadata for open-source libraries.
...
- [oracle/nosql-java-sdk](https://github.com/oracle/nosql-java-sdk) topic:cloud,database,java,nosql,nosql-database,oracle,oracle-cloud pushed_at:2024-11 star:0.0k fork:0.0k SDK for Java for the Oracle NoSQL Database
...
- [oracle/oci-compute-jenkins-plugin](https://github.com/oracle/oci-compute-jenkins-plugin) topic:cloud,jenkins,oci,oracle-cloud,oracle-cloud-infrastructure pushed_at:2024-11 star:0.0k fork:0.0k Jenkins Plugin for Oracle Cloud Infrastructure (Compute)
...
- [oracle/opengrok](https://github.com/oracle/opengrok) topic:code,engine,java,opengrok,search,source pushed_at:2024-11 star:4.4k fork:0.8k OpenGrok is a fast and usable source code search and cross reference engine, written in Java
...
- [oracle/tribuo](https://github.com/oracle/tribuo) topic:classification,clustering,deep-learning,java,machine-learning,ml,nlp,regression pushed_at:2024-11 star:1.3k fork:0.2k Tribuo - A Java machine learning library
...
- [oracle/node-oracledb](https://github.com/oracle/node-oracledb) topic:database,javascript,node,node-oracledb,nodejs,oracle,typescript pushed_at:2024-11 star:2.3k fork:1.1k Oracle Database driver for Node.js maintained by Oracle Corp.
...
- [oracle/dbt-oracle](https://github.com/oracle/dbt-oracle) topic:autonomous-database,data-build-tool,dbt,oracle pushed_at:2024-09 star:0.1k fork:0.0k dbt (data build tool) adapter for Oracle Autonomous Database
...
- [oracle/oci-cli](https://github.com/oracle/oci-cli) topic:bare-metal,cli,cloud,infrastructure pushed_at:2024-11 star:0.5k fork:0.2k Command Line Interface for Oracle Cloud Infrastructure
...
- [oracle/coherence-js-client](https://github.com/oracle/coherence-js-client) topic:caching,clustering,coherence,data-grid,distributed,grpc,grpc-client,grpc-node,in-memory,kv-store,microservices,polyglot,scalability pushed_at:2024-11 star:0.0k fork:0.0k The Coherence JavaScript Client
...
- [oracle/gdk-vscode-extensions](https://github.com/oracle/gdk-vscode-extensions) topic:devops,gcn,graalvm,oci,vscode-extension pushed_at:2024-11 star:0.0k fork:0.0k Graal Development Kit for Micronaut VSCode developer support
...
- [oracle/oci-grafana-metrics](https://github.com/oracle/oci-grafana-metrics) topic:grafana,oci,oracle-cloud-infrastructure,plugin pushed_at:2024-11 star:0.1k fork:0.0k Grafana datasource plugin for OCI metrics
