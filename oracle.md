...
- [oracle/adaptivemm](https://github.com/oracle/adaptivemm) topic:memory,performance pushed_at:2024-10 star:0.0k fork:0.0k adaptivemm - A userspace daemon for proactive free memory management
- [oracle/bpftune](https://github.com/oracle/bpftune) topic:auto-tuning,bpf,ebpf,linux pushed_at:2024-10 star:0.7k fork:0.1k bpftune uses BPF to auto-tune Linux systems
...
- [oracle/odpi](https://github.com/oracle/odpi) topic: pushed_at:2024-10 star:0.3k fork:0.1k ODPI-C: Oracle Database Programming Interface for Drivers and Applications
...
- [oracle/nosql-dotnet-sdk](https://github.com/oracle/nosql-dotnet-sdk) topic:dotnet,nosql,nosql-database,oracle pushed_at:2024-10 star:0.0k fork:0.0k A .NET SDK for Oracle NoSQL Database
...
- [oracle/graaljs](https://github.com/oracle/graaljs) topic:graalvm,java,javascript,nodejs pushed_at:2024-10 star:1.8k fork:0.2k GraalJS – A high-performance, ECMAScript compliant, and embeddable JavaScript runtime for Java
...
- [oracle/coherence-operator](https://github.com/oracle/coherence-operator) topic:coherence,kubernetes,kubernetes-operator,operator,oracle pushed_at:2024-10 star:0.1k fork:0.0k Oracle Coherence Operator
...
- [oracle/nosql-go-sdk](https://github.com/oracle/nosql-go-sdk) topic:cloud,nosql-database,oracle pushed_at:2024-10 star:0.0k fork:0.0k SDK for Go for Oracle NoSQL Database
...
- [oracle/coherence-eclipse-plugin](https://github.com/oracle/coherence-eclipse-plugin) topic:coherence,coherence-ce,eclipse-plugin,plugin pushed_at:2024-11 star:0.0k fork:0.0k The Coherence Eclipse Plugin provides various features to help developer productivity when working with Coherence.
...
- [oracle/coherence-idea-plugin](https://github.com/oracle/coherence-idea-plugin) topic:coherence,coherence-ce,idea-plugin,plugin pushed_at:2024-10 star:0.0k fork:0.0k This plugin adds features to IntelliJ to assist in development of applications using Oracle Coherence.
...
- [oracle/coherence-visualvm](https://github.com/oracle/coherence-visualvm) topic:coherence,management,visualvm,visualvm-plugin pushed_at:2024-11 star:0.0k fork:0.0k The Coherence-VisualVM Plugin provides management and monitoring of a single Coherence cluster using the VisualVM management utility.
...
- [oracle/graal](https://github.com/oracle/graal) topic:aot,compiler,graalvm,java pushed_at:2024-11 star:20.4k fork:1.6k GraalVM compiles Java applications into native executables that start instantly, scale fast, and use fewer compute resources 🚀
...
- [oracle/graalvm-reachability-metadata](https://github.com/oracle/graalvm-reachability-metadata) topic: pushed_at:2024-11 star:0.4k fork:0.1k Repository which contains community-driven collection of GraalVM reachability metadata for open-source libraries.
...
- [oracle/nosql-spring-sdk](https://github.com/oracle/nosql-spring-sdk) topic:java,nosql,nosql-database,oracle,spring,spring-boot pushed_at:2024-10 star:0.0k fork:0.0k SDK for Spring Data for Oracle NoSQL Database
...
- [oracle/olcut](https://github.com/oracle/olcut) topic:command-line-arguments,command-shell,configuration,dependency-injection-framework,java,options-parsing,provenance pushed_at:2024-10 star:0.0k fork:0.0k A Java configuration, shell, and general utility toolkit
...
- [oracle/rewrite-recipes](https://github.com/oracle/rewrite-recipes) topic:java,openrewrite,openrewrite-recipes,weblogic pushed_at:2024-10 star:0.0k fork:0.0k OpenRewrite recipes for Oracle solutions, like upgrades of java and Weblogic.
...
- [oracle/sandwood](https://github.com/oracle/sandwood) topic:compiler,java,machine-learning,ml,probabilistic-models,probabilistic-programming,runtime pushed_at:2024-10 star:0.0k fork:0.0k Sandwood - A JVM based Java like Probabilistic Programming Language
...
- [oracle/soda-for-java](https://github.com/oracle/soda-for-java) topic:crud,fulltext-search,java,jdbc,json,json-data,no-sql,nosql,nosql-database,oracle-database,persistence,rest,soda,sql,text-search pushed_at:2024-10 star:0.1k fork:0.0k SODA (Simple Oracle Document Access) for Java is an Oracle library for writing Java apps that work with JSON (and not only JSON!) in the Oracle Database. SODA allows your Java app to use the Oracle Database as a NoSQL document store.
...
- [oracle/nosql-node-sdk](https://github.com/oracle/nosql-node-sdk) topic:cloud,database,nodejs,nosql,nosql-database,oracle,oracle-cloud pushed_at:2024-10 star:0.0k fork:0.0k Node.js SDK for Oracle NoSQL Database
...
- [oracle/weblogic-remote-console](https://github.com/oracle/weblogic-remote-console) topic:configuration,management,monitoring,rest,weblogic pushed_at:2024-10 star:0.0k fork:0.0k A WebLogic Console that connects remotely using the WebLogic Management REST API
...
- [oracle/graalpython](https://github.com/oracle/graalpython) topic:embeddable,graalvm,java,python,python3 pushed_at:2024-10 star:1.2k fork:0.1k GraalPy – A high-performance embeddable Python 3 runtime for Java
...
- [oracle/fluent-plugin-oci-logging](https://github.com/oracle/fluent-plugin-oci-logging) topic:fluentd,fluentd-output-plugin,oci pushed_at:2024-10 star:0.0k fork:0.0k This is the official fluentD output plugin for the Oracle Cloud Infrastructure (OCI) Logging service.
...
- [oracle/wookiee](https://github.com/oracle/wookiee) topic:framework,lightweight,microservice,scala,wookiee pushed_at:2024-02 star:0.1k fork:0.0k Scala based lightweight service framework using zookeeper, gRPC, and other popular technologies.
...
- [oracle/docker-images](https://github.com/oracle/docker-images) topic:coherence-ce,docker,docker-images,dockerfile,dockerfiles,graalvm,nosql,oci,oracle,oracle-commercial,oracle-database,oracle-instantclient,oracle-linux,oracle-products,oraclelinux pushed_at:2024-10 star:6.6k fork:5.4k Official source of container configurations, images, and examples for Oracle products and projects
...
- [oracle/weblogic-azure](https://github.com/oracle/weblogic-azure) topic:aks,azure,kubernetes,vms,weblogic pushed_at:2024-10 star:0.0k fork:0.0k This project offers support for running Oracle WebLogic Server in the Azure Virtual Machines and Azure Kubernetes Service (AKS)
