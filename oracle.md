...
- [oracle/adaptivemm](https://github.com/oracle/adaptivemm) topic:memory,performance pushed_at:2024-12 star:0.1k fork:0.0k adaptivemm - A userspace daemon for proactive free memory management
- [oracle/bpftune](https://github.com/oracle/bpftune) topic:auto-tuning,bpf,ebpf,linux pushed_at:2024-12 star:1.5k fork:0.1k bpftune uses BPF to auto-tune Linux systems
...
- [oracle/ktls-utils](https://github.com/oracle/ktls-utils) topic:ktls,linux,tls pushed_at:2024-12 star:0.0k fork:0.0k TLS handshake utilities for in-kernel TLS consumers
...
- [oracle/odpi](https://github.com/oracle/odpi) topic: pushed_at:2024-12 star:0.3k fork:0.1k ODPI-C: Oracle Database Programming Interface for Drivers and Applications
...
- [oracle/coherence-dotnet-extend-client](https://github.com/oracle/coherence-dotnet-extend-client) topic:caching,cloud,clustering,coherence,data-grid,distributed,dotnet,hpc,imdg,in-memory,kv-store,microservices,polyglot,scalability pushed_at:2024-12 star:0.0k fork:0.0k Coherence .NET client library
...
- [oracle/oci-dotnet-sdk](https://github.com/oracle/oci-dotnet-sdk) topic:cloud,csharp,dotnet,oracle,oracle-cloud,oracle-cloud-infrastructure,sdk pushed_at:2024-12 star:0.1k fork:0.0k Oracle Cloud Infrastructure SDK for .NET
- [oracle/oci-powershell-modules](https://github.com/oracle/oci-powershell-modules) topic:cloud,csharp,dotnet,oci,oracle,oracle-cloud,oracle-cloud-infrastructure,powershell,powershell-modules pushed_at:2024-12 star:0.0k fork:0.0k Oracle Cloud Infrastructure Modules for PowerShell

## C++

- [oracle/coherence-cpp-extend-client](https://github.com/oracle/coherence-cpp-extend-client) topic:caching,cloud,clustering,coherence,cpp,data-grid,distributed,hpc,imdg,in-memory,kv-store,microservices,polyglot,sanka,scalability pushed_at:2024-12 star:0.0k fork:0.0k Coherence C++ client library
- [oracle/graaljs](https://github.com/oracle/graaljs) topic:graalvm,java,javascript,nodejs pushed_at:2024-12 star:1.8k fork:0.2k GraalJS – A high-performance, ECMAScript compliant, and embeddable JavaScript runtime for Java
...
- [oracle/coherence-cli](https://github.com/oracle/coherence-cli) topic:cli,cli-tool,coherence,coherence-ce,management,monitoring,oracle pushed_at:2024-12 star:0.0k fork:0.0k The Coherence command line interface (CLI) is a lightweight tool, in the tradition of tools such as kubectl, which can be scripted or used interactively to manage and monitor Coherence clusters.
- [oracle/coherence-go-client](https://github.com/oracle/coherence-go-client) topic:caching,coherence,coherence-ce,data-grid,distributed,go-client,golang,grpc,grpc-client,in-memory-caching,kv-store,microservices,scalability pushed_at:2024-12 star:0.0k fork:0.0k The Coherence Go Client allows native Go applications to act as cache clients to a Coherence cluster using gRPC for the network transport.
- [oracle/coherence-operator](https://github.com/oracle/coherence-operator) topic:coherence,kubernetes,kubernetes-operator,operator,oracle pushed_at:2024-12 star:0.1k fork:0.0k Oracle Coherence Operator
...
- [oracle/nosql-go-sdk](https://github.com/oracle/nosql-go-sdk) topic:cloud,nosql-database,oracle pushed_at:2024-12 star:0.0k fork:0.0k SDK for Go for Oracle NoSQL Database
- [oracle/oci-cloud-controller-manager](https://github.com/oracle/oci-cloud-controller-manager) topic:kubernetes,kubernetes-cluster,oracle-cloud,oracle-cloud-infrastructure pushed_at:2024-12 star:0.1k fork:0.1k Kubernetes Cloud Controller Manager implementation for Oracle Cloud Infrastructure
...
- [oracle/oci-go-sdk](https://github.com/oracle/oci-go-sdk) topic:cloud,go,oracle-cloud,oracle-cloud-infrastructure,sdk pushed_at:2024-12 star:0.2k fork:0.1k Go SDK for Oracle Cloud Infrastructure 
...
- [oracle/oracle-db-appdev-monitoring](https://github.com/oracle/oracle-db-appdev-monitoring) topic:appdev,grafana-dashboard,microservices,oracle-database,prometheus pushed_at:2024-12 star:0.1k fork:0.0k Metrics exporter and samples for unified observability for data-centric app dev and microservices
...
- [oracle/terraform-provider-oci](https://github.com/oracle/terraform-provider-oci) topic:bare-metal,iaas,oci,oracle,oracle-cloud,oracle-cloud-infrastructure,orchestration,terraform,terraform-provider pushed_at:2024-12 star:0.8k fork:0.7k Terraform Oracle Cloud Infrastructure provider
...
- [oracle/hospitality-api-docs](https://github.com/oracle/hospitality-api-docs) topic:hospitality,oas2,postman-collection,rest-api pushed_at:2024-12 star:0.1k fork:0.1k This repository stores REST API specifications and accompanying Postman collections for Oracle Hospitality APIs.
...
- [oracle/tribuo-site](https://github.com/oracle/tribuo-site) topic:java,machine-learning,tribuo pushed_at:2024-12 star:0.0k fork:0.0k The website for the Tribuo Java Machine Learning Library - https://github.com/oracle/tribuo
...
- [oracle/coherence](https://github.com/oracle/coherence) topic:caching,cloud,clustering,coherence,data-grid,distributed,hpc,imdg,in-memory,java,kv-store,microservices,polyglot,scalability pushed_at:2024-12 star:0.4k fork:0.1k Oracle Coherence Community Edition
...
- [oracle/coherence-helidon-sockshop-sample](https://github.com/oracle/coherence-helidon-sockshop-sample) topic:coherence,helidon,sockshop pushed_at:2024-12 star:0.0k fork:0.0k Coherence Helidon Sockshop Demo
...
- [oracle/coherence-micronaut-sockshop-sample](https://github.com/oracle/coherence-micronaut-sockshop-sample) topic:coherence,micronaut,sockshop pushed_at:2024-12 star:0.0k fork:0.0k Coherence Micronaut Sockshop Demo
...
- [oracle/coherence-spring-sockshop-sample](https://github.com/oracle/coherence-spring-sockshop-sample) topic:coherence,sockshop,spring pushed_at:2024-12 star:0.0k fork:0.0k Coherence Spring Sockshop Demo
- [oracle/coherence-visualvm](https://github.com/oracle/coherence-visualvm) topic:coherence,management,visualvm,visualvm-plugin pushed_at:2024-12 star:0.0k fork:0.0k The Coherence-VisualVM Plugin provides management and monitoring of a single Coherence cluster using the VisualVM management utility.
...
- [oracle/fastr](https://github.com/oracle/fastr) topic:graalvm,r,r-language pushed_at:2024-12 star:0.6k fork:0.1k A high-performance implementation of the R programming language, built on GraalVM.
...
- [oracle/graal](https://github.com/oracle/graal) topic:aot,compiler,graalvm,java pushed_at:2024-12 star:20.5k fork:1.6k GraalVM compiles Java applications into native executables that start instantly, scale fast, and use fewer compute resources 🚀
- [oracle/graal-dev-kit](https://github.com/oracle/graal-dev-kit) topic: pushed_at:2024-12 star:0.0k fork:0.0k Graal Development Kit for Micronaut (GDK) is a curated set of open source Micronaut® framework modules designed from the ground up to be compiled ahead-of-time with GraalVM Native Image resulting in native executables ideal for microservices.
...
- [oracle/nosql-examples](https://github.com/oracle/nosql-examples) topic:api,awesome,cloud,database,examples,functions,java,node-js,nosql,nosql-database,oci,on-premise,oracle,oracle-cloud,oracle-nosql-database,python,spring,spring-data,stream,terraform pushed_at:2024-12 star:0.1k fork:0.0k This is a top level repository for code examples related to the use of Oracle NoSQL Database.
...
- [oracle/nosql-spring-sdk](https://github.com/oracle/nosql-spring-sdk) topic:java,nosql,nosql-database,oracle,spring,spring-boot pushed_at:2024-12 star:0.0k fork:0.0k SDK for Spring Data for Oracle NoSQL Database
...
- [oracle/oci-hdfs-connector](https://github.com/oracle/oci-hdfs-connector) topic:cloud,hdfs,oracle-cloud pushed_at:2024-12 star:0.0k fork:0.0k HDFS Connector for Oracle Cloud Infrastructure
- [oracle/oci-java-sdk](https://github.com/oracle/oci-java-sdk) topic:oracle-cloud,sdk pushed_at:2024-12 star:0.2k fork:0.2k Oracle Cloud Infrastructure SDK for Java
...
- [oracle/ojdbc-extensions](https://github.com/oracle/ojdbc-extensions) topic:jdbc,oauth2,ojdbc8,oracle,spi pushed_at:2024-12 star:0.0k fork:0.0k The Oracle JDBC Driver Extensions include providers for centralized configuration or token providers for authentication with the DB.
- [oracle/okafka](https://github.com/oracle/okafka) topic:aq,converged-database,event-queues,java,kafka,microservices pushed_at:2024-12 star:0.0k fork:0.0k Kafka Java Client for Oracle Transactional Event Queues
...
- [oracle/opengrok](https://github.com/oracle/opengrok) topic:code,engine,java,opengrok,search,source pushed_at:2024-12 star:4.4k fork:0.8k OpenGrok is a fast and usable source code search and cross reference engine, written in Java
...
- [oracle/rewrite-recipes](https://github.com/oracle/rewrite-recipes) topic:java,openrewrite,openrewrite-recipes,weblogic pushed_at:2024-12 star:0.0k fork:0.0k OpenRewrite recipes for Oracle solutions, like upgrades of java and Weblogic.
...
- [oracle/spring-cloud-oracle](https://github.com/oracle/spring-cloud-oracle) topic: pushed_at:2024-12 star:0.0k fork:0.0k Spring Cloud Oracle, eases the integration with Oracle Database and OCI services, and offers a convenient way to interact with Oracle Database and OCI-provided services using well-known Spring idioms and APIs.
- [oracle/tribuo](https://github.com/oracle/tribuo) topic:classification,clustering,deep-learning,java,machine-learning,ml,nlp,regression pushed_at:2024-12 star:1.3k fork:0.2k Tribuo - A Java machine learning library
...
- [oracle/visualvm](https://github.com/oracle/visualvm) topic:java,monitoring-tool,performance,profiler,visualvm pushed_at:2024-12 star:2.9k fork:0.3k VisualVM is an All-in-One Java Troubleshooting Tool
- [oracle/weblogic-image-tool](https://github.com/oracle/weblogic-image-tool) topic:docker,docker-image,image-builder,kubernetes,oracle-weblogic-image,weblogic,weblogic-server pushed_at:2024-12 star:0.1k fork:0.0k WebLogic Image Tool
- [oracle/weblogic-kubernetes-operator](https://github.com/oracle/weblogic-kubernetes-operator) topic:kubernetes,operator,weblogic,weblogic-server pushed_at:2024-12 star:0.3k fork:0.2k WebLogic Kubernetes Operator
...
- [oracle/weblogic-monitoring-exporter](https://github.com/oracle/weblogic-monitoring-exporter) topic:monitoring,prometheus,weblogic pushed_at:2024-12 star:0.1k fork:0.1k WebLogic Monitoring Exporter exposes metrics and monitoring data through REST APIs for consumption by other tools (e.g. Prometheus)
...
- [oracle/netsuite-suitecloud-sdk](https://github.com/oracle/netsuite-suitecloud-sdk) topic:cli,development-kit,javascript,netsuite,nodejs,sdf,sdk,suiteapp,suitecloud,suitecloud-cli,suitecloud-sdk pushed_at:2024-12 star:0.2k fork:0.1k SuiteCloud Software Development Kit (SuiteCloud SDK) are the set of tools that allow you to customize accounts and create SuiteApps through SuiteCloud Development Framework (SDF).
- [oracle/node-oracledb](https://github.com/oracle/node-oracledb) topic:database,javascript,node,node-oracledb,nodejs,oracle,typescript pushed_at:2024-12 star:2.3k fork:1.1k Oracle Database driver for Node.js maintained by Oracle Corp.
...
- [oracle/weblogic-remote-console](https://github.com/oracle/weblogic-remote-console) topic:configuration,management,monitoring,rest,weblogic pushed_at:2024-12 star:0.0k fork:0.0k A WebLogic Console that connects remotely using the WebLogic Management REST API
- [oracle/weblogic-toolkit-ui](https://github.com/oracle/weblogic-toolkit-ui) topic:devops,kubernetes,provisioning,verrazzano,weblogic pushed_at:2024-12 star:0.0k fork:0.0k WebLogic Kubernetes Toolkit UI
...
- [oracle/container-images](https://github.com/oracle/container-images) topic:aarch64,amd64,docker,docker-image,oracle,oracle-linux,oracle-support pushed_at:2024-12 star:0.2k fork:0.1k Oracle Linux container images
...
- [oracle/dtrace-utils](https://github.com/oracle/dtrace-utils) topic:dtrace,kernel,linux,linux-kernel,tracing pushed_at:2024-12 star:0.2k fork:0.0k DTrace-utils contains the DTrace port to Linux
...
- [oracle/linux-uek](https://github.com/oracle/linux-uek) topic:kernel,linux,linux-kernel,oracle,uek pushed_at:2024-12 star:0.3k fork:0.1k Oracle Linux UEK: Unbreakable Enterprise Kernel
...
- [oracle/accelerated-data-science](https://github.com/oracle/accelerated-data-science) topic:cloud,machine-learning,oci,oracle,python3 pushed_at:2024-12 star:0.1k fork:0.0k ADS is the Oracle Data Science Cloud Service's python SDK supporting, model ops (train/eval/deploy), along with running workloads on Jobs and Pipeline resources.
...
- [oracle/coherence-py-client](https://github.com/oracle/coherence-py-client) topic:caching,coherence,distributed,in-memory,kv-store,microservices,python pushed_at:2024-12 star:0.0k fork:0.0k The Coherence Python Client allows Python applications to act as cache clients to an Oracle Coherence cluster using gRPC as the network transport.
...
- [oracle/dbt-oracle](https://github.com/oracle/dbt-oracle) topic:autonomous-database,data-build-tool,dbt,oracle pushed_at:2024-12 star:0.1k fork:0.0k dbt (data build tool) adapter for Oracle Autonomous Database
- [oracle/graalpython](https://github.com/oracle/graalpython) topic:embeddable,graalvm,java,python,python3 pushed_at:2024-12 star:1.3k fork:0.1k GraalPy – A high-performance embeddable Python 3 runtime for Java
...
- [oracle/kconfigs](https://github.com/oracle/kconfigs) topic:linux,linux-kernel pushed_at:2024-12 star:0.0k fork:0.0k Tool for extracting Linux kernel configurations from many distributions & displaying a web UI
- [oracle/macaron](https://github.com/oracle/macaron) topic:build-system,cicd,docker,gradle,integrity-protection,malware-analysis,malware-detection,maven,npm,python,sbom,slsa,supply-chain-security pushed_at:2024-12 star:0.1k fork:0.0k Macaron is an extensible supply-chain security analysis framework from Oracle Labs that supports a wide range of build systems and CI/CD services. It can be used to prevent supply chain attacks, detect malicious Python packages, or check conformance to frameworks, such as SLSA. Documentation:
...
- [oracle/oci-ai-speech-realtime-python-sdk](https://github.com/oracle/oci-ai-speech-realtime-python-sdk) topic: pushed_at:2024-12 star:0.0k fork:0.0k This repository contains the source code for the Python SDK to connect to the Realtime Speech Service. There is also an example client to help with connecting to the service. This SDK is based on the popular websockets python library.
...
- [oracle/oci-cli](https://github.com/oracle/oci-cli) topic:bare-metal,cli,cloud,infrastructure pushed_at:2024-12 star:0.5k fork:0.2k Command Line Interface for Oracle Cloud Infrastructure
- [oracle/oci-mlflow](https://github.com/oracle/oci-mlflow) topic:accelerated-data-science,cloud,machine-learning,mlflow,mlflow-tracking-server,mlops,oci,oracle,oracle-ads pushed_at:2024-12 star:0.0k fork:0.0k The Oracle Cloud Infrastructure (OCI) MLflow plugin empowers users of OCI by providing seamless integration with OCI resources, allowing them to effectively manage the entire life cycle of their machine learning use cases.
- [oracle/oci-python-sdk](https://github.com/oracle/oci-python-sdk) topic: pushed_at:2024-12 star:0.4k fork:0.3k Oracle Cloud Infrastructure SDK for Python
...
- [oracle/python-oracledb](https://github.com/oracle/python-oracledb) topic:database,oracle,oracle-database,oracle-database-driver,python pushed_at:2024-12 star:0.4k fork:0.1k Python driver for Oracle Database conforming to the Python DB API 2.0 specification. This is the renamed, new major release of cx_Oracle
- [oracle/solaris-ips](https://github.com/oracle/solaris-ips) topic:solaris pushed_at:2024-12 star:0.1k fork:0.0k Solaris IPS: Image Packaging System
...
- [oracle/weblogic-deploy-tooling](https://github.com/oracle/weblogic-deploy-tooling) topic:automation,continuous-testing,python,wdt,weblogic pushed_at:2024-12 star:0.2k fork:0.1k WebLogic Deploy Tooling
...
- [oracle/yo](https://github.com/oracle/yo) topic:linux,oci,oracle-cloud-infrastructure pushed_at:2024-12 star:0.1k fork:0.0k A fast and simple command line OCI client
...
- [oracle/truffleruby](https://github.com/oracle/truffleruby) topic:graalvm,hacktoberfest,ruby,truffle pushed_at:2024-12 star:3.1k fork:0.2k A high performance implementation of the Ruby programming language, built on GraalVM.
...
- [oracle/docker-images](https://github.com/oracle/docker-images) topic:coherence-ce,docker,docker-images,dockerfile,dockerfiles,graalvm,nosql,oci,oracle,oracle-commercial,oracle-database,oracle-instantclient,oracle-linux,oracle-products,oraclelinux pushed_at:2024-12 star:6.6k fork:5.4k Official source of container configurations, images, and examples for Oracle products and projects
- [oracle/fmw-kubernetes](https://github.com/oracle/fmw-kubernetes) topic:kubernetes,operator,oracle-webcenter pushed_at:2024-12 star:0.0k fork:0.0k Kubernetes Deployment Scripts for Oracle Fusion Middleware products
...
- [oracle/vagrant-projects](https://github.com/oracle/vagrant-projects) topic:oracle,vagrant,vagrant-boxes,vagrant-virtual-machine,vagrantfiles,virtualbox,virtualbox-vm pushed_at:2024-12 star:1.0k fork:0.5k Vagrant projects for Oracle products and other examples
- [oracle/weblogic-azure](https://github.com/oracle/weblogic-azure) topic:aks,azure,kubernetes,vms,weblogic pushed_at:2024-12 star:0.0k fork:0.0k This project offers support for running Oracle WebLogic Server in the Azure Virtual Machines and Azure Kubernetes Service (AKS)
...
- [oracle/create-database-app](https://github.com/oracle/create-database-app) topic:create-database-app,npm-package,oracle,oracle-database,scaffolding pushed_at:2024-12 star:0.0k fork:0.0k An NPM package to create Oracle Database Applications from a selection of templates
- [oracle/gdk-vscode-extensions](https://github.com/oracle/gdk-vscode-extensions) topic:devops,gcn,graalvm,oci,vscode-extension pushed_at:2024-12 star:0.0k fork:0.0k Graal Development Kit for Micronaut VSCode developer support
- [oracle/javavscode](https://github.com/oracle/javavscode) topic:java,language-server-protocol,oracle,vscode-extension pushed_at:2024-12 star:0.2k fork:0.0k Java platform support for Visual Studio Code for full featured Java development (edit-compile-debug & test cycle)
- [oracle/oci-ai-speech-realtime-typescript-sdk](https://github.com/oracle/oci-ai-speech-realtime-typescript-sdk) topic: pushed_at:2024-12 star:0.0k fork:0.0k This repository contains the source code for the TypeScript SDK to connect to the realtime speech service.
- [oracle/oci-ai-speech-realtime-web-sdk](https://github.com/oracle/oci-ai-speech-realtime-web-sdk) topic: pushed_at:2024-12 star:0.0k fork:0.0k 
- [oracle/oci-designer-toolkit](https://github.com/oracle/oci-designer-toolkit) topic:oci,oci-ansible,oci-cli,oci-designer,oci-terraform-modules,oci-toolkit,okit,visualise-oci-environments pushed_at:2024-12 star:0.3k fork:0.1k OCI designer toolKIT (OKIT) is a set of tools for enabling design, deploy and visualise OCI environments through a graphical web based interface.
...
- [oracle/oci-typescript-sdk](https://github.com/oracle/oci-typescript-sdk) topic:cloud,javascript,nodejs,oracle-cloud,sdk,typescript pushed_at:2024-12 star:0.1k fork:0.1k Oracle Cloud Infrastructure SDK for TypeScript and JavaScript
