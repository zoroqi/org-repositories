...
- [oracle/odpi](https://github.com/oracle/odpi) topic: pushed_at:2025-05 star:0.3k fork:0.1k ODPI-C: Oracle Database Programming Interface for Drivers and Applications
...
- [oracle/graal](https://github.com/oracle/graal) topic:aot,compiler,graalvm,java pushed_at:2025-06 star:20.9k fork:1.7k GraalVM compiles Java applications into native executables that start instantly, scale fast, and use fewer compute resources 🚀
...
- [oracle/opengrok](https://github.com/oracle/opengrok) topic:code,engine,java,maven,opengrok,search,source pushed_at:2025-06 star:4.5k fork:0.8k OpenGrok is a fast and usable source code search and cross reference engine, written in Java
...
- [oracle/container-images](https://github.com/oracle/container-images) topic:aarch64,amd64,docker,docker-image,oracle,oracle-linux,oracle-support pushed_at:2025-06 star:0.2k fork:0.1k Oracle Linux container images
...
- [oracle/accelerated-data-science](https://github.com/oracle/accelerated-data-science) topic:cloud,machine-learning,oci,oracle,python3 pushed_at:2025-06 star:0.1k fork:0.0k ADS is the Oracle Data Science Cloud Service's python SDK supporting, model ops (train/eval/deploy), along with running workloads on Jobs and Pipeline resources.
...
- [oracle/docker-images](https://github.com/oracle/docker-images) topic:coherence-ce,docker,docker-images,dockerfile,dockerfiles,graalvm,nosql,oci,oracle,oracle-commercial,oracle-database,oracle-instantclient,oracle-linux,oracle-products,oraclelinux pushed_at:2025-05 star:6.8k fork:5.5k Official source of container configurations, images, and examples for Oracle products and projects
