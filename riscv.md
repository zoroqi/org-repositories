...
- [riscv/meta-riscv](https://github.com/riscv/meta-riscv) topic:openembedded,openembedded-layer,risc-v,riscv,yocto,yocto-layer,yocto-meta pushed_at:2025-06 star:0.4k fork:0.2k OpenEmbedded/Yocto layer for RISC-V Architecture
...
- [riscv/riscv-b](https://github.com/riscv/riscv-b) topic: pushed_at:2025-06 star:0.0k fork:0.0k "B" extension - that represents the collection of the Zba, Zbb, and Zbs extensions 
...
- [riscv/riscv-cfi](https://github.com/riscv/riscv-cfi) topic: pushed_at:2025-06 star:0.1k fork:0.0k This specification is integrated into the Priv. and Unpriv. specifications. This repo is no longer maintained. Please refer to the Priv. and Unpriv. specifications at https://github.com/riscv/riscv-isa-manual
...
- [riscv/riscv-fast-interrupt](https://github.com/riscv/riscv-fast-interrupt) topic: pushed_at:2025-06 star:0.3k fork:0.1k Proposal for a RISC-V Core-Local Interrupt Controller (CLIC)
- [riscv/riscv-glossary](https://github.com/riscv/riscv-glossary) topic: pushed_at:2025-06 star:0.0k fork:0.0k 
- [riscv/riscv-high-assurance-cryptography](https://github.com/riscv/riscv-high-assurance-cryptography) topic: pushed_at:2025-06 star:0.0k fork:0.0k  High Assurance Cryptography
- [riscv/riscv-j-extension](https://github.com/riscv/riscv-j-extension) topic: pushed_at:2025-05 star:0.2k fork:0.0k Working Draft of the RISC-V J Extension Specification
- [riscv/riscv-memory-tagging](https://github.com/riscv/riscv-memory-tagging) topic: pushed_at:2025-06 star:0.0k fork:0.0k Memory Tagging ISA extension that can be used by software to enforce memory tag checks on memory loads and stores
- [riscv/riscv-performance-event-sampling](https://github.com/riscv/riscv-performance-event-sampling) topic: pushed_at:2025-06 star:0.0k fork:0.0k Define 2 new extensions to, along with Zihpm and Sscofpmf, enable event and instruction sampling with precise attribution.
- [riscv/riscv-performance-events](https://github.com/riscv/riscv-performance-events) topic: pushed_at:2025-06 star:0.0k fork:0.0k RISC-V Performance Events Specification
...
- [riscv/riscv-svvptc](https://github.com/riscv/riscv-svvptc) topic: pushed_at:2025-06 star:0.0k fork:0.0k Obviating Memory-Management Instructions after Marking PTEs Valid (Svvptc)
...
- [riscv/riscv-zabha](https://github.com/riscv/riscv-zabha) topic: pushed_at:2025-05 star:0.0k fork:0.0k The Zabha extension provides support for byte and halfword atomic memory operations.
- [riscv/riscv-zalasr](https://github.com/riscv/riscv-zalasr) topic: pushed_at:2025-05 star:0.0k fork:0.0k The ISA specification for the Zalasr extension.
...
- [riscv/docs-resources](https://github.com/riscv/docs-resources) topic: pushed_at:2025-06 star:0.0k fork:0.0k 
...
- [riscv/kersten-ui](https://github.com/riscv/kersten-ui) topic: pushed_at:2025-06 star:0.0k fork:0.0k 
...
- [riscv/riscv-docs-base-container-image](https://github.com/riscv/riscv-docs-base-container-image) topic: pushed_at:2025-06 star:0.0k fork:0.0k A base container image populated with the dependencies to build the RISC-V Documentation.
- [riscv/riscv-library](https://github.com/riscv/riscv-library) topic: pushed_at:2025-06 star:0.0k fork:0.0k This repository holds the front matter pages for the RISC-V Library
...
- [riscv/self-hosted-trace](https://github.com/riscv/self-hosted-trace) topic: pushed_at:2025-06 star:0.0k fork:0.0k RISC-V Self-hosted Trace Development Repositoty
...
- [riscv/riscv-debug-spec](https://github.com/riscv/riscv-debug-spec) topic: pushed_at:2025-05 star:0.5k fork:0.1k Working Draft of the RISC-V Debug Specification Standard
- [riscv/riscv-opcodes](https://github.com/riscv/riscv-opcodes) topic: pushed_at:2025-06 star:0.8k fork:0.3k RISC-V Opcodes

## Sail

- [riscv/sail-riscv](https://github.com/riscv/sail-riscv) topic: pushed_at:2025-06 star:0.6k fork:0.2k Sail RISC-V model

## TeX

- [riscv/docs-dev-guide](https://github.com/riscv/docs-dev-guide) topic: pushed_at:2025-06 star:0.1k fork:0.0k Documentation developer guide
- [riscv/riscv-cheri](https://github.com/riscv/riscv-cheri) topic:capabilities,compartmentalization,memory-safety pushed_at:2025-06 star:0.1k fork:0.0k This repository contains the CHERI extension specification, adding hardware capabilities to RISC-V ISA to enable fine-grained memory protection and scalable compartmentalization.
- [riscv/riscv-isa-manual](https://github.com/riscv/riscv-isa-manual) topic: pushed_at:2025-06 star:4.1k fork:0.7k RISC-V Instruction Set Manual
...
- [riscv/riscv-spmp](https://github.com/riscv/riscv-spmp) topic: pushed_at:2025-06 star:0.0k fork:0.0k The repo contains the SPMP architectural specification, which includes capabilities like access control of read/write/execute requests by an hart, address matching, encoding of permissions, exceptions for access violation, and support for virtualization.
...
- [riscv/sig-functional-safety-whitepaper](https://github.com/riscv/sig-functional-safety-whitepaper) topic: pushed_at:2025-06 star:0.0k fork:0.0k GitHub repository for the Functional Safety SIG Whitepaper Development
