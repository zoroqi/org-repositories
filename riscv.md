...
- [riscv/meta-riscv](https://github.com/riscv/meta-riscv) topic:openembedded,openembedded-layer,risc-v,riscv,yocto,yocto-layer,yocto-meta pushed_at:2026-03 star:0.4k fork:0.2k OpenEmbedded/Yocto layer for RISC-V Architecture
...
- [riscv/riscv-aia](https://github.com/riscv/riscv-aia) topic: pushed_at:2026-03 star:0.1k fork:0.0k 
- [riscv/riscv-b](https://github.com/riscv/riscv-b) topic: pushed_at:2026-03 star:0.0k fork:0.0k "B" extension - that represents the collection of the Zba, Zbb, and Zbs extensions 
...
- [riscv/riscv-cfi](https://github.com/riscv/riscv-cfi) topic: pushed_at:2026-03 star:0.1k fork:0.0k This specification is integrated into the Priv. and Unpriv. specifications. This repo is no longer maintained. Please refer to the Priv. and Unpriv. specifications at https://github.com/riscv/riscv-isa-manual
...
- [riscv/riscv-event-trace](https://github.com/riscv/riscv-event-trace) topic: pushed_at:2026-03 star:0.0k fork:0.0k Extension to the RISC-V Trace standards which is user-configurable to trace a hardware-filtered subset of instructions
- [riscv/riscv-fast-interrupt](https://github.com/riscv/riscv-fast-interrupt) topic: pushed_at:2026-03 star:0.3k fork:0.1k Proposal for a RISC-V Core-Local Interrupt Controller (CLIC)
...
- [riscv/riscv-profiles](https://github.com/riscv/riscv-profiles) topic: pushed_at:2026-03 star:0.2k fork:0.0k RISC-V Architecture Profiles
- [riscv/riscv-security-model](https://github.com/riscv/riscv-security-model) topic: pushed_at:2026-03 star:0.0k fork:0.0k RISC-V Security Model
- [riscv/riscv-smmtt](https://github.com/riscv/riscv-smmtt) topic:access-control,ap-tee,confidential-computing,io-mpt,smgeien,smmpt,smmtt,smqosid,smsdedbga,smsdetrca,smsdia,smsdid,supervisor-domains,trusted-computing,trusted-execution-environment pushed_at:2026-03 star:0.1k fork:0.0k This specification will define the RISC-V privilege ISA extensions required to support Supervisor Domain isolation for multi-tenant security use cases e.g. confidential-computing, trusted platform services, fault isolation and so on.
- [riscv/riscv-spec-barrier](https://github.com/riscv/riscv-spec-barrier) topic: pushed_at:2026-03 star:0.0k fork:0.0k RISC-V Speculation Barrier
...
- [riscv/riscv-svvptc](https://github.com/riscv/riscv-svvptc) topic: pushed_at:2026-03 star:0.0k fork:0.0k Obviating Memory-Management Instructions after Marking PTEs Valid (Svvptc)
...
- [riscv/learn](https://github.com/riscv/learn) topic: pushed_at:2026-03 star:1.5k fork:0.1k Tracking RISC-V Actions on Education, Training, Courses, Monitorships, etc. 
- [riscv/riscv-docs-base-container-image](https://github.com/riscv/riscv-docs-base-container-image) topic: pushed_at:2026-03 star:0.0k fork:0.0k A base container image populated with the dependencies to build the RISC-V Documentation.
...
- [riscv/riscv-plic-spec](https://github.com/riscv/riscv-plic-spec) topic: pushed_at:2026-03 star:0.2k fork:0.0k PLIC Specification
- [riscv/virtual-memory](https://github.com/riscv/virtual-memory) topic: pushed_at:2021-09 star:0.0k fork:0.0k 

## Python

- [riscv/docs-resources](https://github.com/riscv/docs-resources) topic: pushed_at:2026-03 star:0.0k fork:0.0k 
- [riscv/riscv-debug-spec](https://github.com/riscv/riscv-debug-spec) topic: pushed_at:2026-03 star:0.5k fork:0.1k Working Draft of the RISC-V Debug Specification Standard
- [riscv/riscv-opcodes](https://github.com/riscv/riscv-opcodes) topic: pushed_at:2026-03 star:0.8k fork:0.4k RISC-V Opcodes

## Ruby

- [riscv/riscv-unified-db](https://github.com/riscv/riscv-unified-db) topic:risc-v,riscv pushed_at:2026-03 star:0.2k fork:0.1k Monorepo containing a machine-readable database of the RISC-V specification and artifact generation tools

## Sail

- [riscv/sail-riscv](https://github.com/riscv/sail-riscv) topic: pushed_at:2026-03 star:0.7k fork:0.3k Sail RISC-V model

## TeX

- [riscv/docs-dev-guide](https://github.com/riscv/docs-dev-guide) topic: pushed_at:2026-03 star:0.1k fork:0.0k Documentation developer guide
...
- [riscv/riscv-worlds](https://github.com/riscv/riscv-worlds) topic: pushed_at:2026-03 star:0.0k fork:0.0k RISC-V Worlds provides isolation in a hardware platform by constraining access to system physical addresses.
...
- [riscv/sig-functional-safety-whitepaper](https://github.com/riscv/sig-functional-safety-whitepaper) topic: pushed_at:2026-03 star:0.0k fork:0.0k GitHub repository for the Functional Safety SIG Whitepaper Development
