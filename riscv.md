...
- [riscv/meta-riscv](https://github.com/riscv/meta-riscv) topic:openembedded,openembedded-layer,risc-v,riscv,yocto,yocto-layer,yocto-meta pushed_at:2023-05 star:0.3k fork:0.1k OpenEmbedded/Yocto layer for RISC-V Architecture
...
- [riscv/riscv-isa-manual](https://github.com/riscv/riscv-isa-manual) topic: pushed_at:2023-05 star:2.7k fork:0.5k RISC-V Instruction Set Manual
...
- [riscv/riscv-smmtt](https://github.com/riscv/riscv-smmtt) topic: pushed_at:2023-05 star:0.0k fork:0.0k This specification will define the Smmtt privilege ISA extensions required to support the supervisor domain isolation for many isolation use cases e.g. confidential-computing, fault isolation and so on.
