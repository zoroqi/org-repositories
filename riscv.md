...
- [riscv/meta-riscv](https://github.com/riscv/meta-riscv) topic:openembedded,openembedded-layer,risc-v,riscv,yocto,yocto-layer,yocto-meta pushed_at:2025-03 star:0.4k fork:0.1k OpenEmbedded/Yocto layer for RISC-V Architecture
...
- [riscv/sail-riscv](https://github.com/riscv/sail-riscv) topic: pushed_at:2025-03 star:0.5k fork:0.2k Sail RISC-V model
...
- [riscv/composable-custom-extensions](https://github.com/riscv/composable-custom-extensions) topic: pushed_at:2025-03 star:0.0k fork:0.0k This task group will propose ISA extension(s) and non-ISA hardware and software interop interfaces to enable routine reuse and composition of a subcategory of custom extensions called composable extensions.
...
- [riscv/riscv-fast-interrupt](https://github.com/riscv/riscv-fast-interrupt) topic: pushed_at:2025-03 star:0.3k fork:0.1k Proposal for a RISC-V Core-Local Interrupt Controller (CLIC)
...
- [riscv/riscv-performance-events](https://github.com/riscv/riscv-performance-events) topic: pushed_at:2025-03 star:0.0k fork:0.0k RISC-V Performance Events Specification
...
- [riscv/riscv-docs-base-container-image](https://github.com/riscv/riscv-docs-base-container-image) topic: pushed_at:2025-03 star:0.0k fork:0.0k A base container image populated with the dependencies to build the RISC-V Documentation.
...
- [riscv/riscv-cheri](https://github.com/riscv/riscv-cheri) topic:capabilities,compartmentalization,memory-safety pushed_at:2025-03 star:0.1k fork:0.0k This repository contains the CHERI extension specification, adding hardware capabilities to RISC-V ISA to enable fine-grained memory protection and scalable compartmentalization.
...
- [riscv/docs-dev-guide](https://github.com/riscv/docs-dev-guide) topic: pushed_at:2025-03 star:0.1k fork:0.0k Documentation developer guide
- [riscv/riscv-isa-manual](https://github.com/riscv/riscv-isa-manual) topic: pushed_at:2025-03 star:3.9k fork:0.7k RISC-V Instruction Set Manual
...
- [riscv/riscv-spmp](https://github.com/riscv/riscv-spmp) topic: pushed_at:2025-03 star:0.0k fork:0.0k The repo contains the SPMP architectural specification, which includes capabilities like access control of read/write/execute requests by an hart, address matching, encoding of permissions, exceptions for access violation, and support for virtualization.
