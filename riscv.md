...
- [riscv/meta-riscv](https://github.com/riscv/meta-riscv) topic:openembedded,openembedded-layer,risc-v,riscv,yocto,yocto-layer,yocto-meta pushed_at:2024-08 star:0.3k fork:0.1k OpenEmbedded/Yocto layer for RISC-V Architecture
...
- [riscv/sail-riscv](https://github.com/riscv/sail-riscv) topic: pushed_at:2024-08 star:0.4k fork:0.2k Sail RISC-V model
...
- [riscv/riscv-control-transfer-records](https://github.com/riscv/riscv-control-transfer-records) topic: pushed_at:2024-08 star:0.0k fork:0.0k This repo contains a RISC-V ISA extension (proposal) to allow recording of control transfer history to on-chip registers, to support usages associated with profiling and debug.
...
- [riscv/riscv-docs-base-container-image](https://github.com/riscv/riscv-docs-base-container-image) topic: pushed_at:2024-08 star:0.0k fork:0.0k A base container image populated with the dependencies to build the RISC-V Documentation.
...
- [riscv/riscv-cheri](https://github.com/riscv/riscv-cheri) topic:capabilities,compartmentalization,memory-safety pushed_at:2024-08 star:0.0k fork:0.0k This repository contains the CHERI extension specification, adding hardware capabilities to RISC-V ISA to enable fine-grained memory protection and scalable compartmentalization.
- [riscv/riscv-debug-spec](https://github.com/riscv/riscv-debug-spec) topic: pushed_at:2024-08 star:0.5k fork:0.1k Working Draft of the RISC-V Debug Specification Standard
...
- [riscv/riscv-isa-manual](https://github.com/riscv/riscv-isa-manual) topic: pushed_at:2024-08 star:3.5k fork:0.6k RISC-V Instruction Set Manual
