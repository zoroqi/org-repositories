...
- [riscv/meta-riscv](https://github.com/riscv/meta-riscv) topic:openembedded,openembedded-layer,risc-v,riscv,yocto,yocto-layer,yocto-meta pushed_at:2023-07 star:0.3k fork:0.1k OpenEmbedded/Yocto layer for RISC-V Architecture
...
- [riscv/riscv-openocd](https://github.com/riscv/riscv-openocd) topic: pushed_at:2023-07 star:0.3k fork:0.3k Fork of OpenOCD that has RISC-V support
...
- [riscv/riscv-cfi](https://github.com/riscv/riscv-cfi) topic: pushed_at:2023-07 star:0.0k fork:0.0k This repo holds the work area and revisions of the RISC-V CFI (Shadow Stack and Landing Pads) specifications. CFI defines the privileged and unprivileged ISA extensions that can be used by privileged and unprivileged programs to protect the integrity of their control-flow.
...
- [riscv/riscv-smcntrpmf](https://github.com/riscv/riscv-smcntrpmf) topic: pushed_at:2023-06 star:0.0k fork:0.0k Cycle & Instret Privilege Mode Filtering Architecture Extension
