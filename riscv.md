...
- [riscv/meta-riscv](https://github.com/riscv/meta-riscv) topic:openembedded,openembedded-layer,risc-v,riscv,yocto,yocto-layer,yocto-meta pushed_at:2024-04 star:0.3k fork:0.1k OpenEmbedded/Yocto layer for RISC-V Architecture
...
- [riscv/sail-riscv](https://github.com/riscv/sail-riscv) topic: pushed_at:2024-04 star:0.4k fork:0.1k Sail RISC-V model
...
- [riscv/docs-spec-template](https://github.com/riscv/docs-spec-template) topic: pushed_at:2024-04 star:0.0k fork:0.0k 
...
- [riscv/riscv-cfi](https://github.com/riscv/riscv-cfi) topic: pushed_at:2024-04 star:0.1k fork:0.0k This repo holds the work area and revisions of the RISC-V CFI (Shadow Stack and Landing Pads) specifications. CFI defines the privileged and unprivileged ISA extensions that can be used by privileged and unprivileged programs to protect the integrity of their control-flow.
...
- [riscv/riscv-double-trap](https://github.com/riscv/riscv-double-trap) topic: pushed_at:2024-04 star:0.0k fork:0.0k RISC-V Double Trap Fast-Track Extension
- [riscv/riscv-glossary](https://github.com/riscv/riscv-glossary) topic: pushed_at:2024-04 star:0.0k fork:0.0k 
...
- [riscv/learn](https://github.com/riscv/learn) topic: pushed_at:2024-04 star:0.2k fork:0.0k Tracking RISC-V Actions on Education, Training, Courses, Monitorships, etc. 
...
- [riscv/configuration-structure](https://github.com/riscv/configuration-structure) topic: pushed_at:2024-04 star:0.0k fork:0.0k RISC-V Configuration Structure
- [riscv/riscv-cheri](https://github.com/riscv/riscv-cheri) topic: pushed_at:2024-04 star:0.0k fork:0.0k This repository contains the CHERI extension specification, adding hardware capabilities to RISC-V ISA to enable fine-grained memory protection and scalable compartmentalization.
- [riscv/riscv-debug-spec](https://github.com/riscv/riscv-debug-spec) topic: pushed_at:2024-04 star:0.4k fork:0.1k Working Draft of the RISC-V Debug Specification Standard
- [riscv/riscv-opcodes](https://github.com/riscv/riscv-opcodes) topic: pushed_at:2024-04 star:0.6k fork:0.3k RISC-V Opcodes

## TeX

- [riscv/docs-dev-guide](https://github.com/riscv/docs-dev-guide) topic: pushed_at:2024-04 star:0.1k fork:0.0k Documentation developer guide
- [riscv/riscv-isa-manual](https://github.com/riscv/riscv-isa-manual) topic: pushed_at:2024-04 star:3.3k fork:0.6k RISC-V Instruction Set Manual
