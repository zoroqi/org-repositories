...
- [riscv/meta-riscv](https://github.com/riscv/meta-riscv) topic:openembedded,openembedded-layer,risc-v,riscv,yocto,yocto-layer,yocto-meta pushed_at:2024-03 star:0.3k fork:0.1k OpenEmbedded/Yocto layer for RISC-V Architecture
...
- [riscv/sail-riscv](https://github.com/riscv/sail-riscv) topic: pushed_at:2024-03 star:0.4k fork:0.1k Sail RISC-V model

## Makefile

- [riscv/docs-spec-template](https://github.com/riscv/docs-spec-template) topic: pushed_at:2024-03 star:0.0k fork:0.0k 
...
- [riscv/riscv-b](https://github.com/riscv/riscv-b) topic: pushed_at:2024-02 star:0.0k fork:0.0k "B" extension - that represents the collection of the Zba, Zbb, and Zbs extensions 
...
- [riscv/riscv-cfi](https://github.com/riscv/riscv-cfi) topic: pushed_at:2024-03 star:0.1k fork:0.0k This repo holds the work area and revisions of the RISC-V CFI (Shadow Stack and Landing Pads) specifications. CFI defines the privileged and unprivileged ISA extensions that can be used by privileged and unprivileged programs to protect the integrity of their control-flow.
- [riscv/riscv-control-transfer-records](https://github.com/riscv/riscv-control-transfer-records) topic: pushed_at:2024-03 star:0.0k fork:0.0k This repo contains a RISC-V ISA extension (proposal) to allow recording of control transfer history to on-chip registers, to support usages associated with profiling and debug.
...
- [riscv/riscv-double-trap](https://github.com/riscv/riscv-double-trap) topic: pushed_at:2024-03 star:0.0k fork:0.0k RISC-V Double Trap Fast-Track Extension
- [riscv/riscv-hac](https://github.com/riscv/riscv-hac) topic: pushed_at:2024-02 star:0.0k fork:0.0k  High Assurance Cryptography
- [riscv/riscv-indirect-csr-access](https://github.com/riscv/riscv-indirect-csr-access) topic: pushed_at:2024-02 star:0.0k fork:0.0k Smcsrind/Sscsrind is an ISA extension that extends the indirect CSR access mechanism originally defined as part of the Smaia/Ssaia extensions, in order to make it available for use by other extensions without creating an unnecessary dependence on Smaia/Ssaia.
- [riscv/riscv-j-extension](https://github.com/riscv/riscv-j-extension) topic: pushed_at:2024-03 star:0.1k fork:0.0k Working Draft of the RISC-V J Extension Specification
...
- [riscv/riscv-smcdeleg-ssccfg](https://github.com/riscv/riscv-smcdeleg-ssccfg) topic: pushed_at:2024-02 star:0.0k fork:0.0k Supervisor Counter Delegation Architecture Extension
...
- [riscv/riscv-zaamo-zalrsc](https://github.com/riscv/riscv-zaamo-zalrsc) topic: pushed_at:2024-03 star:0.0k fork:0.0k Zaamo / Zalrsc: A extension components
- [riscv/riscv-zabha](https://github.com/riscv/riscv-zabha) topic: pushed_at:2024-03 star:0.0k fork:0.0k The Zabha extension provides support for byte and halfword atomic memory operations.
...
- [riscv/riscv-zalasr](https://github.com/riscv/riscv-zalasr) topic: pushed_at:2024-01 star:0.0k fork:0.0k The ISA specification for the Zalasr extension.
...
- [riscv/riscv-zilsd](https://github.com/riscv/riscv-zilsd) topic: pushed_at:2024-03 star:0.0k fork:0.0k Zilsd (Load/Store Pair for RV32) Fast-Track Extension
...
- [riscv/learn](https://github.com/riscv/learn) topic: pushed_at:2024-03 star:0.2k fork:0.0k Tracking RISC-V Actions on Education, Training, Courses, Monitorships, etc. 
- [riscv/riscv-aia](https://github.com/riscv/riscv-aia) topic: pushed_at:2024-03 star:0.1k fork:0.0k 
- [riscv/riscv-docs-base-container-image](https://github.com/riscv/riscv-docs-base-container-image) topic: pushed_at:2024-03 star:0.0k fork:0.0k A base container image populated with the dependencies to build the RISC-V Documentation.
- [riscv/riscv-fast-interrupt](https://github.com/riscv/riscv-fast-interrupt) topic: pushed_at:2024-03 star:0.2k fork:0.0k Proposal for a RISC-V Core-Local Interrupt Controller (CLIC)
- [riscv/riscv-glossary](https://github.com/riscv/riscv-glossary) topic: pushed_at:2024-02 star:0.0k fork:0.0k 
...
- [riscv/riscv-cheri](https://github.com/riscv/riscv-cheri) topic: pushed_at:2024-03 star:0.0k fork:0.0k This repository contains the CHERI extension specification, adding hardware capabilities to RISC-V ISA to enable fine-grained memory protection and scalable compartmentalization.
- [riscv/riscv-debug-spec](https://github.com/riscv/riscv-debug-spec) topic: pushed_at:2024-03 star:0.4k fork:0.1k Working Draft of the RISC-V Debug Specification Standard
- [riscv/riscv-opcodes](https://github.com/riscv/riscv-opcodes) topic: pushed_at:2024-03 star:0.6k fork:0.3k RISC-V Opcodes
...
- [riscv/riscv-isa-manual](https://github.com/riscv/riscv-isa-manual) topic: pushed_at:2024-03 star:3.2k fork:0.6k RISC-V Instruction Set Manual
