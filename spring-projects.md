...
- [spring-projects/spring-ai](https://github.com/spring-projects/spring-ai) topic:artificial-intelligence,java pushed_at:2024-07 star:2.6k fork:0.6k An Application Framework for AI Engineering
...
- [spring-projects/spring-data-keyvalue](https://github.com/spring-projects/spring-data-keyvalue) topic: pushed_at:2024-07 star:0.1k fork:0.1k Project to provide infrastructure to implement Spring Data repositories on top of key-value-based, in-memory data stores.
- [spring-projects/spring-data-ldap](https://github.com/spring-projects/spring-data-ldap) topic:ddd,framework,ldap,spring-data,spring-ldap pushed_at:2024-07 star:0.1k fork:0.1k Repository abstraction for Spring LDAP
- [spring-projects/spring-data-mongodb](https://github.com/spring-projects/spring-data-mongodb) topic:ddd,framework,java,mongodb,spring,spring-data pushed_at:2024-07 star:1.6k fork:1.1k Provides support to increase developer productivity in Java when using MongoDB. Uses familiar Spring concepts such as a template classes for core API usage and lightweight repository style data access.
- [spring-projects/spring-data-neo4j](https://github.com/spring-projects/spring-data-neo4j) topic:ddd,framework,java,neo4j,spring,spring-data pushed_at:2024-07 star:0.8k fork:0.6k Provide support to increase developer productivity in Java when using Neo4j. Uses familiar Spring concepts such as a template classes for core API usage and lightweight repository style data access.
- [spring-projects/spring-data-redis](https://github.com/spring-projects/spring-data-redis) topic:ddd,framework,java,redis,spring,spring-data pushed_at:2024-07 star:1.7k fork:1.1k Provides support to increase developer productivity in Java when using Redis, a key-value store. Uses familiar Spring concepts such as a template classes for core API usage and lightweight repository style data access.
...
- [spring-projects/spring-hateoas](https://github.com/spring-projects/spring-hateoas) topic: pushed_at:2024-07 star:1.0k fork:0.5k Spring HATEOAS - Library to support implementing representations for hyper-text driven REST web services.
...
- [spring-projects/spring-integration](https://github.com/spring-projects/spring-integration) topic:eip,java,microservices,spring pushed_at:2024-07 star:1.5k fork:1.1k Spring Integration provides an extension of the Spring programming model to support the well-known Enterprise Integration Patterns (EIP)
...
- [spring-projects/spring-kafka](https://github.com/spring-projects/spring-kafka) topic: pushed_at:2024-07 star:2.1k fork:1.5k Provides Familiar Spring Abstractions for Apache Kafka
...
- [spring-projects/spring-lifecycle-smoke-tests](https://github.com/spring-projects/spring-lifecycle-smoke-tests) topic: pushed_at:2024-07 star:0.0k fork:0.0k 
...
- [spring-projects/spring-security-kerberos](https://github.com/spring-projects/spring-security-kerberos) topic: pushed_at:2024-07 star:0.2k fork:0.2k Spring Security Kerberos
- [spring-projects/spring-security-samples](https://github.com/spring-projects/spring-security-samples) topic: pushed_at:2024-07 star:1.3k fork:0.7k 
- [spring-projects/spring-session](https://github.com/spring-projects/spring-session) topic: pushed_at:2024-07 star:1.8k fork:1.1k Spring Session
...
- [spring-projects/sts4](https://github.com/spring-projects/sts4) topic:eclipse,spring,spring-boot,sts4,theia,visual-studio-code,vscode-extension pushed_at:2024-07 star:0.9k fork:0.2k The next generation of tooling for Spring Boot, including support for Cloud Foundry manifest files, Concourse CI pipeline definitions, BOSH deployment manifests, and more... - Available for Eclipse, Visual Studio Code, and Theia
...
- [spring-projects/spring-data-bom](https://github.com/spring-projects/spring-data-bom) topic:bill-of-materials,bom,spring-data pushed_at:2024-07 star:0.0k fork:0.0k Spring Data Bill of Materials
...
- [spring-projects/spring-data-build](https://github.com/spring-projects/spring-data-build) topic: pushed_at:2024-07 star:0.1k fork:0.1k Modules to centralize common resources and configuration for Spring Data Maven builds.
