...
- [spring-projects/spring-amqp](https://github.com/spring-projects/spring-amqp) pushed_at:2021-06 star:0.7k fork:0.5k Spring AMQP - support for Spring programming model with AMQP, especially but not limited to RabbitMQ
...
- [spring-projects/spring-batch](https://github.com/spring-projects/spring-batch) pushed_at:2021-06 star:1.9k fork:1.8k Spring Batch is a framework for writing offline and batch applications using Spring and Java
...
- [spring-projects/spring-boot](https://github.com/spring-projects/spring-boot) pushed_at:2021-07 star:56.0k fork:34.0k Spring Boot
...
- [spring-projects/spring-data-commons](https://github.com/spring-projects/spring-data-commons) pushed_at:2021-06 star:0.6k fork:0.5k Spring Data Commons. Interfaces and code shared between the various datastore specific implementations.
...
- [spring-projects/spring-data-rest](https://github.com/spring-projects/spring-data-rest) pushed_at:2021-06 star:0.8k fork:0.5k Simplifies building hypermedia-driven REST web services on top of Spring Data repositories
...
- [spring-projects/spring-framework](https://github.com/spring-projects/spring-framework) pushed_at:2021-07 star:43.4k fork:30.3k Spring Framework
...
- [spring-projects/spring-graphql](https://github.com/spring-projects/spring-graphql) pushed_at:2021-07 star:0.2k fork:0.0k Spring integration for GraphQL 
...
- [spring-projects/spring-integration-extensions](https://github.com/spring-projects/spring-integration-extensions) pushed_at:2021-06 star:0.2k fork:0.3k The Spring Integration Extensions project provides extension components for Spring Integration
...
- [spring-projects/spring-petclinic](https://github.com/spring-projects/spring-petclinic) pushed_at:2021-06 star:4.9k fork:12.7k A sample Spring-based application
...
- [spring-projects/spring-security](https://github.com/spring-projects/spring-security) pushed_at:2021-07 star:6.0k fork:4.6k Spring Security
...
- [spring-projects/spring-security-oauth2-boot](https://github.com/spring-projects/spring-security-oauth2-boot) pushed_at:2021-06 star:0.3k fork:0.1k Provides spring-security-oauth2 & Boot 2 integration (i.e. autoconfig)
...
- [spring-projects/spring-session](https://github.com/spring-projects/spring-session) pushed_at:2021-06 star:1.6k fork:1.0k Spring Session
...
- [spring-projects/spring-statemachine](https://github.com/spring-projects/spring-statemachine) pushed_at:2021-06 star:1.1k fork:0.5k Spring Statemachine is a framework for application developers to use state machine concepts with Spring.
...
- [spring-projects/sts4](https://github.com/spring-projects/sts4) pushed_at:2021-06 star:0.5k fork:0.1k The next generation of tooling for Spring Boot, including support for Cloud Foundry manifest files, Concourse CI pipeline definitions, BOSH deployment manifests, and more... - Available for Eclipse, Visual Studio Code, and Theia
...
- [spring-projects/spring-data-build](https://github.com/spring-projects/spring-data-build) pushed_at:2021-06 star:0.1k fork:0.1k Modules to centralize common resources and configuration for Spring Data Maven builds.
