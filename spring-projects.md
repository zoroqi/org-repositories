...
- [spring-projects/spring-boot](https://github.com/spring-projects/spring-boot) pushed_at:2022-06 star:62.0k fork:36.7k Spring Boot
- [spring-projects/spring-boot-data-geode](https://github.com/spring-projects/spring-boot-data-geode) pushed_at:2022-06 star:0.0k fork:0.0k Spring Boot support for Apache Geode and VMware Tanzu GemFire
- [spring-projects/spring-credhub](https://github.com/spring-projects/spring-credhub) pushed_at:2022-06 star:0.0k fork:0.0k Spring abstractions for Cloud Foundry CredHub
- [spring-projects/spring-data-book](https://github.com/spring-projects/spring-data-book) pushed_at:2022-06 star:1.3k fork:1.1k Spring Data - The Definitive Guide - Modern Data Access for Enterprise Java Developers
- [spring-projects/spring-data-cassandra](https://github.com/spring-projects/spring-data-cassandra) pushed_at:2022-06 star:0.3k fork:0.3k Provides support to increase developer productivity in Java when using Apache Cassandra.  Uses familiar Spring concepts such as a template classes for core API usage and lightweight repository style data access.
- [spring-projects/spring-data-commons](https://github.com/spring-projects/spring-data-commons) pushed_at:2022-06 star:0.7k fork:0.6k Spring Data Commons. Interfaces and code shared between the various datastore specific implementations.
...
- [spring-projects/spring-data-geode](https://github.com/spring-projects/spring-data-geode) pushed_at:2022-06 star:0.0k fork:0.0k Spring Data support for Apache Geode
...
- [spring-projects/spring-data-keyvalue](https://github.com/spring-projects/spring-data-keyvalue) pushed_at:2022-06 star:0.1k fork:0.1k Project to provide infrastructure to implement Spring Data repositories on top of key-value-based, in-memory data stores.
...
- [spring-projects/spring-data-mongodb](https://github.com/spring-projects/spring-data-mongodb) pushed_at:2022-06 star:1.4k fork:1.0k Provide support to increase developer productivity in Java when using MongoDB. Uses familiar Spring concepts such as a template classes for core API usage and lightweight repository style data access.
- [spring-projects/spring-data-neo4j](https://github.com/spring-projects/spring-data-neo4j) pushed_at:2022-06 star:0.8k fork:0.6k Provide support to increase developer productivity in Java when using Neo4j. Uses familiar Spring concepts such as a template classes for core API usage and lightweight repository style data access.
...
- [spring-projects/spring-data-relational](https://github.com/spring-projects/spring-data-relational) pushed_at:2022-06 star:0.6k fork:0.3k Spring Data Relational
- [spring-projects/spring-data-rest](https://github.com/spring-projects/spring-data-rest) pushed_at:2022-06 star:0.8k fork:0.5k Simplifies building hypermedia-driven REST web services on top of Spring Data repositories
...
- [spring-projects/spring-framework](https://github.com/spring-projects/spring-framework) pushed_at:2022-06 star:48.3k fork:34.1k Spring Framework
...
- [spring-projects/spring-aot-smoke-tests](https://github.com/spring-projects/spring-aot-smoke-tests) pushed_at:2022-06 star:0.0k fork:0.0k 
...
- [spring-projects/spring-data-build](https://github.com/spring-projects/spring-data-build) pushed_at:2022-06 star:0.1k fork:0.1k Modules to centralize common resources and configuration for Spring Data Maven builds.
