...
- [spring-projects/spring-net](https://github.com/spring-projects/spring-net) pushed_at:2022-01 star:0.8k fork:0.4k Spring Framework for .NET
...
- [spring-projects/eclipse-integration-commons](https://github.com/spring-projects/eclipse-integration-commons) pushed_at:2022-02 star:0.0k fork:0.0k Common SpringSource components used to integrate tooling with Eclipse, like the SpringSource Dashboard, Eclipse Spring UAA, common framework components and workspace configurators
...
- [spring-projects/spring-amqp-samples](https://github.com/spring-projects/spring-amqp-samples) pushed_at:2022-01 star:0.5k fork:0.4k Samples for Spring AMQP
...
- [spring-projects/spring-authorization-server](https://github.com/spring-projects/spring-authorization-server) pushed_at:2022-03 star:3.3k fork:0.7k The Spring Authorization Server project is focused on delivering OAuth 2.1 Authorization Server support to the Spring community.
...
- [spring-projects/spring-boot](https://github.com/spring-projects/spring-boot) pushed_at:2022-03 star:60.0k fork:35.9k Spring Boot
...
- [spring-projects/spring-data-envers](https://github.com/spring-projects/spring-data-envers) pushed_at:2022-02 star:0.3k fork:0.1k Envers extension of the Spring Data JPA module
...
- [spring-projects/spring-data-geode](https://github.com/spring-projects/spring-data-geode) pushed_at:2022-02 star:0.0k fork:0.0k Spring Data support for Apache Geode
...
- [spring-projects/spring-data-keyvalue](https://github.com/spring-projects/spring-data-keyvalue) pushed_at:2022-02 star:0.1k fork:0.1k Project to provide infrastructure to implement Spring Data repositories on top of key-value-based, in-memory data stores.
- [spring-projects/spring-data-ldap](https://github.com/spring-projects/spring-data-ldap) pushed_at:2022-02 star:0.1k fork:0.0k Repository abstraction for Spring LDAP
...
- [spring-projects/spring-data-r2dbc](https://github.com/spring-projects/spring-data-r2dbc) pushed_at:2022-02 star:0.6k fork:0.1k Provide support to increase developer productivity in Java when using Reactive Relational Database Connectivity. Uses familiar Spring concepts such as a DatabaseClient for core API usage and lightweight repository style data access.
...
- [spring-projects/spring-framework](https://github.com/spring-projects/spring-framework) pushed_at:2022-03 star:46.5k fork:32.9k Spring Framework
...
- [spring-projects/spring-ide](https://github.com/spring-projects/spring-ide) pushed_at:2022-02 star:0.3k fork:0.1k Spring Development Environment for Eclipse
...
- [spring-projects/spring-security](https://github.com/spring-projects/spring-security) pushed_at:2022-03 star:6.6k fork:4.9k Spring Security
...
- [spring-projects/spring-security-oauth2-boot](https://github.com/spring-projects/spring-security-oauth2-boot) pushed_at:2022-01 star:0.3k fork:0.1k Provides spring-security-oauth2 & Boot 2 integration (i.e. autoconfig)
...
- [spring-projects/spring-security-samples](https://github.com/spring-projects/spring-security-samples) pushed_at:2022-03 star:0.2k fork:0.1k 
...
- [spring-projects/spring-session-data-geode](https://github.com/spring-projects/spring-session-data-geode) pushed_at:2022-02 star:0.0k fork:0.0k Spring Session support for Apache Geode and VMware Tanzu GemFire
...
- [spring-projects/toolsuite-distribution](https://github.com/spring-projects/toolsuite-distribution) pushed_at:2022-02 star:0.1k fork:0.0k the distribution build for the Spring Tool Suite and the Groovy/Grails Tool Suite
