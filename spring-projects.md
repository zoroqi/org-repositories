...
- [spring-projects/spring-data-elasticsearch](https://github.com/spring-projects/spring-data-elasticsearch) topic: pushed_at:2025-11 star:3.0k fork:1.3k Provide support to increase developer productivity in Java when using Elasticsearch. Uses familiar Spring concepts such as a template classes for core API usage and lightweight repository style data access.
- [spring-projects/spring-data-examples](https://github.com/spring-projects/spring-data-examples) topic: pushed_at:2025-11 star:5.4k fork:3.4k Spring Data Example Projects
...
- [spring-projects/spring-data-jpa](https://github.com/spring-projects/spring-data-jpa) topic:ddd,framework,java,jpa,spring,spring-data pushed_at:2025-11 star:3.2k fork:1.5k Simplifies the development of creating a JPA-based data access layer. 
- [spring-projects/spring-data-keyvalue](https://github.com/spring-projects/spring-data-keyvalue) topic: pushed_at:2025-11 star:0.2k fork:0.1k Project to provide infrastructure to implement Spring Data repositories on top of key-value-based, in-memory data stores.
- [spring-projects/spring-data-ldap](https://github.com/spring-projects/spring-data-ldap) topic:ddd,framework,ldap,spring-data,spring-ldap pushed_at:2025-11 star:0.1k fork:0.1k Repository abstraction for Spring LDAP
- [spring-projects/spring-data-mongodb](https://github.com/spring-projects/spring-data-mongodb) topic:ddd,framework,java,mongodb,spring,spring-data pushed_at:2025-11 star:1.7k fork:1.1k Provides support to increase developer productivity in Java when using MongoDB. Uses familiar Spring concepts such as a template classes for core API usage and lightweight repository style data access.
- [spring-projects/spring-data-neo4j](https://github.com/spring-projects/spring-data-neo4j) topic:ddd,framework,java,neo4j,spring,spring-data pushed_at:2025-11 star:0.9k fork:0.6k Provide support to increase developer productivity in Java when using Neo4j. Uses familiar Spring concepts such as a template classes for core API usage and lightweight repository style data access.
- [spring-projects/spring-data-redis](https://github.com/spring-projects/spring-data-redis) topic:ddd,framework,java,redis,spring,spring-data pushed_at:2025-11 star:1.8k fork:1.2k Provides support to increase developer productivity in Java when using Redis, a key-value store. Uses familiar Spring concepts such as a template classes for core API usage and lightweight repository style data access.
...
- [spring-projects/spring-hateoas](https://github.com/spring-projects/spring-hateoas) topic: pushed_at:2025-11 star:1.1k fork:0.5k Spring HATEOAS - Library to support implementing representations for hyper-text driven REST web services.
...
- [spring-projects/spring-integration](https://github.com/spring-projects/spring-integration) topic:eip,java,microservices,spring pushed_at:2025-11 star:1.6k fork:1.1k Spring Integration provides an extension of the Spring programming model to support the well-known Enterprise Integration Patterns (EIP)
...
- [spring-projects/spring-modulith](https://github.com/spring-projects/spring-modulith) topic:architecture,modularity,spring-boot pushed_at:2025-11 star:1.0k fork:0.2k Modular applications with Spring Boot
- [spring-projects/spring-plugin](https://github.com/spring-projects/spring-plugin) topic: pushed_at:2025-11 star:0.5k fork:0.1k 
- [spring-projects/spring-pulsar](https://github.com/spring-projects/spring-pulsar) topic: pushed_at:2025-11 star:0.2k fork:0.1k Spring Friendly Abstractions for Apache Pulsar
...
- [spring-projects/spring-shell](https://github.com/spring-projects/spring-shell) topic: pushed_at:2025-11 star:0.8k fork:0.4k Spring based shell
...
- [spring-projects/spring-tools](https://github.com/spring-projects/spring-tools) topic:eclipse,spring,spring-boot,sts4,theia,visual-studio-code,vscode-extension pushed_at:2025-11 star:0.9k fork:0.2k The next generation of tooling for Spring Boot, including support for Cloud Foundry manifest files, Concourse CI pipeline definitions, BOSH deployment manifests, and more... - Available for Eclipse, Visual Studio Code, and Theia
- [spring-projects/spring-vault](https://github.com/spring-projects/spring-vault) topic:encryption,framework,java,secrets,security,spring,vault pushed_at:2025-11 star:0.3k fork:0.2k Provides familiar Spring abstractions for HashiCorp Vault
- [spring-projects/spring-webflow](https://github.com/spring-projects/spring-webflow) topic: pushed_at:2025-11 star:0.3k fork:0.2k Spring Web Flow
- [spring-projects/spring-ws](https://github.com/spring-projects/spring-ws) topic: pushed_at:2025-11 star:0.3k fork:0.3k Spring Web Services
...
- [spring-projects/spring-data-build](https://github.com/spring-projects/spring-data-build) topic: pushed_at:2025-11 star:0.1k fork:0.1k Modules to centralize common resources and configuration for Spring Data Maven builds.
