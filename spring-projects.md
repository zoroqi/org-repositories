...
- [spring-projects/spring-petclinic](https://github.com/spring-projects/spring-petclinic) pushed_at:2022-03 star:5.5k fork:15.4k A sample Spring-based application
...
- [spring-projects/eclipse-integration-commons](https://github.com/spring-projects/eclipse-integration-commons) pushed_at:2022-03 star:0.0k fork:0.0k Common SpringSource components used to integrate tooling with Eclipse, like the SpringSource Dashboard, Eclipse Spring UAA, common framework components and workspace configurators
...
- [spring-projects/spring-amqp](https://github.com/spring-projects/spring-amqp) pushed_at:2022-03 star:0.7k fork:0.5k Spring AMQP - support for Spring programming model with AMQP, especially but not limited to RabbitMQ
- [spring-projects/spring-amqp-samples](https://github.com/spring-projects/spring-amqp-samples) pushed_at:2022-03 star:0.5k fork:0.4k Samples for Spring AMQP
...
- [spring-projects/spring-android](https://github.com/spring-projects/spring-android) pushed_at:2021-12 star:0.7k fork:0.3k Support for Spring's RestTemplate within native Android applications
- [spring-projects/spring-android-samples](https://github.com/spring-projects/spring-android-samples) pushed_at:2021-12 star:0.8k fork:0.5k Spring for Android Sample Applications
- [spring-projects/spring-authorization-server](https://github.com/spring-projects/spring-authorization-server) pushed_at:2022-03 star:3.4k fork:0.7k The Spring Authorization Server project is focused on delivering OAuth 2.1 Authorization Server support to the Spring community.
- [spring-projects/spring-batch](https://github.com/spring-projects/spring-batch) pushed_at:2022-03 star:2.1k fork:2.0k Spring Batch is a framework for writing offline and batch applications using Spring and Java
- [spring-projects/spring-batch-extensions](https://github.com/spring-projects/spring-batch-extensions) pushed_at:2022-02 star:0.2k fork:0.2k Spring Batch Extensions
- [spring-projects/spring-boot](https://github.com/spring-projects/spring-boot) pushed_at:2022-03 star:60.4k fork:36.1k Spring Boot
- [spring-projects/spring-boot-data-geode](https://github.com/spring-projects/spring-boot-data-geode) pushed_at:2022-03 star:0.0k fork:0.0k Spring Boot support for Apache Geode and VMware Tanzu GemFire
...
- [spring-projects/spring-data-book](https://github.com/spring-projects/spring-data-book) pushed_at:2022-03 star:1.3k fork:1.1k Spring Data - The Definitive Guide - Modern Data Access for Enterprise Java Developers
- [spring-projects/spring-data-cassandra](https://github.com/spring-projects/spring-data-cassandra) pushed_at:2022-03 star:0.3k fork:0.3k Provides support to increase developer productivity in Java when using Apache Cassandra.  Uses familiar Spring concepts such as a template classes for core API usage and lightweight repository style data access.
- [spring-projects/spring-data-commons](https://github.com/spring-projects/spring-data-commons) pushed_at:2022-03 star:0.6k fork:0.6k Spring Data Commons. Interfaces and code shared between the various datastore specific implementations.
- [spring-projects/spring-data-couchbase](https://github.com/spring-projects/spring-data-couchbase) pushed_at:2022-03 star:0.2k fork:0.2k Spring Data Couchbase
- [spring-projects/spring-data-dev-tools](https://github.com/spring-projects/spring-data-dev-tools) pushed_at:2022-03 star:0.0k fork:0.0k A collection of tools to support Spring Data development.
...
- [spring-projects/spring-data-elasticsearch](https://github.com/spring-projects/spring-data-elasticsearch) pushed_at:2022-03 star:2.6k fork:1.2k Provide support to increase developer productivity in Java when using Elasticsearch. Uses familiar Spring concepts such as a template classes for core API usage and lightweight repository style data access.
- [spring-projects/spring-data-examples](https://github.com/spring-projects/spring-data-examples) pushed_at:2022-03 star:4.4k fork:3.1k Spring Data Example Projects
...
- [spring-projects/spring-data-geode](https://github.com/spring-projects/spring-data-geode) pushed_at:2022-03 star:0.0k fork:0.0k Spring Data support for Apache Geode
- [spring-projects/spring-data-jpa](https://github.com/spring-projects/spring-data-jpa) pushed_at:2022-03 star:2.3k fork:1.1k Simplifies the development of creating a JPA-based data access layer. 
- [spring-projects/spring-data-keyvalue](https://github.com/spring-projects/spring-data-keyvalue) pushed_at:2022-03 star:0.1k fork:0.1k Project to provide infrastructure to implement Spring Data repositories on top of key-value-based, in-memory data stores.
- [spring-projects/spring-data-ldap](https://github.com/spring-projects/spring-data-ldap) pushed_at:2022-03 star:0.1k fork:0.0k Repository abstraction for Spring LDAP
- [spring-projects/spring-data-mongodb](https://github.com/spring-projects/spring-data-mongodb) pushed_at:2022-03 star:1.4k fork:1.0k Provide support to increase developer productivity in Java when using MongoDB. Uses familiar Spring concepts such as a template classes for core API usage and lightweight repository style data access.
- [spring-projects/spring-data-neo4j](https://github.com/spring-projects/spring-data-neo4j) pushed_at:2022-03 star:0.7k fork:0.6k Provide support to increase developer productivity in Java when using Neo4j. Uses familiar Spring concepts such as a template classes for core API usage and lightweight repository style data access.
- [spring-projects/spring-data-redis](https://github.com/spring-projects/spring-data-redis) pushed_at:2022-03 star:1.4k fork:1.0k Provides support to increase developer productivity in Java when using Redis, a key-value store. Uses familiar Spring concepts such as a template classes for core API usage and lightweight repository style data access.
- [spring-projects/spring-data-relational](https://github.com/spring-projects/spring-data-relational) pushed_at:2022-03 star:0.6k fork:0.2k Spring Data Relational
- [spring-projects/spring-data-rest](https://github.com/spring-projects/spring-data-rest) pushed_at:2022-03 star:0.8k fork:0.5k Simplifies building hypermedia-driven REST web services on top of Spring Data repositories
...
- [spring-projects/spring-data-solr](https://github.com/spring-projects/spring-data-solr) pushed_at:2021-11 star:0.4k fork:0.3k Spring Data - Apache Solr integration
...
- [spring-projects/spring-framework](https://github.com/spring-projects/spring-framework) pushed_at:2022-03 star:46.9k fork:33.2k Spring Framework
...
- [spring-projects/spring-graphql](https://github.com/spring-projects/spring-graphql) pushed_at:2022-03 star:1.1k fork:0.1k Spring Integration for GraphQL 
- [spring-projects/spring-guice](https://github.com/spring-projects/spring-guice) pushed_at:2022-03 star:0.1k fork:0.1k Tools for using Spring in Guice and Guice in Spring
- [spring-projects/spring-hadoop](https://github.com/spring-projects/spring-hadoop) pushed_at:2022-03 star:0.6k fork:0.4k Spring for Apache Hadoop is a framework for application developers to take advantage of the features of both Hadoop and Spring.
- [spring-projects/spring-hadoop-admin](https://github.com/spring-projects/spring-hadoop-admin) pushed_at:2021-10 star:0.0k fork:0.0k Web application and API for managing and monitoring Spring Hadoop
...
- [spring-projects/spring-hateoas](https://github.com/spring-projects/spring-hateoas) pushed_at:2022-03 star:1.0k fork:0.4k Spring HATEOAS - Library to support implementing representations for hyper-text driven REST web services.
...
- [spring-projects/spring-ide](https://github.com/spring-projects/spring-ide) pushed_at:2022-03 star:0.3k fork:0.1k Spring Development Environment for Eclipse
- [spring-projects/spring-integration](https://github.com/spring-projects/spring-integration) pushed_at:2022-03 star:1.3k fork:1.0k Spring Integration provides an extension of the Spring programming model to support the well-known Enterprise Integration Patterns (EIP)
- [spring-projects/spring-integration-aws](https://github.com/spring-projects/spring-integration-aws) pushed_at:2022-03 star:0.2k fork:0.1k 
- [spring-projects/spring-integration-extensions](https://github.com/spring-projects/spring-integration-extensions) pushed_at:2022-03 star:0.3k fork:0.3k The Spring Integration Extensions project provides extension components for Spring Integration
...
- [spring-projects/spring-integration-samples](https://github.com/spring-projects/spring-integration-samples) pushed_at:2022-03 star:2.1k fork:2.5k You are looking for examples, code snippets, sample applications for Spring Integration? This is the place.
...
- [spring-projects/spring-kafka](https://github.com/spring-projects/spring-kafka) pushed_at:2022-03 star:1.6k fork:1.2k Provides Familiar Spring Abstractions for Apache Kafka
- [spring-projects/spring-ldap](https://github.com/spring-projects/spring-ldap) pushed_at:2022-03 star:0.3k fork:0.5k Spring LDAP
...
- [spring-projects/spring-restdocs](https://github.com/spring-projects/spring-restdocs) pushed_at:2022-03 star:1.0k fork:0.7k Test-driven documentation for RESTful services
- [spring-projects/spring-retry](https://github.com/spring-projects/spring-retry) pushed_at:2022-03 star:1.7k fork:0.4k 
- [spring-projects/spring-security](https://github.com/spring-projects/spring-security) pushed_at:2022-03 star:6.7k fork:5.0k Spring Security
...
- [spring-projects/spring-security-oauth](https://github.com/spring-projects/spring-security-oauth) pushed_at:2022-03 star:4.5k fork:4.1k Support for adding OAuth1(a) and OAuth2 features (consumer and provider) for Spring web applications.
- [spring-projects/spring-security-oauth2-boot](https://github.com/spring-projects/spring-security-oauth2-boot) pushed_at:2022-03 star:0.3k fork:0.1k Provides spring-security-oauth2 & Boot 2 integration (i.e. autoconfig)
- [spring-projects/spring-security-saml](https://github.com/spring-projects/spring-security-saml) pushed_at:2021-11 star:0.4k fork:0.5k SAML extension for the Spring Security project
- [spring-projects/spring-security-samples](https://github.com/spring-projects/spring-security-samples) pushed_at:2022-03 star:0.3k fork:0.2k 
- [spring-projects/spring-session](https://github.com/spring-projects/spring-session) pushed_at:2022-03 star:1.7k fork:1.0k Spring Session
- [spring-projects/spring-session-data-geode](https://github.com/spring-projects/spring-session-data-geode) pushed_at:2022-03 star:0.0k fork:0.0k Spring Session support for Apache Geode and VMware Tanzu GemFire
...
- [spring-projects/spring-shell](https://github.com/spring-projects/spring-shell) pushed_at:2022-03 star:0.5k fork:0.3k Spring based interactive shell
- [spring-projects/spring-social](https://github.com/spring-projects/spring-social) pushed_at:2021-11 star:0.6k fork:0.4k Allows you to connect your applications with SaaS providers such as Facebook and Twitter.
- [spring-projects/spring-social-facebook](https://github.com/spring-projects/spring-social-facebook) pushed_at:2021-11 star:0.2k fork:0.3k Facebook API binding and connect support.
...
- [spring-projects/spring-social-samples](https://github.com/spring-projects/spring-social-samples) pushed_at:2022-03 star:0.5k fork:0.8k Samples of using Spring Social
...
- [spring-projects/spring-statemachine](https://github.com/spring-projects/spring-statemachine) pushed_at:2022-03 star:1.3k fork:0.5k Spring Statemachine is a framework for application developers to use state machine concepts with Spring.
...
- [spring-projects/spring-test-data-geode](https://github.com/spring-projects/spring-test-data-geode) pushed_at:2022-03 star:0.0k fork:0.0k A Spring-based Test Framework supporting Unit and Integration testing for Spring Boot applications using Spring Data with either Apache Geode or VMware Tanzu GemFire
- [spring-projects/spring-tuple](https://github.com/spring-projects/spring-tuple) pushed_at:2019-03 star:0.0k fork:0.0k 
- [spring-projects/spring-vault](https://github.com/spring-projects/spring-vault) pushed_at:2022-03 star:0.2k fork:0.1k Provides familiar Spring abstractions for HashiCorp Vault
...
- [spring-projects/spring-ws](https://github.com/spring-projects/spring-ws) pushed_at:2022-03 star:0.3k fork:0.3k Spring Web Services
...
- [spring-projects/sts4](https://github.com/spring-projects/sts4) pushed_at:2022-03 star:0.6k fork:0.2k The next generation of tooling for Spring Boot, including support for Cloud Foundry manifest files, Concourse CI pipeline definitions, BOSH deployment manifests, and more... - Available for Eclipse, Visual Studio Code, and Theia
...
- [spring-projects/scripted-alpha](https://github.com/spring-projects/scripted-alpha) pushed_at:2019-03 star:0.0k fork:0.0k The Scripted code editor
...
- [spring-projects/spring-data-bom](https://github.com/spring-projects/spring-data-bom) pushed_at:2022-03 star:0.0k fork:0.0k Spring Data Bill of Materials
- [spring-projects/spring-data-ci](https://github.com/spring-projects/spring-data-ci) pushed_at:2018-11 star:0.0k fork:0.0k 
- [spring-projects/spring-data-envers](https://github.com/spring-projects/spring-data-envers) pushed_at:2022-03 star:0.3k fork:0.1k Envers extension of the Spring Data JPA module
- [spring-projects/spring-data-r2dbc](https://github.com/spring-projects/spring-data-r2dbc) pushed_at:2022-03 star:0.6k fork:0.1k Provide support to increase developer productivity in Java when using Reactive Relational Database Connectivity. Uses familiar Spring concepts such as a DatabaseClient for core API usage and lightweight repository style data access.
...
- [spring-projects/spring-session-bom](https://github.com/spring-projects/spring-session-bom) pushed_at:2022-03 star:0.0k fork:0.0k Spring Session Bill of Materials
...
- [spring-projects/spring-data-build](https://github.com/spring-projects/spring-data-build) pushed_at:2022-03 star:0.1k fork:0.1k Modules to centralize common resources and configuration for Spring Data Maven builds.
...
- [spring-projects/toolsuite-distribution](https://github.com/spring-projects/toolsuite-distribution) pushed_at:2022-03 star:0.1k fork:0.0k the distribution build for the Spring Tool Suite and the Groovy/Grails Tool Suite
