...
- [spring-projects/spring-net](https://github.com/spring-projects/spring-net) pushed_at:2021-01 star:0.7k fork:0.3k Spring Framework for .NET
...
- [spring-projects/spring-webflow-samples](https://github.com/spring-projects/spring-webflow-samples) pushed_at:2021-03 star:0.4k fork:0.6k 
...
- [spring-projects/jenkins-common](https://github.com/spring-projects/jenkins-common) pushed_at:2021-02 star:0.0k fork:0.0k 
...
- [spring-projects/eclipse-integration-commons](https://github.com/spring-projects/eclipse-integration-commons) pushed_at:2021-02 star:0.0k fork:0.0k Common SpringSource components used to integrate tooling with Eclipse, like the SpringSource Dashboard, Eclipse Spring UAA, common framework components and workspace configurators
...
- [spring-projects/spring-amqp](https://github.com/spring-projects/spring-amqp) pushed_at:2021-02 star:0.6k fork:0.5k Spring AMQP - support for Spring programming model with AMQP, especially but not limited to RabbitMQ
- [spring-projects/spring-amqp-samples](https://github.com/spring-projects/spring-amqp-samples) pushed_at:2021-02 star:0.5k fork:0.4k Samples for Spring AMQP
...
- [spring-projects/spring-boot](https://github.com/spring-projects/spring-boot) pushed_at:2021-03 star:53.8k fork:33.0k Spring Boot
- [spring-projects/spring-boot-data-geode](https://github.com/spring-projects/spring-boot-data-geode) pushed_at:2021-02 star:0.0k fork:0.0k Spring Boot support for Apache Geode and VMware Tanzu GemFire
...
- [spring-projects/spring-data-couchbase](https://github.com/spring-projects/spring-data-couchbase) pushed_at:2021-03 star:0.2k fork:0.1k Spring Data Couchbase
...
- [spring-projects/spring-data-dev-tools](https://github.com/spring-projects/spring-data-dev-tools) pushed_at:2021-02 star:0.0k fork:0.0k A collection of tools to support Spring Data development.
...
- [spring-projects/spring-data-envers](https://github.com/spring-projects/spring-data-envers) pushed_at:2021-02 star:0.2k fork:0.1k Envers extension of the Spring Data JPA module
- [spring-projects/spring-data-examples](https://github.com/spring-projects/spring-data-examples) pushed_at:2021-02 star:3.9k fork:2.8k Spring Data Example Projects
...
- [spring-projects/spring-data-geode](https://github.com/spring-projects/spring-data-geode) pushed_at:2021-02 star:0.0k fork:0.0k Spring Data support for Apache Geode
...
- [spring-projects/spring-data-keyvalue](https://github.com/spring-projects/spring-data-keyvalue) pushed_at:2021-02 star:0.1k fork:0.0k Project to provide infrastructure to implement Spring Data repositories on top of key-value-based, in-memory data stores.
- [spring-projects/spring-data-ldap](https://github.com/spring-projects/spring-data-ldap) pushed_at:2021-02 star:0.1k fork:0.0k Repository abstraction for Spring LDAP
- [spring-projects/spring-data-mongodb](https://github.com/spring-projects/spring-data-mongodb) pushed_at:2021-03 star:1.2k fork:0.9k Provide support to increase developer productivity in Java when using MongoDB. Uses familiar Spring concepts such as a template classes for core API usage and lightweight repository style data access.
...
- [spring-projects/spring-data-rest](https://github.com/spring-projects/spring-data-rest) pushed_at:2021-02 star:0.7k fork:0.5k Simplifies building hypermedia-driven REST web services on top of Spring Data repositories
...
- [spring-projects/spring-data-solr](https://github.com/spring-projects/spring-data-solr) pushed_at:2021-02 star:0.4k fork:0.2k Spring Data - Apache Solr integration
...
- [spring-projects/spring-framework](https://github.com/spring-projects/spring-framework) pushed_at:2021-03 star:41.7k fork:29.0k Spring Framework
...
- [spring-projects/spring-hateoas](https://github.com/spring-projects/spring-hateoas) pushed_at:2021-02 star:0.9k fork:0.4k Spring HATEOAS - Library to support implementing representations for hyper-text driven REST web services.
...
- [spring-projects/spring-ide](https://github.com/spring-projects/spring-ide) pushed_at:2021-02 star:0.3k fork:0.1k Spring Development Environment for Eclipse
...
- [spring-projects/spring-integration](https://github.com/spring-projects/spring-integration) pushed_at:2021-03 star:1.1k fork:0.9k Spring Integration provides an extension of the Spring programming model to support the well-known Enterprise Integration Patterns (EIP)
- [spring-projects/spring-integration-aws](https://github.com/spring-projects/spring-integration-aws) pushed_at:2021-01 star:0.1k fork:0.1k 
...
- [spring-projects/spring-integration-samples](https://github.com/spring-projects/spring-integration-samples) pushed_at:2021-02 star:1.9k fork:2.4k You are looking for examples, code snippets, sample applications for Spring Integration? This is the place.
...
- [spring-projects/spring-ldap](https://github.com/spring-projects/spring-ldap) pushed_at:2021-03 star:0.3k fork:0.4k Spring LDAP
- [spring-projects/spring-loaded](https://github.com/spring-projects/spring-loaded) pushed_at:2020-08 star:2.5k fork:0.5k Java agent that enables class reloading in a running JVM
...
- [spring-projects/spring-mobile](https://github.com/spring-projects/spring-mobile) pushed_at:2019-05 star:0.2k fork:0.1k Extensions to Spring MVC for developing mobile web applications.
...
- [spring-projects/spring-mvc-showcase](https://github.com/spring-projects/spring-mvc-showcase) pushed_at:2020-12 star:4.9k fork:3.8k Demonstrates the features of the Spring MVC web framework
...
- [spring-projects/spring-petclinic](https://github.com/spring-projects/spring-petclinic) pushed_at:2021-02 star:4.7k fork:11.5k A sample Spring-based application
...
- [spring-projects/spring-retry](https://github.com/spring-projects/spring-retry) pushed_at:2021-02 star:1.4k fork:0.4k 
...
- [spring-projects/spring-security](https://github.com/spring-projects/spring-security) pushed_at:2021-03 star:5.7k fork:4.4k Spring Security
...
- [spring-projects/spring-security-kerberos](https://github.com/spring-projects/spring-security-kerberos) pushed_at:2021-02 star:0.1k fork:0.2k 
...
- [spring-projects/spring-security-oauth](https://github.com/spring-projects/spring-security-oauth) pushed_at:2021-03 star:4.3k fork:3.9k Support for adding OAuth1(a) and OAuth2 features (consumer and provider) for Spring web applications.
- [spring-projects/spring-security-oauth-javaconfig](https://github.com/spring-projects/spring-security-oauth-javaconfig) pushed_at:2019-03 star:0.0k fork:0.0k 
- [spring-projects/spring-security-oauth2-boot](https://github.com/spring-projects/spring-security-oauth2-boot) pushed_at:2021-01 star:0.3k fork:0.1k Provides spring-security-oauth2 & Boot 2 integration (i.e. autoconfig)
- [spring-projects/spring-security-portlet](https://github.com/spring-projects/spring-security-portlet) pushed_at:2019-03 star:0.0k fork:0.0k 
...
- [spring-projects/spring-session](https://github.com/spring-projects/spring-session) pushed_at:2021-03 star:1.6k fork:0.9k Spring Session
...
- [spring-projects/spring-shell](https://github.com/spring-projects/spring-shell) pushed_at:2021-02 star:0.5k fork:0.3k Spring based interactive shell
...
- [spring-projects/spring-statemachine](https://github.com/spring-projects/spring-statemachine) pushed_at:2021-01 star:1.0k fork:0.4k Spring Statemachine is a framework for application developers to use state machine concepts with Spring.
...
- [spring-projects/spring-test-data-geode](https://github.com/spring-projects/spring-test-data-geode) pushed_at:2021-02 star:0.0k fork:0.0k A Spring-based Test Framework supporting Unit and Integration testing for Spring Boot applications using Spring Data with either Apache Geode or VMware Tanzu GemFire
...
- [spring-projects/spring-vault](https://github.com/spring-projects/spring-vault) pushed_at:2021-02 star:0.2k fork:0.1k Provides familiar Spring abstractions for HashiCorp Vault
...
- [spring-projects/spring-data-build](https://github.com/spring-projects/spring-data-build) pushed_at:2021-02 star:0.1k fork:0.1k Modules to centralize common resources and configuration for Spring Data Maven builds.
...
- [spring-projects/.github](https://github.com/spring-projects/.github) pushed_at:2021-01 star:0.0k fork:0.0k 
...
- [spring-projects/spring-data-bom](https://github.com/spring-projects/spring-data-bom) pushed_at:2021-02 star:0.0k fork:0.0k Spring Data Bill of Materials
...
- [spring-projects/spring-security-issues](https://github.com/spring-projects/spring-security-issues) pushed_at:2016-03 star:0.0k fork:0.0k 
- [spring-projects/spring-security-team-tasks](https://github.com/spring-projects/spring-security-team-tasks) pushed_at:2019-05 star:0.0k fork:0.0k Repository just tracking arbitrary tasks for the Spring Security team.
- [spring-projects/spring-session-bom](https://github.com/spring-projects/spring-session-bom) pushed_at:2021-02 star:0.0k fork:0.0k Spring Session Bill of Materials
...
- [spring-projects/toolsuite-distribution](https://github.com/spring-projects/toolsuite-distribution) pushed_at:2021-02 star:0.1k fork:0.0k the distribution build for the Spring Tool Suite and the Groovy/Grails Tool Suite
...
- [spring-projects/spring-flo](https://github.com/spring-projects/spring-flo) pushed_at:2021-01 star:0.2k fork:0.1k JavaScript angular based embeddable graphical component for pipeline/graph building and editing
