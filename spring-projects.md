...
- [spring-projects/spring-net](https://github.com/spring-projects/spring-net) pushed_at:2022-01 star:0.7k fork:0.4k Spring Framework for .NET
...
- [spring-projects/spring-authorization-server](https://github.com/spring-projects/spring-authorization-server) pushed_at:2022-01 star:3.2k fork:0.7k The Spring Authorization Server project is focused on delivering OAuth 2.1 Authorization Server support to the Spring community.
...
- [spring-projects/spring-boot](https://github.com/spring-projects/spring-boot) pushed_at:2022-02 star:59.4k fork:35.5k Spring Boot
...
- [spring-projects/spring-data-book](https://github.com/spring-projects/spring-data-book) pushed_at:2022-01 star:1.3k fork:1.1k Spring Data - The Definitive Guide - Modern Data Access for Enterprise Java Developers
- [spring-projects/spring-data-cassandra](https://github.com/spring-projects/spring-data-cassandra) pushed_at:2022-01 star:0.3k fork:0.3k Provides support to increase developer productivity in Java when using Apache Cassandra.  Uses familiar Spring concepts such as a template classes for core API usage and lightweight repository style data access.
...
- [spring-projects/spring-data-dev-tools](https://github.com/spring-projects/spring-data-dev-tools) pushed_at:2022-01 star:0.0k fork:0.0k A collection of tools to support Spring Data development.
...
- [spring-projects/spring-data-examples](https://github.com/spring-projects/spring-data-examples) pushed_at:2022-01 star:4.3k fork:3.1k Spring Data Example Projects
...
- [spring-projects/spring-data-rest](https://github.com/spring-projects/spring-data-rest) pushed_at:2022-01 star:0.8k fork:0.5k Simplifies building hypermedia-driven REST web services on top of Spring Data repositories
...
- [spring-projects/spring-framework](https://github.com/spring-projects/spring-framework) pushed_at:2022-02 star:46.0k fork:32.5k Spring Framework
...
- [spring-projects/spring-hateoas](https://github.com/spring-projects/spring-hateoas) pushed_at:2022-01 star:1.0k fork:0.4k Spring HATEOAS - Library to support implementing representations for hyper-text driven REST web services.
...
- [spring-projects/spring-integration](https://github.com/spring-projects/spring-integration) pushed_at:2022-02 star:1.2k fork:0.9k Spring Integration provides an extension of the Spring programming model to support the well-known Enterprise Integration Patterns (EIP)
...
- [spring-projects/spring-security](https://github.com/spring-projects/spring-security) pushed_at:2022-02 star:6.5k fork:4.9k Spring Security
...
- [spring-projects/spring-session-data-geode](https://github.com/spring-projects/spring-session-data-geode) pushed_at:2022-01 star:0.0k fork:0.0k Spring Session support for Apache Geode and VMware Tanzu GemFire
...
- [spring-projects/spring-vault](https://github.com/spring-projects/spring-vault) pushed_at:2022-01 star:0.2k fork:0.1k Provides familiar Spring abstractions for HashiCorp Vault
...
- [spring-projects/sts4](https://github.com/spring-projects/sts4) pushed_at:2022-02 star:0.6k fork:0.1k The next generation of tooling for Spring Boot, including support for Cloud Foundry manifest files, Concourse CI pipeline definitions, BOSH deployment manifests, and more... - Available for Eclipse, Visual Studio Code, and Theia
