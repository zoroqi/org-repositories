...
- [alibaba/AliOS-Things](https://github.com/alibaba/AliOS-Things) topic:embedded,haas,haas-python,iot,microcontroller,os,risc-v,rtos pushed_at:2023-07 star:4.5k fork:1.2k 面向IoT领域的、高可伸缩的物联网操作系统，可去官网了解更多信息https://www.aliyun.com/product/aliosthings
...
- [alibaba/kubeskoop](https://github.com/alibaba/kubeskoop) topic: pushed_at:2024-01 star:0.4k fork:0.1k 
...
- [alibaba/async_simple](https://github.com/alibaba/async_simple) topic:asynchronous,coroutines,cpp20,cpp20-modules,modules pushed_at:2024-01 star:1.3k fork:0.2k Simple, light-weight and easy-to-use asynchronous components 
- [alibaba/BladeDISC](https://github.com/alibaba/BladeDISC) topic:compiler,deep-learning,inference-optimization,machine-learning,mlir,neural-network,pytorch,tensorflow pushed_at:2024-01 star:0.7k fork:0.2k BladeDISC is an end-to-end DynamIc Shape Compiler project for machine learning workloads.
...
- [alibaba/GraphAr](https://github.com/alibaba/GraphAr) topic:big-data,data-orchestration,etl,graph,graph-analysis,graph-storage pushed_at:2024-01 star:0.1k fork:0.0k An open source, standard data file format for graph data storage and retrieval
- [alibaba/GraphScope](https://github.com/alibaba/GraphScope) topic:analytics,big-data,data-science,graph,graph-analytics,graph-computation,graph-computing,graph-data,graph-neural-networks,gremlin pushed_at:2024-01 star:3.0k fork:0.5k 🔨 🍇 💻 🚀 GraphScope: A One-Stop Large-Scale Graph Computing System from Alibaba 来自阿里巴巴的一站式大规模图计算系统 图分析 图查询 图机器学习
...
- [alibaba/ilogtail](https://github.com/alibaba/ilogtail) topic:aliyun,apm,cloud-native,ebpf,observability,sls pushed_at:2024-01 star:1.4k fork:0.3k Fast and Lightweight Observability Data Collector
...
- [alibaba/PhotonLibOS](https://github.com/alibaba/PhotonLibOS) topic:async-io,coroutine,cpp,fs-library,iouring,kernel-features,libos,net-library,posix,std pushed_at:2024-01 star:0.7k fork:0.1k Probably the fastest coroutine lib of the world
...
- [alibaba/rtp-llm](https://github.com/alibaba/rtp-llm) topic:gpt,inference,llama,llm,llm-serving,llmops,model-serving pushed_at:2024-01 star:0.2k fork:0.0k RTP-LLM: Alibaba's high-performance LLM inference engine for diverse applications.
...
- [alibaba/yalantinglibs](https://github.com/alibaba/yalantinglibs) topic: pushed_at:2024-01 star:1.2k fork:0.2k A collection of modern C++ libraries, include coro_rpc, struct_pack, struct_json, struct_xml, struct_pb, easylog, async_simple
...
- [alibaba/flutter_boost](https://github.com/alibaba/flutter_boost) topic:android,dart,flutter,hybrid-app,hybrid-flutter,ios pushed_at:2024-01 star:6.7k fork:1.2k FlutterBoost is a Flutter plugin which enables hybrid integration of Flutter for your existing native apps with minimum efforts
...
- [alibaba/higress](https://github.com/alibaba/higress) topic:gateway,gateway-api,ingress,ingress-controller,microservice pushed_at:2024-01 star:2.1k fork:0.3k Next-generation Cloud Native Gateway | 下一代云原生网关
...
- [alibaba/virtual-environment](https://github.com/alibaba/virtual-environment) topic:isolation,istio,kubernetes,service-mesh pushed_at:2023-03 star:0.2k fork:0.0k Route isolation with service sharing https://alibaba.github.io/virtual-environment/#/zh-cn/
...
- [alibaba/arthas](https://github.com/alibaba/arthas) topic:agent,alibaba,arthas,classloader,diagnosis,java,jvm,trace,trouble-shooting pushed_at:2024-01 star:34.2k fork:7.4k Alibaba Java Diagnostic Tool Arthas/Alibaba Java诊断利器Arthas
...
- [alibaba/canal](https://github.com/alibaba/canal) topic: pushed_at:2024-01 star:27.3k fork:7.5k 阿里巴巴 MySQL binlog 增量订阅&消费组件 
- [alibaba/cli](https://github.com/alibaba/cli) topic: pushed_at:2023-09 star:0.1k fork:0.0k 
- [alibaba/cloud-native-app-initializer](https://github.com/alibaba/cloud-native-app-initializer) topic:cloud-native,cloud-native-app-initializer,initializer,microservices pushed_at:2023-09 star:0.2k fork:0.1k Cloud Native App Initializer is committed to providing developers with a simpler and more efficient project construction experience in the current cloud-native era.
...
- [alibaba/COLA](https://github.com/alibaba/COLA) topic:architecture,clean,cola pushed_at:2023-12 star:10.9k fork:2.9k 🥤 COLA: Clean Object-oriented & Layered Architecture
- [alibaba/compileflow](https://github.com/alibaba/compileflow) topic:alibaba,bpmn2,compile,flow,halo-platform,java,process,process-engine,spring pushed_at:2023-08 star:1.7k fork:0.3k 🎨 core business process engine of Alibaba Halo platform, best process engine for trade scenes. | 一个高性能流程编排引擎
...
- [alibaba/druid](https://github.com/alibaba/druid) topic: pushed_at:2024-01 star:27.5k fork:8.6k 阿里云计算平台DataWorks(https://help.aliyun.com/document_detail/137663.html) 团队出品，为监控而生的数据库连接池
...
- [alibaba/easyexcel](https://github.com/alibaba/easyexcel) topic:excel,java,jxl,oom,poi,xls,xlsx pushed_at:2024-01 star:30.3k fork:7.4k 快速、简洁、解决大文件内存溢出的java处理Excel工具
...
- [alibaba/havenask-federation](https://github.com/alibaba/havenask-federation) topic: pushed_at:2024-01 star:0.0k fork:0.0k 
...
- [alibaba/java-dns-cache-manipulator](https://github.com/alibaba/java-dns-cache-manipulator) topic:dns,dns-cache,dns-cache-manipulator,domain-name,hacking,hacking-code,integration-testing,java,jvm,testing,threadsafe,unit-testing pushed_at:2024-01 star:0.8k fork:0.2k 🌏 A tiny 0-dependency thread-safe Java™ lib for setting/viewing dns programmatically without touching host file, make unit/integration testing portable; and a tiny tool for setting/viewing dns of running JVM process.
...
- [alibaba/nacos](https://github.com/alibaba/nacos) topic:alibaba,config,configuration-management,distributed-configuration,dns,dubbo,istio,kubernetes,microservices,nacos,service-discovery,service-mesh,spring-cloud pushed_at:2024-01 star:28.5k fork:12.5k an easy-to-use dynamic service discovery, configuration and service management platform for building cloud native applications.
...
- [alibaba/Sentinel](https://github.com/alibaba/Sentinel) topic:alibaba,circuit-breaker,cloud-native,java,microservice,microservices,rate-limiting,reliability,resiliency pushed_at:2024-01 star:21.8k fork:7.9k A powerful flow control component enabling reliability, resilience and monitoring for microservices. (面向云原生微服务的高可用流控防护组件)
...
- [alibaba/SmartEngine](https://github.com/alibaba/SmartEngine) topic: pushed_at:2024-01 star:0.7k fork:0.2k SmartEngine is a lightweight business orchestration engine.
...
- [alibaba/spring-cloud-alibaba](https://github.com/alibaba/spring-cloud-alibaba) topic:alibaba,alibaba-middleware,alibaba-oss,aliyun,circuit-breaker,cloud-native,distributed-configuration,distributed-messaging,distributed-transaction,dubbo,java,microservices,nacos,rocketmq,service-discovery,service-registry,spring,spring-cloud,spring-cloud-alibaba,spring-cloud-core pushed_at:2024-01 star:26.9k fork:8.2k Spring Cloud Alibaba provides a one-stop solution for application development for the distributed solutions of Alibaba middleware.
- [alibaba/spring-context-support](https://github.com/alibaba/spring-context-support) topic:alibaba,java,spring,spring-context,spring-framework pushed_at:2023-04 star:0.2k fork:0.1k An internal support project for spring-context in Alibaba 
...
- [alibaba/SREWorks](https://github.com/alibaba/SREWorks) topic:aiops,application,cloudnative,dataops,devops,engineering,flink,k8s,kubernetes,maintenance,oam,operation,ops,saas,sre pushed_at:2023-10 star:1.6k fork:0.4k Cloud Native DataOps & AIOps Platform | 云原生数智运维平台 
...
- [alibaba/termd](https://github.com/alibaba/termd) topic: pushed_at:2023-09 star:0.1k fork:0.1k 
...
- [alibaba/f2e-spec](https://github.com/alibaba/f2e-spec) topic:guidelines,linter,specification pushed_at:2024-01 star:0.7k fork:0.2k Alibaba Front-end Coding Guidelines and Relevant Tools
...
- [alibaba/react-intl-universal](https://github.com/alibaba/react-intl-universal) topic: pushed_at:2024-01 star:1.3k fork:0.2k Internationalize React apps. Not only for Component but also for Vanilla JS.
...
- [alibaba/web-editor](https://github.com/alibaba/web-editor) topic:atx,editor,web pushed_at:2023-11 star:1.1k fork:0.3k web editor for atx
...
- [alibaba/p3c](https://github.com/alibaba/p3c) topic: pushed_at:2024-01 star:29.9k fork:8.1k Alibaba Java Coding Guidelines pmd implements and IDE plugin
...
- [alibaba/animate-anything](https://github.com/alibaba/animate-anything) topic:animation,video-diffusion-model,video-generation pushed_at:2024-01 star:0.4k fork:0.0k Fine-Grained Open Domain Image Animation with Motion Guidance
...
- [alibaba/data-juicer](https://github.com/alibaba/data-juicer) topic:chinese,data-analysis,data-science,data-visualization,dataset,gpt,gpt-4,instruction-tuning,large-language-models,llama,llm,llms,machine-learning,multi-modal,nlp,opendata,pre-training,pytorch,streamlit pushed_at:2024-01 star:1.0k fork:0.1k A one-stop data processing system to make data higher-quality, juicier, and more digestible for LLMs!  🍎 🍋 🌽 ➡️ ➡️🍸 🍹 🍷为大语言模型提供更高质量、更丰富、更易”消化“的数据！
...
- [alibaba/EasyCV](https://github.com/alibaba/EasyCV) topic:classification,computer-vision,object-detection,pytorch,self-supervised-learning,transformers,vision-transformer pushed_at:2024-01 star:1.6k fork:0.2k An all-in-one toolkit for computer vision
...
- [alibaba/easydist](https://github.com/alibaba/easydist) topic:automatic-parallelization,deep-learning,diffusion-models,distributed-computing,graph-neural-networks,high-performance-computing,large-language-models,llama,llm,machine-learning pushed_at:2024-01 star:0.1k fork:0.0k Automated Parallelization System and Infrastructure for Multiple Ecosystems
...
- [alibaba/FederatedScope](https://github.com/alibaba/FederatedScope) topic:federated-learning,machine-learning,pytorch pushed_at:2023-12 star:1.1k fork:0.2k An easy-to-use federated learning platform
...
- [alibaba/graphlearn-for-pytorch](https://github.com/alibaba/graphlearn-for-pytorch) topic:deep-learning,distributed,gpu,graph-neural-networks,pytorch pushed_at:2024-01 star:0.1k fork:0.0k A GPU-accelerated graph learning library for PyTorch, facilitating the scaling of GNN training and inference.
...
- [alibaba/LucaProt](https://github.com/alibaba/LucaProt) topic: pushed_at:2024-01 star:0.1k fork:0.0k LucaProt: A novel deep learning framework that incorporates protein amino acid sequence and structure information to predict protein function.
...
- [alibaba/Pai-Megatron-Patch](https://github.com/alibaba/Pai-Megatron-Patch) topic: pushed_at:2024-01 star:0.3k fork:0.0k The official repo of Pai-Megatron-Patch for LLM & VLM large scale training developed by Alibaba Cloud.
...
- [alibaba/aliyunpan-ios-sdk](https://github.com/alibaba/aliyunpan-ios-sdk) topic: pushed_at:2024-01 star:0.0k fork:0.0k 阿里云盘 OpenSDK-iOS
...
- [alibaba/cloud-charts](https://github.com/alibaba/cloud-charts) topic: pushed_at:2024-01 star:0.5k fork:0.1k 开箱即用的前端图表库，简单配置就能拥有漂亮的可视化图表
...
- [alibaba/formily](https://github.com/alibaba/formily) topic:ant-design,designable,form,form-builder,fusion,json-schema,json-schema-form,low-code,no-code,observable,react,react-form,react-native,reactive,schema-form,validator,vue,vue-form,vue3 pushed_at:2024-01 star:10.5k fork:1.5k 📱🚀 🧩 Cross Device & High Performance Normal Form/Dynamic(JSON Schema) Form/Form Builder -- Support React/React Native/Vue 2/Vue 3
...
- [alibaba/hooks](https://github.com/alibaba/hooks) topic:ahooks,hooks-library,react,react-hooks,umi-hooks pushed_at:2024-01 star:13.1k fork:2.5k A high-quality & reliable React Hooks library.
- [alibaba/ice](https://github.com/alibaba/ice) topic:framework,icejs,microfrontends,mpa,nodejs,react,react-router,serverless,spa,ssr,typescript,vite,webpack pushed_at:2024-01 star:17.7k fork:2.1k 🚀 ice.js: The Progressive App Framework Based On React（基于 React 的渐进式应用框架）
...
- [alibaba/lowcode-demo](https://github.com/alibaba/lowcode-demo) topic:alibaba,low-code,lowcode pushed_at:2024-01 star:1.5k fork:0.5k An enterprise-class low-code technology stack with scale-out design / 一套面向扩展设计的企业级低代码技术体系
- [alibaba/lowcode-engine](https://github.com/alibaba/lowcode-engine) topic:alibaba,low-code,lowcode pushed_at:2024-02 star:13.4k fork:2.3k An enterprise-class low-code technology stack with scale-out design / 一套面向扩展设计的企业级低代码技术体系
...
- [alibaba/pont](https://github.com/alibaba/pont) topic:mock-data,pont,swagger,typescript pushed_at:2024-01 star:3.0k fork:0.3k 🌉数据服务层解决方案
...
- [alibaba/x-render](https://github.com/alibaba/x-render) topic:ant,ant-design,chart,form,formrender,javascript,json-schema,list,react,table,typescript,webpack,widget pushed_at:2024-01 star:6.6k fork:0.9k 🚴‍♀️ 阿里 - 很易用的中后台「表单 / 表格 / 图表」解决方案
