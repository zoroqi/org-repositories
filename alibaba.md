...
- [alibaba/GCanvas](https://github.com/alibaba/GCanvas) topic:2d,canvas,graphics,opengl,webgl pushed_at:2023-03 star:1.8k fork:0.2k A lightweight cross-platform graphics rendering engine. (超轻量的跨平台图形引擎) https://alibaba.github.io/GCanvas
...
- [alibaba/kubeskoop](https://github.com/alibaba/kubeskoop) topic: pushed_at:2024-01 star:0.4k fork:0.0k 
...
- [alibaba/tengine](https://github.com/alibaba/tengine) topic:http3,ingress,nginx,quic,tengine pushed_at:2023-12 star:12.4k fork:2.5k A distribution of Nginx with some advanced features
- [alibaba/tsar](https://github.com/alibaba/tsar) topic: pushed_at:2022-02 star:2.4k fork:0.8k Taobao System Activity Reporter
...
- [alibaba/async_simple](https://github.com/alibaba/async_simple) topic:asynchronous,coroutines,cpp20,modules pushed_at:2024-01 star:1.3k fork:0.2k Simple, light-weight and easy-to-use asynchronous components 
...
- [alibaba/graph-learn](https://github.com/alibaba/graph-learn) topic:aligraph,dynamic-graph,dynamic-graph-service,gnn,gnn-framework,gnn-inference,graph,graph-neural-networks,graphlearn,pytorch,tensorflow,training pushed_at:2023-11 star:1.2k fork:0.3k An Industrial Graph Neural Network Framework
...
- [alibaba/rtp-llm](https://github.com/alibaba/rtp-llm) topic: pushed_at:2024-01 star:0.1k fork:0.0k 
...
- [alibaba/higress](https://github.com/alibaba/higress) topic:gateway,gateway-api,ingress,ingress-controller,microservice pushed_at:2024-01 star:2.0k fork:0.3k Next-generation Cloud Native Gateway | 下一代云原生网关
...
- [alibaba/sentinel-golang](https://github.com/alibaba/sentinel-golang) topic:cloud-native,go,golang,microservice,microservices,middleware,rate-limiting,resiliency pushed_at:2023-12 star:2.6k fork:0.5k Sentinel Go enables reliability and resiliency for Go microservices
...
- [alibaba/arthas](https://github.com/alibaba/arthas) topic:agent,alibaba,arthas,classloader,diagnosis,java,jvm,trace,trouble-shooting pushed_at:2024-01 star:34.1k fork:7.4k Alibaba Java Diagnostic Tool Arthas/Alibaba Java诊断利器Arthas
...
- [alibaba/DataX](https://github.com/alibaba/DataX) topic: pushed_at:2024-01 star:14.7k fork:5.2k DataX是阿里云DataWorks数据集成的开源版本。
...
- [alibaba/easyexcel](https://github.com/alibaba/easyexcel) topic:excel,java,jxl,oom,poi,xls,xlsx pushed_at:2023-12 star:30.2k fork:7.4k 快速、简洁、解决大文件内存溢出的java处理Excel工具
...
- [alibaba/fastjson](https://github.com/alibaba/fastjson) topic:android,best-performance,deserialization,fastjson,java,json,json-parser,json-serialization,json-serializer,serialization pushed_at:2023-11 star:25.5k fork:6.6k FASTJSON 2.0.x has been released, faster and more secure, recommend you upgrade.
- [alibaba/fastjson2](https://github.com/alibaba/fastjson2) topic:android,big-data,deserialization,fastjson,fastjson2,graal,graalvm-native-image,high-performance,java,java-json,json,json-deserialization,json-parser,json-path,json-serialization,json-serializer,jsonb,serialization pushed_at:2024-01 star:3.2k fork:0.5k 🚄 FASTJSON2 is a Java JSON  library with excellent performance.
...
- [alibaba/nacos](https://github.com/alibaba/nacos) topic:alibaba,config,configuration-management,distributed-configuration,dns,dubbo,istio,kubernetes,microservices,nacos,service-discovery,service-mesh,spring-cloud pushed_at:2024-01 star:28.4k fork:12.4k an easy-to-use dynamic service discovery, configuration and service management platform for building cloud native applications.
...
- [alibaba/QLExpress](https://github.com/alibaba/QLExpress) topic: pushed_at:2024-01 star:4.4k fork:1.1k QLExpress is a powerful, lightweight, dynamic language for the Java platform aimed at improving developers’ productivity in different business scenes.
...
- [alibaba/Sentinel](https://github.com/alibaba/Sentinel) topic:alibaba,circuit-breaker,cloud-native,java,microservice,microservices,rate-limiting,reliability,resiliency pushed_at:2024-01 star:21.7k fork:7.9k A powerful flow control component enabling reliability, resilience and monitoring for microservices. (面向云原生微服务的高可用流控防护组件)
...
- [alibaba/SmartEngine](https://github.com/alibaba/SmartEngine) topic: pushed_at:2023-10 star:0.7k fork:0.2k SmartEngine is a lightweight business orchestration engine.
...
- [alibaba/butterfly](https://github.com/alibaba/butterfly) topic:bpmn,butterfly,connectivity,dag,diagram,diagramming,edge,flow,flow-dag,flow-layout,flowchart,mindmap,react,svg,tree,treemap-diagram,vue pushed_at:2023-08 star:4.0k fork:0.6k 🦋Butterfly，A JavaScript/React/Vue2 Diagramming library which concentrate on flow layout field.    (基于JavaScript/React/Vue2的流程图组件)
...
- [alibaba/f2e-spec](https://github.com/alibaba/f2e-spec) topic:guidelines,linter,specification pushed_at:2023-12 star:0.7k fork:0.2k Alibaba Front-end Coding Guidelines and Relevant Tools
...
- [alibaba/react-intl-universal](https://github.com/alibaba/react-intl-universal) topic: pushed_at:2023-12 star:1.3k fork:0.2k Internationalize React apps. Not only for Component but also for Vanilla JS.
...
- [alibaba/AgentScope](https://github.com/alibaba/AgentScope) topic: pushed_at:2024-01 star:0.0k fork:0.0k 
...
- [alibaba/animate-anything](https://github.com/alibaba/animate-anything) topic:animation,video-diffusion-model,video-generation pushed_at:2024-01 star:0.3k fork:0.0k Fine-Grained Open Domain Image Animation with Motion Guidance
...
- [alibaba/data-juicer](https://github.com/alibaba/data-juicer) topic:chinese,data-analysis,data-science,data-visualization,dataset,gpt,gpt-4,instruction-tuning,large-language-models,llama,llm,llms,machine-learning,multi-modal,nlp,opendata,pre-training,pytorch,streamlit pushed_at:2024-01 star:0.9k fork:0.1k A one-stop data processing system to make data higher-quality, juicier, and more digestible for LLMs!  🍎 🍋 🌽 ➡️ ➡️🍸 🍹 🍷为大语言模型提供更高质量、更丰富、更易”消化“的数据！
...
- [alibaba/graph-gpt](https://github.com/alibaba/graph-gpt) topic: pushed_at:2024-01 star:0.0k fork:0.0k 
...
- [alibaba/LucaProt](https://github.com/alibaba/LucaProt) topic: pushed_at:2024-01 star:0.0k fork:0.0k LucaProt: A novel deep learning framework that incorporates protein amino acid sequence and structure information to predict protein function.
...
- [alibaba/designable](https://github.com/alibaba/designable) topic:builder,designable,designer,editor,form,react pushed_at:2023-12 star:3.0k fork:0.6k 🧩 Make everything designable 🧩 
- [alibaba/form-driver](https://github.com/alibaba/form-driver) topic: pushed_at:2023-12 star:0.0k fork:0.0k 
- [alibaba/formily](https://github.com/alibaba/formily) topic:ant-design,designable,form,form-builder,fusion,json-schema,json-schema-form,low-code,no-code,observable,react,react-form,react-native,reactive,schema-form,validator,vue,vue-form,vue3 pushed_at:2024-01 star:10.4k fork:1.5k 📱🚀 🧩 Cross Device & High Performance Normal Form/Dynamic(JSON Schema) Form/Form Builder -- Support React/React Native/Vue 2/Vue 3
...
- [alibaba/general-scene-interface](https://github.com/alibaba/general-scene-interface) topic:web3d pushed_at:2023-12 star:0.0k fork:0.0k Build Your Web3D Programs With a Paradigm.
...
- [alibaba/hooks](https://github.com/alibaba/hooks) topic:ahooks,hooks-library,react,react-hooks,umi-hooks pushed_at:2024-01 star:13.0k fork:2.5k A high-quality & reliable React Hooks library.
...
- [alibaba/kiwi](https://github.com/alibaba/kiwi) topic:g11n,i18n,intl,translation,typescript pushed_at:2023-10 star:2.4k fork:0.2k 🐤 Kiwi-国际化翻译全流程解决方案
- [alibaba/lightproxy](https://github.com/alibaba/lightproxy) topic:chrome,debug,devtools,electron,light,lightproxy,proxy,typescript,whistle pushed_at:2023-03 star:3.0k fork:0.3k 💎 Cross platform Web debugging proxy
...
- [alibaba/lowcode-demo](https://github.com/alibaba/lowcode-demo) topic:alibaba,low-code,lowcode pushed_at:2024-01 star:1.4k fork:0.5k An enterprise-class low-code technology stack with scale-out design / 一套面向扩展设计的企业级低代码技术体系
- [alibaba/lowcode-engine](https://github.com/alibaba/lowcode-engine) topic:alibaba,low-code,lowcode pushed_at:2024-01 star:13.2k fork:2.3k An enterprise-class low-code technology stack with scale-out design / 一套面向扩展设计的企业级低代码技术体系
- [alibaba/lowcode-engine-ext](https://github.com/alibaba/lowcode-engine-ext) topic:alibaba,low-code,lowcode pushed_at:2024-01 star:0.1k fork:0.1k An enterprise-class low-code technology stack with scale-out design / 一套面向扩展设计的企业级低代码技术体系
- [alibaba/lowcode-graph](https://github.com/alibaba/lowcode-graph) topic: pushed_at:2023-11 star:0.1k fork:0.0k 
- [alibaba/lowcode-materials](https://github.com/alibaba/lowcode-materials) topic:alibaba,low-code,lowcode pushed_at:2023-11 star:0.3k fork:0.2k An enterprise-class low-code technology stack with scale-out design / 一套面向扩展设计的企业级低代码技术体系
...
- [alibaba/pipcook](https://github.com/alibaba/pipcook) topic:js,machine-learning,pipeline,tensorflow pushed_at:2024-01 star:2.5k fork:0.2k Machine learning platform for Web developers
- [alibaba/pont](https://github.com/alibaba/pont) topic:mock-data,pont,swagger,typescript pushed_at:2023-10 star:3.0k fork:0.2k 🌉数据服务层解决方案
...
- [alibaba/timeline](https://github.com/alibaba/timeline) topic: pushed_at:2023-03 star:0.0k fork:0.0k 
