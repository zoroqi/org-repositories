...
- [alibaba/code-data-share-for-python](https://github.com/alibaba/code-data-share-for-python) topic: pushed_at:2023-04 star:0.0k fork:0.0k 
...
- [alibaba/kubeskoop](https://github.com/alibaba/kubeskoop) topic: pushed_at:2023-04 star:0.1k fork:0.0k 
...
- [alibaba/xquic](https://github.com/alibaba/xquic) topic:http3,ietf,protocol,quic,tls13 pushed_at:2023-04 star:1.4k fork:0.3k XQUIC Library released by Alibaba is a cross-platform implementation of QUIC and HTTP/3 protocol.
...
- [alibaba/MNN](https://github.com/alibaba/MNN) topic:arm,convolution,deep-learning,deep-neural-networks,embedded-devices,machine-learning,ml,mnn,vulkan,winograd-algorithm pushed_at:2023-04 star:7.6k fork:1.5k MNN is a blazing fast, lightweight deep learning framework, battle-tested by business-critical use cases in Alibaba
...
- [alibaba/TePDist](https://github.com/alibaba/TePDist) topic: pushed_at:2023-04 star:0.1k fork:0.0k TePDist (TEnsor Program DISTributed) is an HLO-level automatic distributed system for DL models.
...
- [alibaba/pouch](https://github.com/alibaba/pouch) topic:cloud-native,containers,efficiency,go,isolation,kubernetes,oci,package,security pushed_at:2023-04 star:4.6k fork:1.0k An Efficient Enterprise-class Container Engine
...
- [alibaba/arthas](https://github.com/alibaba/arthas) topic:agent,alibaba,arthas,classloader,diagnosis,java,jvm,trace,trouble-shooting pushed_at:2023-04 star:32.3k fork:7.0k Alibaba Java Diagnostic Tool Arthas/Alibaba Java诊断利器Arthas
...
- [alibaba/canal](https://github.com/alibaba/canal) topic: pushed_at:2023-04 star:25.6k fork:7.2k 阿里巴巴 MySQL binlog 增量订阅&消费组件 
- [alibaba/Chat2DB](https://github.com/alibaba/Chat2DB) topic:ai,chat,chatbot,chatgpt,chatgpt-api,electron,gpt,java,mysql,oracle,postgresql,redis,redis-client,sql pushed_at:2023-04 star:0.4k fork:0.1k 一个集成了ChatGPT具备AIGC能力的数据库客户端工具
...
- [alibaba/COLA](https://github.com/alibaba/COLA) topic:architecture,clean,cola pushed_at:2023-04 star:9.6k fork:2.6k 🥤 COLA: Clean Object-oriented & Layered Architecture
...
- [alibaba/easyexcel](https://github.com/alibaba/easyexcel) topic:excel,java,jxl,oom,poi,xls,xlsx pushed_at:2023-04 star:27.6k fork:7.0k 快速、简洁、解决大文件内存溢出的java处理Excel工具
...
- [alibaba/nacos](https://github.com/alibaba/nacos) topic:alibaba,config,configuration-management,distributed-configuration,dns,dubbo,istio,kubernetes,microservices,nacos,service-discovery,service-mesh,spring-cloud pushed_at:2023-04 star:26.2k fork:11.7k an easy-to-use dynamic service discovery, configuration and service management platform for building cloud native applications.
...
- [alibaba/QLExpress](https://github.com/alibaba/QLExpress) topic: pushed_at:2023-04 star:4.1k fork:1.0k QLExpress is a powerful, lightweight, dynamic language for the Java platform aimed at improving developers’ productivity in different business scenes.
...
- [alibaba/Sentinel](https://github.com/alibaba/Sentinel) topic:alibaba,circuit-breaker,cloud-native,java,microservice,microservices,rate-limiting,reliability,resiliency pushed_at:2023-04 star:20.9k fork:7.6k A powerful flow control component enabling reliability, resilience and monitoring for microservices. (面向云原生微服务的高可用流控防护组件)
...
- [alibaba/spring-cloud-alibaba](https://github.com/alibaba/spring-cloud-alibaba) topic:alibaba,alibaba-middleware,alibaba-oss,aliyun,circuit-breaker,cloud-native,distributed-configuration,distributed-messaging,distributed-transaction,dubbo,java,microservices,nacos,rocketmq,service-discovery,service-registry,spring,spring-cloud,spring-cloud-alibaba,spring-cloud-core pushed_at:2023-04 star:25.5k fork:7.8k Spring Cloud Alibaba provides a one-stop solution for application development for the distributed solutions of Alibaba middleware.
...
- [alibaba/EasyCV](https://github.com/alibaba/EasyCV) topic:classification,computer-vision,object-detection,pytorch,self-supervised-learning,transformers,vision-transformer pushed_at:2023-04 star:1.4k fork:0.2k An all-in-one toolkit for computer vision
...
- [alibaba/graphlearn-for-pytorch](https://github.com/alibaba/graphlearn-for-pytorch) topic:distributed-training,gnn,gpu-acceleration,large-scale-learning pushed_at:2023-04 star:0.0k fork:0.0k A graph learning library for PyTorch that makes distributed GNN training and inference easy and efficient.
...
- [alibaba/taobao-iphone-device](https://github.com/alibaba/taobao-iphone-device) topic:ios,iphone,usbmuxd,wda pushed_at:2023-04 star:1.9k fork:0.4k  tidevice can be used to communicate with iPhone device
...
- [alibaba/cloud-charts](https://github.com/alibaba/cloud-charts) topic: pushed_at:2023-04 star:0.4k fork:0.1k 开箱即用的前端图表库，简单配置就能拥有漂亮的可视化图表
...
- [alibaba/general-scene-interface](https://github.com/alibaba/general-scene-interface) topic:web3d pushed_at:2023-04 star:0.0k fork:0.0k Build Your Web3D Programs With a Paradigm.
...
- [alibaba/hooks](https://github.com/alibaba/hooks) topic:ahooks,hooks-library,react,react-hooks,umi-hooks pushed_at:2023-04 star:11.8k fork:2.2k A high-quality & reliable React Hooks library.
...
- [alibaba/lowcode-engine](https://github.com/alibaba/lowcode-engine) topic:alibaba,low-code,lowcode pushed_at:2023-04 star:11.3k fork:1.9k An enterprise-class low-code technology stack with scale-out design / 一套面向扩展设计的企业级低代码技术体系
...
- [alibaba/lowcode-graph](https://github.com/alibaba/lowcode-graph) topic: pushed_at:2023-04 star:0.1k fork:0.0k 
...
- [alibaba/x-render](https://github.com/alibaba/x-render) topic:ant,ant-design,chart,form,formrender,javascript,json-schema,list,react,table,typescript,webpack,widget pushed_at:2023-04 star:6.0k fork:0.9k 🚴‍♀️ 阿里 - 很易用的中后台「表单 / 表格 / 图表」解决方案
