...
- [alibaba/SiliconFastOS](https://github.com/alibaba/SiliconFastOS) topic: pushed_at:2022-09 star:0.0k fork:0.0k 
...
- [alibaba/AlibabaCloud.TairSDK](https://github.com/alibaba/AlibabaCloud.TairSDK) topic: pushed_at:2022-09 star:0.0k fork:0.0k Based on StackExchange.Redis that operates Tair For Redis Modules.
...
- [alibaba/async_simple](https://github.com/alibaba/async_simple) topic: pushed_at:2022-09 star:0.5k fork:0.1k Simple, light-weight and easy-to-use asynchronous components 
- [alibaba/BladeDISC](https://github.com/alibaba/BladeDISC) topic:compiler,deep-learning,inference-optimization,machine-learning,mlir,neural-network,pytorch,tensorflow pushed_at:2022-09 star:0.4k fork:0.1k BladeDISC is an end-to-end DynamIc Shape Compiler project for machine learning workloads.
...
- [alibaba/libgrape-lite](https://github.com/alibaba/libgrape-lite) topic:cxx,gnn,gpu,grape,graph,graph-algorithms,graph-theory,header-only,library,mpi,parallel pushed_at:2022-09 star:0.3k fork:0.1k 🍇 A C++ library for parallel graph processing (GRAPE) 🍇
...
- [alibaba/PhotonLibOS](https://github.com/alibaba/PhotonLibOS) topic:asyncio,coroutine,cpp,fastest,fs-library,iouring,kernel-features,libos,linux,net-library pushed_at:2022-09 star:0.3k fork:0.0k Write fast and agile C++ programs with Photon!
...
- [alibaba/weex](https://github.com/alibaba/weex) topic:android,ios,mobile,sdk,web,weex pushed_at:2022-09 star:18.0k fork:2.2k A framework for building Mobile cross-platform UI
...
- [alibaba/flutter_boost](https://github.com/alibaba/flutter_boost) topic:android,dart,flutter,hybrid-app,hybrid-flutter,ios pushed_at:2022-08 star:6.2k fork:1.1k FlutterBoost is a Flutter plugin which enables hybrid integration of Flutter for your existing native apps with minimum efforts
...
- [alibaba/IOC-golang](https://github.com/alibaba/IOC-golang) topic:annotation,aop,debug,dependency-injection,golang,middleware,monkey,sdk,tag pushed_at:2022-08 star:0.9k fork:0.1k 一款服务于 Go 开发者的依赖注入框架，方便搭建任何 Go 应用。 A Golang depenedency injection framework, helps developers to build any go application.
...
- [alibaba/kt-connect](https://github.com/alibaba/kt-connect) topic:connect,developer-tools,exchage,istio,kubernetes,mesh,vpn pushed_at:2022-09 star:0.9k fork:0.2k A toolkit for Integrating with your kubernetes dev environment more efficiently
...
- [alibaba/RedisShake](https://github.com/alibaba/RedisShake) topic:redis,redis-cluster,redis-proxy pushed_at:2022-09 star:2.6k fork:0.5k redis-shake is a tool for Redis data migration and data filtering. redis-shake 是一个用于 Redis 数据迁移与过滤的工具。
...
- [alibaba/alibaba-rsocket-broker](https://github.com/alibaba/alibaba-rsocket-broker) topic:alibaba,broker,grpc,iot,rpc,rsocket,service-mesh pushed_at:2022-09 star:0.7k fork:0.1k Alibaba RSocket Broker: Mesh, Streaming & IoT
- [alibaba/alibabacloud-tairjedis-sdk](https://github.com/alibaba/alibabacloud-tairjedis-sdk) topic:module,redis,tair pushed_at:2022-09 star:0.1k fork:0.0k Based on Jedis that operates Tair For Redis Modules.
- [alibaba/Alink](https://github.com/alibaba/Alink) topic:apriori,classification,clustering,data-mining,feature-engineering,flink,flink-machine-learning,flink-ml,fm,graph-algorithms,graph-embedding,kafka,machine-learning,recommender,recommender-system,regression,statistics,word2vec,xgboost pushed_at:2022-09 star:3.2k fork:0.8k Alink is the Machine Learning algorithm platform based on Flink, developed by the PAI team of Alibaba computing platform. 
- [alibaba/AliOpen](https://github.com/alibaba/AliOpen) topic: pushed_at:2018-12 star:0.1k fork:0.0k 阿里巴巴开放平台
- [alibaba/aliyun-spring-boot](https://github.com/alibaba/aliyun-spring-boot) topic:aliyun,aliyun-oss,aliyun-rds,aliyun-redis,aliyun-schedulerx,aliyun-sms,spring-boot,spring-boot-starters pushed_at:2022-06 star:0.4k fork:0.1k Spring Boot Starters for Aliyun services
...
- [alibaba/arthas](https://github.com/alibaba/arthas) topic:agent,alibaba,arthas,classloader,diagnosis,java,jvm,trace,trouble-shooting pushed_at:2022-09 star:30.4k fork:6.6k Alibaba Java Diagnostic Tool Arthas/Alibaba Java诊断利器Arthas
...
- [alibaba/compileflow](https://github.com/alibaba/compileflow) topic:alibaba,bpmn2,compile,flow,halo-platform,java,process,process-engine,spring pushed_at:2022-09 star:1.1k fork:0.2k 🎨 core business process engine of Alibaba Halo platform, best process engine for trade scenes. | 一个高性能流程编排引擎
...
- [alibaba/easyexcel](https://github.com/alibaba/easyexcel) topic:excel,java,jxl,oom,poi,xls,xlsx pushed_at:2022-09 star:25.0k fork:6.6k 快速、简洁、解决大文件内存溢出的java处理Excel工具
...
- [alibaba/fastjson](https://github.com/alibaba/fastjson) topic:android,best-performance,deserialization,fastjson,java,json,json-parser,json-serialization,json-serializer,serialization pushed_at:2022-09 star:25.0k fork:6.5k A fast JSON parser/generator for Java.  
...
- [alibaba/GraphScope](https://github.com/alibaba/GraphScope) topic:graph,graph-analytics,graph-computation,graph-computing,graph-data,graph-neural-networks,gremlin pushed_at:2022-09 star:1.9k fork:0.2k 🔨 🍇 💻 🚀 GraphScope: A One-Stop Large-Scale Graph Computing System from Alibaba 来自阿里巴巴的一站式大规模图计算系统 图分析 图查询 图机器学习
...
- [alibaba/java-dns-cache-manipulator](https://github.com/alibaba/java-dns-cache-manipulator) topic:dns,dns-cache,dns-cache-manipulator,domain-name,hacking,hacking-code,integration-testing,java,jvm,testing,threadsafe,unit-testing pushed_at:2022-09 star:0.7k fork:0.2k 🌏 A tiny 0-dependency thread-safe Java™ lib for setting/viewing dns programmatically without touching host file, make unit/integration testing portable; and a tiny tool for setting/viewing dns of running JVM process.
...
- [alibaba/jvm-sandbox](https://github.com/alibaba/jvm-sandbox) topic: pushed_at:2022-09 star:5.1k fork:1.3k Real - time non-invasive AOP framework container based on JVM
...
- [alibaba/nacos](https://github.com/alibaba/nacos) topic:alibaba,config,configuration-management,distributed-configuration,dns,dubbo,istio,kubernetes,microservices,nacos,service-discovery,service-mesh,spring-cloud pushed_at:2022-09 star:23.9k fork:10.6k an easy-to-use dynamic service discovery, configuration and service management platform for building cloud native applications.
...
- [alibaba/rsqldb](https://github.com/alibaba/rsqldb) topic: pushed_at:2022-09 star:0.0k fork:0.0k 
...
- [alibaba/Sentinel](https://github.com/alibaba/Sentinel) topic:alibaba,circuit-breaker,hacktoberfest,java,microservice,rate-limiting,reliability pushed_at:2022-09 star:19.8k fork:7.2k A powerful flow control component enabling reliability, resilience and monitoring for microservices. (面向云原生微服务的高可用流控防护组件)
...
- [alibaba/SmartEngine](https://github.com/alibaba/SmartEngine) topic: pushed_at:2022-09 star:0.5k fork:0.2k SmartEngine is a lightweight business orchestration engine.
...
- [alibaba/spring-cloud-alibaba](https://github.com/alibaba/spring-cloud-alibaba) topic:alibaba,alibaba-middleware,alibaba-oss,aliyun,circuit-breaker,cloud-native,distributed-configuration,distributed-messaging,distributed-transaction,dubbo,java,microservices,nacos,rocketmq,service-discovery,service-registry,spring,spring-cloud,spring-cloud-alibaba,spring-cloud-core pushed_at:2022-09 star:23.6k fork:7.3k Spring Cloud Alibaba provides a one-stop solution for application development for the distributed solutions of Alibaba middleware.
...
- [alibaba/butterfly](https://github.com/alibaba/butterfly) topic:bpmn,butterfly,connectivity,dag,diagram,diagramming,edge,flow,flow-dag,flow-layout,flowchart,mindmap,react,svg,tree,treemap-diagram,vue pushed_at:2022-09 star:3.2k fork:0.5k 🦋Butterfly，A JavaScript/React/Vue2 Diagramming library which concentrate on flow layout field.    (基于JavaScript/React/Vue2的流程图组件)
...
- [alibaba/f2e-spec](https://github.com/alibaba/f2e-spec) topic:guidelines,linter,specification pushed_at:2022-09 star:0.4k fork:0.1k Alibaba Front-end Coding Guidelines and Relevant Tools
...
- [alibaba/lowcode-tools](https://github.com/alibaba/lowcode-tools) topic:alibaba,low-code,lowcode pushed_at:2022-09 star:0.0k fork:0.0k An enterprise-class low-code technology stack with scale-out design / 一套面向扩展设计的企业级低代码技术体系
...
- [alibaba/x-render](https://github.com/alibaba/x-render) topic:ant,ant-design,chart,form,formrender,javascript,json-schema,list,react,table,typescript,webpack,widget pushed_at:2022-09 star:5.0k fork:0.7k 🚴‍♀️ 阿里 - 很易用的中后台「表单 / 表格 / 图表」解决方案
...
- [alibaba/p3c](https://github.com/alibaba/p3c) topic: pushed_at:2022-07 star:28.2k fork:7.7k Alibaba Java Coding Guidelines pmd implements and IDE plugin
...
- [alibaba/netpila](https://github.com/alibaba/netpila) topic: pushed_at:2022-09 star:0.0k fork:0.0k 
...
- [alibaba/AliceMind](https://github.com/alibaba/AliceMind) topic:bert,deep-learning,natural-language-processing,nlp pushed_at:2022-09 star:1.3k fork:0.2k ALIbaba's Collection of Encoder-decoders from MinD (Machine IntelligeNce of Damo) Lab
...
- [alibaba/EasyCV](https://github.com/alibaba/EasyCV) topic:classification,computer-vision,object-detection,pytorch,self-supervised-learning,transformers,vision-transformer pushed_at:2022-09 star:1.0k fork:0.1k An all-in-one toolkit for computer vision
...
- [alibaba/EasyNLP](https://github.com/alibaba/EasyNLP) topic:bert,deep-learning,knowledge-pretrain,nlp,pretrained-models,pytorch,transformers pushed_at:2022-09 star:1.0k fork:0.1k EasyNLP: A Comprehensive and Easy-to-use NLP Toolkit
...
- [alibaba/EssentialMC2](https://github.com/alibaba/EssentialMC2) topic: pushed_at:2022-09 star:0.1k fork:0.0k EssentialMC2 Video Understanding.
...
- [alibaba/FederatedScope](https://github.com/alibaba/FederatedScope) topic:federated-learning,machine-learning,pytorch pushed_at:2022-09 star:0.7k fork:0.1k An easy-to-use federated learning platform
...
- [alibaba/font-toolkit](https://github.com/alibaba/font-toolkit) topic: pushed_at:2022-09 star:0.1k fork:0.0k A Rust 🦀️ font loading, positioning and rendering toolkit
...
- [alibaba/canvas-ui](https://github.com/alibaba/canvas-ui) topic:canvas,react,typescript pushed_at:2022-09 star:0.1k fork:0.0k UI Renderer runs on top of the HTML5 Canvas
...
- [alibaba/form-driver](https://github.com/alibaba/form-driver) topic: pushed_at:2022-09 star:0.0k fork:0.0k 
...
- [alibaba/hooks](https://github.com/alibaba/hooks) topic:ahooks,hooks-library,react,react-hooks,umi-hooks pushed_at:2022-09 star:10.3k fork:1.9k A high-quality & reliable React Hooks library.
...
- [alibaba/lowcode-demo](https://github.com/alibaba/lowcode-demo) topic:alibaba,low-code,lowcode pushed_at:2022-09 star:0.7k fork:0.3k An enterprise-class low-code technology stack with scale-out design / 一套面向扩展设计的企业级低代码技术体系
...
- [alibaba/lowcode-materials](https://github.com/alibaba/lowcode-materials) topic:alibaba,low-code,lowcode pushed_at:2022-09 star:0.1k fork:0.1k An enterprise-class low-code technology stack with scale-out design / 一套面向扩展设计的企业级低代码技术体系
...
- [alibaba/pont](https://github.com/alibaba/pont) topic:mock-data,pont,swagger,typescript pushed_at:2022-09 star:2.7k fork:0.2k 🌉数据服务层解决方案
...
- [alibaba/spatial-data-vis-framework](https://github.com/alibaba/spatial-data-vis-framework) topic:3d,gis,web3d,webgis pushed_at:2022-09 star:0.0k fork:0.0k Layered Spatial Data Vis Framework
