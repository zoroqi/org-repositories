...
- [alibaba/SiliconFastOS](https://github.com/alibaba/SiliconFastOS) topic: pushed_at:2022-10 star:0.0k fork:0.0k 
...
- [alibaba/libgrape-lite](https://github.com/alibaba/libgrape-lite) topic:cxx,gnn,gpu,grape,graph,graph-algorithms,graph-theory,header-only,library,mpi,parallel pushed_at:2022-10 star:0.3k fork:0.1k 🍇 A C++ library for parallel graph processing (GRAPE) 🍇
...
- [alibaba/yalantinglibs](https://github.com/alibaba/yalantinglibs) topic: pushed_at:2022-10 star:0.1k fork:0.0k A collection of C++20 libraries, include async_simple, coro_rpc and struct_pack
...
- [alibaba/open-object](https://github.com/alibaba/open-object) topic: pushed_at:2022-10 star:0.0k fork:0.0k 
...
- [alibaba/sentinel-golang](https://github.com/alibaba/sentinel-golang) topic:cloud-native,microservice,rate-limiting,resiliency pushed_at:2022-10 star:2.2k fork:0.4k Sentinel Go version (Reliability & Resilience)
...
- [alibaba/ARouter](https://github.com/alibaba/ARouter) topic:android,componentization,dependency-injection,interceptor,navigation,router pushed_at:2022-10 star:14.0k fork:2.5k 💪 A framework for assisting in the renovation of Android componentization (帮助 Android App 进行组件化改造的路由框架)
- [alibaba/arthas](https://github.com/alibaba/arthas) topic:agent,alibaba,arthas,classloader,diagnosis,java,jvm,trace,trouble-shooting pushed_at:2022-10 star:30.9k fork:6.7k Alibaba Java Diagnostic Tool Arthas/Alibaba Java诊断利器Arthas
...
- [alibaba/celeborn](https://github.com/alibaba/celeborn) topic:big-data,shuffle,spark pushed_at:2022-10 star:0.3k fork:0.1k Celeborn provides an elastic and high-performance service for shuffle and spilled data.
...
- [alibaba/dragonwell17](https://github.com/alibaba/dragonwell17) topic: pushed_at:2022-10 star:0.2k fork:0.0k Alibaba Dragonwell17 JDK
...
- [alibaba/druid](https://github.com/alibaba/druid) topic: pushed_at:2022-10 star:26.2k fork:8.3k 阿里云计算平台DataWorks(https://help.aliyun.com/document_detail/137663.html) 团队出品，为监控而生的数据库连接池
...
- [alibaba/fastjson](https://github.com/alibaba/fastjson) topic:android,best-performance,deserialization,fastjson,java,json,json-parser,json-serialization,json-serializer,serialization pushed_at:2022-10 star:25.1k fork:6.5k FASTJSON 2.0.x has been released, faster and more secure, recommend you upgrade.
...
- [alibaba/jetcache](https://github.com/alibaba/jetcache) topic:cache,java,jcache,redis,spring,spring-cache pushed_at:2022-10 star:3.6k fork:0.9k JetCache is a Java cache framework.
...
- [alibaba/nacos](https://github.com/alibaba/nacos) topic:alibaba,config,configuration-management,distributed-configuration,dns,dubbo,istio,kubernetes,microservices,nacos,service-discovery,service-mesh,spring-cloud pushed_at:2022-10 star:24.4k fork:10.8k an easy-to-use dynamic service discovery, configuration and service management platform for building cloud native applications.
...
- [alibaba/Sentinel](https://github.com/alibaba/Sentinel) topic:alibaba,circuit-breaker,hacktoberfest,java,microservice,rate-limiting,reliability pushed_at:2022-10 star:20.1k fork:7.3k A powerful flow control component enabling reliability, resilience and monitoring for microservices. (面向云原生微服务的高可用流控防护组件)
...
- [alibaba/spring-cloud-alibaba](https://github.com/alibaba/spring-cloud-alibaba) topic:alibaba,alibaba-middleware,alibaba-oss,aliyun,circuit-breaker,cloud-native,distributed-configuration,distributed-messaging,distributed-transaction,dubbo,java,microservices,nacos,rocketmq,service-discovery,service-registry,spring,spring-cloud,spring-cloud-alibaba,spring-cloud-core pushed_at:2022-10 star:24.0k fork:7.4k Spring Cloud Alibaba provides a one-stop solution for application development for the distributed solutions of Alibaba middleware.
...
- [alibaba/SREWorks](https://github.com/alibaba/SREWorks) topic:aiops,application,cloud-native,cloudnative,dataops,devops,engineering,k8s,kubernetes,maintenance,oam,operation,ops,saas,sre pushed_at:2022-10 star:1.1k fork:0.2k Cloud Native DataOps & AIOps Platform | 云原生数智运维平台 
...
- [alibaba/f2e-spec](https://github.com/alibaba/f2e-spec) topic:guidelines,linter,specification pushed_at:2022-09 star:0.5k fork:0.1k Alibaba Front-end Coding Guidelines and Relevant Tools
...
- [alibaba/ai-matrix](https://github.com/alibaba/ai-matrix) topic: pushed_at:2022-10 star:0.2k fork:0.1k To make it easy to benchmark AI accelerators
...
- [alibaba/p3c](https://github.com/alibaba/p3c) topic: pushed_at:2022-09 star:28.4k fork:7.8k Alibaba Java Coding Guidelines pmd implements and IDE plugin
...
- [alibaba/higress](https://github.com/alibaba/higress) topic: pushed_at:2022-10 star:0.0k fork:0.0k 
...
- [alibaba/Elastic-Federated-Learning-Solution](https://github.com/alibaba/Elastic-Federated-Learning-Solution) topic: pushed_at:2022-10 star:0.1k fork:0.0k 
...
- [alibaba/FederatedScope](https://github.com/alibaba/FederatedScope) topic:federated-learning,machine-learning,pytorch pushed_at:2022-10 star:0.8k fork:0.1k An easy-to-use federated learning platform
...
- [alibaba/HybridBackend](https://github.com/alibaba/HybridBackend) topic:deep-learning,gpu,hybrid-parallelism,parquet,recommender-system pushed_at:2022-10 star:0.1k fork:0.0k A high-performance framework for training wide-and-deep recommender systems on heterogeneous cluster
...
- [alibaba/designable](https://github.com/alibaba/designable) topic:builder,designable,designer,editor,form,react pushed_at:2022-09 star:2.4k fork:0.4k 🧩 Make everything designable 🧩 
...
- [alibaba/hooks](https://github.com/alibaba/hooks) topic:ahooks,hooks-library,react,react-hooks,umi-hooks pushed_at:2022-10 star:10.7k fork:1.9k A high-quality & reliable React Hooks library.
...
- [alibaba/lowcode-demo](https://github.com/alibaba/lowcode-demo) topic:alibaba,low-code,lowcode pushed_at:2022-10 star:0.8k fork:0.3k An enterprise-class low-code technology stack with scale-out design / 一套面向扩展设计的企业级低代码技术体系
