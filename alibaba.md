...
- [alibaba/GaiaX](https://github.com/alibaba/GaiaX) topic:android,cross-platform,css,flexbox,ios,kotlin,rust,swift pushed_at:2023-12 star:1.1k fork:0.1k 动态模板引擎是一套轻量化、跨平台、高性能的纯原生移动端卡片渲染动态化解决方案
...
- [alibaba/kubeskoop](https://github.com/alibaba/kubeskoop) topic: pushed_at:2023-11 star:0.4k fork:0.0k 
...
- [alibaba/xquic](https://github.com/alibaba/xquic) topic:http3,ietf,protocol,quic,tls13 pushed_at:2023-12 star:1.6k fork:0.3k XQUIC Library released by Alibaba is a cross-platform implementation of QUIC and HTTP/3 protocol.
...
- [alibaba/async_simple](https://github.com/alibaba/async_simple) topic:asynchronous,coroutines,cpp20,modules pushed_at:2023-12 star:1.3k fork:0.2k Simple, light-weight and easy-to-use asynchronous components 
- [alibaba/BladeDISC](https://github.com/alibaba/BladeDISC) topic:compiler,deep-learning,inference-optimization,machine-learning,mlir,neural-network,pytorch,tensorflow pushed_at:2023-12 star:0.7k fork:0.2k BladeDISC is an end-to-end DynamIc Shape Compiler project for machine learning workloads.
...
- [alibaba/GraphAr](https://github.com/alibaba/GraphAr) topic:big-data,data-orchestration,etl,graph,graph-analysis,graph-storage pushed_at:2023-12 star:0.1k fork:0.0k An open source, standard data file format for graph data storage and retrieval
- [alibaba/GraphScope](https://github.com/alibaba/GraphScope) topic:analytics,big-data,data-science,graph,graph-analytics,graph-computation,graph-computing,graph-data,graph-neural-networks,gremlin pushed_at:2023-12 star:3.0k fork:0.5k 🔨 🍇 💻 🚀 GraphScope: A One-Stop Large-Scale Graph Computing System from Alibaba 来自阿里巴巴的一站式大规模图计算系统 图分析 图查询 图机器学习
- [alibaba/havenask](https://github.com/alibaba/havenask) topic: pushed_at:2023-12 star:1.3k fork:0.3k 
...
- [alibaba/ilogtail](https://github.com/alibaba/ilogtail) topic:aliyun,apm,cloud-native,ebpf,observability,sls pushed_at:2023-12 star:1.4k fork:0.3k Fast and Lightweight Observability Data Collector
...
- [alibaba/libgrape-lite](https://github.com/alibaba/libgrape-lite) topic:cxx,gnn,gpu,grape,graph,graph-algorithms,graph-theory,header-only,library,mpi,parallel pushed_at:2023-12 star:0.3k fork:0.1k 🍇 A C++ library for parallel graph processing (GRAPE) 🍇
...
- [alibaba/PhotonLibOS](https://github.com/alibaba/PhotonLibOS) topic:async-io,coroutine,cpp,fs-library,iouring,kernel-features,libos,net-library,posix,std pushed_at:2023-12 star:0.7k fork:0.1k Probably the fastest coroutine lib of the world
...
- [alibaba/rtp-llm](https://github.com/alibaba/rtp-llm) topic: pushed_at:2023-12 star:0.0k fork:0.0k 
...
- [alibaba/yalantinglibs](https://github.com/alibaba/yalantinglibs) topic: pushed_at:2023-12 star:1.1k fork:0.2k A collection of modern C++ libraries, include coro_rpc, struct_pack, struct_json, struct_xml, struct_pb, easylog, async_simple
...
- [alibaba/flutter_boost](https://github.com/alibaba/flutter_boost) topic:android,dart,flutter,hybrid-app,hybrid-flutter,ios pushed_at:2023-12 star:6.7k fork:1.2k FlutterBoost is a Flutter plugin which enables hybrid integration of Flutter for your existing native apps with minimum efforts
...
- [alibaba/higress](https://github.com/alibaba/higress) topic:gateway,gateway-api,ingress,ingress-controller,microservice pushed_at:2023-12 star:2.0k fork:0.3k Next-generation Cloud Native Gateway | 下一代云原生网关
...
- [alibaba/open-local](https://github.com/alibaba/open-local) topic:cloud-native,csi,kubernetes,localstorage,low-latency,lvm,snapshot,stateful-workloads,storage pushed_at:2023-12 star:0.4k fork:0.1k cloud-native local storage management system for stateful workload, low-latency with simplicity
...
- [alibaba/pairec](https://github.com/alibaba/pairec) topic:go,http-api,recommend pushed_at:2023-12 star:0.0k fork:0.0k A Go web framework for quickly building recommendation online services based on JSON configuration.
...
- [alibaba/schedulerx-worker-go](https://github.com/alibaba/schedulerx-worker-go) topic:aliyun,cronjob,golang,scheduler pushed_at:2023-12 star:0.0k fork:0.0k schedulerx-worker-go is the Golang SDK of SchedulerX
...
- [alibaba/arthas](https://github.com/alibaba/arthas) topic:agent,alibaba,arthas,classloader,diagnosis,java,jvm,trace,trouble-shooting pushed_at:2023-12 star:34.0k fork:7.3k Alibaba Java Diagnostic Tool Arthas/Alibaba Java诊断利器Arthas
...
- [alibaba/canal](https://github.com/alibaba/canal) topic: pushed_at:2023-12 star:27.2k fork:7.5k 阿里巴巴 MySQL binlog 增量订阅&消费组件 
...
- [alibaba/COLA](https://github.com/alibaba/COLA) topic:architecture,clean,cola pushed_at:2023-12 star:10.8k fork:2.9k 🥤 COLA: Clean Object-oriented & Layered Architecture
- [alibaba/compileflow](https://github.com/alibaba/compileflow) topic:alibaba,bpmn2,compile,flow,halo-platform,java,process,process-engine,spring pushed_at:2023-08 star:1.6k fork:0.3k 🎨 core business process engine of Alibaba Halo platform, best process engine for trade scenes. | 一个高性能流程编排引擎
...
- [alibaba/DataX](https://github.com/alibaba/DataX) topic: pushed_at:2023-12 star:14.6k fork:5.2k DataX是阿里云DataWorks数据集成的开源版本。
...
- [alibaba/druid](https://github.com/alibaba/druid) topic: pushed_at:2023-12 star:27.5k fork:8.6k 阿里云计算平台DataWorks(https://help.aliyun.com/document_detail/137663.html) 团队出品，为监控而生的数据库连接池
...
- [alibaba/easyexcel](https://github.com/alibaba/easyexcel) topic:excel,java,jxl,oom,poi,xls,xlsx pushed_at:2023-12 star:30.1k fork:7.4k 快速、简洁、解决大文件内存溢出的java处理Excel工具
- [alibaba/fast-modeling-language](https://github.com/alibaba/fast-modeling-language) topic:aliyun,dataworks,fastmodel,fml,java pushed_at:2023-12 star:0.0k fork:0.0k 阿里云计算平台DataWorks(https://help.aliyun.com/document_detail/276018.html) 团队出品，快速建模语言
...
- [alibaba/havenask-federation](https://github.com/alibaba/havenask-federation) topic: pushed_at:2023-12 star:0.0k fork:0.0k 
...
- [alibaba/java-dns-cache-manipulator](https://github.com/alibaba/java-dns-cache-manipulator) topic:dns,dns-cache,dns-cache-manipulator,domain-name,hacking,hacking-code,integration-testing,java,jvm,testing,threadsafe,unit-testing pushed_at:2023-12 star:0.8k fork:0.2k 🌏 A tiny 0-dependency thread-safe Java™ lib for setting/viewing dns programmatically without touching host file, make unit/integration testing portable; and a tiny tool for setting/viewing dns of running JVM process.
- [alibaba/jetcache](https://github.com/alibaba/jetcache) topic:cache,java,jcache,redis,spring,spring-cache pushed_at:2023-12 star:4.5k fork:1.0k JetCache is a Java cache framework.
...
- [alibaba/nacos](https://github.com/alibaba/nacos) topic:alibaba,config,configuration-management,distributed-configuration,dns,dubbo,istio,kubernetes,microservices,nacos,service-discovery,service-mesh,spring-cloud pushed_at:2023-12 star:28.2k fork:12.4k an easy-to-use dynamic service discovery, configuration and service management platform for building cloud native applications.
...
- [alibaba/QLExpress](https://github.com/alibaba/QLExpress) topic: pushed_at:2023-12 star:4.4k fork:1.1k QLExpress is a powerful, lightweight, dynamic language for the Java platform aimed at improving developers’ productivity in different business scenes.
...
- [alibaba/Sentinel](https://github.com/alibaba/Sentinel) topic:alibaba,circuit-breaker,cloud-native,java,microservice,microservices,rate-limiting,reliability,resiliency pushed_at:2023-12 star:21.7k fork:7.9k A powerful flow control component enabling reliability, resilience and monitoring for microservices. (面向云原生微服务的高可用流控防护组件)
...
- [alibaba/spring-cloud-alibaba](https://github.com/alibaba/spring-cloud-alibaba) topic:alibaba,alibaba-middleware,alibaba-oss,aliyun,circuit-breaker,cloud-native,distributed-configuration,distributed-messaging,distributed-transaction,dubbo,java,microservices,nacos,rocketmq,service-discovery,service-registry,spring,spring-cloud,spring-cloud-alibaba,spring-cloud-core pushed_at:2023-12 star:26.8k fork:8.2k Spring Cloud Alibaba provides a one-stop solution for application development for the distributed solutions of Alibaba middleware.
...
- [alibaba/lowcode-tools](https://github.com/alibaba/lowcode-tools) topic:alibaba,low-code,lowcode pushed_at:2023-10 star:0.1k fork:0.1k An enterprise-class low-code technology stack with scale-out design / 一套面向扩展设计的企业级低代码技术体系
...
- [alibaba/p3c](https://github.com/alibaba/p3c) topic: pushed_at:2023-08 star:29.9k fork:8.1k Alibaba Java Coding Guidelines pmd implements and IDE plugin
...
- [alibaba/graph-gpt](https://github.com/alibaba/graph-gpt) topic: pushed_at:2023-10 star:0.0k fork:0.0k 
...
- [alibaba/animate-anything](https://github.com/alibaba/animate-anything) topic:animation,video-diffusion-model,video-generation pushed_at:2023-12 star:0.2k fork:0.0k Fine-Grained Open Domain Image Animation with Motion Guidance
...
- [alibaba/data-juicer](https://github.com/alibaba/data-juicer) topic:chinese,data-analysis,data-science,data-visualization,dataset,gpt,gpt-4,instruction-tuning,large-language-models,llama,llm,llms,machine-learning,multi-modal,nlp,opendata,pre-training,pytorch,streamlit pushed_at:2023-12 star:0.8k fork:0.0k A one-stop data processing system to make data higher-quality, juicier, and more digestible for LLMs!  🍎 🍋 🌽 ➡️ ➡️🍸 🍹 🍷为大语言模型提供更高质量、更丰富、更易”消化“的数据！
...
- [alibaba/EasyCV](https://github.com/alibaba/EasyCV) topic:classification,computer-vision,object-detection,pytorch,self-supervised-learning,transformers,vision-transformer pushed_at:2023-11 star:1.6k fork:0.2k An all-in-one toolkit for computer vision
...
- [alibaba/easydist](https://github.com/alibaba/easydist) topic:automatic-parallelization,deep-learning,diffusion-models,distributed-computing,graph-neural-networks,high-performance-computing,large-language-models,llama,llm,machine-learning pushed_at:2023-12 star:0.1k fork:0.0k Automated Parallelization System and Infrastructure for Multiple Ecosystems
- [alibaba/EasyNLP](https://github.com/alibaba/EasyNLP) topic:bert,deep-learning,fewshot-learning,knowledge-distillation,knowledge-pretraining,machine-learning,nlp,pretrained-models,pytorch,text-classification,text-image-retrieval,text-to-image-synthesis,transfer-learning,transformers pushed_at:2023-10 star:1.9k fork:0.2k EasyNLP: A Comprehensive and Easy-to-use NLP Toolkit
...
- [alibaba/graphlearn-for-pytorch](https://github.com/alibaba/graphlearn-for-pytorch) topic:deep-learning,distributed,gpu,graph-neural-networks,pytorch pushed_at:2023-12 star:0.1k fork:0.0k A GPU-accelerated graph learning library for PyTorch, facilitating the scaling of GNN training and inference.
...
- [alibaba/LucaProt](https://github.com/alibaba/LucaProt) topic: pushed_at:2023-12 star:0.0k fork:0.0k LucaProt: A novel deep learning framework that incorporates protein amino acid sequence and structure information to predict protein function.
- [alibaba/Megatron-LLaMA](https://github.com/alibaba/Megatron-LLaMA) topic:deepspeed,distributed-training,llama,llm,megatron-lm,pretraining,pytorch pushed_at:2023-12 star:0.5k fork:0.0k Best practice for training LLaMA models in Megatron-LM
...
- [alibaba/Pai-Megatron-Patch](https://github.com/alibaba/Pai-Megatron-Patch) topic: pushed_at:2023-12 star:0.3k fork:0.0k The official repo of Pai-Megatron-Patch for LLM & VLM large scale training developed by Alibaba Cloud.
- [alibaba/pilotscope](https://github.com/alibaba/pilotscope) topic:ai4db,cardinality-estimation,database,index-recommendation,knob-tuning,middleware,postgresql,query-optimizer,spark pushed_at:2023-12 star:0.1k fork:0.0k PilotScope is a middleware to bridge the gaps of deploying AI4DB (Artificial Intelligence for Databases) algorithms into actual database systems.
...
- [alibaba/font-toolkit](https://github.com/alibaba/font-toolkit) topic: pushed_at:2023-10 star:0.1k fork:0.0k A Rust 🦀️ font loading, positioning and rendering toolkit
...
- [alibaba/aliyunpan-ios-sdk](https://github.com/alibaba/aliyunpan-ios-sdk) topic: pushed_at:2023-12 star:0.0k fork:0.0k 阿里云盘 OpenSDK-iOS
...
- [alibaba/ali-react-table](https://github.com/alibaba/ali-react-table) topic:react,react-table,table pushed_at:2023-03 star:0.9k fork:0.3k Performent, flexible and modern React table component.
...
- [alibaba/ChatUI](https://github.com/alibaba/ChatUI) topic:chat,chatbot,react,ui pushed_at:2023-12 star:2.3k fork:0.2k The UI design language and React library for Conversational UI
- [alibaba/cloud-charts](https://github.com/alibaba/cloud-charts) topic: pushed_at:2023-12 star:0.5k fork:0.1k 开箱即用的前端图表库，简单配置就能拥有漂亮的可视化图表
...
- [alibaba/formily](https://github.com/alibaba/formily) topic:ant-design,designable,form,form-builder,fusion,json-schema,json-schema-form,low-code,no-code,observable,react,react-form,react-native,reactive,schema-form,validator,vue,vue-form,vue3 pushed_at:2023-12 star:10.4k fork:1.4k 📱🚀 🧩 Cross Device & High Performance Normal Form/Dynamic(JSON Schema) Form/Form Builder -- Support React/React Native/Vue 2/Vue 3
...
- [alibaba/hooks](https://github.com/alibaba/hooks) topic:ahooks,hooks-library,react,react-hooks,umi-hooks pushed_at:2023-12 star:12.9k fork:2.5k A high-quality & reliable React Hooks library.
- [alibaba/ice](https://github.com/alibaba/ice) topic:framework,icejs,microfrontends,mpa,nodejs,react,react-router,serverless,spa,ssr,typescript,vite,webpack pushed_at:2023-12 star:17.7k fork:2.1k 🚀 ice.js: The Progressive App Framework Based On React（基于 React 的渐进式应用框架）
...
- [alibaba/lowcode-demo](https://github.com/alibaba/lowcode-demo) topic:alibaba,low-code,lowcode pushed_at:2023-12 star:1.4k fork:0.5k An enterprise-class low-code technology stack with scale-out design / 一套面向扩展设计的企业级低代码技术体系
- [alibaba/lowcode-engine](https://github.com/alibaba/lowcode-engine) topic:alibaba,low-code,lowcode pushed_at:2023-12 star:12.8k fork:2.3k An enterprise-class low-code technology stack with scale-out design / 一套面向扩展设计的企业级低代码技术体系
- [alibaba/lowcode-engine-ext](https://github.com/alibaba/lowcode-engine-ext) topic:alibaba,low-code,lowcode pushed_at:2023-12 star:0.1k fork:0.1k An enterprise-class low-code technology stack with scale-out design / 一套面向扩展设计的企业级低代码技术体系
...
- [alibaba/lowcode-plugins](https://github.com/alibaba/lowcode-plugins) topic:alibaba,low-code,lowcode pushed_at:2023-12 star:0.2k fork:0.1k An enterprise-class low-code technology stack with scale-out design / 一套面向扩展设计的企业级低代码技术体系
...
- [alibaba/x-render](https://github.com/alibaba/x-render) topic:ant,ant-design,chart,form,formrender,javascript,json-schema,list,react,table,typescript,webpack,widget pushed_at:2023-12 star:6.6k fork:0.9k 🚴‍♀️ 阿里 - 很易用的中后台「表单 / 表格 / 图表」解决方案
