...
- [alibaba/pemja](https://github.com/alibaba/pemja) topic: pushed_at:2022-09 star:0.1k fork:0.0k 
...
- [alibaba/TairHash](https://github.com/alibaba/TairHash) topic:expiration,hash,module,redis,version pushed_at:2022-09 star:0.2k fork:0.0k A redis module, similar to redis hash, but you can set expiration and version for field
...
- [alibaba/TairZset](https://github.com/alibaba/TairZset) topic:module,multiple-scores,redis,zset pushed_at:2022-08 star:0.1k fork:0.0k A redis module, similar to redis zset, but you can set multiple scores for each member to support multi-dimensional sorting
...
- [alibaba/xquic](https://github.com/alibaba/xquic) topic:http3,ietf,protocol,quic,tls13 pushed_at:2022-08 star:1.3k fork:0.2k XQUIC Library released by Alibaba is a cross-platform implementation of QUIC and HTTP/3 protocol.
...
- [alibaba/BladeDISC](https://github.com/alibaba/BladeDISC) topic:compiler,deep-learning,inference-optimization,machine-learning,mlir,neural-network,pytorch,tensorflow pushed_at:2022-09 star:0.5k fork:0.1k BladeDISC is an end-to-end DynamIc Shape Compiler project for machine learning workloads.
...
- [alibaba/IOC-golang](https://github.com/alibaba/IOC-golang) topic:annotation,aop,debug,dependency-injection,golang,middleware,monkey,sdk,tag pushed_at:2022-09 star:0.9k fork:0.1k 一款服务于 Go 开发者的依赖注入框架，方便搭建任何 Go 应用。 A Golang depenedency injection framework, helps developers to build any go application.
...
- [alibaba/pouch](https://github.com/alibaba/pouch) topic:cloud-native,containers,efficiency,go,isolation,kubernetes,oci,package,security pushed_at:2022-09 star:4.5k fork:1.0k An Efficient Enterprise-class Container Engine
...
- [alibaba/sentinel-golang](https://github.com/alibaba/sentinel-golang) topic:cloud-native,microservice,rate-limiting,resiliency pushed_at:2022-09 star:2.1k fork:0.4k Sentinel Go version (Reliability & Resilience)
...
- [alibaba/ARouter](https://github.com/alibaba/ARouter) topic:android,componentization,dependency-injection,interceptor,navigation,router pushed_at:2022-07 star:14.0k fork:2.5k 💪 A framework for assisting in the renovation of Android componentization (帮助 Android App 进行组件化改造的路由框架)
- [alibaba/arthas](https://github.com/alibaba/arthas) topic:agent,alibaba,arthas,classloader,diagnosis,java,jvm,trace,trouble-shooting pushed_at:2022-09 star:30.5k fork:6.7k Alibaba Java Diagnostic Tool Arthas/Alibaba Java诊断利器Arthas
...
- [alibaba/canal](https://github.com/alibaba/canal) topic: pushed_at:2022-09 star:24.1k fork:6.9k 阿里巴巴 MySQL binlog 增量订阅&消费组件 
...
- [alibaba/COLA](https://github.com/alibaba/COLA) topic:architecture,clean,cola pushed_at:2022-09 star:8.4k fork:2.3k 🥤 COLA: Clean Object-oriented & Layered Architecture
- [alibaba/compileflow](https://github.com/alibaba/compileflow) topic:alibaba,bpmn2,compile,flow,halo-platform,java,process,process-engine,spring pushed_at:2022-09 star:1.2k fork:0.2k 🎨 core business process engine of Alibaba Halo platform, best process engine for trade scenes. | 一个高性能流程编排引擎
...
- [alibaba/DataX](https://github.com/alibaba/DataX) topic: pushed_at:2022-09 star:12.0k fork:4.3k DataX是阿里云DataWorks数据集成的开源版本。
...
- [alibaba/easyexcel](https://github.com/alibaba/easyexcel) topic:excel,java,jxl,oom,poi,xls,xlsx pushed_at:2022-09 star:25.2k fork:6.7k 快速、简洁、解决大文件内存溢出的java处理Excel工具
...
- [alibaba/nacos](https://github.com/alibaba/nacos) topic:alibaba,config,configuration-management,distributed-configuration,dns,dubbo,istio,kubernetes,microservices,nacos,service-discovery,service-mesh,spring-cloud pushed_at:2022-09 star:24.0k fork:10.7k an easy-to-use dynamic service discovery, configuration and service management platform for building cloud native applications.
...
- [alibaba/otter](https://github.com/alibaba/otter) topic: pushed_at:2022-07 star:7.4k fork:2.5k 阿里巴巴分布式数据库同步系统(解决中美异地机房)
...
- [alibaba/QLExpress](https://github.com/alibaba/QLExpress) topic: pushed_at:2022-09 star:3.7k fork:1.0k QLExpress is a powerful, lightweight, dynamic language for the Java platform aimed at improving developers’ productivity in different business scenes.
...
- [alibaba/Sentinel](https://github.com/alibaba/Sentinel) topic:alibaba,circuit-breaker,hacktoberfest,java,microservice,rate-limiting,reliability pushed_at:2022-09 star:19.9k fork:7.2k A powerful flow control component enabling reliability, resilience and monitoring for microservices. (面向云原生微服务的高可用流控防护组件)
...
- [alibaba/spring-cloud-alibaba](https://github.com/alibaba/spring-cloud-alibaba) topic:alibaba,alibaba-middleware,alibaba-oss,aliyun,circuit-breaker,cloud-native,distributed-configuration,distributed-messaging,distributed-transaction,dubbo,java,microservices,nacos,rocketmq,service-discovery,service-registry,spring,spring-cloud,spring-cloud-alibaba,spring-cloud-core pushed_at:2022-09 star:23.7k fork:7.3k Spring Cloud Alibaba provides a one-stop solution for application development for the distributed solutions of Alibaba middleware.
...
- [alibaba/SREWorks](https://github.com/alibaba/SREWorks) topic:aiops,application,cloud-native,cloudnative,dataops,devops,engineering,k8s,kubernetes,maintenance,oam,operation,ops,saas,sre pushed_at:2022-09 star:1.0k fork:0.2k Cloud Native DataOps & AIOps Platform | 云原生数智运维平台 
...
- [alibaba/dawn](https://github.com/alibaba/dawn) topic:build,build-tool,construction,dawn,dawn-cli,front-end,javascript,middleware,nodejs,pack,pipeline,task pushed_at:2022-09 star:1.1k fork:0.1k :sunrise: Dawn is a lightweight task management and build tool for front-end and nodejs. 
...
- [alibaba/clusterdata](https://github.com/alibaba/clusterdata) topic:dataset pushed_at:2022-09 star:1.1k fork:0.3k cluster data collected from production clusters in Alibaba for cluster management research
...
- [alibaba/alibaba-centralized-mesh-gateway](https://github.com/alibaba/alibaba-centralized-mesh-gateway) topic: pushed_at:2022-09 star:0.0k fork:0.0k 
...
- [alibaba/EasyCV](https://github.com/alibaba/EasyCV) topic:classification,computer-vision,object-detection,pytorch,self-supervised-learning,transformers,vision-transformer pushed_at:2022-09 star:1.1k fork:0.1k An all-in-one toolkit for computer vision
...
- [alibaba/EasyParallelLibrary](https://github.com/alibaba/EasyParallelLibrary) topic:data-parallelism,deep-learning,distributed-training,gpu,memory-efficient,model-parallelism,pipeline-parallelism pushed_at:2022-09 star:0.2k fork:0.0k Easy Parallel Library (EPL) is a general and efficient deep learning framework for distributed model training.
...
- [alibaba/easyrobust](https://github.com/alibaba/easyrobust) topic:adversarial-robustness,deep-learning,image-classification,imagenet,pretrained-models,robustness pushed_at:2022-09 star:0.1k fork:0.0k EasyRobust: an Easy-to-use library for state-of-the-art Robust Computer Vision Research with PyTorch.
...
- [alibaba/feathub](https://github.com/alibaba/feathub) topic:apache-flink,data-engineering,data-science,feature-engineering,feature-store,machine-learning pushed_at:2022-09 star:0.0k fork:0.0k FeatHub - A stream-batch unified feature store for real-time machine learning
...
- [alibaba/tair-py](https://github.com/alibaba/tair-py) topic: pushed_at:2022-09 star:0.0k fork:0.0k A Python client of Tair based on redis-py
- [alibaba/taobao-iphone-device](https://github.com/alibaba/taobao-iphone-device) topic:ios,iphone,usbmuxd,wda pushed_at:2022-08 star:1.7k fork:0.3k  tidevice can be used to communicate with iPhone device
...
- [alibaba/GaiaX](https://github.com/alibaba/GaiaX) topic:android,cross-platform,css,flexbox,ios,kotlin,rust,swift pushed_at:2022-09 star:0.7k fork:0.1k GaiaX动态模板引擎是一套轻量化、跨平台、高性能的纯原生移动端卡片渲染动态化解决方案
...
- [alibaba/ChatUI](https://github.com/alibaba/ChatUI) topic:chat,chatbot,react,ui pushed_at:2022-09 star:1.5k fork:0.1k The UI design language and React library for Conversational UI
- [alibaba/cloud-charts](https://github.com/alibaba/cloud-charts) topic: pushed_at:2022-09 star:0.4k fork:0.1k 开箱即用的前端图表库，简单配置就能拥有漂亮的可视化图表
...
- [alibaba/designable](https://github.com/alibaba/designable) topic:builder,designable,designer,editor,form,react pushed_at:2022-09 star:2.3k fork:0.4k 🧩 Make everything designable 🧩 
- [alibaba/form-driver](https://github.com/alibaba/form-driver) topic: pushed_at:2022-09 star:0.0k fork:0.0k 
- [alibaba/formily](https://github.com/alibaba/formily) topic:ant-design,designable,form,form-builder,fusion,json-schema,json-schema-form,low-code,no-code,observable,react,react-form,react-native,reactive,schema-form,validator,vue,vue-form,vue3 pushed_at:2022-09 star:8.5k fork:1.2k 📱🚀 🧩 Cross Device & High Performance Normal Form/Dynamic(JSON Schema) Form/Form Builder -- Support React/React Native/Vue 2/Vue 3
...
- [alibaba/hooks](https://github.com/alibaba/hooks) topic:ahooks,hooks-library,react,react-hooks,umi-hooks pushed_at:2022-09 star:10.4k fork:1.9k A high-quality & reliable React Hooks library.
...
- [alibaba/kiwi](https://github.com/alibaba/kiwi) topic:g11n,i18n,intl,translation,typescript pushed_at:2022-09 star:2.1k fork:0.2k 🐤 Kiwi-国际化翻译全流程解决方案
- [alibaba/lightproxy](https://github.com/alibaba/lightproxy) topic:chrome,debug,devtools,electron,light,lightproxy,proxy,typescript,whistle pushed_at:2022-09 star:2.7k fork:0.2k 💎 Cross platform Web debugging proxy
...
- [alibaba/lowcode-datasource](https://github.com/alibaba/lowcode-datasource) topic:alibaba,low-code,lowcode pushed_at:2022-09 star:0.0k fork:0.0k An enterprise-class low-code technology stack with scale-out design / 一套面向扩展设计的企业级低代码技术体系
...
- [alibaba/lowcode-engine](https://github.com/alibaba/lowcode-engine) topic:alibaba,low-code,lowcode pushed_at:2022-09 star:8.0k fork:1.3k An enterprise-class low-code technology stack with scale-out design / 一套面向扩展设计的企业级低代码技术体系
...
- [alibaba/pont](https://github.com/alibaba/pont) topic:mock-data,pont,swagger,typescript pushed_at:2022-09 star:2.8k fork:0.2k 🌉数据服务层解决方案
