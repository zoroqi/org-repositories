...
- [alibaba/AliOS-Things](https://github.com/alibaba/AliOS-Things) topic:embedded,haas,haas-python,iot,microcontroller,os,risc-v,rtos pushed_at:2022-10 star:4.3k fork:1.1k 面向IoT领域的、高可伸缩的物联网操作系统，可去官网了解更多信息https://www.aliyun.com/product/aliosthings
...
- [alibaba/xquic](https://github.com/alibaba/xquic) topic:http3,ietf,protocol,quic,tls13 pushed_at:2022-10 star:1.3k fork:0.2k XQUIC Library released by Alibaba is a cross-platform implementation of QUIC and HTTP/3 protocol.
...
- [alibaba/async_simple](https://github.com/alibaba/async_simple) topic: pushed_at:2022-10 star:0.6k fork:0.1k Simple, light-weight and easy-to-use asynchronous components 
...
- [alibaba/PhotonLibOS](https://github.com/alibaba/PhotonLibOS) topic:asyncio,coroutine,cpp,fs-library,iouring,kernel-features,libos,net-library,posix,std pushed_at:2022-10 star:0.4k fork:0.0k Write fast and agile C++ programs with Photon!
...
- [alibaba/power_image](https://github.com/alibaba/power_image) topic:flutter,image pushed_at:2022-10 star:0.4k fork:0.0k A powerful plugin that fully uses the native image library's ability to display images on the flutter side.
...
- [alibaba/IOC-golang](https://github.com/alibaba/IOC-golang) topic:annotation,aop,debug,dependency-injection,golang,middleware,monkey,sdk,tag pushed_at:2022-10 star:0.9k fork:0.1k 一款服务于 Go 开发者的依赖注入框架，方便搭建任何 Go 应用。 A Golang depenedency injection framework, helps developers to build any go application.
...
- [alibaba/RedisShake](https://github.com/alibaba/RedisShake) topic:redis,redis-cluster,redis-proxy pushed_at:2022-10 star:2.8k fork:0.5k redis-shake is a tool for Redis data migration and data filtering. redis-shake 是一个用于 Redis 数据迁移与过滤的工具。
...
- [alibaba/AGEIPort](https://github.com/alibaba/AGEIPort) topic: pushed_at:2022-10 star:0.0k fork:0.0k 
...
- [alibaba/aliyun-spring-boot](https://github.com/alibaba/aliyun-spring-boot) topic:aliyun,aliyun-oss,aliyun-rds,aliyun-redis,aliyun-schedulerx,aliyun-sms,spring-boot,spring-boot-starters pushed_at:2022-10 star:0.4k fork:0.1k Spring Boot Starters for Aliyun services
...
- [alibaba/arthas](https://github.com/alibaba/arthas) topic:agent,alibaba,arthas,classloader,diagnosis,java,jvm,trace,trouble-shooting pushed_at:2022-10 star:30.8k fork:6.7k Alibaba Java Diagnostic Tool Arthas/Alibaba Java诊断利器Arthas
...
- [alibaba/canal](https://github.com/alibaba/canal) topic: pushed_at:2022-10 star:24.3k fork:7.0k 阿里巴巴 MySQL binlog 增量订阅&消费组件 
- [alibaba/celeborn](https://github.com/alibaba/celeborn) topic:big-data,shuffle,spark pushed_at:2022-10 star:0.2k fork:0.1k Celeborn provides an elastic and high-performance service for shuffle and spilled data.
...
- [alibaba/COLA](https://github.com/alibaba/COLA) topic:architecture,clean,cola pushed_at:2022-10 star:8.6k fork:2.3k 🥤 COLA: Clean Object-oriented & Layered Architecture
...
- [alibaba/DataX](https://github.com/alibaba/DataX) topic: pushed_at:2022-10 star:12.2k fork:4.4k DataX是阿里云DataWorks数据集成的开源版本。
...
- [alibaba/druid](https://github.com/alibaba/druid) topic: pushed_at:2022-10 star:26.1k fork:8.3k 阿里云计算平台DataWorks(https://help.aliyun.com/document_detail/137663.html) 团队出品，为监控而生的数据库连接池
...
- [alibaba/easyexcel](https://github.com/alibaba/easyexcel) topic:excel,java,jxl,oom,poi,xls,xlsx pushed_at:2022-10 star:25.5k fork:6.7k 快速、简洁、解决大文件内存溢出的java处理Excel工具
...
- [alibaba/jvm-sandbox-repeater](https://github.com/alibaba/jvm-sandbox-repeater) topic: pushed_at:2022-10 star:2.0k fork:0.6k  A Java server-side recording and playback solution based on JVM-Sandbox
...
- [alibaba/nacos](https://github.com/alibaba/nacos) topic:alibaba,config,configuration-management,distributed-configuration,dns,dubbo,istio,kubernetes,microservices,nacos,service-discovery,service-mesh,spring-cloud pushed_at:2022-10 star:24.3k fork:10.8k an easy-to-use dynamic service discovery, configuration and service management platform for building cloud native applications.
...
- [alibaba/spring-cloud-alibaba](https://github.com/alibaba/spring-cloud-alibaba) topic:alibaba,alibaba-middleware,alibaba-oss,aliyun,circuit-breaker,cloud-native,distributed-configuration,distributed-messaging,distributed-transaction,dubbo,java,microservices,nacos,rocketmq,service-discovery,service-registry,spring,spring-cloud,spring-cloud-alibaba,spring-cloud-core pushed_at:2022-10 star:23.9k fork:7.4k Spring Cloud Alibaba provides a one-stop solution for application development for the distributed solutions of Alibaba middleware.
...
- [alibaba/react-intl-universal](https://github.com/alibaba/react-intl-universal) topic: pushed_at:2022-10 star:1.2k fork:0.2k Internationalize React apps. Not only for Component but also for Vanilla JS.
...
- [alibaba/web-editor](https://github.com/alibaba/web-editor) topic:atx,editor,web pushed_at:2022-10 star:0.8k fork:0.2k web editor for atx
- [alibaba/x-render](https://github.com/alibaba/x-render) topic:ant,ant-design,chart,form,formrender,javascript,json-schema,list,react,table,typescript,webpack,widget pushed_at:2022-10 star:5.1k fork:0.8k 🚴‍♀️ 阿里 - 很易用的中后台「表单 / 表格 / 图表」解决方案
...
- [alibaba/alibaba-load-balancer-controller](https://github.com/alibaba/alibaba-load-balancer-controller) topic: pushed_at:2022-10 star:0.0k fork:0.0k 
...
- [alibaba/havenask](https://github.com/alibaba/havenask) topic: pushed_at:2022-10 star:0.0k fork:0.0k 
...
- [alibaba/AliceMind](https://github.com/alibaba/AliceMind) topic:bert,deep-learning,natural-language-processing,nlp pushed_at:2022-10 star:1.3k fork:0.2k ALIbaba's Collection of Encoder-decoders from MinD (Machine IntelligeNce of Damo) Lab
...
- [alibaba/tair-py](https://github.com/alibaba/tair-py) topic: pushed_at:2022-10 star:0.0k fork:0.0k A Python client of Tair based on redis-py
...
- [alibaba/font-toolkit](https://github.com/alibaba/font-toolkit) topic: pushed_at:2022-10 star:0.1k fork:0.0k A Rust 🦀️ font loading, positioning and rendering toolkit
...
- [alibaba/SparkCube](https://github.com/alibaba/SparkCube) topic: pushed_at:2022-10 star:0.1k fork:0.1k SparkCube is an open-source project for extremely fast OLAP data analysis. SparkCube is an extension of Apache Spark.
...
- [alibaba/BizCharts](https://github.com/alibaba/BizCharts) topic:chart,data-visualization,es6,grammar,html5-canvas,react pushed_at:2022-08 star:6.0k fork:0.7k Powerful data visualization library based on G2 and React.
...
- [alibaba/ChatUI](https://github.com/alibaba/ChatUI) topic:chat,chatbot,react,ui pushed_at:2022-10 star:1.5k fork:0.1k The UI design language and React library for Conversational UI
...
- [alibaba/formily](https://github.com/alibaba/formily) topic:ant-design,designable,form,form-builder,fusion,json-schema,json-schema-form,low-code,no-code,observable,react,react-form,react-native,reactive,schema-form,validator,vue,vue-form,vue3 pushed_at:2022-10 star:8.7k fork:1.2k 📱🚀 🧩 Cross Device & High Performance Normal Form/Dynamic(JSON Schema) Form/Form Builder -- Support React/React Native/Vue 2/Vue 3
...
- [alibaba/ice](https://github.com/alibaba/ice) topic:framework,icejs,microfrontends,mpa,nodejs,react,react-router,serverless,spa,ssr,typescript,vite,webpack pushed_at:2022-10 star:17.4k fork:2.1k 🚀 Icejs: The Progressive App Framework Based On React（基于 React 的渐进式应用框架）
...
- [alibaba/lowcode-engine](https://github.com/alibaba/lowcode-engine) topic:alibaba,low-code,lowcode pushed_at:2022-10 star:8.2k fork:1.4k An enterprise-class low-code technology stack with scale-out design / 一套面向扩展设计的企业级低代码技术体系
...
- [alibaba/lowcode-plugins](https://github.com/alibaba/lowcode-plugins) topic:alibaba,low-code,lowcode pushed_at:2022-10 star:0.1k fork:0.1k An enterprise-class low-code technology stack with scale-out design / 一套面向扩展设计的企业级低代码技术体系
- [alibaba/lowcode-tools](https://github.com/alibaba/lowcode-tools) topic:alibaba,low-code,lowcode pushed_at:2022-10 star:0.1k fork:0.0k An enterprise-class low-code technology stack with scale-out design / 一套面向扩展设计的企业级低代码技术体系
