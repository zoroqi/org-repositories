...
- [alibaba/CicadaPlayer](https://github.com/alibaba/CicadaPlayer) topic:dash,fairplay,ffmpeg,ll-hls,mediaplayer,webassembly,widevine pushed_at:2023-03 star:0.6k fork:0.2k CicadaPlayer is the player core of AliPlayer, which support multiple platform Android, iOS, macOS, Windows, Linux, and WebAssembly for now. The goal is providing a player core which support multi platform, hardware accelerator, customizable and extensible features. Which support WideVine drm and LL-HLS dash.
...
- [alibaba/GraphAr](https://github.com/alibaba/GraphAr) topic:big-data,data-orchestration,etl,graph,graph-analysis,graph-storage pushed_at:2023-03 star:0.1k fork:0.0k An open source, standard data file format for graph data storage and retrieval
...
- [alibaba/hiactor](https://github.com/alibaba/hiactor) topic: pushed_at:2023-03 star:0.0k fork:0.0k Hiactor is an actor framework for building high-performance, concurrent and scalable event-driven systems using C++.
- [alibaba/higress](https://github.com/alibaba/higress) topic:gateway,gateway-api,ingress,ingress-controller,microservice pushed_at:2023-03 star:1.0k fork:0.1k Next-generation Cloud Native Gateway | 下一代云原生网关
...
- [alibaba/libgrape-lite](https://github.com/alibaba/libgrape-lite) topic:cxx,gnn,gpu,grape,graph,graph-algorithms,graph-theory,header-only,library,mpi,parallel pushed_at:2023-03 star:0.3k fork:0.1k 🍇 A C++ library for parallel graph processing (GRAPE) 🍇
...
- [alibaba/open-local](https://github.com/alibaba/open-local) topic:cloud-native,csi,kubernetes,localstorage,lvm,snapshot,storage pushed_at:2023-03 star:0.4k fork:0.1k cloud-native local storage management system
...
- [alibaba/canal](https://github.com/alibaba/canal) topic: pushed_at:2023-03 star:25.4k fork:7.2k 阿里巴巴 MySQL binlog 增量订阅&消费组件 
...
- [alibaba/DataX](https://github.com/alibaba/DataX) topic: pushed_at:2023-03 star:13.2k fork:4.7k DataX是阿里云DataWorks数据集成的开源版本。
...
- [alibaba/easyexcel](https://github.com/alibaba/easyexcel) topic:excel,java,jxl,oom,poi,xls,xlsx pushed_at:2023-03 star:27.3k fork:7.0k 快速、简洁、解决大文件内存溢出的java处理Excel工具
...
- [alibaba/nacos](https://github.com/alibaba/nacos) topic:alibaba,config,configuration-management,distributed-configuration,dns,dubbo,istio,kubernetes,microservices,nacos,service-discovery,service-mesh,spring-cloud pushed_at:2023-03 star:25.9k fork:11.5k an easy-to-use dynamic service discovery, configuration and service management platform for building cloud native applications.
...
- [alibaba/Sentinel](https://github.com/alibaba/Sentinel) topic:alibaba,circuit-breaker,cloud-native,java,microservice,microservices,rate-limiting,reliability,resiliency pushed_at:2023-03 star:20.8k fork:7.5k A powerful flow control component enabling reliability, resilience and monitoring for microservices. (面向云原生微服务的高可用流控防护组件)
...
- [alibaba/spring-cloud-alibaba](https://github.com/alibaba/spring-cloud-alibaba) topic:alibaba,alibaba-middleware,alibaba-oss,aliyun,circuit-breaker,cloud-native,distributed-configuration,distributed-messaging,distributed-transaction,dubbo,java,microservices,nacos,rocketmq,service-discovery,service-registry,spring,spring-cloud,spring-cloud-alibaba,spring-cloud-core pushed_at:2023-03 star:25.2k fork:7.7k Spring Cloud Alibaba provides a one-stop solution for application development for the distributed solutions of Alibaba middleware.
...
- [alibaba/clusterdata](https://github.com/alibaba/clusterdata) topic:dataset pushed_at:2023-03 star:1.2k fork:0.4k cluster data collected from production clusters in Alibaba for cluster management research
...
- [alibaba/feathub](https://github.com/alibaba/feathub) topic:apache-flink,data-engineering,data-science,feature-engineering,feature-store,machine-learning pushed_at:2023-03 star:0.2k fork:0.0k FeatHub - A stream-batch unified feature store for real-time machine learning
- [alibaba/FederatedScope](https://github.com/alibaba/FederatedScope) topic:federated-learning,machine-learning,pytorch pushed_at:2023-03 star:0.9k fork:0.1k An easy-to-use federated learning platform
...
- [alibaba/GaiaX](https://github.com/alibaba/GaiaX) topic:android,cross-platform,css,flexbox,ios,kotlin,rust,swift pushed_at:2023-03 star:0.8k fork:0.1k 动态模板引擎是一套轻量化、跨平台、高性能的纯原生移动端卡片渲染动态化解决方案
...
- [alibaba/ChatUI](https://github.com/alibaba/ChatUI) topic:chat,chatbot,react,ui pushed_at:2023-03 star:1.7k fork:0.2k The UI design language and React library for Conversational UI
...
- [alibaba/formily](https://github.com/alibaba/formily) topic:ant-design,designable,form,form-builder,fusion,json-schema,json-schema-form,low-code,no-code,observable,react,react-form,react-native,reactive,schema-form,validator,vue,vue-form,vue3 pushed_at:2023-03 star:9.4k fork:1.3k 📱🚀 🧩 Cross Device & High Performance Normal Form/Dynamic(JSON Schema) Form/Form Builder -- Support React/React Native/Vue 2/Vue 3
...
- [alibaba/hooks](https://github.com/alibaba/hooks) topic:ahooks,hooks-library,react,react-hooks,umi-hooks pushed_at:2023-03 star:11.6k fork:2.2k A high-quality & reliable React Hooks library.
...
- [alibaba/lowcode-demo](https://github.com/alibaba/lowcode-demo) topic:alibaba,low-code,lowcode pushed_at:2023-03 star:1.1k fork:0.4k An enterprise-class low-code technology stack with scale-out design / 一套面向扩展设计的企业级低代码技术体系
...
- [alibaba/x-render](https://github.com/alibaba/x-render) topic:ant,ant-design,chart,form,formrender,javascript,json-schema,list,react,table,typescript,webpack,widget pushed_at:2023-03 star:5.7k fork:0.8k 🚴‍♀️ 阿里 - 很易用的中后台「表单 / 表格 / 图表」解决方案
