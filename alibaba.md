...
- [alibaba/kubeskoop](https://github.com/alibaba/kubeskoop) topic: pushed_at:2023-08 star:0.2k fork:0.0k 
...
- [alibaba/tengine](https://github.com/alibaba/tengine) topic:http3,ingress,nginx,quic,tengine pushed_at:2023-08 star:12.2k fork:2.5k A distribution of Nginx with some advanced features
...
- [alibaba/graph-learn](https://github.com/alibaba/graph-learn) topic:aligraph,dynamic-graph,dynamic-graph-service,gnn,gnn-framework,gnn-inference,graph,graph-neural-networks,graphlearn,pytorch,tensorflow,training pushed_at:2023-08 star:1.2k fork:0.3k An Industrial Graph Neural Network Framework
- [alibaba/GraphAr](https://github.com/alibaba/GraphAr) topic:big-data,data-orchestration,etl,graph,graph-analysis,graph-storage pushed_at:2023-08 star:0.1k fork:0.0k An open source, standard data file format for graph data storage and retrieval
...
- [alibaba/flutter_boost](https://github.com/alibaba/flutter_boost) topic:android,dart,flutter,hybrid-app,hybrid-flutter,ios pushed_at:2023-08 star:6.6k fork:1.2k FlutterBoost is a Flutter plugin which enables hybrid integration of Flutter for your existing native apps with minimum efforts
...
- [alibaba/open-local](https://github.com/alibaba/open-local) topic:cloud-native,csi,kubernetes,localstorage,lvm,snapshot,storage pushed_at:2023-08 star:0.4k fork:0.1k cloud-native local storage management system
...
- [alibaba/sentinel-golang](https://github.com/alibaba/sentinel-golang) topic:cloud-native,go,golang,microservice,microservices,middleware,rate-limiting,resiliency pushed_at:2023-08 star:2.5k fork:0.4k Sentinel Go enables reliability and resiliency for Go microservices
...
- [alibaba/lowcode-tools](https://github.com/alibaba/lowcode-tools) topic:alibaba,low-code,lowcode pushed_at:2023-08 star:0.1k fork:0.1k An enterprise-class low-code technology stack with scale-out design / 一套面向扩展设计的企业级低代码技术体系
...
- [alibaba/p3c](https://github.com/alibaba/p3c) topic: pushed_at:2023-08 star:29.5k fork:8.0k Alibaba Java Coding Guidelines pmd implements and IDE plugin
...
- [alibaba/data-juicer](https://github.com/alibaba/data-juicer) topic:ai,chinese,data-analysis,data-science,data-visualization,dataset,gpt,large-language-models,llm,machine-learning,nlp,opendata,python,pytorch pushed_at:2023-08 star:0.0k fork:0.0k A data-centric text processing system to make data higher-quality, juicier, and more digestible for LLMs!  🍎 🍋 🌽 ➡️ ➡️🍸 🍹 🍷为大语言模型提供更高质量、更丰富、更易”消化“的数据！
...
- [alibaba/formily](https://github.com/alibaba/formily) topic:ant-design,designable,form,form-builder,fusion,json-schema,json-schema-form,low-code,no-code,observable,react,react-form,react-native,reactive,schema-form,validator,vue,vue-form,vue3 pushed_at:2023-08 star:10.0k fork:1.4k 📱🚀 🧩 Cross Device & High Performance Normal Form/Dynamic(JSON Schema) Form/Form Builder -- Support React/React Native/Vue 2/Vue 3
...
- [alibaba/lowcode-demo](https://github.com/alibaba/lowcode-demo) topic:alibaba,low-code,lowcode pushed_at:2023-08 star:1.3k fork:0.5k An enterprise-class low-code technology stack with scale-out design / 一套面向扩展设计的企业级低代码技术体系
- [alibaba/lowcode-engine](https://github.com/alibaba/lowcode-engine) topic:alibaba,low-code,lowcode pushed_at:2023-08 star:12.1k fork:2.1k An enterprise-class low-code technology stack with scale-out design / 一套面向扩展设计的企业级低代码技术体系
...
- [alibaba/x-render](https://github.com/alibaba/x-render) topic:ant,ant-design,chart,form,formrender,javascript,json-schema,list,react,table,typescript,webpack,widget pushed_at:2023-08 star:6.3k fork:0.9k 🚴‍♀️ 阿里 - 很易用的中后台「表单 / 表格 / 图表」解决方案
