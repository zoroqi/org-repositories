...
- [alibaba/tengine](https://github.com/alibaba/tengine) topic:http3,ingress,nginx,quic,tengine pushed_at:2023-11 star:12.4k fork:2.5k A distribution of Nginx with some advanced features
...
- [alibaba/async_simple](https://github.com/alibaba/async_simple) topic:asynchronous,coroutines,cpp20,modules pushed_at:2023-12 star:1.2k fork:0.2k Simple, light-weight and easy-to-use asynchronous components 
...
- [alibaba/alibaba-load-balancer-controller](https://github.com/alibaba/alibaba-load-balancer-controller) topic: pushed_at:2023-09 star:0.0k fork:0.0k 
...
- [alibaba/higress](https://github.com/alibaba/higress) topic:gateway,gateway-api,ingress,ingress-controller,microservice pushed_at:2023-12 star:1.9k fork:0.3k Next-generation Cloud Native Gateway | 下一代云原生网关
...
- [alibaba/NimoShake](https://github.com/alibaba/NimoShake) topic: pushed_at:2023-09 star:0.1k fork:0.0k sync from DynamoDB to MongoDB
...
- [alibaba/schedulerx-worker-go](https://github.com/alibaba/schedulerx-worker-go) topic:aliyun,cronjob,golang,scheduler pushed_at:2023-11 star:0.0k fork:0.0k schedulerx-worker-go is the Golang SDK of SchedulerX
...
- [alibaba/AGEIPort](https://github.com/alibaba/AGEIPort) topic: pushed_at:2023-11 star:0.7k fork:0.1k 
...
- [alibaba/arthas](https://github.com/alibaba/arthas) topic:agent,alibaba,arthas,classloader,diagnosis,java,jvm,trace,trouble-shooting pushed_at:2023-12 star:33.9k fork:7.3k Alibaba Java Diagnostic Tool Arthas/Alibaba Java诊断利器Arthas
...
- [alibaba/bytekit](https://github.com/alibaba/bytekit) topic: pushed_at:2023-08 star:0.4k fork:0.2k Java Bytecode Kit
- [alibaba/canal](https://github.com/alibaba/canal) topic: pushed_at:2023-12 star:27.1k fork:7.5k 阿里巴巴 MySQL binlog 增量订阅&消费组件 
...
- [alibaba/COLA](https://github.com/alibaba/COLA) topic:architecture,clean,cola pushed_at:2023-12 star:10.8k fork:2.8k 🥤 COLA: Clean Object-oriented & Layered Architecture
...
- [alibaba/DataX](https://github.com/alibaba/DataX) topic: pushed_at:2023-12 star:14.5k fork:5.1k DataX是阿里云DataWorks数据集成的开源版本。
...
- [alibaba/druid](https://github.com/alibaba/druid) topic: pushed_at:2023-12 star:27.4k fork:8.6k 阿里云计算平台DataWorks(https://help.aliyun.com/document_detail/137663.html) 团队出品，为监控而生的数据库连接池
...
- [alibaba/easyexcel](https://github.com/alibaba/easyexcel) topic:excel,java,jxl,oom,poi,xls,xlsx pushed_at:2023-12 star:30.0k fork:7.3k 快速、简洁、解决大文件内存溢出的java处理Excel工具
...
- [alibaba/jvm-sandbox-repeater](https://github.com/alibaba/jvm-sandbox-repeater) topic: pushed_at:2023-11 star:2.3k fork:0.7k  A Java server-side recording and playback solution based on JVM-Sandbox
...
- [alibaba/nacos](https://github.com/alibaba/nacos) topic:alibaba,config,configuration-management,distributed-configuration,dns,dubbo,istio,kubernetes,microservices,nacos,service-discovery,service-mesh,spring-cloud pushed_at:2023-12 star:28.1k fork:12.4k an easy-to-use dynamic service discovery, configuration and service management platform for building cloud native applications.
...
- [alibaba/Sentinel](https://github.com/alibaba/Sentinel) topic:alibaba,circuit-breaker,cloud-native,java,microservice,microservices,rate-limiting,reliability,resiliency pushed_at:2023-12 star:21.6k fork:7.9k A powerful flow control component enabling reliability, resilience and monitoring for microservices. (面向云原生微服务的高可用流控防护组件)
...
- [alibaba/spring-cloud-alibaba](https://github.com/alibaba/spring-cloud-alibaba) topic:alibaba,alibaba-middleware,alibaba-oss,aliyun,circuit-breaker,cloud-native,distributed-configuration,distributed-messaging,distributed-transaction,dubbo,java,microservices,nacos,rocketmq,service-discovery,service-registry,spring,spring-cloud,spring-cloud-alibaba,spring-cloud-core pushed_at:2023-12 star:26.8k fork:8.1k Spring Cloud Alibaba provides a one-stop solution for application development for the distributed solutions of Alibaba middleware.
...
- [alibaba/intelligent-test-platform](https://github.com/alibaba/intelligent-test-platform) topic: pushed_at:2023-03 star:0.5k fork:0.2k intelligent-test-platform
...
- [alibaba/p3c](https://github.com/alibaba/p3c) topic: pushed_at:2023-08 star:29.8k fork:8.1k Alibaba Java Coding Guidelines pmd implements and IDE plugin
...
- [alibaba/ali-dbhub](https://github.com/alibaba/ali-dbhub) topic: pushed_at:2023-09 star:8.7k fork:2.0k 已迁移新仓库，此版本将不再维护
...
- [alibaba/pilotscope](https://github.com/alibaba/pilotscope) topic: pushed_at:2023-10 star:0.0k fork:0.0k 
- [alibaba/RichDreamer](https://github.com/alibaba/RichDreamer) topic: pushed_at:2023-12 star:0.1k fork:0.0k 
...
- [alibaba/animate-anything](https://github.com/alibaba/animate-anything) topic:animation,video-diffusion-model,video-generation pushed_at:2023-12 star:0.1k fork:0.0k Fine-Grained Open Domain Image Animation with Motion Guidance
...
- [alibaba/data-juicer](https://github.com/alibaba/data-juicer) topic:chinese,data-analysis,data-science,data-visualization,dataset,gpt,gpt-4,instruction-tuning,large-language-models,llama,llm,llms,machine-learning,multi-modal,nlp,opendata,pre-training,pytorch,streamlit pushed_at:2023-12 star:0.7k fork:0.0k A one-stop data processing system to make data higher-quality, juicier, and more digestible for LLMs!  🍎 🍋 🌽 ➡️ ➡️🍸 🍹 🍷为大语言模型提供更高质量、更丰富、更易”消化“的数据！
...
- [alibaba/FederatedScope](https://github.com/alibaba/FederatedScope) topic:federated-learning,machine-learning,pytorch pushed_at:2023-11 star:1.1k fork:0.2k An easy-to-use federated learning platform
...
- [alibaba/graphlearn-for-pytorch](https://github.com/alibaba/graphlearn-for-pytorch) topic:deep-learning,distributed,gpu,graph-neural-networks,pytorch pushed_at:2023-12 star:0.1k fork:0.0k A graph learning library for PyTorch that makes distributed GNN training and inference easy and efficient.
...
- [alibaba/Megatron-LLaMA](https://github.com/alibaba/Megatron-LLaMA) topic:deepspeed,distributed-training,llama,llm,megatron-lm,pretraining,pytorch pushed_at:2023-12 star:0.4k fork:0.0k Best practice for training LLaMA models in Megatron-LM
...
- [alibaba/Pai-Megatron-Patch](https://github.com/alibaba/Pai-Megatron-Patch) topic: pushed_at:2023-12 star:0.2k fork:0.0k The official repo of Pai-Megatron-Patch for LLM & VLM large scale training developed by Alibaba Cloud.
...
- [alibaba/tidevice](https://github.com/alibaba/tidevice) topic:ios,iphone,tidevice,usbmuxd,wda pushed_at:2023-11 star:2.2k fork:0.4k  tidevice can be used to communicate with iPhone device
...
- [alibaba/ChatUI](https://github.com/alibaba/ChatUI) topic:chat,chatbot,react,ui pushed_at:2023-07 star:2.3k fork:0.2k The UI design language and React library for Conversational UI
...
- [alibaba/formily](https://github.com/alibaba/formily) topic:ant-design,designable,form,form-builder,fusion,json-schema,json-schema-form,low-code,no-code,observable,react,react-form,react-native,reactive,schema-form,validator,vue,vue-form,vue3 pushed_at:2023-12 star:10.3k fork:1.4k 📱🚀 🧩 Cross Device & High Performance Normal Form/Dynamic(JSON Schema) Form/Form Builder -- Support React/React Native/Vue 2/Vue 3
...
- [alibaba/lowcode-engine](https://github.com/alibaba/lowcode-engine) topic:alibaba,low-code,lowcode pushed_at:2023-12 star:12.8k fork:2.2k An enterprise-class low-code technology stack with scale-out design / 一套面向扩展设计的企业级低代码技术体系
- [alibaba/lowcode-engine-ext](https://github.com/alibaba/lowcode-engine-ext) topic:alibaba,low-code,lowcode pushed_at:2023-11 star:0.1k fork:0.1k An enterprise-class low-code technology stack with scale-out design / 一套面向扩展设计的企业级低代码技术体系
...
- [alibaba/pipcook](https://github.com/alibaba/pipcook) topic:js,machine-learning,pipeline,tensorflow pushed_at:2023-12 star:2.5k fork:0.2k Machine learning platform for Web developers
...
- [alibaba/x-render](https://github.com/alibaba/x-render) topic:ant,ant-design,chart,form,formrender,javascript,json-schema,list,react,table,typescript,webpack,widget pushed_at:2023-11 star:6.5k fork:0.9k 🚴‍♀️ 阿里 - 很易用的中后台「表单 / 表格 / 图表」解决方案
