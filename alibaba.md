...
- [alibaba/code-data-share-for-python](https://github.com/alibaba/code-data-share-for-python) topic: pushed_at:2023-02 star:0.0k fork:0.0k 
...
- [alibaba/kubeskoop](https://github.com/alibaba/kubeskoop) topic: pushed_at:2023-03 star:0.0k fork:0.0k 
...
- [alibaba/serverless-adapter](https://github.com/alibaba/serverless-adapter) topic: pushed_at:2023-03 star:0.0k fork:0.0k 
- [alibaba/SiliconFastOS](https://github.com/alibaba/SiliconFastOS) topic: pushed_at:2023-02 star:0.0k fork:0.0k 
...
- [alibaba/tengine](https://github.com/alibaba/tengine) topic:nginx,tengine pushed_at:2023-03 star:11.9k fork:2.5k A distribution of Nginx with some advanced features
...
- [alibaba/xquic](https://github.com/alibaba/xquic) topic:http3,ietf,protocol,quic,tls13 pushed_at:2023-02 star:1.4k fork:0.3k XQUIC Library released by Alibaba is a cross-platform implementation of QUIC and HTTP/3 protocol.
...
- [alibaba/BladeDISC](https://github.com/alibaba/BladeDISC) topic:compiler,deep-learning,inference-optimization,machine-learning,mlir,neural-network,pytorch,tensorflow pushed_at:2023-03 star:0.6k fork:0.1k BladeDISC is an end-to-end DynamIc Shape Compiler project for machine learning workloads.
...
- [alibaba/DeepRec](https://github.com/alibaba/DeepRec) topic:advertising,deep-learning,distributed-training,machine-learning,python,recommendation-engine,scalability,search-engine pushed_at:2023-03 star:0.7k fork:0.3k DeepRec is a high-performance recommendation deep learning framework based on TensorFlow.
...
- [alibaba/GraphAr](https://github.com/alibaba/GraphAr) topic:big-data,data-orchestration,etl,graph,graph-analysis,graph-storage pushed_at:2023-03 star:0.0k fork:0.0k An open source, standard data file format for graph data storage and retrieval
- [alibaba/havenask](https://github.com/alibaba/havenask) topic: pushed_at:2023-03 star:1.0k fork:0.2k 
...
- [alibaba/higress](https://github.com/alibaba/higress) topic:gateway,gateway-api,ingress,ingress-controller,microservice pushed_at:2023-03 star:0.9k fork:0.1k Next-generation Cloud Native Gateway | 下一代云原生网关
- [alibaba/ilogtail](https://github.com/alibaba/ilogtail) topic:aliyun,apm,cloud-native,ebpf,observability,sls pushed_at:2023-03 star:1.2k fork:0.2k Fast and Lightweight Observability Data Collector
...
- [alibaba/libgrape-lite](https://github.com/alibaba/libgrape-lite) topic:cxx,gnn,gpu,grape,graph,graph-algorithms,graph-theory,header-only,library,mpi,parallel pushed_at:2023-02 star:0.3k fork:0.1k 🍇 A C++ library for parallel graph processing (GRAPE) 🍇
...
- [alibaba/nann](https://github.com/alibaba/nann) topic:matching,recommendation-system pushed_at:2023-02 star:0.0k fork:0.0k A flexible, high-performance framework for large-scale retrieval problems based on TensorFlow.
...
- [alibaba/yalantinglibs](https://github.com/alibaba/yalantinglibs) topic: pushed_at:2023-03 star:0.6k fork:0.1k A collection of C++20 libraries, include coro_rpc, struct_pack, struct_json, struct_pb, easylog, asnyc_simple
...
- [alibaba/flutter-go](https://github.com/alibaba/flutter-go) topic:dart,flutter,flutter-demo,flutter-doc pushed_at:2023-02 star:23.3k fork:3.8k flutter 开发者帮助 APP，包含 flutter 常用 140+ 组件的demo 演示与中文文档
- [alibaba/flutter_boost](https://github.com/alibaba/flutter_boost) topic:android,dart,flutter,hybrid-app,hybrid-flutter,ios pushed_at:2023-03 star:6.4k fork:1.1k FlutterBoost is a Flutter plugin which enables hybrid integration of Flutter for your existing native apps with minimum efforts
...
- [alibaba/hybridnet](https://github.com/alibaba/hybridnet) topic:bgp,cni,cni-plugin,container,hybrid-cloud,kubernetes,kubernetes-networking,networking,overlay-network,sdn,vlan,vxlan pushed_at:2023-03 star:0.2k fork:0.0k A CNI plugin, provides networking environment where overlay and underlay containers can run on the same node and have cluster-wide bidirectional network connectivity.
...
- [alibaba/kt-connect](https://github.com/alibaba/kt-connect) topic:connect,developer-tools,exchage,istio,kubernetes,mesh,vpn pushed_at:2023-03 star:1.1k fork:0.2k A toolkit for Integrating with your kubernetes dev environment more efficiently
...
- [alibaba/open-local](https://github.com/alibaba/open-local) topic:cloud-native,csi,kubernetes,localstorage,lvm,snapshot,storage pushed_at:2023-03 star:0.3k fork:0.1k cloud-native local storage management system
...
- [alibaba/AGEIPort](https://github.com/alibaba/AGEIPort) topic: pushed_at:2023-03 star:0.6k fork:0.1k 
- [alibaba/ali-dbhub](https://github.com/alibaba/ali-dbhub) topic:app,database,database-management,database-schema,dba,ddl,electron,h2,java,javascript,mysql,oracle,postgresql,redis,redis-client,sql,sqlite pushed_at:2023-03 star:0.3k fork:0.1k Free multi-platform database tool for developers.(数据库客户端工具)
- [alibaba/alibaba-dragonwell-security-provider](https://github.com/alibaba/alibaba-dragonwell-security-provider) topic: pushed_at:2023-03 star:0.0k fork:0.0k 
...
- [alibaba/alibaba-rsocket-broker](https://github.com/alibaba/alibaba-rsocket-broker) topic:alibaba,broker,grpc,iot,rpc,rsocket,service-mesh pushed_at:2023-03 star:0.7k fork:0.2k Alibaba RSocket Broker: Mesh, Streaming & IoT
- [alibaba/alibabacloud-tairjedis-sdk](https://github.com/alibaba/alibabacloud-tairjedis-sdk) topic:module,redis,tair pushed_at:2023-03 star:0.1k fork:0.0k Based on Jedis that operates Tair For Redis Modules.
...
- [alibaba/arthas](https://github.com/alibaba/arthas) topic:agent,alibaba,arthas,classloader,diagnosis,java,jvm,trace,trouble-shooting pushed_at:2023-03 star:31.9k fork:6.9k Alibaba Java Diagnostic Tool Arthas/Alibaba Java诊断利器Arthas
...
- [alibaba/bytekit](https://github.com/alibaba/bytekit) topic: pushed_at:2023-02 star:0.3k fork:0.1k Java Bytecode Kit
- [alibaba/canal](https://github.com/alibaba/canal) topic: pushed_at:2023-03 star:25.2k fork:7.1k 阿里巴巴 MySQL binlog 增量订阅&消费组件 
- [alibaba/cli](https://github.com/alibaba/cli) topic: pushed_at:2020-10 star:0.1k fork:0.0k 
- [alibaba/cloud-native-app-initializer](https://github.com/alibaba/cloud-native-app-initializer) topic:cloud-native,cloud-native-app-initializer,initializer,microservices pushed_at:2023-03 star:0.1k fork:0.0k Cloud Native App Initializer is committed to providing developers with a simpler and more efficient project construction experience in the current cloud-native era.
...
- [alibaba/COLA](https://github.com/alibaba/COLA) topic:architecture,clean,cola pushed_at:2023-03 star:9.2k fork:2.5k 🥤 COLA: Clean Object-oriented & Layered Architecture
...
- [alibaba/DataX](https://github.com/alibaba/DataX) topic: pushed_at:2023-03 star:13.0k fork:4.7k DataX是阿里云DataWorks数据集成的开源版本。
...
- [alibaba/dragonwell11](https://github.com/alibaba/dragonwell11) topic: pushed_at:2023-03 star:0.5k fork:0.1k Alibaba Dragonwell11 JDK
- [alibaba/dragonwell17](https://github.com/alibaba/dragonwell17) topic: pushed_at:2023-02 star:0.2k fork:0.0k Alibaba Dragonwell17 JDK
- [alibaba/dragonwell8](https://github.com/alibaba/dragonwell8) topic:dragonwell8,java,java8,jdk,lts,openjdk pushed_at:2023-02 star:3.9k fork:0.5k Alibaba Dragonwell8 JDK
...
- [alibaba/druid](https://github.com/alibaba/druid) topic: pushed_at:2023-03 star:26.6k fork:8.3k 阿里云计算平台DataWorks(https://help.aliyun.com/document_detail/137663.html) 团队出品，为监控而生的数据库连接池
...
- [alibaba/easyexcel](https://github.com/alibaba/easyexcel) topic:excel,java,jxl,oom,poi,xls,xlsx pushed_at:2023-03 star:27.0k fork:7.0k 快速、简洁、解决大文件内存溢出的java处理Excel工具
...
- [alibaba/fastjson](https://github.com/alibaba/fastjson) topic:android,best-performance,deserialization,fastjson,java,json,json-parser,json-serialization,json-serializer,serialization pushed_at:2023-01 star:25.2k fork:6.5k FASTJSON 2.0.x has been released, faster and more secure, recommend you upgrade.
- [alibaba/fastjson2](https://github.com/alibaba/fastjson2) topic:android,big-data,deserialization,fastjson,fastjson2,graal,graalvm-native-image,high-performance,java,java-json,json,json-deserialization,json-parser,json-path,json-serialization,json-serializer,jsonb,serialization pushed_at:2023-03 star:2.5k fork:0.3k FASTJSON2 is a Java JSON  library with excellent performance.
...
- [alibaba/java-dns-cache-manipulator](https://github.com/alibaba/java-dns-cache-manipulator) topic:dns,dns-cache,dns-cache-manipulator,domain-name,hacking,hacking-code,integration-testing,java,jvm,testing,threadsafe,unit-testing pushed_at:2023-03 star:0.8k fork:0.2k 🌏 A tiny 0-dependency thread-safe Java™ lib for setting/viewing dns programmatically without touching host file, make unit/integration testing portable; and a tiny tool for setting/viewing dns of running JVM process.
...
- [alibaba/jvm-sandbox](https://github.com/alibaba/jvm-sandbox) topic: pushed_at:2023-01 star:5.8k fork:1.4k Real - time non-invasive AOP framework container based on JVM
...
- [alibaba/nacos](https://github.com/alibaba/nacos) topic:alibaba,config,configuration-management,distributed-configuration,dns,dubbo,istio,kubernetes,microservices,nacos,service-discovery,service-mesh,spring-cloud pushed_at:2023-03 star:25.6k fork:11.4k an easy-to-use dynamic service discovery, configuration and service management platform for building cloud native applications.
...
- [alibaba/otter](https://github.com/alibaba/otter) topic: pushed_at:2023-01 star:7.6k fork:2.5k 阿里巴巴分布式数据库同步系统(解决中美异地机房)
...
- [alibaba/QLExpress](https://github.com/alibaba/QLExpress) topic: pushed_at:2023-03 star:4.0k fork:1.0k QLExpress is a powerful, lightweight, dynamic language for the Java platform aimed at improving developers’ productivity in different business scenes.
...
- [alibaba/Sentinel](https://github.com/alibaba/Sentinel) topic:alibaba,circuit-breaker,cloud-native,java,microservice,microservices,rate-limiting,reliability,resiliency pushed_at:2023-03 star:20.6k fork:7.5k A powerful flow control component enabling reliability, resilience and monitoring for microservices. (面向云原生微服务的高可用流控防护组件)
...
- [alibaba/SmartEngine](https://github.com/alibaba/SmartEngine) topic: pushed_at:2023-02 star:0.6k fork:0.2k SmartEngine is a lightweight business orchestration engine.
...
- [alibaba/spring-cloud-alibaba](https://github.com/alibaba/spring-cloud-alibaba) topic:alibaba,alibaba-middleware,alibaba-oss,aliyun,circuit-breaker,cloud-native,distributed-configuration,distributed-messaging,distributed-transaction,dubbo,java,microservices,nacos,rocketmq,service-discovery,service-registry,spring,spring-cloud,spring-cloud-alibaba,spring-cloud-core pushed_at:2023-03 star:24.9k fork:7.7k Spring Cloud Alibaba provides a one-stop solution for application development for the distributed solutions of Alibaba middleware.
...
- [alibaba/SREWorks](https://github.com/alibaba/SREWorks) topic:aiops,application,cloudnative,dataops,devops,engineering,flink,k8s,kubernetes,maintenance,oam,operation,ops,saas,sre pushed_at:2023-03 star:1.2k fork:0.3k Cloud Native DataOps & AIOps Platform | 云原生数智运维平台 
...
- [alibaba/butterfly](https://github.com/alibaba/butterfly) topic:bpmn,butterfly,connectivity,dag,diagram,diagramming,edge,flow,flow-dag,flow-layout,flowchart,mindmap,react,svg,tree,treemap-diagram,vue pushed_at:2023-03 star:3.5k fork:0.5k 🦋Butterfly，A JavaScript/React/Vue2 Diagramming library which concentrate on flow layout field.    (基于JavaScript/React/Vue2的流程图组件)
...
- [alibaba/f2e-spec](https://github.com/alibaba/f2e-spec) topic:guidelines,linter,specification pushed_at:2023-03 star:0.5k fork:0.1k Alibaba Front-end Coding Guidelines and Relevant Tools
...
- [alibaba/react-intl-universal](https://github.com/alibaba/react-intl-universal) topic: pushed_at:2023-03 star:1.3k fork:0.2k Internationalize React apps. Not only for Component but also for Vanilla JS.
...
- [alibaba/web-editor](https://github.com/alibaba/web-editor) topic:atx,editor,web pushed_at:2023-01 star:0.9k fork:0.3k web editor for atx
...
- [alibaba/clusterdata](https://github.com/alibaba/clusterdata) topic:dataset pushed_at:2023-02 star:1.2k fork:0.4k cluster data collected from production clusters in Alibaba for cluster management research
...
- [alibaba/CNStackCommunityEdition](https://github.com/alibaba/CNStackCommunityEdition) topic: pushed_at:2023-02 star:0.0k fork:0.0k CNStack Community Edition
...
- [alibaba/lowcode-graph](https://github.com/alibaba/lowcode-graph) topic: pushed_at:2023-03 star:0.0k fork:0.0k 
...
- [alibaba/AIOpsServing](https://github.com/alibaba/AIOpsServing) topic:ai-ops,alicloud-compatible,machine-learning,mlflow-compatible,model-benchmarking,model-serving pushed_at:2023-02 star:0.0k fork:0.0k Open source code for AIOpsServing
- [alibaba/alibaba.alicloud](https://github.com/alibaba/alibaba.alicloud) topic: pushed_at:2023-02 star:0.2k fork:0.1k 
- [alibaba/AliceMind](https://github.com/alibaba/AliceMind) topic:bert,deep-learning,natural-language-processing,nlp pushed_at:2023-02 star:1.6k fork:0.2k ALIbaba's Collection of Encoder-decoders from MinD (Machine IntelligeNce of Damo) Lab
...
- [alibaba/Elastic-Federated-Learning-Solution](https://github.com/alibaba/Elastic-Federated-Learning-Solution) topic: pushed_at:2023-03 star:0.1k fork:0.0k 
...
- [alibaba/feathub](https://github.com/alibaba/feathub) topic:apache-flink,data-engineering,data-science,feature-engineering,feature-store,machine-learning pushed_at:2023-03 star:0.1k fork:0.0k FeatHub - A stream-batch unified feature store for real-time machine learning
- [alibaba/FederatedScope](https://github.com/alibaba/FederatedScope) topic:federated-learning,machine-learning,pytorch pushed_at:2023-03 star:0.8k fork:0.1k An easy-to-use federated learning platform
...
- [alibaba/HybridBackend](https://github.com/alibaba/HybridBackend) topic:deep-learning,gpu,hybrid-parallelism,parquet,recommender-system pushed_at:2023-03 star:0.1k fork:0.0k A high-performance framework for training wide-and-deep recommender systems on heterogeneous cluster
...
- [alibaba/lightweight-neural-architecture-search](https://github.com/alibaba/lightweight-neural-architecture-search) topic:automl,maedet,nas,object-detection,training-free-nas,zennas,zero-cost-nas pushed_at:2023-03 star:0.2k fork:0.0k This is a collection of our zero-cost NAS and efficient vision applications. 
...
- [alibaba/tair-py](https://github.com/alibaba/tair-py) topic: pushed_at:2023-02 star:0.0k fork:0.0k A Python client of Tair based on redis-py
- [alibaba/taobao-iphone-device](https://github.com/alibaba/taobao-iphone-device) topic:ios,iphone,usbmuxd,wda pushed_at:2023-02 star:1.9k fork:0.4k  tidevice can be used to communicate with iPhone device
...
- [alibaba/GaiaX](https://github.com/alibaba/GaiaX) topic:android,cross-platform,css,flexbox,ios,kotlin,rust,swift pushed_at:2023-03 star:0.8k fork:0.1k GaiaX动态模板引擎是一套轻量化、跨平台、高性能的纯原生移动端卡片渲染动态化解决方案
- [alibaba/GraphScope](https://github.com/alibaba/GraphScope) topic:analytics,big-data,data-science,graph,graph-analytics,graph-computation,graph-computing,graph-data,graph-neural-networks,gremlin pushed_at:2023-03 star:2.3k fork:0.3k 🔨 🍇 💻 🚀 GraphScope: A One-Stop Large-Scale Graph Computing System from Alibaba 来自阿里巴巴的一站式大规模图计算系统 图分析 图查询 图机器学习
...
- [alibaba/ali-react-table](https://github.com/alibaba/ali-react-table) topic:react,react-table,table pushed_at:2023-03 star:0.9k fork:0.2k Performent, flexible and modern React table component.
...
- [alibaba/ChatUI](https://github.com/alibaba/ChatUI) topic:chat,chatbot,react,ui pushed_at:2023-03 star:1.6k fork:0.2k The UI design language and React library for Conversational UI
...
- [alibaba/designable](https://github.com/alibaba/designable) topic:builder,designable,designer,editor,form,react pushed_at:2023-03 star:2.6k fork:0.5k 🧩 Make everything designable 🧩 
- [alibaba/form-driver](https://github.com/alibaba/form-driver) topic: pushed_at:2023-02 star:0.0k fork:0.0k 
- [alibaba/formily](https://github.com/alibaba/formily) topic:ant-design,designable,form,form-builder,fusion,json-schema,json-schema-form,low-code,no-code,observable,react,react-form,react-native,reactive,schema-form,validator,vue,vue-form,vue3 pushed_at:2023-02 star:9.3k fork:1.3k 📱🚀 🧩 Cross Device & High Performance Normal Form/Dynamic(JSON Schema) Form/Form Builder -- Support React/React Native/Vue 2/Vue 3
...
- [alibaba/general-scene-interface](https://github.com/alibaba/general-scene-interface) topic:web3d pushed_at:2023-01 star:0.0k fork:0.0k Build Your Web3D Programs With a Paradigm.
...
- [alibaba/hooks](https://github.com/alibaba/hooks) topic:ahooks,hooks-library,react,react-hooks,umi-hooks pushed_at:2023-03 star:11.5k fork:2.1k A high-quality & reliable React Hooks library.
- [alibaba/ice](https://github.com/alibaba/ice) topic:framework,icejs,microfrontends,mpa,nodejs,react,react-router,serverless,spa,ssr,typescript,vite,webpack pushed_at:2023-03 star:17.5k fork:2.1k 🚀 ice.js: The Progressive App Framework Based On React（基于 React 的渐进式应用框架）
- [alibaba/kiwi](https://github.com/alibaba/kiwi) topic:g11n,i18n,intl,translation,typescript pushed_at:2023-01 star:2.2k fork:0.2k 🐤 Kiwi-国际化翻译全流程解决方案
...
- [alibaba/lowcode-demo](https://github.com/alibaba/lowcode-demo) topic:alibaba,low-code,lowcode pushed_at:2023-03 star:1.0k fork:0.4k An enterprise-class low-code technology stack with scale-out design / 一套面向扩展设计的企业级低代码技术体系
- [alibaba/lowcode-engine](https://github.com/alibaba/lowcode-engine) topic:alibaba,low-code,lowcode pushed_at:2023-03 star:10.8k fork:1.8k An enterprise-class low-code technology stack with scale-out design / 一套面向扩展设计的企业级低代码技术体系
- [alibaba/lowcode-engine-ext](https://github.com/alibaba/lowcode-engine-ext) topic:alibaba,low-code,lowcode pushed_at:2023-03 star:0.1k fork:0.1k An enterprise-class low-code technology stack with scale-out design / 一套面向扩展设计的企业级低代码技术体系
- [alibaba/lowcode-materials](https://github.com/alibaba/lowcode-materials) topic:alibaba,low-code,lowcode pushed_at:2023-03 star:0.2k fork:0.1k An enterprise-class low-code technology stack with scale-out design / 一套面向扩展设计的企业级低代码技术体系
- [alibaba/lowcode-plugins](https://github.com/alibaba/lowcode-plugins) topic:alibaba,low-code,lowcode pushed_at:2023-03 star:0.1k fork:0.1k An enterprise-class low-code technology stack with scale-out design / 一套面向扩展设计的企业级低代码技术体系
- [alibaba/lowcode-tools](https://github.com/alibaba/lowcode-tools) topic:alibaba,low-code,lowcode pushed_at:2023-02 star:0.1k fork:0.1k An enterprise-class low-code technology stack with scale-out design / 一套面向扩展设计的企业级低代码技术体系
- [alibaba/MiniOptimizer](https://github.com/alibaba/MiniOptimizer) topic: pushed_at:2023-03 star:0.0k fork:0.0k 
- [alibaba/pipcook](https://github.com/alibaba/pipcook) topic:js,machine-learning,pipeline,tensorflow pushed_at:2023-03 star:2.4k fork:0.2k Machine learning platform for Web developers
- [alibaba/pont](https://github.com/alibaba/pont) topic:mock-data,pont,swagger,typescript pushed_at:2023-02 star:2.8k fork:0.2k 🌉数据服务层解决方案
...
- [alibaba/spatial-data-vis-framework](https://github.com/alibaba/spatial-data-vis-framework) topic:3d,gis,web3d,webgis pushed_at:2023-03 star:0.0k fork:0.0k Layered Spatial Data Vis Framework
- [alibaba/timeline](https://github.com/alibaba/timeline) topic: pushed_at:2023-03 star:0.0k fork:0.0k 
- [alibaba/x-render](https://github.com/alibaba/x-render) topic:ant,ant-design,chart,form,formrender,javascript,json-schema,list,react,table,typescript,webpack,widget pushed_at:2023-03 star:5.6k fork:0.8k 🚴‍♀️ 阿里 - 很易用的中后台「表单 / 表格 / 图表」解决方案
