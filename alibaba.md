...
- [alibaba/AliOS-Things](https://github.com/alibaba/AliOS-Things) topic:embedded,haas,haas-python,iot,microcontroller,os,risc-v,rtos pushed_at:2023-05 star:4.4k fork:1.1k 面向IoT领域的、高可伸缩的物联网操作系统，可去官网了解更多信息https://www.aliyun.com/product/aliosthings
...
- [alibaba/code-data-share-for-python](https://github.com/alibaba/code-data-share-for-python) topic: pushed_at:2023-05 star:0.0k fork:0.0k 
...
- [alibaba/kubeskoop](https://github.com/alibaba/kubeskoop) topic: pushed_at:2023-05 star:0.1k fork:0.0k 
...
- [alibaba/tengine](https://github.com/alibaba/tengine) topic:nginx,tengine pushed_at:2023-05 star:12.0k fork:2.5k A distribution of Nginx with some advanced features
...
- [alibaba/xquic](https://github.com/alibaba/xquic) topic:http3,ietf,protocol,quic,tls13 pushed_at:2023-05 star:1.4k fork:0.3k XQUIC Library released by Alibaba is a cross-platform implementation of QUIC and HTTP/3 protocol.
...
- [alibaba/async_simple](https://github.com/alibaba/async_simple) topic:asynchronous,coroutines,cpp20,modules pushed_at:2023-05 star:0.8k fork:0.1k Simple, light-weight and easy-to-use asynchronous components 
- [alibaba/BladeDISC](https://github.com/alibaba/BladeDISC) topic:compiler,deep-learning,inference-optimization,machine-learning,mlir,neural-network,pytorch,tensorflow pushed_at:2023-05 star:0.6k fork:0.1k BladeDISC is an end-to-end DynamIc Shape Compiler project for machine learning workloads.
...
- [alibaba/GraphAr](https://github.com/alibaba/GraphAr) topic:big-data,data-orchestration,etl,graph,graph-analysis,graph-storage pushed_at:2023-05 star:0.1k fork:0.0k An open source, standard data file format for graph data storage and retrieval
- [alibaba/havenask](https://github.com/alibaba/havenask) topic: pushed_at:2023-05 star:1.1k fork:0.2k 
...
- [alibaba/hiactor](https://github.com/alibaba/hiactor) topic: pushed_at:2023-05 star:0.0k fork:0.0k Hiactor is an actor framework for building high-performance, concurrent and scalable event-driven systems using C++.
- [alibaba/higress](https://github.com/alibaba/higress) topic:gateway,gateway-api,ingress,ingress-controller,microservice pushed_at:2023-05 star:1.2k fork:0.2k Next-generation Cloud Native Gateway | 下一代云原生网关
- [alibaba/ilogtail](https://github.com/alibaba/ilogtail) topic:aliyun,apm,cloud-native,ebpf,observability,sls pushed_at:2023-05 star:1.2k fork:0.2k Fast and Lightweight Observability Data Collector
...
- [alibaba/libgrape-lite](https://github.com/alibaba/libgrape-lite) topic:cxx,gnn,gpu,grape,graph,graph-algorithms,graph-theory,header-only,library,mpi,parallel pushed_at:2023-05 star:0.3k fork:0.1k 🍇 A C++ library for parallel graph processing (GRAPE) 🍇
- [alibaba/mile](https://github.com/alibaba/mile) topic: pushed_at:2013-08 star:0.0k fork:0.0k schemaless的类sql分布式查询系统
- [alibaba/MNN](https://github.com/alibaba/MNN) topic:arm,convolution,deep-learning,deep-neural-networks,embedded-devices,machine-learning,ml,mnn,vulkan,winograd-algorithm pushed_at:2023-05 star:7.6k fork:1.5k MNN is a blazing fast, lightweight deep learning framework, battle-tested by business-critical use cases in Alibaba
...
- [alibaba/PhotonLibOS](https://github.com/alibaba/PhotonLibOS) topic:async-io,coroutine,cpp,fs-library,iouring,kernel-features,libos,net-library,posix,std pushed_at:2023-05 star:0.6k fork:0.1k Write fast and agile C++ programs with Photon!
...
- [alibaba/yalantinglibs](https://github.com/alibaba/yalantinglibs) topic: pushed_at:2023-05 star:0.7k fork:0.1k A collection of C++20 libraries, include coro_rpc, struct_pack, struct_json, struct_xml, struct_pb, easylog, async_simple
...
- [alibaba/flutter_boost](https://github.com/alibaba/flutter_boost) topic:android,dart,flutter,hybrid-app,hybrid-flutter,ios pushed_at:2023-05 star:6.5k fork:1.1k FlutterBoost is a Flutter plugin which enables hybrid integration of Flutter for your existing native apps with minimum efforts
...
- [alibaba/alibabacloud-ack-connector](https://github.com/alibaba/alibabacloud-ack-connector) topic: pushed_at:2023-05 star:0.0k fork:0.0k 
...
- [alibaba/hybridnet](https://github.com/alibaba/hybridnet) topic:bgp,cni,cni-plugin,container,hybrid-cloud,kubernetes,kubernetes-networking,networking,overlay-network,sdn,vlan,vxlan pushed_at:2023-05 star:0.2k fork:0.0k Make underlay and overlay network can coexist, communicate, even be transformed purposefully.
...
- [alibaba/NimoShake](https://github.com/alibaba/NimoShake) topic: pushed_at:2023-04 star:0.1k fork:0.0k sync from DynamoDB to MongoDB
...
- [alibaba/open-simulator](https://github.com/alibaba/open-simulator) topic:capacity-planning,kubernetes,simulator pushed_at:2023-04 star:0.2k fork:0.0k K8s cluster simulator for capacity planning
...
- [alibaba/pouch](https://github.com/alibaba/pouch) topic:cloud-native,containers,efficiency,go,isolation,kubernetes,oci,package,security pushed_at:2023-05 star:4.6k fork:1.0k An Efficient Enterprise-class Container Engine
- [alibaba/sentinel-golang](https://github.com/alibaba/sentinel-golang) topic:cloud-native,go,golang,microservice,microservices,middleware,rate-limiting,resiliency pushed_at:2023-05 star:2.4k fork:0.4k Sentinel Go enables reliability and resiliency for Go microservices
...
- [alibaba/GraphScope](https://github.com/alibaba/GraphScope) topic:analytics,big-data,data-science,graph,graph-analytics,graph-computation,graph-computing,graph-data,graph-neural-networks,gremlin pushed_at:2023-05 star:2.4k fork:0.3k 🔨 🍇 💻 🚀 GraphScope: A One-Stop Large-Scale Graph Computing System from Alibaba 来自阿里巴巴的一站式大规模图计算系统 图分析 图查询 图机器学习
...
- [alibaba/AGEIPort](https://github.com/alibaba/AGEIPort) topic: pushed_at:2023-05 star:0.6k fork:0.1k 
...
- [alibaba/alibaba-rsocket-broker](https://github.com/alibaba/alibaba-rsocket-broker) topic:alibaba,broker,grpc,iot,rpc,rsocket,service-mesh pushed_at:2023-05 star:0.7k fork:0.2k Alibaba RSocket Broker: Mesh, Streaming & IoT
...
- [alibaba/arthas](https://github.com/alibaba/arthas) topic:agent,alibaba,arthas,classloader,diagnosis,java,jvm,trace,trouble-shooting pushed_at:2023-05 star:32.4k fork:7.0k Alibaba Java Diagnostic Tool Arthas/Alibaba Java诊断利器Arthas
...
- [alibaba/bytekit](https://github.com/alibaba/bytekit) topic: pushed_at:2023-04 star:0.4k fork:0.1k Java Bytecode Kit
- [alibaba/canal](https://github.com/alibaba/canal) topic: pushed_at:2023-04 star:25.7k fork:7.2k 阿里巴巴 MySQL binlog 增量订阅&消费组件 
- [alibaba/Chat2DB](https://github.com/alibaba/Chat2DB) topic:ai,chatbot,chatgpt,chatgpt-api,datagrip,dbeaver,electron,gpt,java,mysql,navicat,oracle,postgresql,redis,sql pushed_at:2023-05 star:1.2k fork:0.1k 智能的通用数据库工具和SQL客户端（General-purpose database tools and SQL clients with AI (ChatGPT)）
...
- [alibaba/COLA](https://github.com/alibaba/COLA) topic:architecture,clean,cola pushed_at:2023-05 star:9.8k fork:2.6k 🥤 COLA: Clean Object-oriented & Layered Architecture
- [alibaba/compileflow](https://github.com/alibaba/compileflow) topic:alibaba,bpmn2,compile,flow,halo-platform,java,process,process-engine,spring pushed_at:2023-04 star:1.4k fork:0.2k 🎨 core business process engine of Alibaba Halo platform, best process engine for trade scenes. | 一个高性能流程编排引擎
...
- [alibaba/DataX](https://github.com/alibaba/DataX) topic: pushed_at:2023-05 star:13.4k fork:4.8k DataX是阿里云DataWorks数据集成的开源版本。
...
- [alibaba/druid](https://github.com/alibaba/druid) topic: pushed_at:2023-05 star:26.9k fork:8.4k 阿里云计算平台DataWorks(https://help.aliyun.com/document_detail/137663.html) 团队出品，为监控而生的数据库连接池
...
- [alibaba/easyexcel](https://github.com/alibaba/easyexcel) topic:excel,java,jxl,oom,poi,xls,xlsx pushed_at:2023-05 star:27.7k fork:7.1k 快速、简洁、解决大文件内存溢出的java处理Excel工具
...
- [alibaba/fastjson](https://github.com/alibaba/fastjson) topic:android,best-performance,deserialization,fastjson,java,json,json-parser,json-serialization,json-serializer,serialization pushed_at:2023-05 star:25.3k fork:6.5k FASTJSON 2.0.x has been released, faster and more secure, recommend you upgrade.
- [alibaba/fastjson2](https://github.com/alibaba/fastjson2) topic:android,big-data,deserialization,fastjson,fastjson2,graal,graalvm-native-image,high-performance,java,java-json,json,json-deserialization,json-parser,json-path,json-serialization,json-serializer,jsonb,serialization pushed_at:2023-05 star:2.7k fork:0.3k 🚄 FASTJSON2 is a Java JSON  library with excellent performance.
...
- [alibaba/havenask-federation](https://github.com/alibaba/havenask-federation) topic: pushed_at:2023-05 star:0.0k fork:0.0k 
...
- [alibaba/java-dns-cache-manipulator](https://github.com/alibaba/java-dns-cache-manipulator) topic:dns,dns-cache,dns-cache-manipulator,domain-name,hacking,hacking-code,integration-testing,java,jvm,testing,threadsafe,unit-testing pushed_at:2023-05 star:0.8k fork:0.2k 🌏 A tiny 0-dependency thread-safe Java™ lib for setting/viewing dns programmatically without touching host file, make unit/integration testing portable; and a tiny tool for setting/viewing dns of running JVM process.
- [alibaba/jetcache](https://github.com/alibaba/jetcache) topic:cache,java,jcache,redis,spring,spring-cache pushed_at:2023-04 star:3.9k fork:0.9k JetCache is a Java cache framework.
...
- [alibaba/jvm-sandbox](https://github.com/alibaba/jvm-sandbox) topic: pushed_at:2023-04 star:6.1k fork:1.5k Real - time non-invasive AOP framework container based on JVM
- [alibaba/jvm-sandbox-repeater](https://github.com/alibaba/jvm-sandbox-repeater) topic: pushed_at:2023-02 star:2.2k fork:0.7k  A Java server-side recording and playback solution based on JVM-Sandbox
...
- [alibaba/nacos](https://github.com/alibaba/nacos) topic:alibaba,config,configuration-management,distributed-configuration,dns,dubbo,istio,kubernetes,microservices,nacos,service-discovery,service-mesh,spring-cloud pushed_at:2023-05 star:26.4k fork:11.7k an easy-to-use dynamic service discovery, configuration and service management platform for building cloud native applications.
...
- [alibaba/QLExpress](https://github.com/alibaba/QLExpress) topic: pushed_at:2023-05 star:4.1k fork:1.0k QLExpress is a powerful, lightweight, dynamic language for the Java platform aimed at improving developers’ productivity in different business scenes.
...
- [alibaba/Sentinel](https://github.com/alibaba/Sentinel) topic:alibaba,circuit-breaker,cloud-native,java,microservice,microservices,rate-limiting,reliability,resiliency pushed_at:2023-05 star:21.0k fork:7.6k A powerful flow control component enabling reliability, resilience and monitoring for microservices. (面向云原生微服务的高可用流控防护组件)
...
- [alibaba/SmartEngine](https://github.com/alibaba/SmartEngine) topic: pushed_at:2023-05 star:0.6k fork:0.2k SmartEngine is a lightweight business orchestration engine.
...
- [alibaba/spring-cloud-alibaba](https://github.com/alibaba/spring-cloud-alibaba) topic:alibaba,alibaba-middleware,alibaba-oss,aliyun,circuit-breaker,cloud-native,distributed-configuration,distributed-messaging,distributed-transaction,dubbo,java,microservices,nacos,rocketmq,service-discovery,service-registry,spring,spring-cloud,spring-cloud-alibaba,spring-cloud-core pushed_at:2023-05 star:25.6k fork:7.8k Spring Cloud Alibaba provides a one-stop solution for application development for the distributed solutions of Alibaba middleware.
...
- [alibaba/SREWorks](https://github.com/alibaba/SREWorks) topic:aiops,application,cloudnative,dataops,devops,engineering,flink,k8s,kubernetes,maintenance,oam,operation,ops,saas,sre pushed_at:2023-05 star:1.4k fork:0.3k Cloud Native DataOps & AIOps Platform | 云原生数智运维平台 
...
- [alibaba/butterfly](https://github.com/alibaba/butterfly) topic:bpmn,butterfly,connectivity,dag,diagram,diagramming,edge,flow,flow-dag,flow-layout,flowchart,mindmap,react,svg,tree,treemap-diagram,vue pushed_at:2023-05 star:3.7k fork:0.5k 🦋Butterfly，A JavaScript/React/Vue2 Diagramming library which concentrate on flow layout field.    (基于JavaScript/React/Vue2的流程图组件)
...
- [alibaba/lowcode-tools](https://github.com/alibaba/lowcode-tools) topic:alibaba,low-code,lowcode pushed_at:2023-05 star:0.1k fork:0.1k An enterprise-class low-code technology stack with scale-out design / 一套面向扩展设计的企业级低代码技术体系
...
- [alibaba/GaiaX](https://github.com/alibaba/GaiaX) topic:android,cross-platform,css,flexbox,ios,kotlin,rust,swift pushed_at:2023-05 star:0.9k fork:0.1k 动态模板引擎是一套轻量化、跨平台、高性能的纯原生移动端卡片渲染动态化解决方案
- [alibaba/p3c](https://github.com/alibaba/p3c) topic: pushed_at:2023-04 star:29.1k fork:8.0k Alibaba Java Coding Guidelines pmd implements and IDE plugin
...
- [alibaba/dtf-cli](https://github.com/alibaba/dtf-cli) topic: pushed_at:2023-05 star:0.0k fork:0.0k 
...
- [alibaba/sreworks-ext](https://github.com/alibaba/sreworks-ext) topic: pushed_at:2023-05 star:0.0k fork:0.0k 
...
- [alibaba/alibaba.alicloud](https://github.com/alibaba/alibaba.alicloud) topic: pushed_at:2023-04 star:0.2k fork:0.1k 
- [alibaba/AliceMind](https://github.com/alibaba/AliceMind) topic:bert,deep-learning,natural-language-processing,nlp pushed_at:2023-05 star:1.7k fork:0.3k ALIbaba's Collection of Encoder-decoders from MinD (Machine IntelligeNce of Damo) Lab
...
- [alibaba/EasyCV](https://github.com/alibaba/EasyCV) topic:classification,computer-vision,object-detection,pytorch,self-supervised-learning,transformers,vision-transformer pushed_at:2023-05 star:1.5k fork:0.2k An all-in-one toolkit for computer vision
...
- [alibaba/feathub](https://github.com/alibaba/feathub) topic:apache-flink,data-engineering,data-science,feature-engineering,feature-store,machine-learning pushed_at:2023-05 star:0.2k fork:0.0k FeatHub - A stream-batch unified feature store for real-time machine learning
- [alibaba/FederatedScope](https://github.com/alibaba/FederatedScope) topic:federated-learning,machine-learning,pytorch pushed_at:2023-05 star:0.9k fork:0.1k An easy-to-use federated learning platform
...
- [alibaba/graphlearn-for-pytorch](https://github.com/alibaba/graphlearn-for-pytorch) topic:deep-learning,distributed,gpu,graph-neural-networks,pytorch pushed_at:2023-05 star:0.0k fork:0.0k A graph learning library for PyTorch that makes distributed GNN training and inference easy and efficient.
...
- [alibaba/lightweight-neural-architecture-search](https://github.com/alibaba/lightweight-neural-architecture-search) topic:automl,classfication,cvpr2023,deepmad,iclr2023,icml-2022,maedet,nas,neurips-2022,object-detection,pytorch,training-free-nas,zennas,zero-cost-nas pushed_at:2023-05 star:0.2k fork:0.0k This is a collection of our zero-cost NAS and efficient vision applications. 
- [alibaba/LucaProt](https://github.com/alibaba/LucaProt) topic: pushed_at:2023-05 star:0.0k fork:0.0k LucaProt: A novel deep learning framework that incorporates protein amino acid sequence and structure information to predict protein function.
...
- [alibaba/HandyJSON](https://github.com/alibaba/HandyJSON) topic:deserialization,json,json-fields,mapping,serialization,swift pushed_at:2023-05 star:4.1k fork:0.6k A handy swift json-object serialization/deserialization library
...
- [alibaba/cloud-charts](https://github.com/alibaba/cloud-charts) topic: pushed_at:2023-05 star:0.4k fork:0.1k 开箱即用的前端图表库，简单配置就能拥有漂亮的可视化图表
...
- [alibaba/formily](https://github.com/alibaba/formily) topic:ant-design,designable,form,form-builder,fusion,json-schema,json-schema-form,low-code,no-code,observable,react,react-form,react-native,reactive,schema-form,validator,vue,vue-form,vue3 pushed_at:2023-05 star:9.6k fork:1.3k 📱🚀 🧩 Cross Device & High Performance Normal Form/Dynamic(JSON Schema) Form/Form Builder -- Support React/React Native/Vue 2/Vue 3
...
- [alibaba/general-scene-interface](https://github.com/alibaba/general-scene-interface) topic:web3d pushed_at:2023-05 star:0.0k fork:0.0k Build Your Web3D Programs With a Paradigm.
...
- [alibaba/hooks](https://github.com/alibaba/hooks) topic:ahooks,hooks-library,react,react-hooks,umi-hooks pushed_at:2023-05 star:11.9k fork:2.2k A high-quality & reliable React Hooks library.
- [alibaba/ice](https://github.com/alibaba/ice) topic:framework,icejs,microfrontends,mpa,nodejs,react,react-router,serverless,spa,ssr,typescript,vite,webpack pushed_at:2023-05 star:17.5k fork:2.1k 🚀 ice.js: The Progressive App Framework Based On React（基于 React 的渐进式应用框架）
- [alibaba/kiwi](https://github.com/alibaba/kiwi) topic:g11n,i18n,intl,translation,typescript pushed_at:2023-04 star:2.3k fork:0.2k 🐤 Kiwi-国际化翻译全流程解决方案
...
- [alibaba/lowcode-demo](https://github.com/alibaba/lowcode-demo) topic:alibaba,low-code,lowcode pushed_at:2023-05 star:1.2k fork:0.4k An enterprise-class low-code technology stack with scale-out design / 一套面向扩展设计的企业级低代码技术体系
- [alibaba/lowcode-engine](https://github.com/alibaba/lowcode-engine) topic:alibaba,low-code,lowcode pushed_at:2023-05 star:11.4k fork:1.9k An enterprise-class low-code technology stack with scale-out design / 一套面向扩展设计的企业级低代码技术体系
- [alibaba/lowcode-engine-ext](https://github.com/alibaba/lowcode-engine-ext) topic:alibaba,low-code,lowcode pushed_at:2023-05 star:0.1k fork:0.1k An enterprise-class low-code technology stack with scale-out design / 一套面向扩展设计的企业级低代码技术体系
- [alibaba/lowcode-graph](https://github.com/alibaba/lowcode-graph) topic: pushed_at:2023-05 star:0.1k fork:0.0k 
- [alibaba/lowcode-materials](https://github.com/alibaba/lowcode-materials) topic:alibaba,low-code,lowcode pushed_at:2023-05 star:0.2k fork:0.1k An enterprise-class low-code technology stack with scale-out design / 一套面向扩展设计的企业级低代码技术体系
- [alibaba/lowcode-plugins](https://github.com/alibaba/lowcode-plugins) topic:alibaba,low-code,lowcode pushed_at:2023-05 star:0.1k fork:0.1k An enterprise-class low-code technology stack with scale-out design / 一套面向扩展设计的企业级低代码技术体系
- [alibaba/MiniOptimizer](https://github.com/alibaba/MiniOptimizer) topic: pushed_at:2023-03 star:0.0k fork:0.0k 
- [alibaba/pipcook](https://github.com/alibaba/pipcook) topic:js,machine-learning,pipeline,tensorflow pushed_at:2023-05 star:2.4k fork:0.2k Machine learning platform for Web developers
- [alibaba/pont](https://github.com/alibaba/pont) topic:mock-data,pont,swagger,typescript pushed_at:2023-05 star:2.9k fork:0.2k 🌉数据服务层解决方案
...
- [alibaba/spatial-data-vis-framework](https://github.com/alibaba/spatial-data-vis-framework) topic:3d,gis,web3d,webgis pushed_at:2023-05 star:0.0k fork:0.0k Layered Spatial Data Vis Framework
- [alibaba/timeline](https://github.com/alibaba/timeline) topic: pushed_at:2023-03 star:0.0k fork:0.0k 
- [alibaba/x-render](https://github.com/alibaba/x-render) topic:ant,ant-design,chart,form,formrender,javascript,json-schema,list,react,table,typescript,webpack,widget pushed_at:2023-05 star:6.0k fork:0.9k 🚴‍♀️ 阿里 - 很易用的中后台「表单 / 表格 / 图表」解决方案
