...
- [alibaba/AliOS-Things](https://github.com/alibaba/AliOS-Things) topic:embedded,haas,haas-python,iot,microcontroller,os,risc-v,rtos pushed_at:2023-01 star:4.4k fork:1.1k 面向IoT领域的、高可伸缩的物联网操作系统，可去官网了解更多信息https://www.aliyun.com/product/aliosthings
...
- [alibaba/tengine](https://github.com/alibaba/tengine) topic:nginx,tengine pushed_at:2023-04 star:11.9k fork:2.5k A distribution of Nginx with some advanced features
...
- [alibaba/async_simple](https://github.com/alibaba/async_simple) topic:asynchronous,coroutines,cpp20,modules pushed_at:2023-03 star:0.8k fork:0.1k Simple, light-weight and easy-to-use asynchronous components 
...
- [alibaba/DeepRec](https://github.com/alibaba/DeepRec) topic:advertising,deep-learning,distributed-training,machine-learning,python,recommendation-engine,scalability,search-engine pushed_at:2023-04 star:0.8k fork:0.3k DeepRec is a high-performance recommendation deep learning framework based on TensorFlow.
...
- [alibaba/graph-learn](https://github.com/alibaba/graph-learn) topic:aligraph,dynamic-graph,dynamic-graph-service,gnn,gnn-framework,gnn-inference,graph,graph-neural-networks,graphlearn,pytorch,tensorflow,training pushed_at:2023-03 star:1.2k fork:0.2k An Industrial Graph Neural Network Framework
...
- [alibaba/havenask](https://github.com/alibaba/havenask) topic: pushed_at:2023-03 star:1.1k fork:0.2k 
...
- [alibaba/higress](https://github.com/alibaba/higress) topic:gateway,gateway-api,ingress,ingress-controller,microservice pushed_at:2023-04 star:1.0k fork:0.2k Next-generation Cloud Native Gateway | 下一代云原生网关
...
- [alibaba/MNN](https://github.com/alibaba/MNN) topic:arm,convolution,deep-learning,deep-neural-networks,embedded-devices,machine-learning,ml,mnn,vulkan,winograd-algorithm pushed_at:2023-03 star:7.5k fork:1.5k MNN is a blazing fast, lightweight deep learning framework, battle-tested by business-critical use cases in Alibaba
...
- [alibaba/PhotonLibOS](https://github.com/alibaba/PhotonLibOS) topic:async-io,coroutine,cpp,fs-library,iouring,kernel-features,libos,net-library,posix,std pushed_at:2023-03 star:0.5k fork:0.1k Write fast and agile C++ programs with Photon!
...
- [alibaba/yalantinglibs](https://github.com/alibaba/yalantinglibs) topic: pushed_at:2023-03 star:0.7k fork:0.1k A collection of C++20 libraries, include coro_rpc, struct_pack, struct_json, struct_pb, easylog, async_simple
...
- [alibaba/alibaba-load-balancer-controller](https://github.com/alibaba/alibaba-load-balancer-controller) topic: pushed_at:2023-02 star:0.0k fork:0.0k 
...
- [alibaba/sentinel-golang](https://github.com/alibaba/sentinel-golang) topic:cloud-native,go,golang,microservice,microservices,middleware,rate-limiting,resiliency pushed_at:2023-04 star:2.3k fork:0.4k Sentinel Go enables reliability and resiliency for Go microservices
...
- [alibaba/tair-go](https://github.com/alibaba/tair-go) topic: pushed_at:2023-03 star:0.0k fork:0.0k A client packaged based on go-redis that operates Tair For Redis Modules.
...
- [alibaba/ARouter](https://github.com/alibaba/ARouter) topic:android,componentization,dependency-injection,interceptor,navigation,router pushed_at:2023-02 star:14.1k fork:2.5k 💪 A framework for assisting in the renovation of Android componentization (帮助 Android App 进行组件化改造的路由框架)
- [alibaba/arthas](https://github.com/alibaba/arthas) topic:agent,alibaba,arthas,classloader,diagnosis,java,jvm,trace,trouble-shooting pushed_at:2023-03 star:32.1k fork:6.9k Alibaba Java Diagnostic Tool Arthas/Alibaba Java诊断利器Arthas
...
- [alibaba/canal](https://github.com/alibaba/canal) topic: pushed_at:2023-04 star:25.4k fork:7.2k 阿里巴巴 MySQL binlog 增量订阅&消费组件 
- [alibaba/Chat2DB](https://github.com/alibaba/Chat2DB) topic:app,database,database-management,database-schema,dba,ddl,electron,h2,java,javascript,mysql,oracle,postgresql,redis,redis-client,sql,sqlite pushed_at:2023-04 star:0.3k fork:0.1k Free multi-platform database tool for developers.(数据库客户端工具)
...
- [alibaba/DataX](https://github.com/alibaba/DataX) topic: pushed_at:2023-04 star:13.2k fork:4.7k DataX是阿里云DataWorks数据集成的开源版本。
...
- [alibaba/druid](https://github.com/alibaba/druid) topic: pushed_at:2023-04 star:26.7k fork:8.4k 阿里云计算平台DataWorks(https://help.aliyun.com/document_detail/137663.html) 团队出品，为监控而生的数据库连接池
...
- [alibaba/havenask-federation](https://github.com/alibaba/havenask-federation) topic: pushed_at:2023-03 star:0.0k fork:0.0k 
...
- [alibaba/jetcache](https://github.com/alibaba/jetcache) topic:cache,java,jcache,redis,spring,spring-cache pushed_at:2023-01 star:3.8k fork:0.9k JetCache is a Java cache framework.
...
- [alibaba/metrics](https://github.com/alibaba/metrics) topic:java,metrics pushed_at:2023-03 star:0.5k fork:0.1k The metrics library for Apache Dubbo and any frameworks or systems.
...
- [alibaba/nacos](https://github.com/alibaba/nacos) topic:alibaba,config,configuration-management,distributed-configuration,dns,dubbo,istio,kubernetes,microservices,nacos,service-discovery,service-mesh,spring-cloud pushed_at:2023-04 star:26.0k fork:11.6k an easy-to-use dynamic service discovery, configuration and service management platform for building cloud native applications.
...
- [alibaba/otter](https://github.com/alibaba/otter) topic: pushed_at:2023-04 star:7.6k fork:2.5k 阿里巴巴分布式数据库同步系统(解决中美异地机房)
...
- [alibaba/camera-proxy](https://github.com/alibaba/camera-proxy) topic: pushed_at:2023-03 star:0.0k fork:0.0k Cross-platform 3D Camera Controller.
...
- [alibaba/easyrobust](https://github.com/alibaba/easyrobust) topic:adversarial-robustness,deep-learning,image-classification,imagenet,pretrained-models,robustness pushed_at:2023-03 star:0.2k fork:0.0k EasyRobust: an Easy-to-use library for state-of-the-art Robust Computer Vision Research with PyTorch.
...
- [alibaba/p3c](https://github.com/alibaba/p3c) topic: pushed_at:2023-03 star:29.0k fork:7.9k Alibaba Java Coding Guidelines pmd implements and IDE plugin
...
- [alibaba/CNStackCommunityEdition](https://github.com/alibaba/CNStackCommunityEdition) topic: pushed_at:2023-03 star:0.1k fork:0.0k CNStack Community Edition
...
- [alibaba/AliceMind](https://github.com/alibaba/AliceMind) topic:bert,deep-learning,natural-language-processing,nlp pushed_at:2023-03 star:1.6k fork:0.3k ALIbaba's Collection of Encoder-decoders from MinD (Machine IntelligeNce of Damo) Lab
...
- [alibaba/EasyCV](https://github.com/alibaba/EasyCV) topic:classification,computer-vision,object-detection,pytorch,self-supervised-learning,transformers,vision-transformer pushed_at:2023-03 star:1.4k fork:0.1k An all-in-one toolkit for computer vision
...
- [alibaba/HybridBackend](https://github.com/alibaba/HybridBackend) topic:deep-learning,gpu,hybrid-parallelism,parquet,recommender-system pushed_at:2023-04 star:0.1k fork:0.0k A high-performance framework for training wide-and-deep recommender systems on heterogeneous cluster
...
- [alibaba/tair-py](https://github.com/alibaba/tair-py) topic: pushed_at:2023-03 star:0.0k fork:0.0k A Python client of Tair based on redis-py
...
- [alibaba/font-toolkit](https://github.com/alibaba/font-toolkit) topic: pushed_at:2023-03 star:0.1k fork:0.0k A Rust 🦀️ font loading, positioning and rendering toolkit
...
- [alibaba/GraphScope](https://github.com/alibaba/GraphScope) topic:analytics,big-data,data-science,graph,graph-analytics,graph-computation,graph-computing,graph-data,graph-neural-networks,gremlin pushed_at:2023-04 star:2.3k fork:0.3k 🔨 🍇 💻 🚀 GraphScope: A One-Stop Large-Scale Graph Computing System from Alibaba 来自阿里巴巴的一站式大规模图计算系统 图分析 图查询 图机器学习
...
- [alibaba/ChatUI](https://github.com/alibaba/ChatUI) topic:chat,chatbot,react,ui pushed_at:2023-04 star:1.7k fork:0.2k The UI design language and React library for Conversational UI
...
- [alibaba/designable](https://github.com/alibaba/designable) topic:builder,designable,designer,editor,form,react pushed_at:2023-03 star:2.7k fork:0.5k 🧩 Make everything designable 🧩 
...
- [alibaba/lowcode-datasource](https://github.com/alibaba/lowcode-datasource) topic:alibaba,low-code,lowcode pushed_at:2023-03 star:0.0k fork:0.0k An enterprise-class low-code technology stack with scale-out design / 一套面向扩展设计的企业级低代码技术体系
...
- [alibaba/lowcode-tools](https://github.com/alibaba/lowcode-tools) topic:alibaba,low-code,lowcode pushed_at:2023-03 star:0.1k fork:0.1k An enterprise-class low-code technology stack with scale-out design / 一套面向扩展设计的企业级低代码技术体系
...
- [alibaba/pont](https://github.com/alibaba/pont) topic:mock-data,pont,swagger,typescript pushed_at:2023-02 star:2.9k fork:0.2k 🌉数据服务层解决方案
...
- [alibaba/x-render](https://github.com/alibaba/x-render) topic:ant,ant-design,chart,form,formrender,javascript,json-schema,list,react,table,typescript,webpack,widget pushed_at:2023-04 star:5.7k fork:0.8k 🚴‍♀️ 阿里 - 很易用的中后台「表单 / 表格 / 图表」解决方案
