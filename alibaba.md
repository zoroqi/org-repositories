...
- [alibaba/AlibabaCloud.TairSDK](https://github.com/alibaba/AlibabaCloud.TairSDK) topic: pushed_at:2023-03 star:0.0k fork:0.0k Based on StackExchange.Redis that operates Tair For Redis Modules.
...
- [alibaba/CicadaPlayer](https://github.com/alibaba/CicadaPlayer) topic:codec,dash,fairplay,ffmpeg,hdr,ll-hls,mediaplayer,webassembly,widevine pushed_at:2023-03 star:0.6k fork:0.2k CicadaPlayer is the player core of AliPlayer, which support multiple platform Android, iOS, macOS, Windows, Linux, and WebAssembly for now. The goal is providing a player core which support multi platform, hardware accelerator, customizable and extensible features. Which support WideVine drm, LL-HLS, MPEG-DASH and HDR playback.
...
- [alibaba/graph-learn](https://github.com/alibaba/graph-learn) topic:aligraph,dynamic-graph,dynamic-graph-service,gnn,gnn-framework,gnn-inference,graph,graph-neural-networks,graphlearn,pytorch,tensorflow,training pushed_at:2023-04 star:1.2k fork:0.2k An Industrial Graph Neural Network Framework
...
- [alibaba/flutter_boost](https://github.com/alibaba/flutter_boost) topic:android,dart,flutter,hybrid-app,hybrid-flutter,ios pushed_at:2023-04 star:6.4k fork:1.1k FlutterBoost is a Flutter plugin which enables hybrid integration of Flutter for your existing native apps with minimum efforts
...
- [alibaba/IOC-golang](https://github.com/alibaba/IOC-golang) topic:annotation,aop,debug,dependency-injection,golang,middleware,monkey,sdk,tag pushed_at:2023-03 star:1.0k fork:0.1k 一款服务于 Go 开发者的依赖注入框架，方便搭建任何 Go 应用。 A Golang depenedency injection framework, helps developers to build any go application.
...
- [alibaba/RedisShake](https://github.com/alibaba/RedisShake) topic:redis,redis-cluster,redis-proxy pushed_at:2023-04 star:3.0k fork:0.6k redis-shake is a tool for Redis data migration and data filtering. redis-shake 是一个用于 Redis 数据迁移与过滤的工具。
...
- [alibaba/ARouter](https://github.com/alibaba/ARouter) topic:android,componentization,dependency-injection,interceptor,navigation,router pushed_at:2023-02 star:14.2k fork:2.5k 💪 A framework for assisting in the renovation of Android componentization (帮助 Android App 进行组件化改造的路由框架)
- [alibaba/arthas](https://github.com/alibaba/arthas) topic:agent,alibaba,arthas,classloader,diagnosis,java,jvm,trace,trouble-shooting pushed_at:2023-03 star:32.2k fork:6.9k Alibaba Java Diagnostic Tool Arthas/Alibaba Java诊断利器Arthas
...
- [alibaba/bytekit](https://github.com/alibaba/bytekit) topic: pushed_at:2023-03 star:0.3k fork:0.1k Java Bytecode Kit
- [alibaba/canal](https://github.com/alibaba/canal) topic: pushed_at:2023-04 star:25.5k fork:7.2k 阿里巴巴 MySQL binlog 增量订阅&消费组件 
- [alibaba/Chat2DB](https://github.com/alibaba/Chat2DB) topic:ai,chatgpt,database,database-management,dba,electron,java,javascript,mysql,oracle,postgresql,redis,redis-client,sql,sqlite pushed_at:2023-04 star:0.3k fork:0.1k Free multi-platform database tool for developers.(数据库客户端工具)
...
- [alibaba/COLA](https://github.com/alibaba/COLA) topic:architecture,clean,cola pushed_at:2023-04 star:9.5k fork:2.5k 🥤 COLA: Clean Object-oriented & Layered Architecture
...
- [alibaba/easyexcel](https://github.com/alibaba/easyexcel) topic:excel,java,jxl,oom,poi,xls,xlsx pushed_at:2023-04 star:27.4k fork:7.0k 快速、简洁、解决大文件内存溢出的java处理Excel工具
...
- [alibaba/jvm-sandbox-repeater](https://github.com/alibaba/jvm-sandbox-repeater) topic: pushed_at:2023-02 star:2.1k fork:0.6k  A Java server-side recording and playback solution based on JVM-Sandbox
...
- [alibaba/one-java-agent](https://github.com/alibaba/one-java-agent) topic: pushed_at:2023-03 star:0.4k fork:0.1k 
...
- [alibaba/Sentinel](https://github.com/alibaba/Sentinel) topic:alibaba,circuit-breaker,cloud-native,java,microservice,microservices,rate-limiting,reliability,resiliency pushed_at:2023-04 star:20.8k fork:7.5k A powerful flow control component enabling reliability, resilience and monitoring for microservices. (面向云原生微服务的高可用流控防护组件)
...
- [alibaba/SmartEngine](https://github.com/alibaba/SmartEngine) topic: pushed_at:2023-03 star:0.6k fork:0.2k SmartEngine is a lightweight business orchestration engine.
...
- [alibaba/spring-cloud-alibaba](https://github.com/alibaba/spring-cloud-alibaba) topic:alibaba,alibaba-middleware,alibaba-oss,aliyun,circuit-breaker,cloud-native,distributed-configuration,distributed-messaging,distributed-transaction,dubbo,java,microservices,nacos,rocketmq,service-discovery,service-registry,spring,spring-cloud,spring-cloud-alibaba,spring-cloud-core pushed_at:2023-04 star:25.3k fork:7.7k Spring Cloud Alibaba provides a one-stop solution for application development for the distributed solutions of Alibaba middleware.
- [alibaba/spring-context-support](https://github.com/alibaba/spring-context-support) topic:alibaba,java,spring,spring-context,spring-framework pushed_at:2023-03 star:0.1k fork:0.1k An internal support project for spring-context in Alibaba 
...
- [alibaba/schema-plugin-flow](https://github.com/alibaba/schema-plugin-flow) topic:ant-design,ant-design-vue,drag-and-drop,extend-plugins,extensible,form,fusion,js-framework,low-code,plugin,react,react-drag-and-drop,schema,schema-plugin-flow,schema-render,sifo,vue,vue-drag-and-drop pushed_at:2023-01 star:0.4k fork:0.0k A highly extensible JavaScript library, abbreviated as Sifo. 一个高扩展性、可二开的插件式前端开发框架
...
- [alibaba/uirecorder](https://github.com/alibaba/uirecorder) topic:nodejs,recorder,selenium,uitest,webdriver pushed_at:2023-03 star:2.0k fork:0.4k UI Recorder is a  multi-platform UI test recorder.
...
- [alibaba/web-editor](https://github.com/alibaba/web-editor) topic:atx,editor,web pushed_at:2023-03 star:0.9k fork:0.3k web editor for atx
...
- [alibaba/LucaProt](https://github.com/alibaba/LucaProt) topic: pushed_at:2023-04 star:0.0k fork:0.0k 
...
- [alibaba/sreworks-ext](https://github.com/alibaba/sreworks-ext) topic: pushed_at:2023-03 star:0.0k fork:0.0k 
...
- [alibaba/lightweight-neural-architecture-search](https://github.com/alibaba/lightweight-neural-architecture-search) topic:automl,classfication,cvpr2023,deepmad,iclr2023,icml2022,maedet,nas,neurips-2022,object-detection,pytorch,training-free-nas,zennas,zero-cost-nas pushed_at:2023-03 star:0.2k fork:0.0k This is a collection of our zero-cost NAS and efficient vision applications. 
...
- [alibaba/formily](https://github.com/alibaba/formily) topic:ant-design,designable,form,form-builder,fusion,json-schema,json-schema-form,low-code,no-code,observable,react,react-form,react-native,reactive,schema-form,validator,vue,vue-form,vue3 pushed_at:2023-04 star:9.4k fork:1.3k 📱🚀 🧩 Cross Device & High Performance Normal Form/Dynamic(JSON Schema) Form/Form Builder -- Support React/React Native/Vue 2/Vue 3
...
- [alibaba/lowcode-engine](https://github.com/alibaba/lowcode-engine) topic:alibaba,low-code,lowcode pushed_at:2023-04 star:11.1k fork:1.9k An enterprise-class low-code technology stack with scale-out design / 一套面向扩展设计的企业级低代码技术体系
