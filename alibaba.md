...
- [alibaba/BladeDISC](https://github.com/alibaba/BladeDISC) topic:compiler,deep-learning,machine-learning,pytorch,tensorflow pushed_at:2022-09 star:0.4k fork:0.1k BladeDISC is an end-to-end DynamIc Shape Compiler project for machine learning workloads.
...
- [alibaba/DeepRec](https://github.com/alibaba/DeepRec) topic:advertising,deep-learning,distributed-training,machine-learning,python,recommendation-engine,scalability,search-engine pushed_at:2022-09 star:0.6k fork:0.2k DeepRec is a recommendation engine based on TensorFlow.
...
- [alibaba/graph-learn](https://github.com/alibaba/graph-learn) topic:aligraph,dynamic-graph,gnn,gnn-framework,graph,graph-neural-networks,graphlearn,inference,pytorch,tensorflow,training pushed_at:2022-09 star:1.1k fork:0.2k An Industrial Graph Neural Network Framework
...
- [alibaba/heterogeneity-aware-lowering-and-optimization](https://github.com/alibaba/heterogeneity-aware-lowering-and-optimization) topic: pushed_at:2022-09 star:0.2k fork:0.1k heterogeneity-aware-lowering-and-optimization
...
- [alibaba/ilogtail](https://github.com/alibaba/ilogtail) topic:aliyun,apm,cloud-native,ebpf,observability,sls pushed_at:2022-09 star:0.9k fork:0.2k Fast and Lightweight Observability Data Collector
...
- [alibaba/MNN](https://github.com/alibaba/MNN) topic:arm,convolution,deep-learning,deep-neural-networks,embedded-devices,machine-learning,ml,mnn,vulkan,winograd-algorithm pushed_at:2022-09 star:7.0k fork:1.4k MNN is a blazing fast, lightweight deep learning framework, battle-tested by business-critical use cases in Alibaba
...
- [alibaba/flutter-go](https://github.com/alibaba/flutter-go) topic:dart,flutter,flutter-demo,flutter-doc pushed_at:2021-05 star:23.2k fork:3.7k flutter 开发者帮助 APP，包含 flutter 常用 140+ 组件的demo 演示与中文文档
...
- [alibaba/derrick](https://github.com/alibaba/derrick) topic: pushed_at:2022-07 star:0.7k fork:0.1k 🐳A tool to help you containerize application in seconds
...
- [alibaba/hybridnet](https://github.com/alibaba/hybridnet) topic:bgp,cni,cni-plugin,container,hybrid-cloud,kubernetes,kubernetes-networking,networking,overlay-network,sdn,vlan,vxlan pushed_at:2022-09 star:0.1k fork:0.0k A CNI plugin, provides networking environment where overlay and underlay containers can run on the same node and have cluster-wide bidirectional network connectivity.
...
- [alibaba/open-local](https://github.com/alibaba/open-local) topic:cloud-native,csi,kubernetes,localstorage,lvm,snapshot,storage pushed_at:2022-09 star:0.3k fork:0.1k cloud-native local storage management system
...
- [alibaba/tair-go](https://github.com/alibaba/tair-go) topic: pushed_at:2022-09 star:0.0k fork:0.0k A client packaged based on go-redis that operates Tair For Redis Modules.
...
- [alibaba/AGEIPort](https://github.com/alibaba/AGEIPort) topic: pushed_at:2022-09 star:0.0k fork:0.0k 
...
- [alibaba/arthas](https://github.com/alibaba/arthas) topic:agent,alibaba,arthas,classloader,diagnosis,java,jvm,trace,trouble-shooting pushed_at:2022-08 star:30.4k fork:6.6k Alibaba Java Diagnostic Tool Arthas/Alibaba Java诊断利器Arthas
...
- [alibaba/canal](https://github.com/alibaba/canal) topic: pushed_at:2022-09 star:24.0k fork:6.9k 阿里巴巴 MySQL binlog 增量订阅&消费组件 
...
- [alibaba/COLA](https://github.com/alibaba/COLA) topic:architecture,clean,cola pushed_at:2022-09 star:8.3k fork:2.2k 🥤 COLA: Clean Object-oriented & Layered Architecture
...
- [alibaba/DataX](https://github.com/alibaba/DataX) topic: pushed_at:2022-08 star:11.9k fork:4.3k DataX是阿里云DataWorks数据集成的开源版本。
...
- [alibaba/dragonwell11](https://github.com/alibaba/dragonwell11) topic: pushed_at:2022-09 star:0.5k fork:0.1k Alibaba Dragonwell11 JDK
...
- [alibaba/druid](https://github.com/alibaba/druid) topic: pushed_at:2022-09 star:26.0k fork:8.2k 阿里云计算平台DataWorks(https://help.aliyun.com/document_detail/137663.html) 团队出品，为监控而生的数据库连接池
...
- [alibaba/easyexcel](https://github.com/alibaba/easyexcel) topic:excel,java,jxl,oom,poi,xls,xlsx pushed_at:2022-08 star:24.9k fork:6.6k 快速、简洁、解决大文件内存溢出的java处理Excel工具
...
- [alibaba/GraphScope](https://github.com/alibaba/GraphScope) topic:graph,graph-analytics,graph-computation,graph-computing,graph-data,graph-neural-networks,gremlin pushed_at:2022-09 star:1.8k fork:0.2k 🔨 🍇 💻 🚀 GraphScope: A One-Stop Large-Scale Graph Computing System from Alibaba 来自阿里巴巴的一站式大规模图计算系统 图分析 图查询 图机器学习
...
- [alibaba/jetcache](https://github.com/alibaba/jetcache) topic:cache,java,jcache,redis,spring,spring-cache pushed_at:2022-09 star:3.6k fork:0.8k JetCache is a Java cache framework.
...
- [alibaba/jvm-sandbox](https://github.com/alibaba/jvm-sandbox) topic: pushed_at:2022-09 star:5.0k fork:1.3k Real - time non-invasive AOP framework container based on JVM
...
- [alibaba/nacos](https://github.com/alibaba/nacos) topic:alibaba,config,configuration-management,distributed-configuration,dns,dubbo,istio,kubernetes,microservices,nacos,service-discovery,service-mesh,spring-cloud pushed_at:2022-09 star:23.8k fork:10.6k an easy-to-use dynamic service discovery, configuration and service management platform for building cloud native applications.
...
- [alibaba/RemoteShuffleService](https://github.com/alibaba/RemoteShuffleService) topic: pushed_at:2022-09 star:0.2k fork:0.1k 
...
- [alibaba/Sentinel](https://github.com/alibaba/Sentinel) topic:alibaba,circuit-breaker,hacktoberfest,java,microservice,rate-limiting,reliability pushed_at:2022-09 star:19.8k fork:7.1k A powerful flow control component enabling reliability, resilience and monitoring for microservices. (面向云原生微服务的高可用流控防护组件)
...
- [alibaba/spring-cloud-alibaba](https://github.com/alibaba/spring-cloud-alibaba) topic:alibaba,alibaba-middleware,alibaba-oss,aliyun,circuit-breaker,cloud-native,distributed-configuration,distributed-messaging,distributed-transaction,dubbo,java,microservices,nacos,rocketmq,service-discovery,service-registry,spring,spring-cloud,spring-cloud-alibaba,spring-cloud-core pushed_at:2022-08 star:23.5k fork:7.2k Spring Cloud Alibaba provides a one-stop solution for application development for the distributed solutions of Alibaba middleware.
...
- [alibaba/SREWorks](https://github.com/alibaba/SREWorks) topic:aiops,application,cloud-native,cloudnative,dataops,devops,engineering,k8s,kubernetes,maintenance,oam,operation,ops,saas,sre pushed_at:2022-09 star:0.9k fork:0.2k Cloud Native DataOps & AIOps Platform | 云原生运维平台 | 一站式数据化、智能化运维SaaS应用套件（交付、监测、管理、控制、运营、服务）
...
- [alibaba/butterfly](https://github.com/alibaba/butterfly) topic:bpmn,butterfly,connectivity,dag,diagram,diagramming,edge,flow,flow-dag,flow-layout,flowchart,mindmap,react,svg,tree,treemap-diagram,vue pushed_at:2022-09 star:3.1k fork:0.5k 🦋Butterfly，A JavaScript/React/Vue2 Diagramming library which concentrate on flow layout field.    (基于JavaScript/React/Vue2的流程图组件)
...
- [alibaba/react-intl-universal](https://github.com/alibaba/react-intl-universal) topic: pushed_at:2022-09 star:1.2k fork:0.2k Internationalize React apps. Not only for React.Component but also for Vanilla JS.
...
- [alibaba/x-render](https://github.com/alibaba/x-render) topic:ant,ant-design,chart,form,formrender,javascript,json-schema,list,react,table,typescript,webpack,widget pushed_at:2022-09 star:4.9k fork:0.7k 🚴‍♀️ 阿里 - 很易用的中后台「表单 / 表格 / 图表」解决方案
...
- [alibaba/AliceMind](https://github.com/alibaba/AliceMind) topic:bert,deep-learning,natural-language-processing,nlp pushed_at:2022-09 star:1.2k fork:0.2k ALIbaba's Collection of Encoder-decoders from MinD (Machine IntelligeNce of Damo) Lab
...
- [alibaba/EasyCV](https://github.com/alibaba/EasyCV) topic:classification,computer-vision,object-detection,pytorch,self-supervised-learning,transformers,vision-transformer pushed_at:2022-09 star:0.4k fork:0.1k An all-in-one toolkit for computer vision
...
- [alibaba/EasyNLP](https://github.com/alibaba/EasyNLP) topic:bert,deep-learning,knowledge-pretrain,nlp,pretrained-models,pytorch,transformers pushed_at:2022-09 star:0.9k fork:0.1k EasyNLP: A Comprehensive and Easy-to-use NLP Toolkit
...
- [alibaba/Elastic-Federated-Learning-Solution](https://github.com/alibaba/Elastic-Federated-Learning-Solution) topic: pushed_at:2022-08 star:0.1k fork:0.0k 
...
- [alibaba/FederatedScope](https://github.com/alibaba/FederatedScope) topic:federated-learning,machine-learning,pytorch pushed_at:2022-09 star:0.6k fork:0.1k An easy-to-use federated learning platform
...
- [alibaba/tair-py](https://github.com/alibaba/tair-py) topic: pushed_at:2022-08 star:0.0k fork:0.0k A Python client of Tair based on redis-py
...
- [alibaba/TinyNeuralNetwork](https://github.com/alibaba/TinyNeuralNetwork) topic:deep-learning,model-compression,model-converter,pruning,pytorch,quantization-aware-training pushed_at:2022-09 star:0.4k fork:0.1k TinyNeuralNetwork is an efficient and easy-to-use deep learning model compression framework.
...
- [alibaba/GaiaX](https://github.com/alibaba/GaiaX) topic:android,cross-platform,css,flexbox,ios,kotlin,rust,swift pushed_at:2022-09 star:0.6k fork:0.1k GaiaX动态模板引擎是一套轻量化、跨平台、高性能的纯原生移动端卡片渲染动态化解决方案
...
- [alibaba/SparkCube](https://github.com/alibaba/SparkCube) topic: pushed_at:2022-07 star:0.1k fork:0.1k SparkCube is an open-source project for extremely fast OLAP data analysis. SparkCube is an extension of Apache Spark.
...
- [alibaba/ChatUI](https://github.com/alibaba/ChatUI) topic:chat,chatbot,react,ui pushed_at:2022-09 star:1.4k fork:0.1k The UI design language and React library for Conversational UI
...
- [alibaba/formily](https://github.com/alibaba/formily) topic:ant-design,designable,form,form-builder,fusion,json-schema,json-schema-form,low-code,no-code,observable,react,react-form,react-native,reactive,schema-form,validator,vue,vue-form,vue3 pushed_at:2022-09 star:8.4k fork:1.2k 📱🚀 🧩 Cross Device & High Performance Normal Form/Dynamic(JSON Schema) Form/Form Builder -- Support React/React Native/Vue 2/Vue 3
...
- [alibaba/hooks](https://github.com/alibaba/hooks) topic:ahooks,hooks-library,react,react-hooks,umi-hooks pushed_at:2022-09 star:10.3k fork:1.8k A high-quality & reliable React Hooks library.
- [alibaba/ice](https://github.com/alibaba/ice) topic:framework,icejs,microfrontends,mpa,nodejs,react,react-router,serverless,spa,ssr,typescript,vite,webpack pushed_at:2022-09 star:17.3k fork:2.1k 🚀 Icejs: The Progressive App Framework Based On React（基于 React 的渐进式应用框架）
...
- [alibaba/lowcode-engine](https://github.com/alibaba/lowcode-engine) topic:alibaba,low-code,lowcode pushed_at:2022-09 star:7.8k fork:1.3k An enterprise-class low-code technology stack with scale-out design / 一套面向扩展设计的企业级低代码技术体系
- [alibaba/lowcode-engine-ext](https://github.com/alibaba/lowcode-engine-ext) topic:alibaba,low-code,lowcode pushed_at:2022-09 star:0.1k fork:0.1k An enterprise-class low-code technology stack with scale-out design / 一套面向扩展设计的企业级低代码技术体系
...
- [alibaba/pipcook](https://github.com/alibaba/pipcook) topic:js,machine-learning,pipeline,tensorflow pushed_at:2022-09 star:2.3k fork:0.2k Machine learning platform for Web developers
