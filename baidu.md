...
- [baidu/du1906_esp](https://github.com/baidu/du1906_esp) pushed_at:2021-04 star:0.0k fork:0.0k DUHOME AIOT platform based on du1906 and esp32
...
- [baidu/AnyQ](https://github.com/baidu/AnyQ) pushed_at:2020-11 star:2.2k fork:0.6k FAQ-based Question Answering System
- [baidu/BaikalDB](https://github.com/baidu/BaikalDB) pushed_at:2021-04 star:0.7k fork:0.1k BaikalDB, A Distributed HTAP Database.
...
- [baidu/braft](https://github.com/baidu/braft) pushed_at:2021-04 star:2.6k fork:0.6k An industrial-grade C++ implementation of RAFT consensus algorithm based on brpc,  widely used inside Baidu to build highly-available distributed systems.
...
- [baidu/openrasp](https://github.com/baidu/openrasp) pushed_at:2021-04 star:1.8k fork:0.4k 🔥Open source RASP solution
...
- [baidu/go-lib](https://github.com/baidu/go-lib) pushed_at:2021-03 star:0.1k fork:0.0k 
...
- [baidu/brcc](https://github.com/baidu/brcc) pushed_at:2021-04 star:0.2k fork:0.0k BRCC（better remote config center）是一个分布式配置中心，用于统一管理应用服务的配置信息，避免各类资源散落在各个项目中，简化资源配置的维护成本。作为一种轻量级的解决方案，部署简单，同时支持多环境、多版本、多角色的资源管理，可以在不改变应用源码的情况下无缝切换和实时生效配置信息。
- [baidu/brpc-java](https://github.com/baidu/brpc-java) pushed_at:2020-10 star:0.7k fork:0.2k Java implementation for Baidu RPC, multi-protocol & high performance RPC.
...
- [baidu/NoahV](https://github.com/baidu/NoahV) pushed_at:2021-04 star:0.6k fork:0.1k An efficient front-end application framework based on vue.js
...
- [baidu/san-store](https://github.com/baidu/san-store) pushed_at:2021-03 star:0.1k fork:0.0k Application States Management for San
...
- [baidu/bfe-book](https://github.com/baidu/bfe-book) pushed_at:2021-04 star:0.0k fork:0.0k 《深入理解BFE》（Book for opensource project BFE, in Chinese）
...
- [baidu/Senta](https://github.com/baidu/Senta) pushed_at:2020-08 star:1.2k fork:0.3k Baidu's open-source Sentiment Analysis System.
...
- [baidu/m-git](https://github.com/baidu/m-git) pushed_at:2021-04 star:0.1k fork:0.0k MGit 是一款基于 Git 的多仓库管理工具，可以安全的、高效的管理多个 Git 仓库； 适合于在多个仓库中进行关联开发的项目，实现批量的版本管理功能，提高 Git 操作的效率，避免逐个执行 Git 命令带来的误操作风险。

## TypeScript

- [baidu/amis](https://github.com/baidu/amis) pushed_at:2021-04 star:6.7k fork:0.9k 前端低代码框架，通过 JSON 配置就能生成各种页面。
