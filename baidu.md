...
- [baidu/dperf](https://github.com/baidu/dperf) topic:dpdk,dpvs,http,ipv6,load-tester,lvs,nginx,packet-loss,performance,tcp,udp,vlan,vxlan pushed_at:2023-06 star:3.0k fork:0.3k dperf is a DPDK based 100Gbps network performance and load testing software.
...
- [baidu/BaikalDB](https://github.com/baidu/BaikalDB) topic:baikaldb,database,htap,mysql,raft,sql pushed_at:2023-05 star:1.1k fork:0.2k BaikalDB, A Distributed HTAP Database.
...
- [baidu/bifromq-docs](https://github.com/baidu/bifromq-docs) topic: pushed_at:2023-06 star:0.0k fork:0.0k 
...
- [baidu/bifromq](https://github.com/baidu/bifromq) topic: pushed_at:2023-06 star:0.0k fork:0.0k A MQTT broker implementation using serverless architecture
...
- [baidu/starlight](https://github.com/baidu/starlight) topic:brpc,high-performance,microservice,netty,protobuf,rpc,spring-boot,spring-cloud pushed_at:2023-06 star:0.9k fork:0.3k Java implementation for Baidu RPC, multi-protocol & high performance RPC.
...
- [baidu/san](https://github.com/baidu/san) topic:component,framework,frontend,javascript,mvvm,san pushed_at:2023-05 star:4.7k fork:0.6k A fast, portable, flexible JavaScript component framework
...
- [baidu/san-store](https://github.com/baidu/san-store) topic:appstate,san pushed_at:2023-05 star:0.1k fork:0.0k Application States Management for San
...
- [baidu/CUP](https://github.com/baidu/CUP) topic:common-libraries,common-libs,library,python pushed_at:2023-05 star:0.9k fork:0.2k CUP, common useful python-lib.  (Currently, Most popular python lib in baidu).  Python 开发底层库, 涵盖util、service(threadpool/generator/executor/cache等等)、logging、monitoring、增强型配置 等等库支持
...
- [baidu/QCompute](https://github.com/baidu/QCompute) topic: pushed_at:2023-04 star:0.1k fork:0.0k QCompute is a Python-based quantum software development kit (SDK). It provides a full-stack programming experience for advanced users via hybrid quantum programming language features and a high-performance simulator.
...
- [baidu/CarbonGraph](https://github.com/baidu/CarbonGraph) topic:component-architecture,dependency-injection,di-container,dsl,ioc,ioc-container,ios,objective-c,swift pushed_at:2023-05 star:0.2k fork:0.0k A Swift dependency injection / lookup framework for iOS

## TypeScript

- [baidu/amis](https://github.com/baidu/amis) topic:frontend,frontend-framework,json,low-code,low-code-development-platform,lowcode,no-code pushed_at:2023-06 star:14.1k fork:2.0k 前端低代码框架，通过 JSON 配置就能生成各种页面。
...
- [baidu/san-ssr](https://github.com/baidu/san-ssr) topic:san,ssr,ssr-target-js pushed_at:2023-06 star:0.0k fork:0.0k San SSR framework and utils
