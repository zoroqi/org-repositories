...
- [baidu/dperf](https://github.com/baidu/dperf) topic:dpdk,dpvs,http,ipv6,load-tester,lvs,nginx,packet-loss,performance,tcp,udp,vlan,vxlan pushed_at:2024-01 star:4.0k fork:0.4k dperf is a 100Gbps network load tester.
...
- [baidu/lac](https://github.com/baidu/lac) topic:chinese-nlp,chinese-word-segmentation,java,lexical-analysis,named-entity-recognition,part-of-speech-tagger,python,word-segmentation pushed_at:2021-05 star:3.7k fork:0.6k 百度NLP：分词，词性标注，命名实体识别，词重要性
- [baidu/openrasp](https://github.com/baidu/openrasp) topic:devsecops,iast,rasp,security,waf pushed_at:2024-01 star:2.6k fork:0.6k 🔥Open source RASP solution
...
- [baidu/starlight](https://github.com/baidu/starlight) topic:brpc,high-performance,microservice,netty,protobuf,rpc,spring-boot,spring-cloud pushed_at:2024-01 star:0.9k fork:0.3k Java implementation for Baidu RPC, multi-protocol & high performance RPC.
...
- [baidu/san](https://github.com/baidu/san) topic:component,framework,frontend,javascript,mvvm,san pushed_at:2024-01 star:4.7k fork:0.6k A fast, portable, flexible JavaScript component framework
...
- [baidu/amis](https://github.com/baidu/amis) topic:admin,frontend,frontend-framework,json,low-code,low-code-development-platform,lowcode,no-code pushed_at:2024-01 star:15.6k fork:2.3k 前端低代码框架，通过 JSON 配置就能生成各种页面。
