...
- [baidu/dperf](https://github.com/baidu/dperf) topic:dpdk,dpvs,http,ipv6,load-tester,lvs,nginx,packet-loss,performance,tcp,udp,vlan,vxlan pushed_at:2024-07 star:4.6k fork:0.5k dperf is a 100Gbps network load tester.
...
- [baidu/babylon](https://github.com/baidu/babylon) topic: pushed_at:2024-07 star:0.4k fork:0.1k High-Performance C++ Fundamental Library
...
- [baidu/openrasp](https://github.com/baidu/openrasp) topic:devsecops,iast,rasp,security,waf pushed_at:2024-06 star:2.7k fork:0.6k 🔥Open source RASP solution
...
- [baidu/san](https://github.com/baidu/san) topic:component,framework,frontend,javascript,mvvm,san pushed_at:2024-06 star:4.7k fork:0.5k A fast, portable, flexible JavaScript component framework
...
- [baidu/pymochow](https://github.com/baidu/pymochow) topic: pushed_at:2024-07 star:0.0k fork:0.0k 
...
- [baidu/amis](https://github.com/baidu/amis) topic:admin,frontend,frontend-framework,json,low-code,low-code-development-platform,lowcode,no-code pushed_at:2024-07 star:16.6k fork:2.4k 前端低代码框架，通过 JSON 配置就能生成各种页面。
