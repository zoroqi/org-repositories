...
- [baidu/BaikalDB](https://github.com/baidu/BaikalDB) topic:baikaldb,database,htap,mysql,raft,sql pushed_at:2026-06 star:1.2k fork:0.2k BaikalDB, A Distributed HTAP Database.
...
- [baidu/CUP](https://github.com/baidu/CUP) topic:common-libraries,common-libs,library,python pushed_at:2026-06 star:0.9k fork:0.2k CUP, common useful python-lib.  (Currently, Most popular python lib in baidu).  Python 开发底层库, 涵盖util、service(threadpool/generator/executor/cache等等)、logging、monitoring、增强型配置 等等库支持
...
- [baidu/Unlimited-OCR](https://github.com/baidu/Unlimited-OCR) topic: pushed_at:2026-07 star:21.1k fork:2.1k Unlimited OCR Works: Welcome the Era of One-shot Long-horizon Parsing.
- [baidu/vLLM-Kunlun](https://github.com/baidu/vLLM-Kunlun) topic: pushed_at:2026-07 star:0.5k fork:0.1k vLLM Kunlun (vllm-kunlun) is a community-maintained hardware plugin designed to seamlessly run vLLM on the Kunlun XPU.
...
- [baidu/cosui](https://github.com/baidu/cosui) topic:agent,ai,ai-ui,chatbot,frontend,generative-ui,json,markdown,protocol,ui-library,uikit pushed_at:2026-06 star:0.1k fork:0.0k A frontend UI solution for the AI era. Includes UI protocols, rendering SDKs, and component libraries for Generative UI, AI Agents, and LLM-powered applications.
