...
- [baidu/dperf](https://github.com/baidu/dperf) topic:dpdk,dpvs,http,ipv6,load-tester,lvs,nginx,packet-loss,performance,tcp,udp,vlan,vxlan pushed_at:2022-10 star:1.3k fork:0.2k dperf is a DPDK based 100Gbps network performance and load testing software.
...
- [baidu/AnyQ](https://github.com/baidu/AnyQ) topic:dialogue,dialogue-systems,faq,faq-question-answering-system,faq-system,faqbot,qa-system,question-answering,semantic-matching pushed_at:2020-11 star:2.4k fork:0.7k FAQ-based Question Answering System
- [baidu/BaikalDB](https://github.com/baidu/BaikalDB) topic:baikaldb,database,htap,mysql,raft,sql pushed_at:2022-11 star:1.0k fork:0.1k BaikalDB, A Distributed HTAP Database.
...
- [baidu/lac](https://github.com/baidu/lac) topic:chinese-nlp,chinese-word-segmentation,java,lexical-analysis,named-entity-recognition,part-of-speech-tagger,python,word-segmentation pushed_at:2021-05 star:3.3k fork:0.5k 百度NLP：分词，词性标注，命名实体识别，词重要性
- [baidu/openrasp](https://github.com/baidu/openrasp) topic:devsecops,iast,rasp,security,waf pushed_at:2022-11 star:2.3k fork:0.6k 🔥Open source RASP solution
...
- [baidu/iotcore-sdk-java](https://github.com/baidu/iotcore-sdk-java) topic: pushed_at:2022-11 star:0.0k fork:0.0k Java SDK  for baidu IoT Core service 
- [baidu/ipipe-agent](https://github.com/baidu/ipipe-agent) topic: pushed_at:2020-10 star:0.0k fork:0.0k 
- [baidu/Jprotobuf-rpc-socket](https://github.com/baidu/Jprotobuf-rpc-socket) topic: pushed_at:2022-11 star:0.5k fork:0.2k Protobuf RPC是一种基于TCP协议的二进制RPC通信协议的Java实现
...
- [baidu/starlight](https://github.com/baidu/starlight) topic:brpc,high-performance,microservice,netty,protobuf,rpc,spring-boot,spring-cloud pushed_at:2022-11 star:0.9k fork:0.3k Java implementation for Baidu RPC, multi-protocol & high performance RPC.
...
- [baidu/uid-generator](https://github.com/baidu/uid-generator) topic: pushed_at:2022-10 star:4.9k fork:1.5k UniqueID generator

## JavaScript

- [baidu/BIPlatform](https://github.com/baidu/BIPlatform) topic: pushed_at:2019-03 star:0.2k fork:0.1k 
...
- [baidu/grafana-tsdb-datasource](https://github.com/baidu/grafana-tsdb-datasource) topic:grafana,grafana-datasource,grafana-plugin pushed_at:2022-11 star:0.0k fork:0.0k 
...
- [baidu/san](https://github.com/baidu/san) topic:component,framework,frontend,javascript,mvvm,san pushed_at:2022-11 star:4.6k fork:0.5k A fast, portable, flexible JavaScript component framework
...
- [baidu/san-router](https://github.com/baidu/san-router) topic:san pushed_at:2022-11 star:0.0k fork:0.0k Official Router for San
- [baidu/san-store](https://github.com/baidu/san-store) topic:appstate,san pushed_at:2022-11 star:0.1k fork:0.0k Application States Management for San
- [baidu/san-update](https://github.com/baidu/san-update) topic:san pushed_at:2022-08 star:0.1k fork:0.0k Object immutable update utility for san solution
- [baidu/san-website](https://github.com/baidu/san-website) topic: pushed_at:2022-08 star:0.0k fork:0.1k 
...
- [baidu/spring-cloud-baidu](https://github.com/baidu/spring-cloud-baidu) topic: pushed_at:2022-10 star:0.1k fork:0.0k 
...
- [baidu/baiduads-sdk](https://github.com/baidu/baiduads-sdk) topic:ads,baidu,sdk pushed_at:2022-11 star:0.0k fork:0.0k Baidu Ads API SDK
- [baidu/broc](https://github.com/baidu/broc) topic: pushed_at:2017-12 star:0.1k fork:0.1k 
- [baidu/CUP](https://github.com/baidu/CUP) topic:common-libraries,common-libs,library,python pushed_at:2022-11 star:0.9k fork:0.2k CUP, common useful python-lib.  (Currently, Most popular python lib in baidu).  Python 开发底层库, 涵盖util、service(threadpool/generator/executor/cache等等)、logging、monitoring、增强型配置 等等库支持
- [baidu/DDParser](https://github.com/baidu/DDParser) topic:chinese-dependency-parser,chinese-nlp,dependency-parser,dependency-parsing,python,syntax-parser pushed_at:2022-10 star:0.8k fork:0.2k 百度开源的依存句法分析系统
...
- [baidu/QCompute](https://github.com/baidu/QCompute) topic: pushed_at:2022-11 star:0.1k fork:0.0k QCompute is a Python-based quantum software development kit (SDK). It provides a full-stack programming experience for advanced users via hybrid quantum programming language features and a high-performance simulator.
...
- [baidu/amis](https://github.com/baidu/amis) topic:frontend,frontend-framework,json,low-code,low-code-development-platform,lowcode,no-code pushed_at:2022-11 star:12.5k fork:1.8k 前端低代码框架，通过 JSON 配置就能生成各种页面。
...
- [baidu/san-ssr](https://github.com/baidu/san-ssr) topic:san,ssr,ssr-target-js pushed_at:2022-11 star:0.0k fork:0.0k San SSR framework and utils
