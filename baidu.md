...
- [baidu/dperf](https://github.com/baidu/dperf) topic:dpdk,dpvs,http,ipv6,load-tester,lvs,nginx,packet-loss,performance,tcp,udp,vlan,vxlan pushed_at:2024-04 star:4.4k fork:0.5k dperf is a 100Gbps network load tester.
...
- [baidu/babylon](https://github.com/baidu/babylon) topic: pushed_at:2024-04 star:0.2k fork:0.0k High-Performance C++ Fundamental Library
- [baidu/BaikalDB](https://github.com/baidu/BaikalDB) topic:baikaldb,database,htap,mysql,raft,sql pushed_at:2024-04 star:1.1k fork:0.2k BaikalDB, A Distributed HTAP Database.
...
- [baidu/lac](https://github.com/baidu/lac) topic:chinese-nlp,chinese-word-segmentation,java,lexical-analysis,named-entity-recognition,part-of-speech-tagger,python,word-segmentation pushed_at:2021-05 star:3.8k fork:0.6k 百度NLP：分词，词性标注，命名实体识别，词重要性
- [baidu/openrasp](https://github.com/baidu/openrasp) topic:devsecops,iast,rasp,security,waf pushed_at:2024-04 star:2.7k fork:0.6k 🔥Open source RASP solution
...
- [baidu/san](https://github.com/baidu/san) topic:component,framework,frontend,javascript,mvvm,san pushed_at:2024-04 star:4.7k fork:0.5k A fast, portable, flexible JavaScript component framework
...
- [baidu/san-website](https://github.com/baidu/san-website) topic: pushed_at:2024-04 star:0.0k fork:0.1k 
...
- [baidu/pymochow](https://github.com/baidu/pymochow) topic: pushed_at:2024-04 star:0.0k fork:0.0k 
...
- [baidu/amis](https://github.com/baidu/amis) topic:admin,frontend,frontend-framework,json,low-code,low-code-development-platform,lowcode,no-code pushed_at:2024-04 star:16.2k fork:2.3k 前端低代码框架，通过 JSON 配置就能生成各种页面。
