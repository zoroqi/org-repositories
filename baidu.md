...
- [baidu/dperf](https://github.com/baidu/dperf) topic:dpdk,dpvs,http,ipv6,load-tester,lvs,nginx,packet-loss,performance,tcp,udp,vlan,vxlan pushed_at:2024-03 star:4.3k fork:0.4k dperf is a 100Gbps network load tester.
...
- [baidu/CarbonGraph](https://github.com/baidu/CarbonGraph) topic:component-architecture,dependency-injection,di-container,dsl,ioc,ioc-container,ios,objective-c,swift pushed_at:2023-07 star:0.3k fork:0.0k A Swift dependency injection / lookup framework for iOS

## TypeScript

- [baidu/amis](https://github.com/baidu/amis) topic:admin,frontend,frontend-framework,json,low-code,low-code-development-platform,lowcode,no-code pushed_at:2024-03 star:16.0k fork:2.3k 前端低代码框架，通过 JSON 配置就能生成各种页面。
