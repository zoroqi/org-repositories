...
- [baidu/amis](https://github.com/baidu/amis) topic:admin,frontend,frontend-framework,json,low-code,low-code-development-platform,lowcode,no-code pushed_at:2024-04 star:16.1k fork:2.3k 前端低代码框架，通过 JSON 配置就能生成各种页面。
