...
- [baidu/san](https://github.com/baidu/san) topic:component,framework,frontend,javascript,mvvm,san pushed_at:2025-11 star:4.8k fork:0.5k A fast, portable, flexible JavaScript component framework
...
- [baidu/vLLM-Kunlun](https://github.com/baidu/vLLM-Kunlun) topic: pushed_at:2025-12 star:0.2k fork:0.0k vLLM Kunlun (vllm-kunlun) is a community-maintained hardware plugin designed to seamlessly run vLLM on the Kunlun XPU.
...
- [baidu/amis](https://github.com/baidu/amis) topic:admin,frontend,frontend-framework,json,low-code,low-code-development-platform,lowcode,no-code pushed_at:2025-12 star:18.7k fork:2.7k 前端低代码框架，通过 JSON 配置就能生成各种页面。
