...
- [baidu/BaikalDB](https://github.com/baidu/BaikalDB) pushed_at:2022-02 star:0.9k fork:0.1k BaikalDB, A Distributed HTAP Database.
...
- [baidu/braft](https://github.com/baidu/braft) pushed_at:2022-02 star:3.1k fork:0.7k An industrial-grade C++ implementation of RAFT consensus algorithm based on brpc,  widely used inside Baidu to build highly-available distributed systems.
...
- [baidu/openrasp](https://github.com/baidu/openrasp) pushed_at:2022-03 star:2.1k fork:0.5k 🔥Open source RASP solution
...
- [baidu/EasyFaaS](https://github.com/baidu/EasyFaaS) pushed_at:2021-10 star:0.6k fork:0.0k EasyFaaS是一个依赖轻、适配性强、资源占用少、无状态且高性能的函数计算服务引擎
...
- [baidu/smartapp-openapi-go](https://github.com/baidu/smartapp-openapi-go) pushed_at:2022-03 star:0.0k fork:0.0k 百度智能小程序服务端 OpenAPI SDK for go，是基于小程序服务端 OpenAPI 封装的一套让开发者方便使用的 SDK， 它可以帮开发者减少理解和使用 OpenAPI 的成本， 减少开发者直接调用服务端接口不当而引起的错误， 避免在开发中走弯路。
...
- [baidu/Jprotobuf-rpc-socket](https://github.com/baidu/Jprotobuf-rpc-socket) pushed_at:2022-02 star:0.5k fork:0.2k Protobuf RPC是一种基于TCP协议的二进制RPC通信协议的Java实现
- [baidu/OASP](https://github.com/baidu/OASP) pushed_at:2017-11 star:0.0k fork:0.0k OASP (Online App Status Protocol)
- [baidu/smartapp-openapi-java](https://github.com/baidu/smartapp-openapi-java) pushed_at:2022-03 star:0.0k fork:0.0k 百度智能小程序服务端 OpenAPI SDK for java，是基于小程序服务端 OpenAPI 封装的一套让开发者方便使用的 SDK， 它可以帮开发者减少理解和使用 OpenAPI 的成本， 减少开发者直接调用服务端接口不当而引起的错误， 避免在开发中走弯路。
...
- [baidu/uid-generator](https://github.com/baidu/uid-generator) pushed_at:2022-03 star:4.6k fork:1.4k UniqueID generator
...
- [baidu/grafana-tsdb-datasource](https://github.com/baidu/grafana-tsdb-datasource) pushed_at:2022-02 star:0.0k fork:0.0k 
...
- [baidu/NoahV](https://github.com/baidu/NoahV) pushed_at:2022-03 star:0.6k fork:0.1k An efficient front-end application framework based on vue.js
- [baidu/san](https://github.com/baidu/san) pushed_at:2022-03 star:4.5k fork:0.5k A fast, portable, flexible JavaScript component framework
...
- [baidu/san-router](https://github.com/baidu/san-router) pushed_at:2022-02 star:0.0k fork:0.0k Official Router for San
...
- [baidu/san-website](https://github.com/baidu/san-website) pushed_at:2022-03 star:0.0k fork:0.1k 
...
- [baidu/bfe-book](https://github.com/baidu/bfe-book) pushed_at:2022-01 star:1.0k fork:0.1k 《深入理解BFE》（Book for opensource project BFE, in Chinese）
...
- [baidu/CarbonGraph](https://github.com/baidu/CarbonGraph) pushed_at:2022-03 star:0.1k fork:0.0k A Swift dependency injection / lookup framework for iOS

## TypeScript

- [baidu/amis](https://github.com/baidu/amis) pushed_at:2022-03 star:10.4k fork:1.4k 前端低代码框架，通过 JSON 配置就能生成各种页面。
...
- [baidu/san-ssr](https://github.com/baidu/san-ssr) pushed_at:2022-03 star:0.0k fork:0.0k San SSR framework and utils
