...
- [golang/go](https://github.com/golang/go) topic:go,golang,language,programming-language pushed_at:2023-04 star:110.2k fork:16.2k The Go programming language
...
- [golang/groupcache](https://github.com/golang/groupcache) topic: pushed_at:2023-03 star:12.1k fork:1.3k groupcache is a caching and cache-filling library, intended as a replacement for memcached in many cases.
...
- [golang/mock](https://github.com/golang/mock) topic: pushed_at:2023-04 star:8.7k fork:0.6k GoMock is a mocking framework for the Go programming language.
