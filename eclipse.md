...
- [eclipse/tinydtls](https://github.com/eclipse/tinydtls) topic: pushed_at:2024-06 star:0.1k fork:0.1k Eclipse tinydtls
...
- [eclipse/cloe](https://github.com/eclipse/cloe) topic: pushed_at:2024-07 star:0.0k fork:0.0k Cloe
...
- [eclipse/xtext-website-publish](https://github.com/eclipse/xtext-website-publish) topic: pushed_at:2024-07 star:0.0k fork:0.0k xtext-website-publish
...
- [eclipse/epsilon](https://github.com/eclipse/epsilon) topic:domain-specific-languages,model-based-software-engineering,model-driven-engineering pushed_at:2024-07 star:0.1k fork:0.0k Epsilon is a family of Java-based scripting languages for automating common model-based software engineering tasks, such as code generation, model-to-model transformation and model validation, that work out of the box with EMF (including Xtext and Sirius), UML (including Cameo/MagicDraw), Simulink, XML and other types of models.
...
- [eclipse/jifa](https://github.com/eclipse/jifa) topic:gc-log,heap-dump,java,jfr,jvm,k8s,online-analyzer,thread-dump,troubleshooting pushed_at:2024-07 star:0.5k fork:0.1k 🔬 Online Heap Dump, GC Log, Thread Dump & JFR File Analyzer.
