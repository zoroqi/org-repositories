...
- [eclipse/mraa](https://github.com/eclipse/mraa) topic:board,communication,galileo,gpio,i2c,intel-joule,io,libmraa,linux,mraa,raspberry-pi,spi pushed_at:2024-05 star:1.4k fork:0.6k Linux Library for low speed IO Communication in C with bindings for C++, Python, Node.js & Java. Supports generic io platforms, as well as Intel Edison, Intel Joule, Raspberry Pi and many more.
- [eclipse/openmcx](https://github.com/eclipse/openmcx) topic: pushed_at:2024-02 star:0.0k fork:0.0k openmcx
- [eclipse/paho.mqtt.c](https://github.com/eclipse/paho.mqtt.c) topic:eclipse-paho,eclipseiot,internet-of-things,iot,mqtt pushed_at:2024-05 star:1.9k fork:1.1k An Eclipse Paho C client library for MQTT for Windows, Linux and MacOS. API documentation: https://eclipse.github.io/paho.mqtt.c/
...
- [eclipse/xtext-website-publish](https://github.com/eclipse/xtext-website-publish) topic: pushed_at:2024-05 star:0.0k fork:0.0k xtext-website-publish
...
- [eclipse/elk](https://github.com/eclipse/elk) topic:eclipse,java,layout-algorithms pushed_at:2024-05 star:0.2k fork:0.1k Eclipse Layout Kernel - Automatic layout for Java applications.
...
- [eclipse/jbom](https://github.com/eclipse/jbom) topic: pushed_at:2024-05 star:0.1k fork:0.0k 
...
- [eclipse/jnosql-extensions](https://github.com/eclipse/jnosql-extensions) topic:jakartaee,java,jnosql,microprofile pushed_at:2024-05 star:0.0k fork:0.0k This project contains all specialization to Eclipse JNoSQL. The specific behavior in a NoSQL database matters, that's why there are Eclipse JNoSQL Mapper specializations.
...
- [eclipse/lemminx-maven](https://github.com/eclipse/lemminx-maven) topic: pushed_at:2024-05 star:0.0k fork:0.0k lemminx-maven
...
- [eclipse/paho.mqtt.android](https://github.com/eclipse/paho.mqtt.android) topic:eclipseiot,internet-of-things,iot,mqtt pushed_at:2024-04 star:2.9k fork:0.9k MQTT Android
...
- [eclipse/xtext](https://github.com/eclipse/xtext) topic: pushed_at:2024-05 star:0.8k fork:0.3k Eclipse Xtext™ is a language development framework 
...
- [eclipse/dirigible](https://github.com/eclipse/dirigible) topic: pushed_at:2024-05 star:0.3k fork:0.1k Eclipse Dirigible™ Project
...
- [eclipse/editdor](https://github.com/eclipse/editdor) topic:iot,jsonld,web,webofthings pushed_at:2024-05 star:0.0k fork:0.0k Eclipse ediTDor - A tool for simply designing W3C Thing Descriptions
...
- [eclipse/elk-models](https://github.com/eclipse/elk-models) topic: pushed_at:2024-05 star:0.0k fork:0.0k Eclipse Layout Kernel - Test models
