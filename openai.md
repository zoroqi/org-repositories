...
- [openai/retro](https://github.com/openai/retro) topic: pushed_at:2024-02 star:3.3k fork:0.5k Retro Games in Gym
...
- [openai/triton](https://github.com/openai/triton) topic: pushed_at:2024-03 star:10.4k fork:1.2k Development repository for the Triton language and compiler
...
- [openai/kubernetes](https://github.com/openai/kubernetes) topic: pushed_at:2024-03 star:0.0k fork:0.0k Production-Grade Container Scheduling and Management
...
- [openai/democratic-inputs](https://github.com/openai/democratic-inputs) topic: pushed_at:2024-03 star:0.0k fork:0.0k 
...
- [openai/CLIP](https://github.com/openai/CLIP) topic:deep-learning,machine-learning pushed_at:2024-01 star:21.3k fork:2.9k CLIP (Contrastive Language-Image Pretraining),  Predict the most relevant text snippet given an image
...
- [openai/openai-cookbook](https://github.com/openai/openai-cookbook) topic:chatgpt,gpt-4,openai,openai-api pushed_at:2024-03 star:54.8k fork:8.6k Examples and guides for using the OpenAI API
...
- [openai/gpt-3](https://github.com/openai/gpt-3) topic: pushed_at:2020-09 star:15.6k fork:2.3k GPT-3: Language Models are Few-Shot Learners
...
- [openai/openai-openapi](https://github.com/openai/openai-openapi) topic:openai,openai-api pushed_at:2024-03 star:0.9k fork:0.3k OpenAPI specification for the OpenAI API
- [openai/openai-quickstart-python](https://github.com/openai/openai-quickstart-python) topic:openai,openai-api pushed_at:2024-03 star:1.6k fork:1.3k Python example app from the OpenAI API quickstart tutorial
...
- [openai/automated-interpretability](https://github.com/openai/automated-interpretability) topic: pushed_at:2024-03 star:0.9k fork:0.1k 
- [openai/baselines](https://github.com/openai/baselines) topic: pushed_at:2023-11 star:15.2k fork:4.8k OpenAI Baselines: high-quality implementations of reinforcement learning algorithms
...
- [openai/chatgpt-retrieval-plugin](https://github.com/openai/chatgpt-retrieval-plugin) topic:chatgpt,chatgpt-plugins pushed_at:2024-03 star:20.7k fork:3.6k The ChatGPT Retrieval Plugin lets you easily find personal or work documents by asking questions in natural language.
...
- [openai/consistency_models](https://github.com/openai/consistency_models) topic: pushed_at:2024-03 star:5.9k fork:0.4k Official repo for consistency models.
...
- [openai/DALL-E](https://github.com/openai/DALL-E) topic: pushed_at:2024-01 star:10.7k fork:1.9k PyTorch package for the discrete VAE used for DALL·E.
...
- [openai/evals](https://github.com/openai/evals) topic: pushed_at:2024-03 star:13.5k fork:2.5k Evals is a framework for evaluating LLMs and LLM systems, and an open-source registry of benchmarks.
...
- [openai/glide-text2im](https://github.com/openai/glide-text2im) topic: pushed_at:2024-03 star:3.4k fork:0.5k GLIDE: a diffusion-based text-conditional image synthesis model
...
- [openai/gpt-2](https://github.com/openai/gpt-2) topic:paper pushed_at:2024-01 star:20.8k fork:5.3k Code for the paper "Language Models are Unsupervised Multitask Learners"
...
- [openai/grok](https://github.com/openai/grok) topic: pushed_at:2024-03 star:1.4k fork:0.1k 
- [openai/guided-diffusion](https://github.com/openai/guided-diffusion) topic: pushed_at:2023-04 star:5.4k fork:0.7k 
- [openai/gym](https://github.com/openai/gym) topic: pushed_at:2024-02 star:33.7k fork:8.5k A toolkit for developing and comparing reinforcement learning algorithms.
...
- [openai/human-eval](https://github.com/openai/human-eval) topic: pushed_at:2024-02 star:1.8k fork:0.3k Code for the paper "Evaluating Large Language Models Trained on Code"
...
- [openai/improved-diffusion](https://github.com/openai/improved-diffusion) topic: pushed_at:2024-03 star:2.7k fork:0.4k Release for Improved Denoising Diffusion Probabilistic Models
...
- [openai/jukebox](https://github.com/openai/jukebox) topic:audio,generative-model,music,paper,pytorch,transformer,vq-vae pushed_at:2024-03 star:7.5k fork:1.4k Code for the paper "Jukebox: A Generative Model for Music"
...
- [openai/lm-human-preferences](https://github.com/openai/lm-human-preferences) topic: pushed_at:2023-07 star:1.1k fork:0.2k Code for the paper Fine-Tuning Language Models from Human Preferences
- [openai/maddpg](https://github.com/openai/maddpg) topic:paper pushed_at:2024-03 star:1.5k fork:0.5k Code for the MADDPG algorithm from the paper "Multi-Agent Actor-Critic for Mixed Cooperative-Competitive Environments"
...
- [openai/multiagent-particle-envs](https://github.com/openai/multiagent-particle-envs) topic:paper pushed_at:2024-02 star:2.1k fork:0.8k Code for a multi-agent particle environment used in the paper "Multi-Agent Actor-Critic for Mixed Cooperative-Competitive Environments"
...
- [openai/openai-python](https://github.com/openai/openai-python) topic:openai,python pushed_at:2024-03 star:19.1k fork:2.5k The official Python library for the OpenAI API
...
- [openai/shap-e](https://github.com/openai/shap-e) topic: pushed_at:2024-02 star:11.1k fork:0.9k Generate 3D objects conditioned on text or images
...
- [openai/spinningup](https://github.com/openai/spinningup) topic: pushed_at:2024-03 star:9.5k fork:2.1k An educational resource to help anyone learn deep reinforcement learning.
...
- [openai/tiktoken](https://github.com/openai/tiktoken) topic: pushed_at:2024-03 star:9.0k fork:0.6k tiktoken is a fast BPE tokeniser for use with OpenAI's models.
...
- [openai/transformer-debugger](https://github.com/openai/transformer-debugger) topic: pushed_at:2024-03 star:3.1k fork:0.2k 
...
- [openai/Video-Pre-Training](https://github.com/openai/Video-Pre-Training) topic: pushed_at:2024-01 star:1.2k fork:0.1k Video PreTraining (VPT): Learning to Act by Watching Unlabeled Online Videos
...
- [openai/whisper](https://github.com/openai/whisper) topic: pushed_at:2024-03 star:58.0k fork:6.6k Robust Speech Recognition via Large-Scale Weak Supervision
...
- [openai/openai-deno-build](https://github.com/openai/openai-deno-build) topic:deno,openai,openai-api pushed_at:2024-03 star:0.1k fork:0.0k Deno build of the official Typescript library for the OpenAI API.
- [openai/openai-node](https://github.com/openai/openai-node) topic:nodejs,openai,typescript pushed_at:2024-03 star:6.6k fork:0.7k The official Node.js / Typescript library for the OpenAI API
