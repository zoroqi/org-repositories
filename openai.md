...
- [openai/triton](https://github.com/openai/triton) pushed_at:2022-02 star:3.5k fork:0.3k Development repository for the Triton language and compiler

## CSS

- [openai/openai-quickstart-python](https://github.com/openai/openai-quickstart-python) pushed_at:2022-01 star:0.0k fork:0.0k Python example app from the OpenAI API quickstart tutorial
...
- [openai/pixel](https://github.com/openai/pixel) pushed_at:2022-01 star:0.0k fork:0.0k Code for the single pixel debate game from the paper "AI safety via debate" (https://arxiv.org/abs/1805.00899)
...
- [openai/CLIP](https://github.com/openai/CLIP) pushed_at:2022-01 star:6.1k fork:0.8k Contrastive Language-Image Pretraining
...
- [openai/lean-gym](https://github.com/openai/lean-gym) pushed_at:2022-01 star:0.0k fork:0.0k 

## Mustache

- [openai/openai-openapi](https://github.com/openai/openai-openapi) pushed_at:2022-01 star:0.0k fork:0.0k OpenAPI specification for the OpenAI API

## Objective-C++

- [openai/miniF2F](https://github.com/openai/miniF2F) pushed_at:2022-02 star:0.1k fork:0.0k Formal to Formal Mathematics Benchmark
...
- [openai/gpt-3](https://github.com/openai/gpt-3) pushed_at:2020-09 star:11.0k fork:1.4k GPT-3: Language Models are Few-Shot Learners
...
- [openai/baselines](https://github.com/openai/baselines) pushed_at:2021-12 star:12.3k fork:4.2k OpenAI Baselines: high-quality implementations of reinforcement learning algorithms
...
- [openai/DALL-E](https://github.com/openai/DALL-E) pushed_at:2021-12 star:4.0k fork:0.6k PyTorch package for the discrete VAE used for DALL·E.
...
- [openai/glide-text2im](https://github.com/openai/glide-text2im) pushed_at:2022-01 star:1.6k fork:0.2k GLIDE: a diffusion-based text-conditional image synthesis model
...
- [openai/guided-diffusion](https://github.com/openai/guided-diffusion) pushed_at:2022-01 star:1.1k fork:0.1k 
- [openai/gym](https://github.com/openai/gym) pushed_at:2022-02 star:26.3k fork:7.6k A toolkit for developing and comparing reinforcement learning algorithms.
...
- [openai/jukebox](https://github.com/openai/jukebox) pushed_at:2021-09 star:4.9k fork:0.8k Code for the paper "Jukebox: A Generative Model for Music"
...
- [openai/multi-agent-emergence-environments](https://github.com/openai/multi-agent-emergence-environments) pushed_at:2021-08 star:1.2k fork:0.2k Environment generation code for the paper "Emergent Tool Use From Multi-Agent Autocurricula"
...
- [openai/openai-python](https://github.com/openai/openai-python) pushed_at:2022-02 star:0.4k fork:0.1k 
...
- [openai/openai-node](https://github.com/openai/openai-node) pushed_at:2022-01 star:0.0k fork:0.0k Node.js library for the OpenAI API
