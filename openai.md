...
- [openai/triton](https://github.com/openai/triton) topic: pushed_at:2022-12 star:4.4k fork:0.4k Development repository for the Triton language and compiler
...
- [openai/dalle-discord-bot](https://github.com/openai/dalle-discord-bot) topic: pushed_at:2022-12 star:0.1k fork:0.0k OpenAI Discord Community's GPT-3 powered DALL·E 2 support bot
...
- [openai/openai-quickstart-node](https://github.com/openai/openai-quickstart-node) topic: pushed_at:2022-12 star:0.5k fork:0.3k Node.js example app from the OpenAI API quickstart tutorial
...
- [openai/CLIP](https://github.com/openai/CLIP) topic: pushed_at:2022-09 star:11.1k fork:1.7k Contrastive Language-Image Pretraining
...
- [openai/whisper](https://github.com/openai/whisper) topic: pushed_at:2022-12 star:18.0k fork:1.5k Robust Speech Recognition via Large-Scale Weak Supervision
...
- [openai/following-instructions-human-feedback](https://github.com/openai/following-instructions-human-feedback) topic: pushed_at:2022-01 star:0.3k fork:0.0k 
...
- [openai/gpt-3](https://github.com/openai/gpt-3) topic: pushed_at:2020-09 star:12.2k fork:1.5k GPT-3: Language Models are Few-Shot Learners
...
- [openai/baselines](https://github.com/openai/baselines) topic: pushed_at:2022-06 star:13.2k fork:4.4k OpenAI Baselines: high-quality implementations of reinforcement learning algorithms
...
- [openai/DALL-E](https://github.com/openai/DALL-E) topic: pushed_at:2022-10 star:9.3k fork:1.7k PyTorch package for the discrete VAE used for DALL·E.
...
- [openai/gpt-2](https://github.com/openai/gpt-2) topic:paper pushed_at:2022-07 star:15.8k fork:4.0k Code for the paper "Language Models are Unsupervised Multitask Learners"
...
- [openai/gym](https://github.com/openai/gym) topic: pushed_at:2022-11 star:29.3k fork:8.1k A toolkit for developing and comparing reinforcement learning algorithms.
...
- [openai/lm-human-preferences](https://github.com/openai/lm-human-preferences) topic: pushed_at:2022-12 star:0.2k fork:0.0k Code for the paper Fine-Tuning Language Models from Human Preferences
...
- [openai/openai-cookbook](https://github.com/openai/openai-cookbook) topic: pushed_at:2022-12 star:0.9k fork:0.2k Examples and guides for using the OpenAI API
- [openai/openai-python](https://github.com/openai/openai-python) topic: pushed_at:2022-12 star:1.1k fork:0.3k 
...
- [openai/safety-gym](https://github.com/openai/safety-gym) topic: pushed_at:2022-11 star:0.4k fork:0.1k Tools for accelerating safe exploration research.
...
- [openai/spinningup](https://github.com/openai/spinningup) topic: pushed_at:2022-09 star:7.4k fork:1.8k An educational resource to help anyone learn deep reinforcement learning.
