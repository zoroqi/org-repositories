...
- [openai/openai-dotnet](https://github.com/openai/openai-dotnet) topic:csharp,dotnet,openai pushed_at:2025-12 star:2.4k fork:0.3k The official .NET library for the OpenAI API
...
- [openai/codex-universal](https://github.com/openai/codex-universal) topic: pushed_at:2025-12 star:0.7k fork:0.2k Base docker image used in Codex environments
...
- [openai/openai-go](https://github.com/openai/openai-go) topic: pushed_at:2025-12 star:2.8k fork:0.2k The official Go library for the OpenAI API
...
- [openai/CLIP](https://github.com/openai/CLIP) topic:deep-learning,machine-learning pushed_at:2024-07 star:32.0k fork:3.9k CLIP (Contrastive Language-Image Pretraining),  Predict the most relevant text snippet given an image
...
- [openai/GPTs-are-GPTs](https://github.com/openai/GPTs-are-GPTs) topic: pushed_at:2025-10 star:0.0k fork:0.0k 
...
- [openai/openai-cookbook](https://github.com/openai/openai-cookbook) topic:chatgpt,gpt-4,openai,openai-api pushed_at:2025-12 star:69.8k fork:11.7k Examples and guides for using the OpenAI API
...
- [openai/openai-java](https://github.com/openai/openai-java) topic: pushed_at:2025-12 star:1.3k fork:0.2k The official Java library for the OpenAI API
...
- [openai/gpt-oss-safeguard](https://github.com/openai/gpt-oss-safeguard) topic: pushed_at:2025-10 star:0.0k fork:0.0k 
- [openai/lustre](https://github.com/openai/lustre) topic: pushed_at:2021-01 star:0.0k fork:0.0k 
- [openai/model_spec](https://github.com/openai/model_spec) topic: pushed_at:2025-10 star:0.7k fork:0.1k The OpenAI Model Spec
...
- [openai/openai-chatkit-advanced-samples](https://github.com/openai/openai-chatkit-advanced-samples) topic:chatkit,openai,openai-api,python,typescript pushed_at:2025-12 star:0.5k fork:0.2k Starter app to build with OpenAI ChatKit SDK
...
- [openai/chatkit-python](https://github.com/openai/chatkit-python) topic: pushed_at:2025-12 star:0.3k fork:0.1k 
- [openai/chz](https://github.com/openai/chz) topic: pushed_at:2025-11 star:0.2k fork:0.0k 
- [openai/circuit_sparsity](https://github.com/openai/circuit_sparsity) topic: pushed_at:2025-12 star:0.4k fork:0.0k Open-source release accompanying Gao et al. 2025
...
- [openai/evals](https://github.com/openai/evals) topic: pushed_at:2025-11 star:17.4k fork:2.9k Evals is a framework for evaluating LLMs and LLM systems, and an open-source registry of benchmarks.
...
- [openai/gpt-oss](https://github.com/openai/gpt-oss) topic: pushed_at:2025-11 star:19.4k fork:2.0k gpt-oss-120b and gpt-oss-20b are two open-weight language models by OpenAI
...
- [openai/gym](https://github.com/openai/gym) topic: pushed_at:2024-10 star:36.9k fork:8.7k A toolkit for developing and comparing reinforcement learning algorithms.
...
- [openai/mle-bench](https://github.com/openai/mle-bench) topic: pushed_at:2025-12 star:1.2k fork:0.2k MLE-bench is a benchmark for measuring how well AI agents perform at machine learning engineering
...
- [openai/openai-agents-python](https://github.com/openai/openai-agents-python) topic:agents,ai,framework,llm,openai,python pushed_at:2025-12 star:17.8k fork:3.0k A lightweight, powerful framework for multi-agent workflows
- [openai/openai-chatkit-starter-app](https://github.com/openai/openai-chatkit-starter-app) topic:chatkit,openai,openai-api pushed_at:2025-12 star:0.7k fork:0.9k Starter app to build with OpenAI ChatKit + Agent Builder
...
- [openai/openai-cua-sample-app](https://github.com/openai/openai-cua-sample-app) topic: pushed_at:2025-04 star:1.2k fork:0.4k Learn how to use CUA (our Computer Using Agent) via the API on multiple computer environments.
- [openai/openai-guardrails-python](https://github.com/openai/openai-guardrails-python) topic: pushed_at:2025-12 star:0.2k fork:0.0k OpenAI Guardrails - Python
- [openai/openai-knowledge-retrieval](https://github.com/openai/openai-knowledge-retrieval) topic: pushed_at:2025-12 star:0.0k fork:0.0k OS repo for Knowledge Retrieval starter kit
- [openai/openai-mcpkit](https://github.com/openai/openai-mcpkit) topic: pushed_at:2025-11 star:0.0k fork:0.0k 
- [openai/openai-python](https://github.com/openai/openai-python) topic:openai,python pushed_at:2025-12 star:29.5k fork:4.5k The official Python library for the OpenAI API
...
- [openai/simple-evals](https://github.com/openai/simple-evals) topic: pushed_at:2025-07 star:4.2k fork:0.5k 
...
- [openai/spinningup](https://github.com/openai/spinningup) topic: pushed_at:2024-08 star:11.4k fork:2.4k An educational resource to help anyone learn deep reinforcement learning.
...
- [openai/swarm](https://github.com/openai/swarm) topic: pushed_at:2025-03 star:20.7k fork:2.2k Educational framework exploring ergonomic, lightweight multi-agent orchestration. Managed by OpenAI Solution team.
- [openai/tiktoken](https://github.com/openai/tiktoken) topic: pushed_at:2025-10 star:16.8k fork:1.3k tiktoken is a fast BPE tokeniser for use with OpenAI's models.
...
- [openai/whisper](https://github.com/openai/whisper) topic: pushed_at:2025-12 star:92.1k fork:11.5k Robust Speech Recognition via Large-Scale Weak Supervision
...
- [openai/openai-ruby](https://github.com/openai/openai-ruby) topic: pushed_at:2025-12 star:0.4k fork:0.0k Official Ruby SDK for the OpenAI API

## Rust

- [openai/codex](https://github.com/openai/codex) topic: pushed_at:2025-12 star:54.1k fork:6.8k Lightweight coding agent that runs in your terminal
...
- [openai/snap-o](https://github.com/openai/snap-o) topic:android,developer-tools,teams pushed_at:2025-12 star:0.0k fork:0.0k Lightweight Android capture developer tools for macOS
...
- [openai/apps-sdk-ui](https://github.com/openai/apps-sdk-ui) topic: pushed_at:2025-12 star:0.7k fork:0.1k 
- [openai/chatkit-js](https://github.com/openai/chatkit-js) topic: pushed_at:2025-12 star:1.7k fork:0.1k 
- [openai/codex-action](https://github.com/openai/codex-action) topic: pushed_at:2025-12 star:0.7k fork:0.1k 
...
- [openai/openai-agents-js](https://github.com/openai/openai-agents-js) topic:agents,openai,openai-api,realtime-api,typescript pushed_at:2025-12 star:2.0k fork:0.5k A lightweight, powerful framework for multi-agent workflows and voice agents
- [openai/openai-apps-sdk-examples](https://github.com/openai/openai-apps-sdk-examples) topic: pushed_at:2025-12 star:1.8k fork:0.4k Example apps for the Apps SDK
...
- [openai/openai-fm](https://github.com/openai/openai-fm) topic: pushed_at:2025-12 star:0.5k fork:0.1k Code for openai.fm, a demo for the OpenAI Speech API
- [openai/openai-guardrails-js](https://github.com/openai/openai-guardrails-js) topic: pushed_at:2025-12 star:0.1k fork:0.0k OpenAI Guardrails - TypeScript / JavaScript
- [openai/openai-node](https://github.com/openai/openai-node) topic:nodejs,openai,typescript pushed_at:2025-12 star:10.4k fork:1.3k Official JavaScript / TypeScript library for the OpenAI API
- [openai/openai-realtime-agents](https://github.com/openai/openai-realtime-agents) topic: pushed_at:2025-12 star:6.7k fork:1.0k This is a simple demonstration of more advanced, agentic patterns built on top of the Realtime API.
...
- [openai/openai-responses-starter-app](https://github.com/openai/openai-responses-starter-app) topic: pushed_at:2025-12 star:0.7k fork:0.3k Starter app to build with the OpenAI Responses API
