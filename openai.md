...
- [openai/openai-dotnet](https://github.com/openai/openai-dotnet) topic:csharp,dotnet,openai pushed_at:2025-12 star:2.5k fork:0.4k The official .NET library for the OpenAI API
...
- [openai/openai-go](https://github.com/openai/openai-go) topic: pushed_at:2025-12 star:2.8k fork:0.3k The official Go library for the OpenAI API
...
- [openai/CLIP](https://github.com/openai/CLIP) topic:deep-learning,machine-learning pushed_at:2024-07 star:32.1k fork:3.9k CLIP (Contrastive Language-Image Pretraining),  Predict the most relevant text snippet given an image
...
- [openai/baselines](https://github.com/openai/baselines) topic: pushed_at:2024-08 star:16.6k fork:4.9k OpenAI Baselines: high-quality implementations of reinforcement learning algorithms
...
- [openai/circuit_sparsity](https://github.com/openai/circuit_sparsity) topic: pushed_at:2025-12 star:0.5k fork:0.0k Open-source release accompanying Gao et al. 2025
...
- [openai/evals](https://github.com/openai/evals) topic: pushed_at:2025-11 star:17.5k fork:2.9k Evals is a framework for evaluating LLMs and LLM systems, and an open-source registry of benchmarks.
...
- [openai/gpt-oss](https://github.com/openai/gpt-oss) topic: pushed_at:2025-11 star:19.5k fork:2.0k gpt-oss-120b and gpt-oss-20b are two open-weight language models by OpenAI
...
- [openai/mle-bench](https://github.com/openai/mle-bench) topic: pushed_at:2025-12 star:1.3k fork:0.2k MLE-bench is a benchmark for measuring how well AI agents perform at machine learning engineering
...
- [openai/openai-agents-python](https://github.com/openai/openai-agents-python) topic:agents,ai,framework,llm,openai,python pushed_at:2025-12 star:18.1k fork:3.0k A lightweight, powerful framework for multi-agent workflows
...
- [openai/openai-python](https://github.com/openai/openai-python) topic:openai,python pushed_at:2025-12 star:29.6k fork:4.5k The official Python library for the OpenAI API
...
- [openai/skills](https://github.com/openai/skills) topic: pushed_at:2025-12 star:1.1k fork:0.1k Skills Catalog for Codex
...
- [openai/tiktoken](https://github.com/openai/tiktoken) topic: pushed_at:2025-10 star:16.9k fork:1.4k tiktoken is a fast BPE tokeniser for use with OpenAI's models.
...
- [openai/codex](https://github.com/openai/codex) topic: pushed_at:2026-01 star:55.0k fork:7.0k Lightweight coding agent that runs in your terminal
...
- [openai/snap-o](https://github.com/openai/snap-o) topic:android,developer-tools,teams pushed_at:2025-12 star:0.1k fork:0.0k Lightweight Android capture developer tools for macOS
...
- [openai/openai-agents-js](https://github.com/openai/openai-agents-js) topic:agents,openai,openai-api,realtime-api,typescript pushed_at:2025-12 star:2.1k fork:0.5k A lightweight, powerful framework for multi-agent workflows and voice agents
- [openai/openai-apps-sdk-examples](https://github.com/openai/openai-apps-sdk-examples) topic: pushed_at:2025-12 star:1.9k fork:0.4k Example apps for the Apps SDK
...
- [openai/openai-fm](https://github.com/openai/openai-fm) topic: pushed_at:2025-12 star:2.2k fork:5.4k Code for openai.fm, a demo for the OpenAI Speech API
...
- [openai/openai-node](https://github.com/openai/openai-node) topic:nodejs,openai,typescript pushed_at:2025-12 star:10.5k fork:1.4k Official JavaScript / TypeScript library for the OpenAI API
- [openai/openai-realtime-agents](https://github.com/openai/openai-realtime-agents) topic: pushed_at:2025-12 star:6.7k fork:1.1k This is a simple demonstration of more advanced, agentic patterns built on top of the Realtime API.
