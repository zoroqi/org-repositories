...
- [openai/mujoco-py](https://github.com/openai/mujoco-py) pushed_at:2022-02 star:2.0k fork:0.6k MuJoCo is a physics engine for detailed, efficient rigid body simulations with contacts. mujoco-py allows using MuJoCo from Python 3.
...
- [openai/CLIP](https://github.com/openai/CLIP) pushed_at:2022-02 star:6.7k fork:0.9k Contrastive Language-Image Pretraining
...
- [openai/miniF2F](https://github.com/openai/miniF2F) pushed_at:2022-03 star:0.1k fork:0.0k Formal to Formal Mathematics Benchmark
...
- [openai/gpt-3](https://github.com/openai/gpt-3) pushed_at:2020-09 star:11.1k fork:1.4k GPT-3: Language Models are Few-Shot Learners
...
- [openai/jeffwu-dotfiles](https://github.com/openai/jeffwu-dotfiles) pushed_at:2022-03 star:0.0k fork:0.0k my configuration files
...
- [openai/baselines](https://github.com/openai/baselines) pushed_at:2021-12 star:12.4k fork:4.3k OpenAI Baselines: high-quality implementations of reinforcement learning algorithms
...
- [openai/DALL-E](https://github.com/openai/DALL-E) pushed_at:2021-12 star:4.1k fork:0.7k PyTorch package for the discrete VAE used for DALL·E.
...
- [openai/glide-text2im](https://github.com/openai/glide-text2im) pushed_at:2022-03 star:2.1k fork:0.3k GLIDE: a diffusion-based text-conditional image synthesis model
...
- [openai/guided-diffusion](https://github.com/openai/guided-diffusion) pushed_at:2022-01 star:1.2k fork:0.2k 
- [openai/gym](https://github.com/openai/gym) pushed_at:2022-03 star:27.0k fork:7.7k A toolkit for developing and comparing reinforcement learning algorithms.
...
- [openai/multiagent-particle-envs](https://github.com/openai/multiagent-particle-envs) pushed_at:2021-08 star:1.5k fork:0.6k Code for a multi-agent particle environment used in the paper "Multi-Agent Actor-Critic for Mixed Cooperative-Competitive Environments"
...
- [openai/neural-mmo](https://github.com/openai/neural-mmo) pushed_at:2022-02 star:1.3k fork:0.2k Code for the paper "Neural MMO: A Massively Multiagent Game Environment for Training and Evaluating Intelligent Agents"
- [openai/openai-python](https://github.com/openai/openai-python) pushed_at:2022-03 star:0.4k fork:0.1k 
...
- [openai/vdvae](https://github.com/openai/vdvae) pushed_at:2020-11 star:0.3k fork:0.1k Repository for the paper "Very Deep VAEs Generalize Autoregressive Models and Can Outperform Them on Images"
