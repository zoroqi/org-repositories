...
- [openai/openai-go](https://github.com/openai/openai-go) topic: pushed_at:2025-08 star:2.3k fork:0.2k The official Go library for the OpenAI API
...
- [openai/gpt-5-coding-examples](https://github.com/openai/gpt-5-coding-examples) topic:codex,coding,frontend,gpt,openai,web,website pushed_at:2025-08 star:1.3k fork:0.2k GPT-5 coding examples
...
- [openai/CLIP](https://github.com/openai/CLIP) topic:deep-learning,machine-learning pushed_at:2024-07 star:30.3k fork:3.7k CLIP (Contrastive Language-Image Pretraining),  Predict the most relevant text snippet given an image
...
- [openai/openai-cookbook](https://github.com/openai/openai-cookbook) topic:chatgpt,gpt-4,openai,openai-api pushed_at:2025-08 star:67.2k fork:11.1k Examples and guides for using the OpenAI API
...
- [openai/openai-java](https://github.com/openai/openai-java) topic: pushed_at:2025-08 star:1.0k fork:0.1k The official Java library for the OpenAI API
...
- [openai/chz](https://github.com/openai/chz) topic: pushed_at:2025-08 star:0.1k fork:0.0k 
...
- [openai/evals](https://github.com/openai/evals) topic: pushed_at:2024-12 star:16.8k fork:2.8k Evals is a framework for evaluating LLMs and LLM systems, and an open-source registry of benchmarks.
...
- [openai/gpt-oss](https://github.com/openai/gpt-oss) topic: pushed_at:2025-08 star:17.3k fork:1.5k gpt-oss-120b and gpt-oss-20b are two open-weight language models by OpenAI
...
- [openai/mle-bench](https://github.com/openai/mle-bench) topic: pushed_at:2025-08 star:0.8k fork:0.1k MLE-bench is a benchmark for measuring how well AI agents perform at machine learning engineering
...
- [openai/openai-agents-python](https://github.com/openai/openai-agents-python) topic:agents,ai,framework,llm,openai,python pushed_at:2025-08 star:13.7k fork:2.2k A lightweight, powerful framework for multi-agent workflows
...
- [openai/openai-python](https://github.com/openai/openai-python) topic:openai,python pushed_at:2025-08 star:28.4k fork:4.2k The official Python library for the OpenAI API
...
- [openai/preparedness](https://github.com/openai/preparedness) topic: pushed_at:2025-08 star:0.8k fork:0.1k Releases from OpenAI Preparedness
...
- [openai/tiktoken](https://github.com/openai/tiktoken) topic: pushed_at:2025-08 star:15.6k fork:1.2k tiktoken is a fast BPE tokeniser for use with OpenAI's models.
...
- [openai/whisper](https://github.com/openai/whisper) topic: pushed_at:2025-06 star:86.7k fork:10.7k Robust Speech Recognition via Large-Scale Weak Supervision
...
- [openai/codex](https://github.com/openai/codex) topic: pushed_at:2025-08 star:35.2k fork:4.0k Lightweight coding agent that runs in your terminal
- [openai/harmony](https://github.com/openai/harmony) topic: pushed_at:2025-08 star:3.5k fork:0.2k Renderer for the harmony response format to be used with gpt-oss
...
- [openai/openai-agents-js](https://github.com/openai/openai-agents-js) topic: pushed_at:2025-08 star:1.1k fork:0.2k A lightweight, powerful framework for multi-agent workflows and voice agents
...
- [openai/openai-cs-agents-demo](https://github.com/openai/openai-cs-agents-demo) topic: pushed_at:2025-06 star:5.7k fork:0.9k Demo of a customer service use case implemented with the OpenAI Agents SDK
...
- [openai/openai-realtime-agents](https://github.com/openai/openai-realtime-agents) topic: pushed_at:2025-08 star:6.2k fork:0.9k This is a simple demonstration of more advanced, agentic patterns built on top of the Realtime API.
...
- [openai/openai-responses-starter-app](https://github.com/openai/openai-responses-starter-app) topic: pushed_at:2025-06 star:0.4k fork:0.2k Starter app to build with the OpenAI Responses API
