...
- [openai/openai-dotnet](https://github.com/openai/openai-dotnet) topic:csharp,dotnet,openai pushed_at:2025-11 star:2.4k fork:0.3k The official .NET library for the OpenAI API
...
- [openai/codex-universal](https://github.com/openai/codex-universal) topic: pushed_at:2025-10 star:0.7k fork:0.2k Base docker image used in Codex environments
...
- [openai/openai-go](https://github.com/openai/openai-go) topic: pushed_at:2025-12 star:2.7k fork:0.2k The official Go library for the OpenAI API
...
- [openai/gpt-5-coding-examples](https://github.com/openai/gpt-5-coding-examples) topic:codex,coding,frontend,gpt,openai,web,website pushed_at:2025-08 star:1.8k fork:0.2k GPT-5 coding examples
...
- [openai/openai-apps-sdk-examples](https://github.com/openai/openai-apps-sdk-examples) topic: pushed_at:2025-11 star:1.7k fork:0.4k Example apps for the Apps SDK
...
- [openai/build-hours](https://github.com/openai/build-hours) topic: pushed_at:2025-11 star:0.6k fork:0.1k Build hours code to share.
- [openai/CLIP](https://github.com/openai/CLIP) topic:deep-learning,machine-learning pushed_at:2024-07 star:31.8k fork:3.9k CLIP (Contrastive Language-Image Pretraining),  Predict the most relevant text snippet given an image
...
- [openai/openai-cookbook](https://github.com/openai/openai-cookbook) topic:chatgpt,gpt-4,openai,openai-api pushed_at:2025-12 star:69.5k fork:11.7k Examples and guides for using the OpenAI API
...
- [openai/openai-java](https://github.com/openai/openai-java) topic: pushed_at:2025-12 star:1.2k fork:0.2k The official Java library for the OpenAI API
...
- [openai/openai-chatkit-advanced-samples](https://github.com/openai/openai-chatkit-advanced-samples) topic:chatkit,openai,openai-api,python,typescript pushed_at:2025-11 star:0.5k fork:0.2k Starter app to build with OpenAI ChatKit SDK
...
- [openai/chatkit-python](https://github.com/openai/chatkit-python) topic: pushed_at:2025-11 star:0.3k fork:0.1k 
- [openai/chz](https://github.com/openai/chz) topic: pushed_at:2025-11 star:0.2k fork:0.0k 
- [openai/circuit_sparsity](https://github.com/openai/circuit_sparsity) topic: pushed_at:2025-11 star:0.1k fork:0.0k Open-source release accompanying Gao et al. 2025
...
- [openai/evals](https://github.com/openai/evals) topic: pushed_at:2025-11 star:17.4k fork:2.8k Evals is a framework for evaluating LLMs and LLM systems, and an open-source registry of benchmarks.
...
- [openai/frontier-evals](https://github.com/openai/frontier-evals) topic: pushed_at:2025-11 star:1.0k fork:0.1k OpenAI Frontier Evals
...
- [openai/gpt-2](https://github.com/openai/gpt-2) topic:paper pushed_at:2024-08 star:24.4k fork:5.8k Code for the paper "Language Models are Unsupervised Multitask Learners"
...
- [openai/gpt-oss](https://github.com/openai/gpt-oss) topic: pushed_at:2025-11 star:19.3k fork:1.9k gpt-oss-120b and gpt-oss-20b are two open-weight language models by OpenAI
...
- [openai/gym](https://github.com/openai/gym) topic: pushed_at:2024-10 star:36.8k fork:8.7k A toolkit for developing and comparing reinforcement learning algorithms.
...
- [openai/human-eval](https://github.com/openai/human-eval) topic: pushed_at:2025-01 star:3.0k fork:0.4k Code for the paper "Evaluating Large Language Models Trained on Code"
...
- [openai/improved-diffusion](https://github.com/openai/improved-diffusion) topic: pushed_at:2024-07 star:3.7k fork:0.5k Release for Improved Denoising Diffusion Probabilistic Models
...
- [openai/mle-bench](https://github.com/openai/mle-bench) topic: pushed_at:2025-11 star:1.2k fork:0.2k MLE-bench is a benchmark for measuring how well AI agents perform at machine learning engineering
...
- [openai/openai-agents-python](https://github.com/openai/openai-agents-python) topic:agents,ai,framework,llm,openai,python pushed_at:2025-11 star:17.6k fork:2.9k A lightweight, powerful framework for multi-agent workflows
...
- [openai/openai-guardrails-python](https://github.com/openai/openai-guardrails-python) topic: pushed_at:2025-11 star:0.1k fork:0.0k OpenAI Guardrails - Python
- [openai/openai-knowledge-retrieval](https://github.com/openai/openai-knowledge-retrieval) topic: pushed_at:2025-11 star:0.0k fork:0.0k OS repo for Knowledge Retrieval starter kit
- [openai/openai-mcpkit](https://github.com/openai/openai-mcpkit) topic: pushed_at:2025-11 star:0.0k fork:0.0k 
- [openai/openai-python](https://github.com/openai/openai-python) topic:openai,python pushed_at:2025-12 star:29.4k fork:4.4k The official Python library for the OpenAI API
...
- [openai/tiktoken](https://github.com/openai/tiktoken) topic: pushed_at:2025-10 star:16.7k fork:1.3k tiktoken is a fast BPE tokeniser for use with OpenAI's models.
...
- [openai/whisper](https://github.com/openai/whisper) topic: pushed_at:2025-09 star:91.4k fork:11.5k Robust Speech Recognition via Large-Scale Weak Supervision
...
- [openai/openai-ruby](https://github.com/openai/openai-ruby) topic: pushed_at:2025-11 star:0.4k fork:0.0k Official Ruby SDK for the OpenAI API

## Rust

- [openai/codex](https://github.com/openai/codex) topic: pushed_at:2025-12 star:51.5k fork:6.5k Lightweight coding agent that runs in your terminal
- [openai/harmony](https://github.com/openai/harmony) topic: pushed_at:2025-11 star:4.0k fork:0.2k Renderer for the harmony response format to be used with gpt-oss
...
- [openai/snap-o](https://github.com/openai/snap-o) topic:android,developer-tools,teams pushed_at:2025-11 star:0.0k fork:0.0k Lightweight Android capture developer tools for macOS
...
- [openai/agents.md](https://github.com/openai/agents.md) topic: pushed_at:2025-10 star:8.7k fork:0.7k AGENTS.md — a simple, open format for guiding coding agents
- [openai/apps-sdk-ui](https://github.com/openai/apps-sdk-ui) topic: pushed_at:2025-11 star:0.6k fork:0.1k 
- [openai/chatkit-js](https://github.com/openai/chatkit-js) topic: pushed_at:2025-11 star:1.6k fork:0.1k 
- [openai/codex-action](https://github.com/openai/codex-action) topic: pushed_at:2025-11 star:0.7k fork:0.1k 
...
- [openai/openai-agents-js](https://github.com/openai/openai-agents-js) topic:agents,openai,openai-api,realtime-api,typescript pushed_at:2025-11 star:2.0k fork:0.5k A lightweight, powerful framework for multi-agent workflows and voice agents
...
- [openai/openai-chatkit-starter-app](https://github.com/openai/openai-chatkit-starter-app) topic:chatkit,openai,openai-api pushed_at:2025-11 star:0.7k fork:0.8k Starter app to build with OpenAI ChatKit + Agent Builder
- [openai/openai-cs-agents-demo](https://github.com/openai/openai-cs-agents-demo) topic: pushed_at:2025-08 star:5.9k fork:0.9k Demo of a customer service use case implemented with the OpenAI Agents SDK
...
- [openai/openai-guardrails-js](https://github.com/openai/openai-guardrails-js) topic: pushed_at:2025-11 star:0.1k fork:0.0k OpenAI Guardrails - TypeScript / JavaScript
- [openai/openai-node](https://github.com/openai/openai-node) topic:nodejs,openai,typescript pushed_at:2025-11 star:10.4k fork:1.3k Official JavaScript / TypeScript library for the OpenAI API
- [openai/openai-realtime-agents](https://github.com/openai/openai-realtime-agents) topic: pushed_at:2025-10 star:6.6k fork:1.0k This is a simple demonstration of more advanced, agentic patterns built on top of the Realtime API.
...
- [openai/openai-responses-starter-app](https://github.com/openai/openai-responses-starter-app) topic: pushed_at:2025-11 star:0.7k fork:0.3k Starter app to build with the OpenAI Responses API
- [openai/openai-sora-sample-app](https://github.com/openai/openai-sora-sample-app) topic: pushed_at:2025-10 star:0.0k fork:0.0k Sample app to get started using the Video API with Sora
- [openai/openai-structured-outputs-samples](https://github.com/openai/openai-structured-outputs-samples) topic: pushed_at:2025-01 star:0.7k fork:0.1k Sample apps to help developers get started with Structured Outputs
- [openai/openai-support-agent-demo](https://github.com/openai/openai-support-agent-demo) topic: pushed_at:2025-05 star:0.2k fork:0.1k Demo of a customer support agent interface using NextJS and the OpenAI Responses API with File Search
