...
- [openai/triton](https://github.com/openai/triton) topic: pushed_at:2024-04 star:10.9k fork:1.3k Development repository for the Triton language and compiler
...
- [openai/CLIP](https://github.com/openai/CLIP) topic:deep-learning,machine-learning pushed_at:2024-04 star:22.0k fork:3.0k CLIP (Contrastive Language-Image Pretraining),  Predict the most relevant text snippet given an image
...
- [openai/web-crawl-q-and-a-example](https://github.com/openai/web-crawl-q-and-a-example) topic:openai pushed_at:2024-04 star:0.2k fork:0.1k Learn how to crawl your website and build a Q/A bot with the OpenAI API
...
- [openai/openai-cookbook](https://github.com/openai/openai-cookbook) topic:chatgpt,gpt-4,openai,openai-api pushed_at:2024-04 star:55.7k fork:8.8k Examples and guides for using the OpenAI API
...
- [openai/openai-openapi](https://github.com/openai/openai-openapi) topic:openai,openai-api pushed_at:2024-04 star:0.9k fork:0.3k OpenAPI specification for the OpenAI API
...
- [openai/chatgpt-retrieval-plugin](https://github.com/openai/chatgpt-retrieval-plugin) topic:chatgpt,chatgpt-plugins pushed_at:2024-04 star:20.8k fork:3.7k The ChatGPT Retrieval Plugin lets you easily find personal or work documents by asking questions in natural language.
...
- [openai/consistencydecoder](https://github.com/openai/consistencydecoder) topic: pushed_at:2023-11 star:2.1k fork:0.1k Consistency Distilled Diff VAE
...
- [openai/evals](https://github.com/openai/evals) topic: pushed_at:2024-04 star:13.8k fork:2.5k Evals is a framework for evaluating LLMs and LLM systems, and an open-source registry of benchmarks.
...
- [openai/gpt-2](https://github.com/openai/gpt-2) topic:paper pushed_at:2024-04 star:21.1k fork:5.3k Code for the paper "Language Models are Unsupervised Multitask Learners"
...
- [openai/gpt-discord-bot](https://github.com/openai/gpt-discord-bot) topic: pushed_at:2024-04 star:1.7k fork:0.6k Example Discord bot written in Python that uses the completions API to have conversations with the `text-davinci-003` model, and the moderations API to filter the messages.
- [openai/grade-school-math](https://github.com/openai/grade-school-math) topic: pushed_at:2024-01 star:0.9k fork:0.1k 
- [openai/grok](https://github.com/openai/grok) topic: pushed_at:2024-03 star:4.0k fork:0.5k 
- [openai/guided-diffusion](https://github.com/openai/guided-diffusion) topic: pushed_at:2024-04 star:5.5k fork:0.7k 
- [openai/gym](https://github.com/openai/gym) topic: pushed_at:2024-04 star:33.8k fork:8.5k A toolkit for developing and comparing reinforcement learning algorithms.
...
- [openai/improved-diffusion](https://github.com/openai/improved-diffusion) topic: pushed_at:2024-03 star:2.8k fork:0.5k Release for Improved Denoising Diffusion Probabilistic Models
...
- [openai/jukebox](https://github.com/openai/jukebox) topic:audio,generative-model,music,paper,pytorch,transformer,vq-vae pushed_at:2024-03 star:7.6k fork:1.4k Code for the paper "Jukebox: A Generative Model for Music"
...
- [openai/maddpg](https://github.com/openai/maddpg) topic:paper pushed_at:2024-04 star:1.5k fork:0.5k Code for the MADDPG algorithm from the paper "Multi-Agent Actor-Critic for Mixed Cooperative-Competitive Environments"
...
- [openai/multiagent-particle-envs](https://github.com/openai/multiagent-particle-envs) topic:paper pushed_at:2024-04 star:2.2k fork:0.8k Code for a multi-agent particle environment used in the paper "Multi-Agent Actor-Critic for Mixed Cooperative-Competitive Environments"
...
- [openai/openai-python](https://github.com/openai/openai-python) topic:openai,python pushed_at:2024-04 star:19.7k fork:2.7k The official Python library for the OpenAI API
...
- [openai/plugins-quickstart](https://github.com/openai/plugins-quickstart) topic:chatgpt,chatgpt-plugins pushed_at:2024-01 star:4.3k fork:0.8k Get a ChatGPT plugin up and running in under 5 minutes!
...
- [openai/shap-e](https://github.com/openai/shap-e) topic: pushed_at:2024-02 star:11.3k fork:0.9k Generate 3D objects conditioned on text or images
- [openai/simple-evals](https://github.com/openai/simple-evals) topic: pushed_at:2024-04 star:0.7k fork:0.1k 
...
- [openai/tiktoken](https://github.com/openai/tiktoken) topic: pushed_at:2024-04 star:9.6k fork:0.7k tiktoken is a fast BPE tokeniser for use with OpenAI's models.
...
- [openai/transformer-debugger](https://github.com/openai/transformer-debugger) topic: pushed_at:2024-04 star:3.7k fork:0.2k 
...
- [openai/whisper](https://github.com/openai/whisper) topic: pushed_at:2024-04 star:59.8k fork:6.9k Robust Speech Recognition via Large-Scale Weak Supervision
...
- [openai/openai-deno-build](https://github.com/openai/openai-deno-build) topic:deno,openai,openai-api pushed_at:2024-04 star:0.1k fork:0.0k Deno build of the official Typescript library for the OpenAI API.
- [openai/openai-node](https://github.com/openai/openai-node) topic:nodejs,openai,typescript pushed_at:2024-04 star:6.8k fork:0.7k The official Node.js / Typescript library for the OpenAI API
