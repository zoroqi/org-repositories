...
- [openai/openai-dotnet](https://github.com/openai/openai-dotnet) topic:csharp,dotnet,openai pushed_at:2025-08 star:2.3k fork:0.3k The official .NET library for the OpenAI API
...
- [openai/openai-go](https://github.com/openai/openai-go) topic: pushed_at:2025-09 star:2.4k fork:0.2k The official Go library for the OpenAI API
...
- [openai/gpt-5-coding-examples](https://github.com/openai/gpt-5-coding-examples) topic:codex,coding,frontend,gpt,openai,web,website pushed_at:2025-08 star:1.5k fork:0.2k GPT-5 coding examples
...
- [openai/CLIP](https://github.com/openai/CLIP) topic:deep-learning,machine-learning pushed_at:2024-07 star:30.5k fork:3.7k CLIP (Contrastive Language-Image Pretraining),  Predict the most relevant text snippet given an image
...
- [openai/openai-cookbook](https://github.com/openai/openai-cookbook) topic:chatgpt,gpt-4,openai,openai-api pushed_at:2025-08 star:67.6k fork:11.2k Examples and guides for using the OpenAI API
...
- [openai/compose-richtext](https://github.com/openai/compose-richtext) topic: pushed_at:2025-08 star:0.1k fork:0.0k (OpenAI Fork) A collection of Compose libraries for advanced text formatting and alternative display types.
...
- [openai/model_spec](https://github.com/openai/model_spec) topic: pushed_at:2025-04 star:0.6k fork:0.1k The OpenAI Model Spec
...
- [openai/evals](https://github.com/openai/evals) topic: pushed_at:2024-12 star:16.9k fork:2.8k Evals is a framework for evaluating LLMs and LLM systems, and an open-source registry of benchmarks.
...
- [openai/gpt-2](https://github.com/openai/gpt-2) topic:paper pushed_at:2024-08 star:24.1k fork:5.8k Code for the paper "Language Models are Unsupervised Multitask Learners"
...
- [openai/gpt-oss](https://github.com/openai/gpt-oss) topic: pushed_at:2025-08 star:18.0k fork:1.7k gpt-oss-120b and gpt-oss-20b are two open-weight language models by OpenAI
...
- [openai/gym](https://github.com/openai/gym) topic: pushed_at:2024-10 star:36.4k fork:8.7k A toolkit for developing and comparing reinforcement learning algorithms.
...
- [openai/mle-bench](https://github.com/openai/mle-bench) topic: pushed_at:2025-08 star:0.9k fork:0.1k MLE-bench is a benchmark for measuring how well AI agents perform at machine learning engineering
...
- [openai/openai-agents-python](https://github.com/openai/openai-agents-python) topic:agents,ai,framework,llm,openai,python pushed_at:2025-09 star:14.1k fork:2.3k A lightweight, powerful framework for multi-agent workflows
...
- [openai/openai-python](https://github.com/openai/openai-python) topic:openai,python pushed_at:2025-09 star:28.5k fork:4.2k The official Python library for the OpenAI API
...
- [openai/simple-evals](https://github.com/openai/simple-evals) topic: pushed_at:2025-07 star:4.0k fork:0.4k 
...
- [openai/swarm](https://github.com/openai/swarm) topic: pushed_at:2025-03 star:20.3k fork:2.2k Educational framework exploring ergonomic, lightweight multi-agent orchestration. Managed by OpenAI Solution team.
- [openai/tiktoken](https://github.com/openai/tiktoken) topic: pushed_at:2025-09 star:15.7k fork:1.2k tiktoken is a fast BPE tokeniser for use with OpenAI's models.
...
- [openai/whisper](https://github.com/openai/whisper) topic: pushed_at:2025-08 star:87.5k fork:10.8k Robust Speech Recognition via Large-Scale Weak Supervision
...
- [openai/openai-ruby](https://github.com/openai/openai-ruby) topic: pushed_at:2025-08 star:0.3k fork:0.0k Official Ruby SDK for the OpenAI API

## Rust

- [openai/codex](https://github.com/openai/codex) topic: pushed_at:2025-09 star:37.7k fork:4.3k Lightweight coding agent that runs in your terminal
- [openai/harmony](https://github.com/openai/harmony) topic: pushed_at:2025-08 star:3.7k fork:0.2k Renderer for the harmony response format to be used with gpt-oss
...
- [openai/agents.md](https://github.com/openai/agents.md) topic: pushed_at:2025-08 star:4.5k fork:0.3k AGENTS.md — a simple, open format for guiding coding agents
...
- [openai/openai-agents-js](https://github.com/openai/openai-agents-js) topic: pushed_at:2025-09 star:1.2k fork:0.3k A lightweight, powerful framework for multi-agent workflows and voice agents
...
- [openai/openai-node](https://github.com/openai/openai-node) topic:nodejs,openai,typescript pushed_at:2025-08 star:10.0k fork:1.2k Official JavaScript / TypeScript library for the OpenAI API
- [openai/openai-realtime-agents](https://github.com/openai/openai-realtime-agents) topic: pushed_at:2025-08 star:6.3k fork:0.9k This is a simple demonstration of more advanced, agentic patterns built on top of the Realtime API.
...
- [openai/openai-responses-starter-app](https://github.com/openai/openai-responses-starter-app) topic: pushed_at:2025-08 star:0.6k fork:0.2k Starter app to build with the OpenAI Responses API
