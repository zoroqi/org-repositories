...
- [openai/openai-dotnet](https://github.com/openai/openai-dotnet) topic:csharp,dotnet,openai pushed_at:2025-07 star:2.1k fork:0.3k The official .NET library for the OpenAI API
...
- [openai/CLIP](https://github.com/openai/CLIP) topic:deep-learning,machine-learning pushed_at:2024-07 star:29.9k fork:3.7k CLIP (Contrastive Language-Image Pretraining),  Predict the most relevant text snippet given an image
...
- [openai/openai-cookbook](https://github.com/openai/openai-cookbook) topic:chatgpt,gpt-4,openai,openai-api pushed_at:2025-07 star:65.4k fork:10.8k Examples and guides for using the OpenAI API
...
- [openai/model_spec](https://github.com/openai/model_spec) topic: pushed_at:2025-04 star:0.4k fork:0.0k The OpenAI Model Spec
...
- [openai/evals](https://github.com/openai/evals) topic: pushed_at:2024-12 star:16.6k fork:2.8k Evals is a framework for evaluating LLMs and LLM systems, and an open-source registry of benchmarks.
...
- [openai/gpt-2](https://github.com/openai/gpt-2) topic:paper pushed_at:2024-08 star:23.8k fork:5.7k Code for the paper "Language Models are Unsupervised Multitask Learners"
...
- [openai/openai-agents-python](https://github.com/openai/openai-agents-python) topic:agents,ai,framework,llm,openai,python pushed_at:2025-07 star:12.7k fork:2.0k A lightweight, powerful framework for multi-agent workflows
...
- [openai/openai-python](https://github.com/openai/openai-python) topic:openai,python pushed_at:2025-07 star:27.4k fork:4.1k The official Python library for the OpenAI API
...
- [openai/simple-evals](https://github.com/openai/simple-evals) topic: pushed_at:2025-07 star:3.8k fork:0.4k 
...
- [openai/swarm](https://github.com/openai/swarm) topic: pushed_at:2025-03 star:20.1k fork:2.1k Educational framework exploring ergonomic, lightweight multi-agent orchestration. Managed by OpenAI Solution team.
...
- [openai/tiktoken](https://github.com/openai/tiktoken) topic: pushed_at:2025-03 star:15.1k fork:1.1k tiktoken is a fast BPE tokeniser for use with OpenAI's models.
...
- [openai/whisper](https://github.com/openai/whisper) topic: pushed_at:2025-06 star:85.0k fork:10.4k Robust Speech Recognition via Large-Scale Weak Supervision
...
- [openai/codex](https://github.com/openai/codex) topic: pushed_at:2025-07 star:31.0k fork:3.6k Lightweight coding agent that runs in your terminal
...
- [openai/openai-agents-js](https://github.com/openai/openai-agents-js) topic: pushed_at:2025-07 star:0.8k fork:0.1k A lightweight, powerful framework for multi-agent workflows and voice agents
...
- [openai/openai-cs-agents-demo](https://github.com/openai/openai-cs-agents-demo) topic: pushed_at:2025-06 star:5.6k fork:0.8k Demo of a customer service use case implemented with the OpenAI Agents SDK
...
- [openai/openai-node](https://github.com/openai/openai-node) topic:nodejs,openai,typescript pushed_at:2025-07 star:9.5k fork:1.1k Official JavaScript / TypeScript library for the OpenAI API
