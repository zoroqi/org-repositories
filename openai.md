...
- [openai/openai-dotnet](https://github.com/openai/openai-dotnet) topic:csharp,dotnet,openai pushed_at:2025-09 star:2.3k fork:0.3k The official .NET library for the OpenAI API
...
- [openai/openai-icpc-2025](https://github.com/openai/openai-icpc-2025) topic: pushed_at:2025-09 star:0.0k fork:0.0k OpenAI 2025 ICPC Submissions
...
- [openai/openai-go](https://github.com/openai/openai-go) topic: pushed_at:2025-09 star:2.5k fork:0.2k The official Go library for the OpenAI API
...
- [openai/build-hours](https://github.com/openai/build-hours) topic: pushed_at:2025-08 star:0.6k fork:0.1k Build hours code to share.
- [openai/CLIP](https://github.com/openai/CLIP) topic:deep-learning,machine-learning pushed_at:2024-07 star:30.9k fork:3.8k CLIP (Contrastive Language-Image Pretraining),  Predict the most relevant text snippet given an image
...
- [openai/openai-cookbook](https://github.com/openai/openai-cookbook) topic:chatgpt,gpt-4,openai,openai-api pushed_at:2025-09 star:68.2k fork:11.4k Examples and guides for using the OpenAI API
...
- [openai/compose-richtext](https://github.com/openai/compose-richtext) topic: pushed_at:2025-09 star:0.1k fork:0.0k (OpenAI Fork) A collection of Compose libraries for advanced text formatting and alternative display types.
- [openai/openai-java](https://github.com/openai/openai-java) topic: pushed_at:2025-09 star:1.1k fork:0.2k The official Java library for the OpenAI API
...
- [openai/evals](https://github.com/openai/evals) topic: pushed_at:2024-12 star:17.0k fork:2.8k Evals is a framework for evaluating LLMs and LLM systems, and an open-source registry of benchmarks.
...
- [openai/gpt-2](https://github.com/openai/gpt-2) topic:paper pushed_at:2024-08 star:24.2k fork:5.8k Code for the paper "Language Models are Unsupervised Multitask Learners"
...
- [openai/gpt-oss](https://github.com/openai/gpt-oss) topic: pushed_at:2025-09 star:18.6k fork:1.8k gpt-oss-120b and gpt-oss-20b are two open-weight language models by OpenAI
...
- [openai/gym](https://github.com/openai/gym) topic: pushed_at:2024-10 star:36.6k fork:8.7k A toolkit for developing and comparing reinforcement learning algorithms.
...
- [openai/mle-bench](https://github.com/openai/mle-bench) topic: pushed_at:2025-09 star:1.0k fork:0.1k MLE-bench is a benchmark for measuring how well AI agents perform at machine learning engineering
...
- [openai/openai-agents-python](https://github.com/openai/openai-agents-python) topic:agents,ai,framework,llm,openai,python pushed_at:2025-09 star:15.1k fork:2.5k A lightweight, powerful framework for multi-agent workflows
- [openai/openai-cua-sample-app](https://github.com/openai/openai-cua-sample-app) topic: pushed_at:2025-04 star:1.1k fork:0.3k Learn how to use CUA (our Computer Using Agent) via the API on multiple computer environments.
- [openai/openai-python](https://github.com/openai/openai-python) topic:openai,python pushed_at:2025-09 star:28.8k fork:4.3k The official Python library for the OpenAI API
...
- [openai/tiktoken](https://github.com/openai/tiktoken) topic: pushed_at:2025-09 star:16.1k fork:1.2k tiktoken is a fast BPE tokeniser for use with OpenAI's models.
...
- [openai/Video-Pre-Training](https://github.com/openai/Video-Pre-Training) topic: pushed_at:2025-09 star:1.5k fork:0.2k Video PreTraining (VPT): Learning to Act by Watching Unlabeled Online Videos
...
- [openai/whisper](https://github.com/openai/whisper) topic: pushed_at:2025-09 star:88.9k fork:11.1k Robust Speech Recognition via Large-Scale Weak Supervision
...
- [openai/openai-ruby](https://github.com/openai/openai-ruby) topic: pushed_at:2025-09 star:0.3k fork:0.0k Official Ruby SDK for the OpenAI API

## Rust

- [openai/codex](https://github.com/openai/codex) topic: pushed_at:2025-10 star:45.4k fork:5.4k Lightweight coding agent that runs in your terminal
- [openai/harmony](https://github.com/openai/harmony) topic: pushed_at:2025-08 star:3.8k fork:0.2k Renderer for the harmony response format to be used with gpt-oss
...
- [openai/snap-o](https://github.com/openai/snap-o) topic:android,developer-tools,teams pushed_at:2025-09 star:0.0k fork:0.0k Lightweight Android screen capture tool for macOS
...
- [openai/agents.md](https://github.com/openai/agents.md) topic: pushed_at:2025-09 star:6.7k fork:0.5k AGENTS.md — a simple, open format for guiding coding agents
...
- [openai/openai-agents-js](https://github.com/openai/openai-agents-js) topic: pushed_at:2025-09 star:1.5k fork:0.4k A lightweight, powerful framework for multi-agent workflows and voice agents
...
- [openai/openai-node](https://github.com/openai/openai-node) topic:nodejs,openai,typescript pushed_at:2025-10 star:10.1k fork:1.3k Official JavaScript / TypeScript library for the OpenAI API
- [openai/openai-realtime-agents](https://github.com/openai/openai-realtime-agents) topic: pushed_at:2025-09 star:6.5k fork:1.0k This is a simple demonstration of more advanced, agentic patterns built on top of the Realtime API.
...
- [openai/openai-responses-starter-app](https://github.com/openai/openai-responses-starter-app) topic: pushed_at:2025-09 star:0.6k fork:0.2k Starter app to build with the OpenAI Responses API
...
- [openai/openai-support-agent-demo](https://github.com/openai/openai-support-agent-demo) topic: pushed_at:2025-05 star:0.1k fork:0.1k Demo of a customer support agent interface using NextJS and the OpenAI Responses API with File Search
