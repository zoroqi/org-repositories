...
- [openai/openai-go](https://github.com/openai/openai-go) topic: pushed_at:2025-04 star:1.7k fork:0.1k The official Go library for the OpenAI API
...
- [openai/openai-realtime-console](https://github.com/openai/openai-realtime-console) topic:javascript,nodejs,openai,react,typescript pushed_at:2025-03 star:3.2k fork:1.2k React app for inspecting, building and debugging with the Realtime API
...
- [openai/CLIP](https://github.com/openai/CLIP) topic:deep-learning,machine-learning pushed_at:2024-07 star:28.8k fork:3.6k CLIP (Contrastive Language-Image Pretraining),  Predict the most relevant text snippet given an image
...
- [openai/compose-richtext](https://github.com/openai/compose-richtext) topic: pushed_at:2025-05 star:0.1k fork:0.0k (OpenAI Fork) A collection of Compose libraries for advanced text formatting and alternative display types.
- [openai/openai-java](https://github.com/openai/openai-java) topic: pushed_at:2025-05 star:0.8k fork:0.1k The official Java library for the OpenAI API
...
- [openai/openai-cookbook](https://github.com/openai/openai-cookbook) topic:chatgpt,gpt-4,openai,openai-api pushed_at:2025-04 star:63.6k fork:10.3k Examples and guides for using the OpenAI API
...
- [openai/openai-openapi](https://github.com/openai/openai-openapi) topic:openai,openai-api pushed_at:2025-04 star:2.0k fork:0.4k OpenAPI specification for the OpenAI API
...
- [openai/evals](https://github.com/openai/evals) topic: pushed_at:2024-12 star:16.0k fork:2.7k Evals is a framework for evaluating LLMs and LLM systems, and an open-source registry of benchmarks.
...
- [openai/gpt-2](https://github.com/openai/gpt-2) topic:paper pushed_at:2024-08 star:23.4k fork:5.7k Code for the paper "Language Models are Unsupervised Multitask Learners"
...
- [openai/guided-diffusion](https://github.com/openai/guided-diffusion) topic: pushed_at:2024-07 star:6.8k fork:0.9k 
- [openai/gym](https://github.com/openai/gym) topic: pushed_at:2024-10 star:35.9k fork:8.7k A toolkit for developing and comparing reinforcement learning algorithms.
...
- [openai/openai-agents-python](https://github.com/openai/openai-agents-python) topic:agents,ai,framework,llm,openai,python pushed_at:2025-04 star:9.7k fork:1.3k A lightweight, powerful framework for multi-agent workflows
...
- [openai/openai-python](https://github.com/openai/openai-python) topic:openai,python pushed_at:2025-05 star:26.5k fork:3.8k The official Python library for the OpenAI API
...
- [openai/simple-evals](https://github.com/openai/simple-evals) topic: pushed_at:2025-04 star:2.8k fork:0.2k 
...
- [openai/swarm](https://github.com/openai/swarm) topic: pushed_at:2025-03 star:19.7k fork:2.1k Educational framework exploring ergonomic, lightweight multi-agent orchestration. Managed by OpenAI Solution team.
- [openai/SWELancer-Benchmark](https://github.com/openai/SWELancer-Benchmark) topic: pushed_at:2025-04 star:1.4k fork:0.1k This repo contains the dataset and code for the paper "SWE-Lancer: Can Frontier LLMs Earn $1 Million from Real-World Freelance Software Engineering?"
- [openai/tiktoken](https://github.com/openai/tiktoken) topic: pushed_at:2025-03 star:14.3k fork:1.0k tiktoken is a fast BPE tokeniser for use with OpenAI's models.
...
- [openai/whisper](https://github.com/openai/whisper) topic: pushed_at:2025-01 star:81.0k fork:9.7k Robust Speech Recognition via Large-Scale Weak Supervision
...
- [openai/openai-ruby](https://github.com/openai/openai-ruby) topic: pushed_at:2025-04 star:0.1k fork:0.0k 
...
- [openai/codex](https://github.com/openai/codex) topic: pushed_at:2025-05 star:21.1k fork:2.0k Lightweight coding agent that runs in your terminal
...
- [openai/openai-fm](https://github.com/openai/openai-fm) topic: pushed_at:2025-04 star:0.4k fork:0.0k Code for openai.fm, a demo for the OpenAI Speech API
- [openai/openai-node](https://github.com/openai/openai-node) topic:nodejs,openai,typescript pushed_at:2025-04 star:9.1k fork:1.1k Official JavaScript / TypeScript library for the OpenAI API
- [openai/openai-realtime-agents](https://github.com/openai/openai-realtime-agents) topic: pushed_at:2025-03 star:5.5k fork:0.6k This is a simple demonstration of more advanced, agentic patterns built on top of the Realtime API.
...
- [openai/openai-responses-starter-app](https://github.com/openai/openai-responses-starter-app) topic: pushed_at:2025-04 star:0.2k fork:0.1k Starter app to build with the OpenAI Responses API
...
- [openai/openai-support-agent-demo](https://github.com/openai/openai-support-agent-demo) topic: pushed_at:2025-04 star:0.1k fork:0.0k Demo of a customer support agent interface using NextJS and the OpenAI Responses API with File Search
- [openai/openai-voice-agent-sdk-sample](https://github.com/openai/openai-voice-agent-sdk-sample) topic: pushed_at:2025-04 star:0.2k fork:0.0k Sample application to add voice capabilities to the Agents SDK
