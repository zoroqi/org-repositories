...
- [openai/triton](https://github.com/openai/triton) topic: pushed_at:2024-01 star:9.5k fork:1.1k Development repository for the Triton language and compiler
...
- [openai/CLIP](https://github.com/openai/CLIP) topic:deep-learning,machine-learning pushed_at:2024-01 star:20.2k fork:2.8k CLIP (Contrastive Language-Image Pretraining),  Predict the most relevant text snippet given an image
...
- [openai/openai-cookbook](https://github.com/openai/openai-cookbook) topic:chatgpt,docs,gpt-3,gpt-4,openai pushed_at:2024-01 star:53.1k fork:8.9k Examples and guides for using the OpenAI API
...
- [openai/chatgpt-retrieval-plugin](https://github.com/openai/chatgpt-retrieval-plugin) topic:chatgpt,chatgpt-plugins pushed_at:2024-01 star:20.4k fork:3.8k The ChatGPT Retrieval Plugin lets you easily find personal or work documents by asking questions in natural language.
...
- [openai/evals](https://github.com/openai/evals) topic: pushed_at:2024-01 star:13.0k fork:2.4k Evals is a framework for evaluating LLMs and LLM systems, and an open-source registry of benchmarks.
...
- [openai/gpt-2](https://github.com/openai/gpt-2) topic:paper pushed_at:2023-11 star:20.5k fork:5.2k Code for the paper "Language Models are Unsupervised Multitask Learners"
...
- [openai/gym](https://github.com/openai/gym) topic: pushed_at:2023-10 star:33.4k fork:8.7k A toolkit for developing and comparing reinforcement learning algorithms.
...
- [openai/openai-python](https://github.com/openai/openai-python) topic:openai,python pushed_at:2024-01 star:17.7k fork:2.4k The official Python library for the OpenAI API
...
- [openai/plugins-quickstart](https://github.com/openai/plugins-quickstart) topic:chatgpt,chatgpt-plugins pushed_at:2023-12 star:4.2k fork:0.9k Get a ChatGPT plugin up and running in under 5 minutes!
...
- [openai/shap-e](https://github.com/openai/shap-e) topic: pushed_at:2023-11 star:10.9k fork:0.8k Generate 3D objects conditioned on text or images
...
- [openai/tiktoken](https://github.com/openai/tiktoken) topic: pushed_at:2024-01 star:8.1k fork:0.6k tiktoken is a fast BPE tokeniser for use with OpenAI's models.
...
- [openai/whisper](https://github.com/openai/whisper) topic: pushed_at:2024-01 star:54.3k fork:6.2k Robust Speech Recognition via Large-Scale Weak Supervision
...
- [openai/openai-node](https://github.com/openai/openai-node) topic:nodejs,openai,typescript pushed_at:2024-01 star:6.2k fork:0.6k The official Node.js / Typescript library for the OpenAI API
