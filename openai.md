...
- [openai/retro](https://github.com/openai/retro) topic: pushed_at:2024-01 star:3.3k fork:0.5k Retro Games in Gym
...
- [openai/procgen](https://github.com/openai/procgen) topic: pushed_at:2024-01 star:1.0k fork:0.2k Procgen Benchmark: Procedurally-Generated Game-Like Gym-Environments
...
- [openai/democratic-inputs](https://github.com/openai/democratic-inputs) topic: pushed_at:2024-01 star:0.0k fork:0.0k 
...
- [openai/openai-quickstart-node](https://github.com/openai/openai-quickstart-node) topic:openai,openai-api pushed_at:2024-02 star:2.5k fork:2.0k Node.js example app from the OpenAI API quickstart tutorial
...
- [openai/CLIP](https://github.com/openai/CLIP) topic:deep-learning,machine-learning pushed_at:2024-01 star:20.7k fork:2.9k CLIP (Contrastive Language-Image Pretraining),  Predict the most relevant text snippet given an image
...
- [openai/web-crawl-q-and-a-example](https://github.com/openai/web-crawl-q-and-a-example) topic:openai pushed_at:2024-01 star:0.2k fork:0.1k Learn how to crawl your website and build a Q/A bot with the OpenAI API

## Kotlin

- [openai/compose-richtext](https://github.com/openai/compose-richtext) topic: pushed_at:2024-02 star:0.0k fork:0.0k (OpenAI Fork) A collection of Compose libraries for advanced text formatting and alternative display types.
...
- [openai/openai-cookbook](https://github.com/openai/openai-cookbook) topic:chatgpt,gpt-4,openai,openai-api pushed_at:2024-02 star:53.9k fork:9.0k Examples and guides for using the OpenAI API
...
- [openai/openai-openapi](https://github.com/openai/openai-openapi) topic:openai,openai-api pushed_at:2024-02 star:0.8k fork:0.3k OpenAPI specification for the OpenAI API
- [openai/openai-quickstart-python](https://github.com/openai/openai-quickstart-python) topic:openai,openai-api pushed_at:2024-02 star:1.6k fork:1.3k Python example app from the OpenAI API quickstart tutorial
...
- [openai/automated-interpretability](https://github.com/openai/automated-interpretability) topic: pushed_at:2024-02 star:0.8k fork:0.1k 
- [openai/baselines](https://github.com/openai/baselines) topic: pushed_at:2023-11 star:15.2k fork:4.9k OpenAI Baselines: high-quality implementations of reinforcement learning algorithms
...
- [openai/chatgpt-retrieval-plugin](https://github.com/openai/chatgpt-retrieval-plugin) topic:chatgpt,chatgpt-plugins pushed_at:2024-02 star:20.6k fork:3.8k The ChatGPT Retrieval Plugin lets you easily find personal or work documents by asking questions in natural language.
...
- [openai/consistencydecoder](https://github.com/openai/consistencydecoder) topic: pushed_at:2023-11 star:2.0k fork:0.1k Consistency Distilled Diff VAE
- [openai/DALL-E](https://github.com/openai/DALL-E) topic: pushed_at:2024-01 star:10.6k fork:1.9k PyTorch package for the discrete VAE used for DALL·E.
...
- [openai/evals](https://github.com/openai/evals) topic: pushed_at:2024-02 star:13.3k fork:2.4k Evals is a framework for evaluating LLMs and LLM systems, and an open-source registry of benchmarks.
...
- [openai/gpt-2](https://github.com/openai/gpt-2) topic:paper pushed_at:2024-01 star:20.6k fork:5.3k Code for the paper "Language Models are Unsupervised Multitask Learners"
- [openai/gpt-2-output-dataset](https://github.com/openai/gpt-2-output-dataset) topic: pushed_at:2023-12 star:1.9k fork:0.5k Dataset of GPT-2 outputs for research in detection, biases, and more
- [openai/gpt-discord-bot](https://github.com/openai/gpt-discord-bot) topic: pushed_at:2024-02 star:1.7k fork:0.6k Example Discord bot written in Python that uses the completions API to have conversations with the `text-davinci-003` model, and the moderations API to filter the messages.
- [openai/grade-school-math](https://github.com/openai/grade-school-math) topic: pushed_at:2024-01 star:0.8k fork:0.1k 
- [openai/grok](https://github.com/openai/grok) topic: pushed_at:2023-04 star:0.1k fork:0.0k 
- [openai/guided-diffusion](https://github.com/openai/guided-diffusion) topic: pushed_at:2023-04 star:5.2k fork:0.7k 
- [openai/gym](https://github.com/openai/gym) topic: pushed_at:2023-10 star:33.5k fork:8.7k A toolkit for developing and comparing reinforcement learning algorithms.
...
- [openai/human-eval](https://github.com/openai/human-eval) topic: pushed_at:2024-02 star:1.7k fork:0.3k Code for the paper "Evaluating Large Language Models Trained on Code"
...
- [openai/improved-diffusion](https://github.com/openai/improved-diffusion) topic: pushed_at:2023-08 star:2.6k fork:0.4k Release for Improved Denoising Diffusion Probabilistic Models
...
- [openai/jukebox](https://github.com/openai/jukebox) topic:audio,generative-model,music,paper,pytorch,transformer,vq-vae pushed_at:2023-04 star:7.4k fork:1.3k Code for the paper "Jukebox: A Generative Model for Music"
...
- [openai/maddpg](https://github.com/openai/maddpg) topic:paper pushed_at:2024-02 star:1.4k fork:0.5k Code for the MADDPG algorithm from the paper "Multi-Agent Actor-Critic for Mixed Cooperative-Competitive Environments"
...
- [openai/multi-agent-emergence-environments](https://github.com/openai/multi-agent-emergence-environments) topic: pushed_at:2023-04 star:1.6k fork:0.3k Environment generation code for the paper "Emergent Tool Use From Multi-Agent Autocurricula"
...
- [openai/multiagent-particle-envs](https://github.com/openai/multiagent-particle-envs) topic:paper pushed_at:2023-05 star:2.1k fork:0.8k Code for a multi-agent particle environment used in the paper "Multi-Agent Actor-Critic for Mixed Cooperative-Competitive Environments"
...
- [openai/openai-python](https://github.com/openai/openai-python) topic:openai,python pushed_at:2024-02 star:18.4k fork:2.5k The official Python library for the OpenAI API
...
- [openai/plugins-quickstart](https://github.com/openai/plugins-quickstart) topic:chatgpt,chatgpt-plugins pushed_at:2024-01 star:4.2k fork:0.9k Get a ChatGPT plugin up and running in under 5 minutes!
- [openai/point-e](https://github.com/openai/point-e) topic: pushed_at:2023-10 star:6.2k fork:0.7k Point cloud diffusion for 3D model synthesis
...
- [openai/shap-e](https://github.com/openai/shap-e) topic: pushed_at:2024-02 star:11.0k fork:0.9k Generate 3D objects conditioned on text or images
...
- [openai/sparse_attention](https://github.com/openai/sparse_attention) topic: pushed_at:2020-08 star:1.5k fork:0.2k Examples of using sparse attention, as in "Generating Long Sequences with Sparse Transformers"
- [openai/sparse_autoencoder](https://github.com/openai/sparse_autoencoder) topic: pushed_at:2024-01 star:0.0k fork:0.0k 
- [openai/spinningup](https://github.com/openai/spinningup) topic: pushed_at:2024-01 star:9.4k fork:2.1k An educational resource to help anyone learn deep reinforcement learning.
...
- [openai/tiktoken](https://github.com/openai/tiktoken) topic: pushed_at:2024-02 star:8.5k fork:0.6k tiktoken is a fast BPE tokeniser for use with OpenAI's models.
...
- [openai/triton](https://github.com/openai/triton) topic: pushed_at:2024-02 star:9.9k fork:1.1k Development repository for the Triton language and compiler
...
- [openai/Video-Pre-Training](https://github.com/openai/Video-Pre-Training) topic: pushed_at:2024-01 star:1.1k fork:0.1k Video PreTraining (VPT): Learning to Act by Watching Unlabeled Online Videos
...
- [openai/weak-to-strong](https://github.com/openai/weak-to-strong) topic: pushed_at:2024-02 star:2.3k fork:0.3k 
...
- [openai/whisper](https://github.com/openai/whisper) topic: pushed_at:2024-02 star:56.0k fork:6.5k Robust Speech Recognition via Large-Scale Weak Supervision
...
- [openai/openai-deno-build](https://github.com/openai/openai-deno-build) topic:deno,openai,openai-api pushed_at:2024-02 star:0.1k fork:0.0k Deno build of the official Typescript library for the OpenAI API.
- [openai/openai-node](https://github.com/openai/openai-node) topic:nodejs,openai,typescript pushed_at:2024-02 star:6.4k fork:0.6k The official Node.js / Typescript library for the OpenAI API
