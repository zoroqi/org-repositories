...
- [openai/openai-dotnet](https://github.com/openai/openai-dotnet) topic:csharp,dotnet,openai pushed_at:2024-08 star:1.0k fork:0.1k The official .NET library for the OpenAI API
...
- [openai/openai-go](https://github.com/openai/openai-go) topic: pushed_at:2024-08 star:0.1k fork:0.0k The official Go library for the OpenAI API
...
- [openai/CLIP](https://github.com/openai/CLIP) topic:deep-learning,machine-learning pushed_at:2024-07 star:24.4k fork:3.2k CLIP (Contrastive Language-Image Pretraining),  Predict the most relevant text snippet given an image
...
- [openai/openai-cookbook](https://github.com/openai/openai-cookbook) topic:chatgpt,gpt-4,openai,openai-api pushed_at:2024-08 star:58.3k fork:9.2k Examples and guides for using the OpenAI API
...
- [openai/evals](https://github.com/openai/evals) topic: pushed_at:2024-08 star:14.6k fork:2.6k Evals is a framework for evaluating LLMs and LLM systems, and an open-source registry of benchmarks.
...
- [openai/gpt-2](https://github.com/openai/gpt-2) topic:paper pushed_at:2024-08 star:22.2k fork:5.5k Code for the paper "Language Models are Unsupervised Multitask Learners"
...
- [openai/openai-python](https://github.com/openai/openai-python) topic:openai,python pushed_at:2024-08 star:21.8k fork:3.0k The official Python library for the OpenAI API
...
- [openai/point-e](https://github.com/openai/point-e) topic: pushed_at:2024-07 star:6.5k fork:0.7k Point cloud diffusion for 3D model synthesis
...
- [openai/tiktoken](https://github.com/openai/tiktoken) topic: pushed_at:2024-08 star:11.6k fork:0.8k tiktoken is a fast BPE tokeniser for use with OpenAI's models.
...
- [openai/whisper](https://github.com/openai/whisper) topic: pushed_at:2024-08 star:66.9k fork:7.9k Robust Speech Recognition via Large-Scale Weak Supervision
...
- [openai/openai-node](https://github.com/openai/openai-node) topic:nodejs,openai,typescript pushed_at:2024-08 star:7.6k fork:0.8k The official Node.js / Typescript library for the OpenAI API
