...
- [openai/retro](https://github.com/openai/retro) topic: pushed_at:2024-02 star:3.4k fork:0.5k Retro Games in Gym

## C#

- [openai/openai-dotnet](https://github.com/openai/openai-dotnet) topic:csharp,dotnet,openai pushed_at:2024-12 star:1.7k fork:0.2k The official .NET library for the OpenAI API
...
- [openai/openai-realtime-embedded-sdk](https://github.com/openai/openai-realtime-embedded-sdk) topic: pushed_at:2025-01 star:1.4k fork:0.1k A SDK to using the Realtime API with Microcontrollers like the ESP32
...
- [openai/kubernetes](https://github.com/openai/kubernetes) topic: pushed_at:2024-10 star:0.0k fork:0.0k Production-Grade Container Scheduling and Management
...
- [openai/openai-go](https://github.com/openai/openai-go) topic: pushed_at:2025-01 star:0.9k fork:0.1k The official Go library for the OpenAI API
...
- [openai/openai-quickstart-node](https://github.com/openai/openai-quickstart-node) topic:openai,openai-api pushed_at:2024-02 star:2.6k fork:2.0k Node.js example app from the OpenAI API quickstart tutorial
- [openai/openai-realtime-api-beta](https://github.com/openai/openai-realtime-api-beta) topic:javascript,nodejs,openai,typescript pushed_at:2024-11 star:0.8k fork:0.2k Node.js + JavaScript reference client for the Realtime API (beta)
- [openai/openai-realtime-console](https://github.com/openai/openai-realtime-console) topic:javascript,nodejs,openai,react,typescript pushed_at:2025-01 star:2.6k fork:1.0k React app for inspecting, building and debugging with the Realtime API
...
- [openai/CLIP](https://github.com/openai/CLIP) topic:deep-learning,machine-learning pushed_at:2024-07 star:27.0k fork:3.4k CLIP (Contrastive Language-Image Pretraining),  Predict the most relevant text snippet given an image
...
- [openai/compose-richtext](https://github.com/openai/compose-richtext) topic: pushed_at:2024-11 star:0.0k fork:0.0k (OpenAI Fork) A collection of Compose libraries for advanced text formatting and alternative display types.
- [openai/openai-java](https://github.com/openai/openai-java) topic: pushed_at:2025-01 star:0.3k fork:0.0k The official Java library for the OpenAI API
...
- [openai/openai-cookbook](https://github.com/openai/openai-cookbook) topic:chatgpt,gpt-4,openai,openai-api pushed_at:2025-01 star:61.2k fork:9.8k Examples and guides for using the OpenAI API
...
- [openai/openai-openapi](https://github.com/openai/openai-openapi) topic:openai,openai-api pushed_at:2024-12 star:1.8k fork:0.4k OpenAPI specification for the OpenAI API
...
- [openai/baselines](https://github.com/openai/baselines) topic: pushed_at:2024-08 star:16.0k fork:4.9k OpenAI Baselines: high-quality implementations of reinforcement learning algorithms
...
- [openai/chz](https://github.com/openai/chz) topic: pushed_at:2024-12 star:0.0k fork:0.0k 
...
- [openai/consistency_models](https://github.com/openai/consistency_models) topic: pushed_at:2024-03 star:6.2k fork:0.4k Official repo for consistency models.
...
- [openai/evals](https://github.com/openai/evals) topic: pushed_at:2024-12 star:15.3k fork:2.6k Evals is a framework for evaluating LLMs and LLM systems, and an open-source registry of benchmarks.
...
- [openai/gpt-2](https://github.com/openai/gpt-2) topic:paper pushed_at:2024-08 star:22.8k fork:5.6k Code for the paper "Language Models are Unsupervised Multitask Learners"
...
- [openai/guided-diffusion](https://github.com/openai/guided-diffusion) topic: pushed_at:2024-07 star:6.5k fork:0.8k 
- [openai/gym](https://github.com/openai/gym) topic: pushed_at:2024-10 star:35.2k fork:8.6k A toolkit for developing and comparing reinforcement learning algorithms.
...
- [openai/human-eval](https://github.com/openai/human-eval) topic: pushed_at:2025-01 star:2.5k fork:0.4k Code for the paper "Evaluating Large Language Models Trained on Code"
...
- [openai/improved-diffusion](https://github.com/openai/improved-diffusion) topic: pushed_at:2024-07 star:3.4k fork:0.5k Release for Improved Denoising Diffusion Probabilistic Models
...
- [openai/multiagent-particle-envs](https://github.com/openai/multiagent-particle-envs) topic:paper pushed_at:2024-04 star:2.4k fork:0.8k Code for a multi-agent particle environment used in the paper "Multi-Agent Actor-Critic for Mixed Cooperative-Competitive Environments"
...
- [openai/openai-python](https://github.com/openai/openai-python) topic:openai,python pushed_at:2025-01 star:24.0k fork:3.4k The official Python library for the OpenAI API
...
- [openai/point-e](https://github.com/openai/point-e) topic: pushed_at:2024-07 star:6.6k fork:0.8k Point cloud diffusion for 3D model synthesis
- [openai/prm800k](https://github.com/openai/prm800k) topic: pushed_at:2023-06 star:1.8k fork:0.1k 800,000 step-level correctness labels on LLM solutions to MATH problems
...
- [openai/simple-evals](https://github.com/openai/simple-evals) topic: pushed_at:2025-01 star:2.2k fork:0.2k 
...
- [openai/spinningup](https://github.com/openai/spinningup) topic: pushed_at:2024-08 star:10.4k fork:2.3k An educational resource to help anyone learn deep reinforcement learning.
...
- [openai/swarm](https://github.com/openai/swarm) topic: pushed_at:2024-10 star:17.7k fork:1.8k Educational framework exploring ergonomic, lightweight multi-agent orchestration. Managed by OpenAI Solution team.
- [openai/tiktoken](https://github.com/openai/tiktoken) topic: pushed_at:2024-10 star:13.0k fork:0.9k tiktoken is a fast BPE tokeniser for use with OpenAI's models.
...
- [openai/whisper](https://github.com/openai/whisper) topic: pushed_at:2025-01 star:74.4k fork:8.9k Robust Speech Recognition via Large-Scale Weak Supervision
...
- [openai/openai-assistants-quickstart](https://github.com/openai/openai-assistants-quickstart) topic: pushed_at:2024-07 star:1.7k fork:0.4k OpenAI Assistants API quickstart with Next.js.
...
- [openai/openai-node](https://github.com/openai/openai-node) topic:nodejs,openai,typescript pushed_at:2025-01 star:8.3k fork:0.9k Official JavaScript / TypeScript library for the OpenAI API
- [openai/openai-realtime-agents](https://github.com/openai/openai-realtime-agents) topic: pushed_at:2025-01 star:0.1k fork:0.0k This is a simple demonstration of more advanced, agentic patterns built on top of the Realtime API.
- [openai/openai-realtime-solar-system](https://github.com/openai/openai-realtime-solar-system) topic: pushed_at:2025-01 star:0.0k fork:0.0k Demo showing how to use the OpenAI Realtime API to navigate a 3D scene via tool calling
- [openai/openai-realtime-twilio-demo](https://github.com/openai/openai-realtime-twilio-demo) topic: pushed_at:2024-12 star:0.1k fork:0.0k 
- [openai/openai-structured-outputs-samples](https://github.com/openai/openai-structured-outputs-samples) topic: pushed_at:2025-01 star:0.5k fork:0.0k Sample apps to help developers get started with Structured Outputs
