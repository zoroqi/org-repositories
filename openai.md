...
- [openai/openai-dotnet](https://github.com/openai/openai-dotnet) topic:csharp,dotnet,openai pushed_at:2025-02 star:1.8k fork:0.2k The official .NET library for the OpenAI API
...
- [openai/openai-realtime-embedded-sdk](https://github.com/openai/openai-realtime-embedded-sdk) topic: pushed_at:2025-01 star:1.5k fork:0.2k A SDK to using the Realtime API with Microcontrollers like the ESP32
...
- [openai/openai-go](https://github.com/openai/openai-go) topic: pushed_at:2025-02 star:1.2k fork:0.1k The official Go library for the OpenAI API
...
- [openai/openai-realtime-console](https://github.com/openai/openai-realtime-console) topic:javascript,nodejs,openai,react,typescript pushed_at:2025-02 star:2.9k fork:1.1k React app for inspecting, building and debugging with the Realtime API
...
- [openai/CLIP](https://github.com/openai/CLIP) topic:deep-learning,machine-learning pushed_at:2024-07 star:27.4k fork:3.4k CLIP (Contrastive Language-Image Pretraining),  Predict the most relevant text snippet given an image
...
- [openai/openai-java](https://github.com/openai/openai-java) topic: pushed_at:2025-02 star:0.5k fork:0.1k The official Java library for the OpenAI API
...
- [openai/openai-cookbook](https://github.com/openai/openai-cookbook) topic:chatgpt,gpt-4,openai,openai-api pushed_at:2025-02 star:61.9k fork:10.0k Examples and guides for using the OpenAI API
...
- [openai/model_spec](https://github.com/openai/model_spec) topic: pushed_at:2025-02 star:0.2k fork:0.0k The OpenAI Model Spec
...
- [openai/openai-openapi](https://github.com/openai/openai-openapi) topic:openai,openai-api pushed_at:2025-02 star:1.9k fork:0.4k OpenAPI specification for the OpenAI API
...
- [openai/evals](https://github.com/openai/evals) topic: pushed_at:2024-12 star:15.5k fork:2.7k Evals is a framework for evaluating LLMs and LLM systems, and an open-source registry of benchmarks.
...
- [openai/gpt-2](https://github.com/openai/gpt-2) topic:paper pushed_at:2024-08 star:23.0k fork:5.6k Code for the paper "Language Models are Unsupervised Multitask Learners"
...
- [openai/gym](https://github.com/openai/gym) topic: pushed_at:2024-10 star:35.4k fork:8.6k A toolkit for developing and comparing reinforcement learning algorithms.
...
- [openai/openai-python](https://github.com/openai/openai-python) topic:openai,python pushed_at:2025-02 star:24.6k fork:3.6k The official Python library for the OpenAI API
...
- [openai/simple-evals](https://github.com/openai/simple-evals) topic: pushed_at:2025-02 star:2.3k fork:0.2k 
...
- [openai/spinningup](https://github.com/openai/spinningup) topic: pushed_at:2024-08 star:10.5k fork:2.3k An educational resource to help anyone learn deep reinforcement learning.
...
- [openai/swarm](https://github.com/openai/swarm) topic: pushed_at:2024-10 star:18.7k fork:2.0k Educational framework exploring ergonomic, lightweight multi-agent orchestration. Managed by OpenAI Solution team.
- [openai/tiktoken](https://github.com/openai/tiktoken) topic: pushed_at:2025-02 star:13.4k fork:0.9k tiktoken is a fast BPE tokeniser for use with OpenAI's models.
...
- [openai/whisper](https://github.com/openai/whisper) topic: pushed_at:2025-01 star:76.4k fork:9.1k Robust Speech Recognition via Large-Scale Weak Supervision
...
- [openai/openai-assistants-quickstart](https://github.com/openai/openai-assistants-quickstart) topic: pushed_at:2024-07 star:1.7k fork:0.5k OpenAI Assistants API quickstart with Next.js.
...
- [openai/openai-node](https://github.com/openai/openai-node) topic:nodejs,openai,typescript pushed_at:2025-02 star:8.5k fork:1.0k Official JavaScript / TypeScript library for the OpenAI API
- [openai/openai-realtime-agents](https://github.com/openai/openai-realtime-agents) topic: pushed_at:2025-02 star:5.0k fork:0.5k This is a simple demonstration of more advanced, agentic patterns built on top of the Realtime API.
- [openai/openai-realtime-solar-system](https://github.com/openai/openai-realtime-solar-system) topic: pushed_at:2025-01 star:0.4k fork:0.0k Demo showing how to use the OpenAI Realtime API to navigate a 3D scene via tool calling
- [openai/openai-realtime-twilio-demo](https://github.com/openai/openai-realtime-twilio-demo) topic: pushed_at:2024-12 star:0.2k fork:0.0k 
- [openai/openai-structured-outputs-samples](https://github.com/openai/openai-structured-outputs-samples) topic: pushed_at:2025-01 star:0.6k fork:0.0k Sample apps to help developers get started with Structured Outputs
