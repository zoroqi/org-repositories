...
- [openai/openai-dotnet](https://github.com/openai/openai-dotnet) topic:csharp,dotnet,openai pushed_at:2025-05 star:2.0k fork:0.3k The official .NET library for the OpenAI API
...
- [openai/codex-universal](https://github.com/openai/codex-universal) topic: pushed_at:2025-05 star:0.3k fork:0.1k Base docker image used in Codex environments
...
- [openai/openai-go](https://github.com/openai/openai-go) topic: pushed_at:2025-06 star:1.9k fork:0.1k The official Go library for the OpenAI API
...
- [openai/openai-realtime-console](https://github.com/openai/openai-realtime-console) topic:javascript,nodejs,openai,react,typescript pushed_at:2025-03 star:3.3k fork:1.2k React app for inspecting, building and debugging with the Realtime API
...
- [openai/build-hours](https://github.com/openai/build-hours) topic: pushed_at:2025-05 star:0.3k fork:0.1k Build hours code to share.
- [openai/CLIP](https://github.com/openai/CLIP) topic:deep-learning,machine-learning pushed_at:2024-07 star:29.2k fork:3.6k CLIP (Contrastive Language-Image Pretraining),  Predict the most relevant text snippet given an image
...
- [openai/openai-cookbook](https://github.com/openai/openai-cookbook) topic:chatgpt,gpt-4,openai,openai-api pushed_at:2025-05 star:64.4k fork:10.6k Examples and guides for using the OpenAI API
...
- [openai/openai-openapi](https://github.com/openai/openai-openapi) topic:openai,openai-api pushed_at:2025-05 star:2.0k fork:0.5k OpenAPI specification for the OpenAI API
...
- [openai/evals](https://github.com/openai/evals) topic: pushed_at:2024-12 star:16.3k fork:2.7k Evals is a framework for evaluating LLMs and LLM systems, and an open-source registry of benchmarks.
...
- [openai/human-eval](https://github.com/openai/human-eval) topic: pushed_at:2025-01 star:2.8k fork:0.4k Code for the paper "Evaluating Large Language Models Trained on Code"
...
- [openai/openai-agents-python](https://github.com/openai/openai-agents-python) topic:agents,ai,framework,llm,openai,python pushed_at:2025-06 star:10.9k fork:1.6k A lightweight, powerful framework for multi-agent workflows
...
- [openai/openai-python](https://github.com/openai/openai-python) topic:openai,python pushed_at:2025-05 star:26.9k fork:3.9k The official Python library for the OpenAI API
...
- [openai/preparedness](https://github.com/openai/preparedness) topic: pushed_at:2025-05 star:0.8k fork:0.1k Releases from OpenAI Preparedness
...
- [openai/simple-evals](https://github.com/openai/simple-evals) topic: pushed_at:2025-05 star:3.6k fork:0.3k 
...
- [openai/swarm](https://github.com/openai/swarm) topic: pushed_at:2025-03 star:19.9k fork:2.1k Educational framework exploring ergonomic, lightweight multi-agent orchestration. Managed by OpenAI Solution team.
...
- [openai/tiktoken](https://github.com/openai/tiktoken) topic: pushed_at:2025-03 star:14.7k fork:1.1k tiktoken is a fast BPE tokeniser for use with OpenAI's models.
...
- [openai/Video-Pre-Training](https://github.com/openai/Video-Pre-Training) topic: pushed_at:2024-06 star:1.5k fork:0.1k Video PreTraining (VPT): Learning to Act by Watching Unlabeled Online Videos
...
- [openai/whisper](https://github.com/openai/whisper) topic: pushed_at:2025-05 star:82.6k fork:10.0k Robust Speech Recognition via Large-Scale Weak Supervision
...
- [openai/openai-ruby](https://github.com/openai/openai-ruby) topic: pushed_at:2025-05 star:0.2k fork:0.0k Official Ruby SDK for the OpenAI API
...
- [openai/codex](https://github.com/openai/codex) topic: pushed_at:2025-05 star:27.6k fork:2.9k Lightweight coding agent that runs in your terminal
...
- [openai/openai-fm](https://github.com/openai/openai-fm) topic: pushed_at:2025-04 star:0.4k fork:0.1k Code for openai.fm, a demo for the OpenAI Speech API
- [openai/openai-node](https://github.com/openai/openai-node) topic:nodejs,openai,typescript pushed_at:2025-05 star:9.3k fork:1.1k Official JavaScript / TypeScript library for the OpenAI API
- [openai/openai-realtime-agents](https://github.com/openai/openai-realtime-agents) topic: pushed_at:2025-05 star:5.7k fork:0.7k This is a simple demonstration of more advanced, agentic patterns built on top of the Realtime API.
