...
- [openai/retro](https://github.com/openai/retro) topic: pushed_at:2021-11 star:2.7k fork:0.4k Retro Games in Gym
...
- [openai/procgen](https://github.com/openai/procgen) topic: pushed_at:2022-10 star:0.7k fork:0.1k Procgen Benchmark: Procedurally-Generated Game-Like Gym-Environments
...
- [openai/triton](https://github.com/openai/triton) topic: pushed_at:2022-10 star:4.1k fork:0.3k Development repository for the Triton language and compiler

## CSS

- [openai/openai-quickstart-python](https://github.com/openai/openai-quickstart-python) topic: pushed_at:2022-10 star:0.1k fork:0.1k Python example app from the OpenAI API quickstart tutorial
...
- [openai/mujoco-py](https://github.com/openai/mujoco-py) topic: pushed_at:2022-08 star:2.2k fork:0.7k MuJoCo is a physics engine for detailed, efficient rigid body simulations with contacts. mujoco-py allows using MuJoCo from Python 3.

## Go

- [openai/go-vncdriver](https://github.com/openai/go-vncdriver) topic: pushed_at:2020-04 star:0.1k fork:0.0k Fast VNC driver
- [openai/kubernetes](https://github.com/openai/kubernetes) topic: pushed_at:2021-09 star:0.0k fork:0.0k Production-Grade Container Scheduling and Management
...
- [openai/dalle-discord-bot](https://github.com/openai/dalle-discord-bot) topic: pushed_at:2022-10 star:0.0k fork:0.0k OpenAI Discord Community's GPT-3 powered DALL·E 2 support bot
...
- [openai/openai-quickstart-node](https://github.com/openai/openai-quickstart-node) topic: pushed_at:2022-10 star:0.1k fork:0.2k Node.js example app from the OpenAI API quickstart tutorial
- [openai/pixel](https://github.com/openai/pixel) topic:paper pushed_at:2022-06 star:0.0k fork:0.0k Code for the single pixel debate game from the paper "AI safety via debate" (https://arxiv.org/abs/1805.00899)
...
- [openai/CLIP](https://github.com/openai/CLIP) topic: pushed_at:2022-09 star:10.3k fork:1.5k Contrastive Language-Image Pretraining
...
- [openai/whisper](https://github.com/openai/whisper) topic: pushed_at:2022-10 star:13.1k fork:1.0k Robust Speech Recognition via Large-Scale Weak Supervision
...
- [openai/openai-openapi](https://github.com/openai/openai-openapi) topic: pushed_at:2022-10 star:0.0k fork:0.0k OpenAPI specification for the OpenAI API
...
- [openai/gpt-3](https://github.com/openai/gpt-3) topic: pushed_at:2020-09 star:11.7k fork:1.5k GPT-3: Language Models are Few-Shot Learners
...
- [openai/DALL-E](https://github.com/openai/DALL-E) topic: pushed_at:2022-10 star:9.0k fork:1.6k PyTorch package for the discrete VAE used for DALL·E.
...
- [openai/glow](https://github.com/openai/glow) topic:paper pushed_at:2021-02 star:2.9k fork:0.5k Code for reproducing results in "Glow: Generative Flow with Invertible 1x1 Convolutions"
- [openai/gpt-2](https://github.com/openai/gpt-2) topic:paper pushed_at:2022-07 star:15.6k fork:4.0k Code for the paper "Language Models are Unsupervised Multitask Learners"
...
- [openai/guided-diffusion](https://github.com/openai/guided-diffusion) topic: pushed_at:2022-08 star:2.5k fork:0.4k 
- [openai/gym](https://github.com/openai/gym) topic: pushed_at:2022-10 star:28.9k fork:8.0k A toolkit for developing and comparing reinforcement learning algorithms.
...
- [openai/human-eval-infilling](https://github.com/openai/human-eval-infilling) topic: pushed_at:2022-07 star:0.0k fork:0.0k Code for the paper "Efficient Training of Language Models to Fill in the Middle"
...
- [openai/image-gpt](https://github.com/openai/image-gpt) topic: pushed_at:2022-04 star:1.6k fork:0.3k 
...
- [openai/improved-diffusion](https://github.com/openai/improved-diffusion) topic: pushed_at:2022-08 star:0.9k fork:0.2k Release for Improved Denoising Diffusion Probabilistic Models
- [openai/improved-gan](https://github.com/openai/improved-gan) topic:paper pushed_at:2018-11 star:2.1k fork:0.6k Code for the paper "Improved Techniques for Training GANs"
...
- [openai/jukebox](https://github.com/openai/jukebox) topic:audio,generative-model,music,paper,pytorch,transformer,vq-vae pushed_at:2021-09 star:5.6k fork:0.9k Code for the paper "Jukebox: A Generative Model for Music"
...
- [openai/multi-agent-emergence-environments](https://github.com/openai/multi-agent-emergence-environments) topic: pushed_at:2022-05 star:1.3k fork:0.3k Environment generation code for the paper "Emergent Tool Use From Multi-Agent Autocurricula"
...
- [openai/multiagent-particle-envs](https://github.com/openai/multiagent-particle-envs) topic:paper pushed_at:2022-04 star:1.6k fork:0.6k Code for a multi-agent particle environment used in the paper "Multi-Agent Actor-Critic for Mixed Cooperative-Competitive Environments"
...
- [openai/openai-cookbook](https://github.com/openai/openai-cookbook) topic: pushed_at:2022-10 star:0.3k fork:0.1k Examples and guides for using the OpenAI API
- [openai/openai-python](https://github.com/openai/openai-python) topic: pushed_at:2022-10 star:0.8k fork:0.3k 
...
- [openai/spinningup](https://github.com/openai/spinningup) topic: pushed_at:2022-09 star:7.3k fork:1.7k An educational resource to help anyone learn deep reinforcement learning.
...
- [openai/summarize-from-feedback](https://github.com/openai/summarize-from-feedback) topic: pushed_at:2021-12 star:0.4k fork:0.1k Code for "Learning to summarize from human feedback"
...
- [openai/openai-node](https://github.com/openai/openai-node) topic: pushed_at:2022-10 star:0.1k fork:0.0k Node.js library for the OpenAI API
