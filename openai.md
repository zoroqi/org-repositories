...
- [openai/triton](https://github.com/openai/triton) topic: pushed_at:2023-10 star:8.5k fork:0.9k Development repository for the Triton language and compiler
...
- [openai/CLIP](https://github.com/openai/CLIP) topic:deep-learning,machine-learning pushed_at:2023-10 star:18.2k fork:2.6k CLIP (Contrastive Language-Image Pretraining),  Predict the most relevant text snippet given an image
...
- [openai/web-crawl-q-and-a-example](https://github.com/openai/web-crawl-q-and-a-example) topic: pushed_at:2023-10 star:0.0k fork:0.0k 
...
- [openai/openai-cookbook](https://github.com/openai/openai-cookbook) topic:chatgpt,docs,gpt-3,gpt-4,openai pushed_at:2023-10 star:49.3k fork:8.1k Examples and guides for using the OpenAI API
...
- [openai/chatgpt-retrieval-plugin](https://github.com/openai/chatgpt-retrieval-plugin) topic:chatgpt,chatgpt-plugins pushed_at:2023-10 star:19.8k fork:3.6k The ChatGPT Retrieval Plugin lets you easily find personal or work documents by asking questions in natural language.
...
- [openai/evals](https://github.com/openai/evals) topic: pushed_at:2023-10 star:12.1k fork:2.3k Evals is a framework for evaluating LLMs and LLM systems, and an open-source registry of benchmarks.
...
- [openai/gpt-2](https://github.com/openai/gpt-2) topic:paper pushed_at:2023-10 star:20.0k fork:5.1k Code for the paper "Language Models are Unsupervised Multitask Learners"
...
- [openai/guided-diffusion](https://github.com/openai/guided-diffusion) topic: pushed_at:2023-04 star:4.7k fork:0.7k 
- [openai/gym](https://github.com/openai/gym) topic: pushed_at:2023-08 star:32.9k fork:8.6k A toolkit for developing and comparing reinforcement learning algorithms.
...
- [openai/openai-python](https://github.com/openai/openai-python) topic:openai,python pushed_at:2023-10 star:13.0k fork:1.8k The official Python library for the OpenAI API
...
- [openai/point-e](https://github.com/openai/point-e) topic: pushed_at:2023-04 star:5.9k fork:0.7k Point cloud diffusion for 3D model synthesis
...
- [openai/tiktoken](https://github.com/openai/tiktoken) topic: pushed_at:2023-10 star:7.0k fork:0.5k tiktoken is a fast BPE tokeniser for use with OpenAI's models.
...
- [openai/whisper](https://github.com/openai/whisper) topic: pushed_at:2023-10 star:46.3k fork:5.3k Robust Speech Recognition via Large-Scale Weak Supervision
...
- [openai/openai-node](https://github.com/openai/openai-node) topic:nodejs,openai,typescript pushed_at:2023-10 star:5.0k fork:0.5k The official Node.js / Typescript library for the OpenAI API
