...
- [openai/openai-dotnet](https://github.com/openai/openai-dotnet) topic:csharp,dotnet,openai pushed_at:2024-07 star:0.8k fork:0.1k The official .NET library for the OpenAI API
...
- [openai/kubernetes](https://github.com/openai/kubernetes) topic: pushed_at:2024-08 star:0.0k fork:0.0k Production-Grade Container Scheduling and Management
...
- [openai/CLIP](https://github.com/openai/CLIP) topic:deep-learning,machine-learning pushed_at:2024-07 star:23.9k fork:3.2k CLIP (Contrastive Language-Image Pretraining),  Predict the most relevant text snippet given an image
...
- [openai/safety-rbr-code-and-data](https://github.com/openai/safety-rbr-code-and-data) topic: pushed_at:2024-07 star:0.1k fork:0.0k Code and example data for the paper: Rule Based Rewards for Language Model Safety
...
- [openai/compose-richtext](https://github.com/openai/compose-richtext) topic: pushed_at:2024-07 star:0.0k fork:0.0k (OpenAI Fork) A collection of Compose libraries for advanced text formatting and alternative display types.
...
- [openai/openai-cookbook](https://github.com/openai/openai-cookbook) topic:chatgpt,gpt-4,openai,openai-api pushed_at:2024-07 star:57.9k fork:9.2k Examples and guides for using the OpenAI API
...
- [openai/openai-openapi](https://github.com/openai/openai-openapi) topic:openai,openai-api pushed_at:2024-07 star:1.1k fork:0.3k OpenAPI specification for the OpenAI API
...
- [openai/baselines](https://github.com/openai/baselines) topic: pushed_at:2024-05 star:15.5k fork:4.9k OpenAI Baselines: high-quality implementations of reinforcement learning algorithms
...
- [openai/build-hours](https://github.com/openai/build-hours) topic: pushed_at:2024-07 star:0.0k fork:0.0k Build hours code to share.
...
- [openai/evals](https://github.com/openai/evals) topic: pushed_at:2024-07 star:14.5k fork:2.6k Evals is a framework for evaluating LLMs and LLM systems, and an open-source registry of benchmarks.
...
- [openai/gpt-discord-bot](https://github.com/openai/gpt-discord-bot) topic: pushed_at:2024-06 star:1.7k fork:0.7k Example Discord bot written in Python that uses the completions API to have conversations with the `text-davinci-003` model, and the moderations API to filter the messages.
- [openai/grade-school-math](https://github.com/openai/grade-school-math) topic: pushed_at:2024-01 star:1.0k fork:0.1k 
- [openai/grok](https://github.com/openai/grok) topic: pushed_at:2024-03 star:4.1k fork:0.5k 
- [openai/guided-diffusion](https://github.com/openai/guided-diffusion) topic: pushed_at:2024-07 star:5.9k fork:0.8k 
- [openai/gym](https://github.com/openai/gym) topic: pushed_at:2024-05 star:34.3k fork:8.6k A toolkit for developing and comparing reinforcement learning algorithms.
...
- [openai/human-eval](https://github.com/openai/human-eval) topic: pushed_at:2024-02 star:2.2k fork:0.3k Code for the paper "Evaluating Large Language Models Trained on Code"
...
- [openai/improved-diffusion](https://github.com/openai/improved-diffusion) topic: pushed_at:2024-07 star:3.1k fork:0.5k Release for Improved Denoising Diffusion Probabilistic Models
...
- [openai/multi-agent-emergence-environments](https://github.com/openai/multi-agent-emergence-environments) topic: pushed_at:2024-07 star:1.6k fork:0.3k Environment generation code for the paper "Emergent Tool Use From Multi-Agent Autocurricula"
...
- [openai/openai-python](https://github.com/openai/openai-python) topic:openai,python pushed_at:2024-08 star:21.4k fork:2.9k The official Python library for the OpenAI API
...
- [openai/point-e](https://github.com/openai/point-e) topic: pushed_at:2024-07 star:6.4k fork:0.7k Point cloud diffusion for 3D model synthesis
- [openai/prm800k](https://github.com/openai/prm800k) topic: pushed_at:2023-06 star:1.4k fork:0.1k 800,000 step-level correctness labels on LLM solutions to MATH problems
...
- [openai/shap-e](https://github.com/openai/shap-e) topic: pushed_at:2024-06 star:11.5k fork:0.9k Generate 3D objects conditioned on text or images
- [openai/simple-evals](https://github.com/openai/simple-evals) topic: pushed_at:2024-07 star:1.4k fork:0.1k 
...
- [openai/sparse_autoencoder](https://github.com/openai/sparse_autoencoder) topic: pushed_at:2024-07 star:0.2k fork:0.0k 
- [openai/spinningup](https://github.com/openai/spinningup) topic: pushed_at:2024-07 star:9.9k fork:2.2k An educational resource to help anyone learn deep reinforcement learning.
...
- [openai/tiktoken](https://github.com/openai/tiktoken) topic: pushed_at:2024-07 star:11.4k fork:0.8k tiktoken is a fast BPE tokeniser for use with OpenAI's models.
...
- [openai/Video-Pre-Training](https://github.com/openai/Video-Pre-Training) topic: pushed_at:2024-06 star:1.3k fork:0.1k Video PreTraining (VPT): Learning to Act by Watching Unlabeled Online Videos
...
- [openai/whisper](https://github.com/openai/whisper) topic: pushed_at:2024-07 star:65.4k fork:7.7k Robust Speech Recognition via Large-Scale Weak Supervision
...
- [openai/openai-assistants-quickstart](https://github.com/openai/openai-assistants-quickstart) topic: pushed_at:2024-07 star:1.3k fork:0.2k OpenAI Assistants API quickstart with Next.js.
- [openai/openai-deno-build](https://github.com/openai/openai-deno-build) topic:deno,openai,openai-api pushed_at:2024-07 star:0.1k fork:0.0k Deno build of the official Typescript library for the OpenAI API.
- [openai/openai-node](https://github.com/openai/openai-node) topic:nodejs,openai,typescript pushed_at:2024-07 star:7.4k fork:0.8k The official Node.js / Typescript library for the OpenAI API
