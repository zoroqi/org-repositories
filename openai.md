...
- [openai/openai-dotnet](https://github.com/openai/openai-dotnet) topic:csharp,dotnet,openai pushed_at:2024-09 star:1.1k fork:0.1k The official .NET library for the OpenAI API
...
- [openai/openai-go](https://github.com/openai/openai-go) topic: pushed_at:2024-10 star:0.1k fork:0.0k The official Go library for the OpenAI API
...
- [openai/CLIP](https://github.com/openai/CLIP) topic:deep-learning,machine-learning pushed_at:2024-07 star:25.0k fork:3.2k CLIP (Contrastive Language-Image Pretraining),  Predict the most relevant text snippet given an image
...
- [openai/openai-cookbook](https://github.com/openai/openai-cookbook) topic:chatgpt,gpt-4,openai,openai-api pushed_at:2024-10 star:58.8k fork:9.3k Examples and guides for using the OpenAI API
...
- [openai/evals](https://github.com/openai/evals) topic: pushed_at:2024-09 star:14.7k fork:2.6k Evals is a framework for evaluating LLMs and LLM systems, and an open-source registry of benchmarks.
...
- [openai/gpt-2-output-dataset](https://github.com/openai/gpt-2-output-dataset) topic: pushed_at:2023-12 star:1.9k fork:0.6k Dataset of GPT-2 outputs for research in detection, biases, and more
...
- [openai/gym](https://github.com/openai/gym) topic: pushed_at:2024-05 star:34.6k fork:8.6k A toolkit for developing and comparing reinforcement learning algorithms.
...
- [openai/openai-python](https://github.com/openai/openai-python) topic:openai,python pushed_at:2024-10 star:22.2k fork:3.1k The official Python library for the OpenAI API
...
- [openai/prm800k](https://github.com/openai/prm800k) topic: pushed_at:2023-06 star:1.5k fork:0.1k 800,000 step-level correctness labels on LLM solutions to MATH problems
...
- [openai/tiktoken](https://github.com/openai/tiktoken) topic: pushed_at:2024-08 star:11.9k fork:0.8k tiktoken is a fast BPE tokeniser for use with OpenAI's models.
...
- [openai/whisper](https://github.com/openai/whisper) topic: pushed_at:2024-09 star:68.2k fork:8.1k Robust Speech Recognition via Large-Scale Weak Supervision
...
- [openai/build-hours](https://github.com/openai/build-hours) topic: pushed_at:2024-09 star:0.1k fork:0.0k Build hours code to share.
...
- [openai/openai-node](https://github.com/openai/openai-node) topic:nodejs,openai,typescript pushed_at:2024-09 star:7.7k fork:0.8k The official Node.js / Typescript library for the OpenAI API
