...
- [openai/mujoco-py](https://github.com/openai/mujoco-py) topic: pushed_at:2023-12 star:2.8k fork:0.8k MuJoCo is a physics engine for detailed, efficient rigid body simulations with contacts. mujoco-py allows using MuJoCo from Python 3.
...
- [openai/CLIP](https://github.com/openai/CLIP) topic:deep-learning,machine-learning pushed_at:2024-05 star:22.8k fork:3.0k CLIP (Contrastive Language-Image Pretraining),  Predict the most relevant text snippet given an image
...
- [openai/web-crawl-q-and-a-example](https://github.com/openai/web-crawl-q-and-a-example) topic:openai pushed_at:2024-04 star:0.2k fork:0.2k Learn how to crawl your website and build a Q/A bot with the OpenAI API
...
- [openai/openai-cookbook](https://github.com/openai/openai-cookbook) topic:chatgpt,gpt-4,openai,openai-api pushed_at:2024-05 star:56.9k fork:9.0k Examples and guides for using the OpenAI API
...
- [openai/openai-quickstart-python](https://github.com/openai/openai-quickstart-python) topic:openai,openai-api pushed_at:2024-05 star:1.6k fork:1.3k Python example app from the OpenAI API quickstart tutorial
...
- [openai/baselines](https://github.com/openai/baselines) topic: pushed_at:2024-05 star:15.4k fork:4.8k OpenAI Baselines: high-quality implementations of reinforcement learning algorithms
...
- [openai/evals](https://github.com/openai/evals) topic: pushed_at:2024-05 star:14.2k fork:2.5k Evals is a framework for evaluating LLMs and LLM systems, and an open-source registry of benchmarks.
...
- [openai/gpt-2](https://github.com/openai/gpt-2) topic:paper pushed_at:2024-05 star:21.4k fork:5.3k Code for the paper "Language Models are Unsupervised Multitask Learners"
...
- [openai/human-eval](https://github.com/openai/human-eval) topic: pushed_at:2024-02 star:2.1k fork:0.3k Code for the paper "Evaluating Large Language Models Trained on Code"
...
- [openai/openai-python](https://github.com/openai/openai-python) topic:openai,python pushed_at:2024-05 star:20.6k fork:2.8k The official Python library for the OpenAI API
...
- [openai/point-e](https://github.com/openai/point-e) topic: pushed_at:2024-05 star:6.4k fork:0.7k Point cloud diffusion for 3D model synthesis
...
- [openai/shap-e](https://github.com/openai/shap-e) topic: pushed_at:2024-05 star:11.4k fork:0.9k Generate 3D objects conditioned on text or images
...
- [openai/sparse_autoencoder](https://github.com/openai/sparse_autoencoder) topic: pushed_at:2024-05 star:0.0k fork:0.0k 
...
- [openai/tiktoken](https://github.com/openai/tiktoken) topic: pushed_at:2024-05 star:10.6k fork:0.7k tiktoken is a fast BPE tokeniser for use with OpenAI's models.
...
- [openai/transformer-debugger](https://github.com/openai/transformer-debugger) topic: pushed_at:2024-05 star:3.9k fork:0.2k 
...
- [openai/whisper](https://github.com/openai/whisper) topic: pushed_at:2024-05 star:62.3k fork:7.2k Robust Speech Recognition via Large-Scale Weak Supervision
...
- [openai/openai-assistants-quickstart](https://github.com/openai/openai-assistants-quickstart) topic: pushed_at:2024-05 star:1.0k fork:0.1k OpenAI Assistants API quickstart with Next.js.
...
- [openai/openai-node](https://github.com/openai/openai-node) topic:nodejs,openai,typescript pushed_at:2024-05 star:7.1k fork:0.7k The official Node.js / Typescript library for the OpenAI API
