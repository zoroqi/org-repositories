...
- [openai/openai-dotnet](https://github.com/openai/openai-dotnet) topic:csharp,dotnet,openai pushed_at:2025-05 star:2.0k fork:0.2k The official .NET library for the OpenAI API
...
- [openai/codex-universal](https://github.com/openai/codex-universal) topic: pushed_at:2025-05 star:0.1k fork:0.0k Base docker image used in Codex environments
...
- [openai/openai-go](https://github.com/openai/openai-go) topic: pushed_at:2025-05 star:1.8k fork:0.1k The official Go library for the OpenAI API
...
- [openai/CLIP](https://github.com/openai/CLIP) topic:deep-learning,machine-learning pushed_at:2024-07 star:29.0k fork:3.6k CLIP (Contrastive Language-Image Pretraining),  Predict the most relevant text snippet given an image
...
- [openai/openai-cookbook](https://github.com/openai/openai-cookbook) topic:chatgpt,gpt-4,openai,openai-api pushed_at:2025-05 star:64.1k fork:10.5k Examples and guides for using the OpenAI API
...
- [openai/openai-openapi](https://github.com/openai/openai-openapi) topic:openai,openai-api pushed_at:2025-04 star:2.0k fork:0.5k OpenAPI specification for the OpenAI API
...
- [openai/TestUGxlYXNlIGlnbm9yZQo](https://github.com/openai/TestUGxlYXNlIGlnbm9yZQo) topic: pushed_at:2025-05 star:0.0k fork:0.0k Test Please ignore
...
- [openai/baselines](https://github.com/openai/baselines) topic: pushed_at:2024-08 star:16.3k fork:4.9k OpenAI Baselines: high-quality implementations of reinforcement learning algorithms
...
- [openai/evals](https://github.com/openai/evals) topic: pushed_at:2024-12 star:16.2k fork:2.7k Evals is a framework for evaluating LLMs and LLM systems, and an open-source registry of benchmarks.
...
- [openai/gpt-2](https://github.com/openai/gpt-2) topic:paper pushed_at:2024-08 star:23.6k fork:5.7k Code for the paper "Language Models are Unsupervised Multitask Learners"
...
- [openai/gym](https://github.com/openai/gym) topic: pushed_at:2024-10 star:36.0k fork:8.7k A toolkit for developing and comparing reinforcement learning algorithms.
...
- [openai/mle-bench](https://github.com/openai/mle-bench) topic: pushed_at:2025-05 star:0.7k fork:0.1k MLE-bench is a benchmark for measuring how well AI agents perform at machine learning engineering
...
- [openai/openai-agents-python](https://github.com/openai/openai-agents-python) topic:agents,ai,framework,llm,openai,python pushed_at:2025-05 star:10.3k fork:1.4k A lightweight, powerful framework for multi-agent workflows
- [openai/openai-cua-sample-app](https://github.com/openai/openai-cua-sample-app) topic: pushed_at:2025-04 star:0.9k fork:0.2k Learn how to use CUA (our Computer Using Agent) via the API on multiple computer environments.
- [openai/openai-python](https://github.com/openai/openai-python) topic:openai,python pushed_at:2025-05 star:26.7k fork:3.9k The official Python library for the OpenAI API
...
- [openai/preparedness](https://github.com/openai/preparedness) topic: pushed_at:2025-05 star:0.7k fork:0.1k Releases from OpenAI Preparedness
...
- [openai/simple-evals](https://github.com/openai/simple-evals) topic: pushed_at:2025-05 star:3.4k fork:0.3k 
...
- [openai/spinningup](https://github.com/openai/spinningup) topic: pushed_at:2024-08 star:10.9k fork:2.3k An educational resource to help anyone learn deep reinforcement learning.
...
- [openai/swarm](https://github.com/openai/swarm) topic: pushed_at:2025-03 star:19.8k fork:2.1k Educational framework exploring ergonomic, lightweight multi-agent orchestration. Managed by OpenAI Solution team.
- [openai/SWELancer-Benchmark](https://github.com/openai/SWELancer-Benchmark) topic: pushed_at:2025-05 star:1.4k fork:0.1k This repo contains the dataset and code for the paper "SWE-Lancer: Can Frontier LLMs Earn $1 Million from Real-World Freelance Software Engineering?"
- [openai/tiktoken](https://github.com/openai/tiktoken) topic: pushed_at:2025-03 star:14.5k fork:1.1k tiktoken is a fast BPE tokeniser for use with OpenAI's models.
...
- [openai/whisper](https://github.com/openai/whisper) topic: pushed_at:2025-05 star:81.8k fork:9.8k Robust Speech Recognition via Large-Scale Weak Supervision
...
- [openai/openai-ruby](https://github.com/openai/openai-ruby) topic: pushed_at:2025-05 star:0.2k fork:0.0k 
...
- [openai/codex](https://github.com/openai/codex) topic: pushed_at:2025-05 star:22.8k fork:2.3k Lightweight coding agent that runs in your terminal
...
- [openai/openai-assistants-quickstart](https://github.com/openai/openai-assistants-quickstart) topic: pushed_at:2025-03 star:1.9k fork:0.5k OpenAI Assistants API quickstart with Next.js.
...
- [openai/openai-node](https://github.com/openai/openai-node) topic:nodejs,openai,typescript pushed_at:2025-05 star:9.2k fork:1.1k Official JavaScript / TypeScript library for the OpenAI API
- [openai/openai-realtime-agents](https://github.com/openai/openai-realtime-agents) topic: pushed_at:2025-05 star:5.5k fork:0.7k This is a simple demonstration of more advanced, agentic patterns built on top of the Realtime API.
...
- [openai/openai-responses-starter-app](https://github.com/openai/openai-responses-starter-app) topic: pushed_at:2025-04 star:0.3k fork:0.1k Starter app to build with the OpenAI Responses API
...
- [openai/openai-voice-agent-sdk-sample](https://github.com/openai/openai-voice-agent-sdk-sample) topic: pushed_at:2025-05 star:0.2k fork:0.0k Sample application to add voice capabilities to the Agents SDK
