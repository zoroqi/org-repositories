...
- [openai/CLIP](https://github.com/openai/CLIP) topic:deep-learning,machine-learning pushed_at:2024-01 star:20.9k fork:2.9k CLIP (Contrastive Language-Image Pretraining),  Predict the most relevant text snippet given an image
...
- [openai/openai-cookbook](https://github.com/openai/openai-cookbook) topic:chatgpt,gpt-4,openai,openai-api pushed_at:2024-02 star:54.3k fork:8.5k Examples and guides for using the OpenAI API
...
- [openai/chatgpt-retrieval-plugin](https://github.com/openai/chatgpt-retrieval-plugin) topic:chatgpt,chatgpt-plugins pushed_at:2024-02 star:20.6k fork:3.6k The ChatGPT Retrieval Plugin lets you easily find personal or work documents by asking questions in natural language.
...
- [openai/evals](https://github.com/openai/evals) topic: pushed_at:2024-03 star:13.4k fork:2.4k Evals is a framework for evaluating LLMs and LLM systems, and an open-source registry of benchmarks.
...
- [openai/gpt-2](https://github.com/openai/gpt-2) topic:paper pushed_at:2024-01 star:20.7k fork:5.2k Code for the paper "Language Models are Unsupervised Multitask Learners"
...
- [openai/guided-diffusion](https://github.com/openai/guided-diffusion) topic: pushed_at:2023-04 star:5.3k fork:0.7k 
- [openai/gym](https://github.com/openai/gym) topic: pushed_at:2024-02 star:33.6k fork:8.5k A toolkit for developing and comparing reinforcement learning algorithms.
...
- [openai/maddpg](https://github.com/openai/maddpg) topic:paper pushed_at:2024-02 star:1.5k fork:0.5k Code for the MADDPG algorithm from the paper "Multi-Agent Actor-Critic for Mixed Cooperative-Competitive Environments"
...
- [openai/openai-python](https://github.com/openai/openai-python) topic:openai,python pushed_at:2024-03 star:18.7k fork:2.5k The official Python library for the OpenAI API
...
- [openai/tiktoken](https://github.com/openai/tiktoken) topic: pushed_at:2024-02 star:8.8k fork:0.6k tiktoken is a fast BPE tokeniser for use with OpenAI's models.
...
- [openai/triton](https://github.com/openai/triton) topic: pushed_at:2024-03 star:10.1k fork:1.1k Development repository for the Triton language and compiler
...
- [openai/whisper](https://github.com/openai/whisper) topic: pushed_at:2024-02 star:56.8k fork:6.4k Robust Speech Recognition via Large-Scale Weak Supervision
...
- [openai/openai-node](https://github.com/openai/openai-node) topic:nodejs,openai,typescript pushed_at:2024-03 star:6.5k fork:0.6k The official Node.js / Typescript library for the OpenAI API
