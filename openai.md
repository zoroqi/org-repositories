...
- [openai/openai-dotnet](https://github.com/openai/openai-dotnet) topic:csharp,dotnet,openai pushed_at:2026-03 star:2.5k fork:0.4k The official .NET library for the OpenAI API
...
- [openai/symphony](https://github.com/openai/symphony) topic: pushed_at:2026-03 star:13.1k fork:1.0k Symphony turns project work into isolated, autonomous implementation runs, allowing teams to manage work instead of supervising coding agents.
...
- [openai/openai-go](https://github.com/openai/openai-go) topic: pushed_at:2026-03 star:3.1k fork:0.3k The official Go library for the OpenAI API
...
- [openai/CLIP](https://github.com/openai/CLIP) topic:deep-learning,machine-learning pushed_at:2026-02 star:32.8k fork:4.0k CLIP (Contrastive Language-Image Pretraining),  Predict the most relevant text snippet given an image
...
- [openai/openai-cookbook](https://github.com/openai/openai-cookbook) topic:chatgpt,gpt-4,openai,openai-api pushed_at:2026-03 star:72.2k fork:12.2k Examples and guides for using the OpenAI API
...
- [openai/openai-java](https://github.com/openai/openai-java) topic: pushed_at:2026-03 star:1.4k fork:0.2k The official Java library for the OpenAI API
...
- [openai/evals](https://github.com/openai/evals) topic: pushed_at:2025-11 star:18.0k fork:2.9k Evals is a framework for evaluating LLMs and LLM systems, and an open-source registry of benchmarks.
...
- [openai/gpt-oss](https://github.com/openai/gpt-oss) topic: pushed_at:2026-01 star:19.9k fork:2.1k gpt-oss-120b and gpt-oss-20b are two open-weight language models by OpenAI
...
- [openai/gym](https://github.com/openai/gym) topic: pushed_at:2024-10 star:37.1k fork:8.7k A toolkit for developing and comparing reinforcement learning algorithms.
...
- [openai/openai-agents-python](https://github.com/openai/openai-agents-python) topic:agents,ai,framework,llm,openai,python pushed_at:2026-03 star:20.1k fork:3.3k A lightweight, powerful framework for multi-agent workflows
- [openai/openai-chatkit-starter-app](https://github.com/openai/openai-chatkit-starter-app) topic:chatkit,openai,openai-api pushed_at:2025-12 star:0.8k fork:1.1k Starter app to build with OpenAI ChatKit + Agent Builder
...
- [openai/openai-python](https://github.com/openai/openai-python) topic:openai,python pushed_at:2026-03 star:30.3k fork:4.6k The official Python library for the OpenAI API
...
- [openai/plugins](https://github.com/openai/plugins) topic: pushed_at:2026-03 star:0.1k fork:0.0k OpenAI Plugins
...
- [openai/skills](https://github.com/openai/skills) topic: pushed_at:2026-03 star:14.4k fork:0.8k Skills Catalog for Codex
...
- [openai/swarm](https://github.com/openai/swarm) topic: pushed_at:2025-03 star:21.2k fork:2.3k Educational framework exploring ergonomic, lightweight multi-agent orchestration. Managed by OpenAI Solution team.
- [openai/tiktoken](https://github.com/openai/tiktoken) topic: pushed_at:2026-02 star:17.6k fork:1.4k tiktoken is a fast BPE tokeniser for use with OpenAI's models.
...
- [openai/whisper](https://github.com/openai/whisper) topic: pushed_at:2025-12 star:96.1k fork:11.9k Robust Speech Recognition via Large-Scale Weak Supervision
...
- [openai/codex](https://github.com/openai/codex) topic: pushed_at:2026-03 star:65.7k fork:8.8k Lightweight coding agent that runs in your terminal
...
- [openai/apps-sdk-ui](https://github.com/openai/apps-sdk-ui) topic: pushed_at:2025-12 star:0.9k fork:0.1k 
...
- [openai/openai-agents-js](https://github.com/openai/openai-agents-js) topic:agents,openai,openai-api,realtime-api,typescript pushed_at:2026-03 star:2.5k fork:0.6k A lightweight, powerful framework for multi-agent workflows and voice agents
...
- [openai/openai-cua-sample-app](https://github.com/openai/openai-cua-sample-app) topic: pushed_at:2026-03 star:1.6k fork:0.4k Learn how to use CUA (our Computer Using Agent) via the API on multiple computer environments.
...
- [openai/openai-node](https://github.com/openai/openai-node) topic:nodejs,openai,typescript pushed_at:2026-03 star:10.7k fork:1.4k Official JavaScript / TypeScript library for the OpenAI API
