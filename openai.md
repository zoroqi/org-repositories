...
- [openai/openai-go](https://github.com/openai/openai-go) topic: pushed_at:2025-11 star:2.7k fork:0.2k The official Go library for the OpenAI API
...
- [openai/gpt-5-coding-examples](https://github.com/openai/gpt-5-coding-examples) topic:codex,coding,frontend,gpt,openai,web,website pushed_at:2025-08 star:1.7k fork:0.2k GPT-5 coding examples
...
- [openai/openai-apps-sdk-examples](https://github.com/openai/openai-apps-sdk-examples) topic: pushed_at:2025-11 star:1.7k fork:0.3k Example apps for the Apps SDK
...
- [openai/CLIP](https://github.com/openai/CLIP) topic:deep-learning,machine-learning pushed_at:2024-07 star:31.6k fork:3.8k CLIP (Contrastive Language-Image Pretraining),  Predict the most relevant text snippet given an image
...
- [openai/openai-cookbook](https://github.com/openai/openai-cookbook) topic:chatgpt,gpt-4,openai,openai-api pushed_at:2025-11 star:69.2k fork:11.6k Examples and guides for using the OpenAI API
...
- [openai/openai-java](https://github.com/openai/openai-java) topic: pushed_at:2025-11 star:1.2k fork:0.2k The official Java library for the OpenAI API
...
- [openai/openai-openapi](https://github.com/openai/openai-openapi) topic:openai,openai-api pushed_at:2025-06 star:2.2k fork:0.5k OpenAPI specification for the OpenAI API
...
- [openai/chz](https://github.com/openai/chz) topic: pushed_at:2025-08 star:0.2k fork:0.0k 
...
- [openai/evals](https://github.com/openai/evals) topic: pushed_at:2025-11 star:17.3k fork:2.8k Evals is a framework for evaluating LLMs and LLM systems, and an open-source registry of benchmarks.
...
- [openai/frontier-evals](https://github.com/openai/frontier-evals) topic: pushed_at:2025-10 star:0.9k fork:0.1k OpenAI Frontier Evals
...
- [openai/gpt-oss](https://github.com/openai/gpt-oss) topic: pushed_at:2025-11 star:19.2k fork:1.9k gpt-oss-120b and gpt-oss-20b are two open-weight language models by OpenAI
...
- [openai/guided-diffusion](https://github.com/openai/guided-diffusion) topic: pushed_at:2024-07 star:7.1k fork:0.9k 
...
- [openai/openai-agents-python](https://github.com/openai/openai-agents-python) topic:agents,ai,framework,llm,openai,python pushed_at:2025-11 star:17.4k fork:2.9k A lightweight, powerful framework for multi-agent workflows
...
- [openai/openai-python](https://github.com/openai/openai-python) topic:openai,python pushed_at:2025-11 star:29.3k fork:4.4k The official Python library for the OpenAI API
...
- [openai/shap-e](https://github.com/openai/shap-e) topic: pushed_at:2024-06 star:12.1k fork:1.1k Generate 3D objects conditioned on text or images
- [openai/simple-evals](https://github.com/openai/simple-evals) topic: pushed_at:2025-07 star:4.2k fork:0.4k 
...
- [openai/swarm](https://github.com/openai/swarm) topic: pushed_at:2025-03 star:20.6k fork:2.2k Educational framework exploring ergonomic, lightweight multi-agent orchestration. Managed by OpenAI Solution team.
- [openai/tiktoken](https://github.com/openai/tiktoken) topic: pushed_at:2025-10 star:16.6k fork:1.3k tiktoken is a fast BPE tokeniser for use with OpenAI's models.
...
- [openai/whisper](https://github.com/openai/whisper) topic: pushed_at:2025-09 star:90.9k fork:11.4k Robust Speech Recognition via Large-Scale Weak Supervision
...
- [openai/codex](https://github.com/openai/codex) topic: pushed_at:2025-11 star:50.7k fork:6.3k Lightweight coding agent that runs in your terminal
...
- [openai/snap-o](https://github.com/openai/snap-o) topic:android,developer-tools,teams pushed_at:2025-11 star:0.0k fork:0.0k Lightweight Android screen capture tool for macOS
...
- [openai/agents.md](https://github.com/openai/agents.md) topic: pushed_at:2025-10 star:8.2k fork:0.6k AGENTS.md — a simple, open format for guiding coding agents
- [openai/chatkit-js](https://github.com/openai/chatkit-js) topic: pushed_at:2025-10 star:1.6k fork:0.1k 
...
- [openai/openai-agents-js](https://github.com/openai/openai-agents-js) topic:agents,openai,openai-api,realtime-api,typescript pushed_at:2025-11 star:1.9k fork:0.5k A lightweight, powerful framework for multi-agent workflows and voice agents
...
- [openai/openai-chatkit-starter-app](https://github.com/openai/openai-chatkit-starter-app) topic:chatkit,openai,openai-api pushed_at:2025-10 star:0.7k fork:0.7k Starter app to build with OpenAI ChatKit + Agent Builder
- [openai/openai-cs-agents-demo](https://github.com/openai/openai-cs-agents-demo) topic: pushed_at:2025-08 star:5.8k fork:0.9k Demo of a customer service use case implemented with the OpenAI Agents SDK
...
- [openai/openai-guardrails-js](https://github.com/openai/openai-guardrails-js) topic: pushed_at:2025-11 star:0.0k fork:0.0k OpenAI Guardrails - TypeScript / JavaScript
...
- [openai/openai-responses-starter-app](https://github.com/openai/openai-responses-starter-app) topic: pushed_at:2025-11 star:0.7k fork:0.2k Starter app to build with the OpenAI Responses API
