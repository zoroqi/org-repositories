...
- [openai/kubernetes](https://github.com/openai/kubernetes) topic: pushed_at:2025-08 star:0.1k fork:0.0k Production-Grade Container Scheduling and Management
...
- [openai/openai-go](https://github.com/openai/openai-go) topic: pushed_at:2026-01 star:2.9k fork:0.3k The official Go library for the OpenAI API
...
- [openai/gpt-5-coding-examples](https://github.com/openai/gpt-5-coding-examples) topic:codex,coding,frontend,gpt,openai,web,website pushed_at:2025-12 star:1.8k fork:0.2k GPT-5 coding examples
...
- [openai/build-hours](https://github.com/openai/build-hours) topic: pushed_at:2025-12 star:0.7k fork:0.1k Build hours code to share.
- [openai/CLIP](https://github.com/openai/CLIP) topic:deep-learning,machine-learning pushed_at:2024-07 star:32.3k fork:3.9k CLIP (Contrastive Language-Image Pretraining),  Predict the most relevant text snippet given an image
...
- [openai/openai-cookbook](https://github.com/openai/openai-cookbook) topic:chatgpt,gpt-4,openai,openai-api pushed_at:2026-01 star:71.0k fork:11.9k Examples and guides for using the OpenAI API
...
- [openai/compose-richtext](https://github.com/openai/compose-richtext) topic: pushed_at:2025-10 star:0.1k fork:0.0k (OpenAI Fork) A collection of Compose libraries for advanced text formatting and alternative display types.
- [openai/openai-java](https://github.com/openai/openai-java) topic: pushed_at:2026-01 star:1.3k fork:0.2k The official Java library for the OpenAI API
...
- [openai/openai-chatkit-advanced-samples](https://github.com/openai/openai-chatkit-advanced-samples) topic:chatkit,openai,openai-api,python,typescript pushed_at:2026-01 star:0.5k fork:0.3k Starter app to build with OpenAI ChatKit SDK
...
- [openai/chatkit-python](https://github.com/openai/chatkit-python) topic: pushed_at:2026-01 star:0.3k fork:0.1k 
...
- [openai/gpt-2](https://github.com/openai/gpt-2) topic:paper pushed_at:2024-08 star:24.6k fork:5.8k Code for the paper "Language Models are Unsupervised Multitask Learners"
...
- [openai/gpt-oss](https://github.com/openai/gpt-oss) topic: pushed_at:2026-01 star:19.6k fork:2.0k gpt-oss-120b and gpt-oss-20b are two open-weight language models by OpenAI
...
- [openai/guided-diffusion](https://github.com/openai/guided-diffusion) topic: pushed_at:2024-07 star:7.2k fork:0.9k 
...
- [openai/openai-agents-python](https://github.com/openai/openai-agents-python) topic:agents,ai,framework,llm,openai,python pushed_at:2026-01 star:18.4k fork:3.1k A lightweight, powerful framework for multi-agent workflows
- [openai/openai-chatkit-starter-app](https://github.com/openai/openai-chatkit-starter-app) topic:chatkit,openai,openai-api pushed_at:2025-12 star:0.7k fork:1.0k Starter app to build with OpenAI ChatKit + Agent Builder
...
- [openai/openai-python](https://github.com/openai/openai-python) topic:openai,python pushed_at:2026-01 star:29.7k fork:4.5k The official Python library for the OpenAI API
...
- [openai/skills](https://github.com/openai/skills) topic: pushed_at:2026-01 star:1.7k fork:0.1k Skills Catalog for Codex
...
- [openai/spinningup](https://github.com/openai/spinningup) topic: pushed_at:2024-08 star:11.5k fork:2.4k An educational resource to help anyone learn deep reinforcement learning.
...
- [openai/swarm](https://github.com/openai/swarm) topic: pushed_at:2025-03 star:20.8k fork:2.2k Educational framework exploring ergonomic, lightweight multi-agent orchestration. Managed by OpenAI Solution team.
- [openai/tiktoken](https://github.com/openai/tiktoken) topic: pushed_at:2025-10 star:17.0k fork:1.4k tiktoken is a fast BPE tokeniser for use with OpenAI's models.
...
- [openai/whisper](https://github.com/openai/whisper) topic: pushed_at:2025-12 star:93.3k fork:11.7k Robust Speech Recognition via Large-Scale Weak Supervision
...
- [openai/codex](https://github.com/openai/codex) topic: pushed_at:2026-01 star:56.4k fork:7.3k Lightweight coding agent that runs in your terminal
- [openai/harmony](https://github.com/openai/harmony) topic: pushed_at:2025-12 star:4.1k fork:0.2k Renderer for the harmony response format to be used with gpt-oss
...
- [openai/chatkit-js](https://github.com/openai/chatkit-js) topic: pushed_at:2026-01 star:1.7k fork:0.1k 
...
- [openai/openai-apps-sdk-examples](https://github.com/openai/openai-apps-sdk-examples) topic: pushed_at:2026-01 star:2.0k fork:0.4k Example apps for the Apps SDK
...
- [openai/openai-fm](https://github.com/openai/openai-fm) topic: pushed_at:2025-12 star:2.5k fork:6.7k Code for openai.fm, a demo for the OpenAI Speech API
...
- [openai/openai-node](https://github.com/openai/openai-node) topic:nodejs,openai,typescript pushed_at:2026-01 star:10.5k fork:1.4k Official JavaScript / TypeScript library for the OpenAI API
...
- [openai/openai-sora-sample-app](https://github.com/openai/openai-sora-sample-app) topic: pushed_at:2025-12 star:0.0k fork:0.0k Sample app to get started using the Video API with Sora
