...
- [openai/triton](https://github.com/openai/triton) topic: pushed_at:2023-12 star:8.9k fork:1.0k Development repository for the Triton language and compiler
...
- [openai/CLIP](https://github.com/openai/CLIP) topic:deep-learning,machine-learning pushed_at:2023-11 star:19.3k fork:2.7k CLIP (Contrastive Language-Image Pretraining),  Predict the most relevant text snippet given an image
...
- [openai/openai-cookbook](https://github.com/openai/openai-cookbook) topic:chatgpt,docs,gpt-3,gpt-4,openai pushed_at:2023-12 star:51.6k fork:8.5k Examples and guides for using the OpenAI API
...
- [openai/openai-openapi](https://github.com/openai/openai-openapi) topic:openai,openai-api pushed_at:2023-11 star:0.7k fork:0.3k OpenAPI specification for the OpenAI API
...
- [openai/baselines](https://github.com/openai/baselines) topic: pushed_at:2023-11 star:15.0k fork:4.8k OpenAI Baselines: high-quality implementations of reinforcement learning algorithms
...
- [openai/chatgpt-retrieval-plugin](https://github.com/openai/chatgpt-retrieval-plugin) topic:chatgpt,chatgpt-plugins pushed_at:2023-11 star:20.2k fork:3.7k The ChatGPT Retrieval Plugin lets you easily find personal or work documents by asking questions in natural language.
...
- [openai/evals](https://github.com/openai/evals) topic: pushed_at:2023-11 star:12.6k fork:2.3k Evals is a framework for evaluating LLMs and LLM systems, and an open-source registry of benchmarks.
...
- [openai/gpt-2](https://github.com/openai/gpt-2) topic:paper pushed_at:2023-11 star:20.2k fork:5.2k Code for the paper "Language Models are Unsupervised Multitask Learners"
...
- [openai/gym](https://github.com/openai/gym) topic: pushed_at:2023-10 star:33.2k fork:8.7k A toolkit for developing and comparing reinforcement learning algorithms.
...
- [openai/lm-human-preferences](https://github.com/openai/lm-human-preferences) topic: pushed_at:2023-07 star:1.0k fork:0.1k Code for the paper Fine-Tuning Language Models from Human Preferences
...
- [openai/openai-python](https://github.com/openai/openai-python) topic:openai,python pushed_at:2023-12 star:16.2k fork:2.2k The official Python library for the OpenAI API
...
- [openai/plugins-quickstart](https://github.com/openai/plugins-quickstart) topic:chatgpt,chatgpt-plugins pushed_at:2023-10 star:4.1k fork:0.8k Get a ChatGPT plugin up and running in under 5 minutes!
...
- [openai/prm800k](https://github.com/openai/prm800k) topic: pushed_at:2023-06 star:1.1k fork:0.1k 800,000 step-level correctness labels on LLM solutions to MATH problems
...
- [openai/tiktoken](https://github.com/openai/tiktoken) topic: pushed_at:2023-11 star:7.6k fork:0.5k tiktoken is a fast BPE tokeniser for use with OpenAI's models.
...
- [openai/whisper](https://github.com/openai/whisper) topic: pushed_at:2023-11 star:51.5k fork:5.9k Robust Speech Recognition via Large-Scale Weak Supervision
...
- [openai/openai-deno-build](https://github.com/openai/openai-deno-build) topic:deno,openai,openai-api pushed_at:2023-11 star:0.0k fork:0.0k Deno build of the official Typescript library for the OpenAI API.
- [openai/openai-node](https://github.com/openai/openai-node) topic:nodejs,openai,typescript pushed_at:2023-11 star:5.7k fork:0.6k The official Node.js / Typescript library for the OpenAI API
