...
- [openai/retro](https://github.com/openai/retro) topic: pushed_at:2021-11 star:2.8k fork:0.4k Retro Games in Gym
...
- [openai/triton](https://github.com/openai/triton) topic: pushed_at:2022-11 star:4.2k fork:0.4k Development repository for the Triton language and compiler
...
- [openai/mujoco-py](https://github.com/openai/mujoco-py) topic: pushed_at:2022-10 star:2.3k fork:0.7k MuJoCo is a physics engine for detailed, efficient rigid body simulations with contacts. mujoco-py allows using MuJoCo from Python 3.
...
- [openai/openai-quickstart-node](https://github.com/openai/openai-quickstart-node) topic: pushed_at:2022-11 star:0.1k fork:0.2k Node.js example app from the OpenAI API quickstart tutorial
- [openai/pixel](https://github.com/openai/pixel) topic:paper pushed_at:2022-11 star:0.0k fork:0.0k Code for the single pixel debate game from the paper "AI safety via debate" (https://arxiv.org/abs/1805.00899)
...
- [openai/CLIP](https://github.com/openai/CLIP) topic: pushed_at:2022-09 star:10.7k fork:1.6k Contrastive Language-Image Pretraining
...
- [openai/whisper](https://github.com/openai/whisper) topic: pushed_at:2022-11 star:14.9k fork:1.2k Robust Speech Recognition via Large-Scale Weak Supervision
...
- [openai/baselines](https://github.com/openai/baselines) topic: pushed_at:2022-06 star:13.1k fork:4.4k OpenAI Baselines: high-quality implementations of reinforcement learning algorithms
...
- [openai/DALL-E](https://github.com/openai/DALL-E) topic: pushed_at:2022-10 star:9.2k fork:1.6k PyTorch package for the discrete VAE used for DALL·E.
...
- [openai/guided-diffusion](https://github.com/openai/guided-diffusion) topic: pushed_at:2022-08 star:2.7k fork:0.4k 
- [openai/gym](https://github.com/openai/gym) topic: pushed_at:2022-10 star:29.0k fork:8.0k A toolkit for developing and comparing reinforcement learning algorithms.
...
- [openai/improved-diffusion](https://github.com/openai/improved-diffusion) topic: pushed_at:2022-11 star:1.0k fork:0.2k Release for Improved Denoising Diffusion Probabilistic Models
...
- [openai/multi-agent-emergence-environments](https://github.com/openai/multi-agent-emergence-environments) topic: pushed_at:2022-05 star:1.4k fork:0.3k Environment generation code for the paper "Emergent Tool Use From Multi-Agent Autocurricula"
...
- [openai/openai-cookbook](https://github.com/openai/openai-cookbook) topic: pushed_at:2022-11 star:0.4k fork:0.1k Examples and guides for using the OpenAI API
- [openai/openai-python](https://github.com/openai/openai-python) topic: pushed_at:2022-11 star:0.8k fork:0.3k 
...
- [openai/dallify-discord-bot](https://github.com/openai/dallify-discord-bot) topic: pushed_at:2022-11 star:0.0k fork:0.0k Example code for using OpenAI’s NodeJS SDK with discord.js SDK to create a Discord Bot that uses Slash Commands.
- [openai/openai-node](https://github.com/openai/openai-node) topic: pushed_at:2022-11 star:0.2k fork:0.0k Node.js library for the OpenAI API
