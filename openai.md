...
- [openai/retro](https://github.com/openai/retro) pushed_at:2021-09 star:2.5k fork:0.4k Retro Games in Gym
...
- [openai/triton](https://github.com/openai/triton) pushed_at:2021-10 star:3.3k fork:0.2k Development repository for the Triton language and compiler
...
- [openai/scheduler-plugins](https://github.com/openai/scheduler-plugins) pushed_at:2021-10 star:0.0k fork:0.0k Repository for out-of-tree scheduler plugins based on scheduler framework.
...
- [openai/pixel](https://github.com/openai/pixel) pushed_at:2021-10 star:0.0k fork:0.0k Code for the single pixel debate game from the paper "AI safety via debate" (https://arxiv.org/abs/1805.00899)
...
- [openai/CLIP](https://github.com/openai/CLIP) pushed_at:2021-10 star:5.1k fork:0.6k Contrastive Language-Image Pretraining
...
- [openai/lean-gym](https://github.com/openai/lean-gym) pushed_at:2021-10 star:0.0k fork:0.0k 

## Objective-C++

- [openai/miniF2F](https://github.com/openai/miniF2F) pushed_at:2021-10 star:0.1k fork:0.0k Formal to Formal Mathematics Benchmark
...
- [openai/baselines](https://github.com/openai/baselines) pushed_at:2021-10 star:12.0k fork:4.1k OpenAI Baselines: high-quality implementations of reinforcement learning algorithms
...
- [openai/DALL-E](https://github.com/openai/DALL-E) pushed_at:2021-04 star:3.5k fork:0.5k PyTorch package for the discrete VAE used for DALL·E.
...
- [openai/gpt-2](https://github.com/openai/gpt-2) pushed_at:2021-03 star:15.0k fork:3.9k Code for the paper "Language Models are Unsupervised Multitask Learners"
...
- [openai/grade-school-math](https://github.com/openai/grade-school-math) pushed_at:2021-10 star:0.0k fork:0.0k 
- [openai/guided-diffusion](https://github.com/openai/guided-diffusion) pushed_at:2021-10 star:0.8k fork:0.1k 
- [openai/gym](https://github.com/openai/gym) pushed_at:2021-10 star:25.5k fork:7.3k A toolkit for developing and comparing reinforcement learning algorithms.
...
- [openai/jukebox](https://github.com/openai/jukebox) pushed_at:2021-09 star:4.8k fork:0.7k Code for the paper "Jukebox: A Generative Model for Music"
...
- [openai/mujoco-py](https://github.com/openai/mujoco-py) pushed_at:2021-10 star:1.8k fork:0.6k MuJoCo is a physics engine for detailed, efficient rigid body simulations with contacts. mujoco-py allows using MuJoCo from Python 3.
...
- [openai/multiagent-particle-envs](https://github.com/openai/multiagent-particle-envs) pushed_at:2021-08 star:1.3k fork:0.5k Code for a multi-agent particle environment used in the paper "Multi-Agent Actor-Critic for Mixed Cooperative-Competitive Environments"
...
- [openai/openai-python](https://github.com/openai/openai-python) pushed_at:2021-10 star:0.2k fork:0.1k 
...
- [openai/spinningup](https://github.com/openai/spinningup) pushed_at:2021-10 star:6.4k fork:1.5k An educational resource to help anyone learn deep reinforcement learning.
...
- [openai/summarize-from-feedback](https://github.com/openai/summarize-from-feedback) pushed_at:2021-01 star:0.3k fork:0.1k Code for "Learning to summarize from human feedback"
