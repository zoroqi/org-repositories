...
- [openai/openai-dotnet](https://github.com/openai/openai-dotnet) topic:csharp,dotnet,openai pushed_at:2026-01 star:2.5k fork:0.4k The official .NET library for the OpenAI API
...
- [openai/openai-go](https://github.com/openai/openai-go) topic: pushed_at:2026-02 star:2.9k fork:0.3k The official Go library for the OpenAI API
...
- [openai/openai-realtime-console](https://github.com/openai/openai-realtime-console) topic:javascript,nodejs,openai,react,typescript pushed_at:2025-08 star:3.5k fork:1.4k React app for inspecting, building and debugging with the Realtime API
...
- [openai/CLIP](https://github.com/openai/CLIP) topic:deep-learning,machine-learning pushed_at:2024-07 star:32.4k fork:3.9k CLIP (Contrastive Language-Image Pretraining),  Predict the most relevant text snippet given an image
...
- [openai/openai-cookbook](https://github.com/openai/openai-cookbook) topic:chatgpt,gpt-4,openai,openai-api pushed_at:2026-01 star:71.2k fork:11.9k Examples and guides for using the OpenAI API
...
- [openai/compose-richtext](https://github.com/openai/compose-richtext) topic: pushed_at:2026-01 star:0.1k fork:0.0k (OpenAI Fork) A collection of Compose libraries for advanced text formatting and alternative display types.
...
- [openai/snap-o](https://github.com/openai/snap-o) topic:android,developer-tools,teams pushed_at:2026-01 star:0.1k fork:0.0k Lightweight Android capture developer tools for macOS
...
- [openai/model_spec](https://github.com/openai/model_spec) topic: pushed_at:2025-12 star:0.7k fork:0.1k The OpenAI Model Spec
...
- [openai/evals](https://github.com/openai/evals) topic: pushed_at:2025-11 star:17.6k fork:2.9k Evals is a framework for evaluating LLMs and LLM systems, and an open-source registry of benchmarks.
...
- [openai/gpt-oss](https://github.com/openai/gpt-oss) topic: pushed_at:2026-01 star:19.7k fork:2.0k gpt-oss-120b and gpt-oss-20b are two open-weight language models by OpenAI
...
- [openai/openai-agents-python](https://github.com/openai/openai-agents-python) topic:agents,ai,framework,llm,openai,python pushed_at:2026-02 star:18.7k fork:3.1k A lightweight, powerful framework for multi-agent workflows
...
- [openai/openai-knowledge-retrieval](https://github.com/openai/openai-knowledge-retrieval) topic: pushed_at:2026-01 star:0.0k fork:0.0k OS repo for Knowledge Retrieval starter kit
- [openai/openai-mcpkit](https://github.com/openai/openai-mcpkit) topic: pushed_at:2025-11 star:0.0k fork:0.0k 
- [openai/openai-python](https://github.com/openai/openai-python) topic:openai,python pushed_at:2026-02 star:29.8k fork:4.5k The official Python library for the OpenAI API
...
- [openai/simple-evals](https://github.com/openai/simple-evals) topic: pushed_at:2025-07 star:4.3k fork:0.5k 
- [openai/skills](https://github.com/openai/skills) topic: pushed_at:2026-02 star:2.3k fork:0.1k Skills Catalog for Codex
...
- [openai/swarm](https://github.com/openai/swarm) topic: pushed_at:2025-03 star:20.9k fork:2.2k Educational framework exploring ergonomic, lightweight multi-agent orchestration. Managed by OpenAI Solution team.
- [openai/tiktoken](https://github.com/openai/tiktoken) topic: pushed_at:2025-10 star:17.1k fork:1.4k tiktoken is a fast BPE tokeniser for use with OpenAI's models.
...
- [openai/whisper](https://github.com/openai/whisper) topic: pushed_at:2025-12 star:94.0k fork:11.7k Robust Speech Recognition via Large-Scale Weak Supervision
...
- [openai/openai-ruby](https://github.com/openai/openai-ruby) topic: pushed_at:2026-01 star:0.4k fork:0.0k Official Ruby SDK for the OpenAI API

## Rust

- [openai/codex](https://github.com/openai/codex) topic: pushed_at:2026-02 star:58.3k fork:7.6k Lightweight coding agent that runs in your terminal
- [openai/harmony](https://github.com/openai/harmony) topic: pushed_at:2025-12 star:4.2k fork:0.2k Renderer for the harmony response format to be used with gpt-oss
...
- [openai/chatkit-js](https://github.com/openai/chatkit-js) topic: pushed_at:2026-01 star:1.7k fork:0.2k 
- [openai/codex-action](https://github.com/openai/codex-action) topic: pushed_at:2026-01 star:0.8k fork:0.1k 
...
- [openai/openai-agents-js](https://github.com/openai/openai-agents-js) topic:agents,openai,openai-api,realtime-api,typescript pushed_at:2026-01 star:2.2k fork:0.6k A lightweight, powerful framework for multi-agent workflows and voice agents
...
- [openai/openai-fm](https://github.com/openai/openai-fm) topic: pushed_at:2025-12 star:2.6k fork:7.2k Code for openai.fm, a demo for the OpenAI Speech API
...
- [openai/openai-node](https://github.com/openai/openai-node) topic:nodejs,openai,typescript pushed_at:2026-01 star:10.6k fork:1.4k Official JavaScript / TypeScript library for the OpenAI API
- [openai/openai-realtime-agents](https://github.com/openai/openai-realtime-agents) topic: pushed_at:2026-01 star:6.7k fork:1.1k This is a simple demonstration of more advanced, agentic patterns built on top of the Realtime API.
