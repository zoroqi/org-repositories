...
- [openai/openai-dotnet](https://github.com/openai/openai-dotnet) topic:csharp,dotnet,openai pushed_at:2025-06 star:2.1k fork:0.3k The official .NET library for the OpenAI API
...
- [openai/openai-go](https://github.com/openai/openai-go) topic: pushed_at:2025-07 star:2.0k fork:0.2k The official Go library for the OpenAI API
...
- [openai/openai-realtime-console](https://github.com/openai/openai-realtime-console) topic:javascript,nodejs,openai,react,typescript pushed_at:2025-06 star:3.3k fork:1.3k React app for inspecting, building and debugging with the Realtime API
...
- [openai/build-hours](https://github.com/openai/build-hours) topic: pushed_at:2025-06 star:0.4k fork:0.1k Build hours code to share.
- [openai/CLIP](https://github.com/openai/CLIP) topic:deep-learning,machine-learning pushed_at:2024-07 star:29.6k fork:3.7k CLIP (Contrastive Language-Image Pretraining),  Predict the most relevant text snippet given an image
...
- [openai/openai-java](https://github.com/openai/openai-java) topic: pushed_at:2025-07 star:0.9k fork:0.1k The official Java library for the OpenAI API
...
- [openai/openai-cookbook](https://github.com/openai/openai-cookbook) topic:chatgpt,gpt-4,openai,openai-api pushed_at:2025-06 star:65.0k fork:10.8k Examples and guides for using the OpenAI API
...
- [openai/TestUGxlYXNlIGlnbm9yZQo](https://github.com/openai/TestUGxlYXNlIGlnbm9yZQo) topic: pushed_at:2025-06 star:0.0k fork:0.0k Test Please ignore
...
- [openai/evals](https://github.com/openai/evals) topic: pushed_at:2024-12 star:16.5k fork:2.7k Evals is a framework for evaluating LLMs and LLM systems, and an open-source registry of benchmarks.
...
- [openai/guided-diffusion](https://github.com/openai/guided-diffusion) topic: pushed_at:2024-07 star:6.9k fork:0.9k 
- [openai/gym](https://github.com/openai/gym) topic: pushed_at:2024-10 star:36.2k fork:8.7k A toolkit for developing and comparing reinforcement learning algorithms.
...
- [openai/mle-bench](https://github.com/openai/mle-bench) topic: pushed_at:2025-06 star:0.8k fork:0.1k MLE-bench is a benchmark for measuring how well AI agents perform at machine learning engineering
...
- [openai/openai-agents-python](https://github.com/openai/openai-agents-python) topic:agents,ai,framework,llm,openai,python pushed_at:2025-06 star:12.1k fork:1.9k A lightweight, powerful framework for multi-agent workflows
...
- [openai/openai-python](https://github.com/openai/openai-python) topic:openai,python pushed_at:2025-07 star:27.2k fork:4.0k The official Python library for the OpenAI API
...
- [openai/simple-evals](https://github.com/openai/simple-evals) topic: pushed_at:2025-05 star:3.8k fork:0.4k 
...
- [openai/spinningup](https://github.com/openai/spinningup) topic: pushed_at:2024-08 star:11.0k fork:2.4k An educational resource to help anyone learn deep reinforcement learning.
...
- [openai/swarm](https://github.com/openai/swarm) topic: pushed_at:2025-03 star:20.0k fork:2.1k Educational framework exploring ergonomic, lightweight multi-agent orchestration. Managed by OpenAI Solution team.
...
- [openai/tiktoken](https://github.com/openai/tiktoken) topic: pushed_at:2025-03 star:15.0k fork:1.1k tiktoken is a fast BPE tokeniser for use with OpenAI's models.
...
- [openai/whisper](https://github.com/openai/whisper) topic: pushed_at:2025-06 star:84.2k fork:10.2k Robust Speech Recognition via Large-Scale Weak Supervision
...
- [openai/openai-ruby](https://github.com/openai/openai-ruby) topic: pushed_at:2025-06 star:0.3k fork:0.0k Official Ruby SDK for the OpenAI API

## Rust

- [openai/codex](https://github.com/openai/codex) topic: pushed_at:2025-07 star:30.2k fork:3.4k Lightweight coding agent that runs in your terminal
...
- [openai/openai-agents-js](https://github.com/openai/openai-agents-js) topic: pushed_at:2025-06 star:0.7k fork:0.1k A lightweight, powerful framework for multi-agent workflows and voice agents
...
- [openai/openai-cs-agents-demo](https://github.com/openai/openai-cs-agents-demo) topic: pushed_at:2025-06 star:5.3k fork:0.8k Demo of a customer service use case implemented with the OpenAI Agents SDK
...
- [openai/openai-node](https://github.com/openai/openai-node) topic:nodejs,openai,typescript pushed_at:2025-06 star:9.4k fork:1.1k Official JavaScript / TypeScript library for the OpenAI API
- [openai/openai-realtime-agents](https://github.com/openai/openai-realtime-agents) topic: pushed_at:2025-06 star:6.0k fork:0.8k This is a simple demonstration of more advanced, agentic patterns built on top of the Realtime API.
...
- [openai/openai-testing-agent-demo](https://github.com/openai/openai-testing-agent-demo) topic: pushed_at:2025-06 star:0.6k fork:0.1k Demo of a UI testing agent using the OpenAI CUA model and the Responses API.
