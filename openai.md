...
- [openai/openai-dotnet](https://github.com/openai/openai-dotnet) topic:csharp,dotnet,openai pushed_at:2024-12 star:1.6k fork:0.2k The official .NET library for the OpenAI API
...
- [openai/openai-realtime-embedded-sdk](https://github.com/openai/openai-realtime-embedded-sdk) topic: pushed_at:2024-12 star:1.3k fork:0.1k A SDK to using the Realtime API with Microcontrollers like the ESP32
...
- [openai/openai-go](https://github.com/openai/openai-go) topic: pushed_at:2024-12 star:0.7k fork:0.0k The official Go library for the OpenAI API
...
- [openai/openai-realtime-console](https://github.com/openai/openai-realtime-console) topic:javascript,nodejs,openai,react,typescript pushed_at:2024-12 star:2.4k fork:0.9k React app for inspecting, building and debugging with the Realtime API
...
- [openai/CLIP](https://github.com/openai/CLIP) topic:deep-learning,machine-learning pushed_at:2024-07 star:26.7k fork:3.4k CLIP (Contrastive Language-Image Pretraining),  Predict the most relevant text snippet given an image
...
- [openai/openai-java](https://github.com/openai/openai-java) topic: pushed_at:2024-12 star:0.3k fork:0.0k The official Java library for the OpenAI API
...
- [openai/openai-cookbook](https://github.com/openai/openai-cookbook) topic:chatgpt,gpt-4,openai,openai-api pushed_at:2024-12 star:60.9k fork:9.7k Examples and guides for using the OpenAI API
...
- [openai/baselines](https://github.com/openai/baselines) topic: pushed_at:2024-08 star:15.9k fork:4.9k OpenAI Baselines: high-quality implementations of reinforcement learning algorithms
...
- [openai/gpt-2](https://github.com/openai/gpt-2) topic:paper pushed_at:2024-08 star:22.7k fork:5.6k Code for the paper "Language Models are Unsupervised Multitask Learners"
...
- [openai/grade-school-math](https://github.com/openai/grade-school-math) topic: pushed_at:2024-01 star:1.1k fork:0.2k 
- [openai/grok](https://github.com/openai/grok) topic: pushed_at:2024-03 star:4.1k fork:0.5k 
- [openai/guided-diffusion](https://github.com/openai/guided-diffusion) topic: pushed_at:2024-07 star:6.4k fork:0.8k 
- [openai/gym](https://github.com/openai/gym) topic: pushed_at:2024-10 star:35.1k fork:8.6k A toolkit for developing and comparing reinforcement learning algorithms.
...
- [openai/human-eval](https://github.com/openai/human-eval) topic: pushed_at:2024-02 star:2.5k fork:0.4k Code for the paper "Evaluating Large Language Models Trained on Code"
...
- [openai/mle-bench](https://github.com/openai/mle-bench) topic: pushed_at:2024-11 star:0.6k fork:0.1k MLE-bench is a benchmark for measuring how well AI agents perform at machine learning engineering
...
- [openai/openai-python](https://github.com/openai/openai-python) topic:openai,python pushed_at:2024-12 star:23.8k fork:3.4k The official Python library for the OpenAI API
...
- [openai/shap-e](https://github.com/openai/shap-e) topic: pushed_at:2024-06 star:11.7k fork:1.0k Generate 3D objects conditioned on text or images
- [openai/simple-evals](https://github.com/openai/simple-evals) topic: pushed_at:2024-12 star:2.1k fork:0.2k 
...
- [openai/spinningup](https://github.com/openai/spinningup) topic: pushed_at:2024-08 star:10.3k fork:2.2k An educational resource to help anyone learn deep reinforcement learning.
...
- [openai/swarm](https://github.com/openai/swarm) topic: pushed_at:2024-10 star:17.3k fork:1.8k Educational framework exploring ergonomic, lightweight multi-agent orchestration. Managed by OpenAI Solution team.
- [openai/tiktoken](https://github.com/openai/tiktoken) topic: pushed_at:2024-10 star:12.9k fork:0.9k tiktoken is a fast BPE tokeniser for use with OpenAI's models.
...
- [openai/whisper](https://github.com/openai/whisper) topic: pushed_at:2024-12 star:73.6k fork:8.8k Robust Speech Recognition via Large-Scale Weak Supervision
...
- [openai/openai-assistants-quickstart](https://github.com/openai/openai-assistants-quickstart) topic: pushed_at:2024-07 star:1.6k fork:0.4k OpenAI Assistants API quickstart with Next.js.
...
- [openai/openai-node](https://github.com/openai/openai-node) topic:nodejs,openai,typescript pushed_at:2024-12 star:8.2k fork:0.9k Official JavaScript / TypeScript library for the OpenAI API
...
- [openai/openai-structured-outputs-samples](https://github.com/openai/openai-structured-outputs-samples) topic: pushed_at:2024-12 star:0.0k fork:0.0k Sample apps to help developers get started with Structured Outputs
