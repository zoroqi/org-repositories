...
- [openai/codex-universal](https://github.com/openai/codex-universal) topic: pushed_at:2025-08 star:0.6k fork:0.2k Base docker image used in Codex environments
...
- [openai/openai-apps-sdk-examples](https://github.com/openai/openai-apps-sdk-examples) topic: pushed_at:2025-10 star:1.4k fork:0.2k Example apps for the Apps SDK
...
- [openai/CLIP](https://github.com/openai/CLIP) topic:deep-learning,machine-learning pushed_at:2024-07 star:31.1k fork:3.8k CLIP (Contrastive Language-Image Pretraining),  Predict the most relevant text snippet given an image
...
- [openai/openai-cookbook](https://github.com/openai/openai-cookbook) topic:chatgpt,gpt-4,openai,openai-api pushed_at:2025-10 star:68.6k fork:11.4k Examples and guides for using the OpenAI API
...
- [openai/openai-java](https://github.com/openai/openai-java) topic: pushed_at:2025-10 star:1.2k fork:0.2k The official Java library for the OpenAI API
...
- [openai/model_spec](https://github.com/openai/model_spec) topic: pushed_at:2025-09 star:0.6k fork:0.1k The OpenAI Model Spec
...
- [openai/chatkit-python](https://github.com/openai/chatkit-python) topic: pushed_at:2025-10 star:0.2k fork:0.1k 
...
- [openai/evals](https://github.com/openai/evals) topic: pushed_at:2024-12 star:17.1k fork:2.8k Evals is a framework for evaluating LLMs and LLM systems, and an open-source registry of benchmarks.
...
- [openai/frontier-evals](https://github.com/openai/frontier-evals) topic: pushed_at:2025-09 star:0.9k fork:0.1k OpenAI Frontier Evals
...
- [openai/gpt-oss](https://github.com/openai/gpt-oss) topic: pushed_at:2025-10 star:18.8k fork:1.8k gpt-oss-120b and gpt-oss-20b are two open-weight language models by OpenAI
...
- [openai/mle-bench](https://github.com/openai/mle-bench) topic: pushed_at:2025-10 star:1.0k fork:0.2k MLE-bench is a benchmark for measuring how well AI agents perform at machine learning engineering
...
- [openai/openai-agents-python](https://github.com/openai/openai-agents-python) topic:agents,ai,framework,llm,openai,python pushed_at:2025-10 star:16.6k fork:2.7k A lightweight, powerful framework for multi-agent workflows
- [openai/openai-chatkit-advanced-samples](https://github.com/openai/openai-chatkit-advanced-samples) topic:chatkit,openai,openai-api,python,typescript pushed_at:2025-10 star:0.3k fork:0.1k Starter app to build with OpenAI ChatKit SDK
...
- [openai/openai-guardrails-python](https://github.com/openai/openai-guardrails-python) topic: pushed_at:2025-10 star:0.1k fork:0.0k OpenAI Guardrails Python (Preview)
- [openai/openai-python](https://github.com/openai/openai-python) topic:openai,python pushed_at:2025-10 star:29.0k fork:4.3k The official Python library for the OpenAI API
...
- [openai/summarize-from-feedback](https://github.com/openai/summarize-from-feedback) topic: pushed_at:2023-09 star:1.0k fork:0.2k Code for "Learning to summarize from human feedback"
- [openai/swarm](https://github.com/openai/swarm) topic: pushed_at:2025-03 star:20.5k fork:2.2k Educational framework exploring ergonomic, lightweight multi-agent orchestration. Managed by OpenAI Solution team.
- [openai/tiktoken](https://github.com/openai/tiktoken) topic: pushed_at:2025-10 star:16.2k fork:1.3k tiktoken is a fast BPE tokeniser for use with OpenAI's models.
...
- [openai/whisper](https://github.com/openai/whisper) topic: pushed_at:2025-09 star:89.6k fork:11.2k Robust Speech Recognition via Large-Scale Weak Supervision
...
- [openai/codex](https://github.com/openai/codex) topic: pushed_at:2025-10 star:47.9k fork:5.8k Lightweight coding agent that runs in your terminal
- [openai/harmony](https://github.com/openai/harmony) topic: pushed_at:2025-08 star:3.9k fork:0.2k Renderer for the harmony response format to be used with gpt-oss
...
- [openai/agents.md](https://github.com/openai/agents.md) topic: pushed_at:2025-10 star:7.3k fork:0.6k AGENTS.md — a simple, open format for guiding coding agents
- [openai/chatkit-js](https://github.com/openai/chatkit-js) topic: pushed_at:2025-10 star:1.5k fork:0.1k 
- [openai/codex-action](https://github.com/openai/codex-action) topic: pushed_at:2025-10 star:0.5k fork:0.0k 
...
- [openai/openai-agents-js](https://github.com/openai/openai-agents-js) topic: pushed_at:2025-10 star:1.7k fork:0.4k A lightweight, powerful framework for multi-agent workflows and voice agents
...
- [openai/openai-chatkit-starter-app](https://github.com/openai/openai-chatkit-starter-app) topic:chatkit,openai,openai-api pushed_at:2025-10 star:0.5k fork:0.3k Starter app to build with OpenAI ChatKit + Agent Builder
...
- [openai/openai-guardrails-js](https://github.com/openai/openai-guardrails-js) topic: pushed_at:2025-10 star:0.0k fork:0.0k OpenAI Guardrails TypeScript / JavaScript (Preview)
- [openai/openai-node](https://github.com/openai/openai-node) topic:nodejs,openai,typescript pushed_at:2025-10 star:10.2k fork:1.3k Official JavaScript / TypeScript library for the OpenAI API
- [openai/openai-realtime-agents](https://github.com/openai/openai-realtime-agents) topic: pushed_at:2025-10 star:6.5k fork:1.0k This is a simple demonstration of more advanced, agentic patterns built on top of the Realtime API.
