...
- [openai/triton](https://github.com/openai/triton) topic: pushed_at:2024-04 star:10.6k fork:1.2k Development repository for the Triton language and compiler
...
- [openai/CLIP](https://github.com/openai/CLIP) topic:deep-learning,machine-learning pushed_at:2024-01 star:21.7k fork:2.9k CLIP (Contrastive Language-Image Pretraining),  Predict the most relevant text snippet given an image
...
- [openai/openai-cookbook](https://github.com/openai/openai-cookbook) topic:chatgpt,gpt-4,openai,openai-api pushed_at:2024-04 star:55.4k fork:8.7k Examples and guides for using the OpenAI API
...
- [openai/baselines](https://github.com/openai/baselines) topic: pushed_at:2023-11 star:15.3k fork:4.8k OpenAI Baselines: high-quality implementations of reinforcement learning algorithms
...
- [openai/chatgpt-retrieval-plugin](https://github.com/openai/chatgpt-retrieval-plugin) topic:chatgpt,chatgpt-plugins pushed_at:2024-03 star:20.8k fork:3.7k The ChatGPT Retrieval Plugin lets you easily find personal or work documents by asking questions in natural language.
...
- [openai/evals](https://github.com/openai/evals) topic: pushed_at:2024-04 star:13.6k fork:2.5k Evals is a framework for evaluating LLMs and LLM systems, and an open-source registry of benchmarks.
...
- [openai/finetune-transformer-lm](https://github.com/openai/finetune-transformer-lm) topic:paper pushed_at:2019-01 star:2.1k fork:0.5k Code and model for the paper "Improving Language Understanding by Generative Pre-Training"
...
- [openai/gpt-2](https://github.com/openai/gpt-2) topic:paper pushed_at:2024-01 star:20.9k fork:5.3k Code for the paper "Language Models are Unsupervised Multitask Learners"
...
- [openai/gpt-discord-bot](https://github.com/openai/gpt-discord-bot) topic: pushed_at:2024-03 star:1.7k fork:0.6k Example Discord bot written in Python that uses the completions API to have conversations with the `text-davinci-003` model, and the moderations API to filter the messages.
- [openai/grade-school-math](https://github.com/openai/grade-school-math) topic: pushed_at:2024-01 star:0.8k fork:0.1k 
- [openai/grok](https://github.com/openai/grok) topic: pushed_at:2024-03 star:3.9k fork:0.5k 
- [openai/guided-diffusion](https://github.com/openai/guided-diffusion) topic: pushed_at:2023-04 star:5.5k fork:0.7k 
- [openai/gym](https://github.com/openai/gym) topic: pushed_at:2024-02 star:33.8k fork:8.5k A toolkit for developing and comparing reinforcement learning algorithms.
...
- [openai/human-eval](https://github.com/openai/human-eval) topic: pushed_at:2024-02 star:1.9k fork:0.3k Code for the paper "Evaluating Large Language Models Trained on Code"
...
- [openai/multiagent-particle-envs](https://github.com/openai/multiagent-particle-envs) topic:paper pushed_at:2024-02 star:2.2k fork:0.8k Code for a multi-agent particle environment used in the paper "Multi-Agent Actor-Critic for Mixed Cooperative-Competitive Environments"
...
- [openai/openai-python](https://github.com/openai/openai-python) topic:openai,python pushed_at:2024-04 star:19.4k fork:2.6k The official Python library for the OpenAI API
...
- [openai/plugins-quickstart](https://github.com/openai/plugins-quickstart) topic:chatgpt,chatgpt-plugins pushed_at:2024-01 star:4.3k fork:0.7k Get a ChatGPT plugin up and running in under 5 minutes!
- [openai/point-e](https://github.com/openai/point-e) topic: pushed_at:2023-10 star:6.3k fork:0.7k Point cloud diffusion for 3D model synthesis
- [openai/prm800k](https://github.com/openai/prm800k) topic: pushed_at:2023-06 star:1.3k fork:0.1k 800,000 step-level correctness labels on LLM solutions to MATH problems
...
- [openai/shap-e](https://github.com/openai/shap-e) topic: pushed_at:2024-02 star:11.2k fork:0.9k Generate 3D objects conditioned on text or images
...
- [openai/spinningup](https://github.com/openai/spinningup) topic: pushed_at:2024-03 star:9.6k fork:2.1k An educational resource to help anyone learn deep reinforcement learning.
...
- [openai/tiktoken](https://github.com/openai/tiktoken) topic: pushed_at:2024-03 star:9.4k fork:0.6k tiktoken is a fast BPE tokeniser for use with OpenAI's models.
...
- [openai/transformer-debugger](https://github.com/openai/transformer-debugger) topic: pushed_at:2024-03 star:3.6k fork:0.2k 
...
- [openai/Video-Pre-Training](https://github.com/openai/Video-Pre-Training) topic: pushed_at:2024-03 star:1.2k fork:0.1k Video PreTraining (VPT): Learning to Act by Watching Unlabeled Online Videos
...
- [openai/weak-to-strong](https://github.com/openai/weak-to-strong) topic: pushed_at:2024-02 star:2.4k fork:0.3k 
...
- [openai/whisper](https://github.com/openai/whisper) topic: pushed_at:2024-03 star:58.9k fork:6.7k Robust Speech Recognition via Large-Scale Weak Supervision
...
- [openai/openai-node](https://github.com/openai/openai-node) topic:nodejs,openai,typescript pushed_at:2024-03 star:6.8k fork:0.7k The official Node.js / Typescript library for the OpenAI API
