...
- [openai/openai-reflect](https://github.com/openai/openai-reflect) topic: pushed_at:2025-08 star:0.2k fork:0.0k Physical AI Assistant that illuminates your life
...
- [openai/gpt-5-coding-examples](https://github.com/openai/gpt-5-coding-examples) topic:codex,coding,frontend,gpt,openai,web,website pushed_at:2025-08 star:1.6k fork:0.2k GPT-5 coding examples
...
- [openai/openai-realtime-console](https://github.com/openai/openai-realtime-console) topic:javascript,nodejs,openai,react,typescript pushed_at:2025-08 star:3.4k fork:1.3k React app for inspecting, building and debugging with the Realtime API
...
- [openai/build-hours](https://github.com/openai/build-hours) topic: pushed_at:2025-08 star:0.5k fork:0.1k Build hours code to share.
- [openai/CLIP](https://github.com/openai/CLIP) topic:deep-learning,machine-learning pushed_at:2024-07 star:30.7k fork:3.7k CLIP (Contrastive Language-Image Pretraining),  Predict the most relevant text snippet given an image
...
- [openai/openai-cookbook](https://github.com/openai/openai-cookbook) topic:chatgpt,gpt-4,openai,openai-api pushed_at:2025-09 star:67.9k fork:11.3k Examples and guides for using the OpenAI API
...
- [openai/gpt-oss](https://github.com/openai/gpt-oss) topic: pushed_at:2025-09 star:18.4k fork:1.8k gpt-oss-120b and gpt-oss-20b are two open-weight language models by OpenAI
...
- [openai/gym](https://github.com/openai/gym) topic: pushed_at:2024-10 star:36.5k fork:8.7k A toolkit for developing and comparing reinforcement learning algorithms.
...
- [openai/openai-agents-python](https://github.com/openai/openai-agents-python) topic:agents,ai,framework,llm,openai,python pushed_at:2025-09 star:14.7k fork:2.4k A lightweight, powerful framework for multi-agent workflows
...
- [openai/openai-python](https://github.com/openai/openai-python) topic:openai,python pushed_at:2025-09 star:28.7k fork:4.3k The official Python library for the OpenAI API
...
- [openai/preparedness](https://github.com/openai/preparedness) topic: pushed_at:2025-08 star:0.9k fork:0.1k Releases from OpenAI Preparedness
...
- [openai/spinningup](https://github.com/openai/spinningup) topic: pushed_at:2024-08 star:11.2k fork:2.4k An educational resource to help anyone learn deep reinforcement learning.
...
- [openai/swarm](https://github.com/openai/swarm) topic: pushed_at:2025-03 star:20.4k fork:2.2k Educational framework exploring ergonomic, lightweight multi-agent orchestration. Managed by OpenAI Solution team.
- [openai/tiktoken](https://github.com/openai/tiktoken) topic: pushed_at:2025-09 star:15.9k fork:1.2k tiktoken is a fast BPE tokeniser for use with OpenAI's models.
...
- [openai/whisper](https://github.com/openai/whisper) topic: pushed_at:2025-09 star:88.3k fork:11.0k Robust Speech Recognition via Large-Scale Weak Supervision
...
- [openai/codex](https://github.com/openai/codex) topic: pushed_at:2025-09 star:41.6k fork:4.9k Lightweight coding agent that runs in your terminal
...
- [openai/snap-o](https://github.com/openai/snap-o) topic: pushed_at:2025-09 star:0.0k fork:0.0k Lightweight Android screen capture tool for macOS
...
- [openai/agents.md](https://github.com/openai/agents.md) topic: pushed_at:2025-09 star:5.9k fork:0.4k AGENTS.md — a simple, open format for guiding coding agents
...
- [openai/openai-agents-js](https://github.com/openai/openai-agents-js) topic: pushed_at:2025-09 star:1.4k fork:0.3k A lightweight, powerful framework for multi-agent workflows and voice agents
...
- [openai/openai-node](https://github.com/openai/openai-node) topic:nodejs,openai,typescript pushed_at:2025-09 star:10.1k fork:1.2k Official JavaScript / TypeScript library for the OpenAI API
- [openai/openai-realtime-agents](https://github.com/openai/openai-realtime-agents) topic: pushed_at:2025-09 star:6.4k fork:0.9k This is a simple demonstration of more advanced, agentic patterns built on top of the Realtime API.
