...
- [openai/openai-dotnet](https://github.com/openai/openai-dotnet) topic:csharp,dotnet,openai pushed_at:2025-10 star:2.4k fork:0.3k The official .NET library for the OpenAI API
...
- [openai/openai-go](https://github.com/openai/openai-go) topic: pushed_at:2025-10 star:2.6k fork:0.2k The official Go library for the OpenAI API
...
- [openai/openai-apps-sdk-examples](https://github.com/openai/openai-apps-sdk-examples) topic: pushed_at:2025-10 star:1.6k fork:0.3k Example apps for the Apps SDK
...
- [openai/build-hours](https://github.com/openai/build-hours) topic: pushed_at:2025-10 star:0.6k fork:0.1k Build hours code to share.
- [openai/CLIP](https://github.com/openai/CLIP) topic:deep-learning,machine-learning pushed_at:2024-07 star:31.3k fork:3.8k CLIP (Contrastive Language-Image Pretraining),  Predict the most relevant text snippet given an image
...
- [openai/openai-cookbook](https://github.com/openai/openai-cookbook) topic:chatgpt,gpt-4,openai,openai-api pushed_at:2025-10 star:69.0k fork:11.5k Examples and guides for using the OpenAI API
...
- [openai/baselines](https://github.com/openai/baselines) topic: pushed_at:2024-08 star:16.5k fork:4.9k OpenAI Baselines: high-quality implementations of reinforcement learning algorithms
...
- [openai/chatkit-python](https://github.com/openai/chatkit-python) topic: pushed_at:2025-10 star:0.3k fork:0.1k 
...
- [openai/evals](https://github.com/openai/evals) topic: pushed_at:2024-12 star:17.2k fork:2.8k Evals is a framework for evaluating LLMs and LLM systems, and an open-source registry of benchmarks.
...
- [openai/gpt-2](https://github.com/openai/gpt-2) topic:paper pushed_at:2024-08 star:24.3k fork:5.8k Code for the paper "Language Models are Unsupervised Multitask Learners"
...
- [openai/gpt-oss](https://github.com/openai/gpt-oss) topic: pushed_at:2025-11 star:19.0k fork:1.9k gpt-oss-120b and gpt-oss-20b are two open-weight language models by OpenAI
...
- [openai/gym](https://github.com/openai/gym) topic: pushed_at:2024-10 star:36.7k fork:8.7k A toolkit for developing and comparing reinforcement learning algorithms.
...
- [openai/mle-bench](https://github.com/openai/mle-bench) topic: pushed_at:2025-10 star:1.1k fork:0.2k MLE-bench is a benchmark for measuring how well AI agents perform at machine learning engineering
...
- [openai/openai-agents-python](https://github.com/openai/openai-agents-python) topic:agents,ai,framework,llm,openai,python pushed_at:2025-10 star:17.0k fork:2.8k A lightweight, powerful framework for multi-agent workflows
- [openai/openai-chatkit-advanced-samples](https://github.com/openai/openai-chatkit-advanced-samples) topic:chatkit,openai,openai-api,python,typescript pushed_at:2025-10 star:0.4k fork:0.2k Starter app to build with OpenAI ChatKit SDK
- [openai/openai-cua-sample-app](https://github.com/openai/openai-cua-sample-app) topic: pushed_at:2025-04 star:1.2k fork:0.3k Learn how to use CUA (our Computer Using Agent) via the API on multiple computer environments.
- [openai/openai-guardrails-python](https://github.com/openai/openai-guardrails-python) topic: pushed_at:2025-10 star:0.1k fork:0.0k OpenAI Guardrails - Python
- [openai/openai-python](https://github.com/openai/openai-python) topic:openai,python pushed_at:2025-11 star:29.1k fork:4.4k The official Python library for the OpenAI API
...
- [openai/shap-e](https://github.com/openai/shap-e) topic: pushed_at:2024-06 star:12.1k fork:1.0k Generate 3D objects conditioned on text or images
- [openai/simple-evals](https://github.com/openai/simple-evals) topic: pushed_at:2025-07 star:4.1k fork:0.4k 
...
- [openai/spinningup](https://github.com/openai/spinningup) topic: pushed_at:2024-08 star:11.3k fork:2.4k An educational resource to help anyone learn deep reinforcement learning.
...
- [openai/tiktoken](https://github.com/openai/tiktoken) topic: pushed_at:2025-10 star:16.4k fork:1.3k tiktoken is a fast BPE tokeniser for use with OpenAI's models.
...
- [openai/whisper](https://github.com/openai/whisper) topic: pushed_at:2025-09 star:90.2k fork:11.3k Robust Speech Recognition via Large-Scale Weak Supervision
...
- [openai/openai-ruby](https://github.com/openai/openai-ruby) topic: pushed_at:2025-10 star:0.4k fork:0.0k Official Ruby SDK for the OpenAI API

## Rust

- [openai/codex](https://github.com/openai/codex) topic: pushed_at:2025-11 star:49.5k fork:6.1k Lightweight coding agent that runs in your terminal
- [openai/harmony](https://github.com/openai/harmony) topic: pushed_at:2025-08 star:4.0k fork:0.2k Renderer for the harmony response format to be used with gpt-oss
...
- [openai/snap-o](https://github.com/openai/snap-o) topic:android,developer-tools,teams pushed_at:2025-10 star:0.0k fork:0.0k Lightweight Android screen capture tool for macOS
...
- [openai/agents.md](https://github.com/openai/agents.md) topic: pushed_at:2025-10 star:7.8k fork:0.6k AGENTS.md — a simple, open format for guiding coding agents
- [openai/chatkit-js](https://github.com/openai/chatkit-js) topic: pushed_at:2025-10 star:1.5k fork:0.1k 
- [openai/codex-action](https://github.com/openai/codex-action) topic: pushed_at:2025-10 star:0.6k fork:0.1k 
...
- [openai/openai-agents-js](https://github.com/openai/openai-agents-js) topic:agents,openai,openai-api,realtime-api,typescript pushed_at:2025-10 star:1.8k fork:0.5k A lightweight, powerful framework for multi-agent workflows and voice agents
...
- [openai/openai-chatkit-starter-app](https://github.com/openai/openai-chatkit-starter-app) topic:chatkit,openai,openai-api pushed_at:2025-10 star:0.6k fork:0.6k Starter app to build with OpenAI ChatKit + Agent Builder
...
- [openai/openai-guardrails-js](https://github.com/openai/openai-guardrails-js) topic: pushed_at:2025-10 star:0.0k fork:0.0k OpenAI Guardrails - TypeScript / JavaScript
- [openai/openai-node](https://github.com/openai/openai-node) topic:nodejs,openai,typescript pushed_at:2025-11 star:10.3k fork:1.3k Official JavaScript / TypeScript library for the OpenAI API
...
- [openai/openai-responses-starter-app](https://github.com/openai/openai-responses-starter-app) topic: pushed_at:2025-09 star:0.7k fork:0.2k Starter app to build with the OpenAI Responses API
