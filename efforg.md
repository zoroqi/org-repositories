...
- [EFForg/privacybadger](https://github.com/EFForg/privacybadger) topic:browser-fingerprinting,chrome-extension,cookies,fingerprinting,firefox-extension,javascript,privacy,tracking,webextension pushed_at:2023-09 star:2.8k fork:0.4k Privacy Badger is a browser extension that automatically learns to block invisible trackers.
...
- [EFForg/badger-sett](https://github.com/EFForg/badger-sett) topic: pushed_at:2023-09 star:0.1k fork:0.0k Browser automation for Privacy Badger. Used to pre-train new Badgers before every release.
