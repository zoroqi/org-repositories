...
- [EFForg/action-center-platform](https://github.com/EFForg/action-center-platform) topic: pushed_at:2026-03 star:0.5k fork:0.1k The EFF Action Center Platform
...
- [EFForg/apkeep](https://github.com/EFForg/apkeep) topic: pushed_at:2025-11 star:1.7k fork:0.1k A command-line tool for downloading APK files from various sources
...
- [EFForg/rayhunter](https://github.com/EFForg/rayhunter) topic: pushed_at:2026-04 star:5.1k fork:0.4k Rust tool to detect cell site simulators on an orbic mobile hotspot 
