...
- [EFForg/privacybadger](https://github.com/EFForg/privacybadger) topic:browser-fingerprinting,chrome-extension,cookies,fingerprinting,firefox-extension,javascript,privacy,tracking,webextension pushed_at:2025-05 star:3.4k fork:0.4k Privacy Badger is a browser extension that automatically learns to block invisible trackers.
...
- [EFForg/badger-sett](https://github.com/EFForg/badger-sett) topic: pushed_at:2025-05 star:0.1k fork:0.0k Automated training for Privacy Badger. Badger Sett automates browsers to visit websites to produce fresh Privacy Badger tracker data.
...
- [EFForg/action-center-platform](https://github.com/EFForg/action-center-platform) topic: pushed_at:2025-05 star:0.5k fork:0.1k The EFF Action Center Platform
...
- [EFForg/congress_forms](https://github.com/EFForg/congress_forms) topic: pushed_at:2025-04 star:0.0k fork:0.0k 
- [EFForg/congress_forms_api](https://github.com/EFForg/congress_forms_api) topic: pushed_at:2025-05 star:0.0k fork:0.0k Public mirror for the Congress Forms API, a Rails app providnig a JSON-based API for the congress_forms gem.
...
- [EFForg/rayhunter](https://github.com/EFForg/rayhunter) topic: pushed_at:2025-05 star:2.0k fork:0.1k Rust tool to detect cell site simulators on an orbic mobile hotspot 
...
- [EFForg/privacybadger-website](https://github.com/EFForg/privacybadger-website) topic: pushed_at:2025-04 star:0.0k fork:0.0k Code and content of https://privacybadger.org
