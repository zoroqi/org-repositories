...
- [EFForg/privacybadger](https://github.com/EFForg/privacybadger) topic:browser-fingerprinting,chrome-extension,cookies,fingerprinting,firefox-extension,javascript,privacy,tracking,webextension pushed_at:2025-02 star:3.3k fork:0.4k Privacy Badger is a browser extension that automatically learns to block invisible trackers.
...
- [EFForg/badger-sett](https://github.com/EFForg/badger-sett) topic: pushed_at:2025-02 star:0.1k fork:0.0k Automated training for Privacy Badger. Badger Sett automates browsers to visit websites to produce fresh Privacy Badger tracker data.
- [EFForg/call-congress](https://github.com/EFForg/call-congress) topic: pushed_at:2025-02 star:0.0k fork:0.0k a simple server that connects calls between citizens and their congress person using the Twilio API
...
- [EFForg/action-center-platform](https://github.com/EFForg/action-center-platform) topic: pushed_at:2025-02 star:0.5k fork:0.1k The EFF Action Center Platform
...
- [EFForg/rayhunter](https://github.com/EFForg/rayhunter) topic: pushed_at:2025-02 star:0.1k fork:0.0k Rust tool to detect cell site simulators on an orbic mobile hotspot 
...
- [EFForg/privacybadger-website](https://github.com/EFForg/privacybadger-website) topic: pushed_at:2025-01 star:0.0k fork:0.0k Code and content of https://privacybadger.org
