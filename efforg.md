...
- [EFForg/apkeep](https://github.com/EFForg/apkeep) topic: pushed_at:2025-11 star:1.6k fork:0.1k A command-line tool for downloading APK files from various sources
...
- [EFForg/rayhunter](https://github.com/EFForg/rayhunter) topic: pushed_at:2026-02 star:4.7k fork:0.4k Rust tool to detect cell site simulators on an orbic mobile hotspot 
