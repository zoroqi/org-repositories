...
- [NVIDIA/cuda-samples](https://github.com/NVIDIA/cuda-samples) topic:cuda,cuda-driver-api,cuda-kernels,cuda-opengl pushed_at:2025-08 star:8.0k fork:2.1k Samples for CUDA Developers which demonstrates features in CUDA Toolkit
...
- [NVIDIA/edk2](https://github.com/NVIDIA/edk2) topic: pushed_at:2025-08 star:0.0k fork:0.0k NVIDIA fork of tianocore/edk2
...
- [NVIDIA/edk2-platforms](https://github.com/NVIDIA/edk2-platforms) topic: pushed_at:2025-08 star:0.0k fork:0.0k NVIDIA fork of tianocore/edk2-platforms
- [NVIDIA/edk2-redfish-client](https://github.com/NVIDIA/edk2-redfish-client) topic: pushed_at:2025-08 star:0.0k fork:0.0k NVIDIA fork of tianocore/edk2-redfish-client
...
- [NVIDIA/go-nvml](https://github.com/NVIDIA/go-nvml) topic: pushed_at:2025-08 star:0.4k fork:0.1k Go Bindings for the NVIDIA Management Library (NVML)
...
- [NVIDIA/linux](https://github.com/NVIDIA/linux) topic: pushed_at:2025-08 star:0.0k fork:0.0k OpenBMC Linux kernel source tree
...
- [NVIDIA/NV-Kernels](https://github.com/NVIDIA/NV-Kernels) topic: pushed_at:2025-08 star:0.1k fork:0.0k Ubuntu kernels which are optimized for NVIDIA server systems
- [NVIDIA/nvapi](https://github.com/NVIDIA/nvapi) topic: pushed_at:2025-08 star:0.1k fork:0.0k NVAPI is NVIDIA's core software development kit that allows direct access to NVIDIA GPUs and drivers on supported platforms.
- [NVIDIA/nvgpu](https://github.com/NVIDIA/nvgpu) topic: pushed_at:2014-11 star:0.0k fork:0.0k 
- [NVIDIA/nvidia-installer](https://github.com/NVIDIA/nvidia-installer) topic: pushed_at:2025-08 star:0.1k fork:0.0k NVIDIA driver installer
- [NVIDIA/nvidia-modprobe](https://github.com/NVIDIA/nvidia-modprobe) topic: pushed_at:2025-08 star:0.1k fork:0.0k Load the NVIDIA kernel module and create NVIDIA character device files
- [NVIDIA/nvidia-persistenced](https://github.com/NVIDIA/nvidia-persistenced) topic: pushed_at:2025-08 star:0.1k fork:0.0k NVIDIA driver persistence daemon
...
- [NVIDIA/nvidia-settings](https://github.com/NVIDIA/nvidia-settings) topic: pushed_at:2025-08 star:0.3k fork:0.1k NVIDIA driver control panel
- [NVIDIA/nvidia-xconfig](https://github.com/NVIDIA/nvidia-xconfig) topic: pushed_at:2025-08 star:0.0k fork:0.0k NVIDIA xorg.conf configurator
...
- [NVIDIA/open-gpu-kernel-modules](https://github.com/NVIDIA/open-gpu-kernel-modules) topic: pushed_at:2025-08 star:16.1k fork:1.5k NVIDIA Linux open GPU kernel module source
...
- [NVIDIA/bmcweb](https://github.com/NVIDIA/bmcweb) topic: pushed_at:2025-08 star:0.0k fork:0.0k A do everything Redfish, KVM, GUI, and DBus webserver for OpenBMC
...
- [NVIDIA/cccl](https://github.com/NVIDIA/cccl) topic:accelerated-computing,cpp,cpp-programming,cuda,cuda-cpp,cuda-kernels,cuda-library,cuda-programming,gpu,gpu-acceleration,gpu-computing,gpu-programming,hpc,modern-cpp,nvidia,nvidia-gpu,parallel-algorithm,parallel-computing,parallel-programming pushed_at:2025-08 star:1.9k fork:0.3k CUDA Core Compute Libraries
...
- [NVIDIA/cudaqx](https://github.com/NVIDIA/cudaqx) topic: pushed_at:2025-08 star:0.1k fork:0.0k Accelerated libraries for quantum-classical computing built on CUDA-Q.  
- [NVIDIA/cuDecomp](https://github.com/NVIDIA/cuDecomp) topic:fft,pencil-decomposition pushed_at:2025-08 star:0.1k fork:0.0k An Adaptive Pencil Decomposition Library for NVIDIA GPUs
- [NVIDIA/cudnn-frontend](https://github.com/NVIDIA/cudnn-frontend) topic: pushed_at:2025-08 star:0.6k fork:0.1k cudnn_frontend provides a c++ wrapper for the cudnn backend API and samples on how to use it
...
- [NVIDIA/DALI](https://github.com/NVIDIA/DALI) topic:audio-processing,data-augmentation,data-processing,deep-learning,fast-data-pipeline,gpu,gpu-tensorflow,image-augmentation,image-processing,machine-learning,mxnet,neural-network,paddle,python,pytorch pushed_at:2025-08 star:5.5k fork:0.6k A GPU-accelerated library containing highly optimized building blocks and an execution engine for data processing to accelerate deep learning training and inference applications.
...
- [NVIDIA/jitify](https://github.com/NVIDIA/jitify) topic:cpp,cuda,jit-compilation,nvrtc,runtime-compilation,single-header pushed_at:2025-08 star:0.6k fork:0.1k A single-header C++ library for simplifying the use of CUDA Runtime Compilation (NVRTC).
...
- [NVIDIA/MatX](https://github.com/NVIDIA/MatX) topic:cuda,gpgpu,gpu,gpu-computing,hpc pushed_at:2025-08 star:1.3k fork:0.1k An efficient C++17 GPU numerical computing library with Python-like syntax
...
- [NVIDIA/nccl](https://github.com/NVIDIA/nccl) topic: pushed_at:2025-08 star:3.9k fork:1.0k Optimized primitives for collective multi-GPU communication
- [NVIDIA/nsmd](https://github.com/NVIDIA/nsmd) topic: pushed_at:2025-08 star:0.0k fork:0.0k MCTP VDM-based Nvidia System Management API
...
- [NVIDIA/nvidia-monitor-eventing](https://github.com/NVIDIA/nvidia-monitor-eventing) topic: pushed_at:2025-08 star:0.0k fork:0.0k Monitor and react to platform events
- [NVIDIA/nvidia-nvme-manager](https://github.com/NVIDIA/nvidia-nvme-manager) topic: pushed_at:2025-08 star:0.0k fork:0.0k Manage NVME drives via MCTP
...
- [NVIDIA/phosphor-debug-collector](https://github.com/NVIDIA/phosphor-debug-collector) topic: pushed_at:2025-08 star:0.0k fork:0.0k Collects debug data from the BMC for extraction.
...
- [NVIDIA/phosphor-net-ipmid](https://github.com/NVIDIA/phosphor-net-ipmid) topic: pushed_at:2025-08 star:0.0k fork:0.0k Network IPMI server
...
- [NVIDIA/pldm](https://github.com/NVIDIA/pldm) topic: pushed_at:2025-08 star:0.0k fork:0.0k 
...
- [NVIDIA/spdm](https://github.com/NVIDIA/spdm) topic: pushed_at:2025-08 star:0.0k fork:0.0k Implementation of the SPDM protocol
...
- [NVIDIA/stdexec](https://github.com/NVIDIA/stdexec) topic: pushed_at:2025-08 star:2.0k fork:0.2k `std::execution`, the proposed C++ framework for asynchronous and parallel programming.
...
- [NVIDIA/TensorRT](https://github.com/NVIDIA/TensorRT) topic:deep-learning,gpu-acceleration,inference,nvidia,tensorrt pushed_at:2025-08 star:12.0k fork:2.2k NVIDIA® TensorRT™ is an SDK for high-performance deep learning inference on NVIDIA GPUs. This repository contains the open source components of TensorRT.
...
- [NVIDIA/TensorRT-LLM](https://github.com/NVIDIA/TensorRT-LLM) topic:blackwell,cuda,llm-serving,moe,pytorch pushed_at:2025-08 star:11.3k fork:1.7k TensorRT-LLM provides users with an easy-to-use Python API to define Large Language Models (LLMs) and support state-of-the-art optimizations to perform inference efficiently on NVIDIA GPUs. TensorRT-LLM also contains components to create Python and C++ runtimes that orchestrate the inference execution in performant way.
...
- [NVIDIA/VisRTX](https://github.com/NVIDIA/VisRTX) topic: pushed_at:2025-08 star:0.3k fork:0.0k NVIDIA OptiX based implementation of ANARI
...
- [NVIDIA/CUDALibrarySamples](https://github.com/NVIDIA/CUDALibrarySamples) topic:cuda,cudss,cufft,curand,cusolver,cusparse,cutenros,gpu,linear-algebra,mathdx,nppcublas,nvcomp,nvjpeg,nvjpeg2000,nvtiff pushed_at:2025-08 star:2.1k fork:0.4k CUDA Library Samples
...
- [NVIDIA/cuopt](https://github.com/NVIDIA/cuopt) topic:cuda,gpu,linear-programming,optimization pushed_at:2025-08 star:0.4k fork:0.1k GPU accelerated decision optimization 
...
- [NVIDIA/nvbench](https://github.com/NVIDIA/nvbench) topic:benchmark,cuda,cuda-kernels,gpu,kernel-benchmark,nvidia,performance pushed_at:2025-08 star:0.7k fork:0.1k CUDA Kernel Benchmarking Library
...
- [NVIDIA/spark-rapids-jni](https://github.com/NVIDIA/spark-rapids-jni) topic: pushed_at:2025-08 star:0.0k fork:0.1k RAPIDS Accelerator JNI For Apache Spark
...
- [NVIDIA/k8s-samples](https://github.com/NVIDIA/k8s-samples) topic: pushed_at:2025-08 star:0.0k fork:0.0k Sample Dockerfiles for Docker Hub images
...
- [NVIDIA/ais-k8s](https://github.com/NVIDIA/ais-k8s) topic: pushed_at:2025-08 star:0.1k fork:0.0k Kubernetes Operator, ansible playbooks, and production scripts for large-scale AIStore deployments on Kubernetes.
...
- [NVIDIA/dcgm-exporter](https://github.com/NVIDIA/dcgm-exporter) topic: pushed_at:2025-08 star:1.3k fork:0.2k NVIDIA GPU metrics exporter for Prometheus leveraging DCGM
- [NVIDIA/doca-platform](https://github.com/NVIDIA/doca-platform) topic: pushed_at:2025-08 star:0.0k fork:0.0k DOCA Platform manages provisioning and service orchestration for Bluefield DPUs
...
- [NVIDIA/go-gpuallocator](https://github.com/NVIDIA/go-gpuallocator) topic: pushed_at:2025-08 star:0.1k fork:0.0k Go Abstraction for Allocating NVIDIA GPUs with Custom Policies
- [NVIDIA/go-nvlib](https://github.com/NVIDIA/go-nvlib) topic: pushed_at:2025-08 star:0.0k fork:0.0k A collection of useful Go libraries for use with NVIDIA GPU management tools
...
- [NVIDIA/k8s-device-plugin](https://github.com/NVIDIA/k8s-device-plugin) topic:kubernetes pushed_at:2025-08 star:3.4k fork:0.7k NVIDIA device plugin for Kubernetes
- [NVIDIA/k8s-dra-driver-gpu](https://github.com/NVIDIA/k8s-dra-driver-gpu) topic: pushed_at:2025-08 star:0.4k fork:0.1k NVIDIA DRA Driver for GPUs
- [NVIDIA/k8s-kata-manager](https://github.com/NVIDIA/k8s-kata-manager) topic: pushed_at:2025-08 star:0.0k fork:0.0k 
- [NVIDIA/k8s-nim-operator](https://github.com/NVIDIA/k8s-nim-operator) topic: pushed_at:2025-08 star:0.1k fork:0.0k An Operator for deployment and maintenance of NVIDIA NIMs and NeMo microservices in a Kubernetes environment.
- [NVIDIA/k8s-operator-libs](https://github.com/NVIDIA/k8s-operator-libs) topic: pushed_at:2025-08 star:0.0k fork:0.0k A collection of useful Go libraries to ease the development of NVIDIA Operators for GPU/NIC management.
- [NVIDIA/k8s-test-infra](https://github.com/NVIDIA/k8s-test-infra) topic: pushed_at:2025-08 star:0.0k fork:0.0k K8s-test-infra
- [NVIDIA/KAI-Scheduler](https://github.com/NVIDIA/KAI-Scheduler) topic: pushed_at:2025-08 star:0.7k fork:0.1k KAI Scheduler is an open source Kubernetes Native scheduler for AI workloads at large scale
...
- [NVIDIA/kubectl-nv](https://github.com/NVIDIA/kubectl-nv) topic: pushed_at:2025-08 star:0.0k fork:0.0k Kubectl NV plugin, a tool for managing NVIDIA objects on a kubernetes cluster. 
- [NVIDIA/kubevirt-gpu-device-plugin](https://github.com/NVIDIA/kubevirt-gpu-device-plugin) topic: pushed_at:2025-08 star:0.3k fork:0.1k NVIDIA k8s device plugin for Kubevirt
...
- [NVIDIA/nvidia-container-toolkit](https://github.com/NVIDIA/nvidia-container-toolkit) topic: pushed_at:2025-08 star:3.6k fork:0.4k Build and run containers leveraging NVIDIA GPUs
...
- [NVIDIA/skyhook](https://github.com/NVIDIA/skyhook) topic: pushed_at:2025-08 star:0.0k fork:0.0k A Kubernetes Operator to manage Node OS customizations.
...
- [NVIDIA/terraform-provider-ngc](https://github.com/NVIDIA/terraform-provider-ngc) topic: pushed_at:2025-08 star:0.0k fork:0.0k The NGC Provider enables Terraform to manage NGC (NVIDIA GPU Cloud) resources.
...
- [NVIDIA/topograph](https://github.com/NVIDIA/topograph) topic: pushed_at:2025-08 star:0.1k fork:0.0k A toolkit for discovering cluster network topology.
...
- [NVIDIA/vgpu-device-manager](https://github.com/NVIDIA/vgpu-device-manager) topic: pushed_at:2025-08 star:0.1k fork:0.0k NVIDIA vGPU Device Manager manages NVIDIA vGPU devices on top of Kubernetes
...
- [NVIDIA/accelerated-computing-hub](https://github.com/NVIDIA/accelerated-computing-hub) topic: pushed_at:2025-08 star:0.6k fork:0.1k NVIDIA curated collection of educational resources related to general purpose GPU programming.
...
- [NVIDIA/cuda-q-academic](https://github.com/NVIDIA/cuda-q-academic) topic: pushed_at:2025-08 star:0.2k fork:0.0k This repo contains CUDA-Q Academic materials, including self-paced Jupyter notebook modules for building and optimizing hybrid quantum-classical algorithms using CUDA-Q.
- [NVIDIA/cuopt-examples](https://github.com/NVIDIA/cuopt-examples) topic:combinatorial-optimization,gpu,linear-programming,mixed-integer-programming,operations-research,optimization,optimization-algorithms,route-optimization,traveling-salesman-problem,vehicle-routing-problem pushed_at:2025-07 star:0.4k fork:0.1k NVIDIA cuOpt examples for decision optimization
...
- [NVIDIA/GenerativeAIExamples](https://github.com/NVIDIA/GenerativeAIExamples) topic:gpu-acceleration,large-language-models,llm,llm-inference,microservice,nemo,rag,retrieval-augmented-generation,tensorrt,triton-inference-server pushed_at:2025-08 star:3.3k fork:0.8k Generative AI reference workflows optimized for accelerated infrastructure and microservice architecture.
...
- [NVIDIA/Isaac-GR00T](https://github.com/NVIDIA/Isaac-GR00T) topic: pushed_at:2025-08 star:4.7k fork:0.7k NVIDIA Isaac GR00T N1.5 is the world's first open foundation model for generalized humanoid robot reasoning and skills.
...
- [NVIDIA/nim-deploy](https://github.com/NVIDIA/nim-deploy) topic: pushed_at:2025-08 star:0.2k fork:0.1k A collection of YAML files, Helm Charts, Operator code, and guides to act as an example reference implementation for NVIDIA NIM deployment.
...
- [NVIDIA/spark-rapids-examples](https://github.com/NVIDIA/spark-rapids-examples) topic: pushed_at:2025-08 star:0.2k fork:0.1k A repo for all spark examples using Rapids Accelerator including ETL, ML/DL, etc.
- [NVIDIA/spark-rapids-ml](https://github.com/NVIDIA/spark-rapids-ml) topic: pushed_at:2025-08 star:0.1k fork:0.0k Spark RAPIDS MLlib – accelerate Apache Spark MLlib with GPUs
...
- [NVIDIA/tao_tutorials](https://github.com/NVIDIA/tao_tutorials) topic: pushed_at:2025-08 star:0.1k fork:0.0k Quick start scripts and tutorial notebooks to get started with TAO Toolkit
...
- [NVIDIA/phosphor-dbus-interfaces](https://github.com/NVIDIA/phosphor-dbus-interfaces) topic: pushed_at:2025-08 star:0.0k fork:0.0k YAML descriptors of standard dbus interfaces
...
- [NVIDIA/audio-flamingo](https://github.com/NVIDIA/audio-flamingo) topic:audio-captioning,audio-language-models,audio-question-answering,audio-reasoning,multimodal-large-language-models pushed_at:2025-08 star:0.7k fork:0.0k PyTorch implementation of Audio Flamingo: Series of Advanced Audio Understanding Language Models
- [NVIDIA/bionemo-examples](https://github.com/NVIDIA/bionemo-examples) topic: pushed_at:2025-08 star:0.2k fork:0.0k BioNeMo NIMs example notebooks: for optimized inference at scale
...
- [NVIDIA/TensorRT-RTX](https://github.com/NVIDIA/TensorRT-RTX) topic: pushed_at:2025-08 star:0.0k fork:0.0k NVIDIA TensorRT-RTX is an SDK for high-performance AI inference on NVIDIA RTX GPUs. This repository contains Open-Source Software components of TensorRT-RTX.
- [NVIDIA/Trustworthy-AI](https://github.com/NVIDIA/Trustworthy-AI) topic: pushed_at:2025-08 star:0.0k fork:0.0k NVIDIA’s repository for enabling trustworthy AI.
...
- [NVIDIA/cloud-native-docs](https://github.com/NVIDIA/cloud-native-docs) topic:containers,kubernetes,kubernetes-operator pushed_at:2025-08 star:0.0k fork:0.0k Documentation repository for NVIDIA Cloud Native Technologies
...
- [NVIDIA/ace-controller](https://github.com/NVIDIA/ace-controller) topic: pushed_at:2025-08 star:0.0k fork:0.0k Pipecat framework based orchestrator for building real-time, voice-enabled, and multimodal conversational AI agents
...
- [NVIDIA/apex](https://github.com/NVIDIA/apex) topic: pushed_at:2025-08 star:8.8k fork:1.5k A PyTorch Extension:  Tools for easy mixed precision and distributed training in Pytorch
...
- [NVIDIA/cloudai](https://github.com/NVIDIA/cloudai) topic: pushed_at:2025-08 star:0.1k fork:0.0k CloudAI Benchmark Framework
...
- [NVIDIA/cuda-python](https://github.com/NVIDIA/cuda-python) topic: pushed_at:2025-08 star:2.9k fork:0.2k CUDA Python: Performance meets Productivity
- [NVIDIA/cuEquivariance](https://github.com/NVIDIA/cuEquivariance) topic: pushed_at:2025-08 star:0.3k fork:0.0k cuEquivariance is a math library that is a collective of low-level primitives and tensor ops to accelerate widely-used models, like DiffDock, MACE, Allegro and NEQUIP, based on equivariant neural networks. 
...
- [NVIDIA/diffusion-audio-restoration](https://github.com/NVIDIA/diffusion-audio-restoration) topic: pushed_at:2025-08 star:0.0k fork:0.0k Audio-to-Audio Schrodinger Bridges is a diffusion-based audio restoration model for bandwidth extension and inpainting. 
...
- [NVIDIA/earth2studio](https://github.com/NVIDIA/earth2studio) topic:ai,climate-science,deep-learning,weather pushed_at:2025-08 star:0.2k fork:0.1k Open-source deep-learning framework for exploring, building and deploying AI weather/climate workflows.
...
- [NVIDIA/garak](https://github.com/NVIDIA/garak) topic:ai,llm-evaluation,llm-security,security-scanners,vulnerability-assessment pushed_at:2025-08 star:5.0k fork:0.5k the LLM vulnerability scanner
...
- [NVIDIA/kvpress](https://github.com/NVIDIA/kvpress) topic:inference,kv-cache,kv-cache-compression,large-language-models,llm,long-context,python,pytorch,transformers pushed_at:2025-08 star:0.6k fork:0.1k LLM KV cache compression made easy
...
- [NVIDIA/makani](https://github.com/NVIDIA/makani) topic: pushed_at:2025-08 star:0.3k fork:0.1k Massively parallel training of machine-learning based weather and climate models
...
- [NVIDIA/Megatron-Energon](https://github.com/NVIDIA/Megatron-Energon) topic: pushed_at:2025-08 star:0.2k fork:0.0k Megatron's multi-modal data loader
- [NVIDIA/Megatron-LM](https://github.com/NVIDIA/Megatron-LM) topic:large-language-models,model-para,transformers pushed_at:2025-08 star:13.2k fork:3.0k Ongoing research training transformer models at scale
...
- [NVIDIA/NeMo](https://github.com/NVIDIA/NeMo) topic:asr,deeplearning,generative-ai,large-language-models,machine-translation,multimodal,neural-networks,speaker-diariazation,speaker-recognition,speech-synthesis,speech-translation,tts pushed_at:2025-08 star:15.4k fork:3.0k A scalable generative AI framework built for researchers and developers working on Large Language Models, Multimodal, and Speech AI (Automatic Speech Recognition and Text-to-Speech)
...
- [NVIDIA/NeMo-Guardrails](https://github.com/NVIDIA/NeMo-Guardrails) topic: pushed_at:2025-08 star:5.0k fork:0.5k NeMo Guardrails is an open-source toolkit for easily adding programmable guardrails to LLM-based conversational systems.
...
- [NVIDIA/NeMo-speech-data-processor](https://github.com/NVIDIA/NeMo-speech-data-processor) topic: pushed_at:2025-08 star:0.1k fork:0.0k A toolkit for processing speech data and creating speech datasets
- [NVIDIA/NeMo-text-processing](https://github.com/NVIDIA/NeMo-text-processing) topic:inverse-text-n,text-normalization pushed_at:2025-08 star:0.4k fork:0.1k NeMo text processing for ASR and TTS
...
- [NVIDIA/numba-cuda](https://github.com/NVIDIA/numba-cuda) topic: pushed_at:2025-08 star:0.2k fork:0.0k The CUDA target for Numba
- [NVIDIA/numbast](https://github.com/NVIDIA/numbast) topic:cuda,numba pushed_at:2025-08 star:0.1k fork:0.0k Numbast is a tool to build an automated pipeline that converts CUDA APIs into Numba bindings.
...
- [NVIDIA/nv-ingest](https://github.com/NVIDIA/nv-ingest) topic: pushed_at:2025-08 star:2.7k fork:0.3k NeMo Retriever extraction is a scalable, performance-oriented document content and metadata extraction microservice. NeMo Retriever extraction uses specialized NVIDIA NIM microservices to find, contextualize, and extract text, tables, charts and images that you can use in downstream generative applications.
- [NVIDIA/nvaitc-aps-project-demos](https://github.com/NVIDIA/nvaitc-aps-project-demos) topic: pushed_at:2025-08 star:0.0k fork:0.0k Clear, runnable demos of projects that apply NVIDIA technology to real research and industry needs. It showcases collaborative projects with educational institutions and partners, providing one place to browse, clone, and reuse working examples.
- [NVIDIA/NVFlare](https://github.com/NVIDIA/NVFlare) topic:decentralized,federated-analytics,federated-computing,federated-learning,pet,privacy-protection,python pushed_at:2025-08 star:0.8k fork:0.2k NVIDIA Federated Learning Application Runtime Environment
- [NVIDIA/nvidia-dlfw-inspect](https://github.com/NVIDIA/nvidia-dlfw-inspect) topic: pushed_at:2025-08 star:0.0k fork:0.0k The tool facilitates debugging convergence issues and testing new algorithms and recipes for training LLMs using Nvidia libraries such as Transformer Engine, Megatron-LM, and NeMo.
- [NVIDIA/nvidia-resiliency-ext](https://github.com/NVIDIA/nvidia-resiliency-ext) topic: pushed_at:2025-08 star:0.2k fork:0.0k NVIDIA Resiliency Extension is a python package for framework developers and users to implement fault-tolerant features. It improves the effective training time by minimizing the downtime due to failures and interruptions.
...
- [NVIDIA/nvtrust](https://github.com/NVIDIA/nvtrust) topic: pushed_at:2025-08 star:0.3k fork:0.0k Ancillary open source software to support confidential computing on NVIDIA GPUs
...
- [NVIDIA/physicsnemo](https://github.com/NVIDIA/physicsnemo) topic:deep-learning,machine-learning,nvidia-gpu,physics,pytorch pushed_at:2025-08 star:1.8k fork:0.4k Open-source deep-learning framework for building, training, and fine-tuning deep learning models using state-of-the-art Physics-ML methods
- [NVIDIA/physicsnemo-curator](https://github.com/NVIDIA/physicsnemo-curator) topic: pushed_at:2025-08 star:0.0k fork:0.0k PhysicsNeMo-Curator is a Python-based library designed to streamline and accelerate the process of data curation for engineering datasets. 
- [NVIDIA/physicsnemo-sym](https://github.com/NVIDIA/physicsnemo-sym) topic:deep-learning,machine-learning,nvidia-gpu,physics,pytorch pushed_at:2025-08 star:0.3k fork:0.1k Framework providing pythonic APIs, algorithms and utilities to be used with PhysicsNeMo core to physics inform model training as well as higher level abstraction for domain experts
...
- [NVIDIA/spark-rapids-benchmarks](https://github.com/NVIDIA/spark-rapids-benchmarks) topic: pushed_at:2025-08 star:0.0k fork:0.0k Spark RAPIDS Benchmarks – benchmark sets and utilities for the RAPIDS Accelerator for Apache Spark
...
- [NVIDIA/swift](https://github.com/NVIDIA/swift) topic: pushed_at:2025-08 star:0.0k fork:0.0k OpenStack Storage (Swift). Mirror of code maintained at opendev.org.
...
- [NVIDIA/tao_dataset_suite](https://github.com/NVIDIA/tao_dataset_suite) topic: pushed_at:2025-08 star:0.0k fork:0.0k Set of advanced data augmentation and analytics tools
...
- [NVIDIA/tao_pytorch_backend](https://github.com/NVIDIA/tao_pytorch_backend) topic: pushed_at:2025-08 star:0.1k fork:0.0k TAO Toolkit deep learning networks with PyTorch backend
...
- [NVIDIA/TensorRT-Model-Optimizer](https://github.com/NVIDIA/TensorRT-Model-Optimizer) topic: pushed_at:2025-08 star:1.1k fork:0.1k A unified library of state-of-the-art model optimization techniques like quantization, pruning, distillation, speculative decoding, etc. It compresses deep learning models for downstream deployment frameworks like TensorRT-LLM or TensorRT to optimize inference speed.
- [NVIDIA/tilus](https://github.com/NVIDIA/tilus) topic: pushed_at:2025-08 star:0.1k fork:0.0k Tilus is a tile-level kernel programming language, implemented in Python.
...
- [NVIDIA/warp](https://github.com/NVIDIA/warp) topic:cuda,differentiable-programming,gpu,gpu-acceleration,nvidia,nvidia-warp,python pushed_at:2025-08 star:5.4k fork:0.3k A Python framework for accelerated simulation, data generation and spatial computing.
...
- [NVIDIA/nvrc](https://github.com/NVIDIA/nvrc) topic: pushed_at:2025-08 star:0.0k fork:0.0k The NVRC project provides a Rust binary that implements a simple init system for microVMs.
...
- [NVIDIA/spark-rapids-tools](https://github.com/NVIDIA/spark-rapids-tools) topic: pushed_at:2025-08 star:0.1k fork:0.0k User tools for Spark RAPIDS
...
- [NVIDIA/DALI_deps](https://github.com/NVIDIA/DALI_deps) topic: pushed_at:2025-08 star:0.0k fork:0.0k 3rd party dependencies for DALI project
...
- [NVIDIA/enroot](https://github.com/NVIDIA/enroot) topic: pushed_at:2025-08 star:0.8k fork:0.1k A simple yet powerful tool to turn traditional container/OS images into unprivileged sandboxes.
- [NVIDIA/gpu-driver-container](https://github.com/NVIDIA/gpu-driver-container) topic: pushed_at:2025-08 star:0.1k fork:0.1k The NVIDIA GPU driver container allows the provisioning of the NVIDIA driver through the use of containers.
...
- [NVIDIA/k8s-driver-manager](https://github.com/NVIDIA/k8s-driver-manager) topic: pushed_at:2025-08 star:0.0k fork:0.0k The NVIDIA Driver Manager is a Kubernetes component which assist in seamless upgrades of NVIDIA Driver on each node of the cluster. 
...
- [NVIDIA/NeMo-Agent-Toolkit-UI](https://github.com/NVIDIA/NeMo-Agent-Toolkit-UI) topic: pushed_at:2025-08 star:0.0k fork:0.0k The NVIDIA AIQToolkit UI streamlines interacting with AIQToolkit workflows in an easy-to-use web application.
...
- [NVIDIA/webui-vue](https://github.com/NVIDIA/webui-vue) topic: pushed_at:2025-08 star:0.0k fork:0.0k Web-based user interface built on Vue.js for managing OpenBMC systems
