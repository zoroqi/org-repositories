...
- [NVIDIA/edk2-non-osi](https://github.com/NVIDIA/edk2-non-osi) topic: pushed_at:2025-09 star:0.0k fork:0.0k NVIDIA fork of tianocore/edk2-non-osi
...
- [NVIDIA/openbmc](https://github.com/NVIDIA/openbmc) topic: pushed_at:2025-09 star:0.0k fork:0.0k OpenBMC Distribution
...
- [NVIDIA/cuda-samples](https://github.com/NVIDIA/cuda-samples) topic:cuda,cuda-driver-api,cuda-kernels,cuda-opengl pushed_at:2025-09 star:8.2k fork:2.1k Samples for CUDA Developers which demonstrates features in CUDA Toolkit
...
- [NVIDIA/edk2-nvidia](https://github.com/NVIDIA/edk2-nvidia) topic: pushed_at:2025-09 star:0.1k fork:0.0k NVIDIA EDK2 platform support
...
- [NVIDIA/go-dcgm](https://github.com/NVIDIA/go-dcgm) topic: pushed_at:2025-09 star:0.1k fork:0.0k Golang bindings for Nvidia Datacenter GPU Manager (DCGM)
...
- [NVIDIA/libmctp](https://github.com/NVIDIA/libmctp) topic: pushed_at:2025-09 star:0.0k fork:0.0k 
- [NVIDIA/libnvidia-container](https://github.com/NVIDIA/libnvidia-container) topic: pushed_at:2025-09 star:1.0k fork:0.2k NVIDIA container runtime library
...
- [NVIDIA/pyxis](https://github.com/NVIDIA/pyxis) topic: pushed_at:2025-09 star:0.4k fork:0.0k Container plugin for Slurm Workload Manager
...
- [NVIDIA/Audio2Face-3D-SDK](https://github.com/NVIDIA/Audio2Face-3D-SDK) topic:cuda,gpu-acceleration,nvidia,tensorrt pushed_at:2025-08 star:0.0k fork:0.0k High-performance C++/CUDA SDK for running Audio2Emotion and Audio2Face inference with integrated post-processing.
...
- [NVIDIA/bmcweb](https://github.com/NVIDIA/bmcweb) topic: pushed_at:2025-09 star:0.0k fork:0.0k A do everything Redfish, KVM, GUI, and DBus webserver for OpenBMC
...
- [NVIDIA/cccl](https://github.com/NVIDIA/cccl) topic:accelerated-computing,cpp,cpp-programming,cuda,cuda-cpp,cuda-kernels,cuda-library,cuda-programming,gpu,gpu-acceleration,gpu-computing,gpu-programming,hpc,modern-cpp,nvidia,nvidia-gpu,parallel-algorithm,parallel-computing,parallel-programming pushed_at:2025-10 star:1.9k fork:0.3k CUDA Core Compute Libraries
...
- [NVIDIA/cutlass](https://github.com/NVIDIA/cutlass) topic:cpp,cuda,deep-learning,deep-learning-library,gpu,nvidia pushed_at:2025-09 star:8.5k fork:1.5k CUDA Templates for Linear Algebra Subroutines
- [NVIDIA/DALI](https://github.com/NVIDIA/DALI) topic:audio-processing,data-augmentation,data-processing,deep-learning,fast-data-pipeline,gpu,gpu-tensorflow,image-augmentation,image-processing,machine-learning,mxnet,neural-network,paddle,python,pytorch pushed_at:2025-09 star:5.5k fork:0.7k A GPU-accelerated library containing highly optimized building blocks and an execution engine for data processing to accelerate deep learning training and inference applications.
...
- [NVIDIA/dbus-sensors](https://github.com/NVIDIA/dbus-sensors) topic: pushed_at:2025-09 star:0.0k fork:0.0k D-Bus configurable sensor scanning applications
...
- [NVIDIA/nvidia-code-mgmt](https://github.com/NVIDIA/nvidia-code-mgmt) topic: pushed_at:2025-09 star:0.0k fork:0.0k Non-PLDM firmware update infrastructure
...
- [NVIDIA/phosphor-host-postd](https://github.com/NVIDIA/phosphor-host-postd) topic: pushed_at:2025-09 star:0.0k fork:0.0k 
...
- [NVIDIA/cuopt](https://github.com/NVIDIA/cuopt) topic:cuda,gpu,linear-programming,optimization pushed_at:2025-10 star:0.4k fork:0.1k GPU accelerated decision optimization 
...
- [NVIDIA/grove](https://github.com/NVIDIA/grove) topic:agentic,auto-scaling,auto-scaling-group,disaggregated,gang-scheduling,gpu,grove,inference,kubernetes,leader-worker,multinode,operator,role-based,topology-aware-scheduling pushed_at:2025-09 star:0.1k fork:0.0k Kubernetes enhancements for Network Topology Aware Gang Scheduling & Autoscaling
...
- [NVIDIA/k8s-dra-driver-gpu](https://github.com/NVIDIA/k8s-dra-driver-gpu) topic: pushed_at:2025-09 star:0.5k fork:0.1k NVIDIA DRA Driver for GPUs
...
- [NVIDIA/k8s-operator-libs](https://github.com/NVIDIA/k8s-operator-libs) topic: pushed_at:2025-09 star:0.0k fork:0.0k A collection of useful Go libraries to ease the development of NVIDIA Operators for GPU/NIC management.
...
- [NVIDIA/accelerated-computing-hub](https://github.com/NVIDIA/accelerated-computing-hub) topic: pushed_at:2025-09 star:0.7k fork:0.1k NVIDIA curated collection of educational resources related to general purpose GPU programming.
...
- [NVIDIA/Isaac-GR00T](https://github.com/NVIDIA/Isaac-GR00T) topic: pushed_at:2025-09 star:5.0k fork:0.8k NVIDIA Isaac GR00T N1.5 is the world's first open foundation model for generalized humanoid robot reasoning and skills.
...
- [NVIDIA/cloud-native-stack](https://github.com/NVIDIA/cloud-native-stack) topic: pushed_at:2025-09 star:0.2k fork:0.1k Run cloud native workloads on NVIDIA GPUs

## Meson

- [NVIDIA/phosphor-dbus-interfaces](https://github.com/NVIDIA/phosphor-dbus-interfaces) topic: pushed_at:2025-09 star:0.0k fork:0.0k YAML descriptors of standard dbus interfaces
...
- [NVIDIA/Audio2Face-3D-Training-Framework](https://github.com/NVIDIA/Audio2Face-3D-Training-Framework) topic: pushed_at:2025-09 star:0.0k fork:0.0k Audio2Face-3D Training Framework for creating custom neural networks that generate realistic facial animations from audio input
...
- [NVIDIA/doca-sosreport](https://github.com/NVIDIA/doca-sosreport) topic: pushed_at:2025-09 star:0.0k fork:0.0k A unified tool for collecting system logs and other debug information
...
- [NVIDIA/elucidated-audio-intelligence](https://github.com/NVIDIA/elucidated-audio-intelligence) topic: pushed_at:2025-06 star:0.1k fork:0.0k Elucidated Text-To-Audio (ETTA) is a SOTA text-to-audio model with a holistic understanding of the design space and trained with synthetic captions.
...
- [NVIDIA/garak](https://github.com/NVIDIA/garak) topic:ai,llm-evaluation,llm-security,security-scanners,vulnerability-assessment pushed_at:2025-09 star:6.1k fork:0.6k the LLM vulnerability scanner
...
- [NVIDIA/hpc-container-maker](https://github.com/NVIDIA/hpc-container-maker) topic:containers,docker,hpc,singularity pushed_at:2025-09 star:0.5k fork:0.1k HPC Container Maker
- [NVIDIA/image-captioner](https://github.com/NVIDIA/image-captioner) topic: pushed_at:2025-09 star:0.0k fork:0.0k A tool for captioning, visualizing and analyzing image datasets
...
- [NVIDIA/Megatron-LM](https://github.com/NVIDIA/Megatron-LM) topic:large-language-models,model-para,transformers pushed_at:2025-10 star:13.7k fork:3.1k Ongoing research training transformer models at scale
...
- [NVIDIA/mitten](https://github.com/NVIDIA/mitten) topic: pushed_at:2025-09 star:0.0k fork:0.0k Mitten is NVIDIA's framework for our MLPerf Inference code submissions.
...
- [NVIDIA/multi-storage-client](https://github.com/NVIDIA/multi-storage-client) topic: pushed_at:2025-09 star:0.0k fork:0.0k Unified high-performance Python client for object and file stores.
...
- [NVIDIA/NeMo-Skills](https://github.com/NVIDIA/NeMo-Skills) topic: pushed_at:2025-10 star:0.6k fork:0.1k A project to improve skills of large language models
...
- [NVIDIA/NeMo-text-processing](https://github.com/NVIDIA/NeMo-text-processing) topic:inverse-text-n,text-normalization pushed_at:2025-09 star:0.4k fork:0.1k NeMo text processing for ASR and TTS
...
- [NVIDIA/nv-ingest](https://github.com/NVIDIA/nv-ingest) topic: pushed_at:2025-09 star:2.7k fork:0.3k NeMo Retriever extraction is a scalable, performance-oriented document content and metadata extraction microservice. NeMo Retriever extraction uses specialized NVIDIA NIM microservices to find, contextualize, and extract text, tables, charts and images that you can use in downstream generative applications.
- [NVIDIA/nv-one-logger](https://github.com/NVIDIA/nv-one-logger) topic: pushed_at:2025-09 star:0.0k fork:0.0k nv-one-logger enables tracking of GPU application progress over time and can help to identify overhead from workload and cluster inefficiencies to provide efficiency metrics.
- [NVIDIA/nvaitc-aps-project-demos](https://github.com/NVIDIA/nvaitc-aps-project-demos) topic: pushed_at:2025-09 star:0.0k fork:0.0k Clear, runnable demos of projects that apply NVIDIA technology to real research and industry needs. It showcases collaborative projects with educational institutions and partners, providing one place to browse, clone, and reuse working examples.
...
- [NVIDIA/nvidia-resiliency-ext](https://github.com/NVIDIA/nvidia-resiliency-ext) topic: pushed_at:2025-09 star:0.2k fork:0.0k NVIDIA Resiliency Extension is a python package for framework developers and users to implement fault-tolerant features. It improves the effective training time by minimizing the downtime due to failures and interruptions.
...
- [NVIDIA/nvtrust](https://github.com/NVIDIA/nvtrust) topic: pushed_at:2025-09 star:0.3k fork:0.0k Ancillary open source software to support confidential computing on NVIDIA GPUs
...
- [NVIDIA/physicsnemo](https://github.com/NVIDIA/physicsnemo) topic:deep-learning,machine-learning,nvidia-gpu,physics,pytorch pushed_at:2025-10 star:1.9k fork:0.4k Open-source deep-learning framework for building, training, and fine-tuning deep learning models using state-of-the-art Physics-ML methods
- [NVIDIA/physicsnemo-curator](https://github.com/NVIDIA/physicsnemo-curator) topic: pushed_at:2025-09 star:0.0k fork:0.0k PhysicsNeMo-Curator is a Python-based library designed to streamline and accelerate the process of data curation for engineering datasets. 
...
- [NVIDIA/recsys-examples](https://github.com/NVIDIA/recsys-examples) topic:generative-recommenders,pytorch,recommender-system,recommenders pushed_at:2025-09 star:0.1k fork:0.0k Examples for Recommenders - easy to train and deploy on accelerated infrastructure.
...
- [NVIDIA/swift](https://github.com/NVIDIA/swift) topic: pushed_at:2025-09 star:0.0k fork:0.0k OpenStack Storage (Swift). Mirror of code maintained at opendev.org.
...
- [NVIDIA/tilus](https://github.com/NVIDIA/tilus) topic:cuda,kernel,programming,tile pushed_at:2025-09 star:0.4k fork:0.0k Tilus is a tile-level kernel programming language with explicit control over shared memory and registers.
...
- [NVIDIA/warp](https://github.com/NVIDIA/warp) topic:cuda,differentiable-programming,gpu,gpu-acceleration,nvidia,nvidia-warp,python pushed_at:2025-10 star:5.6k fork:0.4k A Python framework for accelerated simulation, data generation and spatial computing.
...
- [NVIDIA/whetstone](https://github.com/NVIDIA/whetstone) topic: pushed_at:2025-09 star:0.0k fork:0.0k Whetstone: Adaptive Security Testing Framework for GenAI Applications
...
- [NVIDIA/kata-containers](https://github.com/NVIDIA/kata-containers) topic: pushed_at:2025-09 star:0.0k fork:0.0k Kata containers is an implementation of lightweight Virtual Machines (VMs) that feel and perform like containers, but provide the workload isolation and security advantages of VMs.
- [NVIDIA/nvrc](https://github.com/NVIDIA/nvrc) topic: pushed_at:2025-09 star:0.0k fork:0.0k The NVRC project provides a Rust binary that implements a simple init system for microVMs.
...
- [NVIDIA/spark-rapids-tools](https://github.com/NVIDIA/spark-rapids-tools) topic: pushed_at:2025-09 star:0.1k fork:0.0k User tools for Spark RAPIDS
...
- [NVIDIA/DALI_deps](https://github.com/NVIDIA/DALI_deps) topic: pushed_at:2025-09 star:0.0k fork:0.0k 3rd party dependencies for DALI project
...
- [NVIDIA/enroot](https://github.com/NVIDIA/enroot) topic: pushed_at:2025-09 star:0.8k fork:0.1k A simple yet powerful tool to turn traditional container/OS images into unprivileged sandboxes.
- [NVIDIA/gpu-driver-container](https://github.com/NVIDIA/gpu-driver-container) topic: pushed_at:2025-09 star:0.1k fork:0.1k The NVIDIA GPU driver container allows the provisioning of the NVIDIA driver through the use of containers.
