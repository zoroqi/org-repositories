...
- [NVIDIA/QEMU](https://github.com/NVIDIA/QEMU) topic: pushed_at:2025-08 star:0.0k fork:0.0k NVIDIA fork of QEMU
...
- [NVIDIA/cutlass](https://github.com/NVIDIA/cutlass) topic:cpp,cuda,deep-learning,deep-learning-library,gpu,nvidia pushed_at:2025-08 star:8.3k fork:1.4k CUDA Templates for Linear Algebra Subroutines
...
- [NVIDIA/Fuser](https://github.com/NVIDIA/Fuser) topic: pushed_at:2025-08 star:0.4k fork:0.1k A Fusion Code Generator for NVIDIA GPUs (commonly known as "nvFuser")
...
- [NVIDIA/nccl](https://github.com/NVIDIA/nccl) topic: pushed_at:2025-08 star:4.0k fork:1.0k Optimized primitives for collective multi-GPU communication
...
- [NVIDIA/nvidia-hpcg](https://github.com/NVIDIA/nvidia-hpcg) topic: pushed_at:2025-08 star:0.1k fork:0.0k NVIDIA HPCG is based on the HPCG benchmark and optimized for performance on NVIDIA accelerated HPC systems.
...
- [NVIDIA/optix-toolkit](https://github.com/NVIDIA/optix-toolkit) topic: pushed_at:2025-08 star:0.1k fork:0.0k Set of utilities supporting workflows common in GPU raytracing applications
...
- [NVIDIA/TensorRT](https://github.com/NVIDIA/TensorRT) topic:deep-learning,gpu-acceleration,inference,nvidia,tensorrt pushed_at:2025-08 star:12.1k fork:2.2k NVIDIA® TensorRT™ is an SDK for high-performance deep learning inference on NVIDIA GPUs. This repository contains the open source components of TensorRT.
...
- [NVIDIA/TensorRT-LLM](https://github.com/NVIDIA/TensorRT-LLM) topic:blackwell,cuda,llm-serving,moe,pytorch pushed_at:2025-09 star:11.5k fork:1.7k TensorRT-LLM provides users with an easy-to-use Python API to define Large Language Models (LLMs) and support state-of-the-art optimizations to perform inference efficiently on NVIDIA GPUs. TensorRT-LLM also contains components to create Python and C++ runtimes that orchestrate the inference execution in performant way.
...
- [NVIDIA/TorchFort](https://github.com/NVIDIA/TorchFort) topic:deep-learning,fortran,libtorch,pytorch pushed_at:2025-08 star:0.2k fork:0.0k An Online Deep Learning Interface for HPC programs on NVIDIA GPUs
...
- [NVIDIA/viskores-graph](https://github.com/NVIDIA/viskores-graph) topic: pushed_at:2025-08 star:0.0k fork:0.0k Filter execution graph library built on top of VTK-m
...
- [NVIDIA/nccl-tests](https://github.com/NVIDIA/nccl-tests) topic: pushed_at:2025-08 star:1.2k fork:0.3k NCCL Tests
...
- [NVIDIA/nvmath-python](https://github.com/NVIDIA/nvmath-python) topic: pushed_at:2025-08 star:0.3k fork:0.0k NVIDIA Math Libraries for the Python Ecosystem
...
- [NVIDIA/container-canary](https://github.com/NVIDIA/container-canary) topic:automation,ci,containers,docker,kubernetes,podman,utilities,versioning pushed_at:2025-08 star:0.3k fork:0.0k A tool for testing and validating container requirements against versioned manifests
...
- [NVIDIA/dcgm-exporter](https://github.com/NVIDIA/dcgm-exporter) topic: pushed_at:2025-08 star:1.4k fork:0.2k NVIDIA GPU metrics exporter for Prometheus leveraging DCGM
...
- [NVIDIA/gpu-operator](https://github.com/NVIDIA/gpu-operator) topic:cuda,gpu,kubernetes,nvidia pushed_at:2025-08 star:2.3k fork:0.4k NVIDIA GPU Operator creates, configures, and manages GPUs in Kubernetes
...
- [NVIDIA/KAI-Scheduler](https://github.com/NVIDIA/KAI-Scheduler) topic: pushed_at:2025-08 star:0.8k fork:0.1k KAI Scheduler is an open source Kubernetes Native scheduler for AI workloads at large scale
...
- [NVIDIA/nvkind](https://github.com/NVIDIA/nvkind) topic: pushed_at:2025-08 star:0.2k fork:0.0k 
...
- [NVIDIA/GenerativeAIExamples](https://github.com/NVIDIA/GenerativeAIExamples) topic:gpu-acceleration,large-language-models,llm,llm-inference,microservice,nemo,rag,retrieval-augmented-generation,tensorrt,triton-inference-server pushed_at:2025-08 star:3.4k fork:0.8k Generative AI reference workflows optimized for accelerated infrastructure and microservice architecture.
...
- [NVIDIA/Isaac-GR00T](https://github.com/NVIDIA/Isaac-GR00T) topic: pushed_at:2025-08 star:4.8k fork:0.7k NVIDIA Isaac GR00T N1.5 is the world's first open foundation model for generalized humanoid robot reasoning and skills.
...
- [NVIDIA/torch-harmonics](https://github.com/NVIDIA/torch-harmonics) topic:machine-learning,pytorch,signal-processing,sphere pushed_at:2025-08 star:0.5k fork:0.1k Differentiable signal processing on the sphere for PyTorch
...
- [NVIDIA/audio-flamingo](https://github.com/NVIDIA/audio-flamingo) topic:audio-captioning,audio-language-models,audio-question-answering,audio-reasoning,multimodal-large-language-models pushed_at:2025-08 star:0.7k fork:0.1k PyTorch implementation of Audio Flamingo: Series of Advanced Audio Understanding Language Models
...
- [NVIDIA/garak](https://github.com/NVIDIA/garak) topic:ai,llm-evaluation,llm-security,security-scanners,vulnerability-assessment pushed_at:2025-08 star:5.1k fork:0.6k the LLM vulnerability scanner
...
- [NVIDIA/jetson-gpio](https://github.com/NVIDIA/jetson-gpio) topic: pushed_at:2025-08 star:1.0k fork:0.3k A Python library that enables the use of Jetson's GPIOs
...
- [NVIDIA/Megatron-LM](https://github.com/NVIDIA/Megatron-LM) topic:large-language-models,model-para,transformers pushed_at:2025-09 star:13.4k fork:3.0k Ongoing research training transformer models at scale
...
- [NVIDIA/NeMo-Agent-Toolkit](https://github.com/NVIDIA/NeMo-Agent-Toolkit) topic: pushed_at:2025-08 star:1.3k fork:0.3k The NVIDIA NeMo Agent toolkit is an open-source library for efficiently connecting and optimizing teams of AI agents.
- [NVIDIA/NeMo-Agent-Toolkit-Examples](https://github.com/NVIDIA/NeMo-Agent-Toolkit-Examples) topic: pushed_at:2025-08 star:0.0k fork:0.0k Community examples utilizing NVIDIA NeMo Agent Toolkit.
...
- [NVIDIA/NeMo-Skills](https://github.com/NVIDIA/NeMo-Skills) topic: pushed_at:2025-09 star:0.5k fork:0.1k A project to improve skills of large language models
- [NVIDIA/NeMo-speech-data-processor](https://github.com/NVIDIA/NeMo-speech-data-processor) topic: pushed_at:2025-08 star:0.2k fork:0.0k A toolkit for processing speech data and creating speech datasets
...
- [NVIDIA/NVFlare](https://github.com/NVIDIA/NVFlare) topic:decentralized,federated-analytics,federated-computing,federated-learning,pet,privacy-protection,python pushed_at:2025-09 star:0.8k fork:0.2k NVIDIA Federated Learning Application Runtime Environment
...
- [NVIDIA/RULER](https://github.com/NVIDIA/RULER) topic: pushed_at:2025-07 star:1.3k fork:0.1k This repo contains the source code for RULER: What’s the Real Context Size of Your Long-Context Language Models?
...
- [NVIDIA/TensorRT-Model-Optimizer](https://github.com/NVIDIA/TensorRT-Model-Optimizer) topic: pushed_at:2025-08 star:1.2k fork:0.1k A unified library of state-of-the-art model optimization techniques like quantization, pruning, distillation, speculative decoding, etc. It compresses deep learning models for downstream deployment frameworks like TensorRT-LLM or TensorRT to optimize inference speed.
- [NVIDIA/tilus](https://github.com/NVIDIA/tilus) topic:cuda,kernel,programming,tile pushed_at:2025-09 star:0.3k fork:0.0k Tilus is a tile-level kernel programming language with explicit control over shared memory and registers.
...
- [NVIDIA/TransformerEngine](https://github.com/NVIDIA/TransformerEngine) topic:cuda,deep-learning,fp8,gpu,jax,machine-learning,python,pytorch pushed_at:2025-08 star:2.7k fork:0.5k A library for accelerating Transformer models on NVIDIA GPUs, including using 8-bit floating point (FP8) precision on Hopper, Ada and Blackwell GPUs, to provide better performance with lower memory utilization in both training and inference.
...
- [NVIDIA/warp](https://github.com/NVIDIA/warp) topic:cuda,differentiable-programming,gpu,gpu-acceleration,nvidia,nvidia-warp,python pushed_at:2025-09 star:5.5k fork:0.3k A Python framework for accelerated simulation, data generation and spatial computing.
...
- [NVIDIA/vagrant-swift-all-in-one](https://github.com/NVIDIA/vagrant-swift-all-in-one) topic: pushed_at:2025-08 star:0.1k fork:0.1k Vagrant Swift All In One
...
- [NVIDIA/spark-rapids](https://github.com/NVIDIA/spark-rapids) topic:big-data,gpu,rapids,spark pushed_at:2025-09 star:0.9k fork:0.3k Spark RAPIDS plugin - accelerate Apache Spark with GPUs
...
- [NVIDIA/cumulus-test-drive](https://github.com/NVIDIA/cumulus-test-drive) topic: pushed_at:2025-08 star:0.0k fork:0.0k Testing and validation scripts and playbooks for Cumulus Linux Workshops
...
- [NVIDIA/dgxc-benchmarking](https://github.com/NVIDIA/dgxc-benchmarking) topic: pushed_at:2025-08 star:0.0k fork:0.0k DGXC Benchmarking provides recipes in ready-to-use templates for evaluating performance of specific AI use cases across hardware and software combinations.
...
- [NVIDIA/skyhook-packages](https://github.com/NVIDIA/skyhook-packages) topic: pushed_at:2025-08 star:0.0k fork:0.0k Packages for the Skyhook Kubernetes Operator.
...
- [NVIDIA/NeMo-Agent-Toolkit-UI](https://github.com/NVIDIA/NeMo-Agent-Toolkit-UI) topic: pushed_at:2025-09 star:0.0k fork:0.0k The NVIDIA AIQToolkit UI streamlines interacting with AIQToolkit workflows in an easy-to-use web application.
