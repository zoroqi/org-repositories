...
- [NVIDIA/Isaac-GR00T](https://github.com/NVIDIA/Isaac-GR00T) topic: pushed_at:2025-09 star:4.9k fork:0.7k NVIDIA Isaac GR00T N1.5 is the world's first open foundation model for generalized humanoid robot reasoning and skills.
...
- [NVIDIA/NeMo-Agent-Toolkit](https://github.com/NVIDIA/NeMo-Agent-Toolkit) topic: pushed_at:2025-09 star:1.4k fork:0.4k The NVIDIA NeMo Agent toolkit is an open-source library for efficiently connecting and optimizing teams of AI agents.
...
- [NVIDIA/NeMo-Guardrails](https://github.com/NVIDIA/NeMo-Guardrails) topic: pushed_at:2025-09 star:5.1k fork:0.5k NeMo Guardrails is an open-source toolkit for easily adding programmable guardrails to LLM-based conversational systems.
...
- [NVIDIA/NeMo-Skills](https://github.com/NVIDIA/NeMo-Skills) topic: pushed_at:2025-09 star:0.6k fork:0.1k A project to improve skills of large language models
...
- [NVIDIA/numba-cuda](https://github.com/NVIDIA/numba-cuda) topic: pushed_at:2025-09 star:0.2k fork:0.0k The CUDA target for Numba
- [NVIDIA/numbast](https://github.com/NVIDIA/numbast) topic:cuda,numba pushed_at:2025-09 star:0.1k fork:0.0k Numbast is a tool to build an automated pipeline that converts CUDA APIs into Numba bindings.
...
- [NVIDIA/physicsnemo](https://github.com/NVIDIA/physicsnemo) topic:deep-learning,machine-learning,nvidia-gpu,physics,pytorch pushed_at:2025-09 star:1.8k fork:0.4k Open-source deep-learning framework for building, training, and fine-tuning deep learning models using state-of-the-art Physics-ML methods
...
- [NVIDIA/physicsnemo-sym](https://github.com/NVIDIA/physicsnemo-sym) topic:deep-learning,machine-learning,nvidia-gpu,physics,pytorch pushed_at:2025-09 star:0.3k fork:0.1k Framework providing pythonic APIs, algorithms and utilities to be used with PhysicsNeMo core to physics inform model training as well as higher level abstraction for domain experts
...
- [NVIDIA/TensorRT-Model-Optimizer](https://github.com/NVIDIA/TensorRT-Model-Optimizer) topic: pushed_at:2025-09 star:1.4k fork:0.2k A unified library of state-of-the-art model optimization techniques like quantization, pruning, distillation, speculative decoding, etc. It compresses deep learning models for downstream deployment frameworks like TensorRT-LLM or TensorRT to optimize inference speed.
...
- [NVIDIA/TransformerEngine](https://github.com/NVIDIA/TransformerEngine) topic:cuda,deep-learning,fp8,gpu,jax,machine-learning,python,pytorch pushed_at:2025-09 star:2.7k fork:0.5k A library for accelerating Transformer models on NVIDIA GPUs, including using 8-bit floating point (FP8) precision on Hopper, Ada and Blackwell GPUs, to provide better performance with lower memory utilization in both training and inference.
...
- [NVIDIA/warp](https://github.com/NVIDIA/warp) topic:cuda,differentiable-programming,gpu,gpu-acceleration,nvidia,nvidia-warp,python pushed_at:2025-09 star:5.5k fork:0.4k A Python framework for accelerated simulation, data generation and spatial computing.
