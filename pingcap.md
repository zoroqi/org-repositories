...
- [pingcap/mydumper](https://github.com/pingcap/mydumper) pushed_at:2020-05 star:0.0k fork:0.0k PingCAP fork of mydumper, with enhancements for TiDB
- [pingcap/poco](https://github.com/pingcap/poco) pushed_at:2020-08 star:0.0k fork:0.0k POCO C++ Libraries - Cross-platform C++ libraries with a network/internet focus.
...
- [pingcap/grpc](https://github.com/pingcap/grpc) pushed_at:2021-02 star:0.0k fork:0.0k The C based gRPC (C++, Node.js, Python, Ruby, Objective-C, PHP, C#)
...
- [pingcap/jepsen](https://github.com/pingcap/jepsen) pushed_at:2021-01 star:0.0k fork:0.0k A framework for distributed systems verification, with fault injection

## Go

- [pingcap/advanced-statefulset](https://github.com/pingcap/advanced-statefulset) pushed_at:2020-06 star:0.0k fork:0.0k 
- [pingcap/badger](https://github.com/pingcap/badger) pushed_at:2021-02 star:0.0k fork:0.0k Fast key-value DB in Go.
- [pingcap/br](https://github.com/pingcap/br) pushed_at:2021-02 star:0.1k fork:0.1k A command-line tool for distributed backup and restoration of the TiDB cluster data
...
- [pingcap/dm](https://github.com/pingcap/dm) pushed_at:2021-02 star:0.4k fork:0.1k Data Migration Platform
...
- [pingcap/failpoint](https://github.com/pingcap/failpoint) pushed_at:2020-09 star:0.6k fork:0.0k An implementation of failpoints for Golang.
...
- [pingcap/go-tpc](https://github.com/pingcap/go-tpc) pushed_at:2021-02 star:0.1k fork:0.0k A toolbox to benchmark TPC workloads in Go 
- [pingcap/go-ycsb](https://github.com/pingcap/go-ycsb) pushed_at:2021-01 star:0.3k fork:0.1k A Go port of Yahoo! Cloud Serving Benchmark (YCSB) 
...
- [pingcap/log](https://github.com/pingcap/log) pushed_at:2020-11 star:0.0k fork:0.0k 
...
- [pingcap/parser](https://github.com/pingcap/parser) pushed_at:2021-02 star:0.8k fork:0.4k A MySQL Compatible SQL Parser
...
- [pingcap/ticdc](https://github.com/pingcap/ticdc) pushed_at:2021-02 star:0.1k fork:0.1k Change data capture for TiDB
- [pingcap/tidb](https://github.com/pingcap/tidb) pushed_at:2021-02 star:26.9k fork:4.2k TiDB is an open source distributed HTAP database compatible with the MySQL protocol 
...
- [pingcap/tidb-dashboard](https://github.com/pingcap/tidb-dashboard) pushed_at:2021-02 star:0.1k fork:0.1k A Web UI for monitoring, diagnosing and managing the TiDB cluster.
- [pingcap/tidb-lightning](https://github.com/pingcap/tidb-lightning) pushed_at:2021-02 star:0.1k fork:0.1k A high-speed data import tool for TiDB
...
- [pingcap/tidb-operator](https://github.com/pingcap/tidb-operator) pushed_at:2021-02 star:0.8k fork:0.3k TiDB operator creates and manages TiDB clusters running in Kubernetes.
- [pingcap/tidb-tools](https://github.com/pingcap/tidb-tools) pushed_at:2021-02 star:0.2k fork:0.1k tidb-tools are some useful tool collections for TiDB.
- [pingcap/tidiff](https://github.com/pingcap/tidiff) pushed_at:2020-01 star:0.0k fork:0.0k A toolset to improve efficiency 
- [pingcap/tipb](https://github.com/pingcap/tipb) pushed_at:2021-02 star:0.1k fork:0.1k TiDB protobuf
- [pingcap/tipocket](https://github.com/pingcap/tipocket) pushed_at:2021-02 star:0.1k fork:0.1k A toolkit for testing TiDB
- [pingcap/tiup](https://github.com/pingcap/tiup) pushed_at:2021-02 star:0.2k fork:0.1k A component manager for TiDB
...
- [pingcap/pingcap.github.io](https://github.com/pingcap/pingcap.github.io) pushed_at:2021-02 star:0.0k fork:0.0k PingCAP Website
- [pingcap/sqlgram](https://github.com/pingcap/sqlgram) pushed_at:2020-05 star:0.0k fork:0.0k TiDB SQL

## Java

- [pingcap/benchmarksql](https://github.com/pingcap/benchmarksql) pushed_at:2020-12 star:0.0k fork:0.0k mirror of benchmarksql on github
...
- [pingcap/tispark](https://github.com/pingcap/tispark) pushed_at:2021-02 star:0.7k fork:0.2k TiSpark is built for running Apache Spark on top of TiDB/TiKV

## JavaScript

- [pingcap/campaign](https://github.com/pingcap/campaign) pushed_at:2020-09 star:0.0k fork:0.0k 
- [pingcap/community](https://github.com/pingcap/community) pushed_at:2021-02 star:0.2k fork:0.1k TiDB community content
- [pingcap/community-website](https://github.com/pingcap/community-website) pushed_at:2021-02 star:0.0k fork:0.0k 
- [pingcap/tidb-vision](https://github.com/pingcap/tidb-vision) pushed_at:2021-01 star:0.0k fork:0.0k TiDB data visualization
- [pingcap/tug-website](https://github.com/pingcap/tug-website) pushed_at:2021-02 star:0.0k fork:0.0k 
- [pingcap/website](https://github.com/pingcap/website) pushed_at:2021-02 star:0.0k fork:0.0k The website of PingCAP. Powered by Gatsby ⚛️ and Rocket 🚀.
- [pingcap/website-docs](https://github.com/pingcap/website-docs) pushed_at:2021-02 star:0.0k fork:0.0k The next generation of PingCAP Docs. Powered by Gatsby ⚛️.

## OCaml

- [pingcap/cloud-assets-utils](https://github.com/pingcap/cloud-assets-utils) pushed_at:2021-01 star:0.0k fork:0.0k Cloud assets utils by PingCAP FE.

## Others

- [pingcap/.github](https://github.com/pingcap/.github) pushed_at:2020-11 star:0.0k fork:0.0k 
- [pingcap/awesome-database-learning](https://github.com/pingcap/awesome-database-learning) pushed_at:2021-02 star:2.5k fork:0.3k A list of learning materials to understand databases internals
...
- [pingcap/style-guide](https://github.com/pingcap/style-guide) pushed_at:2021-02 star:0.0k fork:0.0k Style guide for PingCAP and TiKV code
- [pingcap/ticdc-lib](https://github.com/pingcap/ticdc-lib) pushed_at:2020-09 star:0.0k fork:0.0k 
...
- [pingcap/weekly](https://github.com/pingcap/weekly) pushed_at:2021-02 star:0.1k fork:0.0k 
...
- [pingcap/docs-cn](https://github.com/pingcap/docs-cn) pushed_at:2021-02 star:1.5k fork:0.9k TiDB/TiKV/PD documentation in Chinese.
- [pingcap/docs-dm](https://github.com/pingcap/docs-dm) pushed_at:2021-02 star:0.0k fork:0.0k Documentation for the TiDB Data Migration (DM) tool in both English and Chinese.
- [pingcap/docs-tidb-operator](https://github.com/pingcap/docs-tidb-operator) pushed_at:2021-02 star:0.0k fork:0.1k Documentation for TiDB in Kubernetes in both English and Chinese.
...
- [pingcap/tidb-ansible](https://github.com/pingcap/tidb-ansible) pushed_at:2021-02 star:0.3k fork:0.3k 
- [pingcap/tidb-docker-compose](https://github.com/pingcap/tidb-docker-compose) pushed_at:2020-04 star:0.2k fork:0.1k 
- [pingcap/tidb-insight](https://github.com/pingcap/tidb-insight) pushed_at:2021-02 star:0.0k fork:0.0k 
...
- [pingcap/blog](https://github.com/pingcap/blog) pushed_at:2021-02 star:0.0k fork:0.0k 
- [pingcap/blog-cn](https://github.com/pingcap/blog-cn) pushed_at:2021-02 star:0.1k fork:0.1k 
- [pingcap/Dockerfile](https://github.com/pingcap/Dockerfile) pushed_at:2015-12 star:0.0k fork:0.0k 
- [pingcap/docs](https://github.com/pingcap/docs) pushed_at:2021-02 star:0.4k fork:0.4k TiDB/TiKV/PD documentation.
...
- [pingcap/kvproto](https://github.com/pingcap/kvproto) pushed_at:2021-02 star:0.1k fork:0.1k Protocol buffer files for TiKV
- [pingcap/monitoring](https://github.com/pingcap/monitoring) pushed_at:2021-02 star:0.0k fork:0.0k 
...
- [pingcap/tidb-map](https://github.com/pingcap/tidb-map) pushed_at:2020-12 star:0.1k fork:0.0k A series of maps to help users and contributors
