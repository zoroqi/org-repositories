...
- [pingcap/tipb](https://github.com/pingcap/tipb) topic: pushed_at:2022-12 star:0.1k fork:0.1k TiDB protobuf
...
- [pingcap/badger](https://github.com/pingcap/badger) topic: pushed_at:2022-12 star:0.0k fork:0.0k Fast key-value DB in Go.
- [pingcap/br](https://github.com/pingcap/br) topic:backup,distributed-database,point-in-time,restore,tidb pushed_at:2022-12 star:0.1k fork:0.1k A command-line tool for distributed backup and restoration of the TiDB cluster data
...
- [pingcap/go-ycsb](https://github.com/pingcap/go-ycsb) topic: pushed_at:2022-12 star:0.5k fork:0.2k A Go port of Yahoo! Cloud Serving Benchmark (YCSB) 
...
- [pingcap/mysql-tester](https://github.com/pingcap/mysql-tester) topic: pushed_at:2022-12 star:0.0k fork:0.1k A Golang implementation of MySQL Test Framework
...
- [pingcap/tidb](https://github.com/pingcap/tidb) topic:cloud-native,database,distributed-database,distributed-transactions,go,hacktoberfest,htap,mysql,mysql-compatibility,scale,serverless,sql,tidb pushed_at:2022-12 star:33.1k fork:5.4k TiDB is an open-source, cloud-native, distributed, MySQL-Compatible database for elastic scale and real-time analytics. Try free: https://tidbcloud.com/free-trial
...
- [pingcap/tiup](https://github.com/pingcap/tiup) topic:cluster,playground,tidb,tidb-components,tiup pushed_at:2022-12 star:0.4k fork:0.3k A component manager for TiDB
...
- [pingcap/book.tidb.net](https://github.com/pingcap/book.tidb.net) topic: pushed_at:2022-12 star:0.0k fork:0.0k 
...
- [pingcap/awesome-database-learning](https://github.com/pingcap/awesome-database-learning) topic:awesome,awesome-list,blogs,books,course,database,papers pushed_at:2022-11 star:5.8k fork:0.8k A list of learning materials to understand databases internals
...
- [pingcap/community](https://github.com/pingcap/community) topic: pushed_at:2022-12 star:0.2k fork:0.1k TiDB community content
...
- [pingcap/talent-plan](https://github.com/pingcap/talent-plan) topic:distributed-database,distributed-systems,golang,open-source,pingcap,rust,talent-plan pushed_at:2022-12 star:8.3k fork:1.1k open source training courses about distributed database and distributed systems
...
- [pingcap/tispark](https://github.com/pingcap/tispark) topic:bigdata,spark,tidb,tikv pushed_at:2022-12 star:0.8k fork:0.2k TiSpark is built for running Apache Spark on top of TiDB/TiKV
...
- [pingcap/docs-cn](https://github.com/pingcap/docs-cn) topic:hacktoberfest,tidb,tidb-documentation pushed_at:2022-12 star:1.8k fork:1.1k TiDB/TiKV/PD documentation in Chinese.
...
- [pingcap/ossinsight](https://github.com/pingcap/ossinsight) topic:aisql,analytics,demo,github,htap,insight,openai,oss,realtime,text2sql pushed_at:2022-12 star:0.7k fork:0.1k Open Source Software Insights - Analysis, Comparison, Trends, Rankings of Open Source Software, also using OpenAI to translate text to SQL. Follow us on Twitter: https://twitter.com/ossinsight
