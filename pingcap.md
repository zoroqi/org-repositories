...
- [pingcap/tiflash](https://github.com/pingcap/tiflash) topic: pushed_at:2022-12 star:0.8k fork:0.4k The analytical engine for TiDB and TiDB Cloud. Try free: https://tidbcloud.com/free-trial

## CMake

- [pingcap/kvproto](https://github.com/pingcap/kvproto) topic: pushed_at:2022-12 star:0.1k fork:0.2k Protocol buffer files for TiKV
...
- [pingcap/tidb](https://github.com/pingcap/tidb) topic:cloud-native,database,distributed-database,distributed-transactions,go,hacktoberfest,htap,mysql,mysql-compatibility,scale,serverless,sql,tidb pushed_at:2022-12 star:32.9k fork:5.3k TiDB is an open-source, cloud-native, distributed, MySQL-Compatible database for elastic scale and real-time analytics. Try free: https://tidbcloud.com/free-trial
...
- [pingcap/tidb-operator](https://github.com/pingcap/tidb-operator) topic:cloud-native,golang,hacktoberfest,kubernetes,operator,tidb pushed_at:2022-12 star:1.0k fork:0.4k TiDB operator creates and manages TiDB clusters running in Kubernetes.
...
- [pingcap/tidb-course-201-lab](https://github.com/pingcap/tidb-course-201-lab) topic: pushed_at:2022-12 star:0.0k fork:0.0k Lab scripts for the PingCAP training course: TiDB SQL for Developers.
...
- [pingcap/docs-staging](https://github.com/pingcap/docs-staging) topic: pushed_at:2022-12 star:0.0k fork:0.0k 
...
- [pingcap/dbt-tidb](https://github.com/pingcap/dbt-tidb) topic:dataanalysis,database,dbt,mysql,python,sql,tidb pushed_at:2022-12 star:0.0k fork:0.0k A dbt adapter for TiDB
...
- [pingcap/docs](https://github.com/pingcap/docs) topic:hacktoberfest,tidb,tidb-documentation pushed_at:2022-12 star:0.5k fork:0.6k TiDB database documentation.
...
- [pingcap/docs-tidb-operator](https://github.com/pingcap/docs-tidb-operator) topic:hacktoberfest,tidb-in-kubernetes,tidb-operator,tidb-operator-documentation pushed_at:2022-12 star:0.0k fork:0.1k Documentation for TiDB on Kubernetes in both English and Chinese.
...
- [pingcap/etcd-client](https://github.com/pingcap/etcd-client) topic: pushed_at:2022-12 star:0.0k fork:0.0k An etcd v3 API client
...
- [pingcap/tidb-engine-ext](https://github.com/pingcap/tidb-engine-ext) topic: pushed_at:2022-12 star:0.0k fork:0.0k A TiKV based `c dynamic library` for extending storage system in TiDB cluster
...
- [pingcap/docs-cn](https://github.com/pingcap/docs-cn) topic:hacktoberfest,tidb,tidb-documentation pushed_at:2022-12 star:1.7k fork:1.1k TiDB/TiKV/PD documentation in Chinese.
...
- [pingcap/ossinsight](https://github.com/pingcap/ossinsight) topic:analytics,demo,github,htap,insight,oss,realtime pushed_at:2022-12 star:0.6k fork:0.1k Open Source Software Insights - Analysis, Comparison, Trends, Rankings of Open Source Software. Follow us on Twitter: https://twitter.com/ossinsight
...
- [pingcap/website-docs](https://github.com/pingcap/website-docs) topic: pushed_at:2022-12 star:0.0k fork:0.0k The next generation of PingCAP Docs. Powered by Gatsby ⚛️.
