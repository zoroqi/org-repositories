...
- [pingcap/tiflash](https://github.com/pingcap/tiflash) topic: pushed_at:2025-12 star:1.0k fork:0.4k The analytical engine for TiDB and TiDB Cloud. Try free: https://tidbcloud.com/free-trial
...
- [pingcap/diag](https://github.com/pingcap/diag) topic: pushed_at:2025-11 star:0.0k fork:0.0k A tool to collect diagnostic data from TiDB Clusters
...
- [pingcap/ticdc](https://github.com/pingcap/ticdc) topic: pushed_at:2025-12 star:0.0k fork:0.0k TiCDC pulls change logs out of TiDB and pushes to kinds of systems.
- [pingcap/tidb](https://github.com/pingcap/tidb) topic:cloud-native,database,distributed-database,distributed-transactions,go,hacktoberfest,htap,mysql,mysql-compatibility,scale,serverless,sql,tidb pushed_at:2025-12 star:39.4k fork:6.1k TiDB - the open-source, cloud-native, distributed SQL database designed for modern applications.
- [pingcap/tidb-binlog](https://github.com/pingcap/tidb-binlog) topic: pushed_at:2025-11 star:0.3k fork:0.1k A tool used to collect and merge tidb's binlog for real-time data backup and synchronization.
...
- [pingcap/tidb-operator](https://github.com/pingcap/tidb-operator) topic:cloud-native,golang,hacktoberfest,kubernetes,operator,tidb pushed_at:2025-12 star:1.3k fork:0.5k TiDB operator creates and manages TiDB clusters running in Kubernetes.
...
- [pingcap/full-stack-app-builder-ai-agent](https://github.com/pingcap/full-stack-app-builder-ai-agent) topic: pushed_at:2025-12 star:0.0k fork:0.0k 
...
- [pingcap/LinguFlow](https://github.com/pingcap/LinguFlow) topic:chatgpt,gpt,llm-framework,llm-inference,openai pushed_at:2025-11 star:0.0k fork:0.0k LinguFlow, a low-code tool designed for LLM application development, simplifies the building, debugging, and deployment process for developers.
- [pingcap/ossinsight](https://github.com/pingcap/ossinsight) topic:aisql,analytics,chat2query,demo,github,htap,insight,openai,oss,realtime,text2sql pushed_at:2025-11 star:2.3k fork:0.4k Analysis, Comparison, Trends, Rankings of Open Source Software, you can also get insight from more than 7 billion with natural language (powered by OpenAI). Follow us on Twitter: https://twitter.com/ossinsight
