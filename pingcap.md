...
- [pingcap/poco](https://github.com/pingcap/poco) pushed_at:2021-09 star:0.0k fork:0.0k POCO C++ Libraries - Cross-platform C++ libraries with a network/internet focus.
...
- [pingcap/grpc](https://github.com/pingcap/grpc) pushed_at:2021-09 star:0.0k fork:0.0k The C based gRPC (C++, Node.js, Python, Ruby, Objective-C, PHP, C#)
- [pingcap/sqlsmith](https://github.com/pingcap/sqlsmith) pushed_at:2019-10 star:0.0k fork:0.0k A random SQL query generator

## CMake

- [pingcap/kvproto](https://github.com/pingcap/kvproto) pushed_at:2021-12 star:0.1k fork:0.2k Protocol buffer files for TiKV
- [pingcap/tipb](https://github.com/pingcap/tipb) pushed_at:2021-12 star:0.1k fork:0.1k TiDB protobuf
...
- [pingcap/br](https://github.com/pingcap/br) pushed_at:2021-12 star:0.1k fork:0.1k A command-line tool for distributed backup and restoration of the TiDB cluster data
...
- [pingcap/dm](https://github.com/pingcap/dm) pushed_at:2021-11 star:0.4k fork:0.2k Data Migration Platform
- [pingcap/dumpling](https://github.com/pingcap/dumpling) pushed_at:2021-12 star:0.2k fork:0.1k Dumpling is a fast, easy-to-use tool written by Go for dumping data from the database(MySQL, TiDB...) to local/cloud(S3, GCP...) in multifarious formats(SQL, CSV...).
- [pingcap/errcode](https://github.com/pingcap/errcode) pushed_at:2021-08 star:0.0k fork:0.0k 
- [pingcap/errors](https://github.com/pingcap/errors) pushed_at:2021-10 star:0.0k fork:0.0k Simple error handling primitives
...
- [pingcap/go-tpc](https://github.com/pingcap/go-tpc) pushed_at:2021-09 star:0.1k fork:0.0k A toolbox to benchmark TPC workloads in Go 
- [pingcap/go-ycsb](https://github.com/pingcap/go-ycsb) pushed_at:2021-10 star:0.4k fork:0.1k A Go port of Yahoo! Cloud Serving Benchmark (YCSB) 
...
- [pingcap/mysql-tester](https://github.com/pingcap/mysql-tester) pushed_at:2021-12 star:0.0k fork:0.0k A Golang implementation of MySQL Test Framework
...
- [pingcap/parser](https://github.com/pingcap/parser) pushed_at:2021-11 star:1.1k fork:0.4k A MySQL Compatible SQL Parser
...
- [pingcap/ticdc](https://github.com/pingcap/ticdc) pushed_at:2021-12 star:0.2k fork:0.1k Change data capture for TiDB
- [pingcap/tidb](https://github.com/pingcap/tidb) pushed_at:2021-12 star:29.8k fork:4.8k TiDB is an open source distributed HTAP database compatible with the MySQL protocol 
...
- [pingcap/tidb-dashboard](https://github.com/pingcap/tidb-dashboard) pushed_at:2021-12 star:0.1k fork:0.1k A Web UI for monitoring, diagnosing and managing the TiDB cluster.
...
- [pingcap/tidb-operator](https://github.com/pingcap/tidb-operator) pushed_at:2021-12 star:0.9k fork:0.4k TiDB operator creates and manages TiDB clusters running in Kubernetes.
- [pingcap/tidb-tools](https://github.com/pingcap/tidb-tools) pushed_at:2021-12 star:0.2k fork:0.2k tidb-tools are some useful tool collections for TiDB.
- [pingcap/tidiff](https://github.com/pingcap/tidiff) pushed_at:2020-01 star:0.0k fork:0.0k A toolset to improve efficiency 
- [pingcap/tipocket](https://github.com/pingcap/tipocket) pushed_at:2021-12 star:0.1k fork:0.1k A toolkit for testing TiDB
- [pingcap/tiup](https://github.com/pingcap/tiup) pushed_at:2021-12 star:0.3k fork:0.2k A component manager for TiDB
...
- [pingcap/education](https://github.com/pingcap/education) pushed_at:2021-09 star:0.0k fork:0.0k 
...
- [pingcap/tispark](https://github.com/pingcap/tispark) pushed_at:2021-12 star:0.8k fork:0.2k TiSpark is built for running Apache Spark on top of TiDB/TiKV
...
- [pingcap/tug-website](https://github.com/pingcap/tug-website) pushed_at:2021-12 star:0.0k fork:0.0k 
- [pingcap/website](https://github.com/pingcap/website) pushed_at:2021-12 star:0.0k fork:0.0k The website of PingCAP. Powered by Gatsby ⚛️ and Rocket 🚀.
- [pingcap/website-docs](https://github.com/pingcap/website-docs) pushed_at:2021-12 star:0.0k fork:0.0k The next generation of PingCAP Docs. Powered by Gatsby ⚛️.
...
- [pingcap/tidb-dev-guide](https://github.com/pingcap/tidb-dev-guide) pushed_at:2021-12 star:0.1k fork:0.0k A comprehensive development guide to help you be more and more familiar with the TiDB community and become an expert finally.
...
- [pingcap/docs](https://github.com/pingcap/docs) pushed_at:2021-12 star:0.5k fork:0.5k TiDB/TiKV/PD documentation.
- [pingcap/docs-appdev](https://github.com/pingcap/docs-appdev) pushed_at:2021-11 star:0.0k fork:0.0k 
- [pingcap/docs-dm](https://github.com/pingcap/docs-dm) pushed_at:2021-12 star:0.0k fork:0.1k Documentation for the TiDB Data Migration (DM) tool in both English and Chinese.
- [pingcap/docs-tidb-operator](https://github.com/pingcap/docs-tidb-operator) pushed_at:2021-12 star:0.0k fork:0.1k Documentation for TiDB in Kubernetes in both English and Chinese.
...
- [pingcap/tidb-docker-compose](https://github.com/pingcap/tidb-docker-compose) pushed_at:2021-07 star:0.3k fork:0.1k 
- [pingcap/tidb-insight](https://github.com/pingcap/tidb-insight) pushed_at:2021-12 star:0.0k fork:0.0k 
- [pingcap/tidb-inspect-tools](https://github.com/pingcap/tidb-inspect-tools) pushed_at:2020-09 star:0.0k fork:0.0k 

## Ruby

- [pingcap/activerecord-tidb-adapter](https://github.com/pingcap/activerecord-tidb-adapter) pushed_at:2021-09 star:0.0k fork:0.0k TiDB adapter for ActiveRecord, allows the use of TiDB as a backend for ActiveRecord and Rails apps.
- [pingcap/discourse](https://github.com/pingcap/discourse) pushed_at:2021-12 star:0.0k fork:0.0k A platform for community discussion. Free, open, simple.
...
- [pingcap/homebrew-brew](https://github.com/pingcap/homebrew-brew) pushed_at:2021-12 star:0.0k fork:0.0k Homebrew taps for TiDB
...
- [pingcap/talent-plan](https://github.com/pingcap/talent-plan) pushed_at:2021-11 star:6.9k fork:0.9k open source training courses about distributed database and distributed systemes
- [pingcap/tidb-engine-ext](https://github.com/pingcap/tidb-engine-ext) pushed_at:2021-11 star:0.0k fork:0.0k A TiKV based `c dynamic library` for extending storage system in TiDB cluster
...
- [pingcap/docs-cn](https://github.com/pingcap/docs-cn) pushed_at:2021-12 star:1.6k fork:1.0k TiDB/TiKV/PD documentation in Chinese.
...
- [pingcap/monitoring](https://github.com/pingcap/monitoring) pushed_at:2021-12 star:0.0k fork:0.0k 
