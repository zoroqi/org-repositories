...
- [pingcap/tiflash](https://github.com/pingcap/tiflash) topic: pushed_at:2026-08 star:1.0k fork:0.4k The analytical engine for TiDB and TiDB Cloud. Try free: https://tidbcloud.com/free-trial

## CMake

- [pingcap/kvproto](https://github.com/pingcap/kvproto) topic: pushed_at:2026-08 star:0.2k fork:0.2k Protocol buffer files for TiKV
...
- [pingcap/advanced-statefulset](https://github.com/pingcap/advanced-statefulset) topic: pushed_at:2026-08 star:0.1k fork:0.0k 
...
- [pingcap/failpoint](https://github.com/pingcap/failpoint) topic:failpoint,failure-injection,fault-injection,golang pushed_at:2026-08 star:0.9k fork:0.1k An implementation of failpoints for Golang.
...
- [pingcap/log](https://github.com/pingcap/log) topic: pushed_at:2026-06 star:0.0k fork:0.0k 
- [pingcap/metering_sdk](https://github.com/pingcap/metering_sdk) topic: pushed_at:2026-08 star:0.0k fork:0.0k 
...
- [pingcap/ng-monitoring](https://github.com/pingcap/ng-monitoring) topic: pushed_at:2026-07 star:0.0k fork:0.0k 
...
- [pingcap/ticdc](https://github.com/pingcap/ticdc) topic: pushed_at:2026-08 star:0.1k fork:0.1k TiCDC pulls change logs out of TiDB and pushes to kinds of systems.
...
- [pingcap/tidb-operator](https://github.com/pingcap/tidb-operator) topic:cloud-native,golang,hacktoberfest,kubernetes,operator,tidb pushed_at:2026-08 star:1.3k fork:0.5k TiDB operator creates and manages TiDB clusters running in Kubernetes.
...
- [pingcap/tiflow](https://github.com/pingcap/tiflow) topic:cdc,dm,kafka,mysql,ticdc,tidb pushed_at:2026-08 star:0.5k fork:0.3k This repo maintains DM (a data migration platform) and TiCDC (change data capture for TiDB)
...
- [pingcap/tipb](https://github.com/pingcap/tipb) topic: pushed_at:2026-08 star:0.1k fork:0.2k TiDB protobuf
...
- [pingcap/tiproxy](https://github.com/pingcap/tiproxy) topic: pushed_at:2026-08 star:0.1k fork:0.0k 
- [pingcap/tiunimanager](https://github.com/pingcap/tiunimanager) topic: pushed_at:2026-08 star:0.0k fork:0.0k TiUniManager
...
- [pingcap/benchmarksql](https://github.com/pingcap/benchmarksql) topic: pushed_at:2026-06 star:0.1k fork:0.1k Unofficial mirror of benchmarksql on github
...
- [pingcap/TiBigData](https://github.com/pingcap/TiBigData) topic:bigdata,cdc,flink,hive,presto,tidb,tikv pushed_at:2024-04 star:0.2k fork:0.1k TiDB connectors for Flink/Hive/Presto
...
- [pingcap/docs-staging](https://github.com/pingcap/docs-staging) topic: pushed_at:2026-08 star:0.0k fork:0.0k 
- [pingcap/docs-toolkit](https://github.com/pingcap/docs-toolkit) topic: pushed_at:2026-06 star:0.0k fork:0.0k The essential utility library for automating, validating, and ensuring the quality and consistency of the official TiDB documentation.
...
- [pingcap/awesome-database-learning](https://github.com/pingcap/awesome-database-learning) topic:awesome,awesome-list,blogs,books,course,database,papers pushed_at:2024-08 star:11.0k fork:1.2k A list of learning materials to understand databases internals
...
- [pingcap/community](https://github.com/pingcap/community) topic: pushed_at:2026-08 star:0.3k fork:0.2k TiDB community content
...
- [pingcap/sarama](https://github.com/pingcap/sarama) topic: pushed_at:2026-06 star:0.0k fork:0.0k Sarama is a Go library for Apache Kafka.
...
- [pingcap/agent-rules](https://github.com/pingcap/agent-rules) topic: pushed_at:2026-06 star:0.0k fork:0.0k Agentic Store Skills
...
- [pingcap/docs](https://github.com/pingcap/docs) topic:hacktoberfest,tidb,tidb-documentation pushed_at:2026-08 star:0.6k fork:0.7k TiDB database documentation. TiDB is an open-source, cloud-native, distributed, MySQL-Compatible database for elastic scale and real-time analytics.
- [pingcap/docs-appdev](https://github.com/pingcap/docs-appdev) topic: pushed_at:2022-06 star:0.0k fork:0.0k 
- [pingcap/docs-cn](https://github.com/pingcap/docs-cn) topic:hacktoberfest,tidb,tidb-documentation pushed_at:2026-08 star:1.8k fork:1.2k TiDB/TiKV/PD 中文文档
...
- [pingcap/talent-plan](https://github.com/pingcap/talent-plan) topic:distributed-database,distributed-systems,golang,open-source,pingcap,rust,talent-plan pushed_at:2023-09 star:11.0k fork:1.4k open source training courses about distributed database and distributed systems
- [pingcap/tantivy](https://github.com/pingcap/tantivy) topic: pushed_at:2026-07 star:0.0k fork:0.0k Tantivy is a full-text search engine library inspired by Apache Lucene and written in Rust
- [pingcap/tidb-engine-ext](https://github.com/pingcap/tidb-engine-ext) topic: pushed_at:2026-06 star:0.0k fork:0.0k A TiKV based `c dynamic library` for extending storage system in TiDB cluster

## Scala

- [pingcap/tispark](https://github.com/pingcap/tispark) topic:bigdata,spark,tidb,tikv pushed_at:2026-08 star:0.9k fork:0.2k TiSpark is built for running Apache Spark on top of TiDB/TiKV
...
- [pingcap/monitoring](https://github.com/pingcap/monitoring) topic: pushed_at:2026-08 star:0.0k fork:0.0k 
...
- [pingcap/ossinsight](https://github.com/pingcap/ossinsight) topic:aisql,analytics,chat2query,demo,github,htap,insight,openai,oss,realtime,text2sql pushed_at:2026-07 star:2.5k fork:0.4k Analysis, Comparison, Trends, Rankings of Open Source Software, you can also get insight from more than 10 billion with natural language (powered by LLM). Follow us on Twitter: https://twitter.com/ossinsight
...
- [pingcap/tidb-dashboard](https://github.com/pingcap/tidb-dashboard) topic:dashboard,tidb,troubleshooting,ui pushed_at:2026-08 star:0.2k fork:0.2k A Web UI for monitoring, diagnosing and managing the TiDB cluster.
...
- [pingcap/tiunimanager-ui](https://github.com/pingcap/tiunimanager-ui) topic:tidb,tiunimanager,ui pushed_at:2026-08 star:0.0k fork:0.0k A web UI for TiUniManager
- [pingcap/website-docs](https://github.com/pingcap/website-docs) topic: pushed_at:2026-08 star:0.0k fork:0.0k The next generation of PingCAP Docs. Powered by Gatsby ⚛️.
