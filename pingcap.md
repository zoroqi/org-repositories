...
- [pingcap/kvproto](https://github.com/pingcap/kvproto) pushed_at:2021-07 star:0.1k fork:0.1k Protocol buffer files for TiKV
- [pingcap/tipb](https://github.com/pingcap/tipb) pushed_at:2021-07 star:0.1k fork:0.1k TiDB protobuf
...
- [pingcap/br](https://github.com/pingcap/br) pushed_at:2021-07 star:0.1k fork:0.1k A command-line tool for distributed backup and restoration of the TiDB cluster data
...
- [pingcap/dm](https://github.com/pingcap/dm) pushed_at:2021-07 star:0.4k fork:0.2k Data Migration Platform
- [pingcap/dt](https://github.com/pingcap/dt) pushed_at:2015-08 star:0.0k fork:0.0k 
- [pingcap/dumpling](https://github.com/pingcap/dumpling) pushed_at:2021-07 star:0.2k fork:0.1k Dumpling is a fast, easy-to-use tool written by Go for dumping data from the database(MySQL, TiDB...) to local/cloud(S3, GCP...) in multifarious formats(SQL, CSV...).
...
- [pingcap/failpoint](https://github.com/pingcap/failpoint) pushed_at:2021-07 star:0.6k fork:0.1k An implementation of failpoints for Golang.
...
- [pingcap/go-tpc](https://github.com/pingcap/go-tpc) pushed_at:2021-07 star:0.1k fork:0.0k A toolbox to benchmark TPC workloads in Go 
...
- [pingcap/mysql-tester](https://github.com/pingcap/mysql-tester) pushed_at:2021-05 star:0.0k fork:0.0k A Golang implementation of MySQL Test Framework
...
- [pingcap/parser](https://github.com/pingcap/parser) pushed_at:2021-07 star:1.0k fork:0.4k A MySQL Compatible SQL Parser
...
- [pingcap/tidb](https://github.com/pingcap/tidb) pushed_at:2021-07 star:28.6k fork:4.5k TiDB is an open source distributed HTAP database compatible with the MySQL protocol 
...
- [pingcap/tidb-dashboard](https://github.com/pingcap/tidb-dashboard) pushed_at:2021-07 star:0.1k fork:0.1k A Web UI for monitoring, diagnosing and managing the TiDB cluster.
...
- [pingcap/tidb-operator](https://github.com/pingcap/tidb-operator) pushed_at:2021-07 star:0.9k fork:0.3k TiDB operator creates and manages TiDB clusters running in Kubernetes.
- [pingcap/tidb-tools](https://github.com/pingcap/tidb-tools) pushed_at:2021-07 star:0.2k fork:0.1k tidb-tools are some useful tool collections for TiDB.
...
- [pingcap/tiup](https://github.com/pingcap/tiup) pushed_at:2021-07 star:0.2k fork:0.2k A component manager for TiDB
...
- [pingcap/pingcap.github.io](https://github.com/pingcap/pingcap.github.io) pushed_at:2021-07 star:0.0k fork:0.0k PingCAP Website
...
- [pingcap/tispark](https://github.com/pingcap/tispark) pushed_at:2021-07 star:0.7k fork:0.2k TiSpark is built for running Apache Spark on top of TiDB/TiKV
...
- [pingcap/tug-website](https://github.com/pingcap/tug-website) pushed_at:2021-07 star:0.0k fork:0.0k 
- [pingcap/website](https://github.com/pingcap/website) pushed_at:2021-07 star:0.0k fork:0.0k The website of PingCAP. Powered by Gatsby ⚛️ and Rocket 🚀.
- [pingcap/website-docs](https://github.com/pingcap/website-docs) pushed_at:2021-07 star:0.0k fork:0.0k The next generation of PingCAP Docs. Powered by Gatsby ⚛️.
...
- [pingcap/django-tidb](https://github.com/pingcap/django-tidb) pushed_at:2021-07 star:0.0k fork:0.0k 
- [pingcap/docs-internals](https://github.com/pingcap/docs-internals) pushed_at:2020-06 star:0.0k fork:0.0k 
- [pingcap/hibernate-tidb](https://github.com/pingcap/hibernate-tidb) pushed_at:2021-07 star:0.0k fork:0.0k 
...
- [pingcap/tidb-dev-guide](https://github.com/pingcap/tidb-dev-guide) pushed_at:2021-07 star:0.0k fork:0.0k A comprehensive development guide to help you be more and more familiar with the TiDB community and become an expert finally.
...
- [pingcap/blog](https://github.com/pingcap/blog) pushed_at:2021-07 star:0.0k fork:0.0k 
- [pingcap/dev-guide](https://github.com/pingcap/dev-guide) pushed_at:2021-02 star:0.0k fork:0.0k 
- [pingcap/docs-dm](https://github.com/pingcap/docs-dm) pushed_at:2021-07 star:0.0k fork:0.1k Documentation for the TiDB Data Migration (DM) tool in both English and Chinese.
- [pingcap/docs-tidb-operator](https://github.com/pingcap/docs-tidb-operator) pushed_at:2021-07 star:0.0k fork:0.1k Documentation for TiDB in Kubernetes in both English and Chinese.
...
- [pingcap/docs](https://github.com/pingcap/docs) pushed_at:2021-07 star:0.5k fork:0.4k TiDB/TiKV/PD documentation.
- [pingcap/docs-cn](https://github.com/pingcap/docs-cn) pushed_at:2021-07 star:1.6k fork:0.9k TiDB/TiKV/PD documentation in Chinese.
...
- [pingcap/tidb-map](https://github.com/pingcap/tidb-map) pushed_at:2021-03 star:0.1k fork:0.0k A series of maps to help users and contributors

## TypeScript

- [pingcap/gdocwiki](https://github.com/pingcap/gdocwiki) pushed_at:2021-07 star:0.1k fork:0.0k A wiki based on Google Doc / Drive
