...
- [pingcap/agfs](https://github.com/pingcap/agfs) topic: pushed_at:2025-12 star:0.0k fork:0.0k Aggregated File System (AGFS), a modern tribute to the spirit of Plan 9
...
- [pingcap/tiflash](https://github.com/pingcap/tiflash) topic: pushed_at:2026-05 star:1.0k fork:0.4k The analytical engine for TiDB and TiDB Cloud. Try free: https://tidbcloud.com/free-trial

## CMake

- [pingcap/kvproto](https://github.com/pingcap/kvproto) topic: pushed_at:2026-06 star:0.2k fork:0.2k Protocol buffer files for TiKV

## Clojure

- [pingcap/jepsen](https://github.com/pingcap/jepsen) topic: pushed_at:2026-05 star:0.0k fork:0.0k A framework for distributed systems verification, with fault injection

## Go

- [pingcap/advanced-statefulset](https://github.com/pingcap/advanced-statefulset) topic: pushed_at:2026-02 star:0.1k fork:0.0k 
...
- [pingcap/diag](https://github.com/pingcap/diag) topic: pushed_at:2026-03 star:0.0k fork:0.0k A tool to collect diagnostic data from TiDB Clusters
...
- [pingcap/errors](https://github.com/pingcap/errors) topic: pushed_at:2026-05 star:0.0k fork:0.0k Simple error handling primitives
...
- [pingcap/failpoint](https://github.com/pingcap/failpoint) topic:failpoint,failure-injection,fault-injection,golang pushed_at:2026-05 star:0.9k fork:0.1k An implementation of failpoints for Golang.
...
- [pingcap/go-tpc](https://github.com/pingcap/go-tpc) topic: pushed_at:2026-01 star:0.2k fork:0.1k A toolbox to benchmark TPC workloads in Go 
...
- [pingcap/log](https://github.com/pingcap/log) topic: pushed_at:2026-02 star:0.0k fork:0.0k 
- [pingcap/metering_sdk](https://github.com/pingcap/metering_sdk) topic: pushed_at:2026-03 star:0.0k fork:0.0k 
...
- [pingcap/mysql-tester](https://github.com/pingcap/mysql-tester) topic: pushed_at:2026-01 star:0.1k fork:0.1k A Golang implementation of MySQL Test Framework
...
- [pingcap/ng-monitoring](https://github.com/pingcap/ng-monitoring) topic: pushed_at:2026-04 star:0.0k fork:0.0k 
...
- [pingcap/ticdc](https://github.com/pingcap/ticdc) topic: pushed_at:2026-05 star:0.1k fork:0.1k TiCDC pulls change logs out of TiDB and pushes to kinds of systems.
- [pingcap/tidb](https://github.com/pingcap/tidb) topic:agent,agent-context,agent-memory,agentic,ai,cloud-native,database,distributed-database,distributed-transactions,go,hacktoberfest,htap,memory,mysql,mysql-compatibility,scale,serverless,sql,tidb pushed_at:2026-06 star:40.1k fork:6.2k TiDB is built for agentic workloads that grow unpredictably, with ACID guarantees and native support for transactions, analytics, and vector search. No data silos. No noisy neighbors. No infrastructure ceiling.
- [pingcap/tidb-binlog](https://github.com/pingcap/tidb-binlog) topic: pushed_at:2026-05 star:0.3k fork:0.1k A tool used to collect and merge tidb's binlog for real-time data backup and synchronization.
...
- [pingcap/tidb-operator](https://github.com/pingcap/tidb-operator) topic:cloud-native,golang,hacktoberfest,kubernetes,operator,tidb pushed_at:2026-05 star:1.3k fork:0.5k TiDB operator creates and manages TiDB clusters running in Kubernetes.
- [pingcap/tidb-tools](https://github.com/pingcap/tidb-tools) topic: pushed_at:2026-05 star:0.3k fork:0.2k tidb-tools are some useful tool collections for TiDB.
...
- [pingcap/tiflow](https://github.com/pingcap/tiflow) topic:cdc,dm,kafka,mysql,ticdc,tidb pushed_at:2026-05 star:0.5k fork:0.3k This repo maintains DM (a data migration platform) and TiCDC (change data capture for TiDB)
...
- [pingcap/tiproxy](https://github.com/pingcap/tiproxy) topic: pushed_at:2026-06 star:0.1k fork:0.0k 
- [pingcap/tiunimanager](https://github.com/pingcap/tiunimanager) topic: pushed_at:2026-05 star:0.0k fork:0.0k TiUniManager
- [pingcap/tiup](https://github.com/pingcap/tiup) topic:cluster,playground,tidb,tidb-components,tiup pushed_at:2026-05 star:0.5k fork:0.3k A component manager for TiDB
...
- [pingcap/discourse-theme-asktug](https://github.com/pingcap/discourse-theme-asktug) topic: pushed_at:2026-03 star:0.0k fork:0.0k A discourse theme used in AskTUG.
...
- [pingcap/docs-cn](https://github.com/pingcap/docs-cn) topic:hacktoberfest,tidb,tidb-documentation pushed_at:2026-06 star:1.8k fork:1.2k TiDB/TiKV/PD 中文文档
- [pingcap/docs-staging](https://github.com/pingcap/docs-staging) topic: pushed_at:2026-06 star:0.0k fork:0.0k 
- [pingcap/docs-toolkit](https://github.com/pingcap/docs-toolkit) topic: pushed_at:2026-05 star:0.0k fork:0.0k The essential utility library for automating, validating, and ensuring the quality and consistency of the official TiDB documentation.
...
- [pingcap/awesome-database-learning](https://github.com/pingcap/awesome-database-learning) topic:awesome,awesome-list,blogs,books,course,database,papers pushed_at:2024-08 star:10.9k fork:1.2k A list of learning materials to understand databases internals
...
- [pingcap/community](https://github.com/pingcap/community) topic: pushed_at:2026-05 star:0.3k fork:0.2k TiDB community content
...
- [pingcap/sarama](https://github.com/pingcap/sarama) topic: pushed_at:2026-05 star:0.0k fork:0.0k Sarama is a Go library for Apache Kafka.
...
- [pingcap/tidb-dev-guide](https://github.com/pingcap/tidb-dev-guide) topic:development,distributed-database,guide,tidb pushed_at:2026-05 star:0.1k fork:0.1k A comprehensive development guide to help you be more and more familiar with the TiDB community and become an expert finally.
...
- [pingcap/wordpress-tidb-plugin](https://github.com/pingcap/wordpress-tidb-plugin) topic: pushed_at:2025-08 star:0.0k fork:0.0k 
...
- [pingcap/agent-rules](https://github.com/pingcap/agent-rules) topic: pushed_at:2026-04 star:0.0k fork:0.0k Agentic Store Skills
...
- [pingcap/docs-tidb-operator](https://github.com/pingcap/docs-tidb-operator) topic:hacktoberfest,tidb-in-kubernetes,tidb-operator,tidb-operator-documentation pushed_at:2026-05 star:0.1k fork:0.1k Documentation for TiDB on Kubernetes. TiDB is an open-source, cloud-native, distributed, MySQL-Compatible database for elastic scale and real-time analytics. Try AI-powered Chat2Query free at: https://www.pingcap.com/tidb-cloud-serverless/
...
- [pingcap/pytidb](https://github.com/pingcap/pytidb) topic:ai,embeddings,fulltext-search,hnsw,hybrid-search,multi-modal,rag,semantic-search,similarity-search,sql,tidb,vector-search pushed_at:2026-03 star:0.0k fork:0.0k TiDB AI SDK: Unified Multi-Modal Data Platform for AI Apps & Agents
...
- [pingcap/tidb-vector-python](https://github.com/pingcap/tidb-vector-python) topic:python,tidb-vector,tidbcloud pushed_at:2025-07 star:0.1k fork:0.0k TiDB Vector SDK for Python, including code examples. Join our Discord: https://discord.gg/XzSW23Jg9p

## Ruby

- [pingcap/activerecord-tidb-adapter](https://github.com/pingcap/activerecord-tidb-adapter) topic:activerecord,mysql,rails,tidb pushed_at:2025-11 star:0.0k fork:0.0k TiDB adapter for ActiveRecord, allows the use of TiDB as a backend for ActiveRecord and Rails apps.
...
- [pingcap/tantivy](https://github.com/pingcap/tantivy) topic: pushed_at:2026-05 star:0.0k fork:0.0k Tantivy is a full-text search engine library inspired by Apache Lucene and written in Rust
- [pingcap/tidb-engine-ext](https://github.com/pingcap/tidb-engine-ext) topic: pushed_at:2026-05 star:0.0k fork:0.0k A TiKV based `c dynamic library` for extending storage system in TiDB cluster

## Scala

- [pingcap/tispark](https://github.com/pingcap/tispark) topic:bigdata,spark,tidb,tikv pushed_at:2026-05 star:0.9k fork:0.3k TiSpark is built for running Apache Spark on top of TiDB/TiKV
...
- [pingcap/monitoring](https://github.com/pingcap/monitoring) topic: pushed_at:2026-06 star:0.0k fork:0.0k 
...
- [pingcap/tipb](https://github.com/pingcap/tipb) topic: pushed_at:2026-05 star:0.1k fork:0.2k TiDB protobuf
...
- [pingcap/ossinsight](https://github.com/pingcap/ossinsight) topic:aisql,analytics,chat2query,demo,github,htap,insight,openai,oss,realtime,text2sql pushed_at:2026-05 star:2.4k fork:0.4k Analysis, Comparison, Trends, Rankings of Open Source Software, you can also get insight from more than 10 billion with natural language (powered by LLM). Follow us on Twitter: https://twitter.com/ossinsight
...
- [pingcap/tidb-dashboard](https://github.com/pingcap/tidb-dashboard) topic:dashboard,tidb,troubleshooting,ui pushed_at:2026-05 star:0.2k fork:0.2k A Web UI for monitoring, diagnosing and managing the TiDB cluster.
...
- [pingcap/tiunimanager-ui](https://github.com/pingcap/tiunimanager-ui) topic:tidb,tiunimanager,ui pushed_at:2026-05 star:0.0k fork:0.0k A web UI for TiUniManager
- [pingcap/website-docs](https://github.com/pingcap/website-docs) topic: pushed_at:2026-05 star:0.0k fork:0.0k The next generation of PingCAP Docs. Powered by Gatsby ⚛️.
