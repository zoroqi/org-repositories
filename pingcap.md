...
- [pingcap/poco](https://github.com/pingcap/poco) topic: pushed_at:2023-04 star:0.0k fork:0.0k POCO C++ Libraries - Cross-platform C++ libraries with a network/internet focus.
...
- [pingcap/tiflash](https://github.com/pingcap/tiflash) topic: pushed_at:2023-09 star:0.9k fork:0.4k The analytical engine for TiDB and TiDB Cloud. Try free: https://tidbcloud.com/free-trial

## CMake

- [pingcap/kvproto](https://github.com/pingcap/kvproto) topic: pushed_at:2023-08 star:0.1k fork:0.2k Protocol buffer files for TiKV
- [pingcap/tipb](https://github.com/pingcap/tipb) topic: pushed_at:2023-08 star:0.1k fork:0.1k TiDB protobuf

## Clojure

- [pingcap/jepsen](https://github.com/pingcap/jepsen) topic: pushed_at:2023-08 star:0.0k fork:0.0k A framework for distributed systems verification, with fault injection

## Go

- [pingcap/advanced-statefulset](https://github.com/pingcap/advanced-statefulset) topic: pushed_at:2023-08 star:0.1k fork:0.0k 
- [pingcap/badger](https://github.com/pingcap/badger) topic: pushed_at:2023-01 star:0.0k fork:0.0k Fast key-value DB in Go.
- [pingcap/br](https://github.com/pingcap/br) topic:backup,distributed-database,point-in-time,restore,tidb pushed_at:2023-03 star:0.1k fork:0.1k A command-line tool for distributed backup and restoration of the TiDB cluster data
...
- [pingcap/diag](https://github.com/pingcap/diag) topic: pushed_at:2023-08 star:0.0k fork:0.0k A tool to collect diagnostic data from TiDB Clusters
...
- [pingcap/errcode](https://github.com/pingcap/errcode) topic: pushed_at:2023-06 star:0.0k fork:0.0k 
- [pingcap/errors](https://github.com/pingcap/errors) topic: pushed_at:2022-10 star:0.0k fork:0.0k Simple error handling primitives
...
- [pingcap/failpoint](https://github.com/pingcap/failpoint) topic:failpoint,failure-injection,fault-injection,golang pushed_at:2022-08 star:0.8k fork:0.1k An implementation of failpoints for Golang.
...
- [pingcap/go-tpc](https://github.com/pingcap/go-tpc) topic: pushed_at:2023-04 star:0.1k fork:0.1k A toolbox to benchmark TPC workloads in Go 
- [pingcap/go-ycsb](https://github.com/pingcap/go-ycsb) topic: pushed_at:2023-08 star:0.5k fork:0.2k A Go port of Yahoo! Cloud Serving Benchmark (YCSB) 
...
- [pingcap/log](https://github.com/pingcap/log) topic: pushed_at:2023-03 star:0.0k fork:0.0k 
...
- [pingcap/mysql-tester](https://github.com/pingcap/mysql-tester) topic: pushed_at:2023-08 star:0.1k fork:0.1k A Golang implementation of MySQL Test Framework
...
- [pingcap/ng-monitoring](https://github.com/pingcap/ng-monitoring) topic: pushed_at:2023-08 star:0.0k fork:0.0k 
...
- [pingcap/parser](https://github.com/pingcap/parser) topic: pushed_at:2023-02 star:1.4k fork:0.5k A MySQL Compatible SQL Parser
...
- [pingcap/sysutil](https://github.com/pingcap/sysutil) topic: pushed_at:2023-07 star:0.0k fork:0.0k sysutil is a library which implementats the gRPC service Diagnostics and shares the diagnostics functions between TiDB and PD.
- [pingcap/tidb](https://github.com/pingcap/tidb) topic:cloud-native,database,distributed-database,distributed-transactions,go,hacktoberfest,htap,mysql,mysql-compatibility,scale,serverless,sql,tidb pushed_at:2023-09 star:34.7k fork:5.6k TiDB is an open-source, cloud-native, distributed, MySQL-Compatible database for elastic scale and real-time analytics. Try AI-powered Chat2Query free at : https://tidbcloud.com/free-trial
- [pingcap/tidb-binlog](https://github.com/pingcap/tidb-binlog) topic: pushed_at:2023-08 star:0.3k fork:0.1k A tool used to collect and merge tidb's binlog for real-time data backup and synchronization.
...
- [pingcap/tidb-operator](https://github.com/pingcap/tidb-operator) topic:cloud-native,golang,hacktoberfest,kubernetes,operator,tidb pushed_at:2023-08 star:1.1k fork:0.5k TiDB operator creates and manages TiDB clusters running in Kubernetes.
- [pingcap/tidb-tools](https://github.com/pingcap/tidb-tools) topic: pushed_at:2023-08 star:0.3k fork:0.2k tidb-tools are some useful tool collections for TiDB.
...
- [pingcap/tiflow](https://github.com/pingcap/tiflow) topic:cdc,dm,kafka,mysql,ticdc,tidb pushed_at:2023-08 star:0.4k fork:0.2k This repo maintains DM (a data migration platform) and TiCDC (change data capture for TiDB)
- [pingcap/tiflow-operator](https://github.com/pingcap/tiflow-operator) topic: pushed_at:2023-02 star:0.0k fork:0.0k TiFlow-Operator creates and manages TiFlow clusters running in Kubernetes.
...
- [pingcap/TiProxy](https://github.com/pingcap/TiProxy) topic: pushed_at:2023-08 star:0.0k fork:0.0k 
- [pingcap/tiunimanager](https://github.com/pingcap/tiunimanager) topic: pushed_at:2023-08 star:0.0k fork:0.0k TiUniManager
- [pingcap/tiup](https://github.com/pingcap/tiup) topic:cluster,playground,tidb,tidb-components,tiup pushed_at:2023-08 star:0.4k fork:0.3k A component manager for TiDB
...
- [pingcap/discourse-theme-asktug](https://github.com/pingcap/discourse-theme-asktug) topic: pushed_at:2023-04 star:0.0k fork:0.0k A discourse theme used in AskTUG.
- [pingcap/sqlgram](https://github.com/pingcap/sqlgram) topic: pushed_at:2020-05 star:0.0k fork:0.0k TiDB SQL

## Java

- [pingcap/benchmarksql](https://github.com/pingcap/benchmarksql) topic: pushed_at:2023-06 star:0.1k fork:0.1k mirror of benchmarksql on github
...
- [pingcap/mysql-connector-j](https://github.com/pingcap/mysql-connector-j) topic: pushed_at:2022-11 star:0.0k fork:0.0k MySQL Connector/J
...
- [pingcap/tidb-loadbalance](https://github.com/pingcap/tidb-loadbalance) topic: pushed_at:2023-04 star:0.0k fork:0.0k 
...
- [pingcap/book.tidb.net](https://github.com/pingcap/book.tidb.net) topic: pushed_at:2023-05 star:0.0k fork:0.0k 
...
- [pingcap/docs-staging](https://github.com/pingcap/docs-staging) topic: pushed_at:2023-08 star:0.0k fork:0.0k 
...
- [pingcap/awesome-database-learning](https://github.com/pingcap/awesome-database-learning) topic:awesome,awesome-list,blogs,books,course,database,papers pushed_at:2023-07 star:6.7k fork:0.9k A list of learning materials to understand databases internals
...
- [pingcap/community](https://github.com/pingcap/community) topic: pushed_at:2023-08 star:0.3k fork:0.2k TiDB community content
...
- [pingcap/tidb-dev-guide](https://github.com/pingcap/tidb-dev-guide) topic:development,distributed-database,guide,tidb pushed_at:2023-08 star:0.1k fork:0.1k A comprehensive development guide to help you be more and more familiar with the TiDB community and become an expert finally.
...
- [pingcap/dbt-tidb](https://github.com/pingcap/dbt-tidb) topic:dataanalysis,database,dbt,mysql,python,sql,tidb pushed_at:2023-01 star:0.0k fork:0.0k A dbt adapter for TiDB
- [pingcap/django-tidb](https://github.com/pingcap/django-tidb) topic:django,python,tidb pushed_at:2023-08 star:0.0k fork:0.0k TiDB dialect for Django
- [pingcap/docs](https://github.com/pingcap/docs) topic:hacktoberfest,tidb,tidb-documentation pushed_at:2023-09 star:0.5k fork:0.6k TiDB database documentation.
- [pingcap/docs-appdev](https://github.com/pingcap/docs-appdev) topic: pushed_at:2022-06 star:0.0k fork:0.0k 
- [pingcap/docs-dm](https://github.com/pingcap/docs-dm) topic:dm-documentation,hacktoberfest,tidb-data-migration,tidb-dm pushed_at:2022-09 star:0.0k fork:0.1k Documentation for the TiDB Data Migration (DM) tool in both English and Chinese.
- [pingcap/docs-tidb-operator](https://github.com/pingcap/docs-tidb-operator) topic:hacktoberfest,tidb-in-kubernetes,tidb-operator,tidb-operator-documentation pushed_at:2023-08 star:0.0k fork:0.1k Documentation for TiDB on Kubernetes in both English and Chinese.
...
- [pingcap/sqlalchemy-tidb](https://github.com/pingcap/sqlalchemy-tidb) topic: pushed_at:2023-07 star:0.0k fork:0.0k 
...
- [pingcap/tidb-docker-compose](https://github.com/pingcap/tidb-docker-compose) topic: pushed_at:2022-07 star:0.3k fork:0.1k 
...
- [pingcap/activerecord-tidb-adapter](https://github.com/pingcap/activerecord-tidb-adapter) topic:activerecord,mysql,rails,tidb pushed_at:2023-06 star:0.0k fork:0.0k TiDB adapter for ActiveRecord, allows the use of TiDB as a backend for ActiveRecord and Rails apps.
...
- [pingcap/talent-plan](https://github.com/pingcap/talent-plan) topic:distributed-database,distributed-systems,golang,open-source,pingcap,rust,talent-plan pushed_at:2023-07 star:9.2k fork:1.2k open source training courses about distributed database and distributed systems
- [pingcap/tidb-engine-ext](https://github.com/pingcap/tidb-engine-ext) topic: pushed_at:2023-08 star:0.0k fork:0.0k A TiKV based `c dynamic library` for extending storage system in TiDB cluster

## Scala

- [pingcap/tispark](https://github.com/pingcap/tispark) topic:bigdata,spark,tidb,tikv pushed_at:2023-08 star:0.9k fork:0.2k TiSpark is built for running Apache Spark on top of TiDB/TiKV
...
- [pingcap/docs-cn](https://github.com/pingcap/docs-cn) topic:hacktoberfest,tidb,tidb-documentation pushed_at:2023-09 star:1.8k fork:1.2k TiDB/TiKV/PD 中文文档
...
- [pingcap/monitoring](https://github.com/pingcap/monitoring) topic: pushed_at:2023-08 star:0.0k fork:0.0k 
- [pingcap/tidb-course-201-lab](https://github.com/pingcap/tidb-course-201-lab) topic: pushed_at:2023-08 star:0.0k fork:0.0k Lab scripts for the PingCAP training course: TiDB SQL for Developers.
- [pingcap/tidb-helper](https://github.com/pingcap/tidb-helper) topic:brew,deb,rpm pushed_at:2020-04 star:0.0k fork:0.0k 

## TLA

- [pingcap/tla-plus](https://github.com/pingcap/tla-plus) topic: pushed_at:2023-08 star:0.3k fork:0.0k 
...
- [pingcap/ossinsight](https://github.com/pingcap/ossinsight) topic:aisql,analytics,chat2query,demo,github,htap,insight,openai,oss,realtime,text2sql pushed_at:2023-08 star:1.3k fork:0.3k Analysis, Comparison, Trends, Rankings of Open Source Software, you can also get insight from more than 6 billion with natural language (powered by OpenAI). Follow us on Twitter: https://twitter.com/ossinsight
- [pingcap/ossinsight-lite](https://github.com/pingcap/ossinsight-lite) topic: pushed_at:2023-08 star:0.4k fork:0.1k 🚧[WIP] Yet another customizable free GitHub stats dashboard based on TiDB Serverless: https://ossinsight-lite.vercel.app, hand-drawn style.
- [pingcap/ossinsight-next](https://github.com/pingcap/ossinsight-next) topic: pushed_at:2023-09 star:0.0k fork:0.0k 
- [pingcap/realtime-hackernewsdb-on-serverless](https://github.com/pingcap/realtime-hackernewsdb-on-serverless) topic:autogpt,chatgpt,database,hackernews,mysql-compatibility,openai,tidbcloud pushed_at:2023-04 star:0.0k fork:0.0k Chat to query Hacker News database, based on Auto-GPT and TiDB Cloud Serverless Database
- [pingcap/sp500-insight-template](https://github.com/pingcap/sp500-insight-template) topic: pushed_at:2023-08 star:0.0k fork:0.0k SP500 Insight vercel template based on TiDB Cloud Data API: https://sp500-insight.vercel.app
...
- [pingcap/tidb-dashboard](https://github.com/pingcap/tidb-dashboard) topic:dashboard,tidb,troubleshooting,ui pushed_at:2023-08 star:0.2k fork:0.1k A Web UI for monitoring, diagnosing and managing the TiDB cluster.
...
- [pingcap/tidb-prisma-vercel-demo](https://github.com/pingcap/tidb-prisma-vercel-demo) topic:bookstore,ecommerce,nextjs,prisma,tidb,tidbcloud,vercel pushed_at:2023-08 star:0.0k fork:0.0k Virtual online bookstore application demo which you can find books of various categories and rate the books.
- [pingcap/tiunimanager-ui](https://github.com/pingcap/tiunimanager-ui) topic:tidb,tiunimanager,ui pushed_at:2023-08 star:0.0k fork:0.0k A web UI for TiUniManager
- [pingcap/website-docs](https://github.com/pingcap/website-docs) topic: pushed_at:2023-08 star:0.0k fork:0.0k The next generation of PingCAP Docs. Powered by Gatsby ⚛️.
