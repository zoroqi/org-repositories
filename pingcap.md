...
- [pingcap/boost-extra](https://github.com/pingcap/boost-extra) pushed_at:2021-06 star:0.0k fork:0.0k extra boost libs for libhdfs3
...
- [pingcap/kvproto](https://github.com/pingcap/kvproto) pushed_at:2021-08 star:0.1k fork:0.1k Protocol buffer files for TiKV
- [pingcap/tipb](https://github.com/pingcap/tipb) pushed_at:2021-08 star:0.1k fork:0.1k TiDB protobuf
...
- [pingcap/advanced-statefulset](https://github.com/pingcap/advanced-statefulset) pushed_at:2020-06 star:0.0k fork:0.0k 
- [pingcap/badger](https://github.com/pingcap/badger) pushed_at:2021-05 star:0.0k fork:0.0k Fast key-value DB in Go.
- [pingcap/br](https://github.com/pingcap/br) pushed_at:2021-08 star:0.1k fork:0.1k A command-line tool for distributed backup and restoration of the TiDB cluster data
...
- [pingcap/go-randgen](https://github.com/pingcap/go-randgen) pushed_at:2021-06 star:0.1k fork:0.0k a QA tool to random generate sql by bnf pattern
...
- [pingcap/go-tpc](https://github.com/pingcap/go-tpc) pushed_at:2021-08 star:0.1k fork:0.0k A toolbox to benchmark TPC workloads in Go 
- [pingcap/go-ycsb](https://github.com/pingcap/go-ycsb) pushed_at:2021-07 star:0.3k fork:0.1k A Go port of Yahoo! Cloud Serving Benchmark (YCSB) 
...
- [pingcap/mysql-tester](https://github.com/pingcap/mysql-tester) pushed_at:2021-08 star:0.0k fork:0.0k A Golang implementation of MySQL Test Framework
...
- [pingcap/parser](https://github.com/pingcap/parser) pushed_at:2021-08 star:1.0k fork:0.4k A MySQL Compatible SQL Parser
...
- [pingcap/ticdc](https://github.com/pingcap/ticdc) pushed_at:2021-08 star:0.1k fork:0.1k Change data capture for TiDB
- [pingcap/tidb](https://github.com/pingcap/tidb) pushed_at:2021-08 star:28.6k fork:4.5k TiDB is an open source distributed HTAP database compatible with the MySQL protocol 
- [pingcap/tidb-binlog](https://github.com/pingcap/tidb-binlog) pushed_at:2021-08 star:0.2k fork:0.1k A tool used to collect and merge tidb's binlog for real-time data backup and synchronization.
...
- [pingcap/tidb-dashboard](https://github.com/pingcap/tidb-dashboard) pushed_at:2021-08 star:0.1k fork:0.1k A Web UI for monitoring, diagnosing and managing the TiDB cluster.
...
- [pingcap/tidb-operator](https://github.com/pingcap/tidb-operator) pushed_at:2021-08 star:0.9k fork:0.3k TiDB operator creates and manages TiDB clusters running in Kubernetes.
- [pingcap/tidb-tools](https://github.com/pingcap/tidb-tools) pushed_at:2021-08 star:0.2k fork:0.1k tidb-tools are some useful tool collections for TiDB.
- [pingcap/tidiff](https://github.com/pingcap/tidiff) pushed_at:2020-01 star:0.0k fork:0.0k A toolset to improve efficiency 
- [pingcap/tipocket](https://github.com/pingcap/tipocket) pushed_at:2021-07 star:0.1k fork:0.1k A toolkit for testing TiDB
- [pingcap/tiup](https://github.com/pingcap/tiup) pushed_at:2021-08 star:0.2k fork:0.2k A component manager for TiDB
...
- [pingcap/pingcap.github.io](https://github.com/pingcap/pingcap.github.io) pushed_at:2021-08 star:0.0k fork:0.0k PingCAP Website
...
- [pingcap/tispark](https://github.com/pingcap/tispark) pushed_at:2021-08 star:0.7k fork:0.2k TiSpark is built for running Apache Spark on top of TiDB/TiKV

## JavaScript

- [pingcap/campaign](https://github.com/pingcap/campaign) pushed_at:2020-09 star:0.0k fork:0.0k 
- [pingcap/community-website](https://github.com/pingcap/community-website) pushed_at:2021-08 star:0.0k fork:0.0k 
- [pingcap/tidb-vision](https://github.com/pingcap/tidb-vision) pushed_at:2021-05 star:0.0k fork:0.0k TiDB data visualization
- [pingcap/tug-website](https://github.com/pingcap/tug-website) pushed_at:2021-08 star:0.0k fork:0.0k 
- [pingcap/website](https://github.com/pingcap/website) pushed_at:2021-08 star:0.0k fork:0.0k The website of PingCAP. Powered by Gatsby ⚛️ and Rocket 🚀.
- [pingcap/website-docs](https://github.com/pingcap/website-docs) pushed_at:2021-08 star:0.0k fork:0.0k The next generation of PingCAP Docs. Powered by Gatsby ⚛️.
...
- [pingcap/awesome-database-learning](https://github.com/pingcap/awesome-database-learning) pushed_at:2021-07 star:3.3k fork:0.4k A list of learning materials to understand databases internals
...
- [pingcap/presentations](https://github.com/pingcap/presentations) pushed_at:2021-07 star:0.3k fork:0.1k 
...
- [pingcap/tidb-dev-guide](https://github.com/pingcap/tidb-dev-guide) pushed_at:2021-08 star:0.0k fork:0.0k A comprehensive development guide to help you be more and more familiar with the TiDB community and become an expert finally.
...
- [pingcap/blog](https://github.com/pingcap/blog) pushed_at:2021-08 star:0.0k fork:0.0k 
- [pingcap/dev-guide](https://github.com/pingcap/dev-guide) pushed_at:2021-02 star:0.0k fork:0.0k 
- [pingcap/django-tidb](https://github.com/pingcap/django-tidb) pushed_at:2021-08 star:0.0k fork:0.0k 
- [pingcap/docs-dm](https://github.com/pingcap/docs-dm) pushed_at:2021-08 star:0.0k fork:0.1k Documentation for the TiDB Data Migration (DM) tool in both English and Chinese.
- [pingcap/docs-tidb-operator](https://github.com/pingcap/docs-tidb-operator) pushed_at:2021-08 star:0.0k fork:0.1k Documentation for TiDB in Kubernetes in both English and Chinese.
...
- [pingcap/tidb-docker-compose](https://github.com/pingcap/tidb-docker-compose) pushed_at:2021-07 star:0.2k fork:0.1k 
...
- [pingcap/activerecord-tidb-adapter](https://github.com/pingcap/activerecord-tidb-adapter) pushed_at:2021-08 star:0.0k fork:0.0k TiDB adapter for ActiveRecord, allows the use of TiDB as a backend for ActiveRecord and Rails apps.
- [pingcap/discourse](https://github.com/pingcap/discourse) pushed_at:2021-07 star:0.0k fork:0.0k A platform for community discussion. Free, open, simple.
...
- [pingcap/talent-plan](https://github.com/pingcap/talent-plan) pushed_at:2021-07 star:6.4k fork:0.8k open source training courses about distributed database and distributed systemes
...
- [pingcap/blog-cn](https://github.com/pingcap/blog-cn) pushed_at:2021-07 star:0.1k fork:0.1k 
...
- [pingcap/docs](https://github.com/pingcap/docs) pushed_at:2021-08 star:0.5k fork:0.4k TiDB/TiKV/PD documentation.
- [pingcap/docs-cn](https://github.com/pingcap/docs-cn) pushed_at:2021-08 star:1.6k fork:0.9k TiDB/TiKV/PD documentation in Chinese.
...
- [pingcap/monitoring](https://github.com/pingcap/monitoring) pushed_at:2021-07 star:0.0k fork:0.0k 
- [pingcap/tidb-helper](https://github.com/pingcap/tidb-helper) pushed_at:2020-04 star:0.0k fork:0.0k 

## TLA

- [pingcap/tla-plus](https://github.com/pingcap/tla-plus) pushed_at:2021-07 star:0.2k fork:0.0k 
...
- [pingcap/tidb-map](https://github.com/pingcap/tidb-map) pushed_at:2021-08 star:0.1k fork:0.0k A series of maps to help users and contributors

## TypeScript

- [pingcap/gdocwiki](https://github.com/pingcap/gdocwiki) pushed_at:2021-08 star:0.1k fork:0.0k A wiki based on Google Doc / Drive
