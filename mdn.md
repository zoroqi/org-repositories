...
- [mdn/beginner-html-site](https://github.com/mdn/beginner-html-site) topic:example,html,learning pushed_at:2026-03 star:0.3k fork:0.4k A simple one page website created to help complete beginners learn HTML basics.
- [mdn/beginner-html-site-scripted](https://github.com/mdn/beginner-html-site-scripted) topic:example,html,javascript,learning pushed_at:2026-06 star:0.3k fork:0.3k A single-page website created to help complete beginners learn HTML with JS added to help beginners learn JavaScript. Supports https://developer.mozilla.org/en-US/Learn/Getting_started_with_the_web/JavaScript_basics 
- [mdn/beginner-html-site-styled](https://github.com/mdn/beginner-html-site-styled) topic: pushed_at:2026-06 star:0.3k fork:1.0k A simple one page website created to help complete beginners learn HTML basics, which in this repo has also been styled to help beginners learn CSS basics. The styling is explained over the course of https://developer.mozilla.org/en-US/Learn/Getting_started_with_the_web/CSS_basics.
...
- [mdn/css-examples](https://github.com/mdn/css-examples) topic:css,examples pushed_at:2026-06 star:0.6k fork:0.8k Code examples that accompany the MDN CSS documentation
...
- [mdn/houdini-examples](https://github.com/mdn/houdini-examples) topic:css,examples,houdini pushed_at:2026-06 star:0.0k fork:0.0k CSS Houdini examples relating to MDN content.
- [mdn/html-examples](https://github.com/mdn/html-examples) topic:examples,html pushed_at:2026-06 star:0.1k fork:0.1k Code examples that accompany the MDN HTML documentation: https://developer.mozilla.org/en-US/docs/Web/HTML
- [mdn/imsc-examples](https://github.com/mdn/imsc-examples) topic:captioning,examples,media,subtitles,web pushed_at:2026-06 star:0.0k fork:0.0k Repository for examples to go along with MDN IMSC documentation.
...
- [mdn/learning-area](https://github.com/mdn/learning-area) topic:learning,learning-js,learning-to-code,mdn-docs pushed_at:2026-04 star:7.6k fork:27.3k GitHub repo for the MDN Learning Area. 
...
- [mdn/watify](https://github.com/mdn/watify) topic: pushed_at:2026-06 star:0.0k fork:0.0k Compile WAT to WASM with WASM 🙇
- [mdn/web-tech-games](https://github.com/mdn/web-tech-games) topic: pushed_at:2026-06 star:0.0k fork:0.0k Interactive diagram showing what parts of the web technology stack can used for different purposes when creating games. Includes links to more information about each.
...
- [mdn/bcd-utils](https://github.com/mdn/bcd-utils) topic:bcd,browser-compat-data,infra,tooling pushed_at:2026-06 star:0.0k fork:0.0k 
...
- [mdn/client-toolchain-example](https://github.com/mdn/client-toolchain-example) topic:demo,examples,javascript,toolchain pushed_at:2026-06 star:0.0k fork:0.0k Demo project for the MDN client-side web development tools tutorial.
- [mdn/content-inventory](https://github.com/mdn/content-inventory) topic: pushed_at:2026-06 star:0.0k fork:0.0k Inventory of MDN content
- [mdn/data](https://github.com/mdn/data) topic:css,data,json,json-data pushed_at:2026-06 star:0.8k fork:0.2k This repository contains general data for Web technologies
- [mdn/dex](https://github.com/mdn/dex) topic: pushed_at:2026-06 star:0.0k fork:0.0k MDN's deployment infrastructure.
...
- [mdn/dom-examples](https://github.com/mdn/dom-examples) topic:channel-messaging,demo,dom-manipulation,drag-drop,javascript,matchmedia,mdn,pointer-events,pointer-lock,touch-events pushed_at:2026-06 star:4.0k fork:1.9k Code examples that accompany various MDN DOM and Web API documentation pages
...
- [mdn/express-locallibrary-tutorial](https://github.com/mdn/express-locallibrary-tutorial) topic:demo,example,express,nodejs,webapp pushed_at:2026-06 star:1.3k fork:0.8k Local Library website written in NodeJS/Express; example for the MDN server-side development NodeJS module: https://developer.mozilla.org/en-US/docs/Learn/Server-side/Express_Nodejs.
- [mdn/fred](https://github.com/mdn/fred) topic:lit,ssr,web-components pushed_at:2026-07 star:0.2k fork:0.1k MDN's frontend since late 2025, built with Web Components, Lit, and SSR for a fast, clean documentation experience. Fred = /fr(ont)e(n)d/.
...
- [mdn/mcp](https://github.com/mdn/mcp) topic: pushed_at:2026-06 star:0.1k fork:0.0k MDN's prototype MCP server
...
- [mdn/mdn-http-observatory](https://github.com/mdn/mdn-http-observatory) topic:http,http-headers,mdn,privacy,security,security-tools pushed_at:2026-06 star:0.1k fork:0.0k Backend for HTTP Observatory on MDN
...
- [mdn/museum](https://github.com/mdn/museum) topic:archive,examples pushed_at:2026-06 star:0.0k fork:0.0k A historic collection of MDN Web Docs content and examples
...
- [mdn/pwa-examples](https://github.com/mdn/pwa-examples) topic:examples,progressive-web-app,pwa pushed_at:2026-06 star:1.0k fork:0.6k Examples for progressive web apps.
...
- [mdn/todo-react](https://github.com/mdn/todo-react) topic:demo,example,react,todo pushed_at:2026-06 star:0.3k fork:0.3k Sample todo app built with the React/ReactDOM framework.
- [mdn/tree-sitter-mdn](https://github.com/mdn/tree-sitter-mdn) topic: pushed_at:2026-06 star:0.0k fork:0.0k MDN's macro grammar for tree-sitter
- [mdn/triagebot](https://github.com/mdn/triagebot) topic:automation pushed_at:2026-06 star:0.0k fork:0.0k 
...
- [mdn/webextensions-examples](https://github.com/mdn/webextensions-examples) topic:browser,mdn,webextensions,webextensions-apis pushed_at:2026-06 star:4.5k fork:2.6k Example Firefox add-ons created using the WebExtensions API
...
- [mdn/content](https://github.com/mdn/content) topic:css,documentation,html,http,javascript,learning,mdn,reference,web-development,web-standards pushed_at:2026-06 star:10.8k fork:23.2k The official source for MDN Web Docs content. Home to over 14,000 pages of documentation about HTML, CSS, JS, HTTP, Web APIs, and more.
- [mdn/translated-content](https://github.com/mdn/translated-content) topic:documentation,l10n,localization,mdn,web-development,web-platform pushed_at:2026-06 star:2.0k fork:8.3k 7 community-maintained translations of MDN Web Docs in ES, FR, JA, KO, PT-BR, RU, and ZH, to learn and contribute in your native language.
- [mdn/translated-content-de](https://github.com/mdn/translated-content-de) topic: pushed_at:2026-06 star:0.0k fork:0.0k Experimental German locale for MDN, aimed at German-speaking users that prefer to read MDN Web Docs in their native language
- [mdn/translated-content-it](https://github.com/mdn/translated-content-it) topic: pushed_at:2026-06 star:0.0k fork:0.0k Experimental Italian locale for MDN, aimed at Italian-speaking users that prefer to read MDN Web Docs in their native language 
...
- [mdn/.github](https://github.com/mdn/.github) topic:community,mdn,web,web-platform pushed_at:2026-02 star:0.0k fork:0.0k MDN Web Docs public organization profile
...
- [mdn/generic-content](https://github.com/mdn/generic-content) topic:community pushed_at:2026-06 star:0.0k fork:0.0k Various pieces of generic MDN content
- [mdn/mdn](https://github.com/mdn/mdn) topic:governance,mdn,meta,planning,web-platform pushed_at:2026-06 star:1.4k fork:0.2k Planning and proposals for MDN Web Docs content
- [mdn/mdn-community](https://github.com/mdn/mdn-community) topic:community,feedback,governance,mdn pushed_at:2026-06 star:0.2k fork:0.1k A place to provide feedback and suggestions for MDN Web Docs
- [mdn/mdn-contributor-spotlight](https://github.com/mdn/mdn-contributor-spotlight) topic:achievements,community,kudos pushed_at:2026-06 star:0.0k fork:0.0k Content for the contributor spotlight on MDN Web Docs
...
- [mdn/django-diy-blog](https://github.com/mdn/django-diy-blog) topic:blog,demo,django,example,python pushed_at:2026-04 star:0.2k fork:0.1k Basic blog site written in Django (part of MDN Django module assessment).
- [mdn/django-locallibrary-tutorial](https://github.com/mdn/django-locallibrary-tutorial) topic:demo,django,example,python,web-app pushed_at:2026-04 star:1.7k fork:1.0k Local Library website written in Django; example for the MDN server-side development Django module: https://developer.mozilla.org/en-US/docs/Learn/Server-side/Django.
...
- [mdn/rari](https://github.com/mdn/rari) topic:infra pushed_at:2026-06 star:0.1k fork:0.0k Rari is a Rust-based build system that transforms markdown into structured JSON, powering MDN Web Docs content and translations since 2024.
- [mdn/rumba](https://github.com/mdn/rumba) topic:rust pushed_at:2026-06 star:0.1k fork:0.0k The clean kuma (🤖🧹)
...
- [mdn/curriculum](https://github.com/mdn/curriculum) topic:beginners,career,education,learning,web-development pushed_at:2026-06 star:0.4k fork:0.0k MDN front-end developer curriculum
...
- [mdn/yari](https://github.com/mdn/yari) topic:mdn,yari pushed_at:2026-06 star:1.3k fork:0.6k The platform code behind MDN Web Docs

## Vue

- [mdn/release-dashboard](https://github.com/mdn/release-dashboard) topic:bugzilla,mdn pushed_at:2026-03 star:0.0k fork:0.0k Small app to display bugzilla bugs which need dev docs
- [mdn/todo-vue](https://github.com/mdn/todo-vue) topic:mdn,todo,vue,vuejs pushed_at:2026-06 star:0.1k fork:0.1k Sample todo app built with the Vue framework

## WebAssembly

- [mdn/webassembly-examples](https://github.com/mdn/webassembly-examples) topic:examples,wasm,webassembly pushed_at:2026-06 star:1.2k fork:0.3k Code examples that accompany the MDN WebAssembly documentation — see https://developer.mozilla.org/en-US/docs/WebAssembly. 
