...
- [mdn/browser-compat-data](https://github.com/mdn/browser-compat-data) topic:compat,compatibility,data,dataset,json pushed_at:2025-07 star:5.3k fork:2.2k Browser compatibility data for Web technologies as displayed on MDN
...
- [mdn/bcd-utils](https://github.com/mdn/bcd-utils) topic:bcd,infra,tooling pushed_at:2025-07 star:0.0k fork:0.0k 
...
- [mdn/data](https://github.com/mdn/data) topic:css,data,json,json-data pushed_at:2025-07 star:0.7k fork:0.2k This repository contains general data for Web technologies
...
- [mdn/dom-examples](https://github.com/mdn/dom-examples) topic:channel-messaging,demo,dom-manipulation,drag-drop,javascript,matchmedia,mdn-docs,pointer-events,pointer-lock,touch-events pushed_at:2025-07 star:3.8k fork:1.9k Code examples that accompany various MDN DOM and Web API documentation pages
...
- [mdn/express-locallibrary-tutorial](https://github.com/mdn/express-locallibrary-tutorial) topic:demo,example,express,nodejs,webapp pushed_at:2025-07 star:1.3k fork:0.7k Local Library website written in NodeJS/Express; example for the MDN server-side development NodeJS module: https://developer.mozilla.org/en-US/docs/Learn/Server-side/Express_Nodejs.
- [mdn/fred](https://github.com/mdn/fred) topic: pushed_at:2025-07 star:0.0k fork:0.0k MDN's next fr(ont)e(n)d
...
- [mdn/mdn-http-observatory](https://github.com/mdn/mdn-http-observatory) topic:http-headers,mdn,security-tools pushed_at:2025-07 star:0.1k fork:0.0k Backend for HTTP Observatory on MDN
...
- [mdn/todo-react](https://github.com/mdn/todo-react) topic:demo,example,react,todo pushed_at:2025-07 star:0.3k fork:0.3k Sample todo app built with the React/ReactDOM framework.
...
- [mdn/triagebot](https://github.com/mdn/triagebot) topic: pushed_at:2025-07 star:0.0k fork:0.0k 
...
- [mdn/differy](https://github.com/mdn/differy) topic: pushed_at:2025-07 star:0.0k fork:0.0k 
- [mdn/rari](https://github.com/mdn/rari) topic: pushed_at:2025-07 star:0.0k fork:0.0k MDN's new build system.
- [mdn/rumba](https://github.com/mdn/rumba) topic:rust pushed_at:2025-07 star:0.1k fork:0.0k The clean kuma (🤖🧹)
...
- [mdn/yari](https://github.com/mdn/yari) topic:mdn,yari pushed_at:2025-07 star:1.2k fork:0.5k The platform code behind MDN Web Docs
