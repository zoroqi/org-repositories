...
- [mdn/infra](https://github.com/mdn/infra) topic: pushed_at:2022-09 star:0.1k fork:0.0k MDN Web Docs Infrastructure scripts and configuration
...
- [mdn/beginner-html-site](https://github.com/mdn/beginner-html-site) topic: pushed_at:2022-10 star:0.2k fork:0.3k A simple one page website created to help complete beginners learn HTML basics. This example is built up over the course of https://developer.mozilla.org/en-US/Learn/Getting_started_with_the_web/HTML_basics
...
- [mdn/beginner-html-site-styled](https://github.com/mdn/beginner-html-site-styled) topic: pushed_at:2022-09 star:0.2k fork:0.6k A simple one page website created to help complete beginners learn HTML basics, which in this repo has also been styled to help beginners learn CSS basics. The styling is explained over the course of https://developer.mozilla.org/en-US/Learn/Getting_started_with_the_web/CSS_basics.
...
- [mdn/css-examples](https://github.com/mdn/css-examples) topic:css,css3 pushed_at:2022-11 star:0.4k fork:0.7k Code examples that accompany the MDN CSS documentation
...
- [mdn/html-examples](https://github.com/mdn/html-examples) topic: pushed_at:2022-11 star:0.1k fork:0.1k Code examples that accompany the MDN HTML documentation: https://developer.mozilla.org/en-US/docs/Web/HTML
- [mdn/imsc-examples](https://github.com/mdn/imsc-examples) topic: pushed_at:2022-09 star:0.0k fork:0.0k Repository for examples to go along with MDN IMSC documentation.
...
- [mdn/interactive-examples](https://github.com/mdn/interactive-examples) topic:css,editor,examples,html,interactive,javascript,mdn,nodejs pushed_at:2022-11 star:0.6k fork:0.5k Home of the MDN live code editor interactive examples
...
- [mdn/learning-area](https://github.com/mdn/learning-area) topic:learning,learning-js,learning-to-code,mdn-docs pushed_at:2022-11 star:5.4k fork:22.8k Github repo for the MDN Learning Area. 
...
- [mdn/webaudio-examples](https://github.com/mdn/webaudio-examples) topic:audio,demo,webaudio,webaudio-api pushed_at:2022-11 star:0.9k fork:0.4k Code examples that accompany the MDN Web Docs pages relating to Web Audio.
...
- [mdn/browser-compat-data](https://github.com/mdn/browser-compat-data) topic:compat,compatibility,data,dataset,json pushed_at:2022-11 star:4.3k fork:1.9k This repository contains compatibility data for Web technologies as displayed on MDN
...
- [mdn/bob](https://github.com/mdn/bob) topic: pushed_at:2022-11 star:0.1k fork:0.1k Builder of Bits aka The MDN Web Docs interactive examples, example builder
...
- [mdn/data](https://github.com/mdn/data) topic:css,data,json,json-data pushed_at:2022-11 star:0.7k fork:0.2k This repository contains general data for Web technologies
...
- [mdn/dom-examples](https://github.com/mdn/dom-examples) topic:channel-messaging,demo,dom-manipulation,drag-drop,matchmedia,mdn-docs,pointer-events,pointer-lock,touch-events pushed_at:2022-11 star:1.9k fork:1.3k Code examples that accompany various MDN DOM and Web API documentation pages
...
- [mdn/express-locallibrary-tutorial](https://github.com/mdn/express-locallibrary-tutorial) topic: pushed_at:2022-10 star:1.0k fork:0.5k Local Library website written in NodeJS/Express; example for the MDN server-side development NodeJS module: https://developer.mozilla.org/en-US/docs/Learn/Server-side/Express_Nodejs.
...
- [mdn/js-examples](https://github.com/mdn/js-examples) topic:ecmascript,javascript pushed_at:2022-08 star:0.9k fork:0.6k Code examples that accompany the MDN JavaScript/ECMAScript documentation
- [mdn/markdown](https://github.com/mdn/markdown) topic:markdown,tooling pushed_at:2022-11 star:0.0k fork:0.0k MDN Web Docs tool to covert HTML to Markdown
...
- [mdn/museum](https://github.com/mdn/museum) topic: pushed_at:2022-09 star:0.0k fork:0.0k A historic collection of MDN Web Docs content and examples
...
- [mdn/pwa-examples](https://github.com/mdn/pwa-examples) topic: pushed_at:2022-08 star:0.7k fork:0.6k Examples for progressive web apps.
...
- [mdn/serviceworker-cookbook](https://github.com/mdn/serviceworker-cookbook) topic: pushed_at:2022-11 star:2.5k fork:0.3k It's online. It's offline. It's a Service Worker!
...
- [mdn/todo-react](https://github.com/mdn/todo-react) topic: pushed_at:2022-10 star:0.1k fork:0.2k Sample todo app built with the React/ReactDOM framework.
...
- [mdn/web-components-examples](https://github.com/mdn/web-components-examples) topic: pushed_at:2022-10 star:2.4k fork:0.7k A series of web components examples, related to the MDN web components documentation at https://developer.mozilla.org/en-US/docs/Web/Web_Components.
...
- [mdn/webextensions-examples](https://github.com/mdn/webextensions-examples) topic:mdn,webextensions,webextensions-apis pushed_at:2022-10 star:3.4k fork:2.5k Example Firefox add-ons created using the WebExtensions API
...
- [mdn/webvr-tests](https://github.com/mdn/webvr-tests) topic:mdn-docs,webvr,webvr-tests pushed_at:2022-09 star:0.1k fork:0.0k A set of simple tests for testing WebVR functionality. See https://developer.mozilla.org/en-US/docs/Web/API/WebVR_API for the latest on the documentation.
...
- [mdn/content](https://github.com/mdn/content) topic:css,documentation,html,http,javascript,learning,mdn,reference,web-development,web-standards pushed_at:2022-11 star:7.0k fork:13.2k The content behind MDN Web Docs
- [mdn/translated-content](https://github.com/mdn/translated-content) topic: pushed_at:2022-11 star:1.0k fork:4.9k The source repository of all translated content for MDN Web Docs

## Others

- [mdn/.github](https://github.com/mdn/.github) topic: pushed_at:2022-10 star:0.0k fork:0.0k MDN Web Docs public organization profile
...
- [mdn/mdn](https://github.com/mdn/mdn) topic:governance,mdn,meta pushed_at:2022-10 star:1.2k fork:0.2k Contributors handbook that governs the MDN GitHub organization
- [mdn/mdn-community](https://github.com/mdn/mdn-community) topic:community,feedback,governance pushed_at:2022-10 star:0.1k fork:0.0k A place to provide feedback and suggestions for MDN Web Docs
- [mdn/mdn-contributor-spotlight](https://github.com/mdn/mdn-contributor-spotlight) topic: pushed_at:2022-10 star:0.0k fork:0.0k Content for the contributor spotlight on MDN Web Docs
...
- [mdn/project-template](https://github.com/mdn/project-template) topic: pushed_at:2022-11 star:0.0k fork:0.0k A project template to use for new MDN GitHub repositories
...
- [mdn/workflows](https://github.com/mdn/workflows) topic: pushed_at:2022-11 star:0.0k fork:0.0k Reusable GitHub Actions workflows
...
- [mdn/django-diy-blog](https://github.com/mdn/django-diy-blog) topic: pushed_at:2022-10 star:0.2k fork:0.1k Basic blog site written in Django (part of MDN Django module assessment).
- [mdn/django-locallibrary-tutorial](https://github.com/mdn/django-locallibrary-tutorial) topic: pushed_at:2022-10 star:1.3k fork:0.8k Local Library website written in Django; example for the MDN server-side development Django module: https://developer.mozilla.org/en-US/docs/Learn/Server-side/Django.
...
- [mdn/rumba](https://github.com/mdn/rumba) topic: pushed_at:2022-11 star:0.0k fork:0.0k The clean kuma (🤖🧹)
...
- [mdn/yari](https://github.com/mdn/yari) topic:mdn,yari pushed_at:2022-11 star:0.9k fork:0.4k The platform code behind MDN Web Docs

## Vue

- [mdn/release-dashboard](https://github.com/mdn/release-dashboard) topic: pushed_at:2022-11 star:0.0k fork:0.0k Small app to display bugzilla bugs which need dev docs
- [mdn/todo-vue](https://github.com/mdn/todo-vue) topic: pushed_at:2022-11 star:0.0k fork:0.0k Sample todo app built with the Vue framework

## WebAssembly

- [mdn/webassembly-examples](https://github.com/mdn/webassembly-examples) topic: pushed_at:2022-08 star:1.0k fork:0.2k Code examples that accompany the MDN WebAssembly documentation — see https://developer.mozilla.org/en-US/docs/WebAssembly. 
