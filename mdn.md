...
- [mdn/infra](https://github.com/mdn/infra) pushed_at:2021-08 star:0.0k fork:0.0k MDN Web Docs Infrastructure scripts and configuration

## HTML

- [mdn/_test_content_dont_use](https://github.com/mdn/_test_content_dont_use) pushed_at:2020-08 star:0.0k fork:0.0k 
- [mdn/archived-content](https://github.com/mdn/archived-content) pushed_at:2021-06 star:0.0k fork:0.1k Archived MDN Web Docs content that is not actively maintained or frequently built
...
- [mdn/beginner-html-site](https://github.com/mdn/beginner-html-site) pushed_at:2021-08 star:0.2k fork:0.3k A simple one page website created to help complete beginners learn HTML basics. This example is built up over the course of https://developer.mozilla.org/en-US/Learn/Getting_started_with_the_web/HTML_basics
...
- [mdn/content](https://github.com/mdn/content) pushed_at:2021-08 star:3.0k fork:2.2k The content behind MDN Web Docs
...
- [mdn/css-examples](https://github.com/mdn/css-examples) pushed_at:2021-08 star:0.2k fork:0.3k Code examples that accompany the MDN CSS documentation
...
- [mdn/dom-examples](https://github.com/mdn/dom-examples) pushed_at:2021-06 star:1.1k fork:0.8k Code examples that accompany various MDN DOM and Web API documentation pages
- [mdn/fetch-examples](https://github.com/mdn/fetch-examples) pushed_at:2021-03 star:0.4k fork:0.2k A repository of Fetch examples. See https://developer.mozilla.org/en-US/docs/Web/API/Fetch_API for the corresponding documentation.
...
- [mdn/html-examples](https://github.com/mdn/html-examples) pushed_at:2020-11 star:0.1k fork:0.1k Code examples that accompany the MDN HTML documentation: https://developer.mozilla.org/en-US/docs/Web/HTML
...
- [mdn/insights](https://github.com/mdn/insights) pushed_at:2021-08 star:0.0k fork:0.0k The repo that powers MDN Web Docs Insights.
- [mdn/interactive-examples](https://github.com/mdn/interactive-examples) pushed_at:2021-08 star:0.4k fork:0.3k Home of the MDN live code editor interactive examples
...
- [mdn/learning-area](https://github.com/mdn/learning-area) pushed_at:2021-08 star:4.1k fork:14.4k Github repo for the MDN Learning Area. 
...
- [mdn/translated-content](https://github.com/mdn/translated-content) pushed_at:2021-08 star:0.3k fork:0.7k All translated MDN content in raw form
...
- [mdn/webaudio-examples](https://github.com/mdn/webaudio-examples) pushed_at:2021-07 star:0.7k fork:0.3k Code examples that accompany the MDN Web Audio documentation 
...
- [mdn/browser-compat-data](https://github.com/mdn/browser-compat-data) pushed_at:2021-08 star:3.5k fork:1.6k This repository contains compatibility data for Web technologies as displayed on MDN
...
- [mdn/data](https://github.com/mdn/data) pushed_at:2021-07 star:0.5k fork:0.1k This repository contains general data for Web technologies
...
- [mdn/express-locallibrary-tutorial](https://github.com/mdn/express-locallibrary-tutorial) pushed_at:2021-04 star:0.9k fork:0.4k Local Library website written in NodeJS/Express; example for the MDN server-side development NodeJS module: https://developer.mozilla.org/en-US/docs/Learn/Server-side/Express_Nodejs.
...
- [mdn/mdn-storybook](https://github.com/mdn/mdn-storybook) pushed_at:2021-06 star:0.0k fork:0.0k UI components for MDN Web Docs
...
- [mdn/todo-react](https://github.com/mdn/todo-react) pushed_at:2021-06 star:0.1k fork:0.1k Sample todo app built with the React/ReactDOM framework.
...
- [mdn/web-components-examples](https://github.com/mdn/web-components-examples) pushed_at:2021-06 star:1.7k fork:0.5k A series of web components examples, related to the MDN web components documentation at https://developer.mozilla.org/en-US/docs/Web/Web_Components.
- [mdn/web-dictaphone](https://github.com/mdn/web-dictaphone) pushed_at:2020-05 star:0.4k fork:0.2k A sample MDN app that uses getUserMedia and MediaRecorder API for recording audio snippets, and The Web Audio API for visualizations.
- [mdn/web-speech-api](https://github.com/mdn/web-speech-api) pushed_at:2020-05 star:1.2k fork:0.6k A repository for demos illustrating features of the Web Speech API. See https://developer.mozilla.org/en-US/docs/Web/API/Web_Speech_API for more details.
- [mdn/webextensions-examples](https://github.com/mdn/webextensions-examples) pushed_at:2021-07 star:2.9k fork:2.2k Example Firefox add-ons created using the WebExtensions API
- [mdn/webgl-examples](https://github.com/mdn/webgl-examples) pushed_at:2021-07 star:1.0k fork:0.9k Code examples that accompany the MDN WebGL documentation
...
- [mdn/yari](https://github.com/mdn/yari) pushed_at:2021-08 star:0.5k fork:0.1k The platform code behind MDN Web Docs

## Jinja

- [mdn/ansible-jenkins](https://github.com/mdn/ansible-jenkins) pushed_at:2021-08 star:0.0k fork:0.0k Jenkins ansible playbook
...
- [mdn/mdn](https://github.com/mdn/mdn) pushed_at:2021-07 star:1.1k fork:0.2k Meta repository that governs the MDN GitHub organization
...
- [mdn/developer-portal](https://github.com/mdn/developer-portal) pushed_at:2021-06 star:0.1k fork:0.0k The code that generates the MDN Web Docs Developer Portal.
...
- [mdn/kuma](https://github.com/mdn/kuma) pushed_at:2021-08 star:1.9k fork:0.7k The project that powers MDN.
...
- [mdn/mdn-minimalist](https://github.com/mdn/mdn-minimalist) pushed_at:2021-08 star:0.1k fork:0.0k The base Sass for Mozilla Developer based projects and products
...
- [mdn/todo-vue](https://github.com/mdn/todo-vue) pushed_at:2021-06 star:0.0k fork:0.0k Sample todo app built with the Vue framework
