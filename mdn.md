...
- [mdn/css-examples](https://github.com/mdn/css-examples) topic:css,css3 pushed_at:2022-12 star:0.4k fork:0.7k Code examples that accompany the MDN CSS documentation
...
- [mdn/interactive-examples](https://github.com/mdn/interactive-examples) topic:css,editor,examples,html,interactive,javascript,mdn,nodejs pushed_at:2022-12 star:0.6k fork:0.5k Home of the MDN live code editor interactive examples
...
- [mdn/learning-area](https://github.com/mdn/learning-area) topic:learning,learning-js,learning-to-code,mdn-docs pushed_at:2022-12 star:5.5k fork:23.2k Github repo for the MDN Learning Area. 
...
- [mdn/browser-compat-data](https://github.com/mdn/browser-compat-data) topic:compat,compatibility,data,dataset,json pushed_at:2022-12 star:4.3k fork:2.0k This repository contains compatibility data for Web technologies as displayed on MDN
...
- [mdn/bob](https://github.com/mdn/bob) topic: pushed_at:2022-12 star:0.1k fork:0.1k Builder of Bits aka The MDN Web Docs interactive examples, example builder
...
- [mdn/data](https://github.com/mdn/data) topic:css,data,json,json-data pushed_at:2022-12 star:0.7k fork:0.2k This repository contains general data for Web technologies
...
- [mdn/dom-examples](https://github.com/mdn/dom-examples) topic:channel-messaging,demo,dom-manipulation,drag-drop,matchmedia,mdn-docs,pointer-events,pointer-lock,touch-events pushed_at:2022-12 star:2.0k fork:1.3k Code examples that accompany various MDN DOM and Web API documentation pages
...
- [mdn/markdown](https://github.com/mdn/markdown) topic:markdown,tooling pushed_at:2022-12 star:0.0k fork:0.0k MDN Web Docs tool to covert HTML to Markdown
...
- [mdn/pwa-examples](https://github.com/mdn/pwa-examples) topic: pushed_at:2022-11 star:0.8k fork:0.6k Examples for progressive web apps.
...
- [mdn/todo-react](https://github.com/mdn/todo-react) topic: pushed_at:2022-12 star:0.1k fork:0.2k Sample todo app built with the React/ReactDOM framework.
...
- [mdn/webextensions-examples](https://github.com/mdn/webextensions-examples) topic:mdn,webextensions,webextensions-apis pushed_at:2022-12 star:3.4k fork:2.5k Example Firefox add-ons created using the WebExtensions API
...
- [mdn/content](https://github.com/mdn/content) topic:css,documentation,html,http,javascript,learning,mdn,reference,web-development,web-standards pushed_at:2022-12 star:7.1k fork:13.7k The content behind MDN Web Docs
- [mdn/translated-content](https://github.com/mdn/translated-content) topic: pushed_at:2022-12 star:1.1k fork:5.1k The source repository of all translated content for MDN Web Docs
...
- [mdn/bcd-utils](https://github.com/mdn/bcd-utils) topic: pushed_at:2022-12 star:0.0k fork:0.0k 
...
- [mdn/mdn](https://github.com/mdn/mdn) topic:governance,mdn,meta pushed_at:2022-12 star:1.2k fork:0.2k Holding repo for MDN Web Docs things
...
- [mdn/mdn-contributor-spotlight](https://github.com/mdn/mdn-contributor-spotlight) topic: pushed_at:2022-12 star:0.0k fork:0.0k Content for the contributor spotlight on MDN Web Docs
...
- [mdn/project-template](https://github.com/mdn/project-template) topic: pushed_at:2022-12 star:0.0k fork:0.0k A project template to use for new MDN GitHub repositories
- [mdn/sprints](https://github.com/mdn/sprints) topic:issue-management,issue-tracker,issues-only,mdn pushed_at:2022-03 star:0.1k fork:0.2k MDN Web Docs content issue management
- [mdn/temp-processes](https://github.com/mdn/temp-processes) topic: pushed_at:2022-12 star:0.0k fork:0.0k Temp repository to define issue & pr processes with mermaid flow charts
...
- [mdn/workflows](https://github.com/mdn/workflows) topic: pushed_at:2022-12 star:0.0k fork:0.0k Reusable GitHub Actions workflows
...
- [mdn/django-locallibrary-tutorial](https://github.com/mdn/django-locallibrary-tutorial) topic: pushed_at:2022-11 star:1.3k fork:0.8k Local Library website written in Django; example for the MDN server-side development Django module: https://developer.mozilla.org/en-US/docs/Learn/Server-side/Django.
...
- [mdn/rumba](https://github.com/mdn/rumba) topic: pushed_at:2022-12 star:0.0k fork:0.0k The clean kuma (🤖🧹)
...
- [mdn/yari](https://github.com/mdn/yari) topic:mdn,yari pushed_at:2022-12 star:0.9k fork:0.4k The platform code behind MDN Web Docs
...
- [mdn/todo-vue](https://github.com/mdn/todo-vue) topic: pushed_at:2022-12 star:0.0k fork:0.0k Sample todo app built with the Vue framework
