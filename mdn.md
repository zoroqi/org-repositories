...
- [mdn/battery-quickstart-starter-template](https://github.com/mdn/battery-quickstart-starter-template) topic: pushed_at:2017-07 star:0.0k fork:0.0k [archived] The starting state of the example built up in the "Your first app" tutorial found in the Mozilla Developer Network open web app Quickstart article.
...
- [mdn/beginner-html-site](https://github.com/mdn/beginner-html-site) topic:example,html,learning pushed_at:2026-03 star:0.3k fork:0.5k A simple one page website created to help complete beginners learn HTML basics.
- [mdn/beginner-html-site-scripted](https://github.com/mdn/beginner-html-site-scripted) topic:example,html,javascript,learning pushed_at:2026-07 star:0.3k fork:0.3k A single-page website created to help complete beginners learn HTML with JS added to help beginners learn JavaScript. Supports https://developer.mozilla.org/en-US/Learn/Getting_started_with_the_web/JavaScript_basics 
- [mdn/beginner-html-site-styled](https://github.com/mdn/beginner-html-site-styled) topic: pushed_at:2026-07 star:0.3k fork:1.0k A simple one page website created to help complete beginners learn HTML basics, which in this repo has also been styled to help beginners learn CSS basics. The styling is explained over the course of https://developer.mozilla.org/en-US/Learn/Getting_started_with_the_web/CSS_basics.
- [mdn/beginning-programming-content-kit](https://github.com/mdn/beginning-programming-content-kit) topic:content-kit,html pushed_at:2019-03 star:0.0k fork:0.0k This is a Content Kit for people who want to teach programming to beginners.
- [mdn/content-kit-template](https://github.com/mdn/content-kit-template) topic:content-management,demo-material,mdn,mdn-content-kit,presentation-materials pushed_at:2016-05 star:0.0k fork:0.0k This is the repo to fork or clone when creating a new MDN Content Kit.
- [mdn/css-examples](https://github.com/mdn/css-examples) topic:css,examples pushed_at:2026-07 star:0.6k fork:0.8k Code examples that accompany the MDN CSS documentation
...
- [mdn/houdini-examples](https://github.com/mdn/houdini-examples) topic:css,examples,houdini pushed_at:2026-07 star:0.0k fork:0.0k CSS Houdini examples relating to MDN content.
- [mdn/html-examples](https://github.com/mdn/html-examples) topic:examples,html pushed_at:2026-07 star:0.1k fork:0.1k Code examples that accompany the MDN HTML documentation: https://developer.mozilla.org/en-US/docs/Web/HTML
- [mdn/imsc-examples](https://github.com/mdn/imsc-examples) topic:captioning,examples,media,subtitles,web pushed_at:2026-07 star:0.0k fork:0.0k Repository for examples to go along with MDN IMSC documentation.
...
- [mdn/learning-area](https://github.com/mdn/learning-area) topic:learning,learning-js,learning-to-code,mdn-docs pushed_at:2026-08 star:7.6k fork:27.2k GitHub repo for the MDN Learning Area. 
...
- [mdn/pab](https://github.com/mdn/pab) topic: pushed_at:2026-06 star:0.0k fork:0.0k MDN Web Docs Product Advisory Board
...
- [mdn/watify](https://github.com/mdn/watify) topic: pushed_at:2026-09 star:0.0k fork:0.0k Compile WAT to WASM with WASM 🙇
- [mdn/web-tech-games](https://github.com/mdn/web-tech-games) topic: pushed_at:2026-07 star:0.0k fork:0.0k Interactive diagram showing what parts of the web technology stack can used for different purposes when creating games. Includes links to more information about each.
- [mdn/webaudio-examples](https://github.com/mdn/webaudio-examples) topic:audio,demo,examples,webaudio,webaudio-api pushed_at:2026-05 star:1.4k fork:0.4k Code examples that accompany the MDN Web Docs pages relating to Web Audio.
...
- [mdn/browser-compat-data](https://github.com/mdn/browser-compat-data) topic:compat,compatibility,data,dataset,json pushed_at:2026-09 star:5.8k fork:2.6k Browser compatibility data for Web technologies as displayed on MDN

## JavaScript

- [mdn/addon-sdk-content-scripts](https://github.com/mdn/addon-sdk-content-scripts) topic:contentscript,javascript,mdn-docs,page-mod,sdk pushed_at:2017-05 star:0.0k fork:0.0k Archived! | Use WebExtensions instead | Add-ons demonstrating how to use content scripts in the Add-on SDK.
...
- [mdn/bcd-utils](https://github.com/mdn/bcd-utils) topic:bcd,browser-compat-data,infra,tooling pushed_at:2026-09 star:0.0k fork:0.0k 
...
- [mdn/client-toolchain-example](https://github.com/mdn/client-toolchain-example) topic:demo,examples,javascript,toolchain pushed_at:2026-09 star:0.0k fork:0.0k Demo project for the MDN client-side web development tools tutorial.
- [mdn/content-inventory](https://github.com/mdn/content-inventory) topic: pushed_at:2026-09 star:0.0k fork:0.0k Inventory of MDN content
- [mdn/data](https://github.com/mdn/data) topic:css,data,json,json-data pushed_at:2026-09 star:0.8k fork:0.2k This repository contains general data for Web technologies
- [mdn/dex](https://github.com/mdn/dex) topic: pushed_at:2026-09 star:0.0k fork:0.0k MDN's deployment infrastructure.
...
- [mdn/dom-examples](https://github.com/mdn/dom-examples) topic:channel-messaging,demo,dom-manipulation,drag-drop,javascript,matchmedia,mdn,pointer-events,pointer-lock,touch-events pushed_at:2026-08 star:4.0k fork:1.9k Code examples that accompany various MDN DOM and Web API documentation pages
...
- [mdn/express-locallibrary-tutorial](https://github.com/mdn/express-locallibrary-tutorial) topic:demo,example,express,nodejs,webapp pushed_at:2026-09 star:1.3k fork:0.8k Local Library website written in NodeJS/Express; example for the MDN server-side development NodeJS module: https://developer.mozilla.org/en-US/docs/Learn/Server-side/Express_Nodejs.
- [mdn/fred](https://github.com/mdn/fred) topic:lit,ssr,web-components pushed_at:2026-09 star:0.2k fork:0.1k MDN's frontend since late 2025, built with Web Components, Lit, and SSR for a fast, clean documentation experience. Fred = /fr(ont)e(n)d/.
...
- [mdn/js-examples](https://github.com/mdn/js-examples) topic:ecmascript,examples,javascript,mdn pushed_at:2025-11 star:1.3k fork:0.7k Code examples that accompany the MDN JavaScript/ECMAScript documentation
...
- [mdn/mcp](https://github.com/mdn/mcp) topic: pushed_at:2026-09 star:0.2k fork:0.0k MDN's prototype MCP server
...
- [mdn/mdn-http-observatory](https://github.com/mdn/mdn-http-observatory) topic:http,http-headers,mdn,privacy,security,security-tools pushed_at:2026-09 star:0.1k fork:0.0k Backend for HTTP Observatory on MDN
...
- [mdn/museum](https://github.com/mdn/museum) topic:archive,examples pushed_at:2026-08 star:0.0k fork:0.0k A historic collection of MDN Web Docs content and examples
...
- [mdn/pwa-examples](https://github.com/mdn/pwa-examples) topic:examples,progressive-web-app,pwa pushed_at:2026-07 star:1.0k fork:0.6k Examples for progressive web apps.
...
- [mdn/serviceworker-cookbook](https://github.com/mdn/serviceworker-cookbook) topic: pushed_at:2022-11 star:2.9k fork:0.3k It's online. It's offline. It's a Service Worker!
...
- [mdn/sw-test](https://github.com/mdn/sw-test) topic: pushed_at:2022-08 star:0.7k fork:0.2k Service Worker test repository. This is a very simple demo to show basic service worker features in action.
...
- [mdn/todo-react](https://github.com/mdn/todo-react) topic:demo,example,react,todo pushed_at:2026-09 star:0.3k fork:0.3k Sample todo app built with the React/ReactDOM framework.
- [mdn/tree-sitter-mdn](https://github.com/mdn/tree-sitter-mdn) topic: pushed_at:2026-09 star:0.0k fork:0.0k MDN's macro grammar for tree-sitter
- [mdn/triagebot](https://github.com/mdn/triagebot) topic:automation pushed_at:2026-09 star:0.0k fork:0.0k 
...
- [mdn/web-components-examples](https://github.com/mdn/web-components-examples) topic:examples,web-components pushed_at:2026-01 star:3.4k fork:0.8k A series of web components examples, related to the MDN web components documentation at https://developer.mozilla.org/en-US/docs/Web/Web_Components.
...
- [mdn/webextensions-examples](https://github.com/mdn/webextensions-examples) topic:browser,mdn,webextensions,webextensions-apis pushed_at:2026-09 star:4.5k fork:2.6k Example Firefox add-ons created using the WebExtensions API
...
- [mdn/content](https://github.com/mdn/content) topic:css,documentation,html,http,javascript,learning,mdn,reference,web-development,web-standards pushed_at:2026-09 star:11.0k fork:23.2k The official source for MDN Web Docs content. Home to over 14,000 pages of documentation about HTML, CSS, JS, HTTP, Web APIs, and more.
- [mdn/translated-content](https://github.com/mdn/translated-content) topic:documentation,l10n,localization,mdn,web-development,web-platform pushed_at:2026-09 star:2.0k fork:8.3k 7 community-maintained translations of MDN Web Docs in ES, FR, JA, KO, PT-BR, RU, and ZH, to learn and contribute in your native language.
- [mdn/translated-content-de](https://github.com/mdn/translated-content-de) topic: pushed_at:2026-09 star:0.0k fork:0.0k Experimental German locale for MDN, aimed at German-speaking users that prefer to read MDN Web Docs in their native language
- [mdn/translated-content-it](https://github.com/mdn/translated-content-it) topic: pushed_at:2026-09 star:0.0k fork:0.0k Experimental Italian locale for MDN, aimed at Italian-speaking users that prefer to read MDN Web Docs in their native language 

## Mermaid

- [mdn/shared-assets](https://github.com/mdn/shared-assets) topic:assets,examples,infra pushed_at:2026-09 star:0.0k fork:0.0k A repository for media and assets to be used across MDN Web Docs

## Others

- [mdn/.github](https://github.com/mdn/.github) topic:community,mdn,web,web-platform pushed_at:2026-08 star:0.0k fork:0.0k MDN Web Docs public organization profile
...
- [mdn/claude-oidc-test](https://github.com/mdn/claude-oidc-test) topic: pushed_at:2026-08 star:0.0k fork:0.0k 
- [mdn/community-meetings](https://github.com/mdn/community-meetings) topic:community,documentation,planning,web-platform pushed_at:2025-12 star:0.0k fork:0.0k A place for agendas and minutes from regular MDN community meetings
...
- [mdn/generic-content](https://github.com/mdn/generic-content) topic:community pushed_at:2026-07 star:0.0k fork:0.0k Various pieces of generic MDN content
- [mdn/mdn](https://github.com/mdn/mdn) topic:governance,mdn,meta,planning,web-platform pushed_at:2026-07 star:1.4k fork:0.2k Planning and proposals for MDN Web Docs content
- [mdn/mdn-community](https://github.com/mdn/mdn-community) topic:community,feedback,governance,mdn pushed_at:2026-09 star:0.2k fork:0.1k A place to provide feedback and suggestions for MDN Web Docs
- [mdn/mdn-contributor-spotlight](https://github.com/mdn/mdn-contributor-spotlight) topic:achievements,community,kudos pushed_at:2026-07 star:0.0k fork:0.0k Content for the contributor spotlight on MDN Web Docs
...
- [mdn/project-template](https://github.com/mdn/project-template) topic:template pushed_at:2026-03 star:0.0k fork:0.0k A project template to use for new MDN GitHub repositories
...
- [mdn/workflows](https://github.com/mdn/workflows) topic:github-actions,infra pushed_at:2026-09 star:0.1k fork:0.0k Reusable GitHub Actions workflows
...
- [mdn/browsercompat](https://github.com/mdn/browsercompat) topic:python pushed_at:2017-04 star:0.0k fork:0.0k API for browser compatibility data on developer.mozilla.org
...
- [mdn/django-diy-blog](https://github.com/mdn/django-diy-blog) topic:blog,demo,django,example,python pushed_at:2026-08 star:0.2k fork:0.1k Basic blog site written in Django (part of MDN Django module assessment).
- [mdn/django-locallibrary-tutorial](https://github.com/mdn/django-locallibrary-tutorial) topic:demo,django,example,python,web-app pushed_at:2026-09 star:1.7k fork:1.0k Local Library website written in Django; example for the MDN server-side development Django module: https://developer.mozilla.org/en-US/docs/Learn/Server-side/Django.
...
- [mdn/webalyzer](https://github.com/mdn/webalyzer) topic:analysis,html,python pushed_at:2015-07 star:0.0k fork:0.0k [ARCHIVED] Collects web code for analysis and reporting.

## Rust

- [mdn/differy](https://github.com/mdn/differy) topic: pushed_at:2026-09 star:0.0k fork:0.0k 
- [mdn/rari](https://github.com/mdn/rari) topic:infra pushed_at:2026-09 star:0.1k fork:0.0k Rari is a Rust-based build system that transforms markdown into structured JSON, powering MDN Web Docs content and translations since 2024.
- [mdn/rumba](https://github.com/mdn/rumba) topic:rust pushed_at:2026-09 star:0.1k fork:0.0k The clean kuma (🤖🧹)
...
- [mdn/curriculum](https://github.com/mdn/curriculum) topic:beginners,career,education,learning,web-development pushed_at:2026-09 star:0.4k fork:0.0k MDN front-end developer curriculum

## TypeScript

- [mdn/bob](https://github.com/mdn/bob) topic:infra pushed_at:2025-05 star:0.1k fork:0.0k (Deprecated) Builder of Bits, powered MDN's interactive examples 2018–2025
- [mdn/yari](https://github.com/mdn/yari) topic:mdn,yari pushed_at:2026-09 star:1.3k fork:0.6k The platform code behind MDN Web Docs

## Vue

- [mdn/todo-vue](https://github.com/mdn/todo-vue) topic:mdn,todo,vue,vuejs pushed_at:2026-09 star:0.1k fork:0.1k Sample todo app built with the Vue framework

## WebAssembly

- [mdn/webassembly-examples](https://github.com/mdn/webassembly-examples) topic:examples,wasm,webassembly pushed_at:2026-08 star:1.2k fork:0.3k Code examples that accompany the MDN WebAssembly documentation — see https://developer.mozilla.org/en-US/docs/WebAssembly. 
