...
- [mdn/learning-area](https://github.com/mdn/learning-area) topic:learning,learning-js,learning-to-code,mdn-docs pushed_at:2022-11 star:5.5k fork:23.1k Github repo for the MDN Learning Area. 
...
- [mdn/browser-compat-data](https://github.com/mdn/browser-compat-data) topic:compat,compatibility,data,dataset,json pushed_at:2022-12 star:4.3k fork:1.9k This repository contains compatibility data for Web technologies as displayed on MDN
...
- [mdn/webextensions-examples](https://github.com/mdn/webextensions-examples) topic:mdn,webextensions,webextensions-apis pushed_at:2022-11 star:3.4k fork:2.5k Example Firefox add-ons created using the WebExtensions API
...
- [mdn/content](https://github.com/mdn/content) topic:css,documentation,html,http,javascript,learning,mdn,reference,web-development,web-standards pushed_at:2022-12 star:7.1k fork:13.5k The content behind MDN Web Docs
- [mdn/translated-content](https://github.com/mdn/translated-content) topic: pushed_at:2022-12 star:1.1k fork:5.0k The source repository of all translated content for MDN Web Docs
...
- [mdn/mdn](https://github.com/mdn/mdn) topic:governance,mdn,meta pushed_at:2022-11 star:1.2k fork:0.2k Contributors handbook that governs the MDN GitHub organization
...
- [mdn/temp-processes](https://github.com/mdn/temp-processes) topic: pushed_at:2022-11 star:0.0k fork:0.0k Temp repository to define issue & pr processes with mermaid flow charts
