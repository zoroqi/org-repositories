...
- [mdn/beginner-html-site](https://github.com/mdn/beginner-html-site) topic:html,learning pushed_at:2023-10 star:0.3k fork:0.4k A simple one page website created to help complete beginners learn HTML basics.
- [mdn/beginner-html-site-scripted](https://github.com/mdn/beginner-html-site-scripted) topic:html,javascript,learning pushed_at:2023-10 star:0.3k fork:0.3k A simple one page website created to help complete beginners learn HTML basics. which in this repo has also had some script added to help beginners learn JavaScript basics.
- [mdn/beginner-html-site-styled](https://github.com/mdn/beginner-html-site-styled) topic: pushed_at:2023-10 star:0.2k fork:0.7k A simple one page website created to help complete beginners learn HTML basics, which in this repo has also been styled to help beginners learn CSS basics. The styling is explained over the course of https://developer.mozilla.org/en-US/Learn/Getting_started_with_the_web/CSS_basics.
...
- [mdn/css-examples](https://github.com/mdn/css-examples) topic:css,css3 pushed_at:2023-11 star:0.5k fork:0.8k Code examples that accompany the MDN CSS documentation
...
- [mdn/html-examples](https://github.com/mdn/html-examples) topic: pushed_at:2023-10 star:0.1k fork:0.1k Code examples that accompany the MDN HTML documentation: https://developer.mozilla.org/en-US/docs/Web/HTML
- [mdn/imsc-examples](https://github.com/mdn/imsc-examples) topic: pushed_at:2023-09 star:0.0k fork:0.0k Repository for examples to go along with MDN IMSC documentation.
...
- [mdn/interactive-examples](https://github.com/mdn/interactive-examples) topic:css,editor,examples,html,interactive,javascript,mdn,nodejs pushed_at:2023-11 star:0.7k fork:0.5k Home of the MDN live code editor interactive examples
...
- [mdn/learning-area](https://github.com/mdn/learning-area) topic:learning,learning-js,learning-to-code,mdn-docs pushed_at:2023-11 star:6.4k fork:26.3k GitHub repo for the MDN Learning Area. 
...
- [mdn/webaudio-examples](https://github.com/mdn/webaudio-examples) topic:audio,demo,webaudio,webaudio-api pushed_at:2023-11 star:1.1k fork:0.4k Code examples that accompany the MDN Web Docs pages relating to Web Audio.
...
- [mdn/browser-compat-data](https://github.com/mdn/browser-compat-data) topic:compat,compatibility,data,dataset,json pushed_at:2023-11 star:4.6k fork:2.1k This repository contains compatibility data for Web technologies as displayed on MDN
...
- [mdn/bcd-utils](https://github.com/mdn/bcd-utils) topic: pushed_at:2023-11 star:0.0k fork:0.0k 
...
- [mdn/dom-examples](https://github.com/mdn/dom-examples) topic:channel-messaging,demo,dom-manipulation,drag-drop,javascript,matchmedia,mdn-docs,pointer-events,pointer-lock,touch-events pushed_at:2023-11 star:2.8k fork:1.7k Code examples that accompany various MDN DOM and Web API documentation pages
...
- [mdn/express-locallibrary-tutorial](https://github.com/mdn/express-locallibrary-tutorial) topic: pushed_at:2023-11 star:1.1k fork:0.7k Local Library website written in NodeJS/Express; example for the MDN server-side development NodeJS module: https://developer.mozilla.org/en-US/docs/Learn/Server-side/Express_Nodejs.
...
- [mdn/js-examples](https://github.com/mdn/js-examples) topic:ecmascript,javascript pushed_at:2023-11 star:1.0k fork:0.7k Code examples that accompany the MDN JavaScript/ECMAScript documentation
...
- [mdn/perf-examples](https://github.com/mdn/perf-examples) topic: pushed_at:2023-10 star:0.0k fork:0.0k Examples related to MDN performance documentation; see https://developer.mozilla.org/en-US/docs/web/Performance
- [mdn/pwa-examples](https://github.com/mdn/pwa-examples) topic: pushed_at:2023-10 star:0.9k fork:0.6k Examples for progressive web apps.
...
- [mdn/serviceworker-cookbook](https://github.com/mdn/serviceworker-cookbook) topic: pushed_at:2022-11 star:2.7k fork:0.3k It's online. It's offline. It's a Service Worker!
...
- [mdn/todo-react](https://github.com/mdn/todo-react) topic:mdn,react,todo pushed_at:2023-11 star:0.2k fork:0.2k Sample todo app built with the React/ReactDOM framework.
...
- [mdn/web-components-examples](https://github.com/mdn/web-components-examples) topic: pushed_at:2023-10 star:2.8k fork:0.8k A series of web components examples, related to the MDN web components documentation at https://developer.mozilla.org/en-US/docs/Web/Web_Components.
...
- [mdn/webextensions-examples](https://github.com/mdn/webextensions-examples) topic:browser,mdn,webextensions,webextensions-apis pushed_at:2023-11 star:3.8k fork:2.6k Example Firefox add-ons created using the WebExtensions API
...
- [mdn/content](https://github.com/mdn/content) topic:css,documentation,html,http,javascript,learning,mdn,reference,web-development,web-standards pushed_at:2023-11 star:8.3k fork:21.1k The content behind MDN Web Docs
- [mdn/translated-content](https://github.com/mdn/translated-content) topic: pushed_at:2023-11 star:1.4k fork:7.4k The source repository of all translated content for MDN Web Docs

## Others

- [mdn/.github](https://github.com/mdn/.github) topic: pushed_at:2023-11 star:0.0k fork:0.0k MDN Web Docs public organization profile
- [mdn/ai-feedback](https://github.com/mdn/ai-feedback) topic: pushed_at:2023-11 star:0.0k fork:0.0k Feedback about AI Help
...
- [mdn/community-meetings](https://github.com/mdn/community-meetings) topic: pushed_at:2023-11 star:0.0k fork:0.0k A place for agendas and minutes from regular MDN community meetings
...
- [mdn/mdn](https://github.com/mdn/mdn) topic:governance,mdn,meta pushed_at:2023-11 star:1.2k fork:0.2k Holding repo for MDN Web Docs things
...
- [mdn/shared-assets](https://github.com/mdn/shared-assets) topic: pushed_at:2023-10 star:0.0k fork:0.0k A repository for media and assets to be used across MDN Web Docs
- [mdn/sprints](https://github.com/mdn/sprints) topic:issue-management,issue-tracker,issues-only,mdn pushed_at:2023-07 star:0.2k fork:0.2k MDN Web Docs content issue management
...
- [mdn/workflows](https://github.com/mdn/workflows) topic:github-actions pushed_at:2023-11 star:0.0k fork:0.0k Reusable GitHub Actions workflows
...
- [mdn/django-locallibrary-tutorial](https://github.com/mdn/django-locallibrary-tutorial) topic: pushed_at:2023-11 star:1.5k fork:0.9k Local Library website written in Django; example for the MDN server-side development Django module: https://developer.mozilla.org/en-US/docs/Learn/Server-side/Django.
...
- [mdn/differy](https://github.com/mdn/differy) topic: pushed_at:2023-04 star:0.0k fork:0.0k 
- [mdn/rumba](https://github.com/mdn/rumba) topic:rust pushed_at:2023-11 star:0.0k fork:0.0k The clean kuma (🤖🧹)
...
- [mdn/curriculum](https://github.com/mdn/curriculum) topic: pushed_at:2023-11 star:0.3k fork:0.0k MDN front-end developer curriculum
...
- [mdn/bob](https://github.com/mdn/bob) topic: pushed_at:2023-11 star:0.1k fork:0.1k Builder of Bits aka The MDN Web Docs interactive examples, example builder
- [mdn/yari](https://github.com/mdn/yari) topic:mdn,yari pushed_at:2023-11 star:1.1k fork:0.5k The platform code behind MDN Web Docs

## Vue

- [mdn/release-dashboard](https://github.com/mdn/release-dashboard) topic: pushed_at:2023-11 star:0.0k fork:0.0k Small app to display bugzilla bugs which need dev docs
- [mdn/todo-vue](https://github.com/mdn/todo-vue) topic:mdn,todo,vue,vuejs pushed_at:2023-11 star:0.1k fork:0.1k Sample todo app built with the Vue framework

## WebAssembly

- [mdn/webassembly-examples](https://github.com/mdn/webassembly-examples) topic:wasm,webassembly pushed_at:2023-10 star:1.1k fork:0.3k Code examples that accompany the MDN WebAssembly documentation — see https://developer.mozilla.org/en-US/docs/WebAssembly. 
