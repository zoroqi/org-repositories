...
- [mdn/interactive-examples](https://github.com/mdn/interactive-examples) topic:css,editor,examples,html,interactive,javascript,mdn,nodejs pushed_at:2025-08 star:0.7k fork:0.5k Home of the MDN live code editor interactive examples
...
- [mdn/browser-compat-data](https://github.com/mdn/browser-compat-data) topic:compat,compatibility,data,dataset,json pushed_at:2025-08 star:5.4k fork:2.3k Browser compatibility data for Web technologies as displayed on MDN
...
- [mdn/data](https://github.com/mdn/data) topic:css,data,json,json-data pushed_at:2025-08 star:0.8k fork:0.2k This repository contains general data for Web technologies
...
- [mdn/fred](https://github.com/mdn/fred) topic: pushed_at:2025-08 star:0.0k fork:0.0k MDN's fr(ont)e(n)d
...
- [mdn/mdn-http-observatory](https://github.com/mdn/mdn-http-observatory) topic:http-headers,mdn,security-tools pushed_at:2025-08 star:0.1k fork:0.0k Backend for HTTP Observatory on MDN
...
- [mdn/todo-react](https://github.com/mdn/todo-react) topic:demo,example,react,todo pushed_at:2025-08 star:0.3k fork:0.3k Sample todo app built with the React/ReactDOM framework.
...
- [mdn/triagebot](https://github.com/mdn/triagebot) topic: pushed_at:2025-08 star:0.0k fork:0.0k 
...
- [mdn/content](https://github.com/mdn/content) topic:css,documentation,html,http,javascript,learning,mdn,reference,web-development,web-standards pushed_at:2025-08 star:9.7k fork:22.8k The content behind MDN Web Docs
...
- [mdn/shared-assets](https://github.com/mdn/shared-assets) topic:assets,examples pushed_at:2025-08 star:0.0k fork:0.0k A repository for media and assets to be used across MDN Web Docs
...
- [mdn/mdn-community](https://github.com/mdn/mdn-community) topic:community,feedback,governance,mdn pushed_at:2025-01 star:0.1k fork:0.0k A place to provide feedback and suggestions for MDN Web Docs
...
- [mdn/django-diy-blog](https://github.com/mdn/django-diy-blog) topic:blog,demo,django,example,python pushed_at:2024-12 star:0.2k fork:0.1k Basic blog site written in Django (part of MDN Django module assessment).
- [mdn/django-locallibrary-tutorial](https://github.com/mdn/django-locallibrary-tutorial) topic:demo,django,python,web-app pushed_at:2025-07 star:1.7k fork:1.0k Local Library website written in Django; example for the MDN server-side development Django module: https://developer.mozilla.org/en-US/docs/Learn/Server-side/Django.
...
- [mdn/differy](https://github.com/mdn/differy) topic: pushed_at:2025-08 star:0.0k fork:0.0k 
- [mdn/rari](https://github.com/mdn/rari) topic: pushed_at:2025-08 star:0.0k fork:0.0k MDN's build system.
- [mdn/rumba](https://github.com/mdn/rumba) topic:rust pushed_at:2025-08 star:0.1k fork:0.0k The clean kuma (🤖🧹)
...
- [mdn/yari](https://github.com/mdn/yari) topic:mdn,yari pushed_at:2025-08 star:1.3k fork:0.5k The platform code behind MDN Web Docs
...
- [mdn/todo-vue](https://github.com/mdn/todo-vue) topic:mdn,todo,vue,vuejs pushed_at:2025-08 star:0.1k fork:0.1k Sample todo app built with the Vue framework
