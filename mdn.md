...
- [mdn/learning-area](https://github.com/mdn/learning-area) topic:learning,learning-js,learning-to-code,mdn-docs pushed_at:2024-11 star:7.1k fork:27.2k GitHub repo for the MDN Learning Area. 
...
- [mdn/webextensions-examples](https://github.com/mdn/webextensions-examples) topic:browser,mdn,webextensions,webextensions-apis pushed_at:2024-11 star:4.2k fork:2.6k Example Firefox add-ons created using the WebExtensions API
...
- [mdn/content](https://github.com/mdn/content) topic:css,documentation,html,http,javascript,learning,mdn,reference,web-development,web-standards pushed_at:2025-02 star:9.4k fork:22.6k The content behind MDN Web Docs
- [mdn/translated-content](https://github.com/mdn/translated-content) topic:documentation,l10n,mdn pushed_at:2025-02 star:1.8k fork:8.2k The source repository of all translated content for MDN Web Docs
- [mdn/translated-content-de](https://github.com/mdn/translated-content-de) topic: pushed_at:2025-02 star:0.0k fork:0.0k Experimental German locale for MDN, aimed at German-speaking users that prefer to read MDN Web Docs in their native language
...
- [mdn/awesome](https://github.com/mdn/awesome) topic:awesome,awesome-list,css,documentation,html,javascript,mdn,web pushed_at:2025-01 star:0.0k fork:0.0k A curated list of awesome things related to MDN.
