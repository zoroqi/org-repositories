...
- [ARM-software/Arm-2D](https://github.com/ARM-software/Arm-2D) topic: pushed_at:2024-08 star:0.3k fork:0.1k 2D Graphic Library optimized for Cortex-M processors
...
- [ARM-software/arm-trusted-firmware](https://github.com/ARM-software/arm-trusted-firmware) topic: pushed_at:2024-08 star:1.9k fork:1.3k Read-only mirror of Trusted Firmware-A
- [ARM-software/astc-encoder](https://github.com/ARM-software/astc-encoder) topic:astc,astcenc,compression,image-compression pushed_at:2024-08 star:1.0k fork:0.2k The Arm ASTC Encoder, a compressor for the Adaptive Scalable Texture Compression data format.
- [ARM-software/AVH](https://github.com/ARM-software/AVH) topic:avh,ci-cd,embedded,fvp,github-action,mlops,simulation pushed_at:2024-08 star:0.0k fork:0.0k AVH-FVP: Arm Virtual Hardware - Fixed Virtual Platform
...
- [ARM-software/AVH-GetStarted](https://github.com/ARM-software/AVH-GetStarted) topic: pushed_at:2024-06 star:0.1k fork:0.0k DEPRECATED - use instead AVH_CI_Template
...
- [ARM-software/bbr-acs](https://github.com/ARM-software/bbr-acs) topic: pushed_at:2024-07 star:0.0k fork:0.0k Arm SystemReady : BBR Compliance Suite
...
- [ARM-software/bsa-acs](https://github.com/ARM-software/bsa-acs) topic: pushed_at:2024-08 star:0.0k fork:0.0k Arm SystemReady : BSA Architecture Compliance Suite
...
- [ARM-software/CMSIS-Compiler](https://github.com/ARM-software/CMSIS-Compiler) topic: pushed_at:2024-07 star:0.0k fork:0.0k CMSIS Compiler support for Arm Compiler
...
- [ARM-software/CMSIS-Driver](https://github.com/ARM-software/CMSIS-Driver) topic: pushed_at:2024-07 star:0.2k fork:0.1k Repository of microcontroller peripheral driver implementing the CMSIS-Driver API specification
- [ARM-software/CMSIS-Driver_Validation](https://github.com/ARM-software/CMSIS-Driver_Validation) topic: pushed_at:2024-07 star:0.0k fork:0.0k Test suite for verifying CMSIS-Driver implementations.
- [ARM-software/CMSIS-DSP](https://github.com/ARM-software/CMSIS-DSP) topic:cortex-a,cortex-m,dsp,embedded,fft,filter,fixed-point-arithmetic,matrix,ml,numpy pushed_at:2024-08 star:0.5k fork:0.1k CMSIS-DSP embedded compute library for Cortex-M and Cortex-A
- [ARM-software/CMSIS-FreeRTOS](https://github.com/ARM-software/CMSIS-FreeRTOS) topic: pushed_at:2024-08 star:0.5k fork:0.1k FreeRTOS adaptation for CMSIS-RTOS Version 2
...
- [ARM-software/CMSIS-NN](https://github.com/ARM-software/CMSIS-NN) topic: pushed_at:2024-07 star:0.2k fork:0.1k CMSIS-NN Library
- [ARM-software/CMSIS-RTOS2_Validation](https://github.com/ARM-software/CMSIS-RTOS2_Validation) topic: pushed_at:2024-08 star:0.0k fork:0.0k Validation test suite for CMSIS-RTOS2 API implementations using Arm Virtual Hardware (AVH).
- [ARM-software/CMSIS-RTX](https://github.com/ARM-software/CMSIS-RTX) topic: pushed_at:2024-08 star:0.1k fork:0.0k RTX5 real time kernel for Arm Cortex-based embedded systems (spin-off from CMSIS_5)
...
- [ARM-software/CMSIS_5](https://github.com/ARM-software/CMSIS_5) topic: pushed_at:2024-08 star:1.3k fork:1.1k CMSIS Version 5 Development Repository
- [ARM-software/CMSIS_6](https://github.com/ARM-software/CMSIS_6) topic: pushed_at:2024-08 star:0.2k fork:0.1k CMSIS version 6 (successor of CMSIS_5)
- [ARM-software/Cortex_DFP](https://github.com/ARM-software/Cortex_DFP) topic: pushed_at:2024-06 star:0.0k fork:0.0k CMSIS generic Arm Cortex-M device family pack
...
- [ARM-software/CSAL](https://github.com/ARM-software/CSAL) topic: pushed_at:2024-06 star:0.1k fork:0.0k Coresight Access Library
- [ARM-software/ff-a-acs](https://github.com/ARM-software/ff-a-acs) topic: pushed_at:2024-07 star:0.0k fork:0.0k Firmware Framework for A Architecture Compliance Suite
...
- [ARM-software/MDK-Middleware](https://github.com/ARM-software/MDK-Middleware) topic: pushed_at:2024-08 star:0.1k fork:0.0k MDK-Middleware (file system, network and USB components) source code for Arm Cortex-M using CMSIS-Drivers and CMSIS-RTOS2 APIs.
...
- [ARM-software/optimized-routines](https://github.com/ARM-software/optimized-routines) topic: pushed_at:2024-08 star:0.6k fork:0.1k Optimized implementations of various library functions for ARM architecture processors
...
- [ARM-software/progress64](https://github.com/ARM-software/progress64) topic: pushed_at:2024-06 star:0.1k fork:0.0k PROGRESS64 is a C library of scalable functions for concurrent programs, primarily focused on networking applications.
- [ARM-software/psa-api](https://github.com/ARM-software/psa-api) topic:api,attestation,cryptography,firmware-update,iot,security pushed_at:2024-08 star:0.1k fork:0.0k Documentation source and development of the PSA Certified API
- [ARM-software/psa-arch-tests](https://github.com/ARM-software/psa-arch-tests) topic: pushed_at:2024-07 star:0.1k fork:0.1k Tests for verifying implementations of TBSA-v8M and the PSA Certified APIs
...
- [ARM-software/sbsa-acs](https://github.com/ARM-software/sbsa-acs) topic: pushed_at:2024-06 star:0.1k fork:0.1k ARM Enterprise: SBSA Architecture Compliance Suite
...
- [ARM-software/SCP-firmware](https://github.com/ARM-software/SCP-firmware) topic: pushed_at:2024-08 star:0.2k fork:0.2k Read-only mirror of System Control Processor (SCP) firmware
...
- [ARM-software/SDS-Framework](https://github.com/ARM-software/SDS-Framework) topic: pushed_at:2024-05 star:0.0k fork:0.0k Synchronous Data Stream (SDS) Framework allowing to record real-world data off a device and playing it back on Arm Virtual Hardware.
...
- [ARM-software/synchronization-benchmarks](https://github.com/ARM-software/synchronization-benchmarks) topic:micro-benchmarks,synchronization pushed_at:2024-05 star:0.0k fork:0.0k Collection of synchronization micro-benchmarks and traces from infrastructure applications
- [ARM-software/Tool-Solutions](https://github.com/ARM-software/Tool-Solutions) topic: pushed_at:2024-08 star:0.2k fork:0.1k Tutorials & examples for Arm software development tools.
...
- [ARM-software/android-nn-driver](https://github.com/ARM-software/android-nn-driver) topic: pushed_at:2024-05 star:0.1k fork:0.1k 
- [ARM-software/armnn](https://github.com/ARM-software/armnn) topic:machine-learning,neural-network,neural-networks pushed_at:2024-08 star:1.2k fork:0.3k Arm NN ML Software. The code here is a read-only mirror of https://review.mlplatform.org/admin/repos/ml/armnn
...
- [ARM-software/caiman](https://github.com/ARM-software/caiman) topic: pushed_at:2024-07 star:0.0k fork:0.0k Sources for Arm Streamline's caiman daemon
- [ARM-software/CMSIS-CV](https://github.com/ARM-software/CMSIS-CV) topic: pushed_at:2024-07 star:0.1k fork:0.0k Computer Vision library for IoT
- [ARM-software/ComputeLibrary](https://github.com/ARM-software/ComputeLibrary) topic:aarch64,android,arm,armv7,armv8,computer-vision,cpp,linux,machine-learning,neon,neural-network,opencl,simd,sve pushed_at:2024-08 star:2.8k fork:0.8k The Compute Library is a set of computer vision and machine learning functions optimised for both Arm CPUs and GPUs using SIMD technologies.
...
- [ARM-software/devtools](https://github.com/ARM-software/devtools) topic: pushed_at:2024-08 star:0.0k fork:0.0k Open-CMSIS-Pack development tools - C++ 
...
- [ARM-software/EndpointAI](https://github.com/ARM-software/EndpointAI) topic: pushed_at:2024-06 star:0.2k fork:0.1k 
- [ARM-software/ethos-n-driver-stack](https://github.com/ARM-software/ethos-n-driver-stack) topic: pushed_at:2024-08 star:0.1k fork:0.0k Driver stack (including user space libraries, kernel module and firmware) for the Arm® Ethos™-N NPU
- [ARM-software/gator](https://github.com/ARM-software/gator) topic:android,arm,arm64,game-development,linux,performance,performance-analysis,profiling pushed_at:2024-07 star:0.1k fork:0.1k Sources for Arm Streamline's gator daemon, part of Arm Mobile Studio suite of performance analysis tools
...
- [ARM-software/lavatube](https://github.com/ARM-software/lavatube) topic: pushed_at:2024-06 star:0.0k fork:0.0k Experimental Vulkan tracer
- [ARM-software/libcollector](https://github.com/ARM-software/libcollector) topic: pushed_at:2024-08 star:0.0k fork:0.0k 
- [ARM-software/libGPUCounters](https://github.com/ARM-software/libGPUCounters) topic: pushed_at:2024-07 star:0.2k fork:0.1k A utility library for application developers to sample Arm Immortalis GPU or Arm Mali GPU performance counters.
- [ARM-software/libGPUInfo](https://github.com/ARM-software/libGPUInfo) topic: pushed_at:2024-08 star:0.0k fork:0.0k A utility library for application developers to query the configuration of the Arm Immortalis GPU or Arm Mali GPU present in their system.
...
- [ARM-software/ML-examples](https://github.com/ARM-software/ML-examples) topic:arm,deep-learning,deep-neural-networks,machine-learning,ml,neural-network,python,raspberry-pi,raspberry-pi-3 pushed_at:2024-07 star:0.4k fork:0.2k Arm Machine Learning tutorials and examples
...
- [ARM-software/PAF](https://github.com/ARM-software/PAF) topic: pushed_at:2024-06 star:0.0k fork:0.0k PAF (the Physical Attack Framework) is a framework for learning about physical attacks: fault injection and side channels
...
- [ARM-software/tarmac-trace-utilities](https://github.com/ARM-software/tarmac-trace-utilities) topic: pushed_at:2024-08 star:0.1k fork:0.0k Tools for analyzing and browsing Tarmac instruction traces.
- [ARM-software/tracetooltests](https://github.com/ARM-software/tracetooltests) topic: pushed_at:2024-08 star:0.0k fork:0.0k 
- [ARM-software/vktrace-arm](https://github.com/ARM-software/vktrace-arm) topic: pushed_at:2024-08 star:0.0k fork:0.0k Vktrace arm fork
...
- [ARM-software/LLVM-embedded-toolchain-for-Arm](https://github.com/ARM-software/LLVM-embedded-toolchain-for-Arm) topic: pushed_at:2024-08 star:0.4k fork:0.1k A project dedicated to building LLVM toolchain for 32-bit Arm embedded targets.

## CSS

- [ARM-software/opengl-es-sdk-for-android](https://github.com/ARM-software/opengl-es-sdk-for-android) topic: pushed_at:2024-06 star:0.4k fork:0.1k OpenGL ES SDK for Android
...
- [ARM-software/bob-build](https://github.com/ARM-software/bob-build) topic:build-system,build-tool,build-tool-android,build-tool-linux,ninja-build pushed_at:2024-08 star:0.0k fork:0.0k Meta-build system using Blueprint and ninja
- [ARM-software/CMSIS-View](https://github.com/ARM-software/CMSIS-View) topic: pushed_at:2024-06 star:0.0k fork:0.0k Repository of CMSIS Software Pack for software event generation and input/output handling.
- [ARM-software/embedded-development-services-client](https://github.com/ARM-software/embedded-development-services-client) topic:client-library,development,embedded-development,golang-library,online-services pushed_at:2024-08 star:0.0k fork:0.0k Golang HTTP client for our embedded development online services offering
- [ARM-software/embedded-development-services-client-utils](https://github.com/ARM-software/embedded-development-services-client-utils) topic:client-library,golang-library,online-services,utilities,utility-library pushed_at:2024-07 star:0.0k fork:0.0k Helpers and utilities for Golang HTTP clients using our embedded development online services
- [ARM-software/golang-utils](https://github.com/ARM-software/golang-utils) topic:golang,golang-library,golang-module,helpers,utilities pushed_at:2024-08 star:0.0k fork:0.0k Helpers and utilities for Golang in order to do actions not available in the standard library.

## HTML

- [ARM-software/abi-aa](https://github.com/ARM-software/abi-aa) topic: pushed_at:2024-08 star:0.9k fork:0.2k Application Binary Interface for the Arm® Architecture
- [ARM-software/coresight-wire-protocol](https://github.com/ARM-software/coresight-wire-protocol) topic: pushed_at:2024-07 star:0.0k fork:0.0k Coresight Wire Protocol (CSWP) Server/Client and streaming trace examples.
...
- [ARM-software/lisa](https://github.com/ARM-software/lisa) topic: pushed_at:2024-08 star:0.2k fork:0.1k Linux Integrated System Analysis
- [ARM-software/mango](https://github.com/ARM-software/mango) topic:bayesian-optimization,blackbox-optimization,cluster-deployment,gaussian-processes,hyperparameter-optimization,hyperparameter-tuning,keras-examples,kubernetes-deployment,machine-learning,neural-network,neural-networks,parallel-computing,production-system,pytorch-compatible,scipy-compatible,sklearn-compatible,tensorflow-examples,tuning-parameters pushed_at:2024-08 star:0.3k fork:0.0k Parallel Hyperparameter Tuning in Python
...
- [ARM-software/cmsis-actions](https://github.com/ARM-software/cmsis-actions) topic: pushed_at:2024-07 star:0.0k fork:0.0k Custom GitHub actions for MDK / AVH-FVP CI workflows
- [ARM-software/data](https://github.com/ARM-software/data) topic: pushed_at:2024-04 star:0.0k fork:0.0k Machine-readable data describing Arm architecture and implementations. Includes JSON descriptions of implemented PMU events.
...
- [ARM-software/vscode-arm-debugger](https://github.com/ARM-software/vscode-arm-debugger) topic: pushed_at:2024-07 star:0.0k fork:0.0k 
- [ARM-software/vscode-cmsis-csolution](https://github.com/ARM-software/vscode-cmsis-csolution) topic: pushed_at:2024-07 star:0.0k fork:0.0k Extension support for VS Code CMSIS Project Extension
...
- [ARM-software/vscode-embedded-debug](https://github.com/ARM-software/vscode-embedded-debug) topic: pushed_at:2024-07 star:0.0k fork:0.0k Extension support for VS Code Embedded Debug Extension
- [ARM-software/vscode-environment-manager](https://github.com/ARM-software/vscode-environment-manager) topic: pushed_at:2024-05 star:0.0k fork:0.0k Extension support for VS Code Environment Manager Extension
...
- [ARM-software/vscode-remote-build](https://github.com/ARM-software/vscode-remote-build) topic: pushed_at:2024-06 star:0.0k fork:0.0k Extension for remote build service
...
- [ARM-software/ebbr](https://github.com/ARM-software/ebbr) topic: pushed_at:2024-07 star:0.1k fork:0.0k Embedded Base Boot Requirements Specification

## Python

- [ARM-software/acle](https://github.com/ARM-software/acle) topic: pushed_at:2024-08 star:0.1k fork:0.1k Arm C Language Extensions (ACLE)
- [ARM-software/avhclient](https://github.com/ARM-software/avhclient) topic: pushed_at:2024-06 star:0.0k fork:0.0k DEPRECATED: Arm Virtual Hardware Client
...
- [ARM-software/CMSIS-Stream](https://github.com/ARM-software/CMSIS-Stream) topic:arm,cortex-m,dataflow,dsp,embedded,ml,streaming pushed_at:2024-05 star:0.0k fork:0.0k CMSIS-Stream software component
...
- [ARM-software/devlib](https://github.com/ARM-software/devlib) topic: pushed_at:2024-08 star:0.0k fork:0.1k Library for interaction with and instrumentation of remote devices.
...
- [ARM-software/sbmr-acs](https://github.com/ARM-software/sbmr-acs) topic: pushed_at:2024-07 star:0.0k fork:0.0k Arm SBMR Architecture Compliance Suite
...
- [ARM-software/workload-automation](https://github.com/ARM-software/workload-automation) topic: pushed_at:2024-07 star:0.1k fork:0.1k A framework for automating workload execution and measurement collection on ARM devices.
...
- [ARM-software/arm-systemready](https://github.com/ARM-software/arm-systemready) topic: pushed_at:2024-08 star:0.0k fork:0.1k Arm SystemReady
