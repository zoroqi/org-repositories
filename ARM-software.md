...
- [ARM-software/Arm-2D](https://github.com/ARM-software/Arm-2D) topic: pushed_at:2025-08 star:0.4k fork:0.1k 2D Graphic Library optimized for Cortex-M processors
...
- [ARM-software/arm-trusted-firmware](https://github.com/ARM-software/arm-trusted-firmware) topic: pushed_at:2025-08 star:2.1k fork:1.5k Read-only mirror of Trusted Firmware-A
- [ARM-software/astc-encoder](https://github.com/ARM-software/astc-encoder) topic:astc,astcenc,compression,image-compression pushed_at:2025-08 star:1.2k fork:0.3k The Arm ASTC Encoder, a compressor for the Adaptive Scalable Texture Compression data format.
- [ARM-software/AVH](https://github.com/ARM-software/AVH) topic:avh,ci-cd,embedded,fvp,github-action,mlops,simulation pushed_at:2025-08 star:0.0k fork:0.0k AVH-FVP: Arm Virtual Hardware - Fixed Virtual Platform
...
- [ARM-software/bbr-acs](https://github.com/ARM-software/bbr-acs) topic: pushed_at:2025-08 star:0.0k fork:0.0k Arm SystemReady : BBR Compliance Suite
...
- [ARM-software/CMSIS-Compiler](https://github.com/ARM-software/CMSIS-Compiler) topic: pushed_at:2025-08 star:0.0k fork:0.0k CMSIS Compiler support for Arm Compiler
...
- [ARM-software/CMSIS-Driver](https://github.com/ARM-software/CMSIS-Driver) topic: pushed_at:2025-08 star:0.2k fork:0.1k Repository of microcontroller peripheral driver implementing the CMSIS-Driver API specification
- [ARM-software/CMSIS-Driver_Validation](https://github.com/ARM-software/CMSIS-Driver_Validation) topic: pushed_at:2025-08 star:0.0k fork:0.0k Test suite for verifying CMSIS-Driver implementations.
- [ARM-software/CMSIS-DSP](https://github.com/ARM-software/CMSIS-DSP) topic:cortex-a,cortex-m,dsp,embedded,fft,filter,fixed-point-arithmetic,matrix,ml,numpy pushed_at:2025-08 star:0.8k fork:0.2k CMSIS-DSP embedded compute library for Cortex-M and Cortex-A
- [ARM-software/CMSIS-FreeRTOS](https://github.com/ARM-software/CMSIS-FreeRTOS) topic: pushed_at:2025-08 star:0.6k fork:0.2k FreeRTOS adaptation for CMSIS-RTOS Version 2
...
- [ARM-software/CMSIS-NN](https://github.com/ARM-software/CMSIS-NN) topic: pushed_at:2025-08 star:0.3k fork:0.1k CMSIS-NN Library
- [ARM-software/CMSIS-RTOS2_Validation](https://github.com/ARM-software/CMSIS-RTOS2_Validation) topic: pushed_at:2025-08 star:0.0k fork:0.0k Validation test suite for CMSIS-RTOS2 API implementations using Arm Virtual Hardware (AVH).
- [ARM-software/CMSIS-RTX](https://github.com/ARM-software/CMSIS-RTX) topic: pushed_at:2025-08 star:0.1k fork:0.0k RTX5 real time kernel for Arm Cortex-based embedded systems (spin-off from CMSIS_5)
...
- [ARM-software/CMSIS_6](https://github.com/ARM-software/CMSIS_6) topic: pushed_at:2025-08 star:0.3k fork:0.1k CMSIS version 6 (successor of CMSIS_5)
- [ARM-software/Cortex_DFP](https://github.com/ARM-software/Cortex_DFP) topic: pushed_at:2025-08 star:0.0k fork:0.0k CMSIS generic Arm Cortex-M device family pack
...
- [ARM-software/kleidiai](https://github.com/ARM-software/kleidiai) topic: pushed_at:2025-08 star:0.1k fork:0.0k This repository is a read-only mirror of https://gitlab.arm.com/kleidi/kleidiai
...
- [ARM-software/MDK-Middleware](https://github.com/ARM-software/MDK-Middleware) topic: pushed_at:2025-08 star:0.1k fork:0.0k MDK-Middleware (file system, network and USB components) source code for Arm Cortex-M using CMSIS-Drivers and CMSIS-RTOS2 APIs.
...
- [ARM-software/optimized-routines](https://github.com/ARM-software/optimized-routines) topic: pushed_at:2025-08 star:0.7k fork:0.1k Optimized implementations of various library functions for ARM architecture processors
...
- [ARM-software/psa-api](https://github.com/ARM-software/psa-api) topic:api,attestation,cryptography,firmware-update,iot,security pushed_at:2025-08 star:0.1k fork:0.0k Documentation source and development of the PSA Certified API
...
- [ARM-software/SDS-Framework](https://github.com/ARM-software/SDS-Framework) topic: pushed_at:2025-08 star:0.0k fork:0.0k Synchronous Data Stream (SDS) Framework allowing to record real-world data off a device and playing it back on Arm Virtual Hardware.
...
- [ARM-software/sysarch-acs](https://github.com/ARM-software/sysarch-acs) topic: pushed_at:2025-08 star:0.0k fork:0.0k Arm System Architecture: Architecture Compliance Suite
...
- [ARM-software/armnn](https://github.com/ARM-software/armnn) topic:machine-learning,neural-network,neural-networks pushed_at:2025-08 star:1.3k fork:0.3k Arm NN ML Software. The code here is a read-only mirror of https://review.mlplatform.org/admin/repos/ml/armnn
...
- [ARM-software/CMSIS-CV](https://github.com/ARM-software/CMSIS-CV) topic: pushed_at:2025-08 star:0.1k fork:0.0k Computer Vision library for IoT
...
- [ARM-software/ComputeLibrary](https://github.com/ARM-software/ComputeLibrary) topic:aarch64,android,arm,armv7,armv8,computer-vision,cpp,linux,machine-learning,neon,neural-network,opencl,simd,sve pushed_at:2025-08 star:3.0k fork:0.8k The Compute Library is a set of computer vision and machine learning functions optimised for both Arm CPUs and GPUs using SIMD technologies.
...
- [ARM-software/devtools](https://github.com/ARM-software/devtools) topic: pushed_at:2025-08 star:0.0k fork:0.0k Open-CMSIS-Pack development tools - C++ 
...
- [ARM-software/gfxreconstruct-arm](https://github.com/ARM-software/gfxreconstruct-arm) topic: pushed_at:2025-08 star:0.0k fork:0.0k Graphics API Capture and Replay Tools for Reconstructing Graphics Application Behavior
...
- [ARM-software/lavatube](https://github.com/ARM-software/lavatube) topic: pushed_at:2025-08 star:0.0k fork:0.0k Experimental Vulkan tracer
...
- [ARM-software/spirv-simulator](https://github.com/ARM-software/spirv-simulator) topic: pushed_at:2025-08 star:0.0k fork:0.0k 
- [ARM-software/tarmac-trace-utilities](https://github.com/ARM-software/tarmac-trace-utilities) topic: pushed_at:2025-08 star:0.1k fork:0.0k Tools for analyzing and browsing Tarmac instruction traces.
- [ARM-software/tracetooltests](https://github.com/ARM-software/tracetooltests) topic: pushed_at:2025-08 star:0.0k fork:0.0k 
...
- [ARM-software/Vulkan-Samples](https://github.com/ARM-software/Vulkan-Samples) topic: pushed_at:2025-08 star:0.0k fork:0.0k One stop solution for all Vulkan samples
...
- [ARM-software/bob-build](https://github.com/ARM-software/bob-build) topic:build-system,build-tool,build-tool-android,build-tool-linux,ninja-build pushed_at:2025-08 star:0.0k fork:0.0k Meta-build system using Blueprint and ninja
- [ARM-software/CMSIS-View](https://github.com/ARM-software/CMSIS-View) topic: pushed_at:2025-08 star:0.0k fork:0.0k Repository of CMSIS Software Pack for software event generation and input/output handling.
- [ARM-software/embedded-development-services-client](https://github.com/ARM-software/embedded-development-services-client) topic:client-library,development,embedded-development,golang-library,online-services pushed_at:2025-08 star:0.0k fork:0.0k Golang HTTP client for our embedded development online services offering
- [ARM-software/embedded-development-services-client-utils](https://github.com/ARM-software/embedded-development-services-client-utils) topic:arm-tools,client-library,golang-library,online-services,utilities,utility-library pushed_at:2025-08 star:0.0k fork:0.0k Helpers and utilities for Golang HTTP clients using our embedded development online services
- [ARM-software/golang-utils](https://github.com/ARM-software/golang-utils) topic:golang,golang-library,golang-module,helpers,utilities pushed_at:2025-08 star:0.0k fork:0.0k Helpers and utilities for Golang in order to do actions not available in the standard library.

## HTML

- [ARM-software/abi-aa](https://github.com/ARM-software/abi-aa) topic: pushed_at:2025-08 star:1.1k fork:0.2k Application Binary Interface for the Arm® Architecture
...
- [ARM-software/lisa](https://github.com/ARM-software/lisa) topic: pushed_at:2025-08 star:0.2k fork:0.1k Linux Integrated System Analysis
...
- [ARM-software/cmsis-actions](https://github.com/ARM-software/cmsis-actions) topic: pushed_at:2025-08 star:0.0k fork:0.0k Custom GitHub actions for MDK / AVH-FVP CI workflows
...
- [ARM-software/ebbr](https://github.com/ARM-software/ebbr) topic: pushed_at:2025-08 star:0.1k fork:0.0k Embedded Base Boot Requirements Specification
...
- [ARM-software/arm-systemready](https://github.com/ARM-software/arm-systemready) topic: pushed_at:2025-08 star:0.1k fork:0.1k Arm SystemReady
...
- [ARM-software/sbmr-acs](https://github.com/ARM-software/sbmr-acs) topic: pushed_at:2025-08 star:0.0k fork:0.0k Arm SBMR Architecture Compliance Suite
...
- [ARM-software/Tool-Solutions](https://github.com/ARM-software/Tool-Solutions) topic: pushed_at:2025-08 star:0.3k fork:0.1k Tutorials & examples for Arm software development tools.
...
- [ARM-software/workload-automation](https://github.com/ARM-software/workload-automation) topic: pushed_at:2025-08 star:0.2k fork:0.1k A framework for automating workload execution and measurement collection on ARM devices.
