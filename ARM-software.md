...
- [ARM-software/arm-trusted-firmware](https://github.com/ARM-software/arm-trusted-firmware) topic: pushed_at:2025-10 star:2.1k fork:1.5k Read-only mirror of Trusted Firmware-A
...
- [ARM-software/CMSIS-Driver_Validation](https://github.com/ARM-software/CMSIS-Driver_Validation) topic: pushed_at:2025-10 star:0.0k fork:0.0k Test suite for verifying CMSIS-Driver implementations.
- [ARM-software/CMSIS-DSP](https://github.com/ARM-software/CMSIS-DSP) topic:cortex-a,cortex-m,dsp,embedded,fft,filter,fixed-point-arithmetic,matrix,ml,numpy pushed_at:2025-10 star:0.8k fork:0.2k CMSIS-DSP embedded compute library for Cortex-M and Cortex-A
- [ARM-software/CMSIS-FreeRTOS](https://github.com/ARM-software/CMSIS-FreeRTOS) topic: pushed_at:2025-10 star:0.6k fork:0.2k FreeRTOS adaptation for CMSIS-RTOS Version 2
...
- [ARM-software/CMSIS-RTOS2_Validation](https://github.com/ARM-software/CMSIS-RTOS2_Validation) topic: pushed_at:2025-10 star:0.0k fork:0.0k Validation test suite for CMSIS-RTOS2 API implementations using Arm Virtual Hardware (AVH).
- [ARM-software/CMSIS-RTX](https://github.com/ARM-software/CMSIS-RTX) topic: pushed_at:2025-10 star:0.1k fork:0.0k RTX5 real time kernel for Arm Cortex-based embedded systems (spin-off from CMSIS_5)
...
- [ARM-software/CMSIS_6](https://github.com/ARM-software/CMSIS_6) topic: pushed_at:2025-10 star:0.3k fork:0.1k CMSIS version 6 (successor of CMSIS_5)
...
- [ARM-software/kleidiai](https://github.com/ARM-software/kleidiai) topic: pushed_at:2025-10 star:0.1k fork:0.0k This repository is a read-only mirror of https://gitlab.arm.com/kleidi/kleidiai
...
- [ARM-software/MDK-Middleware](https://github.com/ARM-software/MDK-Middleware) topic: pushed_at:2025-10 star:0.1k fork:0.0k MDK-Middleware (file system, network and USB components) source code for Arm Cortex-M using CMSIS-Drivers and CMSIS-RTOS2 APIs.
...
- [ARM-software/optimized-routines](https://github.com/ARM-software/optimized-routines) topic: pushed_at:2025-10 star:0.7k fork:0.1k Optimized implementations of various library functions for ARM architecture processors
...
- [ARM-software/sysarch-acs](https://github.com/ARM-software/sysarch-acs) topic: pushed_at:2025-10 star:0.0k fork:0.0k Arm System Architecture: Architecture Compliance Suite
...
- [ARM-software/armnn](https://github.com/ARM-software/armnn) topic:machine-learning,neural-network,neural-networks pushed_at:2025-10 star:1.3k fork:0.3k Arm NN ML Software.
...
- [ARM-software/ComputeLibrary](https://github.com/ARM-software/ComputeLibrary) topic:aarch64,android,arm,armv7,armv8,computer-vision,cpp,linux,machine-learning,neon,neural-network,opencl,simd,sve pushed_at:2025-10 star:3.1k fork:0.8k The Compute Library is a set of computer vision and machine learning functions optimised for both Arm CPUs and GPUs using SIMD technologies.
...
- [ARM-software/devtools](https://github.com/ARM-software/devtools) topic: pushed_at:2025-10 star:0.0k fork:0.0k Open-CMSIS-Pack development tools - C++ 
...
- [ARM-software/gfxreconstruct-arm](https://github.com/ARM-software/gfxreconstruct-arm) topic: pushed_at:2025-10 star:0.0k fork:0.0k Graphics API Capture and Replay Tools for Reconstructing Graphics Application Behavior
...
- [ARM-software/libGPULayers](https://github.com/ARM-software/libGPULayers) topic: pushed_at:2025-10 star:0.0k fork:0.0k A utility for building Vulkan API layer drivers, and a some off-the-shelf layers for the Arm Immortalis and Arm Mali GPUs.
...
- [ARM-software/PAF](https://github.com/ARM-software/PAF) topic: pushed_at:2025-10 star:0.0k fork:0.0k PAF (the Physical Attack Framework) is a framework for learning about physical attacks: fault injection and side channels
...
- [ARM-software/spirv-simulator](https://github.com/ARM-software/spirv-simulator) topic: pushed_at:2025-10 star:0.0k fork:0.0k 
...
- [ARM-software/Vulkan-Samples](https://github.com/ARM-software/Vulkan-Samples) topic: pushed_at:2025-10 star:0.0k fork:0.0k One stop solution for all Vulkan samples
...
- [ARM-software/bob-build](https://github.com/ARM-software/bob-build) topic:build-system,build-tool,build-tool-android,build-tool-linux,ninja-build pushed_at:2025-10 star:0.0k fork:0.0k Meta-build system using Blueprint and ninja
...
- [ARM-software/embedded-development-services-client](https://github.com/ARM-software/embedded-development-services-client) topic:client-library,development,embedded-development,golang-library,online-services pushed_at:2025-10 star:0.0k fork:0.0k Golang HTTP client for our embedded development online services offering
- [ARM-software/embedded-development-services-client-utils](https://github.com/ARM-software/embedded-development-services-client-utils) topic:arm-tools,client-library,golang-library,online-services,utilities,utility-library pushed_at:2025-10 star:0.0k fork:0.0k Helpers and utilities for Golang HTTP clients using our embedded development online services
- [ARM-software/golang-utils](https://github.com/ARM-software/golang-utils) topic:golang,golang-library,golang-module,helpers,utilities pushed_at:2025-10 star:0.0k fork:0.0k Helpers and utilities for Golang in order to do actions not available in the standard library.
...
- [ARM-software/lisa](https://github.com/ARM-software/lisa) topic: pushed_at:2025-10 star:0.2k fork:0.1k Linux Integrated System Analysis
...
- [ARM-software/acle](https://github.com/ARM-software/acle) topic: pushed_at:2025-10 star:0.1k fork:0.1k Arm C Language Extensions (ACLE)
- [ARM-software/arm-systemready](https://github.com/ARM-software/arm-systemready) topic: pushed_at:2025-10 star:0.1k fork:0.1k Arm SystemReady
- [ARM-software/AVH](https://github.com/ARM-software/AVH) topic:avh,ci-cd,embedded,fvp,github-action,mlops,simulation pushed_at:2025-10 star:0.0k fork:0.0k AVH-FVP: Arm Virtual Hardware - Fixed Virtual Platform
...
- [ARM-software/labgrid](https://github.com/ARM-software/labgrid) topic: pushed_at:2025-10 star:0.0k fork:0.0k Embedded systems control library for development, testing and installation
...
- [ARM-software/Tool-Solutions](https://github.com/ARM-software/Tool-Solutions) topic: pushed_at:2025-10 star:0.3k fork:0.1k Scripts to build a wheel and a Docker image containing a complete ML framework stack, including dependencies, for AArch64 CPUs, as well as a selection of examples and benchmarks.
- [ARM-software/traceui](https://github.com/ARM-software/traceui) topic: pushed_at:2025-10 star:0.0k fork:0.0k traceui is a python application that is designed to streamline the process of creating and post-processing traces by automating as much of the workflow as possible.
