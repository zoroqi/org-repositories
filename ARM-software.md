...
- [ARM-software/arm-trusted-firmware](https://github.com/ARM-software/arm-trusted-firmware) pushed_at:2021-04 star:1.2k fork:0.9k Read-only mirror of Trusted Firmware-A
...
- [ARM-software/CMSIS-FreeRTOS](https://github.com/ARM-software/CMSIS-FreeRTOS) pushed_at:2020-12 star:0.3k fork:0.1k FreeRTOS adaptation for CMSIS-RTOS Version 2
...
- [ARM-software/CMSIS-Musca-S1](https://github.com/ARM-software/CMSIS-Musca-S1) pushed_at:2020-08 star:0.0k fork:0.0k Repository of CMSIS Software Pack for Musca-S1 test-chip and board.
...
- [ARM-software/CMSIS_5](https://github.com/ARM-software/CMSIS_5) pushed_at:2021-04 star:1.7k fork:0.7k CMSIS Version 5 Development Repository
...
- [ARM-software/CSAL](https://github.com/ARM-software/CSAL) pushed_at:2021-03 star:0.0k fork:0.0k Coresight Access Library
- [ARM-software/EndpointAI](https://github.com/ARM-software/EndpointAI) pushed_at:2021-04 star:0.1k fork:0.0k 
- [ARM-software/ff-a-acs](https://github.com/ARM-software/ff-a-acs) pushed_at:2021-04 star:0.0k fork:0.0k Firmware Framework for A Architecture Compliance Suite
...
- [ARM-software/libddssec](https://github.com/ARM-software/libddssec) pushed_at:2020-06 star:0.0k fork:0.0k DDS Security library
...
- [ARM-software/mobile-studio-integration-for-unity](https://github.com/ARM-software/mobile-studio-integration-for-unity) pushed_at:2021-04 star:0.0k fork:0.0k Mobile Studio tool integration with C# scripting for the Unity game engine.
...
- [ARM-software/optimized-routines](https://github.com/ARM-software/optimized-routines) pushed_at:2021-03 star:0.2k fork:0.1k Optimized implementations of various library functions for ARM architecture processors
- [ARM-software/perf-libs-tools](https://github.com/ARM-software/perf-libs-tools) pushed_at:2021-04 star:0.0k fork:0.0k 
...
- [ARM-software/psa-arch-tests](https://github.com/ARM-software/psa-arch-tests) pushed_at:2021-04 star:0.0k fork:0.1k Tests for verifying implementations of TBSA-v8M and the PSA Developer APIs
...
- [ARM-software/sbsa-acs](https://github.com/ARM-software/sbsa-acs) pushed_at:2021-04 star:0.1k fork:0.0k ARM Enterprise: SBSA Architecture Compliance Suite
- [ARM-software/scmi-tests](https://github.com/ARM-software/scmi-tests) pushed_at:2021-01 star:0.0k fork:0.0k Test suite for SCMI PDD
- [ARM-software/SCP-firmware](https://github.com/ARM-software/SCP-firmware) pushed_at:2021-04 star:0.1k fork:0.1k System Control Processor (SCP) firmware
...
- [ARM-software/Shackleton-Framework](https://github.com/ARM-software/Shackleton-Framework) pushed_at:2019-08 star:0.0k fork:0.0k A generic genetic programming framework that aims to make genetic programming easier for a myriad of uses. Currently, the main target is to use the framework for code optimization in tandem with the LLVM framework.
- [ARM-software/synchronization-benchmarks](https://github.com/ARM-software/synchronization-benchmarks) pushed_at:2020-12 star:0.0k fork:0.0k Collection of synchronization micro-benchmarks and traces from infrastructure applications
...
- [ARM-software/android-nn-driver](https://github.com/ARM-software/android-nn-driver) pushed_at:2021-04 star:0.1k fork:0.0k 
- [ARM-software/armnn](https://github.com/ARM-software/armnn) pushed_at:2021-04 star:0.7k fork:0.2k Arm NN ML Software. The code here is a read-only mirror of https://review.mlplatform.org/admin/repos/ml/armnn
...
- [ARM-software/astc-encoder](https://github.com/ARM-software/astc-encoder) pushed_at:2021-04 star:0.5k fork:0.1k This is the official repository for the Arm ASTC Encoder, a texture compressor for the Adaptive Scalable Texture Compression data format.
...
- [ARM-software/caiman](https://github.com/ARM-software/caiman) pushed_at:2020-11 star:0.0k fork:0.0k Sources for Arm Streamline's caiman daemon
- [ARM-software/ComputeLibrary](https://github.com/ARM-software/ComputeLibrary) pushed_at:2021-04 star:1.9k fork:0.6k The Compute Library is a set of computer vision and machine learning functions optimised for both Arm CPUs and GPUs using SIMD technologies.
- [ARM-software/developer](https://github.com/ARM-software/developer) pushed_at:2021-04 star:0.0k fork:0.0k GTM related documentation
...
- [ARM-software/gator](https://github.com/ARM-software/gator) pushed_at:2021-04 star:0.1k fork:0.1k Sources for Arm Streamline's gator daemon
...
- [ARM-software/patrace](https://github.com/ARM-software/patrace) pushed_at:2021-04 star:0.0k fork:0.0k 
...
- [ARM-software/tarmac-trace-utilities](https://github.com/ARM-software/tarmac-trace-utilities) pushed_at:2021-04 star:0.0k fork:0.0k Tools for analyzing and browsing Tarmac instruction traces.
- [ARM-software/Tool-Solutions](https://github.com/ARM-software/Tool-Solutions) pushed_at:2021-04 star:0.1k fork:0.1k Tutorials & examples for Arm software development tools.
- [ARM-software/vktrace-arm](https://github.com/ARM-software/vktrace-arm) pushed_at:2021-04 star:0.0k fork:0.0k Vktrace arm fork
...
- [ARM-software/vulkan_best_practice_for_mobile_developers](https://github.com/ARM-software/vulkan_best_practice_for_mobile_developers) pushed_at:2021-04 star:0.4k fork:0.0k Vulkan best practice for mobile developers

## CSS

- [ARM-software/opengl-es-sdk-for-android](https://github.com/ARM-software/opengl-es-sdk-for-android) pushed_at:2021-04 star:0.2k fork:0.1k OpenGL ES SDK for Android
...
- [ARM-software/CMSIS-Zone](https://github.com/ARM-software/CMSIS-Zone) pushed_at:2020-05 star:0.0k fork:0.0k Repository for CMSIS-Zone eclipse plug-in

## Go

- [ARM-software/bob-build](https://github.com/ARM-software/bob-build) pushed_at:2021-04 star:0.0k fork:0.0k Meta-build system using Blueprint and ninja
...
- [ARM-software/cmsis-pack-eclipse](https://github.com/ARM-software/cmsis-pack-eclipse) pushed_at:2020-09 star:0.0k fork:0.0k CMSIS-Pack Eclipse Plug-ins

## Jupyter Notebook

- [ARM-software/lisa](https://github.com/ARM-software/lisa) pushed_at:2021-04 star:0.1k fork:0.1k Linux Integrated System Analysis
- [ARM-software/mango](https://github.com/ARM-software/mango) pushed_at:2021-04 star:0.1k fork:0.0k Parallel Hyperparameter Optimization in Python
...
- [ARM-software/arm-systemready](https://github.com/ARM-software/arm-systemready) pushed_at:2020-10 star:0.0k fork:0.0k Arm SystemReady
- [ARM-software/bbr-acs](https://github.com/ARM-software/bbr-acs) pushed_at:2020-10 star:0.0k fork:0.0k Arm SystemReady : BBR Compliance Suite
...
- [ARM-software/bsa-acs](https://github.com/ARM-software/bsa-acs) pushed_at:2020-10 star:0.0k fork:0.0k Arm SystemReady : BSA Architecture Compliance Suite
- [ARM-software/data](https://github.com/ARM-software/data) pushed_at:2020-11 star:0.0k fork:0.0k Machine-readable data describing Arm architecture and implementations. Includes JSON descriptions of implemented PMU events.
...
- [ARM-software/bm-plotter](https://github.com/ARM-software/bm-plotter) pushed_at:2020-12 star:0.0k fork:0.0k A tool for plotting graphs to compare benchmark results.

## PostScript

- [ARM-software/ebbr](https://github.com/ARM-software/ebbr) pushed_at:2021-04 star:0.1k fork:0.0k Embedded Base Boot Requirements Specification
...
- [ARM-software/daq-server](https://github.com/ARM-software/daq-server) pushed_at:2019-11 star:0.0k fork:0.0k Server for remote access to National Instruments DAQ devices
- [ARM-software/devlib](https://github.com/ARM-software/devlib) pushed_at:2021-04 star:0.0k fork:0.1k Library for interaction with and instrumentation of remote devices.
- [ARM-software/LLVM-embedded-toolchain-for-Arm](https://github.com/ARM-software/LLVM-embedded-toolchain-for-Arm) pushed_at:2021-04 star:0.0k fork:0.0k A project dedicated to build LLVM toolchain for 32-bit Arm embedded targets.
...
- [ARM-software/abi-aa](https://github.com/ARM-software/abi-aa) pushed_at:2021-04 star:0.2k fork:0.0k Application Binary Interface for the Arm® Architecture
- [ARM-software/acle](https://github.com/ARM-software/acle) pushed_at:2021-04 star:0.0k fork:0.0k Arm C Language Extensions (ACLE)
- [ARM-software/ML-zoo](https://github.com/ARM-software/ML-zoo) pushed_at:2021-04 star:0.0k fork:0.0k 
