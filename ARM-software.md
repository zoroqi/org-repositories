...
- [ARM-software/Arm-2D](https://github.com/ARM-software/Arm-2D) topic: pushed_at:2024-10 star:0.3k fork:0.1k 2D Graphic Library optimized for Cortex-M processors
...
- [ARM-software/arm-trusted-firmware](https://github.com/ARM-software/arm-trusted-firmware) topic: pushed_at:2024-10 star:1.9k fork:1.4k Read-only mirror of Trusted Firmware-A
- [ARM-software/astc-encoder](https://github.com/ARM-software/astc-encoder) topic:astc,astcenc,compression,image-compression pushed_at:2024-10 star:1.1k fork:0.2k The Arm ASTC Encoder, a compressor for the Adaptive Scalable Texture Compression data format.
- [ARM-software/AVH](https://github.com/ARM-software/AVH) topic:avh,ci-cd,embedded,fvp,github-action,mlops,simulation pushed_at:2024-10 star:0.0k fork:0.0k AVH-FVP: Arm Virtual Hardware - Fixed Virtual Platform
...
- [ARM-software/bbr-acs](https://github.com/ARM-software/bbr-acs) topic: pushed_at:2024-09 star:0.0k fork:0.0k Arm SystemReady : BBR Compliance Suite
...
- [ARM-software/bsa-acs](https://github.com/ARM-software/bsa-acs) topic: pushed_at:2024-10 star:0.0k fork:0.0k Arm SystemReady : BSA Architecture Compliance Suite
- [ARM-software/cca-rmm-acs](https://github.com/ARM-software/cca-rmm-acs) topic: pushed_at:2024-09 star:0.0k fork:0.0k Tests for verifying compliance of RMM implementations
...
- [ARM-software/CMSIS-Driver](https://github.com/ARM-software/CMSIS-Driver) topic: pushed_at:2024-10 star:0.2k fork:0.1k Repository of microcontroller peripheral driver implementing the CMSIS-Driver API specification
...
- [ARM-software/CMSIS-DSP](https://github.com/ARM-software/CMSIS-DSP) topic:cortex-a,cortex-m,dsp,embedded,fft,filter,fixed-point-arithmetic,matrix,ml,numpy pushed_at:2024-10 star:0.5k fork:0.1k CMSIS-DSP embedded compute library for Cortex-M and Cortex-A
...
- [ARM-software/CMSIS-NN](https://github.com/ARM-software/CMSIS-NN) topic: pushed_at:2024-10 star:0.2k fork:0.1k CMSIS-NN Library
...
- [ARM-software/CMSIS_5](https://github.com/ARM-software/CMSIS_5) topic: pushed_at:2024-09 star:1.3k fork:1.1k CMSIS Version 5 Development Repository
- [ARM-software/CMSIS_6](https://github.com/ARM-software/CMSIS_6) topic: pushed_at:2024-09 star:0.2k fork:0.1k CMSIS version 6 (successor of CMSIS_5)
...
- [ARM-software/ff-a-acs](https://github.com/ARM-software/ff-a-acs) topic: pushed_at:2024-08 star:0.0k fork:0.0k Firmware Framework for A Architecture Compliance Suite
...
- [ARM-software/MDK-Middleware](https://github.com/ARM-software/MDK-Middleware) topic: pushed_at:2024-10 star:0.1k fork:0.0k MDK-Middleware (file system, network and USB components) source code for Arm Cortex-M using CMSIS-Drivers and CMSIS-RTOS2 APIs.
...
- [ARM-software/optimized-routines](https://github.com/ARM-software/optimized-routines) topic: pushed_at:2024-10 star:0.6k fork:0.1k Optimized implementations of various library functions for ARM architecture processors
...
- [ARM-software/psa-api](https://github.com/ARM-software/psa-api) topic:api,attestation,cryptography,firmware-update,iot,security pushed_at:2024-10 star:0.1k fork:0.0k Documentation source and development of the PSA Certified API
- [ARM-software/psa-arch-tests](https://github.com/ARM-software/psa-arch-tests) topic: pushed_at:2024-10 star:0.1k fork:0.1k Tests for verifying implementations of TBSA-v8M and the PSA Certified APIs
...
- [ARM-software/sbsa-acs](https://github.com/ARM-software/sbsa-acs) topic: pushed_at:2024-10 star:0.1k fork:0.1k ARM Enterprise: SBSA Architecture Compliance Suite
...
- [ARM-software/Tool-Solutions](https://github.com/ARM-software/Tool-Solutions) topic: pushed_at:2024-08 star:0.3k fork:0.1k Tutorials & examples for Arm software development tools.
...
- [ARM-software/android-nn-driver](https://github.com/ARM-software/android-nn-driver) topic: pushed_at:2024-08 star:0.2k fork:0.1k 
- [ARM-software/armnn](https://github.com/ARM-software/armnn) topic:machine-learning,neural-network,neural-networks pushed_at:2024-10 star:1.2k fork:0.3k Arm NN ML Software. The code here is a read-only mirror of https://review.mlplatform.org/admin/repos/ml/armnn
...
- [ARM-software/CMSIS-CV](https://github.com/ARM-software/CMSIS-CV) topic: pushed_at:2024-10 star:0.1k fork:0.0k Computer Vision library for IoT
- [ARM-software/ComputeLibrary](https://github.com/ARM-software/ComputeLibrary) topic:aarch64,android,arm,armv7,armv8,computer-vision,cpp,linux,machine-learning,neon,neural-network,opencl,simd,sve pushed_at:2024-09 star:2.8k fork:0.8k The Compute Library is a set of computer vision and machine learning functions optimised for both Arm CPUs and GPUs using SIMD technologies.
...
- [ARM-software/devtools](https://github.com/ARM-software/devtools) topic: pushed_at:2024-10 star:0.0k fork:0.0k Open-CMSIS-Pack development tools - C++ 
...
- [ARM-software/EndpointAI](https://github.com/ARM-software/EndpointAI) topic: pushed_at:2024-10 star:0.2k fork:0.1k 
...
- [ARM-software/lavatube](https://github.com/ARM-software/lavatube) topic: pushed_at:2024-09 star:0.0k fork:0.0k Experimental Vulkan tracer
...
- [ARM-software/libGPUInfo](https://github.com/ARM-software/libGPUInfo) topic:arm,vulkan pushed_at:2024-08 star:0.0k fork:0.0k A utility library for application developers to query the configuration of the Arm Immortalis GPU or Arm Mali GPU present in their system.
...
- [ARM-software/ML-examples](https://github.com/ARM-software/ML-examples) topic:arm,deep-learning,deep-neural-networks,machine-learning,ml,neural-network,python,raspberry-pi,raspberry-pi-3 pushed_at:2024-10 star:0.4k fork:0.2k Arm Machine Learning tutorials and examples
...
- [ARM-software/tracetooltests](https://github.com/ARM-software/tracetooltests) topic: pushed_at:2024-09 star:0.0k fork:0.0k 
- [ARM-software/vktrace-arm](https://github.com/ARM-software/vktrace-arm) topic: pushed_at:2024-09 star:0.0k fork:0.0k Vktrace arm fork
...
- [ARM-software/LLVM-embedded-toolchain-for-Arm](https://github.com/ARM-software/LLVM-embedded-toolchain-for-Arm) topic: pushed_at:2024-10 star:0.4k fork:0.1k A project dedicated to building LLVM toolchain for Arm and AArch64 embedded targets.
...
- [ARM-software/bob-build](https://github.com/ARM-software/bob-build) topic:build-system,build-tool,build-tool-android,build-tool-linux,ninja-build pushed_at:2024-10 star:0.0k fork:0.0k Meta-build system using Blueprint and ninja
...
- [ARM-software/embedded-development-services-client](https://github.com/ARM-software/embedded-development-services-client) topic:client-library,development,embedded-development,golang-library,online-services pushed_at:2024-10 star:0.0k fork:0.0k Golang HTTP client for our embedded development online services offering
- [ARM-software/embedded-development-services-client-utils](https://github.com/ARM-software/embedded-development-services-client-utils) topic:client-library,golang-library,online-services,utilities,utility-library pushed_at:2024-08 star:0.0k fork:0.0k Helpers and utilities for Golang HTTP clients using our embedded development online services
- [ARM-software/golang-utils](https://github.com/ARM-software/golang-utils) topic:golang,golang-library,golang-module,helpers,utilities pushed_at:2024-10 star:0.0k fork:0.0k Helpers and utilities for Golang in order to do actions not available in the standard library.

## HTML

- [ARM-software/abi-aa](https://github.com/ARM-software/abi-aa) topic: pushed_at:2024-10 star:0.9k fork:0.2k Application Binary Interface for the Arm® Architecture
...
- [ARM-software/lisa](https://github.com/ARM-software/lisa) topic: pushed_at:2024-10 star:0.2k fork:0.1k Linux Integrated System Analysis
...
- [ARM-software/cmsis-actions](https://github.com/ARM-software/cmsis-actions) topic: pushed_at:2024-09 star:0.0k fork:0.0k Custom GitHub actions for MDK / AVH-FVP CI workflows
...
- [ARM-software/labgrid](https://github.com/ARM-software/labgrid) topic: pushed_at:2024-10 star:0.0k fork:0.0k Embedded systems control library for development, testing and installation
...
- [ARM-software/vscode-cmsis-csolution](https://github.com/ARM-software/vscode-cmsis-csolution) topic: pushed_at:2024-10 star:0.0k fork:0.0k Extension support for VS Code CMSIS Project Extension
...
- [ARM-software/vscode-environment-manager](https://github.com/ARM-software/vscode-environment-manager) topic: pushed_at:2024-09 star:0.0k fork:0.0k Extension support for VS Code Environment Manager Extension
...
- [ARM-software/ebbr](https://github.com/ARM-software/ebbr) topic: pushed_at:2024-10 star:0.1k fork:0.0k Embedded Base Boot Requirements Specification

## Python

- [ARM-software/acle](https://github.com/ARM-software/acle) topic: pushed_at:2024-09 star:0.1k fork:0.1k Arm C Language Extensions (ACLE)
...
- [ARM-software/libGPULayers](https://github.com/ARM-software/libGPULayers) topic: pushed_at:2024-10 star:0.0k fork:0.0k A utility for building graphics API layer drivers, and a some off-the-shelf layers for the Arm Immortalis and Arm Mali GPUs.
...
- [ARM-software/arm-systemready](https://github.com/ARM-software/arm-systemready) topic: pushed_at:2024-10 star:0.1k fork:0.1k Arm SystemReady
