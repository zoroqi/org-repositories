...
- [ARM-software/arm-trusted-firmware](https://github.com/ARM-software/arm-trusted-firmware) pushed_at:2021-02 Read-only mirror of Trusted Firmware-A
...
- [ARM-software/CMSIS_5](https://github.com/ARM-software/CMSIS_5) pushed_at:2021-02 CMSIS Version 5 Development Repository
- [ARM-software/CPA](https://github.com/ARM-software/CPA) pushed_at:2017-11 Contiguous page allocator project
- [ARM-software/cryptocell-312-runtime](https://github.com/ARM-software/cryptocell-312-runtime) pushed_at:2021-02 CryptoCell 312 runtime code
...
- [ARM-software/Cryptocell-713-TEE-Lib](https://github.com/ARM-software/Cryptocell-713-TEE-Lib) pushed_at:2020-09 
- [ARM-software/CSAL](https://github.com/ARM-software/CSAL) pushed_at:2020-09 Coresight Access Library
- [ARM-software/fluent-bit-modbus-plugin](https://github.com/ARM-software/fluent-bit-modbus-plugin) pushed_at:2020-04   A dynamic Modbus plugin for Fluent Bit
- [ARM-software/iot-platform-sw](https://github.com/ARM-software/iot-platform-sw) pushed_at:2016-07 ARM Platform SDK code
- [ARM-software/libddssec](https://github.com/ARM-software/libddssec) pushed_at:2020-06 DDS Security library
...
- [ARM-software/sbsa-acs](https://github.com/ARM-software/sbsa-acs) pushed_at:2021-02 ARM Enterprise: SBSA Architecture Compliance Suite
- [ARM-software/scmi-tests](https://github.com/ARM-software/scmi-tests) pushed_at:2021-01 Test suite for SCMI PDD
- [ARM-software/SCP-firmware](https://github.com/ARM-software/SCP-firmware) pushed_at:2021-02 System Control Processor (SCP) firmware
...
- [ARM-software/nomali-model](https://github.com/ARM-software/nomali-model) pushed_at:2016-01 A simple Mali 6xx/7xx register interface model that doesn't do any rendering.
...
- [ARM-software/opengl-es-sdk-for-android](https://github.com/ARM-software/opengl-es-sdk-for-android) pushed_at:2020-02 OpenGL ES SDK for Android
- [ARM-software/vr-sdk-for-android](https://github.com/ARM-software/vr-sdk-for-android) pushed_at:2017-07 VR SDK for Android

## Dockerfile

- [ARM-software/arm-hpc-tools](https://github.com/ARM-software/arm-hpc-tools) pushed_at:2019-03 This repository is home to a dockerfile for an aarch64 ubuntu image containing Arm Compiler for HPC.

## FreeMarker

- [ARM-software/CMSIS-Zone](https://github.com/ARM-software/CMSIS-Zone) pushed_at:2020-05 Repository for CMSIS-Zone eclipse plug-in
...
- [ARM-software/coresight-wire-protocol](https://github.com/ARM-software/coresight-wire-protocol) pushed_at:2020-08 Coresight Wire Protocol (CSWP) Server/Client and streaming trace examples.

## Java

- [ARM-software/cmsis-pack-eclipse](https://github.com/ARM-software/cmsis-pack-eclipse) pushed_at:2020-09 CMSIS-Pack Eclipse Plug-ins
...
- [ARM-software/asl-interpreter](https://github.com/ARM-software/asl-interpreter) pushed_at:2019-08 Example implementation of Arm's Architecture Specification Language (ASL)
...
- [ARM-software/Tool-Solutions](https://github.com/ARM-software/Tool-Solutions) pushed_at:2021-02 Tutorials & examples for Arm software development tools.
...
- [ARM-software/third-party-source](https://github.com/ARM-software/third-party-source) pushed_at:2019-10 Source code snapshots of third party OSS

## Perl

- [ARM-software/bm-plotter](https://github.com/ARM-software/bm-plotter) pushed_at:2020-12 A tool for plotting graphs to compare benchmark results.

## PostScript

- [ARM-software/ebbr](https://github.com/ARM-software/ebbr) pushed_at:2021-02 Embedded Base Boot Requirements Specification
...
- [ARM-software/devlib](https://github.com/ARM-software/devlib) pushed_at:2021-02 Library for interaction with and instrumentation of remote devices.
...
- [ARM-software/workload-automation](https://github.com/ARM-software/workload-automation) pushed_at:2021-02 A framework for automating workload execution and measurement collection on ARM devices.
...
- [ARM-software/smart_proxy_realm_activedirectory](https://github.com/ARM-software/smart_proxy_realm_activedirectory) pushed_at:2020-03 
...
- [ARM-software/DeepFreeze](https://github.com/ARM-software/DeepFreeze) pushed_at:2019-12 
