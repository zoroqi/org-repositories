...
- [ARM-software/Arm-2D](https://github.com/ARM-software/Arm-2D) topic: pushed_at:2024-09 star:0.3k fork:0.1k 2D Graphic Library optimized for Cortex-M processors
...
- [ARM-software/arm-trusted-firmware](https://github.com/ARM-software/arm-trusted-firmware) topic: pushed_at:2024-09 star:1.9k fork:1.4k Read-only mirror of Trusted Firmware-A
- [ARM-software/astc-encoder](https://github.com/ARM-software/astc-encoder) topic:astc,astcenc,compression,image-compression pushed_at:2024-09 star:1.0k fork:0.2k The Arm ASTC Encoder, a compressor for the Adaptive Scalable Texture Compression data format.
...
- [ARM-software/bsa-acs](https://github.com/ARM-software/bsa-acs) topic: pushed_at:2024-09 star:0.0k fork:0.0k Arm SystemReady : BSA Architecture Compliance Suite
...
- [ARM-software/CMSIS-DSP](https://github.com/ARM-software/CMSIS-DSP) topic:cortex-a,cortex-m,dsp,embedded,fft,filter,fixed-point-arithmetic,matrix,ml,numpy pushed_at:2024-09 star:0.5k fork:0.1k CMSIS-DSP embedded compute library for Cortex-M and Cortex-A
...
- [ARM-software/CMSIS-NN](https://github.com/ARM-software/CMSIS-NN) topic: pushed_at:2024-09 star:0.2k fork:0.1k CMSIS-NN Library
...
- [ARM-software/MDK-Middleware](https://github.com/ARM-software/MDK-Middleware) topic: pushed_at:2024-09 star:0.1k fork:0.0k MDK-Middleware (file system, network and USB components) source code for Arm Cortex-M using CMSIS-Drivers and CMSIS-RTOS2 APIs.
...
- [ARM-software/optimized-routines](https://github.com/ARM-software/optimized-routines) topic: pushed_at:2024-09 star:0.6k fork:0.1k Optimized implementations of various library functions for ARM architecture processors
...
- [ARM-software/psa-api](https://github.com/ARM-software/psa-api) topic:api,attestation,cryptography,firmware-update,iot,security pushed_at:2024-09 star:0.1k fork:0.0k Documentation source and development of the PSA Certified API
- [ARM-software/psa-arch-tests](https://github.com/ARM-software/psa-arch-tests) topic: pushed_at:2024-09 star:0.1k fork:0.1k Tests for verifying implementations of TBSA-v8M and the PSA Certified APIs
...
- [ARM-software/sbsa-acs](https://github.com/ARM-software/sbsa-acs) topic: pushed_at:2024-09 star:0.1k fork:0.1k ARM Enterprise: SBSA Architecture Compliance Suite
...
- [ARM-software/armnn](https://github.com/ARM-software/armnn) topic:machine-learning,neural-network,neural-networks pushed_at:2024-09 star:1.2k fork:0.3k Arm NN ML Software. The code here is a read-only mirror of https://review.mlplatform.org/admin/repos/ml/armnn
...
- [ARM-software/devtools](https://github.com/ARM-software/devtools) topic: pushed_at:2024-09 star:0.0k fork:0.0k Open-CMSIS-Pack development tools - C++ 
...
- [ARM-software/EndpointAI](https://github.com/ARM-software/EndpointAI) topic: pushed_at:2024-09 star:0.2k fork:0.1k 
...
- [ARM-software/ML-examples](https://github.com/ARM-software/ML-examples) topic:arm,deep-learning,deep-neural-networks,machine-learning,ml,neural-network,python,raspberry-pi,raspberry-pi-3 pushed_at:2024-09 star:0.4k fork:0.2k Arm Machine Learning tutorials and examples
...
- [ARM-software/LLVM-embedded-toolchain-for-Arm](https://github.com/ARM-software/LLVM-embedded-toolchain-for-Arm) topic: pushed_at:2024-09 star:0.4k fork:0.1k A project dedicated to building LLVM toolchain for Arm and AArch64 embedded targets.
...
- [ARM-software/bob-build](https://github.com/ARM-software/bob-build) topic:build-system,build-tool,build-tool-android,build-tool-linux,ninja-build pushed_at:2024-09 star:0.0k fork:0.0k Meta-build system using Blueprint and ninja
...
- [ARM-software/golang-utils](https://github.com/ARM-software/golang-utils) topic:golang,golang-library,golang-module,helpers,utilities pushed_at:2024-09 star:0.0k fork:0.0k Helpers and utilities for Golang in order to do actions not available in the standard library.

## HTML

- [ARM-software/abi-aa](https://github.com/ARM-software/abi-aa) topic: pushed_at:2024-09 star:0.9k fork:0.2k Application Binary Interface for the Arm® Architecture
...
- [ARM-software/lisa](https://github.com/ARM-software/lisa) topic: pushed_at:2024-09 star:0.2k fork:0.1k Linux Integrated System Analysis
...
- [ARM-software/labgrid](https://github.com/ARM-software/labgrid) topic: pushed_at:2024-09 star:0.0k fork:0.0k Embedded systems control library for development, testing and installation
...
- [ARM-software/ebbr](https://github.com/ARM-software/ebbr) topic: pushed_at:2024-08 star:0.1k fork:0.0k Embedded Base Boot Requirements Specification
...
- [ARM-software/devlib](https://github.com/ARM-software/devlib) topic: pushed_at:2024-09 star:0.0k fork:0.1k Library for interaction with and instrumentation of remote devices.
- [ARM-software/libGPULayers](https://github.com/ARM-software/libGPULayers) topic: pushed_at:2024-09 star:0.0k fork:0.0k A utility for building graphics API layer drivers, and a some off-the-shelf layers for the Arm Immortalis and Arm Mali GPUs.
