...
- [ARM-software/Arm-2D](https://github.com/ARM-software/Arm-2D) topic: pushed_at:2023-08 star:0.2k fork:0.0k 2D Graphic Library optimized for Cortex-M processors
...
- [ARM-software/arm-trusted-firmware](https://github.com/ARM-software/arm-trusted-firmware) topic: pushed_at:2023-08 star:1.7k fork:1.2k Read-only mirror of Trusted Firmware-A
- [ARM-software/astc-encoder](https://github.com/ARM-software/astc-encoder) topic:astc,astcenc,compression,image-compression pushed_at:2023-08 star:0.8k fork:0.2k The Arm ASTC Encoder, a compressor for the Adaptive Scalable Texture Compression data format.
...
- [ARM-software/bbr-acs](https://github.com/ARM-software/bbr-acs) topic: pushed_at:2023-08 star:0.0k fork:0.0k Arm SystemReady : BBR Compliance Suite
...
- [ARM-software/bsa-acs](https://github.com/ARM-software/bsa-acs) topic: pushed_at:2023-08 star:0.0k fork:0.0k Arm SystemReady : BSA Architecture Compliance Suite
...
- [ARM-software/CMSIS-DFP](https://github.com/ARM-software/CMSIS-DFP) topic: pushed_at:2023-08 star:0.0k fork:0.0k CMSIS generic Arm Cortex-M device family pack
...
- [ARM-software/CMSIS-DSP](https://github.com/ARM-software/CMSIS-DSP) topic:cortex-a,cortex-m,dsp,embedded,fft,filter,fixed-point-arithmetic,matrix,ml,numpy pushed_at:2023-08 star:0.3k fork:0.1k CMSIS-DSP embedded compute library for Cortex-M and Cortex-A
...
- [ARM-software/CMSIS-NN](https://github.com/ARM-software/CMSIS-NN) topic: pushed_at:2023-08 star:0.1k fork:0.0k CMSIS-NN Library
- [ARM-software/CMSIS-RTOS2_Validation](https://github.com/ARM-software/CMSIS-RTOS2_Validation) topic: pushed_at:2023-08 star:0.0k fork:0.0k Validation test suite for CMSIS-RTOS2 API implementations using Arm Virtual Hardware (AVH).
- [ARM-software/CMSIS-RTX](https://github.com/ARM-software/CMSIS-RTX) topic: pushed_at:2023-08 star:0.0k fork:0.0k RTX5 real time kernel for Arm Cortex-based embedded systems (spin-off from CMSIS_5)
...
- [ARM-software/CMSIS_5](https://github.com/ARM-software/CMSIS_5) topic: pushed_at:2023-08 star:1.0k fork:1.1k CMSIS Version 5 Development Repository
- [ARM-software/CMSIS_6](https://github.com/ARM-software/CMSIS_6) topic: pushed_at:2023-08 star:0.0k fork:0.0k Next major version of CMSIS (successor for CMSIS_5)
...
- [ARM-software/optimized-routines](https://github.com/ARM-software/optimized-routines) topic: pushed_at:2023-08 star:0.5k fork:0.1k Optimized implementations of various library functions for ARM architecture processors
...
- [ARM-software/psa-api](https://github.com/ARM-software/psa-api) topic: pushed_at:2023-08 star:0.0k fork:0.0k Documentation source and development of the PSA Certified API
- [ARM-software/psa-arch-tests](https://github.com/ARM-software/psa-arch-tests) topic: pushed_at:2023-08 star:0.1k fork:0.1k Tests for verifying implementations of TBSA-v8M and the PSA Certified APIs
...
- [ARM-software/sbsa-acs](https://github.com/ARM-software/sbsa-acs) topic: pushed_at:2023-08 star:0.1k fork:0.1k ARM Enterprise: SBSA Architecture Compliance Suite
...
- [ARM-software/SCP-firmware](https://github.com/ARM-software/SCP-firmware) topic: pushed_at:2023-08 star:0.2k fork:0.2k System Control Processor (SCP) firmware
...
- [ARM-software/Tool-Solutions](https://github.com/ARM-software/Tool-Solutions) topic: pushed_at:2023-08 star:0.2k fork:0.1k Tutorials & examples for Arm software development tools.
...
- [ARM-software/android-nn-driver](https://github.com/ARM-software/android-nn-driver) topic: pushed_at:2023-08 star:0.1k fork:0.1k 
- [ARM-software/armnn](https://github.com/ARM-software/armnn) topic:machine-learning,neural-network,neural-networks pushed_at:2023-08 star:1.0k fork:0.3k Arm NN ML Software. The code here is a read-only mirror of https://review.mlplatform.org/admin/repos/ml/armnn
...
- [ARM-software/caiman](https://github.com/ARM-software/caiman) topic: pushed_at:2023-08 star:0.0k fork:0.0k Sources for Arm Streamline's caiman daemon
...
- [ARM-software/devtools](https://github.com/ARM-software/devtools) topic: pushed_at:2023-08 star:0.0k fork:0.0k Open-CMSIS-Pack development tools - C++ 
...
- [ARM-software/gator](https://github.com/ARM-software/gator) topic: pushed_at:2023-08 star:0.1k fork:0.1k Sources for Arm Streamline's gator daemon
- [ARM-software/HPCG_for_Arm](https://github.com/ARM-software/HPCG_for_Arm) topic: pushed_at:2022-12 star:0.0k fork:0.0k 
- [ARM-software/HWCPipe](https://github.com/ARM-software/HWCPipe) topic: pushed_at:2023-08 star:0.2k fork:0.0k Hardware counters interface
...
- [ARM-software/lavatube](https://github.com/ARM-software/lavatube) topic: pushed_at:2023-08 star:0.0k fork:0.0k Experimental Vulkan tracer
...
- [ARM-software/tracetooltests](https://github.com/ARM-software/tracetooltests) topic: pushed_at:2023-08 star:0.0k fork:0.0k 
...
- [ARM-software/LLVM-embedded-toolchain-for-Arm](https://github.com/ARM-software/LLVM-embedded-toolchain-for-Arm) topic: pushed_at:2023-08 star:0.3k fork:0.1k A project dedicated to building LLVM toolchain for 32-bit Arm embedded targets.
...
- [ARM-software/bob-build](https://github.com/ARM-software/bob-build) topic:build-system,build-tool,build-tool-android,build-tool-linux,ninja-build pushed_at:2023-08 star:0.0k fork:0.0k Meta-build system using Blueprint and ninja
...
- [ARM-software/golang-utils](https://github.com/ARM-software/golang-utils) topic:golang,golang-library,golang-module,helpers,utilities pushed_at:2023-08 star:0.0k fork:0.0k Helpers and utilities for Golang in order to do actions not available in the standard library.

## HTML

- [ARM-software/abi-aa](https://github.com/ARM-software/abi-aa) topic: pushed_at:2023-08 star:0.7k fork:0.1k Application Binary Interface for the Arm® Architecture
...
- [ARM-software/lisa](https://github.com/ARM-software/lisa) topic: pushed_at:2023-08 star:0.2k fork:0.1k Linux Integrated System Analysis
...
- [ARM-software/vscode-cmsis-csolution](https://github.com/ARM-software/vscode-cmsis-csolution) topic: pushed_at:2023-08 star:0.0k fork:0.0k Extension support for VS Code CMSIS Project Extension
...
- [ARM-software/vscode-embedded-debug](https://github.com/ARM-software/vscode-embedded-debug) topic: pushed_at:2023-08 star:0.0k fork:0.0k Extension support for VS Code Embedded Debug Extension
...
- [ARM-software/acle](https://github.com/ARM-software/acle) topic: pushed_at:2023-08 star:0.1k fork:0.0k Arm C Language Extensions (ACLE)
- [ARM-software/AVH](https://github.com/ARM-software/AVH) topic:avh,ci-cd,embedded,fvp,github-action,mlops,simulation pushed_at:2023-07 star:0.0k fork:0.0k AVH FVPs: Arm Virtual Hardware with Fixed Virtual Platforms
...
- [ARM-software/CMSIS-Stream](https://github.com/ARM-software/CMSIS-Stream) topic:arm,cortex-m,dataflow,dsp,embedded,ml,streaming pushed_at:2023-08 star:0.0k fork:0.0k CMSIS-Stream software component
...
- [ARM-software/devlib](https://github.com/ARM-software/devlib) topic: pushed_at:2023-08 star:0.0k fork:0.1k Library for interaction with and instrumentation of remote devices.
...
- [ARM-software/workload-automation](https://github.com/ARM-software/workload-automation) topic: pushed_at:2023-08 star:0.1k fork:0.1k A framework for automating workload execution and measurement collection on ARM devices.
...
- [ARM-software/arm-systemready](https://github.com/ARM-software/arm-systemready) topic: pushed_at:2023-08 star:0.0k fork:0.0k Arm SystemReady
