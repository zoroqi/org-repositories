...
- [ARM-software/arm-trusted-firmware](https://github.com/ARM-software/arm-trusted-firmware) pushed_at:2021-08 star:1.2k fork:1.0k Read-only mirror of Trusted Firmware-A
- [ARM-software/bbr-acs](https://github.com/ARM-software/bbr-acs) pushed_at:2021-08 star:0.0k fork:0.0k Arm SystemReady : BBR Compliance Suite
...
- [ARM-software/CMSIS-Driver](https://github.com/ARM-software/CMSIS-Driver) pushed_at:2021-08 star:0.1k fork:0.0k Repository of microcontroller peripheral driver implementing the CMSIS-Driver API specification
...
- [ARM-software/CMSIS-FreeRTOS](https://github.com/ARM-software/CMSIS-FreeRTOS) pushed_at:2021-08 star:0.3k fork:0.1k FreeRTOS adaptation for CMSIS-RTOS Version 2
...
- [ARM-software/CMSIS_5](https://github.com/ARM-software/CMSIS_5) pushed_at:2021-08 star:0.2k fork:0.8k CMSIS Version 5 Development Repository
...
- [ARM-software/CSAL](https://github.com/ARM-software/CSAL) pushed_at:2021-08 star:0.0k fork:0.0k Coresight Access Library
- [ARM-software/EndpointAI](https://github.com/ARM-software/EndpointAI) pushed_at:2021-08 star:0.1k fork:0.1k 
...
- [ARM-software/psa-arch-tests](https://github.com/ARM-software/psa-arch-tests) pushed_at:2021-08 star:0.0k fork:0.1k Tests for verifying implementations of TBSA-v8M and the PSA Developer APIs
...
- [ARM-software/sbsa-acs](https://github.com/ARM-software/sbsa-acs) pushed_at:2021-07 star:0.1k fork:0.1k ARM Enterprise: SBSA Architecture Compliance Suite
...
- [ARM-software/SCP-firmware](https://github.com/ARM-software/SCP-firmware) pushed_at:2021-08 star:0.1k fork:0.1k System Control Processor (SCP) firmware
...
- [ARM-software/Shackleton-Framework](https://github.com/ARM-software/Shackleton-Framework) pushed_at:2021-08 star:0.0k fork:0.0k A generic genetic programming framework that aims to make genetic programming easier for a myriad of uses. Currently, the main target is to use the framework for code optimization in tandem with the LLVM framework.
...
- [ARM-software/android-nn-driver](https://github.com/ARM-software/android-nn-driver) pushed_at:2021-08 star:0.1k fork:0.0k 
- [ARM-software/armnn](https://github.com/ARM-software/armnn) pushed_at:2021-08 star:0.8k fork:0.2k Arm NN ML Software. The code here is a read-only mirror of https://review.mlplatform.org/admin/repos/ml/armnn
...
- [ARM-software/astc-encoder](https://github.com/ARM-software/astc-encoder) pushed_at:2021-08 star:0.5k fork:0.1k This is the official repository for the Arm ASTC Encoder, a texture compressor for the Adaptive Scalable Texture Compression data format.
...
- [ARM-software/caiman](https://github.com/ARM-software/caiman) pushed_at:2021-05 star:0.0k fork:0.0k Sources for Arm Streamline's caiman daemon
- [ARM-software/ComputeLibrary](https://github.com/ARM-software/ComputeLibrary) pushed_at:2021-08 star:2.0k fork:0.6k The Compute Library is a set of computer vision and machine learning functions optimised for both Arm CPUs and GPUs using SIMD technologies.
- [ARM-software/developer](https://github.com/ARM-software/developer) pushed_at:2021-08 star:0.0k fork:0.0k GTM related documentation
...
- [ARM-software/ethos-n-driver-stack](https://github.com/ARM-software/ethos-n-driver-stack) pushed_at:2021-08 star:0.0k fork:0.0k Driver stack (including user space libraries, kernel module and firmware) for the Arm® Ethos™-N NPU
- [ARM-software/gator](https://github.com/ARM-software/gator) pushed_at:2021-06 star:0.1k fork:0.1k Sources for Arm Streamline's gator daemon
...
- [ARM-software/ML-examples](https://github.com/ARM-software/ML-examples) pushed_at:2021-08 star:0.2k fork:0.1k Arm Machine Learning tutorials and examples
...
- [ARM-software/tarmac-trace-utilities](https://github.com/ARM-software/tarmac-trace-utilities) pushed_at:2021-08 star:0.0k fork:0.0k Tools for analyzing and browsing Tarmac instruction traces.
- [ARM-software/Tool-Solutions](https://github.com/ARM-software/Tool-Solutions) pushed_at:2021-08 star:0.1k fork:0.1k Tutorials & examples for Arm software development tools.
- [ARM-software/vktrace-arm](https://github.com/ARM-software/vktrace-arm) pushed_at:2021-07 star:0.0k fork:0.0k Vktrace arm fork
...
- [ARM-software/bob-build](https://github.com/ARM-software/bob-build) pushed_at:2021-08 star:0.0k fork:0.0k Meta-build system using Blueprint and ninja
- [ARM-software/golang-utils](https://github.com/ARM-software/golang-utils) pushed_at:2021-08 star:0.0k fork:0.0k Helpers and utilities for Golang in order to do actions not available in the standard library.
...
- [ARM-software/fast-probabilistic-models](https://github.com/ARM-software/fast-probabilistic-models) pushed_at:2021-08 star:0.0k fork:0.0k 
- [ARM-software/keyword-transformer](https://github.com/ARM-software/keyword-transformer) pushed_at:2021-05 star:0.0k fork:0.0k 
- [ARM-software/lisa](https://github.com/ARM-software/lisa) pushed_at:2021-08 star:0.1k fork:0.1k Linux Integrated System Analysis
- [ARM-software/mango](https://github.com/ARM-software/mango) pushed_at:2021-08 star:0.1k fork:0.0k Parallel Hyperparameter Tuning in Python
...
- [ARM-software/acle](https://github.com/ARM-software/acle) pushed_at:2021-07 star:0.0k fork:0.0k Arm C Language Extensions (ACLE)
...
- [ARM-software/devlib](https://github.com/ARM-software/devlib) pushed_at:2021-08 star:0.0k fork:0.1k Library for interaction with and instrumentation of remote devices.
- [ARM-software/LLVM-embedded-toolchain-for-Arm](https://github.com/ARM-software/LLVM-embedded-toolchain-for-Arm) pushed_at:2021-08 star:0.0k fork:0.0k A project dedicated to build LLVM toolchain for 32-bit Arm embedded targets.
- [ARM-software/ML-zoo](https://github.com/ARM-software/ML-zoo) pushed_at:2021-08 star:0.0k fork:0.0k 
...
- [ARM-software/workload-automation](https://github.com/ARM-software/workload-automation) pushed_at:2021-08 star:0.1k fork:0.1k A framework for automating workload execution and measurement collection on ARM devices.
...
- [ARM-software/abi-aa](https://github.com/ARM-software/abi-aa) pushed_at:2021-08 star:0.2k fork:0.1k Application Binary Interface for the Arm® Architecture
- [ARM-software/arm-systemready](https://github.com/ARM-software/arm-systemready) pushed_at:2021-08 star:0.0k fork:0.0k Arm SystemReady
