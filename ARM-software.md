...
- [ARM-software/arm-trusted-firmware](https://github.com/ARM-software/arm-trusted-firmware) topic: pushed_at:2023-02 star:1.6k fork:1.2k Read-only mirror of Trusted Firmware-A
- [ARM-software/astc-encoder](https://github.com/ARM-software/astc-encoder) topic:astc,astcenc,compression,image-compression pushed_at:2023-02 star:0.8k fork:0.2k The Arm ASTC Encoder, a compressor for the Adaptive Scalable Texture Compression data format.
...
- [ARM-software/CMSIS-Driver_Validation](https://github.com/ARM-software/CMSIS-Driver_Validation) topic: pushed_at:2023-02 star:0.0k fork:0.0k Test suite for verifying CMSIS-Driver implementations.
- [ARM-software/CMSIS-DSP](https://github.com/ARM-software/CMSIS-DSP) topic:cortex-a,cortex-m,dsp,embedded,fft,filter,fixed-point-arithmetic,matrix,ml,numpy pushed_at:2023-03 star:0.1k fork:0.0k CMSIS-DSP embedded compute library for Cortex-M and Cortex-A
...
- [ARM-software/CMSIS-RTOS2_Validation](https://github.com/ARM-software/CMSIS-RTOS2_Validation) topic: pushed_at:2023-02 star:0.0k fork:0.0k Validation test suite for CMSIS-RTOS2 API implementations using Arm Virtual Hardware (AVH).
...
- [ARM-software/progress64](https://github.com/ARM-software/progress64) topic: pushed_at:2023-02 star:0.1k fork:0.0k PROGRESS64 is a C library of scalable functions for concurrent programs, primarily focused on networking applications.
...
- [ARM-software/SCP-firmware](https://github.com/ARM-software/SCP-firmware) topic: pushed_at:2023-02 star:0.2k fork:0.1k System Control Processor (SCP) firmware
...
- [ARM-software/workload-automation](https://github.com/ARM-software/workload-automation) topic: pushed_at:2023-02 star:0.1k fork:0.1k A framework for automating workload execution and measurement collection on ARM devices.
...
- [ARM-software/arm-systemready](https://github.com/ARM-software/arm-systemready) topic: pushed_at:2023-02 star:0.0k fork:0.0k Arm SystemReady
