...
- [ARM-software/Arm-2D](https://github.com/ARM-software/Arm-2D) topic: pushed_at:2025-01 star:0.3k fork:0.1k 2D Graphic Library optimized for Cortex-M processors
...
- [ARM-software/arm-trusted-firmware](https://github.com/ARM-software/arm-trusted-firmware) topic: pushed_at:2025-01 star:2.0k fork:1.4k Read-only mirror of Trusted Firmware-A
- [ARM-software/astc-encoder](https://github.com/ARM-software/astc-encoder) topic:astc,astcenc,compression,image-compression pushed_at:2025-01 star:1.1k fork:0.2k The Arm ASTC Encoder, a compressor for the Adaptive Scalable Texture Compression data format.
...
- [ARM-software/bbr-acs](https://github.com/ARM-software/bbr-acs) topic: pushed_at:2025-01 star:0.0k fork:0.0k Arm SystemReady : BBR Compliance Suite
...
- [ARM-software/bsa-acs](https://github.com/ARM-software/bsa-acs) topic: pushed_at:2025-01 star:0.0k fork:0.0k Arm SystemReady : BSA Architecture Compliance Suite
- [ARM-software/cca-rmm-acs](https://github.com/ARM-software/cca-rmm-acs) topic: pushed_at:2025-01 star:0.0k fork:0.0k Tests for verifying compliance of RMM implementations
...
- [ARM-software/CMSIS-Driver](https://github.com/ARM-software/CMSIS-Driver) topic: pushed_at:2025-01 star:0.2k fork:0.1k Repository of microcontroller peripheral driver implementing the CMSIS-Driver API specification
- [ARM-software/CMSIS-Driver_Validation](https://github.com/ARM-software/CMSIS-Driver_Validation) topic: pushed_at:2025-01 star:0.0k fork:0.0k Test suite for verifying CMSIS-Driver implementations.
- [ARM-software/CMSIS-DSP](https://github.com/ARM-software/CMSIS-DSP) topic:cortex-a,cortex-m,dsp,embedded,fft,filter,fixed-point-arithmetic,matrix,ml,numpy pushed_at:2025-01 star:0.6k fork:0.2k CMSIS-DSP embedded compute library for Cortex-M and Cortex-A
- [ARM-software/CMSIS-FreeRTOS](https://github.com/ARM-software/CMSIS-FreeRTOS) topic: pushed_at:2024-11 star:0.5k fork:0.2k FreeRTOS adaptation for CMSIS-RTOS Version 2
...
- [ARM-software/CMSIS-NN](https://github.com/ARM-software/CMSIS-NN) topic: pushed_at:2025-01 star:0.2k fork:0.1k CMSIS-NN Library
...
- [ARM-software/CSAL](https://github.com/ARM-software/CSAL) topic: pushed_at:2025-01 star:0.1k fork:0.0k Coresight Access Library
- [ARM-software/ff-a-acs](https://github.com/ARM-software/ff-a-acs) topic: pushed_at:2024-12 star:0.0k fork:0.0k Firmware Framework for A Architecture Compliance Suite
...
- [ARM-software/kleidiai](https://github.com/ARM-software/kleidiai) topic: pushed_at:2025-01 star:0.0k fork:0.0k This repository is a read-only mirror of https://gitlab.arm.com/kleidi/kleidiai
...
- [ARM-software/MDK-Middleware](https://github.com/ARM-software/MDK-Middleware) topic: pushed_at:2025-01 star:0.1k fork:0.0k MDK-Middleware (file system, network and USB components) source code for Arm Cortex-M using CMSIS-Drivers and CMSIS-RTOS2 APIs.
...
- [ARM-software/optimized-routines](https://github.com/ARM-software/optimized-routines) topic: pushed_at:2025-01 star:0.6k fork:0.1k Optimized implementations of various library functions for ARM architecture processors
...
- [ARM-software/progress64](https://github.com/ARM-software/progress64) topic: pushed_at:2025-01 star:0.1k fork:0.0k PROGRESS64 is a C library of scalable functions for concurrent programs, primarily focused on networking applications.
...
- [ARM-software/sbsa-acs](https://github.com/ARM-software/sbsa-acs) topic: pushed_at:2025-01 star:0.1k fork:0.1k ARM Enterprise: SBSA Architecture Compliance Suite
...
- [ARM-software/SDS-Framework](https://github.com/ARM-software/SDS-Framework) topic: pushed_at:2024-11 star:0.0k fork:0.0k Synchronous Data Stream (SDS) Framework allowing to record real-world data off a device and playing it back on Arm Virtual Hardware.
...
- [ARM-software/armnn](https://github.com/ARM-software/armnn) topic:machine-learning,neural-network,neural-networks pushed_at:2025-01 star:1.2k fork:0.3k Arm NN ML Software. The code here is a read-only mirror of https://review.mlplatform.org/admin/repos/ml/armnn
...
- [ARM-software/devtools](https://github.com/ARM-software/devtools) topic: pushed_at:2025-01 star:0.0k fork:0.0k Open-CMSIS-Pack development tools - C++ 
...
- [ARM-software/lavatube](https://github.com/ARM-software/lavatube) topic: pushed_at:2025-01 star:0.0k fork:0.0k Experimental Vulkan tracer
- [ARM-software/libcollector](https://github.com/ARM-software/libcollector) topic: pushed_at:2025-01 star:0.0k fork:0.0k 
...
- [ARM-software/libGPULayers](https://github.com/ARM-software/libGPULayers) topic: pushed_at:2025-01 star:0.0k fork:0.0k A utility for building graphics API layer drivers, and a some off-the-shelf layers for the Arm Immortalis and Arm Mali GPUs.
...
- [ARM-software/PAF](https://github.com/ARM-software/PAF) topic: pushed_at:2025-01 star:0.0k fork:0.0k PAF (the Physical Attack Framework) is a framework for learning about physical attacks: fault injection and side channels
...
- [ARM-software/LLVM-embedded-toolchain-for-Arm](https://github.com/ARM-software/LLVM-embedded-toolchain-for-Arm) topic: pushed_at:2025-01 star:0.4k fork:0.1k A project dedicated to building LLVM toolchain for Arm and AArch64 embedded targets.
...
- [ARM-software/golang-utils](https://github.com/ARM-software/golang-utils) topic:golang,golang-library,golang-module,helpers,utilities pushed_at:2025-01 star:0.0k fork:0.0k Helpers and utilities for Golang in order to do actions not available in the standard library.

## HTML

- [ARM-software/abi-aa](https://github.com/ARM-software/abi-aa) topic: pushed_at:2025-01 star:1.0k fork:0.2k Application Binary Interface for the Arm® Architecture
...
- [ARM-software/lisa](https://github.com/ARM-software/lisa) topic: pushed_at:2025-01 star:0.2k fork:0.1k Linux Integrated System Analysis
...
- [ARM-software/cmsis-actions](https://github.com/ARM-software/cmsis-actions) topic: pushed_at:2024-12 star:0.0k fork:0.0k Custom GitHub actions for MDK / AVH-FVP CI workflows
...
- [ARM-software/MDK-Toolbox](https://github.com/ARM-software/MDK-Toolbox) topic: pushed_at:2024-12 star:0.0k fork:0.0k MDK-Toolbox documentation
...
- [ARM-software/acle](https://github.com/ARM-software/acle) topic: pushed_at:2025-01 star:0.1k fork:0.1k Arm C Language Extensions (ACLE)
- [ARM-software/arm-systemready](https://github.com/ARM-software/arm-systemready) topic: pushed_at:2025-01 star:0.1k fork:0.1k Arm SystemReady
...
- [ARM-software/devlib](https://github.com/ARM-software/devlib) topic: pushed_at:2024-10 star:0.0k fork:0.1k Library for interaction with and instrumentation of remote devices.
- [ARM-software/labgrid](https://github.com/ARM-software/labgrid) topic: pushed_at:2025-01 star:0.0k fork:0.0k Embedded systems control library for development, testing and installation
...
- [ARM-software/Tool-Solutions](https://github.com/ARM-software/Tool-Solutions) topic: pushed_at:2025-01 star:0.3k fork:0.1k Tutorials & examples for Arm software development tools.
...
- [ARM-software/workload-automation](https://github.com/ARM-software/workload-automation) topic: pushed_at:2024-09 star:0.2k fork:0.1k A framework for automating workload execution and measurement collection on ARM devices.
