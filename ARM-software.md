...
- [ARM-software/Arm-2D](https://github.com/ARM-software/Arm-2D) topic: pushed_at:2025-06 star:0.3k fork:0.1k 2D Graphic Library optimized for Cortex-M processors
...
- [ARM-software/arm-trusted-firmware](https://github.com/ARM-software/arm-trusted-firmware) topic: pushed_at:2025-06 star:2.1k fork:1.5k Read-only mirror of Trusted Firmware-A
- [ARM-software/astc-encoder](https://github.com/ARM-software/astc-encoder) topic:astc,astcenc,compression,image-compression pushed_at:2025-05 star:1.2k fork:0.3k The Arm ASTC Encoder, a compressor for the Adaptive Scalable Texture Compression data format.
...
- [ARM-software/bsa-acs](https://github.com/ARM-software/bsa-acs) topic: pushed_at:2025-06 star:0.0k fork:0.0k Arm SystemReady : BSA Architecture Compliance Suite
...
- [ARM-software/CMSIS-DSP](https://github.com/ARM-software/CMSIS-DSP) topic:cortex-a,cortex-m,dsp,embedded,fft,filter,fixed-point-arithmetic,matrix,ml,numpy pushed_at:2025-06 star:0.7k fork:0.2k CMSIS-DSP embedded compute library for Cortex-M and Cortex-A
- [ARM-software/CMSIS-FreeRTOS](https://github.com/ARM-software/CMSIS-FreeRTOS) topic: pushed_at:2025-05 star:0.6k fork:0.2k FreeRTOS adaptation for CMSIS-RTOS Version 2
...
- [ARM-software/CMSIS-NN](https://github.com/ARM-software/CMSIS-NN) topic: pushed_at:2025-06 star:0.3k fork:0.1k CMSIS-NN Library
...
- [ARM-software/CMSIS-RTX](https://github.com/ARM-software/CMSIS-RTX) topic: pushed_at:2025-05 star:0.1k fork:0.0k RTX5 real time kernel for Arm Cortex-based embedded systems (spin-off from CMSIS_5)
...
- [ARM-software/CMSIS_6](https://github.com/ARM-software/CMSIS_6) topic: pushed_at:2025-06 star:0.3k fork:0.1k CMSIS version 6 (successor of CMSIS_5)
...
- [ARM-software/CSAL](https://github.com/ARM-software/CSAL) topic: pushed_at:2025-05 star:0.1k fork:0.0k Coresight Access Library
...
- [ARM-software/kleidiai](https://github.com/ARM-software/kleidiai) topic: pushed_at:2025-06 star:0.0k fork:0.0k This repository is a read-only mirror of https://gitlab.arm.com/kleidi/kleidiai
...
- [ARM-software/MDK-Middleware](https://github.com/ARM-software/MDK-Middleware) topic: pushed_at:2025-04 star:0.1k fork:0.0k MDK-Middleware (file system, network and USB components) source code for Arm Cortex-M using CMSIS-Drivers and CMSIS-RTOS2 APIs.
...
- [ARM-software/optimized-routines](https://github.com/ARM-software/optimized-routines) topic: pushed_at:2025-06 star:0.6k fork:0.1k Optimized implementations of various library functions for ARM architecture processors
...
- [ARM-software/psa-api](https://github.com/ARM-software/psa-api) topic:api,attestation,cryptography,firmware-update,iot,security pushed_at:2025-06 star:0.1k fork:0.0k Documentation source and development of the PSA Certified API
- [ARM-software/psa-arch-tests](https://github.com/ARM-software/psa-arch-tests) topic: pushed_at:2025-06 star:0.1k fork:0.1k Tests for verifying implementations of TBSA-v8M and the PSA Certified APIs
...
- [ARM-software/SDS-Framework](https://github.com/ARM-software/SDS-Framework) topic: pushed_at:2025-06 star:0.0k fork:0.0k Synchronous Data Stream (SDS) Framework allowing to record real-world data off a device and playing it back on Arm Virtual Hardware.
...
- [ARM-software/synchronization-benchmarks](https://github.com/ARM-software/synchronization-benchmarks) topic:micro-benchmarks,synchronization pushed_at:2025-06 star:0.0k fork:0.0k Collection of synchronization micro-benchmarks and traces from infrastructure applications
- [ARM-software/sysarch-acs](https://github.com/ARM-software/sysarch-acs) topic: pushed_at:2025-06 star:0.0k fork:0.0k Arm System Architecture: Architecture Compliance Suite
...
- [ARM-software/armnn](https://github.com/ARM-software/armnn) topic:machine-learning,neural-network,neural-networks pushed_at:2025-06 star:1.3k fork:0.3k Arm NN ML Software. The code here is a read-only mirror of https://review.mlplatform.org/admin/repos/ml/armnn
...
- [ARM-software/ComputeLibrary](https://github.com/ARM-software/ComputeLibrary) topic:aarch64,android,arm,armv7,armv8,computer-vision,cpp,linux,machine-learning,neon,neural-network,opencl,simd,sve pushed_at:2025-06 star:3.0k fork:0.8k The Compute Library is a set of computer vision and machine learning functions optimised for both Arm CPUs and GPUs using SIMD technologies.
...
- [ARM-software/devtools](https://github.com/ARM-software/devtools) topic: pushed_at:2025-06 star:0.0k fork:0.0k Open-CMSIS-Pack development tools - C++ 
...
- [ARM-software/lavatube](https://github.com/ARM-software/lavatube) topic: pushed_at:2025-06 star:0.0k fork:0.0k Experimental Vulkan tracer
- [ARM-software/libcollector](https://github.com/ARM-software/libcollector) topic: pushed_at:2025-04 star:0.0k fork:0.0k 
- [ARM-software/libGPUCounters](https://github.com/ARM-software/libGPUCounters) topic: pushed_at:2025-06 star:0.2k fork:0.1k A utility library for application developers to sample Arm Immortalis GPU or Arm Mali GPU performance counters.
...
- [ARM-software/libGPULayers](https://github.com/ARM-software/libGPULayers) topic: pushed_at:2025-06 star:0.0k fork:0.0k A utility for building graphics API layer drivers, and a some off-the-shelf layers for the Arm Immortalis and Arm Mali GPUs.
...
- [ARM-software/ML-examples](https://github.com/ARM-software/ML-examples) topic:arm,deep-learning,deep-neural-networks,machine-learning,ml,neural-network,python,raspberry-pi,raspberry-pi-3 pushed_at:2025-06 star:0.5k fork:0.2k Arm Machine Learning tutorials and examples
...
- [ARM-software/PAF](https://github.com/ARM-software/PAF) topic: pushed_at:2025-06 star:0.0k fork:0.0k PAF (the Physical Attack Framework) is a framework for learning about physical attacks: fault injection and side channels
...
- [ARM-software/spirv-simulator](https://github.com/ARM-software/spirv-simulator) topic: pushed_at:2025-06 star:0.0k fork:0.0k 
- [ARM-software/tarmac-trace-utilities](https://github.com/ARM-software/tarmac-trace-utilities) topic: pushed_at:2025-06 star:0.1k fork:0.0k Tools for analyzing and browsing Tarmac instruction traces.
- [ARM-software/tracetooltests](https://github.com/ARM-software/tracetooltests) topic: pushed_at:2025-05 star:0.0k fork:0.0k 
...
- [ARM-software/bob-build](https://github.com/ARM-software/bob-build) topic:build-system,build-tool,build-tool-android,build-tool-linux,ninja-build pushed_at:2025-06 star:0.0k fork:0.0k Meta-build system using Blueprint and ninja
- [ARM-software/CMSIS-View](https://github.com/ARM-software/CMSIS-View) topic: pushed_at:2025-05 star:0.0k fork:0.0k Repository of CMSIS Software Pack for software event generation and input/output handling.
- [ARM-software/embedded-development-services-client](https://github.com/ARM-software/embedded-development-services-client) topic:client-library,development,embedded-development,golang-library,online-services pushed_at:2025-06 star:0.0k fork:0.0k Golang HTTP client for our embedded development online services offering
- [ARM-software/embedded-development-services-client-utils](https://github.com/ARM-software/embedded-development-services-client-utils) topic:arm-tools,client-library,golang-library,online-services,utilities,utility-library pushed_at:2025-06 star:0.0k fork:0.0k Helpers and utilities for Golang HTTP clients using our embedded development online services
- [ARM-software/golang-utils](https://github.com/ARM-software/golang-utils) topic:golang,golang-library,golang-module,helpers,utilities pushed_at:2025-06 star:0.0k fork:0.0k Helpers and utilities for Golang in order to do actions not available in the standard library.

## HTML

- [ARM-software/abi-aa](https://github.com/ARM-software/abi-aa) topic: pushed_at:2025-06 star:1.1k fork:0.2k Application Binary Interface for the Arm® Architecture
...
- [ARM-software/lisa](https://github.com/ARM-software/lisa) topic: pushed_at:2025-05 star:0.2k fork:0.1k Linux Integrated System Analysis
...
- [ARM-software/gfxreconstruct-arm](https://github.com/ARM-software/gfxreconstruct-arm) topic: pushed_at:2025-06 star:0.0k fork:0.0k Graphics API Capture and Replay Tools for Reconstructing Graphics Application Behavior
...
- [ARM-software/vscode-cmsis-csolution](https://github.com/ARM-software/vscode-cmsis-csolution) topic: pushed_at:2025-05 star:0.0k fork:0.0k Extension support for VS Code CMSIS Project Extension
...
- [ARM-software/arm-systemready](https://github.com/ARM-software/arm-systemready) topic: pushed_at:2025-06 star:0.1k fork:0.1k Arm SystemReady
...
- [ARM-software/CMSIS-Stream](https://github.com/ARM-software/CMSIS-Stream) topic:arm,cortex-m,dataflow,dsp,embedded,ml,streaming pushed_at:2025-06 star:0.0k fork:0.0k CMSIS-Stream software component
...
- [ARM-software/devlib](https://github.com/ARM-software/devlib) topic: pushed_at:2025-05 star:0.0k fork:0.1k Library for interaction with and instrumentation of remote devices.
...
- [ARM-software/Tool-Solutions](https://github.com/ARM-software/Tool-Solutions) topic: pushed_at:2025-06 star:0.3k fork:0.1k Tutorials & examples for Arm software development tools.
...
- [ARM-software/traceui](https://github.com/ARM-software/traceui) topic: pushed_at:2025-05 star:0.0k fork:0.0k traceui is a python application that is designed to streamline the process of creating and post-processing traces by automating as much of the workflow as possible.
