...
- [ARM-software/AArch64cryptolib](https://github.com/ARM-software/AArch64cryptolib) topic: pushed_at:2023-02 star:0.0k fork:0.0k AArch64cryptolib is a from scratch implementation of cryptographic primitives aiming for optimal performance on Arm A-class cores
- [ARM-software/Arm-2D](https://github.com/ARM-software/Arm-2D) topic: pushed_at:2023-02 star:0.1k fork:0.0k 2D Graphic Library optimized for Cortex-M processors
...
- [ARM-software/CMSIS-DSP](https://github.com/ARM-software/CMSIS-DSP) topic:cortex-a,cortex-m,dsp,embedded,fft,filter,fixed-point-arithmetic,matrix,ml,numpy pushed_at:2023-03 star:0.2k fork:0.0k CMSIS-DSP embedded compute library for Cortex-M and Cortex-A
...
- [ARM-software/optimized-routines](https://github.com/ARM-software/optimized-routines) topic: pushed_at:2023-02 star:0.4k fork:0.1k Optimized implementations of various library functions for ARM architecture processors
...
- [ARM-software/Tool-Solutions](https://github.com/ARM-software/Tool-Solutions) topic: pushed_at:2023-02 star:0.2k fork:0.1k Tutorials & examples for Arm software development tools.
...
- [ARM-software/devlib](https://github.com/ARM-software/devlib) topic: pushed_at:2023-02 star:0.0k fork:0.1k Library for interaction with and instrumentation of remote devices.
