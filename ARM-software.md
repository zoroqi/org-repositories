...
- [ARM-software/Arm-2D](https://github.com/ARM-software/Arm-2D) topic: pushed_at:2024-03 star:0.2k fork:0.0k 2D Graphic Library optimized for Cortex-M processors
...
- [ARM-software/arm-trusted-firmware](https://github.com/ARM-software/arm-trusted-firmware) topic: pushed_at:2024-03 star:1.8k fork:1.3k Read-only mirror of Trusted Firmware-A
- [ARM-software/astc-encoder](https://github.com/ARM-software/astc-encoder) topic:astc,astcenc,compression,image-compression pushed_at:2024-03 star:1.0k fork:0.2k The Arm ASTC Encoder, a compressor for the Adaptive Scalable Texture Compression data format.
...
- [ARM-software/bbr-acs](https://github.com/ARM-software/bbr-acs) topic: pushed_at:2024-03 star:0.0k fork:0.0k Arm SystemReady : BBR Compliance Suite
...
- [ARM-software/bsa-acs](https://github.com/ARM-software/bsa-acs) topic: pushed_at:2024-03 star:0.0k fork:0.0k Arm SystemReady : BSA Architecture Compliance Suite
...
- [ARM-software/CMSIS-Compiler](https://github.com/ARM-software/CMSIS-Compiler) topic: pushed_at:2024-03 star:0.0k fork:0.0k CMSIS Compiler support for Arm Compiler
...
- [ARM-software/CMSIS-DSP](https://github.com/ARM-software/CMSIS-DSP) topic:cortex-a,cortex-m,dsp,embedded,fft,filter,fixed-point-arithmetic,matrix,ml,numpy pushed_at:2024-03 star:0.4k fork:0.1k CMSIS-DSP embedded compute library for Cortex-M and Cortex-A
- [ARM-software/CMSIS-FreeRTOS](https://github.com/ARM-software/CMSIS-FreeRTOS) topic: pushed_at:2024-03 star:0.5k fork:0.1k FreeRTOS adaptation for CMSIS-RTOS Version 2
...
- [ARM-software/CMSIS-NN](https://github.com/ARM-software/CMSIS-NN) topic: pushed_at:2024-03 star:0.1k fork:0.0k CMSIS-NN Library
...
- [ARM-software/CMSIS_6](https://github.com/ARM-software/CMSIS_6) topic: pushed_at:2024-03 star:0.1k fork:0.0k CMSIS version 6 (successor of CMSIS_5)
...
- [ARM-software/psa-api](https://github.com/ARM-software/psa-api) topic:api,attestation,cryptography,firmware-update,iot,security pushed_at:2024-03 star:0.0k fork:0.0k Documentation source and development of the PSA Certified API
...
- [ARM-software/sbsa-acs](https://github.com/ARM-software/sbsa-acs) topic: pushed_at:2024-03 star:0.1k fork:0.1k ARM Enterprise: SBSA Architecture Compliance Suite
...
- [ARM-software/SCP-firmware](https://github.com/ARM-software/SCP-firmware) topic: pushed_at:2024-03 star:0.2k fork:0.2k Read-only mirror of System Control Processor (SCP) firmware
...
- [ARM-software/Tool-Solutions](https://github.com/ARM-software/Tool-Solutions) topic: pushed_at:2024-03 star:0.2k fork:0.1k Tutorials & examples for Arm software development tools.
...
- [ARM-software/armnn](https://github.com/ARM-software/armnn) topic:machine-learning,neural-network,neural-networks pushed_at:2024-03 star:1.1k fork:0.3k Arm NN ML Software. The code here is a read-only mirror of https://review.mlplatform.org/admin/repos/ml/armnn
...
- [ARM-software/devtools](https://github.com/ARM-software/devtools) topic: pushed_at:2024-03 star:0.0k fork:0.0k Open-CMSIS-Pack development tools - C++ 
...
- [ARM-software/gator](https://github.com/ARM-software/gator) topic:android,arm,arm64,game-development,linux,performance,performance-analysis,profiling pushed_at:2024-03 star:0.1k fork:0.1k Sources for Arm Streamline's gator daemon, part of Arm Mobile Studio suite of performance analysis tools
...
- [ARM-software/lavatube](https://github.com/ARM-software/lavatube) topic: pushed_at:2024-03 star:0.0k fork:0.0k Experimental Vulkan tracer
...
- [ARM-software/tracetooltests](https://github.com/ARM-software/tracetooltests) topic: pushed_at:2024-03 star:0.0k fork:0.0k 
...
- [ARM-software/LLVM-embedded-toolchain-for-Arm](https://github.com/ARM-software/LLVM-embedded-toolchain-for-Arm) topic: pushed_at:2024-03 star:0.3k fork:0.1k A project dedicated to building LLVM toolchain for 32-bit Arm embedded targets.
...
- [ARM-software/golang-utils](https://github.com/ARM-software/golang-utils) topic:golang,golang-library,golang-module,helpers,utilities pushed_at:2024-03 star:0.0k fork:0.0k Helpers and utilities for Golang in order to do actions not available in the standard library.

## HTML

- [ARM-software/abi-aa](https://github.com/ARM-software/abi-aa) topic: pushed_at:2024-03 star:0.8k fork:0.2k Application Binary Interface for the Arm® Architecture
...
- [ARM-software/lisa](https://github.com/ARM-software/lisa) topic: pushed_at:2024-03 star:0.2k fork:0.1k Linux Integrated System Analysis
...
- [ARM-software/vscode-arm-debugger](https://github.com/ARM-software/vscode-arm-debugger) topic: pushed_at:2024-03 star:0.0k fork:0.0k 
- [ARM-software/vscode-cmsis-csolution](https://github.com/ARM-software/vscode-cmsis-csolution) topic: pushed_at:2024-03 star:0.0k fork:0.0k Extension support for VS Code CMSIS Project Extension
...
- [ARM-software/vscode-remote-build](https://github.com/ARM-software/vscode-remote-build) topic: pushed_at:2024-03 star:0.0k fork:0.0k Extension for remote build service
...
- [ARM-software/ebbr](https://github.com/ARM-software/ebbr) topic: pushed_at:2024-03 star:0.1k fork:0.0k Embedded Base Boot Requirements Specification

## Python

- [ARM-software/acle](https://github.com/ARM-software/acle) topic: pushed_at:2024-03 star:0.1k fork:0.0k Arm C Language Extensions (ACLE)
...
- [ARM-software/CMSIS-Stream](https://github.com/ARM-software/CMSIS-Stream) topic:arm,cortex-m,dataflow,dsp,embedded,ml,streaming pushed_at:2024-02 star:0.0k fork:0.0k CMSIS-Stream software component
...
- [ARM-software/devlib](https://github.com/ARM-software/devlib) topic: pushed_at:2024-03 star:0.0k fork:0.1k Library for interaction with and instrumentation of remote devices.
...
- [ARM-software/sbmr-acs](https://github.com/ARM-software/sbmr-acs) topic: pushed_at:2024-03 star:0.0k fork:0.0k Arm SBMR Architecture Compliance Suite
...
- [ARM-software/workload-automation](https://github.com/ARM-software/workload-automation) topic: pushed_at:2024-03 star:0.1k fork:0.1k A framework for automating workload execution and measurement collection on ARM devices.
...
- [ARM-software/arm-systemready](https://github.com/ARM-software/arm-systemready) topic: pushed_at:2024-03 star:0.0k fork:0.1k Arm SystemReady
