...
- [ARM-software/Arm-2D](https://github.com/ARM-software/Arm-2D) topic: pushed_at:2024-06 star:0.2k fork:0.1k 2D Graphic Library optimized for Cortex-M processors
...
- [ARM-software/bbr-acs](https://github.com/ARM-software/bbr-acs) topic: pushed_at:2024-05 star:0.0k fork:0.0k Arm SystemReady : BBR Compliance Suite
...
- [ARM-software/CMSIS-DAP](https://github.com/ARM-software/CMSIS-DAP) topic: pushed_at:2024-05 star:0.0k fork:0.0k CoreSight Debug Access Port (DAP) debug probe protocol reference implementation (spin-off from CMSIS_5)
...
- [ARM-software/CMSIS-DSP](https://github.com/ARM-software/CMSIS-DSP) topic:cortex-a,cortex-m,dsp,embedded,fft,filter,fixed-point-arithmetic,matrix,ml,numpy pushed_at:2024-06 star:0.4k fork:0.1k CMSIS-DSP embedded compute library for Cortex-M and Cortex-A
...
- [ARM-software/CMSIS-RTX](https://github.com/ARM-software/CMSIS-RTX) topic: pushed_at:2024-05 star:0.0k fork:0.0k RTX5 real time kernel for Arm Cortex-based embedded systems (spin-off from CMSIS_5)
...
- [ARM-software/MDK-Middleware](https://github.com/ARM-software/MDK-Middleware) topic: pushed_at:2024-06 star:0.1k fork:0.0k MDK Middleware Filesystem, Network and USB components source code for Arm Cortex-M using CMSIS-Drivers and CMSIS-RTOS2 APIs
...
- [ARM-software/sbsa-acs](https://github.com/ARM-software/sbsa-acs) topic: pushed_at:2024-05 star:0.1k fork:0.1k ARM Enterprise: SBSA Architecture Compliance Suite
...
- [ARM-software/ComputeLibrary](https://github.com/ARM-software/ComputeLibrary) topic:aarch64,android,arm,armv7,armv8,computer-vision,cpp,linux,machine-learning,neon,neural-network,opencl,simd,sve pushed_at:2024-05 star:2.7k fork:0.8k The Compute Library is a set of computer vision and machine learning functions optimised for both Arm CPUs and GPUs using SIMD technologies.
...
- [ARM-software/HWCPipe](https://github.com/ARM-software/HWCPipe) topic: pushed_at:2024-06 star:0.2k fork:0.0k Hardware counters interface
...
- [ARM-software/lavatube](https://github.com/ARM-software/lavatube) topic: pushed_at:2024-04 star:0.0k fork:0.0k Experimental Vulkan tracer
- [ARM-software/libcollector](https://github.com/ARM-software/libcollector) topic: pushed_at:2024-05 star:0.0k fork:0.0k 
...
- [ARM-software/LLVM-embedded-toolchain-for-Arm](https://github.com/ARM-software/LLVM-embedded-toolchain-for-Arm) topic: pushed_at:2024-05 star:0.4k fork:0.1k A project dedicated to building LLVM toolchain for 32-bit Arm embedded targets.

## CSS

- [ARM-software/opengl-es-sdk-for-android](https://github.com/ARM-software/opengl-es-sdk-for-android) topic: pushed_at:2023-01 star:0.4k fork:0.1k OpenGL ES SDK for Android
