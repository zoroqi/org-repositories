...
- [ARM-software/CMSIS-Compiler](https://github.com/ARM-software/CMSIS-Compiler) topic: pushed_at:2023-08 star:0.0k fork:0.0k CMSIS Compiler support for Arm Compiler
...
- [ARM-software/CMSIS-FreeRTOS](https://github.com/ARM-software/CMSIS-FreeRTOS) topic: pushed_at:2023-08 star:0.4k fork:0.1k FreeRTOS adaptation for CMSIS-RTOS Version 2
...
- [ARM-software/ff-a-acs](https://github.com/ARM-software/ff-a-acs) topic: pushed_at:2023-08 star:0.0k fork:0.0k Firmware Framework for A Architecture Compliance Suite
...
- [ARM-software/SDS-Framework](https://github.com/ARM-software/SDS-Framework) topic: pushed_at:2023-08 star:0.0k fork:0.0k Synchronous Data Stream (SDS) Framework allowing to record real-world data off a device and playing it back on Arm Virtual Hardware.
...
- [ARM-software/ComputeLibrary](https://github.com/ARM-software/ComputeLibrary) topic:aarch64,android,arm,armv7,armv8,computer-vision,cpp,linux,machine-learning,neon,neural-network,opencl,simd,sve pushed_at:2023-08 star:2.5k fork:0.8k The Compute Library is a set of computer vision and machine learning functions optimised for both Arm CPUs and GPUs using SIMD technologies.
...
- [ARM-software/libcollector](https://github.com/ARM-software/libcollector) topic: pushed_at:2023-08 star:0.0k fork:0.0k 
...
- [ARM-software/tarmac-trace-utilities](https://github.com/ARM-software/tarmac-trace-utilities) topic: pushed_at:2023-08 star:0.1k fork:0.0k Tools for analyzing and browsing Tarmac instruction traces.
...
- [ARM-software/CMSIS-View](https://github.com/ARM-software/CMSIS-View) topic: pushed_at:2023-08 star:0.0k fork:0.0k Repository of CMSIS Software Pack for software event generation and input/output handling.
- [ARM-software/embedded-development-services-client](https://github.com/ARM-software/embedded-development-services-client) topic:client-library,development,embedded-development,golang-library,online-services pushed_at:2023-08 star:0.0k fork:0.0k Golang HTTP client for our embedded development online services offering
...
- [ARM-software/abi-aa](https://github.com/ARM-software/abi-aa) topic: pushed_at:2023-08 star:0.7k fork:0.2k Application Binary Interface for the Arm® Architecture
...
- [ARM-software/vscode-environment-manager](https://github.com/ARM-software/vscode-environment-manager) topic: pushed_at:2023-08 star:0.0k fork:0.0k Extension support for VS Code Environment Manager Extension
...
- [ARM-software/ebbr](https://github.com/ARM-software/ebbr) topic: pushed_at:2023-08 star:0.1k fork:0.0k Embedded Base Boot Requirements Specification
