...
- [Netflix/dynomite](https://github.com/Netflix/dynomite) topic:c,cache,distributed-database,dynomite,key-value,nosql,redis pushed_at:2023-05 star:4.2k fork:0.5k A generic dynamo implementation for different k-v storage engines
- [Netflix/read_bbrlog](https://github.com/Netflix/read_bbrlog) topic: pushed_at:2024-02 star:0.0k fork:0.0k Utility designed to read data generated by FreeBSD's BBR TCP stack and placed into the black box, such as the files produced by tcplog_dumper
...
- [Netflix/chaosmonkey](https://github.com/Netflix/chaosmonkey) topic: pushed_at:2023-12 star:14.3k fork:1.1k Chaos Monkey is a resiliency tool that helps applications tolerate random instance failures.
...
- [Netflix/dgs](https://github.com/Netflix/dgs) topic: pushed_at:2024-02 star:0.0k fork:0.1k 
...
- [Netflix/netflix.github.com](https://github.com/Netflix/netflix.github.com) topic: pushed_at:2023-09 star:1.5k fork:0.4k 
...
- [Netflix/apache-pyiceberg](https://github.com/Netflix/apache-pyiceberg) topic: pushed_at:2024-02 star:0.0k fork:0.0k Apache Iceberg
- [Netflix/archaius](https://github.com/Netflix/archaius) topic: pushed_at:2024-02 star:2.4k fork:0.5k Library for configuration management API
...
- [Netflix/concurrency-limits](https://github.com/Netflix/concurrency-limits) topic: pushed_at:2024-02 star:3.1k fork:0.3k 
- [Netflix/conductor](https://github.com/Netflix/conductor) topic:distributed-systems,grpc,java,javascript,microservice-orchestration,orchestration-engine,orchestrator,reactjs,spring-boot,workflow-automation,workflow-engine,workflow-management,workflows pushed_at:2023-12 star:12.9k fork:2.3k Conductor is a microservices orchestration engine.
...
- [Netflix/dgs-examples-java](https://github.com/Netflix/dgs-examples-java) topic: pushed_at:2024-02 star:0.1k fork:0.1k 
- [Netflix/dgs-examples-java-2.7](https://github.com/Netflix/dgs-examples-java-2.7) topic: pushed_at:2024-02 star:0.0k fork:0.0k 
...
- [Netflix/eureka](https://github.com/Netflix/eureka) topic: pushed_at:2024-02 star:12.2k fork:3.7k AWS Service registry for resilient mid-tier load balancing and failover.
...
- [Netflix/genie](https://github.com/Netflix/genie) topic:big-data,bigdata,cloud,configuration,configuration-management,distributed-systems,java,microservice,microservices,netflix-oss,netflixoss,orchestration,spring-boot pushed_at:2024-02 star:1.7k fork:0.4k Distributed Big Data Orchestration Service
...
- [Netflix/hollow](https://github.com/Netflix/hollow) topic: pushed_at:2024-02 star:1.1k fork:0.2k Hollow is a java library and toolset for disseminating in-memory datasets from a single producer to many consumers for high performance read-only access.
...
- [Netflix/Hystrix](https://github.com/Netflix/Hystrix) topic: pushed_at:2023-10 star:23.8k fork:4.7k Hystrix is a latency and fault tolerance library designed to isolate points of access to remote systems, services and 3rd party libraries, stop cascading failure and enable resilience in complex distributed systems where failure is inevitable.
...
- [Netflix/iep](https://github.com/Netflix/iep) topic: pushed_at:2024-02 star:0.1k fork:0.0k Insight Engineering Platform Components
...
- [Netflix/mantis](https://github.com/Netflix/mantis) topic: pushed_at:2024-02 star:1.4k fork:0.2k A platform that makes it easy for developers to build realtime, cost-effective, operations-focused applications
...
- [Netflix/metacat](https://github.com/Netflix/metacat) topic: pushed_at:2024-02 star:1.5k fork:0.3k 
...
- [Netflix/photon](https://github.com/Netflix/photon) topic: pushed_at:2024-02 star:0.2k fork:0.1k Photon is a Java implementation of the Interoperable Master Format (IMF) standard. IMF is a SMPTE standard whose core constraints are defined in the specification st2067-2:2013
...
- [Netflix/Priam](https://github.com/Netflix/Priam) topic: pushed_at:2024-02 star:1.0k fork:0.3k Co-Process for backup/recovery, Token Management, and Centralized Configuration management for Cassandra.
...
- [Netflix/spectator](https://github.com/Netflix/spectator) topic: pushed_at:2024-02 star:0.7k fork:0.2k Client library for collecting metrics.
...
- [Netflix/zuul](https://github.com/Netflix/zuul) topic: pushed_at:2024-03 star:13.1k fork:2.3k Zuul is a gateway service that provides dynamic routing, monitoring, resiliency, security, and more.
...
- [Netflix/eslint-config-netflix](https://github.com/Netflix/eslint-config-netflix) topic: pushed_at:2024-02 star:0.1k fork:0.0k Shared ESLint config for Netflix JavaScript
...
- [Netflix/falcor](https://github.com/Netflix/falcor) topic: pushed_at:2023-10 star:10.4k fork:0.4k A JavaScript library for efficient data fetching
...
- [Netflix/x-element](https://github.com/Netflix/x-element) topic: pushed_at:2024-03 star:0.0k fork:0.0k A dead simple starting point for custom elements.
- [Netflix/x-test](https://github.com/Netflix/x-test) topic: pushed_at:2024-03 star:0.0k fork:0.0k 
...
- [Netflix/dgs-codegen](https://github.com/Netflix/dgs-codegen) topic: pushed_at:2024-02 star:0.2k fork:0.1k 
- [Netflix/dgs-examples-kotlin](https://github.com/Netflix/dgs-examples-kotlin) topic: pushed_at:2024-02 star:0.1k fork:0.0k 
- [Netflix/dgs-examples-kotlin-2.7](https://github.com/Netflix/dgs-examples-kotlin-2.7) topic: pushed_at:2024-02 star:0.0k fork:0.0k 
...
- [Netflix/dgs-framework](https://github.com/Netflix/dgs-framework) topic:dgs,graphql,graphql-java,java,spring-boot pushed_at:2024-02 star:2.9k fork:0.3k GraphQL for Java with Spring Boot made easy.
- [Netflix/dgs-intellij-plugin](https://github.com/Netflix/dgs-intellij-plugin) topic: pushed_at:2024-02 star:0.0k fork:0.0k 
...
- [Netflix/nflx-geofeed](https://github.com/Netflix/nflx-geofeed) topic: pushed_at:2024-02 star:0.0k fork:0.0k 
...
- [Netflix/atlas-docs](https://github.com/Netflix/atlas-docs) topic: pushed_at:2024-02 star:0.0k fork:0.0k Atlas Documentation Site (https://netflix.github.io/atlas-docs/)
...
- [Netflix/clove](https://github.com/Netflix/clove) topic: pushed_at:2024-02 star:0.0k fork:0.0k 
...
- [Netflix/consoleme](https://github.com/Netflix/consoleme) topic:aws,aws-iam,cloud-security,security-tools pushed_at:2023-11 star:3.1k fork:0.2k A Central Control Plane for AWS Permissions and Access
- [Netflix/dispatch](https://github.com/Netflix/dispatch) topic: pushed_at:2024-02 star:4.5k fork:0.4k All of the ad-hoc things you're doing to manage incidents today, done for you, and much more!
...
- [Netflix/iceberg-python](https://github.com/Netflix/iceberg-python) topic: pushed_at:2024-02 star:0.0k fork:0.0k Apache PyIceberg
...
- [Netflix/lemur](https://github.com/Netflix/lemur) topic:aws,python,security,ssl,ssl-certificates,tls pushed_at:2024-02 star:1.7k fork:0.3k Repository for the Lemur Certificate Manager
...
- [Netflix/metaflow-service](https://github.com/Netflix/metaflow-service) topic:ai,data-science,machine-learning,metaflow,ml,ml-infrastructure,ml-platform,productivity,ui pushed_at:2024-02 star:0.2k fork:0.1k :rocket: Metadata tracking and UI service for Metaflow!
...
- [Netflix/vmaf](https://github.com/Netflix/vmaf) topic: pushed_at:2024-02 star:4.1k fork:0.7k Perceptual video quality assessment based on multi-method fusion.
...
- [Netflix/bpftop](https://github.com/Netflix/bpftop) topic: pushed_at:2024-02 star:1.1k fork:0.0k bpftop provides a dynamic real-time view of running eBPF programs. It displays the average runtime, events per second, and estimated total CPU % for each program.
- [Netflix/libamicontained](https://github.com/Netflix/libamicontained) topic: pushed_at:2024-01 star:0.0k fork:0.0k 

## Scala

- [Netflix/atlas](https://github.com/Netflix/atlas) topic: pushed_at:2024-02 star:3.4k fork:0.3k In-memory dimensional time series database.
...
- [Netflix/dispatch-docker](https://github.com/Netflix/dispatch-docker) topic: pushed_at:2024-02 star:0.2k fork:0.1k 
...
- [Netflix/metaflow-ui](https://github.com/Netflix/metaflow-ui) topic:metaflow,ml-platform,ui pushed_at:2024-02 star:0.3k fork:0.0k :art: UI for monitoring your Metaflow executions!
