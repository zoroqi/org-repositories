...
- [Netflix/bbparse](https://github.com/Netflix/bbparse) topic: pushed_at:2026-05 star:0.0k fork:0.0k Library to parse a PCAPng file which contains black box records, such as the files produced by tcplog_dumper
...
- [Netflix/read_bbrlog](https://github.com/Netflix/read_bbrlog) topic: pushed_at:2026-05 star:0.0k fork:0.0k Utility designed to read data generated by FreeBSD's BBR TCP stack and placed into the black box, such as the files produced by tcplog_dumper
- [Netflix/taskintrospection](https://github.com/Netflix/taskintrospection) topic: pushed_at:2023-04 star:0.0k fork:0.0k 
- [Netflix/tcplog_dumper](https://github.com/Netflix/tcplog_dumper) topic: pushed_at:2026-05 star:0.0k fork:0.0k Utility designed to pull data from the FreeBSD's tcp_log device
...
- [Netflix/spectator-cpp](https://github.com/Netflix/spectator-cpp) topic: pushed_at:2026-05 star:0.0k fork:0.0k Thin-client metrics library for use with Atlas and SpectatorD

## Clojure

- [Netflix/mantis-mql](https://github.com/Netflix/mantis-mql) topic: pushed_at:2026-05 star:0.0k fork:0.0k 
...
- [Netflix/netflix.github.com](https://github.com/Netflix/netflix.github.com) topic: pushed_at:2024-08 star:1.8k fork:0.5k 
...
- [Netflix/EVCache](https://github.com/Netflix/EVCache) topic: pushed_at:2026-05 star:2.2k fork:0.3k A distributed in-memory data store for the cloud
...
- [Netflix/hollow](https://github.com/Netflix/hollow) topic: pushed_at:2026-05 star:1.4k fork:0.2k Hollow is a java library and toolset for disseminating in-memory datasets from a single producer to many consumers for high performance read-only access.
...
- [Netflix/maestro](https://github.com/Netflix/maestro) topic:agentic-workflow,analytics,automation,batch-processing,dag,data-engineering,data-ops,data-orchestrator,data-pipelines,data-science,elt,etl,java,machine-learning,mlops,orchestration,scheduler,workflow,workflow-engine,workflow-orchestration pushed_at:2026-05 star:3.8k fork:0.3k Maestro: Netflix’s Workflow Orchestrator
- [Netflix/mantis](https://github.com/Netflix/mantis) topic: pushed_at:2026-05 star:1.5k fork:0.2k A platform that makes it easy for developers to build realtime, cost-effective, operations-focused applications
...
- [Netflix/metacat](https://github.com/Netflix/metacat) topic: pushed_at:2026-05 star:1.7k fork:0.3k 
...
- [Netflix/zuul](https://github.com/Netflix/zuul) topic: pushed_at:2026-05 star:14.0k fork:2.4k Zuul is a gateway service that provides dynamic routing, monitoring, resiliency, security, and more.
...
- [Netflix/dgs-framework](https://github.com/Netflix/dgs-framework) topic:dgs,graphql,graphql-java,java,spring-boot pushed_at:2026-05 star:3.4k fork:0.3k GraphQL for Java with Spring Boot made easy.
...
- [Netflix/atlas-docs](https://github.com/Netflix/atlas-docs) topic: pushed_at:2026-05 star:0.1k fork:0.0k Atlas Documentation Site (https://netflix.github.io/atlas-docs/)
...
- [Netflix/dispatch](https://github.com/Netflix/dispatch) topic: pushed_at:2025-09 star:6.5k fork:0.7k All of the ad-hoc things you're doing to manage incidents today, done for you, and much more!
...
- [Netflix/lemur](https://github.com/Netflix/lemur) topic:aws,python,security,ssl,ssl-certificates,tls pushed_at:2026-05 star:1.8k fork:0.3k Repository for the Lemur Certificate Manager
...
- [Netflix/metaflow-nflx-extensions](https://github.com/Netflix/metaflow-nflx-extensions) topic: pushed_at:2026-05 star:0.0k fork:0.0k 
- [Netflix/metaflow-service](https://github.com/Netflix/metaflow-service) topic:ai,data-science,machine-learning,metaflow,ml,ml-infrastructure,ml-platform,productivity,ui pushed_at:2026-05 star:0.2k fork:0.1k :rocket: Metadata tracking and UI service for Metaflow!
...
- [Netflix/void-model](https://github.com/Netflix/void-model) topic: pushed_at:2026-05 star:1.8k fork:0.2k 
...
- [Netflix/spectator-js](https://github.com/Netflix/spectator-js) topic: pushed_at:2026-05 star:0.1k fork:0.0k Thin-client metrics library for use with Atlas and SpectatorD
