...
- [Netflix/bettertls](https://github.com/Netflix/bettertls) topic:security pushed_at:2023-08 star:0.2k fork:0.0k BetterTLS:  A Name Constraints test suite for HTTPS clients.
- [Netflix/chaosmonkey](https://github.com/Netflix/chaosmonkey) topic: pushed_at:2023-10 star:14.0k fork:1.1k Chaos Monkey is a resiliency tool that helps applications tolerate random instance failures.
...
- [Netflix/virtual-kubelet](https://github.com/Netflix/virtual-kubelet) topic: pushed_at:2023-10 star:0.0k fork:0.0k Virtual Kubelet is an open source Kubernetes kubelet implementation.
- [Netflix/weep](https://github.com/Netflix/weep) topic: pushed_at:2023-10 star:0.3k fork:0.0k The ConsoleMe CLI utility
...
- [Netflix/mantis-gradle-plugin](https://github.com/Netflix/mantis-gradle-plugin) topic: pushed_at:2023-10 star:0.0k fork:0.0k Gradle plugin for producing a deployable Mantis Job artifact from a JVM-based project
...
- [Netflix/dgs](https://github.com/Netflix/dgs) topic: pushed_at:2023-10 star:0.0k fork:0.0k 
...
- [Netflix/apache-pyiceberg](https://github.com/Netflix/apache-pyiceberg) topic: pushed_at:2023-10 star:0.0k fork:0.0k Apache Iceberg
- [Netflix/archaius](https://github.com/Netflix/archaius) topic: pushed_at:2023-10 star:2.4k fork:0.5k Library for configuration management API
...
- [Netflix/concurrency-limits](https://github.com/Netflix/concurrency-limits) topic: pushed_at:2023-06 star:3.1k fork:0.3k 
- [Netflix/conductor](https://github.com/Netflix/conductor) topic:distributed-systems,grpc,java,javascript,microservice-orchestration,orchestration-engine,orchestrator,reactjs,spring-boot,workflow-automation,workflow-engine,workflow-management,workflows pushed_at:2023-10 star:12.0k fork:2.3k Conductor is a microservices orchestration engine.
- [Netflix/conductor-community](https://github.com/Netflix/conductor-community) topic: pushed_at:2023-10 star:0.1k fork:0.1k 
...
- [Netflix/eureka](https://github.com/Netflix/eureka) topic: pushed_at:2023-10 star:12.0k fork:3.7k AWS Service registry for resilient mid-tier load balancing and failover.
- [Netflix/EVCache](https://github.com/Netflix/EVCache) topic: pushed_at:2023-10 star:1.9k fork:0.2k A distributed in-memory data store for the cloud
...
- [Netflix/genie](https://github.com/Netflix/genie) topic:big-data,bigdata,cloud,configuration,configuration-management,distributed-systems,java,microservice,microservices,netflix-oss,netflixoss,orchestration,spring-boot pushed_at:2023-10 star:1.6k fork:0.4k Distributed Big Data Orchestration Service
...
- [Netflix/hollow](https://github.com/Netflix/hollow) topic: pushed_at:2023-10 star:1.1k fork:0.2k Hollow is a java library and toolset for disseminating in-memory datasets from a single producer to many consumers for high performance read-only access.
...
- [Netflix/Hystrix](https://github.com/Netflix/Hystrix) topic: pushed_at:2023-10 star:23.7k fork:4.7k Hystrix is a latency and fault tolerance library designed to isolate points of access to remote systems, services and 3rd party libraries, stop cascading failure and enable resilience in complex distributed systems where failure is inevitable.
...
- [Netflix/iep](https://github.com/Netflix/iep) topic: pushed_at:2023-10 star:0.1k fork:0.0k Insight Engineering Platform Components
...
- [Netflix/mantis](https://github.com/Netflix/mantis) topic: pushed_at:2023-10 star:1.4k fork:0.2k A platform that makes it easy for developers to build realtime, cost-effective, operations-focused applications
- [Netflix/mantis-api](https://github.com/Netflix/mantis-api) topic: pushed_at:2023-10 star:0.0k fork:0.0k 
...
- [Netflix/mantis-rxcontrol](https://github.com/Netflix/mantis-rxcontrol) topic: pushed_at:2023-10 star:0.0k fork:0.0k 
- [Netflix/mantis-source-jobs](https://github.com/Netflix/mantis-source-jobs) topic: pushed_at:2023-04 star:0.0k fork:0.0k 
- [Netflix/metacat](https://github.com/Netflix/metacat) topic: pushed_at:2023-10 star:1.5k fork:0.3k 
...
- [Netflix/photon](https://github.com/Netflix/photon) topic: pushed_at:2023-10 star:0.2k fork:0.1k Photon is a Java implementation of the Interoperable Master Format (IMF) standard. IMF is a SMPTE standard whose core constraints are defined in the specification st2067-2:2013
...
- [Netflix/ribbon](https://github.com/Netflix/ribbon) topic: pushed_at:2023-10 star:4.5k fork:1.2k Ribbon is a Inter Process Communication (remote procedure calls) library with built in software load balancers. The primary usage model involves REST calls with various serialization scheme support.
...
- [Netflix/spectator](https://github.com/Netflix/spectator) topic: pushed_at:2023-10 star:0.7k fork:0.2k Client library for collecting metrics.
...
- [Netflix/zuul](https://github.com/Netflix/zuul) topic: pushed_at:2023-10 star:12.9k fork:2.3k Zuul is a gateway service that provides dynamic routing, monitoring, resiliency, security, and more.
...
- [Netflix/conductor-ui](https://github.com/Netflix/conductor-ui) topic: pushed_at:2023-10 star:0.0k fork:0.0k 
...
- [Netflix/falcor](https://github.com/Netflix/falcor) topic: pushed_at:2023-10 star:10.3k fork:0.5k A JavaScript library for efficient data fetching
...
- [Netflix/metaflow-docs](https://github.com/Netflix/metaflow-docs) topic: pushed_at:2023-10 star:0.0k fork:0.0k 
...
- [Netflix/pollyjs](https://github.com/Netflix/pollyjs) topic:browser,javascript,netflix,nodejs,record,replay,testing pushed_at:2023-10 star:10.0k fork:0.4k Record, Replay, and Stub HTTP Interactions.
...
- [Netflix/vizceral](https://github.com/Netflix/vizceral) topic:graph,monitoring,traffic,visualization,webgl pushed_at:2023-10 star:4.0k fork:0.4k WebGL visualization for displaying animated traffic graphs
...
- [Netflix/vizceral-example](https://github.com/Netflix/vizceral-example) topic: pushed_at:2023-10 star:0.4k fork:0.2k Example Vizceral app
- [Netflix/vizceral-react](https://github.com/Netflix/vizceral-react) topic: pushed_at:2023-10 star:0.2k fork:0.1k 
...
- [Netflix/dgs-codegen](https://github.com/Netflix/dgs-codegen) topic: pushed_at:2023-10 star:0.2k fork:0.1k 
...
- [Netflix/dgs-framework](https://github.com/Netflix/dgs-framework) topic:dgs,graphql,graphql-java,java,spring-boot pushed_at:2023-10 star:2.8k fork:0.3k GraphQL for Java with Spring Boot made easy.
...
- [Netflix/iceberg-python](https://github.com/Netflix/iceberg-python) topic: pushed_at:2023-10 star:0.0k fork:0.0k Apache PyIceberg
...
- [Netflix/mantis-helm](https://github.com/Netflix/mantis-helm) topic: pushed_at:2023-10 star:0.0k fork:0.0k 
...
- [Netflix/nflx-geofeed](https://github.com/Netflix/nflx-geofeed) topic: pushed_at:2023-10 star:0.0k fork:0.0k 
...
- [Netflix/atlas-docs](https://github.com/Netflix/atlas-docs) topic: pushed_at:2023-10 star:0.0k fork:0.0k Atlas Documentation Site (https://netflix.github.io/atlas-docs/)
...
- [Netflix/dispatch](https://github.com/Netflix/dispatch) topic: pushed_at:2023-10 star:4.3k fork:0.4k All of the ad-hoc things you're doing to manage incidents today, done for you, and much more!
- [Netflix/e2nest](https://github.com/Netflix/e2nest) topic: pushed_at:2023-10 star:0.0k fork:0.0k Web-based platform for media-centric (video, audio and images) subjective testing
- [Netflix/flamescope](https://github.com/Netflix/flamescope) topic: pushed_at:2023-10 star:2.9k fork:0.2k FlameScope is a visualization tool for exploring different time ranges as Flame Graphs.
...
- [Netflix/lemur](https://github.com/Netflix/lemur) topic:aws,python,security,ssl,ssl-certificates,tls pushed_at:2023-10 star:1.7k fork:0.3k Repository for the Lemur Certificate Manager
...
- [Netflix/metaflow-nflx-extensions](https://github.com/Netflix/metaflow-nflx-extensions) topic: pushed_at:2023-10 star:0.0k fork:0.0k 
- [Netflix/metaflow-service](https://github.com/Netflix/metaflow-service) topic:ai,data-science,machine-learning,metaflow,ml,ml-infrastructure,ml-platform,productivity,ui pushed_at:2023-10 star:0.2k fork:0.1k :rocket: Metadata tracking and UI service for Metaflow!
...
- [Netflix/vmaf](https://github.com/Netflix/vmaf) topic: pushed_at:2023-11 star:3.9k fork:0.7k Perceptual video quality assessment based on multi-method fusion.
...
- [Netflix/atlas](https://github.com/Netflix/atlas) topic: pushed_at:2023-10 star:3.3k fork:0.3k In-memory dimensional time series database.
- [Netflix/edda](https://github.com/Netflix/edda) topic: pushed_at:2023-10 star:0.6k fork:0.1k AWS API Read Cache
...
- [Netflix/metaflow-ui](https://github.com/Netflix/metaflow-ui) topic:metaflow,ml-platform,ui pushed_at:2023-10 star:0.3k fork:0.0k :art: UI for monitoring your Metaflow executions!
