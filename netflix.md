...
- [Netflix/bpftop](https://github.com/Netflix/bpftop) topic: pushed_at:2024-07 star:2.1k fork:0.1k bpftop provides a dynamic real-time view of running eBPF programs. It displays the average runtime, events per second, and estimated total CPU % for each program.
...
- [Netflix/spectator-cpp](https://github.com/Netflix/spectator-cpp) topic: pushed_at:2024-07 star:0.0k fork:0.0k Spectator library for instrumenting C++ applications, which sends metrics to SpectatorD.
...
- [Netflix/chaosmonkey](https://github.com/Netflix/chaosmonkey) topic: pushed_at:2023-12 star:14.9k fork:1.1k Chaos Monkey is a resiliency tool that helps applications tolerate random instance failures.
...
- [Netflix/spectator-go](https://github.com/Netflix/spectator-go) topic: pushed_at:2024-07 star:0.1k fork:0.0k 
...
- [Netflix/dgs](https://github.com/Netflix/dgs) topic: pushed_at:2024-07 star:0.0k fork:0.1k 
...
- [Netflix/archaius](https://github.com/Netflix/archaius) topic: pushed_at:2024-05 star:2.5k fork:0.5k Library for configuration management API
...
- [Netflix/dgs-examples-java](https://github.com/Netflix/dgs-examples-java) topic: pushed_at:2024-05 star:0.2k fork:0.1k 
...
- [Netflix/eclipse-jifa](https://github.com/Netflix/eclipse-jifa) topic: pushed_at:2024-07 star:0.0k fork:0.0k 
...
- [Netflix/genie](https://github.com/Netflix/genie) topic:big-data,bigdata,cloud,configuration,configuration-management,distributed-systems,java,microservice,microservices,netflix-oss,netflixoss,orchestration,spring-boot pushed_at:2024-07 star:1.7k fork:0.4k Distributed Big Data Orchestration Service
...
- [Netflix/hollow](https://github.com/Netflix/hollow) topic: pushed_at:2024-07 star:1.2k fork:0.2k Hollow is a java library and toolset for disseminating in-memory datasets from a single producer to many consumers for high performance read-only access.
...
- [Netflix/iep](https://github.com/Netflix/iep) topic: pushed_at:2024-07 star:0.1k fork:0.0k Insight Engineering Platform Components
...
- [Netflix/maestro](https://github.com/Netflix/maestro) topic: pushed_at:2024-07 star:2.3k fork:0.1k Maestro: Netflix’s Workflow Orchestrator
- [Netflix/mantis](https://github.com/Netflix/mantis) topic: pushed_at:2024-07 star:1.4k fork:0.2k A platform that makes it easy for developers to build realtime, cost-effective, operations-focused applications
- [Netflix/mantis-api](https://github.com/Netflix/mantis-api) topic: pushed_at:2024-07 star:0.0k fork:0.0k 
...
- [Netflix/metacat](https://github.com/Netflix/metacat) topic: pushed_at:2024-07 star:1.6k fork:0.3k 
...
- [Netflix/Priam](https://github.com/Netflix/Priam) topic: pushed_at:2024-07 star:1.0k fork:0.3k Co-Process for backup/recovery, Token Management, and Centralized Configuration management for Cassandra.
...
- [Netflix/ribbon](https://github.com/Netflix/ribbon) topic: pushed_at:2024-07 star:4.5k fork:1.2k Ribbon is a Inter Process Communication (remote procedure calls) library with built in software load balancers. The primary usage model involves REST calls with various serialization scheme support.
...
- [Netflix/spectator](https://github.com/Netflix/spectator) topic: pushed_at:2024-07 star:0.7k fork:0.2k Client library for collecting metrics.
...
- [Netflix/zuul](https://github.com/Netflix/zuul) topic: pushed_at:2024-07 star:13.3k fork:2.4k Zuul is a gateway service that provides dynamic routing, monitoring, resiliency, security, and more.
...
- [Netflix/metaflow-docs](https://github.com/Netflix/metaflow-docs) topic: pushed_at:2024-07 star:0.0k fork:0.0k 
...
- [Netflix/x-element](https://github.com/Netflix/x-element) topic: pushed_at:2024-07 star:0.0k fork:0.0k A dead simple starting point for custom elements.
...
- [Netflix/dgs-codegen](https://github.com/Netflix/dgs-codegen) topic: pushed_at:2024-07 star:0.2k fork:0.1k 
...
- [Netflix/dgs-framework](https://github.com/Netflix/dgs-framework) topic:dgs,graphql,graphql-java,java,spring-boot pushed_at:2024-08 star:3.0k fork:0.3k GraphQL for Java with Spring Boot made easy.
- [Netflix/dgs-intellij-plugin](https://github.com/Netflix/dgs-intellij-plugin) topic: pushed_at:2024-07 star:0.0k fork:0.0k 
...
- [Netflix/nflx-geofeed](https://github.com/Netflix/nflx-geofeed) topic: pushed_at:2024-07 star:0.0k fork:0.0k 
...
- [Netflix/security-bulletins](https://github.com/Netflix/security-bulletins) topic:security pushed_at:2024-07 star:0.7k fork:0.1k Security Bulletins that relate to Netflix Open Source
...
- [Netflix/atlas-docs](https://github.com/Netflix/atlas-docs) topic: pushed_at:2024-07 star:0.0k fork:0.0k Atlas Documentation Site (https://netflix.github.io/atlas-docs/)
...
- [Netflix/consoleme](https://github.com/Netflix/consoleme) topic:aws,aws-iam,cloud-security,security-tools pushed_at:2024-07 star:3.1k fork:0.3k A Central Control Plane for AWS Permissions and Access
- [Netflix/dispatch](https://github.com/Netflix/dispatch) topic: pushed_at:2024-07 star:4.8k fork:0.5k All of the ad-hoc things you're doing to manage incidents today, done for you, and much more!
- [Netflix/e2nest](https://github.com/Netflix/e2nest) topic: pushed_at:2024-07 star:0.0k fork:0.0k Web-based platform for media-centric (video, audio and images) subjective testing
...
- [Netflix/lemur](https://github.com/Netflix/lemur) topic:aws,python,security,ssl,ssl-certificates,tls pushed_at:2024-07 star:1.7k fork:0.3k Repository for the Lemur Certificate Manager
...
- [Netflix/metaflow-nflx-extensions](https://github.com/Netflix/metaflow-nflx-extensions) topic: pushed_at:2024-07 star:0.0k fork:0.0k 
- [Netflix/metaflow-service](https://github.com/Netflix/metaflow-service) topic:ai,data-science,machine-learning,metaflow,ml,ml-infrastructure,ml-platform,productivity,ui pushed_at:2024-07 star:0.2k fork:0.1k :rocket: Metadata tracking and UI service for Metaflow!
...
- [Netflix/OpenVPCal](https://github.com/Netflix/OpenVPCal) topic: pushed_at:2024-07 star:0.1k fork:0.0k 
...
- [Netflix/spectator-py](https://github.com/Netflix/spectator-py) topic: pushed_at:2024-07 star:0.0k fork:0.0k 
- [Netflix/spectator-py-runtime-metrics](https://github.com/Netflix/spectator-py-runtime-metrics) topic: pushed_at:2024-07 star:0.0k fork:0.0k 
...
- [Netflix/vmaf](https://github.com/Netflix/vmaf) topic: pushed_at:2024-07 star:4.4k fork:0.7k Perceptual video quality assessment based on multi-method fusion.
...
- [Netflix/atlas](https://github.com/Netflix/atlas) topic: pushed_at:2024-07 star:3.4k fork:0.3k In-memory dimensional time series database.
...
- [Netflix/metaflow-ui](https://github.com/Netflix/metaflow-ui) topic:metaflow,ml-platform,ui pushed_at:2024-07 star:0.3k fork:0.0k :art: UI for monitoring your Metaflow executions!
