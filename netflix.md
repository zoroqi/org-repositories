...
- [Netflix/bettertls](https://github.com/Netflix/bettertls) topic:security pushed_at:2024-03 star:0.2k fork:0.0k BetterTLS:  A Name Constraints test suite for HTTPS clients.
- [Netflix/chaosmonkey](https://github.com/Netflix/chaosmonkey) topic: pushed_at:2023-12 star:14.4k fork:1.1k Chaos Monkey is a resiliency tool that helps applications tolerate random instance failures.
...
- [Netflix/dgs](https://github.com/Netflix/dgs) topic: pushed_at:2024-03 star:0.0k fork:0.1k 
...
- [Netflix/netflix.github.com](https://github.com/Netflix/netflix.github.com) topic: pushed_at:2024-03 star:1.5k fork:0.4k 
...
- [Netflix/archaius](https://github.com/Netflix/archaius) topic: pushed_at:2024-03 star:2.4k fork:0.5k Library for configuration management API
- [Netflix/astyanax](https://github.com/Netflix/astyanax) topic: pushed_at:2024-03 star:1.0k fork:0.4k Cassandra Java Client
- [Netflix/blitz4j](https://github.com/Netflix/blitz4j) topic: pushed_at:2024-03 star:0.6k fork:0.1k Logging framework for fast asynchronous logging
...
- [Netflix/dgs-examples-java](https://github.com/Netflix/dgs-examples-java) topic: pushed_at:2024-03 star:0.1k fork:0.1k 
...
- [Netflix/genie](https://github.com/Netflix/genie) topic:big-data,bigdata,cloud,configuration,configuration-management,distributed-systems,java,microservice,microservices,netflix-oss,netflixoss,orchestration,spring-boot pushed_at:2024-03 star:1.7k fork:0.4k Distributed Big Data Orchestration Service
...
- [Netflix/hollow](https://github.com/Netflix/hollow) topic: pushed_at:2024-03 star:1.1k fork:0.2k Hollow is a java library and toolset for disseminating in-memory datasets from a single producer to many consumers for high performance read-only access.
...
- [Netflix/iep](https://github.com/Netflix/iep) topic: pushed_at:2024-03 star:0.1k fork:0.0k Insight Engineering Platform Components
...
- [Netflix/mantis](https://github.com/Netflix/mantis) topic: pushed_at:2024-03 star:1.4k fork:0.2k A platform that makes it easy for developers to build realtime, cost-effective, operations-focused applications
...
- [Netflix/metacat](https://github.com/Netflix/metacat) topic: pushed_at:2024-03 star:1.5k fork:0.3k 
...
- [Netflix/Priam](https://github.com/Netflix/Priam) topic: pushed_at:2024-03 star:1.0k fork:0.3k Co-Process for backup/recovery, Token Management, and Centralized Configuration management for Cassandra.
...
- [Netflix/ribbon](https://github.com/Netflix/ribbon) topic: pushed_at:2024-03 star:4.5k fork:1.2k Ribbon is a Inter Process Communication (remote procedure calls) library with built in software load balancers. The primary usage model involves REST calls with various serialization scheme support.
...
- [Netflix/spectator](https://github.com/Netflix/spectator) topic: pushed_at:2024-03 star:0.7k fork:0.2k Client library for collecting metrics.
...
- [Netflix/metaflow-docs](https://github.com/Netflix/metaflow-docs) topic: pushed_at:2024-03 star:0.0k fork:0.0k 
...
- [Netflix/dgs-codegen](https://github.com/Netflix/dgs-codegen) topic: pushed_at:2024-03 star:0.2k fork:0.1k 
- [Netflix/dgs-examples-kotlin](https://github.com/Netflix/dgs-examples-kotlin) topic: pushed_at:2024-03 star:0.1k fork:0.0k 
...
- [Netflix/dgs-framework](https://github.com/Netflix/dgs-framework) topic:dgs,graphql,graphql-java,java,spring-boot pushed_at:2024-03 star:3.0k fork:0.3k GraphQL for Java with Spring Boot made easy.
...
- [Netflix/nflx-geofeed](https://github.com/Netflix/nflx-geofeed) topic: pushed_at:2024-03 star:0.0k fork:0.0k 
...
- [Netflix/atlas-docs](https://github.com/Netflix/atlas-docs) topic: pushed_at:2024-03 star:0.0k fork:0.0k Atlas Documentation Site (https://netflix.github.io/atlas-docs/)
...
- [Netflix/clove](https://github.com/Netflix/clove) topic: pushed_at:2024-03 star:0.0k fork:0.0k 
...
- [Netflix/dispatch](https://github.com/Netflix/dispatch) topic: pushed_at:2024-03 star:4.5k fork:0.5k All of the ad-hoc things you're doing to manage incidents today, done for you, and much more!
- [Netflix/e2nest](https://github.com/Netflix/e2nest) topic: pushed_at:2024-03 star:0.0k fork:0.0k Web-based platform for media-centric (video, audio and images) subjective testing
...
- [Netflix/lemur](https://github.com/Netflix/lemur) topic:aws,python,security,ssl,ssl-certificates,tls pushed_at:2024-03 star:1.7k fork:0.3k Repository for the Lemur Certificate Manager
...
- [Netflix/metaflow-service](https://github.com/Netflix/metaflow-service) topic:ai,data-science,machine-learning,metaflow,ml,ml-infrastructure,ml-platform,productivity,ui pushed_at:2024-03 star:0.2k fork:0.1k :rocket: Metadata tracking and UI service for Metaflow!
...
- [Netflix/vmaf](https://github.com/Netflix/vmaf) topic: pushed_at:2024-03 star:4.1k fork:0.7k Perceptual video quality assessment based on multi-method fusion.
...
- [Netflix/bpftop](https://github.com/Netflix/bpftop) topic: pushed_at:2024-03 star:1.6k fork:0.1k bpftop provides a dynamic real-time view of running eBPF programs. It displays the average runtime, events per second, and estimated total CPU % for each program.
- [Netflix/libamicontained](https://github.com/Netflix/libamicontained) topic: pushed_at:2024-01 star:0.0k fork:0.0k 

## Scala

- [Netflix/atlas](https://github.com/Netflix/atlas) topic: pushed_at:2024-03 star:3.4k fork:0.3k In-memory dimensional time series database.
...
- [Netflix/eslint-config-netflix](https://github.com/Netflix/eslint-config-netflix) topic: pushed_at:2024-03 star:0.1k fork:0.0k Shared ESLint config for Netflix JavaScript
