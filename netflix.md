...
- [Netflix/conductor](https://github.com/Netflix/conductor) topic:distributed-systems,grpc,java,javascript,microservice-orchestration,orchestration-engine,orchestrator,reactjs,spring-boot,workflow-automation,workflow-engine,workflow-management,workflows pushed_at:2023-12 star:12.9k fork:2.4k Conductor is a microservices orchestration engine.
...
- [Netflix/eureka](https://github.com/Netflix/eureka) topic: pushed_at:2024-02 star:12.1k fork:3.7k AWS Service registry for resilient mid-tier load balancing and failover.
...
- [Netflix/zuul](https://github.com/Netflix/zuul) topic: pushed_at:2024-02 star:13.1k fork:2.3k Zuul is a gateway service that provides dynamic routing, monitoring, resiliency, security, and more.
...
- [Netflix/x-element](https://github.com/Netflix/x-element) topic: pushed_at:2024-02 star:0.0k fork:0.0k A dead simple starting point for custom elements.
