...
- [Netflix/bpftop](https://github.com/Netflix/bpftop) topic: pushed_at:2024-05 star:2.0k fork:0.1k bpftop provides a dynamic real-time view of running eBPF programs. It displays the average runtime, events per second, and estimated total CPU % for each program.
...
- [Netflix/chaosmonkey](https://github.com/Netflix/chaosmonkey) topic: pushed_at:2023-12 star:14.6k fork:1.1k Chaos Monkey is a resiliency tool that helps applications tolerate random instance failures.
...
- [Netflix/spectator-go](https://github.com/Netflix/spectator-go) topic: pushed_at:2024-05 star:0.1k fork:0.0k 
- [Netflix/spectator-go-runtime-metrics](https://github.com/Netflix/spectator-go-runtime-metrics) topic: pushed_at:2024-05 star:0.0k fork:0.0k 
...
- [Netflix/concurrency-limits](https://github.com/Netflix/concurrency-limits) topic: pushed_at:2024-05 star:3.1k fork:0.3k 
...
- [Netflix/eclipse-jifa](https://github.com/Netflix/eclipse-jifa) topic: pushed_at:2024-05 star:0.0k fork:0.0k 
...
- [Netflix/genie](https://github.com/Netflix/genie) topic:big-data,bigdata,cloud,configuration,configuration-management,distributed-systems,java,microservice,microservices,netflix-oss,netflixoss,orchestration,spring-boot pushed_at:2024-05 star:1.7k fork:0.4k Distributed Big Data Orchestration Service
...
- [Netflix/hollow](https://github.com/Netflix/hollow) topic: pushed_at:2024-05 star:1.2k fork:0.2k Hollow is a java library and toolset for disseminating in-memory datasets from a single producer to many consumers for high performance read-only access.
...
- [Netflix/mantis](https://github.com/Netflix/mantis) topic: pushed_at:2024-05 star:1.4k fork:0.2k A platform that makes it easy for developers to build realtime, cost-effective, operations-focused applications
...
- [Netflix/Priam](https://github.com/Netflix/Priam) topic: pushed_at:2024-05 star:1.0k fork:0.3k Co-Process for backup/recovery, Token Management, and Centralized Configuration management for Cassandra.
...
- [Netflix/spectator](https://github.com/Netflix/spectator) topic: pushed_at:2024-05 star:0.7k fork:0.2k Client library for collecting metrics.
...
- [Netflix/zuul](https://github.com/Netflix/zuul) topic: pushed_at:2024-05 star:13.2k fork:2.3k Zuul is a gateway service that provides dynamic routing, monitoring, resiliency, security, and more.
...
- [Netflix/x-test](https://github.com/Netflix/x-test) topic: pushed_at:2024-04 star:0.0k fork:0.0k 
...
- [Netflix/atlas-docs](https://github.com/Netflix/atlas-docs) topic: pushed_at:2024-05 star:0.0k fork:0.0k Atlas Documentation Site (https://netflix.github.io/atlas-docs/)
...
- [Netflix/consoleme](https://github.com/Netflix/consoleme) topic:aws,aws-iam,cloud-security,security-tools pushed_at:2024-05 star:3.1k fork:0.2k A Central Control Plane for AWS Permissions and Access
- [Netflix/dispatch](https://github.com/Netflix/dispatch) topic: pushed_at:2024-05 star:4.7k fork:0.5k All of the ad-hoc things you're doing to manage incidents today, done for you, and much more!
...
- [Netflix/lemur](https://github.com/Netflix/lemur) topic:aws,python,security,ssl,ssl-certificates,tls pushed_at:2024-05 star:1.7k fork:0.3k Repository for the Lemur Certificate Manager
...
- [Netflix/metaflow-service](https://github.com/Netflix/metaflow-service) topic:ai,data-science,machine-learning,metaflow,ml,ml-infrastructure,ml-platform,productivity,ui pushed_at:2024-05 star:0.2k fork:0.1k :rocket: Metadata tracking and UI service for Metaflow!
...
- [Netflix/vmaf](https://github.com/Netflix/vmaf) topic: pushed_at:2024-04 star:4.3k fork:0.7k Perceptual video quality assessment based on multi-method fusion.
...
- [Netflix/atlas](https://github.com/Netflix/atlas) topic: pushed_at:2024-05 star:3.4k fork:0.3k In-memory dimensional time series database.
