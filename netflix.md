...
- [Netflix/bpftop](https://github.com/Netflix/bpftop) topic: pushed_at:2024-08 star:2.1k fork:0.1k bpftop provides a dynamic real-time view of running eBPF programs. It displays the average runtime, events per second, and estimated total CPU % for each program.
...
- [Netflix/go-env](https://github.com/Netflix/go-env) topic:environment-variables,golang pushed_at:2024-08 star:0.6k fork:0.1k a golang library to manage environment variables
...
- [Netflix/dgs](https://github.com/Netflix/dgs) topic: pushed_at:2024-08 star:0.0k fork:0.1k 
...
- [Netflix/netflix.github.com](https://github.com/Netflix/netflix.github.com) topic: pushed_at:2024-08 star:1.5k fork:0.4k 
...
- [Netflix/archaius](https://github.com/Netflix/archaius) topic: pushed_at:2024-08 star:2.5k fork:0.5k Library for configuration management API
...
- [Netflix/eclipse-jifa](https://github.com/Netflix/eclipse-jifa) topic: pushed_at:2024-08 star:0.0k fork:0.0k 
...
- [Netflix/hollow](https://github.com/Netflix/hollow) topic: pushed_at:2024-08 star:1.2k fork:0.2k Hollow is a java library and toolset for disseminating in-memory datasets from a single producer to many consumers for high performance read-only access.
...
- [Netflix/iep](https://github.com/Netflix/iep) topic: pushed_at:2024-08 star:0.1k fork:0.0k Insight Engineering Platform Components
...
- [Netflix/maestro](https://github.com/Netflix/maestro) topic: pushed_at:2024-08 star:3.0k fork:0.2k Maestro: Netflix’s Workflow Orchestrator
- [Netflix/mantis](https://github.com/Netflix/mantis) topic: pushed_at:2024-08 star:1.4k fork:0.2k A platform that makes it easy for developers to build realtime, cost-effective, operations-focused applications
- [Netflix/mantis-api](https://github.com/Netflix/mantis-api) topic: pushed_at:2024-08 star:0.0k fork:0.0k 
...
- [Netflix/photon](https://github.com/Netflix/photon) topic: pushed_at:2024-08 star:0.2k fork:0.1k Photon is a Java implementation of the Interoperable Master Format (IMF) standard. IMF is a SMPTE standard whose core constraints are defined in the specification st2067-2:2013
...
- [Netflix/spectator](https://github.com/Netflix/spectator) topic: pushed_at:2024-08 star:0.7k fork:0.2k Client library for collecting metrics.
...
- [Netflix/zuul](https://github.com/Netflix/zuul) topic: pushed_at:2024-08 star:13.4k fork:2.4k Zuul is a gateway service that provides dynamic routing, monitoring, resiliency, security, and more.
...
- [Netflix/x-element](https://github.com/Netflix/x-element) topic: pushed_at:2024-08 star:0.0k fork:0.0k A dead simple starting point for custom elements.
...
- [Netflix/dgs-codegen](https://github.com/Netflix/dgs-codegen) topic: pushed_at:2024-08 star:0.2k fork:0.1k 
...
- [Netflix/security-bulletins](https://github.com/Netflix/security-bulletins) topic:security pushed_at:2024-08 star:0.7k fork:0.1k Security Bulletins that relate to Netflix Open Source
...
- [Netflix/atlas-docs](https://github.com/Netflix/atlas-docs) topic: pushed_at:2024-08 star:0.0k fork:0.0k Atlas Documentation Site (https://netflix.github.io/atlas-docs/)
...
- [Netflix/dispatch](https://github.com/Netflix/dispatch) topic: pushed_at:2024-08 star:4.9k fork:0.5k All of the ad-hoc things you're doing to manage incidents today, done for you, and much more!
...
- [Netflix/lemur](https://github.com/Netflix/lemur) topic:aws,python,security,ssl,ssl-certificates,tls pushed_at:2024-08 star:1.7k fork:0.3k Repository for the Lemur Certificate Manager
...
- [Netflix/metaflow-nflx-extensions](https://github.com/Netflix/metaflow-nflx-extensions) topic: pushed_at:2024-08 star:0.0k fork:0.0k 
- [Netflix/metaflow-service](https://github.com/Netflix/metaflow-service) topic:ai,data-science,machine-learning,metaflow,ml,ml-infrastructure,ml-platform,productivity,ui pushed_at:2024-08 star:0.2k fork:0.1k :rocket: Metadata tracking and UI service for Metaflow!
...
- [Netflix/OpenVPCal](https://github.com/Netflix/OpenVPCal) topic: pushed_at:2024-08 star:0.1k fork:0.0k 
...
- [Netflix/spectator-py](https://github.com/Netflix/spectator-py) topic: pushed_at:2024-08 star:0.0k fork:0.0k 
...
- [Netflix/vmaf](https://github.com/Netflix/vmaf) topic: pushed_at:2024-08 star:4.4k fork:0.7k Perceptual video quality assessment based on multi-method fusion.
...
- [Netflix/atlas](https://github.com/Netflix/atlas) topic: pushed_at:2024-08 star:3.4k fork:0.3k In-memory dimensional time series database.
