...
- [Netflix/bpftop](https://github.com/Netflix/bpftop) topic: pushed_at:2026-02 star:2.6k fork:0.1k bpftop provides a dynamic real-time view of running eBPF programs. It displays the average runtime, events per second, and estimated total CPU % for each program.
- [Netflix/dial-reference](https://github.com/Netflix/dial-reference) topic: pushed_at:2023-07 star:0.3k fork:0.1k 
...
- [Netflix/global-lock-bench](https://github.com/Netflix/global-lock-bench) topic: pushed_at:2025-10 star:0.0k fork:0.0k 
- [Netflix/read_bbrlog](https://github.com/Netflix/read_bbrlog) topic: pushed_at:2025-10 star:0.0k fork:0.0k Utility designed to read data generated by FreeBSD's BBR TCP stack and placed into the black box, such as the files produced by tcplog_dumper
...
- [Netflix/msl](https://github.com/Netflix/msl) topic: pushed_at:2025-12 star:0.7k fork:0.1k Message Security Layer
...
- [Netflix/spectator-cpp](https://github.com/Netflix/spectator-cpp) topic: pushed_at:2025-12 star:0.0k fork:0.0k Thin-client metrics library for use with Atlas and SpectatorD

## Clojure

- [Netflix/mantis-mql](https://github.com/Netflix/mantis-mql) topic: pushed_at:2025-12 star:0.0k fork:0.0k 
...
- [Netflix/chaosmonkey](https://github.com/Netflix/chaosmonkey) topic: pushed_at:2025-01 star:16.6k fork:1.3k Chaos Monkey is a resiliency tool that helps applications tolerate random instance failures.
...
- [Netflix/spectator-go](https://github.com/Netflix/spectator-go) topic: pushed_at:2025-08 star:0.1k fork:0.0k Thin-client metrics library for use with Atlas and SpectatorD
...
- [Netflix/weep](https://github.com/Netflix/weep) topic: pushed_at:2026-02 star:0.3k fork:0.1k The ConsoleMe CLI utility
...
- [Netflix/awsobjectmapper](https://github.com/Netflix/awsobjectmapper) topic: pushed_at:2025-12 star:0.0k fork:0.0k Serializing / deserializing library for AWS objects
...
- [Netflix/mantis-gradle-plugin](https://github.com/Netflix/mantis-gradle-plugin) topic: pushed_at:2025-12 star:0.0k fork:0.0k Gradle plugin for producing a deployable Mantis Job artifact from a JVM-based project
...
- [Netflix/dgs](https://github.com/Netflix/dgs) topic: pushed_at:2026-01 star:0.0k fork:0.1k 
...
- [Netflix/archaius](https://github.com/Netflix/archaius) topic: pushed_at:2025-12 star:2.5k fork:0.5k Library for configuration management API
...
- [Netflix/concurrency-limits](https://github.com/Netflix/concurrency-limits) topic: pushed_at:2026-01 star:3.5k fork:0.3k 
...
- [Netflix/dgs-examples-java](https://github.com/Netflix/dgs-examples-java) topic: pushed_at:2025-12 star:0.2k fork:0.1k 
...
- [Netflix/dyno-queues](https://github.com/Netflix/dyno-queues) topic: pushed_at:2025-12 star:0.3k fork:0.1k Dyno Queues is a recipe that provides task queues utilizing Dynomite.
- [Netflix/dynomite-manager](https://github.com/Netflix/dynomite-manager) topic: pushed_at:2025-12 star:0.1k fork:0.1k A sidecar to manage Dynomite clusters
- [Netflix/eclipse-jifa](https://github.com/Netflix/eclipse-jifa) topic: pushed_at:2025-11 star:0.0k fork:0.0k 
- [Netflix/edda-client](https://github.com/Netflix/edda-client) topic: pushed_at:2023-04 star:0.0k fork:0.0k 
- [Netflix/eureka](https://github.com/Netflix/eureka) topic: pushed_at:2026-01 star:12.7k fork:3.8k AWS Service registry for resilient mid-tier load balancing and failover.
- [Netflix/EVCache](https://github.com/Netflix/EVCache) topic: pushed_at:2026-02 star:2.2k fork:0.3k A distributed in-memory data store for the cloud
...
- [Netflix/frigga](https://github.com/Netflix/frigga) topic: pushed_at:2025-12 star:0.0k fork:0.0k Utilities for working with Asgard named objects
- [Netflix/genie](https://github.com/Netflix/genie) topic:big-data,bigdata,cloud,configuration,configuration-management,distributed-systems,java,microservice,microservices,netflix-oss,netflixoss,orchestration,spring-boot pushed_at:2026-01 star:1.8k fork:0.4k Distributed Big Data Orchestration Service
...
- [Netflix/hollow](https://github.com/Netflix/hollow) topic: pushed_at:2026-02 star:1.3k fork:0.2k Hollow is a java library and toolset for disseminating in-memory datasets from a single producer to many consumers for high performance read-only access.
...
- [Netflix/iep](https://github.com/Netflix/iep) topic: pushed_at:2026-02 star:0.1k fork:0.0k Insight Engineering Platform Components
- [Netflix/karyon](https://github.com/Netflix/karyon) topic: pushed_at:2024-03 star:0.5k fork:0.1k The nucleus or the base container for Applications and Services built using the NetflixOSS ecosystem
- [Netflix/maestro](https://github.com/Netflix/maestro) topic:agentic-workflow,analytics,automation,batch-processing,dag,data-engineering,data-ops,data-orchestrator,data-pipelines,data-science,elt,etl,java,machine-learning,mlops,orchestration,scheduler,workflow,workflow-engine,workflow-orchestration pushed_at:2026-01 star:3.7k fork:0.3k Maestro: Netflix’s Workflow Orchestrator
- [Netflix/mantis](https://github.com/Netflix/mantis) topic: pushed_at:2026-02 star:1.5k fork:0.2k A platform that makes it easy for developers to build realtime, cost-effective, operations-focused applications
- [Netflix/mantis-api](https://github.com/Netflix/mantis-api) topic: pushed_at:2026-02 star:0.0k fork:0.0k 
...
- [Netflix/metacat](https://github.com/Netflix/metacat) topic: pushed_at:2026-02 star:1.7k fork:0.3k 
- [Netflix/netflix-commons](https://github.com/Netflix/netflix-commons) topic: pushed_at:2025-12 star:0.2k fork:0.1k Common utilities for Netflix OSS projects
...
- [Netflix/photon](https://github.com/Netflix/photon) topic: pushed_at:2026-02 star:0.2k fork:0.1k Photon is a Java implementation of the Interoperable Master Format (IMF) standard. IMF is a SMPTE standard whose core constraints are defined in the specification st2067-2:2013
...
- [Netflix/Priam](https://github.com/Netflix/Priam) topic: pushed_at:2026-02 star:1.0k fork:0.3k Co-Process for backup/recovery, Token Management, and Centralized Configuration management for Cassandra.
- [Netflix/q](https://github.com/Netflix/q) topic: pushed_at:2025-12 star:0.1k fork:0.0k Query testing framework
- [Netflix/Raigad](https://github.com/Netflix/Raigad) topic: pushed_at:2025-12 star:0.3k fork:0.1k Co-Process for backup/recovery, Auto Deployments and Centralized Configuration management for ElasticSearch
...
- [Netflix/ribbon](https://github.com/Netflix/ribbon) topic: pushed_at:2025-12 star:4.6k fork:1.2k Ribbon is a Inter Process Communication (remote procedure calls) library with built in software load balancers. The primary usage model involves REST calls with various serialization scheme support.
...
- [Netflix/servo](https://github.com/Netflix/servo) topic: pushed_at:2025-12 star:1.4k fork:0.3k Netflix Application Monitoring Library
...
- [Netflix/spectator](https://github.com/Netflix/spectator) topic: pushed_at:2026-02 star:0.8k fork:0.2k Client library for collecting metrics.
...
- [Netflix/zuul](https://github.com/Netflix/zuul) topic: pushed_at:2026-02 star:14.0k fork:2.4k Zuul is a gateway service that provides dynamic routing, monitoring, resiliency, security, and more.
...
- [Netflix/metaflow-docs](https://github.com/Netflix/metaflow-docs) topic: pushed_at:2026-02 star:0.0k fork:0.1k 
...
- [Netflix/x-element](https://github.com/Netflix/x-element) topic: pushed_at:2026-02 star:0.0k fork:0.0k A dead simple starting point for custom elements.
- [Netflix/x-test](https://github.com/Netflix/x-test) topic: pushed_at:2026-01 star:0.0k fork:0.0k 
- [Netflix/x-test-cli](https://github.com/Netflix/x-test-cli) topic: pushed_at:2025-10 star:0.0k fork:0.0k 
...
- [Netflix/dgs-codegen](https://github.com/Netflix/dgs-codegen) topic: pushed_at:2026-02 star:0.2k fork:0.1k 
- [Netflix/dgs-examples-kotlin](https://github.com/Netflix/dgs-examples-kotlin) topic: pushed_at:2025-12 star:0.1k fork:0.0k 
...
- [Netflix/dgs-framework](https://github.com/Netflix/dgs-framework) topic:dgs,graphql,graphql-java,java,spring-boot pushed_at:2026-02 star:3.3k fork:0.3k GraphQL for Java with Spring Boot made easy.
- [Netflix/dgs-intellij-plugin](https://github.com/Netflix/dgs-intellij-plugin) topic: pushed_at:2025-12 star:0.0k fork:0.0k 
...
- [Netflix/nflx-geofeed](https://github.com/Netflix/nflx-geofeed) topic: pushed_at:2026-02 star:0.0k fork:0.0k 
...
- [Netflix/atlas-docs](https://github.com/Netflix/atlas-docs) topic: pushed_at:2026-02 star:0.1k fork:0.0k Atlas Documentation Site (https://netflix.github.io/atlas-docs/)
...
- [Netflix/consoleme](https://github.com/Netflix/consoleme) topic:aws,aws-iam,cloud-security,security-tools pushed_at:2026-02 star:3.2k fork:0.3k A Central Control Plane for AWS Permissions and Access
- [Netflix/dispatch](https://github.com/Netflix/dispatch) topic: pushed_at:2025-09 star:6.4k fork:0.6k All of the ad-hoc things you're doing to manage incidents today, done for you, and much more!
...
- [Netflix/lemur](https://github.com/Netflix/lemur) topic:aws,python,security,ssl,ssl-certificates,tls pushed_at:2026-02 star:1.8k fork:0.3k Repository for the Lemur Certificate Manager
- [Netflix/lemur-docker](https://github.com/Netflix/lemur-docker) topic:security pushed_at:2026-02 star:0.2k fork:0.1k Docker files for the Lemur certificate orchestration tool
- [Netflix/metaflow](https://github.com/Netflix/metaflow) topic:agents,ai,aws,azure,cost-optimization,datascience,distributed-training,gcp,generative-ai,high-performance-computing,kubernetes,llm,llmops,machine-learning,ml,ml-infrastructure,ml-platform,mlops,model-management,python pushed_at:2026-02 star:9.8k fork:1.0k Build, Manage and Deploy AI/ML Systems
...
- [Netflix/metaflow-nflx-extensions](https://github.com/Netflix/metaflow-nflx-extensions) topic: pushed_at:2026-02 star:0.0k fork:0.0k 
- [Netflix/metaflow-service](https://github.com/Netflix/metaflow-service) topic:ai,data-science,machine-learning,metaflow,ml,ml-infrastructure,ml-platform,productivity,ui pushed_at:2026-02 star:0.2k fork:0.1k :rocket: Metadata tracking and UI service for Metaflow!
...
- [Netflix/OpenVPCal](https://github.com/Netflix/OpenVPCal) topic: pushed_at:2026-01 star:0.1k fork:0.0k 
- [Netflix/pygenie](https://github.com/Netflix/pygenie) topic: pushed_at:2025-03 star:0.1k fork:0.0k 
- [Netflix/repokid](https://github.com/Netflix/repokid) topic:aws,security pushed_at:2025-11 star:1.1k fork:0.1k AWS Least Privilege for Distributed, High-Velocity Deployment
...
- [Netflix/vmaf](https://github.com/Netflix/vmaf) topic: pushed_at:2026-01 star:5.3k fork:0.8k Perceptual video quality assessment based on multi-method fusion.
...
- [Netflix/atlas](https://github.com/Netflix/atlas) topic: pushed_at:2026-02 star:3.5k fork:0.3k In-memory dimensional time series database.
...
- [Netflix/dispatch-docker](https://github.com/Netflix/dispatch-docker) topic: pushed_at:2025-10 star:0.2k fork:0.1k 
- [Netflix/eslint-config-netflix](https://github.com/Netflix/eslint-config-netflix) topic: pushed_at:2025-11 star:0.1k fork:0.0k Shared ESLint config for Netflix JavaScript

## Smarty

- [Netflix/mantis-helm](https://github.com/Netflix/mantis-helm) topic: pushed_at:2025-10 star:0.0k fork:0.0k 

## TypeScript

- [Netflix/mantis-ui](https://github.com/Netflix/mantis-ui) topic: pushed_at:2023-10 star:0.0k fork:0.0k 
- [Netflix/metaflow-ui](https://github.com/Netflix/metaflow-ui) topic:metaflow,ml-platform,ui pushed_at:2026-01 star:0.4k fork:0.0k :art: UI for monitoring your Metaflow executions!
