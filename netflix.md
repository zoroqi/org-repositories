...
- [Netflix/chaosmonkey](https://github.com/Netflix/chaosmonkey) topic: pushed_at:2023-12 star:14.8k fork:1.1k Chaos Monkey is a resiliency tool that helps applications tolerate random instance failures.
...
- [Netflix/maestro](https://github.com/Netflix/maestro) topic: pushed_at:2024-07 star:0.0k fork:0.0k Maestro: Netflix’s Workflow Orchestrator
...
- [Netflix/zuul](https://github.com/Netflix/zuul) topic: pushed_at:2024-07 star:13.3k fork:2.3k Zuul is a gateway service that provides dynamic routing, monitoring, resiliency, security, and more.
...
- [Netflix/dgs-framework](https://github.com/Netflix/dgs-framework) topic:dgs,graphql,graphql-java,java,spring-boot pushed_at:2024-07 star:3.0k fork:0.3k GraphQL for Java with Spring Boot made easy.
...
- [Netflix/consoleme](https://github.com/Netflix/consoleme) topic:aws,aws-iam,cloud-security,security-tools pushed_at:2024-07 star:3.1k fork:0.2k A Central Control Plane for AWS Permissions and Access
