...
- [Netflix/chaosmonkey](https://github.com/Netflix/chaosmonkey) topic: pushed_at:2023-07 star:13.7k fork:1.0k Chaos Monkey is a resiliency tool that helps applications tolerate random instance failures.
...
- [Netflix/archaius](https://github.com/Netflix/archaius) topic: pushed_at:2023-07 star:2.4k fork:0.5k Library for configuration management API
...
- [Netflix/conductor](https://github.com/Netflix/conductor) topic:distributed-systems,grpc,java,javascript,microservice-orchestration,orchestration-engine,orchestrator,reactjs,spring-boot,workflow-automation,workflow-engine,workflow-management,workflows pushed_at:2023-07 star:9.9k fork:2.2k Conductor is a microservices orchestration engine.
- [Netflix/conductor-community](https://github.com/Netflix/conductor-community) topic: pushed_at:2023-07 star:0.1k fork:0.1k 
...
- [Netflix/dgs-examples-java](https://github.com/Netflix/dgs-examples-java) topic: pushed_at:2023-07 star:0.1k fork:0.1k 
...
- [Netflix/hollow](https://github.com/Netflix/hollow) topic: pushed_at:2023-07 star:1.1k fork:0.2k Hollow is a java library and toolset for disseminating in-memory datasets from a single producer to many consumers for high performance read-only access.
...
- [Netflix/iep](https://github.com/Netflix/iep) topic: pushed_at:2023-07 star:0.1k fork:0.0k Insight Engineering Platform Components
...
- [Netflix/mantis](https://github.com/Netflix/mantis) topic: pushed_at:2023-07 star:1.3k fork:0.2k A platform that makes it easy for developers to build realtime, cost-effective, operations-focused applications
- [Netflix/mantis-api](https://github.com/Netflix/mantis-api) topic: pushed_at:2023-07 star:0.0k fork:0.0k 
...
- [Netflix/Priam](https://github.com/Netflix/Priam) topic: pushed_at:2023-07 star:1.0k fork:0.3k Co-Process for backup/recovery, Token Management, and Centralized Configuration management for Cassandra.
...
- [Netflix/zuul](https://github.com/Netflix/zuul) topic: pushed_at:2023-07 star:12.7k fork:2.3k Zuul is a gateway service that provides dynamic routing, monitoring, resiliency, security, and more.
...
- [Netflix/conductor-ui](https://github.com/Netflix/conductor-ui) topic: pushed_at:2023-07 star:0.0k fork:0.0k 
...
- [Netflix/dgs-codegen](https://github.com/Netflix/dgs-codegen) topic: pushed_at:2023-07 star:0.2k fork:0.1k 
...
- [Netflix/dgs-federation-example](https://github.com/Netflix/dgs-federation-example) topic: pushed_at:2023-07 star:0.1k fork:0.0k 
...
- [Netflix/bless](https://github.com/Netflix/bless) topic:aws,bastion,lambda,python,security,serverless,ssh,ssh-certificates pushed_at:2023-07 star:2.7k fork:0.2k Repository for BLESS, an SSH Certificate Authority that runs as a AWS Lambda function
...
- [Netflix/dispatch](https://github.com/Netflix/dispatch) topic: pushed_at:2023-07 star:4.0k fork:0.4k All of the ad-hoc things you're doing to manage incidents today, done for you, and much more!
...
- [Netflix/metaflow-service](https://github.com/Netflix/metaflow-service) topic:ai,data-science,machine-learning,metaflow,ml,ml-infrastructure,ml-platform,productivity,ui pushed_at:2023-07 star:0.1k fork:0.1k :rocket: Metadata tracking and UI service for Metaflow!
...
- [Netflix/vmaf](https://github.com/Netflix/vmaf) topic: pushed_at:2023-07 star:3.7k fork:0.7k Perceptual video quality assessment based on multi-method fusion.
...
- [Netflix/atlas](https://github.com/Netflix/atlas) topic: pushed_at:2023-07 star:3.3k fork:0.3k In-memory dimensional time series database.
...
- [Netflix/mantis-ui](https://github.com/Netflix/mantis-ui) topic: pushed_at:2023-07 star:0.0k fork:0.0k 
- [Netflix/metaflow-ui](https://github.com/Netflix/metaflow-ui) topic:metaflow,ml-platform,ui pushed_at:2023-07 star:0.3k fork:0.0k :art: UI for monitoring your Metaflow executions!
