...
- [Netflix/bpftop](https://github.com/Netflix/bpftop) topic: pushed_at:2024-05 star:1.9k fork:0.1k bpftop provides a dynamic real-time view of running eBPF programs. It displays the average runtime, events per second, and estimated total CPU % for each program.
...
- [Netflix/weep](https://github.com/Netflix/weep) topic: pushed_at:2024-04 star:0.3k fork:0.0k The ConsoleMe CLI utility
...
- [Netflix/archaius](https://github.com/Netflix/archaius) topic: pushed_at:2024-04 star:2.4k fork:0.5k Library for configuration management API
...
- [Netflix/eureka](https://github.com/Netflix/eureka) topic: pushed_at:2024-05 star:12.2k fork:3.7k AWS Service registry for resilient mid-tier load balancing and failover.
...
- [Netflix/spectator](https://github.com/Netflix/spectator) topic: pushed_at:2024-04 star:0.7k fork:0.2k Client library for collecting metrics.
...
- [Netflix/dgs-codegen](https://github.com/Netflix/dgs-codegen) topic: pushed_at:2024-05 star:0.2k fork:0.1k 
...
- [Netflix/dgs-framework](https://github.com/Netflix/dgs-framework) topic:dgs,graphql,graphql-java,java,spring-boot pushed_at:2024-05 star:3.0k fork:0.3k GraphQL for Java with Spring Boot made easy.
...
- [Netflix/dispatch](https://github.com/Netflix/dispatch) topic: pushed_at:2024-05 star:4.6k fork:0.5k All of the ad-hoc things you're doing to manage incidents today, done for you, and much more!
- [Netflix/e2nest](https://github.com/Netflix/e2nest) topic: pushed_at:2024-04 star:0.0k fork:0.0k Web-based platform for media-centric (video, audio and images) subjective testing
...
- [Netflix/OpenVPCal](https://github.com/Netflix/OpenVPCal) topic: pushed_at:2024-05 star:0.0k fork:0.0k 
