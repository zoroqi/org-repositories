...
- [Netflix/bpftop](https://github.com/Netflix/bpftop) topic: pushed_at:2025-02 star:2.4k fork:0.1k bpftop provides a dynamic real-time view of running eBPF programs. It displays the average runtime, events per second, and estimated total CPU % for each program.
...
- [Netflix/spectator-cpp](https://github.com/Netflix/spectator-cpp) topic: pushed_at:2025-02 star:0.0k fork:0.0k Spectator library for instrumenting C++ applications, which sends metrics to SpectatorD.
...
- [Netflix/chaosmonkey](https://github.com/Netflix/chaosmonkey) topic: pushed_at:2025-01 star:15.5k fork:1.2k Chaos Monkey is a resiliency tool that helps applications tolerate random instance failures.
...
- [Netflix/dgs](https://github.com/Netflix/dgs) topic: pushed_at:2025-02 star:0.0k fork:0.1k 
...
- [Netflix/archaius](https://github.com/Netflix/archaius) topic: pushed_at:2025-02 star:2.5k fork:0.5k Library for configuration management API
...
- [Netflix/EVCache](https://github.com/Netflix/EVCache) topic: pushed_at:2025-02 star:2.1k fork:0.2k A distributed in-memory data store for the cloud
...
- [Netflix/genie](https://github.com/Netflix/genie) topic:big-data,bigdata,cloud,configuration,configuration-management,distributed-systems,java,microservice,microservices,netflix-oss,netflixoss,orchestration,spring-boot pushed_at:2025-02 star:1.7k fork:0.4k Distributed Big Data Orchestration Service
...
- [Netflix/hollow](https://github.com/Netflix/hollow) topic: pushed_at:2025-02 star:1.2k fork:0.2k Hollow is a java library and toolset for disseminating in-memory datasets from a single producer to many consumers for high performance read-only access.
...
- [Netflix/iep](https://github.com/Netflix/iep) topic: pushed_at:2025-02 star:0.1k fork:0.0k Insight Engineering Platform Components
...
- [Netflix/maestro](https://github.com/Netflix/maestro) topic: pushed_at:2025-02 star:3.4k fork:0.2k Maestro: Netflix’s Workflow Orchestrator
...
- [Netflix/metacat](https://github.com/Netflix/metacat) topic: pushed_at:2025-02 star:1.6k fork:0.3k 
...
- [Netflix/photon](https://github.com/Netflix/photon) topic: pushed_at:2025-01 star:0.2k fork:0.1k Photon is a Java implementation of the Interoperable Master Format (IMF) standard. IMF is a SMPTE standard whose core constraints are defined in the specification st2067-2:2013
...
- [Netflix/Priam](https://github.com/Netflix/Priam) topic: pushed_at:2025-01 star:1.0k fork:0.3k Co-Process for backup/recovery, Token Management, and Centralized Configuration management for Cassandra.
...
- [Netflix/spectator](https://github.com/Netflix/spectator) topic: pushed_at:2025-02 star:0.7k fork:0.2k Client library for collecting metrics.
...
- [Netflix/zuul](https://github.com/Netflix/zuul) topic: pushed_at:2025-02 star:13.6k fork:2.4k Zuul is a gateway service that provides dynamic routing, monitoring, resiliency, security, and more.
...
- [Netflix/eslint-plugin-x-element](https://github.com/Netflix/eslint-plugin-x-element) topic: pushed_at:2025-02 star:0.0k fork:0.0k 
...
- [Netflix/metaflow-docs](https://github.com/Netflix/metaflow-docs) topic: pushed_at:2025-02 star:0.0k fork:0.0k 
...
- [Netflix/x-element](https://github.com/Netflix/x-element) topic: pushed_at:2025-02 star:0.0k fork:0.0k A dead simple starting point for custom elements.
- [Netflix/x-test](https://github.com/Netflix/x-test) topic: pushed_at:2025-02 star:0.0k fork:0.0k 
...
- [Netflix/dgs-codegen](https://github.com/Netflix/dgs-codegen) topic: pushed_at:2025-02 star:0.2k fork:0.1k 
...
- [Netflix/dgs-framework](https://github.com/Netflix/dgs-framework) topic:dgs,graphql,graphql-java,java,spring-boot pushed_at:2025-02 star:3.1k fork:0.3k GraphQL for Java with Spring Boot made easy.
...
- [Netflix/atlas-docs](https://github.com/Netflix/atlas-docs) topic: pushed_at:2025-02 star:0.0k fork:0.0k Atlas Documentation Site (https://netflix.github.io/atlas-docs/)
...
- [Netflix/dispatch](https://github.com/Netflix/dispatch) topic: pushed_at:2025-02 star:5.4k fork:0.5k All of the ad-hoc things you're doing to manage incidents today, done for you, and much more!
...
- [Netflix/lemur](https://github.com/Netflix/lemur) topic:aws,python,security,ssl,ssl-certificates,tls pushed_at:2025-02 star:1.7k fork:0.3k Repository for the Lemur Certificate Manager
...
- [Netflix/metaflow-service](https://github.com/Netflix/metaflow-service) topic:ai,data-science,machine-learning,metaflow,ml,ml-infrastructure,ml-platform,productivity,ui pushed_at:2025-02 star:0.2k fork:0.1k :rocket: Metadata tracking and UI service for Metaflow!
...
- [Netflix/OpenVPCal](https://github.com/Netflix/OpenVPCal) topic: pushed_at:2025-02 star:0.1k fork:0.0k 
- [Netflix/pygenie](https://github.com/Netflix/pygenie) topic: pushed_at:2025-02 star:0.1k fork:0.0k 
...
- [Netflix/vmaf](https://github.com/Netflix/vmaf) topic: pushed_at:2025-02 star:4.8k fork:0.8k Perceptual video quality assessment based on multi-method fusion.
...
- [Netflix/atlas](https://github.com/Netflix/atlas) topic: pushed_at:2025-02 star:3.5k fork:0.3k In-memory dimensional time series database.
...
- [Netflix/metaflow-ui](https://github.com/Netflix/metaflow-ui) topic:metaflow,ml-platform,ui pushed_at:2025-02 star:0.3k fork:0.0k :art: UI for monitoring your Metaflow executions!
