...
- [Netflix/read_bbrlog](https://github.com/Netflix/read_bbrlog) topic: pushed_at:2026-04 star:0.0k fork:0.0k Utility designed to read data generated by FreeBSD's BBR TCP stack and placed into the black box, such as the files produced by tcplog_dumper
...
- [Netflix/vmaf](https://github.com/Netflix/vmaf) topic: pushed_at:2026-04 star:5.3k fork:0.8k Perceptual video quality assessment based on multi-method fusion.
...
- [Netflix/spectator-cpp](https://github.com/Netflix/spectator-cpp) topic: pushed_at:2026-04 star:0.0k fork:0.0k Thin-client metrics library for use with Atlas and SpectatorD
...
- [Netflix/chaosmonkey](https://github.com/Netflix/chaosmonkey) topic: pushed_at:2025-01 star:16.8k fork:1.3k Chaos Monkey is a resiliency tool that helps applications tolerate random instance failures.
...
- [Netflix/spectator-go](https://github.com/Netflix/spectator-go) topic: pushed_at:2026-03 star:0.1k fork:0.0k Thin-client metrics library for use with Atlas and SpectatorD
...
- [Netflix/dgs](https://github.com/Netflix/dgs) topic: pushed_at:2026-03 star:0.0k fork:0.1k 
...
- [Netflix/concurrency-limits](https://github.com/Netflix/concurrency-limits) topic: pushed_at:2026-01 star:3.6k fork:0.3k 
...
- [Netflix/dgs-examples-java](https://github.com/Netflix/dgs-examples-java) topic: pushed_at:2026-04 star:0.2k fork:0.1k 
...
- [Netflix/eclipse-jifa](https://github.com/Netflix/eclipse-jifa) topic: pushed_at:2026-03 star:0.0k fork:0.0k 
- [Netflix/edda-client](https://github.com/Netflix/edda-client) topic: pushed_at:2023-04 star:0.0k fork:0.0k 
- [Netflix/eureka](https://github.com/Netflix/eureka) topic: pushed_at:2026-03 star:12.7k fork:3.8k AWS Service registry for resilient mid-tier load balancing and failover.
- [Netflix/EVCache](https://github.com/Netflix/EVCache) topic: pushed_at:2026-03 star:2.2k fork:0.3k A distributed in-memory data store for the cloud
...
- [Netflix/hollow](https://github.com/Netflix/hollow) topic: pushed_at:2026-04 star:1.3k fork:0.2k Hollow is a java library and toolset for disseminating in-memory datasets from a single producer to many consumers for high performance read-only access.
...
- [Netflix/iep](https://github.com/Netflix/iep) topic: pushed_at:2026-04 star:0.1k fork:0.0k Insight Engineering Platform Components
...
- [Netflix/maestro](https://github.com/Netflix/maestro) topic:agentic-workflow,analytics,automation,batch-processing,dag,data-engineering,data-ops,data-orchestrator,data-pipelines,data-science,elt,etl,java,machine-learning,mlops,orchestration,scheduler,workflow,workflow-engine,workflow-orchestration pushed_at:2026-04 star:3.8k fork:0.3k Maestro: Netflix’s Workflow Orchestrator
- [Netflix/mantis](https://github.com/Netflix/mantis) topic: pushed_at:2026-04 star:1.5k fork:0.2k A platform that makes it easy for developers to build realtime, cost-effective, operations-focused applications
...
- [Netflix/metacat](https://github.com/Netflix/metacat) topic: pushed_at:2026-04 star:1.7k fork:0.3k 
...
- [Netflix/photon](https://github.com/Netflix/photon) topic: pushed_at:2026-02 star:0.3k fork:0.1k Photon is a Java implementation of the Interoperable Master Format (IMF) standard. IMF is a SMPTE standard whose core constraints are defined in the specification st2067-2:2013
...
- [Netflix/spectator](https://github.com/Netflix/spectator) topic: pushed_at:2026-04 star:0.8k fork:0.2k Client library for collecting metrics.
...
- [Netflix/zuul](https://github.com/Netflix/zuul) topic: pushed_at:2026-04 star:14.0k fork:2.4k Zuul is a gateway service that provides dynamic routing, monitoring, resiliency, security, and more.
...
- [Netflix/x-element](https://github.com/Netflix/x-element) topic: pushed_at:2026-03 star:0.0k fork:0.0k A dead simple starting point for custom elements.
- [Netflix/x-test](https://github.com/Netflix/x-test) topic: pushed_at:2026-04 star:0.0k fork:0.0k 
...
- [Netflix/dgs-codegen](https://github.com/Netflix/dgs-codegen) topic: pushed_at:2026-04 star:0.2k fork:0.1k 
...
- [Netflix/dgs-framework](https://github.com/Netflix/dgs-framework) topic:dgs,graphql,graphql-java,java,spring-boot pushed_at:2026-04 star:3.3k fork:0.3k GraphQL for Java with Spring Boot made easy.
...
- [Netflix/nflx-geofeed](https://github.com/Netflix/nflx-geofeed) topic: pushed_at:2026-03 star:0.0k fork:0.0k 
...
- [Netflix/atlas-docs](https://github.com/Netflix/atlas-docs) topic: pushed_at:2026-04 star:0.1k fork:0.0k Atlas Documentation Site (https://netflix.github.io/atlas-docs/)
...
- [Netflix/consoleme](https://github.com/Netflix/consoleme) topic:aws,aws-iam,cloud-security,security-tools pushed_at:2026-03 star:3.2k fork:0.3k A Central Control Plane for AWS Permissions and Access
- [Netflix/dispatch](https://github.com/Netflix/dispatch) topic: pushed_at:2025-09 star:6.4k fork:0.7k All of the ad-hoc things you're doing to manage incidents today, done for you, and much more!
...
- [Netflix/hubcommander](https://github.com/Netflix/hubcommander) topic:bot,chatops,github,privileges,python,security,slack,slack-bot,travis-ci pushed_at:2026-04 star:1.3k fork:0.2k A Slack bot for GitHub organization management -- and other things too
...
- [Netflix/lemur](https://github.com/Netflix/lemur) topic:aws,python,security,ssl,ssl-certificates,tls pushed_at:2026-04 star:1.8k fork:0.3k Repository for the Lemur Certificate Manager
...
- [Netflix/metaflow-nflx-extensions](https://github.com/Netflix/metaflow-nflx-extensions) topic: pushed_at:2026-04 star:0.0k fork:0.0k 
- [Netflix/metaflow-service](https://github.com/Netflix/metaflow-service) topic:ai,data-science,machine-learning,metaflow,ml,ml-infrastructure,ml-platform,productivity,ui pushed_at:2026-04 star:0.2k fork:0.1k :rocket: Metadata tracking and UI service for Metaflow!
...
- [Netflix/OpenVPCal](https://github.com/Netflix/OpenVPCal) topic: pushed_at:2026-03 star:0.1k fork:0.0k 
- [Netflix/pygenie](https://github.com/Netflix/pygenie) topic: pushed_at:2026-04 star:0.1k fork:0.0k 
...
- [Netflix/void-model](https://github.com/Netflix/void-model) topic: pushed_at:2026-04 star:1.6k fork:0.1k 
...
- [Netflix/atlas](https://github.com/Netflix/atlas) topic: pushed_at:2026-04 star:3.6k fork:0.3k In-memory dimensional time series database.
...
- [Netflix/wick](https://github.com/Netflix/wick) topic: pushed_at:2026-04 star:0.0k fork:0.0k A zero cost type safe Apache Spark API
...
- [Netflix/spectator-js](https://github.com/Netflix/spectator-js) topic: pushed_at:2026-04 star:0.1k fork:0.0k Thin-client metrics library for use with Atlas and SpectatorD
