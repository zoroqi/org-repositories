...
- [Netflix/conductor](https://github.com/Netflix/conductor) topic:distributed-systems,grpc,java,javascript,microservice-orchestration,orchestration-engine,reactjs,spring-boot,workflow-automation,workflow-engine,workflow-management pushed_at:2023-05 star:9.8k fork:2.1k Conductor is a microservices orchestration engine.
...
- [Netflix/eureka](https://github.com/Netflix/eureka) topic: pushed_at:2023-04 star:11.8k fork:3.7k AWS Service registry for resilient mid-tier load balancing and failover.
...
- [Netflix/Hystrix](https://github.com/Netflix/Hystrix) topic: pushed_at:2023-04 star:23.4k fork:4.7k Hystrix is a latency and fault tolerance library designed to isolate points of access to remote systems, services and 3rd party libraries, stop cascading failure and enable resilience in complex distributed systems where failure is inevitable.
...
- [Netflix/mantis](https://github.com/Netflix/mantis) topic: pushed_at:2023-05 star:1.3k fork:0.2k A platform that makes it easy for developers to build realtime, cost-effective, operations-focused applications
- [Netflix/mantis-api](https://github.com/Netflix/mantis-api) topic: pushed_at:2023-04 star:0.0k fork:0.0k 
...
- [Netflix/photon](https://github.com/Netflix/photon) topic: pushed_at:2023-04 star:0.2k fork:0.1k Photon is a Java implementation of the Interoperable Master Format (IMF) standard. IMF is a SMPTE standard whose core constraints are defined in the specification st2067-2:2013
...
- [Netflix/zuul](https://github.com/Netflix/zuul) topic: pushed_at:2023-05 star:12.6k fork:2.3k Zuul is a gateway service that provides dynamic routing, monitoring, resiliency, security, and more.
...
- [Netflix/inviso](https://github.com/Netflix/inviso) topic: pushed_at:2023-04 star:0.2k fork:0.1k 
...
- [Netflix/spectator-js](https://github.com/Netflix/spectator-js) topic: pushed_at:2023-04 star:0.0k fork:0.0k Library for instrumenting Node.js applications using a dimensional data model
...
- [Netflix/x-element](https://github.com/Netflix/x-element) topic: pushed_at:2023-04 star:0.0k fork:0.0k 
...
- [Netflix/dispatch](https://github.com/Netflix/dispatch) topic: pushed_at:2023-05 star:3.9k fork:0.4k All of the ad-hoc things you're doing to manage incidents today, done for you, and much more!
...
- [Netflix/repokid](https://github.com/Netflix/repokid) topic:aws,security pushed_at:2023-04 star:1.1k fork:0.1k AWS Least Privilege for Distributed, High-Velocity Deployment
