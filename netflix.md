...
- [Netflix/vmaf](https://github.com/Netflix/vmaf) topic: pushed_at:2026-07 star:5.4k fork:0.8k Perceptual video quality assessment based on multi-method fusion.
...
- [Netflix/EVCache](https://github.com/Netflix/EVCache) topic: pushed_at:2026-07 star:2.2k fork:0.3k A distributed in-memory data store for the cloud
...
- [Netflix/maestro](https://github.com/Netflix/maestro) topic:agentic-workflow,analytics,automation,batch-processing,dag,data-engineering,data-ops,data-orchestrator,data-pipelines,data-science,elt,etl,java,machine-learning,mlops,orchestration,scheduler,workflow,workflow-engine,workflow-orchestration pushed_at:2026-07 star:3.8k fork:0.3k Maestro: Netflix’s Workflow Orchestrator
- [Netflix/mantis](https://github.com/Netflix/mantis) topic: pushed_at:2026-07 star:1.5k fork:0.2k A platform that makes it easy for developers to build realtime, cost-effective, operations-focused applications
...
- [Netflix/metacat](https://github.com/Netflix/metacat) topic: pushed_at:2026-07 star:1.7k fork:0.3k 
...
- [Netflix/spectator](https://github.com/Netflix/spectator) topic: pushed_at:2026-07 star:0.8k fork:0.2k Client library for collecting metrics.
...
- [Netflix/dgs-framework](https://github.com/Netflix/dgs-framework) topic:dgs,graphql,graphql-java,java,spring-boot pushed_at:2026-07 star:3.4k fork:0.3k GraphQL for Java with Spring Boot made easy.
...
- [Netflix/atlas-docs](https://github.com/Netflix/atlas-docs) topic: pushed_at:2026-07 star:0.1k fork:0.0k Atlas Documentation Site (https://netflix.github.io/atlas-docs/)
...
- [Netflix/metaflow-nflx-extensions](https://github.com/Netflix/metaflow-nflx-extensions) topic: pushed_at:2026-07 star:0.1k fork:0.0k 
- [Netflix/metaflow-service](https://github.com/Netflix/metaflow-service) topic:ai,data-science,machine-learning,metaflow,ml,ml-infrastructure,ml-platform,productivity,ui pushed_at:2026-07 star:0.2k fork:0.1k :rocket: Metadata tracking and UI service for Metaflow!
...
- [Netflix/atlas](https://github.com/Netflix/atlas) topic: pushed_at:2026-07 star:3.6k fork:0.4k In-memory dimensional time series database.
