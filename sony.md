...
- [sony/meta-flutter](https://github.com/sony/meta-flutter) topic:bitbake,flutter,flutter-engine,yocto,yocto-layer,yocto-meta pushed_at:2023-12 star:0.1k fork:0.0k Yocto recipes for Flutter Engine and custom embedders
...
- [sony/flutter-embedded-linux](https://github.com/sony/flutter-embedded-linux) topic:embedded-linux,embedded-systems,flutter,linux pushed_at:2023-12 star:1.1k fork:0.1k Embedded Linux embedding for Flutter
- [sony/nmos-cpp](https://github.com/sony/nmos-cpp) topic:cpp,cpp11,nmos,sdk pushed_at:2023-12 star:0.1k fork:0.1k An NMOS (Networked Media Open Specifications) Registry and Node in C++ (IS-04, IS-05)
...
- [sony/nnabla-ext-cuda](https://github.com/sony/nnabla-ext-cuda) topic: pushed_at:2023-12 star:0.1k fork:0.0k A CUDA Extension of Neural Network Libraries

## Dart

- [sony/flutter-elinux](https://github.com/sony/flutter-elinux) topic:embedded-linux,embedded-systems,flutter,linux pushed_at:2023-12 star:0.4k fork:0.0k Flutter tools for embedded Linux (eLinux)
...
- [sony/gobreaker](https://github.com/sony/gobreaker) topic:circuit-breaker,golang,microservice pushed_at:2023-10 star:2.7k fork:0.2k Circuit Breaker implemented in Go
...
- [sony/sonyflake](https://github.com/sony/sonyflake) topic:golang,id-generator pushed_at:2023-11 star:3.6k fork:0.3k A distributed unique ID generator inspired by Twitter's Snowflake
...
- [sony/timbre-trap](https://github.com/sony/timbre-trap) topic: pushed_at:2023-12 star:0.0k fork:0.0k 
...
- [sony/ctm](https://github.com/sony/ctm) topic: pushed_at:2023-10 star:0.1k fork:0.0k 
- [sony/nnabla-doc](https://github.com/sony/nnabla-doc) topic: pushed_at:2023-12 star:0.0k fork:0.0k 
...
- [sony/evsCluster](https://github.com/sony/evsCluster) topic: pushed_at:2023-12 star:0.0k fork:0.0k Python scripts to process EVS (Event-based vision sensor) data
- [sony/FxNorm-automix](https://github.com/sony/FxNorm-automix) topic:automatic-mixing,data-normalization,intelligent-music-production,machine-learning pushed_at:2023-12 star:0.1k fork:0.0k FxNorm-Automix - Implementation of automatic music mixing systems. We show how we can use wet music data and repurpose it to train a fully automatic mixing system
...
- [sony/nnabla](https://github.com/sony/nnabla) topic: pushed_at:2023-12 star:2.7k fork:0.3k Neural Network Libraries
...
- [sony/nnabla-rl](https://github.com/sony/nnabla-rl) topic: pushed_at:2023-12 star:0.1k fork:0.0k Deep reinforcement learning library built on top of Neural Network Libraries
...
- [sony/pyAutoPort](https://github.com/sony/pyAutoPort) topic: pushed_at:2023-12 star:0.0k fork:0.0k 
