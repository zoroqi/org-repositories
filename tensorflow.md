...
- [tensorflow/tensorflow](https://github.com/tensorflow/tensorflow) topic:deep-learning,deep-neural-networks,distributed,machine-learning,ml,neural-network,python,tensorflow pushed_at:2025-06 star:190.4k fork:74.7k An Open Source Machine Learning Framework for Everyone
...
- [tensorflow/fairness-indicators](https://github.com/tensorflow/fairness-indicators) topic:fairness-indicators,fairness-ml,tensorflow pushed_at:2025-04 star:0.4k fork:0.1k Tensorflow's Fairness Evaluation and Visualization Toolkit
...
- [tensorflow/tpu](https://github.com/tensorflow/tpu) topic: pushed_at:2025-03 star:5.3k fork:1.8k Reference models and tools for Cloud TPUs.
...
- [tensorflow/benchmarks](https://github.com/tensorflow/benchmarks) topic: pushed_at:2023-10 star:1.2k fork:0.6k  A benchmark framework for Tensorflow
...
- [tensorflow/gnn](https://github.com/tensorflow/gnn) topic:deep-learning,gnn,machine-learning,tensorflow pushed_at:2025-04 star:1.5k fork:0.2k TensorFlow GNN is a library to build Graph Neural Networks on the TensorFlow platform.
- [tensorflow/graphics](https://github.com/tensorflow/graphics) topic: pushed_at:2025-05 star:2.8k fork:0.4k TensorFlow Graphics: Differentiable Graphics Layers for TensorFlow
...
- [tensorflow/metadata](https://github.com/tensorflow/metadata) topic: pushed_at:2025-04 star:0.1k fork:0.1k Utilities for passing TensorFlow-related metadata between tools
...
- [tensorflow/playground](https://github.com/tensorflow/playground) topic: pushed_at:2025-02 star:12.4k fork:2.6k Play with neural networks!
...
- [tensorflow/tfjs](https://github.com/tensorflow/tfjs) topic:deep-learning,deep-neural-network,gpu-acceleration,javascript,machine-learning,neural-network,typescript,wasm,web-assembly,webgl pushed_at:2025-06 star:18.8k fork:2.0k A WebGL accelerated JavaScript library for training and deploying ML models.
...
- [tensorflow/tfjs-models](https://github.com/tensorflow/tfjs-models) topic: pushed_at:2025-02 star:14.5k fork:4.4k Pretrained models for TensorFlow.js
...
- [tensorflow/tfjs-wechat](https://github.com/tensorflow/tfjs-wechat) topic: pushed_at:2025-03 star:0.6k fork:0.1k WeChat Mini-program plugin for TensorFlow.js
