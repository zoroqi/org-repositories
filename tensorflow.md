...
- [tensorflow/runtime](https://github.com/tensorflow/runtime) topic: pushed_at:2025-01 star:0.8k fork:0.1k A performant and modular runtime for TensorFlow
...
- [tensorflow/tensorflow](https://github.com/tensorflow/tensorflow) topic:deep-learning,deep-neural-networks,distributed,machine-learning,ml,neural-network,python,tensorflow pushed_at:2025-02 star:187.5k fork:74.5k An Open Source Machine Learning Framework for Everyone
...
- [tensorflow/docs](https://github.com/tensorflow/docs) topic:deep-learning,deep-neural-networks,documentation,machine-learning,tensorflow,tensorflow-examples,tensorflow-tutorials pushed_at:2025-01 star:6.2k fork:5.3k TensorFlow documentation
...
- [tensorflow/datasets](https://github.com/tensorflow/datasets) topic:data,dataset,datasets,jax,machine-learning,numpy,tensorflow pushed_at:2025-01 star:4.4k fork:1.6k TFDS is a collection of datasets ready to use with TensorFlow, Jax, ...
...
- [tensorflow/playground](https://github.com/tensorflow/playground) topic: pushed_at:2024-10 star:12.2k fork:2.6k Play with neural networks!
...
- [tensorflow/tensorboard](https://github.com/tensorflow/tensorboard) topic: pushed_at:2025-01 star:6.8k fork:1.7k TensorFlow's Visualization Toolkit
- [tensorflow/tfjs](https://github.com/tensorflow/tfjs) topic:deep-learning,deep-neural-network,gpu-acceleration,javascript,machine-learning,neural-network,typescript,wasm,web-assembly,webgl pushed_at:2025-01 star:18.6k fork:2.0k A WebGL accelerated JavaScript library for training and deploying ML models.
...
- [tensorflow/tfjs-models](https://github.com/tensorflow/tfjs-models) topic: pushed_at:2025-01 star:14.3k fork:4.4k Pretrained models for TensorFlow.js
