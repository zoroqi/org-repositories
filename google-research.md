...
- [google-research/mozolm](https://github.com/google-research/mozolm) topic:assistive-technology,augmentative-communication,language-modeling pushed_at:2025-11 star:0.0k fork:0.0k MozoLM: A language model (LM) serving library
- [google-research/project-guideline](https://github.com/google-research/project-guideline) topic: pushed_at:2025-11 star:0.1k fork:0.0k Project Guideline is a research project that leverages on-device ML to enable people who are blind and low-vision to walk or run for exercise independently.
...
- [google-research/agent-based-epidemic-sim](https://github.com/google-research/agent-based-epidemic-sim) topic: pushed_at:2025-11 star:0.1k fork:0.0k 
...
- [google-research/google-research](https://github.com/google-research/google-research) topic:ai,machine-learning,research pushed_at:2025-12 star:36.9k fork:8.3k Google Research
...
- [google-research/mood-board-search](https://github.com/google-research/mood-board-search) topic: pushed_at:2025-11 star:0.2k fork:0.0k 
...
- [google-research/vision_transformer](https://github.com/google-research/vision_transformer) topic: pushed_at:2025-03 star:12.1k fork:1.4k 
...
- [google-research/tuning_playbook](https://github.com/google-research/tuning_playbook) topic: pushed_at:2024-06 star:29.5k fork:2.4k A playbook for systematically maximizing the performance of deep learning models.
...
- [google-research/android_world](https://github.com/google-research/android_world) topic: pushed_at:2025-11 star:0.5k fork:0.1k AndroidWorld is an environment and benchmark for autonomous agents
...
- [google-research/bert](https://github.com/google-research/bert) topic:google,natural-language-processing,natural-language-understanding,nlp,tensorflow pushed_at:2024-07 star:39.7k fork:9.7k TensorFlow code and pre-trained models for BERT
...
- [google-research/morph-net](https://github.com/google-research/morph-net) topic:automl,deep-learning,machine-learning,neural-architecture-search,python,tensorflow pushed_at:2025-06 star:1.0k fork:0.2k Fast & Simple Resource-Constrained Learning of Deep Network Structure
...
- [google-research/timesfm](https://github.com/google-research/timesfm) topic: pushed_at:2025-12 star:7.3k fork:0.6k TimesFM (Time Series Foundation Model) is a pretrained time-series foundation model developed by Google Research for time-series forecasting.
