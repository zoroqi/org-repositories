...
- [google-research/language](https://github.com/google-research/language) topic:machine-learning,natural-language-processing,research pushed_at:2025-09 star:1.7k fork:0.4k Shared repository for open-sourced projects from the Google AI Language team.
...
- [google-research/look-back-when-surprised](https://github.com/google-research/look-back-when-surprised) topic:reinforcement-learning,replay-buffer pushed_at:2025-08 star:0.0k fork:0.0k Look Back When Surprised: Stabilizing Reverse Experience Replay for Neural Approximation
...
- [google-research/perch](https://github.com/google-research/perch) topic: pushed_at:2025-09 star:0.3k fork:0.1k 
- [google-research/perch-hoplite](https://github.com/google-research/perch-hoplite) topic: pushed_at:2025-09 star:0.1k fork:0.0k 
...
- [google-research/timesfm](https://github.com/google-research/timesfm) topic: pushed_at:2025-10 star:6.8k fork:0.6k TimesFM (Time Series Foundation Model) is a pretrained time-series foundation model developed by Google Research for time-series forecasting.
...
- [google-research/zapbench](https://github.com/google-research/zapbench) topic:benchmark,calcium-imaging,forecasting,light-sheet-microcopy,machine-learning,neuroscience,time-series pushed_at:2025-09 star:0.1k fork:0.0k The Zebrafish Activity Prediction Benchmark measures progress on the problem of predicting cellular-resolution neural activity throughout an entire vertebrate brain.
