...
- [google-research/math-opt-benchmark](https://github.com/google-research/math-opt-benchmark) topic: pushed_at:2024-11 star:0.0k fork:0.0k 
...
- [google-research/agent-based-epidemic-sim](https://github.com/google-research/agent-based-epidemic-sim) topic: pushed_at:2024-11 star:0.0k fork:0.0k 
- [google-research/big_vision](https://github.com/google-research/big_vision) topic: pushed_at:2024-08 star:2.3k fork:0.2k Official codebase used to develop Vision Transformer, SigLIP, MLP-Mixer, LiT and more.
...
- [google-research/google-research](https://github.com/google-research/google-research) topic:ai,machine-learning,research pushed_at:2024-10 star:34.2k fork:7.9k Google Research
...
- [google-research/inksight](https://github.com/google-research/inksight) topic: pushed_at:2024-10 star:0.3k fork:0.0k 
...
- [google-research/language-table](https://github.com/google-research/language-table) topic:robotics,robotics-simulation pushed_at:2024-10 star:0.3k fork:0.0k Suite of human-collected datasets and a multi-task continuous control benchmark for open vocabulary visuolinguomotor learning.
...
- [google-research/pathdreamer](https://github.com/google-research/pathdreamer) topic: pushed_at:2024-10 star:0.1k fork:0.0k 
...
- [google-research/precondition](https://github.com/google-research/precondition) topic: pushed_at:2024-10 star:0.0k fork:0.0k 
...
- [google-research/proteinfer](https://github.com/google-research/proteinfer) topic: pushed_at:2024-10 star:0.2k fork:0.0k Deep networks for protein functional inference
...
- [google-research/self-organising-systems](https://github.com/google-research/self-organising-systems) topic: pushed_at:2024-10 star:0.3k fork:0.1k 
- [google-research/si-score](https://github.com/google-research/si-score) topic: pushed_at:2024-10 star:0.0k fork:0.0k 
...
- [google-research/socialgood](https://github.com/google-research/socialgood) topic: pushed_at:2024-10 star:0.0k fork:0.0k 
...
- [google-research/vision_transformer](https://github.com/google-research/vision_transformer) topic: pushed_at:2024-05 star:10.4k fork:1.3k 
...
- [google-research/tuning_playbook](https://github.com/google-research/tuning_playbook) topic: pushed_at:2024-06 star:27.0k fork:2.2k A playbook for systematically maximizing the performance of deep learning models.
...
- [google-research/bert](https://github.com/google-research/bert) topic:google,natural-language-processing,natural-language-understanding,nlp,tensorflow pushed_at:2024-07 star:38.1k fork:9.6k TensorFlow code and pre-trained models for BERT
...
- [google-research/circuit_training](https://github.com/google-research/circuit_training) topic: pushed_at:2024-09 star:1.2k fork:0.2k 
...
- [google-research/e3x](https://github.com/google-research/e3x) topic: pushed_at:2024-10 star:0.1k fork:0.0k E3x is a JAX library for constructing efficient E(3)-equivariant deep learning architectures built on top of Flax.
...
- [google-research/FLAN](https://github.com/google-research/FLAN) topic: pushed_at:2024-10 star:1.5k fork:0.2k 
...
- [google-research/language](https://github.com/google-research/language) topic:machine-learning,natural-language-processing,research pushed_at:2024-10 star:1.6k fork:0.3k Shared repository for open-sourced projects from the Google AI Language team.
...
- [google-research/lasertagger](https://github.com/google-research/lasertagger) topic: pushed_at:2024-10 star:0.6k fork:0.1k 
- [google-research/last](https://github.com/google-research/last) topic: pushed_at:2024-10 star:0.0k fork:0.0k A JAX library for building lattice-based speech transducer models
...
- [google-research/look-back-when-surprised](https://github.com/google-research/look-back-when-surprised) topic:reinforcement-learning,replay-buffer pushed_at:2024-10 star:0.0k fork:0.0k Look Back When Surprised: Stabilizing Reverse Experience Replay for Neural Approximation
...
- [google-research/neuralgcm](https://github.com/google-research/neuralgcm) topic:climate,neuralgcm,weather pushed_at:2024-10 star:0.7k fork:0.1k Hybrid ML + physics model of the Earth's atmosphere
...
- [google-research/omniglue](https://github.com/google-research/omniglue) topic:image-matching,multi-view-geometry pushed_at:2024-08 star:0.6k fork:0.0k Code release for CVPR'24 submission 'OmniGlue'
...
- [google-research/perceiver-ar](https://github.com/google-research/perceiver-ar) topic: pushed_at:2024-10 star:0.2k fork:0.0k 
...
- [google-research/prompt-tuning](https://github.com/google-research/prompt-tuning) topic:flax,jax,language-model,machine-learning,nlp,prompt-tuning pushed_at:2024-05 star:0.7k fork:0.1k Original Implementation of Prompt Tuning from Lester, et al, 2021
...
- [google-research/sam](https://github.com/google-research/sam) topic: pushed_at:2024-10 star:0.6k fork:0.1k 
...
- [google-research/swirl-dynamics](https://github.com/google-research/swirl-dynamics) topic: pushed_at:2024-10 star:0.0k fork:0.0k 
...
- [google-research/text-to-text-transfer-transformer](https://github.com/google-research/text-to-text-transfer-transformer) topic: pushed_at:2024-09 star:6.2k fork:0.8k Code for the paper "Exploring the Limits of Transfer Learning with a Unified Text-to-Text Transformer"
...
- [google-research/true](https://github.com/google-research/true) topic: pushed_at:2024-10 star:0.1k fork:0.0k Code and data accompanying the paper "TRUE: Re-evaluating Factual Consistency Evaluation".
...
- [google-research/visu3d](https://github.com/google-research/visu3d) topic:3d,nerf,plotly pushed_at:2024-10 star:0.1k fork:0.0k 3d without friction (Torch, TF, Jax, Numpy)
...
- [google-research/xmcgan_image_generation](https://github.com/google-research/xmcgan_image_generation) topic: pushed_at:2024-10 star:0.1k fork:0.0k 
