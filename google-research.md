...
- [google-research/project-guideline](https://github.com/google-research/project-guideline) topic: pushed_at:2026-01 star:0.1k fork:0.0k Project Guideline is a research project that leverages on-device ML to enable people who are blind and low-vision to walk or run for exercise independently.
...
- [google-research/google-research](https://github.com/google-research/google-research) topic:ai,machine-learning,research pushed_at:2026-02 star:37.3k fork:8.3k Google Research
...
- [google-research/inksight](https://github.com/google-research/inksight) topic: pushed_at:2025-06 star:0.9k fork:0.1k 
...
- [google-research/language-table](https://github.com/google-research/language-table) topic:robotics,robotics-simulation pushed_at:2026-02 star:0.3k fork:0.0k Suite of human-collected datasets and a multi-task continuous control benchmark for open vocabulary visuolinguomotor learning.
...
- [google-research/population-dynamics](https://github.com/google-research/population-dynamics) topic: pushed_at:2025-11 star:0.4k fork:0.0k PDFM Embeddings: location-based vectors for geo-spatial analysis.
...
- [google-research/proteinfer](https://github.com/google-research/proteinfer) topic: pushed_at:2026-01 star:0.2k fork:0.0k Deep networks for protein functional inference
...
- [google-research/socialgood](https://github.com/google-research/socialgood) topic: pushed_at:2026-01 star:0.0k fork:0.0k 
- [google-research/sofima](https://github.com/google-research/sofima) topic:2d,3d,4d,alignment-algorithm,biomedical-image-processing,connectomics,electron-microscopy,jax,microscopy,python3,stitching-algorithm pushed_at:2026-01 star:0.1k fork:0.0k Scalable Optical Flow-based Image Montaging and Alignment
...
- [google-research/tuning_playbook](https://github.com/google-research/tuning_playbook) topic: pushed_at:2024-06 star:29.8k fork:2.4k A playbook for systematically maximizing the performance of deep learning models.
...
- [google-research/arco-era5](https://github.com/google-research/arco-era5) topic:cloud-optimized,ecmwf,era5,open-science,zarr pushed_at:2026-01 star:0.4k fork:0.0k Recipes for reproducing Analysis-Ready & Cloud Optimized (ARCO) ERA5 datasets.
...
- [google-research/circuit_training](https://github.com/google-research/circuit_training) topic: pushed_at:2026-02 star:1.6k fork:0.2k 
...
- [google-research/connectomics](https://github.com/google-research/connectomics) topic:connectomics pushed_at:2026-01 star:0.0k fork:0.0k 
- [google-research/corenet](https://github.com/google-research/corenet) topic: pushed_at:2025-11 star:0.1k fork:0.0k CoReNet is a technique for joint multi-object 3D reconstruction from a single RGB image.
...
- [google-research/language](https://github.com/google-research/language) topic:machine-learning,natural-language-processing,research pushed_at:2026-02 star:1.7k fork:0.4k Shared repository for open-sourced projects from the Google AI Language team.
...
- [google-research/last](https://github.com/google-research/last) topic: pushed_at:2026-01 star:0.0k fork:0.0k A JAX library for building lattice-based speech transducer models
...
- [google-research/MapTrace](https://github.com/google-research/MapTrace) topic: pushed_at:2026-01 star:0.0k fork:0.0k 
...
- [google-research/spade_anomaly_detection](https://github.com/google-research/spade_anomaly_detection) topic:anomaly-detection-algorithm,ensemble-model,one-class-classification,semi-supervised pushed_at:2026-01 star:0.0k fork:0.0k Semi-supervised anomaly detection method
...
- [google-research/timesfm](https://github.com/google-research/timesfm) topic: pushed_at:2026-02 star:7.7k fork:0.7k TimesFM (Time Series Foundation Model) is a pretrained time-series foundation model developed by Google Research for time-series forecasting.
