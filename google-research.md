...
- [google-research/openfst](https://github.com/google-research/openfst) topic:finite-state-automata,finite-state-transducers pushed_at:2026-08 star:0.0k fork:0.0k Finite-state Transducer (FST) Library.
...
- [google-research/google-research](https://github.com/google-research/google-research) topic:ai,machine-learning,research pushed_at:2026-08 star:38.6k fork:8.5k Google Research
...
- [google-research/android_world](https://github.com/google-research/android_world) topic: pushed_at:2026-07 star:0.8k fork:0.2k AndroidWorld is an environment and benchmark for autonomous agents
...
- [google-research/bert](https://github.com/google-research/bert) topic:google,natural-language-processing,natural-language-understanding,nlp,tensorflow pushed_at:2024-07 star:40.1k fork:9.7k TensorFlow code and pre-trained models for BERT
...
- [google-research/kauldron](https://github.com/google-research/kauldron) topic:deep-learning,jax,python pushed_at:2026-08 star:0.3k fork:0.0k Modular, scalable library to train ML models
...
- [google-research/metricx](https://github.com/google-research/metricx) topic: pushed_at:2026-07 star:0.1k fork:0.0k 
...
- [google-research/reasoning-bank](https://github.com/google-research/reasoning-bank) topic: pushed_at:2026-08 star:0.5k fork:0.1k 
...
- [google-research/remote-sensing](https://github.com/google-research/remote-sensing) topic: pushed_at:2026-08 star:0.0k fork:0.0k 
...
- [google-research/spade_anomaly_detection](https://github.com/google-research/spade_anomaly_detection) topic:anomaly-detection-algorithm,ensemble-model,one-class-classification,semi-supervised pushed_at:2026-07 star:0.1k fork:0.0k Semi-supervised anomaly detection method
...
- [google-research/swirl-lm](https://github.com/google-research/swirl-lm) topic: pushed_at:2026-04 star:0.1k fork:0.0k 
...
- [google-research/tabfm](https://github.com/google-research/tabfm) topic: pushed_at:2026-08 star:2.5k fork:0.3k TabFM (Tabular Foundation Model) is a pretrained tabular foundation model developed by Google Research for tabular data regression and classification. 
...
- [google-research/timesfm](https://github.com/google-research/timesfm) topic: pushed_at:2026-07 star:27.9k fork:2.7k TimesFM (Time Series Foundation Model) is a pretrained time-series foundation model developed by Google Research for time-series forecasting.
- [google-research/tnco](https://github.com/google-research/tnco) topic:google-quantum,optimization,python,quantum-circuits,tensor-networks pushed_at:2026-07 star:0.0k fork:0.0k TNCO is a heuristic tool that optimizes tensor network contraction paths.
...
- [google-research/weatherbenchX](https://github.com/google-research/weatherbenchX) topic: pushed_at:2026-08 star:0.2k fork:0.0k A modular framework for evaluating weather forecasts
