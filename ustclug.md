...
- [ustclug/rsync-proxy](https://github.com/ustclug/rsync-proxy) topic:proxy,rsync pushed_at:2026-05 star:0.0k fork:0.0k 根据 module name 反向代理不同 host 上的 rsync daemon 以减轻单台主机上的 IO 压力
...
- [ustclug/Yuki](https://github.com/ustclug/Yuki) topic:docker-container,mirror,restful-api pushed_at:2026-05 star:0.1k fork:0.0k Mirror management tool, developed and used in-house in USTC
...
- [ustclug/website](https://github.com/ustclug/website) topic:hacktoberfest,jekyll,website pushed_at:2026-05 star:0.0k fork:0.0k The next-gen website of LUG@USTC
...
- [ustclug/mirrorhelp](https://github.com/ustclug/mirrorhelp) topic:documentation,hacktoberfest,mirror pushed_at:2026-05 star:0.6k fork:0.2k Documentation for USTC Mirrors
...
- [ustclug/ustcmirror-images](https://github.com/ustclug/ustcmirror-images) topic:docker-image,git,hacktoberfest,lftp,rsync pushed_at:2026-05 star:0.1k fork:0.0k Docker images used by ustcmirror :rocket:
