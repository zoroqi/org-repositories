...
- [ustclug/light-socks5](https://github.com/ustclug/light-socks5) topic: pushed_at:2024-05 star:0.0k fork:0.0k light accelerator socks5 daemon
...
- [ustclug/Yuki](https://github.com/ustclug/Yuki) topic:docker-container,mirror,restful-api pushed_at:2024-06 star:0.0k fork:0.0k Mirror management tool, developed and used in-house in USTC
...
- [ustclug/mirrors-index](https://github.com/ustclug/mirrors-index) topic: pushed_at:2024-05 star:0.0k fork:0.0k Mirrored infrequently. Go https://git.lug.ustc.edu.cn/mirrors/mirrors-index for latest version
...
- [ustclug/website](https://github.com/ustclug/website) topic:hacktoberfest,jekyll,website pushed_at:2024-06 star:0.0k fork:0.0k The next-gen website of LUG@USTC
...
- [ustclug/Linux101-docs](https://github.com/ustclug/Linux101-docs) topic:hacktoberfest pushed_at:2024-05 star:0.7k fork:0.1k Linux 101 学生课程教材与讲义
...
- [ustclug/documentations](https://github.com/ustclug/documentations) topic: pushed_at:2024-06 star:0.0k fork:0.0k LUG @ USTC Technical Documentation
...
- [ustclug/hackergame](https://github.com/ustclug/hackergame) topic: pushed_at:2024-05 star:0.1k fork:0.0k Hackergame platform for 2018 and beyond
...
- [ustclug/mirrorhelp](https://github.com/ustclug/mirrorhelp) topic:documentation,hacktoberfest,mirror pushed_at:2024-06 star:0.5k fork:0.1k Documents about how to use repos on mirrors.ustc.edu.cn.
...
- [ustclug/monitor](https://github.com/ustclug/monitor) topic: pushed_at:2024-05 star:0.0k fork:0.0k tools used by USTC LUG monitor site
...
- [ustclug/docker-gitlab](https://github.com/ustclug/docker-gitlab) topic: pushed_at:2024-05 star:0.0k fork:0.0k Dockerized GitLab
...
- [ustclug/light-list](https://github.com/ustclug/light-list) topic: pushed_at:2022-11 star:0.0k fork:0.0k accelerate list of light service (Last run: 2024-06-16)
- [ustclug/light-server](https://github.com/ustclug/light-server) topic: pushed_at:2024-06 star:0.0k fork:0.0k light accelerator daemon
...
- [ustclug/lugftp](https://github.com/ustclug/lugftp) topic:afp,ftp,ftp-site pushed_at:2024-02 star:0.0k fork:0.0k FTP site of USTC Linux User Group
...
- [ustclug/mirrorimage](https://github.com/ustclug/mirrorimage) topic: pushed_at:2024-06 star:0.0k fork:0.0k Docker Distribution Images replaced with USTC Mirrors (Last run: 2024-06-16)
...
- [ustclug/ustcmirror-images](https://github.com/ustclug/ustcmirror-images) topic:docker-image,git,hacktoberfest,lftp,rsync pushed_at:2024-06 star:0.1k fork:0.0k Docker images used by ustcmirror :rocket:
