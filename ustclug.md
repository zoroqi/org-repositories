...
- [ustclug/rsync](https://github.com/ustclug/rsync) topic: pushed_at:2024-09 star:0.0k fork:0.0k 
...
- [ustclug/rsync-proxy](https://github.com/ustclug/rsync-proxy) topic:proxy,rsync pushed_at:2024-08 star:0.0k fork:0.0k 根据 module name 反向代理不同 host 上的 rsync daemon 以减轻单台主机上的 IO 压力
...
- [ustclug/Yuki](https://github.com/ustclug/Yuki) topic:docker-container,mirror,restful-api pushed_at:2024-09 star:0.0k fork:0.0k Mirror management tool, developed and used in-house in USTC
...
- [ustclug/mirrors-index](https://github.com/ustclug/mirrors-index) topic: pushed_at:2024-08 star:0.0k fork:0.0k Mirrored infrequently. Go https://git.lug.ustc.edu.cn/mirrors/mirrors-index for latest version
...
- [ustclug/website](https://github.com/ustclug/website) topic:hacktoberfest,jekyll,website pushed_at:2024-09 star:0.0k fork:0.0k The next-gen website of LUG@USTC
...
- [ustclug/Linux101-docs](https://github.com/ustclug/Linux101-docs) topic:hacktoberfest pushed_at:2024-09 star:0.7k fork:0.1k Linux 101 学生课程教材与讲义
...
- [ustclug/documentations](https://github.com/ustclug/documentations) topic: pushed_at:2024-09 star:0.0k fork:0.0k LUG @ USTC Technical Documentation
...
- [ustclug/hackergame](https://github.com/ustclug/hackergame) topic: pushed_at:2024-09 star:0.1k fork:0.0k Hackergame platform for 2018 and beyond
...
- [ustclug/Linux201-docs](https://github.com/ustclug/Linux201-docs) topic:debian,linux,server pushed_at:2024-09 star:0.0k fork:0.0k Linux 201 进阶教程阅读资料
- [ustclug/lug-vpn-web](https://github.com/ustclug/lug-vpn-web) topic: pushed_at:2024-05 star:0.0k fork:0.0k LUG VPN 申请系统
- [ustclug/mirrorhelp](https://github.com/ustclug/mirrorhelp) topic:documentation,hacktoberfest,mirror pushed_at:2024-09 star:0.5k fork:0.1k Documents about how to use repos on mirrors.ustc.edu.cn.
...
- [ustclug/monitor](https://github.com/ustclug/monitor) topic: pushed_at:2024-07 star:0.0k fork:0.0k tools used by USTC LUG monitor site
...
- [ustclug/docker-gitlab](https://github.com/ustclug/docker-gitlab) topic: pushed_at:2024-07 star:0.0k fork:0.0k Dockerized GitLab
...
- [ustclug/light-list](https://github.com/ustclug/light-list) topic: pushed_at:2022-11 star:0.0k fork:0.0k accelerate list of light service (Last run: 2024-09-16)
...
- [ustclug/mirrorimage](https://github.com/ustclug/mirrorimage) topic: pushed_at:2024-06 star:0.0k fork:0.0k Docker Distribution Images replaced with USTC Mirrors (Last run: 2024-09-15)
...
- [ustclug/ustcmirror-images](https://github.com/ustclug/ustcmirror-images) topic:docker-image,git,hacktoberfest,lftp,rsync pushed_at:2024-09 star:0.1k fork:0.0k Docker images used by ustcmirror :rocket:
