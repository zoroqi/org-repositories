...
- [bytedance/sonic](https://github.com/bytedance/sonic) pushed_at:2022-01 star:1.8k fork:0.1k A blazingly fast JSON serializing & deserializing library
...
- [bytedance/CodeLocator](https://github.com/bytedance/CodeLocator) pushed_at:2021-08 star:0.5k fork:0.0k 
...
- [bytedance/scene](https://github.com/bytedance/scene) pushed_at:2021-10 star:1.8k fork:0.2k Android Single Activity Applications framework without Fragment.
...
- [bytedance/xgplayer](https://github.com/bytedance/xgplayer) pushed_at:2021-12 star:4.8k fork:0.6k A HTML5 video player with a parser that saves traffic
...
- [bytedance/btrace](https://github.com/bytedance/btrace) pushed_at:2021-12 star:0.7k fork:0.1k 🔥🔥 btrace(AKA RheaTrace) is a high performance Android trace tool which is based on Systrace, it support to define custom events automatically during building apk and using bhook to provider more native events like IO.
...
- [bytedance/Fastbot_Android](https://github.com/bytedance/Fastbot_Android) pushed_at:2021-11 star:0.4k fork:0.1k Fastbot(2.0) is a model-based testing tool for modeling GUI transitions to discover app stability problems
...
- [bytedance/byteps](https://github.com/bytedance/byteps) pushed_at:2021-12 star:3.0k fork:0.4k A high performance and generic framework for distributed DNN training
...
- [bytedance/keyhouse](https://github.com/bytedance/keyhouse) pushed_at:2022-01 star:0.0k fork:0.0k Keyhouse is a skeleton of general-purpose Key Management System written in Rust.
...
- [bytedance/bytemd](https://github.com/bytedance/bytemd) pushed_at:2021-12 star:1.7k fork:0.1k A hackable Markdown editor component built with Svelte
...
- [bytedance/mona-templates](https://github.com/bytedance/mona-templates) pushed_at:2021-12 star:0.0k fork:0.0k template's repo for mona-cli-init
...
- [bytedance/syllepsis](https://github.com/bytedance/syllepsis) pushed_at:2021-12 star:0.1k fork:0.0k Syllepsis is an out-of-the-box rich text editor.
