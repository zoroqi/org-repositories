...
- [bytedance/sonic](https://github.com/bytedance/sonic) topic: pushed_at:2022-11 star:3.6k fork:0.2k A blazingly fast JSON serializing & deserializing library

## C

- [bytedance/android-inline-hook](https://github.com/bytedance/android-inline-hook) topic:android,androidinlinehook,arm,arm64,hook,inline,inlinehook,jni,ndk,security,thumb pushed_at:2022-11 star:0.7k fork:0.2k :fire: ShadowHook is an Android inline hook library which supports thumb, arm32 and arm64.
...
- [bytedance/lightseq](https://github.com/bytedance/lightseq) topic:accelerate,bart,beam-search,bert,cuda,diverse-decoding,gpt,inference,multilingual-nmt,sampling,training,transformer pushed_at:2022-11 star:2.4k fork:0.3k LightSeq: A High Performance Library for Sequence Processing and Generation
...
- [bytedance/appshark](https://github.com/bytedance/appshark) topic:android,compliance,static-analysis,vulnerability pushed_at:2022-11 star:0.8k fork:0.1k Appshark is a static taint analysis platform to scan vulnerabilities in an Android app.
...
- [bytedance/DeepSolid](https://github.com/bytedance/DeepSolid) topic: pushed_at:2022-10 star:0.0k fork:0.0k A library combining solid quantum Monte Carlo and neural network.
...
- [bytedance/bytemd](https://github.com/bytedance/bytemd) topic:markdown,markdown-editor,markdown-viewer,svelte pushed_at:2022-11 star:3.1k fork:0.2k Hackable Markdown Editor and Viewer
...
- [bytedance/IconPark](https://github.com/bytedance/IconPark) topic:fill,icon,icon-components,icons,multiple-themes,stroke,svg,svg-icon,vue-component,vue-next,vue3 pushed_at:2022-08 star:6.6k fork:0.4k 🍎Transform an SVG icon into multiple themes, and generate React icons，Vue icons，svg icons
...
- [bytedance/mona](https://github.com/bytedance/mona) topic: pushed_at:2022-11 star:0.0k fork:0.0k mona is for developing merchant's app
