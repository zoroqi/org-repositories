...
- [bytedance/ps-lite](https://github.com/bytedance/ps-lite) pushed_at:2020-12 A lightweight parameter server interface
- [bytedance/tensorflow](https://github.com/bytedance/tensorflow) pushed_at:2020-11 An Open Source Machine Learning Framework for Everyone
- [bytedance/triton-inference-server](https://github.com/bytedance/triton-inference-server) pushed_at:2020-11 The Triton Inference Server provides a cloud inferencing solution optimized for NVIDIA GPUs. 
...
- [bytedance/rangers_applog_flutter_plugin](https://github.com/bytedance/rangers_applog_flutter_plugin) pushed_at:2019-10 flutter plugin for RangersAppLog.
...
- [bytedance/unpub](https://github.com/bytedance/unpub) pushed_at:2020-08 Self-hosted private Dart Pub server for Enterprise
...
- [bytedance/AlphaPlayer](https://github.com/bytedance/AlphaPlayer) pushed_at:2020-11 AlphaPlayer is a video animation engine.
- [bytedance/BoostMultiDex](https://github.com/bytedance/BoostMultiDex) pushed_at:2020-07 BoostMultiDex is a solution for quickly loading multiple DEXs on low Android version devices (4.X and below, SDK <21).
- [bytedance/ByteX](https://github.com/bytedance/ByteX) pushed_at:2020-11 ByteX is a bytecode plugin platform based on Android Gradle Transform API and ASM.  字节码插件开发平台
...
- [bytedance/tiktok-business-android-sdk](https://github.com/bytedance/tiktok-business-android-sdk) pushed_at:2020-11 

## JavaScript

- [bytedance/danmu.js](https://github.com/bytedance/danmu.js) pushed_at:2020-04 HTML5 danmu (danmaku) plugin for any DOM element
- [bytedance/diat](https://github.com/bytedance/diat) pushed_at:2020-11 A CLI tool to help with diagnosing Node.js processes basing on inspector.
...
- [bytedance/xgplayer](https://github.com/bytedance/xgplayer) pushed_at:2020-11 A HTML5 video player with a parser that saves traffic
...
- [bytedance/tiktok-business-ios-sdk](https://github.com/bytedance/tiktok-business-ios-sdk) pushed_at:2020-11 
...
- [bytedance/qemu](https://github.com/bytedance/qemu) pushed_at:2020-10 Official QEMU mirror. Please see http://wiki.qemu.org/Contribute/SubmitAPatch for how to submit changes to QEMU. Pull Requests are ignored. Please only use release tarballs from the QEMU website.
...
- [bytedance/neurst](https://github.com/bytedance/neurst) pushed_at:2020-11 Neural end-to-end Speech Translation Toolkit
...
- [bytedance/IconPark](https://github.com/bytedance/IconPark) pushed_at:2020-11 🍎Transform an SVG icon into multiple themes, and generate React icons，Vue icons，svg icons
