...
- [bytedance/diat](https://github.com/bytedance/diat) pushed_at:2022-04 star:0.1k fork:0.0k A CLI tool to help with diagnosing Node.js processes basing on inspector.
...
- [bytedance/xgplayer](https://github.com/bytedance/xgplayer) pushed_at:2022-05 star:5.3k fork:0.6k A HTML5 video player with a parser that saves traffic
...
- [bytedance/btrace](https://github.com/bytedance/btrace) pushed_at:2022-05 star:1.0k fork:0.2k 🔥🔥 btrace(AKA RheaTrace) is a high performance Android trace tool which is based on Systrace, it support to define custom events automatically during building apk and using bhook to provider more native events like IO.
...
- [bytedance/ParaGen](https://github.com/bytedance/ParaGen) pushed_at:2022-05 star:0.2k fork:0.0k ParaGen is a PyTorch deep learning framework for parallel sequence generation.
...
- [bytedance/Elkeid](https://github.com/bytedance/Elkeid) pushed_at:2022-06 star:1.2k fork:0.3k Elkeid is a Cloud-Native Host-Based Intrusion Detection solution project to provide next-generation Threat Detection and Behavior Audition with modern architecture. 
...
- [bytedance/bytemd](https://github.com/bytedance/bytemd) pushed_at:2022-06 star:2.5k fork:0.2k Hackable Markdown Editor and Viewer
...
- [bytedance/IconPark](https://github.com/bytedance/IconPark) pushed_at:2022-06 star:5.9k fork:0.3k 🍎Transform an SVG icon into multiple themes, and generate React icons，Vue icons，svg icons
