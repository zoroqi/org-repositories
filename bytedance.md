...
- [bytedance/atop](https://github.com/bytedance/atop) pushed_at:2021-12 star:0.0k fork:0.0k System and process monitor for Linux
...
- [bytedance/bhook](https://github.com/bytedance/bhook) pushed_at:2021-12 star:1.0k fork:0.1k 🔥 ByteHook(aka bhook) is a PLT hook framework for Android app.
...
- [bytedance/memory-leak-detector](https://github.com/bytedance/memory-leak-detector) pushed_at:2022-01 star:0.6k fork:0.1k 
...
- [bytedance/trace-irqoff](https://github.com/bytedance/trace-irqoff) pushed_at:2021-11 star:0.1k fork:0.1k Interrupts-off or softirqs-off latency tracer
...
- [bytedance/ps-lite](https://github.com/bytedance/ps-lite) pushed_at:2021-12 star:0.1k fork:0.0k A lightweight parameter server interface
- [bytedance/pyskynet](https://github.com/bytedance/pyskynet) pushed_at:2021-12 star:0.0k fork:0.0k PySkynet is a library for using skynet in python.
...
- [bytedance/terarkdb](https://github.com/bytedance/terarkdb) pushed_at:2022-01 star:1.5k fork:0.1k A RocksDB compatible KV storage engine with better performance
- [bytedance/xoa_set_ip_option](https://github.com/bytedance/xoa_set_ip_option) pushed_at:2021-09 star:0.0k fork:0.0k 

## Cuda

- [bytedance/lightseq](https://github.com/bytedance/lightseq) pushed_at:2022-01 star:1.9k fork:0.2k LightSeq: A High Performance Library for Sequence Processing and Generation

## Dart

- [bytedance/flutter_ume](https://github.com/bytedance/flutter_ume) pushed_at:2021-12 star:1.4k fork:0.1k UME is an in-app debug kits platform for Flutter. Produced by Flutter Infra team of ByteDance
...
- [bytedance/rangers_applog_flutter_plugin](https://github.com/bytedance/rangers_applog_flutter_plugin) pushed_at:2021-12 star:0.0k fork:0.0k flutter plugin for RangersAppLog.
...
- [bytedance/Elkeid](https://github.com/bytedance/Elkeid) pushed_at:2022-01 star:1.0k fork:0.2k Elkeid is a Cloud-Native Host-Based Intrusion Detection solution project to provide next-generation Threat Detection and Behavior Audition with modern architecture.
...
- [bytedance/go-tagexpr](https://github.com/bytedance/go-tagexpr) pushed_at:2021-12 star:1.1k fork:0.1k An interesting go struct tag expression syntax for field validation, etc.
- [bytedance/godlp](https://github.com/bytedance/godlp) pushed_at:2021-11 star:0.0k fork:0.0k sensitive information protection toolkit
- [bytedance/gopkg](https://github.com/bytedance/gopkg) pushed_at:2021-11 star:0.5k fork:0.1k Universal Utilities for Go
...
- [bytedance/kldx-common](https://github.com/bytedance/kldx-common) pushed_at:2022-01 star:0.0k fork:0.0k 
- [bytedance/kldx-core](https://github.com/bytedance/kldx-core) pushed_at:2022-01 star:0.0k fork:0.0k 
- [bytedance/kldx-infra](https://github.com/bytedance/kldx-infra) pushed_at:2022-01 star:0.0k fork:0.0k 
...
- [bytedance/sonic](https://github.com/bytedance/sonic) pushed_at:2022-01 star:2.0k fork:0.1k A blazingly fast JSON serializing & deserializing library
...
- [bytedance/AlphaPlayer](https://github.com/bytedance/AlphaPlayer) pushed_at:2021-12 star:1.5k fork:0.2k AlphaPlayer is a video animation engine.
...
- [bytedance/ByteX](https://github.com/bytedance/ByteX) pushed_at:2021-07 star:2.2k fork:0.3k ByteX is a bytecode plugin platform based on Android Gradle Transform API and ASM.  字节码插件开发平台
...
- [bytedance/CodeLocator](https://github.com/bytedance/CodeLocator) pushed_at:2022-01 star:0.6k fork:0.0k 
...
- [bytedance/scene](https://github.com/bytedance/scene) pushed_at:2022-01 star:1.8k fork:0.2k Android Single Activity Applications framework without Fragment.
- [bytedance/tiktok-business-android-sdk](https://github.com/bytedance/tiktok-business-android-sdk) pushed_at:2021-12 star:0.0k fork:0.0k 
...
- [bytedance/diat](https://github.com/bytedance/diat) pushed_at:2021-09 star:0.1k fork:0.0k A CLI tool to help with diagnosing Node.js processes basing on inspector.
...
- [bytedance/xgplayer](https://github.com/bytedance/xgplayer) pushed_at:2021-12 star:4.9k fork:0.6k A HTML5 video player with a parser that saves traffic
...
- [bytedance/ibot](https://github.com/bytedance/ibot) pushed_at:2022-01 star:0.2k fork:0.0k iBOT: Image BERT Pre-Training with Online Tokenizer
...
- [bytedance/btrace](https://github.com/bytedance/btrace) pushed_at:2021-12 star:0.8k fork:0.1k 🔥🔥 btrace(AKA RheaTrace) is a high performance Android trace tool which is based on Systrace, it support to define custom events automatically during building apk and using bhook to provider more native events like IO.
...
- [bytedance/Fastbot_iOS](https://github.com/bytedance/Fastbot_iOS) pushed_at:2022-01 star:0.3k fork:0.0k About Fastbot(2.0) is a model-based testing tool for modeling GUI transitions to discover app stability problems
...
- [bytedance/tiktok-business-ios-sdk](https://github.com/bytedance/tiktok-business-ios-sdk) pushed_at:2022-01 star:0.0k fork:0.0k 
...
- [bytedance/Fastbot_Android](https://github.com/bytedance/Fastbot_Android) pushed_at:2022-01 star:0.4k fork:0.1k Fastbot(2.0) is a model-based testing tool for modeling GUI transitions to discover app stability problems
...
- [bytedance/byteps](https://github.com/bytedance/byteps) pushed_at:2022-01 star:3.0k fork:0.4k A high performance and generic framework for distributed DNN training
...
- [bytedance/fedlearner](https://github.com/bytedance/fedlearner) pushed_at:2022-01 star:0.7k fork:0.1k A multi-party collaborative machine learning framework
...
- [bytedance/GiantMIDI-Piano](https://github.com/bytedance/GiantMIDI-Piano) pushed_at:2021-11 star:1.1k fork:0.1k 
...
- [bytedance/music_source_separation](https://github.com/bytedance/music_source_separation) pushed_at:2021-12 star:0.7k fork:0.1k 
...
- [bytedance/Bytedance-UnionAD](https://github.com/bytedance/Bytedance-UnionAD) pushed_at:2022-01 star:0.1k fork:0.0k 
...
- [bytedance/panglead-specs](https://github.com/bytedance/panglead-specs) pushed_at:2022-01 star:0.0k fork:0.0k 
...
- [bytedance/monoio](https://github.com/bytedance/monoio) pushed_at:2021-12 star:1.7k fork:0.1k Rust async runtime based on io-uring.
...
- [bytedance/DCFrame](https://github.com/bytedance/DCFrame) pushed_at:2021-12 star:0.1k fork:0.0k DCFrame is a swift language UI combination frame, which can easily assemble complex UI.

## TypeScript

- [bytedance/byteinspire-js-sdk](https://github.com/bytedance/byteinspire-js-sdk) pushed_at:2021-12 star:0.0k fork:0.0k 轻服务 JavaScript SDK https://qingfuwu.cn
- [bytedance/bytemd](https://github.com/bytedance/bytemd) pushed_at:2022-01 star:1.7k fork:0.2k A hackable Markdown editor component built with Svelte
- [bytedance/debugtron](https://github.com/bytedance/debugtron) pushed_at:2021-02 star:0.7k fork:0.1k Debug in-production Electron based app
...
- [bytedance/IconPark](https://github.com/bytedance/IconPark) pushed_at:2021-12 star:5.0k fork:0.3k 🍎Transform an SVG icon into multiple themes, and generate React icons，Vue icons，svg icons
...
- [bytedance/mona](https://github.com/bytedance/mona) pushed_at:2022-01 star:0.0k fork:0.0k mona is for developing merchant's app and plugin
- [bytedance/mona-templates](https://github.com/bytedance/mona-templates) pushed_at:2022-01 star:0.0k fork:0.0k template's repo for mona-cli-init
...
- [bytedance/syllepsis](https://github.com/bytedance/syllepsis) pushed_at:2022-01 star:0.1k fork:0.0k Syllepsis is an out-of-the-box rich text editor.
