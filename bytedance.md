...
- [bytedance/xgplayer](https://github.com/bytedance/xgplayer) pushed_at:2021-12 star:5.0k fork:0.6k A HTML5 video player with a parser that saves traffic
...
- [bytedance/Fastbot_iOS](https://github.com/bytedance/Fastbot_iOS) pushed_at:2022-02 star:0.3k fork:0.0k About Fastbot(2.0) is a model-based testing tool for modeling GUI transitions to discover app stability problems
...
- [bytedance/bytemd](https://github.com/bytedance/bytemd) pushed_at:2022-03 star:1.9k fork:0.2k A hackable Markdown editor component built with Svelte
